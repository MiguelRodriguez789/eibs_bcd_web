...
<% if (userPO.getSource().equals("FACT")) {
	out.print("Eliminación de Emisi&oacute;n Cheques de Gerencia por Desembolso de Descuento de Documentos");
   } else {
   	out.print("Eliminación de Emisi&oacute;n Cheques de Gerencia por Desembolso de Préstamos");
   }	
 %> 


<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="of_chk_basic_lns_del.jsp, EOF0115"> 
</H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEOF0115">
  <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="1900">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap>
              ...
              / 
       	       <eibsinput:text 	name="offBasic" property="E01OFMBRN" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_BRANCH %>" readonly="true"/>         </td>
            <td nowrap>
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark">  
            ...
            <td nowrap width="22%">
           <eibsinput:text	name="offBasic" property="E01OFMAID" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_IDENTIFICATION%>" readonly="true"/>          </td>
            <td nowrap width="18%"> 
