...
function setDefaultInt(obj){ //call in onBlur event
 ...
 function disabledOpt(id) { //call in onFocus event
    var id1 = (id == 0 )? 1: 0;
    getElement("TBOPT").rows[0].cells[id].style.display = "none";
    getElement("TBOPT").rows[0].cells[id1].style.display = "";
 }
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id=trdark>
            ...
            <td nowrap align="right">                 
 			...
 			<td nowrap >                
			  <input type="text" name="NUMCUO" size="2" maxlength="2" value="1" onKeypress="enterInteger(event)" onBlur="setDefaultInt(this)" onFocus="clearDefault(this)" 
 			...
 			<td nowrap >                 
 			  <input type="text" name="NEWRTE" size="9" maxlength="9" value="0.000001" onKeypress="enterDecimal(event, 2)" onBlur="setDefaultDec(this)" onFocus="clearDefault(this)" 
    ...
    <tr > 
      <td nowrap> 
		...
		%> 
		  <tr id="trclear"> 
            <td nowrap> 
              <div align="center"> <%=Util.formatCustomDate(currUser.getE01DTF(), msgCoute.getBigDecimalE04DLPDTM().intValue(),msgCoute.getBigDecimalE04DLPDTD().intValue(),msgCoute.getBigDecimalE04DLPDTY().intValue())%> </div>
            </td>
            <td nowrap> 
