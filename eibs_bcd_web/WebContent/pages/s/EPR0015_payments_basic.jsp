...
%> 
<h3 align="center"> Detalles Interfase de Pagos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="payments_basic.jsp,EPR0015"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap >
              ...
              <a href="javascript:GetAccount('E01PRCACC','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a></td>
            <td nowrap >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap >
              ...
              <a href="javascript:GetLedger('E01PRCSDG','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
            </td>
            <td nowrap > 
              <div align="right"></div>
            </td>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap > 
              ...
              <input type="text" name="E01PRCTD3" size="5" maxlength="4" value="<%= payments.getE01PRCTD3()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
            ...
            <td nowrap> 
              ...
              <input type="text" name="E01PRPLD3" size="5" maxlength="4" value="<%= payments.getE01PRPLD3()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
