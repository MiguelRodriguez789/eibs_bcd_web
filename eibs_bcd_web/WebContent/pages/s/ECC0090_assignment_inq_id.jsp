...
<body>
<h3 align="center">Consulta de Asignaciones<BR>Detalle<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="assignment_inq_id.jsp, ECC0090"></h3>
<hr size="4">
<% 
