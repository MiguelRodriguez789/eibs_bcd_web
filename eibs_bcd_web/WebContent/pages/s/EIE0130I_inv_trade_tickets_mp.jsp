...
%>
<div align="center"> 
  <h3>Consulta M&uacute;ltiples Ordenes de Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_trade_tickets_mp.jsp,EIE0130I"> 
  </h3>
</div>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0130I" >
  <h4> 
    <h4> 
      ...
      <h4>Informaci&oacute;n Orden Maestra</h4>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap> 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDHBR" size="4" maxlength="4" value="<%= invMult.getE02ORDHBR()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDHGL" size="17" maxlength="16" value="<%= invMult.getE02ORDHGL()%>" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDHAC4" size="13" maxlength="12" value="<%= invMult.getE02ORDHAC()%>" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDHCC" size="9" maxlength="8" value="<%= invMult.getE02ORDHCC()%>" >
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap> 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDIBR" size="4" maxlength="4" value="<%= invMult.getE02ORDIBR()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDIGL" size="17" maxlength="16" value="<%= invMult.getE02ORDIGL()%>" > 
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDIAC" size="13" maxlength="12" value="<%= invMult.getE02ORDIAC()%>" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDICC" size="9" maxlength="8" value="<%= invMult.getE02ORDICC()%>" >
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDCBR" size="4" maxlength="4" value="<%= invMult.getE02ORDCBR()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDCGL" size="17" maxlength="16" value="<%= invMult.getE02ORDCGL()%>" > 
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDCAC" size="13" maxlength="12" value="<%= invMult.getE02ORDCAC()%>" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDCCC" size="9" maxlength="8" value="<%= invMult.getE02ORDCCC()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDDBR" size="4" maxlength="4" value="<%= invMult.getE02ORDDBR()%>" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDDGL" size="17" maxlength="16" value="<%= invMult.getE02ORDDGL()%>" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDDAC" size="13" maxlength="12" value="<%= invMult.getE02ORDDAC()%>" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E02ORDDCC" size="9" maxlength="8" value="<%= invMult.getE02ORDDCC()%>" >
              </div>
            </td>
          </tr>
        </table>
