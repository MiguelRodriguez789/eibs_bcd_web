...
<body>
<h3 align="center">Comisiones de Cartas de Credito Stand By <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sb_commissi.jsp, ELC0400"></h3>
<hr size="4">
...
<table class="tableinfo">
	<tr>
		...
		<tr id="trclear">
				...
				<td nowrap width="20%">
				   <div align="left">
				   		<eibsinput:date name="msg" fn_month="E04LCMIDM" fn_day="E04LCMIDD" fn_year="E04LCMIDY" readonly="true"/>
				   </div>
				</td>
				<td nowrap width="16%">
  		...
  		<tr id="trdark">
				...
				<td nowrap width="20%" colspan=3>
				   <div align="left">
				   		<eibsinput:date name="msg" fn_month="E04LCMEXM" fn_day="E04LCMEXD" fn_year="E04LCMEXY" readonly="true"/>
				   </div>
				</td>
				<td nowrap width="16%">
