...
<h3 align="center">Consulta de Descuento de Documentos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pay_inq_acp_list.jsp,EDL0825"></h3>
<hr size="4">
    ...
    <TR>
        ...
        <table id="dataTable">
            ...
            <TR>
                ...
                <TD ALIGN=CENTER NOWRAP>
                <div ><a href="javascript:showDetailInquiry(<%= docList.getCurrentRow() %>)"><%= docList.getRecord(7) %></a></DIV>
                </TD>
                <TD ALIGN=LEFT NOWRAP>
                <div ><a href="javascript:showDetailInquiry(<%= docList.getCurrentRow() %>)"><%= docList.getRecord(9) %></a></DIV>
                </TD>
...
<SCRIPT type="text/javascript">
     ...
     function resizeDoc() {
       ...
       adjustEquTables( getElement('headTable'), getElement('dataTable'), getElement('dataDiv'),1,false);
      }
