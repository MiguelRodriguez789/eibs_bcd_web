...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ptt_enter_stop_pay.jsp , EDD0190"></h3> 
<hr size="4">
<p>&nbsp;</p>
      ...
      <td nowrap> 
        <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
		  ...
		  <tr> 
            ...
            <td nowrap width="50%"> 
              <input type="text" name="E01DHSACC" size="13" maxlength="12" onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E01DHSACC','','RA','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0"  ></a> 
		  </td>
          </tr>
        </table>
      </td>
