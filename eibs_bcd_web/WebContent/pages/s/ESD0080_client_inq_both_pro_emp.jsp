<html>
<head>
<title>Proveedores de Empresa</title>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=ISO-8859-1">
<link href="<%=request.getContextPath()%>/pages/style.css" rel="stylesheet">
</head>

<jsp:useBean id= "proEmp" type= "datapro.eibs.beans.ESD000004Message"  scope="session" />
...
%>      
<h3 align="center">Proveedores de Empresa<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_inq_both_pro_emp, ESD0080"></h3>
<hr size="4">
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080" >
  <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="85">
   ...
   <tr bordercolor="#FFFFFF"> 
      <td nowrap >
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
         <tr id="trclear"> 
           ...
           <td width="58%" nowrap> 
             <input type="text" readonly name="E<%= name %>4RCN" maxlength="09" size="10" value="<%= proEmp.getField("E" + name + "4RCN").getString().trim()%>">
           </td>
          </tr>
         <tr id="trdark"> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA1" maxlength="60" size="65" value="<%= proEmp.getField("E" + name + "4MA1").getString().trim()%>" readonly>
            </td>
          </tr>
      ...
      <%--
         <tr> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA2" maxlength="35" size="36" value="<%= proEmp.getField("E" + name + "4MA2").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr id="trdark"> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA3" maxlength="35" size="36" value="<%= proEmp.getField("E" + name + "4MA3").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA4" maxlength="35" size="36" value="<%= proEmp.getField("E" + name + "4MA4").getString().trim()%>" readonly>
            </td>
          </tr>
		 <%if(currUser.getE01INT().equals("18")){%> 
           <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" readonly name="E<%= name %>4TID" maxlength="5" size="4" value="<%= proEmp.getField("E" + name + "4TID").getString().trim()%>">
         ...
         <tr> 
            ...
            <td nowrap width="58%"> 
              <input type="text" readonly name="E<%= name %>4PID" maxlength="5" size="4" value="<%= proEmp.getField("E" + name + "4PID").getString().trim()%>">
         ...
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4CTY" maxlength="30" size="31" value="<%= proEmp.getField("E" + name + "4CTY").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4STE" maxlength="4" size="5" value="<%= proEmp.getField("E" + name + "4STE").getString().trim()%>" readonly>
            </td>
          </tr>
       <%}%>
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4CTR" maxlength="20" size="21" value="<%= proEmp.getField("E" + name + "4CTR").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4POB" maxlength="10" size="11" value="<%= proEmp.getField("E" + name + "4POB").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr id="trdark"> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4ZPC" maxlength="15" size="16" value="<%= proEmp.getField("E" + name + "4ZPC").getString().trim()%>" readonly>
            </td>
          </tr>
       --%>
         
		<%	if( proEmp.getH04SCR().equals("07")){%> 	
		 <tr>
		 	<td colspan="2">
			<jsp:include page="ESD0080_address_template_basic_panama.jsp" flush="true">
				...
				<jsp:param name="messageName" value="proEmp" />
		...
		<%} else if( proEmp.getH04SCR().equals("03")) {%> 
		...
		<%} else if( proEmp.getH04SCR().equals("18")){%> 	
        ...
        <%if(!(currUser.getE01INT().equals("11"))){ %>
         <tr> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4HPN" maxlength="15" size="16" value="<%= proEmp.getField("E" + name + "4HPN").getString().trim()%>" readonly>
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4BNI" maxlength="25" size="26" value="<%= proEmp.getField("E" + name + "4BNI").getString().trim()%>" readonly>
              </td>
          </tr>
          ...
          <tr id="trclear">
            ...
            <td width="58%" nowrap > 
              <input type="text" name="E<%= name %>4TID" value="<%= proEmp.getField("E" + name + "4TID").getString().trim()%>" size="5" maxlength="4" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="42%" > 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4PID" size="5" maxlength="4" value="<%= proEmp.getField("E" + name + "4PID").getString().trim()%>" readonly>
            </td>
          </tr>
	   <% } %>
