...
<H3 align="center">Resultado Satisfactorio - Pago de Planillas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pago_planillas_aplicar_process.jsp, ECO0240"></H3>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">     
		    <tr>
		      <td >		    
				<div align="center">
  					<h3>
  						<br>Planillas Procesadas con exito.<br>
  					</h3>
  				 </div>		     		      
		      </td>
		    </tr>
