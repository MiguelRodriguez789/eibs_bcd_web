...
<html> 
<head>
<title>Entrega de Documentos Valorados</title>
...
<H3 align="center">Entrega de Documentos Valorados<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="vl_delivery_deatail,EVL0120"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
        ...
        <tr id=trclear>
          ...
          <td nowrap>
             <input type="text" name="E01IMPNRE" size="65" maxlength="60" value ="<%= msgSearch.getE01IMPNRE() %>">             
              <a href="javascript:GetEntregaCheques('E01IMPNRE','E01IMPRRE',document.forms[0].E01IMPACC.value,'G')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Autorizados a Entrega" align="middle" border="0"></a>
          </td>
        </tr>
        <tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E01IMPRRE" size="27" maxlength="25" value="<%= msgSearch.getE01IMPRRE() %>">
      	  </td>     
      	</tr>
     </table>
    </td>
