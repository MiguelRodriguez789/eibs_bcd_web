    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="16%" height="23"> 
              <div align="right">Codigo tabla Referencia Asociada :</div>
            </td>

            <td nowrap height="23"> 
              <div align="left"> 
                <input type="text" name="E02CNOMID" size="4" maxlength="2" value="<%= refCodes.getE02CNOMID().trim()%>" >               
			    <a href="javascript:GetReferenceCode('E02CNOMID')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a>   
              </div>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
