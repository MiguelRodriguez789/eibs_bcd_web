...
<H3 align="center">C&oacute;digos Especiales<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ELC0525_lc_special_codes.jsp"></H3>
<HR size="4">
<BR>
