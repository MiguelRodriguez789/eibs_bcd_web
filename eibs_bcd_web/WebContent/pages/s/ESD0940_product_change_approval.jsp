...
<BODY>
<h3 align="center">Aprobación de Cambio de Producto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="product_change_approval.jsp, ESD0940"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0940" >
  <p> 
    ...
    <input type=HIDDEN name="APL" id="" value="APL">
    <input type=HIDDEN name="ACC" id="" value="ACC">
    <input type=HIDDEN name="OLD" id="" value="OLD">
    <input type=HIDDEN name="NEW" id="" value="NEW">
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
	  ...
	  <td class=TDBKG width="30%"> 
        <div align="center"><a href="javascript:goAction(3)"><b>Rechazar</b></a></div>
      </td>
      <td class=TDBKG width="30%"> 
  ...
  <TABLE  id="mainTable" class="tableinfo">
	 <tr height="5%">
		<td NOWRAP valign="top" width="80%">
		 ...
		 %>
          <tr id="dataTable<%= ESD094001Help.getCurrentRow() %>">
            <td NOWRAP  align="center" width="2%"> 
              <input type="radio" name="CURRCODE" value="<%= ESD094001Help.getCurrentRow() %>" <%=chk%> onClick="highlightRow('dataTable', <%= ESD094001Help.getCurrentRow() %>)" >
            </td>
