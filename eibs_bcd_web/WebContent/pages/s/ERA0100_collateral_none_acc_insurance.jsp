...
<h3 align="center">Consulta Poliza de Seguro de Garantías<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="collateral_none_acc_insurance.jsp, ERA0100"></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trdark"> 
            ...
            <td width=26% nowrap> 
              <div align="left">
				<eibsinput:date name="collIns" fn_month="E03ROCEMM" fn_day="E03ROCEMD" fn_year="E03ROCEMY" />                
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td width=23%> 
              <div align="left"> 
                <input type="text" class="txtright" name="E03ROCIPA" readonly size="17" maxlength="15" value="<%= collIns.getE03ROCIPA().trim()%>">
              </div>
            </td>
            <td width=29%> 
            ...
            <td width=26% nowrap> 
              <div align="left"> 
				<eibsinput:date name="collIns" fn_month="E03ROCMDM" fn_day="E03ROCMDD" fn_year="E03ROCMDY" />                
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
