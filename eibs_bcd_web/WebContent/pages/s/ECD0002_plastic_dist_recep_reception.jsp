...
<body>
<h3 align="center">Recepción de Plástico<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_dist_recep_reception.jsp, ECD0002"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E02CDRREQ" size="15" maxlength="13" value="<%= msgCD.getE02CDRREQ() %>" onKeypress="enterInteger(event)">
              </div>
            </td>
          </tr>  
        </table>
