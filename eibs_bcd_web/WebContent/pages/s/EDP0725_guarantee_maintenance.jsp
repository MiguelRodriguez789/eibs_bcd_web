        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
 		 ...
 		 <tr id="trclear"> 
            ...
            <td nowrap height="19" width="55%">	
			  ...
			  <% if((userPO.getHeader16().equals("3"))||(userPO.getHeader16().equals("4"))){out.print("readonly");}%>>	  
      	      <a href="javascript:GetCodeDescCNOFC('E01DPCIDN','E01XXXIDN','05')">
      	      <img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" ></a>
      	      <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="absbottom" border="0" width="16" height="20">
         ...
         <%--
          ...
          <tr id="trdark"> 
            ...
            <td nowrap height="19" width="55%">
				<input type=TEXT name="E01DPCOWN" size=15 maxlength="15" onKeypress="enterInteger(event)" 
...
<TABLE id="mainTable1" class="tableinfo">
	...
	<TD NOWRAP valign="top" width="100%">
		...
		<tr>
			...
			<div align="center"><a href="javascript:goActionTit(1)"><b>Crear</b></a></div>
			</td>
			<td class=TDBKG width="33%">
      ...
      <td nowrap height="306">
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan=2> 
			<% if((userPO.getHeader16().equals("1"))||(userPO.getHeader16().equals("2"))) { %> 
				<eibsinput:date name="l0725" fn_month="E01DPIEMM" fn_day="E01DPIEMD" fn_year="E01DPIEMY" required="true" />
			<% } else { %>
				<eibsinput:date name="l0725" fn_month="E01DPIEMM" fn_day="E01DPIEMD" fn_year="E01DPIEMY" readonly="true"/>
			<% } %>                 
            </td>
            <td nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan=2>
			<% if((userPO.getHeader16().equals("1"))||(userPO.getHeader16().equals("2"))) { %> 
				<eibsinput:date name="l0725" fn_month="E01DPIMDM" fn_day="E01DPIMDD" fn_year="E01DPIMDY" required="true" />
			<% } else { %>
				<eibsinput:date name="l0725" fn_month="E01DPIMDM" fn_day="E01DPIMDD" fn_year="E01DPIMDY" readonly="true"/>
			<% } %>                 
            </td>
            <td nowrap> 
