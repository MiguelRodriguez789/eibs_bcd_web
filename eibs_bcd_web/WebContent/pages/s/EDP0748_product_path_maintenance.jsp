...
<H3 align="center">Mantenimiento Producto Ruta Detalle : <span style="font-style: italic;"> <%= userPO.getHeader10().trim()%> </span>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="product_path_maintenance.jsp, EDP0748"></H3>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								...
								<td nowrap width="25%">
									<DIV align="right">Forma Pago Capital :</DIV>
								</TD>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								...
								<td nowrap width="25%">
									<DIV align="right">Forma Pago Interes :</DIV>
								</TD>
