...
<H3 align="center">Consulta de Remesas de Efectivo en Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transfer_basic_inq,EFE0520"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr> 
	      ...
	      <Td nowrap width="20%" align=center><%= msgMT.getE02REMCRT() %></Td>
     	</tr>
     	<tr> 
	      ...
	      <Td nowrap width="20%" align=center><%= msgMT.getE02REMAPT() %></Td>
     	</tr>
     	<tr> 
	      ...
	      <Td nowrap width="20%" align=center><%= msgMT.getE02REMRET() %></Td>
     	</tr>
     	<tr> 
	      <Td id=trdark nowrap width="20%" align=center></Td>
	      <Td nowrap width="20%" align=center>Motivos :</Td>
	      <Td nowrap colspan=2 align=center><%= msgMT.getE02REMRRS()%><br><%= msgMT.getE02REMRRS() %></Td>
	    </tr>
     	<tr> 
	      ...
	      <Td nowrap width="20%" align=center><%= msgMT.getE02REMSHT() %></Td>
     	</tr>
     	<tr> 
	      ...
	      <Td nowrap width="20%" align=center><%= msgMT.getE02REMRCT() %></Td>
     	</tr>
    </table>
   </td>
   </tr>
