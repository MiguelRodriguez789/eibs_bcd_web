...
<h3 align="center">Remesas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="enter_list,EDL0813"></h3>
<hr size="4">
	...
	<%}else{%>
		<TABLE  id="mainTable" class="tableinfo" >
		     <TR id="trdark"> 
			      ...
			      <TH ALIGN=CENTER NOWRAP>Rut<br>Deudor</TH>
			      <TH ALIGN=CENTER NOWRAP>Nombre<br>Deudor</TH>
