...
<h3 align="center">Consulta de Tabla de Cargos en Cuentas de Detalles<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dda_inq_serv_charge, ESD0712"></h3>
<hr size="4">
<form >
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            <td width="20%" height="22"> 
              <div align="right">Descripcion de Tabla</div>
            </td>
            <td width="40%" height="22"> 
              <input type="text" name="E01RTEDSC" size="48" maxlength="45" value="<%= ddaServCharge.getE01RTEDSC().trim()%>">
            </td>
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="16%" height="22"> 
              <input type="text" name="E01RTEMBM" size="15" maxlength="13" value="<%= ddaServCharge.getE01RTEMBM().trim()%>">
            </td>
            <td width="16%" height="22"> 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="17%"> 
              <input type="text" name="E01RTEBL1" size="15" maxlength="13" value="<%= ddaServCharge.getE01RTEBL1().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="34%"> 
            ...
            <td width="17%"> 
              <input type="text" name="E01RTEBL2" size="15" maxlength="13" value="<%= ddaServCharge.getE01RTEBL2().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="34%"> 
            ...
            <td width="17%"> 
              <input type="text" name="E01RTEBL3" size="15" maxlength="13" value="<%= ddaServCharge.getE01RTEBL3().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="34%"> 
            ...
            <td width="17%"> 
              <input type="text" name="E01RTEBL4" size="15" maxlength="13" value="<%= ddaServCharge.getE01RTEBL4().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="34%"> 
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td width="23%">
              <input type="text" name="E01RTEOR1" size="14" maxlength="13" value="<%= ddaServCharge.getE01RTEOR1().trim()%>">
            </td>
            <td width="27%"> 
              <div align="right">D&iacute;as L&iacute;mite 1:</div>
            </td>
            <td width="19%">
              <input type="text" name="E01RTEDO1" size="4" maxlength="3" value="<%= ddaServCharge.getE01RTEDO1().trim()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td width="31%"> 
            ...
            <td width="23%">
              <input type="text" name="E01RTEOR2" size="14" maxlength="13" value="<%= ddaServCharge.getE01RTEOR2().trim()%>">
            </td>
            <td width="27%"> 
              <div align="right">D&iacute;as L&iacute;mite 2:</div>
            </td>
            <td width="19%">
              <input type="text" name="E01RTEDO2" size="4" maxlength="3" value="<%= ddaServCharge.getE01RTEDO2().trim()%>">
            </td>
          </tr>
          <tr id="trdark">
            <td width="31%"> 
            ...
            <td width="23%">
              <input type="text" name="E01RTEOR3" size="14" maxlength="13" value="<%= ddaServCharge.getE01RTEOR3().trim()%>">
            </td>
            <td width="27%"> 
              <div align="right">D&iacute;as L&iacute;mite 3:</div>
            </td>
            <td width="19%">
              <input type="text" name="E01RTEDO3" size="4" maxlength="3" value="<%= ddaServCharge.getE01RTEDO3().trim()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td width="31%"> 
            ...
            <td width="23%">
              <input type="text" name="E01RTEOR4" size="14" maxlength="13" value="<%= ddaServCharge.getE01RTEOR4().trim()%>">
            </td>
            <td width="27%"> 
              <div align="right">D&iacute;as L&iacute;mite 4:</div>
            </td>
            <td width="19%">
              <input type="text" name="E01RTEDO4" size="4" maxlength="3" value="<%= ddaServCharge.getE01RTEDO4().trim()%>">
            </td>
          </tr>
          <tr id="trdark">
            <td width="31%"> 
            ...
            <td width="19%"> 
              <input type="text" name="E01RTEODC" size="14" maxlength="13" value="<%= ddaServCharge.getE01RTEODC().trim()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td width="31%"> 
