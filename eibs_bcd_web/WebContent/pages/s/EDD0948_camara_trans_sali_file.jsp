...
%>
 <h3 align="center">Carga de Archivo de Camara Saliente BCO077
 	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="camara_trans_sal_file.jsp, EDD0948"></h3>
<hr size="4">
 <FORM METHOD="POST" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEDD0948" ENCTYPE="multipart/form-data">	
