...
<H3 align="center">Mantenimiento de Niveles Papel Valor<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_lvl_enter_inq,EVL0000"></H3>
<hr size="4">
<p>&nbsp;</p>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01LVLBNK" size="3" maxlength="2" onkeypress="enterInteger(event)" value="<%= msgMT.getE01LVLBNK()%>">
	      </td>
     	</tr>
     	<tr id=trclear> 
	      <td nowrap width="40%"> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01LVLBRN" size="5" maxlength="4" value="<%= msgMT.getE01LVLBRN()%>">
