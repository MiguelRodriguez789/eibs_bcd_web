...
%>
  <h3 align="center">Estado de Cuentas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="st_list_print_fp.jsp,ECIF030"> 
  </h3>
  <hr size="4">
  <p>&nbsp;</p>
      ...
      <td height="155" > 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td  width="38%" nowrap><%= stBalances.getE02CUMMA1().trim()%></td>
            <td  width="1%">&nbsp;</td>
            <td  width="32%" nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td  width="32%" nowrap> 
              <div align="right"><b> Saldo al </b> <%= Util.formatCustomDate(currUser.getE01DTF(), stBalances.getE02LSSTMM(),stBalances.getE02LSSTMD(),stBalances.getE02LSSTMY())%> 
                <b>: </b></div>
            </td>
            <td  width="13%"> 
