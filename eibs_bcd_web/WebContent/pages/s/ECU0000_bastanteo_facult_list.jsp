    ...
    if (opt == "D") {
	  ...
	  if (ok) document.forms[0].submit();
		...
		document.forms[0].submit();
  	    ...
  	    page = "<%=request.getContextPath()%>/pages/s/ECU0000_bastanteo_facult_new.jsp";
  		CenterNamedWindow(page,'Information',650,500,2);
  	}
  }
...
<h3 align="center">Sistema de Bastanteo - Lista de Facultades Limitadas
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_facult_list.jsp,ECU0000">
</h3>
<hr size="4">
...
%> 
  ...
  <TABLE class="tbenter" width="60%" align=center>
    <TR> 
      <TD class=TDBKG width="33%"> 
        <div align="center"><a href="javascript:goAction('N')">Crar</a> 
        </div>
      </TD>
      <TD class=TDBKG width="33%"> 
  ...
  <TABLE class="tbenter" width=100% height=40%>
      ...
      <TD> 
        <div align="center"> 
          <p>
            <b>No existen registros de facultades. Haga click en la opcion "Nuevo" para crear un registro. </b>
          </p>          
        </div>
      </TD>
     </TR>
  	 ...
  	 <TABLE id="dataTable" width="100%">
     	...
     	<%
                ...
                while (mtListFac.getNextRow()) {
                   datapro.eibs.beans.ECU000007Message msgMTFac = (datapro.eibs.beans.ECU000007Message) mtListFac.getRecord();
     	%>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMTFac.getE07CULFAN())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMTFac.getE07CULAMT())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMTFac.getE07CULAC1(),msgMTFac.getE07CULAC2(),msgMTFac.getE07CULAC3())  + " - " + msgMTFac.getE07CULACT()%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMTFac.getE07CULACU())%></TD>
		</TR>    		
    	<%             
    		chk = "";     
      	}
