...
<h3 align="center">Detalle de Polizas de Seguro<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="collateral_none_acc_poliza_detail.jsp,ERA0100"></h3>
<hr size="4">
