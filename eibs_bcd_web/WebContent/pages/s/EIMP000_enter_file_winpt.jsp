...
<body>
 ...
 <h3 align="center">Importar Interfaz (WINPT)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="enter_file_winpt.jsp, EIMP000"></h3>
<hr size="4">
 <FORM METHOD="POST" action="<%=request.getContextPath()%>/servlet/datapro.eibs.misc.JSEIMP000" ENCTYPE="multipart/form-data">	
