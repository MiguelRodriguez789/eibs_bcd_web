...
<H3 align="center">Informaci&oacute;n para Sobregiros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_overdraft_opc.jsp, EDD0000"></H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0000" >
  <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="2006">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E03ACMCUN" size="10" maxlength="9" readonly value="<%= rtOverdraft.getE03ACMCUN().trim()%>">
              </div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E03ACMACC" readonly size="13" maxlength="12" value="<%= rtOverdraft.getE03ACMACC().trim()%>">
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="30%"> 
              <select name="E03ACMODF">
				...
				||rtOverdraft.getE03ACMODF().equals("4"))) out.print("selected"); %>></option>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%"> 
              <input type="text" name="E03ACMOL1" maxlength="13" size="15" value="<%= rtOverdraft.getE03ACMOL1().trim()%>" onKeypress="enterDecimal()">
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="30%" height="23">
              <input type="text" name="E03ACMOI1" size="10" maxlength="9" value="<%= rtOverdraft.getE03ACMOI1().trim()%>" onKeypress="enterSignDecimal()">
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" height="19"> 
              <input type="text" name="E03ACMOL2" maxlength="13" size="15" value="<%= rtOverdraft.getE03ACMOL2().trim()%>" onKeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" height="19"> 
            ...
            <td nowrap width="30%" height="19"> 
               <input type="text" name="E03ACMOI2" size="10" maxlength="9" value="<%= rtOverdraft.getE03ACMOI2().trim()%>" onKeypress="enterSignDecimal()">
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" height="19"> 
              ...
              <input type="text" name="E03ACMRBR" size="4" maxlength="4" value="<%= rtOverdraft.getE03ACMRBR().trim()%>">
              <a href="javascript:GetBranch('E03ACMRBR','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a> 
              <input type="text" name="E03ACMRCY" size="3" maxlength="3" value="<%= rtOverdraft.getE03ACMRCY().trim()%>">
              <a href="javascript:GetCurrency('E03ACMRCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a> 
              <input type="text" name="E03ACMRGL" size="17" maxlength="16" value="<%= rtOverdraft.getE03ACMRGL().trim()%>">
              <a href="javascript:GetLedger('E03ACMRGL',document.forms[0].E03ACMRBK.value,document.forms[0].E03ACMRCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" height="19"> 
            ...
            <td nowrap width="30%" height="19"> 
              <input type="text" name="E03ACMRAC" size="13" maxlength="12" value="<%= rtOverdraft.getE03ACMRAC().trim()%>">
              <a href="javascript:GetAccount('E03ACMRAC','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0"  ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" height="19"> 
            ...
            <td nowrap width="30%" height="19"> 
              <input type="text" name="E03LNSPRD" size="5" maxlength="4" value="<%= rtOverdraft.getE03LNSPRD().trim()%>">
              <a href="javascript:GetProduct('E03LNSPRD','10','')"><img src="<%=request.getContextPath()%>/images/1b.gif" align="bottom" border="0"></a> 
            </td>
          </tr>
        </table>
      </td>
