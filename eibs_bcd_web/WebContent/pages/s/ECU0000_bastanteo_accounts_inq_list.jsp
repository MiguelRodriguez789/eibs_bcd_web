...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_accounts_inq_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE03CRLAC1(),msgMT.getE03CRLAC2(),msgMT.getE03CRLAC3())  + " - " + msgMT.getE03CRLACT()%></TD>
