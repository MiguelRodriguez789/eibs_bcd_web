...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chb_list.jsp,ECH0306">
</h3>
<hr size="4">
...
%> 
 ...
 <TR> 
     ...
     %> 
            <TR> 
              <TD ALIGN=CENTER NOWRAP> 
                ...
                <% if (msgCHKB.getE02TIPPER().equals("1")) out.print("Moral");
                   else if (msgCHKB.getE02TIPPER().equals("2")) out.print("Física");
                   else if (msgCHKB.getE02TIPPER().equals("3")) out.print("NO APLICA");%><BR>
                <%=msgCHKB.getE02USERID()%><BR>
                <%=Util.formatCustomDate( currUser.getE01DTF(), msgCHKB.getE02FECDTM(),msgCHKB.getE02FECDTD(),msgCHKB.getE02FECDTY())%>                
                ">
              </TD>
   ...
   <TD nowrap ALIGN="RIGHT" valign="top">
     ...
     <Table id="tbAddInfo" >
      <tr id="trclear" >
         <TD  ALIGN="RIGHT"  align="center" nowrap ><b>Comentario : <br>Moneda : <br>Tipo Chequera : <br>Tipo Persona : <br>Operador : <br>Fecha : </b></TD>
