...
<h3 align="center">Referencias Comerciales <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_both_com_ref, ESD0080" ></h3>
<hr size="4">
      ...
      <td nowrap >
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA1" maxlength="60" size="65" value="<%= comRef.getField("E" + name + "4MA1").getString().trim()%>" readonly>
            </td>
          </tr>
        ...
        <%--
         <tr> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA2" maxlength="35" size="36" value="<%= comRef.getField("E" + name + "4MA2").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr id="trdark"> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA3" maxlength="35" size="36" value="<%= comRef.getField("E" + name + "4MA3").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA4" maxlength="35" size="36" value="<%= comRef.getField("E" + name + "4MA4").getString().trim()%>" readonly>
            </td>
          </tr>
		  <%if(currUser.getE01INT().equals("18")){%> 
            <tr id="trdark"> 
              <td nowrap width="42%"> 
                <div align="right">C&oacute;digo de Ciudad :</div>
              </td>
              <td nowrap width="58%"> 
                <input type="text" readonly name="E<%= name %>4TID" maxlength="15" size="16" value="<%= comRef.getField("E" + name + "4ZPC").getString().trim()%>">
            ...
            <tr> 
              ...
              <td nowrap width="58%"> 
                <input type="text" readonly name="E<%= name %>4HPN" maxlength="11" size="12" value="<%= comRef.getField("E" + name + "4HPN").getString().trim()%>">
         ...
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4CTY" maxlength="30" size="31" value="<%= comRef.getField("E" + name + "4CTY").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4STE" maxlength="4" size="5" value="<%= comRef.getField("E" + name + "4STE").getString().trim()%>" readonly>
            </td>
          </tr>
        <%}%>
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4CTR" maxlength="20" size="21" value="<%= comRef.getField("E" + name + "4CTR").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4POB" maxlength="10" size="11" value="<%= comRef.getField("E" + name + "4POB").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr id="trdark"> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4ZPC" maxlength="15" size="16" value="<%= comRef.getField("E" + name + "4ZPC").getString().trim()%>" readonly>
            </td>
          </tr>
          --%>
          
		<%	if( comRef.getH04SCR().equals("07")){%> 	
		 <tr>
		 	<td colspan="2">
		...
		<%} else if( comRef.getH04SCR().equals("03")) {%> 
		...
		<%} else if( comRef.getH04SCR().equals("18")){%> 	
		...
		<%} %>   
         ...
         <tr> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4HPN" maxlength="15" size="16" value="<%= comRef.getField("E" + name + "4HPN").getString().trim()%>" readonly>
            </td>
          </tr>
