...
<h3 align="center">Consulta de Producto de Control de Proyectos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="products_inq_proy.jsp, ESD0711"></h3>
<hr size="4">
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td width="70%"> 
              <input type="text" readonly name="E19MERCAD" size="28" maxlength="25" value="<%= pryProdInq.getE19MERCAD().trim()%>">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="50%"> 
              <input type="text" readonly name="E19GLMDSC" size="45" maxlength="45" value="<%= pryProdInq.getE19GLMDSC().trim()%>">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="55%"> 
              <input type="text" readonly name="E19APCDOC" size="3" maxlength="2" value="<%= pryProdInq.getE19APCDOC().trim()%>">
            </td>
          </tr>
        </table>
      </td>
