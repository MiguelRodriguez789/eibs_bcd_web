...
<h3 align="center">Otorgamiento de Ampliación Sobre Proyecto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_maint_sch.jsp, EPC0065"></h3>
<hr size="4">
    ...
    <tr > 
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" id="INFOCHG">
          ...
          <tr id="trdark"> 
            <td width="30%"> 
              <div align="right">Otorgar Ampliación :</div>
            </td>
            <td width="70%">
