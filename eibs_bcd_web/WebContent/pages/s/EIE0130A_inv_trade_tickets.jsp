...
%> 
<div align="center"> 
  <h3>Consulta de Orden de Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_trade_tickets.jsp,EIE0130A"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap > 
			  ...
			  <% if (invTrade.getF01ORDNUM().equals("Y")) out.print("class=\"txtchanged\""); %> >
            </td>
            <td nowrap colspan="3" >
            ...
            <td nowrap >
			  ...
			  <input type="text" readonly  name="E01ORDSTS" size="35" maxlength="25" 
				<% if (invTrade.getF01ORDSTS().equals("Y")) out.print("class=\"txtchanged\""); %>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="5" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDCUN().equals("Y")) out.print("class=\"txtchanged\""); %>>
                <input type="text" readonly  name="E01ORDCTN" size="35" maxlength="35" value="<%= invTrade.getE01ORDCTN().trim()%>" 
				<% if (invTrade.getF01ORDCTN().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap colspan="5" > 
			  ...
			  <% if (invTrade.getF01ORDPRF().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="5" > 
              <input type="text" readonly  name="E01ORDHCY2" size="3" maxlength="3" value="<%= invTrade.getE01ORDHCY()%>"
               <% if (invTrade.getF01ORDHCY().equals("Y")) out.print("class=\"txtchanged\""); %> >
              <input type="text" readonly  name="E01ORDHAC3" size="12" maxlength="9" value="<%= invTrade.getE01ORDHAC()%>"
                <% if (invTrade.getF01ORDHAC().equals("Y")) out.print("class=\"txtchanged\""); %>
				>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="108%" colspan="3" > 
              <input type="text" readonly  name="E01MEMBAL" size="17" maxlength="16" value="<%= invTrade.getE01MEMBAL()%>"
				<% if (invTrade.getF01MEMBAL().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
            <td nowrap width="14%" > 
            ...
            <td nowrap width="33%" > 
              <input type="text" readonly  name="E01CNVBAL" size="17" maxlength="16" value="<%= invTrade.getE01CNVBAL()%>"
				<% if (invTrade.getF01CNVBAL().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="5" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDCDE().equals("Y")) out.print("class=\"txtchanged\""); %>>
                <input type="text" readonly  name="E01ORDPNM" size="35" maxlength="30" value="<%= invTrade.getE01ORDPNM()%>"
				<% if (invTrade.getF01ORDPNM().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trdark"> 
            <td nowrap > 
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDPBK().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="5" > 
              <input type="text" readonly  name="E01ORDEXR" size="11" maxlength="11" value="<%= invTrade.getE01ORDEXR()%>"
				<% if (invTrade.getF01ORDEXR().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
        </table>
      </td>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
			...
			<input type="text" readonly  name="E01ORDPTY" size="35" maxlength="25" 
				<% if (invTrade.getF01ORDPTY().equals("Y")) out.print("class=\"txtchanged\""); %>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <input type="text" readonly  name="E01ORDIIC" size="9" maxlength="9" value="<%= invTrade.getE01ORDIIC()%>" 
				<% if (invTrade.getF01ORDIIC().equals("Y")) out.print("class=\"txtchanged\""); %>>
              <input type="text" readonly  name="E01ORDICN" size="35" maxlength="30" value="<%= invTrade.getE01ORDICN()%>"
			  <% if (invTrade.getF01ORDICN().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap width="36%" > 
			 ...
			 <% if (invTrade.getF01ORDSCY().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
            <td nowrap width="14%" > 
            ...
            <td nowrap width="33%" > 
			  ...
			  <% if (invTrade.getF01ORDSYM().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap width="36%" > 
              <input type="text" readonly  name="E01ORDLP1" size="3" maxlength="2" value="<%= invTrade.getE01ORDLP1()%>"
			    <% if (invTrade.getF01ORDLP1().equals("Y")) out.print("class=\"txtchanged\""); %>>
              <input type="text" readonly  name="E01ORDLP2" size="3" maxlength="2" value="<%= invTrade.getE01ORDLP2()%>"
				 <% if (invTrade.getF01ORDLP2().equals("Y")) out.print("class=\"txtchanged\""); %>>
              <input type="text" readonly  name="E01ORDLP3" size="5" maxlength="4" value="<%= invTrade.getE01ORDLP3()%>"
				 <% if (invTrade.getF01ORDLP3().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
            <td nowrap width="14%" > 
            ...
            <td nowrap width="33%" > 
              <input type="text" readonly  name="E01ORDISI" size="16" maxlength="12" value="<%= invTrade.getE01ORDISI()%>"
				 <% if (invTrade.getF01ORDISI().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap width="36%" >
			 <input type="text" readonly  name="E01ORDATY" size="35" maxlength="25" 
				<% if (invTrade.getF01ORDATY().equals("Y")) out.print("class=\"txtchanged\""); %>
            ...
            <td nowrap width="33%" > 
              <input type="text" readonly  name="E01ORDCSP" size="16" maxlength="12" value="<%= invTrade.getE01ORDCSP()%>"
				<% if (invTrade.getF01ORDCSP().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
        </table>
      </td>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="71%" > 
			  ...
			  <% if (invTrade.getF01ORDMIP().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="29%" > 
            ...
            <td nowrap width="71%"> 
			  ...
			  <% if (invTrade.getF01ORDMXP().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="29%"> 
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDTRN().equals("Y")) out.print("class=\"txtchanged\""); %>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="36%" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDIN1().equals("Y")) out.print("class=\"txtchanged\""); %>>
                <input type="text" readonly  name="E01ORDIN2" size="3" maxlength="2" value="<%= invTrade.getE01ORDIN2()%>"
				<% if (invTrade.getF01ORDIN2().equals("Y")) out.print("class=\"txtchanged\""); %>>
                <input type="text" readonly  name="E01ORDIN3" size="5" maxlength="4" value="<%= invTrade.getE01ORDIN3()%>"
				<% if (invTrade.getF01ORDIN3().equals("Y")) out.print("class=\"txtchanged\""); %>>
            ...
            <td nowrap width="33%" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDCNF().equals("Y")) out.print("class=\"txtchanged\""); %>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
			  ...
			  <% if (invTrade.getF01ORDST1().equals("Y")) out.print("class=\"txtchanged\""); %> >
              <input type="text" readonly  name="E01ORDST2" size="3" maxlength="2" value="<%= invTrade.getE01ORDST2()%>"
			  <% if (invTrade.getF01ORDST2().equals("Y")) out.print("class=\"txtchanged\""); %>>
              <input type="text" readonly  name="E01ORDST3" size="5" maxlength="4" value="<%= invTrade.getE01ORDST3()%>"
			  <% if (invTrade.getF01ORDST3().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDVNO().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDQTY().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDPRB().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDPRC().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="36%" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDIAM().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" > 
			  ...
			  <% if (invTrade.getF01ORDIAL().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
            <td nowrap width="14%" > 
            ...
            <td nowrap width="33%" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDDYS().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="36%" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDOCV().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap width="14%" > 
            ...
            <td nowrap width="33%" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDOCT().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="36%" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDTGV().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap width="14%" > 
              <div align="right"></div>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDTBK().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
			  ...
			  <% if (invTrade.getF01ORDTVL().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap colspan="4" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <input type="text" readonly name="E01FUTBAL" size="17" maxlength="15" value="<%= invTrade.getE01FUTBAL()%>" 
				<% if (invTrade.getF01FUTBAL().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="3" > 
              <input type="text" readonly name="E01CNVFUB" size="17" maxlength="15" value="<%= invTrade.getE01CNVFUB()%>" 
				<% if (invTrade.getF01CNVFUB().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
        </table>
      </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="80%" > 
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDBRK().equals("Y")) out.print("class=\"txtchanged\""); %>>
                <input type="text" readonly  name="E01ORDBKN" size="35" maxlength="30" value="<%= invTrade.getE01ORDBKN()%>"
				<% if (invTrade.getF01ORDBKN().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="80%" > 
              ...
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDCUC().equals("Y")) out.print("class=\"txtchanged\""); %>>
                <input type="text" readonly  name="E01ORDCCN" size="35" maxlength="30" value="<%= invTrade.getE01ORDCCN()%>"
				<% if (invTrade.getF01ORDCCN().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
        </table>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDHBK().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap> 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDHBR" size="4" maxlength="4"
                <% if (invTrade.getF01ORDHBR().equals("Y")) out.print("class=\"txtchanged\""); %>
            ...
            <td nowrap > 
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDHGL().equals("Y")) out.print("class=\"txtchanged\""); %> >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
            ...
            <td nowrap > 
              <div align="center">
				...
				<% if (invTrade.getF01ORDHCC().equals("Y")) out.print("class=\"txtchanged\""); %>
				readonly>
              </div>
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              ...
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDIPT().equals("Y")) out.print("class=\"txtchanged\""); %>
            ...
            <td nowrap > 
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDIBK().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap> 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDIBR" size="4" maxlength="4"
                <% if (invTrade.getF01ORDIBR().equals("Y")) out.print("class=\"txtchanged\""); %>
            ...
            <td nowrap > 
              <div align="center"> 
                ...
                <% if (invTrade.getF01ORDICY().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDIGL" size="17" maxlength="16" value="<%= invTrade.getE01ORDIGL()%>" 
				<% if (invTrade.getF01ORDIGL().equals("Y")) out.print("class=\"txtchanged\""); %> >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDIAC" size="13" maxlength="12" value="<%= invTrade.getE01ORDIAC()%>"
                <% if (invTrade.getF01ORDIAC().equals("Y")) out.print("class=\"txtchanged\""); %> >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01ORDHCC2" size="9" maxlength="8" value="<%= invTrade.getE01ORDICC()%>"
				<% if (invTrade.getF01ORDICC().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDCPT().equals("Y")) out.print("class=\"txtchanged\""); %>
            ...
            <td nowrap > 
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDCBK().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDCBR" size="4" maxlength="4"
                 <% if (invTrade.getF01ORDCBR().equals("Y")) out.print("class=\"txtchanged\""); %>
            ...
            <td nowrap > 
              <div align="center"> 
                ...
                <% if (invTrade.getF01ORDCCY().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDCGL" size="17" maxlength="16" value="<%= invTrade.getE01ORDCGL()%>" 
				<% if (invTrade.getF01ORDCGL().equals("Y")) out.print("class=\"txtchanged\""); %> >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDCAC" size="13" maxlength="12" value="<%= invTrade.getE01ORDCAC()%>"
                <% if (invTrade.getF01ORDCAC().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01ORDHCC3" size="9" maxlength="8" value="<%= invTrade.getE01ORDCCC()%>"
				readonly <% if (invTrade.getF01ORDCCC().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDDPT().equals("Y")) out.print("class=\"txtchanged\""); %>
            ...
            <td nowrap > 
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDDBK().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDDBR" size="4" maxlength="4" value="<%= invTrade.getE01ORDDBR()%>"
                <% if (invTrade.getF01ORDDBR().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDDCY" size="3" maxlength="3" value="<%= invTrade.getE01ORDDCY()%>"
                <% if (invTrade.getF01ORDDCY().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDDGL" size="17" maxlength="16" value="<%= invTrade.getE01ORDDGL()%>"
				<% if (invTrade.getF01ORDDGL().equals("Y")) out.print("class=\"txtchanged\""); %>  >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDDAC" size="13" maxlength="12" value="<%= invTrade.getE01ORDDAC()%>"
                <% if (invTrade.getF01ORDDAC().equals("Y")) out.print("class=\"txtchanged\""); %> >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01ORDHCC4" size="9" maxlength="8" value="<%= invTrade.getE01ORDDCC()%>"
				readonly <% if (invTrade.getF01ORDDCC().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="center"> 
				<input type="text" readonly  name="E01ORDDPT" size="35" maxlength="25" 
				<% if (invTrade.getF01ORDBPT().equals("Y")) out.print("class=\"txtchanged\""); %>
            ...
            <td nowrap > 
              <div align="center"> 
				...
				<% if (invTrade.getF01ORDBBK().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDBBR" size="4" maxlength="4" value="<%= invTrade.getE01ORDBBR()%>"
                <% if (invTrade.getF01ORDBBR().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDBCY" size="3" maxlength="3" value="<%= invTrade.getE01ORDBCY()%>"
                <% if (invTrade.getF01ORDBCY().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDBGL" size="17" maxlength="16" value="<%= invTrade.getE01ORDBGL()%>"
				<% if (invTrade.getF01ORDBGL().equals("Y")) out.print("class=\"txtchanged\""); %>  >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDBAC" size="13" maxlength="12" value="<%= invTrade.getE01ORDBAC()%>"
                <% if (invTrade.getF01ORDBAC().equals("Y")) out.print("class=\"txtchanged\""); %> >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01ORDHCC5" size="9" maxlength="8" value="<%= invTrade.getE01ORDBCC()%>"
				readonly <% if (invTrade.getF01ORDBCC().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
			...
			<input type="text" readonly  name="E01ORDBVI" size="35" maxlength="25" 
				<% if (invTrade.getF01ORDBVI().equals("Y")) out.print("class=\"txtchanged\""); %>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              ...
              <div align="left"> 
				...
				<% if (invTrade.getF01ORDMXC().equals("Y")) out.print("class=\"txtchanged\""); %>>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
