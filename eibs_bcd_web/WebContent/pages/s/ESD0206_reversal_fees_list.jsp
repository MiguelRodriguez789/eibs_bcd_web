...
%> 
<h3 align="center">Reintegro/Reversión de Comisiones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="reversal_fees.jsp , ESD0206"></h3>
<hr size="4">
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      <td class=TDBKG width="33%"> 
        <div align="center"><a href="javascript:goAction(2)"><b>Reintegrar</b></a></div>
      </td>
      <td class=TDBKG width="33%"> 
        <div align="center"><a href="javascript:goAction(3)"><b>Reversar</b></a></div>
      </td>
      <td class=TDBKG width="33%"> 
        <div align="center"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Salir</b></a></div>
      </td>
		...
		<%
			...
			String chk = "";
       		while (holduncoll.getNextRow()) {
				...
				ESD020601Message msgList= (ESD020601Message) holduncoll.getRecord();
