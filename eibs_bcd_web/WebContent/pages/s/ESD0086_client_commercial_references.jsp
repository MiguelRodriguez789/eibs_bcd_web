...
<H3 align="center">Referencias Comerciales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_commercial_references.jsp, ESD0086"></H3>
<hr size="4">
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap width="35%" align="left">
              <input type="text" name="E01RMK" size="50" maxlength="200" value="<%= ESD0086Record.getE01RMK().trim()%>" <%=read%>>
              <%=mandatory %>
            </td>
            <td nowrap width="15%" align="right">Referencia / Cuenta : </td>
            <td nowrap width="35%" align="left">
            	<input type="text" name="E01REF" size="30" maxlength="25" value="<%= ESD0086Record.getE01REF().trim()%>" <%=read%>>
            </td>
         </tr> 
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="15%" align="right">Antiguedad en Meses :</td>
            <td nowrap width="35%" align="left">
            	<eibsinput:text name="ESD0086Record" property="E01CON" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_INTEGER %>" size="4" maxlength="3" required="true" readonly="<%=isReadOnly %>"/>
            </td>
            <td nowrap width="15%" align="right">Monto o Cupo : </td>
            <td nowrap width="35%" align="left">
         ...
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap width="35%" align="left">
            	<eibsinput:cnofc name="ESD0086Record" property="E01UC8" value="<%=ESD0086Record.getE01UC8()%>"  maxlength="4" required="false" flag="D1" fn_code="E01UC8" fn_description="D01UC8" readonly="<%=isReadOnly %>"/>
            	<eibsinput:text property="D01UC8" name="ESD0086Record" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME%>" readonly="true"/>
            </td>
            <td nowrap width="15%" align="right">Frecuencia de Pago : </td>
            <td nowrap width="35%" align="left">
            	<eibsinput:cnofc name="ESD0086Record" property="E01UC9" value="<%=ESD0086Record.getE01UC9()%>"  maxlength="4" required="false" flag="D5" fn_code="E01UC9" fn_description="D01UC9" readonly="<%=isReadOnly %>"/>
            	<eibsinput:text property="D01UC9" name="ESD0086Record" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME%>" readonly="true"/>
            </td>
         </tr> 
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="15%" align="right">Relación / Vinculo : </td>
            <td nowrap width="35%" align="left">
		        <% if (isReadOnly) {%> 
            		<input type="text" name="E01UC6" size="5" value="<%= ESD0086Record.getE01UC6().trim()%>" readonly> 
               		<%= ESD0086Record.getD01UC6().trim()%>
        	   	<% } else { %>
            		<eibsinput:cnofc name="ESD0086Record" property="E01UC6" required="true" flag="9W" fn_code="E01UC6" fn_description="D01UC6"/>
               		<eibsinput:text property="D01UC6" name="ESD0086Record" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME%>" readonly="true"/>
            	<% } %>
            </td>
