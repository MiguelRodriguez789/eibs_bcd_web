...
<h3 align="center">Consulta de Producto de Cartas de Cr&eacute;dito
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="products_inq_ln.jsp, ESD0711" width="32" height="32"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly name="E04DESCRI" size="50" maxlength="45" value="<%= lcProdInq.getE04DESCRI().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              <input type="text" readonly name="E04MERCAD" size="27" maxlength="25" value="<%= lcProdInq.getE04MERCAD().trim()%>">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="50%"> 
              <input type="text" readonly name="E04GLMDSC" size="45" maxlength="45" value="<%= lcProdInq.getE04GLMDSC().trim()%>">
            </td>
          </tr>
        </table>
      </td>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="55%"> 
              ...
              <a href="javascript:showLCServCharge('<%= lcProdInq.getE04APCBNK().trim()%>','<%= lcProdInq.getE04APCTYP().trim()%>','<%= lcProdInq.getE04APCTLN().trim()%>');"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="45%"> 
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E04APCAMO" size="45" maxlength="45"  
          ...
          <tr id="trdark"> 
            ...
            <td width="55%"> 
              <input type="text" readonly name="E04APCDOC" size="3" maxlength="2" value="<%= lcProdInq.getE04APCDOC().trim()%>">
            </td>
          </tr>
        </table>
      </td>
