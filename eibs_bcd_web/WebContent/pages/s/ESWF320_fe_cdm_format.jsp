...
%>
<h3 align="center">MT 320 Mensaje de Confirmaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_cdm_format.jsp,ESWF320"> 
</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSESWF0130M" >
  ...
  <h4>Sequence D : Instrucciones de Pago por el Monto Pagadero por la Entidad 
    B </h4>
  <table  class="tableinfo">
    <tr > 
      <td nowrap> 
