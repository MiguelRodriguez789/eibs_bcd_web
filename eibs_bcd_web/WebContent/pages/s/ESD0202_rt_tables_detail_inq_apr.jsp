...
<h3 align="center">Comisiones-Consulta Definición de Cargos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ESD0202_rt_tables_detail_inq_apr, ESD0202" ></h3>
<hr size="4">
...
<% if (!charges.getE01DDCFRQ().equals("X")){ %>  
      ...
      <td nowrap> 
        <table cellspacing="0" id="datosAddicionalTable" cellpadding="2" width="100%" border="0" align="left" >
 	    ...
 	    <tr > 
          ...
          <tr id="ESCALA_ROW" style="display : none;"> 
            <td nowrap width="22%"> 
            ...
            <td nowrap width="29%">               <div align="right"> </div>
            </td>
            <td nowrap width="31%" > 
              <div align="right"> </div>
            </td>
      ...
      <td nowrap> 
        <table id="datosAddicionalTable" cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
		  ...
		  <tr >          
            ...
            <td nowrap width="31%" > 
	              <select name="E01DDCCTY" disabled="disabled">
	                <option value=" " <%if (!charges.getE01DDCCTY().equals("C") && !charges.getE01DDCCTY().equals("F") && !charges.getE01DDCCTY().equals("I") ) { out.print("selected"); }%>></option>
	                <option value="C" <%if (charges.getE01DDCCTY().equals("C")) { out.print("selected"); }%>>Comisi&oacute;n</option>
	                <option value="F" <%if (charges.getE01DDCCTY().equals("F")) { out.print("selected"); }%>>omisi&oacute;n FNG</option>
	                <option value="M" <%if (charges.getE01DDCCTY().equals("M")) { out.print("selected"); }%>>omisi&oacute;n MiPYME</option>
	                <option value="I" <%if (charges.getE01DDCCTY().equals("I")) { out.print("selected"); }%>>Impuesto</option>
	              </select>            
            </td>
          </tr>
          ...
          <tr > 
            ...
            <td nowrap width="18%" > 
                <select name="H01FLGWK1" disabled>
  ...
  <p>
  <div align="center"> 
    <input id="EIBSBTN" type=submit name="Submit" value="Regresar" onClick="javascript:CheckAcc(10)">
  </div>
</form>
</body>
<script type="text/javascript">
