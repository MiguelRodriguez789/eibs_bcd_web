...
%>
  <h3 align="center">Resumen de Cuentas por Número de Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rp_sum_for_cust.jsp, ECIF0100P" width="35" height="35"></h3>
  <hr size="4">
  <p>&nbsp;</p>
