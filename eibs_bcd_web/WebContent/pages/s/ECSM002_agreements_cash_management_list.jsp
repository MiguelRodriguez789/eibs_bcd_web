...
function setKey(bnk,num,cun) {

	getElement("E02AGRBNK").value = bnk;
	getElement("E02AGRNUM").value = num;
	getElement("E02AGRCUN").value = cun;
}
...
<h3 align="center">Convenios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="agreements_cash_management_list.jsp, ECSM002"></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cashmg.JSECSM002">
  ...
  <INPUT TYPE=HIDDEN NAME="CURRROWS" VALUE="0">
   <INPUT TYPE=HIDDEN NAME="E02AGRBNK" VALUE=" ">
  <INPUT TYPE=HIDDEN NAME="E02AGRNUM" VALUE=" ">
  <INPUT TYPE=HIDDEN NAME="E02AGRCUN" VALUE="0">
	...
	<TR id=trdark>
        ...
        <%
          ...
          while (msgList.getNextRow()) {
            ECSM00202Message msgRcd = (ECSM00202Message) msgList.getRecord();
		%>              
    <TR id=trclear>
    
		<td NOWRAP align="center" width="5%"> 
            <INPUT type="radio" name="ROW" value="<%= msgList.getCurrentRow() %>" onClick="setKey('<%=msgRcd.getE02AGRBNK()%>','<%= msgRcd.getE02AGRNUM() %>','<%= msgRcd.getE02AGRCUN() %>')">
		</td>
		<td NOWRAP align="center" width="5%"><%= msgRcd.getE02AGRBNK()%></td>
		<td NOWRAP align="left" width="10%" ><%= msgRcd.getE02AGRNUM()%></td>
		<td NOWRAP align="left" width="30%" ><%= msgRcd.getE02AGRDSC()%></td>
		<td NOWRAP align="left" width="10%" ><%= msgRcd.getE02AGRCUN()%></td>
		<td NOWRAP align="left" width="30%" ><%= msgRcd.getD02AGRCUN()%></td>
	</TR>
       <% 
       	 i++; 
        } 
