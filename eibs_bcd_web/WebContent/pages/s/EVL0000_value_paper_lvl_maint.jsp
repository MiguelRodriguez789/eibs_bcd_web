...
<H3 align="center">Mantenimiento de Niveles Papel Valor<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_lvl_maint,EVL0000"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
        ...
        <tr id=trclear>
          ...
          <td nowrap>
             <input type="text" name="E01LVLMED" value ="<%= msgMT.getE01LVLMED() %>" onkeypress="enterInteger(event)">             
          </td>
        </tr>
        <tr id=trdark>
          <td nowrap>
