...
%>
<div align="center"> 
  <h3>Aprobación de Cotizaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_quote_basic.jsp,EIE0060"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" > 
              ...
              <input type="text" readonly  name="E01QUOTE3" size="5" maxlength="4" value="<%= invInst.getE01QUOTE3()%>">
            </td>
            <td nowrap width="14%" > 
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td nowrap width="17%" > 
              <div align="right">Precio BID antes de Cierre :</div>
            </td>
            <td nowrap width="36%" > 
              <div align="left"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="17%" > 
              <div align="right">Precio MID antes de Cierre :</div>
            </td>
            <td nowrap width="36%" > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="17%" > 
              <div align="right">Ultimo Precio Negociado :</div>
            </td>
            <td nowrap width="36%" > 
              <div align="left"> 
