...
Detalle<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="Card_Info.jsp, ECD0009"></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECD0009" >
  ...
  <INPUT TYPE=HIDDEN NAME="E01BNK" VALUE="01">
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" border="0" width="100%">
		  ...
		  <tr id="trdark">
            ...
            <td>
                <input type="text"  name="E01TPLGL0" value="<%= ecd0009.getE01TPLGL0().trim()%>" size="17" maxlength="16" >
                 <a href="javascript:GetLedger('E01TPLGL0',document.forms[0].E01BNK.value,'','')"> 
