...
<h3 align="center">Compraventa Moneda Extranjera<BR>Liquidacion de Compra de Cheques de Remesa y Cobranza<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_maint, EPR0370"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap width="60%"> 
	        <input type="text" name="E01REQBNK" id="E01REQBNK" readonly size="3" maxlength="2" value="<%= msgInst.getE01REQBNK() %>">
	      </td>
     	</tr>
     	<tr id=trclear> 
	      <td nowrap> 
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQCD1" readonly size="3" maxlength="2" value="<%= msgInst.getE01REQCD1() %>" >
                <input type="text" name="E01REQCD2" readonly size="3" maxlength="2" value="<%= msgInst.getE01REQCD2() %>" >
                <input type="text" name="E01REQCD3" readonly size="5" maxlength="4" value="<%= msgInst.getE01REQCD3() %>" >
				<input type="text" name="E01REQCRT" readonly size="28" maxlength="26" value="<%= msgInst.getE01REQCRT() %>" > 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		<tr>
			...
			<td nowrap width="60%">
				<input type="text" name="E01REQEXR" id="E01REQEXR" size="15" maxlength="11" value="<%= msgInst.getE01REQEXR() %>"
				onchange="checkFieldChange('<%=msgInst.getE01REQEXR()%>',document.getElementById('E01REQEXR').value)" onkeypress="enterDecimal()">
  ...
  <TR><TD>
   <table id="headTable" width="100%">
    ...
    <tr id="trclear" align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR1" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR1() %>"
		     ...
		     class="context-menu-help" onmousedown="init(branchHelp,this.name,document.getElementById('E01REQBNK').value,'','','','')">
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
		     ...
		     class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.getElementById('E01REQBNK').value,'','','','')">
          </div>
       </td>
       <td nowrap > 
          <div align="center"> 
		     ...
		     class="context-menu-help" onmousedown="init(lnreferHelp,this.name,document.getElementById('E01REQBNK').value,'',document.forms[0].E01REQCUS.value,'','RT')">
          </div>
       </td>
       <td nowrap > 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR2" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR2() %>"
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR3" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR3() %>"
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR4" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR4() %>"
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR5" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR5() %>"
