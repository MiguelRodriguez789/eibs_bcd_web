...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" alt="ELC0560_lc_nego_com_readonly_hist.jsp" name="EIBS_GIF" align="left"></h3>
<hr size="4">
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
         ...
         <tr id="trclear">
           ...
           <td nowrap  height="24" align="center" width="61">
			<input name="E01DEBBR2" type="text" onKeyPress="enterInteger(event)" value="<%=msg01.getE01DEBBR2()%>" size="6" maxlength="3" readonly="readonly" oncontextmenu="showPopUp(branchHelp,this.name,document.forms[0].E01DEBBK2.value,'','','','')"></td>
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <tr id="trclear">
    ...
    <td nowrap  height="24" align="center" width="61">
		<input name="E01CRPBRN" type="text" onKeyPress="enterInteger(event)" value="<%=msg01.getE01CRPBRN()%>" size="6" maxlength="3" readonly="readonly" oncontextmenu="showPopUp(branchHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')"></td>
    <td nowrap align="center"  height="24" width="47">
...
<tr id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	...
	<TR id="<%= (i++ %2 == 0 ? "trclear" : "trdark") %>">
	    ...
	    <TD align="center"><INPUT type="text" name="E01ALDCOM" value="<%=msg01.getE01ALDCOM()%>" readonly></TD>
