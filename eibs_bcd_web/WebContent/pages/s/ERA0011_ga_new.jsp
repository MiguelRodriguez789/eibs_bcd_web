...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_new.jsp,ERA0011"></h3> 
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3"> 
              ...
              / 
              <input type="text" name="E01ROCBRN" size="5" maxlength="4" value="<%= gaMant.getE01ROCBRN().trim()%>" >
              <a href="javascript:GetBranch('E01ROCBRN',document.forms[0].E01ROCBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
              / 
              <input type="text" name="E01ROCCCY" size="4" maxlength="3" value="<%= gaMant.getE01ROCCCY().trim()%>" >
              <a href="javascript:GetCurrency('E01ROCCCY',document.forms[0].E01ROCBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a>
            </td>
          ...
          <tr id="trclear">
           <td nowrap > 
            ...
            <td nowrap colspan="3"> 
              ...
              <a href="javascript:GetLedger('E01ROCGLN',document.forms[0].E01ROCBNK.value,document.forms[0].E01ROCCCY.value,'91')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap> 
            ...
            <td nowrap colspan=3>
              ...
              <A href="javascript:GetCustomerDescId('E01ROCOWN','E01CUSNAM','')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></A>
             </td>            
          </tr>
          <tr id="trclear"> 
            <TD>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap >
              <INPUT type="text" name="E01ROCAM1" size="17" maxlength="17" value="<%= gaMant.getE01ROCAM1().trim()%>" onkeypress="enterSignDecimal(event, 2)">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
            ...
            <td nowrap>
            	...
            	<a href="javascript:GetCodeCNOFC('E01ROCUC2','2J')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"  ></a> 
            </td>
            <td nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap <% if (!gaMant.getE01ROCTYP().equals("04")) out.print("colspan=3"); %>>
              ...
              <a href="javascript:GetCodeCNOFC('E01ROCUC1','2I')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"  ></a> 
            </td>
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">          
            ...
            <td nowrap ><INPUT type="text" name="E01ROCUC" size="6" maxlength="4" value="<%= gaMant.getE01ROCUC3().trim()%>"><A href="javascript:GetCodeCNOFC('E01ROCUC3','2N')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></A></td>
          </tr>         
        </table>
      </td>
    </tr>
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">          
          ...
          <tr id="trdark"> 
            ...
            <td nowrap >
             ...
             <A href="javascript:GetCodeCNOFC('E01ROCUC3','2N')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></A>
            </td>
            <td nowrap> 
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">          
            ...
            <td nowrap >
              <INPUT type="text" name="E01ROCUC" size=3 maxlength=2 value="<%= 1 %>">
              <INPUT type="text" name="E01ROCUC" size=3 maxlength=2 value="<%= 1 %>">
              <INPUT type="text" name="E01ROCUC" size=5 maxlength=4 value="<%= 1 %>">            
            </td>
            <td nowrap> 
        ...
        <% if (!gaMant.getE01ROCTYP().equals("05")) { %>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap >               
              <INPUT type="text" name="E01RCRF6" size="5" maxlength="4" value="<%= gaMant.getE01RCRF6A().trim()%>"> 
            </td>
            <td nowrap > 
            ...
            <td nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E01ROCUC7','2K')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"  ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">          
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan=2>
             ...
             <a href="javascript:GetCodeCNOFC('E01ROCCRR','2M')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"  ></a>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan=2>
             <input type="text" name="E01ROCICY" size="4" maxlength="3" value="<%= gaMant.getE01ROCICY().trim()%>" >
                <a href="javascript:GetCurrency('E01ROCICY',document.forms[0].E01ROCBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a> 
            </td>
            <td nowrap >
              <div align="right">Valor :</div>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan=2>
             <INPUT type="text" name="E01ROCMD1" size=3 maxlength=2 value="<%= gaMant.getE01ROCMD1()%>">
             <INPUT type="text" name="E01ROCMD2" size=3 maxlength=2 value="<%= gaMant.getE01ROCMD2()%>">
             <INPUT type="text" name="E01ROCMD3" size=5 maxlength=4 value="<%= gaMant.getE01ROCMD3()%>">
            </td>
            <td nowrap> 
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">          
          ...
          <tr id="trclear"> 
            ...
            <td nowrap >
			  <eibsinput:date name="gaMant" fn_month="E01ROCAPM" fn_day="E01ROCAPD" fn_year="E01ROCAPY" readonly="FALSE" required="FALSE"/>
            </td>
            <td nowrap >
              <div align="right">Fecha Vto. :</div>
            </td>
            <td nowrap >
			  <eibsinput:date name="gaMant" fn_month="E01ROCMTM" fn_day="E01ROCMTD" fn_year="E01ROCMTY" readonly="FALSE" required="FALSE"/>
            </td>
          </tr>
   		</table>
      </td>
