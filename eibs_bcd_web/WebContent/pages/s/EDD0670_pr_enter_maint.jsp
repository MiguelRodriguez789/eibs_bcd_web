...
<h3 align="center">Mantenimiento de Ordenes de Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pr_enter_maint.jsp,EDD0670"></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.transfer.JSEDD0670">
  ...
  <table class="tableinfo">
    ...
    <tr id="trclear"> 
      ...
      <td nowrap align="center" width="60%"> 
        <div align="left"> 
          ...
          <a href="javascript:GetCurrency('E01CCY','')"> <img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" width="18" height="22"> 
          </a> </div>
      </td>
    </tr>
    <tr id="trdark"> 
    ...
    <tr id="trclear"> 
      ...
      <td nowrap align="center" width="60%"> 
        <div align="left"> 
          ...
          <a href="javascript:GetAccount('E01ACCNUM','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a></div>
      </td>
    </tr>
    <tr id="trdark"> 
      <td nowrap align="center" width="40%"> 
    ...
    <tr id="trdark"> 
      ...
      <td nowrap align="center" width="60%"> 
        <div align="left"> 
          <input type="text" name="E01REFNUM" size="6" maxlength="4" onKeyPress="enterInteger(event)" value="<%= prBasic.getE01REFNUM()%>">
        </div>
      </td>
    </tr>
    <tr> 
