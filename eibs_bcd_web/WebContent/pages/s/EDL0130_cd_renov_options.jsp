...
<h3 align="center">Instrucciones de Renovaci&oacute;n de Certificados de Dep&oacute;sito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_renov_options,EDL0130"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="16%"> 
              <div align="left"><b>
                <input type="text" name="E08DEAPRO" size="5" maxlength="4" readonly value="<%= userPO.getProdCode().trim()%>">
                </b> </div>
            </td>
          </tr>
        </table>
        ...
        <table cellpadding=2 cellspacing=0 align=center width=100% >
         ...
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td height="32" colspan="2" > Inter&eacute;s ser&aacute; acreditado 
              a la 
              <input type="hidden" name="E08BBBFLG" value="<%= cdRenov.getE08BBBFLG()%>">
              ...
              <input type="text" name="E08BBBACC" size="12" maxlength="12" value="<%= cdRenov.getE08BBBACC().trim()%>" onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E08BBBACC',document.forms[0].E08DEABNK.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td height="44" colspan="2" > Inter&eacute;s ser&aacute; acreditado 
              ...
              <input type="text" name="E08CCCGLN" size="18" maxlength="18" value="<%= cdRenov.getE08CCCGLN().trim()%>" onKeypress="enterInteger(event)">
              <a href="javascript:GetLedger('E08CCCGLN',document.forms[0].E08DEABNK.value,document.forms[0].E08DEACCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
              ,emitiendo un 
              <input type="hidden" name="E08CCCFLV" value="<%= cdRenov.getE08CCCFLV()%>">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td height="46" colspan="2" > Al vencimiento cancelar el Dep&oacute;sito 
              ...
              <input type="text" name="E08DDDGLN" size="16" maxlength="16" value="<%= cdRenov.getE08DDDGLN().trim()%>" onKeypress="enterInteger(event)">
              <a href="javascript:GetLedger('E08DDDGLN',document.forms[0].E08DEABNK.value,document.forms[0].E08DEACCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
              ,emitiendo un 
              <input type="hidden" name="E08DDDFLV" value="<%= cdRenov.getE08DDDFLV()%>">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td height="36" colspan="2" >Al vencimiento cancelar el Dep&oacute;sito 
              ...
              <input type="text" name="E08EEEACC" size="12" maxlength="12" value="<%= cdRenov.getE08EEEACC().trim()%>" onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E08EEEACC',document.forms[0].E08DEABNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>(Corriente, 
              Ahorro, etc.) . </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td width=56></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" > Al vencimiento renovar el Dep&oacute;sito y los 
              ...
              <input type="text" name="E08FFFACC" size="12" maxlength="12" value="<%= cdRenov.getE08FFFACC().trim()%>" onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E08FFFACC',document.forms[0].E08DEABNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td height="19" colspan="2" >Al vencimiento renovar el Dep&oacute;sito 
              ...
              <input type="text" name="E08GGGACC" size="12" maxlength="12" value="<%= cdRenov.getE08GGGACC().trim()%>" onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E08GGGACC',document.forms[0].E08DEABNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a> 
              (Corriente, Ahorro, etc.) . </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td width=56></td>
            ...
            <td colspan="2" > 
              <p>Inter&eacute;s ser&aacute; pagado cada 
				...
				cdRenov.getE08HHHODA().equals("Y")))out.print("selected"); %>> 
                  ...
                  <option value="M" <% if (cdRenov.getE08HHHODA().equals("M")){out.print("selected");} %>>De Cada Mes</option>
                  <option value="Y" <% if (cdRenov.getE08HHHODA().equals("Y")){out.print("selected");} %>>A&ntilde;os</option>
                </select>
                a una 
                <input type="hidden" name="E08HHHFLG" value="<%= cdRenov.getE08HHHFLG()%>">
			  ...
			  <%if (cdRenov.getE08HHHFLG().equals("2")) out.print("checked");%>>
                Certificado, que tendr&aacute;n como n&uacute;mero 
                <input type="text" name="E08HHHACC" size="12" maxlength="12" value="<%= cdRenov.getE08HHHACC().trim()%>" onKeypress="enterInteger(event)">
                <a href="javascript:GetAccount('E08HHHACC',document.forms[0].E08DEABNK.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
                . El Principal ser&aacute; prorrogado por el mismo per&iacute;odo 
                de tiempo.</p>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" > Inter&eacute;s ser&aacute; pagado cada 
              ...
              <select name="E08IIIODA">
                ...
                <option value="D" <% if (cdRenov.getE08IIIODA().equals("D")){out.print("selected");} %>>Dias</option>
                <option value="M" <% if (cdRenov.getE08IIIODA().equals("M")){out.print("selected");} %>>De Cada Mes</option>
                <option value="Y" <% if (cdRenov.getE08IIIODA().equals("Y")){out.print("selected");} %>>A&ntilde;os</option>
              </select>
              a la Cuenta Contable n&uacute;mero 
              <input type="text" name="E08IIIGLN" size="16" maxlength="16" value="<%= cdRenov.getE08IIIGLN().trim()%>" onKeypress="enterInteger(event)">
              <a href="javascript:GetLedger('E08IIIGLN',document.forms[0].E08DEABNK.value,document.forms[0].E08DEACCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
              ,emitiendo un 
         ...
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" > Inter&eacute;s y Principal ser&aacute;n pagados 
              ...
              <input type="text" name="E08JJJACC" size="12" maxlength="12" value="<%= cdRenov.getE08JJJACC().trim()%>" onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E08JJJACC',document.forms[0].E08DEABNK.value,'CD','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" > Inter&eacute;s ser&aacute; pagado 
              <input type="hidden" name="E08KKKFL1" value="<%= cdRenov.getE08KKKFL1()%>">
              ...
              <select name="E08KKKODA">
                ...
                <option value="M" <% if (cdRenov.getE08KKKODA().equals("M")){out.print("selected");} %>>De Cada Mes</option>
              ...
              Certificado, que tendr&aacute;n como n&uacute;mero 
              <input type="text" name="E08KKKACC" size="12" maxlength="12" value="<%= cdRenov.getE08KKKACC().trim()%>" onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E08KKKACC',document.forms[0].E08DEABNK.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
              .</td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td width=56></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" >Inter&eacute;s y Principal ser&aacute;n pagados basados 
              en un Plan de Pagos definido previamente.
				<a href="javascript:document.forms[0].typeS.click();showCDPayMaint()"><img src="<%=request.getContextPath()%>/images/eibs_deducciones.gif" title="Plan de Pagos" align="middle" border="0" ></a>
            </td>
          </tr>
           <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td width=56></td>
