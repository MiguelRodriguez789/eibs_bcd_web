...
%>
<h3 align="center"> SWIFT - Confirmaci&oacute;n Formatos Libres <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="swift_free_format_new_confirm.jsp, ESWF000"> 
</h3>
<hr size="4">
