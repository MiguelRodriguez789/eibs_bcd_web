...
<h3 align="center">Instrucciones de Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pr_maint.jsp,EPR0000"></h3>
<hr size="4">
                          ...
                          <table width="94%" border="0">
                            <tr> 
                              <td width="53%"> 
                                <div align=center>
                                No. Cliente : 
                                <input type="text" readonly  name="E11PYC" size="9" maxlength="9" value="<%= pymInst.getE11PYC()%>" onkeypress="enterInteger(event)">
                                </div>
                              </td>
                            </tr>
                            <tr> 
                          ...
                          <table width="94%" border="0">
                            <tr> 
                              <td width="53%"> 
                                <div align=center>
                                No. Cliente : 
                                <input type="text" readonly  name="E11RCC" size="9" maxlength="9" value="<%= pymInst.getE11RCC()%>" onkeypress="enterInteger(event)">
                                </div>
                              </td>
                            </tr>
                            <tr> 
