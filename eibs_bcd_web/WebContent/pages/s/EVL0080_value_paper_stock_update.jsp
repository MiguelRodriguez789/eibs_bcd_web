...
<HEAD>
<TITLE>
Actualizacion de Stock de Papel Valor de Oficinas
</TITLE>
...
<SCRIPT language="javascript">
  ...
  function goAction() {
    	...
    	page = "<%=request.getContextPath()%>/pages/s/EVL0080_value_paper_stock_update_detail.jsp?ROW=" + row;
...
<h3 align="center">Actualizacion Stock de Papel Valor de Oficinas
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_stock_update.jsp,EVL0080">
</h3>
<hr size="4">
