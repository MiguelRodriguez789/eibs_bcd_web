...
%> 
<h3 align="center">Cambio de PIN<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ECC010001_change_pin.jsp"></h3>
<hr size="4">
<%--
...
function leerPIN(){
	...
	document.forms[0].E01CCRPIO.value.trim() != ""
	document.forms[0].E01CCRPIN.value.trim() != ""
	...
	if( openPINPAD() && activeDevice() ){
		...
		if( document.forms[0].E01CCRPIO.value.trim() != "" ){
			readPIN() ;
		
			if( document.forms[0].E01CCRPIN.value.trim() != "" ){
