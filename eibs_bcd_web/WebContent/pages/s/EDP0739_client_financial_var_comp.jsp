      ...
      <TABLE  class="tableinfo">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="12%"> 
				...
				<INPUT type="text" name="E01IFMFY1" size="5" readonly value="<%=Edp073901.getE01IFMFY1().trim()%>">/
            	<INPUT type="text" name="E01IFMFM1" size="3" readonly value="<%=Edp073901.getE01IFMFM1().trim()%>">
            	<INPUT type="text" name="E01DPBCR1" size="1" readonly value="<%=Edp073901.getE01DPBCR1().trim()%>">
            	</div>
            </th>
            <th align=CENTER nowrap width="12%"> 
            	<div align="center">Periodo<BR>
				<INPUT type="text" name="E01IFMFY2" size="5" readonly value="<%=Edp073901.getE01IFMFY2().trim()%>">/
            	<INPUT type="text" name="E01IFMFM2" size="3" readonly value="<%=Edp073901.getE01IFMFM2().trim()%>">
            	<INPUT type="text" name="E01DPBCR2" size="1" readonly value="<%=Edp073901.getE01DPBCR2().trim()%>">
            	</div>
            	</th>
             <th align=CENTER nowrap width="12%"> 
            	<div align="center">Periodo<BR>
            	<INPUT type="text" name="E01IFMFEY" size="5" readonly value="<%=Edp073901.getE01IFMFEY().trim()%>">/
            	<INPUT type="text" name="E01IFMFEM" size="3" readonly value="<%=Edp073901.getE01IFMFEM().trim()%>">
            	<INPUT type="text" name="E01DPBCR3" size="1" readonly value="<%=Edp073901.getE01DPBCR3().trim()%>"></div>
            </th>
             <th align=CENTER nowrap width="12%"> 
            	<div align="center">Variación<BR>Absoluta
            	</div>
            </th>
