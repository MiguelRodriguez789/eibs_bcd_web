...
<h3 align="center">Transacciones de ACH<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="ach_transactions_list.jsp, EACH130"></h3>
<hr size="4">
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    ...
    <TR id=trdark>
		...
		<TD nowrap align="center" width="10%" valign="top">
			<INPUT type="text" name="E01ACTITC_<%= EACH130List.getCurrentRow() %>" value="<%= msgList.getE01ACTITC() %>" size="5" maxlength="4" <%= read %>>
