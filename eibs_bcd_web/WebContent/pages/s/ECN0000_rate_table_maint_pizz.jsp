...
<h3 align="center">Tasas de Pizarra<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rate_table_maint_pizz.jsp,ECN0000"></h3>
<hr size="4">
	    ...
	    <td valign=top>
	    	 <TABLE>	  
	  			...
	  			<tr>
			        ...
			        <td>
			        	<input type="text" name="E03CDRBAS" size="4" maxlength="3" value="<%= tbRate.getE03CDRBAS()%>" <%if (userPO.getPurpose().equals("READONLY")) {%>readonly<%}%>>
			        </td>      
				  	<td nowrap> 
	  			...
	  			<tr>
			        ...
			        <td colspan=3>
			            <p> 
                		<input name="H03FLGWK1" type="radio" name="TYP" value="1" <%if (tbRate.getH03FLGWK1().trim().equals("1")) out.print("checked"); %>>
                		Efectiva 
                		<input name="H03FLGWK1" type="radio" name="TYP" value=" " <%if (!tbRate.getH03FLGWK1().equals("1")) out.print("checked"); %>>
                		Nominal 
                		</p>
				  	</td>      
	  			</tr>
