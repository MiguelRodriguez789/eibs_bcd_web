...
<h3 align="center">Transacciones de Pr&eacute;stamos (F.E.C.I)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_transac.jsp, EDL0150"></h3>
<hr size="4">
        ...
        <TABLE cellspacing="2" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <TD nowrap align="center"> 
              <INPUT class="txtright" type="text" readonly name="E03DEAPRI" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE03DEAPRI())%>" onkeypress="enterDecimal()">
            </TD>
            <TD nowrap align="center"> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <TD nowrap align="center"> 
              <INPUT class="txtright" type="text" readonly name="E03DEAINT" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE03DEAINT())%>" onkeypress="enterDecimal()">
            </TD>
            <TD nowrap align="center"> 
