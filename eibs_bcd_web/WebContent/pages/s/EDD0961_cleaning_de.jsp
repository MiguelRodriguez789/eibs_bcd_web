...
<html>
<head>
<title>Devolucion enviada - Canje</title>
...
<body>
  ...
  out.println("<SCRIPT> initMenu(); </SCRIPT>");		
	...
	<div align="center">
		<h3>
			Devolucion Enviada<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cleaning_de.jsp,EDD0961">
		</h3>
	</div>
...
<h4>Devoluci&oacute;n Enviada</h4>
	<table class="tableinfo">
		<tr>
			<td nowrap>
				<table cellpadding=2 cellspacing=0 width="100%" border="0">
					...
					<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
						...
						<td nowrap width="25%">
                  			<input type="text" name="E01CANCDE" size="12" maxlength="12" value="<%=msgRcd.getE01CANCDE()%>" />
                  			<a href="javascript:GetCov('E01CANCDE')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0"  ></a>
						</td>
					</tr>
					<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
						...
						<td nowrap width="25%"> 
            			  	<div align="left"> 
             				  <eibsinput:date name="msgRcd" fn_year="E01CANDEY" fn_month="E01CANDEM" fn_day="E01CANDED"
								required="true"  /></td>
              				</div>
            			</td>
    	...
    	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
  			<td width="50%">
  				<% if (userPO.getPurpose().equals("NEW") || userPO.getPurpose().equals("MAINTENANCE"))  { %>
  		  			<div align="center"> 
     					<input id="EIBSBTN" type="button" name="Submit" value="Enviar" onClick="goAction(18);">
     	  			</div>	
     	  		<%}%>
  			</td>
  			<td width="50%">
