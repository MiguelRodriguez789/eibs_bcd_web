      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="35%"> 
			  <input type="checkbox" disabled="disabled" name="E03COSRE1" value="Y" <%if (cnvObj.getE03COSRE1().equals("Y")){out.print(" checked");}; %>/>Dicom &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" disabled="disabled" name="E03COSRE4" value="Y"<%if (cnvObj.getE03COSRE4().equals("Y")){out.print(" checked");}; %>/>Documento de Designación Rep. Leg.<br>
          ...
          <tr id="trclear"> 
            ...
            <td width="35%"> 
			  <input type="checkbox" disabled="disabled" name="E03COSBL1" value="Y" <%if (cnvObj.getE03COSBL1().equals("Y")){out.print(" checked");}; %>/>Balance General&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" disabled="disabled" name="E03COSBL2" value="Y" <%if (cnvObj.getE03COSBL2().equals("Y")){out.print(" checked");}; %>/>Flujo de Caja<br>
  			  <input type="checkbox" disabled="disabled" name="E03COSBL3" value="Y" <%if (cnvObj.getE03COSBL3().equals("Y")){out.print(" checked");}; %>/>Declaración de Impuestos &nbsp;&nbsp;<input type="checkbox" disabled="disabled" name="E03COSBL4" value="Y" <%if (cnvObj.getE03COSBL4().equals("Y")){out.print(" checked");}; %>/>Declaración IVA<br>
  			  <input type="checkbox" disabled="disabled" name="E03COSBL5" value="Y" <%if (cnvObj.getE03COSBL5().equals("Y")){out.print(" checked");}; %>/>Despidos Ultimos 2 años<br>
            </td>
            <td width="15%" > 
            </td>
            <td width="35%" > 
