...
<jsp:useBean id= "idxFnl" class= "datapro.eibs.beans.EDP009001Message"  scope="session" />
...
function ShowFormula() 
{
  	...
  	page= '${pageContext.request.contextPath}/pages/s/STATIC_client_financial_idx_for.jsp';
...
<h3 align="center">Indices Financieros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_financial_idx.jsp,EDP0030"></h3>
<hr size="4">
  ...
  <TD NOWRAP >
   <TABLE id="headTable" width="100%" cellpading=0 cellspacing=0>
    ...
    <tr id="trdark"> 
      ...
      <td nowrap >
       <INPUT type="text" name="E01IFDFEY" size="5" readonly value="<%=userPO.getHeader6()%>">/
