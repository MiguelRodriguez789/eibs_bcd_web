...
<H3 align="center">Mantenimiento de Cuentas de Ahorro<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sv_enter_maint,EDD0000"></H3>
  ...
  <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
    ...
    <tr> 
      ...
      <td nowrap width="50%"> 
        ...
        <a href="javascript:GetAccount('E01ACMACC','','04','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
      </td>
    </tr>
  </table>
  <br>
