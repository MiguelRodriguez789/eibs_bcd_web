...
%> 
<h3 align="center">Detalle de Documentos</h3>
<hr size="4">
...
<TABLE cellpadding="2" cellspacing="0" width="100%" border="0" class="tableinfo">
 <tr id="trdark">
  ...
  <TD nowrap width="20%"> 
  <INPUT type="text" name="E03DLDIDA" size="28" maxlength="25" value="<%= dftAcceptor.getE03DLDIDA() %>" readonly>
  </TD>
  <TD nowrap width="16%">
...
<TABLE class="tbenter" width="100%" border="0">
    <TR>
  		...
  		<a href="javascript:goAction('N')" id="linkAdd" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','<%=request.getContextPath()%>/images/s/anadir_over.gif',1)"><img name="Image1" title="Añadir" border="0" src="<%=request.getContextPath()%>/images/s/anadir.gif" ></a>
      </TD>
            <TD ALIGN=CENTER width="33%" colspan="2">
...
<table id="dataTable" >
	...
	while (lstDocuments.getNextRow()) {
		 ...
		 out.print("<INPUT size=\"5\" maxlength=\"4\" type=\"text\" name=\"E02DLDFV3" + String.valueOf(k).trim() + "\" value=\"" + lstDocuments.getRecord(3).trim() + "\" >");
		 out.print("</TD>");
		 out.print("<TD nowrap>");
		 ...
		 out.print("<a href=\"javascript:GetAccount('E02DLDNDA"+String.valueOf(k).trim()+"','','RT','')\"><img src=\""+request.getContextPath()+"/images/1b.gif\" title=\"Ayuda\" align=\"absbottom\" border=\"0\" ></a>");
		 out.print("</TD>");
