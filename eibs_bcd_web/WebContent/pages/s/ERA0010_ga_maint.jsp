...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_maint.jsp,ERA0010"></h3> 
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="16%" > 
              <div align="left"> 
                <input type="text" name="E01ROCCUN" size="10" maxlength="9" value="<%= gaMant.getE01ROCCUN().trim()%>">
              </div>
            </td>
            <td nowrap width="13%" > 
      ...
      <TD nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="38%" >
              <eibsinput:date name="gaMant" fn_month="E01ROCAPM" fn_day="E01ROCAPD" fn_year="E01ROCAPY" required="TRUE" />
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="23%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="38%" >
              <eibsinput:date name="gaMant" fn_month="E01ROCOPM" fn_day="E01ROCOPD" fn_year="E01ROCOPY" required="TRUE" />
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="23%" > 
            ...
            <td nowrap width="38%" >
              <eibsinput:date name="gaMant" fn_month="E01ROCMTM" fn_day="E01ROCMTD" fn_year="E01ROCMTY" required="TRUE" />
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="23%" > 
            ...
            <td nowrap width="38%" >
              <eibsinput:date name="gaMant" fn_month="E01ROCREM" fn_day="E01ROCRED" fn_year="E01ROCREY" required="TRUE" />
            </td>
          </tr>
        </table>
      </TD>
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="28%" > 
              <eibsinput:date name="gaMant" fn_month="E01ROCEMM" fn_day="E01ROCEMD" fn_year="E01ROCEMY" required="TRUE" />
            </td>
            <td nowrap width="18%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="28%" > 
              <eibsinput:date name="gaMant" fn_month="E01ROCMDM" fn_day="E01ROCMDD" fn_year="E01ROCMDY" required="TRUE" />
            </td>
            <td nowrap width="18%" > 
