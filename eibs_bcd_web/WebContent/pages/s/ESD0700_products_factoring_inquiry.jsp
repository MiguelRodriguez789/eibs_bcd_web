...
<% } else if(userPO.getHeader23().equals("NO_MENU")) { %>
...
function show(obj) {
	if (obj.value == '%' ){
		...
		document.getElementById("datos5").style.display = 'block';
	}
}

function showCred(obj) {
	if (obj.value == 'I' ){
		document.getElementById("creditlinesTable").style.display = 'block';
		...
		document.getElementById("datos9").style.display = 'block';
		document.getElementById("datos10").style.display = 'none';
		document.getElementById("datos11").style.display = 'none';
		document.getElementById("datos12").style.display = 'block';
		document.getElementById("datos13").style.display = 'block';
		
	} else {
		document.getElementById("creditlinesTable").style.display = 'none';
		document.getElementById("datos6").style.display = 'block';
		...
		document.getElementById("datos10").style.display = 'block';
		document.getElementById("datos11").style.display = 'block';
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="products_factoring_inquiry.jsp, ESD0700"></h3>
<hr size="4">
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
				...
				<td width="25%">
 	                <input type="text" name="E01APAD01" size="40" maxlength="35" value="<%= prd.getE01APAD01() %>" readonly>
				</td>
				<td width="25%">
					<div align="right"></div>
				</td>
...
<table class="tableinfo">
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
				...
				<td width="25%">
					<select name="E01APAF11" disabled="disabled">
				...
				<td width="25%">
					<input type="radio" disabled name="E01APAF12" value="Y" <%if (prd.getE01APAF12().equals("Y")) out.print("checked"); %>> Si 
					<input type="radio" disabled name="E01APAF12" value="N" <%if (prd.getE01APAF12().equals("N")) out.print("checked"); %>> No
				</td>
				</tr>
			<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
				<td width="25%">
			...
			<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
			  <td width="25%">
				...
				<td width="25%">
					<input type="text" name="E01APCTAR" size="3" maxlength="2" value="<%= prd.getE01APCTAR()%>" readonly> 
				</td>
				<td width="25%">
	...
	<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
				...
				<td width="25%">
     		     <div align="left">
	 		        <select name="E01APCFL2" disabled>
						<option value=""></option>
				...
				<td width="25%">
					<div align="left">
	 		        <select name="E01APAF09" disabled>
						<option value=""></option>
			...
			<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
				...
				<td width="25%">
     		     <div align="left">
	 		       <input type="radio" disabled name="E01APAF13" value="Y" <%if (prd.getE01APAF13().equals("Y")) out.print("checked"); %>> Si 
				   <input type="radio" disabled name="E01APAF13" value="N" <%if (!prd.getE01APAF13().equals("Y")) out.print("checked"); %>> No
				 </div>	  	
				</td>
				<td width="25%">
				...
				<td width="25%">
					<div align="left">
					 <input type="radio" disabled name="E01APAF14" value="Y" <%if (prd.getE01APAF14().equals("Y")) out.print("checked"); %>> Si 
				   	 <input type="radio" disabled name="E01APAF14" value="N" <%if (!prd.getE01APAF14().equals("Y")) out.print("checked"); %>> No
				 </div>	  	
				</td>
			</tr>
			<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
				...
				<td width="25%">
					<div align="left">
					 <select name="E01APAF15" disabled>
						<option value=""></option>
				...
				<td width="25%">
     		     <div align="left">
	 		       <input type="radio" disabled name="E01APAF07" value="Y" <%if (prd.getE01APAF07().equals("Y")) out.print("checked"); %>> Si 
				   <input type="radio" disabled name="E01APAF07" value="N" <%if (!prd.getE01APAF07().equals("Y")) out.print("checked"); %>> No
				 </div>	  	
				</td>
...
<table class="tableinfo" >
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>" >
				<td nowrap width=25% align="right">
					<div align="right">Permite Extender Plazo con Utilizaciones :</div>
				</td>
				<td nowrap width="25%"  align="left">
				...
				<td nowrap width=25% align="right">
	              <div align="right">D&iacute;as de Mora x Bloqueo : </div>
	            </td>
				<td nowrap width="25%"  align="left">
