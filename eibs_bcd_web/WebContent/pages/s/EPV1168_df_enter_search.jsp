...
<h3 align="center">Destino de Fondos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="df_enter_search.jsp,EPV1168"></h3>
<hr size="4">
...
<table id="TBHELPN" width="100%" border="0" cellspacing="0"
	...
	<tr>
		...
		<td  width="50%">
			<eibsinput:help name="datarec" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CUSTOMER %>" property="E01PDFCUN" 
				fn_param_one="E01PDFCUN" fn_param_two="" fn_param_three="E01PDFCUN"   />
		</td>
	</tr>
	<tr>
		<td align="right" width="50%" nowrap>N&uacute;mero Propuesta :&nbsp;</td>
		<td  width="50%">
 			<eibsinput:help name="datarec" property="E01PDFNUM" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_ACCOUNT %>"fn_param_one="E01PDFNUM" fn_param_two="document.forms[0].E01UBK.value" fn_param_three="RT" required="false" />
		</td>
	</tr>
</table>
