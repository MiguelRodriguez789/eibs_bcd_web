...
<H3 align="center">Transferencia de Carta de Credito <IMG
	...
	name="EIBS_GIF" title="bg_enter_maint,ELC5000"></H3>
...
<table width="100%" border="0" class="tableinfo" cellspacing="1">
	<tr id="trdark">
		...
		<td align="left">
			<eibsinput:date name="lcTran" fn_month="E05LCMIDM" fn_day="E05LCMIDD" fn_year="E05LCMIDY" readonly="true"/>			
		</td>
		<td align="right">Fecha de Expiración:</td>
		<td align="left">
			<eibsinput:date name="lcTran" fn_month="E05LCMEXM" fn_day="E05LCMEXD" fn_year="E05LCMEXY" readonly="true"/>			
		</td>
	</tr>
	<tr>
...
<TABLE class="tableinfo">
	...
	<TR>
		...
		<DIV align="left"><INPUT type="text" readonly="readonly" name="E05LCTBN1" size="45" maxlength="35" value="<%=lcTran.getE05LCTBN1()%>"> 
			<IMG src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" border="0"></DIV>
		</TD>
