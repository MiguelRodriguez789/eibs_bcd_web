...
function setImage() {
  ...
  document.getElementById("tbwait").style.display ="none";
}
</SCRIPT>
</HEAD>
<body bgcolor="#FFFFFF" onLoad="setImage()">

<table border="0" id="tbwait" cellspacing="0" cellpadding="0" style="background-repeat:no-repeat; background-attachement:fixed;" align="center" width="100%" height="100%">
  <tr> 
    <td height="356"> 
