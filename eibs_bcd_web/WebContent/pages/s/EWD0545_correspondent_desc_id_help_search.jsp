...
function enterAction(code,desc,id) {
	...
	if(top.top.opener.fieldDesc.trim() !== ""){form[top.top.opener.fieldDesc].value = desc;}
	if(top.top.opener.fieldId.trim() !== ""){form[top.top.opener.fieldId ].value = id;}
...
function enter(){
    ...
    parent.results.window.location.href="<%=request.getContextPath()%>/pages/s/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0545?NameSearch="
