...
<input type="hidden" id="SCREEN" name="SCREEN" value="200">
	...
	<h3 align="center">Opciones de la Paginas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" id="EIBS_GIF" name="EIBS_GIF" title="eibs_paginas_language.jsp,EUT0115"> </h3> 
