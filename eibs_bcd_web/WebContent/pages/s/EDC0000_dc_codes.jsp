...
<h3 align="center">Cobranza Documentaria C&oacute;digos Especiales
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dc_codes.jsp, EDC0000" width="35" height="35"></h3> 
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0" height="118">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC4','D02UC4','2D')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" border="0" align="middle"></a> 
            </td>
          </tr>
        </table>
      </td>
