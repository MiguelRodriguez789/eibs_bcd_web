...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_accounts_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMTAcc.getE03CRLAC1(),msgMTAcc.getE03CRLAC2(),msgMTAcc.getE03CRLAC3())  + " - " + msgMTAcc.getE03CRLACT()%></TD>
