...
<SCRIPT type="text/javascript">
  ...
  function goAction(opt) {
    ...
    if (opt == "I") { 
    	...
    	page = "<%=request.getContextPath()%>/pages/s/ECU0000_bastanteo_attorney_inq.jsp?ROW=" + row;
...
<h3 align="center">Sistema de Bastanteo - Consulta del Propietario/Apoderado
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_attorney_inq_list.jsp,ECU0000">
</h3>
<hr size="4">
...
%> 
  ...
  <TABLE class="tbenter" width=100% height=40%>
      ...
      <TD> 
        <div align="center"> 
          <p>
            <b>No existen registros de apoderado.</b>
          </p>          
        </div>
      </TD>
     </TR>
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE05CUMMA3())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE05CUMMA1())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE05CUMAC1(),msgMT.getE05CUMAC2(),msgMT.getE05CUMAC3())  + " - " + msgMT.getE05CUMACT()%></TD>
