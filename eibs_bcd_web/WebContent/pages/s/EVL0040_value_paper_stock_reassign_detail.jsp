...
<H3 align="center">Reasignacion de Stock de Papel Valor<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_stock_reassign_detail,EVL0040"></H3>
<hr size="4">
  ...
  <table class="tableinfo">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
        ...
        <tr id=trdark> 
		  <td> 
		     <div align="right">Sucursal Recibe : </div>        
		  </td>
      	  <td nowrap> 
      	    <input type="text" name="E02MOVBRN" size="05" maxlength="04" value="<%= msgMT.getE02MOVBRN() %>">
              			<a href="javascript:GetBranch('E02MOVBRN','')">
              				<img src="${pageContext.request.contextPath}/images/1b.gif" title=". . ." align="bottom" border="0"  ></a>
              			<img src="${pageContext.request.contextPath}/images/Check.gif" title=". . ." align="bottom" border="0" >
      	  </td>     
      	</tr>
      	<tr id=trclear>
          <td nowrap>
