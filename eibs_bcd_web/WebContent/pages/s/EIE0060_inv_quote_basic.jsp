...
%>
<div align="center"> 
  <h3>Cotizaciones <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_quote_basic.jsp,EIE0060"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" > 
              ...
              <input type="text" name="E01QUOTE3" size="5" maxlength="4" value="<%= invInst.getE01QUOTE3()%>">
              <a href="javascript:DatePicker(document.forms[0].E01QUOTE1,document.forms[0].E01QUOTE2,document.forms[0].E01QUOTE3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a> 
