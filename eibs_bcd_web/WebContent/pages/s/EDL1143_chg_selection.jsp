...
<h3 align="center">Reportes Pr&eacute;stamos Preferenciales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chg_selection.jsp,EDL1143"> 
</h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap height="143"> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">
            <td nowrap width="32%"> 
              <div align="right"><b>Tipo de Informaci&oacute;n :</b></div>
            </td>
            <td nowrap width="3%">&nbsp;</td>
            <td nowrap width="23%"> 
              <select name="E01INFTYP">
                <option value="1">Pr&eacute;stamos Preferenciales Nuevos</option>
                <option value="2">Pr&eacute;stamos Preferenciales Modificados</option>
                <option value="3">Cr&eacute;dito Fiscal</option>
              </select>
            </td>
          </tr>
