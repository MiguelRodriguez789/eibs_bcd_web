...
%>
<h3 align="center">MT 340 Mensaje de Confirmaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_fra_format.jsp, ESWF340A"> 
</h3>
<hr size="4">
                ...
                <table cellpadding=2 cellspacing=0 width="100%" border="0">
                  ...
                  <tr id="trclear"> 
                    ...
                    <td nowrap colspan="2" > 
                      <div align="center"></div>
                      <div align="left"> 
                        <select name="E02SWFTOP" disabled>
                  ...
                  <tr id="trdark"> 
                    ...
                    <td nowrap colspan="2" > 
                      <div align="left"></div>
                      <div align="left"><%= swift.getE02SWFCRF()%> </div>
                    </td>
                    <td nowrap width="23%" > 
                      <div align="right"></div>
                    </td>
            ...
            <tr > 
              <td nowrap> 
                <table cellpadding=2 cellspacing=0 width="100%" border="0">
                    ...
                    <td nowrap width="28%" > 
                      <div align="left"><%= Util.formatCustomDate(currUser.getE01DTF(),
                        		swift.getBigDecimalE02SWFTDM().intValue(),
                          		...
                          		swift.getBigDecimalE02SWFTDY().intValue())%></div>
                    </td>
                  </tr>
                  <tr id="trclear"> 
                    <td nowrap width="22%" > 
                    ...
                    <td nowrap width="32%" ><%= Util.fcolorCCY(swift.getE02SWFPRI())%> 
                    </td>
                    <td nowrap width="18%" > 
                      <div align="right">Fecha Efectiva 30 F :</div>
                    </td>
                    <td nowrap width="28%" > 
                      <div align="left"><%= Util.formatCustomDate(currUser.getE01DTF(),
                        		swift.getBigDecimalE02SWFVDM().intValue(),
                          		swift.getBigDecimalE02SWFVDD().intValue(),
                          		swift.getBigDecimalE02SWFVDY().intValue())%></div>
                    </td>
                  </tr>
                  <tr id="trdark"> 
                    <td nowrap width="22%" > 
                    ...
                    <td nowrap width="18%" > 
                      <div align="right">Fecha de Terminaci&oacute;n 30 P :</div>
                    </td>
                    <td nowrap width="28%"> 
                      <div align="left"><%= Util.formatCustomDate(currUser.getE01DTF(),
                  ...
                  <tr id="trclear"> 
                    <td nowrap width="22%" > 
                      <div align="right">Tasa Fija 37 M :</div>
                    </td>
                    <td nowrap width="32%" > 
                    ...
                    <td nowrap width="28%"> 
                      <div align="left"><%= swift.getE02SWFDYS()%> </div>
                    </td>
                  </tr>
                </table>
              </td>
