...
<h3 align="center">Denominaciones de Moneda<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="denominations_list.jsp, ETLR100"></h3>
<hr size="4">
...
%>
  ...
  <TABLE class="tableinfo" id="dataTable">
    <TR id="trdark">
      ...
      <TH ALIGN=CENTER  nowrap width="20%">Paquete</TH>
