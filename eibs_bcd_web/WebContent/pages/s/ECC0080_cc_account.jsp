      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" readonly name="E01CARCUN" size="10" maxlength="9" value="<%= userPO.getCusNum().trim()%>">                
              </div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E01CCAACC" size="13" maxlength="12" value="<%= appList.getRecord(4).trim()%>">
                <a href="javascript:GetAccount('E01CCAACC','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
              </div>
            </td>
            <td nowrap width="16%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" readonly name="E01CTACUN" size="10" maxlength="9" value="<%= appList.getRecord(15).trim()%>">
              </div>
            </td>
            <td nowrap width="16%" > 
              <div align="right"><b>Nombre :</b></div>
