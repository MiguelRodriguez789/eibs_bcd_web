...
<H3 align="center">Seleccion de Ambiente Contable Mes Anterior<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="products,EGL6000"></H3>
<hr size="4">
