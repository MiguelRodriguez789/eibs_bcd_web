...
<h3 align="center">Autorizaciones ACH<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="ach_authorizations_list.jsp, EACH300"></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.ach.JSEACH300">
  ...
  <INPUT TYPE="HIDDEN" id="E01ACACUN" name="E01ACACUN" value="0">
  <INPUT TYPE="HIDDEN" id="E01ACAACC" name="E01ACAACC" value="0">
  <INPUT TYPE="HIDDEN" id="E01ACAOCD" name="E01ACAOCD" value="0">
  <INPUT TYPE="HIDDEN" id="SEARCHCDE" name="SEARCHCDE" value="">
  <INPUT TYPE="HIDDEN" id="SEARCHTYPE" name="SEARCHTYPE" value="A">
<% 
 if (userPO.getPurpose().equals("NEW") || userPO.getPurpose().equals("MAINTENANCE")){
%>
  ...
  <TABLE class="tableinfo" id="dataTable">
    ...
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="10%">
			<INPUT type="text" id="SEARCHCUN" name="SEARCHCUN" size="10" maxlength="9" value="<%= userPO.getCusNum() %>">
		...
		<td NOWRAP align="center" width="10%">
			<INPUT type="text" id="SEARCHACC" name="SEARCHACC" size="13" maxlength="12" value="<%= userPO.getAccNum() %>">
			<IMG src="<%=request.getContextPath()%>/images/ico5.gif" onclick="goSearch('A')" width="15" height="11"
			 ALT="Ordenar y posicionarse en...">
		</td>
		<TD nowrap align="center" width="10%">
			<INPUT type="text" id="SEARCHCOM" name="SEARCHCOM" size="11" maxlength="10" value="<%= userPO.getProdCode() %>">
			<IMG src="<%=request.getContextPath()%>/images/ico5.gif" onclick="goSearch('O')" width="15" height="11"
			 ALT="Ordenar y posicionarse en...">
		</td>
		<TD nowrap align="center" width="35%">
			<INPUT type="text" id="SEARCHNOM" name="SEARCHNOM" size="36" maxlength="35" value="<%= userPO.getHeader10() %>">
        ...
        <%
         ...
         %>              
	<tr id="dataTable<%= EACH300List.getCurrentRow() %>">
		<td NOWRAP align="center" width="5%">
           	<INPUT TYPE="radio" name="ROW"  value="<%= EACH300List.getCurrentRow()%>"  
				onClick="setKey('<%=msgList.getE01ACACUN()%>','<%=msgList.getE01ACAACC()%>','<%=msgList.getE01ACAOCD()%>');highlightRow('dataTable', <%= EACH300List.getCurrentRow() %>)">
		</td>
