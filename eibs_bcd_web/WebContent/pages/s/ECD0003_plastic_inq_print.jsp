...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_inq_print.jsp, ECD0003"> 
</h3>
<hr size="4">
<FORM>
    ...
    <TD NOWRAP valign="top" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE03CDRTIS())%></TD>
		  	<TD NOWRAP ALIGN="CENTER"><%= Util.formatCustomDate( currUser.getE01DTF(),msgPart.getE03CDRMOS(),  msgPart.getE03CDRDAS(),msgPart.getE03CDRYES()) %></TD>
