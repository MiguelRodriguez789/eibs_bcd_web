...
%> 
<h3 align="center">Generación de Documentos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dft_acceptor_docs, EDL0810"> 
</h3>
<hr size="4">
      ...
      <td nowrap>
        <TABLE id="tblAcceptant" cellpadding="2" cellspacing="0" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <TD nowrap colspan="2"> 
              <INPUT size="3" type="text" name="DFTDTMAT1" maxlength="2" >
              <INPUT size="3" type="text" name="DFTDTMAT2" maxlength="2" >
              <INPUT size="5" type="text" name="DFTDTMAT3" maxlength="4" onblur="valida()" >
            </TD>
            <TD nowrap width="13%"></TD>
            <TD nowrap width="56%"></TD>
          </tr>
