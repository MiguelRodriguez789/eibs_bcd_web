...
<BODY>
<h3 align="center">Tablas de Estructuras de Prest&aacute;mos</h3>
<hr size="4">
  ...
  <div id="hiddenDivNew" class="hiddenDiv">
	...
	filter:progid:DXImageTransform.Microsoft.dropshadow(OffX=3, OffY=3, Color='gray', Positive='true');">
      ...
      <tr id="trclear"> 
        ...
        <td align=CENTER width="34%"> 
          <div align="left"> 
            <input type="text" name="DESCRIPTION" size="48" maxlength="45">
          </div>
        </td>
      </tr>
      <tr id="trclear"> 
        ...
        <td align=CENTER width="34%"> 
          <div align="left"> 
            ...
            <a href="javascript:GetProductRates('PRODUCT','10')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
          </div>
        </td>
      </tr>
      <tr id="trclear"> 
        ...
        <td align=CENTER width="34%"> 
          <div align="left"> 
            <input type="text" name="CUSTOMER"  size=12 maxlength="9" 
					  >
            <a href="javascript:GetCustomer('CUSTOMER')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
          </div>
        </td>
      </tr>
      <tr id="trclear"> 
