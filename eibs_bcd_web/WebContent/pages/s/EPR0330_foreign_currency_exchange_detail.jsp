...
<H3 align="center">Consulta de Solicitudes de Compraventa de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0330"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
				...
				<input type="text" name="E01REQRJT" size="8" maxlength="8" value="<%= msgInst.getE01REQRJT() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
		...
		<tr>
			...
			<td nowrap width="60%">
				<input type="text" name="E01REQRJS" size="45" maxlength="40" value="<%= msgInst.getE01REQRJS() %>" readonly> 
			</td>
		</tr>
		<%}%>
     </table>
