...
<h3 align="center">Confirmación de Cambio de Cuenta Contable<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ESD3000_acc_ledger_change_confirmation.jsp"></h3>
<hr size="4">
		...
		<table  class="tbenter" width="100%" border="0" cellspacing=0 cellpadding=2>
			<tr>
		    	...
		    	<td align="left"> 
		            ...
		            <input type="text" name="E01CUSNA1" size="45" readonly value="<%= account.getE01CUSNA1()%>">
		    	</td>
		    </tr>
			<tr>
		    	<td align="right"> 
		...
		<table  class="tbenter" width="100%" height="75%" border="0" cellspacing=0 cellpadding=2>
			<tr>
		    	...
		    	<td align="left"> 
		            ...
		            <input type="text" name="E01OBNKNA" size="45" readonly value="<%= account.getE01OBNKNA()%>">
		        </td>
		    </tr>
		    <tr>
		    	<td align="right"> 
		    	...
		    	<td align="left"> 
					<input type="text" name="E01OLDBRN" size="5" readonly value="<%= account.getE01OLDBRN()%>">
		            <input type="text" name="E01OBRNNA" size="45" readonly value="<%= account.getE01OBRNNA()%>">
		        </td>
		    </tr>
		    <tr>
		    	<td align="right"> 
		    	...
		    	<td align="left"> 
		            ...
		            <input type="text" name="E01OGLNDE" size="45" readonly value="<%= account.getE01OGLNDE()%>">
		        </td>
		    </tr>
			<tr>
		    	<td align="right"> 
		    	...
		    	<td align="left"> 
		            ...
		            <input type="text" name="E01OPRDNA" size="45" readonly value="<%= account.getE01OPRDNA()%>">
		    	</td>
		    </tr>
		</table>
	</td>
		...
		<table  class="tbenter" width="100%" height="75%" border="0" cellspacing=0 cellpadding=2>
		    <tr>
		    	...
		    	<td align="left"> 
		            ...
		            <input type="text" name="E01NBNKNA" size="45" readonly value="<%= account.getE01NBNKNA()%>">
		        </td>
		    </tr>
		    <tr>
		    	<td align="right"> 
		    	...
		    	<td align="left"> 
					<input type="text" name="E01NEWBRN" size="5" readonly value="<%= account.getE01NEWBRN()%>">
		            <input type="text" name="E01NBRNNA" size="45" readonly value="<%= account.getE01NBRNNA()%>">
		        </td>
		    </tr>
		    <tr>
		    	<td align="right"> 
		    	...
		    	<td align="left"> 
		            ...
		            <input type="text" name="E01NGLNDE" size="45" readonly value="<%= account.getE01NGLNDE()%>">
		        </td>
		    </tr>
			<tr>
		    	<td align="right"> 
		    	...
		    	<td align="left"> 
		            ...
		            <input type="text" name="E01NPRDNA" size="45" readonly value="<%= account.getE01NPRDNA()%>">
		    	</td>
		    </tr>
		</table>
	</td>
