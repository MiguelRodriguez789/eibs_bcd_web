...
function enter(code1,name) {
  top.opener.document.forms[0][top.opener.fieldName].value = code1;
  if(isValidObject(top.opener.document.forms[0][top.opener.fieldAux1]))top.opener.document.forms[0][top.opener.fieldAux1].value = name;
   top.close();
 }
