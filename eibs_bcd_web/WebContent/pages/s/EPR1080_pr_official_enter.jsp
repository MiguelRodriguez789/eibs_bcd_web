...
<h3 align="center">Autorización de Oficiales
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pr_official_enter.jsp, EPR1080"></h3>
<hr size="4">
    	...
    	<TD>       
    		<table class="tbenter" width="100%" border="0">
        		...
        		<tr> 
          			...
          			<td NOWRAP width="50%">
            			<div align="left"> 
              				<input type="text" name="E01SELBRN" size=5 maxlength=4 value="">
