...
%> 
<h3 align="center"> Spot Moneda Extranjera (Back Office)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_sf.jsp,EFE0120B"> 
</h3>
<hr size="4">
