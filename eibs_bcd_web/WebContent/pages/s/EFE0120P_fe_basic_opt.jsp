...
%> 
<h3 align="center"> <%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_opt.jsp,EFE120P"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" width="23%"> 
			 ...
			 >
			  ...
			  >
                <a href="javascript:DatePicker(document.forms[0].E01FESVD1,document.forms[0].E01FESVD2,document.forms[0].E01FESVD3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a></div>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="23%" > 
            ...
            <td nowrap colspan="2" width="23%" > 
			  ...
			  >
                <input type="text" name="E01FESMA3" size="5" maxlength="2" value="<%= fex.getE01FESMA3().trim()%>" 
			  >
                <a href="javascript:DatePicker(document.forms[0].E01FESMA1,document.forms[0].E01FESMA2,document.forms[0].E01FESMA3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a> 
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="left"> 
                ...
                <a href="javascript:GetCode('E01FESCOT','STATIC_fe_via.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a></div>
            </td>
            <td nowrap > 
          ...
          <tr id="trdark"> 
          	<% if(fex.getH01FLGWK3().equals("Y")){%>
            	...
            	<td nowrap > 
              		...
              		<a href="javascript:GetClassFex('E01FESCLS','OPT',document.forms[0].E01FESCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            	</td> 
             <%}%>
            <td nowrap  colspan="5" > 
              <div align="right"></div>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap height="35" colspan="4" > 
              <div align="left"> 
                <input type="text" name="E01FESOTS" size="65" maxlength="120" value="<%= fex.getE01FESOTS()%>" 
			  >
