...
<h3 align="center">Abonos Masivos, Proceso Automático - Aceptar<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_enter_sch_acp,EDL1111"></h3>
<hr size="4">

<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL1111">
  <p><INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="900"></p>
  <p>&nbsp;</p>
