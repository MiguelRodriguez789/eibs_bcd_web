...
<H3 align="center">C&oacute;digos de Referencia del Sistema <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnof_dcard_codes_details.jsp, ESD0030"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="23"> 
              <div align="left"> 
                <input type="text" name="E02CNOMXC" size="18" maxlength="17" value="<%= refCodes.getE02CNOMXC().trim()%>" onKeypress="enterDecimal()">
              </div>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="16%" height="19"> 
              <div align="right">Número Máximo Permitido :</div>
            </td>
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E02CNOFRP" size="7" maxlength="6" value="<%= refCodes.getE02CNOFRP().trim()%>" onKeypress="enterInteger">
              </div>
            </td>
          </tr>
        </table>
