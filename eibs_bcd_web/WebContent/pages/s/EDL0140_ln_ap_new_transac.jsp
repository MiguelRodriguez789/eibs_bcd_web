...
<%--<TABLE class="tbenter">
  <TR> 
	...
	<%if(!lnGenTran.getField("E31DLOBN"+idx).getString().trim().equals("")){ %>
        <TR> 
		    ...
		    <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly name="E31DLONC<%= idx %>" size="12" maxlength="11"  value="<%= lnGenTran.getField("E31DLONC"+idx).getString().trim()%>" onKeypress="enterInteger(event)">
              </div>
            </td>
            <td nowrap> 
              <div align="center"> 
            ...
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly name="E31DLOMC<%= idx %>" size="15" maxlength="15"  value="<%= lnGenTran.getField("E31DLOMC"+idx).getString().trim()%>" onKeypress="enterDecimal(event, 2)">
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
  ...
  <SCRIPT type="text/javascript">  	
  	function resizeDocChk() {
       adjustEquTables( getElement('headTableChk'), getElement('dataTableChk'), getElement('dataDiv1Chk'),0, false ) ;
    }
    resizeDocChk();
