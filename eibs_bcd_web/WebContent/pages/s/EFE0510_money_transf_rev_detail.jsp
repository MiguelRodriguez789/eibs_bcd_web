...
<H3 align="center">Reversion de Remesas de Efectivo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transf_rev_detail,EFE0510"></H3>
<hr size="4">
