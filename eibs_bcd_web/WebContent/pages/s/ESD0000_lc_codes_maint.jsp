...
<SCRIPT type="text/javascript">
	...
	builtNewMenu(<%= ( userPO.getPurpose().toUpperCase().equals("MAINTENANCE") ? "lc_maint":"lc_opening" )%>);
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_codes.jsp,ESD0000" width="35" height="35"> 
<hr size="4">
-->
<h3 align="center">C&oacute;digos de Clasificaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_codes.jsp,ESD0000"></h3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0" height="118">
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02OFC','D02OFC','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0"></a> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%" height="37"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02OF2','D02OF2','10')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio"  border="0"  > 
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02INC','D02INC','09')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio"  border="0"  > 
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02BUC','D02BUC','12')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02GEC','D02GEC','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio"  border="0"  > 
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02GRC','D02GRC','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02ORG','D02ORG','18')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02DST','D02DST','38')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
            <%if(!userPO.getType().trim().equals("I")){%>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC1','D02UC1','2A')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0"></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC2','D02UC2','2B')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC3','D02UC3','2C')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC4','D02UC4','2D')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda"  border="0" ></a> 
            </td>
          </tr>
        </table>
      </td>
