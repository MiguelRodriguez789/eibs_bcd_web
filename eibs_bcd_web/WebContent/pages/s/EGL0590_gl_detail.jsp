...
<BODY>
<h3 align="center">Detalle de Cuenta de Tesoreria<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="gl_list.jsp, EGL0590"></h3>
<hr size="4">
    ...
    <tr > 
      <td NOWRAP valign="top" width="100%"> 
		...
		<tr>
			...
			<td nowrap align="CENTER" width="\"><%= msgList.getE02TRATMS() %></td>
			<td nowrap align="CENTER" width="\"><%= msgList.getE02TRABRN() %></td>
			<td nowrap align="CENTER" width="\"><%= msgList.getE02TRAUSO() %></td>
		</tr>
		<%}%>
  		</table>
      </td> 
