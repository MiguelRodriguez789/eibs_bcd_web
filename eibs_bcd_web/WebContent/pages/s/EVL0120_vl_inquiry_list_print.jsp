<html> 
<head>
<title>Impresion Consulta de Documentos Emitidos</title>
...
<form>
<div id="imprime">
  <h3 align="center">Impresion Consulta de Documentos Emitidos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="vl_inquiry_list_print.jsp, EVL0120"> 
  </h3>
	...
	<TR>
		...
		<table id="headTable" width="100%">
			<tr id="trdark">
				...
				<td><input readonly type="text" value="<%=count %>"></td>
				<th>Total Monto :</th>
				<td><input readonly type="text"
					value="<%=Util.formatCCY(originalAmountTotal.toString()) %>">
				</td>
			</tr>
		</table>
		</TD>
