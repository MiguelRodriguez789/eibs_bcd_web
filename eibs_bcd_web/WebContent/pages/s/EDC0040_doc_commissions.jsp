...
<body>
<h3 align="center">Aprobación de Cobranza Documentaria<br>Comisiones y Cargos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="doc_commissions.jsp, EDC0040"></h3>
<hr size="4">
