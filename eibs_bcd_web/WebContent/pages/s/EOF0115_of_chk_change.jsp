...
<h3 align="center">Cambio de Numeraci&oacute;n de Cheques de Gerencia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="of_chk_change.jsp , EOF0115"></h3>
<hr size="4">
<p align="center">&nbsp;</p>
      ...
      <td nowrap> 
        <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr> 
            ...
            <td nowrap width="50%"> 
              <input type="text" name="E01NEWCKN" size="12" maxlength="11" onKeypress="enterInteger(event)">
            </td>
          </tr>
        </table>
      </td>
