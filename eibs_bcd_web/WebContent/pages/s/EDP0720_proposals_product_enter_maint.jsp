...
<h3 align="center">Detalle del Producto
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="proposals_product_enter_maint.jsp,EDP0720"></h3>
			...
			<TR id="trclear">
			   ...
			   <TD width="15%" align="right">
		        ...
		        <td nowrap width=20% align="left"> 
			        ...
			        <a href="javascript:GetProposalsProducts('E01PLTPRO','E01PLTTYP','E01PLTACD','','','T')">
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0" id="opTable">	
			...
			<TR id="trclear">
			   ...
			   <TD width="15%" align="right">
				...
				<TD width="20%" align="left">
				    <INPUT type="text" name="E01PLTRRE" size="13" maxlength="12" onkeypress=enterInteger(event) >   
