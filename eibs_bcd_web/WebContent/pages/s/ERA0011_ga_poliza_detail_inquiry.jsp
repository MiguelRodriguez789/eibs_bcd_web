      ...
      <td nowrap>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan=2> 
			  <eibsinput:date name="gaPoliza" fn_month="E03ROCEMM" fn_day="E03ROCEMD" fn_year="E03ROCEMY" readonly="TRUE" required="FALSE"/>
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan=2> 
			  <eibsinput:date name="collDet" fn_month="E03ROCMDM" fn_day="E03ROCMDD" fn_year="E03ROCMDY" readonly="TRUE" required="FALSE"/>
            </td>
