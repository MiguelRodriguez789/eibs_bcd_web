...
<body >
<h3 align="center">Operaciones del Cliente<br>Modificación de Clave del Sistema IVR<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ivr_pin_change.jsp, ECL0000"> 
</h3>
<hr size="4">
<% 
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trclear"> 
            <td nowrap width="16%" > 
              <div align="right">Número de PIN Actual :</div>
            </td>
            <td nowrap width="16%" > 
              <div align="left"> 
                <input type="text" name="E01CCLPIN" size="3" maxlength="2" value="<%= msgIVR.getE01CCLPIN().trim()%>"> (2 dígitos consecutivos)
			  </div>
            </td>
          </tr>    
          <tr id="trdark"> 
			<TD nowrap width="16%">
				<DIV align="right">Número de PIN Nuevo :</DIV>
			</TD>
			<TD nowrap width="20%">
				<DIV align="left">
