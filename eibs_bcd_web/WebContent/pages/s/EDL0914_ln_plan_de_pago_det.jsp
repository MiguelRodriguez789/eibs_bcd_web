...
<%@ page import="datapro.eibs.master.Util,datapro.eibs.beans.EDL091402Message"%>
...
<form>
  ...
  <h3 align="center">Detalle de la Cuota
  	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_details_de_pago_det.jsp,EDL0914"> 
  </h3>
  <hr size="4">

  <%
			int index = Integer.parseInt(request.getParameter("Row").trim());
			EDL091402Message details = (EDL091402Message)list.get(index);
 %> 
