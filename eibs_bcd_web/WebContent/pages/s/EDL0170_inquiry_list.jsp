...
<html>
<head>
<title>Consulta de documentos papel valor Plazo Fijo</title>
...
function goAction(op) {
	...
	page = '${pageContext.request.contextPath}/pages/s/EDL0170_inquiry_details.jsp?ROW=' + document.forms[0].ROW.value;
...
<BODY>
<h3 align="center">Consulta de documentos papel valor Plazo Fijo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inquiry_list.jsp, EDL0170"></h3>
<hr size="4">
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
	  <td class=TDBKG width="25%"> 
        <div align="center"  style="cursor:hand"><a href="javascript:goAction(4)"><b>Datos Lote</b></a></div>
      </td>      
      <td class=TDBKG width="25%"> 
        <div align="center"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Salir</b></a></div>
      </td>
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%">Sucursal<br>Recepcion</th>
          </tr>
          <%    EDL017001.initRow();
		 ...
		 %>
          <tr> 
            <td NOWRAP  align=CENTER width="5%"> 
              <INPUT TYPE="radio" NAME="CURRCODE" VALUE="<%= EDL017001.getCurrentRow() %>" <% if (EDL017001.getCurrentRow() == row) out.print(chk); %> onClick="showInfo(<%= EDL017001.getCurrentRow() %>)">
            </td>
            ...
            <td NOWRAP  align=CENTER width="10%"><%= msgList.getE01PFDSUC() %></td>
          </tr>
          <%
                }
              %>
