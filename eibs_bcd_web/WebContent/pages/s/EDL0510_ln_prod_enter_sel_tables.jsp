    ...
    <tr > 
      ...
      <td width="51%" nowrap> 
        <input type="text" name="E01DLSTYP"  size=5 maxlength="4" onKeyPress="document.forms[0].SEARCHC.value='I'">
         <a href="javascript:GetProductRates('E01DLSTYP','10')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
      </td>
    </tr>
    <tr > 
      <td width="49%" nowrap> 
      ...
      <td width="51%" nowrap> 
        <input type="text" name="E01DLSCUN"  size=12 maxlength="9" 
					  >
        <a href="javascript:GetCustomer('E01DLSCUN')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
      </td>
    </tr>
  </table>
