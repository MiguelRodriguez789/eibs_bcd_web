...
%> 
<h3 align="center">Codigos Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_codes.jsp,ECC0010" ></h3> 
<hr size="4">
      ...
      <td nowrap > 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02OFC" readonly size="5" maxlength="4" value="<%= lnCodes.getE02OFC().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" readonly name="E02OF2" size="5" maxlength="4" value="<%= lnCodes.getE02OF2().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" readonly name="E02GEC" size="5" maxlength="4" value="<%= lnCodes.getE02GEC().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" readonly name="E02GRC" size="5" maxlength="4" value="<%= lnCodes.getE02GRC().trim()%>" readonly>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" readonly name="E02INC" size="5" maxlength="4" value="<%= lnCodes.getE02INC().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" readonly name="E02BUC" size="5" maxlength="4" value="<%= lnCodes.getE02BUC().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" readonly name="E02UC3" size="5" maxlength="4" value="<%= lnCodes.getE02UC3().trim()%>">
              <input type="text" readonly name="D02UC3" size="40" maxlength="35" value="<%= lnCodes.getD02UC3().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="30%"> 
              <div align="right">Calificacion Cliente:</div>
            </td>
            <td nowrap width="70%"> 
              <input type="text" readonly name="E02UC5" size="5" maxlength="4" value="<%= lnCodes.getE02UC5().trim()%>">
              <input type="text" readonly name="D02UC5" size="40" maxlength="35" value="<%= lnCodes.getD02UC5().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%"> 
              <div align="right">Calificacion de Facilidad:</div>
            </td>
            <td nowrap width="70%"> 
              <input type="text" readonly name="E02UC6" size="5" maxlength="4" value="<%= lnCodes.getE02UC6().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" readonly name="E02UC7" size="5" maxlength="4" value="<%= lnCodes.getE02UC7().trim()%>">
