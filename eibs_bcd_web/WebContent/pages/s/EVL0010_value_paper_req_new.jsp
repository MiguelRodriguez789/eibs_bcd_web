...
<H3 align="center">Creacion de Pedidos Papel Valor<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_req_new,EVL0010"></H3>
<hr size="4">
