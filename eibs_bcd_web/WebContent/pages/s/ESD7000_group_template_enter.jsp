...
<H3 align="center">Perfil de Acceso Grupo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="group_template_enter, ESD7000"></H3>
    ...
    <tr> 
      <td nowrap ALIGN=CENTER> 
        ...
        <INPUT type="text" name="E01BTHKEY" size="16" maxlength="10" >
         <a href="javascript:GetGroupId('E01BTHKEY')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a> 
      </td>
    </tr>       
  </table>
