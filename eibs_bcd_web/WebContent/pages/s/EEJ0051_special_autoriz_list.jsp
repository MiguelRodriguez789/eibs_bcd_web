...
<body>
<h3 align="center">Consulta de Autorizaciones Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="special_autoriz_list.jsp, EEJ0051"></h3>
<hr size="4">
<form name="form1" method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEEJ0051" >
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      ...
      <td class=TDBKG width="20%"> 
        <div align="center"><a href="javascript:goAction('P')"><b>Posicion Cliente</b></a></div>
      </td>
      <td class=TDBKG width="20%"> 
        <div align="center"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Salida</b></a></div>
      </td>
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap>Supervisor<BR>Responsable</th>
