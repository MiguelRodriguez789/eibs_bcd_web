...
%>
<H3 align="center">Nueva Caja de Seguridad<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="safe_deposit_new, ESB0110"></H3>
<hr size="4">
     	...
     	<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
	      <td nowrap width="40%"> 
	        <div align="right">Número : </div>
				...
				<div align="left">
					<input type="text" name="E01SBMCOD" id="E01SBMCOD" size="14" maxlength="12" value="<%= msgPart.getE01SBMCOD() %>" > 
					<a href="javascript:GetAvailableSafeDeposits('E01SBMCOD','E01SBMDSC','E01SBMTYP','D01SBTDSC' ,'E01SBMLOC','D01LOCNME','E01SBMSER', 'E01SBMKNU');"> 
	      ...
	      <td nowrap> 
	        <div align="right">Tipo : </div>
				...
				<div align="left">
					...
					<input type="text" name="D01SBTDSC" id="D01SBTDSC" size="52" maxlength="50" value="<%= msgPart.getD01SBTDSC() %>" > 
					<a href="javascript:GetDepositType('E01SBMTYP','D01SBTDSC')"> 
					<img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0"></a>
					 <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0">
				</div>
				</td>
	        ...
	        <div align="right">Ubicación : </div>
				...
				<div align="left">
					<input type="text" name="E01SBMLOC" id="E01SBMLOC" size="4" maxlength="3" value="<%= msgPart.getE01SBMLOC() %>">
					 <input type="text" name="D01LOCNME" id="D01LOCNME" size="51" maxlength="50" value="<%= msgPart.getD01LOCNME() %>" >
					<A href="javascript:GetLocations('E01SBMLOC','D01LOCNME')"> 
					<IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0"></A> 
					<img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0">
				</div>
				</td>
