      ...
      <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" name="TB_BENEFICIARY_CORP" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
          <tr id="trdark"> 
           ...
           <td width="58%" nowrap> 
             <input type="text" readonly name="E<%= name %>4RCN" maxlength="9" size="10" value="<%= board.getField("E" + name + "4RCN").getString().trim()%>">
           </td>
          </tr>
          <tr id="trclear"> 
            <td width="42%" nowrap> 
            ...
            <td nowrap width="58%"> 
              <input type="text" readonly name="E<%= name %>4MA1" maxlength="60" size="65" value="<%= board.getField("E" + name + "4MA1").getString().trim()%>">
              </td>
          </tr>
...
--%>
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" readonly name="E<%= name %>4CAR" maxlength="45" size="46" value="<%= board.getField("E" + name + "4CAR").getString().trim()%>">
              </td>
          </tr>
          <tr id="trdark"> 
            <td width="42%" nowrap> 
            ...
            <td width="58%" nowrap> 
              <input type="text" readonly name="E<%= name %>4D21" maxlength="2" size="2" value="<%= board.getField("E" + name + "4D21").getString().trim()%>">
              <input type="text" readonly name="E<%= name %>4D22" maxlength="2" size="2" value="<%= board.getField("E" + name + "4D22").getString().trim()%>">
              <input type="text" readonly name="E<%= name %>4D23" maxlength="4" size="4" value="<%= board.getField("E" + name + "4D23").getString().trim()%>">
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="42%" nowrap > 
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" readonly name="D<%= name %>4INC" maxlength="45" size="46" value="<%= board.getField("D" + name + "4INC").getString().trim()%>">
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="42%" nowrap > 
            ...
            <td width="58%" nowrap > 
              <input type="text" readonly  name="E<%= name %>4BMS" size="25" maxlength="30" 
				  value="<% if (board.getField("E" + name + "4BMS").getString().equals("1")) out.print("Casado(a)");
							else if (board.getField("E" + name + "4BMS").getString().equals("2")) out.print("Soltero(a)");
							else if (board.getField("E" + name + "4BMS").getString().equals("3")) out.print("Divorciado(a)");
							else if (board.getField("E" + name + "4BMS").getString().equals("4")) out.print("Viudo(a)");
							else if (board.getField("E" + name + "4BMS").getString().equals("5")) out.print("Otros");
						    else out.print("");%>" 
				>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" readonly  name="E<%= name %>4BSX" size="20" maxlength="25" 
				  value="<% if (board.getField("E" + name + "4BSX").getString().equals("F")) out.print("Femenino");
							else if (board.getField("E" + name + "4BSX").getString().equals("M")) out.print("Masculino");
						    else out.print("");%>" 
				>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" readonly name="E<%= name %>4HPN" maxlength="15" size="16" value="<%= board.getField("E" + name + "4HPN").getString().trim()%>">
              </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" readonly name="E<%= name %>4BNI" maxlength="25" size="26" value="<%= board.getField("E" + name + "4BNI").getString().trim()%>">
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="42%" > 
