...
<BODY onLoad="">
<h3 align="center">Listado de Plantillas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel.jsp,ESWF300"></h3>
<hr size="4">
<% 
    ...
    <TD NOWRAP valign="top" width="100%" >
        <table id="headTable" width="100%" >
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap >Identificaci&oacute;n Swift </th>
            <th align=CENTER nowrap > 
