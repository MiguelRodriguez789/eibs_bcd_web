          ...
          <tr > 
            <td nowrap> 
              <table cellpadding=2 cellspacing=0 width="100%" border="0">
                ...
                <tr id="trclear"> 
                  <td nowrap width="17%" > 
                    <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].INSTCODE.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" title="help" align="bottom" border="0" > 
                  ...
                  <td nowrap > 
                    <div align="left"> 
                      ...
                      <a href="javascript:GetInstrumentParams('INSTCODE','DESCRIPTION','','','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a></div>
                  </td>
                </tr>
                <tr id="trclear"> 
                  <td nowrap width="17%" > 
                  ...
                  <td nowrap width="36%" > 
                    <input type="text" name="CUSTODIAN"  size=4 maxlength="4" 
					>
                    <input type="text" name="DESCR"  size=35 maxlength="35" 
					>
                    <a href="javascript:GetCustodian('CUSTODIAN','DESCR')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a> 
                  </td>
                </tr>
                <tr id="trclear"> 
                  <td nowrap width="17%" > 
                  ...
                  <td nowrap width="36%" > 
                    ...
                    <input type="text" name="CUSTDESC"  size=35 maxlength="35" 
						>
                    <a href="javascript:GetCustomerDescId('CUSTOMER','CUSTDESC','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
                  </td>
                </tr>
                <tr id="trclear"> 
                  <td nowrap width="17%" > 
