...
<body>
<h3 align="center">Aprobacion de Participaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ap_particip_list.jsp, EDL6010"></h3>
<hr size="4">
