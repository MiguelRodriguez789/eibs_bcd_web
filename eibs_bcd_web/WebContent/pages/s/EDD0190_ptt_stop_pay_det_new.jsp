...
<H3 align="center">Generar Protesto Manual de Documentos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ptt_stop_pay_det_new.jsp , EDD0190"> 
</H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap> 
              <div align="left"> 
                <input type="text" name="DHSCHK" size="13" maxlength="11" value="<%= rtStop.getDHSCHK().trim()%>" onKeypress="enterInteger(event)">
              </div>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <SELECT name="DHSORG" <%= rtStop.getDHSORG().trim()%> disabled="disabled">
		  ...
		  <tr id="trclear"> 
            ...
            <td nowrap > 
              <input type="text" name="DHSOBR" size="5" maxlength="4" value="<%= rtStop.getDHSOBR().trim()%>" onKeypress="enterInteger(event)" >
