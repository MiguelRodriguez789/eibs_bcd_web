...
<BODY>
<H3 align="center">Apertura de Carta de Crédito de Importación
<IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="ELC0500_lc_opening_import"></H3>
<HR size="4">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
          ...
          <TR id="">
            ...
            <TD nowrap><SELECT name="E01LCMAF2">
                ...
                <INPUT type="text" name="E01LCMAPA" size="13"
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
          ...
          <TR id="">
            ...
            <TD nowrap><SELECT name="E01LCMAF3">
                ...
                <INPUT type="text" name="E01LCMBAC" size="13" maxlength="12" value="<%=msgLC.getE01LCMBAC()%>">
          ...
          <TR id="">
            ...
            <TD align="left"><INPUT type="text" name="E01LCMBN4" size="48"
					maxlength="35" value="<%=msgLC.getE01LCMBN4().trim()%>">
            </TD>
          </TR>
          <TR id="">
            <TD align="right">Estado: </TD>
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF4">
      ...
      <OPTION value="A" <%if (msgLC.getE01LCMAF4().equals("A")) out.print("selected");%>>Cuenta</OPTION>
        ...
        <INPUT type="text" name="E01LCMABA" size="13" maxlength="12" value="<%=msgLC.getE01LCMABA()%>">
        <A href="javascript: GetCustomerDetailsLC('E01LCMABA','E01LCMAB1','E01LCMAB2','E01LCMAB3','E01LCMAB4','E01LCMAB5','E01LCMAB6','','C')">
		<IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" onClick="javascript: document.forms[0].E01LCMAF4.selectedIndex = 1"  border="0">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB2" size="48" maxlength="45" value="<%=msgLC.getE01LCMAB2().trim()%>">
    </TD>
  </TR>
  <TR id="">
    <TD nowrap></TD>
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB3" size="48" maxlength="45" value="<%=msgLC.getE01LCMAB3().trim()%>">
    </TD>
  </TR>
  <TR id="">
    <TD nowrap></TD>
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB4" size="48" maxlength="35" value="<%=msgLC.getE01LCMAB4().trim()%>">
    </TD>
  </TR>
  <TR id="">
    <TD align="right" valign="bottom" nowrap>Estado: </TD>
    <TD align="left" nowrap>
      <INPUT type="text" name="E01LCMAB5" size="4" maxlength="4" value="<%=msgLC.getE01LCMAB5()%>">
        <A href="javascript:GetCodeCNOFC('E01LCMAB5','27')"> 
  ...
  <TR id="">
        ...
        <TD align="left" nowrap><INPUT name="E01LCMCOR" type="text" id="E01LCMCOR" value="<%=msgLC.getE01LCMCOR()%>" size="12" maxlength="9">
...
<BR>
    <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
          ...
          <TR id="">
            <TD></TD>
            <TD align="left"><INPUT type="text" name="E01LCMCA4" size="48" maxlength="35" value="<%=msgLC.getE01LCMCA4().trim()%>">
            </TD>
          </TR>
          <TR id="">
 ...
 <BR>
  ...
  <TR id="">
    ...
    <TD  align="left" nowrap><INPUT type="text" name="E01LCMRBA" size="12" maxlength="12" value="<%=msgLC.getE01LCMRBA()%>">
		...
		<IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></A> Cliente o <A href="javascript: GetAccByClient('E01LCMRBA','','RT','','E01LCMRB1')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></A> Cuenta </TD>
  </TR>
  <TR id="">
    <TD nowrap="nowrap" align="right">Codigo Swift: </TD>
  ...
  <TR id="">
    <TD></TD>
    <TD align="left"><INPUT type="text" name="E01LCMRB4" size="48" maxlength="35" value="<%=msgLC.getE01LCMRB4().trim()%>"></TD>
  </TR>
  <TR id="">
