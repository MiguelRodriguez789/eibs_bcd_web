...
function goAction(op) {
 ...
 if (op == 1 || op == 2) {
    ...
    if (op == 1)
      page = "${pageContext.request.contextPath}/servlet/datapro.eibs.client.JSERA0010?SCREEN=300";
	else
	  page = "${pageContext.request.contextPath}/servlet/datapro.eibs.client.JSERA0010?SCREEN=500&ROW=" + document.forms[0].ACTROW.value;
...
<h3 align="center"> Lista de Garantías de No-Dep&oacute;sito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_acc_list.jsp,ERA0010"> 
</h3>
<hr size="4">
    ...
    %>              
    			  <TR>
					...
					<TD NOWRAP><%=Util.formatCustomDate(currUser.getE01DTF(),
											...
											msgList.getBigDecimalE04ROCMTY().intValue()) %> </td>
