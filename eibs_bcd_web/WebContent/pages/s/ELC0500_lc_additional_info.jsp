...
<jsp:useBean id="msg07" class="datapro.eibs.beans.ELC050007Message"  scope="session" />
...
<H3 align="center">Datos Adicionales del Crédito
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_additional_info, ELC0500"></H3>
<HR size="4">
        	...
        	<TD nowrap>
            		    ...
            		    <% if (userPO.getID().equals("18") ) { %>
              			<TR id="trdark">
	                		...
	                		<TD nowrap width="20%" align="left">
								<eibsinput:date name="msg07" fn_month="E07LCMD1M" fn_day="E07LCMD1D" fn_year="E07LCMD1Y"/>
	            			</TD>
	              		</TR>
	              		<TR id="trclear">
                			<TD nowrap width="16%"align="right"><B>Fecha de Vencimiento del Pagaré: </B></TD>
	                		<TD nowrap width="20%" align="left">
								<eibsinput:date name="msg07" fn_month="E07LCMD2M" fn_day="E07LCMD2D" fn_year="E07LCMD2Y"/>
	            			</TD>
	              		</TR>
	              		<% } %> 
	              		<TR id="trdark">
	                		...
	                		<TD nowrap width="20%" align="left">
								<eibsinput:date name="msg07" fn_month="E07LCMD3M" fn_day="E07LCMD3D" fn_year="E07LCMD3Y"/>
	            			</TD>
	              		</TR>
	              		<TR id="trclear">
                			<TD nowrap width="16%"align="right"><B>Cargos del Banco Reembolsador: </B></TD>
	                		<TD nowrap width="20%" align="left">
	                	        <SELECT name="E07LCMRCC">
                            		<OPTION value=" "></OPTION>
	            ...
	            --%>    	
			            <TR id="trdark">
                             ...
                             <TD nowrap width="25%"> 
                            	<INPUT type="radio" name="E07LCMHCF" value="Y" <% if(msg07.getE07LCMHCF().equals("Y")) out.print("checked");%>>Si
                            	<INPUT type="radio" name="E07LCMHCF" value="N" <% if(msg07.getE07LCMHCF().equals("N")) out.print("checked");%>>No</TD>
	              		</TR>
	              		<%--
	              		<TR id="trclear">
