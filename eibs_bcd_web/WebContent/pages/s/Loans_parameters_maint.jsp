...
<body>
<h3 align="center"><% if (request.getParameter("OPT").equals("M")) out.print("Mantenimiento"); else out.print("Nueva");%> Tabla de Parametros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="Loans_parameters_maint.jsp"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark">
            ...
            <td nowrap> 
              <INPUT type="text" name="DLSDAB" size="4" maxlength="3" value="<%= lnParam.getDLSDAB()%>" onkeypress="enterInteger(event)">	        
            </td>
            <td nowrap> 
              <div align="right">Tasa Baseo Puntos :</div>
            </td>
            <td nowrap colspan=4> 
              <INPUT type="text" name="DLSRTF" size="10" maxlength="10"	value="<%= lnParam.getDLSRTF()%>" onkeypress="enterInteger(event)">	        
            </td>
            <td nowrap colspan=2> 
              <INPUT type="text" name="DLSRFT" size="2" maxlength="1"	value="<%= lnParam.getDLSRFT()%>" onkeypress="enterInteger(event)">	        
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
            ...
            <td nowrap colspan=4> 
 	        ...
 	        <td nowrap colspan=2> 
              <INPUT type="text" name="DLSMMT" size="2" maxlength="1"	value="<%= lnParam.getDLSMMT()%>" onkeypress="enterInteger(event)">	        
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap>
          ...
          <tr id="trclear">
            ...
            <td nowrap>
  				<input type="text" name="DLSPP1" size="2" maxlength="1" value="<%=lnParam.getDLSPP1()%>" onkeypress="enterInteger(event)">
  			</td>
  			<td nowrap>
  				<input type="text" name="DLSPP2" size="2" maxlength="1" value="<%=lnParam.getDLSPP2()%>" onkeypress="enterInteger(event)">
  			</td>
  			<td nowrap>
  				<input type="text" name="DLSPP3" size="2" maxlength="1" value="<%=lnParam.getDLSPP3()%>" onkeypress="enterInteger(event)">
  			</td>
  			<td nowrap>
  				<input type="text" name="DLSPP4" size="2" maxlength="1" value="<%=lnParam.getDLSPP4()%>" onkeypress="enterInteger(event)">
  			</td>
  			<td nowrap>
  				<input type="text" name="DLSPP5" size="2" maxlength="1" value="<%=lnParam.getDLSPP5()%>" onkeypress="enterInteger(event)">
  			</td>
  			<td nowrap>
  				<input type="text" name="DLSPP6" size="2" maxlength="1" value="<%=lnParam.getDLSPP6()%>" onkeypress="enterInteger(event)">
  			</td>	   
          </tr>
          <tr id="trclear">
			<td nowrap>
