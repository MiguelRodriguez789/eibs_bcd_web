...
%> 
<h3 align="center">Titulares <%= userPO.getHeader4().trim()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_tit.jsp,EDL0150"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table id="headTable" width="100%">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap> 
              <div align="center"> 
                <input type="text" name="E06PR<%= name %>" size="7" maxlength="6" onKeyPress="enterDecimal()" value="<%= lnTit.getField("E06PR"+name).getString().trim()%>">
              </div>
            </td>
          </tr>
          <%
