...
<body>
<h3 align="center">Comisiones de Cartas de Credito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_commissi.jsp, ELC0500"></h3>
<hr size="4">
...
<table class="tableinfo">
	<tr>
		...
		<tr id="trclear">
				...
				<td nowrap width="20%">
				   <div align="left">
				   <eibsinput:date name="msgLC" fn_month="E04LCMIDM" fn_day="E04LCMIDD" fn_year="E04LCMIDY" readonly="true"/>
				</div>
				</td>
				<td nowrap width="16%">
  		...
  		<tr id="trdark">
				...
				<div align="left">
					<eibsinput:date name="msgLC" fn_month="E04LCMEXM" fn_day="E04LCMEXD" fn_year="E04LCMEXY" readonly="true"/>
					</div>
				</td>
				<td nowrap width="16%">
				...
				<tbody>
					...
					<%if (userPO.getID().equals("18")) {%>
						<tr id="trclear">
							...
							<td nowrap width="15%">
								<select name="E04NOTPBY">
									<option value="A">Aplicante</option>
									<option value="W" <%if(msgLC.getE04NOTPBY().equals("W")) out.print("selected");%>>Condonar</option>
								</select></td>
							<td nowrap width="26%"></td>
							<td nowrap width="12%"></td>
						</tr>
						<tr id="trdark">
							...
							<td nowrap width="15%">
								<select name="E04SEGPBY">
									<option value="A">Aplicante</option>
									<option value="W" <%if(msgLC.getE04SEGPBY().equals("W")) out.print("selected");%>>Condonar</option>
								</select></td>
							<td nowrap width="26%"></td>
							<td nowrap width="12%"></td>
						</tr>
