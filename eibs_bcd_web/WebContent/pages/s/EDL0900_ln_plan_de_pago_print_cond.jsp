				...
				<div id="dataDiv1"  style="overflow: auto; border: 0px;"> 
					...
					<%
						 ...
						 while (list.getNextRow()) {
						   ...
						   sumpnu = 0;
						   sumpnu += plan.getBigDecimalE08COND01().doubleValue() + plan.getBigDecimalE08COND02().doubleValue()
								   +plan.getBigDecimalE08COND03().doubleValue() + plan.getBigDecimalE08COND04().doubleValue()
								   +plan.getBigDecimalE08COND05().doubleValue() + plan.getBigDecimalE08COND06().doubleValue()
								   +plan.getBigDecimalE08COND07().doubleValue() + plan.getBigDecimalE08COND08().doubleValue()
								   +plan.getBigDecimalE08COND09().doubleValue() + plan.getBigDecimalE08COND10().doubleValue()
								   +plan.getBigDecimalE08COND11().doubleValue() + plan.getBigDecimalE08COND12().doubleValue()
								   +plan.getBigDecimalE08COND13().doubleValue() + plan.getBigDecimalE08COND14().doubleValue()
								   +plan.getBigDecimalE08COND15().doubleValue() + plan.getBigDecimalE08COND16().doubleValue()
								   +plan.getBigDecimalE08COND17().doubleValue() + plan.getBigDecimalE08COND18().doubleValue()
								   +plan.getBigDecimalE08COND19().doubleValue();
