...
<H3 align="center">Cierre/Reapertura Procesos de Cámara<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cleaning_ctrl.jsp, EDD0933"></H3>
    ...
    <tr> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            <th align=center><div>Tipo  Cámara</div>
            </th>
