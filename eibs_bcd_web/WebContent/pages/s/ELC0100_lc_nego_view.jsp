...
title="ELC0100_lc_nego_view.jsp"></H3>
<HR size="4">
...
<TABLE CLASS="tableinfo" CELLSPACING="0" CELLPADDING="2" WIDTH="100%" BORDER="0">
  ...
  <TR id="trclear">
    ...
    <TD width="51" height="24" align="center" valign="top" nowrap><INPUT name="E01CUSBNK" type="text" value="<%= msg.getE01CUSBNK()%>" size="2" maxlength="2" readonly="readonly"></TD>
    <TD width="61" height="24" align="center" valign="top" nowrap><INPUT name="E01CUSBRN" type="text" onKeyPress="enterInteger(event)" value="<%= msg.getE01CUSBRN()%>" size="4" maxlength="4" readonly="readonly"></TD>
    <TD width="47" height="24" align="center" valign="top" nowrap><INPUT name="E01CUSCCY" type="text" value="<%= msg.getE01CUSCCY()%>" size="3" maxlength="3" readonly="readonly"></TD>
    <TD width="128" height="24" align="center" valign="top" nowrap><INPUT name="E01CUSGLN" type="text" onKeyPress="enterInteger(event)" value="<%= msg.getE01CUSGLN()%>" size="17" maxlength="16" readonly="readonly"></TD>
    <TD width="132" height="24" align="center" valign="top" nowrap><INPUT name="E01CUSACC" type="text" value="<%= msg.getE01CUSACC()%>" size="13" maxlength="12" readonly="readonly"></TD>
    <TD width="114" height="24" align="center" valign="top" nowrap><INPUT name="E01CUSCCN" type="text" value="<%= msg.getE01CUSCCN()%>" size="9" maxlength="8" readonly="readonly"></TD>
  </TR>
</TABLE>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <TR id="trclear">
    ...
    <TD nowrap valign="top" height="24" align="center" width="51"><INPUT name="E01DEBBK2" type="text" value="<%=msg.getE01DEBBK2()%>" size="2" maxlength="2" readonly="readonly"></TD>
    <TD nowrap valign="top" height="24" align="center" width="61"><INPUT name="E01DEBBR2" type="text" onKeyPress="enterInteger(event)" value="<%=msg.getE01DEBBR2()%>" size="4" maxlength="4" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="47"><INPUT name="E01DEBCY2" type="text" value="<%=msg.getE01DEBCY2()%>" size="3" maxlength="3" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="128"><INPUT name="E01DEBGL2" type="text" onKeyPress="enterInteger(event)" value="<%=msg.getE01DEBGL2()%>" size="17" maxlength="16" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="132"><INPUT name="E01DEBAC2" type="text" value="<%=msg.getE01DEBAC2()%>" size="13" maxlength="12" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="114"><INPUT name="E01DEBCC2" type="text" value="<%=msg.getE01DEBCC2()%>" size="9" maxlength="8" readonly="readonly"></TD>
  </TR>
</TABLE>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <TR id="trclear">
    ...
    <TD nowrap valign="top" height="24" align="center" width="51"><INPUT name="E01PMTBNK" type="text" value="<%= msg.getE01PMTBNK()%>" size="2" maxlength="2" readonly="readonly"></TD>
    <TD nowrap valign="top" height="24" align="center" width="61"><INPUT name="E01PMTBRN" type="text" onKeyPress="enterInteger(event)" value="<%= msg.getE01PMTBRN()%>" size="4" maxlength="4" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="47"><INPUT name="E01PMTCCY" type="text" value="<%= msg.getE01PMTCCY()%>" size="3" maxlength="3" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="128"><INPUT name="E01PMTGLN" type="text" onKeyPress="enterInteger(event)" value="<%= msg.getE01PMTGLN()%>" size="17" maxlength="16" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="132"><INPUT name="E01PMTACC" type="text" value="<%= msg.getE01PMTACC()%>" size="13" maxlength="12" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="114"><INPUT name="E01PMTCCN" type="text" value="<%= msg.getE01PMTCCN()%>" size="9" maxlength="8" readonly="readonly"></TD>
  </TR>
</TABLE>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <TR id="trclear">
    ...
    <TD nowrap valign="top" height="24" align="center" width="51"><INPUT name="E01CRPBNK" type="text" value="<%=msg.getE01CRPBNK()%>" size="2" maxlength="2" readonly="readonly"></TD>
    <TD nowrap valign="top" height="24" align="center" width="61"><INPUT name="E01CRPBRN" type="text" onKeyPress="enterInteger(event)" value="<%=msg.getE01CRPBRN()%>" size="4" maxlength="4" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="47"><INPUT name="E01CRPCCY" type="text" value="<%=msg.getE01CRPCCY()%>" size="3" maxlength="3" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="128"><INPUT name="E01CRPGLN" type="text" onKeyPress="enterInteger(event)" value="<%=msg.getE01CRPGLN()%>" size="17" maxlength="16" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="132"><INPUT name="E01CRPACC" type="text" value="<%=msg.getE01CRPACC()%>" size="13" maxlength="12" readonly="readonly"></TD>
    <TD nowrap align="center" valign="top" height="24" width="114"><INPUT name="E01CRPCCN" type="text" value="<%=msg.getE01CRPCCN()%>" size="9" maxlength="8" readonly="readonly"></TD>
  </TR>
</TABLE>
<P></P>
<%int i = 0;%>
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
		...
		<TD nowrap align="left" valign="top" height="24">
			<eibsinput:date name="msg" fn_month="E01DRFDTM" fn_day="E01DRFDTD" fn_year="E01DRFDTY" readonly="true" />
		</TD>
		<TD nowrap align="right">Fecha Valor:</TD>
		<TD nowrap align="left">
			<eibsinput:date name="msg" fn_month="E01VALDTM" fn_day="E01VALDTD" fn_year="E01VALDTY" readonly="true" />
		</TD>
	</TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
		...
		<TD nowrap align="left">
		<INPUT name="E01MATDTM" value="<%=msg.getE01MATDTM()%>" size="3" maxlength="2" readonly="readonly" >
		<INPUT name="E01MATDTD" value="<%=msg.getE01MATDTD()%>" size="3" maxlength="2" readonly="readonly" >
		<INPUT name="E01MATDTY" value="<%=msg.getE01MATDTY()%>" size="5" maxlength="4" readonly="readonly" >
		<A href="javascript:DatePicker(document.forms[0].E01MATDTM,document.forms[0].E01MATDTD,document.forms[0].E01MATDTY)">
		<IMG src="<%=request.getContextPath()%>/images/calendar.gif" title="help"  border="0"></A></TD>
	</TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
		...
		<A href="javascript: GetProduct('E01NEWPRO','<%=(msg.getE01OPCODE().equals("5") ? "10" : "14")%>','<%= msg.getE01CUSBNK()%>')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></A>		</TD>
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  ...
	  <TD height="24" align="left" valign="top" nowrap><INPUT name="E01INTRTE" type="text" onKeyPress="enterDecimal(event)" value="<%=msg.getE01INTRTE()%>" size="10" maxlength="9" readonly="readonly"></TD>
    </TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  ...
	  <TD height="24" align="left" valign="top" nowrap>
	  	<eibsinput:date name="msg" fn_month="E01NXIPDM" fn_day="E01NXIPDD" fn_year="E01NXIPDY" readonly="true" />
    </TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  ...
	  <TD height="24" align="left" valign="top" nowrap>
	  	<eibsinput:date name="msg" fn_month="E01NXPPDM" fn_day="E01NXPPDD" fn_year="E01NXPPDY" readonly="true" />
    </TR>
  </TABLE>
