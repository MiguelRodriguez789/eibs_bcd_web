...
<h3 align="center">Cambio de Cuenta Contable para Amortizaciones<br>Confirmación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="amort_ledger_change_confirmation.jsp, ESD3000"></h3>
<hr size="4">
