...
<H3 align="center"><%= title %> <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="titu_approval.jsp, EDD4008"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
         ...
         <tr id="trclear"> 
          ...
          <tr id="trdark"> 
           ...
           <td nowrap width="50%">
			 <eibsinput:text name="tituDetails" property="E01UC2" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME %>" required="false" readonly="true"/>      
			 <eibsinput:text name="tituDetails" property="D01UC2" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME %>" required="false" readonly="true"/>                          
		   </td>
         </tr> 
          ...
          <tr id="trclear"> 
           ...
           <td nowrap width="50%">
			 <eibsinput:text name="tituDetails" property="E01AM1" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME %>" required="false" readonly="true"/>                
		   </td>
         </tr>  
