...
<title>Mantenimiento de Clientes FATCA</title>
...
<h3 align="center">Mantenimiento de Clientes FATCA<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="client_fatca_list.jsp, ESD0085"></h3>
<hr size="4">
    ...
    <TR id=trdark>
        ...
        <%
          ...
          while (ESD0085List.getNextRow()) {
            ESD008501Message msgList = (ESD008501Message) ESD0085List.getRecord(); 
		%>              
    <TR id=trclear>
		...
		<td NOWRAP align="left" width="10%" ><A HREF="javascript:custInquiry('<%= msgList.getE01CUN() %>','<%="01"%>')"><%= msgList.getE01CUN() %></A> </td>
		<td NOWRAP align="left" width="35%" ><A HREF="javascript:custInquiry('<%= msgList.getE01CUN() %>','<%="01"%>')"><%= msgList.getE01NA1() %></A> </td>
