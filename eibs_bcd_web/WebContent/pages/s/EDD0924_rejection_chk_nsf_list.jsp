...
<h3 align="center">Devolución de Cheques<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rejection_chk_nsf_list.jsp,EDD0924"></h3>
<hr size="4">
...
<INPUT TYPE=HIDDEN NAME="FlagMov" VALUE="0">
 <h4 style="text-align:center">Devolución por Sobregiro de Cuentas -- Ejecutivo : <% if ( dataCR.getOfficer().trim().equals("")) {out.print("All");} else {out.print(dataCR.getOfficer());} %>
   </h4>
