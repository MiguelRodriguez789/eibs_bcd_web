...
<h3 align="center">Imprimir Protesto Manual<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ptt_stop_pay_print_data.jsp , EDD0190"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="70%" align="center" border="0">
           <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="left"><%= Util.formatCell(stop.getRecord(6)) %></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
		  ...
		  <tr id="trclear"> 
            ...
            <td nowrap title="DHSRES" ><%= Util.formatCell(stop.getRecord(33)) %> 
            </td>
		  </tr>
         ...
         <tr id="trdark"> 
            ...
            <td nowrap  colspan="3"> 
              <SELECT name="TIPFIR" disabled="disabled">
         ...
         <tr id="trclear"> 
		  ...
		  <tr id="trdark"> 
            ...
            <td colspan="3">
        		<input type="text" name="RUTGIR11" maxlength="9" size="9" onKeyPress=enterInteger(event)>
       			 - 
		  ...
		  <tr id="trdark"> 
           ...
           <td colspan="3">
        		<input type="text" name="RUTGIR21" maxlength="9" size="9" onKeyPress=enterInteger(event)>
       			 - 
