...
<H3 align="center">Control de Pago de Iva Especial<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="spectax_maintenance.jsp, ETX0150"></H3>
<hr size="4">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"><font face="Arial"><font face="Arial"><font size="2"> 
                <input type="text" name="E01TXCPDD" size="30"  maxlength="30" value="<%= Util.formatDate(brnDetails.getE01TXCPDD(),brnDetails.getE01TXCPDM(),brnDetails.getE01TXCPDY())+'-'+Util.formatCell(brnDetails.getE01TXCPDT())%>" readonly>
                </font></font></font></div>
            </td>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            &nbsp;
            <INPUT type="text" name="E01TXCPBR" size="5" maxlength="4" value="<%= brnDetails.getE01TXCPBR().trim()%>" readonly>
            &nbsp;
