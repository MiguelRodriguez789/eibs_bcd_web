...
%> 
<h3 align="center">Titulares <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_inq_tit.jsp,EDD0000"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table id="headTable" width="100%">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="27%"> 
              <div align="center"> 
                <input type="text" name="E06ID<%= name %>" size="25" maxlength="25" value="<%= rtTit.getField("E06ID"+name).getString().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="18%"> 
              <div align="center"> 
