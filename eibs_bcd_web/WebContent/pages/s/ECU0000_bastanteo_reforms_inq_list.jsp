...
<HEAD>
<TITLE>
Consulta de Reformas al Documento Constitutivo
</TITLE>
...
<SCRIPT type="text/javascript">
  ...
  function goAction(opt) {
    ...
    if (opt == "I") { 
    	...
    	page = "<%=request.getContextPath()%>/pages/s/ECU0000_bastanteo_reforms_inq.jsp?ROW=" + row;
...
<h3 align="center">Sistema de Bastanteo - Consulta de Reformas al Documento Constitutivo
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_reforms_inq_list.jsp,ECU0000">
</h3>
<hr size="4">
...
%> 
  ...
  <TABLE class="tbenter" width=100% height=40%>
      ...
      <TD> 
        <div align="center"> 
          <p>
            <b>No existen registros de reformas.</b>
          </p>          
        </div>
      </TD>
     </TR>
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE04CURRD1(),msgMT.getE04CURRD2(),msgMT.getE04CURRD3()) %></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE04CURDOC())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE04CURTOM())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE04CURCOD()) + " - " + Util.formatCell(msgMT.getE04CURCON())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE04CURAC1(),msgMT.getE04CURAC2(),msgMT.getE04CURAC3())  + " - " + msgMT.getE04CURACT()%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE04CURACU())%></TD>
		</TR>    		
    <%             
    				chk = "";     
                }
