...
<H3 align="center">C&oacute;digos de Referencia del Sistema <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnof_generic_short_codes_details.jsp, ESD0030"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="23"> 
              <div align="left"> 
			    ...
			    <a href="javascript:GetCodeDescCNOFC('STATECODE','STATEDSC','27')" onblur="getElement('STATEDSCL').innerHTML = getElement('STATEDSC').value" ><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="23"> 
              <div align="left"> 
                ...
                <input type="hidden" name="MNDSC" size="37" maxlength="35" value="" >
                <a href="javascript:GetCNOFCFilteredCodes('MNCODE','MNDSC', form1.STATECODE.value ,'85')" onblur="getElement('MNDSCL').innerHTML = getElement('MNDSC').value" >
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="23"> 
              <div align="left"> 
                <input type="text" name="PQCODE" size="4" maxlength="2" value="">
...
function parseValues(){
	...
	if( longCode.length >= 6 ){
		...
		form1.PQCODE.value = longCode.substring(4,6);
	}
}
...
function setValues(){
	...
	if( form1.PQCODE.value == "" ){ form1.PQCODE.value = "  " ; }

	form1.E02CNOMID.value = form1.STATECODE.value + form1.MNCODE.value + form1.PQCODE.value ;
