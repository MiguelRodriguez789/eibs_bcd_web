...
<H3 align="center">C&oacute;digos de Posición de Tesorería <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_codigos_posicion_tesoreria.jsp, ESD0030"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td nowrap width="16%" height="19"> 
              <div align="right">Código de Aplicación :</div>
            </td>
            <td nowrap height="19"> 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="16%" height="23"> 
              <div align="right">Calcular automáticamente? :</div>
            </td>
            <td nowrap height="23"> 
				<div align="left"><SELECT name="E02CNOF03">
					<OPTION value=""  <%if(refCodes.getE02CNOF03().trim().equals("")){%> Selected <%}%>> </OPTION>
					<OPTION value="Y" <%if(refCodes.getE02CNOF03().trim().equals("Y")){%> Selected <%}%>>Si </OPTION>
					<OPTION value="N" <%if(refCodes.getE02CNOF03().trim().equals("N")){%> Selected <%}%>>No </OPTION>					
				</SELECT></div>              
            </td>
          </tr>
        </table>
