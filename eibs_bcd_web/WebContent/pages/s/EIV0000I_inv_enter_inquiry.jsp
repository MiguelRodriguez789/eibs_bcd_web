...
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/s/javascripts/graphical.jsp"> </SCRIPT>
...
<H3 align="center"> Consulta - Inversiones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_enter_inquiry,EIV0000I"></H3>
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
    ...
    <tr id="trclear"> 
      ...
      <td align=CENTER width="34%"> 
        ...
        <a href="javascript:GetCashAccount('CURRENCY','ACCOUNT','MEMBAL',document.forms[0].CUSTOMER.value,document.forms[0].PORTFOLIO.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"  ></a>
	...
	<tr id="trdark"> 
      ...
      <td align=CENTER width="34%"> 
        <div align="left"> 
         ...
         <a href="javascript:GetInstrumentParams('CODE','','','','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0">
		</a>
	  </div>
      </td>
    </tr>
...
<div id="hiddenDivOption3" class="hiddenDiv">
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
   ...
   <tr id="trdark"> 
      ...
      <td align=LEFT width="34%"> 
      				  <input type="text" size="3" maxlength="2" name="DATEF1" onKeyPress="enterInteger(event)">
                      ...
                      To 
                      <input type="text" size="3" maxlength="2" name="DATET1" onKeyPress="enterInteger(event)">
      ...
      <tr id="trclear"> 
        <td colspan="3"> 
          <div align="center">Cliente : 
            ...
            <a href="javascript:GetCustomerDescId('CUSTOMER','CUNDSC','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
          </div>
        </td>
      </tr>
      <tr id="trclear"> 
