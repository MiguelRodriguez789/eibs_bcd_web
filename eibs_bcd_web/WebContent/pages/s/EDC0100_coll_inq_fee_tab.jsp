<html>
<head>
<title>Consulta de Tarifas de Cobranzas</title>
...
<h3 align="center">Consulta de Tarifas de Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="coll_inq_fee_tab,EDC0100"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly  name="E01SELTYP" size="5" maxlength="4" value="<%= colProdInq.getE01SELTYP().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              <input type="text" readonly  name="E01SELTLN" size="3" maxlength="2" value="<%= colProdInq.getE01SELTLN().trim()%>">
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="9%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOCRT" size="8"		maxlength="3" value="<%= colProdInq.getE01RCOCRT().trim()%>">
              </div>
            </td>
            <td width="10%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOCCP" size="8"	maxlength="3" value="<%= colProdInq.getE01RCOCCP().trim()%>">
              </div>
            </td>
            <td width="7%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="9%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCODRT" size="8" maxlength="3" value="<%= colProdInq.getE01RCODRT().trim()%>">
              </div>
            </td>
            <td width="10%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCODCP" size="8"	maxlength="3" value="<%= colProdInq.getE01RCODCP().trim()%>">
              </div>
            </td>
            <td width="7%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="9%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCORRT" size="8" maxlength="3" value="<%= colProdInq.getE01RCORRT().trim()%>">
              </div>
            </td>
            <td width="10%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCORCP" size="8" maxlength="3" value="<%= colProdInq.getE01RCORCP().trim()%>">
              </div>
            </td>
            <td width="7%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="9%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOEBR" size="8" maxlength="3" value="<%= colProdInq.getE01RCOEBR().trim()%>">
              </div>
            </td>
            <td width="10%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td width="48%"> 
              <div align="right">Servicio de Fax/Telefono - Internacionall :</div>
            </td>
            <td width="9%"> 
