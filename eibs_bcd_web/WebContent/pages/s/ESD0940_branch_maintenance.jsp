...
function goCancel(acd, bnk, acc, prod) {

document.forms[0].SCREEN.value="100";
document.forms[0].E01CHGACD.value=acd;
...
<H3 align="center">Cambio de Productos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="branch_maintenance.jsp, ESD0940"></H3>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="55%"> 
				<INPUT type="text" name="E01CHGBNK" maxlength="3" size="2" onkeypress="enterInteger(event)" value="<%= brnDetails.getE01CHGBNK().trim()%>" readonly >
			</td>
			<TD width="14"></td>
          ...
          <INPUT type="text" name="E01CHGPRC" size="5" maxlength="4"
					...
					href="javascript:GetProduct('E01CHGPRC',document.forms[0].E01CHGACD.value,document.forms[0].E01CHGBNK.value)"><IMG
          ...
          <tr id="trclear"> 
            ...
            <td nowrap height="19" width="55%">
            <INPUT type="hidden" name="E01CHGACD" maxlength="2" size="2"
