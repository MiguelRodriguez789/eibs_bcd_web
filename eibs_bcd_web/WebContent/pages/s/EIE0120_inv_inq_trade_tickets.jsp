...
%>
<div align="center"> 
  <h3>Consulta Orden de Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_inq_trade_tickets.jsp,EIE0120"> 
  </h3>
</div>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="17%" > 
              <div align="right"><a href="javascript:showCustomerInq(document.forms[0].E01ORDCUN.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" title="help" align="bottom" border="0" > 
                Cliente </a>:</div>
            </td>
            <td nowrap colspan="3" > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="17%" > 
              <div align="right"><a href="javascript:showRetAccountInq(document.forms[0].E01ORDHAC.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" title="help" align="bottom" border="0" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="14%" > 
              <div align="right"><a href="javascript:GetSymbolInfo(document.forms[0].E01ORDSYM.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" title="help" align="bottom" border="0" > 
                Símbolo :</a> </div>
            </td>
            <td nowrap width="33%" > 
