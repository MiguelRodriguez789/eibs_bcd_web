...
<body>
<h3 align="center">Asignación de Tarjetas<BR>Reemplazo de Tarjeta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="card_assign_replace_add.jsp, ECC0090"></h3>
<hr size="4">
<% 
			...
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
				<TBODY>
					<TR id="trdark">
						...
						<TD nowrap width="16%">
							<DIV align="right">Número de Tarjeta Titular :</DIV>
						</TD>
						<TD nowrap width="20%">
							<DIV align="left">
					...
					<TR id="trclear">
						...
						<TD nowrap width="20%">
							<DIV align="left">
								...
								<A href="javascript:GetPlastic2('E01CCRNEW','D','N')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></A>
							</DIV>
						</TD>
						<TD nowrap width="16%">
						...
						<TD nowrap width="20%">
							<DIV align="left">
								...
								<a href="javascript:GetPlasticStatus('E01CCRSTS', 'E01CCRDSC')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
							</DIV>
						</TD>
					</TR>
				</TBODY>
