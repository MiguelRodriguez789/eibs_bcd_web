...
<BODY>
<h3 align="center">Documentos Relacionados<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="doc_basic.jsp,EDI0110"></h3>
<hr size="4">
			...
			<tr id="trdark">
				...
				<td nowrap width="33%">
					<select name="E02DIDTYP" style="min-width: 160px; width: 180px;" onfocus="CNOFCSelect('FD').getFilters(this)">
						<option value="<%=scanDoc.getE02DIDTYP()%>" selected="selected"></option>
					</select>
				</td>
			</tr>
			<tr id="trclear">
			...
			<tr id="trdark">
				...
				<td nowrap width="33%">
					<select name="E02DIDSTA" style="min-width: 160px; width: 180px;" onfocus="CNOFCSelect('17').getFilters(this)">
						<option value="<%=scanDoc.getE02DIDSTA()%>" selected="selected"></option> 
					</select>
				</td>
			</tr>
		</table>
...
%>
  <h4>Imagen</h4> 	
	<table class="tableinfo">
	<tr > 
		<td nowrap width="30%" align="right">Seleccione la Sequencia: </td>
		<td nowrap width="20%" align="right" style="border-spacing: 4pt"><</td>
		...
		<td nowrap width="30%"></td>
			...
			<PARAM name="document" value="<%= "http://134.177.251.131/eibsimage/data/"+document %>">
