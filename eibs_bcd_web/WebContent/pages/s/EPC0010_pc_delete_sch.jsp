...
<h3 align="center">Participantes de Pool Asociados a Proyecto - Eliminación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_delete_sch.jsp, EPC0010"></h3>
<hr size="4">
          ...
          <tr id="trclear"> 
            ...
            <td width="70%"> 
              <select name="E01PCPLEA">
                <option disabled value="Y" <% if (msgPCA.getE01PCPLEA().equals("Y")) out.print("selected"); %>>Sí</option>
                <option disabled  value="N" <% if (msgPCA.getE01PCPLEA().equals("N")) out.print("selected"); %>>No</option>
                <option disabled value="C" <% if (msgPCA.getE01PCPLEA().equals("C")) out.print("selected"); %>>Control</option>
              </select>
            </td>
          </tr>
...
<table cellspacing=2 cellpadding=2 width="100%" border="0" class="tableinfo">
	...
	<tr>
		...
		<td nowrap><input type="text" name="E01PCPOFB" size="2"
			maxlength="2" value="<%= msgPCA.getE01PCPOFB().trim()%>">
		</td>
