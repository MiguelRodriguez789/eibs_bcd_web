...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="params_group_unit_list.jsp,EEJ0020">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE01EJULM1(),msgMT.getE01EJULM2(),msgMT.getE01EJULM3())  + " - " + Util.formatCell(msgMT.getE01EJULMT())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01EJULMU())%></TD>
		</TR>    		
    <%             
    				chk = "";     
                }
