...
%> 
<h3 align="center">C&oacute;digos Especiales (Back Office)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_codes.jsp,EFE0120B" width="35" ></h3> 
<hr size="4">
