...
<h3 align="center">Beneficiarios <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_bene.jsp, EDL0130M"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" name="TB_BENEFICIARY_CORP" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E<%= name %>4STE','27')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0"></a>	
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="42%" nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E<%= name %>4BNC','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0"></a> 
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="42%" nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap > 
              <p> 
                ...
                <a href="javascript:GetCodeCNOFC('E<%= name %>4MLC','29')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0"  ></a>	
                </p>
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap > 
              ...
              <a href="javascript:GetCodeCNOFC('E<%= name %>4TID','34')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0" ></a>	
              </td>
          </tr>
          <tr id="trdark"> 
            <td width="42%" nowrap> 
            ...
            <td width="58%" nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E<%= name %>4PID','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0" ></a> 
              </td>
          </tr>
        </table>
