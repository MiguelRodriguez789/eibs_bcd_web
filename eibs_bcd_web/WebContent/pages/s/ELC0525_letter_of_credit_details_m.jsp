...
<jsp:useBean id="lcNew2" class="datapro.eibs.beans.ELC051002Message"
	scope="session" />
...
<body>
<h3 align="center">Mantenimiento de Carta de Credito<img
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="letter_of_credit_details_m.jsp,ELC0525"></h3>
		...
		<TABLE cellpadding="2" cellspacing="0" width="100%" border="0">
			<TBODY>
				<TR id="trdark">
					...
					<TD nowrap width="25%">
						<eibsinput:date name="lcNew2" fn_month="E02LCMIDM" fn_day="E02LCMIDD" fn_year="E02LCMIDY" required="true"/>
					</TD>
					<TD nowrap width="25%">
						<DIV align="right">Fecha de Expiración:</DIV>
					</TD>
					<TD nowrap width="25%">
						<eibsinput:date name="lcNew2" fn_month="E02LCMEXM" fn_day="E02LCMEXD" fn_year="E02LCMEXY" required="true"/>
					</TD>
				</TR>
				<TR id="trclear">
					<TD nowrap width="25%">
					...
					<TD nowrap width="25%">
						<eibsinput:date name="lcNew2" fn_month="E02LCMSDM" fn_day="E02LCMSDD" fn_year="E02LCMSDY" required="false"/>
					</TD>
					<TD nowrap width="25%">
					<DIV align="right">Fecha de Aviso/Confirmación:</DIV>
					</TD>
					<TD nowrap width="25%">
						<eibsinput:date name="lcNew2" fn_month="E02LCMCNM" fn_day="E02LCMCND" fn_year="E02LCMCNY" required="false"/>
					</TD>
				</TR>
	...
	out.print("checked");%>>No
				...
				<TR id="trdark">
					...
					<TD nowrap width="25%"><INPUT type="text" name="E02LCMBRK" readonly="readonly" 
						...
						onkeypress="enterDecimal(event)"></TD>
					<TD nowrap width="25%">
