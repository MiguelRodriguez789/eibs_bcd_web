...
<h3 align="center">Tabla de Módulos de Clasificación</h3>
<h3 align="center">
		 ...
		 %>
          <tr> 
	        <td align="center" nowrap > 
	      	...
	      	<td align="center" nowrap >  
    	      <input type="text" name="E01MODCOD_<%= trans.getCurrentRow() %>"  size="4" maxlength="4"  value="<%= trans.getRecord(1) %>" onFocus="setCurrentRow('<%= trans.getCurrentRow() %>')" onkeypress=enterInteger(event) > 
      		</td>
	      	<td align="center" nowrap >  
    ...
    %> 
          <tr> 
		    <td align="center" nowrap  > 
	      	...
	      	<td align="center" nowrap  >  
    	      <input type="text" name="E01MODCOD_<%= i %>"  size="4" maxlength="4" onkeypress=enterInteger(event) > 
      		</td>
	      	<td align="center" nowrap  >  
