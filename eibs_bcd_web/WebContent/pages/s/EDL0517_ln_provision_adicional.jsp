      ...
      <tr > 
        <td nowrap> 
          <table cellspacing="2" cellpadding="2" width="100%" border="0" align="left">
            <tr id="trdark"> 
              <td nowrap width="40%"><div align="center"><b>Conceptos</b></div></td>
              <td nowrap width="20%" align=center><b>Provisi&oacute;n<br>Actual</b></td>
              <td nowrap width="40%" align=center><b>Incremento <br>
                  Provisi&oacute;n</b></td>
            </tr>
            <tr>
              ...
              <td nowrap >  
                <input type="text" class="txtright" name="E01DLCMPR" size="17" maxlength="15" value="<%= provis.getE01DLCMPR().trim()%>" onKeypress="enterDecimal(event, 2)">
               </td>
            </tr>
            <tr >
              ...
              <td nowrap >  
                <input type="text" class="txtright" name="E01DLCMIN" size="17" maxlength="15" value="<%= provis.getE01DLCMIN().trim()%>" onKeypress="enterDecimal(event, 2)">
               </td>
            </tr>
            <tr >
              ...
              <td nowrap >  
                <input type="text" class="txtright" name="E01DLCMOT" size="17" maxlength="15" value="<%= provis.getE01DLCMOT().trim()%>" onKeypress="enterDecimal(event, 2)">
               </td>
            </tr>
