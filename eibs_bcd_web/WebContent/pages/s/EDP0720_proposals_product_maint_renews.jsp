...
<h3 align="center">Detalle del Producto
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="proposals_product_maint_renews.jsp,EDP0720"></h3>
		...
		<TR id="trclear">
			...
			<TR id="trclear">
			   ...
			   <TD width="15%" align="right">
				...
				<TD width="20%" align="left">
            				<input type=TEXT name="E01PLTRA2" value="<%= msgRTC.getE01PLTRA2() %>" size=3 maxlength=2 onKeypress="enterInteger(event)" readonly> 
            				<input type=TEXT name="E01PLTRA1" value="<%= msgRTC.getE01PLTRA1() %>" size=3 maxlength=2 onKeypress="enterInteger(event)" readonly>  
            				<input type=TEXT name="E01PLTRA3" value="<%= msgRTC.getE01PLTRA3() %>" size=5 maxlength=4 onKeypress="enterInteger(event)" readonly>
				 </TD>  
				...
				<TD width="20%" align="right">
		   		 ...
		   		 <TD  width="45%" align="left">
            				<input type=TEXT name="E01PLTRV2" value="<%= msgRTC.getE01PLTRV2() %>" size=3 maxlength=2 onKeypress="enterInteger(event)" readonly> 
   				            <input type=TEXT name="E01PLTRV1" value="<%= msgRTC.getE01PLTRV1() %>" size=3 maxlength=2 onKeypress="enterInteger(event)" readonly>  
            				<input type=TEXT name="E01PLTRV3" value="<%= msgRTC.getE01PLTRV3() %>" size=5 maxlength=4 onKeypress="enterInteger(event)" readonly>
		   		 </TD> 
		    </TR>
