...
<script src="<%=request.getContextPath()%>/pages/s/javascripts/eIBSTreausury.jsp"> </SCRIPT>
<script src="<%=request.getContextPath()%>/pages/s/javascripts/eIBSTreasury.jsp"> </SCRIPT><script src="<%=request.getContextPath()%>/pages/s/javascripts/eIBS.jsp"> </SCRIPT>
...
%>
<h3 align="center">MT 320 Mensaje de Confirmaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_cd_format.jsp,ESWF320A"> 
</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0120B" >
  ...
  <table  class="tableinfo">
   ...
   <h4>Secuencia A : Informaci&oacute;n General</h4>
              ...
              <td nowrap> 
                <table cellpadding=2 cellspacing=0 width="100%" border="0">
                  ...
                  <tr id="trclear"> 
                    ...
                    <td nowrap width="28%" > <%= Util.formatCustomDate(currUser.getE01DTF(),
                    		swift.getBigDecimalE02SWFTDM().intValue(),
                    		swift.getBigDecimalE02SWFTDD().intValue(),
                    		swift.getBigDecimalE02SWFTDY().intValue())%> 
                    </td>
                  </tr>
                  <tr id="trdark"> 
                    <td nowrap width="22%" > 
                    ...
                    <td nowrap width="28%"> 
                      <div align="left"> <%= Util.formatCustomDate(currUser.getE01DTF(),
                      		swift.getBigDecimalE02SWFVDM().intValue(),
                      		swift.getBigDecimalE02SWFVDD().intValue(),
                      		swift.getBigDecimalE02SWFVDY().intValue())%> 
                      </div>
                    </td>
                  </tr>
                  <tr id="trclear"> 
                    ...
                    <td nowrap width="28%"> 
                      <div align="left"> <%= Util.formatCustomDate(currUser.getE01DTF(),
                      		swift.getBigDecimalE02SWFMDM().intValue(),
                      		swift.getBigDecimalE02SWFMDD().intValue(),
                      		swift.getBigDecimalE02SWFMDY().intValue())%> 
                      </div>
                    </td>
                  </tr>
                  <tr id="trdark"> 
                    ...
                    <td nowrap width="28%"> 
                      <div align="left"> <%= Util.formatCustomDate(currUser.getE01DTF(),
                      		swift.getBigDecimalE02SWFIDM().intValue(),
                      		swift.getBigDecimalE02SWFIDD().intValue(),
                      		swift.getBigDecimalE02SWFIDY().intValue())%> 
                      </div>
                    </td>
                  </tr>
                  <tr id="trclear"> 
          ...
          <h4>Secuencia C : Instrucciones de Pago por el Monto Pagadero por la Entidad A</h4>
