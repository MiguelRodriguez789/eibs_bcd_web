...
<h3 align="center">Maestro de Propuestas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="proposal_enter, EPV5000"></h3>
<hr size="4">
              ...
              <table cellspacing="0" cellpadding="2" width="100%" border="0">
                ...
                <tr id="trclear"> 
                  ...
                  <td nowrap width="46%" align="left" valign="middle"> 
                    <input type="text" name="IDENTIFICATION" size="15" maxlength="15" onKeyPress="enterInteger(event)">
                    <a href="javascript:GetCustomerDescId('','','IDENTIFICATION')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
                    <input type="radio" name="TYPSEL" value="1" checked>
                    <input type="text" name="E01PVMIDN" size="17" maxlength="15" onKeyPress="enterInteger(event)">
                    <a href="javascript:GetCustomerDescId('CUSNUM','','E01PVMIDN')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
                  </td>
                </tr>
                <tr  id="trdark"> 
