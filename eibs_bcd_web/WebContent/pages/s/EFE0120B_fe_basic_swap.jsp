...
%>
<h3 align="center"> Swap Moneda Extranjera (Back Office)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_swap.jsp,EFE0120B"> 
</h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="85%" > 
              <div align="left"> 
                <input type="hidden" name="D01FESCPL"  value="<%= fex.getD01FESCPL()%>" readonly>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" ><%= fex.getE01FESOTS()%></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="18%" > 
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
              <a href="javascript:GetClassFex('E01FESCLS','SPT','<%= fex.getE01FESCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
            ...
            <td nowrap > 
			  ...
			  >
              <a href="javascript:GetClassFex('E01FESFLS','FWR','<%= fex.getE01FESCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap >&nbsp;</td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
              <a href="javascript:GetCode('E01FESRVF','STATIC_fe_bo_rev.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a></td>
            <td nowrap colspan="2" > 
            ...
            <td nowrap > 
			  ...
			  >
                <a href="javascript:GetCode('E01FESCOT','STATIC_fe_bo_not.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a></div>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap >
			  ...
			  >
              <a href="javascript:GetCode('E01FESBCT','STATIC_fe_bo_pay.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap width="17%" >&nbsp;</td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="center"> 
                ...
                class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E01FESCBK.value,'','','','')" >
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01FESFBR" size="4" maxlength="4" value="<%= fex.getE01FESFBR()%>"
                class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E01FESFBK.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01FESFCU" size="3" maxlength="3" value="<%= fex.getE01FESFCU()%>"
                class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.forms[0].E01FESFBK.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01FESFGL" size="17" maxlength="16" value="<%= fex.getE01FESFGL()%>"
				class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.forms[0].E01FESFBK.value,document.forms[0].E01FESFCU.value,'','','')"  >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01FESFAC" size="13" maxlength="129" value="<%= fex.getE01FESFAC()%>"
                class="context-menu-help" onmousedown="init(accountHelp,this.name,document.forms[0].E01FESFBK.value,'','','','RT')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01FESFCC" size="12" maxlength="9" value="<%= fex.getE01FESFCC()%>"
                class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E01FESFBK.value,'','','','')" >
              </div>
            </td>
          </tr>
        </table>
