...
{
	page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSECD0015?SCREEN=3&ROW=" + rowNum;
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="settlement_det_list.jsp, ECD0015">
</h3>
<hr size="4">
