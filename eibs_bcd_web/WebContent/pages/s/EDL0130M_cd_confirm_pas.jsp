...
%>
<h3 align="center">Confirmaci&oacute;n - Contrato <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_confirm.jsp,EDL0130M"></h3> 
<hr size="4">
 <FORM >
          ...
          <tr> 
            ...
            <td width="91%"> con fecha de apertura : 
                          <%= datapro.eibs.master.Util.formatCustomDate(currUser.getE01DTF(),
                        		  cdMant.getBigDecimalE01DEAODM().intValue(),
                        		  cdMant.getBigDecimalE01DEAODD().intValue(),
                        		  cdMant.getBigDecimalE01DEAODY().intValue())%>
              y fecha de vencimiento:
                         <%= datapro.eibs.master.Util.formatCustomDate(currUser.getE01DTF(),
                        		  cdMant.getBigDecimalE01DEAMDM().intValue(),
                        		  cdMant.getBigDecimalE01DEAMDD().intValue(),
                        		  cdMant.getBigDecimalE01DEAMDY().intValue())%>
            </td>
          </tr>
          <tr> 
            <td width="9%">&nbsp;</td>
