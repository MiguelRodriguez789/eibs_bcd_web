		 ...
		 %>
          <tr> 
	        <td align="center" nowrap > 
	      	...
	      	<td align="center" nowrap >  
    	      <input type="text" name="E01MXPPTS_<%= trans.getCurrentRow() %>"  size="4" maxlength="4"  value="<%= trans.getRecord(0) %>" onFocus="setCurrentRow('<%= trans.getCurrentRow() %>')" onkeypress=enterInteger(event) > 
      		</td>
	      	<td align="center" nowrap >  
    ...
    %> 
          <tr> 
		    <td align="center" nowrap  > 
	      	...
	      	<td align="center" nowrap  >  
    	      <input type="text" name="E01MXPPTS_<%= i %>"  size="4" maxlength="4" onkeypress=enterInteger(event) > 
      		</td>
	      	<td align="center" nowrap  >  
