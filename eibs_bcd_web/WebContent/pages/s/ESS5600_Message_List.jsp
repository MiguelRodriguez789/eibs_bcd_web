...
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  <h3 align="center">Marketing Message <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="Affiliation_List.jsp,ESS2060"> 
  </h3>
<hr size="4">
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark">  
		      ...
		      <TH ALIGN=CENTER width=50%>Descripció</TH>
       ...
       %>  
          <tr>
             <td align="center">
                <input type="radio" name="IMDUNQ" value ="<%= objList.getIMDUNQ() %>" checked></td>
