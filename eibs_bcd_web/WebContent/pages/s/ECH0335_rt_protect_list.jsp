...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_protec_list.jsp,ECH0335">
</h3>
<hr size="4">
      ...
      <TD> 
        <div align="center"> 
          ...
          <table class="tbenter" width="100%">
            <tr> 
              <td id=TDBKG> <a href="javascript:goAction(1)">Crear</a></td>
