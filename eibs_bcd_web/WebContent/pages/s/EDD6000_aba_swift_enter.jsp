...
<h3 align="center">Mantenimiento de Números ABA y Swift ID<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="aba_swift_enter.jsp, EDD6000"></h3>
<hr size="4">
  <br><br><br>
  <table class="tableinfo"  cellspacing="0" cellpadding="2" width="100%" border="0">
    <tr id="trdark"> 
      ...
      <td valign="middle" align="center" width="51%"> 
        <div align="left"> 
          <input type="text" name="E01INSAB9"  size="14" maxlength="10" onkeypress="enterInteger(event)" >
          <a href="javascript:GetFedId('E01INSAB9')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0"></a> 
        </div>
      </td>
    </tr>
    <tr id="trclear"> 
    ...
    <tr id="trdark"> 
      ...
      <td valign="middle" align="center" width="51%"> 
        <div align="left"> 
          ...
          <a href="javascript:GetSwiftId('E01INSSWF')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0"></a> 
        </div>
      </td>
    </tr>
