...
<h3 align="center">Documentos Requeridos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_documents.jsp,0510"></h3>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD2','E06LCMDS2','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD3','E06LCMDS3','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD4','E06LCMDS4','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD5','E06LCMDS5','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD6','E06LCMDS6','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD7','E06LCMDS7','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD8','E06LCMDS8','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="8%">             
                ...
                <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD9','E06LCMDS9','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ."	align="bottom" border="0"></a><%}%>
            </td>
