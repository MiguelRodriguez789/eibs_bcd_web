...
<H3 align="center">Creacion de Remesas de Efectivo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transfer_new,EFE0500"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	      ...
	      <td nowrap>
	        ...
	        <a href="javascript:GetBranch('E02REMBRN',document.forms[0].E02REMBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
	      </td>
     	</tr>
     	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E02REMCAR','YK')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	  </td>     
      	</tr>
      	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
          <td nowrap>
        ...
        <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">          
          ...
          <td nowrap>
             <input type="text" name="E02REMRAM" size="17" maxlength="15" value ="<%= Util.formatCCY(msgMT.getE02REMRAM()) %>" onkeypress="enterDecimal()">             
          </td>
        </tr>
     </table>
  	</td>
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 	      
	    <td >
			<input type="text" name="E02REMD01" size="5" maxlength="4" value="<%= msgMT.getE02REMD01() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD01','E02REMN01','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ01" value ="<%= msgMT.getE02REMQ01() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD02" size="5" maxlength="4" value="<%= msgMT.getE02REMD02() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD02','E02REMN02','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ02" value ="<%= msgMT.getE02REMQ02() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD03" size="5" maxlength="4" value="<%= msgMT.getE02REMD03() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD03','E02REMN03','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ03" value ="<%= msgMT.getE02REMQ03() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 	      
	    <td>
			<input type="text" name="E02REMD04" size="5" maxlength="4" value="<%= msgMT.getE02REMD04() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD04','E02REMN04','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ04" value ="<%= msgMT.getE02REMQ04() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD05" size="5" maxlength="4" value="<%= msgMT.getE02REMD05() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD05','E02REMN05','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ05" value ="<%= msgMT.getE02REMQ05() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 	      
	    <td>
			<input type="text" name="E02REMD06" size="5" maxlength="4" value="<%= msgMT.getE02REMD06() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD06','E02REMN06','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ06" value ="<%= msgMT.getE02REMQ06() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
    ...
    <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD07" size="5" maxlength="4" value="<%= msgMT.getE02REMD07() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD07','E02REMN07','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ07" value ="<%= msgMT.getE02REMQ07() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 	      
	    <td>
			<input type="text" name="E02REMD08" size="5" maxlength="4" value="<%= msgMT.getE02REMD08() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD08','E02REMN08','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ08" value ="<%= msgMT.getE02REMQ08() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD09" size="5" maxlength="4" value="<%= msgMT.getE02REMD09() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD09','E02REMN09','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ09" value ="<%= msgMT.getE02REMQ09() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD10" size="5" maxlength="4" value="<%= msgMT.getE02REMD10() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD10','E02REMN10','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ10" value ="<%= msgMT.getE02REMQ10() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 	      
	    <td>
			<input type="text" name="E02REMD11" size="5" maxlength="4" value="<%= msgMT.getE02REMD11() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD11','E02REMN11','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ11" value ="<%= msgMT.getE02REMQ11() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">       
	    <td>
			<input type="text" name="E02REMD12" size="5" maxlength="4" value="<%= msgMT.getE02REMD12() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD12','E02REMN12','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ12" value ="<%= msgMT.getE02REMQ12() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD13" size="5" maxlength="4" value="<%= msgMT.getE02REMD13() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD13','E02REMN13','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ13" value ="<%= msgMT.getE02REMQ13() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">       
	    <td>
			<input type="text" name="E02REMD14" size="5" maxlength="4" value="<%= msgMT.getE02REMD14() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD14','E02REMN14','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ14" value ="<%= msgMT.getE02REMQ14() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD15" size="5" maxlength="4" value="<%= msgMT.getE02REMD15() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD15','E02REMN15','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ15" value ="<%= msgMT.getE02REMQ15() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">       
	    <td>
			<input type="text" name="E02REMD16" size="5" maxlength="4" value="<%= msgMT.getE02REMD16() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD16','E02REMN16','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ16" value ="<%= msgMT.getE02REMQ16() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD17" size="5" maxlength="4" value="<%= msgMT.getE02REMD17() %>"> 
      	   ...
      	   <a href="javascript:GetCodeDescAuxCNOFC('E02REMD17','E02REMN17','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ17" value ="<%= msgMT.getE02REMQ17() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">       
	    <td>
			<input type="text" name="E02REMD18" size="5" maxlength="4" value="<%= msgMT.getE02REMD18() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD18','E02REMN18','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ18" value ="<%= msgMT.getE02REMQ18() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  	      
	    <td>
			<input type="text" name="E02REMD19" size="5" maxlength="4" value="<%= msgMT.getE02REMD19() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD19','E02REMN19','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ19" value ="<%= msgMT.getE02REMQ19() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">       
	    <td>
			<input type="text" name="E02REMD20" size="5" maxlength="4" value="<%= msgMT.getE02REMD20() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E02REMD20','E02REMN20','YN',document.forms[0].E02REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E02REMQ20" value ="<%= msgMT.getE02REMQ20() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
