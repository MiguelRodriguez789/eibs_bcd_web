...
function getIdTypeHelp(){
   ...
   if (clientTypeSelected == "CORPORATIVE") 
     GetCode('E01CCLIDT','STATIC_client_help_id_type.jsp?clientType=CORPORATIVE');
   else
     GetCode('E01CCLIDT','STATIC_client_help_id_type.jsp?clientType=PERSONAL');
 }
</script>
<% } %>
...
<h3 align="center">Suspensión de Productos y Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="suspension_cust_id_enter.jsp, ECL0000"></h3>
<hr size="4">
<form name="forma" method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.misc.JSECL0000">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap align="left" valign="middle" colspan="2"> 
            	<input type="text" name="E01CCLIDT" value="" maxlength="1" size="1" readonly>
				<a href="javascript:GetCode('E01CCLIDT','STATIC_client_help_id_type.jsp?clientType=PERSONAL')">
				<img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a>
            	<input type="text" name="E01CCLIDN" value="" size="10" maxlength="9" onBlur="refillLeftField('0',9,'E01CCLIDN');" onKeyPress="enterInteger(event)">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap align="right" valign="middle" width="49%">Código PIN :
           </td>
            <td nowrap align="left" valign="middle" colspan="2"> 
            	<input type="password" name="E01CCLPIN" value="" size="3" maxlength="2" onKeyPress="enterInteger(event)"> (dos dígitos consecutivos)
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap align="left" valign="middle" colspan="2"> 
              <input type="text" name="CUN" value="0" maxlength="10" size="11" onKeypress="enterInteger(event)" >
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap align="right" valign="middle" width="49%">Identificaci&oacute;n :
