...
<H3 align="center">Par&aacute;metros de Lavado de Dinero<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_money, EDL0130M"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text"  name="CUSCUN" size="10" maxlength="9" value="<%= cdMoney.getE06LDMCUN().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text"  name="ACCNUM" size="13"  maxlength="12" value="<%= cdMoney.getE06LDMACC().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%"> 
              <div align="center"> 
                <input type="text"  name="E06LDMSCN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMSCN().trim()%>" onKeyPress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="19%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="19%"> 
              <div align="center"> 
                <input type="text"  name="E06LDMSWN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMSWN().trim()%>" onKeyPress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="19%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%" height="23"> 
              <div align="center"> 
                <input type="text"  name="E06LDMSDN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMSDN().trim()%>" onKeyPress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="19%" height="23"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="19%" height="19"> 
              <div align="center"> 
                <input type="text"  name="E06LDMSKN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMSKN().trim()%>" onKeyPress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="19%" height="19"> 
              <div align="center"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%"> 
              <div align="center"> 
                <input type="text"  name="E06LDMBCN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMBCN().trim()%>" onKeyPress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="19%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="19%"> 
              <div align="center"> 
                <input type="text"  name="E06LDMBWN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMBWN().trim()%>" onKeyPress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="19%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%" height="23"> 
              <div align="center"> 
                <input type="text"  name="E06LDMBDN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMBDN().trim()%>" onKeyPress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="19%" height="23"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="19%" height="19"> 
              <div align="center"> 
                <input type="text"  name="E06LDMBKN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMBKN().trim()%>" onKeyPress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="19%" height="19"> 
              <div align="center"> 
