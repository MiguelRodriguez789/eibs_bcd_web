...
<H3 align="center">Mantenimiento de Ejecutivos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="params_officer_enter_inq,EEJ0030"></H3>
<hr size="4">
<p>&nbsp;</p>
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
		  <td nowrap width="40%"> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E01EJEBNK" size="3" maxlength="2" onKeypress="enterInteger(event)" value="<%= msgMT.getE01EJEBNK()%>"></td>     
      	</tr>
      	<tr id=trclear>
          <td nowrap width="40%">
