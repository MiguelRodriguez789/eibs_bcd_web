...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_inv_detail_print.jsp , ECD0003">
</h3>
<hr size="4">
<FORM>
 ...
 <TR > 
    <TD NOWRAP valign="top" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%= Util.formatCustomDate( currUser.getE01DTF(),msgPart.getE03CDRMOD(), msgPart.getE03CDRDAD(), msgPart.getE03CDRYED()) %></TD>
