...
<h3 align="center">Firmantes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_inq_firm_generic.jsp, EDD0000"></h3>
<hr size="4">
    ...
    <tr bgcolor="#FFFFFF" bordercolor="#FFFFFF"> 
      <td> 
        ...
        <tr id="trdark"> 
            ...
            <td nowrap> 
              <input type="text" name="E<%= name %>4RCN" maxlength="9" size="10" value="<%= rtFirm.getField("E" + name + "4RCN").getString().trim()%>" readonly>
	     ...
	     <tr id="trclear"> 
            ...
            <td nowrap> 
              <input type="text" name="E<%= name %>4MA1" maxlength="60" size="65" value="<%= rtFirm.getField("E" + name + "4MA1").getString().trim()%>" readonly>
            </td>
          </tr>
<%--
          <tr id="trdark"> 
         ...
         <tr id="trdark"> 
            ...
            <td width="23%" nowrap> 
              <input type="text" name="E<%= name %>4TID" maxlength="4" size="5" value="<%= rtFirm.getField("E" + name + "4TID").getString().trim()%>" >
               <a href="javascript:GetCodeCNOFC('E<%= name %>4TID','GD')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
            </td>
          </tr>
         <tr> 
            <td width="13%" nowrap> 
           ...
           <td width="23%" nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E<%= name %>4BNI','GM')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a> 	
            </td>
          </tr>
          <%} else {%>
		  <tr id="trdark"> 
...
--%>
		...
		<%} else if( rtFirm.getH04SCR().equals("18")){%> 	
		...
		<%}%>   
          ...
          <tr id="trclear"> 
            ...
            <td width="23%" nowrap> 
              <input type="text" name="E<%= name %>4BNI" maxlength="25" size="26" value="<%= rtFirm.getField("E" + name + "4BNI").getString().trim()%>" readonly>
            </td>
          </tr>
          <%}%>
          <tr id="trdark"> 
            ...
            <td width="23%" nowrap> 
              <input type="text" name="E<%= name %>4HPN" maxlength="15" size="16" value="<%= rtFirm.getField("E" + name + "4HPN").getString().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="13%" nowrap> 
...
<SCRIPT type="text/javascript">
   getElement('dataDiv').style.height=  getElement('mainTable8').offsetTop + getElement('mainTable8').offsetHeight +"";
</SCRIPT>
