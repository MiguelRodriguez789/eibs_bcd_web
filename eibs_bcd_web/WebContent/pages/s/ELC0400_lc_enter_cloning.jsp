...
<H3 align="center">Apertura de Cartas de Crédito Standby<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF"></H3>
<HR size="4">
  ...
  <TABLE class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
    <TR>
      ...
      <TD nowrap width="50%">
        ...
        <A href="javascript:GetAccount('E01CPYNUM','','ST','')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0" ></A>
      </TD>
    </TR>
    <TR>
