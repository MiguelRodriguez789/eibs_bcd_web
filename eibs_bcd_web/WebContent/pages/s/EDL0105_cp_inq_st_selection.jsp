...
<h3 align="center"> Estado de Cuenta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cp_inq_st_selection.jsp , EDL0105"> 
</h3>
<hr size="4">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="15%"> 
              <div align="left"> 
                ...
                <a href="javascript:DatePicker(document.forms[0].E01FRDTE1,document.forms[0].E01FRDTE2,document.forms[0].E01FRDTE3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="Ayuda" align="middle" border="0"></a></div>
            </td>
            <td nowrap width="10%"> 
            ...
            <td nowrap width="47%"> 
              <div align="left"> 
                ...
                <a href="javascript:DatePicker(document.forms[0].E01TODTE1,document.forms[0].E01TODTE2,document.forms[0].E01TODTE3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="Ayuda" align="middle" border="0"></a></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="27%" > 
