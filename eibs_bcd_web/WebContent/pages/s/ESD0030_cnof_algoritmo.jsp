...
%>
<body>
<H3 align="center">Códigos de Referencia del Sistema - Algoritmos Validacion Convenios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnof_algoritmo.jsp, ESD0030"></H3>
<hr size="4">
