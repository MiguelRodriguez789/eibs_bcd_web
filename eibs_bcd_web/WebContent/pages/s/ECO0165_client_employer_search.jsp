...
<title>Solicitud de Lista de Convenios por Empleados</title>
...
<h3 align="center">Solicitud de Lista de Convenios por Empleados
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_employer_search.jsp, ECO0165"></h3>
<hr size="4">
