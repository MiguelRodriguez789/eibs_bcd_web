...
<body bgcolor="#FFFFFF">
<h3 align="center">Mantenimiento - Moneda Extranjera <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_enter_maint, EFE0140B"></h3>
<hr size="4">
  ...
  <table class="tbenter" height="75%" width="100%" border="0">
    <tr>
      ...
      <td nowrap align="center"> N&uacute;mero de Cuenta : 
        <INPUT type="text" name="E01WKFACC" size="12" maxlength="9" onkeypress="enterInteger(event)">
              <a href="javascript:GetFexAcc('E01WKFACC')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
		<p align="center">&nbsp; </p>              
		<p align="center"> 
