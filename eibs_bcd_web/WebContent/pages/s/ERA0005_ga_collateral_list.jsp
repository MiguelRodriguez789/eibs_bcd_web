...
%>
  <h3 align="center">Asignación de Garantias a Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_collateral_list_fp,ERA005"></h3>
  <hr size="4">
  <BR>
  ...
  <p>&nbsp;</p><table class="tableinfo">
    <tr id="trdark"> 
      ...
      <th align=CENTER width="208" nowrap> 
        <div align="center">Valor de la Garantía</div>
      </th>
