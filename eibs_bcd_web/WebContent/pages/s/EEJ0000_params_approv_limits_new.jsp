...
<H3 align="center">Creacion de L&iacute;mites de Aprobaci&oacute;n de Ejecutivos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="params_approv_limits_new,EEJ0000"></H3>
<hr size="4">
  ...
  <table class="tableinfo">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E01EJLGRT','E01EJLGRN','Y0')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		  ...
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E01EJLGRC','E01EJLGRM',document.forms[0].E01EJLGRT.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
      	  </td>     
      	</tr>
      	<tr id=trdark> 
	      ...
	      <td nowrap>
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E01EJLJRQ','E01EJLJRN','YY')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
      	  </td>
     	</tr>
     	<tr id=trclear> 
	      ...
	      <td nowrap>
      	    ...
      	    <a href="javascript:GetCurrency('E01EJLCCY',<%=currUser.getE01UBK()%>)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
      	  </td>
     	</tr>
     	<tr id=trdark> 
     	...
     	<tr id=trclear> 
		  <td> 
		     <div align="right">Puntos Persona Física :</div>        
		  </td>
      	  <td nowrap> 
      	...
      	<tr id=trclear> 
		  <td> 
		     <div align="right">Montos Persona Física :</div>        
		  </td>
      	  <td nowrap> 
