...
<BODY>
<H3 align="center">Mantenimiento Carta de Crédito de Importación<IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="ELC0525_lc_opening_import_m.jsp"></H3>
<HR size="4">
<FORM>
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo" id="trclear">
            ...
            <TR id="trdark">
              ...
              <TD nowrap width="16%" align="left"><B>
                ...
                <%if (msg051001.getF01LCMTRF().equals("Y")) out.print("class=\"txtchanged\"");%>>
                </B> </TD>
    ...
    <TR id="">
      ...
      <TD nowrap><SELECT name="E01LCMAF4" disabled >
        ...
        <INPUT name="E01LCMABA" type="text" value="<%=msg051001.getE01LCMABA()%>" size="12" maxlength="12" readonly="readonly"
       		<%if (msg051001.getF01LCMABA().equals("Y")) out.print("class=\"txtchanged\"");%>>
           </TD>
    </TR>
    <TR id="">
      ...
      <TD align="left" nowrap><INPUT name="E01LCMABI" type="text" value="<%=msg051001.getE01LCMABI()%>" size="12" maxlength="12" readonly="readonly"
          		<%if (msg051001.getF01LCMABI().equals("Y")) out.print("class=\"txtchanged\"");%>>
         </TD>
    </TR>
    <TR id="">
      ...
      <TD align="left" nowrap><INPUT name="E01LCMAB1" type="text" value="<%=msg051001.getE01LCMAB1()%>" size="45" maxlength="35" readonly="readonly">
       		<%if (msg051001.getF01LCMAB1().equals("Y")) out.print("class=\"txtchanged\"");%>
          <IMG src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" border="0"></TD>
    </TR>
    <TR id="">
      ...
      <TD align="left" nowrap><INPUT name="E01LCMAB2" type="text" value="<%=msg051001.getE01LCMAB2()%>" size="45" maxlength="35" readonly="readonly"      
       		<%if (msg051001.getF01LCMAB2().equals("Y")) out.print("class=\"txtchanged\"");%>>
      </TD>    		
    </TR>
    <TR id="">
      <TD nowrap></TD>
      <TD align="left" nowrap><INPUT name="E01LCMAB3" type="text" value="<%=msg051001.getE01LCMAB3()%>" size="45" maxlength="35" readonly="readonly"      
       		<%if (msg051001.getF01LCMAB3().equals("Y")) out.print("class=\"txtchanged\"");%>>
      </TD>
    </TR>
    <TR id="">
      <TD nowrap></TD>
      <TD align="left" nowrap><INPUT name="E01LCMAB4" type="text" value="<%=msg051001.getE01LCMAB4()%>" size="45" maxlength="35" readonly="readonly"      
       		<%if (msg051001.getF01LCMAB4().equals("Y")) out.print("class=\"txtchanged\"");%>>
      </TD>
    </TR>
    <TR id="">
      <TD align="right" valign="bottom" nowrap>Estado: </TD>
      <TD align="left" nowrap><INPUT name="E01LCMAB5" type="text" value="<%=msg051001.getE01LCMAB5()%>" size="4" maxlength="4" readonly="readonly"
       		<%if (msg051001.getF01LCMAB5().equals("Y")) out.print("class=\"txtchanged\"");%>>
        Cddigo Postal
        <INPUT name="E01LCMAB6" type="text" value="<%=msg051001.getE01LCMAB6()%>" size="16" maxlength="15" readonly="readonly"
       		<%if (msg051001.getF01LCMAB6().equals("Y")) out.print("class=\"txtchanged\"");%>>
        País
        <INPUT name="E01LCMAB7" type="text" value="<%=msg051001.getE01LCMAB7()%>" size="4" maxlength="4" readonly="readonly"
       		<%if (msg051001.getF01LCMAB7().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
    </TR>
    <TR id="">
  ...
  <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
    ...
    <TR id="">
      ...
      <TD align="left" nowrap><INPUT name="E01LCMCA5" type="text" value="<%=msg051001.getE01LCMCA5()%>" size="4" maxlength="4" readonly="readonly"
        ...
        País
        <INPUT name="E01LCMCA7" type="text" value="<%=msg051001.getE01LCMCA7()%>" size="4" maxlength="4" readonly="readonly"
