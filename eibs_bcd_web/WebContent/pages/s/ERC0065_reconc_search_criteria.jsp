...
<h3 align="center"> Ajuste Transacciones Reconciliaci&oacute;n Bancaria<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="reconc_search_criteria,ERC0065"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="32%">
              <input type="text" name="E01RCTACC" size="14" maxlength="12" onKeypress="enterInteger(event)">
