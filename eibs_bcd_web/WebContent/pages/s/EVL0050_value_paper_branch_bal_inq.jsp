...
<H3 align="center">Consulta de Saldos de Papel Valor por Oficina<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_branch_bal_inq,EVL0050"></H3>
<hr size="4">
<p>&nbsp;</p>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01LVLBNK" size="3" maxlength="2" onkeypress="enterInteger(event)" value="<%=(msgMT.getE01LVLBNK().equals(""))?currUser.getE01UBK():msgMT.getE01LVLBNK()%>">
	      </td>
     	</tr>
     	<tr id=trclear> 
	      <td nowrap width="40%"> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01LVLBRN" size="5" maxlength="4" value="<%=(msgMT.getE01LVLBRN().equals("0"))?currUser.getE01UBR():msgMT.getE01LVLBRN()%>" >
	        <a href="javascript:GetBranch('E01LVLBRN',document.forms[0].E01LVLBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
	      </td>
     	</tr>
     	<tr id=trdark> 
		  <td> 
