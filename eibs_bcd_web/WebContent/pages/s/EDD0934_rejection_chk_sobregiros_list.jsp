...
function goPrint(){
location= "${pageContext.request.contextPath}/pages/s/EDD0934_rejection_chk_sobregiros_print.jsp";
}
...
%> 
<h3 align="center">Sobregiros  por Rangos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rejection_chk_sobregiros_list.jsp, EDD0934"></h3>
<hr size="4">
