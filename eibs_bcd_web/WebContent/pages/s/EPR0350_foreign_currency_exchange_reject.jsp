...
<SCRIPT type="text/javascript">
  ...
  function goAction() {
  	document.forms[0].RAZON1.value = document.forms[0].E01REQRJ1.value;
  	document.forms[0].RAZON2.value = document.forms[0].E01REQRJ2.value;
...
<h3 align="center">Compraventa Moneda Extranjera<BR>Rechazo de Liquidacion de Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_reject, EPR0350"></H3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEPR0350">
  ...
  <INPUT TYPE=HIDDEN NAME="RAZON1">
  <INPUT TYPE=HIDDEN NAME="RAZON2">  
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trclear> 
          ...
          <td nowrap>
              <input type="text" name="E01REQSTN" readonly size="10" maxlength="10" value="<%= msgInst.getE01REQSTN() %>">
          </td>
        </tr>
     </table>
    </td>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		<tr>
			...
			<td nowrap width="60%">
				<input type="text" name="E01REQORN" size="40" maxlength="40" value="<%= msgInst.getE01REQORN() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
...
<table class="tableinfo">    
	<tr>
		...
		<td nowrap width="60%">
			<input type="text" name="E01REQRJS" size="45" maxlength="40" value="<%= msgInst.getE01REQRJS() %>"> 
		</td>
	</tr>
</table>
     
<p align="center"> 
   <input id="EIBSBTN" type="submit" name="Submit" value="Enviar" onclick="goAction()">
</p>
