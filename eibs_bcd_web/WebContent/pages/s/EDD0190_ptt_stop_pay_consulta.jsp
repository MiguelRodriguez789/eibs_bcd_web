...
<h3 align="center">Consulta Protesto Manual<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ptt_stop_pay_consulta.jsp , EDD0190"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
		  ...
		  <tr id="trclear"> 
		   ...
		   <tr id="trdark"> 
            ...
            <td nowrap colspan="1"><%= Util.formatCell(stop.getRecord(6)) %></td>
			<td nowrap> 
