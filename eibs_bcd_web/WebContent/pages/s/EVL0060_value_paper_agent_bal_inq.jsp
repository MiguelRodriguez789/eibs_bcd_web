...
<H3 align="center">Consulta de Saldos de Papel Valor por Asesor<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_agent_bal_inq,EVL0060"></H3>
<hr size="4">
<p>&nbsp;</p>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01DOCBNK" size="3" maxlength="2" onkeypress="enterInteger(event)" value="<%= (msgMT.getE01DOCBNK().equals(""))?currUser.getE01UBK():msgMT.getE01DOCBNK()  %>">
	      </td>
     	</tr>
     	<tr id=trclear> 
	      <td nowrap width="40%"> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01DOCBRN" size="5" maxlength="4" value="<%=(msgMT.getE01DOCBRN().equals("0"))?currUser.getE01UBR():msgMT.getE01DOCBRN()%>">
	        <a href="javascript:GetBranch('E01DOCBRN',document.forms[0].E01DOCBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
	      </td>
     	</tr>
     	<tr id=trdark> 
		  <td> 
