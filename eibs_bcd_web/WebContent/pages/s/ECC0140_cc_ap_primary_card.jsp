...
<body>
<h3 align="center">Tarjeta de credito primaria<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_ap_primary_card.jsp, ECC0140"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%">
              <eibsinput:date name="ccPrim" fn_month="E01CCRISM" fn_day="E01CCRISD" fn_year="E01CCRISY" readonly="true" /> 
  			</td>
          </tr>   
          <tr id="trclear"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%"> 
              <eibsinput:date name="ccPrim" fn_month="E01CCREXM" fn_day="E01CCREXD" fn_year="E01CCREXY" readonly="true" /> 
            </td>
            <td nowrap width="25%"> 
