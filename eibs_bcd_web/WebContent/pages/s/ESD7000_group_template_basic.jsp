      ...
      <td nowrap > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap> 
              <input type="radio" name="E01BTHFL2" value="Y" <%if (user.getE01BTHFL2().equals("Y")) out.print("checked"); %>>Sí
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap> 
              <input type="radio" name="E01BTHFL1" value="Y" <%if (user.getE01BTHFL1().equals("Y")) out.print("checked"); %>>Sí
            ...
            <td nowrap> 
              <input type="radio" name="E01BTHFL4" value="Y" <%if (user.getE01BTHFL4().equals("Y")) out.print("checked"); %>>Sí
