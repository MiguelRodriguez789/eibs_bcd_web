...
<%if (!error.getERRNUM().equals("0")) {
	...
	String title = "Consulta de Standby Cartas de Crédito ["; 
	int lines = 0;
	int chars = 0;
	int size = 0;
...
<H3 align="center"><%= title %>
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sb_field_info.jsp, ELC0525"></H3>
<HR size="4">
