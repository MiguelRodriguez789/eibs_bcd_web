...
<h3 align="center">Clases de Entradas ACH<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="ach_classes_list.jsp, EACH120"></h3>
<hr size="4">
...
<TABLE class="tbenter"> 
	<TR>
		<TD align="CENTER" class="TDBKG" width="33%">
			<a href="javascript:goNew()"><b>Crear<br>Clase</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="33%">
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    ...
    <TR id=trdark>
		...
		<TD nowrap align="right" width="10%" valign="top">
			<INPUT type="text" name="E01ACEAMT_<%= EACH120List.getCurrentRow() %>" value="<%= msgList.getE01ACEAMT() %>" size="22" maxlength="20" <%= read %>
			onkeypress="enterDecimal()">
		</TD>
		<TD nowrap align="center" width="10%" valign="top">
			<INPUT type="text" name="E01ACEDFI_<%= EACH120List.getCurrentRow() %>" value="<%= msgList.getE01ACEDFI() %>" size="12" maxlength="10" <%= read %>>
			<A
