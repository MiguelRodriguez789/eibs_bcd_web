...
<H3 align="center">Accionistas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_stocks_holders.jsp, ESD0086"></H3>
<hr size="4">
  ...
  <table  class="tableinfo" width="100%">
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="15%" align="right">Número/Porcentaje Acciones :</td>
            <td nowrap width="35%" align="left">
                <input type="text" name="E01CON" size="10" maxlength="9" value="<%= ESD0086Record.getE01CON().trim()%>" <%=readM%> onkeypress="enterInteger(event)">
            </td>
