...
<h3 align="center">Documento Telex <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="EDD0610_tr_inq_telex.jsp"></h3>
<hr size="4" width="100%">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" ><font face="Arial"><font size="2"> 
				<eibsinput:date name="inqTelex" fn_year="E04INSDTY" fn_month="E04INSDTM" fn_day="E04INSDTD" readonly="true"/>
            </font></font></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="23%"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="17%"> 
              <div align="left"><font size="2"> Cliente Beneficiario:</font> 
              </div>
            </td>
            <td nowrap colspan="2"> 
              <div align="left"></div>
