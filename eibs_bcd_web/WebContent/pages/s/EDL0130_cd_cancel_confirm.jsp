...
<h3 align="center">Confirmaci&oacute;n de Pre-Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_cancel_confirm, EDL0130" ></h3>
<hr size="4">
<br>
...
<table class="tableinfo">
  <tr > 
    ...
    <td> 
      <p align="center">El prepago del Certificado de Deposito n&uacute;mero <b><%= datapro.eibs.master.Util.justifyRight(userPO.getAccNum(),12)%></b> 
