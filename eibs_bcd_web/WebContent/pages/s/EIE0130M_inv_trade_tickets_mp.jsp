...
%>
<div align="center"> 
  <h3>M&uacute;ltiples Ordenes Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_trade_tickets_mp.jsp,EIE0130M"> 
  </h3>
</div>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0130M" >
  <h4>Informaci&oacute;n Orden Maestra
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="14%" > 
              <div align="right"><a href="javascript:showCustomerInq(document.forms[0].E02ORDCUN.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" title="help" align="bottom" border="0" > 
                Cliente</a>:</div>
            </td>
            <td nowrap width="33%" > 
          ...
          <tr id="trclear"> 
            <td nowrap width="17%" > 
              <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].E02ORDMIC.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" title="help" align="bottom" border="0" > 
                Instrumento </a> </div>
            </td>
            <td nowrap width="36%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="36%" > 
              ...
              <input type="text" readonly  name="E02ORDIN3" size="5" maxlength="4" value="<%= invMult.getE02ORDIN3()%>">
            </td>
            <td nowrap width="14%" > 
            ...
            <td nowrap width="33%" > 
              ...
              <input type="text" readonly  name="E02ORDST3" size="5" maxlength="4" value="<%= invMult.getE02ORDST3()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="14%" > 
              <div align="right"><a href="javascript:showRetAccountInq(document.forms[0].E02ORDHAC.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" title="help" align="bottom" border="0" > 
