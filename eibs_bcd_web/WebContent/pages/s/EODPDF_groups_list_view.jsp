...
<H3 align="center">Seleccione un Grupo <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="EODPDF_groups_list_view.jsp, JSEODPDF"></H3>
<hr size="4">
