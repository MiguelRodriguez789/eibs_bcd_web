...
<h3 align="center">Posición del Oficial Por Cuenta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cust_exec_position.jsp,ECIF170"></h3>
<hr size="4">
