          ...
          <tr id="trdark">
            ...
            <td nowrap width="33%" >
              <div align="left">
                ...
                <input type="text" readonly  name="E01ORDPBR" size="4" maxlength="4" value="<%= invTrade.getE01ORDPBR()%>">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01ORDHAC" size="13" maxlength="12" value="<%= invTrade.getE01ORDHAC()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
