...
<HEAD>
<TITLE>
Lista de Compañias - Pago y Cobro de Servicios
</TITLE>
...
<h3 align="center">Lista de Compañias - Pago y Cobro de Servicios
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_cias_list.jsp,SRV0050">
</h3>
<hr size="4">
...
%> 
  ...
  <TABLE class="tbenter" width=100% height=40%>
      ...
      <TD> 
        <div align="center"> 
          <p>
            <b>No existen registros de compañias. Haga click en la opcion "Nuevo" para crear un registro </b>
          </p>          
        </div>
      </TD>
     </TR>
  ...
  <TR> 
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
  		<TR id="trdark"> 
  			<TH ALIGN=CENTER ></TH>
    		<TH ALIGN=CENTER >Codigo de Compañia</TH>
    		<TH ALIGN=CENTER >Nombre de Compañia</TH>
