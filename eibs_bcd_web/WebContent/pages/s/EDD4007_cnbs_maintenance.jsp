...
<H3 align="center"><%= title %> <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnbs_maintenance.jsp, EDD4007"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="80%" colspan="3"> 
                <eibsinput:text name="cnbsDetails" property="E01MA1" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_DESCRIPTION %>" required="false" readonly="false"/>
            </td>
          </tr> 
         ...
         <tr id="trdark"> 
           ...
           <td nowrap width="50%">
			 <eibsinput:text name="cnbsDetails" property="E01MA2" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME %>" required="false" readonly="false"/>                
		   </td>
         </tr> 
         ...
         <tr id="trclear"> 
           ...
           <td nowrap width="50%">
			 <eibsinput:text name="cnbsDetails" property="E01AM1" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME %>" required="false" readonly="false"/>                
		   </td>
         </tr> 
