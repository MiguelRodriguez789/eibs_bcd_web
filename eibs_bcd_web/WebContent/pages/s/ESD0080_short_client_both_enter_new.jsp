		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trclear">
				...
				<input type="radio" id="corp" name="TYPE" value="CORPORATIVE" <%= idData.isLegalType("CORPORATIVE") ? "checked" : "" %> 
					onclick="showIdFields(document.forms[0].COUNTRY.value, this.value);toggleActEmp(false);" >Moral 
				</label>
				<label for="pers" >
				<input type="radio" id="pers" name="TYPE" value="PERSONAL" <%= !isChecked ? "checked" : "" %> 
					onclick="showIdFields(document.forms[0].COUNTRY.value, this.value);toggleActEmp(true);" >Física
				</label>
				<div id="actEmp" style="display: none; padding-left: 60px; " >
					Actividad Empresarial
					<input type="radio" id="pers1" name="E20CFL2" value="1"   >Si
					<input type="radio" id="pers1" name="E20CFL2" value="0" checked="checked"  >No
