...
location= "${pageContext.request.contextPath}/pages/s/EDD0190_ptt_stop_pay.jsp";
}
}
</SCRIPT> 
</head>
   ...
   <TD NOWRAP valign="top" width="100%" >
     ...
     <TR id="trdark">  
            ...
            <TH ALIGN=CENTER NOWRAP width="140"> 
              <DIV ALIGN=CENTER >Fecha / Hora</DIV>
            </TH>
     </TR>
    </TABLE>
    ...
    <TR> 
      ...
      <TD ALIGN=CENTER NOWRAP width="140"><%= Util.formatDate(stop.getRecord(3),stop.getRecord(4),stop.getRecord(5)) %> - <%= Util.formatCell(stop.getRecord(6)) %></TD>
