...
<h3 align="center">Aprobaci&oacute;n de Cobranza Simple<br>C&oacute;digos Especiales
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sing_codes.jsp, EDC0040" width="35" height="35"></h3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0" height="118">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02GEC','D02GEC','03')"></a><img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" border="0" align="middle"> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="30%"> 
