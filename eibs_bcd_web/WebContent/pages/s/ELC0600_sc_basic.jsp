...
<h3 align="center">Tabla de Gastos y Comisiones de Cartas de Crédito<img
	...
	name="EIBS_GIF" title="sc_basic.jsp,ELC0600"></h3>
<hr size="4">
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trclear">
				...
				<td nowrap height="34">
				<div align="right"><b>Descripción de Tabla :</b></div>
				</td>
				<td nowrap colspan="3" height="34">
				<div align="left"><input type="text" name="E01RLCDSC" size="48"
					maxlength="45" value="<%= sc.getE01RLCDSC().trim()%>"><A
			href="javascript:GetCorrespondentDescIdSwift('E01PRIRID','','')"></A></div>
				</td>
			</tr>
</table>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<TR id="trclear">
				...
				<DIV align="center"><INPUT type="text" name="E01RLCGIS" size="18"
							...
							<A href="javascript:GetLedger('E01RLCGIS',document.forms[0].E01RLCBNK.value,document.forms[0].E01RLCACY.value,'', 'E01DSCGIS')">
							<IMG src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0"></A>
				</DIV>
				</TD>
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGIS" size="60" maxlength="60" value="<%= sc.getE01DSCGIS().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGAD" size="60" maxlength="60" value="<%= sc.getE01DSCGAD().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGCO" size="60" maxlength="60" value="<%= sc.getE01DSCGCO().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGEV" size="60" maxlength="60" value="<%= sc.getE01DSCGEV().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGAM" size="60" maxlength="60" value="<%= sc.getE01DSCGAM().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGAA" size="60" maxlength="60" value="<%= sc.getE01DSCGAA().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGDI" size="60" maxlength="60" value="<%= sc.getE01DSCGDI().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGPM" size="60" maxlength="60" value="<%= sc.getE01DSCGPM().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGAC" size="60" maxlength="60" value="<%= sc.getE01DSCGAC().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGDP" size="60" maxlength="60" value="<%= sc.getE01DSCGDP().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGNE" size="60" maxlength="60" value="<%= sc.getE01DSCGNE().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGAS" size="60" maxlength="60" value="<%= sc.getE01DSCGAS().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGTR" size="60" maxlength="60" value="<%= sc.getE01DSCGTR().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGPO" size="60" maxlength="60" value="<%= sc.getE01DSCGPO().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGCR" size="60" maxlength="60" value="<%= sc.getE01DSCGCR().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGCA" size="60" maxlength="60" value="<%= sc.getE01DSCGCA().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGNF" size="60" maxlength="60" value="<%= sc.getE01DSCGNF().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGWT" size="60" maxlength="60" value="<%= sc.getE01DSCGWT().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGTF" size="60" maxlength="60" value="<%= sc.getE01DSCGTF().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01DSCGTM" size="60" maxlength="60" value="<%= sc.getE01DSCGTM().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01RLCCD1" size="60" maxlength="60" value="<%= sc.getE01RLCCD1().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01RLCCD2" size="60" maxlength="60" value="<%= sc.getE01RLCCD2().trim()%>" readonly></DIV>
				</TD>
			</TR>
</TABLE>
