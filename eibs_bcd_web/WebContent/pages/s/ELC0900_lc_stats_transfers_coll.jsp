...
<H3 align="center">Estadísticas de Transacciones de Cobranzas<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_stats.jsp, ELC0900"></H3>
<HR size="4">

<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0900">
<INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="6">

<h4>Estadisticas de Transacciones de Cobranzas</h4>
