...
<frameset  rows="250,*" cols="*"> 
  <frame name="query" src="<%=request.getContextPath()%>/pages/s/ESD0080_client_inq_both_enter_search.jsp" marginwidth=5 marginheight=10 scrolling="no" frameborder="0">
