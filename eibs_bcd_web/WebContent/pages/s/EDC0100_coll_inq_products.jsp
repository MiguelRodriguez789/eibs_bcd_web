...
<h3 align="center">Consulta de Producto de Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="coll_inq_products, EDC0100"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="55%"> 
              ...
              <a href="javascript:showCOLServCharge('<%= colProdInq.getE05APCBNK().trim()%>','<%= colProdInq.getE05APCTYP().trim()%>','<%= colProdInq.getE05APCTLN().trim()%>');"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="45%"> 
