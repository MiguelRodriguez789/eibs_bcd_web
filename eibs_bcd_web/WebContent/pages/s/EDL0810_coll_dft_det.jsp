...
%> 
<h3 align="center">Carta Guia de Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="collection_basic.jsp,EDL0810"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="left">
                ...
                <a href="javascript:GetCustomerDescId('E01DLHCUN','E01CUSNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a></div>
            </td>
            <td nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="left">
                <input type="text" name="E01DLHPRO" size="4" maxlength="4" value="<%= collBasic.getE01DLHPRD() %>" readonly>
              </div>
            </td>
          </tr>
        </table>
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap> 
              <div align="right"><b>No. Deudor :</b></div>
            </td>
            <td nowrap> 
              <div align="left">
            ...
            <td nowrap> 
              <div align="right"><b>Nombre Deudor :</b></div>
            </td>
            <td nowrap colspan="3" > 
              <div align="left">
                <input type="text" name="E01CUSNA1" size="45" maxlength="45" value="<%= collBasic.getE01CUSNA1() %>" readonly>
          ...
          <tr id="trclear"> 
            <td nowrap> 
              <div align="right"><b>R.U.T Deudor :</b></div>
            </td>
            <td nowrap> 
              <div align="left">
                <input type="text" name="E01DLHCUN" size="9" maxlength="9" value="<%= collBasic.getE01DLHCUN() %>" readonly>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
				<eibsinput:date name="dftBasic" fn_year="E02DLDFVY" fn_month="E02DLDFVM" fn_day="E02DLDFVD" />
            </td>
            <td nowrap width="25%"> 
              <div align="right">No. de Documentos :</div>
            </td>
            <td nowrap>
              <INPUT type="text" name="E01DLHNDO" size="3" maxlength="2" value="<%= collBasic.getE01DLHNDO() %>" onkeypress="enterInteger(event)">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="E01DLHCAC" size="12" maxlength="12" value="<%= collBasic.getE01DLHCAC() %>" onkeypress="enterInteger(event)">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap>
              <INPUT type="text" name="E01DLHDAC" size="12" maxlength="12" value="<%= collBasic.getE01DLHDAC() %>" onkeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E01DLHDAC','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
