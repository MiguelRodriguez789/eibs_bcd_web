...
<H3 align="center">Comisiones y Gastos de Cartas de Credito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sc_enter_selection, ELC0600"></H3>
   ...
   <tr> 
      <td > 
        <table id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">      
	      ...
	      <td width="51%" nowrap> 
    	    <input type="text" name="E01RLCATY"  size=5 maxlength="4" value="">
