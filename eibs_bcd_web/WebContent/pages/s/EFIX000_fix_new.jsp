...
<html>
<head>
<title>Apertura Activos Fijos / Amortizaciones</title>
...
<h3 align="center">Apertura Activos Fijos / Amortizaciones
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fix_new.jsp, EFIX000"> 
</h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2"> 
			  ...
			  <a href="javascript:GetLedger('E01FIXGLN',document.forms[0].E01FIXBNK.value,'','','E01GLNDSC','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a>
              <input type="text" name="E01GLNDSC" size="30" maxlength="30" value="<%= fix.getE01GLNDSC().trim()%>" readonly>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="30%"> 
                <input type="text" name="E01FIXREF" size="12" maxlength="10" value="<%= fix.getE01FIXREF()%>" >
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" > 
              <input type="text" name="E01FIXFAC" size="12" maxlength="10" value="<%= fix.getE01FIXFAC().trim()%>">
            </td>
            <td nowrap width="20%" > 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01FIXSER" size="17" maxlength="15" value="<%= fix.getE01FIXSER().trim()%>">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="30%" > 
              <input type="text" name="E01FIXRE2" size="12" maxlength="10" value="<%= fix.getE01FIXRE2().trim()%>" onKeypress="enterInteger(event)">
            </td>
            <td nowrap width="20%" > 
              <div align="right">Marca :</div>
            </td>
            <td nowrap width="30%" > 
              <input type="text" name="E01FIXMAR" size="17" maxlength="15" value="<%= fix.getE01FIXMAR()%>">
       		  <img src="<%=request.getContextPath()%>/images/Check.gif" align="bottom" border="0"/>
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" > 
              <input type="text" name="E01FIXPUS" size="17" maxlength="15" value="<%= fix.getE01FIXPUS().trim()%>" onKeypress="enterDecimal(event, 2)">
            </td>
            <td nowrap width="20%" > 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01FIXTIC" size="10" maxlength="9" value="<%= fix.getE01FIXTIC().trim()%>" onKeypress="enterDecimal(event, 2)"
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="30%" > 
              <input type="text" name="E01FIXPPR" size="17" maxlength="15" value="<%= fix.getE01FIXPPR().trim()%>" onKeypress="enterDecimal(event, 2)">
       		  <img src="<%=request.getContextPath()%>/images/Check.gif" align="bottom" border="0"/>
              <font color="red">VERIFIQUE QUE EL MONTO SEA EL CORRECTO!</font>
            </td>
            <td nowrap width="20%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%"> 
              <input type="text" name="E01FIXPRT" size="7" maxlength="6" value="<%= fix.getE01FIXPRT().trim()%>" onKeypress="enterDecimal(event, 2)"
			  >
            </td>
            <td nowrap width="20%"> 
            ...
            <td nowrap width="30%"> 
              <div align="left"> 
                <input type="text" name="E01FIXRVA" size="17" maxlength="15" value="<%= fix.getE01FIXRVA().trim()%>" onKeypress="enterDecimal(event, 2)">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="30%"> 
              <div align="left"> 
               <eibsinput:date name="fix" fn_year="E01FIXPDY" fn_month="E01FIXPDM" fn_day="E01FIXPDD" required="true"/>
            ...
            <td nowrap width="30%"> 
              <div align="left"> 
                <eibsinput:date name="fix" fn_year="E01FIXD1Y" fn_month="E01FIXD1M" fn_day="E01FIXD1D" />
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%"> 
              <div align="left"> 
                <eibsinput:date name="fix" fn_year="E01FIXD3Y" fn_month="E01FIXD3M" fn_day="E01FIXD3D" />
 				                      
              </div>
            </td>
            <td nowrap width="20%" > 
              <div align="right">Teléfonos de Contacto :</div>
            </td>
            <td nowrap width="30%"> 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="30%"> 
              <input type="text" name="E01FIXPIN" size="6" maxlength="9" value="<%= fix.getE01FIXPIN().trim()%>" >
              <input type="text" name="E01VENDSC" size="40" maxlength="30" value="<%= fix.getE01VENDSC().trim()%>"  readonly>
              <a href="javascript:GetVendorBP('E01FIXPIN','E01VENDSC')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a>
       		  <img src="<%=request.getContextPath()%>/images/Check.gif" align="bottom" border="0"/>
            </td>
            <td nowrap width="20%" > 
            ...
            <td nowrap width="30%"> 
              <div align="left"> 
                <input type="text" name="E01FIXRMK" size="52" maxlength="50" value="<%= fix.getE01FIXRMK().trim()%>" 
			  >
              </div>
            </td>
          </tr>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="30%"> 
              <div align="left"> 
                <eibsinput:cnofc name="fix" flag="f3" property="E01FI2TIM" fn_code="E01FI2TIM" fn_description="E01FI2DTE" />
