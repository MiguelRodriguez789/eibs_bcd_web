...
String action = "";
 ...
 if (userPO.getPurpose().equals("PDN")) {
   ...
   action = request.getContextPath() + "/servlet/datapro.eibs.client.JSESD1080?SCREEN=3";
 }
%>
<h3 align="center"><%= title %> Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="sol_enter_search,EDD1500"></h3>
<hr size="4">
