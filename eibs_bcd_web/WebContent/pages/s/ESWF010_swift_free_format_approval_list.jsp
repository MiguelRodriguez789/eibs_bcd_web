...
<body  onLoad="MM_preloadImages('<%=request.getContextPath()%>/images/s/New_over.gif','<%=request.getContextPath()%>/images/s/approve_over.gif','<%=request.getContextPath()%>/images/s/reject_over.gif','<%=request.getContextPath()%>/images/s/delete_over.gif')">
<% 
...
%>
<h3 align="center">Swift - Formatos Libres</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSESWF010" >
  <p> 
   ...
   <INPUT TYPE=HIDDEN NAME="SWIFTFREE" id="SWIFTFREE" VALUE="Y">
  </p>
  <%
  ...
  <table class="tbenter" width="13%" height="59">
    <tr> 
      ...
      <TD ALIGN=CENTER class=TDBKG> 
        <div align=center> <a href="javascript:goAction(2)"><b>Modificar</b></a> 
        </div> 
      </TD>
      <TD ALIGN=CENTER class=TDBKG> 
        <div align=center> <a href="javascript:goAction(6)"><b>Copiar</b></a> 
      ...
      <TD ALIGN=CENTER class=TDBKG> 
        <div align=center> <a href="javascript:goAction(3)"><b>Consultar</b></a> 
        </div> 
      </TD>
      <TD ALIGN=CENTER class=TDBKG> 
        <div align=center> <a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Salir</b></a> 
