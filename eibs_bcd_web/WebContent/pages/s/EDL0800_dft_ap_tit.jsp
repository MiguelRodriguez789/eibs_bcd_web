...
%> 
<h3 align="center">Titulares <%= userPO.getHeader4().trim()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dft_ap_tit.jsp, EDL0800"></h3>
<hr size="4">
