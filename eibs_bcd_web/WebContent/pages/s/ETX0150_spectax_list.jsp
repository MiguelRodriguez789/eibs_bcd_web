...
<BODY>
<h3 align="center">Control de Pago de Iva Especial<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="spectax_list.jsp, ETX0150"></h3>
<hr size="4">
        ...
        <table id="headTable" width="100%">
		 ...
		 %>
          <tr> 
            ...
            <td NOWRAP  align=CENTER width=\"10%\"><%= Util.formatDate(msgList.getE01TXCPDD(),msgList.getE01TXCPDM(),msgList.getE01TXCPDY())+'-'+Util.formatCell(msgList.getE01TXCPDT())  %></td>
