...
<h3 align="center">Cotizador de Préstamos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sim_enter,EDL6001"></h3>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
              ...
              <input type="text" name="E01MONPRE" size="15" maxlength="15" value="<%= lnBasic.getE01MONPRE().trim()%>" onKeypress="enterDecimal(event)">
               <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0">
              </td>
