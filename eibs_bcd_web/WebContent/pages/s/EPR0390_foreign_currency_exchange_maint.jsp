...
<h3 align="center">Compraventa Moneda Extranjera<BR>Reversion de Operaciones Diarias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_maint, EPR0390"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQLD1" size="3" maxlength="2" value="<%= msgInst.getE01REQLD1() %>" readonly>
                <input type="text" name="E01REQLD2" size="3" maxlength="2" value="<%= msgInst.getE01REQLD2() %>" readonly>
                <input type="text" name="E01REQLD3" size="5" maxlength="4" value="<%= msgInst.getE01REQLD3() %>" readonly>
			</td>
		</tr>
     </table>
    </td>
