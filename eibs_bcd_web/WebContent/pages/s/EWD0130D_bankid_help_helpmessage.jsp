...
function enter(code,desc,city,ctry) {
	...
	if (isValidObject(form[top.opener.fieldName])) form[top.opener.fieldName].value = code;
  	...
  	if (isValidObject(form[top.opener.fieldAux1])) {form[top.opener.fieldAux1].value = city;}
  	if (isValidObject(form[top.opener.fieldAux2])) {form[top.opener.fieldAux2].value = ctry;}
	top.close();
}
