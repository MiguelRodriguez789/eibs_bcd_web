...
<jsp:useBean id= "proEmp" class= "datapro.eibs.beans.ESD000004Message"  scope="session" />
...
%> 
<h3 align="center">Proveedores de Empresa<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_both_pro_emp, ESD0080"></h3>
<hr size="4">
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080" >
 <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="86">
      ...
      <td nowrap >
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
         ...
         <tr id="trdark"> 
           ...
           <td width="58%" nowrap> 
             <input type="text" name="E<%= name %>4RCN" maxlength="9" size="10" value="<%= proEmp.getField("E" + name + "4RCN").getString().trim()%>">
         ...
         <tr id="trclear"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA1" maxlength="60" size="65" value="<%= proEmp.getField("E" + name + "4MA1").getString().trim()%>">
            </td>
          </tr>
         <tr> 
       ...
       <%if(!(currUser.getE01INT().equals("11"))){ %>
         ...
         <tr> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4HPN" maxlength="15" size="16" value="<%= proEmp.getField("E" + name + "4HPN").getString().trim()%>">
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4BNI" maxlength="25" size="26" value="<%= proEmp.getField("E" + name + "4BNI").getString().trim()%>">
              </td>
          </tr>         
          <tr id="trclear">
            <td width="42%" > 
            ...
            <td width="58%" nowrap > 
              <input type="text" name="E<%= name %>4TID" value="<%= proEmp.getField("E" + name + "4TID").getString().trim()%>" size="5" maxlength="4">
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4PID" size="5" maxlength="4" value="<%= proEmp.getField("E" + name + "4PID").getString().trim()%>">
