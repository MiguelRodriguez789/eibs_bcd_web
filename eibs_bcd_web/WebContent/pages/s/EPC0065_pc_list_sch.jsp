...
<HTML>
<HEAD>
<TITLE>Desembolsos Relacionados con Proyectos de Construcción</TITLE>
...
<h3 align="center">Desembolsos Relacionados con Proyectos de Construcción<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_list_sch.jsp,EPC0065"> 
</h3>
<hr size="4">
...
<TABLE class="tbenter">
 ...
 %>
    ...
    <TD ALIGN=CENTER CLASS=tdbkg width="33.3%"><a href="javascript:goAction('4')">Ampliación</a></TD>    
 <% } %>
