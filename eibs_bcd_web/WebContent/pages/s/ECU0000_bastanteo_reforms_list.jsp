...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_reforms_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMTRef.getE04CURAC1(),msgMTRef.getE04CURAC2(),msgMTRef.getE04CURAC3())  + " - " + msgMTRef.getE04CURACT()%></TD>
