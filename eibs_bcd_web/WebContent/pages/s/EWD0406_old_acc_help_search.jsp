...
<script type="text/javascript">
	...
	var client = top.top.opener.Custumer;
...
<body>
<h3 align="center">Consulta de Cuenta Vieja - Cuenta Nueva<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="old_acc_help_search, EWD0406"></h3>
<hr size="4">
  ...
  <table id="tbhelp" align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<TR>
		...
		<TD align="left" width="25%"><INPUT type="text" name="NewAcc"
			...
			href="javascript:GetAccount('NewAcc','','',document.forms[0].Customer.value)"> <IMG
			src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"
...
<script type="text/javascript">
	if (client) {
		document.forms[0].Customer.value = client;
	}
