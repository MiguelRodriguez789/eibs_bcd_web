...
<H3 align="center">Mantenimiento de Cuentas entre Banco / Agencias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="interbranch_maintenance.jsp, EIB0000"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" > 
              <div align="center"><b><font face="Arial"><font face="Arial"><font size="2"> 
                <input type="text" name="E02IBTDFR" size="5"  maxlength="4" value="<%= branch.getE02IBTDFR().trim()%>" readonly>
                </font></font></font></b></div>
            </td>
            <td nowrap width="20%" > 
              <div align="center"><b><font face="Arial"><font face="Arial"><font size="2"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="center"><b><font face="Arial"><font face="Arial"><font size="2"> 
                <input type="text" name="E02IBTDTR" size="5"  maxlength="4" value="<%= branch.getE02IBTDTR().trim()%>" readonly>
                </font></font></font></b></div>
            </td>
            <td nowrap width="20%" > 
              <div align="center"></div>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="60%"> 
              <div align="left"> 
                ...
                <input type="text" name="E02GLDDFA" size="45" maxlength="45" value="<%= branch.getE02GLDDFA().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="60%" > 
              ...
              <img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
              <input type="text" name="E02GLDDTA" size="45" maxlength="45" value="<%= branch.getE02GLDDTA().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%" ><b><font face="Arial"><font face="Arial"><font size="2"> 
              ...
              <a href="javascript:GetCode('E02IBTENT','STATIC_branch_ini.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a></font></font></font></b> 
            </td>
          </tr>
        </table>
      </td>
