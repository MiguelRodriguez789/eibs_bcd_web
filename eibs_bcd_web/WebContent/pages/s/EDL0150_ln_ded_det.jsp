...
<h3 align="center"> Lista de Deducciones <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_ded_det.jsp,EDL0150"> 
</h3>
<hr size="4">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap width="32%"  > 
              <div align="center"> 
                ...
                <a href="javascript:lnGetFactDed('DLIFAC_<%= ded.getCurrentRow() %>','STATIC_ln_fact_ded.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" width="17" height="21" ></a></div>
            </td>
          </tr>
          <%
                }
