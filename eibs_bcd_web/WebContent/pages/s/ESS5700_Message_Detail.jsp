...
<script type="text/javascript">
  function GetIMFHelp(code){   
  	fieldName=code;
	page= "${pageContext.request.contextPath}/pages/s/ESS5700_Message_Help.jsp";
...
<% 
 ...
 %>  
<h3 align="center">Mensajes de Confirmación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="Message_Detail, ESS5700" ></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/com.datapro.eibs.internet.JSESS5700">
  ...
  <table class="tableinfo">
          ...
          <td nowrap>
               <div align="left"> 
                  ...
                  <% if(msgData.getE01IMFCDE().trim().equals("0")){  %>
                     <a href="javascript:GetIMFHelp('E01IMFCDE')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"  ></a>                   
                  <% } %>   
     ...
     <tr id="trclear"> 
        <td nowrap><div align="right">Tipo de Consulta :</div></td>
          <td nowrap>
               <div align="left"> 
...
<h4>Ayuda para Configurar Mensajes</h4>
  ...
  <table class="tableinfo">
	...
	<TR>
		<TD>@M1</TD>
		<TD>Balance de Cuenta o Capital</TD>
		<TD>15,2</TD>
		<TD>19</TD>
	</TR>
	<TR>
		<TD>@M2</TD>
		<TD>Monto de la transaccion, Intereses o Monto del Pago </TD>
		<TD>15,2</TD>
		<TD>19</TD>
	</TR>
	<TR>
