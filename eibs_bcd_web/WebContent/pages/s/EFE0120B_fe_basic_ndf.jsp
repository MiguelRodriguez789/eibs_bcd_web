        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">          
            ...
            <td nowrap colspan="2" > 
              ...
              <a href="javascript:GetClassFex('E01FESCLS','NFR','<%= fex.getE01FESCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" >
			  ...
			  >
              <input type="text" name="E01FESMA3" size="5" maxlength="4" value="<%= fex.getE01FESMA3()%>" 
			  >
