...
<h3 align="center">Consulta de Documentos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="enter_list_consulta, EDL0813"> </h3>
...
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/com.cb.products.JSEDL0813" >
  ...
  <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
	...
	<TR>
      ...
      <div align="left">
        <input type="text" name="E01DLDDWR" size="10" maxlength="9" value="<%= collBasic.getE01DLHCUN() %>">
        <a href="javascript:GetCustomerDescId('E01DLDDWR','E01CUSNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>
   ...
   <TR>
	  ...
	  <TD ALIGN=left nowrap>
          <input type="text" maxlength=25 size=25 name="E01DLDDID" value="">
          <input type="hidden" maxlength=15 size=15 name="idenda" value="">
          <input type="hidden" maxlength=15 size=15 name="idenda1" value="">
	   <a href="javascript:GetAcceptantIdNDA('E01DLDDID','idenda')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a>
      </TD>      
   </TR>
	<TR>
	  <TD ALIGN=right nowrap>
	  ...
	  <TD ALIGN=left nowrap>
          <SELECT name="E01DLDRST" disabled="disabled">
   ...
   <TR>
	  ...
	  <TD ALIGN=left nowrap>
			<input type="text"   size="3" maxlength="2" name="E01DLDRF1" value="" >
			<input type="text"   size="3" maxlength="2" name="E01DLDRF2" value="" >
			<input type="text"   size="5" maxlength="4" name="E01DLDRF3" value="" > 
      </TD>      
   </TR>
   <TR>
	  <TD ALIGN=right nowrap>
	  ...
	  <TD ALIGN=left nowrap>
			<input type="text"   size="3" maxlength="2" name="E01DLDMF1" value="" >
			<input type="text"   size="3" maxlength="2" name="E01DLDMF2" value="" >
			<input type="text"   size="5" maxlength="4" name="E01DLDMF3" value="" > 
      </TD>      
   </TR>
