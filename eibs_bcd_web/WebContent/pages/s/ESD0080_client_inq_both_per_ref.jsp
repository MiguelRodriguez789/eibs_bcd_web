...
%> 
<h3 align="center">Referencias Personales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_inq_both_per_ref, ESD0080"></h3>
<hr size="4">
   ...
   <tr bordercolor="#FFFFFF"> 
      <td nowrap >
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
         <tr id="trclear"> 
           ...
           <td width="58%" nowrap> 
             <input type="text" readonly name="E<%= name %>4RCN" maxlength="9" size="10" value="<%= perRef.getField("E" + name + "4RCN").getString().trim()%>">
           </td>
          </tr>
         <tr id="trdark"> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA1" maxlength="60" size="65" value="<%= perRef.getField("E" + name + "4MA1").getString().trim()%>" readonly>
            </td>
          </tr>
      ...
      <%--
         <tr> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA2" maxlength="35" size="36" value="<%= perRef.getField("E" + name + "4MA2").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr id="trdark"> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA3" maxlength="35" size="36" value="<%= perRef.getField("E" + name + "4MA3").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA4" maxlength="35" size="36" value="<%= perRef.getField("E" + name + "4MA4").getString().trim()%>" readonly>
            </td>
          </tr>
		 <%if(currUser.getE01INT().equals("18")){%> 
           <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" readonly name="E<%= name %>4TID" maxlength="5" size="4" value="<%= perRef.getField("E" + name + "4TID").getString().trim()%>">
         ...
         <tr> 
            ...
            <td nowrap width="58%"> 
              <input type="text" readonly name="E<%= name %>4PID" maxlength="5" size="4" value="<%= perRef.getField("E" + name + "4PID").getString().trim()%>">
         ...
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4CTY" maxlength="30" size="31" value="<%= perRef.getField("E" + name + "4CTY").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4STE" maxlength="4" size="5" value="<%= perRef.getField("E" + name + "4STE").getString().trim()%>" readonly>
            </td>
          </tr>
       <%}%>
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4CTR" maxlength="20" size="21" value="<%= perRef.getField("E" + name + "4CTR").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4POB" maxlength="10" size="11" value="<%= perRef.getField("E" + name + "4POB").getString().trim()%>" readonly>
            </td>
          </tr>
         <tr id="trdark"> 
            <td nowrap width="42%"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4ZPC" maxlength="15" size="16" value="<%= perRef.getField("E" + name + "4ZPC").getString().trim()%>" readonly>
            </td>
          </tr>
       --%>
		...
		<%} %>   
         ...
         <tr> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4HPN" maxlength="15" size="16" value="<%= perRef.getField("E" + name + "4HPN").getString().trim()%>" readonly>
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4BNI" maxlength="25" size="26" value="<%= perRef.getField("E" + name + "4BNI").getString().trim()%>" readonly>
              </td>
          </tr>
          ...
          <tr id="trclear">
            ...
            <td width="58%" nowrap > 
              <input type="text" name="E<%= name %>4TID" value="<%= perRef.getField("E" + name + "4TID").getString().trim()%>" size="5" maxlength="4" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="42%" > 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4PID" size="5" maxlength="4" value="<%= perRef.getField("E" + name + "4PID").getString().trim()%>" readonly>
            </td>
          </tr>
           <tr id="trdark"> 
             <td nowrap width="42%"> 
             ...
             <td nowrap width="58%">
               <input type="text" name="D<%= name %>4RTL" maxlength="45" size="40" value="<%= perRef.getField("D" + name + "4RTL").getString().trim()%>" readonly>
             </td>
           </tr>
          <tr id="trclear"> 
             <td nowrap width="42%"> 
             ...
             <td nowrap width="58%"> 
               <input type="text" name="E<%= name %>4NST" maxlength="9" size="10" value="<%= perRef.getField("E" + name + "4NST").getString().trim()%>" readonly>
             </td>
           </tr>
		<% } %>
