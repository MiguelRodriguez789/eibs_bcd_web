...
<BODY>
<h3 align="center">Aprobación Cambio de Productos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="branch_list.jsp, ESD0940"></h3>
<hr size="4">
		 ...
		 %>
          <tr> 
            <td NOWRAP  align=CENTER width="10%"> 
              <input type="radio" name="CURRCODE" value="<%= ESD094001Help.getCurrentRow() %>" <%=chk%> onClick="getParams(this.value,'<%= msgList.getE01CHGACC() %>','<%= msgList.getE01CHGBNK() %>','<%= msgList.getE01CHGACD() %>','<%= msgList.getE01CHGPRC() %>');">
            </td>
