...
%>
<BODY>
<h3 align="center">Autorización de Accesos a Códigos de Referencia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ref_codes_user_access_list.jsp, ESD0035"> </h3>
<hr size="4">
      ...
      <tr id="trdark"> 
        ...
        <td align=CENTER width="34%"> 
          <div align="left"> 
    		...
    		<a href="javascript:GetReferenceCode('E01CRETCN')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" onClick="document.forms[0].E01CREALL[1].click()"></a>
          </div>
        </td>
      </tr>
      <tr id="trclear"> 
