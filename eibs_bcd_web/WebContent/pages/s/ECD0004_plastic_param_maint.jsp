...
<body>
<h3 align="center">Parámetros de Tarjeta<BR>Mantenimiento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_param_maint.jsp, ECD0004"> 
</h3>
<hr size="4">
<% 
        ...
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trdark">
            ...
            <TD nowrap width="16%"> 
              ...
              <DIV align="left"> 
                <INPUT type="text" name="E04CDRTMD" size="5" maxlength="4" value="<%= msgCD.getE04CDRTMD() %>" onkeypress="enterInteger(event)">
              </DIV>
            </TD>
          ...
          <TR id="trclear"> 
            <TD nowrap width="16%"> 
              ...
              <DIV align="left"> 
                <INPUT type="text" name="E04CDRTMM" size="6" maxlength="5" value="<%= msgCD.getE04CDRTMM() %>" onkeypress="enterInteger(event)">
			  </DIV>
            </TD>
          ...
          <TR id="trclear"> 
            ...
            <TD nowrap width="16%"> 
              ...
              <DIV align="left"> 
                <INPUT type="text" name="E04CDRPIN" size="4" maxlength="3" value="<%= msgCD.getE04CDRPIN() %>" onkeypress="enterInteger(event)">
              </DIV>
            </TD>
          ...
          <TR id="trdark"> 
            <TD nowrap width="16%"> 
              ...
              <DIV align="left"> 
                <INPUT type="text" name="E04CDRPED" size="6" maxlength="5" value="<%= msgCD.getE04CDRPED() %>" onkeypress="enterInteger(event)">
              </DIV>
            </TD>
            ...
            <TD nowrap width="16%"> 
              ...
              <DIV align="left"> 
                <INPUT type="text" name="E04CDRERR" size="4" maxlength="3" value="<%= msgCD.getE04CDRERR() %>" onkeypress="enterInteger(event)">
              </DIV>
            </TD>
          ...
          <TR id="trclear"> 
            <TD nowrap width="16%"> 
              ...
              <DIV align="left"> 
                <INPUT type="text" name="E04CDRERD" size="20" maxlength="17" value="<%= msgCD.getE04CDRERD() %>" onkeypress="enterInteger(event)">
              </DIV>
            </TD>
            ...
            <TD nowrap width="16%"> 
              ...
              <DIV align="left"> 
                <INPUT type="text" name="E04CDRFFE" size="5" maxlength="4" value="<%= msgCD.getE04CDRFFE() %>" onkeypress="enterInteger(event)">
              </DIV>
            </TD>
          ...
          <TR id="trclear"> 
            ...
            <TD nowrap width="20%"> 
              <DIV align="left"> 
                <INPUT type="text" name="E04CDRACC" size="14" maxlength="12" value="<%= msgCD.getE04CDRACC() %>" onkeypress="enterInteger(event)">
            ...
            <TD nowrap width="20%"> 
              <DIV align="left"> 
                <INPUT type="text" name="E04CDRGLN" size="14" maxlength="12" value="<%= msgCD.getE04CDRGLN() %>" onkeypress="enterInteger(event)">
