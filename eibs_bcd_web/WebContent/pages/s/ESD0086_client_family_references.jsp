...
<H3 align="center">Referencias Familiares<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_family_references.jsp, ESD0086"></H3>
<hr size="4">
  ...
  <table  class="tableinfo" width="100%">
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="15%" align="right">Parentesco :</td>
            <td nowrap width="35%" align="left">
                <% if (isReadOnly) {%> 
         ...
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="15%" align="right">En Calidad de :</td>
            <td nowrap width="35%" align="left">
                <% if (isReadOnly) {%> 
            		<input type="text" name="E01UC7" size="5" value="<%= ESD0086Record.getE01UC7().trim()%>" readonly> 
               		<%= ESD0086Record.getD01UC7().trim()%>
               	<% } else { %>
            		<eibsinput:cnofc name="ESD0086Record" property="E01UC7" required="true" flag="IN" fn_code="E01UC7" fn_description="D01UC7"/>
               		<eibsinput:text property="D01UC7" name="ESD0086Record" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME%>" readonly="true"/>
            	<% } %>
            </td>
            <td nowrap width="15%" align="right">Ingresos Mensuales : </td>
            <td nowrap width="35%" align="left">
