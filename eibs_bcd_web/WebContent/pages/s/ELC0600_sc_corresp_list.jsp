...
<H3 align="center">Tablas de Comisiones y Gastos de Cartas de Credito<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sc_corresp_list.jsp, ELC0600"></H3>
<HR size="4">
	...
	filter:progid:DXImageTransform.Microsoft.dropshadow(OffX=3, OffY=3, Color='gray', Positive='true');">
      ...
      <TR id="trdark"> 
        <TD nowrap  > 
	            ...
	            <TD nowrap  > 
	              	<INPUT type="text" name="NEWCUN" size="10" maxlength="9" value="<%=request.getParameter("E01RLCCUN")%>">
