...
<H3 align="center">Mantenimiento de Retenciones e Impuestos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="taxes_700_leasing.jsp, ESD0009"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="left"> 
                <eibsinput:text name="taxes" property="E01TAXBNK" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_BANK %>" />
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap height="23"> 
              <div align="left"> 
                  <eibsinput:text name="taxes" property="E01TAXTTP" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CNOFC %>" />
                  <eibsinput:text name="taxes" property="E01TAXDSC" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_DESCRIPTION %>" readonly="false"/>          
             </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
               <eibsinput:help name="taxes" property="E01TAXGL1" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_GLEDGER%>" required="false"
          	    	fn_param_one="E01TAXGL1" fn_param_two="<%= taxes.getE01TAXBNK() %>"/></div>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%" height="19"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
               <eibsinput:help name="taxes" property="E01TAXGL2" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_GLEDGER%>" required="false"
          	    	fn_param_one="E01TAXGL2" fn_param_two="<%= taxes.getE01TAXBNK() %>"/> </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="30%" height="19"> 
              <div align="right">Cuenta Contable Impuestos I.G.V :</div>
            </td>
            <td nowrap height="19"> 
              <div align="left"> 
               <eibsinput:help name="taxes" property="E01TAXGCD" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_GLEDGER%>" required="false"
          	    	fn_param_one="E01TAXGCD" fn_param_two="<%= taxes.getE01TAXBNK() %>"/> </div>
           </td>
          </tr>
        </table>
      </td>
