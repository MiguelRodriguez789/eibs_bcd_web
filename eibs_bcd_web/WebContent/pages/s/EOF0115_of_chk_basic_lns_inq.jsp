...
<% if (userPO.getSource().equals("FACT")) {
	out.print("Consulta de Emisi&oacute;n Cheques de Gerencia por Desembolso de Descuento de Documentos");
   } else {
   	out.print("Consulta de Emisi&oacute;n Cheques de Gerencia por Desembolso de Préstamos");
   }	
 %> 
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="of_chk_basic_lns_inq.jsp, EOF0115"> 
</H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap height="19" colspan="3">
              <eibsinput:cnofc property="E01OFMCTY" name="offBasic" flag="MO" fn_code="E01OFMCTY" fn_description="D01OFMCTY" readonly="true"/>
          ...
          <tr id="trclear"> 
          	  ...
          	  <table class="tableinfo" style="filter:''">
          		...
          		<tr id="trclear"> 
            		<td width="31%" > 
              		<div align="center"> 
                		<input readonly type=text name="E01DEBOPC" id="E01DEBOPC" value="<%= offBasic.getE01DEBOPC().trim()%>" size="3" maxlength="3">
                		<input readonly type=HIDDEN name="E01DEBGLN" value="<%= offBasic.getE01DEBGLN().trim()%>">
                		<input readonly type="text" name="E01DEBCON" size="25" maxlength="25" readonly value="<%= offBasic.getE01DEBCON().trim()%>">
              		</div>
            		</td>
            		<td width="5%" > 
              		<div align="center"> 
                		<input readonly type="text" name="E01DEBBNK" size="2" maxlength="2" value="<%= offBasic.getE01DEBBNK().trim()%>">
              		</div>
            		</td>
            		<td width="13%"> 
              		<div align="center"> 
                		<input readonly type="text" name="E01DEBBRN" size="4" maxlength="4" value="<%= offBasic.getE01DEBBRN().trim()%>">
              		</div>
            		</td>
            		<td width="12%" > 
              		<div align="center">
                		<input readonly type="text" name="E01DEBCCY" size="3" maxlength="3" value="<%= offBasic.getE01DEBCCY().trim()%>"> 
              		</div>
            		</td>
            		<td width="21%" > 
              		<div align="center"> 
                		<input readonly type="text" name="E01DEBACC" size="14" maxlength="12" value="<%= offBasic.getE01DEBACC().trim()%>">
              		 </div>
            		</td>
          		</tr>
        	</table>
