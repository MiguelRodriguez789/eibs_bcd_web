    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
 		 ...
 		 <tr id="trclear"> 
            <td nowrap width="5%" height="19" align="right">Numero : </td>
			...
			>
			<A href="javascript:GetCustomerDescId('E01DPGIDN','E01DPGDES','E01CUSIDN')"><IMG
          ...
          <tr id="trdark"> 
            ...
            <td nowrap height="23" colspan="1" width="372"> 
      			<INPUT type="text" name="E01CUSIDN" size="16" maxlength="16" value="<%= l0725.getE01CUSIDN().trim()%>";
					<% if(userPO.getHeader16().equals("9")){out.print("readonly");} %> >
			</td>
            <td nowrap height="23" colspan="1" width="14"> 
...
--%>
		...
		<%}%>
 		 ...
 		 <tr id="trclear"> 
            <td nowrap width="5%" height="19" align="right">Tipo de Relación:</td>
            
            <td nowrap height="19" width="55%">
              <div align="left"> 
                <input type="text" name="E01DPCCLS" size="2"  maxlength="1" oncontextmenu="showPopUp(accholdersHelp,this.name,'','','','','')"  value="<%= l0725.getE01DPCCLS().trim() %>" 
				<% if(userPO.getHeader16().equals("9")){out.print("readonly");} %> >
              </div>
