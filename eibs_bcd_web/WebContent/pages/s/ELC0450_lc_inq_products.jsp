...
<h3 align="center">Consulta de Producto de Cartas de Cr&eacute;dito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_inq_products.jsp, ELC0450"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly name="E04TYPDES" size="45" maxlength="45" value="<%= lcProdInq.getE04TYPDES().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly name="E04DESCRI" size="45" maxlength="43" value="<%= lcProdInq.getE04DESCRI().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              <input type="text" readonly name="E04MERCAD" size="25" maxlength="25" value="<%= lcProdInq.getE04MERCAD().trim()%>">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="50%"> 
              <input type="text" readonly name="E04GLMDSC" size="45" maxlength="60" value="<%= lcProdInq.getE04GLMDSC().trim()%>">
            </td>
          </tr>
        </table>
      </td>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E04TLNDSC" size="45" maxlength="45" value="<%= lcProdInq.getE04TLNDSC().trim()%>">
            </td>                                   
          </tr>
          <tr id="trclear"> 
            <td width="45%"> 
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E04APCAMO" size="25" maxlength="25"  
			   value="<% if (lcProdInq.getE04APCAMO().equals("I")) out.print("Importación");
			    		else if (lcProdInq.getE04APCAMO().equals("O")) out.print("Exportación");
						else if (lcProdInq.getE04APCAMO().equals("S")) out.print("Garantía");
						%>">
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E04APCITP" size="25" maxlength="25"  
          ...
          <tr id="trdark"> 
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E04APCCDT" size="25" maxlength="25"  
			   value="<% if (lcProdInq.getE04APCCDT().equals("S")) out.print("Pago");
			    		else if (lcProdInq.getE04APCCDT().equals("A")) out.print("Aceptacion");
						else if (lcProdInq.getE04APCCDT().equals("M")) out.print("Pago Mixto");
						else if (lcProdInq.getE04APCCDT().equals("D")) out.print("Pago Diferido");
						else if (lcProdInq.getE04APCCDT().equals("N")) out.print("Negociacion");
						%>">
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trclear">
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E04APCFRN" size="35" maxlength="35"  
