...
%> 
<h3 align="center">Consulta de Tasas de Pizarra<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rate_table_pizz.jsp, ECN0030"></h3>
<hr size="4">
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="15%"> <%= cdRenRat.getE02CDRRTB().trim()%> </td>
            <td width="24%"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="15%">
            	 <%= Util.formatCustomDate(currUser.getE01DTF(), cdRenRat.getE02CDRDTM().trim(), cdRenRat.getE02CDRDTD().trim(), cdRenRat.getE02CDRDTY().trim()) %>
			</td>
            <td width="28%"> 
