...
%>
<h3 align="center">Mantenimiento de Titulares <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_tit.jsp,EDL0130M"></h3>
<hr size="4">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="45%"> 
              <div align="center">
                ...
                class="context-menu-help" onmousedown="init(custdescidHelp,'E06CU<%= name %>','','','E06MA<%= name %>','E06ID<%= name %>','')">
              </div>
            </td>
            <td nowrap width="25%"> 
              <div align="center"> 
