...
%>
<h3 align="center"> Consulta - Spot Moneda Extranjera </h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEFE0140" >
  ...
  <h4>Informaci&oacute;n B&aacute;sica<b></b><b> 
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <TD nowrap><DIV align="right">Tipo de Operaci&oacute;n :</DIV></TD>
              <TD nowrap> <% if(fex.getE01FEMSBT().equals("PU")) out.print("Compra"); else out.print("Venta");%></TD>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="center"><b>Sucursal</b></div>
            </td>
            <td nowrap > 
            ...
            <td nowrap > 
              <div align="center"><b>Referencia</b></div>
            </td>
            <td nowrap > 
              <div align="center"><b>Centro de Costo</b></div>
            </td>
            <td nowrap >&nbsp;</td>
          </tr>
          <tr id="trclear"> 
