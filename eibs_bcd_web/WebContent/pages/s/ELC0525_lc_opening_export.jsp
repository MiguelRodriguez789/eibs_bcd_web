...
<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ELC0525_lc_opening_export.jsp"></H3>
<HR size="4">
<FORM>
<BR>
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo" id="trclear">
	...
	<TR id="trdark">
	  <TD align="right" nowrap="nowrap"><B>Referencia del Banco Emisor : </B></TD>
		<TD nowrap="nowrap"><B>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    <TD width="35%" align="right">Nemero de Cliente o Cuenta: </TD>
      ...
      <TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
          ...
          <TR id="">
            ...
            <TD nowrap><SELECT name="E01LCMAF1" disabled>
                <OPTION value=" "></OPTION>
                <OPTION value="C" <%if (msg050001.getE01LCMAF1().equals("C")) out.print("selected");%>>Cliente</OPTION>
                <OPTION value="A" <%if (msg050001.getE01LCMAF1().equals("A")) out.print("selected");%>>Cuenta</OPTION>
              </SELECT>
                <INPUT name="E01LCMIBA" type="text" value="<%=msg050001.getE01LCMIBA()%>" size="12" maxlength="12" readonly="readonly"
                	 <%if (msg050001.getE01LCMAF1().equals("A")) out.print("class=\"context-menu-inq\" onmousedown=\"init(inqAccount, this.value)\"");%>>
                </TD>
          </TR>
          <TR id="">
          ...
          <TR id="">
            ...
            <TD align="left" valign="bottom" nowrap>
              <INPUT name="E01LCMIB5" type="text" value="<%=msg050001.getE01LCMIB5()%>" size="4" maxlength="4" readonly="readonly">
              Código Postal
              <INPUT name="E01LCMIB6" type="text" value="<%=msg050001.getE01LCMIB6()%>" size="16" maxlength="15" readonly="readonly">
              País
