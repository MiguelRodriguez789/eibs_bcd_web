...
<h3 align="center">Mantenimiento Lista Proteccion de Cheques<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="enter_param.jsp, ETI0540"></h3>
<hr size="4">
  <br><br><br><br><br><br>
  <table class="tableinfo">
    ...
    <tr> 
      ...
      <td valign="middle" align="center" height=33 width="51%"> 
        <div align="left"> 
      <input type="text" name="E01CKCACC" size="12" maxlength="12" onKeypress="enterInteger(event)">
