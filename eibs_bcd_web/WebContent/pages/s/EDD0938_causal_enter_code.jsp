...
<h3 align="center">Tabla de Cargos Camara/Devoluciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="causal_enter_code,EDD0938"></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0938">
  ...
  <table class="tableinfo">
    <tr id="trdark"> 
      ...
      <td nowrap align="center" width="50%"> 
        <div align="left"> 
          <input type="text" name="CAUSAL" id="CAUSAL" size="5" maxlength="4" value="">
