...
<body>
<h3 align="center">Asignación de Tarjetas<BR>Reemplazo de Tarjeta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="card_assign_replace.jsp, ECC0090"></h3>
<hr size="4">
<% 
