...
<%String ctrlDisabled="disabled";
String ctrlReadonly="readonly"; 
...
<h3 align="center">Tabla de Gastos y Comisiones de Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sc_basic_inq.jsp,EDC0600"></h3>
<hr size="4">
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trdark"> 
            ...
            <td nowrap  > 
              <div align="left"> 
                <input type="text" name="E01RCOTCY" size="4" maxlength="3" value="<%= sc.getE01RCOTCY().trim()%>" readonly>
              </div>
            </td>
           </tr>
          <tr id="trclear"> 
            ...
            <td nowrap  > 
              <div align="left"> 
                <input type="text" name="E01RCOACY" size="4" maxlength="3" value="<%= sc.getE01RCOACY().trim()%>" readonly>
               </div>
            </td>
            <td nowrap  > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" name="E01RCODSC" size="45" maxlength="45" value="<%= sc.getE01RCODSC().trim()%>" readonly>
              </div>
            </td>
           </tr>
  </table>
  ...
  <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" width="100%" border="0">
    <tr id="trdark"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI10" <%=ctrlDisabled %>>
            <option value=" "></option>
    ...
    <tr id="trclear"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI07" <%=ctrlDisabled %>>
            <option value=" "></option>
...
<tr id="trclear"> 
      <td nowrap > 
        <div align="right">Presentación Documentos :</div>
      </td>
      <td nowrap > 
         <div align="center"> 
    ...
    <%-- 
     <tr id="trclear"> 
      <td nowrap > 
        <div align="right">Comisión de Pago :</div>
      </td>
      <td nowrap > 
         <div align="center"> 
