...
<h3 align="center">Consulta Tarjeta de Crédito
 <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_inq_card.jsp,ECC0010"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" readonly name="E01CCMACC" size="13" maxlength="9" value="<%= ccNew.getE01CCMACC().trim()%>">
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
               <eibsinput:date name="ccNew" fn_month="E01CCMOPM" fn_day="E01CCMOPD" fn_year="E01CCMOPY" readonly="true" />
            </td>
            <td nowrap width="25%"> 
              <div align="right">Fecha de Vencimiento:</div>
            </td>
            <td nowrap width="27%"> 
               <eibsinput:date name="ccNew" fn_month="E01CCMEXM" fn_day="E01CCMEXD" fn_year="E01CCMEXY" readonly="true" />
            </td>
          </tr>        
          <tr id="trclear"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%"> 
				<input type="text" readonly name="E01CCMTBL" size="3" maxlength="2" value="<%= ccNew.getE01CCMTBL().trim()%>">
            </td>
            <td nowrap width="25%"> 
