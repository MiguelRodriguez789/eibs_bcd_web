...
%> 
<h3 align="center">MT 300 - Mensaje de Confirmaci&oacute;n <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_fw_format.jsp, ESWF300"> 
</h3>
<hr size="4">
