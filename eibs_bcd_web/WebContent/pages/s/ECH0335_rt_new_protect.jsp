...
<H3 align="center">Proteccion de Cheques (Nuevo)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_new_detail.jsp , ERA0010"></H3> 
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap>
              <INPUT type="text" name="E01CKCCKN" size="13" maxlength="11" onKeypress="enterInteger(event)" value="<%= chkDet.getE01CKCCKN().trim()%>">
            </td>         
          </tr>          
          <tr id="trclear"> 
            <td nowrap > 
