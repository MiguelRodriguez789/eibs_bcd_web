...
<html>
<head>
<title>Información Detalle de Fianza Casa Matriz</title>
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_detail_aval_3.jsp, ERA0066"></h3> 
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap >
              <div align="right">Apostillaje : </div>
            </td>
            <td nowrap >
            ...
            <td nowrap >
              <div align="right">Autenticación ante Consulado : </div>
            </td>
            <td nowrap >
			  ...
			  <%if (gaDetail.getE01R05CAV().equals("S"))
				out.print("checked");%> <%=disabled1%>>
                Sí
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap > 
              <div align="right">Opinión Abogado Externo : </div>
            </td>
            <td nowrap colspan=3>
