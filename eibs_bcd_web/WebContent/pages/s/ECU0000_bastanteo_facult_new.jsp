...
<H3 align="center">Sistema de Bastanteo - Creacion de Facultades Limitadas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_facult_new,ECU0000"></H3>
<hr size="4">
    	...
    	<tr id=trdark> 
		  <td nowrap> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E07CULFAC','E07CULFAN','YF')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
    	...
    	<tr id=trdark> 
		  <td nowrap> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E07CU1FAC','E07CU1FAN','YF')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
      	  </td>     
      	</tr>
    	<tr id="trclear"> 
    	...
    	<tr id=trdark> 
		  <td nowrap> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E07CU2FAC','E07CU2FAN','YF')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
      	  </td>     
      	</tr>
    	<tr id="trclear"> 
    	...
    	<tr id=trdark> 
		  <td nowrap> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E07CU3FAC','E07CU3FAN','YF')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
      	  </td>     
      	</tr>
    	<tr id="trclear"> 
    	...
    	<tr id=trdark> 
		  <td nowrap> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E07CU4FAC','E07CU4FAN','YF')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
      	  </td>     
      	</tr>
    	<tr id="trclear"> 
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E07CULOBS" size="90" maxlength="80" value="<%= msgFac.getE07CULOBS().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%">
