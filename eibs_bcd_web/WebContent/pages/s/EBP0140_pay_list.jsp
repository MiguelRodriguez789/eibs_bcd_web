...
<h3 align="center">Selección de Facturas para Pago
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    <TR id=trdark> 
		...
		<td NOWRAP align="center" width="3%"><B>Calificación<BR>Doc.Origen</B></td>
		...
		<td NOWRAP align="center" width="13%"><B>Descripción Factura</B></td>
    ...
    <TR id=trclear>
		...
		<td NOWRAP align="center" width="3%" >
			<FONT color="red">
			<% if (msgList.getE01BPPRTI().equals("2")) {out.print("Sin Calificación");}%> 	
			</FONT>	
