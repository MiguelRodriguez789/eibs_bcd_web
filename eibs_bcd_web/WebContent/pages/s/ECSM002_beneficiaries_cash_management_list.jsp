...
<jsp:useBean id="msgHdr7" class= "datapro.eibs.beans.ECSM00207Message"  scope="session"  />
...
function setKey(bnk,num,tip,com,rac) {
	getElement("E07BENBNK").value = bnk;
	getElement("E07BENNUM").value = num;
	getElement("E07BENTIP").value = tip;
	getElement("E07BENCOM").value = com;
	getElement("E07BENRAC").value = rac;
}
...
<h3 align="center">Convenios - Dispersion - Beneficiarios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="beneficiaries_cash_management_list.jsp, ECSM002"></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cashmg.JSECSM002">
  ...
  <INPUT TYPE=HIDDEN NAME="E07BENBNK" VALUE=" ">
  <INPUT TYPE=HIDDEN NAME="E07BENNUM" VALUE="0">
  <INPUT TYPE=HIDDEN NAME="E07BENCOM" VALUE=" ">
  <INPUT TYPE=HIDDEN NAME="E07BENRAC" VALUE=" ">
	 ...
	 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
		...
		<tr id="trdark"> 
	      ...
	      <td align=CENTER width="60%"> 
	        <div align="left"> 
				<INPUT type="text" name="E07BENNUM" size="13" maxlength="12" value="<%=userPO.getAccNum()%>" readonly> 
	        </div>
	      </td>
	    </tr>
		<tr id="trclear"> 
	      ...
	      <td align=CENTER width="60%"> 
	        <div align="left"> 
				<select name="E07BENTIP">
					<option value="N" <%if (msgHdr7.getE07BENTIP().equals("N")) { out.print("selected");}%>>Nomina</option>
					<option value="A" <%if (msgHdr7.getE07BENTIP().equals("A")) { out.print("selected");}%>>Ahorro</option>
					<option value="P" <%if (msgHdr7.getE07BENTIP().equals("P")) { out.print("selected");}%>>Proveedor Interno</option>
					<option value="Q" <%if (msgHdr7.getE07BENTIP().equals("Q")) { out.print("selected");}%>>Proveedor Externo</option>
				</select>
	        </div>
	      </td>
	    </tr>
...
%>    
  ...
  <table  class="tableinfo" width="100%">
    ...
    <TR id=trdark> 
		...
		<TD nowrap align="center" width="15%"><B>Banco Destino</B></TD>
		<TD nowrap align="center" width="15%"><B>Cuenta Destino</B></TD>
	</TR>
	<TR id=trdark>
        ...
        <%
          ...
          while (msgList.getNextRow()) {
            ECSM00207Message msgRcd = (ECSM00207Message) msgList.getRecord(); 
		%>              
    <TR id=trclear>
    
		<td NOWRAP align="center" width="5%"> 
            <INPUT type="radio" name="ROW" value="<%= msgList.getCurrentRow() %>" onClick="setKey('<%=msgRcd.getE07BENBNK()%>','<%= msgRcd.getE07BENNUM() %>','<%= msgRcd.getE07BENTIP() %>','<%= msgRcd.getE07BENCOM() %>','<%= msgRcd.getE07BENRAC() %>')">
		</td>
		<td NOWRAP align="center" width="5%"><%= msgRcd.getE07BENBNK()%></td>
		<td NOWRAP align="left" width="15%" ><%= msgRcd.getE07BENNUM()%></td>
		<td NOWRAP align="left" width="15%" ><%= msgRcd.getE07BENTIP()%></td>
		<td NOWRAP align="left" width="15%" ><%= msgRcd.getD07BENTIP()%></td>
		<td NOWRAP align="left" width="15%" ><%= msgRcd.getE07BENCOM()%></td>
		<td NOWRAP align="left" width="15%" ><%= msgRcd.getE07BENRAC()%></td>
	</TR>
       <% 
       	 i++; 
        } 
