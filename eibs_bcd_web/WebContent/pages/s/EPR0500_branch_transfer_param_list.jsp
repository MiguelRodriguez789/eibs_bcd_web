...
<BODY>
<h3 align="center">Parámetros de Transferencias por Agencia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="branch_transfer_param_list.jsp, EPR0500"></h3>
<hr size="4">
    	...
    	<TD NOWRAP width="100%" >
  			<TABLE id="headTable" >
  			   <TR id="trdark">  
           		...
           		<th align=CENTER nowrap colspan="2" width="34%">Persona Física</th>
       		   </TR>
  			   <TR id="trdark">  
