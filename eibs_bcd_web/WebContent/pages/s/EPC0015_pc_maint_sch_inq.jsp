...
<h3 align="center">Inspectores Asociados a Proyecto - Consulta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_maint_sch.jsp, EPC0015"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing=0 cellpadding=1 width="100%" border="0" id="INFOCHG">
          ...
          <tr id="trclear"> 
            ...
            <td NOWRAP width="70%"> 
              <input type="text" readonly name="E01PCPOPM" size="3" maxlength="2" value="<%= msgPCB.getE01PCPOPM().trim()%>" onkeypress="enterInteger(event)">
              <input type="text" readonly name="E01PCPOPD" size="3" maxlength="2" value="<%= msgPCB.getE01PCPOPD().trim()%>" onkeypress="enterInteger(event)">
              <input type="text" readonly name="E01PCPOPY" size="5" maxlength="4" value="<%= msgPCB.getE01PCPOPY().trim()%>" onkeypress="enterInteger(event)">
            </td>
          </tr>
        </table>                       
      </td>
...
<table cellspacing=2 cellpadding=2 width="100%" border="0" class="tableinfo">
	...
	<tr>
		...
		<td nowrap><input readonly type="text" name="E01PCPOFB" size="2"
			maxlength="2" value="<%= msgPCB.getE01PCPOFB().trim()%>"></td>
		<td nowrap><input readonly type="text" name="E01PCPOFR" size="4"
			maxlength="4" value="<%= msgPCB.getE01PCPOFR().trim()%>">
		</td>
		<td nowrap ><input readonly type="text" name="E01PCPOFC" size="3"
			maxlength="3" value="<%= msgPCB.getE01PCPOFC().trim()%>">
		</td>
		<td nowrap ><input readonly type="text" name="E01PCPOFG" size="17"
			maxlength="16" value="<%= msgPCB.getE01PCPOFG().trim()%>">
		</td>
		<td nowrap><input readonly type="text" name="E01PCPOFA" size="13"
