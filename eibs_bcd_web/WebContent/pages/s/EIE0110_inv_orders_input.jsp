...
%>
<h3>Entrada de Ordenes 
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_orders_input.jsp,EIE110"></h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              ...
              <a href="javascript:GetPortfolioNumDesc('E01ORDPRF','E01ORDCUN','',document.forms[0].E01ORDCUN.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="29%" > 
            ...
            <td nowrap colspan="3" > 
              ...
              <input type="text" name="E01ORDHAC" size="12" maxlength="9" value="<%= invOrders.getE01ORDHAC()%>"
                 >
              <a href="javascript:GetCashAccount('E01ORDHCY','E01ORDHAC','E01MEMBAL',document.forms[0].E01ORDCUN.value,document.forms[0].E01ORDPRF.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"  ></a></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="29%" > 
  ...
  <table  class="tableinfo">
    ...
    <tr id="trclear"> 
      ...
      <td nowrap width="71%" > 
        ...
        <a href="javascript:GetInstrumentParams('E01ORDIIC','E01ORDICN','E01ORDSCY','E01ORDSYM','E01ORDISI','E01ORDCSP','E01ORDPTY')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"> 
        <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0"  ></a></td>
    </tr>
    <tr id="trdark"> 
      <td nowrap width="29%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="71%"> 
			  ...
			  <a href="javascript:Calculate()"> 
               <img src="<%=request.getContextPath()%>/images/calculator.gif" title="calculator" align="middle" border="0" >
			  </a> 
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="71%" > 
              <div align="center">
                <textarea name="E01ORDCOM" cols="64" rows="4" readonly> <%= invOrders.getE01ORDCOM() %> </textarea>
              </div>
            </td>
          </tr>
  </table>
