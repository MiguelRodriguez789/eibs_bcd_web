...
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  <h3 align="center">Proveedores Registrados<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="vendor_list_register.jsp,ESS2105"> 
  por Internet</h3>
<%
