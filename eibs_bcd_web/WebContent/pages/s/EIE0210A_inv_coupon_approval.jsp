...
%>
<div align="center"> 
  <h3>Aprobaci&oacute;n Pago de Cupones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_coupon_approval.jsp,EIE0210A"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" >
              <div align="right">Estado del Cupón :</div>
            </td>
            <td nowrap width="36%" >
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td nowrap >
              <div align="right">Tasa Moneda Extrajera :</div>
            </td>
            <td nowrap >
              <div align="left">
