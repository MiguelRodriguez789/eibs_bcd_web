...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="references_list.jsp,EPR0000">
</h3>
<hr size="4">
 ...
 <TABLE  id="mainTable" class="tableinfo" >
  <TR> 
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			<TD NOWRAP width="2%"><input type="radio" name="ROW" id="ROW" value="<%= mtListRef.getCurrentRow()%>" <%=chk%> onClick="document.forms[0].CURRENTROW.value = this.value;"></TD>
