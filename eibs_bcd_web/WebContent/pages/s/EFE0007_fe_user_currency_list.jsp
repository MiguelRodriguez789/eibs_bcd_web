...
<input type=HIDDEN NAME="SCREEN" value="1">
  ...
  <h3 align="center">Tolerancia de Tasas de Cambio para Usuarios / Moneda<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_user_currency_list.jsp, EFE0007">
  </h3>
	<hr size="4">
