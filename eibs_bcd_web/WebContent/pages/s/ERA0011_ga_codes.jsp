...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_codes.jsp,ERA0011" width="35" ></h3> 
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02OF2','D02OF2','<%= code %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0"  > 
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0" width="16" height="20"  > 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="3%"> 
		...
		<% if (gaCodes.getE02ACD().equals("91")) { %> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC1','D02UC1','X0')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            </td>
          </tr>          
          <tr id="trclear"> 
            <td nowrap width="30%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC3','D02UC3','2N')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            </td>
          </tr>
