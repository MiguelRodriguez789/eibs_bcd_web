...
<body>
<h3 align="center">Cobranza Documentaria Comisiones y Cargos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dc_commissions.jsp, EDC0000"></h3>
<hr size="4">
	...
	<tr>
		...
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
			<TBODY><TR id="trdark">
				...
				{%>
					<INPUT type="text" size="12" maxlength="12" value="0" readonly>
			...
			<TR id="trdark">
				...
				<TD nowrap width="16%">
					<DIV align="left"><B>
						<INPUT type="text" name="E02DCMTAR" size="3" maxlength="2" value="<%=dcNew2.getE02DCMTAR().trim()%>" readonly></B>
					</DIV>
				</TD>
			</TR>
			<TR id="trclear">
