...
<H3 align="center">C&oacute;digos de Referencia del Sistema  - Código Postal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnof_codigoPostal_Panama_details.jsp, ESD0030"></H3>
<hr size="4">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="23"> 
              <div align="left"> 
			    ...
			    <a href="javascript:Get2FilterCodes('E02CNORCD','E02CNODSC','59', document.getElementById('E02CNOMID').value,' ')" >
			    <img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
              </div>
            </td>
          </tr>
