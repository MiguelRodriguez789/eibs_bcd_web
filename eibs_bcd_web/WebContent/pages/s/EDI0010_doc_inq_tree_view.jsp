...
<APPLET archive="eibs_applets.zip" align="top" code="datapro.eibs.applets.tree.TreeApp.class" height="100%" width="100%" name="JExplorer" codebase="<%=request.getContextPath()%>/pages/s/">
