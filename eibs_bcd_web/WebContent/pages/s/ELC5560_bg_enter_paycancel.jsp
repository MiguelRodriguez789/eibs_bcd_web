...
<H3 align="center">Ejecucion de Documentarias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bg_enter_paycancel,ELC5560"></H3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.bolgaran.JSELC5560">
  ...
  <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
    ...
    <tr>
      <td>&nbsp;</td>
      <td >
          <INPUT type="radio" name="OPT" value="1" <% if (!userPO.getOption().equals("2")) out.print("checked");%>>Forma de Liquidacion
      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
