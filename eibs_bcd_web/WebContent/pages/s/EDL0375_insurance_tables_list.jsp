...
<h3 align="center">Mantenimiento de Tablas de Calculos de Seguros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ach_batches_list.jsp, EACH310"></h3>
<hr size="4">
