...
<SCRIPT type="text/javascript">
 ...
 function Recalculate(){
    ...
    UpdateField('E01DEAINT','E01TRNAIN','AFTERINT','E01TRNAIF',true);
    UpdateTotal();
 }
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01DEACUN" size="10" maxlength="9" value="<%= lnTransac.getE01DEACUN().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E01DEAACC" size="13" maxlength="12" value="<%= lnTransac.getE01DEAACC().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <TD nowrap> 
        <TABLE cellspacing="2" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <TD nowrap align="center"> 
              <INPUT class="txtright" type="text" readonly name="AFTERINT" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE01DEATOT())%>" onkeypress="enterDecimal()">
            </TD>
          </TR>
...
<%--
          ...
          <TD nowrap> 
			  ...
			  <INPUT type="text" readonly name="E01DEALC1" size="2" maxlength="2" value="<%= lnTransac.getE01DEALC1().trim()%>" onkeypress="enterInteger(event)">
              <INPUT type="text" readonly name="E01DEALC2" size="2" maxlength="2" value="<%= lnTransac.getE01DEALC2().trim()%>" onkeypress="enterInteger(event)">
              <INPUT type="text" readonly name="E01DEALC3" size="2" maxlength="2" value="<%= lnTransac.getE01DEALC3().trim()%>" onkeypress="enterInteger(event)">
              </DIV>
            </TD>
           </TR>
--%>
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td width="60%" height="27"> 
              <input type="text" readonly name="E01TRNINT" size="15" maxlength="15" value="<%= lnTransac.getE01TRNINT().trim()%>" onKeypress="enterDecimal()"
              ...
              <input type="radio" name="CE01TRNINF" value="0"
			   ...
			   <%if(lnTransac.getE01TRNINF().equals("0")) out.print("checked");%> disabled> Reversar <input type="radio" name="CE01TRNINF" value="5"
			   onClick="document.forms[0].E01TRNINF.value='5';Recalculate();"
			   <%if(lnTransac.getE01TRNINF().equals("5")) out.print("checked");%> disabled> Pago </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E01TRNAIN" size="15" maxlength="15" value="<%= lnTransac.getE01TRNAIN().trim()%>" onKeypress="enterDecimal()"
			  ...
			  <%if(lnTransac.getE01TRNAIF().equals("0")) out.print("checked");%> disabled>
              Aumento 
              <input type="radio" name="CE01TRNAIF" value="5" 
              onClick="document.forms[0].E01TRNAIF.value='5';Recalculate();" 
			  <%if(lnTransac.getE01TRNAIF().equals("5")) out.print("checked");%> disabled>
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E01TRNVD1" size="3" maxlength="2" value="<%= lnTransac.getE01TRNVD1().trim()%>">
              <input type="text" readonly name="E01TRNVD2" size="3" maxlength="2" value="<%= lnTransac.getE01TRNVD2().trim()%>">
              <input type="text" readonly name="E01TRNVD3" size="5" maxlength="4" value="<%= lnTransac.getE01TRNVD3().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E01DEANR1" size="60" maxlength="60" value="<%= lnTransac.getE01DEANR1().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E01DEANR2" size="60" maxlength="60" value="<%= lnTransac.getE01DEANR2().trim()%>">
            </td>
          </tr>
        </table>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
        ...
        <table class="tableinfo" style="filter:''">
          ...
          <tr id="trclear"> 
            <td width="31%" > 
              <div align="center" > 
                <input type=text readonly name="E01TRNOPC" value="<%= lnTransac.getE01TRNOPC().trim()%>" size="3" maxlength="3">
                <input type=HIDDEN name="E01TRNGLN" value="<%= lnTransac.getE01TRNGLN().trim()%>">
                <input type="text" readonly name="E01TRNCON" size="25" maxlength="25" readonly value="<%= lnTransac.getE01TRNCON().trim()%>">
              </div>
            </td>
            <td width="5%" > 
              <div align="center"> 
                <input type="text" readonly name="E01TRNBNK" size="2" maxlength="2" value="<%= lnTransac.getE01TRNBNK().trim()%>">
              </div>
            </td>
            <td width="5%"> 
              <div align="center"> 
                <input type="text" readonly name="E01TRNBRN" size="4" maxlength="4" value="<%= lnTransac.getE01TRNBRN().trim()%>">
              </div>
            </td>
            <td width="5%" > 
              <div align="center">
                <input type="text" readonly name="E01TRNCCY" size="3" maxlength="3" value="<%= lnTransac.getE01TRNCCY().trim()%>">
              </div>
            </td>
            <td width="15%" > 
              <div align="center"> 
                <input type="text" readonly name="E01TRNACC" size="16" maxlength="16" value="<%= lnTransac.getE01TRNACC().trim()%>">
               </div>
            </td>
