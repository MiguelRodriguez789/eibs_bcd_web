...
<HTML>
<HEAD>
<TITLE>Lista Ubicaciones Caja de Seguridad</TITLE>
...
function SetType() {	 
	 ...
	 if (true) {
	 	document.getElementById("E01LOCLOC").onkeypress = "";
     	errorMsg.style.visibility="hidden";
	 } else {
	 	document.getElementById("E01LOCLOC").onkeypress="";
	 	document.getElementById("E01LOCLOC").value="";
...
<h3 align="center">Ubicaciones Caja de Seguridad<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="safe_deposit_locations_list, ESB0030"></H3>
<hr size="4">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<tr id="trdark"> 
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          <input type="text" id="E01LOCLOC" name="E01LOCLOC" size="4" maxlength="3" onchange="SetType()">
 ...
 <TABLE class="tbenter" width="100%" align=center>
    <TR>
      <TD class=TDBKG width="25%"> 
        <div align="center" style="cursor:hand" onClick="goAction('N')" id="eibsNew"><a><b>Crear</b></a></div>
      </TD>
      <TD class=TDBKG width="25%"> 
    ...
    <tr  height="5%"> 
      <td NOWRAP valign="top" width="100%"> 
		<table id="headTable" width="98%">
    		...
    		<TH ALIGN=CENTER width="25%">Número</TH>
    		<TH ALIGN=CENTER width="70%">Nombre</TH>
			</tr>
        </table>
      </td>
    </tr>    
        ...
        while (msgList.getNextRow()) {
     	...
     	%> 
   		...
   		<tr id="dataTable<%= msgList.getCurrentRow() %>">
			...
			<TD NOWRAP ALIGN="CENTER" width="25%"><%=Util.formatCell(msgPart.getE01LOCLOC())%></TD>
			<TD NOWRAP ALIGN="CENTER" width="70%"><%=Util.formatCell(msgPart.getE01LOCNME())%></TD>
		</TR>    		
    	<%}%>        	
     </TABLE>
     </div>
