...
<body>
<h3 align="center"><%= dcNew.getE01DCMOPT().equals("N")?"Apertura":"Mantenimiento" %> de Cobranza Simple<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dc_opening.jsp, EDC0010"></h3>
<hr size="4">
      ...
      <td nowrap>
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trclear">
			...
			<TD nowrap width="20%">
            	<INPUT type="text" name="E01DCMOFX" maxlength="19" size="20" value="<%= dcNew.getE01DCMOFX().trim()%>" onkeypress="enterDecimal(event)">
				<IMG src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" border="0">
            </TD>
          ...
          <TR id="trdark">
			...
			<TD nowrap width="20%">
            	<INPUT type="text" name="E01DCMCKN" maxlength="10" size="11" value="<%= dcNew.getE01DCMCKN().trim()%>" onkeypress="enterInteger(event)">
				<IMG src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" border="0">
            </TD>
			<TD nowrap width="30%">
			...
			<INPUT type="text" name="E01DCMTAR" maxlength="3" size="4"
						...
						src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0"></A><IMG
          ...
          <TR id="trclear">
			...
			<TD nowrap width="20%">
            	<INPUT type="text" name="E01DCMOAM" maxlength="19" size="20" value="<%= dcNew.getE01DCMOAM().trim()%>" onkeypress="enterDecimal(event)" <%= !dcNew.getE01DCMOPT().equals("N")?"readonly":"" %>>
				<IMG src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" border="0">
            </TD>
			<TD nowrap width="30%">
         ...
         <% if(!dcNew.getE01DCMOPT().equals("N")){ %>
		  <TR id="trclear">
			...
			<TD nowrap width="20%">
                ...
                <INPUT type="text" name="E01AMTOPT" maxlength="16" size="17" value="<%= dcNew.getE01AMTOPT()%>" onkeypress="enterDecimal(event)">
            </TD>
