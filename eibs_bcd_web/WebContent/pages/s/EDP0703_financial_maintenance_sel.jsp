...
function goConfirm() {
	page= "${pageContext.request.contextPath}/pages/s/EDP0703_financial_maintenance.jsp"
}
...
<H3 align="center">Seleccion lineas para acumular en <span style="font-style: italic;"> <%= userPO.getHeader10().trim()%> </span>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="financial_maintenance.jsp, EDP0703"></H3>
