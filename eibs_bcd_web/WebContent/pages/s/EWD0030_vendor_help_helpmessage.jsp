      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25"> <%
        if ( ewd0030Help.getShowPrev() ) {
      			int pos = ewd0030Help.getFirstRec() - 21;
      			 out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.helps.JSEWD0023?NameSearch=" + NameSearch + "&FromRecord=" + pos + "&codeflag=" + codeflag +  "\" > <img src=\""+request.getContextPath()+"/images/s/previous_records1.gif\" border=0></A>");
        }
%> </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> <%       
        if ( ewd0030Help.getShowNext() ) {
      			int pos = ewd0030Help.getLastRec();
      			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.helps.JSEWD0023?NameSearch=" + NameSearch + "&FromRecord=" + pos + "&codeflag=" + codeflag +  "\" ><img src=\""+request.getContextPath()+"/images/s/next_records1.gif\" border=0></A>");
