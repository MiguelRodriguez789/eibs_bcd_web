...
<jsp:useBean id="msg051004" class="datapro.eibs.beans.ELC051004Message" scope="session" />
...
<BODY>
<H3 align="center">Comisiones de Cartas de Credito<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_commissi_m.jsp, ELC0525"></H3>
<HR size="4">
		...
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0"
			...
			<TR id="trdark">
				...
				<DIV align="left"><INPUT type="text" name="E04LCMBNK" readonly
					size="4" maxlength="2" value="<%=msg051004.getE04LCMBNK().trim()%>"></DIV></TD>
				<TD nowrap width="16%">
				<DIV align="right"><B>Producto : </B></DIV>
				</TD>
				<TD nowrap width="16%">
				<DIV align="left"><B> <INPUT type="text" name="E01LCMPRO" size="4"
					maxlength="4" value="<%=msg051004.getE04LCMPRO().trim()%>" readonly> </B>
				</DIV>
				</TD>
				<TD nowrap width="16%">
				...
				<DIV align="left"><B><INPUT type="text" name="E04LCMACC" size="12"
					maxlength="12" value="<%=msg051004.getE04LCMACC().trim()%>" readonly> </B>
				</DIV>
				</TD>
			</TR>
			<TR id="trclear">
				...
				<TD nowrap width="20%" colspan=3 align="left">
					<eibsinput:date name="msg051004" fn_month="E04LCMIDM" fn_day="E04LCMIDD" fn_year="E04LCMIDY" readonly="true"/>
				</TD>
				<TD nowrap width="16%">
				...
				<TD nowrap width="16%" align="left">
					...
					maxlength="2" value= "<%=msg051004.getE04LCMTAR()%>" readonly>
					<INPUT type="text" name="E04LCMTCY" size="3"
					maxlength="3" value= "<%=msg051004.getE04LCMTCY()%>" readonly>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="16%">
				...
				<TD nowrap width="20%" colspan=3 align="left">
					<eibsinput:date name="msg051004" fn_month="E04LCMEXM" fn_day="E04LCMEXD" fn_year="E04LCMEXY" readonly="true"/>
				</TD>
				<TD nowrap width="16%">
				...
				<DIV align="left"><B><INPUT type="text" name="E04LCMOAM" size="12"
					maxlength="12" value="<%=msg051004.getE04LCMOAM()%>" readonly> </B></DIV>
				</TD>
			</TR>
		</TABLE>
		</TD>
...
<TABLE class="tableinfo" border="0" cellspacing="0" cellpadding="4" width="100%">
					...
					if(msg051004.getH04FLGWK3().equals("N"))
						{
					...
					{
						value2.add(msg051004.getField((String)field2.get(i)).getString().trim());
					}
						...
						<TR id="<%=( i%2==0 ? "trclear" : "trdark" )%>">
							...
							<TD nowrap width="10%" align="center">
								<INPUT name="<%=field1.get(i)%>" type="text"
									value="<%=msg051004.getField((String) field1.get(i)).getString().trim()%>" size="15" maxlength="15" readonly="readonly">
						  </TD>
							<TD nowrap width="10%">
