...
<h3 align="center">Información Básica<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cp_inq_maint.jsp,EDL0105"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01DEACUN" readonly  size="10" maxlength="9" value="<%= cdMant.getE01DEACUN().trim()%>" >
               </div>
            </td>
            <td nowrap width="16%" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="27%"> 
              <input type="text" name="E01DEALID" readonly  size="3" maxlength="2" value="<%= cdMant.getE01DEALID().trim()%>" >
              <input type="text" name="E01DEALIM" readonly  size="3" maxlength="2" value="<%= cdMant.getE01DEALIM().trim()%>" >
              <input type="text" name="E01DEALIY" readonly  size="5" maxlength="4" value="<%= cdMant.getE01DEALIY().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="27%"> 
              <input type="text" name="E01DEAMDD"  size="3" maxlength="2" value="<%= cdMant.getE01DEAMDD().trim()%>" readonly>
              <input type="text" name="E01DEAMDM"  size="3" maxlength="2" value="<%= cdMant.getE01DEAMDM().trim()%>" readonly>
              <input type="text" name="E01DEAMDY"  size="5" maxlength="4" value="<%= cdMant.getE01DEAMDY().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
        ...
        <tr id="trclear"> 
         ...
         <tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEARDD" readonly  size="3" maxlength="2" value="<%= cdMant.getE01DEARDD().trim()%>" >
              <input type="text" name="E01DEARDM" readonly  size="3" maxlength="2" value="<%= cdMant.getE01DEARDM().trim()%>" >
              <input type="text" name="E01DEARDY" readonly  size="5" maxlength="4" value="<%= cdMant.getE01DEARDY().trim()%>" >
              / 
