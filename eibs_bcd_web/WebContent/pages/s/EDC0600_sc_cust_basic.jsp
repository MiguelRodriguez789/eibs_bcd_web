...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trdark"> 
            ...
            <td nowrap  > 
              <div align="right"><b>Codigo de Tabla :</b> </div>
            </td>
            <td nowrap  > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap  > 
              <div align="right"><b>Moneda Contable :</b></div>
            </td>
            <td nowrap  > 
              <div align="left"> 
          ...
          <TR id="trdark">
            ...
            <TD nowrap colspan="3"><input type="text" name="E01CUSNME" size="45" maxlength="45" value="<%= sc.getE01CUSNME().trim()%>" readonly></TD>
    	</TR>
  </table>
