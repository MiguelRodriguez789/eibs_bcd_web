...
%> 
<h3 align="center">Instrucciones de Renovaci&oacute;n de Certificados de Dep&oacute;sito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_renov_options,EDL0140"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left">
                <input type="text" name="E08DEACUN" size="10" maxlength="9" readonly value="<%= userPO.getCusNum().trim()%>">
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"><font face="Arial"><font face="Arial"><font size="2">
                <input type="text" name="E08CUSNA1" size="45" maxlength="45" readonly value="<%= userPO.getCusName().trim()%>">
                </font></font></font></div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left">
                <input type="text" name="E08DEAACC" size="13" maxlength="12" value="<%= userPO.getAccNum().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td>
        <table cellpadding=2 cellspacing=0 align=center width=100% bordercolor="#000000">
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td width="579"> 
              <input type="text" <% if (cdRenov.getF08DEAROR().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08DEAROR" size="9" maxlength="9" value="<%= cdRenov.getE08DEAROR().trim()%>">
              <input type="text" <% if (cdRenov.getF08DEAHTM().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08DEAHTM" size="9" maxlength="9" 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td height="32" colspan="2" > Inter&eacute;s ser&aacute; acreditado 
              a 
              <input type="text" <% if (cdRenov.getF08BBBFLG().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08BBBFLG" size="40"
              ...
              <input type="text" <% if (cdRenov.getF08BBBACC().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08BBBACC" size="12" maxlength="12" value="<%= cdRenov.getE08BBBACC().trim()%>">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td height="44" colspan="2" > Inter&eacute;s ser&aacute; acreditado 
              ...
              <input type="text" <% if (cdRenov.getF08CCCGLN().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08CCCGLN" size="16" maxlength="16" value="<%= cdRenov.getE08CCCGLN().trim()%>">
              <input type="text" <% if (cdRenov.getF08CCCFLV().equals("Y")||cdRenov.getF08CCCPVI().equals("Y")) out.print("class=\"txtchanged\""); %> name="E08CCCFLV" readonly size="25"
						value="<% if (cdRenov.getE08CCCFLV().equals("C")) out.print(",emitiendo un Cheque de Gerencia");
                								...
                								if (cdRenov.getE08CCCPVI().equals("F")) out.print("FED");
													...
													else if (cdRenov.getE08CCCPVI().equals("A")) out.print("ACH");
													else out.print(""); 
												} %>" >
			  . Con n&uacute;mero A.B.A
              <input type="text" <% if (cdRenov.getF08CCCABA().equals("Y")) out.print("id=\"txtchanged\""); %> readonly name="E08CCCABA" size="9" maxlength="10" value="<%= cdRenov.getE08CCCABA().trim()%>">  
              , a la cuenta
              <select name="E08CCCACT" disabled="disabled" <% if (cdRenov.getF08CCCACT().equals("Y")) out.print("id=\"txtchanged\""); %>>
					<option <%= cdRenov.getE08CCCACT().trim().equals("C")?"Selected":"" %> value="C">Corriente</option>
					<option <%= cdRenov.getE08CCCACT().trim().equals("S")?"Selected":"" %> value="S">de Ahorros</option>
			  </select>    
			  No.           
              <input type="text" <% if (cdRenov.getF08CCCBFAC().equals("Y")) out.print("id=\"txtchanged\""); %> readonly name="E08CCCBFAC" size="17" maxlength="18" value="<%= cdRenov.getE08CCCBFAC().trim()%>">									
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td height="46" colspan="2" > Al vencimiento cancelar el Dep&oacute;sito 
              ...
              <input type="text" <% if (cdRenov.getF08DDDGLN().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08DDDGLN" size="16" maxlength="16" value="<%= cdRenov.getE08DDDGLN().trim()%>">
              <input type="text" <% if (cdRenov.getF08DDDFLV().equals("Y")||cdRenov.getF08DDDPVI().equals("Y")) out.print("class=\"txtchanged\""); %> name="E08CCCFLV" readonly size="25"
				value="<% if (cdRenov.getE08DDDFLV().equals("C")) out.print(",emitiendo un Cheque de Gerencia");
							...
							else if (cdRenov.getE08DDDPVI().equals("A")) out.print("ACH");
							else out.print(""); }%>" >
			  . Con n&uacute;mero A.B.A 
              <input type="text" <% if (cdRenov.getF08DDDABA().equals("Y")) out.print("id=\"txtchanged\""); %> readonly name="E08DDDABA" size="9" maxlength="10" value="<%= cdRenov.getE08DDDABA().trim()%>">
              , a la cuenta     
              <select name="E08DDDACT" disabled="disabled" <% if (cdRenov.getF08DDDACT().equals("Y")) out.print("id=\"txtchanged\""); %>>
					<option <%= cdRenov.getE08DDDACT().trim().equals("C")?"Selected":"" %> value="C">Corriente</option>
					<option <%= cdRenov.getE08DDDACT().trim().equals("S")?"Selected":"" %> value="S">de Ahorros</option>
			  </select>    
			  No.                
              <input type="text" <% if (cdRenov.getF08DDDBFAC().equals("Y")) out.print("id=\"txtchanged\""); %> readonly name="E08DDDBFAC" size="17" maxlength="18" value="<%= cdRenov.getE08DDDBFAC().trim()%>">				
              . </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td width=35></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td height="36" colspan="2" >Al vencimiento cancelar el Dep&oacute;sito 
              ...
              <input type="text" <% if (cdRenov.getF08EEEACC().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08EEEACC" size="12" maxlength="12" value="<%= cdRenov.getE08EEEACC().trim()%>">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" > Al vencimiento renovar el Dep&oacute;sito y los 
              Intereses, 
              <input type="TEXT" name="E08FFFRPT" <% if (cdRenov.getF08FFFRPT().equals("Y")) out.print("class=\"txtchanged\""); %> readonly size="15"
              ...
              en 
              <input type="text" <% if (cdRenov.getF08FFFROA().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08FFFROA" size="15" maxlength="15" value="<%= cdRenov.getE08FFFROA().trim()%>">
              contra la Cuenta n&uacute;mero 
              <input type="text" <% if (cdRenov.getF08FFFACC().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08FFFACC" size="12" maxlength="12" value="<%= cdRenov.getE08FFFACC().trim()%>">
              (Corriente, Ahorro, etc.) . </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td height="19" colspan="2" >Al vencimiento renovar el Dep&oacute;sito 
              ...
              Intereses en 
              <input type="text" <% if (cdRenov.getF08GGGROA().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08GGGROA" size="15" maxlength="15" value="<%= cdRenov.getE08GGGROA().trim()%>">
              y acreditando los mismos en la Cuenta n&uacute;mero 
              <input type="text" <% if (cdRenov.getF08GGGACC().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08GGGACC" size="12" maxlength="12" value="<%= cdRenov.getE08GGGACC().trim()%>">
              (Corriente, Ahorro, etc.) . </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td width=35></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" > 
              <p>Inter&eacute;s ser&aacute; pagado cada 
                <input type="text" <% if (cdRenov.getF08HHHROY().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08HHHROY" size="3" maxlength="3" value="<%= cdRenov.getE08HHHROY().trim()%>">
                <input type="text" <% if (cdRenov.getF08HHHODA().equals("Y")) out.print("class=\"txtchanged\""); %> readonly  name="E08HHHODA"
					value="<% if (cdRenov.getE08HHHODA().equals("D")) out.print("Dias");
							  else if (cdRenov.getE08HHHODA().equals("M")) out.print("De Cada Mes");
							  else if (cdRenov.getE08HHHODA().equals("Y")) out.print("A&ntilde;os");
							  else out.print(""); %>">
                <input type="text" <% if (cdRenov.getF08HHHFLG().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08HHHFLG" size="40"
                ...
                , que tendr&aacute;n como n&uacute;mero 
                <input type="text" <% if (cdRenov.getF08HHHACC().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08HHHACC" size="12" maxlength="12" value="<%= cdRenov.getE08HHHACC().trim()%>">
                . El Principal ser&aacute; renovado por el mismo per&iacute;odo 
                de tiempo.</p>
            </td>
          </tr>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" > Inter&eacute;s ser&aacute; pagado cada 
              <input type="text" <% if (cdRenov.getF08IIIROY().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08IIIROY" size="3" maxlength="3" value="<%= cdRenov.getE08IIIROY().trim()%>">
              <input type="text" <% if (cdRenov.getF08IIIODA().equals("Y")) out.print("class=\"txtchanged\""); %> readonly size="15"
				value="<% if (cdRenov.getE08IIIODA().equals("D")) out.print("Dias");
						  else if (cdRenov.getE08IIIODA().equals("M")) out.print("De Cada Mes");
						  else if (cdRenov.getE08IIIODA().equals("Y")) out.print("A&ntilde;os");
						  else out.print(""); %>" >
              a la Cuenta Contable n&uacute;mero 
              <input type="text" <% if (cdRenov.getF08IIIGLN().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08IIIGLN" size="16" maxlength="16" value="<%= cdRenov.getE08IIIGLN().trim()%>">
              <input type="text" <% if (cdRenov.getF08IIIFLV().equals("Y")||cdRenov.getF08IIIPVI().equals("Y")) out.print("class=\"txtchanged\""); %> name="E08CCCFLV" readonly size="25"
				value="<% if (cdRenov.getE08IIIFLV().equals("C")) out.print(",emitiendo un Cheque de Gerencia");
							...
							else if (cdRenov.getE08IIIPVI().equals("A")) out.print("ACH");
							else out.print(""); }%>" >
			  . Con n&uacute;mero A.B.A 
              <input type="text" <% if (cdRenov.getF08IIIABA().equals("Y")) out.print("id=\"txtchanged\""); %> readonly name="E08IIIABA" size="9" maxlength="10" value="<%= cdRenov.getE08IIIABA().trim()%>"> 
              , a la cuenta     
              <select name="E08IIIACT" disabled="disabled" <% if (cdRenov.getF08IIIACT().equals("Y")) out.print("id=\"txtchanged\""); %>>
					<option <%= cdRenov.getE08IIIACT().trim().equals("C")?"Selected":"" %> value="C">Corriente</option>
					<option <%= cdRenov.getE08IIIACT().trim().equals("S")?"Selected":"" %> value="S">de Ahorros</option>
			  </select>    
			  No.               
              <input type="text" <% if (cdRenov.getF08IIIBFAC().equals("Y")) out.print("id=\"txtchanged\""); %> readonly name="E08IIIBFAC" size="17" maxlength="18" value="<%= cdRenov.getE08IIIBFAC().trim()%>">				
              . El Principal ser&aacute; renovado por el mismo per&iacute;odo 
              de tiempo.</td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" > Inter&eacute;s y Principal ser&aacute;n pagados 
              ...
              <input type="text" <% if (cdRenov.getF08JJJACC().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08JJJACC" size="12" maxlength="12" value="<%= cdRenov.getE08JJJACC().trim()%>">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td colspan="2" > Inter&eacute;s ser&aacute; pagado <%if (cdRenov.getE08KKKFL1().equals("1")) {%> 
              cada 
              <input type="text" <% if (cdRenov.getF08KKKROY().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08KKKROY" size="3" maxlength="3" value="<%= cdRenov.getE08KKKROY().trim()%>">
              <input type="text" <% if (cdRenov.getF08KKKODA().equals("Y")) out.print("class=\"txtchanged\""); %> readonly size="15"
				value="<% if (cdRenov.getE08KKKODA().equals("D")) out.print("Dias");
						  else if (cdRenov.getE08KKKODA().equals("M")) out.print("De Cada Mes");
						  else if (cdRenov.getE08KKKODA().equals("Y")) out.print("A&ntilde;os");
						  else out.print(""); %>" >
              <%}
				else if (cdRenov.getE08KKKFL1().equals("2")) {%> a fin de mes 
              <% } %> 
              <input type="text" <% if (cdRenov.getF08KKKFLG().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08KKKFLG" size="40"
              ...
              , que tendr&aacute;n como n&uacute;mero 
              <input type="text" <% if (cdRenov.getF08KKKACC().equals("Y")) out.print("class=\"txtchanged\""); %> readonly name="E08KKKACC" size="12" maxlength="12" value="<%= cdRenov.getE08KKKACC().trim()%>">
              .</td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td width=35></td>
