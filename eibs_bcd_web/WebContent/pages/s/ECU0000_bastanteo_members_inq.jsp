...
<H3 align="center">Sistema de Bastanteo - Consulta de Integrantes de la Administraci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_members_inq,ECU0000"></H3>
<hr size="4">
