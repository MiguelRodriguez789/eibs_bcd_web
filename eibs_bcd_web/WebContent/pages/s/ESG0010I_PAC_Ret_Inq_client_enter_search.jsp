...
<title>Consulta de Seguros Retractados</title>
...
<h3 align="center">Consulta de Seguros Retractados<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="PAC_Inq_client_search.jsp,ESG0010"></h3>
<hr size="4">
