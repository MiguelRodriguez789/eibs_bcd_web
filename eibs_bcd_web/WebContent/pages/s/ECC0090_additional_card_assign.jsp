...
<body>
<h3 align="center">Asignación de Tarjetas de Débito<br>Tarjeta Adicional<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="additional_card_assign.jsp, ECC0090">
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="16%" > 
              <div align="left"> 
                <input type="text" name="E03PRICUN" size="10" maxlength="9" value="<%= msgCD.getE01PRICUN()%>" readonly>
			  </div>
            </td>
            <td nowrap width="16%" > 
