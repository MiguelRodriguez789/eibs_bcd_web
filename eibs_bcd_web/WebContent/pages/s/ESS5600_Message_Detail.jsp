...
<h3 align="center">Marketing Message<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cliente_personal_new_data, ESS2000" ></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          ...
          <tr id="teclear"> 
            ...
            <td nowrap width="60%" ><div align="left"> 
                ...
                <a href="javascript:DOBPicker(document.forms[0].IMDSTMM,document.forms[0].IMDSTDD,document.forms[0].IMDSTYY)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="ayuda" align="middle" border="0"></a> 
                ...
                <a href="javascript:DOBPicker(document.forms[0].IMDENDM,document.forms[0].IMDENDD,document.forms[0].IMDENDY)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="ayuda" align="middle" border="0"></a> 
                <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0" > 
                (DD-MM-AAAA)                       
            </div></TD>
			</tr>                  
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%"><div align="left">
             ...
             <IMG src="<%=request.getContextPath()%>/images/Check.gif"
					title="mandatory field" align="bottom" border="0"></div>
           </td>
          ...
          <tr id="teclear"> 
            ...
            <td nowrap width="60%" ><div align="left"><SELECT name="IMDFRQ">
								...
								<IMG src="<%=request.getContextPath()%>/images/Check.gif"
					title="mandatory field" align="bottom" border="0"></div></td>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" ><div align="left"><SELECT
					...
					title="mandatory field" align="bottom"></div></td>
				...
				<TD nowrap width="30%"><SELECT name="IMDSEX">
					...
					title="mandatory field" align="bottom"></TD>
			</TR>
			<tr id="teclear"> 
            ...
            <td nowrap ><div align="left"> <input type="text" name="IMDEDU" size="5" maxlength="4" value="<%= msgData.getIMDEDU() %>">
			                 <a href="javascript:GetCodeCNOFC('IMDEDU','29')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a>
            	</div></td>
				...
				<TD nowrap >
	              <input type="text" name="IMDUC9" size="5" maxlength="4" value="<%= msgData.getIMDUC9() %>">
                    <a href="javascript:GetCodeCNOFC('IMDUC9','49')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a>
				</TD>
			</TR>
			<TR id="trdark">
              ...
              <a href="javascript:GetCodeCNOFC('IMDUC1','2A')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a> 
              </TD>
				...
				<TD nowrap >
	              ...
	              <a href="javascript:GetCodeCNOFC('IMDINC','09')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a> 				
				</TD>
			</TR>
			<TR id="teclear">
				...
				<TD nowrap ><input type="text" name="IMDRSL" size="5" maxlength="4" value="<%= msgData.getIMDRSL() %>">
                   <a href="javascript:GetCodeCNOFC('IMDRSL','31')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a> 				
				</TD>
			</TR>
			<tr id="trdark"> 
              ...
              <a href="javascript:GetCodeCNOFC('IMDOFC','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a> 
             </div>
           </td>
            ...
            <td nowrap ><div align="left"><INPUT type="text" name="IMDPRD" size="5" maxlength="4" value="<%= msgData.getIMDPRD() %>">
                      <a href="javascript:GetProduct('IMDPRX', '', '','','IMDPRD')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"  ></a> 
            </div></td>
          </tr>
          <tr id="teclear"> 
