...
<h3 align="center">Consulta Credilinea<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="maint_approve_enter.jsp,EPV0153"></h3>
<hr size="4">
...
<table id="TBHELPN" width="100%" border="0" cellspacing="0"
	...
	<tr>
		...
		<td  width="50%">
              ...
              <a href="javascript:GetAccountInfo('E01DEAACC','','L2','','','','','', 'E01DEAPRO')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
			  <input type="hidden" name="E01DEAPRO" size="5" maxlength="4">
	</tr>
