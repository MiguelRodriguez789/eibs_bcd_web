...
<H3 align="center">Transacciones Pagos Proveedores por Internet<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="DCIBS_log_transaction_list.jsp, DCIBS"></H3>
<hr size="4">
