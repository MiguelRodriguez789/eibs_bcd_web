...
<form>
  ...
  <h3 align="center">Consulta - Cuentas en Moneda Extranjera <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_acc.jsp,EWD0333"> 
  </h3>
<hr size="4">
