...
<H3 align="center">Mantenimiento Carta de Credito 
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="lc_enter_maint.jsp ELC510"></H3>
<HR size="4">
  ...
  <TABLE class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
    <TR>
      ...
      <TD nowrap width="50%">
        ...
        <A href="javascript:GetAccount('E01LCMACC','','CC','')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0" ></A>
      </TD>
    </TR>
    <TR>
