...
<script type="text/javascript">
 ...
 function goAction(op) {
	if (op == "A") {
		document.forms[0].getElementById('SCREEN').value = 5;
		document.forms[0].submit();		 
	}
	else if (op == "D") {
		document.forms[0].getElementById('SCREEN').value = 9;
		document.forms[0].submit();
	}    
 }
 
 function goVendorDetail(row){
    page = "${pageContext.request.contextPath}/servlet/datapro.eibs.params.JSEIBP0050?SCREEN=2&document.getElementById('ROW')"+row;
...
<h3 align="center">Aprobaci&oacute;n de Proveedores de Internet
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="approval_list.jsp, EIBP0050">
</h3>
<hr size="4">
...
<INPUT TYPE=HIDDEN id="action" NAME="action" VALUE="A">
				...
				<TABLE id="headTable" width="100%">
					<TR id="trdark"> 
					    ...
					    %>            
						        <TR>
									<TD NOWRAP >
										<SELECT id="E01INASEL" name="E01INASEL" >
