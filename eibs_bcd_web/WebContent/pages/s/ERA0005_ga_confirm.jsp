...
%> 
<h3 align="center">Asignación de Garantias a Cuentas del Cliente
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_confirm.jsp, ERA0005"> 
</h3>
<hr size="4">
