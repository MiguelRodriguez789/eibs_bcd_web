...
<H3 align="center">Impresion Datos del Titular en Libreta de Ahorros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="savings_printer_detail,EDD7000"></H3>
<hr size="4">
   ...
   <td>
    <TABLE cellspacing=0 cellpadding=2 width="100%" border="0">    
			...
			<TR>
				...
				<TD nowrap width="60%">
					<INPUT type="text" name="E01CUSIDN" size="27" maxlength="25" value="<%= msgMT.getE01CUSIDN() %>" readonly> 
				</TD>
			</TR>
			<TR>
				<TD nowrap width="40%">
			...
			<TR>
				...
				<TD nowrap width="60%">
					<INPUT type="text" name="E01CUSBRN" size="5" maxlength="4" value="<%= msgMT.getE01CUSBRN() %>" readonly> 
				</TD>
			</TR>
			<TR>
				<TD nowrap width="40%">
