...
<h3 align="center"> Canal de Pago <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chanel_codes_basic.jsp, EPR0300"> </h3>
...
<H4><br>Parametros Mensajes Outgoing<br></H4>       
       <table class="tableinfo">
            <tr id="trdark"> 
              	...
              	<td nowrap > 
                	<div align="left"> 
                  		<input type="text" name="E01PRCDBK" id="E01PRCDBK" size="3" maxlength="2" value="<%= msgPart.getE01PRCDBK().trim()%>" >
                  		<input type="text" name="E01PRCDBR" size="5" maxlength="4"  value="<%= msgPart.getE01PRCDBR().trim()%>" class="context-menu-help" onmousedown="init(branchHelp,this.name,document.getElementById('E01PRCDBK').value,'','','','')"onkeypress="enterInteger(event)">
                		<input type="text" name="E01PRCDCY" id="E01PRCDCY" size="4" maxlength="3" value="<%= msgPart.getE01PRCDCY().trim()%>"  class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.getElementById('E01PRCDBK').value,'','','','')"> 
                		<input type="text" name="E01PRCDGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCDGL().trim()%>" onkeypress="enterInteger(event)" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.getElementById('E01PRCDBK').value,document.getElementById('E01PRCDCY').value,'','','')">
                	</div>
              	</td>
            </tr>   
            <tr id="trclear"> 
            ...
            <tr id="trdark"> 
              	...
              	<td nowrap > 
                	<div align="left"> 
                  		<input type="text" name="E01PRCLBK" id="E01PRCLBK" size="3" maxlength="2" value="<%= msgPart.getE01PRCLBK().trim()%>" >
                  		<input type="text" name="E01PRCLBR" size="5" maxlength="4"  value="<%= msgPart.getE01PRCLBR().trim()%>" class="context-menu-help" onmousedown="init(branchHelp,this.name,document.getElementById('E01PRCLBK').value,'','','','')"onkeypress="enterInteger(event)">
                		<input type="text" name="E01PRCLCY" id="E01PRCLCY" size="4" maxlength="3" value="<%= msgPart.getE01PRCLCY().trim()%>"  class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.getElementById('E01PRCLBK').value,'','','','')"> 
                		<input type="text" name="E01PRCLGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCLGL().trim()%>" onkeypress="enterInteger(event)" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.getElementById('E01PRCLBK').value,document.getElementById('E01PRCLCY').value,'','','')">
                	</div>
              	</td>
            </tr>   
           	...
           	<td nowrap > 
                	<div align="left"> 
			      		...
			      		<input	type="text" name="D01PRCMPG" size="35" maxlength="30" value="<%= msgPart.getD01PRCMPG().trim()%>" readonly >
 	  	       		 <a href="javascript:GetCodeDescCNOFC('E01PRCMPG','D01PRCMPG','MP')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
           ...
           <table id="mainTable" class="tableinfo">
	            <tr id="trdark"> 
	              	...
	              	<td nowrap colspan="2"> 
	                	<div align="left"> 
                  		<input type="text" name="E01PRCCBK" id="E01PRCCBK" size="3" maxlength="2" value="<%= msgPart.getE01PRCCBK().trim()%>">
                  		<input type="text" name="E01PRCCBR" size="5" maxlength="4" value="<%= msgPart.getE01PRCCBR().trim()%>">
                  		<input type="text" name="E01PRCCCY" id="E01PRCCCY" size="4" maxlength="3" value="<%= msgPart.getE01PRCCCY().trim()%>">
                  		<input type="text" name="E01PRCCGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCCGL().trim()%>" onkeypress="enterInteger(event)" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.getElementById('E01PRCCBK').value,document.getElementById('E01PRCCCY').value,'','','')">
                	</div>
              	</td>
            </tr>
            <tr id="trclear"> 
	            ...
	            <tr id="trdark"> 
	              	...
	              	<td nowrap colspan="2"> 
	                	<div align="left"> 
                  		<input type="text" name="E01PRCRBK" id="E01PRCRBK" size="3" maxlength="2" value="<%= msgPart.getE01PRCRBK().trim()%>">
                  		<input type="text" name="E01PRCRBR" size="5" maxlength="4" value="<%= msgPart.getE01PRCRBR().trim()%>">
                  		<input type="text" name="E01PRCRCY" id="E01PRCRCY" size="4" maxlength="3" value="<%= msgPart.getE01PRCRCY().trim()%>">
                  		<input type="text" name="E01PRCRGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCRGL().trim()%>" onkeypress="enterInteger(event)" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.getElementById('E01PRCCBK').value,document.getElementById('E01PRCCCY').value,'','','')">
                	</div>
              	</td>
            </tr>
            <tr id="trclear"> 
            ...
            <tr id="trdark"> 
              	...
              	<td nowrap colspan="2"> 
	                	<div align="left"> 
                  		<input type="text" name="E01PRCVBK" id="E01PRCVBK" size="3" maxlength="2" value="<%= msgPart.getE01PRCVBK().trim()%>">
                  		<input type="text" name="E01PRCVBR" size="5" maxlength="4" value="<%= msgPart.getE01PRCVBR().trim()%>">
                  		<input type="text" name="E01PRCVCY" id="E01PRCVCY" size="4" maxlength="3" value="<%= msgPart.getE01PRCVCY().trim()%>">
                  		<input type="text" name="E01PRCVGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCVGL().trim()%>" onkeypress="enterInteger(event)" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.getElementById('E01PRCVBK').value,document.getElementById('E01PRCVCY').value,'','','')">
                	</div>
              	</td>
            </tr>
            <tr id="trclear"> 
