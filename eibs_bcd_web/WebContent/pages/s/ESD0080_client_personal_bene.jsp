...
<h3 align="center">Beneficiarios 
  <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_personal_bene, ESD0080"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" name="TB_BENEFICIARY_CORP" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
          <tr id="trclear"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA1" size="65" maxlength="60"  value="<%= bene.getField("E" + name + "4MA1").getString().trim()%>">
              </td>
          </tr>
		...
		<%} %>   
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              ...
              <input type="text" name="E<%= name %>4CAR" maxlength="45" size="50" value="<%= bene.getField("E" + name + "4CAR").getString().trim()%>" >
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4D21" maxlength="2" size="3" value="<%= bene.getField("E" + name + "4D21").getString().trim()%>">
              <input type="text" name="E<%= name %>4D22" maxlength="2" size="3" value="<%= bene.getField("E" + name + "4D22").getString().trim()%>">
              <input type="text" name="E<%= name %>4D23" maxlength="4" size="5" value="<%= bene.getField("E" + name + "4D23").getString().trim()%>">
              </td>
          </tr>
          <tr id="trdark"> 
            <td width="42%" nowrap > 
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4INC" maxlength="4" size="5" value="<%= bene.getField("E" + name + "4INC").getString().trim()%>">
                <a href="javascript:GetCodeCNOFC('E<%= name %>4INC','33')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"  ></a>	
              </td>
          </tr>
          <tr id="trdark"> 
            <td width="42%" nowrap > 
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap> 
              <input type="radio" name="E<%= name %>4BSX" value="F" <% if (bene.getField("E" + name + "4BSX").getString().equals("F")) out.print("checked"); %>>
              Femenino 
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4BNI" maxlength="25" size="26" value="<%= bene.getField("E" + name + "4BNI").getString().trim()%>">
              </td>
          </tr>
