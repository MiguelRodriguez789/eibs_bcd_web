...
<body>
<h3 align="center">Tarjeta de <% if (userPO.getHeader2().equals("D")) out.print("Débito"); else out.print("Crédito");%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_ap_aditional_card.jsp,ECC0140"> 
</h3>
<hr size="4">
<% 
          ...
          <tr id="trdark"> 
            <TD nowrap width="25%"> 
              <DIV align="right">Fecha de expiracion :</DIV>
            	...
            	<eibsinput:date name="msgCC" fn_month="E01CCREXM" fn_day="E01CCREXD" fn_year="E01CCREXY" readonly="true" />
            </TD>
            ...
            <td nowrap width="27%"> 
            	<eibsinput:date name="msgCC" fn_month="E01CCRISM" fn_day="E01CCRISD" fn_year="E01CCRISY" readonly="true" />
  			</td>
          </tr>                                                                                           
        </table>
      </td>
