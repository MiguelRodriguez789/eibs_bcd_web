...
<TABLE id="tbhelp" align="center" width="447" border="0" cellspacing="0"
	cellpadding="0">
	<TR>
		<Td align="CENTER"><b>Busqueda de Agentes Cobradores y Plazas
		de Pago</b></Td>
	</TR>
	<TR>
		<TD align="CENTER">&nbsp;</TD>
	...
	<TR>
		<TD align="CENTER">Ingrese el nombre corto : <INPUT type="text"
			name="SelNew" size=14> &nbsp;&nbsp;<IMG
