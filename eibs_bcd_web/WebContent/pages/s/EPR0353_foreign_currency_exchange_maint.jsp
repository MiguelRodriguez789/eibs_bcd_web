...
function GetInfo(currentrow){
	...
	pg= "${pageContext.request.contextPath}/pages/s/EPR0353_foreign_currency_exchange_conceptos.jsp?CurrRow="+ currentrow;
...
<H3 align="center">Fraccionamiento de Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_maint, EPR0353"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	<tr id=trdark>
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E02REQBRN" size="5" maxlength="4" value="<%= msgFrac.getE02REQBRN() %>" readonly>
		...
		<tr id=trdark>
			...
			<td nowrap>
                <input type="text" name="E02REQVD1" size="3" maxlength="2" value="<%= msgFrac.getE02REQVD1() %>" readonly>
                <input type="text" name="E02REQVD2" size="3" maxlength="2" value="<%= msgFrac.getE02REQVD2() %>" readonly>
                <input type="text" name="E02REQVD3" size="5" maxlength="4" value="<%= msgFrac.getE02REQVD3() %>" readonly>
			</td>
		</tr>
     </table>
    </td>
  ...
  <TR><TD>
   <table id="headTable" width="100%">
    ...
    <tr id="trclear" align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02ORIBR1" size="4" maxlength="4" value="<%= msgFrac.getE02ORIBR1() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02ORIBR2" size="4" maxlength="4" value="<%= msgFrac.getE02ORIBR2() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02ORIBR3" size="4" maxlength="4" value="<%= msgFrac.getE02ORIBR3() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02ORIBR4" size="4" maxlength="4" value="<%= msgFrac.getE02ORIBR4() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02ORIBR5" size="4" maxlength="4" value="<%= msgFrac.getE02ORIBR5() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
		...
		<tr>
			<td>
				<input type="text" name="E02REQIN1" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN1() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN1','E02REQID1','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('1')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%> 
		</tr>
		<tr>
			<td>
				<input type="text" name="E02REQIN2" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN2() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN2','E02REQID2','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('2')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%>  
		</tr>
		<tr>
			<td>
				<input type="text" name="E02REQIN3" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN3() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN3','E02REQID3','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('3')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%> 
		</tr>
		<tr>
			<td>
				<input type="text" name="E02REQIN4" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN4() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN4','E02REQID4','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('4')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%>  
		</tr>
		<tr>
			<td>
				<input type="text" name="E02REQIN5" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN5() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN5','E02REQID5','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('5')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%> 
		</tr>
		<tr>
			<td>
				<input type="text" name="E02REQIN6" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN6() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN6','E02REQID6','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('6')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%>  
		</tr>
		<tr>
			<td>
				<input type="text" name="E02REQIN7" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN7() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN7','E02REQID7','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('7')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%> 
		</tr>
		<tr>
			<td>
				<input type="text" name="E02REQIN8" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN8() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN8','E02REQID8','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('8')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%> 
		</tr>
		<tr>
			<td>
				<input type="text" name="E02REQIN9" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN9() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN9','E02REQID9','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('9')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%>  
		</tr>
		<tr>
			<td>
				<input type="text" name="E02REQIN0" size="5" maxlength="4" value="<%= msgFrac.getE02REQIN0() %>" 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02REQIN0','E02REQID0','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			</td>
			<td>
			...
			<td align="left" nowrap> <a href="javascript:GetInfo('0')" ><img src="<%=request.getContextPath()%>/images/s/info.gif" title="Conceptos" align="middle" border="0" ></a>
			<%}%> 
		</tr>
		<tr>
			<td align="center">
