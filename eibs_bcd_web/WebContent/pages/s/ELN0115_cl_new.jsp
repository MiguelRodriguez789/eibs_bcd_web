...
<h3 align="center">Apertura de Porcentaje de Incidencia en Linea Financiera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cl_enter_maint, ELN0000"> 
</h3>
<hr>
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter" border=0   width=70% align="center" height="80%">
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=40% align="left" height="24" > 
          <input type="text" name="BANK" size="4" maxlength="9" onKeyPress="enterInteger(event)">
        </td>
      </tr>
      <tr valign="middle"> 
        ...
        <td nowrap width=40% align="left" height="24" > 
          ...
          <a href="javascript:GetCodeCNOFC('MODULE','04')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
        </td>
      </tr>
      <tr valign="middle"> 
