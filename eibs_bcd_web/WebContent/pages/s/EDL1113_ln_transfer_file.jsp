...
%> 
 ...
 <h3 align="center">Banesco - Abonos Masivos, opción automática<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_transfer_file.jsp, EDL1113"></h3>
<hr size="4">
      ...
      <td nowrap height="143"> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              <div align="left"> 
	              <input type="radio" name="OPT" value="1" checked>Seguro Social Empleados 
	              <input type="radio" name="OPT" value="2">Seguro Social Jubilados
	              <input type="radio" name="OPT" value="3">Contraloría General
              </div>
            </td>
          </tr>
