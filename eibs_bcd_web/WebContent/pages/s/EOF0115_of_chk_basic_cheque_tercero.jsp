...
<H3 align="center">Emisi&oacute;n de Cheques de Terceros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="of_chk_basic.jsp, EOF0115"> 
</H3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="20%"> 
              <div align="right">Numero Registro :</div>
            </td>
            <td nowrap width="30%">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
			...
			<td nowrap >
              <eibsinput:text name="offBasic" property="E01OFMBNF" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NARRATIVE%>" readonly="false"/> <br>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap  width="30%" colspan="3"> 
              <input type="radio" name="E01OFMBSL" value="1" <%if (!offBasic.getE01OFMBSL().equals("2")) out.print("checked"); %>>
              <%= offBasic.getE01OFMBC1() + "-" + offBasic.getE01OFMBD1().toUpperCase()%> <br>
              <input type="radio" name="E01OFMBSL" value="2" <%if (offBasic.getE01OFMBSL().equals("2")) out.print("checked"); %>>
              <%= offBasic.getE01OFMBC2() + "-" + offBasic.getE01OFMBD2().toUpperCase()%>
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap width="30%" colspan="3">
 	           <eibsinput:text	name="offBasic" property="E01OFMAPL" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NARRATIVE%>" readonly="false"/> <br>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap width="30%" colspan="3"> 
	           <eibsinput:text	name="offBasic" property="E01OFMCO1" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_TEXT%>" size="80" maxlength="80"  readonly="false"/> <br>
	           <eibsinput:text	name="offBasic" property="E01OFMCO2" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_TEXT%>" size="80" maxlength="80" readonly="false"/> <br>
	           <eibsinput:text	name="offBasic" property="E01OFMCO3" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_TEXT%>" size="80" maxlength="80" readonly="false"/> <br>
	           <eibsinput:text	name="offBasic" property="E01OFMCO4" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_TEXT%>" size="80" maxlength="80" readonly="false"/> <br>
	           <eibsinput:text	name="offBasic" property="E01OFMCO5" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_TEXT%>" size="80" maxlength="80" readonly="false"/>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
           	<td nowrap width="20%"> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            		<td width="41%" > 
              		<div align="center"> 
                		...
                		<input type="text" name="E01DEBCON" size="45" maxlength="45" readonly value="<%= offBasic.getE01DEBCON().trim()%>" >
              		</div>
            		</td>
            		<td width="5%" > 
              		<div align="center"> 
