...
<h3 align="center">Seleccionar Planilla de Convenio a Pagar<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="covenant_pay_search.jsp, ECO0200"></h3>
<hr size="4">
