<HTML>
<HEAD>
<TITLE>Aprobación de Documentos Recibidos</TITLE>
...
<H3 ALIGN="center">Control de Documentos Recibidos <IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left"
	NAME="EIBS_GIF" title="lc_doc_info_readonly.jsp, ELC0200"></H3>
<HR SIZE="4">
<BR>
...
<TABLE class="tableinfo" id="trclear" cellspacing="0" cellpadding="2" width="100%" border="0" > 
    <TR id="trdark">
		...
		<TD nowrap align="left">
			<INPUT name="E01LCIRDM" value="<%=msg01.getE01LCIRDM()%>" size="3" maxlength="2" readonly="readonly"> 
			<INPUT name="E01LCIRDD" value="<%=msg01.getE01LCIRDD()%>" size="3" maxlength="2" readonly="readonly"> 
			<INPUT name="E01LCIRDY" value="<%=msg01.getE01LCIRDY()%>" size="5" maxlength="4" readonly="readonly"> 
			<INPUT name="E01LCIRTI" value="<%=msg01.getE01LCIRTI()%>" size="7" maxlength="6" onkeypress="enterInteger(event)" readonly="readonly"></TD>
	...
	<TR id="trclear">
		...
		<TD nowrap colspan="3">
		    <SELECT name="E01LCINDF" disabled>
			  ...
			  <%if(msg01.getE01LCIGDE().trim().equalsIgnoreCase("Y")) out.print("checked");%> disabled>
              Si
              ...
              <input type="radio" disabled name="CE01LCIDEL" value="Y" onClick="document.forms[0].E01LCIDEL.value='Y'"
			  <%if(msg01.getE01LCIDEL().trim().equalsIgnoreCase("Y")) out.print("checked");%>>
              Si
              <input type="radio" disabled name="CE01LCIDEL" value="N" onClick="document.forms[0].E01LCIDEL.value='N'"
			  <%if(!msg01.getE01LCIDEL().trim().equalsIgnoreCase("Y")) out.print("checked");%>>
              No</td>
			  </TR>
</TABLE>
...
<TABLE width="100%" border="0" class="tableinfo" id="trclear">
	...
	<tr id="trclear">
		...
		<TD nowrap>
			<INPUT name="E01LCIDAM" value="<%=msg01.getE01LCIDAM()%>" size="3" maxlength="2" readonly="readonly">  
			<INPUT name="E01LCIDAD" value="<%=msg01.getE01LCIDAD()%>" size="3" maxlength="2" readonly="readonly">  
			<INPUT name="E01LCIDAY" value="<%=msg01.getE01LCIDAY()%>" size="5" maxlength="4" readonly="readonly"> 
	...
	<tr id="trclear">
		...
		<TD nowrap>
			<INPUT name="E01LCIVDM" value="<%=msg01.getE01LCIVDM()%>" size="3" maxlength="2" readonly="readonly">  
			<INPUT name="E01LCIVDD" value="<%=msg01.getE01LCIVDD()%>" size="3" maxlength="2" readonly="readonly">  
			<INPUT name="E01LCIVDY" value="<%=msg01.getE01LCIVDY()%>" size="5" maxlength="4" readonly="readonly"> 
...
<TABLE width="100%" border="0" class="tableinfo">
  ...
  <TR>
    ...
    <TD><INPUT name="E01LCINB1" value="<%=msg01.getE01LCINB1()%>" maxlength="45" size="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">Direcci&oacute;n: </TD>
    <TD><INPUT name="E01LCINB2" value="<%=msg01.getE01LCINB2()%>" maxlength="45" size="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">&nbsp;</TD>
    <TD><INPUT name="E01LCINB3" value="<%=msg01.getE01LCINB3()%>" maxlength="45" size="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">&nbsp;</TD>
    <TD><INPUT name="E01LCINB4" value="<%=msg01.getE01LCINB4()%>" size="45" maxlength="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">Estado: </TD>
    <TD><INPUT name="E01LCINB5" value="<%=msg01.getE01LCINB5()%>" maxlength="4" size="4" readonly="readonly"> 
    C&oacute;digo Postal: 
	    <INPUT name="E01LCINB6" value="<%=msg01.getE01LCINB6()%>" size="15" maxlength="15" readonly="readonly">&nbsp; 
	Pais:  
...
<TABLE width="100%" border="0" class="tableinfo" id="trclear">
  ...
  <TR>
    <TD align="right">Nombre: </TD>
    <TD><INPUT name="E01LCIRB1" value="<%=msg01.getE01LCIRB1()%>" maxlength="45" size="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">Direcci&oacute;n: </TD>
    <TD><INPUT name="E01LCIRB2" value="<%=msg01.getE01LCIRB2()%>" maxlength="45" size="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">&nbsp;</TD>
    <TD><INPUT name="E01LCIRB3" value="<%=msg01.getE01LCIRB3()%>" maxlength="45" size="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">&nbsp;</TD>
    <TD><INPUT name="E01LCIRB4" value="<%=msg01.getE01LCIRB4()%>" size="45" maxlength="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">Estado: </TD>
    <TD><INPUT name="E01LCIRB5" value="<%=msg01.getE01LCIRB5()%>" maxlength="4" size="4" readonly="readonly"> 
    C&oacute;digo Postal:  
        <INPUT name="E01LCIRB6" value="<%=msg01.getE01LCIRB6()%>" size="15" readonly="readonly">&nbsp;
    Pais: 
...
<TABLE width="100%" border="0" class="tableinfo" id="trclear">
  ...
  <TR>
    <TD align="right">Nombre: </TD>
    <TD><INPUT name="E01LCIBB1" value="<%=msg01.getE01LCIBB1()%>" maxlength="45" size="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">Direcci&oacute;n: </TD>
    <TD><INPUT name="E01LCIBB2" value="<%=msg01.getE01LCIBB2()%>" maxlength="45" size="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">&nbsp;</TD>
    <TD><INPUT name="E01LCIBB3" value="<%=msg01.getE01LCIBB3()%>" maxlength="45" size="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">&nbsp;</TD>
    <TD><INPUT name="E01LCIBB4" value="<%=msg01.getE01LCIBB4()%>" size="45" maxlength="45" readonly="readonly"></TD>
  </TR>
  <TR>
    <TD align="right">Estado: </TD>
    <TD><INPUT name="E01LCIBB5" value="<%=msg01.getE01LCIBB5()%>" maxlength="4" size="4" readonly="readonly"> 
    C&oacute;digo Postal:  
        <INPUT name="E01LCIBB6" value="<%=msg01.getE01LCIBB6()%>" size="15" readonly="readonly">&nbsp;
    Pais:  
