...
%> 
<h3 align="center">Intrucciones de Pago  (Renovación)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cp_inq_renov_options,EDL0105"></h3>
<hr size="4">
