...
<BODY>
<h3 align="center">Lista de Deducciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="help_brk_list.jsp,EDL0370"></h3>
<hr size="4">
...
%>
  ...
  <TABLE class="tableinfo" style="width:95%" ALIGN=CENTER>
    ...
    %>
        <TR> 
			<TD ALIGN=center nowrap><div><a href="javascript:enter('<%= brkList.getRecord(4) %>')"><%= brkList.getRecord(4) %></a></DIV></TD>
			<TD ALIGN=LEFT nowrap><div><a href="javascript:enter('<%= brkList.getRecord(4) %>')"><%= brkList.getRecord(9) %></a></DIV></TD>      
			<TD ALIGN=center nowrap><div><a href="javascript:enter('<%= brkList.getRecord(4) %>')"><%= brkList.getRecord(5) %></a></DIV></TD>
			<TD ALIGN=center nowrap><div><a href="javascript:enter('<%= brkList.getRecord(4) %>')"><%= brkList.getRecord(6) %></a></DIV></TD>
			<TD ALIGN=center nowrap><div ><a href="javascript:enter('<%= brkList.getRecord(4) %>')">
