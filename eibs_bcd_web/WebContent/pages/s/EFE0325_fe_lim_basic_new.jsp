...
%> 
<h3 align="center"> L&iacute;mites Establecidos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_lim_basic_new.jsp,EFE0325"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap > 
              ...
              <a href="javascript:GetCurrency('E01FEOCCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
			  ...
			  >
              <input type="text" name="E01FEODT3" size="5" maxlength="4" value="<%= fex.getE01FEODT3().trim()%>" 
			   >
            </td>
            <td nowrap > 
              <div align="right"></div>
