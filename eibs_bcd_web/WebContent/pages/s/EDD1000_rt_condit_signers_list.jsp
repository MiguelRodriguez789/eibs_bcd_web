...
%>
    ...
    function showInfo(idx) {
	   page= "${pageContext.request.contextPath}/pages/s/EDD1000_rt_condit_signers_maint.jsp?ROW=" + idx;
...
<BODY>
 ...
 <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_condit_signers_list.jsp, EDD1000"> 
    </h3>
   <hr size="4">
