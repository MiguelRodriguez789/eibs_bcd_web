...
<h3 align="center">Abonos Masivos, Proceso Automático - Modificación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_maint_sch.jsp, EDL1111"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" id="INFOCHG">
          ...
          <tr id="trdark"> 
            ...
            <td > 
              <input type="text" name="E01DLCVA1" size="17" maxlength="15" value="<%= msgLN.getE01DLCVA1().trim()%>" onkeypress="enterDecimal()">
            </td>
          </tr>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01WK1CED" size="25" maxlength="25" value="<%= msgLN.getE01WK1CED().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="20%" > 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01WK1SSN" size="25" maxlength="25" value="<%= msgLN.getE01WK1SSN().trim()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01WK2CED" size="25" maxlength="25" value="<%= msgLN.getE01WK2CED().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="20%" > 
              <div align="right"><b> </b></div>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01WK3APE" size="35" maxlength="35" value="<%= msgLN.getE01WK3APE().trim()%>" readonly>
              </div>
            </td>
          </tr>
