...
<h3 align="center">Sistema de Bastanteo - Consulta de Vencimientos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_customers_inq, ECU0010" ></h3>
<hr size="4">
        ...
        <td nowrap > 
          <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
            ...
            <tr id="teclear"> 
              ...
              <td nowrap width="25%">  
                <input type="text" name="E01CUSMD1" size="3" maxlength="2"  readonly value="<%= msgMT.getE01CUSMD1().trim()%>">
                <input type="text" name="E01CUSMD2" size="3" maxlength="2"  readonly value="<%= msgMT.getE01CUSMD2().trim()%>">
                <input type="text" name="E01CUSMD3" size="5" maxlength="4"  readonly value="<%= msgMT.getE01CUSMD3().trim()%>">
                </td>
            </tr>
            <tr id="trdark"> 
            <td nowrap  width="25%"> 
        ...
        <td nowrap > 
          <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
            ...
            <tr id="trdark"> 
              ...
              <td nowrap width="25%">  
                <input type="text" name="E01CUSRD1" size="3" maxlength="2"  readonly value="<%= msgMT.getE01CUSRD1().trim()%>">
                <input type="text" name="E01CUSRD2" size="3" maxlength="2"  readonly value="<%= msgMT.getE01CUSRD2().trim()%>">
                <input type="text" name="E01CUSRD3" size="5" maxlength="4"  readonly value="<%= msgMT.getE01CUSRD3().trim()%>">
                </td>
                <td nowrap  width="25%"> 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%" align="center"> 
              <textarea name="E08CUSOBS" rows="8" cols="64" <%= msgMT.getE01CUSOBS().trim() %>>
              </textarea>
            </td>
          </tr>
        </table>
