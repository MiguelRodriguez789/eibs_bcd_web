...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cleaning_load_list, EDD0932"></h3> 
<hr size="4">
...
%>
  ...
  <INPUT TYPE=HIDDEN NAME="E03CNTFEM" value="<%=userPO.getHeader10()%>">
  <INPUT TYPE=HIDDEN NAME="E03CNTFED" value="<%=userPO.getHeader11()%>">
  <INPUT TYPE=HIDDEN NAME="E03CNTFEY" value="<%=userPO.getHeader12()%>">
