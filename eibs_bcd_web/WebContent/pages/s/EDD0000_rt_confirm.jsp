...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_confirm, EDD0000"> 
<hr size="4">
 <FORM METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXEDD0000" >
  ...
  <INPUT TYPE=HIDDEN NAME="H15FLGWK2" id="H15FLGWK2" VALUE="<%= rtFinish.getH15FLGWK2().trim()%>">
