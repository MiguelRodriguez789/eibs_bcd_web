...
public class JSEVL0000 extends datapro.eibs.master.SuperServlet {
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc =
						new MessageContext(super.getMessageHandler("EVL0000", req));
					...
					switch (screen) {
						...
						case W_INV_STOCK_LIST :
							procActionInvListStock(msgUser, req, res, session);
							break;		
						default :
	...
	protected void procActionInvListStock(
			...
			try {
				...
				try {
					flexLog("About to call Page: " + LangPath + "EVL0000_stock_warning_viewer.jsp");
					callPage(LangPath + "EVL0000_stock_warning_viewer.jsp", req, res);
