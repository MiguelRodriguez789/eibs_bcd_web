// ACH Help for Operatos, DFIs and Companies
// C. Castillo  04/16/08
// Source File Name:   JSEWD0360.java 
...
public class JSEWD0360 extends JSEIBSServlet {
	...
	protected void reqList(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		try {
			...
			EWD0360DSMessage msg = (EWD0360DSMessage) mp.getMessageRecord("EWD0360DS");
			...
			userPO.setHeader19(msg.getRWDNME().trim());
			...
			forward("EWD0360_ach_operators_helpmessage.jsp", req, res);
