...
public class JSFormsHistory extends datapro.eibs.master.SuperServlet {
	 ...
	 */
	private void procActionDocList(
		MessageContext mc,
	 ...
	 */
	private void procActionDocListUpdate(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
	 ...
	 * This method was created in VisualAge.
	 */
	private void procReqInqDocList(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EDI0010", req));
	 ...
	 * @param response HttpServletResponse
	 */
	private void procActionInqDocList(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
	 ...
	 * This method was created in VisualAge.
	 */
	private void procReqDocDeleteJDBC(String infoFileName)
		throws ServletException, IOException {
	 ...
	 * This method was created in VisualAge.
	 */
	private void procReqDocInfoJDBC(
		String infoFileName,
		String docName,
		HttpSession ses)
		throws ServletException, IOException {
	 ...
	 * This method was created in VisualAge.
	 */
	private void procReqDocInfoXML(
		String infoFileName,
		String docName,
		HttpSession ses)
		throws ServletException, IOException {
