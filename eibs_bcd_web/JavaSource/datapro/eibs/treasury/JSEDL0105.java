...
public class JSEDL0105 extends JSEIBSServlet { 
	...
	protected void procActionRec(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mp = null;
			mp = new MessageProcessor("EDL0105");
			newmessage = null;
			EDL010502Message msgD = (EDL010502Message) mp.getMessageRecord("EDL010502");
			// Send Initial data
			msgD.setH02USERID(user.getH01USR());
			msgD.setH02PROGRM("EDL0105");
			...
			forward("EDL0105_backoffice.jsp", req, res);
