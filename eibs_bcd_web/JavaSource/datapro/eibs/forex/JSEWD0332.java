...
public class JSEWD0332 extends datapro.eibs.master.SuperServlet {
...
public void destroy() {
	...
	flexLog("free resources used by JSEWD0332");
	...
	if (session == null) {
		...
		try
		{
	  		...
	  		if (newmessage.getFormatName().equals("EWD0332DS")) {
				...
				try {
					 flexLog("About to call Page: " + LangPath + "EWD0332_fe_acc.jsp");
					 callPage(LangPath + "EWD0332_fe_acc.jsp", req, res);
				}
				catch (Exception e) {
