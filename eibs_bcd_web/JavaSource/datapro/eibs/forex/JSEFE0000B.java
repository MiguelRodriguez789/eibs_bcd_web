	...
	try
	{
	  	...
	  	if (newmessage.getFormatName().equals("ELEERR")) {
			...
			try {
				...
				userPO.setHeader2(Util.formatCustomDate(user.getE01DTF(),user.getE01RDM(),user.getE01RDD(),user.getE01RDY()));
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("ELEERR", req));
