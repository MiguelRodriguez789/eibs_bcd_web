...
public class JSESWF100I extends datapro.eibs.master.SuperServlet {
	...
	protected static final int R_SR_SWAP			= 69;
	protected static final int R_SR_SWAP_FOR		= 71;
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10001")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF100I_fe_sf_format.jsp");
						callPage(LangPath + "ESWF100I_fe_sf_format.jsp", req, res);	
					}
					catch (Exception e) {
...
protected void procReqSwift100FWR(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10001")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF100I_fe_fw_format.jsp");
						callPage(LangPath + "ESWF100I_fe_fw_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift100NDF(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10001")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF100I_fe_nd_format.jsp");
						callPage(LangPath + "ESWF100I_fe_nd_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift100OPT(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10001")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF100I_fe_op_format.jsp");
						callPage(LangPath + "ESWF100I_fe_op_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift100SWP(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10001")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF100I_fe_sw_format.jsp");
						callPage(LangPath + "ESWF100I_fe_sw_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift300SPT(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10003")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF300I_fe_sf_format.jsp");
						callPage(LangPath + "ESWF300I_fe_sf_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift300FWR(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10003")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF300I_fe_fw_format.jsp");
						callPage(LangPath + "ESWF300I_fe_fw_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift300NDF(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10003")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF300I_fe_nd_format.jsp");
						callPage(LangPath + "ESWF300I_fe_nd_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift300OPT(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10003")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF300I_fe_op_format.jsp");
						callPage(LangPath + "ESWF300I_fe_op_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift300SWP(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10003")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF300I_fe_sw_format.jsp");
						callPage(LangPath + "ESWF300I_fe_sw_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift210SPT(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10003")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF210I_fe_sf_format.jsp");
						callPage(LangPath + "ESWF210I_fe_sf_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift210FWR(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10003")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF210I_fe_fw_format.jsp");
						callPage(LangPath + "ESWF210I_fe_fw_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift210OPT(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10003")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF210I_fe_op_format.jsp");
						callPage(LangPath + "ESWF210I_fe_op_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
...
protected void procReqSwift210SWP(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ESWF10003")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ESWF210I_fe_sw_format.jsp");
						callPage(LangPath + "ESWF210I_fe_sw_format.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}					
