				...
				if (newmessage.getFormatName().equals("EWD0326DS")) {
					...
					while (true) {
						...
						if (marker.equals("*")) {
							...
							myRow = "<TR>";
							myRow += "<TD NOWRAP width=\"5%\" ALIGN=CENTER><input type=\"radio\" name=\"ACC\" value=\""
								+ msgList.getSWDACC()
								+ "\" "
								+ chk
								+ " onclick=\"getValor('"
								...
								+ msgList.getSWDSBT()								
								+ "')\"></TD>";
							myRow += "<TD NOWRAP width=\"15%\" ALIGN=CENTER>" + msgList.getSWDACC() + "</td>";
							myRow += "<TD NOWRAP width=\"10%\" ALIGN=CENTER>" + msgList.getSWDPRO() + "</td>";															
							myRow += "<TD NOWRAP width=\"30%\" ALIGN=CENTER>" + msgList.getSWDDSC() + "</td>";
							myRow += "<TD NOWRAP width=\"10%\" ALIGN=CENTER>" + msgList.getSWDTYP() + "</td>";
							myRow += "<TD NOWRAP width=\"10%\" ALIGN=CENTER>" + msgList.getSWDCCY() + "</td>";
							myRow += "<TD NOWRAP width=\"20%\" ALIGN=RIGHT>"
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EWD0326", req));
