	  	...
	  	newmessage = mc.receiveMessage();
			...
			while (true) {
				...
				if (marker.equals("*")) {
					...
					myRow.append("<TD NOWRAP ALIGN=CENTER><A HREF=\"javascript:" + showInqSwift + "\">" + Util.formatCustomDate(user.getE01DTF(), msgList.getESW1DT1(),msgList.getESW1DT2(),msgList.getESW1DT3()) + "</A></TD>");
			...
			while (true) {
				...
				if (marker.equals("*")) {
					break;
						...
						myRow[9] = Util.formatCustomDate(user.getE01DTF(),msgList.getE01PRLSY1(),msgList.getE01PRLSY2(),msgList.getE01PRLSY3());
