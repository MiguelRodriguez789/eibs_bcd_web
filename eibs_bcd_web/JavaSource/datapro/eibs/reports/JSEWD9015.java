// Reports - Web menu Options Help 
// C. Castillo  04/21/17
// Source File Name:   JSEWD9015.java 
...
public class JSEWD9015 extends JSEIBSServlet {
	...
	protected void reqList(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		UserPos userPO = null;
		try {
			mp = new MessageProcessor("EWD9015");				
			EWD9015DSMessage msg = (EWD9015DSMessage) mp.getMessageRecord("EWD9015DS");
			userPO = (datapro.eibs.beans.UserPos) ses.getAttribute("userPO");
			
			msg.setRWDUSR(user.getH01USR());
			try {
				((CharacterField) msg.getField("RWDID")).setStringUD(req.getParameter("filter"));  // Get without change lower case and special characters
			} catch (Exception e) {
				msg.setRWDID("");
			}	
			...
			forward("EWD9015_webcm_helpmessage.jsp", req, res);
