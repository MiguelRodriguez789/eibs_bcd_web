...
* Record format level identifier is 2BE340279166F.
*/
...
public class EGC051002Message extends MessageRecord
{
  ...
  final static String rid = "2BE340279166F";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 46, 25, "E02GCRUT");
    fields[11] = fieldE02GCNMBC =
    new CharacterField(message, HEADERSIZE + 71, 45, "E02GCNMBC");
    fields[12] = fieldE02GCNOPR =
    new DecimalField(message, HEADERSIZE + 116, 6, 0, "E02GCNOPR");
    fields[13] = fieldE02GCDMOR =
    new DecimalField(message, HEADERSIZE + 122, 6, 0, "E02GCDMOR");
    fields[14] = fieldE02GCVECY =
    new DecimalField(message, HEADERSIZE + 128, 5, 0, "E02GCVECY");
    fields[15] = fieldE02GCVECM =
    new DecimalField(message, HEADERSIZE + 133, 3, 0, "E02GCVECM");
    fields[16] = fieldE02GCVECD =
    new DecimalField(message, HEADERSIZE + 136, 3, 0, "E02GCVECD");
    fields[17] = fieldE02GCSCAP =
    new DecimalField(message, HEADERSIZE + 139, 17, 2, "E02GCSCAP");
    fields[18] = fieldE02GCTINT =
    new DecimalField(message, HEADERSIZE + 156, 13, 6, "E02GCTINT");
    fields[19] = fieldE02GCNCPG =
    new DecimalField(message, HEADERSIZE + 169, 6, 0, "E02GCNCPG");
    fields[20] = fieldE02GCTOTC =
    new DecimalField(message, HEADERSIZE + 175, 6, 0, "E02GCTOTC");
    fields[21] = fieldE02GCGMDA =
    new CharacterField(message, HEADERSIZE + 181, 3, "E02GCGMDA");
    fields[22] = fieldE02GCVLRV =
    new DecimalField(message, HEADERSIZE + 184, 17, 2, "E02GCVLRV");
    fields[23] = fieldE02GCGPRD =
    new CharacterField(message, HEADERSIZE + 201, 4, "E02GCGPRD");
    fields[24] = fieldE02INDOPE =
    new CharacterField(message, HEADERSIZE + 205, 1, "E02INDOPE");
