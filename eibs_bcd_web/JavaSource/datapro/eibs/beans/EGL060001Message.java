...
* Record format level identifier is 452C492CD857E.
*/
...
public class EGL060001Message extends MessageRecord
{
  ...
  final static String rid = "452C492CD857E";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 42, 6, 0, "E01INPKBT");
    fields[10] = fieldE01INPBNK =
    new CharacterField(message, HEADERSIZE + 48, 2, "E01INPBNK");
    fields[11] = fieldE01INPBRN =
    new DecimalField(message, HEADERSIZE + 50, 5, 0, "E01INPBRN");
    fields[12] = fieldE01INPCCY =
    new CharacterField(message, HEADERSIZE + 55, 3, "E01INPCCY");
    fields[13] = fieldE01INPGLN =
    new DecimalField(message, HEADERSIZE + 58, 17, 0, "E01INPGLN");
    fields[14] = fieldE01INPACC =
    new DecimalField(message, HEADERSIZE + 75, 13, 0, "E01INPACC");
    ...
    new CharacterField(message, HEADERSIZE + 122, 45, "E01INPDSC");
    fields[18] = fieldE01INPTCD =
    new CharacterField(message, HEADERSIZE + 167, 4, "E01INPTCD");
    fields[19] = fieldE01INPAPC =
    new CharacterField(message, HEADERSIZE + 171, 2, "E01INPAPC");
    fields[20] = fieldE01INPVDM =
    new DecimalField(message, HEADERSIZE + 173, 3, 0, "E01INPVDM");
    fields[21] = fieldE01INPVDD =
    new DecimalField(message, HEADERSIZE + 176, 3, 0, "E01INPVDD");
    fields[22] = fieldE01INPVDY =
    new DecimalField(message, HEADERSIZE + 179, 5, 0, "E01INPVDY");
    fields[23] = fieldE01INPTDS =
    new CharacterField(message, HEADERSIZE + 184, 60, "E01INPTDS");
    fields[24] = fieldE01INPINB =
    new DecimalField(message, HEADERSIZE + 244, 17, 2, "E01INPINB");
    fields[25] = fieldE01INPAMN =
    new DecimalField(message, HEADERSIZE + 261, 17, 2, "E01INPAMN");
    fields[26] = fieldE01INPDC =
    new CharacterField(message, HEADERSIZE + 278, 2, "E01INPDC");
    fields[27] = fieldE01INPREM =
    new CharacterField(message, HEADERSIZE + 280, 25, "E01INPREM");
    fields[28] = fieldE01INPBAL =
    new DecimalField(message, HEADERSIZE + 305, 17, 2, "E01INPBAL");
    fields[29] = fieldE01RECPOS =
    new DecimalField(message, HEADERSIZE + 322, 8, 0, "E01RECPOS");
    fields[30] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 330, 1, "E01OPECDE");
