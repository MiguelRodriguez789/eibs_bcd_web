...
* Record format level identifier is 50597B4076396.
*/
...
public class ECMTRNDSMessage extends MessageRecord
{
  ...
  final static String rid = "50597B4076396";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 6, 5, 0, "FECHADEY");
    fields[3] = fieldFECHAHAM =
    new DecimalField(message, HEADERSIZE + 11, 3, 0, "FECHAHAM");
    fields[4] = fieldFECHAHAD =
    new DecimalField(message, HEADERSIZE + 14, 3, 0, "FECHAHAD");
    fields[5] = fieldFECHAHAY =
    new DecimalField(message, HEADERSIZE + 17, 5, 0, "FECHAHAY");
    fields[6] = fieldTRANCO01 =
    new CharacterField(message, HEADERSIZE + 22, 2, "TRANCO01");
    fields[7] = fieldTRANCO02 =
    new CharacterField(message, HEADERSIZE + 24, 2, "TRANCO02");
    fields[8] = fieldTRANCO03 =
    new CharacterField(message, HEADERSIZE + 26, 2, "TRANCO03");
    fields[9] = fieldTRANCO04 =
    new CharacterField(message, HEADERSIZE + 28, 2, "TRANCO04");
    fields[10] = fieldTRANCO05 =
    new CharacterField(message, HEADERSIZE + 30, 2, "TRANCO05");
    fields[11] = fieldTRANCO06 =
    new CharacterField(message, HEADERSIZE + 32, 2, "TRANCO06");
    fields[12] = fieldTRANCO07 =
    new CharacterField(message, HEADERSIZE + 34, 2, "TRANCO07");
    fields[13] = fieldTRANCO08 =
    new CharacterField(message, HEADERSIZE + 36, 2, "TRANCO08");
    fields[14] = fieldTRANCO09 =
    new CharacterField(message, HEADERSIZE + 38, 2, "TRANCO09");
    fields[15] = fieldTRANCO10 =
    new CharacterField(message, HEADERSIZE + 40, 2, "TRANCO10");
    fields[16] = fieldTRANCO11 =
    new CharacterField(message, HEADERSIZE + 42, 2, "TRANCO11");
    fields[17] = fieldTRANCO12 =
    new CharacterField(message, HEADERSIZE + 44, 2, "TRANCO12");
    fields[18] = fieldTRANCO13 =
    new CharacterField(message, HEADERSIZE + 46, 2, "TRANCO13");
    fields[19] = fieldTRANCO14 =
    new CharacterField(message, HEADERSIZE + 48, 2, "TRANCO14");
    fields[20] = fieldTRANCO15 =
    new CharacterField(message, HEADERSIZE + 50, 2, "TRANCO15");
    fields[21] = fieldTRANCO16 =
    new CharacterField(message, HEADERSIZE + 52, 2, "TRANCO16");
    fields[22] = fieldTRANCO17 =
    new CharacterField(message, HEADERSIZE + 54, 2, "TRANCO17");
    fields[23] = fieldTRANCO18 =
    new CharacterField(message, HEADERSIZE + 56, 2, "TRANCO18");
    fields[24] = fieldTRANCO19 =
    new CharacterField(message, HEADERSIZE + 58, 2, "TRANCO19");
    fields[25] = fieldTRANCO20 =
    new CharacterField(message, HEADERSIZE + 60, 2, "TRANCO20");
    fields[26] = fieldTRANCO21 =
    new CharacterField(message, HEADERSIZE + 62, 2, "TRANCO21");
    fields[27] = fieldTRANCO22 =
    new CharacterField(message, HEADERSIZE + 64, 2, "TRANCO22");
    fields[28] = fieldTRANCO23 =
    new CharacterField(message, HEADERSIZE + 66, 2, "TRANCO23");
    fields[29] = fieldTRANCO24 =
    new CharacterField(message, HEADERSIZE + 68, 2, "TRANCO24");
    fields[30] = fieldTRANCO25 =
    new CharacterField(message, HEADERSIZE + 70, 2, "TRANCO25");
    fields[31] = fieldTRANCO26 =
    new CharacterField(message, HEADERSIZE + 72, 2, "TRANCO26");
    fields[32] = fieldTRANCO27 =
    new CharacterField(message, HEADERSIZE + 74, 2, "TRANCO27");
    fields[33] = fieldTRANCO28 =
    new CharacterField(message, HEADERSIZE + 76, 2, "TRANCO28");
    fields[34] = fieldTRANCO29 =
    new CharacterField(message, HEADERSIZE + 78, 2, "TRANCO29");
    fields[35] = fieldTRANCO30 =
    new CharacterField(message, HEADERSIZE + 80, 2, "TRANCO30");
