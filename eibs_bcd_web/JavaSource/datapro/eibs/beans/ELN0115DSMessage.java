...
* Record format level identifier is 49B7D0B439753.
*/
...
public class ELN0115DSMessage extends MessageRecord
{
  ...
  final static String rid = "49B7D0B439753";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 48, 6, 0, "E01FLUTNR");
    fields[12] = fieldE01FLUTNU =
    new DecimalField(message, HEADERSIZE + 54, 6, 0, "E01FLUTNU");
    fields[13] = fieldE01FLUPER =
    new DecimalField(message, HEADERSIZE + 60, 8, 3, "E01FLUPER");
    fields[14] = fieldD01FLUDSC =
    new CharacterField(message, HEADERSIZE + 68, 45, "D01FLUDSC");
