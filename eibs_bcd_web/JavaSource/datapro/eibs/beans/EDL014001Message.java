...
* 
* File level identifier is 1180223141228.
* Record format level identifier is 4A25C648A7B94.
*/
...
public class EDL014001Message extends MessageRecord
{
  ...
  final static String fid = "1180223141228";
  final static String rid = "4A25C648A7B94";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 267, 17, 2, "E01DEAOAM");
    fields[28] = fieldE01DEAPRI =
    new DecimalField(message, HEADERSIZE + 284, 17, 2, "E01DEAPRI");
    fields[29] = fieldE01TOTRTE =
    new DecimalField(message, HEADERSIZE + 301, 11, 6, "E01TOTRTE");
    fields[30] = fieldE01DEAUBT =
    new DecimalField(message, HEADERSIZE + 312, 6, 0, "E01DEAUBT");
    fields[31] = fieldE01DEAUSR =
    new CharacterField(message, HEADERSIZE + 318, 10, "E01DEAUSR");
    fields[32] = fieldE01DEAODM =
    new DecimalField(message, HEADERSIZE + 328, 3, 0, "E01DEAODM");
    fields[33] = fieldE01DEAODD =
    new DecimalField(message, HEADERSIZE + 331, 3, 0, "E01DEAODD");
    fields[34] = fieldE01DEAODY =
    new DecimalField(message, HEADERSIZE + 334, 5, 0, "E01DEAODY");
    fields[35] = fieldE01DEAMDM =
    new DecimalField(message, HEADERSIZE + 339, 3, 0, "E01DEAMDM");
    fields[36] = fieldE01DEAMDD =
    new DecimalField(message, HEADERSIZE + 342, 3, 0, "E01DEAMDD");
    fields[37] = fieldE01DEAMDY =
    new DecimalField(message, HEADERSIZE + 345, 5, 0, "E01DEAMDY");
    fields[38] = fieldE01DEATRM =
    new DecimalField(message, HEADERSIZE + 350, 6, 0, "E01DEATRM");
    fields[39] = fieldE01DEATRC =
    new CharacterField(message, HEADERSIZE + 356, 1, "E01DEATRC");
    fields[40] = fieldE01WARNIN =
    new CharacterField(message, HEADERSIZE + 357, 15, "E01WARNIN");
    fields[41] = fieldE01DEARMK =
    new CharacterField(message, HEADERSIZE + 372, 60, "E01DEARMK");
    fields[42] = fieldE01FLGBUS =
    new CharacterField(message, HEADERSIZE + 432, 4, "E01FLGBUS");
    fields[43] = fieldE01FLGTYP =
    new CharacterField(message, HEADERSIZE + 436, 1, "E01FLGTYP");
    fields[44] = fieldE01FLGIBF =
    new CharacterField(message, HEADERSIZE + 437, 1, "E01FLGIBF");
    fields[45] = fieldE01DEAOVI =
    new CharacterField(message, HEADERSIZE + 438, 1, "E01DEAOVI");
    fields[46] = fieldE01FLGAPB =
    new CharacterField(message, HEADERSIZE + 439, 1, "E01FLGAPB");
    fields[47] = fieldE01DEAOFN =
    new DecimalField(message, HEADERSIZE + 440, 13, 0, "E01DEAOFN");
    fields[48] = fieldE01DEACRC =
    new CharacterField(message, HEADERSIZE + 453, 20, "E01DEACRC");
    fields[49] = fieldE01NUMREC =
    new DecimalField(message, HEADERSIZE + 473, 8, 0, "E01NUMREC");
    fields[50] = fieldE01INDOPE =
    new CharacterField(message, HEADERSIZE + 481, 1, "E01INDOPE");
