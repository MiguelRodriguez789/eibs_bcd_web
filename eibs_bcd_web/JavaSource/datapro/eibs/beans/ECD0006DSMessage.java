...
* Record format level identifier is 3A00AB2E07774.
*/
...
public class ECD0006DSMessage extends MessageRecord
{
  ...
  final static String rid = "3A00AB2E07774";
  ...
  private CharacterField fieldE06CDRTIM = null;
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 42, 5, 0, "E06CDRBRN");
    fields[10] = fieldE06CDRTPL =
    new CharacterField(message, HEADERSIZE + 47, 2, "E06CDRTPL");
    fields[11] = fieldE06CDRNPL =
    new CharacterField(message, HEADERSIZE + 49, 45, "E06CDRNPL");
    fields[12] = fieldE06CDRMIN =
    new DecimalField(message, HEADERSIZE + 94, 7, 0, "E06CDRMIN");
    fields[13] = fieldE06CDRMAX =
    new DecimalField(message, HEADERSIZE + 101, 7, 0, "E06CDRMAX");
    fields[14] = fieldE06CDRUSR =
    new CharacterField(message, HEADERSIZE + 108, 10, "E06CDRUSR");
    fields[15] = fieldE06CDRDAY =
    new DecimalField(message, HEADERSIZE + 118, 3, 0, "E06CDRDAY");
    fields[16] = fieldE06CDRMON =
    new DecimalField(message, HEADERSIZE + 121, 3, 0, "E06CDRMON");
    fields[17] = fieldE06CDRYEA =
    new DecimalField(message, HEADERSIZE + 124, 5, 0, "E06CDRYEA");
    fields[18] = fieldE06CDRTIM =
    new CharacterField(message, HEADERSIZE + 129, 26, "E06CDRTIM");
