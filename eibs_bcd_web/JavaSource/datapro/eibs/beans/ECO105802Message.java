...
/**
* Class generated by AS/400 CRTCLASS command from ECO105802 physical file definition.
* 
* File level identifier is 1150630155551.
* Record format level identifier is 3C7080E1C1122.
*/

public class ECO105802Message extends MessageRecord
{
  ...
  final static String fid = "1150630155551";
  final static String rid = "3C7080E1C1122";
  final static String fmtname = "ECO105802";
  ...
  /**
  * Constructor for ECO105802Message.
  */
  public ECO105802Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[10] = fieldE01MOVBRN =
    new DecimalField(message, HEADERSIZE + 44, 5, 0, "E01MOVBRN");
    fields[11] = fieldE01MOVTIP =
    new CharacterField(message, HEADERSIZE + 49, 4, "E01MOVTIP");
    fields[12] = fieldE01MOVSUB =
    new CharacterField(message, HEADERSIZE + 53, 4, "E01MOVSUB");
    fields[13] = fieldE01MOVCSN =
    new DecimalField(message, HEADERSIZE + 57, 3, 0, "E01MOVCSN");
    fields[14] = fieldE01MOVINI =
    new DecimalField(message, HEADERSIZE + 60, 17, 0, "E01MOVINI");
    fields[15] = fieldE01MOVFIN =
    new DecimalField(message, HEADERSIZE + 77, 17, 0, "E01MOVFIN");
    fields[16] = fieldE01MOVQTY =
    new DecimalField(message, HEADERSIZE + 94, 17, 2, "E01MOVQTY");
    fields[17] = fieldE01MOVSER =
    new DecimalField(message, HEADERSIZE + 111, 13, 0, "E01MOVSER");
    fields[18] = fieldE01MOVVEN =
    new DecimalField(message, HEADERSIZE + 124, 10, 0, "E01MOVVEN");
    fields[19] = fieldE01MOVBRS =
    new DecimalField(message, HEADERSIZE + 134, 5, 0, "E01MOVBRS");
