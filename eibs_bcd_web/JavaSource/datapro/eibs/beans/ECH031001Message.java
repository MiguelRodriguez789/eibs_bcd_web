...
* 
* File level identifier is 1180515145002.
* Record format level identifier is 559608EDD4FBB.
*/
...
public class ECH031001Message extends MessageRecord
{
  ...
  final static String fid = "1180515145002";
  final static String rid = "559608EDD4FBB";
  ...
  */
  protected void createFields()
  {
    ...
    fields[11] = fieldE01SELIDM =
    new DecimalField(message, HEADERSIZE + 49, 3, 0, "E01SELIDM");
    fields[12] = fieldE01SELIDD =
    new DecimalField(message, HEADERSIZE + 52, 3, 0, "E01SELIDD");
    fields[13] = fieldE01SELIDY =
    new DecimalField(message, HEADERSIZE + 55, 5, 0, "E01SELIDY");
    fields[14] = fieldE01SELFDM =
    new DecimalField(message, HEADERSIZE + 60, 3, 0, "E01SELFDM");
    fields[15] = fieldE01SELFDD =
    new DecimalField(message, HEADERSIZE + 63, 3, 0, "E01SELFDD");
    fields[16] = fieldE01SELFDY =
    new DecimalField(message, HEADERSIZE + 66, 5, 0, "E01SELFDY");
    fields[17] = fieldE01CHMBNK =
    new CharacterField(message, HEADERSIZE + 71, 2, "E01CHMBNK");
    fields[18] = fieldE01CHMBRN =
    new DecimalField(message, HEADERSIZE + 73, 5, 0, "E01CHMBRN");
    fields[19] = fieldE01CHMCCY =
    new CharacterField(message, HEADERSIZE + 78, 3, "E01CHMCCY");
    fields[20] = fieldE01CHMACC =
    new DecimalField(message, HEADERSIZE + 81, 13, 0, "E01CHMACC");
    fields[21] = fieldE01CHMACD =
    new CharacterField(message, HEADERSIZE + 94, 2, "E01CHMACD");
    fields[22] = fieldE01CHMPRO =
    new CharacterField(message, HEADERSIZE + 96, 4, "E01CHMPRO");
    fields[23] = fieldE01CHMCUN =
    new DecimalField(message, HEADERSIZE + 100, 10, 0, "E01CHMCUN");
    fields[24] = fieldE01CHMNA1 =
    new CharacterField(message, HEADERSIZE + 110, 60, "E01CHMNA1");
    fields[25] = fieldE01CHMOFC =
    new CharacterField(message, HEADERSIZE + 170, 4, "E01CHMOFC");
    fields[26] = fieldE01DSCOFC =
    new CharacterField(message, HEADERSIZE + 174, 60, "E01DSCOFC");
    fields[27] = fieldE01CHMRQM =
    new DecimalField(message, HEADERSIZE + 234, 3, 0, "E01CHMRQM");
    fields[28] = fieldE01CHMRQD =
    new DecimalField(message, HEADERSIZE + 237, 3, 0, "E01CHMRQD");
    fields[29] = fieldE01CHMRQY =
    new DecimalField(message, HEADERSIZE + 240, 5, 0, "E01CHMRQY");
    fields[30] = fieldE01CHMNCB =
    new DecimalField(message, HEADERSIZE + 245, 13, 0, "E01CHMNCB");
    fields[31] = fieldE01CHMTCB =
    new CharacterField(message, HEADERSIZE + 258, 2, "E01CHMTCB");
    fields[32] = fieldE01CHMICK =
    new DecimalField(message, HEADERSIZE + 260, 12, 0, "E01CHMICK");
    fields[33] = fieldE01CHMFCK =
    new DecimalField(message, HEADERSIZE + 272, 12, 0, "E01CHMFCK");
    fields[34] = fieldE01CHMNTC =
    new DecimalField(message, HEADERSIZE + 284, 5, 0, "E01CHMNTC");
    fields[35] = fieldE01CHMDBR =
    new DecimalField(message, HEADERSIZE + 289, 5, 0, "E01CHMDBR");
    fields[36] = fieldE01CHMACT =
    new CharacterField(message, HEADERSIZE + 294, 1, "E01CHMACT");
    fields[37] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 295, 1, "E01OPECDE");
