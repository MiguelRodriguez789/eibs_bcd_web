...
/**
* Class generated by AS/400 CRTCLASS command from EDL091401 physical file definition.
* 
* File level identifier is 1200403104021.
* Record format level identifier is 4A1F4F6A15399.
*/

public class EDL091401Message extends MessageRecord
{
  ...
  final static String fid = "1200403104021";
  final static String rid = "4A1F4F6A15399";
  final static String fmtname = "EDL091401";
  ...
  /**
  * Constructor for EDL091401Message.
  */
  public EDL091401Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 244, 3, 0, "E01DEAODM");
    fields[30] = fieldE01DEAODD =
    new DecimalField(message, HEADERSIZE + 247, 3, 0, "E01DEAODD");
    fields[31] = fieldE01DEAODY =
    new DecimalField(message, HEADERSIZE + 250, 5, 0, "E01DEAODY");
    fields[32] = fieldE01DEASDM =
    new DecimalField(message, HEADERSIZE + 255, 3, 0, "E01DEASDM");
    fields[33] = fieldE01DEASDD =
    new DecimalField(message, HEADERSIZE + 258, 3, 0, "E01DEASDD");
    fields[34] = fieldE01DEASDY =
    new DecimalField(message, HEADERSIZE + 261, 5, 0, "E01DEASDY");
    fields[35] = fieldE01DEAMAM =
    new DecimalField(message, HEADERSIZE + 266, 3, 0, "E01DEAMAM");
    fields[36] = fieldE01DEAMAD =
    new DecimalField(message, HEADERSIZE + 269, 3, 0, "E01DEAMAD");
    fields[37] = fieldE01DEAMAY =
    new DecimalField(message, HEADERSIZE + 272, 5, 0, "E01DEAMAY");
    fields[38] = fieldE01DEALCM =
    new DecimalField(message, HEADERSIZE + 277, 3, 0, "E01DEALCM");
    fields[39] = fieldE01DEALCD =
    new DecimalField(message, HEADERSIZE + 280, 3, 0, "E01DEALCD");
    fields[40] = fieldE01DEALCY =
    new DecimalField(message, HEADERSIZE + 283, 5, 0, "E01DEALCY");
    fields[41] = fieldE01DSCPRD =
    new CharacterField(message, HEADERSIZE + 288, 45, "E01DSCPRD");
    fields[42] = fieldE01DSCCNV =
    new CharacterField(message, HEADERSIZE + 333, 45, "E01DSCCNV");
    fields[43] = fieldE01DSCCCY =
    new CharacterField(message, HEADERSIZE + 378, 45, "E01DSCCCY");
    fields[44] = fieldE01DLCRFS =
    new DecimalField(message, HEADERSIZE + 423, 11, 6, "E01DLCRFS");
    fields[45] = fieldE01FLGSBS =
    new CharacterField(message, HEADERSIZE + 434, 1, "E01FLGSBS");
    fields[46] = fieldE01DEAHFQ =
    new DecimalField(message, HEADERSIZE + 435, 2, 0, "E01DEAHFQ");
