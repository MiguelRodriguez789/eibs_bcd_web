...
* 
* File level identifier is 1180515145104.
* Record format level identifier is 5DD7C8689F43D.
*/
...
public class ECH037501Message extends MessageRecord
{
  ...
  final static String fid = "1180515145104";
  final static String rid = "5DD7C8689F43D";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 203, 2, "E01CHPTCB");
    fields[19] = fieldE01CHPMSK =
    new DecimalField(message, HEADERSIZE + 205, 3, 0, "E01CHPMSK");
    fields[20] = fieldE01CHPASK =
    new DecimalField(message, HEADERSIZE + 208, 3, 0, "E01CHPASK");
    fields[21] = fieldE01CHPCBC =
    new CharacterField(message, HEADERSIZE + 211, 1, "E01CHPCBC");
    ...
    new CharacterField(message, HEADERSIZE + 223, 2, "E01CHPST0");
    fields[26] = fieldE01CHPST1 =
    new CharacterField(message, HEADERSIZE + 225, 2, "E01CHPST1");
    fields[27] = fieldE01CHPST2 =
    new CharacterField(message, HEADERSIZE + 227, 2, "E01CHPST2");
    fields[28] = fieldE01CHPST3 =
    new CharacterField(message, HEADERSIZE + 229, 2, "E01CHPST3");
    fields[29] = fieldE01CHPST4 =
    new CharacterField(message, HEADERSIZE + 231, 2, "E01CHPST4");
    fields[30] = fieldE01CHPST5 =
    new CharacterField(message, HEADERSIZE + 233, 2, "E01CHPST5");
    fields[31] = fieldE01CHPST6 =
    new CharacterField(message, HEADERSIZE + 235, 2, "E01CHPST6");
    fields[32] = fieldE01CHPST7 =
    new CharacterField(message, HEADERSIZE + 237, 2, "E01CHPST7");
    fields[33] = fieldE01CHPST8 =
    new CharacterField(message, HEADERSIZE + 239, 2, "E01CHPST8");
    fields[34] = fieldE01CHPST9 =
    new CharacterField(message, HEADERSIZE + 241, 2, "E01CHPST9");
    fields[35] = fieldE01CHPCON =
    new CharacterField(message, HEADERSIZE + 243, 1, "E01CHPCON");
    fields[36] = fieldE01CHPVAL =
    new DecimalField(message, HEADERSIZE + 244, 12, 0, "E01CHPVAL");
    fields[37] = fieldE01CHPN01 =
    new CharacterField(message, HEADERSIZE + 256, 45, "E01CHPN01");
    fields[38] = fieldE01CHPN02 =
    new CharacterField(message, HEADERSIZE + 301, 45, "E01CHPN02");
    fields[39] = fieldE01CHPSTA =
    new CharacterField(message, HEADERSIZE + 346, 1, "E01CHPSTA");
    fields[40] = fieldE01CHPRE1 =
    new CharacterField(message, HEADERSIZE + 347, 1, "E01CHPRE1");
    fields[41] = fieldE01CHPDBR =
    new DecimalField(message, HEADERSIZE + 348, 5, 0, "E01CHPDBR");
