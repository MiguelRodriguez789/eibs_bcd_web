...
/**
* Class generated by AS/400 CRTCLASS command from ECD0030DS physical file definition.
* 
* File level identifier is 1130611112843.
* Record format level identifier is 56DAEAA30ACEF.
*/

public class ECD0030DSMessage extends MessageRecord
{
  ...
  final static String rid = "56DAEAA30ACEF";
  final static String fmtname = "ECD0030DS";
  ...
  /**
  * Constructor for ECD0030DSMessage.
  */
  public ECD0030DSMessage()
  {
    createFields();
    initialize();
  }
