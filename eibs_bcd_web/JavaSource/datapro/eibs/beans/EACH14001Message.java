...
* 
* File level identifier is 1120816173230.
* Record format level identifier is 38665A9C1F5D5.
*/
...
public class EACH14001Message extends MessageRecord
{
  ...
  final static String fid = "1120816173230";
  final static String rid = "38665A9C1F5D5";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 57, 6, 0, "E01ACHBAI");
    fields[15] = fieldE01ACHBAT =
    new DecimalField(message, HEADERSIZE + 63, 6, 0, "E01ACHBAT");
    fields[16] = fieldE01ACHIGL =
    new DecimalField(message, HEADERSIZE + 69, 17, 0, "E01ACHIGL");
    fields[17] = fieldE01ACHOGL =
    new DecimalField(message, HEADERSIZE + 86, 17, 0, "E01ACHOGL");
    fields[18] = fieldE01ACHGLN =
    new DecimalField(message, HEADERSIZE + 103, 17, 0, "E01ACHGLN");
    fields[19] = fieldE01ACHNUM =
    new DecimalField(message, HEADERSIZE + 120, 13, 0, "E01ACHNUM");
    fields[20] = fieldE01ACHODF =
    new CharacterField(message, HEADERSIZE + 133, 10, "E01ACHODF");
    fields[21] = fieldE01ACHGLP =
    new DecimalField(message, HEADERSIZE + 143, 17, 0, "E01ACHGLP");
    fields[22] = fieldE01ACHGLL =
    new DecimalField(message, HEADERSIZE + 160, 17, 0, "E01ACHGLL");
    fields[23] = fieldE01ACT =
    new CharacterField(message, HEADERSIZE + 177, 1, "E01ACT");
