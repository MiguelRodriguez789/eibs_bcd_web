...
* Record format level identifier is 3395F3FA4B875.
*/
...
public class ESD000022Message extends MessageRecord
{
  ...
  final static String rid = "3395F3FA4B875";
  ...
  private CharacterField fieldE22ACD = null;
  ...
  */
  protected void createFields()
  {
    ...
    fields[11] = fieldE22ACD =
    new CharacterField(message, HEADERSIZE + 60, 2, "E22ACD");
    fields[12] = fieldE22NRO =
    new DecimalField(message, HEADERSIZE + 62, 3, 0, "E22NRO");
    fields[13] = fieldE22SEQ =
    new DecimalField(message, HEADERSIZE + 65, 4, 0, "E22SEQ");
    fields[14] = fieldE22DSC =
    new CharacterField(message, HEADERSIZE + 69, 132, "E22DSC");
    fields[15] = fieldE22F01 =
    new CharacterField(message, HEADERSIZE + 201, 3, "E22F01");
    fields[16] = fieldE22RCN =
    new DecimalField(message, HEADERSIZE + 204, 10, 0, "E22RCN");
  ...
  */
  ...
  /**
  * Set field E22ACD using a String value.
  */
  public void setE22ACD(String newvalue)
  {
    fieldE22ACD.setString(newvalue);
  }

  /**
  * Get value of field E22ACD as a String.
  */
  public String getE22ACD()
  {
    return fieldE22ACD.getString();
  }
