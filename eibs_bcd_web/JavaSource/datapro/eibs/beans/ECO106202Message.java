...
/**
* Class generated by AS/400 CRTCLASS command from ECO106202 physical file definition.
* 
* File level identifier is 1150701161527.
* Record format level identifier is 49658BB5B6DCE.
*/

public class ECO106202Message extends MessageRecord
{
  ...
  final static String fid = "1150701161527";
  final static String rid = "49658BB5B6DCE";
  final static String fmtname = "ECO106202";
  ...
  /**
  * Constructor for ECO106202Message.
  */
  public ECO106202Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[19] = fieldE02DOCSER =
    new DecimalField(message, HEADERSIZE + 218, 13, 0, "E02DOCSER");
    fields[20] = fieldE02DOCINI =
    new DecimalField(message, HEADERSIZE + 231, 17, 0, "E02DOCINI");
    fields[21] = fieldE02DOCFIN =
    new DecimalField(message, HEADERSIZE + 248, 17, 0, "E02DOCFIN");
    fields[22] = fieldE02DOCLST =
    new DecimalField(message, HEADERSIZE + 265, 17, 0, "E02DOCLST");
    fields[23] = fieldE02DOCBAL =
    new DecimalField(message, HEADERSIZE + 282, 13, 0, "E02DOCBAL");
