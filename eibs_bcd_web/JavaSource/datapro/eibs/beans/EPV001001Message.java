...
* Record format level identifier is 3E23BC62E8153.
*/
...
public class EPV001001Message extends MessageRecord
{
  ...
  final static String rid = "3E23BC62E8153";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 65, 60, "E01PVMNA1");
    fields[12] = fieldE01PVMIDE =
    new CharacterField(message, HEADERSIZE + 125, 25, "E01PVMIDE");
    fields[13] = fieldE01PVBFMR =
    new CharacterField(message, HEADERSIZE + 150, 1, "E01PVBFMR");
    fields[14] = fieldE01PVBDAM =
    new DecimalField(message, HEADERSIZE + 151, 17, 2, "E01PVBDAM");
    fields[15] = fieldE01PVBDVE =
    new DecimalField(message, HEADERSIZE + 168, 17, 2, "E01PVBDVE");
    fields[16] = fieldE01PVBDCA =
    new DecimalField(message, HEADERSIZE + 185, 17, 2, "E01PVBDCA");
    fields[17] = fieldE01PVBIAM =
    new DecimalField(message, HEADERSIZE + 202, 17, 2, "E01PVBIAM");
    fields[18] = fieldE01PVBIVE =
    new DecimalField(message, HEADERSIZE + 219, 17, 2, "E01PVBIVE");
    fields[19] = fieldE01PVBICA =
    new DecimalField(message, HEADERSIZE + 236, 17, 2, "E01PVBICA");
    fields[20] = fieldE01PVBNPO =
    new DecimalField(message, HEADERSIZE + 253, 4, 0, "E01PVBNPO");
    fields[21] = fieldE01PVBMPO =
    new DecimalField(message, HEADERSIZE + 257, 17, 2, "E01PVBMPO");
    fields[22] = fieldE01PVBFOR =
    new DecimalField(message, HEADERSIZE + 274, 3, 0, "E01PVBFOR");
