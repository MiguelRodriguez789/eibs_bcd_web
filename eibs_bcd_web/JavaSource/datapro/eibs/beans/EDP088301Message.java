...
* Record format level identifier is 4C7B21F0EEAD8.
*/
...
public class EDP088301Message extends MessageRecord
{
  ...
  final static String rid = "4C7B21F0EEAD8";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 114, 1, "E01MODFL1");
    fields[14] = fieldE01MODCOD =
    new CharacterField(message, HEADERSIZE + 115, 4, "E01MODCOD");
    fields[15] = fieldE01MODDSC =
    new CharacterField(message, HEADERSIZE + 119, 45, "E01MODDSC");
    fields[16] = fieldE01MODPER =
    new DecimalField(message, HEADERSIZE + 164, 9, 2, "E01MODPER");
    fields[17] = fieldE01MODPTS =
    new DecimalField(message, HEADERSIZE + 173, 9, 2, "E01MODPTS");
    fields[18] = fieldE01MODCAT =
    new DecimalField(message, HEADERSIZE + 182, 9, 2, "E01MODCAT");
    fields[19] = fieldE01PTSPTS =
    new DecimalField(message, HEADERSIZE + 191, 8, 3, "E01PTSPTS");
    fields[20] = fieldE01PTSSEQ =
    new DecimalField(message, HEADERSIZE + 199, 8, 0, "E01PTSSEQ");
    fields[21] = fieldE01PTSFLG =
    new CharacterField(message, HEADERSIZE + 207, 1, "E01PTSFLG");
    fields[22] = fieldE01PTSCAL =
    new DecimalField(message, HEADERSIZE + 208, 9, 2, "E01PTSCAL");
    fields[23] = fieldE01RECPOS =
    new DecimalField(message, HEADERSIZE + 217, 8, 0, "E01RECPOS");
    fields[24] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 225, 1, "E01OPECDE");
