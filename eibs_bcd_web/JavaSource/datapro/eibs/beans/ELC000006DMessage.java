...
/**
* Class generated by AS/400 CRTCLASS command from ELC000006D physical file definition.
* 
* File level identifier is 1110303181117.
* Record format level identifier is 5E2CD237EA18D.
*/

public class ELC000006DMessage extends MessageRecord
{
  ...
  final static String fid = "1110303181117";
  final static String rid = "5E2CD237EA18D";
  final static String fmtname = "ELC000006D";
  ...
  private CharacterField fieldE06SPIACD = null;
  private DecimalField fieldE06SPIACC = null;
  private CharacterField fieldE06SPIM01 = null;

  /**
  * Constructor for ELC000006DMessage.
  */
  public ELC000006DMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[9] = fieldE06SPIACD =
    new CharacterField(message, HEADERSIZE + 42, 2, "E06SPIACD");
    fields[10] = fieldE06SPIACC =
    new DecimalField(message, HEADERSIZE + 44, 13, 0, "E06SPIACC");
    fields[11] = fieldE06SPIM01 =
    new CharacterField(message, HEADERSIZE + 57, 3200, "E06SPIM01");
  ...
  */
  ...
  /**
  * Set field E06SPIACD using a String value.
  */
  public void setE06SPIACD(String newvalue)
  {
    fieldE06SPIACD.setString(newvalue);
  }

  /**
  * Get value of field E06SPIACD as a String.
  */
  public String getE06SPIACD()
  {
    return fieldE06SPIACD.getString();
  }
