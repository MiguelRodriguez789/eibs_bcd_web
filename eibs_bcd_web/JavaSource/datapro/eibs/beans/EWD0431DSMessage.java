...
/**
* Class generated by AS/400 CRTCLASS command from EWD0431DS physical file definition.
* 
* File level identifier is 1130611113508.
* Record format level identifier is 4B69122328555.
*/

public class EWD0431DSMessage extends MessageRecord
{
  ...
  final static String rid = "4B69122328555";
  final static String fmtname = "EWD0431DS";
  ...
  /**
  * Constructor for EWD0431DSMessage.
  */
  public EWD0431DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 30, 5, 0, "SWDBRN");
    fields[5] = fieldSWDNME =
    new CharacterField(message, HEADERSIZE + 35, 45, "SWDNME");
    fields[6] = fieldSWDCCN =
    new DecimalField(message, HEADERSIZE + 80, 9, 0, "SWDCCN");
    fields[7] = fieldSWDGRO =
    new CharacterField(message, HEADERSIZE + 89, 10, "SWDGRO");
    ...
    new CharacterField(message, HEADERSIZE + 108, 1, "SWDTYP");
