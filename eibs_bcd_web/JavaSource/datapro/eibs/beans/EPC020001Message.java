...
* Record format level identifier is 5531BBF999750.
*/
...
public class EPC020001Message extends MessageRecord
{
  ...
  final static String rid = "5531BBF999750";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 93, 6, 0, "E01PCMNUM");
    fields[13] = fieldE01PCMBRN =
    new DecimalField(message, HEADERSIZE + 99, 5, 0, "E01PCMBRN");
    fields[14] = fieldE01PCMCCY =
    new CharacterField(message, HEADERSIZE + 104, 3, "E01PCMCCY");
    fields[15] = fieldE01PCMACC =
    new DecimalField(message, HEADERSIZE + 107, 13, 0, "E01PCMACC");
    fields[16] = fieldE01PCMCCN =
    new DecimalField(message, HEADERSIZE + 120, 9, 0, "E01PCMCCN");
    fields[17] = fieldE01PCMOPM =
    new DecimalField(message, HEADERSIZE + 129, 3, 0, "E01PCMOPM");
    fields[18] = fieldE01PCMOPD =
    new DecimalField(message, HEADERSIZE + 132, 3, 0, "E01PCMOPD");
    fields[19] = fieldE01PCMOPY =
    new DecimalField(message, HEADERSIZE + 135, 5, 0, "E01PCMOPY");
    fields[20] = fieldE01PCMCUN =
    new DecimalField(message, HEADERSIZE + 140, 10, 0, "E01PCMCUN");
    fields[21] = fieldE01PCMNME =
    new CharacterField(message, HEADERSIZE + 150, 45, "E01PCMNME");
    fields[22] = fieldE01PCMVSL =
    new DecimalField(message, HEADERSIZE + 195, 17, 2, "E01PCMVSL");
    fields[23] = fieldE01TOTVSL =
    new DecimalField(message, HEADERSIZE + 212, 17, 2, "E01TOTVSL");
    fields[24] = fieldE01TOTNUM =
    new DecimalField(message, HEADERSIZE + 229, 6, 0, "E01TOTNUM");
    fields[25] = fieldD01PCMCUN =
    new CharacterField(message, HEADERSIZE + 235, 60, "D01PCMCUN");
