...
/**
* Class generated by AS/400 CRTCLASS command from ESS0040DS physical file definition.
* 
* File level identifier is 1130611113405.
* Record format level identifier is 5813DD73E0426.
*/

public class ESS0040DSMessage extends MessageRecord
{
  ...
  final static String rid = "5813DD73E0426";
  final static String fmtname = "ESS0040DS";
  ...
  /**
  * Constructor for ESS0040DSMessage.
  */
  public ESS0040DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 20, 45, "ESSDSC");
    fields[5] = fieldESSIMG =
    new CharacterField(message, HEADERSIZE + 65, 50, "ESSIMG");
    fields[6] = fieldESSTAD =
    new CharacterField(message, HEADERSIZE + 115, 255, "ESSTAD");
    fields[7] = fieldESSTPO =
    new CharacterField(message, HEADERSIZE + 370, 50, "ESSTPO");
