...
* 
* File level identifier is 1120816173229.
* Record format level identifier is 4D2286E427C3F.
*/
...
public class EACH36001Message extends MessageRecord
{
  ...
  final static String fid = "1120816173229";
  final static String rid = "4D2286E427C3F";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 78, 5, 0, "E01ACRVDY");
    fields[13] = fieldE01ACRVDM =
    new DecimalField(message, HEADERSIZE + 83, 3, 0, "E01ACRVDM");
    fields[14] = fieldE01ACRVDD =
    new DecimalField(message, HEADERSIZE + 86, 3, 0, "E01ACRVDD");
    fields[15] = fieldE01ACRECD =
    new CharacterField(message, HEADERSIZE + 89, 3, "E01ACRECD");
    fields[16] = fieldE01ACRROU =
    new CharacterField(message, HEADERSIZE + 92, 9, "E01ACRROU");
    fields[17] = fieldE01ACRDAC =
    new CharacterField(message, HEADERSIZE + 101, 17, "E01ACRDAC");
    fields[18] = fieldE01ACRCCY =
    new CharacterField(message, HEADERSIZE + 118, 3, "E01ACRCCY");
    fields[19] = fieldE01ACRAMT =
    new DecimalField(message, HEADERSIZE + 121, 17, 2, "E01ACRAMT");
    fields[20] = fieldE01ACRCDE =
    new CharacterField(message, HEADERSIZE + 138, 2, "E01ACRCDE");
    fields[21] = fieldE01ACRADD =
    new CharacterField(message, HEADERSIZE + 140, 94, "E01ACRADD");
    fields[22] = fieldE01ACRRTR =
    new CharacterField(message, HEADERSIZE + 234, 3, "E01ACRRTR");
    fields[23] = fieldE01ACRSTS =
    new CharacterField(message, HEADERSIZE + 237, 1, "E01ACRSTS");
    fields[24] = fieldE01ACRUSR =
    new CharacterField(message, HEADERSIZE + 238, 10, "E01ACRUSR");
    fields[25] = fieldE01ACRRTS =
    new DecimalField(message, HEADERSIZE + 248, 13, 0, "E01ACRRTS");
    fields[26] = fieldE01ACRPTS =
    new DecimalField(message, HEADERSIZE + 261, 13, 0, "E01ACRPTS");
    fields[27] = fieldE01CUNDSC =
    new CharacterField(message, HEADERSIZE + 274, 45, "E01CUNDSC");
    fields[28] = fieldE01CDEDSC =
    new CharacterField(message, HEADERSIZE + 319, 45, "E01CDEDSC");
    fields[29] = fieldE01RTRDSC =
    new CharacterField(message, HEADERSIZE + 364, 45, "E01RTRDSC");
    fields[30] = fieldE01ACT =
    new CharacterField(message, HEADERSIZE + 409, 1, "E01ACT");
    fields[31] = fieldE01NUMREC =
    new DecimalField(message, HEADERSIZE + 410, 8, 0, "E01NUMREC");
    fields[32] = fieldE01INDOPE =
    new CharacterField(message, HEADERSIZE + 418, 1, "E01INDOPE");
