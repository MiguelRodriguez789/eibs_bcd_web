...
* Record format level identifier is 3096DC9F40542.
*/
...
public class EIE006001Message extends MessageRecord
{
  ...
  final static String rid = "3096DC9F40542";
  ...
  private CharacterField fieldE01QUOTET = null;
  ...
  private CharacterField fieldE01QUOUPT = null;
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 55, 5, 0, "E01QUOTE1");
    fields[11] = fieldE01QUOTE2 =
    new DecimalField(message, HEADERSIZE + 60, 3, 0, "E01QUOTE2");
    fields[12] = fieldE01QUOTE3 =
    new DecimalField(message, HEADERSIZE + 63, 3, 0, "E01QUOTE3");
    fields[13] = fieldE01QUOTET =
    new CharacterField(message, HEADERSIZE + 66, 26, "E01QUOTET");
    fields[14] = fieldE01QUOOPP =
    new DecimalField(message, HEADERSIZE + 92, 23, 8, "E01QUOOPP");
    fields[15] = fieldE01QUOASK =
    new DecimalField(message, HEADERSIZE + 115, 23, 8, "E01QUOASK");
    fields[16] = fieldE01QUOBID =
    new DecimalField(message, HEADERSIZE + 138, 23, 8, "E01QUOBID");
    fields[17] = fieldE01QUOMID =
    new DecimalField(message, HEADERSIZE + 161, 23, 8, "E01QUOMID");
    fields[18] = fieldE01QUOTPX =
    new DecimalField(message, HEADERSIZE + 184, 23, 8, "E01QUOTPX");
    fields[19] = fieldE01QUOASP =
    new DecimalField(message, HEADERSIZE + 207, 23, 8, "E01QUOASP");
    fields[20] = fieldE01QUOBIP =
    new DecimalField(message, HEADERSIZE + 230, 23, 8, "E01QUOBIP");
    fields[21] = fieldE01QUOMIP =
    new DecimalField(message, HEADERSIZE + 253, 23, 8, "E01QUOMIP");
    fields[22] = fieldE01QUOHIP =
    new DecimalField(message, HEADERSIZE + 276, 23, 8, "E01QUOHIP");
    fields[23] = fieldE01QUOLOP =
    new DecimalField(message, HEADERSIZE + 299, 23, 8, "E01QUOLOP");
    fields[24] = fieldE01QUOMKP =
    new DecimalField(message, HEADERSIZE + 322, 23, 8, "E01QUOMKP");
    fields[25] = fieldE01QUOCLP =
    new DecimalField(message, HEADERSIZE + 345, 23, 8, "E01QUOCLP");
    fields[26] = fieldE01QUOAVS =
    new DecimalField(message, HEADERSIZE + 368, 23, 8, "E01QUOAVS");
    fields[27] = fieldE01QUOAVP =
    new DecimalField(message, HEADERSIZE + 391, 23, 8, "E01QUOAVP");
    fields[28] = fieldE01QUOUSR =
    new CharacterField(message, HEADERSIZE + 414, 10, "E01QUOUSR");
    fields[29] = fieldE01QUOUP1 =
    new DecimalField(message, HEADERSIZE + 424, 5, 0, "E01QUOUP1");
    fields[30] = fieldE01QUOUP2 =
    new DecimalField(message, HEADERSIZE + 429, 3, 0, "E01QUOUP2");
    fields[31] = fieldE01QUOUP3 =
    new DecimalField(message, HEADERSIZE + 432, 3, 0, "E01QUOUP3");
    fields[32] = fieldE01QUOUPT =
    new CharacterField(message, HEADERSIZE + 435, 26, "E01QUOUPT");
    fields[33] = fieldE01QUOSTS =
    new CharacterField(message, HEADERSIZE + 461, 1, "E01QUOSTS");
    fields[34] = fieldE01QUOFL0 =
    new CharacterField(message, HEADERSIZE + 462, 1, "E01QUOFL0");
    fields[35] = fieldE01QUOFL1 =
    new CharacterField(message, HEADERSIZE + 463, 1, "E01QUOFL1");
    fields[36] = fieldE01QUOFL2 =
    new CharacterField(message, HEADERSIZE + 464, 1, "E01QUOFL2");
    fields[37] = fieldE01QUOFL3 =
    new CharacterField(message, HEADERSIZE + 465, 1, "E01QUOFL3");
    fields[38] = fieldE01QUOFL4 =
    new CharacterField(message, HEADERSIZE + 466, 15, "E01QUOFL4");
    fields[39] = fieldE01QUOFL5 =
    new CharacterField(message, HEADERSIZE + 481, 15, "E01QUOFL5");
    fields[40] = fieldE01QUOFL6 =
    new CharacterField(message, HEADERSIZE + 496, 15, "E01QUOFL6");
    fields[41] = fieldE01QUOFL7 =
    new DecimalField(message, HEADERSIZE + 511, 23, 6, "E01QUOFL7");
    fields[42] = fieldE01QUOFL8 =
    new DecimalField(message, HEADERSIZE + 534, 23, 6, "E01QUOFL8");
    fields[43] = fieldE01QUOFL9 =
    new DecimalField(message, HEADERSIZE + 557, 23, 6, "E01QUOFL9");
    fields[44] = fieldD01ISIDSC =
    new CharacterField(message, HEADERSIZE + 580, 60, "D01ISIDSC");
    fields[45] = fieldD01ISIPTY =
    new CharacterField(message, HEADERSIZE + 640, 4, "D01ISIPTY");
    fields[46] = fieldD01ISINUM =
    new CharacterField(message, HEADERSIZE + 644, 12, "D01ISINUM");
    fields[47] = fieldD01ISISER =
    new CharacterField(message, HEADERSIZE + 656, 4, "D01ISISER");
    fields[48] = fieldD01ISICUS =
    new CharacterField(message, HEADERSIZE + 660, 12, "D01ISICUS");
    fields[49] = fieldD01ISISYM =
    new CharacterField(message, HEADERSIZE + 672, 15, "D01ISISYM");
    fields[50] = fieldD01ISICCY =
    new CharacterField(message, HEADERSIZE + 687, 3, "D01ISICCY");
