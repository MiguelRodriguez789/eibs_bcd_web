...
* Record format level identifier is 41C34A80A761E.
*/
...
public class EPC013001Message extends MessageRecord
{
  ...
  final static String rid = "41C34A80A761E";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 62, 5, 0, "E01FRDTE3");
    fields[14] = fieldE01TODTE1 =
    new DecimalField(message, HEADERSIZE + 67, 3, 0, "E01TODTE1");
    fields[15] = fieldE01TODTE2 =
    new DecimalField(message, HEADERSIZE + 70, 3, 0, "E01TODTE2");
    fields[16] = fieldE01TODTE3 =
    new DecimalField(message, HEADERSIZE + 73, 5, 0, "E01TODTE3");
    ...
    new CharacterField(message, HEADERSIZE + 256, 26, "E01TRATIM");
    fields[36] = fieldE01TRAUSA =
    new CharacterField(message, HEADERSIZE + 282, 10, "E01TRAUSA");
    fields[37] = fieldE01TRAUSO =
    new CharacterField(message, HEADERSIZE + 292, 10, "E01TRAUSO");
    ...
    fields[54] = fieldE01TRAPD1 =
    new DecimalField(message, HEADERSIZE + 897, 3, 0, "E01TRAPD1");
    fields[55] = fieldE01TRAPD2 =
    new DecimalField(message, HEADERSIZE + 900, 3, 0, "E01TRAPD2");
    fields[56] = fieldE01TRAPD3 =
    new DecimalField(message, HEADERSIZE + 903, 5, 0, "E01TRAPD3");
