...
* Record format level identifier is 4A8CC4D356DDA.
*/
...
public class EFO012006Message extends MessageRecord
{
  ...
  final static String rid = "4A8CC4D356DDA";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 52, 60, "E06CUSNA1");
    fields[11] = fieldE06SELACD =
    new CharacterField(message, HEADERSIZE + 112, 2, "E06SELACD");
    fields[12] = fieldE06SELFLG =
    new CharacterField(message, HEADERSIZE + 114, 1, "E06SELFLG");
    fields[13] = fieldE06SELTYP =
    new CharacterField(message, HEADERSIZE + 115, 4, "E06SELTYP");
    fields[14] = fieldE06SELPRO =
    new CharacterField(message, HEADERSIZE + 119, 4, "E06SELPRO");
    fields[15] = fieldE06ACCNUM =
    new DecimalField(message, HEADERSIZE + 123, 13, 0, "E06ACCNUM");
    fields[16] = fieldE06BNKNUM =
    new CharacterField(message, HEADERSIZE + 136, 2, "E06BNKNUM");
    fields[17] = fieldE06BRNNUM =
    new DecimalField(message, HEADERSIZE + 138, 5, 0, "E06BRNNUM");
    fields[18] = fieldE06CCYCDE =
    new CharacterField(message, HEADERSIZE + 143, 3, "E06CCYCDE");
    fields[19] = fieldE06ACCTYP =
    new CharacterField(message, HEADERSIZE + 146, 4, "E06ACCTYP");
    fields[20] = fieldE06PROCDE =
    new CharacterField(message, HEADERSIZE + 150, 4, "E06PROCDE");
    fields[21] = fieldE06PRIAMN =
    new DecimalField(message, HEADERSIZE + 154, 17, 2, "E06PRIAMN");
    fields[22] = fieldE06INTAMN =
    new DecimalField(message, HEADERSIZE + 171, 17, 2, "E06INTAMN");
    fields[23] = fieldE06OTHAMN =
    new DecimalField(message, HEADERSIZE + 188, 17, 2, "E06OTHAMN");
    fields[24] = fieldE06TOTAMN =
    new DecimalField(message, HEADERSIZE + 205, 17, 2, "E06TOTAMN");
    fields[25] = fieldE06EQVPRI =
    new DecimalField(message, HEADERSIZE + 222, 17, 2, "E06EQVPRI");
    fields[26] = fieldE06EQVINT =
    new DecimalField(message, HEADERSIZE + 239, 17, 2, "E06EQVINT");
    fields[27] = fieldE06EQVOTH =
    new DecimalField(message, HEADERSIZE + 256, 17, 2, "E06EQVOTH");
    fields[28] = fieldE06EQVAMN =
    new DecimalField(message, HEADERSIZE + 273, 17, 2, "E06EQVAMN");
    fields[29] = fieldE06ACCSTS =
    new CharacterField(message, HEADERSIZE + 290, 45, "E06ACCSTS");
    fields[30] = fieldE06OPEDT1 =
    new DecimalField(message, HEADERSIZE + 335, 3, 0, "E06OPEDT1");
    fields[31] = fieldE06OPEDT2 =
    new DecimalField(message, HEADERSIZE + 338, 3, 0, "E06OPEDT2");
    fields[32] = fieldE06OPEDT3 =
    new DecimalField(message, HEADERSIZE + 341, 5, 0, "E06OPEDT3");
    fields[33] = fieldE06OFFICR =
    new CharacterField(message, HEADERSIZE + 346, 4, "E06OFFICR");
    fields[34] = fieldE06PRODSC =
    new CharacterField(message, HEADERSIZE + 350, 45, "E06PRODSC");
    fields[35] = fieldE06MATDT1 =
    new DecimalField(message, HEADERSIZE + 395, 3, 0, "E06MATDT1");
    fields[36] = fieldE06MATDT2 =
    new DecimalField(message, HEADERSIZE + 398, 3, 0, "E06MATDT2");
    fields[37] = fieldE06MATDT3 =
    new DecimalField(message, HEADERSIZE + 401, 5, 0, "E06MATDT3");
    fields[38] = fieldE06DEAROC =
    new CharacterField(message, HEADERSIZE + 406, 1, "E06DEAROC");
    fields[39] = fieldE06DEARAC =
    new DecimalField(message, HEADERSIZE + 407, 13, 0, "E06DEARAC");
    fields[40] = fieldE06DEATRM =
    new DecimalField(message, HEADERSIZE + 420, 6, 0, "E06DEATRM");
    fields[41] = fieldE06DEATRC =
    new CharacterField(message, HEADERSIZE + 426, 1, "E06DEATRC");
    fields[42] = fieldE06INTRTE =
    new DecimalField(message, HEADERSIZE + 427, 11, 6, "E06INTRTE");
    fields[43] = fieldE06NUMREC =
    new DecimalField(message, HEADERSIZE + 438, 8, 0, "E06NUMREC");
    fields[44] = fieldE06INDOPE =
    new CharacterField(message, HEADERSIZE + 446, 1, "E06INDOPE");
