...
/**
* Class generated by AS/400 CRTCLASS command from ESO000001 physical file definition.
* 
* File level identifier is 1170224115728.
* Record format level identifier is 3C46F28422DDF.
*/

public class ESO000001Message extends MessageRecord
{
  ...
  final static String fid = "1170224115728";
  final static String rid = "3C46F28422DDF";
  final static String fmtname = "ESO000001";
  ...
  /**
  * Constructor for ESO000001Message.
  */
  public ESO000001Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[9] = fieldE01USERID =
    new CharacterField(message, HEADERSIZE + 42, 10, "E01USERID");
    fields[10] = fieldE01SOLACC =
    new DecimalField(message, HEADERSIZE + 52, 13, 0, "E01SOLACC");
    fields[11] = fieldE01SOLACD =
    new CharacterField(message, HEADERSIZE + 65, 2, "E01SOLACD");
    fields[12] = fieldE01SOLCUN =
    new DecimalField(message, HEADERSIZE + 67, 10, 0, "E01SOLCUN");
    fields[13] = fieldE01CUSNA1 =
    new CharacterField(message, HEADERSIZE + 77, 60, "E01CUSNA1");
    fields[14] = fieldE01SOLPRO =
    new CharacterField(message, HEADERSIZE + 137, 4, "E01SOLPRO");
    fields[15] = fieldE01SOLPRI =
    new DecimalField(message, HEADERSIZE + 141, 17, 2, "E01SOLPRI");
    fields[16] = fieldE01SOLTRM =
    new DecimalField(message, HEADERSIZE + 158, 5, 0, "E01SOLTRM");
    fields[17] = fieldE01SOLTRC =
    new CharacterField(message, HEADERSIZE + 163, 1, "E01SOLTRC");
    fields[18] = fieldE01SOLOPE =
    new CharacterField(message, HEADERSIZE + 164, 2, "E01SOLOPE");
    fields[19] = fieldE01SOLRTE =
    new DecimalField(message, HEADERSIZE + 166, 11, 6, "E01SOLRTE");
    fields[20] = fieldE01SOLART =
    new DecimalField(message, HEADERSIZE + 177, 11, 6, "E01SOLART");
    fields[21] = fieldE01DEAMAM =
    new DecimalField(message, HEADERSIZE + 188, 3, 0, "E01DEAMAM");
    fields[22] = fieldE01DEAMAD =
    new DecimalField(message, HEADERSIZE + 191, 3, 0, "E01DEAMAD");
    fields[23] = fieldE01DEAMAY =
    new DecimalField(message, HEADERSIZE + 194, 5, 0, "E01DEAMAY");
    fields[24] = fieldE01SOLPVI =
    new CharacterField(message, HEADERSIZE + 199, 1, "E01SOLPVI");
    fields[25] = fieldE01SOLABY =
    new CharacterField(message, HEADERSIZE + 200, 10, "E01SOLABY");
    fields[26] = fieldE01SOLNME =
    new CharacterField(message, HEADERSIZE + 210, 45, "E01SOLNME");
    fields[27] = fieldE01SOLFCK =
    new DecimalField(message, HEADERSIZE + 255, 12, 0, "E01SOLFCK");
    fields[28] = fieldE01SOLTCK =
    new DecimalField(message, HEADERSIZE + 267, 12, 0, "E01SOLTCK");
    fields[29] = fieldE01ACTION =
    new CharacterField(message, HEADERSIZE + 279, 1, "E01ACTION");
    fields[30] = fieldE01FINDAT =
    new CharacterField(message, HEADERSIZE + 280, 1, "E01FINDAT");
