...
* Record format level identifier is 4C82002ECDBF8.
*/
...
public class ESI000003Message extends MessageRecord
{
  ...
  final static String rid = "4C82002ECDBF8";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 66, 45, "E03WDESGA");
    fields[13] = fieldE03WTIPIG =
    new CharacterField(message, HEADERSIZE + 111, 1, "E03WTIPIG");
    fields[14] = fieldE03WRIFGA =
    new DecimalField(message, HEADERSIZE + 112, 20, 0, "E03WRIFGA");
    fields[15] = fieldE03WMONGA =
    new DecimalField(message, HEADERSIZE + 132, 22, 2, "E03WMONGA");
    fields[16] = fieldE03WTOGAR =
    new DecimalField(message, HEADERSIZE + 154, 22, 2, "E03WTOGAR");
    fields[17] = fieldE03NUMREC =
    new DecimalField(message, HEADERSIZE + 176, 8, 0, "E03NUMREC");
    fields[18] = fieldE03INDOPE =
    new CharacterField(message, HEADERSIZE + 184, 1, "E03INDOPE");
