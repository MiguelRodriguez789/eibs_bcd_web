...
* Record format level identifier is 5600F170B5C32.
*/
...
public class EPV001002Message extends MessageRecord
{
  ...
  final static String rid = "5600F170B5C32";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 65, 60, "E02PVMNA1");
    fields[12] = fieldE02PVMIDE =
    new CharacterField(message, HEADERSIZE + 125, 25, "E02PVMIDE");
    fields[13] = fieldE02NUMPRO =
    new DecimalField(message, HEADERSIZE + 150, 4, 0, "E02NUMPRO");
    fields[14] = fieldE02NUMSBP =
    new DecimalField(message, HEADERSIZE + 154, 3, 0, "E02NUMSBP");
    fields[15] = fieldE02NUMBCO =
    new CharacterField(message, HEADERSIZE + 157, 2, "E02NUMBCO");
    fields[16] = fieldE02NUMOFI =
    new CharacterField(message, HEADERSIZE + 159, 3, "E02NUMOFI");
    fields[17] = fieldE02DATAVR =
    new CharacterField(message, HEADERSIZE + 162, 9000, "E02DATAVR");
