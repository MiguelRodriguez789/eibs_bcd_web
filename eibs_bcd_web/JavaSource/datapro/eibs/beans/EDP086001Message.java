...
* Record format level identifier is 3AEBAC6778C2C.
*/
...
public class EDP086001Message extends MessageRecord
{
  ...
  final static String rid = "3AEBAC6778C2C";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 47, 45, "E01PNRDSC");
    fields[12] = fieldE01PNRSNM =
    new CharacterField(message, HEADERSIZE + 92, 25, "E01PNRSNM");
    fields[13] = fieldE01PNRPTS =
    new DecimalField(message, HEADERSIZE + 117, 17, 2, "E01PNRPTS");
    fields[14] = fieldE01PNRPMN =
    new DecimalField(message, HEADERSIZE + 134, 8, 3, "E01PNRPMN");
    fields[15] = fieldE01PNRPMX =
    new DecimalField(message, HEADERSIZE + 142, 8, 3, "E01PNRPMX");
    fields[16] = fieldE01PNRPRI =
    new DecimalField(message, HEADERSIZE + 150, 8, 3, "E01PNRPRI");
    fields[17] = fieldE01RECPOS =
    new DecimalField(message, HEADERSIZE + 158, 8, 0, "E01RECPOS");
    fields[18] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 166, 1, "E01OPECDE");
