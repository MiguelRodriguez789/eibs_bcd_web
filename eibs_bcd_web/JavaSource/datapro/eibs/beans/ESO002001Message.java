...
* Record format level identifier is 3E2F49D09BC29.
*/
...
public class ESO002001Message extends MessageRecord
{
  ...
  final static String rid = "3E2F49D09BC29";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 95, 60, "E01CUSNA1");
    fields[15] = fieldE01SOLPRI =
    new DecimalField(message, HEADERSIZE + 155, 17, 2, "E01SOLPRI");
    fields[16] = fieldE01SOLTRM =
    new DecimalField(message, HEADERSIZE + 172, 5, 0, "E01SOLTRM");
    fields[17] = fieldE01SOLTRC =
    new CharacterField(message, HEADERSIZE + 177, 1, "E01SOLTRC");
    fields[18] = fieldE01SOLOPE =
    new CharacterField(message, HEADERSIZE + 178, 2, "E01SOLOPE");
    fields[19] = fieldE01SOLRTE =
    new DecimalField(message, HEADERSIZE + 180, 11, 6, "E01SOLRTE");
    fields[20] = fieldE01SOLART =
    new DecimalField(message, HEADERSIZE + 191, 11, 6, "E01SOLART");
    fields[21] = fieldE01SOLABY =
    new CharacterField(message, HEADERSIZE + 202, 10, "E01SOLABY");
    fields[22] = fieldE01SOLCLV =
    new CharacterField(message, HEADERSIZE + 212, 10, "E01SOLCLV");
    fields[23] = fieldE01SOLNME =
    new CharacterField(message, HEADERSIZE + 222, 45, "E01SOLNME");
    fields[24] = fieldE01ACTION =
    new CharacterField(message, HEADERSIZE + 267, 1, "E01ACTION");
    fields[25] = fieldE01FINDAT =
    new CharacterField(message, HEADERSIZE + 268, 1, "E01FINDAT");
