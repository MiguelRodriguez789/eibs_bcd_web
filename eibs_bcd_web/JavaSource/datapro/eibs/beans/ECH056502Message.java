...
* 
* File level identifier is 1180515145213.
* Record format level identifier is 4C3EDCE7A76EB.
*/
...
public class ECH056502Message extends MessageRecord
{
  ...
  final static String fid = "1180515145213";
  final static String rid = "4C3EDCE7A76EB";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 55, 13, 0, "E02CHMNCB");
    fields[11] = fieldE02CHMN01 =
    new DecimalField(message, HEADERSIZE + 68, 12, 0, "E02CHMN01");
    fields[12] = fieldE02CHMN02 =
    new DecimalField(message, HEADERSIZE + 80, 12, 0, "E02CHMN02");
    fields[13] = fieldE02CHMN03 =
    new DecimalField(message, HEADERSIZE + 92, 12, 0, "E02CHMN03");
    fields[14] = fieldE02CHMN04 =
    new DecimalField(message, HEADERSIZE + 104, 12, 0, "E02CHMN04");
    fields[15] = fieldE02CHMN05 =
    new DecimalField(message, HEADERSIZE + 116, 12, 0, "E02CHMN05");
    fields[16] = fieldE02CHMS01 =
    new CharacterField(message, HEADERSIZE + 128, 12, "E02CHMS01");
    fields[17] = fieldE02CHMS02 =
    new CharacterField(message, HEADERSIZE + 140, 12, "E02CHMS02");
    fields[18] = fieldE02CHMS03 =
    new CharacterField(message, HEADERSIZE + 152, 12, "E02CHMS03");
    fields[19] = fieldE02CHMS04 =
    new CharacterField(message, HEADERSIZE + 164, 12, "E02CHMS04");
    fields[20] = fieldE02CHMS05 =
    new CharacterField(message, HEADERSIZE + 176, 12, "E02CHMS05");
