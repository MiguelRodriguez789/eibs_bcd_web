...
* Record format level identifier is 496DBC96E37B7.
*/
...
public class EGL075001Message extends MessageRecord
{
  ...
  final static String rid = "496DBC96E37B7";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 146, 21, 2, "E01GLBBAL");
    fields[19] = fieldE01GLBINI =
    new DecimalField(message, HEADERSIZE + 167, 21, 2, "E01GLBINI");
    fields[20] = fieldE01GLBFIN =
    new DecimalField(message, HEADERSIZE + 188, 21, 2, "E01GLBFIN");
    fields[21] = fieldE01GLBENE =
    new DecimalField(message, HEADERSIZE + 209, 21, 2, "E01GLBENE");
    fields[22] = fieldE01GLBFEB =
    new DecimalField(message, HEADERSIZE + 230, 21, 2, "E01GLBFEB");
    fields[23] = fieldE01GLBMAR =
    new DecimalField(message, HEADERSIZE + 251, 21, 2, "E01GLBMAR");
    fields[24] = fieldE01GLBABR =
    new DecimalField(message, HEADERSIZE + 272, 21, 2, "E01GLBABR");
    fields[25] = fieldE01GLBMAY =
    new DecimalField(message, HEADERSIZE + 293, 21, 2, "E01GLBMAY");
    fields[26] = fieldE01GLBJUN =
    new DecimalField(message, HEADERSIZE + 314, 21, 2, "E01GLBJUN");
    fields[27] = fieldE01GLBJUL =
    new DecimalField(message, HEADERSIZE + 335, 21, 2, "E01GLBJUL");
    fields[28] = fieldE01GLBAGO =
    new DecimalField(message, HEADERSIZE + 356, 21, 2, "E01GLBAGO");
    fields[29] = fieldE01GLBSET =
    new DecimalField(message, HEADERSIZE + 377, 21, 2, "E01GLBSET");
    fields[30] = fieldE01GLBOCT =
    new DecimalField(message, HEADERSIZE + 398, 21, 2, "E01GLBOCT");
    fields[31] = fieldE01GLBNOV =
    new DecimalField(message, HEADERSIZE + 419, 21, 2, "E01GLBNOV");
    fields[32] = fieldE01GLBDIC =
    new DecimalField(message, HEADERSIZE + 440, 21, 2, "E01GLBDIC");
    fields[33] = fieldE01NUMREC =
    new DecimalField(message, HEADERSIZE + 461, 8, 0, "E01NUMREC");
    fields[34] = fieldE01GLBINV =
    new CharacterField(message, HEADERSIZE + 469, 1, "E01GLBINV");
    fields[35] = fieldE01INDOPE =
    new CharacterField(message, HEADERSIZE + 470, 1, "E01INDOPE");
