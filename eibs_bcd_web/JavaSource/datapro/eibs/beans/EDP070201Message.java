...
* Record format level identifier is 5211827A595C2.
*/
...
public class EDP070201Message extends MessageRecord
{
  ...
  final static String rid = "5211827A595C2";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 105, 1, "E01DPFLGT");
    fields[13] = fieldE01DPFVAL =
    new CharacterField(message, HEADERSIZE + 106, 1, "E01DPFVAL");
    fields[14] = fieldE01DPFCLF =
    new CharacterField(message, HEADERSIZE + 107, 1, "E01DPFCLF");
    fields[15] = fieldE01DPFFV1 =
    new DecimalField(message, HEADERSIZE + 108, 6, 0, "E01DPFFV1");
    fields[16] = fieldE01DPFFVN =
    new DecimalField(message, HEADERSIZE + 114, 6, 0, "E01DPFFVN");
    fields[17] = fieldE01DPFUVN =
    new CharacterField(message, HEADERSIZE + 120, 1, "E01DPFUVN");
    fields[18] = fieldE01DPFCMP =
    new CharacterField(message, HEADERSIZE + 121, 1, "E01DPFCMP");
    fields[19] = fieldE01DPFAUT =
    new CharacterField(message, HEADERSIZE + 122, 1, "E01DPFAUT");
    fields[20] = fieldE01DPFCTO =
    new CharacterField(message, HEADERSIZE + 123, 1, "E01DPFCTO");
    fields[21] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 124, 1, "E01OPECDE");
