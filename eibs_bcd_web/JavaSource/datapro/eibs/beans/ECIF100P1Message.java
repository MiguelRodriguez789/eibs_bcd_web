...
* Record format level identifier is 349C7229CC1C0.
*/
...
public class ECIF100P1Message extends MessageRecord
{
  ...
  final static String rid = "349C7229CC1C0";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 56, 6, 0, "E01DEATRM");
    fields[12] = fieldE01DEATRC =
    new CharacterField(message, HEADERSIZE + 62, 1, "E01DEATRC");
    fields[13] = fieldE01CUSSHN =
    new CharacterField(message, HEADERSIZE + 63, 45, "E01CUSSHN");
    fields[14] = fieldE01CUSTOM =
    new DecimalField(message, HEADERSIZE + 108, 10, 0, "E01CUSTOM");
    fields[15] = fieldE01BALANC =
    new DecimalField(message, HEADERSIZE + 118, 17, 2, "E01BALANC");
    fields[16] = fieldE01EXCRTE =
    new DecimalField(message, HEADERSIZE + 135, 13, 6, "E01EXCRTE");
    fields[17] = fieldE01BALBSE =
    new DecimalField(message, HEADERSIZE + 148, 17, 2, "E01BALBSE");
    fields[18] = fieldE01INTRTE =
    new DecimalField(message, HEADERSIZE + 165, 11, 6, "E01INTRTE");
    fields[19] = fieldE01MATDT1 =
    new DecimalField(message, HEADERSIZE + 176, 3, 0, "E01MATDT1");
    fields[20] = fieldE01MATDT2 =
    new DecimalField(message, HEADERSIZE + 179, 3, 0, "E01MATDT2");
    fields[21] = fieldE01MATDT3 =
    new DecimalField(message, HEADERSIZE + 182, 5, 0, "E01MATDT3");
    fields[22] = fieldE01OPNDT1 =
    new DecimalField(message, HEADERSIZE + 187, 3, 0, "E01OPNDT1");
    fields[23] = fieldE01OPNDT2 =
    new DecimalField(message, HEADERSIZE + 190, 3, 0, "E01OPNDT2");
    fields[24] = fieldE01OPNDT3 =
    new DecimalField(message, HEADERSIZE + 193, 5, 0, "E01OPNDT3");
    fields[25] = fieldE01INIDT1 =
    new DecimalField(message, HEADERSIZE + 198, 3, 0, "E01INIDT1");
    fields[26] = fieldE01INIDT2 =
    new DecimalField(message, HEADERSIZE + 201, 3, 0, "E01INIDT2");
    fields[27] = fieldE01INIDT3 =
    new DecimalField(message, HEADERSIZE + 204, 5, 0, "E01INIDT3");
    fields[28] = fieldE01PRODUC =
    new CharacterField(message, HEADERSIZE + 209, 4, "E01PRODUC");
    fields[29] = fieldE01OFCCDE =
    new CharacterField(message, HEADERSIZE + 213, 4, "E01OFCCDE");
    fields[30] = fieldE01OFCNME =
    new CharacterField(message, HEADERSIZE + 217, 45, "E01OFCNME");
    fields[31] = fieldE01GRPNUM =
    new CharacterField(message, HEADERSIZE + 262, 3, "E01GRPNUM");
    fields[32] = fieldE01GRPNAM =
    new CharacterField(message, HEADERSIZE + 265, 60, "E01GRPNAM");
    fields[33] = fieldE01SGRNUM =
    new CharacterField(message, HEADERSIZE + 325, 3, "E01SGRNUM");
    fields[34] = fieldE01SGRNAM =
    new CharacterField(message, HEADERSIZE + 328, 60, "E01SGRNAM");
    fields[35] = fieldE01COSCEN =
    new DecimalField(message, HEADERSIZE + 388, 7, 0, "E01COSCEN");
    fields[36] = fieldE01CCNAME =
    new CharacterField(message, HEADERSIZE + 395, 60, "E01CCNAME");
    fields[37] = fieldE01WTOTAL =
    new DecimalField(message, HEADERSIZE + 455, 17, 2, "E01WTOTAL");
    fields[38] = fieldE01ALLCCT =
    new CharacterField(message, HEADERSIZE + 472, 1, "E01ALLCCT");
    fields[39] = fieldE01CCAUTH =
    new CharacterField(message, HEADERSIZE + 473, 2400, "E01CCAUTH");
    fields[40] = fieldE01OLDRSP =
    new CharacterField(message, HEADERSIZE + 2873, 13, "E01OLDRSP");
