...
/**
* Class generated by AS/400 CRTCLASS command from EGC070020 physical file definition.
* 
* File level identifier is 1100706173619.
* Record format level identifier is 4280CD2020D04.
*/

public class EGC070020Message extends MessageRecord
{
  ...
  final static String rid = "4280CD2020D04";
  final static String fmtname = "EGC070020";
  ...
  /**
  * Constructor for EGC070020Message.
  */
  public EGC070020Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[10] = fieldEUPOFC =
    new CharacterField(message, HEADERSIZE + 52, 4, "EUPOFC");
    fields[11] = fieldEUPNME =
    new CharacterField(message, HEADERSIZE + 56, 45, "EUPNME");
    fields[12] = fieldEUPPHN =
    new DecimalField(message, HEADERSIZE + 101, 12, 0, "EUPPHN");
    fields[13] = fieldEUPUSR =
    new CharacterField(message, HEADERSIZE + 113, 10, "EUPUSR");
    fields[14] = fieldEGCXRT =
    new DecimalField(message, HEADERSIZE + 123, 2, 0, "EGCXRT");
