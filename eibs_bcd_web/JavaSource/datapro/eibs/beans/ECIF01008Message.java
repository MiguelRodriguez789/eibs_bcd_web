...
/**
* Class generated by AS/400 CRTCLASS command from ECIF01008 physical file definition.
* 
* File level identifier is 1130611112845.
* Record format level identifier is 5A050C6F3D19F.
*/

public class ECIF01008Message extends MessageRecord
{
  ...
  final static String rid = "5A050C6F3D19F";
  final static String fmtname = "ECIF01008";
  ...
  private CharacterField fieldE08CUSLN3 = null;

  /**
  * Constructor for ECIF01008Message.
  */
  public ECIF01008Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 112, 25, "E08CUSIDN");
    fields[12] = fieldE08CUSPID =
    new CharacterField(message, HEADERSIZE + 137, 4, "E08CUSPID");
    fields[13] = fieldE08CUSIDF =
    new CharacterField(message, HEADERSIZE + 141, 4, "E08CUSIDF");
    fields[14] = fieldE08CUSLGT =
    new CharacterField(message, HEADERSIZE + 145, 1, "E08CUSLGT");
    fields[15] = fieldE08CUSTYP =
    new CharacterField(message, HEADERSIZE + 146, 1, "E08CUSTYP");
    fields[16] = fieldE08CUSLN3 =
    new CharacterField(message, HEADERSIZE + 147, 45, "E08CUSLN3");
  ...
  */
  ...
  /**
  * Set field E08CUSLN3 using a String value.
  */
  public void setE08CUSLN3(String newvalue)
  {
    fieldE08CUSLN3.setString(newvalue);
  }

  /**
  * Get value of field E08CUSLN3 as a String.
  */
  public String getE08CUSLN3()
  {
    return fieldE08CUSLN3.getString();
  }
