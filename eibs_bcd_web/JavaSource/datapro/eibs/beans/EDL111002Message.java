...
/**
* Class generated by AS/400 CRTCLASS command from EDL111002 physical file definition.
* 
* File level identifier is 1131001182325.
* Record format level identifier is 5CEC87B5A4E11.
*/

public class EDL111002Message extends MessageRecord
{
  ...
  final static String fid = "1131001182325";
  final static String rid = "5CEC87B5A4E11";
  final static String fmtname = "EDL111002";
  ...
  /**
  * Constructor for EDL111002Message.
  */
  public EDL111002Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 44, 1, "E02ACTION");
    fields[11] = fieldE02MSGTXT =
    new CharacterField(message, HEADERSIZE + 45, 512, "E02MSGTXT");
