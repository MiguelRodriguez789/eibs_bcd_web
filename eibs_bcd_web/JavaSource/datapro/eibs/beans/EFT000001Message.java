...
* Record format level identifier is 4A0A68EE4815C.
*/
...
public class EFT000001Message extends MessageRecord
{
  ...
  final static String rid = "4A0A68EE4815C";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 125, 60, "E01CUSNA2");
    fields[13] = fieldE01CUSNA3 =
    new CharacterField(message, HEADERSIZE + 185, 60, "E01CUSNA3");
    fields[14] = fieldE01CUSNA4 =
    new CharacterField(message, HEADERSIZE + 245, 60, "E01CUSNA4");
    fields[15] = fieldE01CUSCTY =
    new CharacterField(message, HEADERSIZE + 305, 35, "E01CUSCTY");
    fields[16] = fieldE01CUSSTE =
    new CharacterField(message, HEADERSIZE + 340, 4, "E01CUSSTE");
    fields[17] = fieldE01CUSCTR =
    new CharacterField(message, HEADERSIZE + 344, 35, "E01CUSCTR");
    fields[18] = fieldE01CUSZPC =
    new CharacterField(message, HEADERSIZE + 379, 15, "E01CUSZPC");
    fields[19] = fieldE01CUSPOB =
    new CharacterField(message, HEADERSIZE + 394, 10, "E01CUSPOB");
    fields[20] = fieldE01CUSIDN =
    new CharacterField(message, HEADERSIZE + 404, 25, "E01CUSIDN");
    fields[21] = fieldE01CUSTID =
    new CharacterField(message, HEADERSIZE + 429, 4, "E01CUSTID");
    fields[22] = fieldE01CUSPID =
    new CharacterField(message, HEADERSIZE + 433, 4, "E01CUSPID");
    fields[23] = fieldE01CUSLGT =
    new CharacterField(message, HEADERSIZE + 437, 1, "E01CUSLGT");
    fields[24] = fieldE01CUSFL1 =
    new CharacterField(message, HEADERSIZE + 438, 1, "E01CUSFL1");
    fields[25] = fieldE01CUSBUC =
    new CharacterField(message, HEADERSIZE + 439, 4, "E01CUSBUC");
    fields[26] = fieldE01CUSINC =
    new CharacterField(message, HEADERSIZE + 443, 4, "E01CUSINC");
    fields[27] = fieldE01DSCBUC =
    new CharacterField(message, HEADERSIZE + 447, 45, "E01DSCBUC");
    fields[28] = fieldE01DSCINC =
    new CharacterField(message, HEADERSIZE + 492, 45, "E01DSCINC");
    fields[29] = fieldE01BANKNM =
    new CharacterField(message, HEADERSIZE + 537, 45, "E01BANKNM");
    fields[30] = fieldE01BRNNME =
    new CharacterField(message, HEADERSIZE + 582, 45, "E01BRNNME");
    fields[31] = fieldE01BRNADR =
    new CharacterField(message, HEADERSIZE + 627, 45, "E01BRNADR");
    fields[32] = fieldE01BRNCIT =
    new CharacterField(message, HEADERSIZE + 672, 45, "E01BRNCIT");
    fields[33] = fieldE01BRNPHN =
    new DecimalField(message, HEADERSIZE + 717, 16, 0, "E01BRNPHN");
    fields[34] = fieldE01CNTBID =
    new CharacterField(message, HEADERSIZE + 733, 25, "E01CNTBID");
    fields[35] = fieldE01CNTRD1 =
    new DecimalField(message, HEADERSIZE + 758, 3, 0, "E01CNTRD1");
    fields[36] = fieldE01CNTRD2 =
    new DecimalField(message, HEADERSIZE + 761, 3, 0, "E01CNTRD2");
    fields[37] = fieldE01CNTRD3 =
    new DecimalField(message, HEADERSIZE + 764, 5, 0, "E01CNTRD3");
    fields[38] = fieldE01DSCPRO =
    new CharacterField(message, HEADERSIZE + 769, 45, "E01DSCPRO");
    fields[39] = fieldE01DSCTYP =
    new CharacterField(message, HEADERSIZE + 814, 45, "E01DSCTYP");
