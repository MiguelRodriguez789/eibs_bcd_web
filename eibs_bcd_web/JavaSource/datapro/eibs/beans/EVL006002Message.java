...
* Record format level identifier is 3B6D669CC4568.
*/
...
public class EVL006002Message extends MessageRecord
{
  ...
  final static String rid = "3B6D669CC4568";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 170, 13, 0, "E02DOCSER");
    fields[18] = fieldE02DOCINI =
    new DecimalField(message, HEADERSIZE + 183, 13, 0, "E02DOCINI");
    fields[19] = fieldE02DOCFIN =
    new DecimalField(message, HEADERSIZE + 196, 13, 0, "E02DOCFIN");
    fields[20] = fieldE02DOCLST =
    new DecimalField(message, HEADERSIZE + 209, 13, 0, "E02DOCLST");
    fields[21] = fieldE02DOCBAL =
    new DecimalField(message, HEADERSIZE + 222, 13, 0, "E02DOCBAL");
