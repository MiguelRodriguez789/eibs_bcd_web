...
/**
* Class generated by AS/400 CRTCLASS command from EWD0123DS physical file definition.
* 
* File level identifier is 1130611113450.
* Record format level identifier is 4B373037A3491.
*/

public class EWD0123DSMessage extends MessageRecord
{
  ...
  final static String rid = "4B373037A3491";
  final static String fmtname = "EWD0123DS";
  ...
  /**
  * Constructor for EWD0123DSMessage.
  */
  public EWD0123DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 55, 25, "EWDIDN");
    fields[3] = fieldEWDEML =
    new CharacterField(message, HEADERSIZE + 80, 60, "EWDEML");
    fields[4] = fieldEWDPHN =
    new DecimalField(message, HEADERSIZE + 140, 16, 0, "EWDPHN");
    fields[5] = fieldEWDPXT =
    new DecimalField(message, HEADERSIZE + 156, 5, 0, "EWDPXT");
    fields[6] = fieldEWDAPL =
    new CharacterField(message, HEADERSIZE + 161, 4, "EWDAPL");
    fields[7] = fieldEWDDSN =
    new CharacterField(message, HEADERSIZE + 165, 45, "EWDDSN");
    fields[8] = fieldEWDLNA =
    new CharacterField(message, HEADERSIZE + 210, 1, "EWDLNA");
    fields[9] = fieldEWDTAT =
    new CharacterField(message, HEADERSIZE + 211, 1, "EWDTAT");
    fields[10] = fieldEWDCCY =
    new CharacterField(message, HEADERSIZE + 212, 3, "EWDCCY");
    fields[11] = fieldEWDALM =
    new DecimalField(message, HEADERSIZE + 215, 17, 2, "EWDALM");
    fields[12] = fieldEWDANG =
    new DecimalField(message, HEADERSIZE + 232, 17, 2, "EWDANG");
    fields[13] = fieldEWDGRE =
    new DecimalField(message, HEADERSIZE + 249, 3, 0, "EWDGRE");
    fields[14] = fieldEWDNUE =
    new DecimalField(message, HEADERSIZE + 252, 3, 0, "EWDNUE");
    fields[15] = fieldEWDBRN =
    new DecimalField(message, HEADERSIZE + 255, 5, 0, "EWDBRN");
    fields[16] = fieldEWDREC =
    new DecimalField(message, HEADERSIZE + 260, 8, 0, "EWDREC");
