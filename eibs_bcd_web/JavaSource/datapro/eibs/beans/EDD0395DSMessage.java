...
* 
* File level identifier is 1170113113827.
* Record format level identifier is 4DF00BC57EAF9.
*/
...
public class EDD0395DSMessage extends MessageRecord
{
  ...
  final static String fid = "1170113113827";
  final static String rid = "4DF00BC57EAF9";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 73, 12, 0, "E01UNCCKN");
    fields[13] = fieldE01UNCDYS =
    new DecimalField(message, HEADERSIZE + 85, 6, 0, "E01UNCDYS");
    fields[14] = fieldE01UNCRDM =
    new DecimalField(message, HEADERSIZE + 91, 3, 0, "E01UNCRDM");
    fields[15] = fieldE01UNCRDD =
    new DecimalField(message, HEADERSIZE + 94, 3, 0, "E01UNCRDD");
    fields[16] = fieldE01UNCRDY =
    new DecimalField(message, HEADERSIZE + 97, 5, 0, "E01UNCRDY");
    fields[17] = fieldE01UNCMDM =
    new DecimalField(message, HEADERSIZE + 102, 3, 0, "E01UNCMDM");
    fields[18] = fieldE01UNCMDD =
    new DecimalField(message, HEADERSIZE + 105, 3, 0, "E01UNCMDD");
    fields[19] = fieldE01UNCMDY =
    new DecimalField(message, HEADERSIZE + 108, 5, 0, "E01UNCMDY");
    fields[20] = fieldE01UNCRSN =
    new CharacterField(message, HEADERSIZE + 113, 60, "E01UNCRSN");
    fields[21] = fieldE01UNCCUN =
    new DecimalField(message, HEADERSIZE + 173, 10, 0, "E01UNCCUN");
    fields[22] = fieldE01UNCSTA =
    new CharacterField(message, HEADERSIZE + 183, 1, "E01UNCSTA");
    fields[23] = fieldE01UNCCON =
    new CharacterField(message, HEADERSIZE + 184, 4, "E01UNCCON");
    fields[24] = fieldE01UNCTEL =
    new CharacterField(message, HEADERSIZE + 188, 10, "E01UNCTEL");
    fields[25] = fieldE01UNCTSQ =
    new DecimalField(message, HEADERSIZE + 198, 8, 0, "E01UNCTSQ");
    fields[26] = fieldE01UNCKBK =
    new CharacterField(message, HEADERSIZE + 206, 4, "E01UNCKBK");
    fields[27] = fieldE01UNCKBR =
    new CharacterField(message, HEADERSIZE + 210, 4, "E01UNCKBR");
    fields[28] = fieldE01UNCKAC =
    new CharacterField(message, HEADERSIZE + 214, 15, "E01UNCKAC");
    fields[29] = fieldE01UNCDES =
    new CharacterField(message, HEADERSIZE + 229, 5, "E01UNCDES");
    fields[30] = fieldE01UNCCRM =
    new CharacterField(message, HEADERSIZE + 234, 3, "E01UNCCRM");
    fields[31] = fieldE01UNCOBR =
    new DecimalField(message, HEADERSIZE + 237, 5, 0, "E01UNCOBR");
    fields[32] = fieldE01UNCHTY =
    new CharacterField(message, HEADERSIZE + 242, 4, "E01UNCHTY");
    fields[33] = fieldE01UNCNRM =
    new DecimalField(message, HEADERSIZE + 246, 13, 0, "E01UNCNRM");
    fields[34] = fieldE01UNCUSR =
    new CharacterField(message, HEADERSIZE + 259, 4, "E01UNCUSR");
    fields[35] = fieldE01UNCFUS =
    new CharacterField(message, HEADERSIZE + 263, 1, "E01UNCFUS");
    fields[36] = fieldE01UNCF02 =
    new CharacterField(message, HEADERSIZE + 264, 1, "E01UNCF02");
