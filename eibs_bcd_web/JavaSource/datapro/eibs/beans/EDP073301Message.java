...
* Record format level identifier is 44323B62C03AD.
*/
...
public class EDP073301Message extends MessageRecord
{
  ...
  final static String rid = "44323B62C03AD";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 47, 45, "E01DPIDSC");
    fields[12] = fieldE01DPIFOR =
    new CharacterField(message, HEADERSIZE + 92, 300, "E01DPIFOR");
    fields[13] = fieldE01DPIAMT =
    new DecimalField(message, HEADERSIZE + 392, 23, 6, "E01DPIAMT");
    fields[14] = fieldE01IFMCUN =
    new DecimalField(message, HEADERSIZE + 415, 10, 0, "E01IFMCUN");
    fields[15] = fieldE01IFMFEY =
    new DecimalField(message, HEADERSIZE + 425, 5, 0, "E01IFMFEY");
    fields[16] = fieldE01IFMFEM =
    new DecimalField(message, HEADERSIZE + 430, 3, 0, "E01IFMFEM");
    fields[17] = fieldE01IFMFED =
    new DecimalField(message, HEADERSIZE + 433, 3, 0, "E01IFMFED");
    fields[18] = fieldE01IFMCFO =
    new CharacterField(message, HEADERSIZE + 436, 2, "E01IFMCFO");
    fields[19] = fieldE01IFMCFA =
    new CharacterField(message, HEADERSIZE + 438, 4, "E01IFMCFA");
    fields[20] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 442, 1, "E01OPECDE");
