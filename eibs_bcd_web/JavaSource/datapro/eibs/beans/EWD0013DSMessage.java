...
* Record format level identifier is 60FC13DDAA612.
*/
...
public class EWD0013DSMessage extends MessageRecord
{
  ...
  final static String rid = "60FC13DDAA612";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 7, 45, "EWDNME");
    fields[3] = fieldEWDADR =
    new CharacterField(message, HEADERSIZE + 52, 45, "EWDADR");
    fields[4] = fieldEWDCIT =
    new CharacterField(message, HEADERSIZE + 97, 45, "EWDCIT");
    fields[5] = fieldEWDPHN =
    new DecimalField(message, HEADERSIZE + 142, 16, 0, "EWDPHN");
    fields[6] = fieldEWDDID =
    new CharacterField(message, HEADERSIZE + 158, 25, "EWDDID");
    fields[7] = fieldEWDUS1 =
    new CharacterField(message, HEADERSIZE + 183, 4, "EWDUS1");
    fields[8] = fieldEWDUS2 =
    new CharacterField(message, HEADERSIZE + 187, 4, "EWDUS2");
    fields[9] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 191, 1, "EWDOPE");
