...
* Record format level identifier is 402E717283F9C.
*/
...
public class EDP088402Message extends MessageRecord
{
  ...
  final static String rid = "402E717283F9C";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 62, 8, 0, "E02PTSSEQ");
    fields[15] = fieldE02PTSDSC =
    new CharacterField(message, HEADERSIZE + 70, 60, "E02PTSDSC");
    fields[16] = fieldE02PTSPTS =
    new DecimalField(message, HEADERSIZE + 130, 8, 3, "E02PTSPTS");
    fields[17] = fieldE02PTSFLG =
    new CharacterField(message, HEADERSIZE + 138, 1, "E02PTSFLG");
    fields[18] = fieldE02PTSPTT =
    new DecimalField(message, HEADERSIZE + 139, 9, 2, "E02PTSPTT");
    fields[19] = fieldE02RECPOS =
    new DecimalField(message, HEADERSIZE + 148, 8, 0, "E02RECPOS");
    fields[20] = fieldE02OPECDE =
    new CharacterField(message, HEADERSIZE + 156, 1, "E02OPECDE");
