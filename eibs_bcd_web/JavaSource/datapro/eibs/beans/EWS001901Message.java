...
/**
* Class generated by AS/400 CRTCLASS command from EWS001901 physical file definition.
* 
* File level identifier is 1130611113511.
* Record format level identifier is 4F52EAD05ABFF.
*/

public class EWS001901Message extends MessageRecord
{
  ...
  final static String rid = "4F52EAD05ABFF";
  final static String fmtname = "EWS001901";
  ...
  /**
  * Constructor for EWS001901Message.
  */
  public EWS001901Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 122, 15, 2, "E01AMN");
    fields[17] = fieldE01FDM =
    new DecimalField(message, HEADERSIZE + 137, 3, 0, "E01FDM");
    fields[18] = fieldE01FDD =
    new DecimalField(message, HEADERSIZE + 140, 3, 0, "E01FDD");
    fields[19] = fieldE01FDY =
    new DecimalField(message, HEADERSIZE + 143, 5, 0, "E01FDY");
    ...
    new DecimalField(message, HEADERSIZE + 154, 5, 0, "E01TDY");
    fields[23] = fieldE01STS =
    new CharacterField(message, HEADERSIZE + 159, 1, "E01STS");
    fields[24] = fieldE01BRN =
    new DecimalField(message, HEADERSIZE + 160, 5, 0, "E01BRN");
    fields[25] = fieldE01DOC =
    new CharacterField(message, HEADERSIZE + 165, 10, "E01DOC");
    fields[26] = fieldE01OBS =
    new CharacterField(message, HEADERSIZE + 175, 35, "E01OBS");
    fields[27] = fieldE01FL1 =
    new CharacterField(message, HEADERSIZE + 210, 1, "E01FL1");
    fields[28] = fieldE01FL2 =
    new CharacterField(message, HEADERSIZE + 211, 1, "E01FL2");
    fields[29] = fieldE01US1 =
    new CharacterField(message, HEADERSIZE + 212, 4, "E01US1");
    fields[30] = fieldE01US2 =
    new CharacterField(message, HEADERSIZE + 216, 4, "E01US2");
    fields[31] = fieldE01TSG =
    new CharacterField(message, HEADERSIZE + 220, 1, "E01TSG");
    fields[32] = fieldE01SG1 =
    new DecimalField(message, HEADERSIZE + 221, 10, 0, "E01SG1");
    fields[33] = fieldE01NM1 =
    new CharacterField(message, HEADERSIZE + 231, 45, "E01NM1");
    fields[34] = fieldE01CS1 =
    new CharacterField(message, HEADERSIZE + 276, 1, "E01CS1");
    fields[35] = fieldE01SG2 =
    new DecimalField(message, HEADERSIZE + 277, 10, 0, "E01SG2");
    fields[36] = fieldE01NM2 =
    new CharacterField(message, HEADERSIZE + 287, 45, "E01NM2");
    fields[37] = fieldE01CS2 =
    new CharacterField(message, HEADERSIZE + 332, 1, "E01CS2");
    fields[38] = fieldE01SG3 =
    new DecimalField(message, HEADERSIZE + 333, 10, 0, "E01SG3");
    fields[39] = fieldE01NM3 =
    new CharacterField(message, HEADERSIZE + 343, 45, "E01NM3");
    fields[40] = fieldE01CS3 =
    new CharacterField(message, HEADERSIZE + 388, 1, "E01CS3");
