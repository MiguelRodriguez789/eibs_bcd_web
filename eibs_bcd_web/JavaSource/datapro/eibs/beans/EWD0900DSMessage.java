...
* Record format level identifier is 4862AEA26D8B4.
*/
...
public class EWD0900DSMessage extends MessageRecord
{
  ...
  final static String rid = "4862AEA26D8B4";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 19, 45, "SWDNAM");
    fields[4] = fieldSWDNUM =
    new CharacterField(message, HEADERSIZE + 64, 6, "SWDNUM");
    fields[5] = fieldSWDFIL =
    new CharacterField(message, HEADERSIZE + 70, 45, "SWDFIL");
    fields[6] = fieldSWDPLN =
    new DecimalField(message, HEADERSIZE + 115, 7, 0, "SWDPLN");
    fields[7] = fieldSWDOUT =
    new CharacterField(message, HEADERSIZE + 122, 45, "SWDOUT");
    fields[8] = fieldSWDSRD =
    new CharacterField(message, HEADERSIZE + 167, 10, "SWDSRD");
    fields[9] = fieldSWDSTS =
    new CharacterField(message, HEADERSIZE + 177, 45, "SWDSTS");
    fields[10] = fieldSWDPAG =
    new DecimalField(message, HEADERSIZE + 222, 7, 0, "SWDPAG");
    fields[11] = fieldSWDDAT =
    new CharacterField(message, HEADERSIZE + 229, 10, "SWDDAT");
    fields[12] = fieldSWDTIM =
    new CharacterField(message, HEADERSIZE + 239, 8, "SWDTIM");
    fields[13] = fieldSWDPTH =
    new CharacterField(message, HEADERSIZE + 247, 132, "SWDPTH");
    fields[14] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 379, 8, 0, "SWDREC");
    fields[15] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 387, 1, "SWDOPE");
