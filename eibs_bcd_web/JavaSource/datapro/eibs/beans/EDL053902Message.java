...
/**
* Class generated by AS/400 CRTCLASS command from EDL053902 physical file definition.
* 
* File level identifier is 1180523174619.
* Record format level identifier is 42748CB8664D9.
*/

public class EDL053902Message extends MessageRecord
{
  ...
  final static String fid = "1180523174619";
  final static String rid = "42748CB8664D9";
  final static String fmtname = "EDL053902";
  ...
  /**
  * Constructor for EDL053902Message.
  */
  public EDL053902Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[11] = fieldE02MODALI =
    new CharacterField(message, HEADERSIZE + 65, 1, "E02MODALI");
    fields[12] = fieldE02ACTION =
    new CharacterField(message, HEADERSIZE + 66, 1, "E02ACTION");
    fields[13] = fieldE02MSGTXT =
    new CharacterField(message, HEADERSIZE + 67, 512, "E02MSGTXT");
