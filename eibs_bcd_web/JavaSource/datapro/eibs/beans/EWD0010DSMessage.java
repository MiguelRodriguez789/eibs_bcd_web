...
* 
* File level identifier is 1151005060630.
* Record format level identifier is 3C9816392E350.
*/
...
public class EWD0010DSMessage extends MessageRecord
{
  ...
  final static String fid = "1151005060630";
  final static String rid = "3C9816392E350";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 50, 60, "EWDDSC");
    fields[9] = fieldEWDCLS =
    new DecimalField(message, HEADERSIZE + 110, 3, 0, "EWDCLS");
    fields[10] = fieldEWDATY =
    new CharacterField(message, HEADERSIZE + 113, 4, "EWDATY");
    fields[11] = fieldEWDACD =
    new CharacterField(message, HEADERSIZE + 117, 2, "EWDACD");
