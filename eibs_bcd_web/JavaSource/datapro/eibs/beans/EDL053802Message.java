...
/**
* Class generated by AS/400 CRTCLASS command from EDL053802 physical file definition.
* 
* File level identifier is 1171006143027.
* Record format level identifier is 4AE1E5E77EE1D.
*/

public class EDL053802Message extends MessageRecord
{
  ...
  final static String fid = "1171006143027";
  final static String rid = "4AE1E5E77EE1D";
  final static String fmtname = "EDL053802";
  ...
  /**
  * Constructor for EDL053802Message.
  */
  public EDL053802Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[10] = fieldE02MODALI =
    new CharacterField(message, HEADERSIZE + 52, 1, "E02MODALI");
    fields[11] = fieldE02ACTION =
    new CharacterField(message, HEADERSIZE + 53, 1, "E02ACTION");
    fields[12] = fieldE02MSGTXT =
    new CharacterField(message, HEADERSIZE + 54, 512, "E02MSGTXT");
