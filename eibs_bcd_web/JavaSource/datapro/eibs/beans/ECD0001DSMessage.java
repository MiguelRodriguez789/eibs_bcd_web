...
* Record format level identifier is 399E7DF026B73.
*/
...
public class ECD0001DSMessage extends MessageRecord
{
  ...
  final static String rid = "399E7DF026B73";
  ...
  private CharacterField fieldE01CDRTIM = null;
  private CharacterField fieldE01CDRSTS = null;
  private CharacterField fieldE01CDRSTD = null;
  private CharacterField fieldE01CDRBND = null;
  ...
  private CharacterField fieldE01CDRTIR = null;
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 126, 5, 0, "E01CDRYEA");
    fields[18] = fieldE01CDRTIM =
    new CharacterField(message, HEADERSIZE + 131, 26, "E01CDRTIM");
    fields[19] = fieldE01CDRSTS =
    new CharacterField(message, HEADERSIZE + 157, 4, "E01CDRSTS");
    fields[20] = fieldE01CDRSTD =
    new CharacterField(message, HEADERSIZE + 161, 45, "E01CDRSTD");
    fields[21] = fieldE01CDRBND =
    new CharacterField(message, HEADERSIZE + 206, 2, "E01CDRBND");
    fields[22] = fieldE01CDRBRD =
    new DecimalField(message, HEADERSIZE + 208, 5, 0, "E01CDRBRD");
    fields[23] = fieldE01CDRRUS =
    new CharacterField(message, HEADERSIZE + 213, 10, "E01CDRRUS");
    fields[24] = fieldE01CDRREQ =
    new DecimalField(message, HEADERSIZE + 223, 7, 0, "E01CDRREQ");
    fields[25] = fieldE01CDRDAR =
    new DecimalField(message, HEADERSIZE + 230, 3, 0, "E01CDRDAR");
    fields[26] = fieldE01CDRMOR =
    new DecimalField(message, HEADERSIZE + 233, 3, 0, "E01CDRMOR");
    fields[27] = fieldE01CDRYER =
    new DecimalField(message, HEADERSIZE + 236, 5, 0, "E01CDRYER");
    fields[28] = fieldE01CDRTIR =
    new CharacterField(message, HEADERSIZE + 241, 26, "E01CDRTIR");
    fields[29] = fieldE01CDRVEN =
    new DecimalField(message, HEADERSIZE + 267, 10, 0, "E01CDRVEN");
    fields[30] = fieldE01CDRNAM =
    new CharacterField(message, HEADERSIZE + 277, 45, "E01CDRNAM");
    fields[31] = fieldE01CDRMOX =
    new DecimalField(message, HEADERSIZE + 322, 3, 0, "E01CDRMOX");
    fields[32] = fieldE01CDRYEX =
    new DecimalField(message, HEADERSIZE + 325, 5, 0, "E01CDRYEX");
    fields[33] = fieldE01CDRFLG =
    new CharacterField(message, HEADERSIZE + 330, 1, "E01CDRFLG");
    fields[34] = fieldE01NUMREG =
    new DecimalField(message, HEADERSIZE + 331, 7, 0, "E01NUMREG");
