...
* 
* File level identifier is 1130718181939.
* Record format level identifier is 3F1173E5D074A.
*/
...
public class ESD080001Message extends MessageRecord
{
  ...
  final static String fid = "1130718181939";
  final static String rid = "3F1173E5D074A";
  ...
  */
  protected void createFields()
  {
    ...
    fields[11] = fieldE01CUSTID =
    new CharacterField(message, HEADERSIZE + 77, 4, "E01CUSTID");
    fields[12] = fieldE01CUSPID =
    new CharacterField(message, HEADERSIZE + 81, 4, "E01CUSPID");
    fields[13] = fieldE01CUSOFC =
    new CharacterField(message, HEADERSIZE + 85, 4, "E01CUSOFC");
    fields[14] = fieldE01CUSUC5 =
    new CharacterField(message, HEADERSIZE + 89, 4, "E01CUSUC5");
    fields[15] = fieldE01CUSNA1 =
    new CharacterField(message, HEADERSIZE + 93, 60, "E01CUSNA1");
    fields[16] = fieldE01CUSSOF =
    new DecimalField(message, HEADERSIZE + 153, 5, 0, "E01CUSSOF");
    fields[17] = fieldE01CUSNOF =
    new CharacterField(message, HEADERSIZE + 158, 45, "E01CUSNOF");
    fields[18] = fieldE01RELBAN =
    new CharacterField(message, HEADERSIZE + 203, 45, "E01RELBAN");
    fields[19] = fieldE01LISTNE =
    new CharacterField(message, HEADERSIZE + 248, 1, "E01LISTNE");
    fields[20] = fieldE01ACCNUM =
    new DecimalField(message, HEADERSIZE + 249, 13, 0, "E01ACCNUM");
