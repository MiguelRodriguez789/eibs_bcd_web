...
* Record format level identifier is 2F761D1300ED5.
*/
...
public class ESD094001Message extends MessageRecord
{
  ...
  final static String rid = "2F761D1300ED5";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 166, 45, "E01CUSNA1");
    fields[27] = fieldE01PRDDSC =
    new CharacterField(message, HEADERSIZE + 211, 45, "E01PRDDSC");
    fields[28] = fieldE01MODDSC =
    new CharacterField(message, HEADERSIZE + 256, 45, "E01MODDSC");
    fields[29] = fieldE01CHGOBR =
    new DecimalField(message, HEADERSIZE + 301, 5, 0, "E01CHGOBR");
    fields[30] = fieldE01CHGNBR =
    new DecimalField(message, HEADERSIZE + 306, 5, 0, "E01CHGNBR");
    fields[31] = fieldE01CHGOFC =
    new CharacterField(message, HEADERSIZE + 311, 4, "E01CHGOFC");
    fields[32] = fieldE01CHGNFC =
    new CharacterField(message, HEADERSIZE + 315, 4, "E01CHGNFC");
    fields[33] = fieldE01OLDBRN =
    new CharacterField(message, HEADERSIZE + 319, 45, "E01OLDBRN");
    fields[34] = fieldE01NEWBRN =
    new CharacterField(message, HEADERSIZE + 364, 45, "E01NEWBRN");
    fields[35] = fieldE01OLDGLD =
    new CharacterField(message, HEADERSIZE + 409, 45, "E01OLDGLD");
    fields[36] = fieldE01NEWGLD =
    new CharacterField(message, HEADERSIZE + 454, 45, "E01NEWGLD");
    fields[37] = fieldE01OLDOFN =
    new CharacterField(message, HEADERSIZE + 499, 45, "E01OLDOFN");
    fields[38] = fieldE01NEWOFN =
    new CharacterField(message, HEADERSIZE + 544, 45, "E01NEWOFN");
    fields[39] = fieldE01NEWPRD =
    new CharacterField(message, HEADERSIZE + 589, 45, "E01NEWPRD");
    fields[40] = fieldE01NEWMDS =
    new CharacterField(message, HEADERSIZE + 634, 45, "E01NEWMDS");
    fields[41] = fieldE01CHGTYP =
    new CharacterField(message, HEADERSIZE + 679, 1, "E01CHGTYP");
    fields[42] = fieldE01TYPDSC =
    new CharacterField(message, HEADERSIZE + 680, 45, "E01TYPDSC");
    fields[43] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 725, 1, "E01OPECDE");
