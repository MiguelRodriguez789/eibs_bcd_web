...
/**
* Class generated by AS/400 CRTCLASS command from EWD0109DS physical file definition.
* 
* File level identifier is 1130611113449.
* Record format level identifier is 47801D044C339.
*/

public class EWD0109DSMessage extends MessageRecord
{
  ...
  final static String rid = "47801D044C339";
  final static String fmtname = "EWD0109DS";
  ...
  /**
  * Constructor for EWD0109DSMessage.
  */
  public EWD0109DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 14, 60, "EWDDSC");
    fields[6] = fieldEWDAMT =
    new DecimalField(message, HEADERSIZE + 74, 17, 2, "EWDAMT");
    fields[7] = fieldEWDCUN =
    new DecimalField(message, HEADERSIZE + 91, 10, 0, "EWDCUN");
    fields[8] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 101, 1, "EWDOPE");
