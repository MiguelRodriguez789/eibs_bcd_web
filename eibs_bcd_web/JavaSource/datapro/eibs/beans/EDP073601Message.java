...
/**
* Class generated by AS/400 CRTCLASS command from EDP073601 physical file definition.
* 
* File level identifier is 1130611113113.
* Record format level identifier is 4C089D2EBC9E0.
*/

public class EDP073601Message extends MessageRecord
{
  ...
  final static String rid = "4C089D2EBC9E0";
  final static String fmtname = "EDP073601";
  ...
  /**
  * Constructor for EDP073601Message.
  */
  public EDP073601Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[10] = fieldE01CNOCFL =
    new CharacterField(message, HEADERSIZE + 43, 2, "E01CNOCFL");
    fields[11] = fieldE01CNORCD =
    new CharacterField(message, HEADERSIZE + 45, 4, "E01CNORCD");
    fields[12] = fieldE01CNODSC =
    new CharacterField(message, HEADERSIZE + 49, 45, "E01CNODSC");
    fields[13] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 94, 1, "E01OPECDE");
