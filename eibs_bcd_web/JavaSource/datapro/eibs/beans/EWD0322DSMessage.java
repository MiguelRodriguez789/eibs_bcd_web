...
* 
* File level identifier is 1160914161101.
* Record format level identifier is 4C2066CFF5659.
*/
...
public class EWD0322DSMessage extends MessageRecord
{
  ...
  final static String fid = "1160914161101";
  final static String rid = "4C2066CFF5659";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 29, 60, "SWDDSC");
    fields[5] = fieldSWDVA1 =
    new DecimalField(message, HEADERSIZE + 89, 3, 0, "SWDVA1");
    fields[6] = fieldSWDVA2 =
    new DecimalField(message, HEADERSIZE + 92, 3, 0, "SWDVA2");
    fields[7] = fieldSWDVA3 =
    new DecimalField(message, HEADERSIZE + 95, 5, 0, "SWDVA3");
    fields[8] = fieldSWDCCY =
    new CharacterField(message, HEADERSIZE + 100, 3, "SWDCCY");
    fields[9] = fieldSWDTYL =
    new CharacterField(message, HEADERSIZE + 103, 4, "SWDTYL");
    fields[10] = fieldSWDAMN =
    new DecimalField(message, HEADERSIZE + 107, 17, 2, "SWDAMN");
    fields[11] = fieldSWDAMU =
    new DecimalField(message, HEADERSIZE + 124, 17, 2, "SWDAMU");
    fields[12] = fieldSWDAMA =
    new DecimalField(message, HEADERSIZE + 141, 17, 2, "SWDAMA");
    fields[13] = fieldSWDTYP =
    new CharacterField(message, HEADERSIZE + 158, 4, "SWDTYP");
    fields[14] = fieldSWDDID =
    new CharacterField(message, HEADERSIZE + 162, 10, "SWDDID");
    fields[15] = fieldSWDREF =
    new CharacterField(message, HEADERSIZE + 172, 20, "SWDREF");
    fields[16] = fieldSWDEQV =
    new DecimalField(message, HEADERSIZE + 192, 17, 2, "SWDEQV");
    fields[17] = fieldSWDSTS =
    new CharacterField(message, HEADERSIZE + 209, 45, "SWDSTS");
    fields[18] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 254, 8, 0, "SWDREC");
    fields[19] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 262, 1, "SWDOPE");
