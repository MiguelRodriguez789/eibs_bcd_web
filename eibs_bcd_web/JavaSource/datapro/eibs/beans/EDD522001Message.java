...
* Record format level identifier is 5628CCCBC561B.
*/
...
public class EDD522001Message extends MessageRecord
{
  ...
  final static String rid = "5628CCCBC561B";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 78, 5, 0, "E01CFMBRN");
    fields[14] = fieldE01CFMCCY =
    new CharacterField(message, HEADERSIZE + 83, 3, "E01CFMCCY");
    fields[15] = fieldE01CFMGLN =
    new DecimalField(message, HEADERSIZE + 86, 17, 0, "E01CFMGLN");
    fields[16] = fieldE01CFMCRE =
    new DecimalField(message, HEADERSIZE + 103, 13, 0, "E01CFMCRE");
    fields[17] = fieldE01CFMVAL =
    new DecimalField(message, HEADERSIZE + 116, 13, 0, "E01CFMVAL");
    fields[18] = fieldE01CFMFRE =
    new CharacterField(message, HEADERSIZE + 129, 1, "E01CFMFRE");
    fields[19] = fieldE01CFMFPD =
    new DecimalField(message, HEADERSIZE + 130, 3, 0, "E01CFMFPD");
    fields[20] = fieldE01CFMFPM =
    new DecimalField(message, HEADERSIZE + 133, 3, 0, "E01CFMFPM");
    fields[21] = fieldE01CFMFPA =
    new DecimalField(message, HEADERSIZE + 136, 5, 0, "E01CFMFPA");
    fields[22] = fieldE01CFMUC1 =
    new CharacterField(message, HEADERSIZE + 141, 4, "E01CFMUC1");
    fields[23] = fieldE01CFMUC2 =
    new CharacterField(message, HEADERSIZE + 145, 4, "E01CFMUC2");
    fields[24] = fieldE01CFMATP =
    new CharacterField(message, HEADERSIZE + 149, 1, "E01CFMATP");
    fields[25] = fieldE01CFMIVA =
    new CharacterField(message, HEADERSIZE + 150, 1, "E01CFMIVA");
    fields[26] = fieldE01CFMFI1 =
    new CharacterField(message, HEADERSIZE + 151, 2, "E01CFMFI1");
    fields[27] = fieldE01DESCAR =
    new CharacterField(message, HEADERSIZE + 153, 45, "E01DESCAR");
