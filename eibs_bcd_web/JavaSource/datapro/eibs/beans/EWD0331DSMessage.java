...
* 
* File level identifier is 1160915171933.
* Record format level identifier is 50A675D6A5285.
*/
...
public class EWD0331DSMessage extends MessageRecord
{
  ...
  final static String fid = "1160915171933";
  final static String rid = "50A675D6A5285";
  ...
  */
  protected void createFields()
  {
    ...
    fields[9] = fieldSWDACD =
    new CharacterField(message, HEADERSIZE + 50, 2, "SWDACD");
    fields[10] = fieldSWDSTS =
    new CharacterField(message, HEADERSIZE + 52, 1, "SWDSTS");
    fields[11] = fieldSWDTRA =
    new DecimalField(message, HEADERSIZE + 53, 9, 0, "SWDTRA");
    fields[12] = fieldSWDVAL =
    new DecimalField(message, HEADERSIZE + 62, 9, 0, "SWDVAL");
    fields[13] = fieldSWDMAT =
    new DecimalField(message, HEADERSIZE + 71, 9, 0, "SWDMAT");
    fields[14] = fieldSWDCUN =
    new DecimalField(message, HEADERSIZE + 80, 10, 0, "SWDCUN");
    fields[15] = fieldSWDOAM =
    new DecimalField(message, HEADERSIZE + 90, 17, 2, "SWDOAM");
    fields[16] = fieldSWDUSR =
    new CharacterField(message, HEADERSIZE + 107, 10, "SWDUSR");
    fields[17] = fieldSWDDSC =
    new CharacterField(message, HEADERSIZE + 117, 60, "SWDDSC");
