...
* Record format level identifier is 31E6AB31E83B4.
*/
...
public class ESS003002Message extends MessageRecord
{
  ...
  final static String rid = "31E6AB31E83B4";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 42, 64, "E02APW");
    fields[10] = fieldE02PSW =
    new CharacterField(message, HEADERSIZE + 106, 64, "E02PSW");
    fields[11] = fieldE02APS =
    new CharacterField(message, HEADERSIZE + 170, 64, "E02APS");
    fields[12] = fieldE02PSE =
    new CharacterField(message, HEADERSIZE + 234, 64, "E02PSE");
    fields[13] = fieldE02OPR =
    new CharacterField(message, HEADERSIZE + 298, 1, "E02OPR");
