...
* Record format level identifier is 3FAE4F7CEE668.
*/
...
public class EDD117001Message extends MessageRecord
{
  ...
  final static String rid = "3FAE4F7CEE668";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 46, 60, "E01DESTYP");
    fields[11] = fieldE01ACMUC3 =
    new CharacterField(message, HEADERSIZE + 106, 4, "E01ACMUC3");
    fields[12] = fieldE01DESUCS =
    new CharacterField(message, HEADERSIZE + 110, 60, "E01DESUCS");
    fields[13] = fieldE01ACMBRN =
    new DecimalField(message, HEADERSIZE + 170, 5, 0, "E01ACMBRN");
    fields[14] = fieldE01DESBRN =
    new CharacterField(message, HEADERSIZE + 175, 60, "E01DESBRN");
    fields[15] = fieldE01PAGOGL =
    new DecimalField(message, HEADERSIZE + 235, 17, 0, "E01PAGOGL");
    fields[16] = fieldE01PAGOCN =
    new DecimalField(message, HEADERSIZE + 252, 9, 0, "E01PAGOCN");
    fields[17] = fieldE01CANRSN =
    new CharacterField(message, HEADERSIZE + 261, 4, "E01CANRSN");
    fields[18] = fieldE01CANDSC =
    new CharacterField(message, HEADERSIZE + 265, 60, "E01CANDSC");
    fields[19] = fieldE01ACMREF =
    new CharacterField(message, HEADERSIZE + 325, 22, "E01ACMREF");
    fields[20] = fieldE01ACCCKF =
    new CharacterField(message, HEADERSIZE + 347, 1, "E01ACCCKF");
