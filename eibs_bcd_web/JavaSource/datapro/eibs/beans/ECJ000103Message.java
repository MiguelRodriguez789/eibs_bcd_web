...
/**
* Class generated by AS/400 CRTCLASS command from ECJ000103 physical file definition.
* 
* File level identifier is 1100706173535.
* Record format level identifier is 477081ADC4CAF.
*/

public class ECJ000103Message extends MessageRecord
{
  ...
  final static String rid = "477081ADC4CAF";
  final static String fmtname = "ECJ000103";
  ...
  private CharacterField fieldCMOTYP = null;
  ...
  private CharacterField fieldCMOTPR = null;
  private CharacterField fieldCMOCDO = null;
  private CharacterField fieldCMORZO = null;
  private DecimalField fieldCMOTND = null;
  private DecimalField fieldCMOTMD = null;
  private DecimalField fieldCMOTDG = null;
  private DecimalField fieldCMOTDF = null;

  /**
  * Constructor for ECJ000103Message.
  */
  public ECJ000103Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[11] = fieldCMOTBR =
    new DecimalField(message, HEADERSIZE + 79, 4, 0, "CMOTBR");
    fields[12] = fieldBRNNME =
    new CharacterField(message, HEADERSIZE + 83, 35, "BRNNME");
    fields[13] = fieldCMOTLC =
    new CharacterField(message, HEADERSIZE + 118, 4, "CMOTLC");
    fields[14] = fieldCMOTLR =
    new CharacterField(message, HEADERSIZE + 122, 7, "CMOTLR");
    fields[15] = fieldCMOTCY =
    new CharacterField(message, HEADERSIZE + 129, 3, "CMOTCY");
    fields[16] = fieldCMORFN =
    new DecimalField(message, HEADERSIZE + 132, 9, 0, "CMORFN");
    fields[17] = fieldCMOACD =
    new DecimalField(message, HEADERSIZE + 141, 13, 0, "CMOACD");
    fields[18] = fieldCMOCKN =
    new DecimalField(message, HEADERSIZE + 154, 10, 0, "CMOCKN");
    fields[19] = fieldCMOAMT =
    new DecimalField(message, HEADERSIZE + 164, 17, 2, "CMOAMT");
    fields[20] = fieldCMOBRM =
    new CharacterField(message, HEADERSIZE + 181, 4, "CMOBRM");
    fields[21] = fieldCMOSRM =
    new CharacterField(message, HEADERSIZE + 185, 4, "CMOSRM");
    fields[22] = fieldCMOACC =
    new DecimalField(message, HEADERSIZE + 189, 13, 0, "CMOACC");
    fields[23] = fieldCMOTYP =
    new CharacterField(message, HEADERSIZE + 202, 1, "CMOTYP");
    fields[24] = fieldCMOCAU =
    new CharacterField(message, HEADERSIZE + 203, 4, "CMOCAU");
    fields[25] = fieldCMOOBS =
    new CharacterField(message, HEADERSIZE + 207, 30, "CMOOBS");
    fields[26] = fieldCMOACR =
    new DecimalField(message, HEADERSIZE + 237, 13, 0, "CMOACR");
    fields[27] = fieldCMOBTH =
    new DecimalField(message, HEADERSIZE + 250, 5, 0, "CMOBTH");
    fields[28] = fieldCMOSEQ =
    new DecimalField(message, HEADERSIZE + 255, 5, 0, "CMOSEQ");
    fields[29] = fieldCMORCY =
    new DecimalField(message, HEADERSIZE + 260, 2, 0, "CMORCY");
    fields[30] = fieldCMORDY =
    new DecimalField(message, HEADERSIZE + 262, 3, 0, "CMORDY");
    fields[31] = fieldCMORDM =
    new DecimalField(message, HEADERSIZE + 265, 3, 0, "CMORDM");
    fields[32] = fieldCMORDD =
    new DecimalField(message, HEADERSIZE + 268, 3, 0, "CMORDD");
    fields[33] = fieldCMOTIM =
    new DecimalField(message, HEADERSIZE + 271, 7, 0, "CMOTIM");
    fields[34] = fieldCMORTL =
    new CharacterField(message, HEADERSIZE + 278, 4, "CMORTL");
    fields[35] = fieldCMODAY =
    new DecimalField(message, HEADERSIZE + 282, 4, 0, "CMODAY");
    fields[36] = fieldCMOSTS =
    new CharacterField(message, HEADERSIZE + 286, 1, "CMOSTS");
    fields[37] = fieldCMORFD =
    new DecimalField(message, HEADERSIZE + 287, 9, 0, "CMORFD");
    fields[38] = fieldCMOTPR =
    new CharacterField(message, HEADERSIZE + 296, 1, "CMOTPR");
    fields[39] = fieldCMOCDO =
    new CharacterField(message, HEADERSIZE + 297, 1, "CMOCDO");
    fields[40] = fieldCMORZO =
    new CharacterField(message, HEADERSIZE + 298, 6, "CMORZO");
    fields[41] = fieldCMOTND =
    new DecimalField(message, HEADERSIZE + 304, 10, 0, "CMOTND");
    fields[42] = fieldCMOTMD =
    new DecimalField(message, HEADERSIZE + 314, 17, 2, "CMOTMD");
    fields[43] = fieldCMOTDG =
    new DecimalField(message, HEADERSIZE + 331, 17, 2, "CMOTDG");
    fields[44] = fieldCMOTDF =
    new DecimalField(message, HEADERSIZE + 348, 17, 2, "CMOTDF");
  ...
  */
  ...
  /**
  * Set field CMOTYP using a String value.
  */
  public void setCMOTYP(String newvalue)
  {
    fieldCMOTYP.setString(newvalue);
  }

  /**
  * Get value of field CMOTYP as a String.
  */
  public String getCMOTYP()
  {
    return fieldCMOTYP.getString();
  }
  ...
  */
  ...
  /**
  * Set field CMOTPR using a String value.
  */
  public void setCMOTPR(String newvalue)
  {
    fieldCMOTPR.setString(newvalue);
  }

  /**
  * Get value of field CMOTPR as a String.
  */
  public String getCMOTPR()
  {
    return fieldCMOTPR.getString();
  }
  ...
  */
  ...
  /**
  * Set field CMORZO using a String value.
  */
  public void setCMORZO(String newvalue)
  {
    fieldCMORZO.setString(newvalue);
  }

  /**
  * Get value of field CMORZO as a String.
  */
  public String getCMORZO()
  {
    return fieldCMORZO.getString();
  }

  /**
  * Set field CMOTND using a String value.
  */
  public void setCMOTND(String newvalue)
  {
    fieldCMOTND.setString(newvalue);
  }

  /**
  * Get value of field CMOTND as a String.
  */
  public String getCMOTND()
  {
    return fieldCMOTND.getString();
  }

  /**
  * Set numeric field CMOTND using a BigDecimal value.
  */
  public void setCMOTND(BigDecimal newvalue)
  {
    fieldCMOTND.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field CMOTND as a BigDecimal.
  */
  public BigDecimal getBigDecimalCMOTND()
  {
    return fieldCMOTND.getBigDecimal();
  }
