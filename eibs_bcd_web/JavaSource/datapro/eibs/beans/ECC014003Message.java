...
* Record format level identifier is 3BC23536A0103.
*/
...
public class ECC014003Message extends MessageRecord
{
  ...
  final static String rid = "3BC23536A0103";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 127, 4, "E03CCMPRO");
    fields[14] = fieldE03CCMCCY =
    new CharacterField(message, HEADERSIZE + 131, 3, "E03CCMCCY");
    fields[15] = fieldE03CCMAMT =
    new DecimalField(message, HEADERSIZE + 134, 17, 2, "E03CCMAMT");
    fields[16] = fieldE03CCMUBT =
    new DecimalField(message, HEADERSIZE + 151, 6, 0, "E03CCMUBT");
    fields[17] = fieldE03CCMUSR =
    new CharacterField(message, HEADERSIZE + 157, 10, "E03CCMUSR");
    fields[18] = fieldE03CCMRMK =
    new CharacterField(message, HEADERSIZE + 167, 60, "E03CCMRMK");
    fields[19] = fieldE03CCMOPM =
    new DecimalField(message, HEADERSIZE + 227, 3, 0, "E03CCMOPM");
    fields[20] = fieldE03CCMOPD =
    new DecimalField(message, HEADERSIZE + 230, 3, 0, "E03CCMOPD");
    fields[21] = fieldE03CCMOPY =
    new DecimalField(message, HEADERSIZE + 233, 5, 0, "E03CCMOPY");
    fields[22] = fieldE03CCMEXM =
    new DecimalField(message, HEADERSIZE + 238, 3, 0, "E03CCMEXM");
    fields[23] = fieldE03CCMEXD =
    new DecimalField(message, HEADERSIZE + 241, 3, 0, "E03CCMEXD");
    fields[24] = fieldE03CCMEXY =
    new DecimalField(message, HEADERSIZE + 244, 5, 0, "E03CCMEXY");
    fields[25] = fieldE03CCMNUM =
    new CharacterField(message, HEADERSIZE + 249, 20, "E03CCMNUM");
