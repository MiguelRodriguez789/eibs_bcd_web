...
* Record format level identifier is 4C46A922F86E1.
*/
...
public class EWD0155DSMessage extends MessageRecord
{
  ...
  final static String rid = "4C46A922F86E1";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 14, 60, "EWDTIT");
    fields[3] = fieldEWDUSR =
    new CharacterField(message, HEADERSIZE + 74, 10, "EWDUSR");
    fields[4] = fieldEWDDT1 =
    new DecimalField(message, HEADERSIZE + 84, 3, 0, "EWDDT1");
    fields[5] = fieldEWDDT2 =
    new DecimalField(message, HEADERSIZE + 87, 3, 0, "EWDDT2");
    fields[6] = fieldEWDDT3 =
    new DecimalField(message, HEADERSIZE + 90, 5, 0, "EWDDT3");
    fields[7] = fieldEWDTIM =
    new DecimalField(message, HEADERSIZE + 95, 7, 0, "EWDTIM");
    fields[8] = fieldEWDREC =
    new DecimalField(message, HEADERSIZE + 102, 8, 0, "EWDREC");
    fields[9] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 110, 1, "EWDOPE");
