...
/**
* Class generated by AS/400 CRTCLASS command from EFRMLDMDSM physical file definition.
* 
* File level identifier is 1100706173614.
* Record format level identifier is 4C10595619E7F.
*/

public class EFRMLDMDSMMessage extends MessageRecord
{
  ...
  final static String fid = "1100706173614";
  final static String rid = "4C10595619E7F";
  final static String fmtname = "EFRMLDMDSM";
  ...
  /**
  * Constructor for EFRMLDMDSMMessage.
  */
  public EFRMLDMDSMMessage()
  {
    createFields();
    initialize();
  }
