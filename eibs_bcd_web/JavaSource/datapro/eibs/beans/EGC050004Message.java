...
* Record format level identifier is 3E9CBA1947CD3.
*/
...
public class EGC050004Message extends MessageRecord
{
  ...
  final static String rid = "3E9CBA1947CD3";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 46, 25, "E04GCRUT");
    fields[11] = fieldE04GCNMBC =
    new CharacterField(message, HEADERSIZE + 71, 45, "E04GCNMBC");
    fields[12] = fieldE04GCGMDA =
    new CharacterField(message, HEADERSIZE + 116, 3, "E04GCGMDA");
    fields[13] = fieldE04GCACNO =
    new DecimalField(message, HEADERSIZE + 119, 13, 0, "E04GCACNO");
    fields[14] = fieldE04GCSCPT =
    new DecimalField(message, HEADERSIZE + 132, 17, 2, "E04GCSCPT");
    fields[15] = fieldE04GCSDPT =
    new DecimalField(message, HEADERSIZE + 149, 17, 2, "E04GCSDPT");
    fields[16] = fieldE04GCSNPT =
    new DecimalField(message, HEADERSIZE + 166, 17, 2, "E04GCSNPT");
    fields[17] = fieldE04GCSDPU =
    new DecimalField(message, HEADERSIZE + 183, 17, 2, "E04GCSDPU");
    fields[18] = fieldE04GCSCPU =
    new DecimalField(message, HEADERSIZE + 200, 17, 2, "E04GCSCPU");
    fields[19] = fieldE04GCTINT =
    new DecimalField(message, HEADERSIZE + 217, 13, 6, "E04GCTINT");
    fields[20] = fieldE04GCGPER =
    new DecimalField(message, HEADERSIZE + 230, 6, 0, "E04GCGPER");
    fields[21] = fieldE04GCGEFE =
    new DecimalField(message, HEADERSIZE + 236, 6, 0, "E04GCGEFE");
    fields[22] = fieldE04GCCAPY =
    new DecimalField(message, HEADERSIZE + 242, 5, 0, "E04GCCAPY");
    fields[23] = fieldE04GCCAPM =
    new DecimalField(message, HEADERSIZE + 247, 3, 0, "E04GCCAPM");
    fields[24] = fieldE04GCCAPD =
    new DecimalField(message, HEADERSIZE + 250, 3, 0, "E04GCCAPD");
    fields[25] = fieldE04GCAPRY =
    new DecimalField(message, HEADERSIZE + 253, 5, 0, "E04GCAPRY");
    fields[26] = fieldE04GCAPRM =
    new DecimalField(message, HEADERSIZE + 258, 3, 0, "E04GCAPRM");
    fields[27] = fieldE04GCAPRD =
    new DecimalField(message, HEADERSIZE + 261, 3, 0, "E04GCAPRD");
    fields[28] = fieldE04INDOPE =
    new CharacterField(message, HEADERSIZE + 264, 1, "E04INDOPE");
