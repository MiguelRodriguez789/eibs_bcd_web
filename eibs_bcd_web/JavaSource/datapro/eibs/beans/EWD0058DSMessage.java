...
/**
* Class generated by AS/400 CRTCLASS command from EWD0058DS physical file definition.
* 
* File level identifier is 1150507162351.
* Record format level identifier is 5320281659E96.
*/

public class EWD0058DSMessage extends MessageRecord
{
  ...
  final static String fid = "1150507162351";
  final static String rid = "5320281659E96";
  final static String fmtname = "EWD0058DS";
  ...
  /**
  * Constructor for EWD0058DSMessage.
  */
  public EWD0058DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 12, 60, "EWDDSC");
    fields[5] = fieldEWDCUN =
    new DecimalField(message, HEADERSIZE + 72, 10, 0, "EWDCUN");
    fields[6] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 82, 1, "EWDOPE");
