...
* Record format level identifier is 4A48100054FA5.
*/
...
public class EGL059001Message extends MessageRecord
{
  ...
  final static String rid = "4A48100054FA5";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 64, 45, "E01GLMDSC");
    fields[13] = fieldE01GLMIBF =
    new CharacterField(message, HEADERSIZE + 109, 2, "E01GLMIBF");
    fields[14] = fieldE01GLMATY =
    new CharacterField(message, HEADERSIZE + 111, 4, "E01GLMATY");
    fields[15] = fieldE01GLMBBL =
    new DecimalField(message, HEADERSIZE + 115, 21, 2, "E01GLMBBL");
