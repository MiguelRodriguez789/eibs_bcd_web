...
* Record format level identifier is 31552519F4E75.
*/
...
public class EWD0040DSMessage extends MessageRecord
{
  ...
  final static String rid = "31552519F4E75";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 0, 13, 0, "EWDDRR");
    fields[1] = fieldEWDSEQ =
    new DecimalField(message, HEADERSIZE + 13, 3, 0, "EWDSEQ");
    fields[2] = fieldEWDNAR =
    new CharacterField(message, HEADERSIZE + 16, 60, "EWDNAR");
