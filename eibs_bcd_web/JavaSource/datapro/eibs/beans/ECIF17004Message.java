...
* Record format level identifier is 30364081732D0.
*/
...
public class ECIF17004Message extends MessageRecord
{
  ...
  final static String rid = "30364081732D0";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 46, 45, "E04OFINME");
    fields[11] = fieldE04OFIEML =
    new CharacterField(message, HEADERSIZE + 91, 60, "E04OFIEML");
    fields[12] = fieldE04OFIPHN =
    new DecimalField(message, HEADERSIZE + 151, 16, 0, "E04OFIPHN");
    fields[13] = fieldE04OFIPXT =
    new DecimalField(message, HEADERSIZE + 167, 5, 0, "E04OFIPXT");
    fields[14] = fieldE04OFICCN =
    new DecimalField(message, HEADERSIZE + 172, 9, 0, "E04OFICCN");
    fields[15] = fieldE04CUSCUN =
    new DecimalField(message, HEADERSIZE + 181, 10, 0, "E04CUSCUN");
    fields[16] = fieldE04CUSNA1 =
    new CharacterField(message, HEADERSIZE + 191, 60, "E04CUSNA1");
    fields[17] = fieldE04CUSSTS =
    new CharacterField(message, HEADERSIZE + 251, 45, "E04CUSSTS");
    fields[18] = fieldE04APLCDE =
    new CharacterField(message, HEADERSIZE + 296, 2, "E04APLCDE");
    fields[19] = fieldE04FLGOPE =
    new CharacterField(message, HEADERSIZE + 298, 1, "E04FLGOPE");
    fields[20] = fieldE04CLSACC =
    new DecimalField(message, HEADERSIZE + 299, 3, 0, "E04CLSACC");
    fields[21] = fieldE04BNKNUM =
    new CharacterField(message, HEADERSIZE + 302, 2, "E04BNKNUM");
    fields[22] = fieldE04CCYCDE =
    new CharacterField(message, HEADERSIZE + 304, 3, "E04CCYCDE");
    fields[23] = fieldE04ACCTYP =
    new CharacterField(message, HEADERSIZE + 307, 4, "E04ACCTYP");
    fields[24] = fieldE04TYPDSC =
    new CharacterField(message, HEADERSIZE + 311, 45, "E04TYPDSC");
    fields[25] = fieldE04PROCDE =
    new CharacterField(message, HEADERSIZE + 356, 4, "E04PROCDE");
    fields[26] = fieldE04PRODSC =
    new CharacterField(message, HEADERSIZE + 360, 45, "E04PRODSC");
    fields[27] = fieldE04NUMOPE =
    new DecimalField(message, HEADERSIZE + 405, 4, 0, "E04NUMOPE");
    fields[28] = fieldE04BSEPRI =
    new DecimalField(message, HEADERSIZE + 409, 17, 2, "E04BSEPRI");
    fields[29] = fieldE04BSEINT =
    new DecimalField(message, HEADERSIZE + 426, 17, 2, "E04BSEINT");
    fields[30] = fieldE04BSEOTH =
    new DecimalField(message, HEADERSIZE + 443, 17, 2, "E04BSEOTH");
    fields[31] = fieldE04BSETOT =
    new DecimalField(message, HEADERSIZE + 460, 17, 2, "E04BSETOT");
    fields[32] = fieldE04INDOPE =
    new CharacterField(message, HEADERSIZE + 477, 1, "E04INDOPE");
