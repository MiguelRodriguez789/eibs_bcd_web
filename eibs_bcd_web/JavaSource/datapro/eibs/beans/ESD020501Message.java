...
* Record format level identifier is 30CB46BC0053C.
*/
...
public class ESD020501Message extends MessageRecord
{
  ...
  final static String rid = "30CB46BC0053C";
  ...
  private CharacterField fieldE01RTETAR = null;
  ...
  private CharacterField fieldE01RTELDT = null;
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 50, 2, "E01RTETAR");
    fields[13] = fieldE01RTECUN =
    new DecimalField(message, HEADERSIZE + 52, 10, 0, "E01RTECUN");
    fields[14] = fieldE01RTECCY =
    new CharacterField(message, HEADERSIZE + 62, 3, "E01RTECCY");
    fields[15] = fieldE01RTEDSC =
    new CharacterField(message, HEADERSIZE + 65, 45, "E01RTEDSC");
    fields[16] = fieldE01RTEFTL =
    new CharacterField(message, HEADERSIZE + 110, 2, "E01RTEFTL");
    fields[17] = fieldE01RTEFYL =
    new CharacterField(message, HEADERSIZE + 112, 2, "E01RTEFYL");
    fields[18] = fieldE01RTEFTA =
    new CharacterField(message, HEADERSIZE + 114, 2, "E01RTEFTA");
    fields[19] = fieldE01RTEFYA =
    new CharacterField(message, HEADERSIZE + 116, 2, "E01RTEFYA");
    fields[20] = fieldE01CDROPE =
    new CharacterField(message, HEADERSIZE + 118, 1, "E01CDROPE");
    fields[21] = fieldE01RTEUSR =
    new CharacterField(message, HEADERSIZE + 119, 10, "E01RTEUSR");
    fields[22] = fieldE01RTELDM =
    new DecimalField(message, HEADERSIZE + 129, 3, 0, "E01RTELDM");
    fields[23] = fieldE01RTELDD =
    new DecimalField(message, HEADERSIZE + 132, 3, 0, "E01RTELDD");
    fields[24] = fieldE01RTELDY =
    new DecimalField(message, HEADERSIZE + 135, 5, 0, "E01RTELDY");
    fields[25] = fieldE01RTELDT =
    new CharacterField(message, HEADERSIZE + 140, 26, "E01RTELDT");
