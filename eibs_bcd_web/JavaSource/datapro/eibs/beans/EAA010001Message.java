...
* Record format level identifier is 51B63F4ED27EC.
*/
...
public class EAA010001Message extends MessageRecord
{
  ...
  final static String rid = "51B63F4ED27EC";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 57, 4, "E01AACTRC");
    fields[13] = fieldE01AADESC =
    new CharacterField(message, HEADERSIZE + 61, 60, "E01AADESC");
    fields[14] = fieldE01AACCST =
    new DecimalField(message, HEADERSIZE + 121, 9, 3, "E01AACCST");
    fields[15] = fieldE01AACOPE =
    new CharacterField(message, HEADERSIZE + 130, 1, "E01AACOPE");
