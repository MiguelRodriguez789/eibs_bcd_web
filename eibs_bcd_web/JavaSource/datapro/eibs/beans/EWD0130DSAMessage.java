...
/**
* Class generated by AS/400 CRTCLASS command from EWD0130DSA physical file definition.
* 
* File level identifier is 1110211181232.
* Record format level identifier is 4B0D23FCEACD3.
*/

public class EWD0130DSAMessage extends MessageRecord
{
  ...
  final static String fid = "1110211181232";
  final static String rid = "4B0D23FCEACD3";
  final static String fmtname = "EWD0130DSA";
  ...
  /**
  * Constructor for EWD0130DSAMessage.
  */
  public EWD0130DSAMessage()
  {
    createFields();
    initialize();
  }
