...
/**
* Class generated by AS/400 CRTCLASS command from EWD0033DS physical file definition.
* 
* File level identifier is 1130611113448.
* Record format level identifier is 4F315C027F8FE.
*/

public class EWD0033DSMessage extends MessageRecord
{
  ...
  final static String rid = "4F315C027F8FE";
  final static String fmtname = "EWD0033DS";
  ...
  /**
  * Constructor for EWD0033DSMessage.
  */
  public EWD0033DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 5, 3, 0, "EWDDT1");
    fields[3] = fieldEWDDT2 =
    new DecimalField(message, HEADERSIZE + 8, 3, 0, "EWDDT2");
    fields[4] = fieldEWDDT3 =
    new DecimalField(message, HEADERSIZE + 11, 5, 0, "EWDDT3");
    fields[5] = fieldEWDSFL =
    new CharacterField(message, HEADERSIZE + 16, 1, "EWDSFL");
    fields[6] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 17, 1, "EWDOPE");
    fields[7] = fieldEWDDSC =
    new CharacterField(message, HEADERSIZE + 18, 45, "EWDDSC");
