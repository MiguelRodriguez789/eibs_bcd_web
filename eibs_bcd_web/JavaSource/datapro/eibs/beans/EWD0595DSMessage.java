...
/**
* Class generated by AS/400 CRTCLASS command from EWD0595DS physical file definition.
* 
* File level identifier is 1150120154422.
* Record format level identifier is 52275871CA839.
*/

public class EWD0595DSMessage extends MessageRecord
{
  ...
  final static String fid = "1150120154422";
  final static String rid = "52275871CA839";
  final static String fmtname = "EWD0595DS";
  ...
  /**
  * Constructor for EWD0595DSMessage.
  */
  public EWD0595DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 21, 3, "SWDTTP");
    fields[5] = fieldSWDDSC =
    new CharacterField(message, HEADERSIZE + 24, 45, "SWDDSC");
    fields[6] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 69, 8, 0, "SWDREC");
    fields[7] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 77, 1, "SWDOPE");
