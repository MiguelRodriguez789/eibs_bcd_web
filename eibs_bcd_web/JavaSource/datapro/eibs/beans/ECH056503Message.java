...
* 
* File level identifier is 1180515141513.
* Record format level identifier is 44411B85BB432.
*/
...
public class ECH056503Message extends MessageRecord
{
  ...
  final static String fid = "1180515141513";
  final static String rid = "44411B85BB432";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 72, 45, "E03CUSNA1");
    fields[14] = fieldE03CHPNO1 =
    new CharacterField(message, HEADERSIZE + 117, 45, "E03CHPNO1");
    fields[15] = fieldE03CHPNO2 =
    new CharacterField(message, HEADERSIZE + 162, 45, "E03CHPNO2");
    fields[16] = fieldE03CHPRE1 =
    new CharacterField(message, HEADERSIZE + 207, 1, "E03CHPRE1");
    fields[17] = fieldE03CHPDBR =
    new DecimalField(message, HEADERSIZE + 208, 5, 0, "E03CHPDBR");
    fields[18] = fieldE03CHPCON =
    new CharacterField(message, HEADERSIZE + 213, 1, "E03CHPCON");
    fields[19] = fieldE03ACMMSK =
    new DecimalField(message, HEADERSIZE + 214, 3, 0, "E03ACMMSK");
    fields[20] = fieldE03ACMTCB =
    new CharacterField(message, HEADERSIZE + 217, 2, "E03ACMTCB");
    fields[21] = fieldE03ACMCBC =
    new CharacterField(message, HEADERSIZE + 219, 1, "E03ACMCBC");
    fields[22] = fieldE03ACMASK =
    new DecimalField(message, HEADERSIZE + 220, 3, 0, "E03ACMASK");
