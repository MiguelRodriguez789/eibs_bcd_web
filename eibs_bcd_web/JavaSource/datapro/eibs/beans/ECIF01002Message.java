...
/**
* Class generated by AS/400 CRTCLASS command from ECIF01002 physical file definition.
* 
* File level identifier is 1130611112845.
* Record format level identifier is 597A7990EBCE0.
*/

public class ECIF01002Message extends MessageRecord
{
  ...
  final static String rid = "597A7990EBCE0";
  final static String fmtname = "ECIF01002";
  ...
  private DecimalField fieldE02CIFOCU = null;
  private DecimalField fieldE02CIFACC = null;
  private CharacterField fieldE02OCUNME = null;
  private CharacterField fieldE02OCUIDN = null;
  private CharacterField fieldE02CUSLN3 = null;

  /**
  * Constructor for ECIF01002Message.
  */
  public ECIF01002Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 112, 25, "E02CUSSHN");
    fields[12] = fieldE02CUSIDN =
    new CharacterField(message, HEADERSIZE + 137, 25, "E02CUSIDN");
    fields[13] = fieldE02CUSTID =
    new CharacterField(message, HEADERSIZE + 162, 4, "E02CUSTID");
    fields[14] = fieldE02CUSPID =
    new CharacterField(message, HEADERSIZE + 166, 4, "E02CUSPID");
    fields[15] = fieldE02CLILGT =
    new CharacterField(message, HEADERSIZE + 170, 10, "E02CLILGT");
    fields[16] = fieldE02CLITYP =
    new CharacterField(message, HEADERSIZE + 180, 10, "E02CLITYP");
    fields[17] = fieldE02CLISTS =
    new CharacterField(message, HEADERSIZE + 190, 20, "E02CLISTS");
    fields[18] = fieldE02NUMREC =
    new DecimalField(message, HEADERSIZE + 210, 8, 0, "E02NUMREC");
    fields[19] = fieldE02INDOPE =
    new CharacterField(message, HEADERSIZE + 218, 1, "E02INDOPE");
    fields[20] = fieldE02CIFOCU =
    new DecimalField(message, HEADERSIZE + 219, 10, 0, "E02CIFOCU");
    fields[21] = fieldE02CIFACC =
    new DecimalField(message, HEADERSIZE + 229, 13, 0, "E02CIFACC");
    fields[22] = fieldE02OCUNME =
    new CharacterField(message, HEADERSIZE + 242, 45, "E02OCUNME");
    fields[23] = fieldE02OCUIDN =
    new CharacterField(message, HEADERSIZE + 287, 25, "E02OCUIDN");
    fields[24] = fieldE02CUSLN3 =
    new CharacterField(message, HEADERSIZE + 312, 30, "E02CUSLN3");
  ...
  */
  ...
  /**
  * Set field E02CIFOCU using a String value.
  */
  public void setE02CIFOCU(String newvalue)
  {
    fieldE02CIFOCU.setString(newvalue);
  }

  /**
  * Get value of field E02CIFOCU as a String.
  */
  public String getE02CIFOCU()
  {
    return fieldE02CIFOCU.getString();
  }

  /**
  * Set numeric field E02CIFOCU using a BigDecimal value.
  */
  public void setE02CIFOCU(BigDecimal newvalue)
  {
    fieldE02CIFOCU.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E02CIFOCU as a BigDecimal.
  */
  public BigDecimal getBigDecimalE02CIFOCU()
  {
    return fieldE02CIFOCU.getBigDecimal();
  }
  ...
  */
  ...
  /**
  * Set field E02OCUNME using a String value.
  */
  public void setE02OCUNME(String newvalue)
  {
    fieldE02OCUNME.setString(newvalue);
  }

  /**
  * Get value of field E02OCUNME as a String.
  */
  public String getE02OCUNME()
  {
    return fieldE02OCUNME.getString();
  }

  /**
  * Set field E02OCUIDN using a String value.
  */
  public void setE02OCUIDN(String newvalue)
  {
    fieldE02OCUIDN.setString(newvalue);
  }

  /**
  * Get value of field E02OCUIDN as a String.
  */
  public String getE02OCUIDN()
  {
    return fieldE02OCUIDN.getString();
  }
