...
/**
* Class generated by AS/400 CRTCLASS command from EGC049003 physical file definition.
* 
* File level identifier is 1130611113159.
* Record format level identifier is 4714009854706.
*/

public class EGC049003Message extends MessageRecord
{
  ...
  final static String rid = "4714009854706";
  final static String fmtname = "EGC049003";
  ...
  /**
  * Constructor for EGC049003Message.
  */
  public EGC049003Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 392, 16, 0, "E03CUSFAX");
    fields[25] = fieldE03CUSIAD =
    new CharacterField(message, HEADERSIZE + 408, 60, "E03CUSIAD");
    fields[26] = fieldE03CUSSUC =
    new CharacterField(message, HEADERSIZE + 468, 2, "E03CUSSUC");
    fields[27] = fieldE03CUSOBC =
    new CharacterField(message, HEADERSIZE + 470, 2, "E03CUSOBC");
    fields[28] = fieldE03CUSOFC =
    new CharacterField(message, HEADERSIZE + 472, 4, "E03CUSOFC");
    fields[29] = fieldE03OVDRFT =
    new DecimalField(message, HEADERSIZE + 476, 17, 2, "E03OVDRFT");
    fields[30] = fieldE03LNSMOR =
    new DecimalField(message, HEADERSIZE + 493, 17, 2, "E03LNSMOR");
    fields[31] = fieldE03LNSLSG =
    new DecimalField(message, HEADERSIZE + 510, 17, 2, "E03LNSLSG");
    fields[32] = fieldE03LNSCON =
    new DecimalField(message, HEADERSIZE + 527, 17, 2, "E03LNSCON");
    fields[33] = fieldE03LNSGRL =
    new DecimalField(message, HEADERSIZE + 544, 17, 2, "E03LNSGRL");
    fields[34] = fieldE03DESDOC =
    new DecimalField(message, HEADERSIZE + 561, 17, 2, "E03DESDOC");
    fields[35] = fieldE03VALCBR =
    new DecimalField(message, HEADERSIZE + 578, 17, 2, "E03VALCBR");
    fields[36] = fieldE03INVERA =
    new DecimalField(message, HEADERSIZE + 595, 17, 2, "E03INVERA");
    fields[37] = fieldE03ACEPTA =
    new DecimalField(message, HEADERSIZE + 612, 17, 2, "E03ACEPTA");
    fields[38] = fieldE03LCCONF =
    new DecimalField(message, HEADERSIZE + 629, 17, 2, "E03LCCONF");
    fields[39] = fieldE03SPTPUR =
    new DecimalField(message, HEADERSIZE + 646, 17, 2, "E03SPTPUR");
    fields[40] = fieldE03FRWPUR =
    new DecimalField(message, HEADERSIZE + 663, 17, 2, "E03FRWPUR");
    fields[41] = fieldE03ACPDES =
    new DecimalField(message, HEADERSIZE + 680, 17, 2, "E03ACPDES");
    fields[42] = fieldE03LCNCON =
    new DecimalField(message, HEADERSIZE + 697, 17, 2, "E03LCNCON");
    fields[43] = fieldE03COLREC =
    new DecimalField(message, HEADERSIZE + 714, 17, 2, "E03COLREC");
    fields[44] = fieldE03CTACTE =
    new DecimalField(message, HEADERSIZE + 731, 17, 2, "E03CTACTE");
    fields[45] = fieldE03CTAMMK =
    new DecimalField(message, HEADERSIZE + 748, 17, 2, "E03CTAMMK");
    fields[46] = fieldE03CTAAHO =
    new DecimalField(message, HEADERSIZE + 765, 17, 2, "E03CTAAHO");
    fields[47] = fieldE03CDTDPO =
    new DecimalField(message, HEADERSIZE + 782, 17, 2, "E03CDTDPO");
    fields[48] = fieldE03INVERP =
    new DecimalField(message, HEADERSIZE + 799, 17, 2, "E03INVERP");
    fields[49] = fieldE03PARTIC =
    new DecimalField(message, HEADERSIZE + 816, 17, 2, "E03PARTIC");
    fields[50] = fieldE03ACEPTP =
    new DecimalField(message, HEADERSIZE + 833, 17, 2, "E03ACEPTP");
    fields[51] = fieldE03LCPROC =
    new DecimalField(message, HEADERSIZE + 850, 17, 2, "E03LCPROC");
    fields[52] = fieldE03SPTSAL =
    new DecimalField(message, HEADERSIZE + 867, 17, 2, "E03SPTSAL");
    fields[53] = fieldE03FRWSAL =
    new DecimalField(message, HEADERSIZE + 884, 17, 2, "E03FRWSAL");
    fields[54] = fieldE03GAREFE =
    new DecimalField(message, HEADERSIZE + 901, 17, 2, "E03GAREFE");
    fields[55] = fieldE03CBZINT =
    new DecimalField(message, HEADERSIZE + 918, 17, 2, "E03CBZINT");
    fields[56] = fieldE03CBZLOC =
    new DecimalField(message, HEADERSIZE + 935, 17, 2, "E03CBZLOC");
    fields[57] = fieldE03COLATE =
    new DecimalField(message, HEADERSIZE + 952, 17, 2, "E03COLATE");
    fields[58] = fieldE03CDTPIG =
    new DecimalField(message, HEADERSIZE + 969, 17, 2, "E03CDTPIG");
    fields[59] = fieldE03LNEAMT =
    new DecimalField(message, HEADERSIZE + 986, 17, 2, "E03LNEAMT");
    fields[60] = fieldE03LNEUSE =
    new DecimalField(message, HEADERSIZE + 1003, 17, 2, "E03LNEUSE");
    fields[61] = fieldE03LNEAVA =
    new DecimalField(message, HEADERSIZE + 1020, 17, 2, "E03LNEAVA");
    fields[62] = fieldE03LNETDY =
    new DecimalField(message, HEADERSIZE + 1037, 17, 2, "E03LNETDY");
    fields[63] = fieldE03PARVEN =
    new DecimalField(message, HEADERSIZE + 1054, 17, 2, "E03PARVEN");
    fields[64] = fieldE03TOTASS =
    new DecimalField(message, HEADERSIZE + 1071, 17, 2, "E03TOTASS");
    fields[65] = fieldE03TOTLIA =
    new DecimalField(message, HEADERSIZE + 1088, 17, 2, "E03TOTLIA");
    fields[66] = fieldE03TOTCDB =
    new DecimalField(message, HEADERSIZE + 1105, 17, 2, "E03TOTCDB");
    fields[67] = fieldE03TOTCCR =
    new DecimalField(message, HEADERSIZE + 1122, 17, 2, "E03TOTCCR");
    fields[68] = fieldP03OVDRFT =
    new DecimalField(message, HEADERSIZE + 1139, 7, 2, "P03OVDRFT");
    fields[69] = fieldP03LNSMOR =
    new DecimalField(message, HEADERSIZE + 1146, 7, 2, "P03LNSMOR");
    fields[70] = fieldP03LNSLSG =
    new DecimalField(message, HEADERSIZE + 1153, 7, 2, "P03LNSLSG");
    fields[71] = fieldP03LNSCON =
    new DecimalField(message, HEADERSIZE + 1160, 7, 2, "P03LNSCON");
    fields[72] = fieldP03LNSGRL =
    new DecimalField(message, HEADERSIZE + 1167, 7, 2, "P03LNSGRL");
    fields[73] = fieldP03DESDOC =
    new DecimalField(message, HEADERSIZE + 1174, 7, 2, "P03DESDOC");
    fields[74] = fieldP03VALCBR =
    new DecimalField(message, HEADERSIZE + 1181, 7, 2, "P03VALCBR");
    fields[75] = fieldP03INVERA =
    new DecimalField(message, HEADERSIZE + 1188, 7, 2, "P03INVERA");
    fields[76] = fieldP03ACEPTA =
    new DecimalField(message, HEADERSIZE + 1195, 7, 2, "P03ACEPTA");
    fields[77] = fieldP03LCCONF =
    new DecimalField(message, HEADERSIZE + 1202, 7, 2, "P03LCCONF");
    fields[78] = fieldP03SPTPUR =
    new DecimalField(message, HEADERSIZE + 1209, 7, 2, "P03SPTPUR");
    fields[79] = fieldP03FRWPUR =
    new DecimalField(message, HEADERSIZE + 1216, 7, 2, "P03FRWPUR");
    fields[80] = fieldP03ACPDES =
    new DecimalField(message, HEADERSIZE + 1223, 7, 2, "P03ACPDES");
    fields[81] = fieldP03LCNCON =
    new DecimalField(message, HEADERSIZE + 1230, 7, 2, "P03LCNCON");
    fields[82] = fieldP03COLREC =
    new DecimalField(message, HEADERSIZE + 1237, 7, 2, "P03COLREC");
    fields[83] = fieldP03CTACTE =
    new DecimalField(message, HEADERSIZE + 1244, 7, 2, "P03CTACTE");
    fields[84] = fieldP03CTAMMK =
    new DecimalField(message, HEADERSIZE + 1251, 7, 2, "P03CTAMMK");
    fields[85] = fieldP03CTAAHO =
    new DecimalField(message, HEADERSIZE + 1258, 7, 2, "P03CTAAHO");
    fields[86] = fieldP03CDTDPO =
    new DecimalField(message, HEADERSIZE + 1265, 7, 2, "P03CDTDPO");
    fields[87] = fieldP03INVERP =
    new DecimalField(message, HEADERSIZE + 1272, 7, 2, "P03INVERP");
    fields[88] = fieldP03PARTIC =
    new DecimalField(message, HEADERSIZE + 1279, 7, 2, "P03PARTIC");
    fields[89] = fieldP03ACEPTP =
    new DecimalField(message, HEADERSIZE + 1286, 7, 2, "P03ACEPTP");
    fields[90] = fieldP03LCPROC =
    new DecimalField(message, HEADERSIZE + 1293, 7, 2, "P03LCPROC");
    fields[91] = fieldP03SPTSAL =
    new DecimalField(message, HEADERSIZE + 1300, 7, 2, "P03SPTSAL");
    fields[92] = fieldP03FRWSAL =
    new DecimalField(message, HEADERSIZE + 1307, 7, 2, "P03FRWSAL");
    fields[93] = fieldP03GAREFE =
    new DecimalField(message, HEADERSIZE + 1314, 7, 2, "P03GAREFE");
    fields[94] = fieldP03CBZINT =
    new DecimalField(message, HEADERSIZE + 1321, 7, 2, "P03CBZINT");
    fields[95] = fieldP03CBZLOC =
    new DecimalField(message, HEADERSIZE + 1328, 7, 2, "P03CBZLOC");
    fields[96] = fieldP03COLATE =
    new DecimalField(message, HEADERSIZE + 1335, 7, 2, "P03COLATE");
    fields[97] = fieldP03CDTPIG =
    new DecimalField(message, HEADERSIZE + 1342, 7, 2, "P03CDTPIG");
