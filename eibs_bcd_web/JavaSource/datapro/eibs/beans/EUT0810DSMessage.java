...
* Record format level identifier is 49408D3DC7CA8.
*/
...
public class EUT0810DSMessage extends MessageRecord
{
  ...
  final static String rid = "49408D3DC7CA8";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 20, 45, "EUTDSC");
    fields[3] = fieldEUTFRP =
    new DecimalField(message, HEADERSIZE + 65, 5, 0, "EUTFRP");
    fields[4] = fieldEUTTOP =
    new DecimalField(message, HEADERSIZE + 70, 5, 0, "EUTTOP");
    fields[5] = fieldEUTBYT =
    new DecimalField(message, HEADERSIZE + 75, 5, 0, "EUTBYT");
    fields[6] = fieldEUTLNG =
    new DecimalField(message, HEADERSIZE + 80, 5, 0, "EUTLNG");
    fields[7] = fieldEUTDEC =
    new DecimalField(message, HEADERSIZE + 85, 3, 0, "EUTDEC");
    fields[8] = fieldEUTTYP =
    new CharacterField(message, HEADERSIZE + 88, 1, "EUTTYP");
    fields[9] = fieldEUTOPE =
    new CharacterField(message, HEADERSIZE + 89, 1, "EUTOPE");
