...
* 
* File level identifier is 1150930160338.
* Record format level identifier is 45390645C958E.
*/
...
public class EDEN011DSMessage extends MessageRecord
{
  ...
  final static String fid = "1150930160338";
  final static String rid = "45390645C958E";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 482, 4, "SWDSTA");
    fields[10] = fieldSWDCCD =
    new CharacterField(message, HEADERSIZE + 486, 4, "SWDCCD");
    fields[11] = fieldSWDDTE =
    new DecimalField(message, HEADERSIZE + 490, 9, 0, "SWDDTE");
    fields[12] = fieldSWDVOL =
    new DecimalField(message, HEADERSIZE + 499, 3, 0, "SWDVOL");
    fields[13] = fieldSWDPAG =
    new DecimalField(message, HEADERSIZE + 502, 7, 0, "SWDPAG");
    fields[14] = fieldSWDCOU =
    new DecimalField(message, HEADERSIZE + 509, 13, 0, "SWDCOU");
    fields[15] = fieldSWDTYP =
    new CharacterField(message, HEADERSIZE + 522, 5, "SWDTYP");
    fields[16] = fieldSWDREM =
    new CharacterField(message, HEADERSIZE + 527, 60, "SWDREM");
    fields[17] = fieldSWDCDS =
    new CharacterField(message, HEADERSIZE + 587, 30, "SWDCDS");
    fields[18] = fieldSWDTDS =
    new CharacterField(message, HEADERSIZE + 617, 30, "SWDTDS");
    fields[19] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 647, 8, 0, "SWDREC");
    fields[20] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 655, 1, "SWDOPE");
