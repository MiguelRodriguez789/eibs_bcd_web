...
/**
* Class generated by AS/400 CRTCLASS command from EDP078803 physical file definition.
* 
* File level identifier is 1160308125155.
* Record format level identifier is 3D735FCA59B8E.
*/

public class EDP078803Message extends MessageRecord
{
  ...
  final static String fid = "1160308125155";
  final static String rid = "3D735FCA59B8E";
  final static String fmtname = "EDP078803";
  ...
  private DecimalField fieldE03PLTNPR = null;
  ...
  private DecimalField fieldE03DLPNPR = null;
  private CharacterField fieldE03DLPCRB = null;
  private CharacterField fieldD03DLPCRB = null;
  ...
  /**
  * Constructor for EDP078803Message.
  */
  public EDP078803Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[9] = fieldE03PLTNPR =
    new DecimalField(message, HEADERSIZE + 42, 13, 0, "E03PLTNPR");
    fields[10] = fieldE03DEAACC =
    new DecimalField(message, HEADERSIZE + 55, 13, 0, "E03DEAACC");
    ...
    new DecimalField(message, HEADERSIZE + 74, 10, 0, "E03DEACUN");
    fields[14] = fieldE03DEABNK =
    new CharacterField(message, HEADERSIZE + 84, 2, "E03DEABNK");
    fields[15] = fieldE03DEABRN =
    new DecimalField(message, HEADERSIZE + 86, 5, 0, "E03DEABRN");
    fields[16] = fieldE03DEACCY =
    new CharacterField(message, HEADERSIZE + 91, 3, "E03DEACCY");
    fields[17] = fieldE03DEAGLN =
    new DecimalField(message, HEADERSIZE + 94, 17, 0, "E03DEAGLN");
    fields[18] = fieldE03CUSNA1 =
    new CharacterField(message, HEADERSIZE + 111, 60, "E03CUSNA1");
    fields[19] = fieldE03DLPNPR =
    new DecimalField(message, HEADERSIZE + 171, 13, 0, "E03DLPNPR");
    fields[20] = fieldE03DLPCRB =
    new CharacterField(message, HEADERSIZE + 184, 4, "E03DLPCRB");
    fields[21] = fieldD03DLPCRB =
    new CharacterField(message, HEADERSIZE + 188, 45, "D03DLPCRB");
    fields[22] = fieldE03DLPPNU =
    new DecimalField(message, HEADERSIZE + 233, 4, 0, "E03DLPPNU");
    fields[23] = fieldE03DLPPDM =
    new DecimalField(message, HEADERSIZE + 237, 3, 0, "E03DLPPDM");
    fields[24] = fieldE03DLPPDD =
    new DecimalField(message, HEADERSIZE + 240, 3, 0, "E03DLPPDD");
    fields[25] = fieldE03DLPPDY =
    new DecimalField(message, HEADERSIZE + 243, 5, 0, "E03DLPPDY");
    fields[26] = fieldE03DLPPRI =
    new DecimalField(message, HEADERSIZE + 248, 17, 2, "E03DLPPRI");
    fields[27] = fieldE03DLPINT =
    new DecimalField(message, HEADERSIZE + 265, 17, 2, "E03DLPINT");
    fields[28] = fieldE03DLPIIP =
    new CharacterField(message, HEADERSIZE + 282, 1, "E03DLPIIP");
    fields[29] = fieldF03DLPPNU =
    new CharacterField(message, HEADERSIZE + 283, 1, "F03DLPPNU");
    fields[30] = fieldF03DLPPDM =
    new CharacterField(message, HEADERSIZE + 284, 1, "F03DLPPDM");
    fields[31] = fieldF03DLPPDD =
    new CharacterField(message, HEADERSIZE + 285, 1, "F03DLPPDD");
    fields[32] = fieldF03DLPPDY =
    new CharacterField(message, HEADERSIZE + 286, 1, "F03DLPPDY");
    fields[33] = fieldF03DLPPRI =
    new CharacterField(message, HEADERSIZE + 287, 1, "F03DLPPRI");
    fields[34] = fieldF03DLPINT =
    new CharacterField(message, HEADERSIZE + 288, 1, "F03DLPINT");
    fields[35] = fieldF03DLPIIP =
    new CharacterField(message, HEADERSIZE + 289, 1, "F03DLPIIP");
  ...
  */
  ...
  /**
  * Set field E03PLTNPR using a String value.
  */
  public void setE03PLTNPR(String newvalue)
  {
    fieldE03PLTNPR.setString(newvalue);
  }

  /**
  * Get value of field E03PLTNPR as a String.
  */
  public String getE03PLTNPR()
  {
    return fieldE03PLTNPR.getString();
  }

  /**
  * Set numeric field E03PLTNPR using a BigDecimal value.
  */
  public void setE03PLTNPR(BigDecimal newvalue)
  {
    fieldE03PLTNPR.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E03PLTNPR as a BigDecimal.
  */
  public BigDecimal getBigDecimalE03PLTNPR()
  {
    return fieldE03PLTNPR.getBigDecimal();
  }
  ...
  */
  ...
  /**
  * Set field E03DLPNPR using a String value.
  */
  public void setE03DLPNPR(String newvalue)
  {
    fieldE03DLPNPR.setString(newvalue);
  }

  /**
  * Get value of field E03DLPNPR as a String.
  */
  public String getE03DLPNPR()
  {
    return fieldE03DLPNPR.getString();
  }

  /**
  * Set numeric field E03DLPNPR using a BigDecimal value.
  */
  public void setE03DLPNPR(BigDecimal newvalue)
  {
    fieldE03DLPNPR.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E03DLPNPR as a BigDecimal.
  */
  public BigDecimal getBigDecimalE03DLPNPR()
  {
    return fieldE03DLPNPR.getBigDecimal();
  }

  /**
  * Set field E03DLPCRB using a String value.
  */
  public void setE03DLPCRB(String newvalue)
  {
    fieldE03DLPCRB.setString(newvalue);
  }

  /**
  * Get value of field E03DLPCRB as a String.
  */
  public String getE03DLPCRB()
  {
    return fieldE03DLPCRB.getString();
  }

  /**
  * Set field D03DLPCRB using a String value.
  */
  public void setD03DLPCRB(String newvalue)
  {
    fieldD03DLPCRB.setString(newvalue);
  }

  /**
  * Get value of field D03DLPCRB as a String.
  */
  public String getD03DLPCRB()
  {
    return fieldD03DLPCRB.getString();
  }
