...
* Record format level identifier is 476A3B35604A5.
*/
...
public class EWD0045DSMessage extends MessageRecord
{
  ...
  final static String rid = "476A3B35604A5";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 7, 3, 0, "EWDDT1");
    fields[4] = fieldEWDDT2 =
    new DecimalField(message, HEADERSIZE + 10, 3, 0, "EWDDT2");
    fields[5] = fieldEWDDT3 =
    new DecimalField(message, HEADERSIZE + 13, 5, 0, "EWDDT3");
    fields[6] = fieldEWDRT1 =
    new DecimalField(message, HEADERSIZE + 18, 11, 6, "EWDRT1");
    fields[7] = fieldEWDRT2 =
    new DecimalField(message, HEADERSIZE + 29, 11, 6, "EWDRT2");
    fields[8] = fieldEWDRT3 =
    new DecimalField(message, HEADERSIZE + 40, 11, 6, "EWDRT3");
    fields[9] = fieldEWDRT4 =
    new DecimalField(message, HEADERSIZE + 51, 11, 6, "EWDRT4");
    fields[10] = fieldEWDRT5 =
    new DecimalField(message, HEADERSIZE + 62, 11, 6, "EWDRT5");
    fields[11] = fieldEWDAM1 =
    new DecimalField(message, HEADERSIZE + 73, 17, 2, "EWDAM1");
    fields[12] = fieldEWDAM2 =
    new DecimalField(message, HEADERSIZE + 90, 17, 2, "EWDAM2");
    fields[13] = fieldEWDAM3 =
    new DecimalField(message, HEADERSIZE + 107, 17, 2, "EWDAM3");
    fields[14] = fieldEWDAM4 =
    new DecimalField(message, HEADERSIZE + 124, 17, 2, "EWDAM4");
    fields[15] = fieldEWDAM5 =
    new DecimalField(message, HEADERSIZE + 141, 17, 2, "EWDAM5");
    fields[16] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 158, 1, "EWDOPE");
