...
* Record format level identifier is 40DB34D001DF3.
*/
...
public class EFO012001Message extends MessageRecord
{
  ...
  final static String rid = "40DB34D001DF3";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 55, 60, "E01CUSNA1");
    fields[14] = fieldE01CUSFNA =
    new CharacterField(message, HEADERSIZE + 115, 30, "E01CUSFNA");
    fields[15] = fieldE01CUSFN2 =
    new CharacterField(message, HEADERSIZE + 145, 30, "E01CUSFN2");
    fields[16] = fieldE01CUSLN1 =
    new CharacterField(message, HEADERSIZE + 175, 30, "E01CUSLN1");
    fields[17] = fieldE01CUSLN2 =
    new CharacterField(message, HEADERSIZE + 205, 30, "E01CUSLN2");
    fields[18] = fieldE01CUSSHN =
    new CharacterField(message, HEADERSIZE + 235, 25, "E01CUSSHN");
    fields[19] = fieldE01CUSNA2 =
    new CharacterField(message, HEADERSIZE + 260, 45, "E01CUSNA2");
    fields[20] = fieldE01CUSNA3 =
    new CharacterField(message, HEADERSIZE + 305, 45, "E01CUSNA3");
    fields[21] = fieldE01CUSNA4 =
    new CharacterField(message, HEADERSIZE + 350, 45, "E01CUSNA4");
    fields[22] = fieldE01CUSCTY =
    new CharacterField(message, HEADERSIZE + 395, 35, "E01CUSCTY");
    fields[23] = fieldE01CUSSTE =
    new CharacterField(message, HEADERSIZE + 430, 4, "E01CUSSTE");
    fields[24] = fieldE01CUSCTR =
    new CharacterField(message, HEADERSIZE + 434, 35, "E01CUSCTR");
    fields[25] = fieldE01CUSSEX =
    new CharacterField(message, HEADERSIZE + 469, 1, "E01CUSSEX");
    fields[26] = fieldE01CUSMST =
    new CharacterField(message, HEADERSIZE + 470, 1, "E01CUSMST");
    fields[27] = fieldE01CUSNSO =
    new DecimalField(message, HEADERSIZE + 471, 3, 0, "E01CUSNSO");
    fields[28] = fieldE01CUSBDM =
    new DecimalField(message, HEADERSIZE + 474, 3, 0, "E01CUSBDM");
    fields[29] = fieldE01CUSBDD =
    new DecimalField(message, HEADERSIZE + 477, 3, 0, "E01CUSBDD");
    fields[30] = fieldE01CUSBDY =
    new DecimalField(message, HEADERSIZE + 480, 5, 0, "E01CUSBDY");
    fields[31] = fieldE01CUSIDM =
    new DecimalField(message, HEADERSIZE + 485, 3, 0, "E01CUSIDM");
    fields[32] = fieldE01CUSIDD =
    new DecimalField(message, HEADERSIZE + 488, 3, 0, "E01CUSIDD");
    fields[33] = fieldE01CUSIDY =
    new DecimalField(message, HEADERSIZE + 491, 5, 0, "E01CUSIDY");
    fields[34] = fieldE01CUSHPN =
    new DecimalField(message, HEADERSIZE + 496, 16, 0, "E01CUSHPN");
    fields[35] = fieldE01CUSPHN =
    new DecimalField(message, HEADERSIZE + 512, 16, 0, "E01CUSPHN");
    fields[36] = fieldE01CUSPH1 =
    new DecimalField(message, HEADERSIZE + 528, 16, 0, "E01CUSPH1");
    fields[37] = fieldE01CUSFAX =
    new DecimalField(message, HEADERSIZE + 544, 16, 0, "E01CUSFAX");
    fields[38] = fieldE01CUSIAD =
    new CharacterField(message, HEADERSIZE + 560, 60, "E01CUSIAD");
    fields[39] = fieldE01CUSIDN =
    new CharacterField(message, HEADERSIZE + 620, 25, "E01CUSIDN");
    fields[40] = fieldE01CUSTID =
    new CharacterField(message, HEADERSIZE + 645, 4, "E01CUSTID");
    fields[41] = fieldE01CUSPID =
    new CharacterField(message, HEADERSIZE + 649, 4, "E01CUSPID");
    fields[42] = fieldE01CUSOFC =
    new CharacterField(message, HEADERSIZE + 653, 4, "E01CUSOFC");
    fields[43] = fieldD01CUSCCS =
    new CharacterField(message, HEADERSIZE + 657, 45, "D01CUSCCS");
    fields[44] = fieldD01CUSSTE =
    new CharacterField(message, HEADERSIZE + 702, 45, "D01CUSSTE");
    fields[45] = fieldD01CUSTID =
    new CharacterField(message, HEADERSIZE + 747, 45, "D01CUSTID");
    fields[46] = fieldD01CUSPID =
    new CharacterField(message, HEADERSIZE + 792, 45, "D01CUSPID");
    fields[47] = fieldD01CUSOFC =
    new CharacterField(message, HEADERSIZE + 837, 45, "D01CUSOFC");
