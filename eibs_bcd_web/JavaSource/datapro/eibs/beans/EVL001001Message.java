...
* Record format level identifier is 31878FCFE5F6D.
*/
...
public class EVL001001Message extends MessageRecord
{
  ...
  final static String rid = "31878FCFE5F6D";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 237, 13, 0, "E01REQREF");
    fields[18] = fieldE01REQRQT =
    new DecimalField(message, HEADERSIZE + 250, 13, 0, "E01REQRQT");
    fields[19] = fieldE01REQCD1 =
    new DecimalField(message, HEADERSIZE + 263, 3, 0, "E01REQCD1");
    fields[20] = fieldE01REQCD2 =
    new DecimalField(message, HEADERSIZE + 266, 3, 0, "E01REQCD2");
    fields[21] = fieldE01REQCD3 =
    new DecimalField(message, HEADERSIZE + 269, 5, 0, "E01REQCD3");
    fields[22] = fieldE01REQCRT =
    new CharacterField(message, HEADERSIZE + 274, 26, "E01REQCRT");
    fields[23] = fieldE01REQCRU =
    new CharacterField(message, HEADERSIZE + 300, 10, "E01REQCRU");
