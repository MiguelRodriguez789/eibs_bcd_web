...
* Record format level identifier is 4C1F4E35EC25E.
*/
...
public class ECD0005DSMessage extends MessageRecord
{
  ...
  final static String rid = "4C1F4E35EC25E";
  ...
  private CharacterField fieldE05CDRTIM = null;
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 44, 45, "E05CDRNPL");
    fields[11] = fieldE05CDRFEE =
    new CharacterField(message, HEADERSIZE + 89, 4, "E05CDRFEE");
    fields[12] = fieldE05CDRFED =
    new CharacterField(message, HEADERSIZE + 93, 45, "E05CDRFED");
    fields[13] = fieldE05CDRFFC =
    new CharacterField(message, HEADERSIZE + 138, 1, "E05CDRFFC");
    fields[14] = fieldE05CDRCHG =
    new DecimalField(message, HEADERSIZE + 139, 12, 6, "E05CDRCHG");
    fields[15] = fieldE05CDRAMT =
    new DecimalField(message, HEADERSIZE + 151, 14, 2, "E05CDRAMT");
    fields[16] = fieldE05CDRACC =
    new DecimalField(message, HEADERSIZE + 165, 13, 0, "E05CDRACC");
    fields[17] = fieldE05CDRGLN =
    new CharacterField(message, HEADERSIZE + 178, 20, "E05CDRGLN");
    fields[18] = fieldE05CDRPER =
    new CharacterField(message, HEADERSIZE + 198, 4, "E05CDRPER");
    fields[19] = fieldE05CDRPED =
    new CharacterField(message, HEADERSIZE + 202, 45, "E05CDRPED");
    fields[20] = fieldE05CDRUSR =
    new CharacterField(message, HEADERSIZE + 247, 10, "E05CDRUSR");
    fields[21] = fieldE05CDRDAY =
    new DecimalField(message, HEADERSIZE + 257, 3, 0, "E05CDRDAY");
    fields[22] = fieldE05CDRMON =
    new DecimalField(message, HEADERSIZE + 260, 3, 0, "E05CDRMON");
    fields[23] = fieldE05CDRYEA =
    new DecimalField(message, HEADERSIZE + 263, 5, 0, "E05CDRYEA");
    fields[24] = fieldE05CDRTIM =
    new CharacterField(message, HEADERSIZE + 268, 26, "E05CDRTIM");
