...
* Record format level identifier is 359EF50B22EEA.
*/
...
public class ELD010003Message extends MessageRecord
{
  ...
  final static String rid = "359EF50B22EEA";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 125, 3, 0, "E03LDESEQ");
    fields[13] = fieldE03LDEBDY =
    new DecimalField(message, HEADERSIZE + 128, 5, 0, "E03LDEBDY");
    fields[14] = fieldE03LDEBDM =
    new DecimalField(message, HEADERSIZE + 133, 3, 0, "E03LDEBDM");
    fields[15] = fieldE03LDETPY =
    new CharacterField(message, HEADERSIZE + 136, 80, "E03LDETPY");
    fields[16] = fieldE03LDERM1 =
    new CharacterField(message, HEADERSIZE + 216, 80, "E03LDERM1");
    fields[17] = fieldE03LDERM2 =
    new CharacterField(message, HEADERSIZE + 296, 80, "E03LDERM2");
    fields[18] = fieldE03LDERM3 =
    new CharacterField(message, HEADERSIZE + 376, 80, "E03LDERM3");
    fields[19] = fieldE03LDERM4 =
    new CharacterField(message, HEADERSIZE + 456, 80, "E03LDERM4");
    fields[20] = fieldE03LDEOPE =
    new CharacterField(message, HEADERSIZE + 536, 1, "E03LDEOPE");
