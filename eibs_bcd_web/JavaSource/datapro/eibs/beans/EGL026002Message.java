...
/**
* Class generated by AS/400 CRTCLASS command from EGL026002 physical file definition.
* 
* File level identifier is 1111019153034.
* Record format level identifier is 4BF8251C55C20.
*/

public class EGL026002Message extends MessageRecord
{
  ...
  final static String fid = "1111019153034";
  final static String rid = "4BF8251C55C20";
  final static String fmtname = "EGL026002";
  ...
  /**
  * Constructor for EGL026002Message.
  */
  public EGL026002Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 82, 1, "E02ACTION");
    fields[15] = fieldE02MSGTXT =
    new CharacterField(message, HEADERSIZE + 83, 512, "E02MSGTXT");
