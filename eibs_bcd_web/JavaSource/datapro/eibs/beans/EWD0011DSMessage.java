...
* Record format level identifier is 5DFA1E8194693.
*/
...
public class EWD0011DSMessage extends MessageRecord
{
  ...
  final static String rid = "5DFA1E8194693";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 5, 17, 0, "EWDSNU");
    fields[3] = fieldEWDBNK =
    new CharacterField(message, HEADERSIZE + 22, 2, "EWDBNK");
    fields[4] = fieldEWDCCY =
    new CharacterField(message, HEADERSIZE + 24, 3, "EWDCCY");
    fields[5] = fieldEWDNUM =
    new DecimalField(message, HEADERSIZE + 27, 17, 0, "EWDNUM");
    fields[6] = fieldEWDCCN =
    new DecimalField(message, HEADERSIZE + 44, 9, 0, "EWDCCN");
    fields[7] = fieldEWDNME =
    new CharacterField(message, HEADERSIZE + 53, 45, "EWDNME");
    fields[8] = fieldEWDREC =
    new DecimalField(message, HEADERSIZE + 98, 8, 0, "EWDREC");
    fields[9] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 106, 1, "EWDOPE");
