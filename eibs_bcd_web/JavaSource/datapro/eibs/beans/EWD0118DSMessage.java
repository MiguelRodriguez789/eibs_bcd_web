...
* Record format level identifier is 51CB9F5374EC0.
*/
...
public class EWD0118DSMessage extends MessageRecord
{
  ...
  final static String rid = "51CB9F5374EC0";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 2, 12, 0, "EWDNCK");
    fields[2] = fieldEWDCCY =
    new CharacterField(message, HEADERSIZE + 14, 3, "EWDCCY");
    fields[3] = fieldEWDATY =
    new CharacterField(message, HEADERSIZE + 17, 4, "EWDATY");
    fields[4] = fieldEWDDSC =
    new CharacterField(message, HEADERSIZE + 21, 60, "EWDDSC");
    fields[5] = fieldEWDTBL =
    new CharacterField(message, HEADERSIZE + 81, 1, "EWDTBL");
    fields[6] = fieldEWDCLS =
    new CharacterField(message, HEADERSIZE + 82, 1, "EWDCLS");
