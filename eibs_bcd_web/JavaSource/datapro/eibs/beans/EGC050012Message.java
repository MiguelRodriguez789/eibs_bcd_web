...
* Record format level identifier is 388182EAE9CD1.
*/
...
public class EGC050012Message extends MessageRecord
{
  ...
  final static String rid = "388182EAE9CD1";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 46, 25, "E12GCRUT");
    fields[11] = fieldE12GCNMBC =
    new CharacterField(message, HEADERSIZE + 71, 45, "E12GCNMBC");
    fields[12] = fieldE12GCNOPR =
    new DecimalField(message, HEADERSIZE + 116, 6, 0, "E12GCNOPR");
    fields[13] = fieldE12GCGPRD =
    new CharacterField(message, HEADERSIZE + 122, 4, "E12GCGPRD");
    fields[14] = fieldE12GCGMDA =
    new CharacterField(message, HEADERSIZE + 126, 3, "E12GCGMDA");
    fields[15] = fieldE12GCESTD =
    new CharacterField(message, HEADERSIZE + 129, 1, "E12GCESTD");
    fields[16] = fieldE12GCMNTC =
    new DecimalField(message, HEADERSIZE + 130, 17, 2, "E12GCMNTC");
    fields[17] = fieldE12GCMNMO =
    new DecimalField(message, HEADERSIZE + 147, 17, 2, "E12GCMNMO");
    fields[18] = fieldE12GCCAPY =
    new DecimalField(message, HEADERSIZE + 164, 5, 0, "E12GCCAPY");
    fields[19] = fieldE12GCCAPM =
    new DecimalField(message, HEADERSIZE + 169, 3, 0, "E12GCCAPM");
    fields[20] = fieldE12GCCAPD =
    new DecimalField(message, HEADERSIZE + 172, 3, 0, "E12GCCAPD");
    fields[21] = fieldE12GCVENY =
    new DecimalField(message, HEADERSIZE + 175, 5, 0, "E12GCVENY");
    fields[22] = fieldE12GCVENM =
    new DecimalField(message, HEADERSIZE + 180, 3, 0, "E12GCVENM");
    fields[23] = fieldE12GCVEND =
    new DecimalField(message, HEADERSIZE + 183, 3, 0, "E12GCVEND");
    fields[24] = fieldE12GCTBAS =
    new DecimalField(message, HEADERSIZE + 186, 13, 6, "E12GCTBAS");
    fields[25] = fieldE12GCPLAZ =
    new DecimalField(message, HEADERSIZE + 199, 6, 0, "E12GCPLAZ");
    fields[26] = fieldE12GCGTYA =
    new DecimalField(message, HEADERSIZE + 205, 6, 0, "E12GCGTYA");
    fields[27] = fieldE12GODNPG =
    new DecimalField(message, HEADERSIZE + 211, 6, 0, "E12GODNPG");
    fields[28] = fieldE12INDOPE =
    new CharacterField(message, HEADERSIZE + 217, 1, "E12INDOPE");
