...
* Record format level identifier is 3EE775CC6DB5B.
*/
...
public class EVG012001Message extends MessageRecord
{
  ...
  final static String rid = "3EE775CC6DB5B";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 714, 80, "E01OFMCO1");
    fields[35] = fieldE01OFMCO2 =
    new CharacterField(message, HEADERSIZE + 794, 80, "E01OFMCO2");
    fields[36] = fieldE01OFMCO3 =
    new CharacterField(message, HEADERSIZE + 874, 80, "E01OFMCO3");
    fields[37] = fieldE01OFMCLS =
    new CharacterField(message, HEADERSIZE + 954, 1, "E01OFMCLS");
    fields[38] = fieldE01LETAMT =
    new CharacterField(message, HEADERSIZE + 955, 160, "E01LETAMT");
    fields[39] = fieldE01OFMAPV =
    new CharacterField(message, HEADERSIZE + 1115, 1, "E01OFMAPV");
    fields[40] = fieldE01OFMPTH =
    new CharacterField(message, HEADERSIZE + 1116, 80, "E01OFMPTH");
    fields[41] = fieldE01OFMCOM =
    new DecimalField(message, HEADERSIZE + 1196, 17, 2, "E01OFMCOM");
    fields[42] = fieldE01OFMIVA =
    new DecimalField(message, HEADERSIZE + 1213, 17, 2, "E01OFMIVA");
    fields[43] = fieldE01OFMBTH =
    new DecimalField(message, HEADERSIZE + 1230, 6, 0, "E01OFMBTH");
    fields[44] = fieldE01NEWCKN =
    new DecimalField(message, HEADERSIZE + 1236, 12, 0, "E01NEWCKN");
    fields[45] = fieldE01OFMBID =
    new CharacterField(message, HEADERSIZE + 1248, 25, "E01OFMBID");
    fields[46] = fieldE01OFMAID =
    new CharacterField(message, HEADERSIZE + 1273, 25, "E01OFMAID");
    fields[47] = fieldE01OFMCTY =
    new CharacterField(message, HEADERSIZE + 1298, 4, "E01OFMCTY");
    fields[48] = fieldD01OFMCTY =
    new CharacterField(message, HEADERSIZE + 1302, 45, "D01OFMCTY");
    fields[49] = fieldE01CREBNK =
    new CharacterField(message, HEADERSIZE + 1347, 2, "E01CREBNK");
    fields[50] = fieldE01CREBRN =
    new DecimalField(message, HEADERSIZE + 1349, 5, 0, "E01CREBRN");
    fields[51] = fieldE01CRECCY =
    new CharacterField(message, HEADERSIZE + 1354, 3, "E01CRECCY");
    fields[52] = fieldE01CREGLN =
    new DecimalField(message, HEADERSIZE + 1357, 17, 0, "E01CREGLN");
    fields[53] = fieldE01CREACC =
    new DecimalField(message, HEADERSIZE + 1374, 13, 0, "E01CREACC");
    fields[54] = fieldE01CRECCN =
    new DecimalField(message, HEADERSIZE + 1387, 9, 0, "E01CRECCN");
    fields[55] = fieldE01DESCRIP =
    new CharacterField(message, HEADERSIZE + 1396, 45, "E01DESCRIP");
