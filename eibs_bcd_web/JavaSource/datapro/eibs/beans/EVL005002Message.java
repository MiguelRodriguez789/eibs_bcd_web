...
* Record format level identifier is 4E15A5486CD01.
*/
...
public class EVL005002Message extends MessageRecord
{
  ...
  final static String rid = "4E15A5486CD01";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 147, 13, 0, "E02LVLMIN");
    fields[16] = fieldE02LVLBAL =
    new DecimalField(message, HEADERSIZE + 160, 13, 0, "E02LVLBAL");
    fields[17] = fieldE02DOCBAL =
    new DecimalField(message, HEADERSIZE + 173, 13, 0, "E02DOCBAL");
    fields[18] = fieldE02TOTBAL =
    new DecimalField(message, HEADERSIZE + 186, 13, 0, "E02TOTBAL");
    fields[19] = fieldE02REQRQT =
    new DecimalField(message, HEADERSIZE + 199, 13, 0, "E02REQRQT");
    fields[20] = fieldE02REQAQT =
    new DecimalField(message, HEADERSIZE + 212, 13, 0, "E02REQAQT");
