...
* Record format level identifier is 49109DC208223.
*/
...
public class EDP000101Message extends MessageRecord
{
  ...
  final static String rid = "49109DC208223";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 42, 2, "E01DPGTIT");
    fields[10] = fieldE01DPGCTA =
    new DecimalField(message, HEADERSIZE + 44, 17, 0, "E01DPGCTA");
    fields[11] = fieldE01DPGCOD =
    new CharacterField(message, HEADERSIZE + 61, 4, "E01DPGCOD");
    fields[12] = fieldE01DPGDSC =
    new CharacterField(message, HEADERSIZE + 65, 60, "E01DPGDSC");
    fields[13] = fieldE01DPGOPE =
    new CharacterField(message, HEADERSIZE + 125, 2, "E01DPGOPE");
    fields[14] = fieldE01DPGCF1 =
    new CharacterField(message, HEADERSIZE + 127, 2, "E01DPGCF1");
    fields[15] = fieldE01DPGCF2 =
    new CharacterField(message, HEADERSIZE + 129, 2, "E01DPGCF2");
    fields[16] = fieldE01DPGCF3 =
    new CharacterField(message, HEADERSIZE + 131, 2, "E01DPGCF3");
    fields[17] = fieldE01DPGCF4 =
    new CharacterField(message, HEADERSIZE + 133, 2, "E01DPGCF4");
    fields[18] = fieldE01DPGCF5 =
    new CharacterField(message, HEADERSIZE + 135, 2, "E01DPGCF5");
