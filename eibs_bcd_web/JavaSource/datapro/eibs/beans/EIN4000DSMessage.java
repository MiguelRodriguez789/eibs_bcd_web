...
* Record format level identifier is 2E8D7D31AF26D.
*/
...
public class EIN4000DSMessage extends MessageRecord
{
  ...
  final static String rid = "2E8D7D31AF26D";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 12, 5, 0, "IN4BRN");
    fields[3] = fieldIN4CCY =
    new CharacterField(message, HEADERSIZE + 17, 3, "IN4CCY");
    fields[4] = fieldIN4ACC =
    new DecimalField(message, HEADERSIZE + 20, 13, 0, "IN4ACC");
    fields[5] = fieldIN4TYP =
    new CharacterField(message, HEADERSIZE + 33, 4, "IN4TYP");
    fields[6] = fieldIN4CLS =
    new CharacterField(message, HEADERSIZE + 37, 2, "IN4CLS");
    fields[7] = fieldIN4BAS =
    new DecimalField(message, HEADERSIZE + 39, 4, 0, "IN4BAS");
    fields[8] = fieldIN4CUN =
    new DecimalField(message, HEADERSIZE + 43, 10, 0, "IN4CUN");
    fields[9] = fieldIN4PRI =
    new DecimalField(message, HEADERSIZE + 53, 17, 2, "IN4PRI");
    fields[10] = fieldIN4INT =
    new DecimalField(message, HEADERSIZE + 70, 17, 2, "IN4INT");
    fields[11] = fieldIN4SCY =
    new CharacterField(message, HEADERSIZE + 87, 3, "IN4SCY");
    fields[12] = fieldIN4SPR =
    new DecimalField(message, HEADERSIZE + 90, 17, 2, "IN4SPR");
    fields[13] = fieldIN4RTE =
    new DecimalField(message, HEADERSIZE + 107, 13, 6, "IN4RTE");
    fields[14] = fieldIN4TRD =
    new DecimalField(message, HEADERSIZE + 120, 9, 0, "IN4TRD");
    fields[15] = fieldIN4VLD =
    new DecimalField(message, HEADERSIZE + 129, 9, 0, "IN4VLD");
    fields[16] = fieldIN4MTD =
    new DecimalField(message, HEADERSIZE + 138, 9, 0, "IN4MTD");
    fields[17] = fieldIN4NXD =
    new DecimalField(message, HEADERSIZE + 147, 9, 0, "IN4NXD");
    fields[18] = fieldIN4SRF =
    new CharacterField(message, HEADERSIZE + 156, 16, "IN4SRF");
    fields[19] = fieldIN4THF =
    new CharacterField(message, HEADERSIZE + 172, 16, "IN4THF");
    fields[20] = fieldIN4WSI =
    new CharacterField(message, HEADERSIZE + 188, 10, "IN4WSI");
    fields[21] = fieldIN4FMT =
    new CharacterField(message, HEADERSIZE + 198, 3, "IN4FMT");
    fields[22] = fieldIN4PRG =
    new CharacterField(message, HEADERSIZE + 201, 10, "IN4PRG");
    fields[23] = fieldIN4PRC =
    new CharacterField(message, HEADERSIZE + 211, 10, "IN4PRC");
    fields[24] = fieldIN4FLG =
    new CharacterField(message, HEADERSIZE + 221, 1, "IN4FLG");
