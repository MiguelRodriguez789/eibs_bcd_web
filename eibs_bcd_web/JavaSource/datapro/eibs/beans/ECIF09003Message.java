...
* Record format level identifier is 4E0D0D55D7805.
*/
...
public class ECIF09003Message extends MessageRecord
{
  ...
  final static String rid = "4E0D0D55D7805";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 44, 45, "E03INQBNN");
    fields[11] = fieldE03INQRDY =
    new DecimalField(message, HEADERSIZE + 89, 5, 0, "E03INQRDY");
    fields[12] = fieldE03INQRDM =
    new DecimalField(message, HEADERSIZE + 94, 3, 0, "E03INQRDM");
    fields[13] = fieldE03INQOFC =
    new CharacterField(message, HEADERSIZE + 97, 4, "E03INQOFC");
    fields[14] = fieldE03INQOFN =
    new CharacterField(message, HEADERSIZE + 101, 45, "E03INQOFN");
    fields[15] = fieldE03INQPRD =
    new CharacterField(message, HEADERSIZE + 146, 4, "E03INQPRD");
    fields[16] = fieldE03INQPRS =
    new CharacterField(message, HEADERSIZE + 150, 45, "E03INQPRS");
    fields[17] = fieldE03INQQTY =
    new DecimalField(message, HEADERSIZE + 195, 13, 0, "E03INQQTY");
    fields[18] = fieldE03INQPRB =
    new DecimalField(message, HEADERSIZE + 208, 17, 2, "E03INQPRB");
    fields[19] = fieldE03INQINB =
    new DecimalField(message, HEADERSIZE + 225, 17, 2, "E03INQINB");
    fields[20] = fieldE03INQPIB =
    new DecimalField(message, HEADERSIZE + 242, 17, 2, "E03INQPIB");
    fields[21] = fieldE03INQHAB =
    new DecimalField(message, HEADERSIZE + 259, 17, 2, "E03INQHAB");
    fields[22] = fieldE03INQCLS =
    new CharacterField(message, HEADERSIZE + 276, 2, "E03INQCLS");
