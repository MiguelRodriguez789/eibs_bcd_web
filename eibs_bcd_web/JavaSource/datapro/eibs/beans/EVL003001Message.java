...
* Record format level identifier is 34059F87C817C.
*/
...
public class EVL003001Message extends MessageRecord
{
  ...
  final static String rid = "34059F87C817C";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 237, 13, 0, "E01MOVINI");
    fields[18] = fieldE01MOVFIN =
    new DecimalField(message, HEADERSIZE + 250, 13, 0, "E01MOVFIN");
    fields[19] = fieldE01MOVQTY =
    new DecimalField(message, HEADERSIZE + 263, 13, 0, "E01MOVQTY");
    fields[20] = fieldE01MOVSER =
    new DecimalField(message, HEADERSIZE + 276, 13, 0, "E01MOVSER");
    fields[21] = fieldE01MOVVEN =
    new DecimalField(message, HEADERSIZE + 289, 10, 0, "E01MOVVEN");
    fields[22] = fieldE01MOVVNN =
    new CharacterField(message, HEADERSIZE + 299, 45, "E01MOVVNN");
