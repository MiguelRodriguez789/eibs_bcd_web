...
* Record format level identifier is 56EEE1EB7D2E4.
*/
...
public class EUT501501Message extends MessageRecord
{
  ...
  final static String rid = "56EEE1EB7D2E4";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 330, 5, 0, "E01CODBRN");
    fields[25] = fieldE01CODCCY =
    new CharacterField(message, HEADERSIZE + 335, 3, "E01CODCCY");
    fields[26] = fieldE01TIPPER =
    new CharacterField(message, HEADERSIZE + 338, 1, "E01TIPPER");
    fields[27] = fieldE01NUMACC =
    new DecimalField(message, HEADERSIZE + 339, 13, 0, "E01NUMACC");
