...
/**
* Class generated by AS/400 CRTCLASS command from EGC049004 physical file definition.
* 
* File level identifier is 1130611113159.
* Record format level identifier is 58B51DA788B9C.
*/

public class EGC049004Message extends MessageRecord
{
  ...
  final static String rid = "58B51DA788B9C";
  final static String fmtname = "EGC049004";
  ...
  /**
  * Constructor for EGC049004Message.
  */
  public EGC049004Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 112, 45, "E04CUSSTS");
    fields[12] = fieldE04APLCDE =
    new CharacterField(message, HEADERSIZE + 157, 2, "E04APLCDE");
    fields[13] = fieldE04FLGOPE =
    new CharacterField(message, HEADERSIZE + 159, 1, "E04FLGOPE");
    fields[14] = fieldE04CLSACC =
    new DecimalField(message, HEADERSIZE + 160, 3, 0, "E04CLSACC");
    fields[15] = fieldE04BNKNUM =
    new CharacterField(message, HEADERSIZE + 163, 2, "E04BNKNUM");
    fields[16] = fieldE04CCYCDE =
    new CharacterField(message, HEADERSIZE + 165, 3, "E04CCYCDE");
    fields[17] = fieldE04ACCTYP =
    new CharacterField(message, HEADERSIZE + 168, 4, "E04ACCTYP");
    fields[18] = fieldE04TYPDSC =
    new CharacterField(message, HEADERSIZE + 172, 45, "E04TYPDSC");
    fields[19] = fieldE04PROCDE =
    new CharacterField(message, HEADERSIZE + 217, 4, "E04PROCDE");
    fields[20] = fieldE04PRODSC =
    new CharacterField(message, HEADERSIZE + 221, 45, "E04PRODSC");
    fields[21] = fieldE04NUMOPE =
    new DecimalField(message, HEADERSIZE + 266, 4, 0, "E04NUMOPE");
    fields[22] = fieldE04BSEPRI =
    new DecimalField(message, HEADERSIZE + 270, 17, 2, "E04BSEPRI");
    fields[23] = fieldE04BSEINT =
    new DecimalField(message, HEADERSIZE + 287, 17, 2, "E04BSEINT");
    fields[24] = fieldE04BSEOTH =
    new DecimalField(message, HEADERSIZE + 304, 17, 2, "E04BSEOTH");
    fields[25] = fieldE04BSETOT =
    new DecimalField(message, HEADERSIZE + 321, 17, 2, "E04BSETOT");
    fields[26] = fieldE04INDOPE =
    new CharacterField(message, HEADERSIZE + 338, 1, "E04INDOPE");
