...
/**
* Class generated by AS/400 CRTCLASS command from EDL053102 physical file definition.
* 
* File level identifier is 1130611112918.
* Record format level identifier is 519ABB9548FFA.
*/

public class EDL053102Message extends MessageRecord
{
  ...
  final static String rid = "519ABB9548FFA";
  final static String fmtname = "EDL053102";
  ...
  /**
  * Constructor for EDL053102Message.
  */
  public EDL053102Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[9] = fieldE02USUPRD =
    new CharacterField(message, HEADERSIZE + 42, 4, "E02USUPRD");
    fields[10] = fieldE02ACTION =
    new CharacterField(message, HEADERSIZE + 46, 1, "E02ACTION");
    fields[11] = fieldE02MSGTXT =
    new CharacterField(message, HEADERSIZE + 47, 512, "E02MSGTXT");
