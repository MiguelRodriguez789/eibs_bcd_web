...
* Record format level identifier is 2A6B112BCB7A7.
*/
...
public class ESD014001Message extends MessageRecord
{
  ...
  final static String rid = "2A6B112BCB7A7";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 132, 4, "E01PRODUC");
    fields[15] = fieldE01BNKNUM =
    new CharacterField(message, HEADERSIZE + 136, 2, "E01BNKNUM");
    fields[16] = fieldE01BRANCH =
    new DecimalField(message, HEADERSIZE + 138, 5, 0, "E01BRANCH");
    fields[17] = fieldE01CURRCY =
    new CharacterField(message, HEADERSIZE + 143, 3, "E01CURRCY");
    fields[18] = fieldE01GLNUMB =
    new DecimalField(message, HEADERSIZE + 146, 17, 0, "E01GLNUMB");
    fields[19] = fieldE01ACTCLS =
    new DecimalField(message, HEADERSIZE + 163, 3, 0, "E01ACTCLS");
    fields[20] = fieldE01CSTCNT =
    new DecimalField(message, HEADERSIZE + 166, 9, 0, "E01CSTCNT");
    fields[21] = fieldE01BALAMN =
    new DecimalField(message, HEADERSIZE + 175, 17, 2, "E01BALAMN");
    fields[22] = fieldE01BTHNUM =
    new DecimalField(message, HEADERSIZE + 192, 6, 0, "E01BTHNUM");
    fields[23] = fieldE01REMARK =
    new CharacterField(message, HEADERSIZE + 198, 60, "E01REMARK");
    fields[24] = fieldE01OPETYP =
    new CharacterField(message, HEADERSIZE + 258, 2, "E01OPETYP");
    fields[25] = fieldE01OPERID =
    new CharacterField(message, HEADERSIZE + 260, 10, "E01OPERID");
    fields[26] = fieldE01FILCOD =
    new CharacterField(message, HEADERSIZE + 270, 1, "E01FILCOD");
