...
* 
* File level identifier is 1161024112158.
* Record format level identifier is 4148F72F8AA0C.
*/
...
public class EFE013001Message extends MessageRecord
{
  ...
  final static String fid = "1161024112158";
  final static String rid = "4148F72F8AA0C";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 52, 20, "E01SWDREF");
    fields[11] = fieldE01SWDCCY =
    new CharacterField(message, HEADERSIZE + 72, 3, "E01SWDCCY");
    fields[12] = fieldE01SWDACD =
    new CharacterField(message, HEADERSIZE + 75, 2, "E01SWDACD");
    fields[13] = fieldE01SWDTYP =
    new CharacterField(message, HEADERSIZE + 77, 4, "E01SWDTYP");
    fields[14] = fieldE01SWDSBT =
    new CharacterField(message, HEADERSIZE + 81, 4, "E01SWDSBT");
    fields[15] = fieldE01SWDVAL =
    new DecimalField(message, HEADERSIZE + 85, 9, 0, "E01SWDVAL");
    fields[16] = fieldE01SWDCUN =
    new DecimalField(message, HEADERSIZE + 94, 10, 0, "E01SWDCUN");
    fields[17] = fieldE01SWDAMN =
    new DecimalField(message, HEADERSIZE + 104, 17, 2, "E01SWDAMN");
    fields[18] = fieldE01SWDRA1 =
    new DecimalField(message, HEADERSIZE + 121, 13, 6, "E01SWDRA1");
    fields[19] = fieldE01SWDDSC =
    new CharacterField(message, HEADERSIZE + 134, 60, "E01SWDDSC");
    fields[20] = fieldE02ACTION =
    new CharacterField(message, HEADERSIZE + 194, 1, "E02ACTION");
    fields[21] = fieldE02MSGTXT =
    new CharacterField(message, HEADERSIZE + 195, 512, "E02MSGTXT");
