...
/**
* Class generated by AS/400 CRTCLASS command from ELC000003D physical file definition.
* 
* File level identifier is 1110303181116.
* Record format level identifier is 33B6B979A469B.
*/

public class ELC000003DMessage extends MessageRecord
{
  ...
  final static String fid = "1110303181116";
  final static String rid = "33B6B979A469B";
  final static String fmtname = "ELC000003D";
  ...
  /**
  * Constructor for ELC000003DMessage.
  */
  public ELC000003DMessage()
  {
    createFields();
    initialize();
  }
