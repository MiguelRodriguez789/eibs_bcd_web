...
/**
* Class generated by AS/400 CRTCLASS command from ETX905001 physical file definition.
* 
* File level identifier is 1130611113440.
* Record format level identifier is 3E674F45388C8.
*/

public class ETX905001Message extends MessageRecord
{
  ...
  final static String rid = "3E674F45388C8";
  final static String fmtname = "ETX905001";
  ...
  /**
  * Constructor for ETX905001Message.
  */
  public ETX905001Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 71, 1, "E01ACT");
    fields[14] = fieldE01NUMREC =
    new DecimalField(message, HEADERSIZE + 72, 8, 0, "E01NUMREC");
    fields[15] = fieldE01INDOPE =
    new CharacterField(message, HEADERSIZE + 80, 1, "E01INDOPE");
