...
/**
* Class generated by AS/400 CRTCLASS command from EWD0417DS physical file definition.
* 
* File level identifier is 1130611113508.
* Record format level identifier is 3712BB191C878.
*/

public class EWD0417DSMessage extends MessageRecord
{
  ...
  final static String rid = "3712BB191C878";
  final static String fmtname = "EWD0417DS";
  ...
  /**
  * Constructor for EWD0417DSMessage.
  */
  public EWD0417DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 4, 45, "EWDMVD");
    fields[2] = fieldEWDMVR =
    new CharacterField(message, HEADERSIZE + 49, 6, "EWDMVR");
    fields[3] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 55, 1, "EWDOPE");
