...
* Record format level identifier is 40A97E5CB45F8.
*/
...
public class EPR201001Message extends MessageRecord
{
  ...
  final static String rid = "40A97E5CB45F8";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 67, 12, 0, "E01PRPNUM");
    fields[13] = fieldE01PRPOPM =
    new DecimalField(message, HEADERSIZE + 79, 3, 0, "E01PRPOPM");
    fields[14] = fieldE01PRPOPD =
    new DecimalField(message, HEADERSIZE + 82, 3, 0, "E01PRPOPD");
    fields[15] = fieldE01PRPOPY =
    new DecimalField(message, HEADERSIZE + 85, 5, 0, "E01PRPOPY");
    fields[16] = fieldE01PRPDSC =
    new CharacterField(message, HEADERSIZE + 90, 60, "E01PRPDSC");
    fields[17] = fieldE01PRPTCY =
    new CharacterField(message, HEADERSIZE + 150, 3, "E01PRPTCY");
    fields[18] = fieldE01PRPAMT =
    new DecimalField(message, HEADERSIZE + 153, 17, 2, "E01PRPAMT");
    fields[19] = fieldE01PRPCAC =
    new DecimalField(message, HEADERSIZE + 170, 13, 0, "E01PRPCAC");
    fields[20] = fieldE01PRPPVI =
    new CharacterField(message, HEADERSIZE + 183, 1, "E01PRPPVI");
    fields[21] = fieldE01PRPORD =
    new CharacterField(message, HEADERSIZE + 184, 45, "E01PRPORD");
    fields[22] = fieldE01PRPBNF =
    new CharacterField(message, HEADERSIZE + 229, 45, "E01PRPBNF");
