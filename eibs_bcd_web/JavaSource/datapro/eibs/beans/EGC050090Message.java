...
* Record format level identifier is 3D3C3A86B278A.
*/
...
public class EGC050090Message extends MessageRecord
{
  ...
  final static String rid = "3D3C3A86B278A";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 46, 25, "E90GCRUT");
    fields[11] = fieldE90GCNMBC =
    new CharacterField(message, HEADERSIZE + 71, 45, "E90GCNMBC");
    fields[12] = fieldE90GCNOPR =
    new DecimalField(message, HEADERSIZE + 116, 6, 0, "E90GCNOPR");
    fields[13] = fieldE90GCGSLN =
    new CharacterField(message, HEADERSIZE + 122, 1, "E90GCGSLN");
    fields[14] = fieldE90GCGMDA =
    new CharacterField(message, HEADERSIZE + 123, 3, "E90GCGMDA");
    fields[15] = fieldE90GCMAUT =
    new DecimalField(message, HEADERSIZE + 126, 17, 2, "E90GCMAUT");
    fields[16] = fieldE90GCMDSP =
    new DecimalField(message, HEADERSIZE + 143, 17, 2, "E90GCMDSP");
    fields[17] = fieldE90GCFAPY =
    new DecimalField(message, HEADERSIZE + 160, 5, 0, "E90GCFAPY");
    fields[18] = fieldE90GCFAPM =
    new DecimalField(message, HEADERSIZE + 165, 3, 0, "E90GCFAPM");
    fields[19] = fieldE90GCFAMD =
    new DecimalField(message, HEADERSIZE + 168, 3, 0, "E90GCFAMD");
    fields[20] = fieldE90GCVENY =
    new DecimalField(message, HEADERSIZE + 171, 5, 0, "E90GCVENY");
    fields[21] = fieldE90GCVENM =
    new DecimalField(message, HEADERSIZE + 176, 3, 0, "E90GCVENM");
    fields[22] = fieldE90GCVEND =
    new DecimalField(message, HEADERSIZE + 179, 3, 0, "E90GCVEND");
    fields[23] = fieldE90GCSLML =
    new DecimalField(message, HEADERSIZE + 182, 6, 0, "E90GCSLML");
    fields[24] = fieldE90INDOPE =
    new CharacterField(message, HEADERSIZE + 188, 1, "E90INDOPE");
