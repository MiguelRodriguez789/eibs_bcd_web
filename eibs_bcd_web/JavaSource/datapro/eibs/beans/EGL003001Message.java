...
* Record format level identifier is 2F0A21BBB63C4.
*/
...
public class EGL003001Message extends MessageRecord
{
  ...
  final static String rid = "2F0A21BBB63C4";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 44, 6, 0, "E01BTHNUM");
    fields[11] = fieldE01RUNDT1 =
    new DecimalField(message, HEADERSIZE + 50, 3, 0, "E01RUNDT1");
    fields[12] = fieldE01RUNDT2 =
    new DecimalField(message, HEADERSIZE + 53, 3, 0, "E01RUNDT2");
    fields[13] = fieldE01RUNDT3 =
    new DecimalField(message, HEADERSIZE + 56, 5, 0, "E01RUNDT3");
    fields[14] = fieldE01TOTDEB =
    new DecimalField(message, HEADERSIZE + 61, 17, 2, "E01TOTDEB");
    fields[15] = fieldE01TOTCRE =
    new DecimalField(message, HEADERSIZE + 78, 17, 2, "E01TOTCRE");
    fields[16] = fieldE01TOTTRN =
    new DecimalField(message, HEADERSIZE + 95, 8, 0, "E01TOTTRN");
    fields[17] = fieldE01ACTION =
    new CharacterField(message, HEADERSIZE + 103, 1, "E01ACTION");
    fields[18] = fieldE01USERID =
    new CharacterField(message, HEADERSIZE + 104, 10, "E01USERID");
