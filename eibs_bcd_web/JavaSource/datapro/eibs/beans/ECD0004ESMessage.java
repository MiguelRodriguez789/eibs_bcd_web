...
/**
* Class generated by AS/400 CRTCLASS command from ECD0004ES physical file definition.
* 
* File level identifier is 1130611112842.
* Record format level identifier is 4234E977B38D2.
*/

public class ECD0004ESMessage extends MessageRecord
{
  ...
  final static String rid = "4234E977B38D2";
  final static String fmtname = "ECD0004ES";
  ...
  private CharacterField fieldE04CDRAPL = null;
  ...
  /**
  * Constructor for ECD0004ESMessage.
  */
  public ECD0004ESMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[26] = fieldE04CDRAPL =
    new CharacterField(message, HEADERSIZE + 237, 1, "E04CDRAPL");
    fields[27] = fieldE04CDRFEE =
    new CharacterField(message, HEADERSIZE + 238, 4, "E04CDRFEE");
    fields[28] = fieldE04CDRFED =
    new CharacterField(message, HEADERSIZE + 242, 45, "E04CDRFED");
    fields[29] = fieldE04CDRFFE =
    new DecimalField(message, HEADERSIZE + 287, 5, 0, "E04CDRFFE");
    fields[30] = fieldE04CDRISA =
    new CharacterField(message, HEADERSIZE + 292, 4, "E04CDRISA");
    fields[31] = fieldE04CDRACC =
    new DecimalField(message, HEADERSIZE + 296, 21, 0, "E04CDRACC");
    fields[32] = fieldE04CDRGLN =
    new CharacterField(message, HEADERSIZE + 317, 20, "E04CDRGLN");
    fields[33] = fieldE04CDRUSR =
    new CharacterField(message, HEADERSIZE + 337, 10, "E04CDRUSR");
    fields[34] = fieldE04CDRDAY =
    new DecimalField(message, HEADERSIZE + 347, 3, 0, "E04CDRDAY");
    fields[35] = fieldE04CDRMON =
    new DecimalField(message, HEADERSIZE + 350, 3, 0, "E04CDRMON");
    fields[36] = fieldE04CDRYEA =
    new DecimalField(message, HEADERSIZE + 353, 5, 0, "E04CDRYEA");
    fields[37] = fieldE04CDRTIM =
    new DecimalField(message, HEADERSIZE + 358, 7, 0, "E04CDRTIM");
  ...
  */
  ...
  /**
  * Set field E04CDRAPL using a String value.
  */
  public void setE04CDRAPL(String newvalue)
  {
    fieldE04CDRAPL.setString(newvalue);
  }

  /**
  * Get value of field E04CDRAPL as a String.
  */
  public String getE04CDRAPL()
  {
    return fieldE04CDRAPL.getString();
  }
