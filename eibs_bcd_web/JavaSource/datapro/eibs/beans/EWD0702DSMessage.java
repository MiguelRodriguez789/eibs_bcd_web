...
* Record format level identifier is 65C9926B5E969.
*/
...
public class EWD0702DSMessage extends MessageRecord
{
  ...
  final static String rid = "65C9926B5E969";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 15, 45, "EWDNOM");
    fields[5] = fieldEWDNDI =
    new DecimalField(message, HEADERSIZE + 60, 3, 0, "EWDNDI");
    fields[6] = fieldEWDLEX =
    new CharacterField(message, HEADERSIZE + 63, 1, "EWDLEX");
    fields[7] = fieldEWDREC =
    new DecimalField(message, HEADERSIZE + 64, 8, 0, "EWDREC");
