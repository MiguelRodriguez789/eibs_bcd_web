...
* Record format level identifier is 5427435D2B342.
*/
...
public class EVL002003Message extends MessageRecord
{
  ...
  final static String rid = "5427435D2B342";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 199, 13, 0, "E03BALBAL");
    fields[20] = fieldE03BALAIN =
    new DecimalField(message, HEADERSIZE + 212, 13, 0, "E03BALAIN");
    fields[21] = fieldE03BALAFI =
    new DecimalField(message, HEADERSIZE + 225, 13, 0, "E03BALAFI");
    fields[22] = fieldE03BALAQT =
    new DecimalField(message, HEADERSIZE + 238, 13, 0, "E03BALAQT");
    fields[23] = fieldE03BALMOT =
    new CharacterField(message, HEADERSIZE + 251, 4, "E03BALMOT");
    fields[24] = fieldE03BALMON =
    new CharacterField(message, HEADERSIZE + 255, 45, "E03BALMON");
