...
* Record format level identifier is 36AAD5208B3C6.
*/
...
public class EWD0405DSMessage extends MessageRecord
{
  ...
  final static String rid = "36AAD5208B3C6";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 10, 17, 0, "EWDSGL");
    fields[4] = fieldEWDSCA =
    new CharacterField(message, HEADERSIZE + 27, 2, "EWDSCA");
    fields[5] = fieldEWDSTY =
    new CharacterField(message, HEADERSIZE + 29, 4, "EWDSTY");
    fields[6] = fieldEWDBNK =
    new CharacterField(message, HEADERSIZE + 33, 2, "EWDBNK");
    fields[7] = fieldEWDBRN =
    new DecimalField(message, HEADERSIZE + 35, 5, 0, "EWDBRN");
    fields[8] = fieldEWDCCY =
    new CharacterField(message, HEADERSIZE + 40, 3, "EWDCCY");
    fields[9] = fieldEWDGLN =
    new DecimalField(message, HEADERSIZE + 43, 17, 0, "EWDGLN");
    fields[10] = fieldEWDACC =
    new DecimalField(message, HEADERSIZE + 60, 13, 0, "EWDACC");
    fields[11] = fieldEWDDSC =
    new CharacterField(message, HEADERSIZE + 73, 60, "EWDDSC");
    fields[12] = fieldEWDCLS =
    new DecimalField(message, HEADERSIZE + 133, 3, 0, "EWDCLS");
    fields[13] = fieldEWDATY =
    new CharacterField(message, HEADERSIZE + 136, 4, "EWDATY");
    fields[14] = fieldEWDACD =
    new CharacterField(message, HEADERSIZE + 140, 2, "EWDACD");
    fields[15] = fieldEWDREC =
    new DecimalField(message, HEADERSIZE + 142, 8, 0, "EWDREC");
    fields[16] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 150, 1, "EWDOPE");
