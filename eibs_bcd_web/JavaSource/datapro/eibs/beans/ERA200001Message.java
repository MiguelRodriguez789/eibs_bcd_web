...
/**
* Class generated by AS/400 CRTCLASS command from ERA200001 physical file definition.
* 
* File level identifier is 1140715172412.
* Record format level identifier is 533EEA33D1967.
*/

public class ERA200001Message extends MessageRecord
{
  ...
  final static String fid = "1140715172412";
  final static String rid = "533EEA33D1967";
  final static String fmtname = "ERA200001";
  ...
  /**
  * Constructor for ERA200001Message.
  */
  public ERA200001Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[9] = fieldE01CNORCD =
    new CharacterField(message, HEADERSIZE + 42, 4, "E01CNORCD");
    fields[10] = fieldE01CNODSC =
    new CharacterField(message, HEADERSIZE + 46, 45, "E01CNODSC");
    fields[11] = fieldE01CNOSCG =
    new DecimalField(message, HEADERSIZE + 91, 17, 0, "E01CNOSCG");
    fields[12] = fieldE01CNOSCY =
    new CharacterField(message, HEADERSIZE + 108, 3, "E01CNOSCY");
    fields[13] = fieldE01CNODCC =
    new CharacterField(message, HEADERSIZE + 111, 2, "E01CNODCC");
    fields[14] = fieldE01CNOOPE =
    new CharacterField(message, HEADERSIZE + 113, 1, "E01CNOOPE");
