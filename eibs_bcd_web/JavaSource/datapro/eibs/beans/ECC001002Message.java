...
* Record format level identifier is 541338C58C295.
*/
...
public class ECC001002Message extends MessageRecord
{
  ...
  final static String rid = "541338C58C295";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 129, 1, "E02CCMAST");
    fields[14] = fieldE02CCMLSM =
    new DecimalField(message, HEADERSIZE + 130, 3, 0, "E02CCMLSM");
    fields[15] = fieldE02CCMLSD =
    new DecimalField(message, HEADERSIZE + 133, 3, 0, "E02CCMLSD");
    fields[16] = fieldE02CCMLSY =
    new DecimalField(message, HEADERSIZE + 136, 5, 0, "E02CCMLSY");
    fields[17] = fieldF02CCMAST =
    new CharacterField(message, HEADERSIZE + 141, 1, "F02CCMAST");
    fields[18] = fieldF02CCMLSM =
    new CharacterField(message, HEADERSIZE + 142, 1, "F02CCMLSM");
    fields[19] = fieldF02CCMLSD =
    new CharacterField(message, HEADERSIZE + 143, 1, "F02CCMLSD");
    fields[20] = fieldF02CCMLSY =
    new CharacterField(message, HEADERSIZE + 144, 1, "F02CCMLSY");
