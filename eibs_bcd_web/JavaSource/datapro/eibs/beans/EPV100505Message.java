...
/**
* Class generated by AS/400 CRTCLASS command from EPV100505 physical file definition.
* 
* File level identifier is 1130611113304.
* Record format level identifier is 449EB27408C38.
*/

public class EPV100505Message extends MessageRecord
{
  ...
  final static String fmtname = "EPV100505";
  ...
  /**
  * Constructor for EPV100505Message.
  */
  public EPV100505Message()
  {
    createFields();
    initialize();
  }
