...
* Record format level identifier is 3AB35220917B1.
*/
...
public class ESWF20002Message extends MessageRecord
{
  ...
  final static String rid = "3AB35220917B1";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 10, 25, "ESW2SWI");
    fields[2] = fieldESW2REF =
    new CharacterField(message, HEADERSIZE + 35, 16, "ESW2REF");
    fields[3] = fieldESW2FTM =
    new DecimalField(message, HEADERSIZE + 51, 4, 0, "ESW2FTM");
    fields[4] = fieldESW2DT1 =
    new DecimalField(message, HEADERSIZE + 55, 3, 0, "ESW2DT1");
    fields[5] = fieldESW2DT2 =
    new DecimalField(message, HEADERSIZE + 58, 3, 0, "ESW2DT2");
    fields[6] = fieldESW2DT3 =
    new DecimalField(message, HEADERSIZE + 61, 5, 0, "ESW2DT3");
    fields[7] = fieldESW2REC =
    new CharacterField(message, HEADERSIZE + 66, 1750, "ESW2REC");
