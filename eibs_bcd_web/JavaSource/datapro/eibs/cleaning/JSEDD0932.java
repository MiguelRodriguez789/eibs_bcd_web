	...
	if (session == null) {
		...
		try {
			...
			if (screen == R_ENTER) {
				...
				mc = new MessageContext(super.getMessageHandler("EDD0932", req));
...
protected void procActionEnter(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		// all the fields here
	 	try {
				msgLOAD.setE01CNTFEM(req.getParameter("E01CNTFEM"));
		} catch (Exception e) {
				msgLOAD.setE01CNTFEM("0");
		}
		try {
				msgLOAD.setE01CNTFED(req.getParameter("E01CNTFED"));
		} catch (Exception e) {
				msgLOAD.setE01CNTFED("0");
		}
		try {
				msgLOAD.setE01CNTFEY(req.getParameter("E01CNTFEY"));
		} catch (Exception e) {
				msgLOAD.setE01CNTFEY("0");
		}
	 	msgLOAD.send();
	 	msgLOAD.destroy();
	}		
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("EDD093202")) {
			...
			if (IsNotError) {  // There are no errors
				//date of process
				userPO.setHeader10(req.getParameter("E01CNTFEM"));
				userPO.setHeader11(req.getParameter("E01CNTFED"));
				userPO.setHeader12(req.getParameter("E01CNTFEY"));
...
protected void procActionLoad(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		try {
				msgLOAD.setE03CNTFEM(req.getParameter("E03CNTFEM"));
		} catch (Exception e) {
				msgLOAD.setE03CNTFEM("0");
		}
		try {
				msgLOAD.setE03CNTFED(req.getParameter("E03CNTFED"));
		} catch (Exception e) {
				msgLOAD.setE03CNTFED("0");
		}
		try {
				msgLOAD.setE03CNTFEY(req.getParameter("E03CNTFEY"));
		} catch (Exception e) {
				msgLOAD.setE03CNTFEY("0");
		}
	 	try {
