				...
				ses.setAttribute("userPO", userPO);
					...
					while (true) {
						...
						if (marker.equals("*")) {
							...
							myRow.append("<TD NOWRAP  ALIGN=CENTER width=\"40%\">" + Util.formatCustomDate(user.getE01DTF(), msgList.getE02PVMOPM(),msgList.getE02PVMOPD(),msgList.getE02PVMOPY()) + "</td>");
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EPV5000", req));
