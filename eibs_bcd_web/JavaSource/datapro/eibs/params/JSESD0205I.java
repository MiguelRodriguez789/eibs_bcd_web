...
public class JSESD0205I extends datapro.eibs.master.SuperServlet {
	...
	protected void procReqInquiry(
		...
		try {
				...
				mc1 =
					new MessageContext(super.getMessageHandler("EDD0000", req));
		...
		{
				e.printStackTrace();
				flexLog("Socket not Open(" + mc1.toString()+ "). Error: " + e);
		...
		try {
			...
			msgDoc.setH02OPECOD("0003");
			
			try{
				msgDoc.setE02RTECUN(msgRT1.getE01ACMCUN());
			} catch (Exception e) {}	
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		if (session == null) {
			...
			try {
				...
				try {
					flexLog("Opennig Socket Connection");
					mc = new MessageContext(super.getMessageHandler("ESD0205", req));
