...
public class JSESD0009 extends datapro.eibs.master.SuperServlet {
	...
	protected void procActionPos(
		...
		switch (inptOPT) {
			case 1 : //New
				res.sendRedirect(
					super.srctx
						+ "/servlet/datapro.eibs.params.JSESD0009?SCREEN=300" +"&TAXCODE=" + taxcode);
				break;
			case 2 : //Maintenance
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000901")) {
				...
				if (IsNotError) { // There are no errors
					res.sendRedirect(
						super.srctx
							+ "/servlet/datapro.eibs.params.JSESD0009?SCREEN=100" 
	...
	protected void procReqMaintenance(
		...
		try {
			...
			int screencode = Integer.parseInt(msgDoc.getE01TAXTTP());
	...
	private String getRedirectPage(int screencode) {
		...
		switch (screencode) {
			...
			case 500 : //IVA Commissions
			case 501 : //IVA Interest
			case 502 : //IVA Late Charges
			case 503 : //IVA deductions
				try {
					flexLog(
						"About to call Page: "
							+ LangPath
			...
			case 600 : //FECI
				try {
					flexLog(
						"About to call Page: "
							+ LangPath
							+ "ESD0009_taxes_600_feci.jsp");
					ret = LangPath + "ESD0009_taxes_600_feci.jsp";
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
				break;

			case 601 : //Overdraft Paraguay
			case 602 : //ITE
			case 605 : //Taxes Paraguay
			case 606 : //Taxes Paraguay
				try {
					flexLog(
						"About to call Page: "
							+ LangPath
							+ "ESD0009_taxes_601_ite_overdraft.jsp");
					ret = LangPath + "ESD0009_taxes_601_ite_overdraft.jsp";
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
				break;
			...
			case 603 : //ALADI
				try {
					flexLog(
						"About to call Page: "
							+ LangPath
							+ "ESD0009_taxes_603_aladi.jsp");
					ret = LangPath + "ESD0009_taxes_603_aladi.jsp";
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
				break;

			case 604 : //Taxes CheckBook
				try {
					flexLog(
						"About to call Page: "
							+ LangPath
							+ "ESD0009_taxes_604_taxes_checkbook.jsp");
					ret = LangPath + "ESD0009_taxes_604_taxes_checkbook.jsp";
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
				break;

			case 700 : //Financial Leasing
				try {
					flexLog(
						"About to call Page: "
							+ LangPath
			...
			case 800 : //Customer debit
			case 801 : //Bank debit
				try {
					flexLog(
						"About to call Page: "
							+ LangPath
							+ "ESD0009_taxes_800_bank_debit.jsp");
					ret = LangPath + "ESD0009_taxes_800_bank_debit.jsp";
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
				break;
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("ESD0009", req));
