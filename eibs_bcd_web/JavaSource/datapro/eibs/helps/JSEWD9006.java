// ATM Help  
// Source File Name:   JSEWD9006.java 
...
public class JSEWD9006 extends JSEIBSServlet {
	...
	protected void reqList(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		UserPos userPO = null;
		try {
			mp = new MessageProcessor("EWD9006");				
			EWD9006DSMessage msg = (EWD9006DSMessage) mp.getMessageRecord("EWD9006DS");
			...
			try {
            	msg.setSWDTID(req.getParameter("SelNew"));
            } catch (Exception e) { }
			...
			userPO.setHeader18(msg.getSWDTID().trim());
			...
			forward("EWD9006_atm_helpmessage.jsp", req, res);
