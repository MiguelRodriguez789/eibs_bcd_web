...
import datapro.eibs.beans.EWD0113DSMessage;
 ...
 */
public class JSEWD0113 extends JSEIBSServlet {
	...
	private void main(ESS0030DSMessage user, HttpServletRequest req,
		...
		try {
			mp = getMessageProcessor("EWD0113", req);
			EWD0113DSMessage msgHelp = (EWD0113DSMessage) mp.getMessageRecord("EWD0113DS");
			...
			if (mp.hasError(list)) {
				...
				while (list.getNextRow()) {
					msgHelp = (EWD0113DSMessage) list.getRecord();
				...
				pageName = "EWD0113_insurance_par_table_helpmessage.jsp";
			}
