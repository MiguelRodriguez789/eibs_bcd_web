// ATM Help  
// Source File Name:   JSEWD9005.java 
...
public class JSEWD9005 extends JSEIBSServlet {
	...
	protected void reqList(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		UserPos userPO = null;
		try {
			mp = new MessageProcessor("EWD9005");				
			EWD9005DSMessage msg = (EWD9005DSMessage) mp.getMessageRecord("EWD9005DS");
			...
			try {
            	msg.setSWCTID(req.getParameter("SelNew"));
            } catch (Exception e) { }
			...
			userPO.setHeader18(msg.getSWCTID().trim());
			...
			forward("EWD9005_teller_tlmst_helpmessage.jsp", req, res);
