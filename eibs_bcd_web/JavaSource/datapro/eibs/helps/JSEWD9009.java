// Pan Virtual Help  
// Source File Name:   JSEWD9009.java 
...
public class JSEWD9009 extends JSEIBSServlet {
	...
	protected void reqList(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		UserPos userPO = null;
		try {
			mp = new MessageProcessor("EWD9009");				
			EWD9009DSMessage msg = (EWD9009DSMessage) mp.getMessageRecord("EWD9009DS");
			...
			forward("EWD9009_virtual_pan_helpmessage.jsp", req, res);
