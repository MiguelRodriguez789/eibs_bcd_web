 ...
 */
public class JSEWD0413 extends JSEIBSServlet {
	...
	private void main(ESS0030DSMessage user, HttpServletRequest req,
		...
		try {
			...
			if (mp.hasError(list)) {
					...
					myRow.append(
						...
						myRow.append(
							"<TD NOWRAP  ALIGN=CENTER><a href=\"javascript:enter('"
								+ msgHelp.getEWDNUM()
								+ "')\">"
								+ Util.formatCustomDate(user.getE01DTF(),msgHelp.getEWDDAS(), msgHelp.getEWDMOS(), msgHelp.getEWDYES())
								+ "</a></td>");
						myRow.append(
							"<TD NOWRAP  ALIGN=CENTER><a href=\"javascript:enter('"
								+ msgHelp.getEWDNUM()
				...
				pageName = "EWD0413_cc_helpmessage.jsp";
			}
