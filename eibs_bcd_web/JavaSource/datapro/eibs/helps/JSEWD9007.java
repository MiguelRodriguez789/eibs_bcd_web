// Centro de Canje Help  
// Source File Name:   JSEWD9007.java 
...
public class JSEWD9007 extends JSEIBSServlet {
	...
	protected void reqList(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		UserPos userPO = null;
		try {
			mp = new MessageProcessor("EWD9007");				
			EWD9007DSMessage msg = (EWD9007DSMessage) mp.getMessageRecord("EWD9007DS");
			...
			try {
            	msg.setSWDCLB(req.getParameter("SelNew"));
            } catch (Exception e) { }
			...
			userPO.setHeader18(msg.getSWDCLB().trim());
			...
			forward("EWD9007_canje_centrocanje_helpmessage.jsp", req, res);
