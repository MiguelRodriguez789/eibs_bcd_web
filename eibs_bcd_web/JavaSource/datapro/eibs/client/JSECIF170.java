		...
		if (newmessage.getFormatName().equals("ELEERR")) {
			...
			while (true) {
				...
				if (marker.equals("*")) {
					...
					myRow.append("<TD NOWRAP>" + Util.formatCustomDate(user.getE01DTF(), msgList.getE05OPEDTM(), msgList.getE05OPEDTD(), msgList.getE05OPEDTY()) + "</TD>");
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("ECIF170", req));
