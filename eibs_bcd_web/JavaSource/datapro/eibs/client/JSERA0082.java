...
public class JSERA0082 extends datapro.eibs.master.SuperServlet {
	...
	protected void procGetYear(MessageContext mc, ESS0030DSMessage user,
		...
		try {
			flexLog("About to call Page: " + LangPath
					+ "ERA0082_valuation_index_enter.jsp");
			callPage(LangPath + "ERA0082_valuation_index_enter.jsp", req, res);
		} catch (Exception e) {
	...
	try {
		...
		mL0082.setH01OPECOD("0015");
		if(typec.equals("D")){
			   mL0082.setH01FLGWK1(typec);
		}
		if(req.getParameter("E01TB2YEA")!=null){
			   mL0082.setE01TB2YEA(req.getParameter("E01TB2YEA"));
		   }
		if(typec.equals("C")){
			   mL0082.setE01TB2DPT(req.getParameter("E01TB2DPT"));
			   userPO.setHeader21(req.getParameter("E01TB2DPT"));
			   userPO.setHeader22(req.getParameter("D01TB2DPT"));
		}
		mL0082.send();
		mL0082.destroy();
	...
	try {
	  ...
	  if (newmessage.getFormatName().equals("ERA008201")) {
				...
				while (true) {
					...
					if(typec.equals("D")){
						dpto = mL0082.getE01TB2DPT();
					}
					if(typec.equals("C")){
						dpto = mL0082.getE01TB2CTY();
					}
					if (marker.equals("*")) {
						break;
					} else {
					...
					if (msgError.getERRNUM().equals("0")) {
						if(typec.equals("D")){
							flexLog(
									"About to call Page: "
									+ LangPath
									+ "ERA0082_modules_list.jsp");
							callPage(LangPath + "ERA0082_valuation_index_depto_list.jsp?ROW=" + idxAcc, req, res);
						}
						if(typec.equals("C")){
							flexLog(
									"About to call Page: "
									+ LangPath
									+ "ERA0082_modules_list.jsp");
							callPage(LangPath + "ERA0082_valuation_index_city_list.jsp?ROW=" + idxAcc, req, res);
						}
					} else {
						//By error
						flexLog(
						...
						+ "ERA0082_valuation_index_enter.jsp");
						 callPage(
						LangPath + "ERA0082_valuation_index_enter.jsp",
						req,
						 res);
...
protected void procUpdAcc(
	...
	if(req.getParameter("RECNUM")!=null){
			...
			try {
				...
				if (newmessage.getFormatName().equals("ELEERR")) {
					...
					try {
						...
						flexLog("About to call Page: " + LangPath + "ERA0082_valuation_index_depto_list.jsp");
						callPage(LangPath + "ERA0082_valuation_index_depto_list.jsp?ROW=" + iw, req, res);
		   ...
		   res.sendRedirect(
			   super.srctx
				   + "/servlet/datapro.eibs.client.JSERA0082?SCREEN=200&E01TB2YEA="+userPO.getHeader20()+"&H01FLGWK1="+req.getParameter("H01FLGWK1")+"&E01TB2DPT="+req.getParameter("E01TB2DPT")+"&D01TB2DPT="+req.getParameter("D01TB2DPT")+"&CONFIRM=Y");
