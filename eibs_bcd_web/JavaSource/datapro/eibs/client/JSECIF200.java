...
*/
						...
						if (marker.equals("*")) {
							...
							myRow.append("<TD NOWRAP  ALIGN=CENTER>" + Util.formatCustomDate( user.getE01DTF(), msgList.getE02DEAMDM(),msgList.getE02DEAMDD(),msgList.getE02DEAMDY()) + "</td>"); //Fecha de Vencimiento																																									
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("ECIF200", req));
