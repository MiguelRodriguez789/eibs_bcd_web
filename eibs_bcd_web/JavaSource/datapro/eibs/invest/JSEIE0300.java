...
public class JSEIE0300 extends datapro.eibs.master.SuperServlet {
	...
	protected void procReqListPortfolios(
		...
		try {
			...
			try { // Search By Customer
				...
				msgList.setE01PRFCUN(userPO.getCusNum());
			}
			
			try { // Historical/Outstanding
				msgList.setH01FLGWK1(req.getParameter("H01FLGWK1"));
				...
				if (newmessage.getFormatName().equals("EIE030001")) {
					...
					while (true) {
						...
						if (marker.equals("*")) {
							...
							userPO.setHeader16(msgList.getH01FLGWK1());
							break;
						} else {
	...
	protected void procReqListOpen(
		...
		try {
			...
			try { // Historical/Outstanding
				msgList.setH02FLGWK1(userPO.getHeader16());
					...
					while (true) {
						...
						if (marker.equals("*")) {
							...
							myRow.append("<TD NOWRAP  ALIGN=RIGHT><input type=\"radio\" name=\"PORTF\" value=\""
							 ...
							 myRow.append("<TD NOWRAP  ALIGN=RIGHT><img src=\"../images/pledge.gif\" title=\"Pledge\" align=\"absmiddle\" border=\"0\" ><input type=\"radio\" name=\"PORTF\" value=\""
								+ msgList.getE02PRFCUN()
								+ "\" "
								+ chk
								+ " onclick=\"getParams('"
						    ...
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT>" + Util.fcolorCCY(msgList.getE02CURMKV()) + "</td>");
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT>" + Util.fcolorCCY(msgList.getE02CURIAL()) + "</td>");
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT>" + Util.fcolorCCY(msgList.getE02CURINV()) + "</td>");
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT>" + Util.formatCell(msgList.getE02CURDYS()) + "</td>"); 
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT bgcolor=\"#FFFFFF\">" + Util.fcolorCCY(msgList.getE02PURPRI()) + "</td>"); 
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT bgcolor=\"#FFFFFF\">" + Util.fcolorCCY(msgList.getE02TOTINV()) + "</td>");
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT bgcolor=\"#FFFFFF\">" + Util.fcolorCCY(msgList.getE02TOTIAL()) + "</td>");
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT bgcolor=\"#FFFFFF\">" + Util.fcolorCCY(msgList.getE02TOTPUR()) + "</td>");
						    myRow.append("<TD NOWRAP  ALIGN=CENTER bgcolor=\"#FFFFFF\" >" + Util.formatDate(msgList.getE02LSTPU1(),msgList.getE02LSTPU2(),msgList.getE02LSTPU3()) + "</td>");
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT>" + Util.formatCell(msgList.getE02INCOME()) + "</td>");  
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT>" + Util.formatCell(msgList.getE02YIELD()) + "</td>");
						    myRow.append("<TD NOWRAP  ALIGN=RIGHT>" + Util.formatCell(msgList.getE02FXRTE()) + "</td>");
						    myRow.append("<TD NOWRAP  ALIGN=CENTER>" + Util.formatCell(Frec) + "</td>");
	...
	protected void procReqListTransact(
		...
		try {
			...
			try { // Historical/Outstanding
				msgList.setH03FLGWK1(userPO.getHeader16());
