	  	...
	  	if (newmessage.getFormatName().equals("ELEERR")) {
			...
			while (true) {
				...
				if (marker.equals("*")) {
					...
					chkWarn = (msgList.getH01FLGWK2().equals("A") ? "<a href=\"javascript:showInqWarn('" + msgList.getE01ISIIIC() + "')\"><img src=\"../images/warning01.gif\" title=\"Warnings\" align=\"absmiddle\" border=\"0\" ></a>" : "");
					...
					myRow.append(Util.formatDate(msgList.getE01ISIMAD(),msgList.getE01ISIMAM(),msgList.getE01ISIMAY()) + "\"></TD>");				
					myRow.append("</TR>");
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("EIE0051", req));
