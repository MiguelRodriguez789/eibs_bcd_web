...
public class JSEIBSProp {
	private static Properties eibsProp; 
	...
	// PARAMETERS FOR IMAGE EXCHANGE
	private static String fieldImgExportPath,
						  fieldImgImportPath,
						  fieldExcel;
	
//	 Parameters for Report Generator
	private static String fieldRepGenURL;
	private static String fieldRepGenID;
...
private static String completeDirectoryPath(String path) {
	return
		path.equals("") || path.endsWith(File.separator) || path.endsWith("/") 
		? path 
		: path + File.separator;
}
/**
...
public static String getFtpFormClientClass() {
	if (fieldFtpFormClientClass == null) initProperties();
	return fieldFtpFormClientClass;
}
...
public static String getFtpPathFormConfig() {
	...
	return completeDirectoryPath(fieldFtpPathFormConfig);
}
...
public static void initProperties() throws MissingResourceException {
	...
	try {
		...
		try {
			fieldActiveX = eIBSProperties.getString("eIBS.ActiveX");
		}
		catch (Exception e) {
			fieldActiveX = "false";
		}
		...
		//ACH Draft
		try {
			fieldACHDraft = eIBSProperties.getString("eIBS.ACHDraft");
		}
		catch (Exception e) {
			fieldACHDraft = "";
		}
		//ACH Pre-Note
		try {
			fieldACHPreNote = eIBSProperties.getString("eIBS.ACHPreNote");
		}
		catch (Exception e) {
			fieldACHPreNote = "";
		}
		//ftpACHUser
		try {
			fieldftpACHUser = eIBSProperties.getString("eIBS.ftpACHUser");
		}
		catch (Exception e) {
			fieldftpACHUser = "";
		}
		//ftpACHPassword
		try {
			fieldftpACHPassword = eIBSProperties.getString("eIBS.ftpACHPassword");
		}
		catch (Exception e) {
			fieldftpACHPassword = "";			
		}	
		...
		try {
			fieldFtpFormClientClass = eIBSProperties.getString("eIBS.form.ftpClientClass");
		}
		catch (Exception e) {
			fieldFtpFormClientClass = "";
		}
		...
		try {
			fieldBranchURL = eIBSProperties.getString("eIBS.Branch.URL");
		}
		catch (Exception e) {
			fieldBranchURL = "";
		}
		...
		try {
			fieldExcel = eIBSProperties.getString("eIBS.Excel");
		} catch (Exception e) {
			fieldExcel = "xls";
		}
...
//		 Report Generator
		...
		if(null != eIBSProperties){
			eibsProp = convertResourceBundleToProperties(eIBSProperties);
		}
...
public static void setFtpFormClientClass(String ftpClientClass) {
	fieldFtpFormClientClass = ftpClientClass;
}
...
public static String getActiveX() {
	if (fieldActiveX == null) initProperties();
	return fieldActiveX;
}
...
public static String getACHDraft() {
	if (fieldACHDraft == null) initProperties();
	return fieldACHDraft;
}

public static void setACHDraft(String newACHDraft) {
	fieldACHDraft = newACHDraft;
}

public static String getACHPreNote() {
	if (fieldACHPreNote == null) initProperties();
	return fieldACHPreNote;
}

public static void setACHPreNote(String newACHPreNote) {
	fieldACHPreNote = newACHPreNote;
}

public static String getftpACHUser() {
	if (fieldftpACHUser == null) initProperties();
	return fieldftpACHUser;
}

public static void setftpACHUser(String newftpACHUser) {
	fieldftpACHUser = newftpACHUser;
}

public static String getftpACHPassword() {
	if (fieldftpACHPassword == null) initProperties();
	return fieldftpACHPassword;
}

public static void setftpACHPassword(String newftpACHPassword) {
	fieldftpACHPassword = newftpACHPassword;
}
//----------- Logo File (Added by HG 11/02/2006) -------------
...
public static void setSessionPluginClass(String sessionPluginClass) {
	...
	public static String getBranchURL() {
		if (fieldBranchURL == null) initProperties();
		return fieldBranchURL ;
	}

	public static void setBranchURL(String branchURL) {
		fieldBranchURL = branchURL;
	}

	public static String getExcelFormat() {
		if (fieldExcel == null) initProperties();
		return fieldExcel;
	}
	public static void setExcelFormat(String excel) {
		fieldExcel = excel;
	}
	...
	public static void setRepGenURL(String rgURL) {
		fieldRepGenURL = rgURL;
	}
	...
	public static String getProperty(String attr) {
		...
		return null != eibsProp ? eibsProp.getProperty(attr) : null;
	 }
