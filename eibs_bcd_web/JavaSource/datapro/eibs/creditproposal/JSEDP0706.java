...
public class JSEDP0706 extends datapro.eibs.master.SuperServlet {
	...
	protected void procReqFilter(
		...
		//RETRIEVE PARAMETERS - OPTION FOR GUARANTY=1 OR ADDITIONAL OPERATION=2
		...
		try {
			...
			flexLog(
				"About to call Page: "
					+ LangPath
					+ "EDP0706_registros_filter.jsp");
			callPage(LangPath + "EDP0706_registros_filter.jsp", req, res);
		} catch (Exception ex) {
...
//take out
	   ...
	   if(req.getParameter("PRD")!=null){
		...
		// Send Initial data
		try {
			msgList = (EDP070601Message) mc.getMessageRecord("EDP070601");
			msgList.setH01USERID(user.getH01USR());
			//msgList.setH01PROGRM("ELD010003");
			msgList.setH01PROGRM("EDP0706");
			msgList.setH01TIMSYS(getTimeStamp());
			msgList.setH01SCRCOD("01");
			msgList.setH01OPECOD("0015");
			msgList.setE01DPQPRD(req.getParameter("PRD"));
			//PARAMETER TO HOST
			msgList.setH01FLGWK2(userPO.getOption());
			//
			msgList.send();
			msgList.destroy();
			flexLog("EDP070601 Message Sent");
		} catch (Exception e) {
			e.printStackTrace();
			flexLog("Error: " + e);
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDP070601")) {
...
//				String myFlag = "";
			   ...
			   beanList.setNoResult(true);
				...
				while (ct++ < datapro.eibs.master.JSEIBSProp.getMaxIterations()) {
					...
					msgList = (EDP070601Message) newmessage;
				...
				flexLog("Putting java beans into the session");
				ses.setAttribute("EDP070601Help", beanList);
				ses.setAttribute("userPO", userPO);
// begin==
// DDLBegin ===
...
//		 String myFlag = "";
		 ...
		 try {
			 ...
			 String Option1 = (String) userPO.getOption();
			 String Option2 = (String) "1";
		 ...
		 //habilitar cuando la primera seleccion esta en blanco
			  ...
			  beanCNPG.addRow(myFlag, myOptionCNP1);
					 ...
					 if (markerCN.equals("*")) {
						 ...
						 myOptionCNP1 =
							 "<option value=\""
								 ...
								 + "</option>";
						 beanCNPG.addRow(myFlagCNP1, myOptionCNP1);
					 }
					 newmessage = mc.receiveMessage();
				 }
				...
				try {
						...
						if (msgError.getERRNUM().equals("0")) {
							flexLog(
								"About to call Page: "
									+ LangPath
									+ "EDP0706_registros_list1.jsp");
							callPage(
								LangPath + "EDP0706_registros_list1.jsp",
								req,
								res);
						} else {
							flexLog(
...
//		}
	...
	//	manejo formato a trabajar first screen
	 ...
	 switch (inptOPT) {
		 ...
		 default :
			 res.sendRedirect(
				 super.srctx
					 + "/servlet/datapro.eibs.creditproposer.JSEDP0706?SCREEN=800") ;
			 break;
		 }
	 }
	...
	// Send Initial data
	try {
		//msgList = (EDP070601Message) mc.getMessageRecord("EDP070201");
		msgList = (EDP070601Message) mc.getMessageRecord("EDP070601");
		msgList.setH01USERID(user.getH01USR());
		//msgList.setH01PROGRM("ELD010003");
		msgList.setH01PROGRM("EDP0706");
...
//	ELEERRMessage msgError = null;
	...
	switch (inptOPT) {
		case 1 : //new
			...
			res.sendRedirect(
			super.srctx
		+ "/servlet/datapro.eibs.creditproposal.JSEDP0706?SCREEN=300&PRD="
...
//			procReqNew(mc, user, req, res, ses);
		...
		default :
			...
			res.sendRedirect(
				super.srctx
			+ "/servlet/datapro.eibs.creditproposal.JSEDP0706?SCREEN=150&PRD="
			+ req.getParameter("PRD"));
			break;
	}
}
   ...
   protected void procReqNew(
	...
	s0706 = new datapro.eibs.beans.EDP070601Message();
	s0706.setE01DPQPRD(req.getParameter("PRD"));

	ses.setAttribute("s0706", s0706);
	try {
		flexLog(
			"About to call Page: "
				+ LangPath
				+ "EDP0706_registros_maintenance.jsp");
		callPage(LangPath + "EDP0706_registros_maintenance.jsp", req, res);
	} catch (Exception e) {
		flexLog("Exception calling page " + e);
	}
...
protected void procActionDelete(
		...
		try {
			flexLog("Send Initial Data");
			s0706 = (EDP070601Message) ses.getAttribute("s0706");
			s0706.setH01USERID(user.getH01USR());
			//s0706.setH01PROGRM("EGL036001");
			s0706.setH01PROGRM("EDP0706");	
			s0706.setH01TIMSYS(getTimeStamp());
			s0706.setH01SCRCOD("01");
			s0706.setH01OPECOD("0003");
			s0706.setH01FLGWK1("N");
			//
			//PARAMETER TO HOST
			s0706.setH01FLGWK2(userPO.getOption());
			//
			// all the fields here
			java.util.Enumeration enu = s0706.fieldEnumeration();
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDP070601")) {
				try {
					s0706 = new datapro.eibs.beans.EDP070601Message();
					flexLog("EDP070601 Message Received");
				} catch (Exception ex) {
					flexLog("Error: " + ex);
				}

				s0706 = (EDP070601Message) newmessage;
						...
						try {
							flexLog(
								"About to call Page: "
									...
									+ "EDP0706_registros_maintenance.jsp");
							callPage(
								LangPath + "EDP0706_registros_maintenance.jsp",
								req,
								res);
						} catch (Exception e) {
							flexLog("Exception calling page " + e);
...
protected void procActionInsert(
	...
	protected void procActionMaintenance(
		...
		try {
			...
			s0706.setH01TIMSYS(getTimeStamp());
			s0706.setH01SCRCOD("01");
			s0706.setH01OPECOD("0005");
			s0706.setH01FLGWK1("N");
			s0706.setH01FLGWK3(req.getParameter("opt"));
			//
			//PARAMETER TO HOST
			s0706.setH01FLGWK2(userPO.getOption());
			//
	...
	// Receive Data
	try {
		JBObjList bl = (JBObjList) ses.getAttribute("EDP070601Help");
		int idx = Integer.parseInt(req.getParameter("CURRCODE2"));
		bl.setCurrentRow(idx);

		s0706 = (EDP070601Message) bl.getRecord();
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		if (session == null) {
			...
			try {
				...
				try {
					flexLog("Opennig Socket Connection");
					mc = new MessageContext(super.getMessageHandler("EDP0706", req));
