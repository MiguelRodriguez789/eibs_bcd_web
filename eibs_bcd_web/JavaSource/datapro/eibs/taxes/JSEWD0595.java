// Taxes Help 
// C. Castillo  01/20/15
// Source File Name:   JSEWD0595.java 
...
public class JSEWD0595 extends JSEIBSServlet {
	...
	protected void reqList(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		UserPos userPO = null;
		try {
			mp = new MessageProcessor("EWD0595");				
			EWD0595DSMessage msg = (EWD0595DSMessage) mp.getMessageRecord("EWD0595DS");
			...
			forward("EWD0595_taxes_helpmessage.jsp", req, res);
