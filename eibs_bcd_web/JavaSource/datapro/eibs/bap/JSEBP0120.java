...
/**
 * Source Documents - Accounts Payable 
 ...
 *	// SCREEN =    3    Send Source Document - old record
...
public class JSEBP0120 extends JSEIBSServlet { 
	...
	protected void procReqSrhPrm(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		try {
			...
			forwardOnSuccess("EBP0120_source_search.jsp", req, res);
		} finally {
			if (mp != null)
				mp.close();
		}
	...
	protected void procReqList(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			switch (screen) {
		    case 2 : // List Source Document
		        msg.setH01OPECOD("0001");
				userPO.setPurpose("INQUIRY");
			    break;
		    case 20 : // List Source Document approval
			...
			userPO.setHeader5(msg.getE01REQDF1());
			userPO.setHeader6(msg.getE01REQDF2());
			userPO.setHeader7(msg.getE01REQDF3());
			userPO.setHeader8(msg.getE01BDCKIN());
			...
			forward("EBP0120_source_document_list.jsp", req, res);
		} finally {
			if (mp != null)
				mp.close();
		}
	...
	protected void procActionRec(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			msg.setE01REQDF1(userPO.getHeader5());
			msg.setE01REQDF2(userPO.getHeader6());
			msg.setE01REQDF3(userPO.getHeader7());
			msg.setE01BDCKIN(userPO.getHeader8());
			...
			if (mp.hasError(newmessage)) {
				...
				if (screen == 3 || screen == 4 || screen == 5 ) {
					redirectToPage("/servlet/datapro.eibs.bap.JSEBP0120?SCREEN=2&FromRecord=0" +
					        "&E01REQTYP=" + userPO.getHeader1() + 
				  			"&E01REQORD=" + userPO.getHeader2() +
				  			"&E01REQSTS=" + userPO.getHeader3() +
				  			"&E01REQFRM=" + userPO.getHeader4() +
				  			"&E01REQDF1=" + userPO.getHeader5() +
				  			"&E01REQDF2=" + userPO.getHeader6() +
				  			"&E01REQDF3=" + userPO.getHeader7() +
					...
					if (screen == 15) {
						redirectToPage("/servlet/datapro.eibs.bap.JSEBP0120?SCREEN=20", res);
					//	forward("EBP0120_source_search.jsp", req, res);
				  	} else {
				  		forward("EBP0120_source_document_detail.jsp", req, res);				 
					}
				}
			} else {
				if (screen == 4 || screen == 6) {			
				    ...
				    if (screen == 15) {
				    	...
				    	// Receive Data
				    	ses.setAttribute("EBP0120Record", newmessage);
				    	forwardOnSuccess("EBP0120_source_document_detail.jsp", req, res);
				    }
				}
			}
