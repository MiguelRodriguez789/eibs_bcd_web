...
public class JSEDL1112 extends datapro.eibs.master.SuperServlet {
...
public void destroy() {
	...
	flexLog("free resources used by JSEDL1112");
...
/////
  msgLN = new datapro.eibs.beans.EDL111201Message();
  ...
  ses.setAttribute("lnScheme", msgLN);
	...
	if (option.equals("1")) {
		opcode="0001"; //new
		msgLN = (EDL111201Message)ses.getAttribute("msgLN");
	}
	else {
		row = Integer.parseInt(req.getParameter("ROW"));
		extList = (JBObjList)ses.getAttribute("extList");
		extList.setCurrentRow(row);
		msgLN = (EDL111201Message) extList.getRecord();
	...
	try
	{
		...
		while (enu.hasMoreElements()) {
	 	...
	 	flexLog("EDL111201 Message Sent");
	}		
	catch (Exception e)
	{
		e.printStackTrace();
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("EDL111201")) {
			try {
				msgLN = new datapro.eibs.beans.EDL111201Message();
				flexLog("EDL111201 Message Received");
		  	} catch (Exception ex) {
				flexLog("Error: " + ex); 
		  	}

			msgLN = (EDL111201Message)newmessage;
			...
			if (IsNotError) {  // There are no errors
				...
				out.println("		top.opener.window.location.href='" + super.webAppPath + "/servlet/datapro.eibs.products.JSEDL1112?SCREEN=3'");
				...
				if (option.equals("1")) { //new
					ses.setAttribute("lnScheme", msgLN);
					try {
						flexLog("About to call Page: " + LangPath + "EDL1112_ln_new_sch.jsp");
						callPage(LangPath + "EDL1112_ln_new_sch.jsp", req, res);	
					}
					catch (Exception e) {
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL1112_ln_maint_sch.jsp?ROW"+ row);
						res.sendRedirect(super.srctx + LangPath + "EDL1112_ln_maint_sch.jsp?ROW"+ row);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL1112_ln_delete_sch.jsp?ROW"+ row);
						res.sendRedirect(super.srctx + LangPath + "EDL1112_ln_delete_sch.jsp?ROW"+ row);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
...
/////
  ...
  ses.setAttribute("lnScheme", msgLN);
	...
	try {
		flexLog("About to call Page: " + LangPath + "EDL1112_ln_conf_sch.jsp");
		callPage(LangPath + "EDL1112_ln_conf_sch.jsp", req, res);	
	}
	catch (Exception e) {
		flexLog("Exception calling page " + e);
	}
...
/////
  ...
  ses.setAttribute("lnScheme", msgLN);
	...
	try {
		flexLog("About to call Page: " + LangPath + "EDL1112_ln_enter_sch_app.jsp");
		callPage(LangPath + "EDL1112_ln_enter_sch_app.jsp", req, res);	
	}
	catch (Exception e) {
		flexLog("Exception calling page " + e);
	}
...
/////
  ...
  ses.setAttribute("lnScheme", msgLN);
	...
	try {
		flexLog("About to call Page: " + LangPath + "EDL1112_ln_enter_sch_acp.jsp");
		callPage(LangPath + "EDL1112_ln_enter_sch_acp.jsp", req, res);	
	}
	catch (Exception e) {
		flexLog("Exception calling page " + e);
	}
...
protected void procReqEnterSchemeLN(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try {
		flexLog("About to call Page: " + LangPath + "EDL1112_ln_enter_sch.jsp");
		callPage(LangPath + "EDL1112_ln_enter_sch.jsp", req, res);	
	}
	catch (Exception e) {
		flexLog("Exception calling page " + e);
	}
...
protected void procReqSchemeLNList(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		msgLN = (EDL111201Message)mc.getMessageRecord("EDL111201");
	 	msgLN.setH01USERID(user.getH01USR());
	 	msgLN.setH01PROGRM("EDL1112");
	 	msgLN.setH01TIMSYS(getTimeStamp());
	 	msgLN.setH01SCRCOD("01");
	...
	try
	{
	  newmessage = mc.receiveMessage();
		...
		else if (newmessage.getFormatName().equals("EDL111201")) {
...
//ojo
		  if (userPO.getHeader23() == null) {
			...
			try {
				 	flexLog("About to call Page: " + LangPath + "EDL1112_ln_list_sch.jsp");
				 	callPage(LangPath + "EDL1112_ln_list_sch.jsp", req, res);					
			}
			catch (Exception e) {
					flexLog("Exception calling page " + e);
			}			
				...
				try {
//						flexLog("About to call Page: " + LangPath + "EDL1112_ln_list_inq_sch.jsp");
//						callPage(LangPath + "EDL1112_ln_list_inq_sch.jsp", req, res);					
					flexLog("About to call Page: " + LangPath + "EDL1112_ln_list_sch.jsp");
					callPage(LangPath + "EDL1112_ln_list_sch.jsp", req, res);					
...
//ojo
		  if (userPO.getHeader23() == null) {
			...
			try {
					flexLog("About to call Page: " + LangPath + "EDL1112_ln_list_sch_app.jsp");
					callPage(LangPath + "EDL1112_ln_list_sch_app.jsp", req, res);					
			}
			catch (Exception e) {
					flexLog("Exception calling page " + e);
			}			
	  ...
	  newmessage = mc.receiveMessage();
		...
		if (newmessage.getFormatName().equals("ELEERR")) {
		  ...
		  if (userPO.getHeader23() == null) {
			...
			try {
					flexLog("About to call Page: " + LangPath + "EDL1112_ln_list_sch_acp.jsp");
					callPage(LangPath + "EDL1112_ln_list_sch_acp.jsp", req, res);					
			}
			catch (Exception e) {
					flexLog("Exception calling page " + e);
			}			
...
//ojo
		  if (userPO.getHeader23() == null) {
			...
			try {
					flexLog("About to call Page: " + LangPath + "EDL1112_ln_list_inq.jsp");
					callPage(LangPath + "EDL1112_ln_list_inq.jsp", req, res);					
			}
			catch (Exception e) {
					flexLog("Exception calling page " + e);
			}			
...
protected void procReqEnterInq(
	...
	try {
		flexLog("About to call Page: " + LangPath + "EDL1112_cp_enter_inquiry.jsp");
		callPage(LangPath + "EDL1112_cp_enter_inquiry.jsp", req, res);
	} catch (Exception e) {
		flexLog("Exception calling page " + e);
	}
...
protected void procActionEnterInquiry(
	...
	try {
		...
		if (newmessage.getFormatName().equals("EDL010501")) {
			...
			if (IsNotError) { // There are no errors
				try {
					flexLog("About to call Page: " + LangPath + "EDL1112_cp_inq_maint.jsp");
					callPage(LangPath + "EDL1112_cp_inq_maint.jsp", req, res);
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
			} else { // There are errors
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("EDL1112", req));
