...
import datapro.eibs.beans.EDL118601Message;
...
public class JSEDL1186 extends datapro.eibs.master.SuperServlet {
  ...
  throws ServletException, IOException {
    ...
    if (session == null) {
      ...
      int screen = JSEDL1186.R_ENTER_MAINT;
      ...
      try {
        ...
        try {
          ...
          mc =
            new MessageContext(super.getMessageHandler("EDL1186"));
  ...
  throws ServletException, IOException {
    ...
    // Send Initial data
    try {
      msgPC = (EDL118601Message) mc.getMessageRecord("EDL118601");
      msgPC.setH01USERID(user.getH01USR());
      msgPC.setH01PROGRM("EDL1186");
    ...
    try {
      ...
      if (newmessage.getFormatName().equals("EDL118601")) {
        msgPC = (EDL118601Message) newmessage;
        ...
        if (IsNotError) { // There are no errors
            callPage(LangPath + "EDL1186_pc_opening.jsp", req, res);
  ...
  throws ServletException, IOException {
    ...
    try {
      ...
      msgPC.destroy();
      flexLog("EDL118601 Message Sent");
    } catch (Exception e) {
      e.printStackTrace();
      flexLog("Error: " + e);
      throw new RuntimeException("Socket Communication Error");
  ...
  throws ServletException, IOException {
    ...
    try {
      ...
      if (newmessage.getFormatName().equals("EDL118601")) {
        ...
        if (IsNotError) { // There are no errors
        	callPage(LangPath + "EDL1186_can_maint.jsp", req, res);
        } else { // There are errors
            callPage(LangPath + "EDL1186_can_enter_maint.jsp", req, res);
        }
      } else {
        flexLog("Message " + newmessage.getFormatName() + " received.");
      }
  ...
  throws ServletException, IOException {
    ...
    try {
      ...
      if (newmessage.getFormatName().equals("EDL118601")) {
        ...
        if (IsNotError) { // There are no errors
        	callPage(LangPath + "EDL1186_can_maint_inq.jsp", req, res);
        } else { // There are errors
            callPage(LangPath + "EDL1186_can_maint_inq.jsp", req, res);
        }
      } else {
  ...
  throws ServletException, IOException {
    ...
    try {
      flexLog("Send Initial Data");
      msgPC = (EDL118601Message) ses.getAttribute("dlCast");
      //msgCD = (EDL118601Message)mc.getMessageRecord("EDL118601");
      msgPC.setH01USERID(user.getH01USR());
      msgPC.setH01PROGRM("EDL1186");
      msgPC.setH01TIMSYS(SuperServlet.getTimeStamp());
      msgPC.setH01SCRCOD("01");
  ...
  throws ServletException, IOException {
    ...
    callPage(LangPath + "EDL1186_pc_enter_inquiry.jsp", req, res);
