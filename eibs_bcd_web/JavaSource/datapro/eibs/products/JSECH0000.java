	  	...
	  	if (IsNotError)
	  	{
			...
			if (newmessage.getFormatName().equals("ECH030501")) 
			{
				...
				try {
						...
						mc1 = new MessageContext(super.getMessageHandler("EDD0000", req));
		...
		if (newmessage.getFormatName().equals("ECH053501")) 
		{
			...
			while (true) 
			{
					...
					else 
					{
						...
						myRow +="<td nowrap>" +  Util.formatCustomDate( user.getE01DTF(), msgRT.getE01CHADTM(),msgRT.getE01CHADTD(), msgRT.getE01CHADTY()) +"</td>";
...
//	 	msgRT.setH01FLGWK1("R");
		...
		try {
            ...
            msgRT.setE01SELFDM(req.getParameter("E01SELFDM"));
            msgRT.setE01SELFDD(req.getParameter("E01SELFDD"));
            msgRT.setE01SELFDY(req.getParameter("E01SELFDY"));
            msgRT.setE01SELIDM(req.getParameter("E01SELIDM"));
            msgRT.setE01SELIDD(req.getParameter("E01SELIDD"));
            msgRT.setE01SELIDY(req.getParameter("E01SELIDY"));
		}
		catch (Exception e)	{
	 	  	
//          msgRT.setE01SELBNK("0");
// 		    msgRT.setE01SELBRN("0");
            msgRT.setE01SELFDM("0");
            msgRT.setE01SELFDD("0");
            msgRT.setE01SELFDY("0");
            msgRT.setE01SELIDM("0");
            msgRT.setE01SELIDD("0");
            msgRT.setE01SELIDY("0");
		...
		if (newmessage.getFormatName().equals("ECH031001")) 
		{
			...
			while (true) 
			{
				...
				/*		myRow +="<td nowrap>" + msgRT.getE01CHMCUN()+"</td>";
						...
						myRow += "<TD NOWRAP><input type=\"radio\" name=\"ACCNUM\" value=\"" + indexRow + "\" " +  " onclick=\"showAddInfo("+indexRow+")\"></TD>";
						myRow +="<td nowrap>" +  Util.formatCustomDate( user.getE01DTF(), msgRT.getE01CHMRQM(),msgRT.getE01CHMRQD(), msgRT.getE01CHMRQY()) +"</td>";
						...
						myRow +="<td nowrap><INPUT TYPE=HIDDEN NAME=RQM" + indexRow +  " value=" + msgRT.getE01CHMRQM() +">";
						myRow +="<td nowrap><INPUT TYPE=HIDDEN NAME=RQD" + indexRow +  " value=" + msgRT.getE01CHMRQD() +">";
						myRow +="<td nowrap><INPUT TYPE=HIDDEN NAME=RQY" + indexRow +  " value=" + msgRT.getE01CHMRQY() +">";												
...
private void procActionRTRecepcion(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		msgRT.setE01CHMRQM(req.getParameter("E01CHMRQM"));
		msgRT.setE01CHMRQD(req.getParameter("E01CHMRQD"));
		msgRT.setE01CHMRQY(req.getParameter("E01CHMRQY"));
...
public void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	...
	if (session == null) {
		...
		try {
			...
			{
				flexLog("Opennig Socket Connection");
				mc = new MessageContext(super.getMessageHandler("ECH0310", req));
