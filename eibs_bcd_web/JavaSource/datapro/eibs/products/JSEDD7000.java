...
import datapro.eibs.beans.EDD700001Message;
...
public class JSEDD7000 extends datapro.eibs.master.SuperServlet {
	...
	public void destroy() {
		...
		flexLog("free resources used by JSEDD7000");
	...
	protected void procReqFilter(
		...
		EDD700001Message msgSearch = new EDD700001Message();
		...
		try { 
			...
			flexLog("About to call Page: " + LangPath + "EDD7000_savings_printer_enter_inq.jsp");
			callPage(LangPath + "EDD7000_savings_printer_enter_inq.jsp", req, res);
	...
	protected void procSndInf(
		...
		EDD700001Message msgSearch = null;
		EDD700001Message msgMT = new EDD700001Message();
		...
		try {
			...
			msgSearch = (EDD700001Message) mc.getMessageRecord("EDD700001");
			msgSearch.setH01USERID(user.getH01USR());
			msgSearch.setH01PROGRM("EDD7000");
			...
			msgSearch.send();
			msgSearch.destroy();
			flexLog("EDD700001 Message Sent");
			...
			if (newmessage.getFormatName().equals("EDD700001")) {
				
				msgMT = (EDD700001Message) newmessage;
				System.out.println(msgMT.toString());
  				ses.setAttribute("msgMT", msgMT);
		   
				if (IsNotError) {
					try {
						flexLog("About to call Page: " + LangPath + "EDD7000_savings_printer_detail.jsp");
						callPage(LangPath + "EDD7000_savings_printer_detail.jsp", req, res);						
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EDD7000", req));
