				...
				if (marker.equals("*")) {
					...
					myRow.append("<TD NOWRAP ALIGN=\"CENTER\">"
							+ Util.formatCustomDate(user.getE01DTF(),
																	msgList.getBigDecimalE01DDCDTM().intValue(),
																	msgList.getBigDecimalE01DDCDTD().intValue(),
																	msgList.getBigDecimalE01DDCDTY().intValue()) + "</TD>");
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("EDD0936", req));
