	  ...
	  if (newmessage.getFormatName().equals("EDL081602")) {
		...
		while (true) {
			...
			if (marker.equals("*")) {
				...
				myRow.append("<TD NOWRAP ALIGN=LEFT>" + Util.formatCell(msgList.getE02DLDRFN()) + "</TD>");
				myRow.append("<TD NOWRAP ALIGN=CENTER>" + Util.formatCustomDate(user.getE01DTF(),msgList.getBigDecimalE02DLDMAM().intValue() ,msgList.getBigDecimalE02DLDMAD().intValue() ,msgList.getBigDecimalE02DLDMAY().intValue()) + "</TD>");
				...
				myRow.append("<TD NOWRAP ALIGN=LEFT>" + Util.formatCell(msgList.getE02DLDDID()) + "</TD>");
				myRow.append("<TD NOWRAP ALIGN=CENTER>" + Util.formatCustomDate(user.getE01DTF(),msgList.getBigDecimalE02DLDPYM().intValue() ,msgList.getBigDecimalE02DLDPYD().intValue() ,msgList.getBigDecimalE02DLDPYY().intValue()) + "</TD>");
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("EDL0816", req));
