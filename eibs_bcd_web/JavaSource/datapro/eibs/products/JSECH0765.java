...
protected void  procAction_req_InfChequera(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try 
	{
		...
		mc = new MessageContext(super.getMessageHandler("ECH0765", req));
				...
				while (true) 
				{
						...
						else 
						{
							...
							if (Estado3.equals("1"))
							{
								...
								myRow +="<td nowrap>" +  Util.formatCustomDate(user.getE01DTF(), msgRT.getE01CHMRQD(),msgRT.getE01CHMRQM(), msgRT.getE01CHMRQY()) +"</td>";
							}
							//if (req.getParameter("E01ESTADO").equals("2"))							
							if (Estado3.equals("2"))
							{
								myRow +="<td nowrap>R</td>";
								myRow +="<td nowrap>" +  Util.formatCustomDate(user.getE01DTF(), msgRT.getE01CHMRCD(),msgRT.getE01CHMRCM(), msgRT.getE01CHMRCY()) +"</td>";
							}
							//if (req.getParameter("E01ESTADO").equals("3"))
							if (Estado3.equals("3"))
							{
								myRow +="<td nowrap>V</td>";
								myRow +="<td nowrap>" +  Util.formatCustomDate(user.getE01DTF(), msgRT.getE01CHMACD(),msgRT.getE01CHMACM(), msgRT.getE01CHMACY()) +"</td>";
							}	
