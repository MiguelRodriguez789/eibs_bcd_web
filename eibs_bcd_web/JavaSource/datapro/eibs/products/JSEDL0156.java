		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL015601")) {
				...
				if (IsNotError) { // There are no errors
					...
					String href = req.getContextPath() + "/pages/s/MISC_search_wait.jsp?URL='" + req.getContextPath() + "/servlet/datapro.eibs.products.JSEDL0156?SCREEN=1'";
					out.println("<HTML>");
					out.println("<HEAD>");
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EDL0156", req));
