	  	...
	  	if (newmessage.getFormatName().equals("ELEERR")) {
			...
			while (true) {
				...
				if (marker.equals("*")) {
					...
					//mod emat
					chkOfac = (msgList.getH01FLGWK3().equals("3") ? "<a href=\"javascript:showInqOFAC('" + msgList.getE01ORDNUM() + "')\"><img src=\"../images/warning_16.jpg\" title=\"OFAC Match List\" align=\"absmiddle\" border=\"0\" ></a>" : "");
					chkWarn = (msgList.getH01FLGWK2().equals("A") ? "<a href=\"javascript:showInqWarn('" + msgList.getE01ORDNUM() + "')\"><img src=\"../images/warning01.gif\" title=\"Warnings\" align=\"absmiddle\" border=\"0\" ></a>" : "");
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("EIE0140", req));
