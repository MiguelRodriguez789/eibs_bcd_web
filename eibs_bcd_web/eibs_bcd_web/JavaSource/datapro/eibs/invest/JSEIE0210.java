...
public class JSEIE0210 extends datapro.eibs.master.SuperServlet {
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("EIE021001")) {
			...
			if (IsNotError) {  // There are no errors
				...
				res.sendRedirect(super.srctx + "/servlet/datapro.eibs.invest.JSEWD0315?SCREEN=1");
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("EIE0210", req));
