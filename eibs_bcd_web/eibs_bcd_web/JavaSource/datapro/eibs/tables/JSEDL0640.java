...
import datapro.eibs.beans.EDL064001Message;
...
public class JSEDL0640 extends JSEIBSServlet {
	...
	private void procInquiry(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession session) 
		...
		forward("EDL0640_official_indice_enter.jsp", req, res);
	...
	private void procActionInquiry(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession session)
		...
		try {
			mp = getMessageProcessor("EDL0640", req);
			EDL064001Message msgdata = (EDL064001Message) mp.getMessageRecord("EDL064001");
			msgdata.setH01USERID(user.getH01USR());
			msgdata.setH01PROGRM("EDL0640");
			msgdata.setH01TIMSYS(getTimeStamp());
			msgdata.setH01SCRCOD("01");
			msgdata.setH01OPECOD("0015");
			msgdata.setE01IFHRCD(req.getParameter("E01IFHRCD"));
			...
			msgdata = (EDL064001Message) mp.receiveMessageRecord();
			...
			if (mp.hasError(error)) {
				...
				forward("EDL0640_official_indice.jsp", req, res);
			}
