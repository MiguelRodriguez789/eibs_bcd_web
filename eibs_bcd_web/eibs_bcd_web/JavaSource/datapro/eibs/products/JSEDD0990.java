					...
					if (marker.equals("*")) {
						...
						myRow.append("<TD NOWRAP ALIGN=\"CENTER\">"
								+ Util.formatCustomDate(user.getE01DTF(),
																		msgList.getBigDecimalE01PBTDTM().intValue(),
																		msgList.getBigDecimalE01PBTDTD().intValue(),
																		msgList.getBigDecimalE01PBTDTY().intValue())
							+ "</TD>");
						myRow.append(
							"<TD NOWRAP>"
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EDD099", req));
