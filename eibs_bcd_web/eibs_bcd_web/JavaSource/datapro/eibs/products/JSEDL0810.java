			...
			if (newmessage.getFormatName().equals("EDL081002")) {
				...
				while (true) {
					...
					if (marker.equals("*")) {
						...
						myRow2[1] = dftBasic.getE02DLDFVM();
						myRow2[2] = dftBasic.getE02DLDFVD();
						myRow2[3] = dftBasic.getE02DLDFVY();
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EDL0810", req));
		...
		try {
			...
			if (action.equals("D")) {
				...
				for (int i = 0; i < numdocs; i++) {
					...
					if (checked == null
						...
						myRow2[1] = req.getParameter("E02DLDFVM" + i);
						myRow2[2] = req.getParameter("E02DLDFVD" + i);
						myRow2[3] = req.getParameter("E02DLDFVY" + i);
						...
						if (numActualSeq.trim().equals(numSeq.trim())
							...
							dftDocument.setE02DLDFVM(
								req.getParameter("E02DLDFVM" + i).trim());
							dftDocument.setE02DLDFVD(
								req.getParameter("E02DLDFVD" + i).trim());
							dftDocument.setE02DLDFVY(
								req.getParameter("E02DLDFVY" + i).trim());
							try {
			...
			if (action.equals("0")) {
				...
				for (int i = 0; i < numdocs; i++) {
					...
					dtini = req.getParameter("E02DLDFVM" + i);
