	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("EGL0421", req));
			...
			try {
				...
				while (true) {
					...
					if (marker.equals("*")) {
						...
						myRow.append("<TD NOWRAP ALIGN=RIGHT>" + Util.formatCustomDate(user.getE01DTF(),
																		msgList.getBigDecimalE02TRAPDM().intValue(),
																		msgList.getBigDecimalE02TRAPDD().intValue(),
																		msgList.getBigDecimalE02TRAPDY().intValue()) + "</TD>");
						myRow.append("<TD NOWRAP ALIGN=RIGHT>" + Util.formatCustomDate(user.getE01DTF(),
																	msgList.getBigDecimalE02TRAVDM().intValue(),
																	msgList.getBigDecimalE02TRAVDD().intValue(),
																	msgList.getBigDecimalE02TRAVDY().intValue()) + "</TD>"); 
						myRow.append("</TR>");
