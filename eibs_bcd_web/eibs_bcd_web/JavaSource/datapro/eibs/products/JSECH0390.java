		...
		if (newmessage.getFormatName().equals("ECH039001"))
		{
			...
			while (true) 
			{
					...
					else 
					{
						...
						myRow +="<td nowrap>" +  Util.formatCustomDate( user.getE01DTF(), msgRT.getE01CHFEUM(),msgRT.getE01CHFEUD(), msgRT.getE01CHFEUY()) +"</td>";
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("ECH0390", req));
