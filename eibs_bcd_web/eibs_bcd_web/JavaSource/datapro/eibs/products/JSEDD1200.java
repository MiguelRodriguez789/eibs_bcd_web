...
//				LangPath = "/pages/s/";
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EDD1200", req));
...
//						msgRT.setH01USERID("DESHMPR");
						...
						try {
							msgRT.setE01RUNDTM(req.getParameter("E01RUNDTM"));
							msgRT.setE01RUNDTD(req.getParameter("E01RUNDTD"));
							msgRT.setE01RUNDTY(req.getParameter("E01RUNDTY"));
						} catch (Exception e) {
						}
						try {
						...
						try {
							msgRT.setE01NARRTV(req.getParameter("E01NARRTV"));
						} catch (Exception e) {
						}
