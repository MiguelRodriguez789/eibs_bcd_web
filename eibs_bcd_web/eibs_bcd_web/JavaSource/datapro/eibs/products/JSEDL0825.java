		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EDL0825", req));
					...
					if (marker.equals("*")) {
						break;
							...
							myRow[4] = Util.formatCustomDate(user.getE01DTF(),
										...
										msgPay.getBigDecimalE01DLDMAY().intValue()); 
						    ...
						    myRow[18] = Util.formatCustomDate(user.getE01DTF(),
									...
									msgPay.getBigDecimalE01DLDRFY().intValue()); 
							...
							myRow[27] = Util.formatCustomDate(user.getE01DTF(),
									...
									msgPay.getBigDecimalE01DLDPDY().intValue()); 
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL082501")) {
				...
				try {
					...
					docData.setPAGVDM(req.getParameter("E01PAGVDM"));
					docData.setPAGVDD(req.getParameter("E01PAGVDD"));
					docData.setPAGVDY(req.getParameter("E01PAGVDY"));
