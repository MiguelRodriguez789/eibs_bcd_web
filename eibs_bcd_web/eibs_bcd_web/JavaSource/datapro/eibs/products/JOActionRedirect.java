...
/**  Fecha                   :  26/12/2011                                                                                      **/
/**  Objetivo                :  Incorporacion manejo de productos de Cuotas de Participacion Nuevo ACD = 06 (CP)                **/
/**                                                                                                                             **/
/*********************************************************************************************************************************/
...
public class JOActionRedirect {
	...
	private UserPos getUserPos(HttpServletRequest request) {
		String beanName = "userPO_" + appCode;
		if (request != null) {
			request.setAttribute("userPOKey", ""+appCode);
		}
	...
	public String action(HttpServletRequest request) {
		...
		String ret = "";
		UserPos userPO = getUserPos(request);
			...
			case 1 : // Account Inquiry
				...
				case 13:// PCOM
					try {
						...
						ret = "/servlet/datapro.eibs.products.JSEDL0105I?SCREEN=400&E01DEAACC="
								+ account;
					} catch (Exception ex) {
					...
					case 95 : // CD
						...
						break;
					case 19: // Loans Constructor
						try{
							userPO.setOption("CD");
							userPO.setPurpose("INQUIRY");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.products.JSEPC0000?SCREEN=600&E01PCMACC=" + account;
						}catch(Exception e){
							e.printStackTrace();
						}
						break;
					...
					case 6 : //Cuotas de Participacion
						try {
							...
							session.setAttribute("userPO", userPO);
							ret =
								"/servlet/datapro.eibs.products.JSEDD0000I?SCREEN=1800&E01ACMACC=" + account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;
					...
					case 43:
						try {
							...
							userPO.setPurpose("INQUIRY");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.bolgaran.JSELC5080?SCREEN=401&E01LCMACC=" + account ;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;
					...
					case 52:
					      ...
					      try{
					         ...
					         session.setAttribute("userPO", userPO);           
					         ret = "/servlet/datapro.eibs.trade.JSEDC0100?SCREEN=200&E01DCMACC=" + account;
					      }catch(Exception e){
					        e.printStackTrace();
					      }
					      break;
					...
					case 59: // Seguros
						try {
							...
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.client.JSESG0010I?SCREEN=205&E01PACNUM=" + account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
					      break;
							
					case 65 : // Trade Tickets
					case 66 :
					case 67 :
					case 68 :
					case 69 :
					...
					case 70: // Externos Activo
						try {
							userPO.setOption("70");
							userPO.setPurpose("INQUIRY");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.products.JSEXP0060?SCREEN=300&E01EXPACC=" + account ;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;
					...
					case 94: // Credit Cards
						try {
							...
							userPO.setPurpose("INQUIRY");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.products.JSECC0040?SCREEN=35&E01CCRCRA="	+ account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;

					case 97: // Credit Cards
						try {
							userPO.setOption("70");
							userPO.setPurpose("INQUIRY");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.products.JSERM0060?SCREEN=300&E01RMMACC=" + account ;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;
				...
				switch (appCode) {
					...
					case 42:
						try{
							...
							userPO.setPurpose("STATEMENT");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.trade.JSESD0817?SCREEN=200&E01LCMACC=" + account;
						}catch(Exception e){
							e.printStackTrace();
						}
						break;
					...
					case 52:						
						try{
							...
							userPO.setPurpose("STATEMENT");
							session.setAttribute("userPO", userPO);								   
							ret = "/servlet/datapro.eibs.trade.JSESD0817C?SCREEN=200&E01DCMACC=" + account;
						}catch(Exception e){
							e.printStackTrace();
						}
			...
			case 4 : // Approval Inquiry
				switch (appCode) {
					case 0 : // Clients
						...
						session.setAttribute("userPO", userPO);
						ret = "/servlet/datapro.eibs.client.JSESD1080?SCREEN=7&E01CUN=" + account;
						break;
/*                                                      PCL01 Se cambia esto por Cuotas de participacion						
...
*/
					case 13 : // CP
						try {
							if (number.equalsIgnoreCase("") || number.equalsIgnoreCase("1")) {
								...
								userPO.setPurpose("APPROVAL_INQ");
								session.setAttribute("userPO", userPO);
								ret = "/servlet/datapro.eibs.products.JSEDL0108?SCREEN=7&E03DEAACC="
										+ account;
							} else {
								userPO.setOption("CP");
								userPO.setPurpose("APPROVAL_INQ");
						...
						try {
							if (number.equalsIgnoreCase("P")) {
								...
								if (number.equalsIgnoreCase("T")) {
									...
									if (number.equalsIgnoreCase("R")) {
										userPO.setOption("LN_CHANGE_RATE");
										userPO.setPurpose("APPROVAL_INQ");
										userPO.setIdentifier(account);
										userPO.setAccNum(account);
										session.setAttribute("userPO", userPO);
										ret =
											"/servlet/datapro.eibs.products.JSEDL0130A?SCREEN=19&E01DEAACC=" + account;
									...
									if (number.equalsIgnoreCase("K")) {
										...
										userPO.setHeader10("APPROVAL");
										session.setAttribute("userPO", userPO);
										ret =
											"/servlet/datapro.eibs.timedeposits.JSEDL2050?SCREEN=1060&R01ACC=" + account;
									} else if(number.equalsIgnoreCase("2")){
										...
										ret =
											...
											session.setAttribute("userPO", userPO);
											ret =
													"/servlet/datapro.eibs.timedeposits.JSEDL2090?SCREEN=5&E01DEAACC=" + account;	
									} else {
										userPO.setOption("CD");
										userPO.setPurpose("APPROVAL_INQ");
										session.setAttribute("userPO", userPO);
						...
						try {
							if (number.equalsIgnoreCase("C")) {
								...
								ret = "/servlet/datapro.eibs.products.JSEDD1150A?SCREEN=1&E01ACMACC=" + account;
										...
										session.setAttribute("userPO", userPO);
										ret =
											"/servlet/datapro.eibs.products.JSEDD0000I?SCREEN=317&E01ACMACC=" + account;	
					...
					case 4 : // Saving Accounts
						try {
							if (number.equalsIgnoreCase("C")) {
								...
								session.setAttribute("userPO", userPO);
								ret =
									"/servlet/datapro.eibs.products.JSEDD2600?SCREEN=600&E01ACMACC=" + account;
							} else if (number.equalsIgnoreCase("2")){
								userPO.setOption("SV");
								userPO.setPurpose("APPROVAL_INQ");
								session.setAttribute("userPO", userPO);
								...
								session.setAttribute("userPO", userPO);
								ret =
									"/servlet/datapro.eibs.products.JSEDD0000A?SCREEN=800&E01ACMACC=" + account;
							}
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
					...
					case 6 : // Cuotas de Participacion
						try {
							if (number.equalsIgnoreCase("C")) {
								...
								session.setAttribute("userPO", userPO);
								ret =
									"/servlet/datapro.eibs.products.JSEDD0000A?SCREEN=4800&E01ACMACC=" + account;
							}
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						...
						try {
							if (number.equalsIgnoreCase("P")) {
								...
								if (number.equalsIgnoreCase("D")) {
									userPO.setOption("LN_REVERSAL");
									userPO.setPurpose("APPROVAL_INQ");
									session.setAttribute("userPO", userPO);
									ret = "/servlet/datapro.eibs.products.JSEDL1300?SCREEN=27&E01DEAACC=" + account;
								} else if (number.equalsIgnoreCase("T")) {
									userPO.setOption("LN_TRANSACTION");
									userPO.setPurpose("APPROVAL_INQ");
									session.setAttribute("userPO", userPO);
									ret = "/servlet/datapro.eibs.products.JSEDL0152A?SCREEN=800&E01DEAACC=" + account;
								} else if (number.equalsIgnoreCase("C")) {
									userPO.setOption("LN_COMMISSION");
									userPO.setPurpose("APPROVAL_INQ");
									session.setAttribute("userPO", userPO);
									ret = "/servlet/datapro.eibs.products.JSEDL0372?SCREEN=3000&E01DEAACC=" + account;
								} else if (number.equalsIgnoreCase("B")) {
									userPO.setOption("LN_DEDUCTION");
									userPO.setPurpose("APPROVAL_INQ");
									session.setAttribute("userPO", userPO);
									ret = "/servlet/datapro.eibs.products.JSEDL0371?SCREEN=3000&E01DEAACC=" + account;
								} else if (number.equalsIgnoreCase("R")) {
									if (userPO.getApplicationCode().equals("10")){
										userPO.setOption("PV");										
										userPO.setPurpose("APPROVAL_INQ");
										userPO.setIdentifier(account);
										session.setAttribute("userPO", userPO);
										ret = "/servlet/datapro.eibs.salesplatform.JSEPV0156?SCREEN=300&E01DEAACC=" + account;
									} else {
										userPO.setOption("LN_CHANGE_RATE");										
										userPO.setPurpose("APPROVAL_INQ");
										userPO.setIdentifier(account);
										session.setAttribute("userPO", userPO);
										ret = "/servlet/datapro.eibs.products.JSEDL0150A?SCREEN=13&E01DEAACC=" + account;
									}
								} else if (number.equalsIgnoreCase("Q")) {
										userPO.setOption("LN_RENEWAL");
										userPO.setPurpose("APPROVAL_INQ");
										session.setAttribute("userPO", userPO);
										ret = "/servlet/datapro.eibs.products.JSEDL0910?SCREEN=200&E01DEAACC=" + account;
								} else if (number.equalsIgnoreCase("M")) {
									userPO.setOption("LN_RENEWAL");
									userPO.setPurpose("APPROVAL_INQ");
									session.setAttribute("userPO", userPO);
									ret = "/servlet/datapro.eibs.products.JSEDL0910?SCREEN=201&E01DEAACC=" + account;
								} else if (number.equalsIgnoreCase("8")) {
									userPO.setOption("PV");
									userPO.setPurpose("APPROVAL_INQ");
									userPO.setHeader20("PRORROGA_CUOTAS");
									session.setAttribute("userPO", userPO);
									ret =  "/servlet/datapro.eibs.salesplatform.JSEPV1400?SCREEN=4&E01DEAACC=" + account;
								} else if (number.equalsIgnoreCase("9")) {
									userPO.setOption("PV");
									userPO.setPurpose("APPROVAL_INQ");
									userPO.setHeader20("PRORROGA_DESPLAZAMIENTO");
									session.setAttribute("userPO", userPO);
									ret =  "/servlet/datapro.eibs.salesplatform.JSEPV1400?SCREEN=4&E01DEAACC=" + account;
									...
									userPO.setPurpose("APPROVAL_INQ");
									session.setAttribute("userPO", userPO);
									ret =  "/servlet/datapro.eibs.products.JSEDL0135?SCREEN=300&E01DEAACC=" + account;
								} else {
									userPO.setOption("LN");
									userPO.setPurpose("APPROVAL_INQ");
									session.setAttribute("userPO", userPO);
									if (number.equals("G")) {
											ret = "/servlet/datapro.eibs.products.JSEDL0800?SCREEN=1200&E01DEAACC="
														+ account
														+ "&H01FLGWK2="
														+ number;
									} else {
					...
					case 43 :
						try {
							...
							ret = "/servlet/datapro.eibs.bolgaran.JSELC5560?SCREEN=2&E01LCMACC=" + account + "&OPT=" + bgOpt;
								...
								userPO.setPurpose("APPROVAL_INQ");
								session.setAttribute("userPO", userPO);
								ret = "/servlet/datapro.eibs.bolgaran.JSELC5085?SCREEN=900&E01LCMACC=" + account;
							}else {
								userPO.setOption("BG");
								userPO.setPurpose("APPROVAL_INQ");
								session.setAttribute("userPO", userPO);
								ret = "/servlet/datapro.eibs.bolgaran.JSELC5080?SCREEN=501&E01LCMACC=" + account;
							}		
				  		} 
						catch (Exception ex) {
							System.out.println("Error: " + ex); 
					...
					case 87 : // Official Check
						try {
							...
							session.setAttribute("userPO", userPO);
							ret =
								"/servlet/datapro.eibs.products.JSEOF0115IA?SCREEN=500&ACCNUM="
									+ account
									+ "&Currency="
									+ number;
						} catch (Exception ex) {
				...
				switch (appCode) {
					case 0 : // Client
						try {
							...
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.client.JSESD1080?SCREEN=6&E01CUN=" + account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;
					...
					case 6 : // Cuotas de Participacion
						try {
							...
							session.setAttribute("userPO", userPO);
							ret =
								"/servlet/datapro.eibs.products.JSEDD0000?SCREEN=4800&E01ACMACC=" + account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;
					case 10 : // Loans
						try {
							...
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.salesplatform.JSEPV0150?SCREEN=400&E01DEAACC=" + account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}						
						break;
					...
					case 40 :
						try {
							...
							userPO.setOption("LC");							
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.products.JSELC0510?SCREEN=3&E01LCMACC=" + account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;
					case 43 : //Boletas de Garantia
						try {
							userPO.setOption("BG");
							userPO.setPurpose("MAINTENANCE");
							userPO.setAccNum(account);
							...
							session.setAttribute("userPO", userPO);
							ret =
								"/servlet/datapro.eibs.bolgaran.JSELC5080?SCREEN=401&E01LCMACC=" + account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;

					case 60 : //CATALOGO CONTABLE
						try {
							userPO.setOption("GL");
							userPO.setPurpose("MAINTENANCE");
							session.setAttribute("userPO", userPO);
							String extraParams = "";
							if( number.length() > 2 ){
								extraParams = "&E01GLMBNK=" + number.substring(0,2) + "&E01GLMCCY=" + number.substring(2) ;
							}
							ret = "/servlet/datapro.eibs.products.JSEGL0340?SCREEN=200&E01GLMGLN=" + account + extraParams ;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}						
						break;
					...
					case 91 : // Garantia.
						try{							
							userPO.setPurpose("MAINTENANCE");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.client.JSERA0050?SCREEN=200&REF=" + account+"&PURPOSE=MAINTENANCE";
						}catch(Exception e){
							System.out.println("Error: "+ e);
						}
						break;
					case 92 : // Reservas Garantia.
						try{							
							userPO.setPurpose("MAINTENANCE");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.client.JSERA0075?SCREEN=102&REF=" + account+"&PURPOSE=MAINTENANCE";
						}catch(Exception e){
							System.out.println("Error: "+ e);
						}
						break;
					...
					case 88 : // Accounting Lots
						try {
							...
							userPO.setPurpose("MAINTENANCE");
							session.setAttribute("userPO", userPO);
							session.setAttribute("TARGET", "EGL0035");
				...
				switch (appCode) {
					...
					case 6 : // Cuotas de Participacion
						try {
							...
							session.setAttribute("userPO", userPO);
							ret =
								"/servlet/datapro.eibs.products.JSEDD1000?SCREEN=1&appCode=06&ACCNUM="
									+ account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
					...
					case 42 : // Letter of Credit
						try {
							...
							userPO.setPurpose("APPROVAL");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.products.JSELC0525?SCREEN=3";
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;
					case 60 : // GL ACCOUNTS
						try {
							...
							userPO.setAccNum(account);
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.products.JSEGL1340?SCREEN=100" ;					
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;
					...
					case 91 : // Collaterals
						try {
							...
							userPO.setPurpose("APPROVAL");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.client.JSERA0080?SCREEN=5&REFNUM=" + account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;						
					case 92 : // Reservas Garantias
						try {
							...
							userPO.setPurpose("APPROVAL");
							session.setAttribute("userPO", userPO);
							ret = "/servlet/datapro.eibs.client.JSERA0086?SCREEN=5&REFNUM=" + account;
						} catch (Exception ex) {
							System.out.println("Error: " + ex);
						}
						break;						
