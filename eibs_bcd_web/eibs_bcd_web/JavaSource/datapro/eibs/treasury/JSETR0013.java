...
/**
 * Dealer Slip for Treasury Investments 
...
public class JSETR0013 extends JSEIBSServlet { 
	...
	protected void procActionRec(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mp = null;
			mp = new MessageProcessor("ETR0013");
			newmessage = null;
			ETR001301Message msgD = (ETR001301Message) mp.getMessageRecord("ETR001301");
			// Send Initial data
			msgD.setH01USERID(user.getH01USR());
			msgD.setH01PROGRM("ETR0013");
			...
			forward("ETR0013_dealer_slip.jsp", req, res);
