...
public class JSEDD0310 extends datapro.eibs.master.SuperServlet {
	                                  ...
	                                  HttpSession ses) throws ServletException, IOException 
    {
	 ...
	 try {
		  ...
		  msgList.setH01PROGRM("EDD0310");
		  msgList.setH01TIMSYS(getTimeStamp());
		  msgList.setH01SCRCOD("01");
		  msgList.setH01OPECOD("0015");
		  msgList.setE01TLMUSU((req.getParameter("SEARCHCDE") == null ? userPO.getHeader2() : req.getParameter("SEARCHCDE")));
		  userPO.setHeader2(msgList.getE01TLMUSU());
		  msgList.send();
		  msgList.destroy();
	...
	protected void procReqBranchListDelete(
		...
		try {
			...
			int idx = Integer.parseInt(req.getParameter("key"));
										 ...
										 int scr) throws ServletException, IOException 
	{
	 ...
	 try {
		  ...
		  msgRT.setH01PROGRM("EDD0310");
		  msgRT.setH01TIMSYS(getTimeStamp());
		  msgRT.setH01SCRCOD("01");
		  msgRT.setE01TLMTYP(req.getParameter("E01TLMTYP"));
		  userPO.setHeader23(req.getParameter("E01TLMTYP"));
		                      ...
		                      HttpSession ses) throws ServletException, IOException 
    {
	 ...
	 msgRT.setD01TLMTYP(req.getParameter("D01TLMTYP"));
	 try { 
	 msgRT.setE01TLMLEV(req.getParameter("E01TLMLEV"));
     }
	 catch (Exception e) {
		 msgRT.setE01TLMLEV("0013");
		 msgRT.setD01TLMLEV("Cajero");
	 }
	 msgRT.setD01TLMLEV(req.getParameter("D01TLMLEV"));
	 
	 try { 
		 if (req.getParameter("E01TLMTYP").equals("T")) {msgRT.setD01TLMTYP("Cajero Regular"); 
		 												 msgRT.setE01TLMSOP("1");
		 }
		 
		 if (req.getParameter("E01TLMTYP").equals("H")) {msgRT.setD01TLMTYP("Cajero Principal");
			 											 msgRT.setE01TLMSOP("2");
		 }
		 if (req.getParameter("E01TLMTYP").equals("O")) {msgRT.setD01TLMTYP("Oficial S/G");
			 											 msgRT.setE01TLMSOP("3");
		  } 
		 if (req.getParameter("E01TLMTYP").equals("S")) {msgRT.setD01TLMTYP("Supervisor");
			 											 msgRT.setE01TLMSOP("4");
		  } 
		 if (req.getParameter("E01TLMTYP").equals("I")) {msgRT.setD01TLMTYP("Cajero IBSBRANCH");
			 											 msgRT.setE01TLMSOP("5");
		 }
		 if (req.getParameter("E01TLMTYP").equals("G")) {msgRT.setD01TLMTYP("Supervisor General");
			 											 msgRT.setE01TLMSOP("4");
		  } 
	 }
	 catch (Exception e) {
		 msgRT.setE01TLMSOP("5");
		 msgRT.setD01TLMTYP("Cajero IBSBRANCH");
	 }
	 ...
	 msgRT.setH01PROGRM("EDD0310");
	 msgRT.setH01TIMSYS(getTimeStamp());
	 msgRT.setH01OPECOD("9999");

	 try {
		 if (!(req.getParameter("E01TLMTID").equals("9999999999"))){
		                              ...
		                              HttpSession ses) throws ServletException, IOException 
	{
	 ...
	 try {
		  JBObjList bl = (JBObjList) ses.getAttribute("EDD031001Help");
		  int idx = Util.parseInt(req.getParameter("key").trim());
		  bl.setCurrentRow(idx);
	  ...
	  else 
	    {
		 ...
		 try {
			  ...
			  try {
				   ...
				   mc =	new MessageContext(super.getMessageHandler("EDD0310", req));
				   try {
