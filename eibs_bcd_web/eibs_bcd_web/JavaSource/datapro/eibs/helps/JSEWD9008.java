...
// Source File Name:   JSEWD9008.java 
...
public class JSEWD9008 extends JSEIBSServlet {
	...
	protected void reqList(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		UserPos userPO = null;
		try {
			mp = new MessageProcessor("EWD9008");				
			EWD9008DSMessage msg = (EWD9008DSMessage) mp.getMessageRecord("EWD9008DS");
			...
			try {
            	msg.setSWDCOM(req.getParameter("SelNew"));
            } catch (Exception e) { }
			...
			userPO.setHeader18(msg.getSWDCOM().trim());
			...
			forward("EWD9008_canje_cover_helpmessage.jsp", req, res);
