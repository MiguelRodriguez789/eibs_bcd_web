		...
		try {
			...
			// Receive Error Y Data
				...
				if (newmessage.getFormatName().equals("ESB003001")) {
					...
					if (msgPart.getE01LOCLOC().equals("0") || msgPart.getE01LOCLOC().trim().equals(""))msgPart.setE01LOCLOC(req.getParameter("E01LOCLOC"));
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("ESB0030", req));
