				...
				if (newmessage.getFormatName().equals("ESWF01001")) {
					...
					while (true) {
						...
						if (msgList.getH01MAS().equals("*")) {
							...
							String chkOfac = (msgList.getH01WK3().equals("3") ? "<a href=\"javascript:showInqOFAC('" + msgList.getESW1ACR() + "')\">" +
									"<img src=\"" + req.getContextPath() + "/images/warning_16.jpg\" title=\"OFAC Posible Coincidencia\" align=\"middle\" border=\"0\" ></a>" : "");
								
							myRow = new StringBuffer();
							myRow.append("<TR>");
							myRow.append("<TD NOWRAP width=\"5%\">" 
								+ "<input type=\"radio\" name=\"REFNUM\" value=\""+ msgList.getESW1REF() + "\" " + chk
								+ " onclick=\"setValue('"+ msgList.getESW1USR()+ "')\">"
								+ chkOfac
								+ "</TD>");
							myRow.append("<TD NOWRAP width=\"15%\" ALIGN=CENTER>"
								+ Util.formatCell(msgList.getESW1FOR())
								+ "</TD>");
							myRow.append("<TD NOWRAP width=\"20%\" ALIGN=CENTER>"
							...
							myRow.append("<TD NOWRAP width=\"20%\" ALIGN=CENTER>"
								+  Util.formatCustomDate(user.getE01DTF(),
										msgList.getBigDecimalESW1DTM().intValue(),
										msgList.getBigDecimalESW1DTD().intValue(),
										msgList.getBigDecimalESW1DTY().intValue())
								+ "</TD>");	
							myRow.append("<TD NOWRAP width=\"20%\" ALIGN=CENTER>"
				...
				if (newmessage.getFormatName().equals("ESWF01001")) {
					...
					while (true) {
						...
						if (msgList.getH01MAS().equals("*")) {
							...
							myRow = new StringBuffer();
							myRow.append("<TR>");
							myRow.append("<TD NOWRAP width=\"5%\"><input type=\"radio\" name=\"index1\" value=\""
								+ msgList.getESW1REF()
								+ "\" "
								+ chk
								+ " onclick=\"setValue('"
								...
								+ msgList.getESW1REF()
								+ "')\"></TD>");
							myRow.append("<TD NOWRAP width=\"15%\" ALIGN=\"CENTER\"><A HREF=\"javascript:showInqApprovalSwiftFree('" + msgList.getESW1USR() + "', '" + msgList.getESW1REF() + "')\">"
								+ Util.formatCell(msgList.getESW1FOR())
								+ "</A></TD>");
							myRow.append("<TD NOWRAP width=\"20%\" ALIGN=\"CENTER\"><A HREF=\"javascript:showInqApprovalSwiftFree('" + msgList.getESW1USR() + "', '" + msgList.getESW1REF() + "')\">"
								+ Util.formatCell(msgList.getESW1USR())
								+ "</A></TD>");
							myRow.append("<TD NOWRAP width=\"20%\" ALIGN=\"CENTER\"><A HREF=\"javascript:showInqApprovalSwiftFree('" + msgList.getESW1USR() + "', '" + msgList.getESW1REF() + "')\">"
								+ Util.formatCell(msgList.getESW1REF())
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("ESWF010", req));
