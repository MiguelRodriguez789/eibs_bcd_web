				...
				if (newmessage.getFormatName().equals("EWD0325DS")) {
					...
					while (true) {
						...
						if (marker.equals("*")) {
							...
							myRow = "<TR>";
							myRow += "<TD NOWRAP width=\"5%\" ALIGN=CENTER><input type=\"radio\" name=\"REF\" value=\""
								+ msgList.getSWDREF()
								+ "\" "
								+ chk
								+ " onclick=\"getValor('"
								...
								+ msgList.getSWDACD()
								+ "')\"></TD>";
							myRow += "<TD NOWRAP width=\"20%\" ALIGN=CENTER>" + msgList.getSWDREF() + "</td>";
							myRow += "<TD NOWRAP width=\"20%\" ALIGN=LEFT>" + msgList.getSWDDSC() + "</td>";
							...
							myRow += "<TD NOWRAP width=\"20%\" ALIGN=RIGHT>"
								...
								+ "</td>";
							myRow += "<TD NOWRAP width=\"15%\" ALIGN=CENTER>" + msgList.getSWDDID() + "</td>";
							myRow += "</TR>";
							myRow += "</TR>";
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EWD0325", req));
