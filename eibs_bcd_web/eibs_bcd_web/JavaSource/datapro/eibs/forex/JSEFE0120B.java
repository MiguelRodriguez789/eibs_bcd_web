...
public class JSEFE0120B extends datapro.eibs.master.SuperServlet {
...
public void destroy() {
	...
	flexLog("free resources used by JSEFE0120B");
		...
		if (newmessage.getFormatName().equals("EFE0120DS")) {
			...
			if (IsNotError) {  // There are no errors
				if(msgFex.getE01FESTYP().equals("OPTI")){				
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_opt.jsp");
						callPage(LangPath + "EFE0120B_fe_basic_opt.jsp", req, res);	
					}
					catch (Exception e) {
					...
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_sf.jsp");
						callPage(LangPath + "EFE0120B_fe_basic_sf.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
					...
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_forward.jsp");
						callPage(LangPath + "EFE0120B_fe_basic_forward.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
					...
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_swap.jsp");
						callPage(LangPath + "EFE0120B_fe_basic_swap.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
				else if(msgFex.getE01FESTYP().trim().equals("NFR")){				
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_ndf.jsp");
						callPage(LangPath + "EFE0120B_fe_basic_ndf.jsp", req, res);	
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}				
...
protected void procActionSpot(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
	    newmessage = mc.receiveMessage();
				...
				userPO.setIdentifier(msgFex.getE01FESACC());
				userPO.setCusNum(msgFex.getE01FESCUN());
				userPO.setBank(msgFex.getE01FESCBK());
				userPO.setCusName(msgFex.getD01FESCPL());
				userPO.setCurrency(msgFex.getE01FESCCY());
				userPO.setProdCode(msgFex.getE01FESTYP());
				userPO.setHeader1(msgFex.getE01FESAMN());
				userPO.setHeader2("2");	
...
protected void procActionOption(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	protected void procActionSpotMod(ESS0030DSMessage user,
		...
		try {
			flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_sf_conf.jsp");
			callPage(LangPath + "EFE0120B_fe_basic_sf_conf.jsp", req, res);
		} catch (Exception e) {
			flexLog("Exception calling page " + e);
		}
	...
	protected void procActionForwardMod(ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		HttpSession ses)
		throws ServletException, IOException {
		...
		try {
			flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_forward_conf.jsp");
			callPage(LangPath + "EFE0120B_fe_basic_forward_conf.jsp", req, res);
		} catch (Exception e) {
			flexLog("Exception calling page " + e);
		}
	...
	protected void procActionNDMod(ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		HttpSession ses)
		throws ServletException, IOException {
		...
		try {
			flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_ndf_conf.jsp");
			callPage(LangPath + "EFE0120B_fe_basic_ndf_conf.jsp", req, res);
		} catch (Exception e) {
			flexLog("Exception calling page " + e);
		}

	}
	protected void procActionSwapMod(ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		HttpSession ses)
		throws ServletException, IOException {
		...
		try {
			flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_swap_conf.jsp");
			callPage(LangPath + "EFE0120B_fe_basic_swap_conf.jsp", req, res);
		} catch (Exception e) {
			flexLog("Exception calling page " + e);
		}
	...
	protected void procActionOptionMod(ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		HttpSession ses)
		throws ServletException, IOException {
		...
		try {
			flexLog("About to call Page: " + LangPath + "EFE0120B_fe_basic_opt_conf.jsp");
			callPage(LangPath + "EFE0120B_fe_basic_opt_conf.jsp", req, res);
		} catch (Exception e) {
			flexLog("Exception calling page " + e);
		}
	...
	protected void procReqEspInst(
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000005")) {
				...
				if (IsNotError) { // There are no errors 
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120B_fe_special_inst.jsp");
						callPage(LangPath + "EFE0120B_fe_special_inst.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				} else { // There are errors
	...
	if (session == null) {
		...
		try {
			...
			switch (screen) {
				...
				case A_SPOT_MOD :
				     procActionSpotMod(msgUser, req, res, session);
					 break;
				case A_FORWARD_MOD :
				     procActionForwardMod(msgUser, req, res, session);
					 break;
				case A_OPTION_MOD :
				     procActionOptionMod(msgUser, req, res, session);
					 break;
				case A_NDF_MOD :
				     procActionNDMod(msgUser, req, res, session);
					 break;
				case A_SWAP_MOD :
				     procActionSwapMod(msgUser, req, res, session);
					 break;
