			...
			if (newmessage.getFormatName().equals("ELEERR")) {
				...
				while (true) {
					...
					if (marker.equals("*")) {
						...
						chkWarn = (msgList.getH01FLGWK2().equals("A") ? "<a href=\"javascript:showInqWarn('" + msgList.getE01SWDREF() + "')\"><img src=\"../images/warning01.gif\" title=\"Warnings\" align=\"absmiddle\" border=\"0\" ></a>" : "");						 
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EFE0130", req));
