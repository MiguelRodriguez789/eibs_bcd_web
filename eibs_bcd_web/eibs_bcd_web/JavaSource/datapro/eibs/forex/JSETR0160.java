...
public class JSETR0160 extends datapro.eibs.master.SuperServlet {
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("ETR0160DS")) {
			...
			if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "ETR0160_fra_acc.jsp");
						callPage(LangPath + "ETR0160_fra_acc.jsp", req, res);	
					}
					catch (Exception e) {
