...
* Record format level identifier is 42BE469AF6EC1.
*/
...
public class EDL0230P1Message extends MessageRecord
{
  ...
  final static String rid = "42BE469AF6EC1";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 100, 11, 6, "E01DEARTE");
    fields[12] = fieldE01MATDAY =
    new DecimalField(message, HEADERSIZE + 111, 6, 0, "E01MATDAY");
    fields[13] = fieldE01MATDT1 =
    new DecimalField(message, HEADERSIZE + 117, 3, 0, "E01MATDT1");
    fields[14] = fieldE01MATDT2 =
    new DecimalField(message, HEADERSIZE + 120, 3, 0, "E01MATDT2");
    fields[15] = fieldE01MATDT3 =
    new DecimalField(message, HEADERSIZE + 123, 5, 0, "E01MATDT3");
    fields[16] = fieldE01MATBAL =
    new DecimalField(message, HEADERSIZE + 128, 17, 2, "E01MATBAL");
    fields[17] = fieldE01DEAEXR =
    new DecimalField(message, HEADERSIZE + 145, 13, 6, "E01DEAEXR");
    fields[18] = fieldE01MATBSE =
    new DecimalField(message, HEADERSIZE + 158, 17, 2, "E01MATBSE");
    fields[19] = fieldE01DEATYP =
    new CharacterField(message, HEADERSIZE + 175, 4, "E01DEATYP");
    fields[20] = fieldE01DEATRM =
    new DecimalField(message, HEADERSIZE + 179, 6, 0, "E01DEATRM");
    fields[21] = fieldE01DEATRC =
    new CharacterField(message, HEADERSIZE + 185, 1, "E01DEATRC");
    fields[22] = fieldE01DEAOFC =
    new CharacterField(message, HEADERSIZE + 186, 4, "E01DEAOFC");
    fields[23] = fieldE01OFCNME =
    new CharacterField(message, HEADERSIZE + 190, 45, "E01OFCNME");
    fields[24] = fieldE01OPNDT1 =
    new DecimalField(message, HEADERSIZE + 235, 3, 0, "E01OPNDT1");
    fields[25] = fieldE01OPNDT2 =
    new DecimalField(message, HEADERSIZE + 238, 3, 0, "E01OPNDT2");
    fields[26] = fieldE01OPNDT3 =
    new DecimalField(message, HEADERSIZE + 241, 5, 0, "E01OPNDT3");
    fields[27] = fieldE01CUSDT1 =
    new DecimalField(message, HEADERSIZE + 246, 3, 0, "E01CUSDT1");
    fields[28] = fieldE01CUSDT2 =
    new DecimalField(message, HEADERSIZE + 249, 3, 0, "E01CUSDT2");
    fields[29] = fieldE01CUSDT3 =
    new DecimalField(message, HEADERSIZE + 252, 5, 0, "E01CUSDT3");
    fields[30] = fieldE01WTOTAL =
    new DecimalField(message, HEADERSIZE + 257, 17, 2, "E01WTOTAL");
    fields[31] = fieldE01GRPNUM =
    new CharacterField(message, HEADERSIZE + 274, 3, "E01GRPNUM");
    fields[32] = fieldE01GRPNAM =
    new CharacterField(message, HEADERSIZE + 277, 60, "E01GRPNAM");
    fields[33] = fieldE01SGRNUM =
    new CharacterField(message, HEADERSIZE + 337, 3, "E01SGRNUM");
    fields[34] = fieldE01SGRNAM =
    new CharacterField(message, HEADERSIZE + 340, 60, "E01SGRNAM");
    fields[35] = fieldE01COSCEN =
    new DecimalField(message, HEADERSIZE + 400, 7, 0, "E01COSCEN");
    fields[36] = fieldE01CCNAME =
    new CharacterField(message, HEADERSIZE + 407, 60, "E01CCNAME");
    fields[37] = fieldE01ALLCCT =
    new CharacterField(message, HEADERSIZE + 467, 1, "E01ALLCCT");
    fields[38] = fieldE01CCAUTH =
    new CharacterField(message, HEADERSIZE + 468, 2400, "E01CCAUTH");
