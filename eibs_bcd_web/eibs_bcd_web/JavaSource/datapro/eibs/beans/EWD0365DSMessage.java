...
* Record format level identifier is 3B05FB7FDCFF3.
*/
...
public class EWD0365DSMessage extends MessageRecord
{
  ...
  final static String rid = "3B05FB7FDCFF3";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 31, 17, 0, "RWDACC");
    fields[5] = fieldRWDBTH =
    new DecimalField(message, HEADERSIZE + 48, 6, 0, "RWDBTH");
    fields[6] = fieldRWDFD1 =
    new DecimalField(message, HEADERSIZE + 54, 5, 0, "RWDFD1");
    fields[7] = fieldRWDFD2 =
    new DecimalField(message, HEADERSIZE + 59, 3, 0, "RWDFD2");
    fields[8] = fieldRWDFD3 =
    new DecimalField(message, HEADERSIZE + 62, 3, 0, "RWDFD3");
    fields[9] = fieldRWDSTS =
    new CharacterField(message, HEADERSIZE + 65, 1, "RWDSTS");
    fields[10] = fieldRWDNUM =
    new DecimalField(message, HEADERSIZE + 66, 13, 0, "RWDNUM");
    fields[11] = fieldRWDFRC =
    new DecimalField(message, HEADERSIZE + 79, 8, 0, "RWDFRC");
    fields[12] = fieldSWDNUM =
    new DecimalField(message, HEADERSIZE + 87, 13, 0, "SWDNUM");
    fields[13] = fieldSWDCUN =
    new DecimalField(message, HEADERSIZE + 100, 10, 0, "SWDCUN");
    fields[14] = fieldSWDACC =
    new DecimalField(message, HEADERSIZE + 110, 17, 0, "SWDACC");
    fields[15] = fieldSWDNA1 =
    new CharacterField(message, HEADERSIZE + 127, 60, "SWDNA1");
    fields[16] = fieldSWDOCD =
    new CharacterField(message, HEADERSIZE + 187, 10, "SWDOCD");
    fields[17] = fieldSWDVD1 =
    new DecimalField(message, HEADERSIZE + 197, 5, 0, "SWDVD1");
    fields[18] = fieldSWDVD2 =
    new DecimalField(message, HEADERSIZE + 202, 3, 0, "SWDVD2");
    fields[19] = fieldSWDVD3 =
    new DecimalField(message, HEADERSIZE + 205, 3, 0, "SWDVD3");
    fields[20] = fieldSWDBTH =
    new DecimalField(message, HEADERSIZE + 208, 6, 0, "SWDBTH");
    fields[21] = fieldSWDECD =
    new CharacterField(message, HEADERSIZE + 214, 3, "SWDECD");
    fields[22] = fieldSWDROU =
    new CharacterField(message, HEADERSIZE + 217, 9, "SWDROU");
    fields[23] = fieldSWDDAC =
    new CharacterField(message, HEADERSIZE + 226, 17, "SWDDAC");
    fields[24] = fieldSWDCCY =
    new CharacterField(message, HEADERSIZE + 243, 3, "SWDCCY");
    fields[25] = fieldSWDAMT =
    new DecimalField(message, HEADERSIZE + 246, 17, 2, "SWDAMT");
    fields[26] = fieldSWDSTS =
    new CharacterField(message, HEADERSIZE + 263, 1, "SWDSTS");
    fields[27] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 264, 8, 0, "SWDREC");
    fields[28] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 272, 1, "SWDOPE");
