...
/**
* Class generated by AS/400 CRTCLASS command from ERC0340P01 physical file definition.
* 
* File level identifier is 1101206154845.
* Record format level identifier is 37EF1688C9454.
*/

public class ERC0340P01Message extends MessageRecord
{
  ...
  final static String fid = "1101206154845";
  final static String rid = "37EF1688C9454";
  final static String fmtname = "ERC0340P01";
  ...
  /**
  * Constructor for ERC0340P01Message.
  */
  public ERC0340P01Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 209, 3, 0, "E01BRMLMY");
    fields[18] = fieldE01BRMLMT =
    new CharacterField(message, HEADERSIZE + 212, 26, "E01BRMLMT");
    fields[19] = fieldE01BRMLMU =
    new CharacterField(message, HEADERSIZE + 238, 10, "E01BRMLMU");
    fields[20] = fieldE01BRMEOD =
    new CharacterField(message, HEADERSIZE + 248, 1, "E01BRMEOD");
    fields[21] = fieldE01BRMA1D =
    new DecimalField(message, HEADERSIZE + 249, 4, 0, "E01BRMA1D");
    fields[22] = fieldE01BRMA1E =
    new CharacterField(message, HEADERSIZE + 253, 60, "E01BRMA1E");
    fields[23] = fieldE01BRMA1A =
    new DecimalField(message, HEADERSIZE + 313, 17, 2, "E01BRMA1A");
    fields[24] = fieldE01BRMA2D =
    new DecimalField(message, HEADERSIZE + 330, 4, 0, "E01BRMA2D");
    fields[25] = fieldE01BRMA2E =
    new CharacterField(message, HEADERSIZE + 334, 60, "E01BRMA2E");
    fields[26] = fieldE01BRMA2A =
    new DecimalField(message, HEADERSIZE + 394, 17, 2, "E01BRMA2A");
    fields[27] = fieldE01BRMA3D =
    new DecimalField(message, HEADERSIZE + 411, 4, 0, "E01BRMA3D");
    fields[28] = fieldE01BRMA3E =
    new CharacterField(message, HEADERSIZE + 415, 60, "E01BRMA3E");
    fields[29] = fieldE01BRMA3A =
    new DecimalField(message, HEADERSIZE + 475, 17, 2, "E01BRMA3A");
    fields[30] = fieldE01BRMA4D =
    new DecimalField(message, HEADERSIZE + 492, 4, 0, "E01BRMA4D");
    fields[31] = fieldE01BRMA4E =
    new CharacterField(message, HEADERSIZE + 496, 60, "E01BRMA4E");
    fields[32] = fieldE01BRMA4A =
    new DecimalField(message, HEADERSIZE + 556, 17, 2, "E01BRMA4A");
    fields[33] = fieldE01BRMA5D =
    new DecimalField(message, HEADERSIZE + 573, 4, 0, "E01BRMA5D");
    fields[34] = fieldE01BRMA5E =
    new CharacterField(message, HEADERSIZE + 577, 60, "E01BRMA5E");
    fields[35] = fieldE01BRMA5A =
    new DecimalField(message, HEADERSIZE + 637, 17, 2, "E01BRMA5A");
    fields[36] = fieldE01BRMNMC =
    new CharacterField(message, HEADERSIZE + 654, 50, "E01BRMNMC");
    fields[37] = fieldE01BRMTE1 =
    new CharacterField(message, HEADERSIZE + 704, 12, "E01BRMTE1");
    fields[38] = fieldE01BRMEMC =
    new CharacterField(message, HEADERSIZE + 716, 60, "E01BRMEMC");
    fields[39] = fieldE01BRMER1 =
    new CharacterField(message, HEADERSIZE + 776, 1, "E01BRMER1");
    fields[40] = fieldE01BRMER2 =
    new CharacterField(message, HEADERSIZE + 777, 1, "E01BRMER2");
    fields[41] = fieldE01BRMER3 =
    new CharacterField(message, HEADERSIZE + 778, 1, "E01BRMER3");
    fields[42] = fieldE01BRMER4 =
    new CharacterField(message, HEADERSIZE + 779, 1, "E01BRMER4");
    fields[43] = fieldE01BRMRE1 =
    new CharacterField(message, HEADERSIZE + 780, 60, "E01BRMRE1");
    fields[44] = fieldE01BRMRE2 =
    new CharacterField(message, HEADERSIZE + 840, 60, "E01BRMRE2");
    fields[45] = fieldE01BRMRE3 =
    new CharacterField(message, HEADERSIZE + 900, 60, "E01BRMRE3");
    fields[46] = fieldE01BRMMCH =
    new DecimalField(message, HEADERSIZE + 960, 17, 2, "E01BRMMCH");
    fields[47] = fieldE01BRMRCH =
    new DecimalField(message, HEADERSIZE + 977, 17, 2, "E01BRMRCH");
    fields[48] = fieldE01BRMDAC =
    new DecimalField(message, HEADERSIZE + 994, 13, 0, "E01BRMDAC");
    fields[49] = fieldE01BRMCGN =
    new DecimalField(message, HEADERSIZE + 1007, 17, 0, "E01BRMCGN");
    fields[50] = fieldE01BRMFNM =
    new CharacterField(message, HEADERSIZE + 1024, 128, "E01BRMFNM");
    fields[51] = fieldE01BRMIPA =
    new CharacterField(message, HEADERSIZE + 1152, 15, "E01BRMIPA");
