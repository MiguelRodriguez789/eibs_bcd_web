...
* Record format level identifier is 3A65B361BC5F8.
*/
...
public class EDD700001Message extends MessageRecord
{
  ...
  final static String rid = "3A65B361BC5F8";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 100, 45, "E01CUSNA2");
    fields[12] = fieldE01CUSNA3 =
    new CharacterField(message, HEADERSIZE + 145, 45, "E01CUSNA3");
    fields[13] = fieldE01CUSNA4 =
    new CharacterField(message, HEADERSIZE + 190, 45, "E01CUSNA4");
    fields[14] = fieldE01CUSIDN =
    new CharacterField(message, HEADERSIZE + 235, 25, "E01CUSIDN");
    fields[15] = fieldE01CUSTI1 =
    new CharacterField(message, HEADERSIZE + 260, 45, "E01CUSTI1");
    fields[16] = fieldE01CUSTI2 =
    new CharacterField(message, HEADERSIZE + 305, 45, "E01CUSTI2");
    fields[17] = fieldE01CUSTI3 =
    new CharacterField(message, HEADERSIZE + 350, 45, "E01CUSTI3");
    fields[18] = fieldE01CUSTI4 =
    new CharacterField(message, HEADERSIZE + 395, 45, "E01CUSTI4");
    fields[19] = fieldE01CUSID1 =
    new CharacterField(message, HEADERSIZE + 440, 25, "E01CUSID1");
    fields[20] = fieldE01CUSID2 =
    new CharacterField(message, HEADERSIZE + 465, 25, "E01CUSID2");
    fields[21] = fieldE01CUSID3 =
    new CharacterField(message, HEADERSIZE + 490, 25, "E01CUSID3");
    fields[22] = fieldE01CUSID4 =
    new CharacterField(message, HEADERSIZE + 515, 25, "E01CUSID4");
    fields[23] = fieldE01CUSBRN =
    new DecimalField(message, HEADERSIZE + 540, 5, 0, "E01CUSBRN");
    fields[24] = fieldE01CUSRDM =
    new DecimalField(message, HEADERSIZE + 545, 3, 0, "E01CUSRDM");
    fields[25] = fieldE01CUSRDD =
    new DecimalField(message, HEADERSIZE + 548, 3, 0, "E01CUSRDD");
    fields[26] = fieldE01CUSRDY =
    new DecimalField(message, HEADERSIZE + 551, 5, 0, "E01CUSRDY");
    fields[27] = fieldE01CUSF01 =
    new CharacterField(message, HEADERSIZE + 556, 1, "E01CUSF01");
    fields[28] = fieldE01CUSPBN =
    new DecimalField(message, HEADERSIZE + 557, 9, 0, "E01CUSPBN");
    fields[29] = fieldE01CUSMOT =
    new CharacterField(message, HEADERSIZE + 566, 1, "E01CUSMOT");
    fields[30] = fieldE01FMTBCC =
    new CharacterField(message, HEADERSIZE + 567, 45, "E01FMTBCC");
    fields[31] = fieldE01BRNNUM =
    new DecimalField(message, HEADERSIZE + 612, 4, 0, "E01BRNNUM");
    fields[32] = fieldE01BRNNME =
    new CharacterField(message, HEADERSIZE + 616, 45, "E01BRNNME");
