...
* Record format level identifier is 2E69402F48EA6.
*/
...
public class EWD0160DSMessage extends MessageRecord
{
  ...
  final static String rid = "2E69402F48EA6";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 21, 45, "EWDRNM");
    fields[4] = fieldEWDSUC =
    new CharacterField(message, HEADERSIZE + 66, 4, "EWDSUC");
    fields[5] = fieldEWDEML =
    new CharacterField(message, HEADERSIZE + 70, 60, "EWDEML");
    fields[6] = fieldEWDPHN =
    new DecimalField(message, HEADERSIZE + 130, 16, 0, "EWDPHN");
    fields[7] = fieldEWDPXT =
    new DecimalField(message, HEADERSIZE + 146, 5, 0, "EWDPXT");
    fields[8] = fieldEWDSEG =
    new CharacterField(message, HEADERSIZE + 151, 4, "EWDSEG");
    fields[9] = fieldEWDTAT =
    new CharacterField(message, HEADERSIZE + 155, 1, "EWDTAT");
    fields[10] = fieldEWDAPL =
    new CharacterField(message, HEADERSIZE + 156, 4, "EWDAPL");
    fields[11] = fieldEWDLNA =
    new CharacterField(message, HEADERSIZE + 160, 1, "EWDLNA");
    fields[12] = fieldEWDALM =
    new DecimalField(message, HEADERSIZE + 161, 17, 2, "EWDALM");
    fields[13] = fieldEWDANG =
    new DecimalField(message, HEADERSIZE + 178, 17, 2, "EWDANG");
    fields[14] = fieldEWDRMK =
    new CharacterField(message, HEADERSIZE + 195, 45, "EWDRMK");
    fields[15] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 240, 1, "EWDOPE");
