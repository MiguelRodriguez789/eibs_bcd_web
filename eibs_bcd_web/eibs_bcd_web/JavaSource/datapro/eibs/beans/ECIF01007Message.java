...
/**
* Class generated by AS/400 CRTCLASS command from ECIF01007 physical file definition.
* 
* File level identifier is 1130611112845.
* Record format level identifier is 3A6EBB73DB884.
*/

public class ECIF01007Message extends MessageRecord
{
  ...
  final static String rid = "3A6EBB73DB884";
  final static String fmtname = "ECIF01007";
  ...
  /**
  * Constructor for ECIF01007Message.
  */
  public ECIF01007Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 57, 5, 0, "E07BRNNUM");
    fields[12] = fieldE07APCCDE =
    new CharacterField(message, HEADERSIZE + 62, 2, "E07APCCDE");
    fields[13] = fieldE07CUSCUN =
    new DecimalField(message, HEADERSIZE + 64, 10, 0, "E07CUSCUN");
    fields[14] = fieldE07CCYCDE =
    new CharacterField(message, HEADERSIZE + 74, 3, "E07CCYCDE");
    fields[15] = fieldE07ACCTYP =
    new CharacterField(message, HEADERSIZE + 77, 4, "E07ACCTYP");
    fields[16] = fieldE07PROCDE =
    new CharacterField(message, HEADERSIZE + 81, 4, "E07PROCDE");
    fields[17] = fieldE07CUSNA1 =
    new CharacterField(message, HEADERSIZE + 85, 60, "E07CUSNA1");
