...
* Record format level identifier is 55567330062BF.
*/
...
public class EPC002001Message extends MessageRecord
{
  ...
  final static String rid = "55567330062BF";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 326, 25, "E01PCMNRG");
    fields[22] = fieldE01PCMACD =
    new CharacterField(message, HEADERSIZE + 351, 2, "E01PCMACD");
    fields[23] = fieldE01PCMCLS =
    new DecimalField(message, HEADERSIZE + 353, 3, 0, "E01PCMCLS");
    fields[24] = fieldE01PCMPRO =
    new CharacterField(message, HEADERSIZE + 356, 4, "E01PCMPRO");
    fields[25] = fieldE01PCMPTY =
    new CharacterField(message, HEADERSIZE + 360, 4, "E01PCMPTY");
    fields[26] = fieldE01PCMPRD =
    new CharacterField(message, HEADERSIZE + 364, 4, "E01PCMPRD");
    fields[27] = fieldE01PCMATY =
    new CharacterField(message, HEADERSIZE + 368, 4, "E01PCMATY");
    fields[28] = fieldE01PCMVPR =
    new DecimalField(message, HEADERSIZE + 372, 17, 2, "E01PCMVPR");
    fields[29] = fieldE01PCMVSL =
    new DecimalField(message, HEADERSIZE + 389, 17, 2, "E01PCMVSL");
    fields[30] = fieldE01PCMPOL =
    new DecimalField(message, HEADERSIZE + 406, 3, 0, "E01PCMPOL");
    fields[31] = fieldE01PCMUNI =
    new DecimalField(message, HEADERSIZE + 409, 5, 0, "E01PCMUNI");
    fields[32] = fieldE01PCMTUN =
    new CharacterField(message, HEADERSIZE + 414, 4, "E01PCMTUN");
    fields[33] = fieldE01PCMRMK =
    new CharacterField(message, HEADERSIZE + 418, 60, "E01PCMRMK");
    fields[34] = fieldD01PCMCUN =
    new CharacterField(message, HEADERSIZE + 478, 45, "D01PCMCUN");
    fields[35] = fieldD01PCMPRO =
    new CharacterField(message, HEADERSIZE + 523, 45, "D01PCMPRO");
