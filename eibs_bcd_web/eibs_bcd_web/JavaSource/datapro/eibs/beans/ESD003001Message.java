...
/**
* Class generated by AS/400 CRTCLASS command from ESD003001 physical file definition.
* 
* File level identifier is 1130611113341.
* Record format level identifier is 508DC7D4EFC4A.
*/

public class ESD003001Message extends MessageRecord
{
  ...
  final static String rid = "508DC7D4EFC4A";
  final static String fmtname = "ESD003001";
  ...
  /**
  * Constructor for ESD003001Message.
  */
  public ESD003001Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[9] = fieldE01CNOTCN =
    new CharacterField(message, HEADERSIZE + 42, 2, "E01CNOTCN");
    fields[10] = fieldE01CNODCN =
    new CharacterField(message, HEADERSIZE + 44, 45, "E01CNODCN");
    fields[11] = fieldE01CNOSCR =
    new DecimalField(message, HEADERSIZE + 89, 3, 0, "E01CNOSCR");
    fields[12] = fieldE01CNOFLD =
    new DecimalField(message, HEADERSIZE + 92, 2, 0, "E01CNOFLD");
    fields[13] = fieldE01CNOLAN =
    new CharacterField(message, HEADERSIZE + 94, 1, "E01CNOLAN");
    fields[14] = fieldE01CNOOPE =
    new CharacterField(message, HEADERSIZE + 95, 1, "E01CNOOPE");
