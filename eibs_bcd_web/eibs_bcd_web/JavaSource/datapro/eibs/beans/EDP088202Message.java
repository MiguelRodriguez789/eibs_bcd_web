...
* Record format level identifier is 318A5E2189A58.
*/
...
public class EDP088202Message extends MessageRecord
{
  ...
  final static String rid = "318A5E2189A58";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 66, 60, "E02CUSNA1");
    fields[13] = fieldE02CUSLGT =
    new CharacterField(message, HEADERSIZE + 126, 1, "E02CUSLGT");
    fields[14] = fieldE02BNKFLG =
    new CharacterField(message, HEADERSIZE + 127, 1, "E02BNKFLG");
    fields[15] = fieldE02DUEPRD =
    new CharacterField(message, HEADERSIZE + 128, 4, "E02DUEPRD");
    fields[16] = fieldE02DUEPDS =
    new CharacterField(message, HEADERSIZE + 132, 45, "E02DUEPDS");
    fields[17] = fieldE02DUEAMT =
    new DecimalField(message, HEADERSIZE + 177, 17, 2, "E02DUEAMT");
    fields[18] = fieldE02DUERTE =
    new DecimalField(message, HEADERSIZE + 194, 13, 6, "E02DUERTE");
    fields[19] = fieldE02DUETRM =
    new DecimalField(message, HEADERSIZE + 207, 6, 0, "E02DUETRM");
    fields[20] = fieldE02DUERTM =
    new DecimalField(message, HEADERSIZE + 213, 11, 6, "E02DUERTM");
    fields[21] = fieldE02DUEPYM =
    new DecimalField(message, HEADERSIZE + 224, 17, 2, "E02DUEPYM");
    fields[22] = fieldE02RECPOS =
    new DecimalField(message, HEADERSIZE + 241, 8, 0, "E02RECPOS");
    fields[23] = fieldE02OPECDE =
    new CharacterField(message, HEADERSIZE + 249, 1, "E02OPECDE");
