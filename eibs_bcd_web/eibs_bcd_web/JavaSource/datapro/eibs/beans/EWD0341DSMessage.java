...
* Record format level identifier is 356A0DA1B75AD.
*/
...
public class EWD0341DSMessage extends MessageRecord
{
  ...
  final static String rid = "356A0DA1B75AD";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 53, 12, 0, "EWDNUM");
    fields[12] = fieldEWDTCY =
    new CharacterField(message, HEADERSIZE + 65, 3, "EWDTCY");
    fields[13] = fieldEWDAMT =
    new DecimalField(message, HEADERSIZE + 68, 17, 2, "EWDAMT");
    fields[14] = fieldEWDVD1 =
    new DecimalField(message, HEADERSIZE + 85, 3, 0, "EWDVD1");
    fields[15] = fieldEWDVD2 =
    new DecimalField(message, HEADERSIZE + 88, 3, 0, "EWDVD2");
    fields[16] = fieldEWDVD3 =
    new DecimalField(message, HEADERSIZE + 91, 5, 0, "EWDVD3");
    fields[17] = fieldEWDORC =
    new CharacterField(message, HEADERSIZE + 96, 45, "EWDORC");
    fields[18] = fieldEWDBNF =
    new CharacterField(message, HEADERSIZE + 141, 45, "EWDBNF");
    fields[19] = fieldEWDRPR =
    new CharacterField(message, HEADERSIZE + 186, 1, "EWDRPR");
    fields[20] = fieldEWDREC =
    new DecimalField(message, HEADERSIZE + 187, 8, 0, "EWDREC");
    fields[21] = fieldEWDFLG =
    new CharacterField(message, HEADERSIZE + 195, 1, "EWDFLG");
