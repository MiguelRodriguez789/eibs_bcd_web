...
/**
* Class generated by AS/400 CRTCLASS command from ERG000103 physical file definition.
* 
* File level identifier is 1100706173646.
* Record format level identifier is 4F064D54B9AE6.
*/

public class ERG000103Message extends MessageRecord
{
  ...
  final static String rid = "4F064D54B9AE6";
  final static String fmtname = "ERG000103";
  ...
  private DecimalField fieldGENPER = null;

  /**
  * Constructor for ERG000103Message.
  */
  public ERG000103Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[10] = fieldGENNRP =
    new DecimalField(message, HEADERSIZE + 43, 9, 0, "GENNRP");
    fields[11] = fieldGENPER =
    new DecimalField(message, HEADERSIZE + 52, 7, 0, "GENPER");
  ...
  */
  ...
  /**
  * Set numeric field GENPER using a BigDecimal value.
  */
  public void setGENPER(BigDecimal newvalue)
  {
    fieldGENPER.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field GENPER as a BigDecimal.
  */
  public BigDecimal getBigDecimalGENPER()
  {
    return fieldGENPER.getBigDecimal();
  }
