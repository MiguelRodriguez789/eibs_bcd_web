...
* Record format level identifier is 5605D2308FA33.
*/
...
public class ESWF020001Message extends MessageRecord
{
  ...
  final static String rid = "5605D2308FA33";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 48, 5, 0, "ESW1DT3");
    fields[7] = fieldESW1REC =
    new DecimalField(message, HEADERSIZE + 53, 8, 0, "ESW1REC");
    fields[8] = fieldESW1OPE =
    new CharacterField(message, HEADERSIZE + 61, 1, "ESW1OPE");
    fields[9] = fieldESW1LIN =
    new DecimalField(message, HEADERSIZE + 62, 5, 0, "ESW1LIN");
    fields[10] = fieldESW1F01 =
    new CharacterField(message, HEADERSIZE + 67, 80, "ESW1F01");
