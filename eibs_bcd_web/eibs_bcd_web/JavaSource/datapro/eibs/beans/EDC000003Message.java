...
* Record format level identifier is 4350C88ED551A.
*/
...
public class EDC000003Message extends MessageRecord
{
  ...
  final static String rid = "4350C88ED551A";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 67, 60, "E03CUSNA1");
    fields[13] = fieldE03DCMPRO =
    new CharacterField(message, HEADERSIZE + 127, 4, "E03DCMPRO");
    fields[14] = fieldE03DSCPRO =
    new CharacterField(message, HEADERSIZE + 131, 60, "E03DSCPRO");
    fields[15] = fieldE03DCMATY =
    new CharacterField(message, HEADERSIZE + 191, 4, "E03DCMATY");
    fields[16] = fieldE03DCMTYP =
    new CharacterField(message, HEADERSIZE + 195, 1, "E03DCMTYP");
    fields[17] = fieldE03DCMBNK =
    new CharacterField(message, HEADERSIZE + 196, 2, "E03DCMBNK");
    fields[18] = fieldE03DCMBRN =
    new DecimalField(message, HEADERSIZE + 198, 5, 0, "E03DCMBRN");
    fields[19] = fieldE03DCMCCY =
    new CharacterField(message, HEADERSIZE + 203, 3, "E03DCMCCY");
    fields[20] = fieldE03DCMGLN =
    new DecimalField(message, HEADERSIZE + 206, 17, 0, "E03DCMGLN");
    fields[21] = fieldE03DCMOPR =
    new CharacterField(message, HEADERSIZE + 223, 10, "E03DCMOPR");
    fields[22] = fieldE03DCMAMN =
    new DecimalField(message, HEADERSIZE + 233, 17, 2, "E03DCMAMN");
    fields[23] = fieldE03DCMORF =
    new CharacterField(message, HEADERSIZE + 250, 16, "E03DCMORF");
    fields[24] = fieldE03DCMCRF =
    new CharacterField(message, HEADERSIZE + 266, 16, "E03DCMCRF");
    fields[25] = fieldE03DCMDRF =
    new CharacterField(message, HEADERSIZE + 282, 16, "E03DCMDRF");
    fields[26] = fieldE03DCMOPT =
    new CharacterField(message, HEADERSIZE + 298, 1, "E03DCMOPT");
    fields[27] = fieldE03DCMIDF =
    new CharacterField(message, HEADERSIZE + 299, 1, "E03DCMIDF");
    fields[28] = fieldE03DCMIDA =
    new DecimalField(message, HEADERSIZE + 300, 17, 2, "E03DCMIDA");
