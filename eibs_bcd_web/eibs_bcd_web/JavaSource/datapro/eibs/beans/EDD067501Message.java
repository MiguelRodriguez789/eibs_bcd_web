...
* Record format level identifier is 46D0D1189A8B6.
*/
...
public class EDD067501Message extends MessageRecord
{
  ...
  final static String rid = "46D0D1189A8B6";
  ...
  private CharacterField fieldE01POINPM = null;
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 102, 6, "E01PODLDT");
    fields[11] = fieldE01POILPN =
    new DecimalField(message, HEADERSIZE + 108, 5, 0, "E01POILPN");
    fields[12] = fieldE01POILPA =
    new DecimalField(message, HEADERSIZE + 113, 17, 2, "E01POILPA");
    fields[13] = fieldE01LSTREF =
    new CharacterField(message, HEADERSIZE + 130, 10, "E01LSTREF");
    fields[14] = fieldE01POIAM1 =
    new CharacterField(message, HEADERSIZE + 140, 11, "E01POIAM1");
    fields[15] = fieldE01POIAM2 =
    new CharacterField(message, HEADERSIZE + 151, 2, "E01POIAM2");
    fields[16] = fieldE01POIDCY =
    new CharacterField(message, HEADERSIZE + 153, 3, "E01POIDCY");
    fields[17] = fieldE01POIDGL =
    new DecimalField(message, HEADERSIZE + 156, 17, 0, "E01POIDGL");
    fields[18] = fieldE01POIDAC =
    new DecimalField(message, HEADERSIZE + 173, 13, 0, "E01POIDAC");
    fields[19] = fieldE01POIDSB =
    new DecimalField(message, HEADERSIZE + 186, 6, 0, "E01POIDSB");
    fields[20] = fieldE01POIDCS =
    new DecimalField(message, HEADERSIZE + 192, 9, 0, "E01POIDCS");
    fields[21] = fieldE01DEBDSC =
    new CharacterField(message, HEADERSIZE + 201, 60, "E01DEBDSC");
    fields[22] = fieldE01POICCY =
    new CharacterField(message, HEADERSIZE + 261, 3, "E01POICCY");
    fields[23] = fieldE01POICGL =
    new DecimalField(message, HEADERSIZE + 264, 17, 0, "E01POICGL");
    fields[24] = fieldE01POICAC =
    new DecimalField(message, HEADERSIZE + 281, 13, 0, "E01POICAC");
    fields[25] = fieldE01POICSB =
    new DecimalField(message, HEADERSIZE + 294, 6, 0, "E01POICSB");
    fields[26] = fieldE01POICCS =
    new DecimalField(message, HEADERSIZE + 300, 9, 0, "E01POICCS");
    fields[27] = fieldE01CREDSC =
    new CharacterField(message, HEADERSIZE + 309, 60, "E01CREDSC");
    fields[28] = fieldE01POIFRQ =
    new CharacterField(message, HEADERSIZE + 369, 1, "E01POIFRQ");
    fields[29] = fieldE01POIPMD =
    new CharacterField(message, HEADERSIZE + 370, 2, "E01POIPMD");
    fields[30] = fieldE01POIDYS =
    new CharacterField(message, HEADERSIZE + 372, 4, "E01POIDYS");
    fields[31] = fieldE01POINPM =
    new CharacterField(message, HEADERSIZE + 376, 4, "E01POINPM");
    fields[32] = fieldE01POIODA =
    new CharacterField(message, HEADERSIZE + 380, 1, "E01POIODA");
    fields[33] = fieldE01POISPM =
    new CharacterField(message, HEADERSIZE + 381, 1, "E01POISPM");
    fields[34] = fieldE01POIDBR =
    new DecimalField(message, HEADERSIZE + 382, 5, 0, "E01POIDBR");
    fields[35] = fieldE01POICBR =
    new DecimalField(message, HEADERSIZE + 387, 5, 0, "E01POICBR");
    fields[36] = fieldE01POIDSC =
    new CharacterField(message, HEADERSIZE + 392, 60, "E01POIDSC");
    fields[37] = fieldE01POIPMT =
    new CharacterField(message, HEADERSIZE + 452, 1, "E01POIPMT");
    fields[38] = fieldE01POIDAS =
    new CharacterField(message, HEADERSIZE + 453, 2, "E01POIDAS");
