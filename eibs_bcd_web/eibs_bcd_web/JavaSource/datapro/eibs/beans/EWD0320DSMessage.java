...
* Record format level identifier is 3F059373C7950.
*/
...
public class EWD0320DSMessage extends MessageRecord
{
  ...
  final static String rid = "3F059373C7950";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 25, 5, 0, "SWDBRN");
    fields[6] = fieldSWDCCY =
    new CharacterField(message, HEADERSIZE + 30, 3, "SWDCCY");
    fields[7] = fieldSWDCLS =
    new CharacterField(message, HEADERSIZE + 33, 4, "SWDCLS");
    fields[8] = fieldSWDDSC =
    new CharacterField(message, HEADERSIZE + 37, 60, "SWDDSC");
    fields[9] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 97, 8, 0, "SWDREC");
    fields[10] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 105, 1, "SWDOPE");
