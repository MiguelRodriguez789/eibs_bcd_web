...
/**
* Class generated by AS/400 CRTCLASS command from EDL037102 physical file definition.
* 
* File level identifier is 1160725180401.
* Record format level identifier is 3FDE977FC2831.
*/

public class EDL037102Message extends MessageRecord
{
  ...
  final static String rid = "3FDE977FC2831";
  final static String fmtname = "EDL037102";
  ...
  private CharacterField fieldE02DLIRTY = null;
  private CharacterField fieldE02DLIBSE = null;
  private DecimalField fieldE02DLIPLN = null;

  /**
  * Constructor for EDL037102Message.
  */
  public EDL037102Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 59, 45, "E02DLINME");
    fields[12] = fieldE02DLITYP =
    new CharacterField(message, HEADERSIZE + 104, 1, "E02DLITYP");
    fields[13] = fieldE02DLIDPM =
    new DecimalField(message, HEADERSIZE + 105, 19, 4, "E02DLIDPM");
    fields[14] = fieldE02DLIFAC =
    new CharacterField(message, HEADERSIZE + 124, 1, "E02DLIFAC");
    fields[15] = fieldE02DLIBNK =
    new CharacterField(message, HEADERSIZE + 125, 2, "E02DLIBNK");
    fields[16] = fieldE02DLIBRN =
    new DecimalField(message, HEADERSIZE + 127, 5, 0, "E02DLIBRN");
    fields[17] = fieldE02DLICCY =
    new CharacterField(message, HEADERSIZE + 132, 3, "E02DLICCY");
    fields[18] = fieldE02DLIGLN =
    new DecimalField(message, HEADERSIZE + 135, 17, 0, "E02DLIGLN");
    fields[19] = fieldE02DLIIVA =
    new CharacterField(message, HEADERSIZE + 152, 1, "E02DLIIVA");
    fields[20] = fieldE02DLIRTY =
    new CharacterField(message, HEADERSIZE + 153, 1, "E02DLIRTY");
    fields[21] = fieldE02DLIBSE =
    new CharacterField(message, HEADERSIZE + 154, 1, "E02DLIBSE");
    fields[22] = fieldE02DLIPLN =
    new DecimalField(message, HEADERSIZE + 155, 3, 0, "E02DLIPLN");
  ...
  */
  ...
  /**
  * Set field E02DLIRTY using a String value.
  */
  public void setE02DLIRTY(String newvalue)
  {
    fieldE02DLIRTY.setString(newvalue);
  }

  /**
  * Get value of field E02DLIRTY as a String.
  */
  public String getE02DLIRTY()
  {
    return fieldE02DLIRTY.getString();
  }

  /**
  * Set field E02DLIBSE using a String value.
  */
  public void setE02DLIBSE(String newvalue)
  {
    fieldE02DLIBSE.setString(newvalue);
  }

  /**
  * Get value of field E02DLIBSE as a String.
  */
  public String getE02DLIBSE()
  {
    return fieldE02DLIBSE.getString();
  }

  /**
  * Set field E02DLIPLN using a String value.
  */
  public void setE02DLIPLN(String newvalue)
  {
    fieldE02DLIPLN.setString(newvalue);
  }

  /**
  * Get value of field E02DLIPLN as a String.
  */
  public String getE02DLIPLN()
  {
    return fieldE02DLIPLN.getString();
  }

  /**
  * Set numeric field E02DLIPLN using a BigDecimal value.
  */
  public void setE02DLIPLN(BigDecimal newvalue)
  {
    fieldE02DLIPLN.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E02DLIPLN as a BigDecimal.
  */
  public BigDecimal getBigDecimalE02DLIPLN()
  {
    return fieldE02DLIPLN.getBigDecimal();
  }
