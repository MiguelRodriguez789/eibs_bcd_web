...
* Record format level identifier is 3CC1D1CD5DED7.
*/
...
public class EFO012003Message extends MessageRecord
{
  ...
  final static String rid = "3CC1D1CD5DED7";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 51, 4, "E03APCTYP");
    fields[13] = fieldE03APCCDT =
    new CharacterField(message, HEADERSIZE + 55, 2, "E03APCCDT");
    fields[14] = fieldE03APCDSC =
    new CharacterField(message, HEADERSIZE + 57, 45, "E03APCDSC");
    fields[15] = fieldE03NUMREC =
    new DecimalField(message, HEADERSIZE + 102, 8, 0, "E03NUMREC");
    fields[16] = fieldE03INDOPE =
    new CharacterField(message, HEADERSIZE + 110, 1, "E03INDOPE");
