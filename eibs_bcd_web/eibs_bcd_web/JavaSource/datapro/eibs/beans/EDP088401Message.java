...
/**
* Class generated by AS/400 CRTCLASS command from EDP088401 physical file definition.
* 
* File level identifier is 1130611113116.
* Record format level identifier is 3B540B3390C66.
*/

public class EDP088401Message extends MessageRecord
{
  ...
  final static String rid = "3B540B3390C66";
  final static String fmtname = "EDP088401";
  ...
  /**
  * Constructor for EDP088401Message.
  */
  public EDP088401Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 113, 1, "E01MODLGT");
    fields[13] = fieldE01MODCOD =
    new CharacterField(message, HEADERSIZE + 114, 4, "E01MODCOD");
    fields[14] = fieldE01MODDSC =
    new CharacterField(message, HEADERSIZE + 118, 45, "E01MODDSC");
    fields[15] = fieldE01MODPER =
    new DecimalField(message, HEADERSIZE + 163, 11, 6, "E01MODPER");
    fields[16] = fieldE01MODPET =
    new DecimalField(message, HEADERSIZE + 174, 11, 6, "E01MODPET");
    fields[17] = fieldE01PTSPTS =
    new DecimalField(message, HEADERSIZE + 185, 8, 3, "E01PTSPTS");
    fields[18] = fieldE01RECPOS =
    new DecimalField(message, HEADERSIZE + 193, 8, 0, "E01RECPOS");
    fields[19] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 201, 1, "E01OPECDE");
