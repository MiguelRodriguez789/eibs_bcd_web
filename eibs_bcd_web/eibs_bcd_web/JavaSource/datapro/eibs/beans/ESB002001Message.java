...
* Record format level identifier is 328F206158EEF.
*/
...
public class ESB002001Message extends MessageRecord
{
  ...
  final static String rid = "328F206158EEF";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 81, 50, "E01SBLRM1");
    fields[12] = fieldE01SBLRM2 =
    new CharacterField(message, HEADERSIZE + 131, 50, "E01SBLRM2");
    fields[13] = fieldE01SBLRM3 =
    new CharacterField(message, HEADERSIZE + 181, 50, "E01SBLRM3");
    fields[14] = fieldE01SBLRM4 =
    new CharacterField(message, HEADERSIZE + 231, 50, "E01SBLRM4");
    fields[15] = fieldE01SBLRM5 =
    new CharacterField(message, HEADERSIZE + 281, 50, "E01SBLRM5");
    fields[16] = fieldE01SBLVD1 =
    new DecimalField(message, HEADERSIZE + 331, 3, 0, "E01SBLVD1");
    fields[17] = fieldE01SBLVD2 =
    new DecimalField(message, HEADERSIZE + 334, 3, 0, "E01SBLVD2");
    fields[18] = fieldE01SBLVD3 =
    new DecimalField(message, HEADERSIZE + 337, 5, 0, "E01SBLVD3");
    fields[19] = fieldE01SBLITH =
    new DecimalField(message, HEADERSIZE + 342, 3, 0, "E01SBLITH");
    fields[20] = fieldE01SBLITM =
    new DecimalField(message, HEADERSIZE + 345, 3, 0, "E01SBLITM");
    fields[21] = fieldE01SBLITS =
    new DecimalField(message, HEADERSIZE + 348, 3, 0, "E01SBLITS");
    fields[22] = fieldE01SBLOTH =
    new DecimalField(message, HEADERSIZE + 351, 3, 0, "E01SBLOTH");
    fields[23] = fieldE01SBLOTM =
    new DecimalField(message, HEADERSIZE + 354, 3, 0, "E01SBLOTM");
    fields[24] = fieldE01SBLOTS =
    new DecimalField(message, HEADERSIZE + 357, 3, 0, "E01SBLOTS");
    fields[25] = fieldE01SBLOFC =
    new CharacterField(message, HEADERSIZE + 360, 5, "E01SBLOFC");
    fields[26] = fieldS01FRDT1 =
    new DecimalField(message, HEADERSIZE + 365, 3, 0, "S01FRDT1");
    fields[27] = fieldS01FRDT2 =
    new DecimalField(message, HEADERSIZE + 368, 3, 0, "S01FRDT2");
    fields[28] = fieldS01FRDT3 =
    new DecimalField(message, HEADERSIZE + 371, 5, 0, "S01FRDT3");
    fields[29] = fieldS01TODT1 =
    new DecimalField(message, HEADERSIZE + 376, 3, 0, "S01TODT1");
    fields[30] = fieldS01TODT2 =
    new DecimalField(message, HEADERSIZE + 379, 3, 0, "S01TODT2");
    fields[31] = fieldS01TODT3 =
    new DecimalField(message, HEADERSIZE + 382, 5, 0, "S01TODT3");
    fields[32] = fieldS01SBLDEP =
    new DecimalField(message, HEADERSIZE + 387, 13, 0, "S01SBLDEP");
    fields[33] = fieldS01SBLCUN =
    new DecimalField(message, HEADERSIZE + 400, 10, 0, "S01SBLCUN");
    fields[34] = fieldD01SBMTYP =
    new DecimalField(message, HEADERSIZE + 410, 5, 0, "D01SBMTYP");
    fields[35] = fieldD01SBTDSC =
    new CharacterField(message, HEADERSIZE + 415, 60, "D01SBTDSC");
    fields[36] = fieldD01SBMLOC =
    new CharacterField(message, HEADERSIZE + 475, 4, "D01SBMLOC");
    fields[37] = fieldD01LOCNME =
    new CharacterField(message, HEADERSIZE + 479, 80, "D01LOCNME");
    fields[38] = fieldD01SBMCUN =
    new DecimalField(message, HEADERSIZE + 559, 10, 0, "D01SBMCUN");
    fields[39] = fieldD01CUSNA1 =
    new CharacterField(message, HEADERSIZE + 569, 60, "D01CUSNA1");
