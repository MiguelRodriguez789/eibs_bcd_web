...
* Record format level identifier is 3AB940DAD461B.
*/
...
public class EGL036001Message extends MessageRecord
{
  ...
  final static String rid = "3AB940DAD461B";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 56, 5, 0, "E01CNTRD3");
    fields[15] = fieldE01RATEXR =
    new DecimalField(message, HEADERSIZE + 61, 13, 6, "E01RATEXR");
    fields[16] = fieldE01RATMUD =
    new CharacterField(message, HEADERSIZE + 74, 1, "E01RATMUD");
    fields[17] = fieldE01RATDCP =
    new DecimalField(message, HEADERSIZE + 75, 2, 0, "E01RATDCP");
    fields[18] = fieldE01RATDSC =
    new CharacterField(message, HEADERSIZE + 77, 60, "E01RATDSC");
    fields[19] = fieldE01RATCYA =
    new CharacterField(message, HEADERSIZE + 137, 25, "E01RATCYA");
    fields[20] = fieldE01RATRNM =
    new CharacterField(message, HEADERSIZE + 162, 4, "E01RATRNM");
    fields[21] = fieldE01RATSCY =
    new CharacterField(message, HEADERSIZE + 166, 3, "E01RATSCY");
    fields[22] = fieldE01RATTLR =
    new DecimalField(message, HEADERSIZE + 169, 8, 3, "E01RATTLR");
    fields[23] = fieldE01RATTLO =
    new DecimalField(message, HEADERSIZE + 177, 8, 3, "E01RATTLO");
    fields[24] = fieldE01RATBSE =
    new DecimalField(message, HEADERSIZE + 185, 4, 0, "E01RATBSE");
    fields[25] = fieldE01RATNAT =
    new CharacterField(message, HEADERSIZE + 189, 1, "E01RATNAT");
    fields[26] = fieldE01RATNAC =
    new DecimalField(message, HEADERSIZE + 190, 17, 0, "E01RATNAC");
    fields[27] = fieldE01RATPBK =
    new CharacterField(message, HEADERSIZE + 207, 2, "E01RATPBK");
    fields[28] = fieldE01RATPCY =
    new CharacterField(message, HEADERSIZE + 209, 3, "E01RATPCY");
    fields[29] = fieldE01RATPGL =
    new DecimalField(message, HEADERSIZE + 212, 17, 0, "E01RATPGL");
    fields[30] = fieldE01GLDSCP =
    new CharacterField(message, HEADERSIZE + 229, 45, "E01GLDSCP");
    fields[31] = fieldE01RATVBK =
    new CharacterField(message, HEADERSIZE + 274, 2, "E01RATVBK");
    fields[32] = fieldE01RATVCY =
    new CharacterField(message, HEADERSIZE + 276, 3, "E01RATVCY");
    fields[33] = fieldE01RATVGL =
    new DecimalField(message, HEADERSIZE + 279, 17, 0, "E01RATVGL");
    fields[34] = fieldE01GLDSCV =
    new CharacterField(message, HEADERSIZE + 296, 45, "E01GLDSCV");
    fields[35] = fieldE01RATBK1 =
    new CharacterField(message, HEADERSIZE + 341, 2, "E01RATBK1");
    fields[36] = fieldE01RATCY1 =
    new CharacterField(message, HEADERSIZE + 343, 3, "E01RATCY1");
    fields[37] = fieldE01RATGL1 =
    new DecimalField(message, HEADERSIZE + 346, 17, 0, "E01RATGL1");
    fields[38] = fieldE01GLDSC1 =
    new CharacterField(message, HEADERSIZE + 363, 45, "E01GLDSC1");
    fields[39] = fieldE01RATBK2 =
    new CharacterField(message, HEADERSIZE + 408, 2, "E01RATBK2");
    fields[40] = fieldE01RATCY2 =
    new CharacterField(message, HEADERSIZE + 410, 3, "E01RATCY2");
    fields[41] = fieldE01RATGL2 =
    new DecimalField(message, HEADERSIZE + 413, 17, 0, "E01RATGL2");
    fields[42] = fieldE01GLDSC2 =
    new CharacterField(message, HEADERSIZE + 430, 45, "E01GLDSC2");
    fields[43] = fieldE01RATBK3 =
    new CharacterField(message, HEADERSIZE + 475, 2, "E01RATBK3");
    fields[44] = fieldE01RATCY3 =
    new CharacterField(message, HEADERSIZE + 477, 3, "E01RATCY3");
    fields[45] = fieldE01RATGL3 =
    new DecimalField(message, HEADERSIZE + 480, 17, 0, "E01RATGL3");
    fields[46] = fieldE01GLDSC3 =
    new CharacterField(message, HEADERSIZE + 497, 45, "E01GLDSC3");
    fields[47] = fieldE01RATBK4 =
    new CharacterField(message, HEADERSIZE + 542, 2, "E01RATBK4");
    fields[48] = fieldE01RATCY4 =
    new CharacterField(message, HEADERSIZE + 544, 3, "E01RATCY4");
    fields[49] = fieldE01RATGL4 =
    new DecimalField(message, HEADERSIZE + 547, 17, 0, "E01RATGL4");
    fields[50] = fieldE01GLDSC4 =
    new CharacterField(message, HEADERSIZE + 564, 45, "E01GLDSC4");
    fields[51] = fieldE01RATACF =
    new CharacterField(message, HEADERSIZE + 609, 1, "E01RATACF");
    fields[52] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 610, 1, "E01OPECDE");
