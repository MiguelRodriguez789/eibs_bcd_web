...
/**
* Class generated by AS/400 CRTCLASS command from EWD0030DS physical file definition.
* 
* File level identifier is 1130611113448.
* Record format level identifier is 3B1F7A67B523D.
*/

public class EWD0030DSMessage extends MessageRecord
{
  ...
  final static String rid = "3B1F7A67B523D";
  final static String fmtname = "EWD0030DS";
  ...
  /**
  * Constructor for EWD0030DSMessage.
  */
  public EWD0030DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 0, 45, "EWDSHR");
    fields[1] = fieldEWDNUM =
    new DecimalField(message, HEADERSIZE + 45, 10, 0, "EWDNUM");
    fields[2] = fieldEWDNM1 =
    new CharacterField(message, HEADERSIZE + 55, 60, "EWDNM1");
    fields[3] = fieldEWDVID =
    new CharacterField(message, HEADERSIZE + 115, 25, "EWDVID");
    fields[4] = fieldEWDREC =
    new DecimalField(message, HEADERSIZE + 140, 8, 0, "EWDREC");
    fields[5] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 148, 1, "EWDOPE");
