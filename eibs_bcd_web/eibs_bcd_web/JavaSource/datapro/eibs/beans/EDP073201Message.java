...
/**
* Class generated by AS/400 CRTCLASS command from EDP073201 physical file definition.
* 
* File level identifier is 1130611113113.
* Record format level identifier is 4D06B75E7F78B.
*/

public class EDP073201Message extends MessageRecord
{
  ...
  final static String rid = "4D06B75E7F78B";
  final static String fmtname = "EDP073201";
  ...
  /**
  * Constructor for EDP073201Message.
  */
  public EDP073201Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[10] = fieldE01IFDCUN =
    new DecimalField(message, HEADERSIZE + 43, 10, 0, "E01IFDCUN");
    fields[11] = fieldE01IFDFEY =
    new DecimalField(message, HEADERSIZE + 53, 5, 0, "E01IFDFEY");
    fields[12] = fieldE01IFDFEM =
    new DecimalField(message, HEADERSIZE + 58, 3, 0, "E01IFDFEM");
    fields[13] = fieldE01IFDCFO =
    new CharacterField(message, HEADERSIZE + 61, 2, "E01IFDCFO");
    fields[14] = fieldE01IFMCFA =
    new CharacterField(message, HEADERSIZE + 63, 4, "E01IFMCFA");
    fields[15] = fieldE01LIQUID =
    new DecimalField(message, HEADERSIZE + 67, 17, 2, "E01LIQUID");
    fields[16] = fieldE01PRUACI =
    new DecimalField(message, HEADERSIZE + 84, 17, 2, "E01PRUACI");
    fields[17] = fieldE01PEMECO =
    new DecimalField(message, HEADERSIZE + 101, 17, 2, "E01PEMECO");
    fields[18] = fieldE01ROTINV =
    new DecimalField(message, HEADERSIZE + 118, 17, 2, "E01ROTINV");
    fields[19] = fieldE01PEMEPA =
    new DecimalField(message, HEADERSIZE + 135, 17, 2, "E01PEMEPA");
    fields[20] = fieldE01ENDEUD =
    new DecimalField(message, HEADERSIZE + 152, 17, 2, "E01ENDEUD");
    fields[21] = fieldE01ENDFIN =
    new DecimalField(message, HEADERSIZE + 169, 17, 2, "E01ENDFIN");
    fields[22] = fieldE01RENACT =
    new DecimalField(message, HEADERSIZE + 186, 17, 2, "E01RENACT");
    fields[23] = fieldE01RENPAT =
    new DecimalField(message, HEADERSIZE + 203, 17, 2, "E01RENPAT");
    fields[24] = fieldE01MANEUT =
    new DecimalField(message, HEADERSIZE + 220, 17, 2, "E01MANEUT");
    fields[25] = fieldE01MAROPE =
    new DecimalField(message, HEADERSIZE + 237, 17, 2, "E01MAROPE");
    fields[26] = fieldE01RIEPAT =
    new DecimalField(message, HEADERSIZE + 254, 17, 2, "E01RIEPAT");
    fields[27] = fieldE01RIEVTA =
    new DecimalField(message, HEADERSIZE + 271, 17, 2, "E01RIEVTA");
