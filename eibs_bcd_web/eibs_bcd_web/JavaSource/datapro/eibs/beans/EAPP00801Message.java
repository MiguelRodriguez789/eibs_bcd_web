...
* Record format level identifier is 450489FD7B381.
*/
...
public class EAPP00801Message extends MessageRecord
{
  ...
  final static String rid = "450489FD7B381";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 333, 20, "E01INUMTAR");
    fields[24] = fieldE01IKEYTAR =
    new CharacterField(message, HEADERSIZE + 353, 20, "E01IKEYTAR");
    fields[25] = fieldE01SQPRC =
    new DecimalField(message, HEADERSIZE + 373, 3, 0, "E01SQPRC");
    fields[26] = fieldE01SCPRC1 =
    new CharacterField(message, HEADERSIZE + 376, 4, "E01SCPRC1");
    fields[27] = fieldE01SNPRC1 =
    new DecimalField(message, HEADERSIZE + 380, 13, 0, "E01SNPRC1");
    fields[28] = fieldE01SCPRC2 =
    new CharacterField(message, HEADERSIZE + 393, 4, "E01SCPRC2");
    fields[29] = fieldE01SNPRC2 =
    new DecimalField(message, HEADERSIZE + 397, 13, 0, "E01SNPRC2");
    fields[30] = fieldE01SCPRC3 =
    new CharacterField(message, HEADERSIZE + 410, 4, "E01SCPRC3");
    fields[31] = fieldE01SNPRC3 =
    new DecimalField(message, HEADERSIZE + 414, 13, 0, "E01SNPRC3");
    fields[32] = fieldE01SCPRC4 =
    new CharacterField(message, HEADERSIZE + 427, 4, "E01SCPRC4");
    fields[33] = fieldE01SNPRC4 =
    new DecimalField(message, HEADERSIZE + 431, 13, 0, "E01SNPRC4");
    fields[34] = fieldE01SCPRC5 =
    new CharacterField(message, HEADERSIZE + 444, 4, "E01SCPRC5");
    fields[35] = fieldE01SNPRC5 =
    new DecimalField(message, HEADERSIZE + 448, 13, 0, "E01SNPRC5");
    fields[36] = fieldE01SCPRC6 =
    new CharacterField(message, HEADERSIZE + 461, 4, "E01SCPRC6");
    fields[37] = fieldE01SNPRC6 =
    new DecimalField(message, HEADERSIZE + 465, 13, 0, "E01SNPRC6");
    fields[38] = fieldE01SCPRC7 =
    new CharacterField(message, HEADERSIZE + 478, 4, "E01SCPRC7");
    fields[39] = fieldE01SNPRC7 =
    new DecimalField(message, HEADERSIZE + 482, 13, 0, "E01SNPRC7");
    fields[40] = fieldE01SCPRC8 =
    new CharacterField(message, HEADERSIZE + 495, 4, "E01SCPRC8");
    fields[41] = fieldE01SNPRC8 =
    new DecimalField(message, HEADERSIZE + 499, 13, 0, "E01SNPRC8");
    fields[42] = fieldE01SCPRC9 =
    new CharacterField(message, HEADERSIZE + 512, 4, "E01SCPRC9");
    fields[43] = fieldE01SNPRC9 =
    new DecimalField(message, HEADERSIZE + 516, 13, 0, "E01SNPRC9");
    fields[44] = fieldE01SCPRC0 =
    new CharacterField(message, HEADERSIZE + 529, 4, "E01SCPRC0");
    fields[45] = fieldE01SNPRC0 =
    new DecimalField(message, HEADERSIZE + 533, 13, 0, "E01SNPRC0");
    fields[46] = fieldE01SCPRCA =
    new CharacterField(message, HEADERSIZE + 546, 4, "E01SCPRCA");
    fields[47] = fieldE01SNPRCA =
    new DecimalField(message, HEADERSIZE + 550, 13, 0, "E01SNPRCA");
    fields[48] = fieldE01SCPRCB =
    new CharacterField(message, HEADERSIZE + 563, 4, "E01SCPRCB");
    fields[49] = fieldE01SNPRCB =
    new DecimalField(message, HEADERSIZE + 567, 13, 0, "E01SNPRCB");
