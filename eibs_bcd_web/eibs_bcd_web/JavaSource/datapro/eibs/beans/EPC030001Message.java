...
* Record format level identifier is 6409DC869FAEE.
*/
...
public class EPC030001Message extends MessageRecord
{
  ...
  final static String rid = "6409DC869FAEE";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 55, 17, 0, "E01PCBNUM");
    fields[11] = fieldE01PCBCFL =
    new CharacterField(message, HEADERSIZE + 72, 2, "E01PCBCFL");
    fields[12] = fieldE01PCBRCD =
    new CharacterField(message, HEADERSIZE + 74, 4, "E01PCBRCD");
    fields[13] = fieldE01PCBCUN =
    new DecimalField(message, HEADERSIZE + 78, 10, 0, "E01PCBCUN");
    fields[14] = fieldE01PCBVLM =
    new DecimalField(message, HEADERSIZE + 88, 3, 0, "E01PCBVLM");
    fields[15] = fieldE01PCBVLD =
    new DecimalField(message, HEADERSIZE + 91, 3, 0, "E01PCBVLD");
    fields[16] = fieldE01PCBVLY =
    new DecimalField(message, HEADERSIZE + 94, 5, 0, "E01PCBVLY");
    fields[17] = fieldE01PCBRDM =
    new DecimalField(message, HEADERSIZE + 99, 3, 0, "E01PCBRDM");
    fields[18] = fieldE01PCBRDD =
    new DecimalField(message, HEADERSIZE + 102, 3, 0, "E01PCBRDD");
    fields[19] = fieldE01PCBRDY =
    new DecimalField(message, HEADERSIZE + 105, 5, 0, "E01PCBRDY");
    fields[20] = fieldE01PCBAMT =
    new DecimalField(message, HEADERSIZE + 110, 17, 2, "E01PCBAMT");
    fields[21] = fieldE01PCBPPR =
    new DecimalField(message, HEADERSIZE + 127, 23, 8, "E01PCBPPR");
    fields[22] = fieldE01PCBEAM =
    new DecimalField(message, HEADERSIZE + 150, 17, 2, "E01PCBEAM");
    fields[23] = fieldE01PCBEPR =
    new DecimalField(message, HEADERSIZE + 167, 23, 8, "E01PCBEPR");
    fields[24] = fieldE01PCBXAM =
    new DecimalField(message, HEADERSIZE + 190, 17, 2, "E01PCBXAM");
    fields[25] = fieldE01PCBXPR =
    new DecimalField(message, HEADERSIZE + 207, 23, 8, "E01PCBXPR");
    fields[26] = fieldE01PCBUSR =
    new CharacterField(message, HEADERSIZE + 230, 10, "E01PCBUSR");
    fields[27] = fieldD01PCMCUN =
    new CharacterField(message, HEADERSIZE + 240, 45, "D01PCMCUN");
    fields[28] = fieldD01PCMPRO =
    new CharacterField(message, HEADERSIZE + 285, 45, "D01PCMPRO");
    fields[29] = fieldF01PCBACC =
    new CharacterField(message, HEADERSIZE + 330, 1, "F01PCBACC");
    fields[30] = fieldF01PCBNUM =
    new CharacterField(message, HEADERSIZE + 331, 1, "F01PCBNUM");
    fields[31] = fieldF01PCBCFL =
    new CharacterField(message, HEADERSIZE + 332, 1, "F01PCBCFL");
    fields[32] = fieldF01PCBRCD =
    new CharacterField(message, HEADERSIZE + 333, 1, "F01PCBRCD");
    fields[33] = fieldF01PCBCUN =
    new CharacterField(message, HEADERSIZE + 334, 1, "F01PCBCUN");
    fields[34] = fieldF01PCBVLC =
    new CharacterField(message, HEADERSIZE + 335, 1, "F01PCBVLC");
    fields[35] = fieldF01PCBVLM =
    new CharacterField(message, HEADERSIZE + 336, 1, "F01PCBVLM");
    fields[36] = fieldF01PCBVLD =
    new CharacterField(message, HEADERSIZE + 337, 1, "F01PCBVLD");
    fields[37] = fieldF01PCBVLY =
    new CharacterField(message, HEADERSIZE + 338, 1, "F01PCBVLY");
    fields[38] = fieldF01PCBRDC =
    new CharacterField(message, HEADERSIZE + 339, 1, "F01PCBRDC");
    fields[39] = fieldF01PCBRDM =
    new CharacterField(message, HEADERSIZE + 340, 1, "F01PCBRDM");
    fields[40] = fieldF01PCBRDD =
    new CharacterField(message, HEADERSIZE + 341, 1, "F01PCBRDD");
    fields[41] = fieldF01PCBRDY =
    new CharacterField(message, HEADERSIZE + 342, 1, "F01PCBRDY");
    fields[42] = fieldF01PCBAMT =
    new CharacterField(message, HEADERSIZE + 343, 1, "F01PCBAMT");
    fields[43] = fieldF01PCBPPR =
    new CharacterField(message, HEADERSIZE + 344, 1, "F01PCBPPR");
    fields[44] = fieldF01PCBEAM =
    new CharacterField(message, HEADERSIZE + 345, 1, "F01PCBEAM");
    fields[45] = fieldF01PCBEPR =
    new CharacterField(message, HEADERSIZE + 346, 1, "F01PCBEPR");
    fields[46] = fieldF01PCBXAM =
    new CharacterField(message, HEADERSIZE + 347, 1, "F01PCBXAM");
    fields[47] = fieldF01PCBXPR =
    new CharacterField(message, HEADERSIZE + 348, 1, "F01PCBXPR");
    fields[48] = fieldF01PCBUSR =
    new CharacterField(message, HEADERSIZE + 349, 1, "F01PCBUSR");
