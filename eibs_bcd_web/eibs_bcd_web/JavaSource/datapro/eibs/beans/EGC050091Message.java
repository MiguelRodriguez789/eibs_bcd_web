...
* Record format level identifier is 3A18516F672F8.
*/
...
public class EGC050091Message extends MessageRecord
{
  ...
  final static String rid = "3A18516F672F8";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 71, 45, "E91GCNMBC");
    fields[12] = fieldE91GCGTYA =
    new CharacterField(message, HEADERSIZE + 116, 1, "E91GCGTYA");
    fields[13] = fieldE91GCNGTY =
    new DecimalField(message, HEADERSIZE + 117, 6, 0, "E91GCNGTY");
    fields[14] = fieldE91GCMONG =
    new DecimalField(message, HEADERSIZE + 123, 17, 2, "E91GCMONG");
    fields[15] = fieldE91GCTAPY =
    new DecimalField(message, HEADERSIZE + 140, 5, 0, "E91GCTAPY");
    fields[16] = fieldE91GCTAPM =
    new DecimalField(message, HEADERSIZE + 145, 3, 0, "E91GCTAPM");
    fields[17] = fieldE91GCTAPD =
    new DecimalField(message, HEADERSIZE + 148, 3, 0, "E91GCTAPD");
    fields[18] = fieldE91GCVENY =
    new DecimalField(message, HEADERSIZE + 151, 5, 0, "E91GCVENY");
    fields[19] = fieldE91GCVENM =
    new DecimalField(message, HEADERSIZE + 156, 3, 0, "E91GCVENM");
    fields[20] = fieldE91GCVEND =
    new DecimalField(message, HEADERSIZE + 159, 3, 0, "E91GCVEND");
    fields[21] = fieldE91INDOPE =
    new CharacterField(message, HEADERSIZE + 162, 1, "E91INDOPE");
