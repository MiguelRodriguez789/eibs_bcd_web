...
/**
* Class generated by AS/400 CRTCLASS command from ELC000004D physical file definition.
* 
* File level identifier is 1110303181117.
* Record format level identifier is 43A615822B0BD.
*/

public class ELC000004DMessage extends MessageRecord
{
  ...
  final static String fmtname = "ELC000004D";
  ...
  /**
  * Constructor for ELC000004DMessage.
  */
  public ELC000004DMessage()
  {
    createFields();
    initialize();
  }
