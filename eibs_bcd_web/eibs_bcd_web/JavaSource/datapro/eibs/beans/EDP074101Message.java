...
/**
* Class generated by AS/400 CRTCLASS command from EDP074101 physical file definition.
* 
* File level identifier is 1130611113113.
* Record format level identifier is 505B00822DFFE.
*/

public class EDP074101Message extends MessageRecord
{
  ...
  final static String rid = "505B00822DFFE";
  final static String fmtname = "EDP074101";
  ...
  /**
  * Constructor for EDP074101Message.
  */
  public EDP074101Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[10] = fieldE01BRNBNK =
    new CharacterField(message, HEADERSIZE + 43, 2, "E01BRNBNK");
    fields[11] = fieldE01BRNNUM =
    new DecimalField(message, HEADERSIZE + 45, 5, 0, "E01BRNNUM");
    fields[12] = fieldE01BRNNME =
    new CharacterField(message, HEADERSIZE + 50, 45, "E01BRNNME");
    fields[13] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 95, 1, "E01OPECDE");
