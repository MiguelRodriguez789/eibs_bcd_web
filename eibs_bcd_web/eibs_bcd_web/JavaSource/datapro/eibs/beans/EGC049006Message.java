...
/**
* Class generated by AS/400 CRTCLASS command from EGC049006 physical file definition.
* 
* File level identifier is 1130611113200.
* Record format level identifier is 411C2456E31A7.
*/

public class EGC049006Message extends MessageRecord
{
  ...
  final static String rid = "411C2456E31A7";
  final static String fmtname = "EGC049006";
  ...
  /**
  * Constructor for EGC049006Message.
  */
  public EGC049006Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 207, 3, 0, "E06OPEDT1");
    fields[26] = fieldE06OPEDT2 =
    new DecimalField(message, HEADERSIZE + 210, 3, 0, "E06OPEDT2");
    fields[27] = fieldE06OPEDT3 =
    new DecimalField(message, HEADERSIZE + 213, 5, 0, "E06OPEDT3");
    fields[28] = fieldE06OFFICR =
    new CharacterField(message, HEADERSIZE + 218, 4, "E06OFFICR");
    fields[29] = fieldE06INDOPE =
    new CharacterField(message, HEADERSIZE + 222, 1, "E06INDOPE");
