...
* 
* File level identifier is 1160830132346.
* Record format level identifier is 46232E2EF54BF.
*/
...
public class ESS024001Message extends MessageRecord
{
  ...
  final static String fid = "1160830132346";
  final static String rid = "46232E2EF54BF";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 50, 5, 0, "E01FRDTE3");
    fields[14] = fieldE01TODTE1 =
    new DecimalField(message, HEADERSIZE + 55, 3, 0, "E01TODTE1");
    fields[15] = fieldE01TODTE2 =
    new DecimalField(message, HEADERSIZE + 58, 3, 0, "E01TODTE2");
    fields[16] = fieldE01TODTE3 =
    new DecimalField(message, HEADERSIZE + 61, 5, 0, "E01TODTE3");
    fields[17] = fieldE01SELUSR =
    new CharacterField(message, HEADERSIZE + 66, 10, "E01SELUSR");
