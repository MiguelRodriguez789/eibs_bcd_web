...
* 
* File level identifier is 1140520104547.
* Record format level identifier is 4B83005719E4E.
*/
...
public class ECH057501Message extends MessageRecord
{
  ...
  final static String fid = "1140520104547";
  final static String rid = "4B83005719E4E";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 60, 2, "E01CHMTCB");
    fields[12] = fieldE01CHMRQM =
    new DecimalField(message, HEADERSIZE + 62, 3, 0, "E01CHMRQM");
    fields[13] = fieldE01CHMRQD =
    new DecimalField(message, HEADERSIZE + 65, 3, 0, "E01CHMRQD");
    fields[14] = fieldE01CHMRQY =
    new DecimalField(message, HEADERSIZE + 68, 5, 0, "E01CHMRQY");
    fields[15] = fieldE01CHMICK =
    new DecimalField(message, HEADERSIZE + 73, 12, 0, "E01CHMICK");
    fields[16] = fieldE01CHMCCY =
    new CharacterField(message, HEADERSIZE + 85, 3, "E01CHMCCY");
    fields[17] = fieldE01CHMDBR =
    new DecimalField(message, HEADERSIZE + 88, 5, 0, "E01CHMDBR");
