...
* Record format level identifier is 4061FD68FC502.
*/
...
public class ESD085001Message extends MessageRecord
{
  ...
  final static String rid = "4061FD68FC502";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 56, 60, "E01OFCNME");
    fields[12] = fieldE01OFCIDN =
    new CharacterField(message, HEADERSIZE + 116, 25, "E01OFCIDN");
    fields[13] = fieldE01OFCEML =
    new CharacterField(message, HEADERSIZE + 141, 60, "E01OFCEML");
    fields[14] = fieldE01OFCPHN =
    new DecimalField(message, HEADERSIZE + 201, 16, 0, "E01OFCPHN");
    fields[15] = fieldE01OFCPXT =
    new DecimalField(message, HEADERSIZE + 217, 5, 0, "E01OFCPXT");
    fields[16] = fieldE01OFCBNK =
    new CharacterField(message, HEADERSIZE + 222, 2, "E01OFCBNK");
    fields[17] = fieldE01OFCBRN =
    new DecimalField(message, HEADERSIZE + 224, 5, 0, "E01OFCBRN");
    fields[18] = fieldE01OFCCCN =
    new DecimalField(message, HEADERSIZE + 229, 9, 0, "E01OFCCCN");
    fields[19] = fieldE01OFCROT =
    new CharacterField(message, HEADERSIZE + 238, 10, "E01OFCROT");
    fields[20] = fieldE01OFCAOF =
    new CharacterField(message, HEADERSIZE + 248, 4, "E01OFCAOF");
    fields[21] = fieldE01DSCAOF =
    new CharacterField(message, HEADERSIZE + 252, 4, "E01DSCAOF");
