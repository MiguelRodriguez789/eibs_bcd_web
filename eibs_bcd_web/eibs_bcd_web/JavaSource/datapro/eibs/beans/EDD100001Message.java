...
* Record format level identifier is 3977DEC4CD369.
*/
...
public class EDD100001Message extends MessageRecord
{
  ...
  final static String rid = "3977DEC4CD369";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 127, 4, "E01ACMPRO");
    ...
    new DecimalField(message, HEADERSIZE + 167, 17, 2, "E01ACMBAL");
    fields[20] = fieldE01ACMDIB =
    new DecimalField(message, HEADERSIZE + 184, 6, 0, "E01ACMDIB");
    fields[21] = fieldE01ACMUSR =
    new CharacterField(message, HEADERSIZE + 190, 10, "E01ACMUSR");
    fields[22] = fieldE01ACMRMK =
    new CharacterField(message, HEADERSIZE + 200, 60, "E01ACMRMK");
