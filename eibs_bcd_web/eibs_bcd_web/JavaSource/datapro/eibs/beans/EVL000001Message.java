...
* Record format level identifier is 4AC5B8BD827F4.
*/
...
public class EVL000001Message extends MessageRecord
{
  ...
  final static String rid = "4AC5B8BD827F4";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 237, 13, 0, "E01LVLMIN");
    fields[18] = fieldE01LVLMED =
    new DecimalField(message, HEADERSIZE + 250, 13, 0, "E01LVLMED");
    fields[19] = fieldE01LVLMAX =
    new DecimalField(message, HEADERSIZE + 263, 13, 0, "E01LVLMAX");
    fields[20] = fieldE01LVLQTY =
    new DecimalField(message, HEADERSIZE + 276, 13, 0, "E01LVLQTY");
    fields[21] = fieldE01LVLAD1 =
    new DecimalField(message, HEADERSIZE + 289, 3, 0, "E01LVLAD1");
    fields[22] = fieldE01LVLAD2 =
    new DecimalField(message, HEADERSIZE + 292, 3, 0, "E01LVLAD2");
    fields[23] = fieldE01LVLAD3 =
    new DecimalField(message, HEADERSIZE + 295, 5, 0, "E01LVLAD3");
    fields[24] = fieldE01LVLACT =
    new CharacterField(message, HEADERSIZE + 300, 26, "E01LVLACT");
    fields[25] = fieldE01LVLACU =
    new CharacterField(message, HEADERSIZE + 326, 10, "E01LVLACU");
