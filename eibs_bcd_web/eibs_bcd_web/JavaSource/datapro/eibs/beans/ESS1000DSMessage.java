...
* Record format level identifier is 40352966216B9.
*/
...
public class ESS1000DSMessage extends MessageRecord
{
  ...
  final static String rid = "40352966216B9";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 33, 60, "APLAD1");
    fields[4] = fieldAPLTEL =
    new DecimalField(message, HEADERSIZE + 93, 16, 0, "APLTEL");
    fields[5] = fieldAPLCEML =
    new CharacterField(message, HEADERSIZE + 109, 60, "APLCEML");
