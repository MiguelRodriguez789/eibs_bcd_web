...
/**
* Class generated by AS/400 CRTCLASS command from EWD0351DS physical file definition.
* 
* File level identifier is 1130611190847.
* Record format level identifier is 57ACE308EEFAF.
*/

public class EWD0351DSMessage extends MessageRecord
{
  ...
  final static String fid = "1130611190847";
  final static String rid = "57ACE308EEFAF";
  final static String fmtname = "EWD0351DS";
  ...
  /**
  * Constructor for EWD0351DSMessage.
  */
  public EWD0351DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 22, 40, "SWDNME");
    fields[5] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 62, 8, 0, "SWDREC");
    fields[6] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 70, 1, "SWDOPE");
