...
* Record format level identifier is 40B813AB7F0B0.
*/
...
public class ECH030601Message extends MessageRecord
{
  ...
  final static String rid = "40B813AB7F0B0";
  ...
  private CharacterField fieldE01TIPCHK = null;
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 44, 5, 0, "E01SUCDST");
    fields[11] = fieldE01SUCORG =
    new DecimalField(message, HEADERSIZE + 49, 5, 0, "E01SUCORG");
    fields[12] = fieldE01NUMCTA =
    new CharacterField(message, HEADERSIZE + 54, 1, "E01NUMCTA");
    fields[13] = fieldE01CODCCY =
    new CharacterField(message, HEADERSIZE + 55, 3, "E01CODCCY");
    fields[14] = fieldE01TIPPER =
    new CharacterField(message, HEADERSIZE + 58, 1, "E01TIPPER");
    fields[15] = fieldE01TIPCHK =
    new CharacterField(message, HEADERSIZE + 59, 2, "E01TIPCHK");
    fields[16] = fieldE01CANCHK =
    new DecimalField(message, HEADERSIZE + 61, 8, 0, "E01CANCHK");
    fields[17] = fieldE01SERIEK =
    new CharacterField(message, HEADERSIZE + 69, 10, "E01SERIEK");
    fields[18] = fieldE01NUMSOL =
    new DecimalField(message, HEADERSIZE + 79, 13, 0, "E01NUMSOL");
