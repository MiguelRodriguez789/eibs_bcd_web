...
* Record format level identifier is 581160938E3C2.
*/
...
public class EWD0535DSMessage extends MessageRecord
{
  ...
  final static String rid = "581160938E3C2";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 11, 4, "EWDSUB");
    fields[4] = fieldEWDLOT =
    new DecimalField(message, HEADERSIZE + 15, 13, 0, "EWDLOT");
    fields[5] = fieldEWDINI =
    new DecimalField(message, HEADERSIZE + 28, 13, 0, "EWDINI");
    fields[6] = fieldEWDFIN =
    new DecimalField(message, HEADERSIZE + 41, 13, 0, "EWDFIN");
    fields[7] = fieldEWDBAL =
    new DecimalField(message, HEADERSIZE + 54, 13, 0, "EWDBAL");
    fields[8] = fieldEWDCHK =
    new DecimalField(message, HEADERSIZE + 67, 13, 0, "EWDCHK");
