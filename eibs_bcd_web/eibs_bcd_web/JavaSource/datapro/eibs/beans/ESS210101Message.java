...
* Record format level identifier is 29F50B5CDB8C7.
*/
...
public class ESS210101Message extends MessageRecord
{
  ...
  final static String rid = "29F50B5CDB8C7";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 43, 45, "E01CCDSC");
    fields[9] = fieldE01CCMODE =
    new CharacterField(message, HEADERSIZE + 88, 1, "E01CCMODE");
    fields[10] = fieldE01DATA1 =
    new CharacterField(message, HEADERSIZE + 89, 45, "E01DATA1");
    fields[11] = fieldE01DATA2 =
    new CharacterField(message, HEADERSIZE + 134, 45, "E01DATA2");
    fields[12] = fieldE01DATA3 =
    new CharacterField(message, HEADERSIZE + 179, 45, "E01DATA3");
    fields[13] = fieldE01DATA4 =
    new CharacterField(message, HEADERSIZE + 224, 45, "E01DATA4");
    fields[14] = fieldE01DATN1 =
    new DecimalField(message, HEADERSIZE + 269, 11, 0, "E01DATN1");
    fields[15] = fieldE01DATN2 =
    new DecimalField(message, HEADERSIZE + 280, 11, 0, "E01DATN2");
    fields[16] = fieldE01DATN3 =
    new DecimalField(message, HEADERSIZE + 291, 11, 0, "E01DATN3");
    fields[17] = fieldE01DATD1 =
    new DecimalField(message, HEADERSIZE + 302, 17, 2, "E01DATD1");
    fields[18] = fieldE01DATD2 =
    new DecimalField(message, HEADERSIZE + 319, 17, 2, "E01DATD2");
    fields[19] = fieldE01DATD3 =
    new DecimalField(message, HEADERSIZE + 336, 17, 2, "E01DATD3");
