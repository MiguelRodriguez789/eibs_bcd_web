...
/**
* Class generated by AS/400 CRTCLASS command from EDL053901 physical file definition.
* 
* File level identifier is 1180523174618.
* Record format level identifier is 3E9FB6AAF4364.
*/

public class EDL053901Message extends MessageRecord
{
  ...
  final static String fid = "1180523174618";
  final static String rid = "3E9FB6AAF4364";
  final static String fmtname = "EDL053901";
  ...
  /**
  * Constructor for EDL053901Message.
  */
  public EDL053901Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 185, 25, "E01CUSIDN");
    fields[14] = fieldE01MODALI =
    new CharacterField(message, HEADERSIZE + 210, 1, "E01MODALI");
    fields[15] = fieldE01DESMOD =
    new CharacterField(message, HEADERSIZE + 211, 20, "E01DESMOD");
    fields[16] = fieldE01SELCUN =
    new DecimalField(message, HEADERSIZE + 231, 10, 0, "E01SELCUN");
    fields[17] = fieldE01SELIDN =
    new CharacterField(message, HEADERSIZE + 241, 25, "E01SELIDN");
    fields[18] = fieldE01SELNME =
    new CharacterField(message, HEADERSIZE + 266, 45, "E01SELNME");
    fields[19] = fieldE01SELTYP =
    new CharacterField(message, HEADERSIZE + 311, 4, "E01SELTYP");
    fields[20] = fieldE01SELPRD =
    new CharacterField(message, HEADERSIZE + 315, 4, "E01SELPRD");
    fields[21] = fieldE01SELBRN =
    new DecimalField(message, HEADERSIZE + 319, 5, 0, "E01SELBRN");
    fields[22] = fieldE01SELCCY =
    new CharacterField(message, HEADERSIZE + 324, 3, "E01SELCCY");
