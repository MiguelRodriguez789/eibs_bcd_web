...
* Record format level identifier is 42C185CE46FB4.
*/
...
public class ELD001001Message extends MessageRecord
{
  ...
  final static String rid = "42C185CE46FB4";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 125, 4, 0, "E01LDESEQ");
    fields[13] = fieldE01LDEBDY =
    new DecimalField(message, HEADERSIZE + 129, 5, 0, "E01LDEBDY");
    fields[14] = fieldE01LDEBDM =
    new DecimalField(message, HEADERSIZE + 134, 3, 0, "E01LDEBDM");
    fields[15] = fieldE01LDETPY =
    new CharacterField(message, HEADERSIZE + 137, 80, "E01LDETPY");
    fields[16] = fieldE01LDERM1 =
    new CharacterField(message, HEADERSIZE + 217, 80, "E01LDERM1");
    fields[17] = fieldE01LDERM2 =
    new CharacterField(message, HEADERSIZE + 297, 80, "E01LDERM2");
    fields[18] = fieldE01LDERM3 =
    new CharacterField(message, HEADERSIZE + 377, 80, "E01LDERM3");
    fields[19] = fieldE01LDERM4 =
    new CharacterField(message, HEADERSIZE + 457, 80, "E01LDERM4");
