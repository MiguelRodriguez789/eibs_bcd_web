...
/**
* Class generated by AS/400 CRTCLASS command from EFRM00071 physical file definition.
* 
* File level identifier is 1170202115308.
* Record format level identifier is 4ED8F6B97A911.
*/

public class EFRM00071Message extends MessageRecord
{
  ...
  final static String rid = "4ED8F6B97A911";
  final static String fmtname = "EFRM00071";
  ...
  /**
  * Constructor for EFRM00071Message.
  */
  public EFRM00071Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 55, 5, 0, "lineaNumber");
    fields[11] = fieldE01RCLACCY =
    new CharacterField(message, HEADERSIZE + 60, 3, "collatCcy");
    fields[12] = fieldE01RCLAPRO =
    new CharacterField(message, HEADERSIZE + 63, 4, "prodType");
    fields[13] = fieldE01RCLATYP =
    new CharacterField(message, HEADERSIZE + 67, 4, "cOllatTypeSta");
    fields[14] = fieldE01RCLAACD =
    new CharacterField(message, HEADERSIZE + 71, 2, "applicatCodeA");
    fields[15] = fieldE01CUSNA1 =
    new CharacterField(message, HEADERSIZE + 73, 60, "legalName");
    fields[16] = fieldE01RCLABAL =
    new DecimalField(message, HEADERSIZE + 133, 17, 2, "balance");
    fields[17] = fieldE01RCLADIS =
    new DecimalField(message, HEADERSIZE + 150, 17, 2, "balenceDisp");
    fields[18] = fieldE01RCLACB =
    new DecimalField(message, HEADERSIZE + 167, 13, 0, "accountBCollat");
    fields[19] = fieldE01RCLBCCY =
    new CharacterField(message, HEADERSIZE + 180, 3, "collatBCcy");
    fields[20] = fieldE01RCLBPRO =
    new CharacterField(message, HEADERSIZE + 183, 4, "prodBType");
    fields[21] = fieldE01RCLBTYP =
    new CharacterField(message, HEADERSIZE + 187, 4, "collatBTypeSta");
    fields[22] = fieldE01RCLBACD =
    new CharacterField(message, HEADERSIZE + 191, 2, "applicatCodeB");
    fields[23] = fieldE01RCLBCOL =
    new DecimalField(message, HEADERSIZE + 193, 17, 2, "balanceColl");
    fields[24] = fieldE01RCLOCOL =
    new DecimalField(message, HEADERSIZE + 210, 17, 2, "balanceColl1");
    fields[25] = fieldE01RCLBDIS =
    new DecimalField(message, HEADERSIZE + 227, 17, 2, "balancEDisp1");
    fields[26] = fieldE01RCLBBAL =
    new DecimalField(message, HEADERSIZE + 244, 17, 2, "balanceEnd");
    fields[27] = fieldE01ENDFLD =
    new CharacterField(message, HEADERSIZE + 261, 1, "endOfFile");
