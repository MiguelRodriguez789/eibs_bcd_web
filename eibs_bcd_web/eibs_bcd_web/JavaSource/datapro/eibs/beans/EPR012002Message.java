...
* Record format level identifier is 3B2A5B20B35DC.
*/
...
public class EPR012002Message extends MessageRecord
{
  ...
  final static String rid = "3B2A5B20B35DC";
  ...
  */
  protected void createFields()
  {
    ...
    fields[9] = fieldE02CUTDTM =
    new DecimalField(message, HEADERSIZE + 42, 3, 0, "E02CUTDTM");
    fields[10] = fieldE02CUTDTD =
    new DecimalField(message, HEADERSIZE + 45, 3, 0, "E02CUTDTD");
    fields[11] = fieldE02CUTDTY =
    new DecimalField(message, HEADERSIZE + 48, 5, 0, "E02CUTDTY");
    fields[12] = fieldE02CUTTIM =
    new DecimalField(message, HEADERSIZE + 53, 7, 0, "E02CUTTIM");
    fields[13] = fieldE02CUTMPG =
    new DecimalField(message, HEADERSIZE + 60, 3, 0, "E02CUTMPG");
    fields[14] = fieldE02PRISID =
    new CharacterField(message, HEADERSIZE + 63, 25, "E02PRISID");
    fields[15] = fieldE02PRINUM =
    new DecimalField(message, HEADERSIZE + 88, 13, 0, "E02PRINUM");
    fields[16] = fieldE02ACTION =
    new CharacterField(message, HEADERSIZE + 101, 1, "E02ACTION");
    fields[17] = fieldE02MSGTXT =
    new CharacterField(message, HEADERSIZE + 102, 512, "E02MSGTXT");
