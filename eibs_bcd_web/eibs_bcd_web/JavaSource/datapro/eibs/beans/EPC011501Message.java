...
* Record format level identifier is 2BF840DFE97AE.
*/
...
public class EPC011501Message extends MessageRecord
{
  ...
  final static String rid = "2BF840DFE97AE";
  ...
  */
  protected void createFields()
  {
    ...
    fields[12] = fieldE01PCSLSM =
    new DecimalField(message, HEADERSIZE + 67, 3, 0, "E01PCSLSM");
    fields[13] = fieldE01PCSLSD =
    new DecimalField(message, HEADERSIZE + 70, 3, 0, "E01PCSLSD");
    fields[14] = fieldE01PCSLSY =
    new DecimalField(message, HEADERSIZE + 73, 5, 0, "E01PCSLSY");
    fields[15] = fieldE01PCSLAM =
    new DecimalField(message, HEADERSIZE + 78, 3, 0, "E01PCSLAM");
    fields[16] = fieldE01PCSLAD =
    new DecimalField(message, HEADERSIZE + 81, 3, 0, "E01PCSLAD");
    fields[17] = fieldE01PCSLAY =
    new DecimalField(message, HEADERSIZE + 84, 5, 0, "E01PCSLAY");
    fields[18] = fieldE01PCSUSR =
    new CharacterField(message, HEADERSIZE + 89, 10, "E01PCSUSR");
    fields[19] = fieldE01PCSUSA =
    new CharacterField(message, HEADERSIZE + 99, 10, "E01PCSUSA");
    fields[20] = fieldE01PCSPGM =
    new CharacterField(message, HEADERSIZE + 109, 10, "E01PCSPGM");
    fields[21] = fieldD01PCSSTS =
    new CharacterField(message, HEADERSIZE + 119, 45, "D01PCSSTS");
    fields[22] = fieldD01PCSCUN =
    new CharacterField(message, HEADERSIZE + 164, 60, "D01PCSCUN");
