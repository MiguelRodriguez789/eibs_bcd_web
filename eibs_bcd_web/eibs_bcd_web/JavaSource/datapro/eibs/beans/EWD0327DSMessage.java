...
* Record format level identifier is 4558E12FBB4A9.
*/
...
public class EWD0327DSMessage extends MessageRecord
{
  ...
  final static String rid = "4558E12FBB4A9";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 24, 25, "SWDDID");
    fields[6] = fieldSWDDSC =
    new CharacterField(message, HEADERSIZE + 49, 45, "SWDDSC");
    fields[7] = fieldSWDREF =
    new CharacterField(message, HEADERSIZE + 94, 15, "SWDREF");
    fields[8] = fieldSWDAMN =
    new DecimalField(message, HEADERSIZE + 109, 17, 2, "SWDAMN");
    fields[9] = fieldSWDOEQ =
    new DecimalField(message, HEADERSIZE + 126, 17, 2, "SWDOEQ");
    fields[10] = fieldSWDEXR =
    new DecimalField(message, HEADERSIZE + 143, 13, 6, "SWDEXR");
    fields[11] = fieldSWDVAL =
    new CharacterField(message, HEADERSIZE + 156, 8, "SWDVAL");
    fields[12] = fieldSWDNME =
    new CharacterField(message, HEADERSIZE + 164, 45, "SWDNME");
    fields[13] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 209, 8, 0, "SWDREC");
    fields[14] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 217, 1, "SWDOPE");
