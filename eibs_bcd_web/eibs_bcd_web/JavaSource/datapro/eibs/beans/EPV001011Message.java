...
/**
* Class generated by AS/400 CRTCLASS command from EPV001011 physical file definition.
* 
* File level identifier is 1100706173643.
* Record format level identifier is 442FB0DC7D9DF.
*/

public class EPV001011Message extends MessageRecord
{
  ...
  final static String fid = "1100706173643";
  final static String rid = "442FB0DC7D9DF";
  final static String fmtname = "EPV001011";
  ...
  private DecimalField fieldE01PVBNAC = null;
  private DecimalField fieldE01PVBMAC = null;
  private DecimalField fieldE01PVBFOR = null;

  /**
  * Constructor for EPV001011Message.
  */
  public EPV001011Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[22] = fieldE01PVBNAC =
    new DecimalField(message, HEADERSIZE + 249, 4, 0, "E01PVBNAC");
    fields[23] = fieldE01PVBMAC =
    new DecimalField(message, HEADERSIZE + 253, 17, 2, "E01PVBMAC");
    fields[24] = fieldE01PVBFOR =
    new DecimalField(message, HEADERSIZE + 270, 3, 0, "E01PVBFOR");
  ...
  */
  ...
  /**
  * Set field E01PVBNAC using a String value.
  */
  public void setE01PVBNAC(String newvalue)
  {
    fieldE01PVBNAC.setString(newvalue);
  }

  /**
  * Get value of field E01PVBNAC as a String.
  */
  public String getE01PVBNAC()
  {
    return fieldE01PVBNAC.getString();
  }

  /**
  * Set numeric field E01PVBNAC using a BigDecimal value.
  */
  public void setE01PVBNAC(BigDecimal newvalue)
  {
    fieldE01PVBNAC.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E01PVBNAC as a BigDecimal.
  */
  public BigDecimal getBigDecimalE01PVBNAC()
  {
    return fieldE01PVBNAC.getBigDecimal();
  }

  /**
  * Set field E01PVBMAC using a String value.
  */
  public void setE01PVBMAC(String newvalue)
  {
    fieldE01PVBMAC.setString(newvalue);
  }

  /**
  * Get value of field E01PVBMAC as a String.
  */
  public String getE01PVBMAC()
  {
    return fieldE01PVBMAC.getString();
  }

  /**
  * Set numeric field E01PVBMAC using a BigDecimal value.
  */
  public void setE01PVBMAC(BigDecimal newvalue)
  {
    fieldE01PVBMAC.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E01PVBMAC as a BigDecimal.
  */
  public BigDecimal getBigDecimalE01PVBMAC()
  {
    return fieldE01PVBMAC.getBigDecimal();
  }
