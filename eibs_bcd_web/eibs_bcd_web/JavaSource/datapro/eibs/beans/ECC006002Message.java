...
* Record format level identifier is 40405BC2BE287.
*/
...
public class ECC006002Message extends MessageRecord
{
  ...
  final static String rid = "40405BC2BE287";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 149, 1, "E02CCRSTS");
    fields[15] = fieldE02CCRLSM =
    new DecimalField(message, HEADERSIZE + 150, 3, 0, "E02CCRLSM");
    fields[16] = fieldE02CCRLSD =
    new DecimalField(message, HEADERSIZE + 153, 3, 0, "E02CCRLSD");
    fields[17] = fieldE02CCRLSY =
    new DecimalField(message, HEADERSIZE + 156, 5, 0, "E02CCRLSY");
    fields[18] = fieldF02CCRAST =
    new CharacterField(message, HEADERSIZE + 161, 1, "F02CCRAST");
    fields[19] = fieldF02CCRLSM =
    new CharacterField(message, HEADERSIZE + 162, 1, "F02CCRLSM");
    fields[20] = fieldF02CCRLSD =
    new CharacterField(message, HEADERSIZE + 163, 1, "F02CCRLSD");
    fields[21] = fieldF02CCRLSY =
    new CharacterField(message, HEADERSIZE + 164, 1, "F02CCRLSY");
