...
* Record format level identifier is 4FCA0C24C02A1.
*/
...
public class EIE030001Message extends MessageRecord
{
  ...
  final static String rid = "4FCA0C24C02A1";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 52, 60, "E01CUSNME");
    fields[11] = fieldE01PRFNUM =
    new DecimalField(message, HEADERSIZE + 112, 10, 0, "E01PRFNUM");
    fields[12] = fieldE01PRFDSC =
    new CharacterField(message, HEADERSIZE + 122, 60, "E01PRFDSC");
    fields[13] = fieldE01PRFBNK =
    new CharacterField(message, HEADERSIZE + 182, 2, "E01PRFBNK");
    fields[14] = fieldE01PRFOFC =
    new CharacterField(message, HEADERSIZE + 184, 4, "E01PRFOFC");
    fields[15] = fieldE01OFCNME =
    new CharacterField(message, HEADERSIZE + 188, 45, "E01OFCNME");
    fields[16] = fieldE01PRFOP1 =
    new DecimalField(message, HEADERSIZE + 233, 3, 0, "E01PRFOP1");
    fields[17] = fieldE01PRFOP2 =
    new DecimalField(message, HEADERSIZE + 236, 3, 0, "E01PRFOP2");
    fields[18] = fieldE01PRFOP3 =
    new DecimalField(message, HEADERSIZE + 239, 5, 0, "E01PRFOP3");
    fields[19] = fieldE01PRFVCY =
    new CharacterField(message, HEADERSIZE + 244, 3, "E01PRFVCY");
    fields[20] = fieldE01PRFTYP =
    new CharacterField(message, HEADERSIZE + 247, 1, "E01PRFTYP");
    fields[21] = fieldE01TYPDSC =
    new CharacterField(message, HEADERSIZE + 248, 45, "E01TYPDSC");
    fields[22] = fieldE01TOTQTY =
    new DecimalField(message, HEADERSIZE + 293, 18, 6, "E01TOTQTY");
    fields[23] = fieldE01TOTNVA =
    new DecimalField(message, HEADERSIZE + 311, 14, 2, "E01TOTNVA");
    fields[24] = fieldE01TOTBAL =
    new DecimalField(message, HEADERSIZE + 325, 14, 2, "E01TOTBAL");
    fields[25] = fieldE01TOTINT =
    new DecimalField(message, HEADERSIZE + 339, 14, 2, "E01TOTINT");
    fields[26] = fieldE01TOTDIS =
    new DecimalField(message, HEADERSIZE + 353, 14, 2, "E01TOTDIS");
    fields[27] = fieldE01TOTNDI =
    new DecimalField(message, HEADERSIZE + 367, 14, 2, "E01TOTNDI");
    fields[28] = fieldE01TOTOQY =
    new DecimalField(message, HEADERSIZE + 381, 18, 6, "E01TOTOQY");
    fields[29] = fieldE01TOTOVN =
    new DecimalField(message, HEADERSIZE + 399, 14, 2, "E01TOTOVN");
    fields[30] = fieldE01TOTBOK =
    new DecimalField(message, HEADERSIZE + 413, 14, 2, "E01TOTBOK");
    fields[31] = fieldE01TOTOIN =
    new DecimalField(message, HEADERSIZE + 427, 14, 2, "E01TOTOIN");
    fields[32] = fieldE01DISINI =
    new DecimalField(message, HEADERSIZE + 441, 14, 2, "E01DISINI");
    fields[33] = fieldE01NDSINI =
    new DecimalField(message, HEADERSIZE + 455, 14, 2, "E01NDSINI");
    fields[34] = fieldE01BSECCY =
    new CharacterField(message, HEADERSIZE + 469, 3, "E01BSECCY");
    fields[35] = fieldE01BSEBAL =
    new DecimalField(message, HEADERSIZE + 472, 14, 2, "E01BSEBAL");
    fields[36] = fieldE01BSEBOK =
    new DecimalField(message, HEADERSIZE + 486, 14, 2, "E01BSEBOK");
    fields[37] = fieldE01BSEEXR =
    new DecimalField(message, HEADERSIZE + 500, 11, 6, "E01BSEEXR");
    fields[38] = fieldE01TOTFL1 =
    new DecimalField(message, HEADERSIZE + 511, 14, 2, "E01TOTFL1");
    fields[39] = fieldE01TOTFL2 =
    new DecimalField(message, HEADERSIZE + 525, 14, 2, "E01TOTFL2");
    fields[40] = fieldE01TOTFL3 =
    new DecimalField(message, HEADERSIZE + 539, 14, 2, "E01TOTFL3");
    fields[41] = fieldE01TOTFL4 =
    new DecimalField(message, HEADERSIZE + 553, 18, 6, "E01TOTFL4");
    fields[42] = fieldE01TOTFL5 =
    new DecimalField(message, HEADERSIZE + 571, 18, 6, "E01TOTFL5");
    fields[43] = fieldE01TOTFL6 =
    new DecimalField(message, HEADERSIZE + 589, 8, 0, "E01TOTFL6");
    fields[44] = fieldE01TOTFL7 =
    new DecimalField(message, HEADERSIZE + 597, 8, 0, "E01TOTFL7");
    fields[45] = fieldE01TOTFL8 =
    new DecimalField(message, HEADERSIZE + 605, 8, 0, "E01TOTFL8");
    fields[46] = fieldE01HLDNME =
    new CharacterField(message, HEADERSIZE + 613, 240, "E01HLDNME");
