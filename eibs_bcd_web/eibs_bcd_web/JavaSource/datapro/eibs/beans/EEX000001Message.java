...
* Record format level identifier is 578C03EE34774.
*/
...
public class EEX000001Message extends MessageRecord
{
  ...
  final static String rid = "578C03EE34774";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 44, 45, "D01EXMACD");
    fields[11] = fieldE01EXMTYP =
    new CharacterField(message, HEADERSIZE + 89, 4, "E01EXMTYP");
    fields[12] = fieldD01EXMTYP =
    new CharacterField(message, HEADERSIZE + 93, 45, "D01EXMTYP");
    fields[13] = fieldE01EXMPRO =
    new CharacterField(message, HEADERSIZE + 138, 4, "E01EXMPRO");
    fields[14] = fieldD01EXMPRO =
    new CharacterField(message, HEADERSIZE + 142, 45, "D01EXMPRO");
    fields[15] = fieldE01EXMCUN =
    new DecimalField(message, HEADERSIZE + 187, 10, 0, "E01EXMCUN");
    fields[16] = fieldD01EXMCUN =
    new CharacterField(message, HEADERSIZE + 197, 45, "D01EXMCUN");
    fields[17] = fieldE01EXMACC =
    new DecimalField(message, HEADERSIZE + 242, 13, 0, "E01EXMACC");
    fields[18] = fieldE01EXMUCX =
    new CharacterField(message, HEADERSIZE + 255, 4, "E01EXMUCX");
    fields[19] = fieldD01EXMUCX =
    new CharacterField(message, HEADERSIZE + 259, 45, "D01EXMUCX");
    fields[20] = fieldE01EXMCOM =
    new CharacterField(message, HEADERSIZE + 304, 4, "E01EXMCOM");
    fields[21] = fieldD01EXMCOM =
    new CharacterField(message, HEADERSIZE + 308, 45, "D01EXMCOM");
    fields[22] = fieldE01EXMSDY =
    new DecimalField(message, HEADERSIZE + 353, 5, 0, "E01EXMSDY");
    fields[23] = fieldE01EXMSDM =
    new DecimalField(message, HEADERSIZE + 358, 3, 0, "E01EXMSDM");
    fields[24] = fieldE01EXMSDD =
    new DecimalField(message, HEADERSIZE + 361, 3, 0, "E01EXMSDD");
    fields[25] = fieldE01EXMMAY =
    new DecimalField(message, HEADERSIZE + 364, 5, 0, "E01EXMMAY");
    fields[26] = fieldE01EXMMAM =
    new DecimalField(message, HEADERSIZE + 369, 3, 0, "E01EXMMAM");
    fields[27] = fieldE01EXMMAD =
    new DecimalField(message, HEADERSIZE + 372, 3, 0, "E01EXMMAD");
    fields[28] = fieldE01EXMUSR =
    new CharacterField(message, HEADERSIZE + 375, 10, "E01EXMUSR");
    fields[29] = fieldE01EXMDTE =
    new DecimalField(message, HEADERSIZE + 385, 9, 0, "E01EXMDTE");
    fields[30] = fieldE01EXMTIM =
    new DecimalField(message, HEADERSIZE + 394, 7, 0, "E01EXMTIM");
