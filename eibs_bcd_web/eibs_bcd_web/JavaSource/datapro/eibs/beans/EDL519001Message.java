...
* 
* File level identifier is 1101027115756.
* Record format level identifier is 5604B9A5CA942.
*/
...
public class EDL519001Message extends MessageRecord
{
  ...
  final static String fid = "1101027115756";
  final static String rid = "5604B9A5CA942";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 374, 60, "E01GLODED");
    fields[27] = fieldE01GLOCRE =
    new CharacterField(message, HEADERSIZE + 434, 4, "E01GLOCRE");
    fields[28] = fieldE01GLOCRD =
    new CharacterField(message, HEADERSIZE + 438, 60, "E01GLOCRD");
    fields[29] = fieldE01FLGCON =
    new CharacterField(message, HEADERSIZE + 498, 1, "E01FLGCON");
    fields[30] = fieldE01MOTCRE =
    new CharacterField(message, HEADERSIZE + 499, 4, "E01MOTCRE");
