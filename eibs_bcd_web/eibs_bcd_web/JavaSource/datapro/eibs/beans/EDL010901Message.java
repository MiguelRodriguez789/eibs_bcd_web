...
* Record format level identifier is 43202550CC05A.
*/
...
public class EDL010901Message extends MessageRecord
{
  ...
  final static String rid = "43202550CC05A";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 131, 2, "E01DLIBNK");
    fields[15] = fieldE01DLIBRN =
    new DecimalField(message, HEADERSIZE + 133, 5, 0, "E01DLIBRN");
    fields[16] = fieldE01DLIFCV =
    new DecimalField(message, HEADERSIZE + 138, 17, 2, "E01DLIFCV");
    fields[17] = fieldE01DLIUSR =
    new CharacterField(message, HEADERSIZE + 155, 10, "E01DLIUSR");
    fields[18] = fieldE01FLGBUS =
    new CharacterField(message, HEADERSIZE + 165, 4, "E01FLGBUS");
    fields[19] = fieldE01DLIRMK =
    new CharacterField(message, HEADERSIZE + 169, 60, "E01DLIRMK");
    fields[20] = fieldE01DLIOPT =
    new CharacterField(message, HEADERSIZE + 229, 1, "E01DLIOPT");
