...
* 
* File level identifier is 1160725175008.
* Record format level identifier is 47192785E1356.
*/
...
public class EDL013505Message extends MessageRecord
{
  ...
  final static String fid = "1160725175008";
  final static String rid = "47192785E1356";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 75, 60, "E05CUSNA1");
    fields[15] = fieldE05DSCPRO =
    new CharacterField(message, HEADERSIZE + 135, 35, "E05DSCPRO");
    fields[16] = fieldE05OLDAMT =
    new DecimalField(message, HEADERSIZE + 170, 17, 2, "E05OLDAMT");
    fields[17] = fieldE05NEWAMT =
    new DecimalField(message, HEADERSIZE + 187, 17, 2, "E05NEWAMT");
