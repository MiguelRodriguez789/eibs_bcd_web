...
* Record format level identifier is 4090EA57BA8CE.
*/
...
public class ECLI00101Message extends MessageRecord
{
  ...
  final static String rid = "4090EA57BA8CE";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 52, 60, "E01NA1");
    fields[11] = fieldE01NA2 =
    new CharacterField(message, HEADERSIZE + 112, 45, "E01NA2");
    fields[12] = fieldE01NA3 =
    new CharacterField(message, HEADERSIZE + 157, 45, "E01NA3");
    fields[13] = fieldE01NA4 =
    new CharacterField(message, HEADERSIZE + 202, 45, "E01NA4");
    fields[14] = fieldE01CTY =
    new CharacterField(message, HEADERSIZE + 247, 35, "E01CTY");
    fields[15] = fieldE01CTR =
    new CharacterField(message, HEADERSIZE + 282, 35, "E01CTR");
