...
/**
* Class generated by AS/400 CRTCLASS command from ECL0160DS physical file definition.
* 
* File level identifier is 1130611112848.
* Record format level identifier is 4DC19377E38AB.
*/

public class ECL0160DSMessage extends MessageRecord
{
  ...
  final static String rid = "4DC19377E38AB";
  final static String fmtname = "ECL0160DS";
  ...
  /**
  * Constructor for ECL0160DSMessage.
  */
  public ECL0160DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 109, 1, "E01TIIDCL");
    fields[14] = fieldE01IDNCLI =
    new CharacterField(message, HEADERSIZE + 110, 25, "E01IDNCLI");
    fields[15] = fieldE01NOMCLI =
    new CharacterField(message, HEADERSIZE + 135, 45, "E01NOMCLI");
    fields[16] = fieldE01REFERE =
    new DecimalField(message, HEADERSIZE + 180, 13, 0, "E01REFERE");
    fields[17] = fieldE01AUTORI =
    new CharacterField(message, HEADERSIZE + 193, 10, "E01AUTORI");
