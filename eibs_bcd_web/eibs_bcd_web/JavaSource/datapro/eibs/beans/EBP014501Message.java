...
* Record format level identifier is 413B7FA2E8DD0.
*/
...
public class EBP014501Message extends MessageRecord
{
  ...
  final static String rid = "413B7FA2E8DD0";
  ...
  private CharacterField fieldE01REQPYM = null;
  ...
  */
  protected void createFields()
  {
    ...
    fields[12] = fieldE01REQVEN =
    new DecimalField(message, HEADERSIZE + 50, 10, 0, "E01REQVEN");
    fields[13] = fieldE01REQPVI =
    new CharacterField(message, HEADERSIZE + 60, 1, "E01REQPVI");
    fields[14] = fieldE01REQPYM =
    new CharacterField(message, HEADERSIZE + 61, 1, "E01REQPYM");
    fields[15] = fieldE01REQDFM =
    new DecimalField(message, HEADERSIZE + 62, 3, 0, "E01REQDFM");
    fields[16] = fieldE01REQDFD =
    new DecimalField(message, HEADERSIZE + 65, 3, 0, "E01REQDFD");
    fields[17] = fieldE01REQDFY =
    new DecimalField(message, HEADERSIZE + 68, 5, 0, "E01REQDFY");
    fields[18] = fieldE01REQDTM =
    new DecimalField(message, HEADERSIZE + 73, 3, 0, "E01REQDTM");
    fields[19] = fieldE01REQDTD =
    new DecimalField(message, HEADERSIZE + 76, 3, 0, "E01REQDTD");
    fields[20] = fieldE01REQDTY =
    new DecimalField(message, HEADERSIZE + 79, 5, 0, "E01REQDTY");
    fields[21] = fieldE01BPPNUM =
    new DecimalField(message, HEADERSIZE + 84, 13, 0, "E01BPPNUM");
    fields[22] = fieldE01BPPSEQ =
    new DecimalField(message, HEADERSIZE + 97, 4, 0, "E01BPPSEQ");
    fields[23] = fieldE01BPBBIL =
    new CharacterField(message, HEADERSIZE + 101, 25, "E01BPBBIL");
    fields[24] = fieldE01BPPCOD =
    new DecimalField(message, HEADERSIZE + 126, 10, 0, "E01BPPCOD");
    fields[25] = fieldE01BPPCUN =
    new DecimalField(message, HEADERSIZE + 136, 10, 0, "E01BPPCUN");
    fields[26] = fieldE01BPPVCN =
    new CharacterField(message, HEADERSIZE + 146, 45, "E01BPPVCN");
    fields[27] = fieldE01BPPORD =
    new DecimalField(message, HEADERSIZE + 191, 13, 0, "E01BPPORD");
    fields[28] = fieldE01BPBTYP =
    new CharacterField(message, HEADERSIZE + 204, 1, "E01BPBTYP");
    fields[29] = fieldE01BPBTYPD =
    new CharacterField(message, HEADERSIZE + 205, 45, "E01BPBTYPD");
    fields[30] = fieldE01BPBDSC =
    new CharacterField(message, HEADERSIZE + 250, 45, "E01BPBDSC");
    fields[31] = fieldE01BPPPVI =
    new CharacterField(message, HEADERSIZE + 295, 1, "E01BPPPVI");
    fields[32] = fieldE01BPPAMT =
    new DecimalField(message, HEADERSIZE + 296, 17, 2, "E01BPPAMT");
    fields[33] = fieldE01BPPFEE =
    new DecimalField(message, HEADERSIZE + 313, 17, 2, "E01BPPFEE");
    fields[34] = fieldE01BPPPDY =
    new DecimalField(message, HEADERSIZE + 330, 5, 0, "E01BPPPDY");
    fields[35] = fieldE01BPPPDM =
    new DecimalField(message, HEADERSIZE + 335, 3, 0, "E01BPPPDM");
    fields[36] = fieldE01BPPPDD =
    new DecimalField(message, HEADERSIZE + 338, 3, 0, "E01BPPPDD");
    fields[37] = fieldE01BPPUSR =
    new CharacterField(message, HEADERSIZE + 341, 10, "E01BPPUSR");
    fields[38] = fieldE01BPPAUS =
    new CharacterField(message, HEADERSIZE + 351, 10, "E01BPPAUS");
    fields[39] = fieldE01BPPADY =
    new DecimalField(message, HEADERSIZE + 361, 5, 0, "E01BPPADY");
    fields[40] = fieldE01BPPADM =
    new DecimalField(message, HEADERSIZE + 366, 3, 0, "E01BPPADM");
    fields[41] = fieldE01BPPADD =
    new DecimalField(message, HEADERSIZE + 369, 3, 0, "E01BPPADD");
    fields[42] = fieldE01BPPSTS =
    new CharacterField(message, HEADERSIZE + 372, 1, "E01BPPSTS");
    fields[43] = fieldE01ACT =
    new CharacterField(message, HEADERSIZE + 373, 1, "E01ACT");
  ...
  */
  ...
  /**
  * Set field E01REQPYM using a String value.
  */
  public void setE01REQPYM(String newvalue)
  {
    fieldE01REQPYM.setString(newvalue);
  }

  /**
  * Get value of field E01REQPYM as a String.
  */
  public String getE01REQPYM()
  {
    return fieldE01REQPYM.getString();
  }
