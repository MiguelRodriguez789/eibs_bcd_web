...
* Record format level identifier is 47B43024044C6.
*/
...
public class EGC051001Message extends MessageRecord
{
  ...
  final static String rid = "47B43024044C6";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 46, 5, 0, "E01GCAFINY");
    fields[11] = fieldE01GCAFINM =
    new DecimalField(message, HEADERSIZE + 51, 3, 0, "E01GCAFINM");
    fields[12] = fieldE01GCAFIND =
    new DecimalField(message, HEADERSIZE + 54, 3, 0, "E01GCAFIND");
    fields[13] = fieldE01GCAFFNY =
    new DecimalField(message, HEADERSIZE + 57, 5, 0, "E01GCAFFNY");
    fields[14] = fieldE01GCAFFNM =
    new DecimalField(message, HEADERSIZE + 62, 3, 0, "E01GCAFFNM");
    fields[15] = fieldE01GCAFFND =
    new DecimalField(message, HEADERSIZE + 65, 3, 0, "E01GCAFFND");
    fields[16] = fieldE01GCSALDC =
    new DecimalField(message, HEADERSIZE + 68, 17, 2, "E01GCSALDC");
    fields[17] = fieldE01GCESTAD =
    new CharacterField(message, HEADERSIZE + 85, 1, "E01GCESTAD");
