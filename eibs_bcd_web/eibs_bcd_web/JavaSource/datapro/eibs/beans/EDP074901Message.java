...
* Record format level identifier is 38C292846C477.
*/
...
public class EDP074901Message extends MessageRecord
{
  ...
  final static String rid = "38C292846C477";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 111, 45, "E01CUSNA2");
    fields[14] = fieldE01PLPAID =
    new CharacterField(message, HEADERSIZE + 156, 10, "E01PLPAID");
    fields[15] = fieldE01PLPIPD =
    new DecimalField(message, HEADERSIZE + 166, 3, 0, "E01PLPIPD");
    fields[16] = fieldE01PLPIPM =
    new DecimalField(message, HEADERSIZE + 169, 3, 0, "E01PLPIPM");
    fields[17] = fieldE01PLPIPY =
    new DecimalField(message, HEADERSIZE + 172, 5, 0, "E01PLPIPY");
    fields[18] = fieldE01PLPRUT =
    new CharacterField(message, HEADERSIZE + 177, 4, "E01PLPRUT");
    fields[19] = fieldE01PLPSRU =
    new DecimalField(message, HEADERSIZE + 181, 8, 2, "E01PLPSRU");
    fields[20] = fieldE01PLPACT =
    new CharacterField(message, HEADERSIZE + 189, 4, "E01PLPACT");
    fields[21] = fieldE01PLPTAR =
    new CharacterField(message, HEADERSIZE + 193, 4, "E01PLPTAR");
    fields[22] = fieldE01PLPPSR =
    new DecimalField(message, HEADERSIZE + 197, 8, 2, "E01PLPPSR");
    fields[23] = fieldE01PLPPAC =
    new CharacterField(message, HEADERSIZE + 205, 4, "E01PLPPAC");
    fields[24] = fieldE01PLPPTA =
    new CharacterField(message, HEADERSIZE + 209, 4, "E01PLPPTA");
    fields[25] = fieldE01PLPEST =
    new CharacterField(message, HEADERSIZE + 213, 2, "E01PLPEST");
    fields[26] = fieldE01XXXEST =
    new CharacterField(message, HEADERSIZE + 215, 45, "E01XXXEST");
    fields[27] = fieldE01DESRUT =
    new CharacterField(message, HEADERSIZE + 260, 45, "E01DESRUT");
    fields[28] = fieldE01DESAC1 =
    new CharacterField(message, HEADERSIZE + 305, 45, "E01DESAC1");
    fields[29] = fieldE01DESAC2 =
    new CharacterField(message, HEADERSIZE + 350, 45, "E01DESAC2");
    fields[30] = fieldE01PLPEJE =
    new CharacterField(message, HEADERSIZE + 395, 4, "E01PLPEJE");
    fields[31] = fieldE01XXXEJE =
    new CharacterField(message, HEADERSIZE + 399, 45, "E01XXXEJE");
