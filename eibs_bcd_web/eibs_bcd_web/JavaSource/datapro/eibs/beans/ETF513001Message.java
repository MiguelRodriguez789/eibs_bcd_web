...
* Record format level identifier is 3316D16E4953E.
*/
...
public class ETF513001Message extends MessageRecord
{
  ...
  final static String rid = "3316D16E4953E";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 378, 5, 0, "E01DEAMD3");
    fields[29] = fieldE01DEAOD1 =
    new DecimalField(message, HEADERSIZE + 383, 3, 0, "E01DEAOD1");
    fields[30] = fieldE01DEAOD2 =
    new DecimalField(message, HEADERSIZE + 386, 3, 0, "E01DEAOD2");
    fields[31] = fieldE01DEAOD3 =
    new DecimalField(message, HEADERSIZE + 389, 5, 0, "E01DEAOD3");
    fields[32] = fieldE01DEAROC =
    new CharacterField(message, HEADERSIZE + 394, 1, "E01DEAROC");
    fields[33] = fieldE01DEANAR =
    new CharacterField(message, HEADERSIZE + 395, 60, "E01DEANAR");
    fields[34] = fieldE01DEAACC =
    new DecimalField(message, HEADERSIZE + 455, 13, 0, "E01DEAACC");
    fields[35] = fieldE01DEABRN =
    new DecimalField(message, HEADERSIZE + 468, 4, 0, "E01DEABRN");
    fields[36] = fieldE01DEACCY =
    new CharacterField(message, HEADERSIZE + 472, 3, "E01DEACCY");
    fields[37] = fieldE01DEAINT =
    new DecimalField(message, HEADERSIZE + 475, 23, 8, "E01DEAINT");
    fields[38] = fieldE01DEATOT =
    new DecimalField(message, HEADERSIZE + 498, 23, 8, "E01DEATOT");
    fields[39] = fieldE01DEATYP =
    new CharacterField(message, HEADERSIZE + 521, 4, "E01DEATYP");
    fields[40] = fieldE01DEABAS =
    new DecimalField(message, HEADERSIZE + 525, 4, 0, "E01DEABAS");
    fields[41] = fieldE01DEAFRA =
    new CharacterField(message, HEADERSIZE + 529, 1, "E01DEAFRA");
    fields[42] = fieldE01DEAEXR =
    new DecimalField(message, HEADERSIZE + 530, 13, 6, "E01DEAEXR");
    fields[43] = fieldE01GLROAM =
    new DecimalField(message, HEADERSIZE + 543, 23, 8, "E01GLROAM");
