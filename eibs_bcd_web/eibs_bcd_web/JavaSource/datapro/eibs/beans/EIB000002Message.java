...
* Record format level identifier is 31D64CD726EFF.
*/
...
public class EIB000002Message extends MessageRecord
{
  ...
  final static String rid = "31D64CD726EFF";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 44, 5, 0, "E02IBTDFR");
    fields[11] = fieldE02IBTDFC =
    new CharacterField(message, HEADERSIZE + 49, 3, "E02IBTDFC");
    fields[12] = fieldE02IBTDFA =
    new DecimalField(message, HEADERSIZE + 52, 17, 0, "E02IBTDFA");
    fields[13] = fieldE02IBTDFF =
    new CharacterField(message, HEADERSIZE + 69, 1, "E02IBTDFF");
    fields[14] = fieldE02IBTDTB =
    new CharacterField(message, HEADERSIZE + 70, 2, "E02IBTDTB");
    fields[15] = fieldE02IBTDTR =
    new DecimalField(message, HEADERSIZE + 72, 5, 0, "E02IBTDTR");
    fields[16] = fieldE02IBTDTC =
    new CharacterField(message, HEADERSIZE + 77, 3, "E02IBTDTC");
    fields[17] = fieldE02IBTDTA =
    new DecimalField(message, HEADERSIZE + 80, 17, 0, "E02IBTDTA");
    fields[18] = fieldE02IBTDTF =
    new CharacterField(message, HEADERSIZE + 97, 1, "E02IBTDTF");
    fields[19] = fieldE02IBTENT =
    new CharacterField(message, HEADERSIZE + 98, 1, "E02IBTENT");
    fields[20] = fieldE02GLDDFA =
    new CharacterField(message, HEADERSIZE + 99, 45, "E02GLDDFA");
    fields[21] = fieldE02GLDDTA =
    new CharacterField(message, HEADERSIZE + 144, 45, "E02GLDDTA");
