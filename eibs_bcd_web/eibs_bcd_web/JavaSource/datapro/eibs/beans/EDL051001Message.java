...
* Record format level identifier is 34182916F6E3F.
*/
...
public class EDL051001Message extends MessageRecord
{
  ...
  final static String rid = "34182916F6E3F";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 60, 45, "E01DLSDSC");
    fields[14] = fieldE01DLSDE1 =
    new CharacterField(message, HEADERSIZE + 105, 60, "E01DLSDE1");
    fields[15] = fieldE01DLSDAB =
    new DecimalField(message, HEADERSIZE + 165, 4, 0, "E01DLSDAB");
    fields[16] = fieldE01DLSUS1 =
    new CharacterField(message, HEADERSIZE + 169, 4, "E01DLSUS1");
    fields[17] = fieldE01DLSUS2 =
    new CharacterField(message, HEADERSIZE + 173, 4, "E01DLSUS2");
    fields[18] = fieldE01CDROPE =
    new CharacterField(message, HEADERSIZE + 177, 1, "E01CDROPE");
    fields[19] = fieldE01DLSMAM =
    new DecimalField(message, HEADERSIZE + 178, 3, 0, "E01DLSMAM");
    fields[20] = fieldE01DLSMAD =
    new DecimalField(message, HEADERSIZE + 181, 3, 0, "E01DLSMAD");
    fields[21] = fieldE01DLSMAY =
    new DecimalField(message, HEADERSIZE + 184, 5, 0, "E01DLSMAY");
