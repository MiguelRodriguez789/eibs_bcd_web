...
* Record format level identifier is 40E7D30A6BA40.
*/
...
public class EWD0324DSMessage extends MessageRecord
{
  ...
  final static String rid = "40E7D30A6BA40";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 70, 6, 0, "SWDTNR");
    fields[7] = fieldSWDTNU =
    new DecimalField(message, HEADERSIZE + 76, 6, 0, "SWDTNU");
    fields[8] = fieldSWDPER =
    new DecimalField(message, HEADERSIZE + 82, 8, 3, "SWDPER");
    fields[9] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 90, 8, 0, "SWDREC");
    fields[10] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 98, 1, "SWDOPE");
