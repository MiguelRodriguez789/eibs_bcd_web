...
/**
* Class generated by AS/400 CRTCLASS command from ESD500701 physical file definition.
* 
* File level identifier is 1130611113401.
* Record format level identifier is 37679061B3DC0.
*/

public class ESD500701Message extends MessageRecord
{
  ...
  final static String rid = "37679061B3DC0";
  final static String fmtname = "ESD500701";
  ...
  /**
  * Constructor for ESD500701Message.
  */
  public ESD500701Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 322, 13, 0, "E01NUMACC");
    fields[22] = fieldE01CODBNK =
    new CharacterField(message, HEADERSIZE + 335, 2, "E01CODBNK");
    fields[23] = fieldE01CODPRD =
    new CharacterField(message, HEADERSIZE + 337, 4, "E01CODPRD");
