...
/**
* Class generated by AS/400 CRTCLASS command from EDL010506 physical file definition.
* 
* File level identifier is 1130611112908.
* Record format level identifier is 37A207AE6C1AF.
*/

public class EDL010506Message extends MessageRecord
{
  ...
  final static String rid = "37A207AE6C1AF";
  final static String fmtname = "EDL010506";
  ...
  /**
  * Constructor for EDL010506Message.
  */
  public EDL010506Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 131, 11, 6, "E06OLDRTE");
    fields[15] = fieldE06NEWRTE =
    new DecimalField(message, HEADERSIZE + 142, 11, 6, "E06NEWRTE");
    fields[16] = fieldE06TRNVD1 =
    new DecimalField(message, HEADERSIZE + 153, 3, 0, "E06TRNVD1");
    fields[17] = fieldE06TRNVD2 =
    new DecimalField(message, HEADERSIZE + 156, 3, 0, "E06TRNVD2");
    fields[18] = fieldE06TRNVD3 =
    new DecimalField(message, HEADERSIZE + 159, 5, 0, "E06TRNVD3");
    fields[19] = fieldE06DEANR1 =
    new CharacterField(message, HEADERSIZE + 164, 60, "E06DEANR1");
    fields[20] = fieldE06DEANR2 =
    new CharacterField(message, HEADERSIZE + 224, 60, "E06DEANR2");
