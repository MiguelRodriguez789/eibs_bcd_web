...
/**
* Class generated by AS/400 CRTCLASS command from ERC0340P1 physical file definition.
* 
* File level identifier is 1110211181134.
* Record format level identifier is 3A50C8C29C888.
*/

public class ERC0340P1Message extends MessageRecord
{
  ...
  final static String fid = "1110211181134";
  final static String rid = "3A50C8C29C888";
  final static String fmtname = "ERC0340P1";
  ...
  /**
  * Constructor for ERC0340P1Message.
  */
  public ERC0340P1Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 782, 60, "E01BRMRE1");
    fields[44] = fieldE01BRMRE2 =
    new CharacterField(message, HEADERSIZE + 842, 60, "E01BRMRE2");
    fields[45] = fieldE01BRMRE3 =
    new CharacterField(message, HEADERSIZE + 902, 60, "E01BRMRE3");
    fields[46] = fieldE01BRMMCH =
    new DecimalField(message, HEADERSIZE + 962, 17, 2, "E01BRMMCH");
    fields[47] = fieldE01BRMRCH =
    new DecimalField(message, HEADERSIZE + 979, 17, 2, "E01BRMRCH");
    fields[48] = fieldE01BRMDAC =
    new DecimalField(message, HEADERSIZE + 996, 13, 0, "E01BRMDAC");
    fields[49] = fieldE01BRMCGN =
    new DecimalField(message, HEADERSIZE + 1009, 17, 0, "E01BRMCGN");
    fields[50] = fieldE01BRMFNM =
    new CharacterField(message, HEADERSIZE + 1026, 128, "E01BRMFNM");
    fields[51] = fieldE01BRMIPA =
    new CharacterField(message, HEADERSIZE + 1154, 15, "E01BRMIPA");
