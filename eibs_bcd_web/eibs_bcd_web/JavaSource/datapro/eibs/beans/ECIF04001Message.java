...
/**
* Class generated by AS/400 CRTCLASS command from ECIF04001 physical file definition.
* 
* File level identifier is 1130611112846.
* Record format level identifier is 4659FDDB42E46.
*/

public class ECIF04001Message extends MessageRecord
{
  ...
  final static String rid = "4659FDDB42E46";
  final static String fmtname = "ECIF04001";
  ...
  /**
  * Constructor for ECIF04001Message.
  */
  public ECIF04001Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 55, 5, 0, "E01SELYAR");
    fields[11] = fieldE01SELMTH =
    new DecimalField(message, HEADERSIZE + 60, 3, 0, "E01SELMTH");
    fields[12] = fieldE01MTHLET =
    new CharacterField(message, HEADERSIZE + 63, 3, "E01MTHLET");
    fields[13] = fieldE01MTHNUM =
    new DecimalField(message, HEADERSIZE + 66, 3, 0, "E01MTHNUM");
    fields[14] = fieldE01YEARNU =
    new DecimalField(message, HEADERSIZE + 69, 5, 0, "E01YEARNU");
    fields[15] = fieldE01AVERAG =
    new DecimalField(message, HEADERSIZE + 74, 17, 2, "E01AVERAG");
    fields[16] = fieldE01BALANC =
    new DecimalField(message, HEADERSIZE + 91, 17, 2, "E01BALANC");
    fields[17] = fieldE01BALMIN =
    new DecimalField(message, HEADERSIZE + 108, 17, 2, "E01BALMIN");
    fields[18] = fieldE01INTERE =
    new DecimalField(message, HEADERSIZE + 125, 17, 2, "E01INTERE");
    fields[19] = fieldE01COSOPE =
    new DecimalField(message, HEADERSIZE + 142, 17, 2, "E01COSOPE");
    fields[20] = fieldE01COSFON =
    new DecimalField(message, HEADERSIZE + 159, 17, 2, "E01COSFON");
    fields[21] = fieldE01OTHAMT =
    new DecimalField(message, HEADERSIZE + 176, 17, 2, "E01OTHAMT");
    fields[22] = fieldE01RTEINT =
    new DecimalField(message, HEADERSIZE + 193, 11, 6, "E01RTEINT");
    fields[23] = fieldE01NUMDEB =
    new DecimalField(message, HEADERSIZE + 204, 6, 0, "E01NUMDEB");
    fields[24] = fieldE01NUMCRE =
    new DecimalField(message, HEADERSIZE + 210, 6, 0, "E01NUMCRE");
    fields[25] = fieldE01NUMCHK =
    new DecimalField(message, HEADERSIZE + 216, 6, 0, "E01NUMCHK");
    fields[26] = fieldE01NUMDEP =
    new DecimalField(message, HEADERSIZE + 222, 6, 0, "E01NUMDEP");
    fields[27] = fieldE01INDOPE =
    new CharacterField(message, HEADERSIZE + 228, 1, "E01INDOPE");
