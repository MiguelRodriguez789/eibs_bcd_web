...
* Record format level identifier is 4B051D1CC15E3.
*/
...
public class EDD061002Message extends MessageRecord
{
  ...
  final static String rid = "4B051D1CC15E3";
  ...
  private DecimalField fieldE02INSDTM = null;
  private DecimalField fieldE02INSDTD = null;
  private DecimalField fieldE02INSDTY = null;
  ...
  private CharacterField fieldE02FEDRAB = null;
  ...
  */
  protected void createFields()
  {
    ...
    fields[12] = fieldE02INSDTM =
    new DecimalField(message, HEADERSIZE + 52, 3, 0, "E02INSDTM");
    fields[13] = fieldE02INSDTD =
    new DecimalField(message, HEADERSIZE + 55, 3, 0, "E02INSDTD");
    fields[14] = fieldE02INSDTY =
    new DecimalField(message, HEADERSIZE + 58, 5, 0, "E02INSDTY");
    fields[15] = fieldE02FEDREF =
    new CharacterField(message, HEADERSIZE + 63, 20, "E02FEDREF");
    fields[16] = fieldE02FEDSAB =
    new CharacterField(message, HEADERSIZE + 83, 25, "E02FEDSAB");
    fields[17] = fieldE02FEDSNM =
    new CharacterField(message, HEADERSIZE + 108, 45, "E02FEDSNM");
    fields[18] = fieldE02FEDRAB =
    new CharacterField(message, HEADERSIZE + 153, 25, "E02FEDRAB");
    fields[19] = fieldE02FEDRNM =
    new CharacterField(message, HEADERSIZE + 178, 45, "E02FEDRNM");
    fields[20] = fieldE02FEDTS1 =
    new DecimalField(message, HEADERSIZE + 223, 3, 0, "E02FEDTS1");
    fields[21] = fieldE02FEDTS2 =
    new DecimalField(message, HEADERSIZE + 226, 3, 0, "E02FEDTS2");
    fields[22] = fieldE02WRTCAM =
    new DecimalField(message, HEADERSIZE + 229, 17, 2, "E02WRTCAM");
    fields[23] = fieldE02FEDORG =
    new CharacterField(message, HEADERSIZE + 246, 45, "E02FEDORG");
    fields[24] = fieldE02FEDOR1 =
    new CharacterField(message, HEADERSIZE + 291, 45, "E02FEDOR1");
    fields[25] = fieldE02FEDOR2 =
    new CharacterField(message, HEADERSIZE + 336, 45, "E02FEDOR2");
    fields[26] = fieldE02FEDORB =
    new CharacterField(message, HEADERSIZE + 381, 45, "E02FEDORB");
    fields[27] = fieldE02FEDPRC =
    new CharacterField(message, HEADERSIZE + 426, 4, "E02FEDPRC");
    fields[28] = fieldE02FEDIBK =
    new CharacterField(message, HEADERSIZE + 430, 45, "E02FEDIBK");
    fields[29] = fieldE02FEDBBK =
    new CharacterField(message, HEADERSIZE + 475, 45, "E02FEDBBK");
    fields[30] = fieldE02FEDBNF =
    new CharacterField(message, HEADERSIZE + 520, 45, "E02FEDBNF");
    fields[31] = fieldE02FEDBN1 =
    new CharacterField(message, HEADERSIZE + 565, 45, "E02FEDBN1");
    fields[32] = fieldE02FEDBRF =
    new CharacterField(message, HEADERSIZE + 610, 20, "E02FEDBRF");
    fields[33] = fieldE02FEDOBI =
    new CharacterField(message, HEADERSIZE + 630, 45, "E02FEDOBI");
    fields[34] = fieldE02FEDBBI =
    new CharacterField(message, HEADERSIZE + 675, 45, "E02FEDBBI");
    fields[35] = fieldE02FEDINS =
    new CharacterField(message, HEADERSIZE + 720, 256, "E02FEDINS");
    fields[36] = fieldE02NUMREC =
    new DecimalField(message, HEADERSIZE + 976, 8, 0, "E02NUMREC");
    fields[37] = fieldE02INDOPE =
    new CharacterField(message, HEADERSIZE + 984, 1, "E02INDOPE");
  ...
  */
  ...
  /**
  * Set field E02INSDTM using a String value.
  */
  public void setE02INSDTM(String newvalue)
  {
    fieldE02INSDTM.setString(newvalue);
  }

  /**
  * Get value of field E02INSDTM as a String.
  */
  public String getE02INSDTM()
  {
    return fieldE02INSDTM.getString();
  }

  /**
  * Set numeric field E02INSDTM using a BigDecimal value.
  */
  public void setE02INSDTM(BigDecimal newvalue)
  {
    fieldE02INSDTM.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E02INSDTM as a BigDecimal.
  */
  public BigDecimal getBigDecimalE02INSDTM()
  {
    return fieldE02INSDTM.getBigDecimal();
  }

  /**
  * Set field E02INSDTD using a String value.
  */
  public void setE02INSDTD(String newvalue)
  {
    fieldE02INSDTD.setString(newvalue);
  }

  /**
  * Get value of field E02INSDTD as a String.
  */
  public String getE02INSDTD()
  {
    return fieldE02INSDTD.getString();
  }

  /**
  * Set numeric field E02INSDTD using a BigDecimal value.
  */
  public void setE02INSDTD(BigDecimal newvalue)
  {
    fieldE02INSDTD.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E02INSDTD as a BigDecimal.
  */
  public BigDecimal getBigDecimalE02INSDTD()
  {
    return fieldE02INSDTD.getBigDecimal();
  }

  /**
  * Set field E02INSDTY using a String value.
  */
  public void setE02INSDTY(String newvalue)
  {
    fieldE02INSDTY.setString(newvalue);
  }

  /**
  * Get value of field E02INSDTY as a String.
  */
  public String getE02INSDTY()
  {
    return fieldE02INSDTY.getString();
  }

  /**
  * Set numeric field E02INSDTY using a BigDecimal value.
  */
  public void setE02INSDTY(BigDecimal newvalue)
  {
    fieldE02INSDTY.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E02INSDTY as a BigDecimal.
  */
  public BigDecimal getBigDecimalE02INSDTY()
  {
    return fieldE02INSDTY.getBigDecimal();
  }
