...
* 
* File level identifier is 1180515145135.
* Record format level identifier is 45B46DBF06F2E.
*/
...
public class ECH039001Message extends MessageRecord
{
  ...
  final static String fid = "1180515145135";
  final static String rid = "45B46DBF06F2E";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 55, 25, "E01CUSIDN");
    fields[11] = fieldE01CUSCUN =
    new DecimalField(message, HEADERSIZE + 80, 10, 0, "E01CUSCUN");
    fields[12] = fieldE01CUSNA1 =
    new CharacterField(message, HEADERSIZE + 90, 60, "E01CUSNA1");
    fields[13] = fieldE01CHMRQY =
    new DecimalField(message, HEADERSIZE + 150, 5, 0, "E01CHMRQY");
    fields[14] = fieldE01CHMRQM =
    new DecimalField(message, HEADERSIZE + 155, 3, 0, "E01CHMRQM");
    fields[15] = fieldE01CHMRQD =
    new DecimalField(message, HEADERSIZE + 158, 3, 0, "E01CHMRQD");
    fields[16] = fieldE01CHFEUY =
    new DecimalField(message, HEADERSIZE + 161, 5, 0, "E01CHFEUY");
    fields[17] = fieldE01CHFEUM =
    new DecimalField(message, HEADERSIZE + 166, 3, 0, "E01CHFEUM");
    fields[18] = fieldE01CHFEUD =
    new DecimalField(message, HEADERSIZE + 169, 3, 0, "E01CHFEUD");
    fields[19] = fieldE01CHMNCB =
    new DecimalField(message, HEADERSIZE + 172, 13, 0, "E01CHMNCB");
    fields[20] = fieldE01ESTADO =
    new CharacterField(message, HEADERSIZE + 185, 10, "E01ESTADO");
    fields[21] = fieldE01CHMNTC =
    new DecimalField(message, HEADERSIZE + 195, 5, 0, "E01CHMNTC");
    fields[22] = fieldE01CHMICK =
    new DecimalField(message, HEADERSIZE + 200, 12, 0, "E01CHMICK");
    fields[23] = fieldE01CHMFCK =
    new DecimalField(message, HEADERSIZE + 212, 12, 0, "E01CHMFCK");
    fields[24] = fieldE01STSSOL =
    new CharacterField(message, HEADERSIZE + 224, 1, "E01STSSOL");
    fields[25] = fieldE01STSREP =
    new CharacterField(message, HEADERSIZE + 225, 1, "E01STSREP");
    fields[26] = fieldE01STSENS =
    new CharacterField(message, HEADERSIZE + 226, 1, "E01STSENS");
    fields[27] = fieldE01STSRES =
    new CharacterField(message, HEADERSIZE + 227, 1, "E01STSRES");
    fields[28] = fieldE01STSENC =
    new CharacterField(message, HEADERSIZE + 228, 1, "E01STSENC");
