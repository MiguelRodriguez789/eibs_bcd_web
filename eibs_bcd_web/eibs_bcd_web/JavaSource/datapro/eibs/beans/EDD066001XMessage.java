...
/**
* Class generated by AS/400 CRTCLASS command from EDD066001X physical file definition.
* 
* File level identifier is 1130611112900.
* Record format level identifier is 593A68C911BB3.
*/

public class EDD066001XMessage extends MessageRecord
{
  ...
  final static String rid = "593A68C911BB3";
  final static String fmtname = "EDD066001X";
  ...
  private CharacterField fieldE01PRFATY = null;
  ...
  /**
  * Constructor for EDD066001XMessage.
  */
  public EDD066001XMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[10] = fieldE01PRFATY =
    new CharacterField(message, HEADERSIZE + 44, 3, "E01PRFATY");
    fields[11] = fieldE01PRFTBL =
    new CharacterField(message, HEADERSIZE + 47, 2, "E01PRFTBL");
    fields[12] = fieldE01PRFFCY =
    new CharacterField(message, HEADERSIZE + 49, 3, "E01PRFFCY");
    fields[13] = fieldE01PRFCUN =
    new DecimalField(message, HEADERSIZE + 52, 10, 0, "E01PRFCUN");
    fields[14] = fieldE01PRFDSC =
    new CharacterField(message, HEADERSIZE + 62, 45, "E01PRFDSC");
    fields[15] = fieldE01PRFOPE =
    new CharacterField(message, HEADERSIZE + 107, 1, "E01PRFOPE");
  ...
  */
  ...
  /**
  * Set field E01PRFATY using a String value.
  */
  public void setE01PRFATY(String newvalue)
  {
    fieldE01PRFATY.setString(newvalue);
  }

  /**
  * Get value of field E01PRFATY as a String.
  */
  public String getE01PRFATY()
  {
    return fieldE01PRFATY.getString();
  }
