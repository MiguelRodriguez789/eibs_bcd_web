...
/**
* Class generated by AS/400 CRTCLASS command from ECIF01006 physical file definition.
* 
* File level identifier is 1160711064228.
* Record format level identifier is 2DEBEA7FB3346.
*/

public class ECIF01006Message extends MessageRecord
{
  ...
  final static String fid = "1160711064228";
  final static String rid = "2DEBEA7FB3346";
  final static String fmtname = "ECIF01006";
  ...
  private CharacterField fieldE06TITTYP = null;
  private DecimalField fieldE06TITPOR = null;
  private CharacterField fieldE06DSCPRO = null;
  private DecimalField fieldE06ACCNUM = null;
  private CharacterField fieldE06ACCACD = null;
  ...
  private CharacterField fieldE06MLATYP = null;
  private DecimalField fieldE06MLANRO = null;
  private CharacterField fieldE06ACROAC = null;
  private CharacterField fieldE06INDOPE = null;
  private DecimalField fieldE06NUMREC = null;

  /**
  * Constructor for ECIF01006Message.
  */
  public ECIF01006Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[14] = fieldE06TITTYP =
    new CharacterField(message, HEADERSIZE + 63, 1, "E06TITTYP");
    fields[15] = fieldE06TITPOR =
    new DecimalField(message, HEADERSIZE + 64, 17, 2, "E06TITPOR");
    fields[16] = fieldE06DSCPRO =
    new CharacterField(message, HEADERSIZE + 81, 45, "E06DSCPRO");
    fields[17] = fieldE06ACCNUM =
    new DecimalField(message, HEADERSIZE + 126, 13, 0, "E06ACCNUM");
    fields[18] = fieldE06ACCACD =
    new CharacterField(message, HEADERSIZE + 139, 2, "E06ACCACD");
    fields[19] = fieldE06BNKNUM =
    new CharacterField(message, HEADERSIZE + 141, 2, "E06BNKNUM");
    fields[20] = fieldE06BRNNUM =
    new DecimalField(message, HEADERSIZE + 143, 5, 0, "E06BRNNUM");
    fields[21] = fieldE06CCYCDE =
    new CharacterField(message, HEADERSIZE + 148, 3, "E06CCYCDE");
    fields[22] = fieldE06ACCTYP =
    new CharacterField(message, HEADERSIZE + 151, 4, "E06ACCTYP");
    fields[23] = fieldE06PROCDE =
    new CharacterField(message, HEADERSIZE + 155, 4, "E06PROCDE");
    fields[24] = fieldE06PRIAMN =
    new DecimalField(message, HEADERSIZE + 159, 17, 2, "E06PRIAMN");
    fields[25] = fieldE06INTAMN =
    new DecimalField(message, HEADERSIZE + 176, 17, 2, "E06INTAMN");
    fields[26] = fieldE06OTHAMN =
    new DecimalField(message, HEADERSIZE + 193, 17, 2, "E06OTHAMN");
    fields[27] = fieldE06TOTAMN =
    new DecimalField(message, HEADERSIZE + 210, 17, 2, "E06TOTAMN");
    fields[28] = fieldE06ACCSTS =
    new CharacterField(message, HEADERSIZE + 227, 45, "E06ACCSTS");
    fields[29] = fieldE06OPEDTM =
    new DecimalField(message, HEADERSIZE + 272, 3, 0, "E06OPEDTM");
    fields[30] = fieldE06OPEDTD =
    new DecimalField(message, HEADERSIZE + 275, 3, 0, "E06OPEDTD");
    fields[31] = fieldE06OPEDTY =
    new DecimalField(message, HEADERSIZE + 278, 5, 0, "E06OPEDTY");
    fields[32] = fieldE06OFFICR =
    new CharacterField(message, HEADERSIZE + 283, 4, "E06OFFICR");
    fields[33] = fieldE06MLATYP =
    new CharacterField(message, HEADERSIZE + 287, 1, "E06MLATYP");
    fields[34] = fieldE06MLANRO =
    new DecimalField(message, HEADERSIZE + 288, 3, 0, "E06MLANRO");
    fields[35] = fieldE06ACROAC =
    new CharacterField(message, HEADERSIZE + 291, 35, "E06ACROAC");
    fields[36] = fieldE06INDOPE =
    new CharacterField(message, HEADERSIZE + 326, 1, "E06INDOPE");
    fields[37] = fieldE06NUMREC =
    new DecimalField(message, HEADERSIZE + 327, 8, 0, "E06NUMREC");
  ...
  */
  ...
  /**
  * Set field E06TITTYP using a String value.
  */
  public void setE06TITTYP(String newvalue)
  {
    fieldE06TITTYP.setString(newvalue);
  }

  /**
  * Get value of field E06TITTYP as a String.
  */
  public String getE06TITTYP()
  {
    return fieldE06TITTYP.getString();
  }

  /**
  * Set field E06TITPOR using a String value.
  */
  public void setE06TITPOR(String newvalue)
  {
    fieldE06TITPOR.setString(newvalue);
  }

  /**
  * Get value of field E06TITPOR as a String.
  */
  public String getE06TITPOR()
  {
    return fieldE06TITPOR.getString();
  }

  /**
  * Set numeric field E06TITPOR using a BigDecimal value.
  */
  public void setE06TITPOR(BigDecimal newvalue)
  {
    fieldE06TITPOR.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E06TITPOR as a BigDecimal.
  */
  public BigDecimal getBigDecimalE06TITPOR()
  {
    return fieldE06TITPOR.getBigDecimal();
  }
  ...
  */
  ...
  /**
  * Set field E06ACCACD using a String value.
  */
  public void setE06ACCACD(String newvalue)
  {
    fieldE06ACCACD.setString(newvalue);
  }

  /**
  * Get value of field E06ACCACD as a String.
  */
  public String getE06ACCACD()
  {
    return fieldE06ACCACD.getString();
  }
  ...
  */
  ...
  /**
  * Set field E06MLATYP using a String value.
  */
  public void setE06MLATYP(String newvalue)
  {
    fieldE06MLATYP.setString(newvalue);
  }

  /**
  * Get value of field E06MLATYP as a String.
  */
  public String getE06MLATYP()
  {
    return fieldE06MLATYP.getString();
  }

  /**
  * Set field E06MLANRO using a String value.
  */
  public void setE06MLANRO(String newvalue)
  {
    fieldE06MLANRO.setString(newvalue);
  }

  /**
  * Get value of field E06MLANRO as a String.
  */
  public String getE06MLANRO()
  {
    return fieldE06MLANRO.getString();
  }

  /**
  * Set numeric field E06MLANRO using a BigDecimal value.
  */
  public void setE06MLANRO(BigDecimal newvalue)
  {
    fieldE06MLANRO.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E06MLANRO as a BigDecimal.
  */
  public BigDecimal getBigDecimalE06MLANRO()
  {
    return fieldE06MLANRO.getBigDecimal();
  }

  /**
  * Set field E06ACROAC using a String value.
  */
  public void setE06ACROAC(String newvalue)
  {
    fieldE06ACROAC.setString(newvalue);
  }

  /**
  * Get value of field E06ACROAC as a String.
  */
  public String getE06ACROAC()
  {
    return fieldE06ACROAC.getString();
  }
