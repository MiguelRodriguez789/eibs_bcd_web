...
* Record format level identifier is 4D6651C45CC20.
*/
...
public class ESI000004Message extends MessageRecord
{
  ...
  final static String rid = "4D6651C45CC20";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 66, 45, "E04WDESGA");
    fields[13] = fieldE04WTIPIG =
    new CharacterField(message, HEADERSIZE + 111, 1, "E04WTIPIG");
    fields[14] = fieldE04WRIFGA =
    new DecimalField(message, HEADERSIZE + 112, 20, 0, "E04WRIFGA");
    fields[15] = fieldE04WMONAV =
    new DecimalField(message, HEADERSIZE + 132, 22, 2, "E04WMONAV");
    fields[16] = fieldE04WTOAVA =
    new DecimalField(message, HEADERSIZE + 154, 22, 2, "E04WTOAVA");
    fields[17] = fieldE04NUMREC =
    new DecimalField(message, HEADERSIZE + 176, 8, 0, "E04NUMREC");
    fields[18] = fieldE04INDOPE =
    new CharacterField(message, HEADERSIZE + 184, 1, "E04INDOPE");
