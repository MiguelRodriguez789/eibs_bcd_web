...
* 
* File level identifier is 1140715161043.
* Record format level identifier is 3B7BC97A11ABD.
*/
...
public class ERA010004Message extends MessageRecord
{
  ...
  final static String fid = "1140715161043";
  final static String rid = "3B7BC97A11ABD";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 54, 60, "E04CUSNA1");
    fields[12] = fieldE04ROCCCY =
    new CharacterField(message, HEADERSIZE + 114, 3, "E04ROCCCY");
    fields[13] = fieldE04ROCREF =
    new DecimalField(message, HEADERSIZE + 117, 13, 0, "E04ROCREF");
    fields[14] = fieldE04ROCTYP =
    new CharacterField(message, HEADERSIZE + 130, 4, "E04ROCTYP");
    fields[15] = fieldE04ROCMTM =
    new DecimalField(message, HEADERSIZE + 134, 3, 0, "E04ROCMTM");
    fields[16] = fieldE04ROCMTD =
    new DecimalField(message, HEADERSIZE + 137, 3, 0, "E04ROCMTD");
    fields[17] = fieldE04ROCMTY =
    new DecimalField(message, HEADERSIZE + 140, 5, 0, "E04ROCMTY");
    fields[18] = fieldE04ROCNBL =
    new DecimalField(message, HEADERSIZE + 145, 17, 2, "E04ROCNBL");
    fields[19] = fieldE04ROCCOP =
    new DecimalField(message, HEADERSIZE + 162, 17, 2, "E04ROCCOP");
    fields[20] = fieldE04DISPON =
    new DecimalField(message, HEADERSIZE + 179, 17, 2, "E04DISPON");
    fields[21] = fieldE04ENDFLD =
    new CharacterField(message, HEADERSIZE + 196, 1, "E04ENDFLD");
