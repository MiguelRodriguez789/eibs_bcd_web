...
* 
* File level identifier is 1151005060631.
* Record format level identifier is 45D06ADAF17F4.
*/
...
public class EWD0325DSMessage extends MessageRecord
{
  ...
  final static String fid = "1151005060631";
  final static String rid = "45D06ADAF17F4";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 29, 20, "SWDREF");
    fields[5] = fieldSWDCCY =
    new CharacterField(message, HEADERSIZE + 49, 3, "SWDCCY");
    fields[6] = fieldSWDACD =
    new CharacterField(message, HEADERSIZE + 52, 2, "SWDACD");
    fields[7] = fieldSWDTYP =
    new CharacterField(message, HEADERSIZE + 54, 4, "SWDTYP");
    fields[8] = fieldSWDSBT =
    new CharacterField(message, HEADERSIZE + 58, 4, "SWDSBT");
    ...
    new CharacterField(message, HEADERSIZE + 111, 60, "SWDDSC");
    fields[14] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 171, 8, 0, "SWDREC");
    fields[15] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 179, 1, "SWDOPE");
