...
* 
* File level identifier is 1180515145239.
* Record format level identifier is 3DC2C40D44335.
*/
...
public class ECH058001Message extends MessageRecord
{
  ...
  final static String fid = "1180515145239";
  final static String rid = "3DC2C40D44335";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 84, 13, 0, "E01CHMNCB");
    fields[14] = fieldE01CHMDSC =
    new CharacterField(message, HEADERSIZE + 97, 45, "E01CHMDSC");
    fields[15] = fieldE01CHMSTS =
    new CharacterField(message, HEADERSIZE + 142, 1, "E01CHMSTS");
