...
* Record format level identifier is 3D2ACA15CEA07.
*/
...
public class EDD0948DSMessage extends MessageRecord
{
  ...
  final static String rid = "3D2ACA15CEA07";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 45, 45, "E01DEVNME");
    fields[11] = fieldE01DEVBRN =
    new CharacterField(message, HEADERSIZE + 90, 45, "E01DEVBRN");
    fields[12] = fieldE01DEVTOI =
    new DecimalField(message, HEADERSIZE + 135, 8, 0, "E01DEVTOI");
    fields[13] = fieldE01DEVTOR =
    new DecimalField(message, HEADERSIZE + 143, 8, 0, "E01DEVTOR");
    fields[14] = fieldE01DEVPAI =
    new DecimalField(message, HEADERSIZE + 151, 17, 2, "E01DEVPAI");
    fields[15] = fieldE01DEVRET =
    new DecimalField(message, HEADERSIZE + 168, 17, 2, "E01DEVRET");
    fields[16] = fieldE01DEVUNC =
    new DecimalField(message, HEADERSIZE + 185, 17, 2, "E01DEVUNC");
    fields[17] = fieldE01DEVOVD =
    new DecimalField(message, HEADERSIZE + 202, 17, 2, "E01DEVOVD");
    fields[18] = fieldE01DEVSTS =
    new CharacterField(message, HEADERSIZE + 219, 1, "E01DEVSTS");
    fields[19] = fieldE01MSGTXT =
    new CharacterField(message, HEADERSIZE + 220, 512, "E01MSGTXT");
