...
* Record format level identifier is 43258A6284C48.
*/
...
public class EWD0016DSMessage extends MessageRecord
{
  ...
  final static String rid = "43258A6284C48";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 19, 60, "EWDNME");
    fields[3] = fieldEWDCO1 =
    new DecimalField(message, HEADERSIZE + 79, 3, 0, "EWDCO1");
    fields[4] = fieldEWDCO2 =
    new DecimalField(message, HEADERSIZE + 82, 3, 0, "EWDCO2");
    fields[5] = fieldEWDCO3 =
    new DecimalField(message, HEADERSIZE + 85, 5, 0, "EWDCO3");
