...
/**
* Class generated by AS/400 CRTCLASS command from ECO105801 physical file definition.
* 
* File level identifier is 1150630155547.
* Record format level identifier is 4E8A8AE9C633B.
*/

public class ECO105801Message extends MessageRecord
{
  ...
  final static String fid = "1150630155547";
  final static String rid = "4E8A8AE9C633B";
  final static String fmtname = "ECO105801";
  ...
  /**
  * Constructor for ECO105801Message.
  */
  public ECO105801Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[19] = fieldE01MOVINI =
    new DecimalField(message, HEADERSIZE + 285, 17, 0, "E01MOVINI");
    fields[20] = fieldE01MOVFIN =
    new DecimalField(message, HEADERSIZE + 302, 17, 0, "E01MOVFIN");
    fields[21] = fieldE01MOVQTY =
    new DecimalField(message, HEADERSIZE + 319, 13, 0, "E01MOVQTY");
    fields[22] = fieldE01MOVSER =
    new DecimalField(message, HEADERSIZE + 332, 13, 0, "E01MOVSER");
    fields[23] = fieldE01MOVVEN =
    new DecimalField(message, HEADERSIZE + 345, 10, 0, "E01MOVVEN");
    fields[24] = fieldE01MOVVNN =
    new CharacterField(message, HEADERSIZE + 355, 45, "E01MOVVNN");
    fields[25] = fieldE01MOVBRS =
    new DecimalField(message, HEADERSIZE + 400, 5, 0, "E01MOVBRS");
    fields[26] = fieldE01MOVBNS =
    new CharacterField(message, HEADERSIZE + 405, 45, "E01MOVBNS");
