...
* Record format level identifier is 4D699493B18BE.
*/
...
public class ECC014001Message extends MessageRecord
{
  ...
  final static String rid = "4D699493B18BE";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 127, 4, "E01CCMPRO");
    fields[14] = fieldE01CCMBNK =
    new CharacterField(message, HEADERSIZE + 131, 2, "E01CCMBNK");
    fields[15] = fieldE01CCMBRN =
    new DecimalField(message, HEADERSIZE + 133, 5, 0, "E01CCMBRN");
    fields[16] = fieldE01CCMCCY =
    new CharacterField(message, HEADERSIZE + 138, 3, "E01CCMCCY");
    fields[17] = fieldE01CCMGLN =
    new DecimalField(message, HEADERSIZE + 141, 17, 0, "E01CCMGLN");
    fields[18] = fieldE01CCMCCN =
    new DecimalField(message, HEADERSIZE + 158, 9, 0, "E01CCMCCN");
    fields[19] = fieldE01CCMAMT =
    new DecimalField(message, HEADERSIZE + 167, 17, 2, "E01CCMAMT");
    fields[20] = fieldE01CCMUBT =
    new DecimalField(message, HEADERSIZE + 184, 6, 0, "E01CCMUBT");
    fields[21] = fieldE01CCMUSR =
    new CharacterField(message, HEADERSIZE + 190, 10, "E01CCMUSR");
    fields[22] = fieldE01CCMRMK =
    new CharacterField(message, HEADERSIZE + 200, 60, "E01CCMRMK");
    fields[23] = fieldE01CCMOPM =
    new DecimalField(message, HEADERSIZE + 260, 3, 0, "E01CCMOPM");
    fields[24] = fieldE01CCMOPD =
    new DecimalField(message, HEADERSIZE + 263, 3, 0, "E01CCMOPD");
    fields[25] = fieldE01CCMOPY =
    new DecimalField(message, HEADERSIZE + 266, 5, 0, "E01CCMOPY");
    fields[26] = fieldE01CCMEXM =
    new DecimalField(message, HEADERSIZE + 271, 3, 0, "E01CCMEXM");
    fields[27] = fieldE01CCMEXD =
    new DecimalField(message, HEADERSIZE + 274, 3, 0, "E01CCMEXD");
    fields[28] = fieldE01CCMEXY =
    new DecimalField(message, HEADERSIZE + 277, 5, 0, "E01CCMEXY");
    fields[29] = fieldE01CCMNUM =
    new CharacterField(message, HEADERSIZE + 282, 20, "E01CCMNUM");
