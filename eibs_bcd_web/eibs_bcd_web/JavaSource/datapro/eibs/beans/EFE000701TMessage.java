...
/**
* Class generated by AS/400 CRTCLASS command from EFE000701T physical file definition.
* 
* File level identifier is 1100914103724.
* Record format level identifier is 343551C227131.
*/

public class EFE000701TMessage extends MessageRecord
{
  ...
  final static String fid = "1100914103724";
  final static String rid = "343551C227131";
  final static String fmtname = "EFE000701T";
  ...
  /**
  * Constructor for EFE000701TMessage.
  */
  public EFE000701TMessage()
  {
    createFields();
    initialize();
  }
