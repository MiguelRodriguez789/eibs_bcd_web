...
* Record format level identifier is 4F61761257CA5.
*/
...
public class EFE0325DSMessage extends MessageRecord
{
  ...
  final static String rid = "4F61761257CA5";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 50, 5, 0, "E01FEODT3");
    fields[13] = fieldE01FEOCUN =
    new DecimalField(message, HEADERSIZE + 55, 10, 0, "E01FEOCUN");
    fields[14] = fieldE01FEOLIM =
    new DecimalField(message, HEADERSIZE + 65, 17, 2, "E01FEOLIM");
    fields[15] = fieldE01FEOUTI =
    new DecimalField(message, HEADERSIZE + 82, 17, 2, "E01FEOUTI");
    fields[16] = fieldE01FEOCCY =
    new CharacterField(message, HEADERSIZE + 99, 3, "E01FEOCCY");
    fields[17] = fieldD01FEOCP1 =
    new CharacterField(message, HEADERSIZE + 102, 45, "D01FEOCP1");
    fields[18] = fieldD01FEOCP2 =
    new CharacterField(message, HEADERSIZE + 147, 45, "D01FEOCP2");
    fields[19] = fieldD01FEOCP3 =
    new CharacterField(message, HEADERSIZE + 192, 45, "D01FEOCP3");
