...
* Record format level identifier is 409ACE2F2741D.
*/
...
public class ESD081701Message extends MessageRecord
{
  ...
  final static String rid = "409ACE2F2741D";
  ...
  private CharacterField fieldE01TRATIM = null;
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 61, 4, "E01TRACDE");
    fields[12] = fieldE01TRANAR =
    new CharacterField(message, HEADERSIZE + 65, 60, "E01TRANAR");
    fields[13] = fieldE01TRABDM =
    new DecimalField(message, HEADERSIZE + 125, 3, 0, "E01TRABDM");
    fields[14] = fieldE01TRABDD =
    new DecimalField(message, HEADERSIZE + 128, 3, 0, "E01TRABDD");
    fields[15] = fieldE01TRABDY =
    new DecimalField(message, HEADERSIZE + 131, 5, 0, "E01TRABDY");
    fields[16] = fieldE01TRAVDM =
    new DecimalField(message, HEADERSIZE + 136, 3, 0, "E01TRAVDM");
    fields[17] = fieldE01TRAVDD =
    new DecimalField(message, HEADERSIZE + 139, 3, 0, "E01TRAVDD");
    fields[18] = fieldE01TRAVDY =
    new DecimalField(message, HEADERSIZE + 142, 5, 0, "E01TRAVDY");
    fields[19] = fieldE01TRACKN =
    new DecimalField(message, HEADERSIZE + 147, 12, 0, "E01TRACKN");
    fields[20] = fieldE01TRAAMT =
    new DecimalField(message, HEADERSIZE + 159, 17, 2, "E01TRAAMT");
    fields[21] = fieldE01TRADCC =
    new CharacterField(message, HEADERSIZE + 176, 1, "E01TRADCC");
    fields[22] = fieldE01TRAAPC =
    new CharacterField(message, HEADERSIZE + 177, 2, "E01TRAAPC");
    fields[23] = fieldE01TRAEXR =
    new DecimalField(message, HEADERSIZE + 179, 13, 6, "E01TRAEXR");
    fields[24] = fieldE01TRAOBK =
    new CharacterField(message, HEADERSIZE + 192, 2, "E01TRAOBK");
    fields[25] = fieldE01TRAOBR =
    new DecimalField(message, HEADERSIZE + 194, 5, 0, "E01TRAOBR");
    fields[26] = fieldE01TRATIM =
    new CharacterField(message, HEADERSIZE + 199, 26, "E01TRATIM");
    fields[27] = fieldE01TRAUSO =
    new CharacterField(message, HEADERSIZE + 225, 10, "E01TRAUSO");
    fields[28] = fieldE01TRAUSA =
    new CharacterField(message, HEADERSIZE + 235, 10, "E01TRAUSA");
    fields[29] = fieldE01TRADRR =
    new DecimalField(message, HEADERSIZE + 245, 13, 0, "E01TRADRR");
    fields[30] = fieldE01TRAACR =
    new DecimalField(message, HEADERSIZE + 258, 13, 0, "E01TRAACR");
    fields[31] = fieldE01TRAPTS =
    new DecimalField(message, HEADERSIZE + 271, 6, 0, "E01TRAPTS");
    fields[32] = fieldE01TRATRN =
    new DecimalField(message, HEADERSIZE + 277, 6, 0, "E01TRATRN");
    fields[33] = fieldE01TRAPMN =
    new DecimalField(message, HEADERSIZE + 283, 6, 0, "E01TRAPMN");
    fields[34] = fieldE01TRACNU =
    new DecimalField(message, HEADERSIZE + 289, 8, 0, "E01TRACNU");
    fields[35] = fieldE01NUMNAR =
    new DecimalField(message, HEADERSIZE + 297, 3, 0, "E01NUMNAR");
    fields[36] = fieldE01TRANA1 =
    new CharacterField(message, HEADERSIZE + 300, 60, "E01TRANA1");
    fields[37] = fieldE01TRANA2 =
    new CharacterField(message, HEADERSIZE + 360, 60, "E01TRANA2");
    fields[38] = fieldE01TRANA3 =
    new CharacterField(message, HEADERSIZE + 420, 60, "E01TRANA3");
    fields[39] = fieldE01TRANA4 =
    new CharacterField(message, HEADERSIZE + 480, 60, "E01TRANA4");
    fields[40] = fieldE01TRANA5 =
    new CharacterField(message, HEADERSIZE + 540, 60, "E01TRANA5");
    fields[41] = fieldE01TRANA6 =
    new CharacterField(message, HEADERSIZE + 600, 60, "E01TRANA6");
    fields[42] = fieldE01TRANA7 =
    new CharacterField(message, HEADERSIZE + 660, 60, "E01TRANA7");
    fields[43] = fieldE01TRANA8 =
    new CharacterField(message, HEADERSIZE + 720, 60, "E01TRANA8");
    fields[44] = fieldE01TRANA9 =
    new CharacterField(message, HEADERSIZE + 780, 60, "E01TRANA9");
    fields[45] = fieldE01NUMREC =
    new DecimalField(message, HEADERSIZE + 840, 8, 0, "E01NUMREC");
    fields[46] = fieldE01INDOPE =
    new CharacterField(message, HEADERSIZE + 848, 1, "E01INDOPE");
