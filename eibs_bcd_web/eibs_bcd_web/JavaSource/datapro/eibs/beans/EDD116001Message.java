...
* Record format level identifier is 302CA0BE72166.
*/
...
public class EDD116001Message extends MessageRecord
{
  ...
  final static String rid = "302CA0BE72166";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 46, 5, 0, "E01ACMBRN");
    fields[11] = fieldE01ACMUC3 =
    new CharacterField(message, HEADERSIZE + 51, 4, "E01ACMUC3");
    fields[12] = fieldE01CONDES =
    new CharacterField(message, HEADERSIZE + 55, 60, "E01CONDES");
    fields[13] = fieldE01PAGOGL =
    new DecimalField(message, HEADERSIZE + 115, 17, 0, "E01PAGOGL");
    fields[14] = fieldE01PAGOCN =
    new DecimalField(message, HEADERSIZE + 132, 9, 0, "E01PAGOCN");
    fields[15] = fieldE01CANRSN =
    new CharacterField(message, HEADERSIZE + 141, 4, "E01CANRSN");
    fields[16] = fieldE01CANDES =
    new CharacterField(message, HEADERSIZE + 145, 60, "E01CANDES");
    fields[17] = fieldE01ACCREF =
    new CharacterField(message, HEADERSIZE + 205, 22, "E01ACCREF");
    fields[18] = fieldE01ACCOPE =
    new CharacterField(message, HEADERSIZE + 227, 1, "E01ACCOPE");
    fields[19] = fieldE01ACCCKF =
    new CharacterField(message, HEADERSIZE + 228, 1, "E01ACCCKF");
