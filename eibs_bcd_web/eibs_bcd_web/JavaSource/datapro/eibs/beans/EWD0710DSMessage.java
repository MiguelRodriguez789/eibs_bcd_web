...
* Record format level identifier is 330482E601C35.
*/
...
public class EWD0710DSMessage extends MessageRecord
{
  ...
  final static String rid = "330482E601C35";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 3, 45, "EWDDCN");
    fields[3] = fieldEWDREC =
    new DecimalField(message, HEADERSIZE + 48, 8, 0, "EWDREC");
    fields[4] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 56, 1, "EWDOPE");
