...
* 
* File level identifier is 1180515144944.
* Record format level identifier is 34D1DB464062C.
*/
...
public class ECH030501Message extends MessageRecord
{
  ...
  final static String fid = "1180515144944";
  final static String rid = "34D1DB464062C";
  ...
  private CharacterField fieldE01CHMTCH = null;
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 304, 5, 0, "E01CHMNCH");
    fields[37] = fieldE01CHMENV =
    new CharacterField(message, HEADERSIZE + 309, 1, "E01CHMENV");
    fields[38] = fieldE01CHMTCH =
    new CharacterField(message, HEADERSIZE + 310, 2, "E01CHMTCH");
    fields[39] = fieldE01CHMDBR =
    new DecimalField(message, HEADERSIZE + 312, 5, 0, "E01CHMDBR");
    fields[40] = fieldE01APCCCY =
    new CharacterField(message, HEADERSIZE + 317, 3, "E01APCCCY");
