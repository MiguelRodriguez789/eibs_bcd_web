...
* Record format level identifier is 52A898F06E19F.
*/
...
public class ESO000002Message extends MessageRecord
{
  ...
  final static String rid = "52A898F06E19F";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 122, 4, "E02SOLPRO");
    fields[13] = fieldE02SOLPRI =
    new DecimalField(message, HEADERSIZE + 126, 17, 2, "E02SOLPRI");
    fields[14] = fieldE02SOLTRM =
    new DecimalField(message, HEADERSIZE + 143, 5, 0, "E02SOLTRM");
    fields[15] = fieldE02SOLTRC =
    new CharacterField(message, HEADERSIZE + 148, 1, "E02SOLTRC");
    fields[16] = fieldE02SOLPVI =
    new CharacterField(message, HEADERSIZE + 149, 1, "E02SOLPVI");
    fields[17] = fieldE02SOLOPE =
    new CharacterField(message, HEADERSIZE + 150, 2, "E02SOLOPE");
    fields[18] = fieldE02SOLRTE =
    new DecimalField(message, HEADERSIZE + 152, 11, 6, "E02SOLRTE");
    fields[19] = fieldE02SOLART =
    new DecimalField(message, HEADERSIZE + 163, 11, 6, "E02SOLART");
    fields[20] = fieldE02ACTION =
    new CharacterField(message, HEADERSIZE + 174, 1, "E02ACTION");
    fields[21] = fieldE02FINDAT =
    new CharacterField(message, HEADERSIZE + 175, 1, "E02FINDAT");
