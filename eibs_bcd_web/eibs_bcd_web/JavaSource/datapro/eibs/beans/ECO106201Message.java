...
/**
* Class generated by AS/400 CRTCLASS command from ECO106201 physical file definition.
* 
* File level identifier is 1150701161523.
* Record format level identifier is 340B720AE4DFE.
*/

public class ECO106201Message extends MessageRecord
{
  ...
  final static String fid = "1150701161523";
  final static String rid = "340B720AE4DFE";
  final static String fmtname = "ECO106201";
  ...
  private DecimalField fieldE01DOCCSN = null;
  private CharacterField fieldE01DOCCSM = null;
  private CharacterField fieldE01DOCUSR = null;

  /**
  * Constructor for ECO106201Message.
  */
  public ECO106201Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[17] = fieldE01DOCCSN =
    new DecimalField(message, HEADERSIZE + 237, 3, 0, "E01DOCCSN");
    fields[18] = fieldE01DOCCSM =
    new CharacterField(message, HEADERSIZE + 240, 45, "E01DOCCSM");
    fields[19] = fieldE01DOCUSR =
    new CharacterField(message, HEADERSIZE + 285, 10, "E01DOCUSR");
  ...
  */
  ...
  /**
  * Set field E01DOCCSN using a String value.
  */
  public void setE01DOCCSN(String newvalue)
  {
    fieldE01DOCCSN.setString(newvalue);
  }

  /**
  * Get value of field E01DOCCSN as a String.
  */
  public String getE01DOCCSN()
  {
    return fieldE01DOCCSN.getString();
  }

  /**
  * Set numeric field E01DOCCSN using a BigDecimal value.
  */
  public void setE01DOCCSN(BigDecimal newvalue)
  {
    fieldE01DOCCSN.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field E01DOCCSN as a BigDecimal.
  */
  public BigDecimal getBigDecimalE01DOCCSN()
  {
    return fieldE01DOCCSN.getBigDecimal();
  }

  /**
  * Set field E01DOCCSM using a String value.
  */
  public void setE01DOCCSM(String newvalue)
  {
    fieldE01DOCCSM.setString(newvalue);
  }

  /**
  * Get value of field E01DOCCSM as a String.
  */
  public String getE01DOCCSM()
  {
    return fieldE01DOCCSM.getString();
  }
