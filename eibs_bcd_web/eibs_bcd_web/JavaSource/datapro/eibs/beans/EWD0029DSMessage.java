...
* Record format level identifier is 33939D983AFA9.
*/
...
public class EWD0029DSMessage extends MessageRecord
{
  ...
  final static String rid = "33939D983AFA9";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 5, 60, "EWDITD");
    fields[2] = fieldEWDTYP =
    new CharacterField(message, HEADERSIZE + 65, 2, "EWDTYP");
    fields[3] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 67, 1, "EWDOPE");
