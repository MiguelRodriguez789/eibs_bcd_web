...
/**
* Class generated by AS/400 CRTCLASS command from EIE000701 physical file definition.
* 
* File level identifier is 1130611113206.
* Record format level identifier is 42BA433E6C9B5.
*/

public class EIE000701Message extends MessageRecord
{
  ...
  final static String rid = "42BA433E6C9B5";
  final static String fmtname = "EIE000701";
  ...
  /**
  * Constructor for EIE000701Message.
  */
  public EIE000701Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 44, 5, 0, "E01OLDBRN");
    fields[11] = fieldE01OLDCCY =
    new CharacterField(message, HEADERSIZE + 49, 3, "E01OLDCCY");
    fields[12] = fieldE01OLDGLN =
    new DecimalField(message, HEADERSIZE + 52, 17, 0, "E01OLDGLN");
    fields[13] = fieldE01OLDACC =
    new DecimalField(message, HEADERSIZE + 69, 13, 0, "E01OLDACC");
    fields[14] = fieldE01OLDACD =
    new CharacterField(message, HEADERSIZE + 82, 2, "E01OLDACD");
    fields[15] = fieldE01OLDATY =
    new CharacterField(message, HEADERSIZE + 84, 4, "E01OLDATY");
    fields[16] = fieldE01OLDPRD =
    new CharacterField(message, HEADERSIZE + 88, 4, "E01OLDPRD");
    fields[17] = fieldE01NEWBNK =
    new CharacterField(message, HEADERSIZE + 92, 2, "E01NEWBNK");
    fields[18] = fieldE01NEWBRN =
    new CharacterField(message, HEADERSIZE + 94, 4, "E01NEWBRN");
    fields[19] = fieldE01NEWCCY =
    new CharacterField(message, HEADERSIZE + 98, 3, "E01NEWCCY");
    fields[20] = fieldE01NEWGLN =
    new DecimalField(message, HEADERSIZE + 101, 17, 0, "E01NEWGLN");
    fields[21] = fieldE01NEWPRD =
    new CharacterField(message, HEADERSIZE + 118, 4, "E01NEWPRD");
    fields[22] = fieldE01NEWATY =
    new CharacterField(message, HEADERSIZE + 122, 4, "E01NEWATY");
    fields[23] = fieldE01CUSNUM =
    new DecimalField(message, HEADERSIZE + 126, 10, 0, "E01CUSNUM");
    fields[24] = fieldE01CUSNA1 =
    new CharacterField(message, HEADERSIZE + 136, 60, "E01CUSNA1");
    fields[25] = fieldE01OBNKNA =
    new CharacterField(message, HEADERSIZE + 196, 60, "E01OBNKNA");
    fields[26] = fieldE01OBRNNA =
    new CharacterField(message, HEADERSIZE + 256, 60, "E01OBRNNA");
    fields[27] = fieldE01OGLNDE =
    new CharacterField(message, HEADERSIZE + 316, 60, "E01OGLNDE");
    fields[28] = fieldE01OPRDNA =
    new CharacterField(message, HEADERSIZE + 376, 45, "E01OPRDNA");
    fields[29] = fieldE01OATYNA =
    new CharacterField(message, HEADERSIZE + 421, 60, "E01OATYNA");
    fields[30] = fieldE01NBNKNA =
    new CharacterField(message, HEADERSIZE + 481, 60, "E01NBNKNA");
    fields[31] = fieldE01NBRNNA =
    new CharacterField(message, HEADERSIZE + 541, 60, "E01NBRNNA");
    fields[32] = fieldE01NGLNDE =
    new CharacterField(message, HEADERSIZE + 601, 60, "E01NGLNDE");
    fields[33] = fieldE01NPRDNA =
    new CharacterField(message, HEADERSIZE + 661, 45, "E01NPRDNA");
    fields[34] = fieldE01NATYNA =
    new CharacterField(message, HEADERSIZE + 706, 60, "E01NATYNA");
    fields[35] = fieldE01ISIIIC =
    new DecimalField(message, HEADERSIZE + 766, 13, 0, "E01ISIIIC");
    fields[36] = fieldE01ISIDSC =
    new CharacterField(message, HEADERSIZE + 779, 45, "E01ISIDSC");
