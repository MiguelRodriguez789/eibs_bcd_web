...
* Record format level identifier is 56401B77A08A3.
*/
...
public class EWD0334DSMessage extends MessageRecord
{
  ...
  final static String rid = "56401B77A08A3";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 29, 5, 0, "SWDBRN");
    fields[6] = fieldSWDCCY =
    new CharacterField(message, HEADERSIZE + 34, 3, "SWDCCY");
    fields[7] = fieldSWDACC =
    new DecimalField(message, HEADERSIZE + 37, 13, 0, "SWDACC");
    fields[8] = fieldSWDTYP =
    new CharacterField(message, HEADERSIZE + 50, 4, "SWDTYP");
    fields[9] = fieldSWDSBT =
    new CharacterField(message, HEADERSIZE + 54, 4, "SWDSBT");
    fields[10] = fieldSWDPRO =
    new CharacterField(message, HEADERSIZE + 58, 4, "SWDPRO");
    fields[11] = fieldSWDTRA =
    new DecimalField(message, HEADERSIZE + 62, 9, 0, "SWDTRA");
    fields[12] = fieldSWDVAL =
    new DecimalField(message, HEADERSIZE + 71, 9, 0, "SWDVAL");
    fields[13] = fieldSWDMAT =
    new DecimalField(message, HEADERSIZE + 80, 9, 0, "SWDMAT");
    fields[14] = fieldSWDCUN =
    new DecimalField(message, HEADERSIZE + 89, 10, 0, "SWDCUN");
    fields[15] = fieldSWDAMT =
    new DecimalField(message, HEADERSIZE + 99, 17, 2, "SWDAMT");
    fields[16] = fieldSWDDSC =
    new CharacterField(message, HEADERSIZE + 116, 60, "SWDDSC");
    fields[17] = fieldSWDSTS =
    new CharacterField(message, HEADERSIZE + 176, 45, "SWDSTS");
    fields[18] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 221, 8, 0, "SWDREC");
    fields[19] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 229, 1, "SWDOPE");
