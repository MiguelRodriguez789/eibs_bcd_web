...
* Record format level identifier is 5B076DAA2311E.
*/
...
public class ESD000503Message extends MessageRecord
{
  ...
  final static String rid = "5B076DAA2311E";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 50, 5, 0, "E03MSGEXY");
    fields[13] = fieldE03MSGONE =
    new CharacterField(message, HEADERSIZE + 55, 50, "E03MSGONE");
    fields[14] = fieldE03MSGTWO =
    new CharacterField(message, HEADERSIZE + 105, 50, "E03MSGTWO");
    fields[15] = fieldE03MSGTHR =
    new CharacterField(message, HEADERSIZE + 155, 50, "E03MSGTHR");
    fields[16] = fieldE03MSGFOU =
    new CharacterField(message, HEADERSIZE + 205, 50, "E03MSGFOU");
    fields[17] = fieldE03MSGFIV =
    new CharacterField(message, HEADERSIZE + 255, 50, "E03MSGFIV");
    fields[18] = fieldE03MSGSIX =
    new CharacterField(message, HEADERSIZE + 305, 50, "E03MSGSIX");
