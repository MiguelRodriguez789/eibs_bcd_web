...
* Record format level identifier is 422EBA1F4C2C7.
*/
...
public class EGC050040Message extends MessageRecord
{
  ...
  final static String rid = "422EBA1F4C2C7";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 46, 25, "E40GCRUT");
    fields[11] = fieldE40GCNMBC =
    new CharacterField(message, HEADERSIZE + 71, 45, "E40GCNMBC");
    fields[12] = fieldE40GCGTPB =
    new CharacterField(message, HEADERSIZE + 116, 4, "E40GCGTPB");
    fields[13] = fieldE40GCNOPR =
    new DecimalField(message, HEADERSIZE + 120, 6, 0, "E40GCNOPR");
    fields[14] = fieldE40GCGMND =
    new CharacterField(message, HEADERSIZE + 126, 3, "E40GCGMND");
    fields[15] = fieldE40GCSTAT =
    new CharacterField(message, HEADERSIZE + 129, 1, "E40GCSTAT");
    fields[16] = fieldE40GCNMBF =
    new CharacterField(message, HEADERSIZE + 130, 45, "E40GCNMBF");
    fields[17] = fieldE40GCMBOL =
    new DecimalField(message, HEADERSIZE + 175, 17, 2, "E40GCMBOL");
    fields[18] = fieldE40GCEMSY =
    new DecimalField(message, HEADERSIZE + 192, 5, 0, "E40GCEMSY");
    fields[19] = fieldE40GCEMSM =
    new DecimalField(message, HEADERSIZE + 197, 3, 0, "E40GCEMSM");
    fields[20] = fieldE40GCEMSD =
    new DecimalField(message, HEADERSIZE + 200, 3, 0, "E40GCEMSD");
    fields[21] = fieldE40GCVENY =
    new DecimalField(message, HEADERSIZE + 203, 5, 0, "E40GCVENY");
    fields[22] = fieldE40GCVENM =
    new DecimalField(message, HEADERSIZE + 208, 3, 0, "E40GCVENM");
    fields[23] = fieldE40GCVEND =
    new DecimalField(message, HEADERSIZE + 211, 3, 0, "E40GCVEND");
    fields[24] = fieldE40GCINTR =
    new DecimalField(message, HEADERSIZE + 214, 13, 6, "E40GCINTR");
    fields[25] = fieldE40GCCOMM =
    new DecimalField(message, HEADERSIZE + 227, 6, 0, "E40GCCOMM");
    fields[26] = fieldE40INDOPE =
    new CharacterField(message, HEADERSIZE + 233, 1, "E40INDOPE");
