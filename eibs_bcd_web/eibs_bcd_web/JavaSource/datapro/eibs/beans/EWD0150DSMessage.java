...
* Record format level identifier is 42C728C9B213F.
*/
...
public class EWD0150DSMessage extends MessageRecord
{
  ...
  final static String rid = "42C728C9B213F";
  ...
  private CharacterField fieldEWDTSL = null;
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 38, 60, "EWDDSC");
    fields[9] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 98, 1, "EWDOPE");
    fields[10] = fieldEWDTSL =
    new CharacterField(message, HEADERSIZE + 99, 1, "EWDTSL");
  ...
  */
  ...
  /**
  * Set field EWDTSL using a String value.
  */
  public void setEWDTSL(String newvalue)
  {
    fieldEWDTSL.setString(newvalue);
  }

  /**
  * Get value of field EWDTSL as a String.
  */
  public String getEWDTSL()
  {
    return fieldEWDTSL.getString();
  }
