...
* Record format level identifier is 45DC957D69B41.
*/
...
public class ECIF120P1Message extends MessageRecord
{
  ...
  final static String rid = "45DC957D69B41";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 91, 3, 0, "E01STRDT1");
    fields[12] = fieldE01STRDT2 =
    new DecimalField(message, HEADERSIZE + 94, 3, 0, "E01STRDT2");
    fields[13] = fieldE01STRDT3 =
    new DecimalField(message, HEADERSIZE + 97, 5, 0, "E01STRDT3");
    fields[14] = fieldE01CONTPM =
    new DecimalField(message, HEADERSIZE + 102, 13, 0, "E01CONTPM");
    fields[15] = fieldE01AMNTPM =
    new DecimalField(message, HEADERSIZE + 115, 17, 2, "E01AMNTPM");
    fields[16] = fieldE01CONTCM =
    new DecimalField(message, HEADERSIZE + 132, 13, 0, "E01CONTCM");
    fields[17] = fieldE01AMNTCM =
    new DecimalField(message, HEADERSIZE + 145, 17, 2, "E01AMNTCM");
    fields[18] = fieldE01CONTPY =
    new DecimalField(message, HEADERSIZE + 162, 13, 0, "E01CONTPY");
    fields[19] = fieldE01AMNTPY =
    new DecimalField(message, HEADERSIZE + 175, 17, 2, "E01AMNTPY");
    fields[20] = fieldE01CONTYT =
    new DecimalField(message, HEADERSIZE + 192, 13, 0, "E01CONTYT");
    fields[21] = fieldE01AMNTYT =
    new DecimalField(message, HEADERSIZE + 205, 17, 2, "E01AMNTYT");
    fields[22] = fieldE01CCAUTH =
    new CharacterField(message, HEADERSIZE + 222, 2400, "E01CCAUTH");
