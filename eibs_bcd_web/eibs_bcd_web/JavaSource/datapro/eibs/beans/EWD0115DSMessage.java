...
* Record format level identifier is 2AFDA9478D720.
*/
...
public class EWD0115DSMessage extends MessageRecord
{
  ...
  final static String rid = "2AFDA9478D720";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 5, 2, "EWDFTY");
    fields[3] = fieldEWDDSC =
    new CharacterField(message, HEADERSIZE + 7, 60, "EWDDSC");
    fields[4] = fieldEWDGLN =
    new DecimalField(message, HEADERSIZE + 67, 17, 0, "EWDGLN");
