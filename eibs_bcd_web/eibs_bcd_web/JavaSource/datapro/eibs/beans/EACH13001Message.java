...
* 
* File level identifier is 1120816173232.
* Record format level identifier is 21F78CF8CDE0F.
*/
...
public class EACH13001Message extends MessageRecord
{
  ...
  final static String fid = "1120816173232";
  final static String rid = "21F78CF8CDE0F";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 91, 4, "E01ACTITC");
    fields[14] = fieldE01ACTRET =
    new CharacterField(message, HEADERSIZE + 95, 2, "E01ACTRET");
    fields[15] = fieldE01ACTAMT =
    new CharacterField(message, HEADERSIZE + 97, 1, "E01ACTAMT");
    fields[16] = fieldE01ACTDYS =
    new DecimalField(message, HEADERSIZE + 98, 3, 0, "E01ACTDYS");
    fields[17] = fieldE01ACTAT1 =
    new CharacterField(message, HEADERSIZE + 101, 3, "E01ACTAT1");
    fields[18] = fieldE01ACTAT2 =
    new CharacterField(message, HEADERSIZE + 104, 3, "E01ACTAT2");
    fields[19] = fieldE01ACTAT3 =
    new CharacterField(message, HEADERSIZE + 107, 3, "E01ACTAT3");
    fields[20] = fieldE01ACTAT4 =
    new CharacterField(message, HEADERSIZE + 110, 3, "E01ACTAT4");
    fields[21] = fieldE01ACTAT5 =
    new CharacterField(message, HEADERSIZE + 113, 3, "E01ACTAT5");
    fields[22] = fieldE01ACTAT6 =
    new CharacterField(message, HEADERSIZE + 116, 3, "E01ACTAT6");
    fields[23] = fieldE01ACTAT7 =
    new CharacterField(message, HEADERSIZE + 119, 3, "E01ACTAT7");
    fields[24] = fieldE01ACTAT8 =
    new CharacterField(message, HEADERSIZE + 122, 3, "E01ACTAT8");
    fields[25] = fieldE01ACTAT9 =
    new CharacterField(message, HEADERSIZE + 125, 3, "E01ACTAT9");
    fields[26] = fieldE01ACT =
    new CharacterField(message, HEADERSIZE + 128, 1, "E01ACT");
