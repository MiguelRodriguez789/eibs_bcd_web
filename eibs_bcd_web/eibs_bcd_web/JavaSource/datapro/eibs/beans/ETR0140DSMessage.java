...
* Record format level identifier is 33CFBC39C4C1C.
*/
...
public class ETR0140DSMessage extends MessageRecord
{
  ...
  final static String rid = "33CFBC39C4C1C";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 44, 5, 0, "E01WFRBRN");
    fields[11] = fieldE01WFRCCY =
    new CharacterField(message, HEADERSIZE + 49, 3, "E01WFRCCY");
    fields[12] = fieldE01WFRACC =
    new DecimalField(message, HEADERSIZE + 52, 13, 0, "E01WFRACC");
    fields[13] = fieldE01WFRGLN =
    new DecimalField(message, HEADERSIZE + 65, 17, 0, "E01WFRGLN");
    fields[14] = fieldE01WFRTYP =
    new CharacterField(message, HEADERSIZE + 82, 4, "E01WFRTYP");
    fields[15] = fieldE01WFRSBT =
    new CharacterField(message, HEADERSIZE + 86, 4, "E01WFRSBT");
    fields[16] = fieldE01WFRPRO =
    new CharacterField(message, HEADERSIZE + 90, 4, "E01WFRPRO");
    fields[17] = fieldE01WFRITP =
    new CharacterField(message, HEADERSIZE + 94, 5, "E01WFRITP");
    fields[18] = fieldE01WFRDD1 =
    new DecimalField(message, HEADERSIZE + 99, 3, 0, "E01WFRDD1");
    fields[19] = fieldE01WFRDD2 =
    new DecimalField(message, HEADERSIZE + 102, 3, 0, "E01WFRDD2");
    fields[20] = fieldE01WFRDD3 =
    new DecimalField(message, HEADERSIZE + 105, 5, 0, "E01WFRDD3");
    fields[21] = fieldE01WFRVD1 =
    new DecimalField(message, HEADERSIZE + 110, 3, 0, "E01WFRVD1");
    fields[22] = fieldE01WFRVD2 =
    new DecimalField(message, HEADERSIZE + 113, 3, 0, "E01WFRVD2");
    fields[23] = fieldE01WFRVD3 =
    new DecimalField(message, HEADERSIZE + 116, 5, 0, "E01WFRVD3");
    fields[24] = fieldE01WFRMA1 =
    new DecimalField(message, HEADERSIZE + 121, 3, 0, "E01WFRMA1");
    fields[25] = fieldE01WFRMA2 =
    new DecimalField(message, HEADERSIZE + 124, 3, 0, "E01WFRMA2");
    fields[26] = fieldE01WFRMA3 =
    new DecimalField(message, HEADERSIZE + 127, 5, 0, "E01WFRMA3");
    fields[27] = fieldE01WFRCUN =
    new DecimalField(message, HEADERSIZE + 132, 10, 0, "E01WFRCUN");
    fields[28] = fieldE01WFRRTE =
    new DecimalField(message, HEADERSIZE + 142, 11, 6, "E01WFRRTE");
    fields[29] = fieldE01WFROAM =
    new DecimalField(message, HEADERSIZE + 153, 17, 2, "E01WFROAM");
    fields[30] = fieldE01WFRLCU =
    new DecimalField(message, HEADERSIZE + 170, 10, 0, "E01WFRLCU");
    fields[31] = fieldE01WFRCMM =
    new DecimalField(message, HEADERSIZE + 180, 5, 0, "E01WFRCMM");
    fields[32] = fieldE01WFROF2 =
    new CharacterField(message, HEADERSIZE + 185, 4, "E01WFROF2");
    fields[33] = fieldE01WFRGRC =
    new CharacterField(message, HEADERSIZE + 189, 4, "E01WFRGRC");
    fields[34] = fieldE01WFRGEC =
    new CharacterField(message, HEADERSIZE + 193, 4, "E01WFRGEC");
    fields[35] = fieldE01WFRBUC =
    new CharacterField(message, HEADERSIZE + 197, 4, "E01WFRBUC");
    fields[36] = fieldE01WFRIND =
    new CharacterField(message, HEADERSIZE + 201, 4, "E01WFRIND");
    fields[37] = fieldE01WFRCST =
    new DecimalField(message, HEADERSIZE + 205, 9, 0, "E01WFRCST");
    fields[38] = fieldE01WFRPVI =
    new CharacterField(message, HEADERSIZE + 214, 1, "E01WFRPVI");
    fields[39] = fieldE01WFRCFT =
    new CharacterField(message, HEADERSIZE + 215, 1, "E01WFRCFT");
    fields[40] = fieldE01WFRHEF =
    new CharacterField(message, HEADERSIZE + 216, 1, "E01WFRHEF");
    fields[41] = fieldE01WFRHEM =
    new DecimalField(message, HEADERSIZE + 217, 13, 0, "E01WFRHEM");
    fields[42] = fieldE01WFROT1 =
    new CharacterField(message, HEADERSIZE + 230, 60, "E01WFROT1");
    fields[43] = fieldE01WFROT2 =
    new CharacterField(message, HEADERSIZE + 290, 60, "E01WFROT2");
    fields[44] = fieldD01WFRCP1 =
    new CharacterField(message, HEADERSIZE + 350, 45, "D01WFRCP1");
    fields[45] = fieldD01WFRCP2 =
    new CharacterField(message, HEADERSIZE + 395, 45, "D01WFRCP2");
    fields[46] = fieldD01WFRCP3 =
    new CharacterField(message, HEADERSIZE + 440, 45, "D01WFRCP3");
    fields[47] = fieldD01LIMAMT =
    new DecimalField(message, HEADERSIZE + 485, 17, 2, "D01LIMAMT");
    fields[48] = fieldD01LIMAVL =
    new DecimalField(message, HEADERSIZE + 502, 17, 2, "D01LIMAVL");
    fields[49] = fieldD01LIMEND =
    new DecimalField(message, HEADERSIZE + 519, 17, 2, "D01LIMEND");
    fields[50] = fieldD01FEOLIM =
    new DecimalField(message, HEADERSIZE + 536, 17, 2, "D01FEOLIM");
    fields[51] = fieldD01FEOAVL =
    new DecimalField(message, HEADERSIZE + 553, 17, 2, "D01FEOAVL");
    fields[52] = fieldD01FEOEND =
    new DecimalField(message, HEADERSIZE + 570, 17, 2, "D01FEOEND");
    fields[53] = fieldD01USRDSC =
    new CharacterField(message, HEADERSIZE + 587, 45, "D01USRDSC");
    fields[54] = fieldD01APCDSC =
    new CharacterField(message, HEADERSIZE + 632, 60, "D01APCDSC");
    fields[55] = fieldD01ACTION =
    new CharacterField(message, HEADERSIZE + 692, 1, "D01ACTION");
    fields[56] = fieldD01MSGTXT =
    new CharacterField(message, HEADERSIZE + 693, 512, "D01MSGTXT");
