...
/**
* Class generated by AS/400 CRTCLASS command from EWD0332DS physical file definition.
* 
* File level identifier is 1130611113453.
* Record format level identifier is 327FD70375891.
*/

public class EWD0332DSMessage extends MessageRecord
{
  ...
  final static String rid = "327FD70375891";
  final static String fmtname = "EWD0332DS";
  ...
  private DecimalField fieldSWDPRI = null;
  ...
  /**
  * Constructor for EWD0332DSMessage.
  */
  public EWD0332DSMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 29, 13, 0, "SWDACC");
    fields[7] = fieldSWDTYP =
    new CharacterField(message, HEADERSIZE + 42, 4, "SWDTYP");
    fields[8] = fieldSWDSBT =
    new CharacterField(message, HEADERSIZE + 46, 4, "SWDSBT");
    fields[9] = fieldSWDITP =
    new CharacterField(message, HEADERSIZE + 50, 5, "SWDITP");
    fields[10] = fieldSWDTRA =
    new DecimalField(message, HEADERSIZE + 55, 9, 0, "SWDTRA");
    fields[11] = fieldSWDVAL =
    new DecimalField(message, HEADERSIZE + 64, 9, 0, "SWDVAL");
    fields[12] = fieldSWDMAT =
    new DecimalField(message, HEADERSIZE + 73, 9, 0, "SWDMAT");
    fields[13] = fieldSWDCUN =
    new DecimalField(message, HEADERSIZE + 82, 10, 0, "SWDCUN");
    fields[14] = fieldSWDPRI =
    new DecimalField(message, HEADERSIZE + 92, 17, 2, "SWDPRI");
    fields[15] = fieldSWDOAM =
    new DecimalField(message, HEADERSIZE + 109, 17, 2, "SWDOAM");
    fields[16] = fieldSWDRTE =
    new DecimalField(message, HEADERSIZE + 126, 13, 6, "SWDRTE");
    fields[17] = fieldSWDDSC =
    new CharacterField(message, HEADERSIZE + 139, 60, "SWDDSC");
    fields[18] = fieldSWDSTS =
    new CharacterField(message, HEADERSIZE + 199, 45, "SWDSTS");
    fields[19] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 244, 8, 0, "SWDREC");
    fields[20] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 252, 1, "SWDOPE");
  ...
  */
  ...
  /**
  * Set field SWDPRI using a String value.
  */
  public void setSWDPRI(String newvalue)
  {
    fieldSWDPRI.setString(newvalue);
  }

  /**
  * Get value of field SWDPRI as a String.
  */
  public String getSWDPRI()
  {
    return fieldSWDPRI.getString();
  }

  /**
  * Set numeric field SWDPRI using a BigDecimal value.
  */
  public void setSWDPRI(BigDecimal newvalue)
  {
    fieldSWDPRI.setBigDecimal(newvalue);
  }

  /**
  * Return value of numeric field SWDPRI as a BigDecimal.
  */
  public BigDecimal getBigDecimalSWDPRI()
  {
    return fieldSWDPRI.getBigDecimal();
  }
