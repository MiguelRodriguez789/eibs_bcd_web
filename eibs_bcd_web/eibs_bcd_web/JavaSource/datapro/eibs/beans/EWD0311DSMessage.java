...
* Record format level identifier is 4E043886DC87F.
*/
...
public class EWD0311DSMessage extends MessageRecord
{
  ...
  final static String rid = "4E043886DC87F";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 100, 45, "SWDREF");
    fields[8] = fieldSWDOP1 =
    new DecimalField(message, HEADERSIZE + 145, 3, 0, "SWDOP1");
    fields[9] = fieldSWDOP2 =
    new DecimalField(message, HEADERSIZE + 148, 3, 0, "SWDOP2");
    fields[10] = fieldSWDOP3 =
    new DecimalField(message, HEADERSIZE + 151, 5, 0, "SWDOP3");
    fields[11] = fieldSWDREC =
    new DecimalField(message, HEADERSIZE + 156, 8, 0, "SWDREC");
    fields[12] = fieldSWDOPE =
    new CharacterField(message, HEADERSIZE + 164, 1, "SWDOPE");
