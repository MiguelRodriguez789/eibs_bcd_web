...
* Record format level identifier is 435A8E6D9D5C6.
*/
...
public class EOFNUMDSMessage extends MessageRecord
{
  ...
  final static String rid = "435A8E6D9D5C6";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 0, 12, 0, "EOFNNUM");
    fields[1] = fieldEOFBNK =
    new CharacterField(message, HEADERSIZE + 12, 2, "EOFBNK");
    fields[2] = fieldEOFBRN =
    new DecimalField(message, HEADERSIZE + 14, 5, 0, "EOFBRN");
    fields[3] = fieldEOFCCY =
    new CharacterField(message, HEADERSIZE + 19, 3, "EOFCCY");
    fields[4] = fieldEOFFORN =
    new CharacterField(message, HEADERSIZE + 22, 2, "EOFFORN");
    fields[5] = fieldEOFPARM =
    new CharacterField(message, HEADERSIZE + 24, 1, "EOFPARM");
