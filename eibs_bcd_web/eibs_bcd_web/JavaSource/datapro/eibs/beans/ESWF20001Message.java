...
* Record format level identifier is 4F4E35776B1E1.
*/
...
public class ESWF20001Message extends MessageRecord
{
  ...
  final static String rid = "4F4E35776B1E1";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 10, 25, "ESW1SWI");
    fields[2] = fieldESW1REF =
    new CharacterField(message, HEADERSIZE + 35, 16, "ESW1REF");
    fields[3] = fieldESW1FTM =
    new DecimalField(message, HEADERSIZE + 51, 4, 0, "ESW1FTM");
    fields[4] = fieldESW1DT1 =
    new DecimalField(message, HEADERSIZE + 55, 3, 0, "ESW1DT1");
    fields[5] = fieldESW1DT2 =
    new DecimalField(message, HEADERSIZE + 58, 3, 0, "ESW1DT2");
    fields[6] = fieldESW1DT3 =
    new DecimalField(message, HEADERSIZE + 61, 5, 0, "ESW1DT3");
    fields[7] = fieldESW1REC =
    new DecimalField(message, HEADERSIZE + 66, 8, 0, "ESW1REC");
    fields[8] = fieldESW1OPE =
    new CharacterField(message, HEADERSIZE + 74, 1, "ESW1OPE");
