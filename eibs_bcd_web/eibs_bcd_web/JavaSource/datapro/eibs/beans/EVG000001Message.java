...
* Record format level identifier is 3F6FCEC2B3A66.
*/
...
public class EVG000001Message extends MessageRecord
{
  ...
  final static String rid = "3F6FCEC2B3A66";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 47, 2, "E01VGNFTY");
    fields[12] = fieldE01VGNDSC =
    new CharacterField(message, HEADERSIZE + 49, 60, "E01VGNDSC");
    fields[13] = fieldE01VGNVIG =
    new DecimalField(message, HEADERSIZE + 109, 17, 0, "E01VGNVIG");
    fields[14] = fieldE01VGNGI1 =
    new DecimalField(message, HEADERSIZE + 126, 17, 0, "E01VGNGI1");
    fields[15] = fieldE01VGNGI2 =
    new DecimalField(message, HEADERSIZE + 143, 17, 0, "E01VGNGI2");
    fields[16] = fieldE01VGNDI1 =
    new DecimalField(message, HEADERSIZE + 160, 5, 0, "E01VGNDI1");
    fields[17] = fieldE01VGNDI2 =
    new DecimalField(message, HEADERSIZE + 165, 5, 0, "E01VGNDI2");
    fields[18] = fieldE01VGNFOC =
    new CharacterField(message, HEADERSIZE + 170, 1, "E01VGNFOC");
    fields[19] = fieldE01VGNFL1 =
    new CharacterField(message, HEADERSIZE + 171, 1, "E01VGNFL1");
    fields[20] = fieldE01VGNFL2 =
    new CharacterField(message, HEADERSIZE + 172, 1, "E01VGNFL2");
