...
* Record format level identifier is 3ED32A443A006.
*/
...
public class EDP082001Message extends MessageRecord
{
  ...
  final static String rid = "3ED32A443A006";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 48, 45, "E01MODDSC");
    fields[13] = fieldE01MODPER =
    new DecimalField(message, HEADERSIZE + 93, 11, 6, "E01MODPER");
    fields[14] = fieldE01MODPET =
    new DecimalField(message, HEADERSIZE + 104, 11, 6, "E01MODPET");
    fields[15] = fieldE01RECPOS =
    new DecimalField(message, HEADERSIZE + 115, 8, 0, "E01RECPOS");
    fields[16] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 123, 1, "E01OPECDE");
