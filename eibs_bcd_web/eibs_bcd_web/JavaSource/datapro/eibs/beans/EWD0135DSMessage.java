...
* Record format level identifier is 620283B77A377.
*/
...
public class EWD0135DSMessage extends MessageRecord
{
  ...
  final static String rid = "620283B77A377";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 62, 7, 0, "EWDBIN");
    fields[3] = fieldEWDTPI =
    new DecimalField(message, HEADERSIZE + 69, 2, 0, "EWDTPI");
    fields[4] = fieldEWDMXC =
    new DecimalField(message, HEADERSIZE + 71, 3, 0, "EWDMXC");
    fields[5] = fieldEWDTRM =
    new DecimalField(message, HEADERSIZE + 74, 4, 0, "EWDTRM");
    fields[6] = fieldEWDTRC =
    new CharacterField(message, HEADERSIZE + 78, 1, "EWDTRC");
    fields[7] = fieldEWDACT =
    new CharacterField(message, HEADERSIZE + 79, 1, "EWDACT");
    fields[8] = fieldEWDPRV =
    new CharacterField(message, HEADERSIZE + 80, 60, "EWDPRV");
    fields[9] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 140, 1, "EWDOPE");
