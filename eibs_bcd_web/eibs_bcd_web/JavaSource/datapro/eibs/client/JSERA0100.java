			...
			while (true) {
				...
				if (marker.equals("*")) {
					...
					myRow.append("<TD NOWRAP ALIGN=CENTER>" + Util.formatCustomDate(user.getE01DTF(),
																	msgList.getBigDecimalE02RODODM().intValue(),
																	msgList.getBigDecimalE02RODODD().intValue(),
																	msgList.getBigDecimalE02RODODY().intValue()) + "</TD>");
					myRow.append("<TD NOWRAP ALIGN=CENTER>" +  Util.formatCustomDate(user.getE01DTF(),
																	msgList.getBigDecimalE02RODMDM().intValue(),
																	msgList.getBigDecimalE02RODMDD().intValue(),
																	msgList.getBigDecimalE02RODMDY().intValue()) + "</TD>");
		...
		if (newmessage.getFormatName().equals("ELEERR")) {
			...
			while (true) {
				...
				if (marker.equals("*")) {
					...
					myRow.append("<TD NOWRAP><A HREF=\"javascript:goCollBasic('" + ref + "')\">" + Util.formatCustomDate(user.getE01DTF(),
																										msgList.getBigDecimalE04ROCMTM().intValue(),
																										msgList.getBigDecimalE04ROCMTD().intValue(),
																										msgList.getBigDecimalE04ROCMTY().intValue()) + "</A></TD>");
