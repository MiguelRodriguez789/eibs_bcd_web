					...
					while (true) {
						...
						if (marker.equals("*")) {
							...
							if ( typeRt.equals("1") )
							      ...
							      typeFL="Nominal";
							modoRt= msgList.getE01PRRMOD();
							if ( modoRt.equals("P") )
							      modoFL="Anticipado";
							else if ( modoRt.equals("S") )
							      modoFL="Vencido";
							      
      						myRow.append("<TD NOWRAP  ALIGN=CENTER width=\"5%\"><input type=\"radio\" name=\"TBL\" value=\""
							...
							+ "')\"></TD>");
							//table
							myRow.append("<TD NOWRAP  ALIGN=CENTER width=\"5%\">" + msgList.getE01PRRTBL() + "</td>");
							//description
							myRow.append("<TD NOWRAP  ALIGN=LEFT width=\"20%\">" + msgList.getE01PRRNME() + "</td>");
							//only for leader
							if (!msgList.getE01PRRTSL().equals("")) {
								//initial value
								myRow.append("<TD NOWRAP  ALIGN=center width=\"10%\">" + msgList.getE01PRRTFR() + "</td>");
								//final value
								myRow.append("<TD NOWRAP  ALIGN=center width=\"10%\">" + msgList.getE01PRRTTO() + "</td>");
							}
							//type
							myRow.append("<TD NOWRAP  ALIGN=center width=\"7%\">" + typeFL + "</td>");
							typeRt= "";
							typeFL= "";							
							//type
							myRow.append("<TD NOWRAP  ALIGN=center width=\"7%\">" + modoFL + "</td>");
							modoRt= "";
							modoFL= "";							
							myRow.append("<TD NOWRAP  ALIGN=center width=\"5%\">" + msgList.getE01PRRPER() + "</td>");
							myRow.append("<TD NOWRAP  ALIGN=center width=\"5%\">" + msgList.getE01PRRBAS() + "</td>");
							// primary rate  
							myRow.append("<TD NOWRAP  ALIGN=right width=\"10%\">" + msgList.getE01PRRPRT() + "</td>");	
		                    // secondary rate  
						    myRow.append("<TD NOWRAP  ALIGN=right width=\"10%\">" + msgList.getE01PRRSRT() + "</td>");		
		                    // Effective Annual Rate  
						    myRow.append("<TD NOWRAP  ALIGN=right width=\"10%\">" + msgList.getE01PRRTEA()+ "</td>");						
							// date
							myRow.append("<TD NOWRAP  ALIGN=center width=\"10%\">" + Util.formatCustomDate(user.getE01DTF(),
																							msgList.getBigDecimalE01PRREFM().intValue(),
																							msgList.getBigDecimalE01PRREFD().intValue(), 
																							msgList.getBigDecimalE01PRREFY().intValue())  + "</td>");	 							
							// status
							myRow.append("<TD NOWRAP  ALIGN=center width=\"10%\">" + msgList.getE01DSCRTY() + "</td>");	
							// user
							myRow.append("<TD NOWRAP  ALIGN=center width=\"10%\">" + msgList.getE01PRRUSR() + "</td>");
							myRow.append("</TR>");
		...
		try {
			...
			try
			{
				flexLog("Opennig Socket Connection");
			  	mc = new MessageContext(super.getMessageHandler("EDL1110", req));
