	...
	try
	{
		...
		try{
			...
			try{
				...
				msgEX.setE01LDERM1(req.getParameter("E01LDERM1"));
				msgEX.setE01LDERM2(req.getParameter("E01LDERM2"));
				msgEX.setE01LDERM3(req.getParameter("E01LDERM3"));
				msgEX.setE01LDERM4(req.getParameter("E01LDERM4"));
			}
			catch (Exception e){
			}
		}
	...
	if (session == null) {
		...
		try {
			...
			try
			{
				...
				mc = new MessageContext(super.getMessageHandler("ELD0010", req));
