					...
					while (true) {
							...
							if(msgList.getEWDRPR().equals("R")){
							   ...
							   Stat ="Pending";
								...
								myRow.append("<TD width=\"2%\" ALIGN=\"CENTER\" NOWRAP><input type=\"radio\" name=\"REFNUM\" value=\"" + msgList.getEWDNUM() + "\"></TD>");
								chkOfac = (msgList.getH01WK3().equals("3") ? "<a href=\"javascript:showInqOFAC('" + msgList.getEWDNUM() + "')\"><img src=\"../images/warning_16.jpg\" title=\"OFAC Match List\" align=\"absmiddle\" border=\"0\" ></a>" : "");
								chkWarn = (msgList.getH01WK2().equals("A") ? "<a href=\"javascript:showInqWarn('" + msgList.getEWDNUM() + "')\"><img src=\"../images/warning01.gif\" title=\"Warnings\" align=\"absmiddle\" border=\"0\" ></a>" : "");
								myRow.append("<TD width=\"5%\" NOWRAP  ALIGN=\"CENTER\"><A HREF=\"javascript:showSwift('" + msgList.getEWDNUM() + "')\">"  + msgList.getEWDNUM() + "</A></TD>");
								myRow.append("<TD width=\"5%\" NOWRAP  ALIGN=\"CENTER\"><A HREF=\"javascript:showSwift('" + msgList.getEWDNUM() + "')\">"  + msgList.getEWDTPE() + "</A></TD>");							
								myRow.append("<TD width=\"5%\" NOWRAP  ALIGN=\"CENTER\"><A HREF=\"javascript:showSwift('" + msgList.getEWDNUM() + "')\">"  + Stat + "</A></TD>");								
								myRow.append("<TD width=\"40%\" NOWRAP  ALIGN=\"CENTER\"><A HREF=\"javascript:showSwift('" + msgList.getEWDNUM() + "')\">"    + msgList.getEWDORC() + "</A></TD>");
								myRow.append("<TD width=\"10%\" NOWRAP  ALIGN=\"CENTER\"><A HREF=\"javascript:showSwift('" + msgList.getEWDNUM() + "')\">"  + Util.formatDate(msgList.getEWDVD1(),msgList.getEWDVD2(),msgList.getEWDVD3())  + "</A></TD>");																						
								myRow.append("<TD width=\"10%\" NOWRAP  ALIGN=\"CENTER\"><A HREF=\"javascript:showSwift('" + msgList.getEWDNUM() + "')\">"   + Util.fcolorCCY(msgList.getEWDAMT()) + ":" + msgList.getEWDTCY() + "</A></TD>");
								myRow.append("<TD width=\"23%\" NOWRAP  ALIGN=\"CENTER\"><A HREF=\"javascript:showSwift('" + msgList.getEWDNUM() + "')\">"    + msgList.getEWDBNF() + "</A></TD>");
								myRow.append("</TR>");
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					mc = new MessageContext(super.getMessageHandler("EWD0341", req));
