...
public class MessageContextHandler {
	...
	private final static Logger log = Logger.getLogger(MessageContextHandler.class.getName());	
  ...
  */
	public ELEERRMessage receiveErrorMessage()
		...
		try {
			...
			throw new RuntimeException("Socket Communication Error",e);
		}
		return result;
	}
  ...
  */
	public MessageRecord receiveMessage() throws IOException {
		...
		log(result.getFormatName() + "Message received.");
	...
	private JBObjList receiveMessageList(
		...
		while ((size == 0 ? true : counter-- > 0 )) {
			...
			if (newmessage.getFormatName().equals(formatname)) {
				...
				marker = newmessage.getField(controlField).toString();
				if (firstTime) {
					firstTime = false;
  ...
  */
   ...
   */
	...
	private void showERROR(ELEERRMessage m) {
		log("ERROR received.");
		log("ERROR number:" + m.getERRNUM());
		log("ERR001 = " + m.getERNU01() + " desc: " + m.getERDS01());
		log("ERR002 = " + m.getERNU02() + " desc: " + m.getERDS02());
		log("ERR003 = " + m.getERNU03() + " desc: " + m.getERDS03());
		log("ERR004 = " + m.getERNU04() + " desc: " + m.getERDS04());
		log("ERR005 = " + m.getERNU05() + " desc: " + m.getERDS05());
		log("ERR006 = " + m.getERNU06() + " desc: " + m.getERDS06());
		log("ERR007 = " + m.getERNU07() + " desc: " + m.getERDS07());
		log("ERR008 = " + m.getERNU08() + " desc: " + m.getERDS08());
		log("ERR009 = " + m.getERNU09() + " desc: " + m.getERDS09());
		log("ERR010 = " + m.getERNU10() + " desc: " + m.getERDS10());
	}
