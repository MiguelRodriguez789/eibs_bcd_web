...
// $Id: XMLReaderFactory.java,v 1.2 2017/05/26 22:13:23 ccastillo Exp $
 ...
 * on the value of the <code>datapro.org.xml.sax.driver</code> system 
 * property:</p>
 *
 * <pre>
 * try {
...
final public class XMLReaderFactory
{
	 ...
	 * "datapro.org.xml.sax.driver" as the full name of a Java class
	 ...
	 * @exception datapro.org.xml.sax.SAXException If the value of the
	 *            "datapro.org.xml.sax.driver" system property is null,
	...
	throws SAXException
	{
	String className = System.getProperty("datapro.org.xml.sax.driver");
	if (className == null) {
	    Parser parser;
	    try {
	    ...
	    if (parser == null) {
		throw new
		    SAXException("System property datapro.org.xml.sax.driver not specified");
	    } else {
	 ...
	 * @exception datapro.org.xml.sax.SAXException If the class cannot be
