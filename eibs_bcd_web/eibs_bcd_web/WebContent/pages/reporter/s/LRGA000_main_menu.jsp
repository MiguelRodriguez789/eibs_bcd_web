...
<div style="width:100%;" align="center">
	...
	<h4>Seleccione una opci&oacute;n</h4>	
        <a href="<%=request.getContextPath()%>/servlet/com.datapro.eibs.reporter.controller.JSLRGA200?SCREEN=10">1. M&oacute;dulos</a><br><br>
        <a href="<%=request.getContextPath()%>/servlet/com.datapro.eibs.reporter.controller.JSLRGA300?SCREEN=10">2. Reportes</a><br><br>
       <!-- <a href="<%=request.getContextPath()%>/servlet/com.datapro.eibs.reporter.controller.JSLRG0001?SCREEN=10">3. Seguridad de Accesos</a><br><br> -->
        <a href="<%=request.getContextPath()%>/servlet/com.datapro.eibs.reporter.controller.JSLRGA400?SCREEN=10">3. Par&aacute;metros Generales.</a><br> 
	</div>
</div>
<br><br>
