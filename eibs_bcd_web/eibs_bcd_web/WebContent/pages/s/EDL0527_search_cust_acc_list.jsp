...
<jsp:useBean id="EDL0527List" class="datapro.eibs.beans.JBObjList"
	scope="session" />
...
<h3 align="center">Consulta de Calificaci&oacute;n de Provisi&oacute;n<img
	...
	name="EIBS_GIF" title="search_cust_acc_list.jsp, EDL0527"></h3>
<hr size="4">
		...
		<table id="headTable" width="100%">
			...
			<%
					...
					chk = "";
						...
						datapro.eibs.beans.EDL052701Message msgList = (datapro.eibs.beans.EDL052701Message) EDL0527List
						.getRecord();
			%>
			<tr>
				<td NOWRAP align=CENTER width="10%"><INPUT TYPE="radio"
					name="ROW" value="<%=EDL0527List.getCurrentRow()%>"></td>
