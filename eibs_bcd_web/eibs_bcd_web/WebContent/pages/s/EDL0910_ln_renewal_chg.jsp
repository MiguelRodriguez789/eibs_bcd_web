...
<SCRIPT type="text/javascript">
 ...
 function updateTotal() { 
  ...
  if ( coll.length > 1 ) {
   for (var i=0; i< coll.length;i++) {      
     try{
      	tmpVal= parseFloat((coll[i].value));
      	if (isNaN(tmpVal)) {
      	  tmpVal= 0.00;
      	  coll[i].value = "0.00";
      	 }
     ...
     try{
      	totalVal= parseFloat((coll.value));
...
<H3 align="center">Pago de <%= title %> <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_renewal_chg.jsp, EDL0910"> 
</H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"><INPUT type="text" size="13" maxlength="12" name="E01DEAACC" value="<%= lnRenew.getE01DEAACC().trim()%>" readonly> </div>
            </td>
            <td nowrap width="16%" > 
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap  width="60%" align=center> 
              <input type="text" name="E01PAMT<%= field%>" id="<%= typ%>" size="16" maxlength="16" value="" onkeypress="enterDecimal(event, 2)" onchange="updateTotal()"> 
            </td>
          </tr>
		  <% }
		  } %>
