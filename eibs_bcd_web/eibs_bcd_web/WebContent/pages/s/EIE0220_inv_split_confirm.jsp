...
%>
<div align="center"> 
  <h3>Confirmaci&oacute;n del Split <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_split_confirm.jsp,EIE0220"> 
  </h3>
</div>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap width="17%" > 
              <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].E01ISIIIC.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" title="help" align="bottom" border="0" > 
                Instrumento </a> :</div>
            </td>
            <td nowrap width="36%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" > 
              <input type="text" name="E01SCRFAC"  size="11" maxlength="10" value="<%= invSplit.getE01SCRFAC()%>" readonly>
            </td>
          </tr>
        </table>
      </td>
