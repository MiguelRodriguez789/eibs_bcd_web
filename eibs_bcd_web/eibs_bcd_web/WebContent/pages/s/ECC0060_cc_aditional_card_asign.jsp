...
<BR>Adicionar
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_aditional_card_assign.jsp,ECC0060"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="16%"> 
              <div align="left">
                <input type="text" name="E01CCRNUM" size="21" maxlength="20" value="<%= msgCard.getE01CCRNUM().trim()%>" onKeypress="enterInteger(event)">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0" align="center" >
           <tr id="trdark"> 
            <TD nowrap width="25%"> 
              ...
              <INPUT type="text" name="E01CCREXM" size="3" maxlength="2" value="<%= msgCard.getE01CCREXM().trim()%>" onkeypress="enterInteger(event)">
              <INPUT type="text" name="E01CCREXY" size="6" maxlength="4" value="<%= msgCard.getE01CCREXY().trim()%>" onkeypress="enterInteger(event)">
            ...
            <td nowrap width="27%"> 
            	<eibsinput:date name="msgCard" fn_month="E01CCRISM" fn_day="E01CCRISD" fn_year="E01CCRISY" />
  			</td>
          </tr>                                                                                           
        </table>
      </td>
