...
<BODY>
<h3 align="center">Asignar Recaudo Documentos por Producto <br>
	<span style="font-style: italic;"> <%= userPO.getHeader9().trim() + "/" +  userPO.getHeader10().trim() + "/" +  userPO.getHeader11().trim()%> </span>
