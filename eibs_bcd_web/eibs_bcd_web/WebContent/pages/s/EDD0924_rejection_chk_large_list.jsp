...
function OkComments(){
	...
	getElement("REMDATA"+idxRow).value = trim(document.forms[0].txtComments.value);
...
function addComments() {
     ...
     Comments.filters[0].Play();
     document.forms[0].txtComments.value=getElement("REMDATA"+idxRow).value;
...
addEventHandler(document, 'click', closeSearch);
...
<h3 align="center">Devolución de Cheques<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rejection_chk_large_list.jsp,EDD0924"></h3>
<hr size="4">
