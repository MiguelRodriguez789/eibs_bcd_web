...
function enter(){
	...
	var FromRecord = 0
	parent.results.window.location.href="<%=request.getContextPath()%>/pages/s/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0030?NameSearch=" + NameSearch + "@FromRecord=" + FromRecord + "'";
}
</SCRIPT>
</HEAD>
<BODY>
<FORM Action="javascript:enter()">
  ...
  <TABLE  id="tbhelp" align="center" width="447" border="0" cellspacing="0" cellpadding="0">
    <TR> 
      <Td align="CENTER">
        <p><b>B&uacute;squeda de Proveedor</b></p>
      </Td>
    </TR>
    <TR>
      <TD align="CENTER">&nbsp;</TD>
