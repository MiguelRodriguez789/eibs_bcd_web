      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="14%" > 
              <div align="right">V&iacute;a Conformaci&oacute;n Orden :</div>
            </td>
            <td nowrap width="33%" > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap colspan="4" > 
              <div align="left"><b>Saldo Fecha Efectiva</b></div>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap > 
              <div align="center"> 
                <select disabled  name="E01ORDCPT">
                  <option value="" <%if (invTrade.getE01ORDCPT().equals("")) { out.print("selected"); }%>>Ninguna</option>
