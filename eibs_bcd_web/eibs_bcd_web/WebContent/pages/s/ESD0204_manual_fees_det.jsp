...
<H3 align="center">Cobro de Comisiones Manuales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="manual_fees_det.jsp , ESD0204"> 
</H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap width="60%"> 
    	        <eibsinput:date name="refCode" fn_year="E01CACRDY" fn_month="E01CACRDM" fn_day="E01CACRDD" readonly="false" />
            </td>
          </tr>
          ...
          <div align="right">Número de Transacciones :</div>
            ...
            <td nowrap width="60%"> 
	          <div align="left"> 
	            <input type="text" name="E01CACNTE" size="6" maxlength="5"  value="<%=refCode.getE01CACNTE().trim()%>"  onKeypress="enterInteger(event)">
	          </div>
            </td>
          </tr>
