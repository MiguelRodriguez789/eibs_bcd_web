...
<jsp:useBean id= "recW4" class= "datapro.eibs.beans.ERA009004Message"  scope="session"/>
...
<%
	...
	String curname = currClient != null ? currClient.getE01CUSNA1()
			.trim() : "";
	String iopecod = recW4 != null ? recW4.getH04OPECOD().trim() : "";
	String oopecod = "";
...
<h3 align="center">Mantenimiento Registro Tabla Garantias Obligación para Interface a CREDISMART 
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="file_listW4,ERA0090"></h3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSERA0090">
  <p> 
    ...
    <INPUT TYPE=HIDDEN NAME="SCREEN" id="SCREEN" VALUE="104">
...
<table class="tableinfo">
    <tr > 
      ...
      <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap >
             <eibsinput:text name="recW4" property="E04RW2REF" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_ACCOUNT%>" required="false" readonly="true"/>
            </td>
            <td nowrap >
            </td>
            <td nowrap >
       ...
       <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap >
             <eibsinput:text name="recW4" property="E04RW2ACC" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CARD_NUMBER%>" required="false" readonly="<%=b_read_only1%>"/>
            </td>
            <td nowrap >
              <div align="right">Número de Cliente : </div>
            </td>
            <td nowrap >
             <eibsinput:text name="recW4" property="E04RW2CUN" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_ACCOUNT%>" required="false" readonly="<%=b_read_only1%>"/>
           </td>
       </tr>
       <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap >
            ...
            <td nowrap >
             <eibsinput:text name="recW4" property="E04RW2TID" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_PO_BOX%>" required="false" readonly="<%=b_read_only1%>"/>
           </td>
            <td nowrap >
              <div align="right">Número de Identificación : </div>
            </td>
            <td nowrap >
             <eibsinput:text name="recW4" property="E04RW2IDN" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CUSTOMER%>" required="false" readonly="<%=b_read_only1%>"/>
            </td>
       </tr>
       <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap >
            ...
            <td nowrap >
             <eibsinput:text name="recW4" property="D04RW2NM1" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_DESCRIPTION%>" required="false" readonly="true"/>
            </td>
            <td nowrap >
            </td>
            <td nowrap >
