...
<html>
<head>
<title>Carga de Camara Entrante</title>
...
%> 
<h3 align="center">Carga de C&aacute;mara Entrante
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="enter_cleaning_load, EDD0931"></h3> 
<hr size="4">
 <form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cleaning.JSEDD0931" >
