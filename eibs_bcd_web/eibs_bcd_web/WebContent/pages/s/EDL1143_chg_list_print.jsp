...
%>
  <h3 align="center">Reportes Préstamos Preferenciales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chg_list_print.jsp,EDL1143"> 
  </h3>
  <hr size="4">
  <p>&nbsp;</p>
