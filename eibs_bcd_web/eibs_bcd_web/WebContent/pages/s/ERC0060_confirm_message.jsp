		...
		<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSERC0060?SCREEN=700" >
		  ...
		  <table class="tableinfo">
			  <tr>
			  	...
			  	<td align="center"> 
		    		<input align="middle" id="EIBSBTN" type=submit name="cancel" value="Cancelar" onclick="cerrarse1()">
		  		</td>
		  		<td width="192" align="center"> 
		    		<input  align="middle" id="EIBSBTN" onclick="cerrarse()" type=submit name="accept" value="Aceptar" <%if(ok.trim().equals("Nook")){%> disabled <%}%>>
		  		</td>
