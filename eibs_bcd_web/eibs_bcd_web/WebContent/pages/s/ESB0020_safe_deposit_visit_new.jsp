...
<H3 align="center">Consulta Log Caja de Seguridad<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="safe_deposit_visit_new, ESB0020"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trdark> 
            <td nowrap width="17%" >
              ...
              <td nowrap > 
                <div align="left"> 
                  <input type="text" name="E01SBLVD1" size="2" maxlength="2" value="<%= msgPart.getE01SBLVD1().trim()%>" onkeypress="enterInteger(event)">
                  <input type="text" name="E01SBLVD2" size="2" maxlength="2" value="<%= msgPart.getE01SBLVD2().trim()%>" onkeypress="enterInteger(event)">
                  <input type="text" name="E01SBLVD3" size="4" maxlength="5" value="<%= msgPart.getE01SBLVD3().trim()%>" onkeypress="enterInteger(event)">
                  <a href="javascript:DatePicker(document.forms[0].E01SBLVD1,document.forms[0].E01SBLVD2,document.forms[0].E01SBLVD3)">
     	...
     	<tr id=trclear> 
            <td nowrap width="17%" >
              ...
              <td nowrap > 
                <div align="left"> 
                  <input type="text" name="E01SBLITH" size="2" maxlength="2" value="<%= msgPart.getE01SBLITH().trim()%>" onkeypress="enterInteger(event)"> : 
                  <input type="text" name="E01SBLITM" size="2" maxlength="2" value="<%= msgPart.getE01SBLITM().trim()%>" onkeypress="enterInteger(event)"> : 
                  <input type="text" name="E01SBLITS" size="2" maxlength="2" value="<%= msgPart.getE01SBLITS().trim()%>" onkeypress="enterInteger(event)"> 
                  <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0" > 
                </div>                
              </td>
			</tr>
     	<tr id=trdark> 
            <td nowrap width="17%" >
              ...
              <td nowrap > 
                <div align="left"> 
                  <input type="text" name="E01SBLOTH" size="2" maxlength="2" value="<%= msgPart.getE01SBLOTH().trim()%>" onkeypress="enterInteger(event)"> : 
                  <input type="text" name="E01SBLOTM" size="2" maxlength="2" value="<%= msgPart.getE01SBLOTM().trim()%>" onkeypress="enterInteger(event)"> : 
                  <input type="text" name="E01SBLOTS" size="2" maxlength="2" value="<%= msgPart.getE01SBLOTS().trim()%>" onkeypress="enterInteger(event)"> 
                </div>
              </td>
			</tr>			
     	<tr id=trclear> 
