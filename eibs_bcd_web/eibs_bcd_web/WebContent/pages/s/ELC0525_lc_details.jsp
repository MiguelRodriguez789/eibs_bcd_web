          ...
          <TR id="trdark">
			...
			<TR id="trdark">
		     ...
		     <TR id="trclear">
				  ...
				  <TD align="right" nowrap>Código T&eacute;rmino: </TD>
				  <TD align="left" nowrap>
				  <SELECT name="E02LCMTRC" disabled >
			                		...
			                		<OPTION value="BE" <% if (msg050002.getE02LCMTRC().equals("BE")) out.println("selected"); %>>Después de Fecha de Letra de Cambio</OPTION>
		                			<OPTION value="BL" <% if (msg050002.getE02LCMTRC().equals("BL")) out.println("selected"); %>>Después de Fecha de Embarque</OPTION>
		                			<OPTION value="CC" <% if (msg050002.getE02LCMTRC().equals("CC")) out.println("selected"); %>>Después de Pase de Mercancía por Aduana</OPTION>
				                 	<OPTION value="FD" <% if (msg050002.getE02LCMTRC().equals("FD")) out.println("selected"); %>>Después de Pase de Mercancía por Revisión</OPTION>
			                		<OPTION value="FP" <% if (msg050002.getE02LCMTRC().equals("FP")) out.println("selected"); %>>Primera Presentación</OPTION>
			                		<OPTION value="GA" <% if (msg050002.getE02LCMTRC().equals("GA")) out.println("selected"); %>>Después de Arribo de Mercancía</OPTION>
			                		<OPTION value="ID" <% if (msg050002.getE02LCMTRC().equals("ID")) out.println("selected"); %>>Después de Fecha de Factura</OPTION>
				                	<OPTION value="ST" <% if (msg050002.getE02LCMTRC().equals("ST")) out.println("selected"); %>>Después de Entregado</OPTION>
					                <OPTION value="TD" <% if (msg050002.getE02LCMTRC().equals("TD")) out.println("selected"); %>>Después de Fecha de Doc. de Transporte</OPTION>
			                    </SELECT>
				</TD>
		     	</TR>
