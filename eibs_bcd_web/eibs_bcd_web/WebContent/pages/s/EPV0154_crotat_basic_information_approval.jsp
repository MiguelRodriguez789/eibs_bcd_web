...
<html>
<head>
<title> Cupo Rotativo Basic Information for Inquiry,Maint,and Creation </title>
...
<h3 align="center">
 ...
 <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="crotat_basic_information_approval.jsp, EPV0154"></h3>
<hr size="4">
 ...
 <table class=tbenter>
		<tr > 
			...
			<td nowrap align=left> 
				...
				<% if (RecData.getE01COLATR().trim().equals("") )
				   out.print("SIN GARANTIA");
				   else
				   out.print(RecData.getE01COLATR());
				%></font>
				</b>
			</td>
			<td nowrap align=left> 
				<b>CONDICION CREDITICIA :</b>
				<b><font color="#ff6600"><%= RecData.getE01CONDSC().trim()%></font></b>
			</td>
			<td nowrap align=left> 
				<b>ESTADO :</b>
				<b><font color="#ff6600"><%= RecData.getE01STATUS().trim()%></font></b>
			</td>
		</tr>
	</table>
			...
			<td nowrap> 
				<table cellpadding=2 cellspacing=0 width="100%" border="0">
					...
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
						...
						<td nowrap width="25%" > 
							<select name="E01DEAF01" disabled >
								<OPTION value=" " <% if (!(RecData.getE01DEAF01().equals("1") ||RecData.getE01DEAF01().equals("2")||RecData.getE01DEAF01().equals("3"))) out.print("selected");;%>></OPTION>
								...
								<OPTION value="3" <% if(RecData.getE01DEAF01().equals("3")) out.print("selected");%>>Ambos</OPTION>
							</select>
						</td>
					</tr>
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
			...
			<td nowrap > 
				<table id="tableSelect" cellspacing=0 cellpadding=2 width="100%" border="0">
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
						<td nowrap width="14%"  > 
							<div align="center"> 
								<select id="E01DEAPP1" name="E01DEAPP1" disabled="disabled">
									<option value=" " selected> &nbsp; </option>
						...
						<td nowrap width="12%"  > 
							<div align="center"> 
								<select id="E01DEAPP2" name="E01DEAPP2" disabled="disabled">
									<option value=" " selected> &nbsp; </option>
						...
						<td nowrap width="12%" > 
							<div align="center"> 
								<select id="E01DEAPP3" name="E01DEAPP3" disabled="disabled">
									<option value=" " selected> &nbsp; </option>
						...
						<td nowrap width="12%" > 
							<div align="center"> 
								<select id="E01DEAPP4" name="E01DEAPP4" disabled="disabled">
									<option value=" " selected> &nbsp; </option>
						...
						<td nowrap width="12%" > 
							<div align="center"> 
								<select id="E01DEAPP5" name="E01DEAPP5" disabled="disabled">
									<option value=" " selected> &nbsp; </option>
						...
						<td nowrap width="12%"  > 
							<div align="center">
								<select id="E01DEAPP6" name="E01DEAPP6" disabled="disabled">
									<option value=" " selected> &nbsp; </option>
			 			...
			 			<% if(currUser.getE01INT().equals("07")) { %> 
							<td nowrap width="12%"  > 
								<div align="center">
									<select id="E01DEAPP7" name="E01DEAPP7" disabled="disabled">
										<option value=" " selected> &nbsp; </option>
						...
						<td nowrap width="12%"  > 
							<div align="center"> 
								<select id="E01DEAPP8" name="E01DEAPP8" disabled="disabled">
									<option value=" " selected> &nbsp; </option>
	...
	<br>
	<!-- Condiciones cupos -->
	<% session.setAttribute("EMPCU","A"); %>
	<iframe frameborder="0" scrolling="no" style="height: 200px;" width="100%" src="<%=request.getContextPath()%>/servlet/datapro.eibs.salesplatform.JSEPV1166?SCREEN=101&appType=CP&E01TYPCUN=<%=RecData.getE01DEACUN()%>&E01TYPNUM=<%=RecData.getE01DEAOFN()%>"> </iframe>
