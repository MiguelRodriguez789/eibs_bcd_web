...
<SCRIPT type="text/javascript">
  ...
  addEventHandler(document, 'click' , closeEnterGroup);
...
<body>
<h3 align="center"> Listado Grupo/Usuarios <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="maint, GroupProfile"></h3>
<hr size="4">
<form>
