...
<H3 align="center">Otras Inscripciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_detail_inquiry.jsp , ERA0011"></H3> 
<hr size="4">
    		...
    		<tr > 
      			<td nowrap> 
        			<table width="100%" border="0">          
            				...
            				<td nowrap > 
				                <eibsinput:date name="collDet" fn_year="E02RODODY" fn_month="E02RODODM" fn_day="E02RODODD" readonly="TRUE" />
            				</td>
					...
					<% } else { %>
         			...
         			<% if (userPO.getType().equals("03")) { %>
           				<tr id="trclear"> 
            				...
            				<td nowrap >               
				                <eibsinput:date name="collDet" fn_year="E02RODPDY" fn_month="E02RODPDM" fn_day="E02RODPDD" readonly="TRUE" />
            				</td>
            				<td nowrap ><div align="right">Fecha Notificación :</div></td>
            				<td nowrap >          
				                <eibsinput:date name="collDet" fn_year="E02RODNDY" fn_month="E02RODNDM" fn_day="E02RODNDD" readonly="TRUE" />
            				</td>
          				</tr>
         			<% } %>
   					</table>
