...
%>    
	window.location.href="<%=request.getContextPath()%>/pages/s/EDD0930_cleaning_applay_list.jsp";
<%
	} 
%>    
  }
...
<h3 align="center">Aplicación de Camara Entrante
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cleaning_applay_confirm, EDD0930"></h3> 
<hr size="4">
 <form method="post">
