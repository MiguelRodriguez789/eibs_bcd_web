...
<body>
<%String title = "";
	if("45".equals(msg01.getE01LCYACD())) {
		title += "Garantias Navieras ";
	}

	if("N".equals(msg01.getE01LCYTYP())){
		title += "Navieras ";
	} 
...
<param name="show_values_on_top_of_bars">
				...
				<%i++;%>			
				<param name="description_1" value="Pagos ACP">
				<param name="val_1" value="<%=msg01.getBigDecimalE01LCYOPT()%>">
				
			
				<%i++;%>
				<param name="description_2" value="Pagos Varios">
				<param name="val_2" value="<%=msg01.getBigDecimalE01LCYPYT()%>">
							
				<%i++;%>
				<param name="description_3" value="Garantias Bancarias">
...
msg01.getBigDecimalE01LCYCAA())).toString())%>
</b></u>
