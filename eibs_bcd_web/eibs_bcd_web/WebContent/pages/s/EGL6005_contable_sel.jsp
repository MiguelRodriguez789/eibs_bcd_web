...
<H3 align="center">Reproducci&oacute;n Estados Financieros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="products,EGL6005"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trdark> 	      
	      ...
	      <td width="50%">  
            <input type="text" name="E01ANOREP" size="5" maxlength="4"  value="<%= msgMT.getE01ANOREP()%>">
          </td>
     	</tr>
     	<tr id=trclear> 
		  <td> 
