...
<body>
<h3 align="center"><%= dcNew.getE01DCMOPT().equals("N")?"Apertura":"Mantenimiento" %> de Cobranza Documentaria<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dc_opening.jsp, EDC0000"></h3>
<hr size="4">
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trclear">
				...
				<td>
					<div align="left">
						<input type="text" name="E01DCMDR1" size="45" maxlength="45" value="<%=dcNew.getE01DCMDR1()%>">
			...
			<tr id="trdark">
				...
				<td>
					<div align="left">
						<input type="text" name="E01DCMDR2" size="45" maxlength="45" value="<%=dcNew.getE01DCMDR2()%>">
					</div>
				</td>
			</tr>
			<tr id="trclear">
				...
				<td>
					<div align="left">
						<input type="text" name="E01DCMDR3" size="45" maxlength="45" value="<%=dcNew.getE01DCMDR3()%>">
					</div>
				</td>
			</tr>
			<tr id="trdark">
				...
				<td>
					<div align="left">
						<input type="text" name="E01DCMDR4" size="45" maxlength="45" value="<%=dcNew.getE01DCMDR4()%>">
					</div>
				</td>
			</tr>
			<tr id="trclear">
			...
			<TBODY><TR id="trdark">
			  ...
			  <TR id="trclear">
			    ...
			    <TD align="left" nowrap><INPUT type="text" name="E01DCMRBI" size="14" maxlength="12" value="<%=dcNew.getE01DCMRBI()%>">
			      <A href="javascript:GetSwiftIdDesc('E01DCMRBI','','','')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"  border="0"></A> </TD>
			  </TR>
			<TR id="trdark">
				<TD>
					<DIV align="right">Nombre :</DIV>
			...
			<tr id="trdark">
				...
				<table border="0" cellspacing="0">
					<tr id="trdark">
						...
						<td>
							...
							<img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." onclick="javascript: document.forms[0].E01DCMAF4.selectedIndex = 1" border="0"></a> Cliente o
							<a href="javascript: GetAccByClient('E01DCMCLA','','RT','','E01DCMCL1')">
							<img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." onclick="javascript: document.forms[0].E01DCMAF4.selectedIndex = 2" border="0"></a> Cuenta
						</td>
					</tr>
				</table>
				</td>
			  ...
			  <TR id="trclear">
			    ...
			    <TD align="left" nowrap><INPUT type="text" name="E01DCMCLI" size="14" maxlength="12" value="<%=dcNew.getE01DCMCLI()%>">
			      <A href="javascript:GetSwiftIdDesc('E01DCMCLI','','','')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"  border="0"></A> </TD>
			  </TR>
			<tr id="trdark">
				<td>
					<div align="right">Nombre :</div>
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="20%">
				<eibsinput:date name="dcNew" fn_month="E01DCMMAM" fn_day="E01DCMMAD" fn_year="E01DCMMAY" required="true"/>				           
			</td>
			<td nowrap width="30%">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="20%">
            	<eibsinput:date name="dcNew" fn_month="E01DCMRMM" fn_day="E01DCMRMD" fn_year="E01DCMRMY" />
			</td>
			<td nowrap width="30%">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="20%">
            	<eibsinput:date name="dcNew" fn_month="E01DCMAKM" fn_day="E01DCMAKD" fn_year="E01DCMAKY" />
			</td>
			<td nowrap width="30%">
             	<div align="right">Fecha de Aceptación :</div>
			</td>
            <td nowrap width="20%">
				<eibsinput:date name="dcNew" fn_month="E01DCMACM" fn_day="E01DCMACD" fn_year="E01DCMACY" />            
            </td>
          </tr>
        </table>
      </td>
        ...
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trdark">
            <TD nowrap width="30%">
			    ...
			    <INPUT type="text" name="E01DCMBRN" maxlength="5" size="4" value="<%= dcNew.getE01DCMBRN().trim()%>" readonly>
            	<% } else { %>	
            	<INPUT type="text" name="E01DCMBRN" maxlength="5" size="4" value="<%= dcNew.getE01DCMBRN().trim()%>">
            ...
            <TD nowrap width="30%">
            	...
            	<A href="javascript:GetCostCenter('E01DCMCCN',document.forms[0].E01DCMBNK.value)"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0"></A>
			</TD>
            </TR>
          <TR id="trclear">
            <TD nowrap width="30%">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="20%">
				<eibsinput:date name="dcNew" fn_month="E01DCMBDM" fn_day="E01DCMBDY" fn_year="E01DCMBDY" required="false" />
            </td>
          </tr>
		  <tr id="trclear">
            <td nowrap width="30%">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark">
            ...
            <td align="center"> <INPUT type="text" name="E01DCMDO1" maxlength="1" size="2" value="<%= dcNew.getE01DCMDO1() %>" onKeyPress="enterInteger(event)"></td>
            <td align="center"> <INPUT type="text" name="E01DCMDC1" maxlength="1" size="2" value="<%= dcNew.getE01DCMDC1() %>" onKeyPress="enterInteger(event)"></td>
            <td></td>
            ...
            <td align="center"> <INPUT type="text" name="E01DCMDO2" maxlength="1" size="2" value="<%= dcNew.getE01DCMDO2() %>" onKeyPress="enterInteger(event)"></td>
            <td align="center"> <INPUT type="text" name="E01DCMDC2" maxlength="1" size="2" value="<%= dcNew.getE01DCMDC2() %>" onKeyPress="enterInteger(event)"></td>
          </tr>
          <tr id="trclear">
            ...
            <td align="center"> <INPUT type="text" name="E01DCMDO3" maxlength="1" size="2" value="<%= dcNew.getE01DCMDO3() %>" onKeyPress="enterInteger(event)"></td>
            <td align="center"> <INPUT type="text" name="E01DCMDC3" maxlength="1" size="2" value="<%= dcNew.getE01DCMDC3() %>" onKeyPress="enterInteger(event)"></td>
            <td></td>
            ...
            <td align="center"> <INPUT type="text" name="E01DCMDO4" maxlength="1" size="2" value="<%= dcNew.getE01DCMDO4() %>" onKeyPress="enterInteger(event)"></td>
            <td align="center"> <INPUT type="text" name="E01DCMDC4" maxlength="1" size="2" value="<%= dcNew.getE01DCMDC4() %>" onKeyPress="enterInteger(event)"></td>
          </tr>
          <tr id="trdark">
            ...
            <td align="center"> <INPUT type="text" name="E01DCMDO5" maxlength="1" size="2" value="<%= dcNew.getE01DCMDO5() %>" onKeyPress="enterInteger(event)"></td>
            <td align="center"> <INPUT type="text" name="E01DCMDC5" maxlength="1" size="2" value="<%= dcNew.getE01DCMDC5() %>" onKeyPress="enterInteger(event)"></td>
            <td></td>
            ...
            <td align="center"> <INPUT type="text" name="E01DCMDO6" maxlength="1" size="2" value="<%= dcNew.getE01DCMDO6() %>" onKeyPress="enterInteger(event)"></td>
            <td align="center"> <INPUT type="text" name="E01DCMDC6" maxlength="1" size="2" value="<%= dcNew.getE01DCMDC6() %>" onKeyPress="enterInteger(event)"></td>
          </tr>
          <tr id="trclear">
            ...
            <td align="center"> <INPUT type="text" name="E01DCMDO7" maxlength="1" size="2" value="<%= dcNew.getE01DCMDO7() %>" onKeyPress="enterInteger(event)"></td>
            <td align="center"> <INPUT type="text" name="E01DCMDC7" maxlength="1" size="2" value="<%= dcNew.getE01DCMDC7() %>" onKeyPress="enterInteger(event)"></td>
            <td></td>
            ...
            <td align="center"> <INPUT type="text" name="E01DCMDO8" maxlength="1" size="2" value="<%= dcNew.getE01DCMDO8() %>" onKeyPress="enterInteger(event)"></td>
            <td align="center"> <INPUT type="text" name="E01DCMDC8" maxlength="1" size="2" value="<%= dcNew.getE01DCMDC8() %>" onKeyPress="enterInteger(event)"></td>
          </tr>
        </table>
      </td>
    </tr>
