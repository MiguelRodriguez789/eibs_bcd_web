...
<H3 align="center">Selección de Documentos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pay_enter,EDL0825"></H3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0825">
  ...
  <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
    ...
    <tr> 
      <td nowrap width="50%"> 
        <div align="right">Número de Identidad del Deudor : </div>
      </td>
      <td nowrap width="50%"> 
