...
<jsp:useBean id= "EDL0510msg" class= "datapro.eibs.beans.EDL051001Message"  scope="session"/>
...
%> 
<h3 align="center">Tablas de Estructuras de Prestamos
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_enter_sel_tables.jsp, EDL0510"></h3>
<hr size="4">
...
<table id="TBHELPN" width="100%" border="0" cellspacing="0"
	...
	<tr >
		...
		<td  width="50%" valign="top">
 			<eibsinput:text property="E01DLSBNK" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_BANK %>" /><br>
 		</td>
	</tr>	
	<tr >
		<td align="right" width="50%" nowrap><br>Tipo de Producto :&nbsp;<br>&nbsp;</td>
		<td  width="50%" >
	        <input type="text" name="E01DLSTYP" size=5 maxlength="4" value="<%=EDL0510msg.getE01DLSTYP()%>">
	        <a href="javascript:GetProductRates('E01DLSTYP','10')"> 
