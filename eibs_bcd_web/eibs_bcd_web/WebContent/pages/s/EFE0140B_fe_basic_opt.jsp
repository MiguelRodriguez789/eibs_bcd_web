...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_opt.jsp, EFE0140B"> 
<hr size="4">
          ...
          <tr id="trdark">
           ...
           <% if(fex.getH01FLGWK3().equals("N")){%>
             <td nowrap colspan="2" > 
              ...
              <a href="javascript:GetClassFex('E01WKFCLS','OPT','<%= fex.getE01WKFCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
             </td>
            <%} else {%>
