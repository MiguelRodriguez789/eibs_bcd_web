...
<BODY>
<h3 align="center">Consulta Solicitudes de Clientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="sol_request_list_view.jsp,EDD1500"> </h3> 
<hr size="4">
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0"
			...
			<tr id="trdark">
				...
				<div align="left"><font face="Arial"><font face="Arial"><font
					size="2"> <input type="text" name="E01REQNAM" size="45"
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      <td class=TDBKG width="33%"> 
        <div align="center" style="cursor:hand" ><a href="javascript:goAction(3)"><b>Consultar</b></a></div>
      </td>
	<td align="center" class="tdbkg" width="15%"><a
			href="javascript:goActionDocuments()"> <b>Formularios PDF</b> </a>
	</td>		        
      <td class=TDBKG width="33%"> 
        <div align="center"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Salir</b></a></div>
      </td>
        ...
        <table id="headTable" width="100%">
		 ...
		 %>
				<TR id="<%= valStyle %>">
					...
					<TD NOWRAP  ALIGN=CENTER width=\"10%\"><%= msgList.getE01REQNUM() %>
						<input type="hidden" name="REQ<%=EDD1500Help.getCurrentRow()%>" value="<%=msgList.getE01REQNUM()%>">
					</td>
