...
<h3 align="center">Mantenimiento de Banco Corresponsal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="correspondant_bank.jsp,ESD0010"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%" height="23">
              ...
              <a href="javascript:GetSwiftId('E01SIC')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="middle" border="0"></a> 
            </td>
            ...
            <td nowrap width="26%" height="23">
              ...
              <a href="javascript:GetFedId('E01ABC')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="middle" border="0"></a> 
            </td>
          </tr>
        </table>
      </td>
