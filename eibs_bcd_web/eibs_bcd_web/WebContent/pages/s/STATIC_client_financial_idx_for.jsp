...
<h3 align="center">Formulas de Calculo de Indices Financieros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_financial_idx_for.jsp,STATIC"></h3>
<hr size="4">
