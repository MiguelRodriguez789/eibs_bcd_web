...
<H3 align="center"><% if (!aba.getE01INSAB9().equals("") && !aba.getE01INSAB9().equals("0")) out.print("Mantenimiento de Número ABA");
  ...
  %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="aba_swift_basic.jsp, EDD6000"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="70%" >
           		...
           		<a href="javascript:GetCodeCNOFC('E01INSTAT', '27')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"	align="bottom" border="0"></a>
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="30%" >
            ...
            <td nowrap width="70%" >
           		<input type="text" name="E01INSPHN" size="18" maxlength="15" value="<%= aba.getE01INSPHN().trim()%>" >
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="30%" >
            ...
            <td nowrap width="70%" >
        		...
        		<a href="javascript:GetAccountInfo('E01MTAACC','','RA','','','D01MTANME','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="30%" >
            ...
            <td nowrap width="70%" >
            	...
            	<a href="javascript:GetLedger('E01MTAGLN','','','','D01MTAGLD')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
            </td>
          </tr>
		  ...
		  <% } else { %>
	          ...
	          <tr id="trclear">
	            ...
	            <td nowrap width="70%" >
	           		...
	           		<a href="javascript:GetSwiftId('E01INSCSI')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0"></a>
	            </td>
	          </tr>
