...
<SCRIPT type="text/javascript">
  ...
  function showTabB(index,name){  
  	for(var i=0;i<4;i++){
   		getElement("TabB"+i).className="tabnormal";
   		getElement("dataTabB"+i).style.display="none";
   	}
  
    getElement("TabB"+index).className="tabhighlight";  
  	getElement("dataTabB"+index).style.display="";
  	getElement(name).focus();
  }
...
<h3 align="center">Pago/Negociación de Cartas de Crédito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_negotiation_maint.jsp,ELC0560"></h3>
<hr size="4">
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			<TR id="trdark">
				...
				<td nowrap valign="top" height="24" width="284"><div align="left">
					<INPUT type="text" name="E01LCMCUN" size="20" maxlength="9" value="<%= msg01.getE01LCMCUN()%>"></div>
				</td>
				<td nowrap align="left" valign="top" height="24" width="56">Nombre:</td>
				<TD nowrap align="left" valign="top" height="24" width="231">
					<INPUT type="text" name="E01CUSNA1" size="46" maxlength="45" value="<%= msg01.getE01CUSNA1()%>">
				</TD>
			</TR>
			<TR id="trclear">
				<TD align="left" valign="top" height="24" width="128">Carta de Crédito:</TD>
				<TD nowrap valign="top" height="24" width="284">
					<INPUT type="text" name="E01LCRNUM" size="23" maxlength="12" value="<%= msg01.getE01LCRNUM()%>">
				</TD>
				<TD nowrap align="left" valign="top" height="24" width="56">Moneda:</TD>
				<TD nowrap align="left" valign="top" height="24" width="291">
					<INPUT type="text" name="E01LCMCCY" size="8" maxlength="3" value="<%= msg01.getE01LCMCCY()%>">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Producto: 
					<INPUT type="text" name="E01LCMPRO" size="8" maxlength="8" value="<%= msg01.getE01LCMPRO()%>">
				</TD>
			</TR>
			<TR id="trdark">
				<TD align="left" valign="top" height="29" width="128">Tipo de Negociación:</TD>
				<TD nowrap valign="top" height="29" width="284">
					<INPUT type="text" name="E01OPCODE" size="4" maxlength="1" value="<%= msg01.getE01OPCODE()%>"> 
					<INPUT type="text" name="E01OPCDSC" size="25" maxlength="25" value="<%= msg01.getE01OPCDSC()%>">
				</TD>
				<TD nowrap align="left" valign="top" height="29" width="56">Monto:</TD>
				<TD nowrap align="left" valign="top" height="29" width="291">
					<INPUT type="text" name="E01DRWAMN" size="26" maxlength="15" value="<%= msg01.getE01DRWAMN()%>">
				</TD>
			</TR>						
		</table>
		</td>
				...
				<TBODY>
					...
					<TR id="trclear">
						...
						<TD nowrap valign="top" height="24" align="center" width="61"><INPUT
							type="text" name="E01CUSBRN" size="6" maxlength="4"></TD>
			...
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
				<TBODY>
					...
					<TR id="trclear">
						...
						<TD nowrap valign="top" height="24" align="center" width="61"><INPUT
							type="text" name="E01PMTBRN" size="6" maxlength="4"></TD>
						<TD nowrap align="center" valign="top" height="24" width="47"><INPUT
