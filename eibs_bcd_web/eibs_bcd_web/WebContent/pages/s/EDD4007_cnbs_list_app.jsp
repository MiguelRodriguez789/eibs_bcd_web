...
function goApproval() {
    ...
    var pg = "";
	pg = "<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD4007?SCREEN=500&ROW="+row;  
...
<BODY>
<h3 align="center"> <%= title %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnbs_list_app.jsp, EDD4007"></h3>
<hr size="4">
