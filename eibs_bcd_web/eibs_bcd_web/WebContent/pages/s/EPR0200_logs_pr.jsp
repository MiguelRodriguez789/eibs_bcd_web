...
%> 
<h3 align="center">Consulta Logs de Transacciones Financieras<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="logs_pr.jsp, EPR0200"></h3>
<hr size="4">
  <form name="form1">
