...
<body>
<h3 align="center">Asignación de Tarjetas<BR>Consulta de Tarjeta Titular<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="card_assign_inq.jsp, ECC0090"></h3>
<hr size="4">
<% 
