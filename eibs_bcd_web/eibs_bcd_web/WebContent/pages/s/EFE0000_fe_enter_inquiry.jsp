...
<body bgcolor="#FFFFFF">
<H3 align="center"> Tesorer&iacute;a - Consultas- <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_enter_inquiry,EFE0000"></H3>
	...
	<tr id="trdark"> 
      ...
      <tr id="trclear"> 
        <td width="313"> 
          <div align="left"> <b> 
            ...
            <a href="javascript:GetFexAcc('ACCNUM')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a></b> 
            </b></div>
        </td>
        <td width="350"> 
          <div align="left"> 
      ...
      <tr id="trclear"> 
        ...
        <td colspan="2">Cliente : 
          ...
          <input type="text" name="CUNDSC" size="25" maxlength="25" value="<%= name %>">
          <a href="javascript:GetCustomerDescId('CUNCOD','CUNDSC','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
...
<SCRIPT type="text/javascript">
	...
	function divResize2() {
  		var minValue = document.getElementById("mainTable").offsetTop + 
  					   document.getElementById("dataDiv1").offsetTop + 30;
  		var h = 400 - minValue ;
  		var totalrow = parseInt(document.forms[0].totalRow.value);
  		var maxHeight = totalrow * 20; 
  
  		if (totalrow > 6) {
     		document.getElementById("dataDiv1").style.height = maxHeight; 
     		document.getElementById("dataDiv1").style.overflowY = "scroll";
  		} else {
			document.getElementById("dataDiv1").style.height = maxHeight; 
   			document.getElementById("dataDiv1").style.overflowY = "";
  		} 
	}
