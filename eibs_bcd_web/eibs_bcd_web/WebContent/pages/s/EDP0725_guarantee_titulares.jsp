 		 ...
 		 <tr id="trclear"> 
            ...
            <td nowrap height="19" width="55%">
				<% if(!userPO.getHeader17().equals("5")){ %>
					<eibsinput:date name="l0723" fn_month="E02DPTCNM" fn_day="E02DPTCND" fn_year="E02DPTCNY" required="true" />
				<% } else { %>
					<eibsinput:date name="l0723" fn_month="E02DPTCNM" fn_day="E02DPTCND" fn_year="E02DPTCNY"  readonly="true" />
				<% } %>
			</td>
			<td nowrap height="19" width="2%"> 
			<div align="right"> </div>
