...
<h3 align="center">Detalles del Documento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pay_inq_det.jsp,EDL0825"></h3>
<hr size="4">
        ...
        <td nowrap>
          <table cellspacing="0" cellpadding="2" width="100%" border="0">
              <tr >
                ...
                <td  align="left" nowrap="nowrap" colspan="3" style="width: 85%; text-decoration: underline;"><%= docList.getRecord(1) +" - " + docList.getRecord(2)%></td>
              </tr>          
              <tr>
                <td nowrap style="width: 25%">
                <DIV align="right"><b>Nro. Documento :</b></DIV>
                </td>
                <td nowrap align="left" style="width: 25%"><%= docList.getRecord(0)%></td>
                <td nowrap style="width: 25%">
                <DIV align="right" ><b>Estado del Dcto.:</b></DIV>
                </td>
                <td nowrap align="left" style="width: 25%"><% if (docList.getRecord(8).equals("A")) out.print("Activo");
              ...
              <tr>
                ...
                <td nowrap align="left"><%= docList.getRecord(10)+" - "+ docList.getRecord(11)+" - "+docList.getRecord(12)+" - "+docList.getRecord(13)%></td>
                <td nowrap>
              ...
              <tr>
                ...
                <td nowrap align="left"><%= docList.getRecord(3)%></td>
                <td nowrap>
              ...
              <tr >
                ...
                <td nowrap align="left"><%= docList.getRecord(14)%></td>
                <td nowrap>
              ...
              <tr>
                ...
                <td nowrap align="left"><%= docList.getRecord(15)%></td>
                <td nowrap>
              ...
              <tr >
                ...
                <td nowrap align="left"><%= docList.getRecord(5)%></td>
                <td nowrap>
              ...
              <div align="right"><B>Monto Revaluaci&oacute;n :</B></div>
                ...
                <td nowrap align="left"><%= docList.getRecord(16)%></td>
                <td nowrap>
              ...
              <tr>
                ...
                <td nowrap align="left"><%= docList.getRecord(17)%></td>
                <td nowrap>
