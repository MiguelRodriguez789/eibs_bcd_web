...
<BODY>
<H3 align="center">Comisiones de Cartas de Credito Stand By <IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_commissi_sb.jsp, ELC0525"></H3>
<HR size="4">
		...
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0"
			...
			<TR id="trclear">
				...
				<TD nowrap width="20%" colspan=3>
					<DIV align="left">
						<eibsinput:date name="msg040004" fn_month="E04LCMIDM" fn_day="E04LCMIDD" fn_year="E04LCMIDY" readonly="true" />
					</DIV>
				</TD>
				<TD nowrap width="16%">
			...
			<TR id="trdark">
				...
				<TD nowrap width="20%" colspan=3>
					<DIV align="left">
					<eibsinput:date name="msg040004" fn_month="E04LCMEXM" fn_day="E04LCMEXD" fn_year="E04LCMEXY" readonly="true" />
					</DIV>
				</TD>
				<TD nowrap width="16%">
