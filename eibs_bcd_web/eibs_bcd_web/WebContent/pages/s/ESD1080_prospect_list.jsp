...
<title>Mantenimiento de Prospectos</title>
...
<%
String ope = (userPO.getSource() == null ? "20" : userPO.getSource());
%> 
...
function goSel() {
	if ( getElement("NEWMNT").value == "0" || getElement("NEWMNT").value == "" ) {
		alert("Favor seleccionar un Prospecto!!!");
		return;	 
	}
...
<h3 align="center">Mantenimiento de Prospectos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="proespect_list.jsp, ESD1080"></h3>
<hr size="4">
