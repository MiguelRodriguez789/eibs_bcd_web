...
function goAction() {
	...
	if (!document.forms[0].CC_Main[0].checked && !document.forms[0].CC_Main[1].checked && !document.forms[0].CC_Main[2].checked) {
		...
		//alert(document.forms[0].AccList.length);
			for (var i=0; i<document.forms[0].AccList.length; i++) {
				document.forms[0].AccList[i].selected = true;
			}
			if (document.forms[0].AccList[0].value == "X") {
				document.forms[0].AccList.remove(0);
			}
			for (var j=0; j<document.forms[0].AccSList.length; j++) {
	...
	if (i == -1) {
		...
		if (num == 1) {
			if (E04CCRAPC.value != "01" &&
				...
				var apcode1 = document.getElementById("CCP_Apcode").value;
				var ccp = document.getElementById("CCP").value;
				var type1 = document.getElementById("CCP_Type").value;
				var subtype1 = document.getElementById("CCP_Subtype").value;
				//alert(ccp);
				if (ccp !="" && ccp !=null) {
					alert("Disculpe, hay una cuenta corriente asignada. Quítela primero y vuelva a intentarlo.");
				}
				else { 
					apcode1 = E04CCRAPC.value;
					ccp = E04CCRCRA.value;
					document.forms[0].CC_Main[0].value = E04CCRCRA.value;
					type1 = E04CCRTYP.value;
					subtype1 = E04CCRSTP.value;
					document.getElementById("CCP_Apcode").value=apcode1;
					document.getElementById("CCP").value=ccp;
					document.getElementById("CCP_Type").value=type1;
					document.getElementById("CCP_Subtype").value=subtype1;
					acc.remove(i);
				}
			}
		}
		if (num == 2) { 
			if (E04CCRAPC.value != "04") {
				...
				var apcode2 = document.getElementById("CAP_Apcode").value;
				var cap = document.getElementById("CAP").value;
				var type2 = document.getElementById("CAP_Type").value;
				var subtype2 = document.getElementById("CAP_Subtype").value;
				//alert(cap);
				if (cap != "" && cap !=null) {
					alert("Disculpe, hay una cuenta de ahorros asignada. Quítela primero y vuelva a intentarlo.");
				}
				else {
					apcode2 = E04CCRAPC.value;
					cap= E04CCRCRA.value;
					document.forms[0].CC_Main[1].value = E04CCRCRA.value;
					type2 = E04CCRTYP.value;
					subtype2 = E04CCRSTP.value;
					document.getElementById("CAP_Apcode").value=apcode2;
					document.getElementById("CAP").value=cap;
					document.getElementById("CAP_Type").value=type2;
					document.getElementById("CAP_Subtype").value=subtype2;
					acc.remove(i);
				}
			}
		}
		if (num == 3) {
			if (E04CCRTYP.value != "CFAL") {
				...
				var apcode3 = document.getElementById("CFP_Apcode").value;
				var cfp = document.getElementById("CFP").value;
				var type3 = document.getElementById("CFP_Type").value;
				var subtype3 = document.getElementById("CFP_Subtype").value;
				if (cfp != "" && cfp != null) {
					alert("Disculpe, hay una cuenta F.A.L. asignada. Quítela primero y vuelva a intentarlo.");
				}
				else {
					apcode3 = E04CCRAPC.value;
					cfp = E04CCRCRA.value;
					document.forms[0].CC_Main[2].value = E04CCRCRA.value;
					type3 = E04CCRTYP.value;
					subtype3 = E04CCRSTP.value;
					
					document.getElementById("CFP_Apcode").value=apcode3;
					document.getElementById("CFP").value=cfp;
					document.getElementById("CFP_Type").value=type3;
					document.getElementById("CFP_Subtype").value=subtype3;
...
<body>
<h3 align="center">Asignación de Tarjetas<BR>Mantenimiento de Tarjeta Adicional<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="card_assign_maint_add.jsp, ECC0090"></h3>
<hr size="4">
<% 
      ...
      <td align="center" valign="bottom">
	  	<table cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<input type="button" name="CCP_Add" value="&gt;&gt;" onClick="javascript:add(1)">
			  </td>
			</tr>
			<tr>
				<td height="25">
    		  ...
    		  <td nowrap> 
       			  <table width="100%" border="0" cellpadding="2" cellspacing="0" class="tbhead">
				      ...
				      <tr id="trdark">
		        		...
		        		<td nowrap>
		          			<input type="hidden" name="CCP_Apcode" id="CCP_Apcode" value="<%= ccpapcode%>">
		          			<input type="text" name="CCP" id="CCP" size="21" maxlength="20" value="<%= ccp%>" readonly>
		          			<input type="text" name="CCP_Type" id="CCP_Type" size="5" maxlength="4" value="<%= ccptype%>" readonly>
		        			<input type="text" name="CCP_Subtype" id="CCP_Subtype" size="5" maxlength="4" value="<%= ccpsubtype%>" readonly>
		        		</td>
						<TD nowrap align="left">
							<INPUT type="radio" name="CC_Main" value="<%= ccp%>" <% if (accmain == 1) { %> checked <% } %>>
		
		          			<% if (accmain == 1) {%>
		          			<img src="<%=request.getContextPath()%>/images/cone.gif" title="main" align="bottom" border="0">
		          			<%}%>
						</TD>
					</tr>
		      		  <tr id="trdark">
		        		...
		        		<td nowrap>
		          			<input type="hidden" name="CAP_Apcode" id="CAP_Apcode" value="<%= capapcode%>">
		          			<input type="text" name="CAP" id="CAP" size="21" maxlength="20" value="<%= cap%>" readonly>
		          			<input type="text" name="CAP_Type" id="CAP_Type" size="5" maxlength="4" value="<%= captype%>" readonly>
		        			<input type="text" name="CAP_Subtype" id="CAP_Subtype" size="5" maxlength="4" value="<%= capsubtype%>" readonly>
		        		</td>
						<TD nowrap align="left">
		        		...
		        		<td nowrap>
		          			<input type="hidden" name="CFP_Apcode" id="CFP_Apcode" value="<%= cfpapcode%>">
		          			<input type="text" name="CFP" id="CFP" size="21" maxlength="20" value="<%= cfp%>" readonly>
		          			<input type="text" name="CFP_Type" id="CFP_Type" size="5" maxlength="4" value="<%= cfptype%>" readonly>
		        			<input type="text" name="CFP_Subtype" id="CFP_Subtype" size="5" maxlength="4" value="<%= cfpsubtype%>" readonly>
		        		</td>
						<TD nowrap align="left">  
