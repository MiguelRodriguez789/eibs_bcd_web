...
<h3 align="center">Comunicaciones 
  <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_both_com, ESD0080"></h3>
<hr size="4">
      ...
      <td nowrap  > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
          ...
          <tr id=trclear> 
            ...
            <td nowrap width="54%"> 
              <div align="left"> 
              <input type="text" name="E07FAX" size="16" maxlength="15" value="<%= com.getE07FAX().trim()%>" readonly="readonly" >
              </div>
            </td>
          </tr>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
          <tr> 
            ...
            <td nowrap width="54%"> 
              <div align="left"> 
                <input type="text" name="E07ABK" size="18" maxlength="16" value="<%= com.getE07ABK().trim()%>" readonly="readonly" >
