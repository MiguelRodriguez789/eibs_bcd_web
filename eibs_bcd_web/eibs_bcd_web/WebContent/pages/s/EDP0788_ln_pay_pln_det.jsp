<html>
<head>
<title>Plan de Amortización</title>
...
%> 
<%if (userPO.getHeader7().equals("AA")||userPO.getHeader7().equals("ZZ")||userPO.getHeader7().equals("NN")||(userPO.getHeader21().equals("5"))) {
 ...
 //Esta funciton se llama en el click del button de borrado
  function DeleteRowSel(tableName,chkboxName){
    ...
    if ( noRow > 0 ){
    	...
    	document.forms[0].ROW.value = "" + getElement(tableName).rows.length -1;
    }
  }
   ...
   var sufix="";
    try {
      ...
      if (myTable.rows.length < 98) {
        ...
        myTable.rows[idxrow].cells[2].innerHTML = "<input type='text' name='DLPPD1_" + sufix + "' id='MANDATORY' size='2' maxlength='2'  value='' onKeypress='enterInteger(event)'>" +
          " <input type='text' name='DLPPD2_" + sufix + "' id='MANDATORY' size='2' maxlength='2'  value='' onKeypress='enterInteger(event)'>" +
    ...
    if (checkAutomaticFields()) {
      ...
      for (i=1; i < number + 1; i++){
      	...
      	if (i > 1) {
			...
			myDate.setMonth(myDate.getMonth() + feq);
...
<h3 align="center"> Plan de Amortización</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0788" onsubmit="return(checkMandatoryFields())">
  <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="300">
  <INPUT TYPE=HIDDEN NAME="opt" VALUE="1">
  <INPUT TYPE=HIDDEN NAME="ROW" VALUE="<%= row %>">
  <INPUT TYPE=HIDDEN NAME="DFORMAT" VALUE="<%= userInfo.getE01DTF() %>">
  <input type=HIDDEN name="E03DLPCRB" value="">
  ...
  <table class="tableinfo">
   ...
   <table width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr id="trclear"> 
      <td nowrap width="14%"> 
        <div align="right">N&uacute;mero de Propuesta de Crédito : </div>
      </td>
      <td nowrap width="42%"> 
        <div align="left"> 
          <input type="text" name="E03DLPNPR" size="14" maxlength="12" value="<%=pmnt.getRecord(8)%>">
        </div>
      </td>
      <td nowrap width="10%"> 
<%-- 
        <div align="right">Número de Préstamo : </div>
--%>
      </td>
      <td nowrap width="9%"> 
<%-- 
          <input type="text" name="E03DLPACC" size="14" maxlength="12" value="<%=pmnt.getRecord(11)%>">
--%>
      </td>
    </tr>
<%-- 
    <tr id="trdark"> 
      ...
      <td nowrap width="42%"> 
        <div align="left"> 
          <input type="text" name="E03DLPCRB" size="5" maxlength="4" value="<%=pmnt.getRecord(9)%>">-
          <input type="text" name="D03DLPCRB" size="35" maxlength="35" value="<%=pmnt.getRecord(10)%>">
        </div>
      </td>
      <td nowrap width="10%"> 
      </td>
  ...
  <h4>Generaci&oacute;n Autom&aacute;tica</h4>
    ...
    <tr id="trdark"> 
      ...
      <td nowrap width="42%"> <%
        ...
        %> 
              <input type="text" name="DATE3" size="3" maxlength="2" onKeypress="enterInteger(event)" id="AUTOMATICINT">
              <input type="text" name="DATE1" size="3" maxlength="2" onKeypress="enterInteger(event)" id="AUTOMATICINT">
              <input type="text" name="DATE2" size="3" maxlength="2" onKeypress="enterInteger(event)" id="AUTOMATICINT">
...
--%>
    ...
    <%
        ...
        if (pmnt.getRecord(7).equals("")) {
        int actrow = pmnt.getCurrentRow() ;
	%> 
    <tr id="trclear">       
      <input type="hidden" name="DLPINT_<%= actrow %>"  value="<%= pmnt.getRecord(5) %>" >
      <td align=center>
      ...
      <td nowrap> 
        <div align="center"> 
          <input type="text" name="DLPPD1_<%= actrow %>" id="MANDATORY" size="2" maxlength="2"  value="<%= pmnt.getRecord(1) %>" onKeypress="enterInteger(event)">
          <input type="text" name="DLPPD2_<%= actrow %>" id="MANDATORY" size="2" maxlength="2"  value="<%= pmnt.getRecord(2) %>" onKeypress="enterInteger(event)">
