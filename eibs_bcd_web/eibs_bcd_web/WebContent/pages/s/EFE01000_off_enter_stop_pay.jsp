...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="off_enter_stop_pay.jsp , EFE01000"> 
<hr size="4">
  ...
  <table class="tbenter" height="75%" width="100%" border="0">
    <tr>
      ...
      <td nowrap align="center"> N&uacute;mero de Cuenta : 
        <input type="text" name="E01STPACC" size="12" maxlength="9" onkeypress="enterInteger(event)">
