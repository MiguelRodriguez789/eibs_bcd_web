...
<H3 align="center">C&oacute;digos de Referencia del Sistema - Límites de Inembargabilidad<img src="<%=request.getContextPath()%>/images/e_ibs.gif"
			...
			<tr id="trdark">
				...
				<div align="left">
					<SELECT name="E02CNOF03">
						...
						<OPTION value="N" <%if(refCodes.getE02CNOF03().trim().equals("N")){%> Selected <%}%>>Natural</OPTION>
						<OPTION value="J" <%if(refCodes.getE02CNOF03().trim().equals("J")){%> Selected <%}%>>Juridica</OPTION>
					</SELECT></div>
				</td>
			</tr>
			<tr id="trdark">
				<td nowrap width="30%" height="23">
					<div align="right">Limite de Inembargabilidad (valor en Pesos) :</div>
				</td>
				<td nowrap height="23">
				<div align="left">
					<input type="text" name="E02CNOMXC" size="18" maxlength="15" value="<%= refCodes.getE02CNOMXC().trim()%>" onKeypress="enterDecimal(event, 2)">
				</div>
				</td>
			</tr>
