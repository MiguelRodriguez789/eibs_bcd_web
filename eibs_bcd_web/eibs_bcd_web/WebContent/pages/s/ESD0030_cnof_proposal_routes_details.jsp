...
<H3 align="center">C&oacute;digos de Referencia del Sistema - Rutas de Propuesta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnof_proposal_routes_details.jsp, ESD0030"></H3>
<hr size="4">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                ...
                <a href="javascript:GetCodeCNOFC('E02CNOCPC','37')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a></div>
            </td>
          </tr>
        </table>
      </td>
