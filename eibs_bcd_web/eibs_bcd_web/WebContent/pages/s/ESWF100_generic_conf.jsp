...
%> 
<h3 align="center"> Reparaci&oacute;n de Mensaje de Swift <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="generic_conf.jsp,ESWF100"> 
</h3>
<hr size="4">
