...
<h3 align="center">Propuesta de Crédito
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="proposals_filter,EDP0720"></h3>
<hr size="4">
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter"  border=0  width=70% align="center" >
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
      	    ...
      	    <input type="text" name="E01FILBRN" size="5" maxlength="4" value="" onKeypress="enterInteger(event)">
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILNPR" size=16 maxlength=12 onKeypress="enterInteger(event)">
        </td>
      </tr>
       <tr valign="middle"> 
        <td nowrap width=20% align="right" >
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILCUN" size=16 maxlength=9 onKeypress="enterInteger(event)">
            <input type=TEXT name="D01FILCUN" size=20 maxlength=20 readonly>
            <a href="javascript:GetCustomerDescId('E01FILCUN','D01FILCUN','')">
            <img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="middle" border="0" ></a> 
        </td>
      </tr>
     ...
     <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILEJE" size=6 maxlength=4 onKeypress="enterInteger(event)">
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILEST" size=3 maxlength=2 onKeypress="enterInteger(event)">
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILREF" size=16 maxlength=16 onKeypress="enterInteger(event)">
        </td>
      </tr>
