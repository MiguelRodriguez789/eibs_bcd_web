...
%>
<h3 align="center"> Confirmaci&oacute;n - Spot (Back Office) </h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="85%" ><font face="Arial">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="right">Fecha de Pacto :<%= Util.formatDate(fex.getE01WKFDD1(),fex.getE01WKFDD2(),fex.getE01WKFDD3())%></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
