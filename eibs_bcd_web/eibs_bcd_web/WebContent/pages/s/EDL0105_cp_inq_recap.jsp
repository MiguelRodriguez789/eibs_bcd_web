...
<h3 align="center">Sumario de Transacciones para el Instrumento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cp_inq_recap.jsp,EDL0105"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <input type="text" name="E01DEAMD1" size="3" maxlength="2" value="<%= userPO.getHeader12().trim()%>" readonly>
              <input type="text" name="E01DEAMD2" size="3" maxlength="2" value="<%= userPO.getHeader13().trim()%>" readonly>
              <input type="text" name="E01DEAMD3" size="5" maxlength="4" value="<%= userPO.getHeader14().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
            ...
            <td nowrap > 
              <input type="text" name="E01DEANX1" size="3" maxlength="2" value="<%= userPO.getHeader15().trim()%>" readonly>
              <input type="text" name="E01DEANX2" size="3" maxlength="2" value="<%= userPO.getHeader16().trim()%>" readonly>
              <input type="text" name="E01DEANX3" size="5" maxlength="4" value="<%= userPO.getHeader17().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
