...
<h3 align="center">Compraventa Moneda Extranjera<BR>Aprobacion de Liquidacion de Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0350"></H3>
<%} else {%>
<h3 align="center">Compraventa Moneda Extranjera<BR>Liquidacion de Operaciones<%if (userPO.getHeader10().equals("D")) {%> Diarias <%} else {%> SPOT <%}%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0350"></H3>
<%}%>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
				...
				<a href="javascript:GetComission(document.forms[0].E01REQREF.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
				<%}%> 
			</td>
		</tr>
		<tr>
  ...
  <table class="tableinfo">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<%if (msgInst.getE01REQSTS().equals("A")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha/Hora de Aprobacion:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQAD1" size="3" maxlength="2" value="<%= msgInst.getE01REQAD1() %>" readonly>
                <input type="text" name="E01REQAD2" size="3" maxlength="2" value="<%= msgInst.getE01REQAD2() %>" readonly>
                <input type="text" name="E01REQAD3" size="5" maxlength="4" value="<%= msgInst.getE01REQAD3() %>" readonly>
				<input type="text" name="E01REQAPT" size="8" maxlength="6" value="<%= Util.formatTime(msgInst.getE01REQAPT()) %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
				<div align="right">Usuario que aprobo:</div>
			</td>
			<td nowrap width="60%">
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQVD1" size="3" maxlength="2" value="<%= msgInst.getE01REQVD1() %>" readonly>
                <input type="text" name="E01REQVD2" size="3" maxlength="2" value="<%= msgInst.getE01REQVD2() %>" readonly>
                <input type="text" name="E01REQVD3" size="5" maxlength="4" value="<%= msgInst.getE01REQVD3() %>" readonly>
			</td>
		</tr>
		<%}%>
     </table>
...
<br>
<%if (userPO.getHeader10().equals("A")) {%>
	<%if (msgInst.getH01FLGWK3().equals("5")) {%>
		<table class="tableinfo">
   			<tr> 
   				<td>
    				<table cellspacing=0 cellpadding=2 width="100%" border="0">
  		...
  		<br>
  	<%}%>
  	<%if (msgInst.getH01FLGWK3().equals("2")) {%>
  		<table class="tableinfo">
   			<tr> 
   				<td>
    				<table cellspacing=0 cellpadding=2 width="100%" border="0">
  		...
  		<br>
  	<%}%>
  	<%if (msgInst.getH01FLGWK3().equals("3")) {%>
  		<br>
  		<table class="tableinfo">
   			<tr> 
  				<td>
