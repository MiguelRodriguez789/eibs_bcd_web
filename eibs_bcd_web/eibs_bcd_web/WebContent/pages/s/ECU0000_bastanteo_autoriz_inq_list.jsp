...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_autoriz_inq_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE06CUAAC1(),msgMT.getE06CUAAC2(),msgMT.getE06CUAAC3())  + " - " + msgMT.getE06CUAACT()%></TD>
