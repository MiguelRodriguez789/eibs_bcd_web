...
<!--
 ...
 function goSubmit(opt) {
    document.forms[0].AOPT.value = opt;
...
<INPUT TYPE=HIDDEN NAME="AOPT" VALUE="">
  <h3 align="center">Activar Nuevo Usuario Internet <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="status_list.jsp,ESS2040"> 
  </h3>
<hr size="4">

 <TABLE class="tbenter">
    <TR> 
      <TD ALIGN=CENTER width="50%" class=TDBKG> <a href="javascript:goSubmit('1')">Aceptar</a> 
      <TD ALIGN=CENTER width="50%" class=TDBKG> <a href="javascript:goSubmit('2')">Rechazar</a> 
      </TD>
    </TR>
  </TABLE>
