  ...
  function goAction(opt) {
    ...
    if (opt == "D") {
	  ...
	  if (ok) document.forms[0].submit();
    	...
    	page = "<%=request.getContextPath()%>/pages/s/EPR0330_foreign_currency_exchange_maint.jsp?ROW=" + row + "&MNT=1";
  		CenterNamedWindow(page,'Information',550,450,2);
	} else if (opt == "C") { 
		var row = document.forms[0].CURRENTROW.value;   
    	page = "<%=request.getContextPath()%>/pages/s/EPR0330_foreign_currency_exchange_detail.jsp?ROW=" + row;
  		CenterNamedWindow(page,'Information',550,450,2);
  	} else {
  	    page = "<%=request.getContextPath()%>/pages/s/EPR0330_foreign_currency_exchange_new.jsp?NEW=yes";
  		CenterNamedWindow(page,'Information',550,450,2);
  	}
  }
...
<h3 align="center">Compraventa Moneda Extranjera<BR>Ingreso y Preliquidacion de Solicitudes de Compraventa<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_list.jsp, EPR0330">
</h3>
<hr size="4">
...
%> 
 ...
 <TABLE class="tbenter" width="100%" align=center>
    <TR> 
      ...
      <TD class=TDBKG width="20%"> 
        <div align="center"><a href="javascript:goAction('C')">Consultar</a> 
        </div>
      </TD>
      <TD class=TDBKG width="20%"> 
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        while (mtList.getNextRow()) {
           ...
           datapro.eibs.beans.EPR033001Message msgMT = (datapro.eibs.beans.EPR033001Message) mtList.getRecord();
     	%>               
        <TR>
