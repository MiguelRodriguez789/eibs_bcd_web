<html>
<head>
<title>Consulta de Representates Legales</title>
...
%> 
<h3 align="center">Representates Legales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_inq_legal_rep.jsp, EDD0000"></h3>
<hr size="4">
      ...
      <td> 
		...
		<%} %>   
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" readonly name="E<%= name %>4D21" maxlength="2" size="2" value="<%= legalRep.getField("E" + name + "4D21").getString().trim()%>">
              <input type="text" readonly name="E<%= name %>4D22" maxlength="2" size="2" value="<%= legalRep.getField("E" + name + "4D22").getString().trim()%>">
              <input type="text" readonly name="E<%= name %>4D23" maxlength="4" size="5" value="<%= legalRep.getField("E" + name + "4D23").getString().trim()%>">
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="42%" nowrap > 
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap > 
              <input type="text" readonly  name="E<%= name %>4BMS" size="25" maxlength="30" 
				  value="<% if (legalRep.getField("E" + name + "4BMS").getString().equals("1")) out.print("Soltero(a)");
							else if (legalRep.getField("E" + name + "4BMS").getString().equals("2")) out.print("Casado(a)");
							...
							else if (legalRep.getField("E" + name + "4BMS").getString().equals("6")) out.print("Union Libre");
						    else out.print("");%>" 
				>
            </td>
          </tr>
