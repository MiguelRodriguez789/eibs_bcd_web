...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_inq_enter.jsp, ECD0003"> 
</h3>
<hr size="4">
<% 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
				...
				<a href="javascript:GetPlastic3('E03CDRINI',' ', ' ', '<%= currUser.getH01USR() %>')">
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
				...
				<a href="javascript:GetPlastic3('E03CDREND', ' ', ' ', '<%= currUser.getH01USR() %>')">
                <img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			  </div>
            </td>
          </tr>
