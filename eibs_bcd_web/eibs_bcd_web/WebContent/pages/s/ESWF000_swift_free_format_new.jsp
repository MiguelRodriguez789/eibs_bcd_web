...
%>
<h3 align="center"> SWIFT - Formatos Libres<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="swift_free_format_new.jsp,ESWF000"> 
</h3>
<hr size="4">
