            ...
            <td> 
              <table width="100%">
                ...
                <tr id="trclear"> 
                  ...
                  <td width="73%" nowrap> 
                    <input type="text" name="ORDERNUM"  size=13 maxlength="12" 
                ...
                <tr id="trclear">
                  ...
                  <td nowrap width="73%" >
                    ...
                    <a href="javascript:GetInstrumentParams('INSTCODE','DESCRIPTION','','','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a></td>
                </tr>
                <tr id="trclear"> 
                  <td width="27%" nowrap > 
