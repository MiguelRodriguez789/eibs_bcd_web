...
<H3 align="center">Sistema de Bastanteo - Creacion de Autorizaciones Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_autoriz_new,ECU0000"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	<tr id=trdark> 
		  <td nowrap> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E06CUAFAC','E06CUAFAN','YF')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
    	...
    	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E06CUARD1" size="3" maxlength="2" value="<%= msgAut.getE06CUARD1() %>">
	      	<input type="text" name="E06CUARD2" size="3" maxlength="2" value="<%= msgAut.getE06CUARD2() %>">
	      	<input type="text" name="E06CUARD3" size="5" maxlength="4" value="<%= msgAut.getE06CUARD3() %>">
    	...
    	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E06CUAAD1" size="3" maxlength="2" value="<%= msgAut.getE06CUAAD1() %>">
	      	<input type="text" name="E06CUAAD2" size="3" maxlength="2" value="<%= msgAut.getE06CUAAD2() %>">
	      	<input type="text" name="E06CUAAD3" size="5" maxlength="4" value="<%= msgAut.getE06CUAAD3() %>">
     	...
     	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E06CUAMA1" size="3" maxlength="2" value="<%= msgAut.getE06CUAMA1() %>">
	      	<input type="text" name="E06CUAMA2" size="3" maxlength="2" value="<%= msgAut.getE06CUAMA2() %>">
	      	<input type="text" name="E06CUAMA3" size="5" maxlength="4" value="<%= msgAut.getE06CUAMA3() %>">
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E06CUAOBS" size="90" maxlength="80" value="<%= msgAut.getE06CUAOBS().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%">
