...
<h3 align="center">Planes De Fomento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="PFomento_client_search.jsp,ESD0365"></h3>
<hr size="4">
...
<table id="TBHELPN" width="100%" border="0" cellspacing="0"
	...
	<tr>
		...
		<td  width="50%"><input type="text" name="customer_number" size="10" maxlength="9" onKeyPress="enterInteger(event);">
