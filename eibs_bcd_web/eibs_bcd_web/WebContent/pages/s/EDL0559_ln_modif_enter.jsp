...
<html>
<head>
<title>Table/List Modif Creditos</title>
...
<h3 align="center">Hist&oacute;rico Modificaciones / Reestructuraciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_monitor_enter.jsp, EDL0559"></h3>
<hr size="4">
			...
			<td nowrap height="94"> 
				<table cellpadding=2 cellspacing=0 width="100%" border="0">
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">  
						...
						<td nowrap width="15%"> 
							<div align="left"> 
								<eibsinput:date fn_month="E01FMDTMM" fn_day="E01FMDTDD" fn_year="E01FMDTYY"  />
							</div>
						</td>
						<td nowrap width="5%"> 
						...
						<td nowrap width="47%"> 
							<div align="left"> 
								<eibsinput:date fn_month="E01TODTMM" fn_day="E01TODTDD" fn_year="E01TODTYY"  />
							</div>
						</td>
					</tr>
				</table>
