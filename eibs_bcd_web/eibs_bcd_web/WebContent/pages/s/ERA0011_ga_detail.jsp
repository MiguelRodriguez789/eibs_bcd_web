...
<H3 align="center">Otras Inscripciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_detail.jsp , ERA0011"></H3> 
<hr size="4">
        		...
        		<table cellspacing="0" cellpadding="2" width="100%" border="0">
          			...
          			<tr id="trclear"> 
            			...
            			<td nowrap>
              				...
              				<A href="javascript:GetCodeCNOFC('E02RODUC1','X0')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></A>
            			</td>
          			</tr>
          			<tr id="trdark"> 
    		...
    		<tr > 
      			<td nowrap> 
        			<table width="100%" border="0">          
            				...
            				<td nowrap > 
				            	<eibsinput:date name="collDet" fn_month="E02RODODM" fn_day="E02RODODD" fn_year="E02RODODY"/>
            				</td>
         			...
         			<% if (collDet.getH02SCRCOD().equals("07")) { %> 
						<tr id="trclear">
							...
							<TD nowrap>
								...
								<A href="javascript:GetCodeDescCNOFC('E02STE','D02STE','PV')"> <IMG	src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" style="cursor:hand"></A>
							</TD>
						</tr>
           				<tr id="trdark">
							...
							<TD nowrap>
								...
								<IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" style="cursor:hand" onclick="javascript:GetCodeDescCNOFC('E02TID','D02TID','PI')">
							</TD>
						</tr>
          				<tr id="trclear"> 
							...
							<TD nowrap>
								...
								<A href="javascript:GetCodeDescCNOFC('E02PID','D02PID','PE')"> <IMG	src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" style="cursor:hand"></A>
							</TD>
						</tr>
           				<tr id="trdark">
          				...
          				<tr id="trclear"> 
							...
							<TD nowrap>
								...
								<IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" style="cursor:hand" onclick="javascript:GetCodeDescCNOFC('E02ZPC','D02ZPC' ,'59')">
							</TD>
						</tr>
					...
					<% } else { %>
            			...
            			<tr id="trdark"> 
							...
							<TD nowrap>
								...
								<A href="javascript:GetCodeCNOFC('E02STE','27')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></A>
							</TD>
						</tr>
            			<tr id="trclear"> 
              				<td nowrap><div align="right"></div></td>
         			...
         			<% if (userPO.getType().equals("03")) { %>
           				<tr id="trclear"> 
            				...
            				<td nowrap >               
				            	<eibsinput:date name="collDet" fn_month="E02RODPDM" fn_day="E02RODPDD" fn_year="E02RODPDY"/>
            				</td>
            				<td nowrap ><div align="right">Fecha Notificación :</div></td>
            				<td nowrap >               
				            	<eibsinput:date name="collDet" fn_month="E02RODNDM" fn_day="E02RODNDD" fn_year="E02RODNDY"/>
            				</td>
          				</tr>
         			<% } %>
   					</table>
