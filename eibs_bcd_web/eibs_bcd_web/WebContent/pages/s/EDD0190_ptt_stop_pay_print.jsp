        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
		 ...
		 <% } %>
          ...
          <tr> 
            ...
            <td align="center" colspan="2" > 
			  <div align="left"><%= Util.formatCustomDate(currUser.getE01DTF(),rtStop.getDHSADM(), rtStop.getDHSADD(), rtStop.getDHSADY()) %></div>
            </td>
            <td align="center" colspan="2" > 
              <div align="right"><b>HORA:</b> <% if ( rtStop.getDHSORG().trim().equals("5")) {out.print(" 09:01");} else {out.print(Util.formatCell(userPO.getHeader19()));} %> </div>
            </td>
          ...
          <tr> 
            <td align="right" colspan="8" height="30"> 
