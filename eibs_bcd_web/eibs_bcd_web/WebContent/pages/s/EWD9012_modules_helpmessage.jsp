...
<title>Reports Modules Help</title>
</head>
<%@ page import="datapro.eibs.master.Util" %>

<body>
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.reports.JSEWD9012">
...
<TABLE class="tableinfo" align="center" style="width:'95%'">
  ...
  <%
        ...
        while (msgHelp.getNextRow()) {
			datapro.eibs.beans.EWD9012DSMessage msg = (datapro.eibs.beans.EWD9012DSMessage) msgHelp.getRecord();
     	%>    
    <TR>
		<td nowrap align="center"><a href="javascript:enter('<%= msg.getSWDRPT()%>','<%= msg.getSWDDSC()%>')"><%= Util.formatCell(msg.getSWDRPT())%></a></td>
		<td nowrap align="left"><a href="javascript:enter('<%= msg.getSWDRPT()%>','<%= msg.getSWDDSC()%>')"><%= Util.formatCell(msg.getSWDDSC())%></a></td>
	</TR>   	
		<%} %>	
</TABLE>
    ...
    <TR>
      <TD WIDTH="50%" ALIGN=LEFT height="25"> 
       <% if ( msgHelp.getShowPrev() ) {
      		...
      		out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.reports.JSEWD9012?FromRecord=" + pos + "&lang=" + userPO.getType() + "&code=" + userPO.getHeader18() + "\" > <img src=\""+request.getContextPath()+ "/images/s/previous_records.gif\" border=0></A>");
        }
%> </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> 
 	   <% if ( msgHelp.getShowNext() ) {
      		int pos = msgHelp.getLastRec();
      		out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.reports.JSEWD9012?FromRecord=" + pos +  "&lang=" + userPO.getType() + "&code=" + userPO.getHeader18() + "\" ><img src=\""+request.getContextPath()+"/images/s/next_records.gif\" border=0></A>");
