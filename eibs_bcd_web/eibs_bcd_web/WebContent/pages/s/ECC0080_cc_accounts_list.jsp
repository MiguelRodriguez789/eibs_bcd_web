          ...
          document.forms[0].submit();
      	 ...
      	 if ( ok ) {
			document.forms[0].submit();
      			...
      			alert("Debe seleccionar una cuenta válida para esta operación");
         }
	 }
...
%> 
<h3 align="center">Asignacion de Cuentas a Tarjetas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_accounts_list.jsp , ECC0080"></h3>
<hr size="4">
              ...
              <td nowrap> 
                <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
                  ...
                  <tr id="trdark"> 
                    ...
                    <td nowrap > 
                      <div align="left">
                      	<input type="text" readonly name="E01CCANUM" size="22" maxlength="20" value="<%= userPO.getHeader1().trim()%>" >
                      </div>
                    </td>
                  </tr>                             
                </table>
