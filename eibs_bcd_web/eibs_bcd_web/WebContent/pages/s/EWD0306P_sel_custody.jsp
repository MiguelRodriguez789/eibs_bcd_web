<html>
<head>
<title>Agentes de Custodia</title>
...
<BODY>
<h3 align="center">Agentes de Custodia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_custody.jsp,EWD0306P"></h3>
<hr size="4">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<tr id="trdark"> 
      ...
      <td align=CENTER width="34%"> 
        <div align="left"> 
          <input type="text" name="CODEN" size="5" maxlength="4">
