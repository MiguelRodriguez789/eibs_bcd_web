...
<H3 align="center">Traspaso de Productos entre Ejecutivos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="officers_change_enter_inq,EEJ0060"></H3>
<hr size="4">
<p>&nbsp;</p>
     	...
     	<tr id=trdark> 
		  <td nowrap width="40%"> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E01EJEORI','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	  </td>
      	</tr>
      	<tr id=trdark> 
		  <td nowrap width="40%"> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E01EJEDES','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	  </td>
      	</tr>
     </table>
    </td>
