...
<H3 align="center">Detalle de Comisiones de Compraventa Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_comission, EPR0330"></H3>
<hr size="4">
