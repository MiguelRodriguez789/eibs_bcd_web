...
<HTML>
<HEAD>
<TITLE>Consulta Deuda Global de Proyecto</TITLE>
...
function goAction(op) {
 ...
 var page="";
 if (op == 1) {
     page = '${pageContext.request.contextPath}/pages/s/EPC0145_pc_new_sch.jsp?LASTROW=' + document.forms[0].LASTROW.value;
 } else if (op == 2) {
   		 page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSEXEDL0160?SCREEN=100";
 } else if (op == 4) {     
     page = '${pageContext.request.contextPath}/pages/s/EPC0145_pc_delete_sch.jsp?ROW=' + document.forms[0].ROW.value; 
 } else if (op == 5) {     
     page = '${pageContext.request.contextPath}/pages/s/EPC0145_pc_sale_sch.jsp?ROW=' + document.forms[0].ROW.value; 
 }
...
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEPC0145">
<INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="2">
<INPUT TYPE=HIDDEN NAME="OPT" VALUE="3">
<INPUT TYPE=HIDDEN NAME="ROW" VALUE="0">
<INPUT TYPE=HIDDEN NAME="LASTROW" VALUE="1">

<h3 align="center">Consulta Deuda Global de Proyecto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_list_sch.jsp,EPC0145"> 
</h3>
<hr size="4">
 ...
 <TR> 
   <TD NOWRAP valign="top" width="100%">
    ...
    <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER nowrap>Interés</TH>            
    ...
    <%
         ...
         while (extList.getNextRow()) {
            EPC014501Message msgPC = (EPC014501Message) extList.getRecord();
            k++;            
     %> 
            <TR> 
              ...
              <TD ALIGN=RIGHT NOWRAP><%= Util.formatCell(msgPC.getE01PDEMEP()) %></TD>              
              <TD ALIGN=RIGHT NOWRAP><%= Util.formatCell(msgPC.getE01PDEMEI()) %></TD>              
              <TD ALIGN=RIGHT NOWRAP><%= Util.formatCell(msgPC.getE01PDEMEM()) %></TD>              
             </TR>
      <%              
		}
    %>
