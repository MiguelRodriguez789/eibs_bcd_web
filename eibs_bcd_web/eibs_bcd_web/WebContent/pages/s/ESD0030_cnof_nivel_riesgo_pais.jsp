...
<H3 align="center">C&oacute;digos de Referencia del Sistema 
-Nivel Riesgo Pais<img src="<%=request.getContextPath()%>/images/e_ibs.gif"
	align="left" name="EIBS_GIF"
	title="cnof_nivel_riesgo_pais.jsp, ESD0030"></H3>
<hr size="4">
<form method="post"
	...
	<tr bordercolor="#FFFFFF">
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
				...
				<td nowrap>
				<div align="left">
					<input type="text" name="E02CNORCD" readonly size="3" maxlength="2" value="<%= refCodes.getE02CNORCD().trim()%>">
				</div>
				</td>
			</tr>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
				...
				<div align="right">Código Insrumento :</div>
				</td>
				<td nowrap height="19">
				<div align="left">
