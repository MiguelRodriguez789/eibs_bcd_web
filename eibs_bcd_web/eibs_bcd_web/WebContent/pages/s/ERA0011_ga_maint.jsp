...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_maint.jsp,ERA0011" width="35" ></h3> 
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              ...
              <a href="javascript:GetBranch('E01ROCBRN',document.forms[0].E01ROCBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" width="18" height="22" ></a> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" height="40" ><a href="javascript:GetBranch('E01WLNBRN',document.forms[0].E01WLNBNK.value)"> 
              ...
              </a><a href="javascript:GetCodeCNOFC('E01ROCTYP','05')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" > 
            </td>
          </tr>
          <tr id="trdark"> 
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%" height="34" > 
              ...
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" width="16" height="19" > 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="38%" >
			  <eibsinput:date name="gaMant" fn_month="E01ROCAPM" fn_day="E01ROCAPD" fn_year="E01ROCAPY" readonly="FALSE" required="true"/>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="23%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="38%" >
			  <eibsinput:date name="gaMant" fn_month="E01ROCOPM" fn_day="E01ROCOPD" fn_year="E01ROCOPY" readonly="FALSE" required="true"/>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="23%" > 
            ...
            <td nowrap width="38%" >
			  <eibsinput:date name="gaMant" fn_month="E01ROCMTM" fn_day="E01ROCMTD" fn_year="E01ROCMTY" readonly="FALSE" required="true"/>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="23%" > 
            ...
            <td nowrap width="38%" >
			  <eibsinput:date name="gaMant" fn_month="E01ROCREM" fn_day="E01ROCRED" fn_year="E01ROCREY" readonly="FALSE" required="true"/>
            </td>
          </tr>
        </table>
      </TD>
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="28%" > 
              <input type="text" name="E01ROCEM1" size="3" maxlength="2" value="<%= gaMant.getE01ROCEM1().trim()%>" >
              <input type="text" name="E01ROCEM2" size="3" maxlength="2" value="<%= gaMant.getE01ROCEM2().trim()%>" >
              <input type="text" name="E01ROCEM3" size="5" maxlength="4" value="<%= gaMant.getE01ROCEM3().trim()%>" >
            </td>
            <td nowrap width="18%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="28%" > 
              <input type="text" name="E01ROCMD1" size="3" maxlength="2" value="<%= gaMant.getE01ROCMD1().trim()%>" >
              <input type="text" name="E01ROCMD2" size="3" maxlength="2" value="<%= gaMant.getE01ROCMD2().trim()%>" >
              <input type="text" name="E01ROCMD3" size="5" maxlength="4" value="<%= gaMant.getE01ROCMD3().trim()%>" >
            </td>
            <td nowrap width="18%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="37%" >
                ...
                <a href="javascript:GetCodeDescCNOFC('E01ROCUSC','E02ROCUSC','2A')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" width="18" height="22" ></a> 
              </td>
          </tr>
        </table>
      </td>
