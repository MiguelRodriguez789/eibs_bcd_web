...
<jsp:useBean id="autoriz" class="datapro.eibs.beans.EEJ005101Message"  scope="session" />
...
<body>
<h3 align="center">Consulta de Autorizaciones Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="special_autoriz_detail.jsp, EEJ0051"></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEEJ0051" >
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="60%">
              ...
              <input type="text" name="E01EJACUN" size="47" maxlength="45" value="<%= autoriz.getE01EJACUN() %>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%">
              <input type="text" name="E01EJAID1" size="3" maxlength="2" value="<%= autoriz.getE01EJAID1() %>" readonly>
              <input type="text" name="E01EJAID2" size="3" maxlength="2" value="<%= autoriz.getE01EJAID2() %>" readonly>
              <input type="text" name="E01EJAID3" size="5" maxlength="4" value="<%= autoriz.getE01EJAID3() %>" readonly>
              <input type="text" name="E01EJAITI" size="8" maxlength="6" value="<%= autoriz.getE01EJAITI() %>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%">
              <input type="text" name="E01EJARD1" size="3" maxlength="2" value="<%= autoriz.getE01EJARD1() %>" readonly>
              <input type="text" name="E01EJARD2" size="3" maxlength="2" value="<%= autoriz.getE01EJARD2() %>" readonly>
              <input type="text" name="E01EJARD3" size="5" maxlength="4" value="<%= autoriz.getE01EJARD3() %>" readonly>
              <input type="text" name="E01EJARTI" size="8" maxlength="6" value="<%= autoriz.getE01EJARTI() %>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
