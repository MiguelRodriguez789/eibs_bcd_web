...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_autoriz_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMTAut.getE06CUAAC1(),msgMTAut.getE06CUAAC2(),msgMTAut.getE06CUAAC3())  + " - " + msgMTAut.getE06CUAACT()%></TD>
