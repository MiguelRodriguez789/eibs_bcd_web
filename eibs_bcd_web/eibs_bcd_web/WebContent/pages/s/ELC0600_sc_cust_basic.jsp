...
<H3 align="center">Tabla de Gastos y Comisiones de Cartas de Crédito por Cliente<IMG 
	...
	name="EIBS_GIF" title="ELC0600_sc_cust_basic"></H3>
<HR size="4">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trclear"> 
            ...
            <TD nowrap  ><input type="text" name="E01RLCTCY" size="4" maxlength="3" value="<%= msg01.getE01RLCTCY().trim()%>" >
              <a href="javascript:GetCurrency('E01RLCTCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" border="0" ></a> </TD>
            ...
            <TD nowrap ><input type="text" name="E01RLCACY" size="4" maxlength="3" value="<%= msg01.getE01RLCACY().trim()%>" >
              <a href="javascript:GetCurrency('E01RLCACY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" border="0" ></a> </TD>
    </TR>
          <TR id="trdark"> 
            <TD align="right" nowrap  ><b>Número de Cliente :</b></TD>
            <TD nowrap  ><input type=HIDDEN name="OPT" value="<%= userPO.getPurpose()%>">
            <input type="text" name="E01RLCCUN2" size="10" maxlength="9" value="<%= msg01.getE01RLCCUN().trim()%>" readonly ></TD>
            <TD align="right" nowrap  ><b>Nombre del Cliente :</b></TD>
            <TD nowrap ><input type="text" name="E01CUSNME" size="48" maxlength="45" value="<%= msg01.getE01CUSNME().trim()%>" readonly></TD>
    </TR>
          <TR id="trclear">
        ...
        <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></A> </TD>
            <TD align="right" nowrap  ><b>Descripción :</b></TD>
            <TD nowrap ><input type="text" name="E01RLCDSC" size="48" maxlength="45" value="<%= msg01.getE01RLCDSC().trim()%>" ></TD>
          </TR>
</TABLE>
...
<BR>
	<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
			<tr id="trdark">
				...
				<TD nowrap width="143">
					<INPUT type="text" name="E01CPYATY" size="5" maxlength="4" value="">
	...
	<TBODY><TR id="trdark">
		...
		<TD nowrap align="center"><B>Aplica</B></TD>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCIFA" size="12" maxlength="11" value="<%= msg01.getE01RLCIFA().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCIBP" size="5" maxlength="4" value="<%= msg01.getE01RLCIBP().trim()%>" onkeypress="enterInteger(event)"></DIV>
					</TD>
					<TD nowrap>

					<DIV align="center"><INPUT type="text" name="E01RLCIMF" size="12" maxlength="11" value="<%= msg01.getE01RLCIMF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCIMX" size="12" maxlength="11" value="<%= msg01.getE01RLCIMX().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCIA2" size="12" maxlength="11" value="<%= msg01.getE01RLCIA2().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCIM2" size="12" maxlength="11" value="<%= msg01.getE01RLCIM2().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCIX2" size="12" maxlength="11" value="<%= msg01.getE01RLCIX2().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
		<TD nowrap></TD>
	</TR>
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCADF" size="12" maxlength="11" value="<%= msg01.getE01RLCADF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCFA" size="12" maxlength="11" value="<%= msg01.getE01RLCCFA().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					...
					<DIV align="center"><INPUT type="text" name="E01RLCCMF" size="12" maxlength="11" value="<%= msg01.getE01RLCCMF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCMX" size="12" maxlength="11" value="<%= msg01.getE01RLCCMX().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCC2" size="12" maxlength="11" value="<%= msg01.getE01RLCCC2().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					...
					<DIV align="center"><INPUT type="text" name="E01RLCCM2" size="12" maxlength="11" value="<%= msg01.getE01RLCCM2().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCX2" size="12" maxlength="11" value="<%= msg01.getE01RLCCX2().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
		<TD nowrap></TD>
	</TR>
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCEVF" size="12" maxlength="11" value="<%= msg01.getE01RLCEVF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCEMF" size="12" maxlength="11" value="<%= msg01.getE01RLCEMF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCEMX" size="12" maxlength="11" value="<%= msg01.getE01RLCEMX().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCAMF" size="12" maxlength="11" value="<%= msg01.getE01RLCAMF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCAAF" size="12" maxlength="11" value="<%= msg01.getE01RLCAAF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCDIF" size="12" maxlength="11" value="<%= msg01.getE01RLCDIF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCSPF" size="12" maxlength="11" value="<%= msg01.getE01RLCSPF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					...
					<TD nowrap></TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCSPM" size="12" maxlength="11" value="<%= msg01.getE01RLCSPM().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCSPX" size="12" maxlength="11" value="<%= msg01.getE01RLCSPX().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCACM" size="12" maxlength="11" value="<%= msg01.getE01RLCACM().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCAMX" size="12" maxlength="11" value="<%= msg01.getE01RLCAMX().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCDBP" size="5" maxlength="4" value="<%= msg01.getE01RLCDBP().trim()%>" onkeypress="enterInteger(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCDPM" size="12" maxlength="11" value="<%= msg01.getE01RLCDPM().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCDMX" size="12" maxlength="11" value="<%= msg01.getE01RLCDMX().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCNEF" size="12" maxlength="11" value="<%= msg01.getE01RLCNEF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					...
					<TD nowrap></TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCNMF" size="12" maxlength="11" value="<%= msg01.getE01RLCNMF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCNMX" size="12" maxlength="11" value="<%= msg01.getE01RLCNMX().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCAPF" size="12" maxlength="11" value="<%= msg01.getE01RLCAPF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					...
					<TD nowrap></TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCAPM" size="12" maxlength="11" value="<%= msg01.getE01RLCAPM().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCAPX" size="12" maxlength="11" value="<%= msg01.getE01RLCAPX().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCTRA" size="12" maxlength="11" value="<%= msg01.getE01RLCTRA().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					...
					<TD nowrap></TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCTMF" size="12" maxlength="11" value="<%= msg01.getE01RLCTMF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCTMX" size="12" maxlength="11" value="<%= msg01.getE01RLCTMX().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCPST" size="12" maxlength="11" value="<%= msg01.getE01RLCPST().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCOU" size="12" maxlength="11" value="<%= msg01.getE01RLCCOU().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCAN" size="12" maxlength="11" value="<%= msg01.getE01RLCCAN().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCNOF" size="12" maxlength="11" value="<%= msg01.getE01RLCNOF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCWTF" size="12" maxlength="11" value="<%= msg01.getE01RLCWTF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCTF" size="12" maxlength="11" value="<%= msg01.getE01RLCCTF().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCTM" size="12" maxlength="11" value="<%= msg01.getE01RLCCTM().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trclear">
					...
					<TD nowrap></TD>
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCA3" size="12" maxlength="11" value="<%= msg01.getE01RLCCA3().trim()%>" onKeyPress="return enterDecimalNum(event)"></DIV>
					</TD>
					<TD nowrap>
		...
		<SELECT name="<%=field%>"> 
			...
			<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Siempre</OPTION>
				...
				<TR id="trdark">
					...
					<TD nowrap>
					<DIV align="center"><INPUT type="text" name="E01RLCCA2" size="12" maxlength="11" value="<%= msg01.getE01RLCCA2().trim()%>" onKeyPress="enterDecimal(event)"></DIV>
					</TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
					<TD nowrap></TD>
