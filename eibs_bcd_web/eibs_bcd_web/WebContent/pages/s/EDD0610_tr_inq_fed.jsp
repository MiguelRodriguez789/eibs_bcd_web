...
<h3 align="center">Docuemnto Fed<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="EDD0610_tr_inq_fed.jsp"></h3>
<hr size="4" width="100%">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trdark"> 
            ...
            <td nowrap width="8%" > 
				<eibsinput:date name="inqFed" fn_year="E02INSDTY" fn_month="E02INSDTM" fn_day="E02INSDTD" readonly="true"/>
            </td>
            <td nowrap width="10%" > 
