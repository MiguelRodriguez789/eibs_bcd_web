...
<html>
<head>
<title>Aprobación Cobro de Comisiones Manuales</title>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=ISO-8859-1">
<link Href="<%=request.getContextPath()%>/pages/style.css" rel="stylesheet">

<jsp:useBean id= "ESD0204Help" class= "datapro.eibs.beans.JBObjList"  scope="session" />
...
<BODY>
<h3 align="center">Aprobación Cobro de Comisiones Manuales
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="manual_fees_approval.jsp,ESD0204"></h3>
<hr size="4">
<form name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSESD0204" >
          	...
          	ESD0204Help.initRow();
				indexRow = 0;
          		...
          		while (ESD0204Help.getNextRow()) {
          			...
          			ESD020401Message list = (ESD020401Message) ESD0204Help.getRecord();
          %>
			<tr id="dataTable<%=ESD0204Help.getCurrentRow()%>">
				<td nowrap align="center" width="5%"> <input type="radio" name="key" value="<%=ESD0204Help.getCurrentRow()%>" <%=chk%>
					class="highlight" onClick="highlightRow('dataTable', <%=ESD0204Help.getCurrentRow()%>)" /></td>
				...
				<td nowrap align="center" width="10%"><%= Util.formatCustomDate(currUser.getE01DTF(),list.getBigDecimalE01CACRDM().intValue(),list.getBigDecimalE01CACRDD().intValue(),list.getBigDecimalE01CACRDY().intValue())%></td>
