...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="settlement_inq_enter.jsp, ECD0015"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trdark">
            ...
            <TD nowrap width="25%"> 
              <DIV align="left"> 
                <INPUT type="text" name="E01CCRDDE" size="3" maxlength="2" value="" onkeypress="enterInteger(event)">
                <INPUT type="text" name="E01CCRMDE" size="3" maxlength="2" value="" onkeypress="enterInteger(event)">
                <INPUT type="text" name="E01CCRADE" size="5" maxlength="4" value="" onkeypress="enterInteger(event)">
              </DIV>
            </TD>
            <TD nowrap width="25%"> 
            ...
            <TD nowrap width="25%"> 
              <DIV align="left"> 
                <INPUT type="text" name="E01CCRDDH" size="3" maxlength="2" value="" onkeypress="enterInteger(event)">
                <INPUT type="text" name="E01CCRMDH" size="3" maxlength="2" value="" onkeypress="enterInteger(event)">
                <INPUT type="text" name="E01CCRADH" size="5" maxlength="4" value="" onkeypress="enterInteger(event)">
              </DIV>
            </TD>
          </TR>
         </TBODY></TABLE>
