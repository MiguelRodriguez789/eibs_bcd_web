...
<HTML>
<HEAD>
<TITLE>Estadisticas de Comisiones Garantias Navieras</TITLE>
...
<H3 align="center">Estadísticas de Comisiones de Garantias Navieras<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="nv_stats_commissions_nav.jsp, ELC0900"></H3>
<HR size="4">
...
<INPUT TYPE=HIDDEN NAME="E02LCYTYP" VALUE="N">
<INPUT TYPE=HIDDEN NAME="E02LCYACD" VALUE="45">

<h4>Estadisticas de Comisiones de Garantias Navieras</h4>
          ...
          <tr id="trclear">
            ...
            <td width="70%" nowrap>
				<SELECT name="E02LCYACD">
					...
					<OPTION value="51">Documentaria</OPTION>
				</SELECT>
            </td>
          </tr>
          <tr id="trdark">
