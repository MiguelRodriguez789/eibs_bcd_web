...
<form >
  <table width="650" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td>
        <div align="center"><img src="<%=request.getContextPath()%>/images/logo.gif" title="DATAPRO, INC" align="bottom" border="0" height="32" ></div>
      </td>
    </tr>
  </table>
      ...
      <td> 
        ...
        <table width="650" border="0" cellspacing="0" cellpadding="3" id="celdas">
          ...
          <tr> 
            ...
            <td width="102"><%= client.getE10IDN().trim()%></td>
