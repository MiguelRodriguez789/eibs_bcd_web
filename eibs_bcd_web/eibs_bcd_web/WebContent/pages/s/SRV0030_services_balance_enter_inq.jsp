...
<H3 align="center">Mantenimiento de Balances - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_balance_enter_inq,SRV0030"></H3>
<hr size="4">
<p>&nbsp;</p>
     	...
     	<tr id=trdark> 
		  <td> 
	        ...
	        <input type="text" name="E01BALCIN" size="40" maxlength="35" readonly value="<%= msgMT.getE01BALCIN() %>">
	      	<a href="javascript:GetCodeDescCNOFC('E01BALCIA','E01BALCIN','YP')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		  ...
		  <td> 
	        ...
	        <a href="javascript:GetCodeService('E01BALSRV','E01BALSRN',document.forms[0].E01BALCIA.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
	        <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
	      </td>     
      	</tr>
      	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E01BALSEQ" size="6" maxlength="5" value="<%= msgMT.getE01BALSEQ() %>" onkeypress="enterInteger(event)">
      	    <a href="javascript:GetSequence('E01BALSEQ',document.forms[0].E01BALCIA.value,document.forms[0].E01BALSRV.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
      	  </td>
      	</tr>
      	<tr id=trdark> 
		  <td> 
