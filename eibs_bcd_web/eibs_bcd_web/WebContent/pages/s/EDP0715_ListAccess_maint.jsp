...
<BODY>
<h3 align="center">Autorizar Usuario a Ruta-Actividad <br>
  Usario : <span style="font-style: italic; text-decoration: underline;"> <%= userPO.getHeader10().trim()%> </span>  
  &nbsp; Ruta : <span style="font-style: italic; text-decoration: underline;"> <%= userPO.getHeader9().trim()%> </span>
