...
<h3 align="center">Comisiones de Cartas de Credito<img
	...
	name="EIBS_GIF" title="letter_of_credit_commissi.jsp,ELC0525"></h3>
<hr size="4">
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0"
			...
			<tr id="trclear">
				...
				<div align="left"><INPUT type="text" name="E04LCMBNK0" readonly
					...
					value="<%=lcComm.getE04LCMIDM()
	+ "/"
	+ lcComm.getE04LCMIDD()
	+ "/"
	+ (lcComm.getE04LCMIDY().length() == 1
		? "0" + lcComm.getE04LCMIDY()
		: lcComm.getE04LCMIDY())%>"></div>
				</td>
				<td nowrap width="16%">
			...
			<tr id="trclear">
				...
				<div align="left"><INPUT type="text" name="E04LCMBNK0" readonly
					size="10" maxlength="10"
					value="<%=lcComm.getE04LCMEXM()
	+ "/"
	+ lcComm.getE04LCMEXD()
	+ "/"
	+ (lcComm.getE04LCMEXY().length() == 1
		? "0" + lcComm.getE04LCMEXY()
		: lcComm.getE04LCMEXY())%>"></div>
				</td>
				<td nowrap width="16%">
