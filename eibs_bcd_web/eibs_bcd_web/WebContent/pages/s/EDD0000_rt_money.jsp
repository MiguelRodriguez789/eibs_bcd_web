...
<H3 align="center">P&aacute;rametros - Prevenci&oacute;n Legitimaci&oacute;n de Capitales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_money, EDD0000"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left">
                <input type="text" name="E06LDMCUN" size="9" maxlength="9" value="<%= userPO.getCusNum().trim()%>">
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"><font face="Arial"><font face="Arial"><font size="2">
                <input type="text" name="E06CUSNA1" size="45" maxlength="45" value="<%= userPO.getCusName().trim()%>">
                </font></font></font></div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left">
                <input type="text" name="E06LDMACC" size="12" maxlength="12" value="<%= userPO.getAccNum().trim()%>">
              </div>
            </td>
            <td nowrap width="16%"> 
            ...
            <td nowrap width="16%"> 
              <div align="left"><b>
                <input type="text" name="E06LDMPRO" size="4" maxlength="4" value="<%= userPO.getProdCode().trim()%>">
                </b> </div>
            </td>
          </tr>
        </table>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="62%"> 
			  ...
			  <a href="javascript:GetProfileTable('E06LDMPRF','E06DSCPRF')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a> 
            </td>
          </tr>
        </table>
      </td>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="33%"> 
              <div align="right">Dep&oacute;sitos Efectivo</div>
				...
				<td nowrap width="11%"> 
              <div align="left"> 
                <input type="text" name="E06LDMCDP" size="5" maxlength="5" value="<%= rtMoney.getE06LDMCDP().trim()%>" onKeypress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="22%"> 
              <div align="left"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="33%"> 
              <div align="right">Dep&oacute;sitos Otros</div>
				...
				<td nowrap width="11%"> 
              <div align="left"> 
                <input type="text" name="E06LDMKDP" size="5" maxlength="5" value="<%= rtMoney.getE06LDMKDP().trim()%>" onKeypress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="22%"> 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap height="23" width="33%"> 
              ...
              <div align="left"> 
                <input type="text" name="E06LDMCWD" size="5" maxlength="5" value="<%= rtMoney.getE06LDMCWD().trim()%>" onKeypress="enterInteger(event)"></div>
            </td>
          ...
          <tr id="trdark"> 
            <td nowrap height="19" width="33%"> 
              ...
              <div align="left"> 
                <input type="text" name="E06LDMCPY" size="5" maxlength="5" value="<%= rtMoney.getE06LDMCPY().trim()%>" onKeypress="enterInteger(event)">
              </div>
            </td>
          ...
          <tr id="trclear"> 
            <td nowrap height="19" width="33%"> 
              <div align="right">Transferencias Emitidas</div>
				...
				<td nowrap height="19" width="11%"> 
              <div align="left"> 
                <input type="text" name="E06LDMTIN" size="5" maxlength="5" value="<%= rtMoney.getE06LDMTIN().trim()%>" onKeypress="enterInteger(event)">
              </div>
            </td>
            <td nowrap height="19" width="22%"> 
              <div align="left"> 
          ...
          <tr id="trdark"> 
            <td nowrap height="19" width="33%"> 
              <div align="right">Transferencias Recibidas</div>
				...
				<td nowrap height="19" width="11%"> 
              <div align="left"> 
                <input type="text" name="E06LDMTRV" size="5" maxlength="5" value="<%= rtMoney.getE06LDMTRV().trim()%>" onKeypress="enterInteger(event)">
              </div>
            </td>
            <td nowrap height="19" width="22%"> 
              <div align="left"> 
