    ...
    <table cellspacing="0" cellpadding="2" class="tbenter"  border=0  width=70% align="center" >
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=40% align="left"> 
            <input type=TEXT name="E01IFMCUN" value="<%= clientFnl.getE01IFMCUN() %>" size=15 maxlength=9 onKeypress="enterInteger(event)">
            <a href="javascript:GetCustomerCorp('E01IFMCUN','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="middle" border="0" ></a> 
        </td>
      </tr>
      <tr valign="middle"> 
        <td nowrap width=40% align="right" > 
        ...
        <td nowrap width=40% align="left">  
            <input type=TEXT name="E01IFMFEY" value="<%= clientFnl.getE01IFMFEY() %>" size=5 maxlength=4 onKeypress="enterInteger(event)">
            <input type=TEXT name="E01IFMFEM" value="<%= clientFnl.getE01IFMFEM() %>" size=3 maxlength=2 onKeypress="enterInteger(event)"> 
        </td>
      </tr>
      <tr valign="middle"> 
        <td nowrap width=40% align="right" > 
