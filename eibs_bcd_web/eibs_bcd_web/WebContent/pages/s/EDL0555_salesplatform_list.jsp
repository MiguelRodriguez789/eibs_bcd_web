...
<jsp:useBean id="msgHeader" class= "datapro.eibs.beans.EDL055501Message"  scope="session" />
...
<h3 align="center">Ingreso de Negociacion de Creditos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="salesplatform_list.jsp,EDL0555"></h3>
<hr size="4">
...
<input type="hidden" id="TYPE" name="TYPE" value=""> 
  ...
  <table  class="tableinfo" style="width: 100%;">
    <tr>   
      <td nowrap> 
        <table width="100%" >
          <tr id="trdark">
            <td nowrap align="center"> Cliente:
              <eibsinput:text name="msgHeader" property="E01CUSCUN" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CUSTOMER %>" readonly="true"/>
              <eibsinput:text name="msgHeader" property="E01CUSNA1" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME_FULL %>" readonly="true"/>
            </td>
          </tr>
        </table>
      </td>
  ...
  <table class="tbenter" style="width: 100%;">
    <tr>
      ...
      <td align="center" class="tdbkg" width="33%"><a href="javascript:goAction('201')"><b>Crear</b></a></td>
      <td align="center" class="tdbkg" width="33%"><a href="javascript:goAction('202')"><b>Modificar</b> </a></td>
      <td align="center" class="tdbkg" width="33%"><a href="javascript:goAction('204')"><b>Borrar</b> </a></td>
      <% } else  {%>
      <td align="center" class="tdbkg" width="100%"><a href="javascript:goAction('201')"><b>Crear</b></a></td>
      <% } %>
    </tr>
  </table>
        ...
        <div id="dataDiv1"  style="height:360px; overflow:auto;"> 
          ...
          %>
            <tr id="dataTable<%= msgList.getCurrentRow() %>">
              ...
              <td nowrap align="center" width="10%"><a href="javascript:goAction('202',<%=msgList.getCurrentRow()%>);"><%=list.getE02DLNOFN()%></a></td>
              <td nowrap align="center" width="10%"><a href="javascript:goAction('202',<%=msgList.getCurrentRow()%>);"><%=list.getE02SELCUN()%></a></td>
              <td nowrap align="left" width="40%"><a href="javascript:goAction('202',<%=msgList.getCurrentRow()%>);"><%=list.getE02DSCPRO()%></a></td>
              <td nowrap align="center" width="10%"><a href="javascript:goAction('202',<%=msgList.getCurrentRow()%>);">
              <%= Util.formatCustomDate(currUser.getE01DTF(), list.getBigDecimalE02DLNODM().intValue(), 
                  list.getBigDecimalE02DLNODD().intValue(),
                  list.getBigDecimalE02DLNODY().intValue()) %></a></td>
              <td nowrap align="center" width="10%"><a href="javascript:goAction('202',<%=msgList.getCurrentRow()%>);"><% if (list.getField("E02DLNSTS").getString().equals("")) {
																		...
																		} else if (list.getField("E02DLNSTS").getString().equals("W")) {
																					out.print(Util.formatCell("Completado"));	
