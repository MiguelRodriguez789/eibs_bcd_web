...
<BR>Recepci&oacute;n
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_request_reception.jsp, ECD0001">
</h3>
<hr size="4">
<% 
	      ...
	      <tr id="trclear"> 
	        ...
	        <td align=CENTER width="34%"> 
	          <div align="left"> 
	            ...
	            <input type="text" name="E01CDRYEX"  size="5" maxlength="4" value="<%= msgCD.getE01CDRYEX() %>" readonly >
	            (Mes/A&ntilde;o) 
	          </div>
	        </td>
