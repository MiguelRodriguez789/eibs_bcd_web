...
<H3 align="center">Mantenimiento Grupos de Usuario<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="user_group_maint_enter, ESS0130"></H3>
  ...
  <table class="tbenter"  width="100%" border="0">
    <tr> 
      <td nowrap ALIGN=CENTER> 
        Codigo de Grupo : 
        <INPUT type="text" name="E01USEUID" size="12" maxlength="10" >
        <a href="javascript:GetGroupId('E01USEUID')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a> 
      </td>
    </tr>       
  </table>
