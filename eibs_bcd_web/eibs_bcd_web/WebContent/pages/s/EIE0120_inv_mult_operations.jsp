...
%>
<div align="center"> 
  <h3>M&uacute;ltiple Orden de Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_mult_operations.jsp,EIE0120"> 
  </h3>
</div>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td nowrap width="31%" > 
              <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].E01ORDIIC.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" title="help" align="bottom" border="0" > 
                Instrumento :</a> </div>
            </td>
            <td nowrap colspan="5" > 
              <div align="left"> </div>
              <div align="left"> 
                ...
                <a href="javascript:GetInstrumentParams('E01ORDIIC','E01ORDICN','E01ORDSCY','','E01ORDISI','','E01ORDPTY')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a> 
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="5" > 
              <div align="left"> 
                <input type="text" name="E01ORDCUC" size="5" maxlength="4" value="<%= invTrade.getE01ORDCUC()%>" >
