...
%> 
<h3 align="center"> Consulta - Forward <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_forward.jsp,EFE0120I"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2"> 
			  ...
			  >
              <input type="text" readonly  name="E01FESVD3" size="5" maxlength="4" value="<%= fex.getE01FESVD3().trim()%>" 
			  >
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap colspan="4" > 
              <input type="text" readonly  name="E01FESOTS" size="70" maxlength="60" value="<%= fex.getE01FESOTS().trim()%>" >
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
            ...
            <td nowrap colspan="4" > 
              <input type="text" readonly  name="E01FESCIS" size="70" maxlength="60" value="<%= fex.getE01FESCIS().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
      ...
      <td nowrap> 
        <table width="100%">
          <tr id="trdark"> 
            ...
            <td nowrap width="4%" ><%= Util.fcolorCCY(fex.getD01YTDBAL())%> </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap  colspan="2"> 
            ...
            <td nowrap width="4%" ><%= Util.fcolorCCY(fex.getD01TOTPUR())%> </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap colspan="2"> 
            ...
            <td nowrap width="4%" ><%= Util.fcolorCCY(fex.getD01TOTSAL())%> </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap  colspan="2"> 
            ...
            <td nowrap width="4%" ><%= Util.fcolorCCY(fex.getD01POSBAL())%> </td>
          </tr>
        </table>
      </td>
    </tr>
