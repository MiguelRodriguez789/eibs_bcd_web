...
<H3 align="center">Consulta de Solicitudes de Canje de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0333"></H3>
<hr size="4">
