...
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL9140" >
<INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="2">
<INPUT TYPE=HIDDEN NAME="action" VALUE="A">
<INPUT TYPE=HIDDEN NAME="reason" VALUE="">
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  <h3 align="center"> Aprobación de Tesorer&iacute;a</h3>
<hr size="4">
 ...
 <TR> 
  ...
  <TR id="trdark"> 
    ...
    <TH ALIGN=CENTER colspan="2"  nowrap>Cliente</TH>
            <TH ALIGN=CENTER rowspan="2"  nowrap>Tasa</TH>
  </TR>
  <TR id="trdark"> 
   ...
   <TD nowrap ALIGN="RIGHT" valign="top">
     ...
     <Table id="tbAddInfo" >
      <tr id="trclear">
         <TD ALIGN="RIGHT" align="center" nowrap><b>Comentario : <br>Principal : <br>Moneda : <br>Banco : <br>Sucursal : <br>Mayor General : <br>Centro de Costo : <br>Lote :<br>Operador : </b></TD>
