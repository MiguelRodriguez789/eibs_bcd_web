...
<h3 align="center">Mantenimiento de Porcentaje de Incidencia en Linea Financiera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cl_maint, ELN0115"> 
</h3>
<hr>
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter" border=0   width=70% align="center" height="80%">
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=40% align="left" height="24" > 
          <input type="text" name="BANK" size="4" maxlength="9" onKeyPress="enterInteger(event)" value="<%= inc.getE01FLUBNK()%>" readonly>
        </td>
      </tr>
      <tr valign="middle"> 
