...
{
	page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSECD0011?SCREEN=20&ROW=" + rowNum;
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_audit_list.jsp, ECD0011"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input readonly type="text" name="E01TDDTDD" size="17" maxlength="20" value="<%= userPO.getHeader7() %>">
              </div>
            </td>
            <td nowrap width="16%" > 
            </td>
 ...
 <TR > 
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="20%"><div align="center">Fecha</div></th>
        ...
        <TR>
			<TD NOWRAP ALIGN="CENTER">
				...
				<%= Util.formatCustomDate( currUser.getE01DTF(), msgPart.getE01TDDMON(), msgPart.getE01TDDDAY(),msgPart.getE01TDDYEA()) %></a>
			</TD>
			<TD NOWRAP ALIGN="CENTER">
				<a href="javascript:getDetail('<%= audList.getCurrentRow() %>')">
