...
<h3 align="center">Crear Prospecto<img
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="prospect_enter_new, ESD1080"></h3>
<hr size="4">

<form name="forma" method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD1080">
<INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="2">
<INPUT TYPE=HIDDEN NAME="OPE" VALUE="20">
...
<table class="tableinfo">
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trclear">
				<td nowrap align="right" valign="middle" width="15%">Tipo de Prospecto :</td>
				<td colspan="3">
				<p>
