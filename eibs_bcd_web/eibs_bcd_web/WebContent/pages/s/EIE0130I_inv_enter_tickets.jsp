...
%>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0309" >
  ...
  <h3 align="center">Consulta Orden de Compra - Venta</h3>
                ...
                <tr id="trclear"> 
                  ...
                  <td width="73%" nowrap> 
                    <input type="text" name="CUSTOMER"  size=9 maxlength="9" 
						onChange="document.forms[0].SEARCHC.value='C'">
                ...
                <tr id="trclear"> 
                  ...
                  <td nowrap width="73%" > 
                    <select name="TRANSTYPE">
                      ...
                      <option value="5">Compra Múltiple</option>
                      <option value="6">Venta Múltiple</option>
                    </select>
                  </td>
                </tr>
                <tr id="trclear"> 
