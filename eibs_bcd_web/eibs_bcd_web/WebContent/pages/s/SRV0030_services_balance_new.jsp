...
<H3 align="center">Creacion de Balances - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_balance_new,SRV0030"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	<tr id=trdark> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01BALSEQ" size="6" maxlength="5" value="<%= msgBal.getE01BALSEQ() %>" onkeypress="enterInteger(event)">
	      </td>
     	</tr>    
     	<tr id=trclear> 
	      <td nowrap width="20%"> 
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01BALBD1" size="3" maxlength="2" value="<%= msgBal.getE01BALBD1() %>" onkeypress="enterInteger(event)">
	      	<input type="text" name="E01BALBD2" size="3" maxlength="2" value="<%= msgBal.getE01BALBD2() %>" onkeypress="enterInteger(event)">
	      	<input type="text" name="E01BALBD3" size="5" maxlength="4" value="<%= msgBal.getE01BALBD3() %>" onkeypress="enterInteger(event)">
	      	<a href="javascript:DatePicker(document.forms[0].E01BALBD1,document.forms[0].E01BALBD2,document.forms[0].E01BALBD3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title=". . ." align="bottom" border="0" ></a>
	      </td>
     	</tr>
     </table>
    </td>
