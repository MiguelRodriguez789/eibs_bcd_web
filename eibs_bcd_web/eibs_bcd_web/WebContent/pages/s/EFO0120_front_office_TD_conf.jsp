...
<head> 
<title>Front Office - Confirmación de Certificado de Déposito</title>
...
<h3>From Office - <%=userPO.getHeader1()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="front_office_TD_conf.jsp,EFO0120"></h3>
</div>
<hr size="4">
		...
		<TABLE width="100%" border="0">
			<TBODY>
				...
				<TR id="trintro">
					...
					<FONT color="red">Cuenta donde se recibirá el Capital y/o Interes.</FONT></TD>
				</TR>
			</TABLE>
...
<TR>
			...
			<TR>
				<TD width="50%" align="right" height="40" valign="middle">Términos :</TD>
				<TD align="left" width="50%" height="40" valign="middle">
			...
			<TR>
				<TD width="50%" align="right" height="40" valign="middle">Instrucciones de Renovación :</TD>
				<TD align="left" width="50%" height="40" valign="middle">
