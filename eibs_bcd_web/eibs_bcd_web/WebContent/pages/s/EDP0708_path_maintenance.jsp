...
<H3 align="center">Mantenimiento Ruta y Detalle : <span style="font-style: italic;"> <%= userPO.getHeader10().trim()%> </span>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="path_maintenance.jsp, EDP0708"></H3>
...
--%>
							<tr id="trclear">
								...
								<SELECT name="E01DPPFG3"
	    								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>	
										<OPTION value="" 
											<%if (brnDetails.getE01DPPFG3().equals("")) { out.print("selected"); }%>>Valida Documentos</OPTION>
										<OPTION value="1"
											<%if (brnDetails.getE01DPPFG3().equals("1")) { out.print("selected"); }%>>NO Valida Documentos</OPTION>
										</SELECT>
								</td>
							</tr>
      ...
      <td nowrap> 
		...
		<TABLE id="tbenter" align="center" style="width: 100%" border="0">
							...
							<TR id="trclear">
								...
								<TD nowrap width="20%">
										<input type="button" value="Seleccionar >" class="styled-button-Search " style="font-style: italic;" onclick="moveOver();" 
										<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>								
										<BR>	
										<BR>								
										<input type="button" value="< Remover "  class="styled-button-Search " style="font-style: italic;" onclick="removeMe();" 
										<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>								
										<BR>
								</TD>
								<TD nowrap width="40%">
...
<div align="center"> 
 ...
 <script type="text/javascript">
	...
	$().ready(function(){
		$('select[name="available"]').each(function(index,field){
	        $(this).dblclick(moveOver); //Double Clicks, indicates selection. Adds the variable to formula on the right hand side. 
	    });	
	});
</script>
</html>