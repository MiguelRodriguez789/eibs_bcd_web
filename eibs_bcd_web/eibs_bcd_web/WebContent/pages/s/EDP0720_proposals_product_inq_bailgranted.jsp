...
<SCRIPT type="text/javascript">
	...
	function ProcAgricola(value) {
   		if (isValidObject(document.getElementById("SecAgricola"))) 
   			document.getElementById("SecAgricola").style.display = value ? "none" : "";
	}
...
<h3 align="center">Detalle del Producto
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="proposals_product_inq_bailgranted.jsp,EDP0720"></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0720" >
   ...
   <TABLE id="headTable" width="100%" cellspacing=0>
    <tr id="trdark"> 
      <td align="right"  >
         <b>Cliente :</b>
      </td>
   	...
   	<tr >      
    	<td width="1126">
      		<table cellspacing="0" cellpadding="0" width="100%" border="0" id="opTable">
				<TR id="trclear">
			   		<TD width="15%" align="right"><DIV >Producto:</DIV></TD>
		        	<td nowrap width=20% align="left"> 
		            	<input type=TEXT name="E01PLTPRO" size="6" maxlength="4" value="<%= msgList.getE01PLTPRO().trim()%>" readonly>
		        	</td>
					<TD width="20%" align="left">  
				  		Tipo: <INPUT type="text" name="E01PLTTYP" size="5" maxlength="4" value="<%= msgList.getE01PLTTYP().trim()%>" readonly>	  
	            	</TD>		
					<td nowrap width="20%" align="left">
   ...
   <table class="tableinfo">
<% 
	String readonly = "3".equals(msgRT.getH01FLGWK3()) ? "readonly" : ""; 
	String disabled = "3".equals(msgRT.getH01FLGWK3()) ? "disabled" : "";
      ...
      <tr > 
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr id="trclear">
					<td width="20%" align="left"><div>Numero Referencia IBS:</div></td>
					<td  width="50%" align="left">
        	        	<INPUT type="text" name="E01PLTRE1" size="13" maxlength="12" value="<%= msgList.getE01PLTRE1().trim()%>" <%= readonly %> onkeypress="enterInteger(event)">
	  	 ...
	  	 <td width="1126">
	  	 	<table cellspacing="0" cellpadding="0" width="100%" border="0">
				  ...
				  <% if (msgRTC.getE02DPJF00().equals("1")) { %>
				    <td width="20%"><div align="left">Monto Solicitado:</div></td>
				    <td width="20%" align="left">
				    	<INPUT type="text" name="E01PLTAMN" size="20" maxlength="20" value="<%= msgList.getE01PLTAMN().trim()%>" <%= readonly %> onkeypress="enterInteger(event)">
				    </td>  
				  <% } %>
                  <% if(msgRTC.getE02DPJF01().equals("1")) { %>
				    <td width="10%" align="left"><div >Moneda :</div></td>
				    <td width="20%" align="left">
			              <input type="text" name="E01PLTCCY" size="5" maxlength="4" value="<%= msgList.getE01PLTCCY().trim()%>" <%= readonly %>>
					 	  <% if (!msgRT.getH01FLGWK3().equals("3")) { %>
...
<% if((msgRTC.getE02DPJF04().equals("1"))) { %>
      <tr > 
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
		   		<tr id="trclear">
				  	<td width="20%" align="right"><div align="left">Destino de Fondos :</div></td>
				  	<td nowrap width="50%" align="left">
			              <input type="text" name="E01PLTDST" size="5" maxlength="4" value="<%= msgList.getE01PLTDST().trim()%>"  <%= readonly %>>
					 	  <% if(!msgRT.getH01FLGWK3().equals("3")) { %>
...
<% if((msgRTC.getE02DPJC00().equals("1"))){ %>
      <tr > 
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
		   		<tr id="trclear">
					<td width="20%" align="right"><div align="left">Coment. Destino Fondos:</div></td>
					<td width="50%" align="left">
					  <TEXTAREA name="E02DPAC00" rows="5" cols="70" <%= readonly %>>
					  	<%= msgRTC.getE02DPAC00().trim()%>
					  </TEXTAREA>
       				</td>
			</tr>	
		</table>
...
<% if((msgRTC.getE02DPJF07().equals("1"))) { %>
      <tr > 
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr id="trclear" >
					<td width="20%" align="left"><div >Plazo/Tiempo:</div></td>
					<td width="50%" align="left">
        	        	<INPUT type="text" name="E01PLTPLZ" size="4" maxlength="3" value="<%= msgList.getE01PLTPLZ().trim()%>" <%=readonly %> onkeypress="enterInteger(event)">
						<SELECT name="E01PLTUPL" <%= disabled %>>
							<OPTION value=""></OPTION>
							<OPTION value="1"
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr id="trclear" >
					...
					<td nowrap align="left" width="50%">
						<TEXTAREA name="E02DPAC01" rows="5" cols="70" <%= readonly %>>
							<%= msgRTC.getE02DPAC01().trim()%>
						</TEXTAREA>
					</td>
				</tr>
			</table>
...
<% if((msgRTC.getE02DPJC02().equals("1"))) { %>
	<tr > 
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
      			<tr id="trclear" > 
					<td nowrap align="left" width="20%">Especifique otra forma de Plazo:</td>
					<td nowrap align="left" width="50%">
						<TEXTAREA name="E02DPAC02" rows="5" cols="70" <%= readonly %>>
							<%= msgRTC.getE02DPAC02().trim()%>
						</TEXTAREA>
					</td>
				</tr>
			</table>
...
<% if((msgRTC.getE02DPJF06().equals("1"))) { %>
      <tr > 
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr id="trclear">
					<td width="20%" align="left"><div>Forma de pago - Capital:</div></td>
					<td width="50%" align="left">
						<SELECT name="E01PLTCCA" onchange="selK();" <%= disabled %>>
							<OPTION value=""></OPTION>
							<OPTION value="2"
        ...
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr id="trclear">
					<td nowrap align="left" width="20%">Comentarios:</td>
					<td nowrap align="left" width="50%">
						<TEXTAREA name="E02DPAC03" rows="5" cols="70" <%= readonly %>>
							<%= msgRTC.getE02DPAC03().trim()%>
						</TEXTAREA>
					</td>
				</tr>
			</table>
...
<% if(msgRTC.getE02DPJC04().equals("1")) { %>
      <tr > 
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr id="trclear">
					<td nowrap align="left" width="20%">Especifique otra forma Pago Cap.:</td>
					<td nowrap align="left" width="50%">
						<TEXTAREA name="E02DPAC04" rows="5" cols="70" <%= readonly %>>
							<%= msgRTC.getE02DPAC04().trim()%>
						</TEXTAREA>
					</td>
				</tr>
			</table>
...
<% if((msgRTC.getE02DPJF08().equals("1"))) { %>
      <TR>
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr id="trclear">
					<td width="20%" align="left"><div>Forma de pago - Interes:</div></td>
					<td width="50%" align="left">
				  		<SELECT name="E01PLTCIN" <%= disabled %>>
							<OPTION value=""></OPTION>
							<OPTION value="2"
        ...
        <td width="1126">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr id="trclear">
					<td nowrap align="left" width="20%">Comentarios:</td>
					<td nowrap align="left" width="50%">
				  		<TEXTAREA name="E02DPAC05" rows="5" cols="70" <%= readonly %>>
				  			<%= msgRTC.getE02DPAC05().trim()%>
				  		</TEXTAREA>
					</td>
				</tr>
			</table>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td align="left" width="15%">
        	        <INPUT type="text" name="E01PLTNC1" size="4" maxlength="3" value="<%= msgList.getE01PLTNC1().trim()%>" <%= readonly %> onkeypress="enterInteger(event)">               
				</td>
				<td nowrap align="right" width="20%">
					<div>Frecuencia Cuotas Plan 1:</div>
				</td>
				<td align="left" width="15%">
				<SELECT name="E01PLTFPX" <%= disabled %>>
					<OPTION value=""></OPTION>
      ...
      <tr> 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<INPUT type="text" name="E01PLTNC2" size="4" maxlength="3" value="<%= msgList.getE01PLTNC2().trim()%>" <%= readonly %> onkeypress="enterInteger(event)">
				</td>
				...
				<td align="left" width="15%">
    				<SELECT name="E01PLTFPY" <%= disabled %>>
					<OPTION value=""></OPTION>
						<%if (msgRTC.getE02PLJMAT().substring(0,1).equals("1") ) { %> 
					<OPTION value="2"
			...
			<tr id="trclear">
				  <td width="20%" align="left">
				   ...
				   <td align="left" width="30%">
				      	<INPUT type="text" name="E01PLTTFO" size="4" maxlength="3" <%= readonly %>>
   	...
   	<% if(msgRTC.getE02DPJC06().equals("1")){%>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td nowrap align="left" width="50%">
				<TEXTAREA name="E02DPAC06" rows="5" cols="70" <%= readonly %>>
					<%= msgRTC.getE02DPAC06().trim()%>
				</TEXTAREA>
				</td>
			</tr>
		</table>
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td width="50%" align="left">
				<SELECT name="E01PLTCBI" <%= disabled %>>
					<OPTION value=""></OPTION>
					<OPTION value="1"
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td width="50%" align="left">
				  <TEXTAREA name="E02DPAC11" rows="5" cols="70" <%= readonly %>><%= msgRTC.getE02DPAC11().trim()%></TEXTAREA>
				</td>
			</tr>
		</table>
		</td>
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td width="50%" align="left">
				  <TEXTAREA name="E02DPAC12" rows="5" cols="70" <%= readonly %>><%= msgRTC.getE02DPAC12().trim()%></TEXTAREA>
				</td>
			</tr>
		</table>
		</td>
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td width="50%" align="left">
				   <TEXTAREA name="E02DPAC13" rows="5" cols="70" <%= readonly %>><%= msgRTC.getE02DPAC13().trim()%></TEXTAREA>
				</td>
			</tr>
		</table>
		</td>
    		  ...
    		  <% if(msgRTC.getE02DPJF10().equals("1")){%>
				...
				<td width="15%" align="left">
				   <INPUT type="TEXT" name="E01PLTRTE" size="12" maxlength="10"
					value="<%= msgList.getE01PLTRTE().trim()%>" <%= readonly %> onkeypress="enterDecimal()">
				</td>
				<% } %>
			...
			<tr id="trclear">
				...
				<td width="50%" align="left">
				   <INPUT type="TEXT" name="E01PLTCOA" size="10" maxlength="9"
					value="<%= msgList.getE01PLTCOA().trim()%>" <%= readonly %> onkeypress="enterDecimal()">
				</td>
			</tr>
		</table>
		</td>
			...
			<tr id="trclear">
				...
				<td width="50%" align="left">
				   <INPUT type="TEXT" name="E01PLTCOU" size="10" maxlength="9"
					value="<%= msgList.getE01PLTCOU().trim()%>" <%= readonly %> onkeypress="enterDecimal()">
				</td>
			</tr>
		</table>
		</td>
			...
			<tr id="trclear">
				...
				<td width="50%" align="left">
				   <INPUT type="TEXT" name="E01PLTCOC" size="10" maxlength="9"
					value="<%= msgList.getE01PLTCOC().trim()%>" <%= readonly %> onkeypress="enterDecimal()">
				</td>
			</tr>
		</table>
		</td>
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td width="50%" align="left">
				  <TEXTAREA name="E02DPAC07" rows="5" cols="70" <%= readonly %>><%= msgRTC.getE02DPAC07().trim()%>
				 </TEXTAREA>
				</td>				
			</tr>
		</table>
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td width="50%" align="left">
				 <TEXTAREA name="E02DPAC08" rows="5" cols="70" <%= readonly %>><%= msgRTC.getE02DPAC08().trim()%>
				</TEXTAREA>
				</td>
			</tr>
		</table>
       ...
       <td width="1126">
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td width="50%" align="left">
				<SELECT name="E01PLTGAR" <%= disabled %>>
					<OPTION value=""
       ...
       <td width="1126">
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
					...
					<td nowrap align="left" width="50%">
						<TEXTAREA name="E02DPAC09" rows="5" cols="70" <%= readonly %>><%= msgRTC.getE02DPAC09().trim()%>
						</TEXTAREA>
					</td>
			</tr>
		</table>
              					...
              					<div align="center"> 
                					<input type="text" name="E01PLTCCR" size="12" maxlength="12"  value="<%= msgList.getE01PLTCCR().trim()%>"
                						class="context-menu-help"
                 						onmousedown="init(lnreferHelp,this.name,document.forms[0].value,'',document.forms[0].E01CUSCUN.value,'','RT'); return false;">
								</div>
				           </td>
				           	<td nowrap width="33%"> 
              					<div align="center"></div>
						...
						<tr id="trdark"> 
            				<td nowrap width="15%" > 
              					<div align="center" > 
									...
									class="context-menu-help"
									onmousedown="init(conceptHelp,this.name,document.forms[0].E01PLPBNK.value,'','E01PLTGCR','E01PAGOPE','<%= msgList.getE01PLTACD().trim()%>'); return false;">
								</div>
				            </td>
            				...
            				<td nowrap width="22%" > 
                 				<div align="center"> 
                					<input type="hidden" name="E01PLPBRN" size="3" maxlength="3" value="<%= msgRT.getE01PLPBRN().trim()%>"
                 						class="context-menu-help"
                 						onmousedown="init(branchHelp,this.name,document.forms[0].E01PLPBNK.value,'','','',''); return false;"> 
				               </div>
				            </td>
            				<td nowrap width="14%" > 
              					<div align="center"> 
                					<input type="hidden" name="E01PLTCCY99" size="3" maxlength="3" value="<%= msgList.getE01PLTCCY().trim()%>"
						                 class="context-menu-help"
						                 onmousedown="init(currencyHelp,this.name,document.forms[0].E01PLPBNK.value,'','','',''); return false;">
								</div>
							</td>
			          </tr>
			      </table>
		...
		<td width="1126">
    		...
    		<tr>
              ...
              <td nowrap width="20%" align="left"> 
                ...
                <a href="javascript:GetCreditLine('E01PLTLNU',document.forms[0].E01PLTRAC.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="middle" border="0" >
                </a> 
					...
					<div id="dataDiv2" class="scbarcolor">
						<table id="dataTable2">
						    <tr id="trclear">
									...
									<td nowrap width="5%"> 
									    <input type=TEXT name="E01COMFA1" size="2" maxlength="1" value="<%= msgList.getE01COMFA1().trim()%>" <%= readonly %>>
									</td>
									
									<td nowrap width="10%">
							            <input type=TEXT name="E01COMAM1" size="17" maxlength="17"
										value="<%= msgList.getE01COMAM1().trim()%>" <%= readonly %> onkeypress="enterInteger(event)"
							            >
									</td>
									
									<td nowrap width="5%">
						      	      <input type="text" name="E01COMAP1" size="2" maxlength="1" <%= readonly %>
							            value="<%= msgList.getE01COMAP1().trim()%>"
							            >
									</td>
									<td nowrap width="10%">
						      	      <input type="text" name="E01COMMN1" size="17" maxlength="17" <%= readonly %> onkeypress="enterInteger(event)"
							            value="<%= msgList.getE01COMMN1().trim()%>"
							            >
									</td>
									<td nowrap width="10%">
						      	      <input type="text" name="E01COMMX1" size="17" maxlength="17" <%= readonly %> onkeypress="enterInteger(event)"
							            value="<%= msgList.getE01COMMX1().trim()%>"
							            >
									</td>
									<td nowrap width="5%">
						      	      <input type="text" name="E01COMSG1" size="2" maxlength="1" <%= readonly %>
							            value="<%= msgList.getE01COMSG1().trim()%>"
							            >
									</td>
									<td nowrap width="15%">
						      	      <input type="text" name="E01COMGL1" size="13" maxlength="12" <%= readonly %>
							            value="<%= msgList.getE01COMGL1().trim()%>"
							            >
									</td>
									<td nowrap width="5%">
						      	      <input type="text" name="E01COMIV1" size="2" maxlength="1" <%= readonly %>
		...
		<table class="tableinfo">
			<tr > 
				...
				<table cellspacing="0" cellpadding="2" width="100%" border="0">
					<tr id="trclear">
						...
						<td nowrap width="10%" align="left">
				            <input type=TEXT name="E01DPZTNR" size=17 maxlength=16  value="<%= msgList.getE01DPZTNR().trim()%>" <%= readonly %> onkeypress="enterInteger(event)">
						</td>
						<td nowrap width="10%">
	      ...
	      <tr > 
			...
			<table cellspacing="0" cellpadding="2" width="100%" border="0">
				...
				<% if(!msgRT.getH01FLGWK3().equals("3")){ %> 
				<a href="javascript:DatePicker(document.forms[0].E01DPZFA1,document.forms[0].E01DPZFA2,document.forms[0].E01DPZFA3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a>
				<% } %>				
			            
			            
			            <input type=TEXT name="E01DPZFA1" size=3 maxlength=2   value="<%= msgList.getE01DPZFA1().trim()%>"
			            	<%= readonly %> onkeypress="enterInteger(event)">
	      ...
	      <tr > 
			...
			<table cellspacing="0" cellpadding="2" width="100%" border="0">
				<tr id="trclear">
					...
					<SELECT name="E01DPZPRF" <%= disabled %>>
						<OPTION value=""
	      ...
	      <tr > 
			...
			<table cellspacing="0" cellpadding="2" width="100%" border="1">
				...
				<tr id="trclear">
					...
					<td nowrap width="35%">
			            <input type=TEXT name="E01DPPUR3" size=26 maxlength=26  value="<%= msgList.getE01DPPUR3().trim()%>" <%= readonly %>>
					</td>
					<td nowrap width="10%">
				...
				<tr id="trclear">
					...
					<td nowrap width="10%">
			            <input type=TEXT name="E01DPPCR4" size=4 maxlength=4 value="<%= msgList.getE01DPPCR4().trim()%>"
			            	<%= readonly %> onkeypress="enterDecimal()">
					</td>
						<td nowrap width="15%" align="left">
				...
				<tr id="trclear">
					...
					<td nowrap width="15%">
			            ...
			            <% if(!msgRT.getH01FLGWK3().equals("3")) {
						%>
			      	      <a href="javascript:GetCodeAuxCNOFC('E01DPPSB5','PS',document.forms[0].E01DPPRB5.value)">
			      	      	img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
						<%   
			            }%>
					</td>
