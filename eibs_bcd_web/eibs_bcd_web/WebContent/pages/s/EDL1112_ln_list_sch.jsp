...
function goAction(op) {
 ...
 if (op == 1) {
     ...
     page = '${pageContext.request.contextPath}/pages/s/EDL1112_ln_maint_sch.jsp?ROW=' + document.forms[0].ROW.value;
 } else if (op == 4) {     
     page = '${pageContext.request.contextPath}/pages/s/EDL1112_ln_delete_sch.jsp?ROW=' + document.forms[0].ROW.value; 
 }
...
<h3 align="center">Abonos Masivos, Proceso Manual<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_list_sch.jsp,EDL1112"> 
</h3>
<hr size="4">
