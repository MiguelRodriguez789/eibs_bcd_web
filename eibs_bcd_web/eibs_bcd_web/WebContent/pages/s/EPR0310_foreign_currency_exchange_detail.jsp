...
<H3 align="center">Mantenimiento de Oficinas de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0310"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
				<%= Util.formatDate(msgInst.getE01FETAD1(),msgInst.getE01FETAD2(),msgInst.getE01FETAD3())  + " - " + Util.formatCell(msgInst.getE01FETACT()) %>
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
