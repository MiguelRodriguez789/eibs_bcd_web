...
<h3 align="center">Commercial Paper Market Value Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="market_value_list.jsp, EDL0115"></h3>
<hr size="4">
