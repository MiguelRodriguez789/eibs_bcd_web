...
<body>
<h3 align="center">Liquidacion  de Cobranza ( Consulta )<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="coll_payment_inquiry.jsp, EDC0140"></h3>
<hr size="4">
