...
function rateDisplay(){
		...
		if((getElement("E01NEWFTB").value == null) || (getElement("E01NEWFTB").value.trim() == "")){ 
            ...
            getElement("E01NEWFTY").value    = " ";   /*  FP=Primary FS=Secondary */
            getElement("E01FLTORG").value    = "0";  /*   Tasa Flotante Base */
			getElement("E01DEARTX").value    = "0";   /*  Valor Tasa Adicional */
			getElement("E01NEWSPR").readOnly = false; /*  Tasa Efectiva */
			getElement("E01NEWRTE").readOnly = false; /*  Tasa Base/Spread  */
			getElement("E01NEWFRT").readOnly = false;  /*  Tasa Flotante/Spread 		 */	
			...
			getElement("E01NEWRTE").value    = "0";   /*  Tasa Base/Spread */
			getElement("E01NEWFRT").value    = "0";   /*  Tasa Flotante Rate */ 
			getElement("E01NEWSPR").readOnly = true;  /*  Tasa Efectiva */
			getElement("E01NEWRTE").readOnly = true;  /*  Tasa Base/Spread  */
			getElement("E01NEWFRT").readOnly = false;  /*  Tasa Flotante/Spread 		 */	
			...
			document.getElementById("FLOATINGTABLE").style.display = 'none';
			document.getElementById("FLOATINGTABLE2").style.display = 'none';
			getElement("E01NEWFRT").readOnly = true;  /*  Tasa Flotante/Spread 	 */		
		...
		}else if ("FS" == getElement("E01NEWFTY").value && (parseInt(getElement("E01FLGFLT").value) == 1)){
			getElement("E01NEWSPR").value = getElement("SECONDARYRATE").value;
		
		}else if ("FP" == getElement("E01NEWFTY").value && (parseInt(getElement("E01FLGFLT").value) == 1)){
			getElement("E01NEWSPR").value = getElement("PRIMARYRATE").value;
		...
		}else if(" " == getElement("E01NEWFTY").value && (parseInt(getElement("E01FLGFLT").value) == 1) ){
			getElement("E01NEWSPR").value = String(defvalue.toFixed(<%=EibsFields.EIBS_FIELD_RATE_LENGTH_PART_DECIMAL%>));		
			
		}else{
			getElement("E01NEWFRT").value = String(defvalue.toFixed(<%=EibsFields.EIBS_FIELD_RATE_LENGTH_PART_DECIMAL%>));
		}
}
...
function newTasa(){
	...
	total = rate + spread + 0 + fbase + adicional;
...
<h3 align="center">Cambio de Tasa<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cambio_tasa.jsp, EPV0156"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" >
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="25%"> 
            	<eibsinput:text name="data" property="E01SALPRI" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>"  readonly="true"/>
            </td>
            <td nowrap width="25%"> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="25%"> 
            	<eibsinput:text name="data" property="E01SALINT" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>"  readonly="true"/>
            </td>
            <td nowrap width="25%"> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="25%"> 
            	<eibsinput:text name="data" property="E01SALMOR" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>"  readonly="true"/>
            </td>
            <td nowrap width="25%"> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="25%"> 
            	<eibsinput:text name="data" property="E01SALOTH" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>"  readonly="true"/>
            </td>
            <td nowrap width="25%"> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="25%"> 
            	<eibsinput:text name="data" property="E01SALDUE" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>"  readonly="true"/>
            </td>
            <td nowrap width="25%"> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="25%"> 
                ...
                <input type="text" name="E01DSCICT" size="45" maxlength="45" value="<%= data.getE01DSCICT().trim()%>" readonly>
            </td>
            <td nowrap width="25%"> 
...
<h4>Nueva Tasa</h4>
  <table class="tableinfo">
    <tr > 
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" id="nuevaTasa">
          <tr class="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
          	<td nowrap width="25%"> 
              <div align="right">Fecha Valor :</div>
            </td>
            <td nowrap width="25%"> 
            	<eibsinput:date name="data" fn_month="E01DEAVDM" fn_day="E01DEAVDD" fn_year="E01DEAVDY"/>
            </td>
          	<td nowrap width="25%"> 
              <div align="right">Tabla Tasa Flotante :</div>
            </td>
            <td nowrap width="25%">      
            	<eibsinput:help name="data" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_BANK%>" 
            	                ...
            	                property="E01NEWFTB" help="<%=HelpTypes.FLOATING_RATE_TABLES%>" onchange="rateDisplay();newTasa();"/>       	
                <select name="E01NEWFTY" onchange="rateDisplay();newTasa();">
          ...
          <tr id="FLOATINGTABLE2" class="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>" style="display: none">
            ...
            <td nowrap width="25%">
				<%if(data.getE01FLGFLT().equals("2")){%>
			  	...
			  	<%}%>
            	<eibsinput:text property="E01FLTORG" name="data" type="<%=EibsFields.EIBS_FIELD_TYPE_SIGN_DECIMAL%>" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_RATE %>" readonly="true" onchange="newTasa();"/>
            </td>
          </tr>
          <tr id="FLOATINGTABLE" class="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>" style="display: none"> 
            ...
            <td nowrap width="25%"> 
            	<eibsinput:text property="E01DEARTX" name="data" type="<%=EibsFields.EIBS_FIELD_TYPE_SIGN_DECIMAL%>" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_RATE %>" onchange="newTasa();"/>
            </td>
	      </tr>
          <tr class="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
	         <td nowrap width="25%"> 
             ...
             <td nowrap width="25%">               	
            	<eibsinput:text name="data" property="E01NEWSPR" type="<%=EibsFields.EIBS_FIELD_TYPE_SIGN_DECIMAL%>" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_RATE %>"  onchange="newTasa();"/>               
             </td>
          	 <td nowrap width="25%"> 
              <div align="right">Tasa Flotante Rate :</div>
            </td>
          ...
          <tr class="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="25%">               	
            	<eibsinput:text name="data" property="E01NEWRTE" type="<%=EibsFields.EIBS_FIELD_TYPE_SIGN_DECIMAL%>" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_RATE %>"  onchange="newTasa();"/>
            </td>
            <td nowrap width="25%"> 
