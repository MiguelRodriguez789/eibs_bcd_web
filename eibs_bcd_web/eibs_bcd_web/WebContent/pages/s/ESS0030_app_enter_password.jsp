...
<BODY>
<H3 align="center">Verificación de Autoridad<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="app_enter_password, ESS0030"></H3>
<hr size="4">
...
%> 
    ...
    <TABLE height="30%" WIDTH="100%"  class="tbenter" BORDER=0>
	 ...
	 <TD ALIGN=right width="50%" > 
        ...
        <TD width="50%"> 
		<% if (true) {	%>
          <INPUT TYPE="password" SIZE="12" MAXLENGTH="10" NAME="AppPassword">
		<% } else {	%>
