...
<HTML>
<HEAD>
<TITLE>Movimientos de Papel Valor por Oficina Para Anular</TITLE>
...
<h3 align="center">Movimientos de Papel Valor por Oficina Para Anular
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_branch_mov_list_anul.jsp,EVL0070">
</h3>
<hr size="4">
 ...
 <TABLE class="tbenter" width="60%" align=center>
    <TR> 
      <TD class=TDBKG width="50%"> 
        <div align="center"><a href="javascript:goAction()">Anular</a> 
        </div>
      </TD>
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE03MOVRBR())%></TD>
