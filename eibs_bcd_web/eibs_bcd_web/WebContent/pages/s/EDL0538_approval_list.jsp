...
<jsp:useBean id= "searchParameters" class= "datapro.eibs.beans.EDL053801Message"  scope="session" />
...
<script type="text/javascript">
  var reason = '';
	...
	function showInqApprovalClient(ref){
		var SCREEN = "400";
		var E02CUSCUN = ref;
		var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSEDL0518?SCREEN="+SCREEN+"&E02CUSCUN="+E02CUSCUN;
...
<h3 align="center"> Aprobación de Calificaciones Adicionales</h3>
<hr size="4">


<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0538" >
   ...
   <TABLE class="tbenter" width="100%" align=center>   
    <TR>
      <TD class=TDBKG width="20%"> 
       ...
       <TD class=TDBKG width="20%"> 
        <div align="center"><a href="javascript:goAction('T')" id="linkAll"><b>Aprobar Todo</b></a></div>
      </TD>
      <TD class=TDBKG width="20%"> 
			...
			%>	  
	          <tr id="dataTable"> 
				<TD ALIGN="CENTER" nowrap width="35%" style="color:#d0122c" colspan="5">
					<br><br><br><br> 
					<font size=3>No  hay Calificaci&oacute;n de Cliente para su Aprobaci&oacute;n. </font>				</TD>          
			 </tr>	  
