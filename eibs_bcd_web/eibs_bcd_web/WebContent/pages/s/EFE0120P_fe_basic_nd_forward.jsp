...
String sTitle = "NDF - Moneda Extranjera";
try {
   sTitle = trOption.getHeader2();
} catch (Exception e) {
   sTitle = "NDF - Moneda Extranjera";
}   
if (sTitle == null) sTitle = "NDF - Moneda Extranjera";

%> 
<h3 align="center"> <%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_nd_forward.jsp, EFE0120P"> 
</h3>
<hr size="4">
...
%>
  ...
  <INPUT TYPE=HIDDEN NAME="E01FESTYP" VALUE="NDF ">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
          	<% if(fex.getH01FLGWK3().equals("Y")){%>
            	...
            	<td nowrap > 
              		...
              		<a href="javascript:GetClassFex('E01FESCLS','NFR',document.forms[0].E01FESCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            	</td> 
             <%}%>
            <td nowrap  colspan="5" > 
              <div align="right"></div>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="4" > 
              <input type="text" name="E01FESOTS" size="70" maxlength="60" value="<%= fex.getE01FESOTS().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
