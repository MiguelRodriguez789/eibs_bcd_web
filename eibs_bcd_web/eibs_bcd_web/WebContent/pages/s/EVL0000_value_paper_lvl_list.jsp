...
<HTML>
<HEAD>
<TITLE>Lista de Niveles Papel Valor</TITLE>
...
{
	page = "${pageContext.request.contextPath}/servlet/datapro.eibs.valuepaper.JSEVL0000?SCREEN=113&ROW=" + rowNum;
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_lvl_list.jsp,EVL0000">
</h3>
<hr size="4">
   ...
   <tr  height="5%"> 
      <td NOWRAP valign="top" width="100%"> 
		<table id="headTable" width="100%">
			<tr id="trdark">
	    		...
	    		<TH ALIGN=CENTER width="300">Usuario<BR>Fecha/Hora<BR>Actualizacion</TH> 
			</tr>
        </table>
      </td>
    </tr>    
     ...
     <%
                ...
                while (mtList.getNextRow()) {
                   ...
                   String chkWarn = (msgMT.getH01FLGWK1().equals("Y")
							? "<a href=\"javascript:showWarn('"
								+ mtList.getCurrentRow()
     ...
     %>               
          <tr id="dataTable<%= mtList.getCurrentRow() %>"> 
            <td NOWRAP  align=CENTER width="10"><input type="radio" name="ROW" id="ROW" value="<%= mtList.getCurrentRow() %>" <%=chk%> class="highlight" onClick="document.forms[0].CURRENTROW.value = this.value;" " ></td>
			<TD NOWRAP ALIGN="CENTER" width="50"><%=Util.formatCell(msgMT.getE01LVLBNK())%> <%=chkWarn%></TD>
			<TD NOWRAP ALIGN="CENTER" width="50"><%=Util.formatCell(msgMT.getE01LVLBRN())%></TD>
			<TD NOWRAP ALIGN="CENTER" width="50"><%=Util.formatCell(msgMT.getE01LVLTIP())%></TD>
			<TD NOWRAP ALIGN="LEFT" width="300"><%=Util.formatCell(msgMT.getE01LVLTIN())%></TD>
			<TD NOWRAP ALIGN="CENTER" width="50"><%=Util.formatCell(msgMT.getE01LVLSUB())%></TD>
			<TD NOWRAP ALIGN="LEFT" width="300"><%=Util.formatCell(msgMT.getE01LVLSUN())%></TD>
			<TD NOWRAP ALIGN="left" width="300"><%=Util.formatCell(msgMT.getE01LVLACU()) + "<br>" +  Util.formatDate(msgMT.getE01LVLAD1(),msgMT.getE01LVLAD2(),msgMT.getE01LVLAD3()) + "<br>" + Util.formatCell(msgMT.getE01LVLACT()) %></TD>
		</TR>    		
    <%             
    				chk = "";     
                }
