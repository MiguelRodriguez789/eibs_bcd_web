...
<H3 align="center">Consulta de Cobranzas Simples<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="coll_simp_inq_basic,EDC0100"></h3>
<hr size="4">
<form method="post">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2"> 
              <div align="center"><b>Banco Remitente </b></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap colspan="2"> 
