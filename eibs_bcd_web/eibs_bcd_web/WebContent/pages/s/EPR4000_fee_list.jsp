...
<BODY>
<h3 align="center">Parametros Tablas de Comision de Transferencias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fee_list.jsp, EPR4000"></h3>
<hr size="4">
  ...
  <div id="enterFee" style="position:absolute; visibility:hidden; left:25px; top:-50px; z-index:3; filter:progid:DXImageTransform.Microsoft.Fade(duration=1.0,overlap=1.0)" onClick="cancelBub()"> 
	...
	filter:progid:DXImageTransform.Microsoft.dropshadow(OffX=3, OffY=3, Color='gray', Positive='true');">
      ...
      <tr id="trclear"> 
        ...
        <td align=CENTER width="34%">    
          <div align="left"> 
            <input type="text" name="COM1" size="3" maxlength="2" value="" onkeypress="enterInteger(event)">
            <a href="javascript:GetCNTRLPRF('COM1','VAL1')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0"></a> 
