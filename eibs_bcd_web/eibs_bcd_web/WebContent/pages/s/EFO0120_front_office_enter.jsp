...
<h3>Front Office - Selección de Transacción<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="front_office_enter.jsp,EFO0120"></h3>
</div>
<hr size="4">
		...
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
			<TBODY>
				<TR id="trintro">
					...
					<TD nowrap width="25%">
						<%if (msgCust.getE01CUSLGT().equals("1")) out.print("Moral - ");
									else if (msgCust.getE01CUSLGT().equals("2")) out.print("Físico - ");
									else out.print("OTRO - ");%>
						<%if (msgCust.getE01CUSSTS().equals("3")) out.print("Lista de Control");
