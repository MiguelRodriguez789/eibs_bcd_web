...
<body bgcolor="#FFFFFF">
<H3 align="center">Entradas Dealer Slip - Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_enter_new,EFE0120P"></H3>
