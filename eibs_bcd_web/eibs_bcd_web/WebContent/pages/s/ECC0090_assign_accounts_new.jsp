...
<body>
<h3 align="center">Asignación de Tarjetas de Débito<br>Nueva Asignación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="assign_accounts_new.jsp,ECC0090"> 
			...
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0"
				...
				<TBODY>
					<TR id="trdark">
						...
						<DIV align="left"><INPUT type="text" name="E02CCRNUM" size="21"
							maxlength="20" value="">
						<A href="javascript:GetPlastic3('E02CCRNUM', '', '', '', '')"></A></DIV>
						</TD>
					</TR>
					<TR id="trclear">
