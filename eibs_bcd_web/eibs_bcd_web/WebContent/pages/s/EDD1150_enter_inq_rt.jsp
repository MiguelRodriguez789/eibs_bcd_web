...
<H3 align="center">Consulta de Cuentas Sin GMF<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="enter_inq_rt, EDD1150"></H3>

<hr size="4">

<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD1150">
  <p> 
    <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="850">
  </p>
  ...
  <table class="tbenter" HEIGHT="75%" width="100%" border="0">
    ...
    <tr> 
      <td nowrap ALIGN=CENTER> N&uacute;mero de Cuenta : 
        ...
        <a href="javascript:GetAccount('E01ACMACC','','RA','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
