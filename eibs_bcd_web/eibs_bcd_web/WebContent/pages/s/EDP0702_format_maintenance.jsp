...
// begin test
//          page= "${pageContext.request.contextPath}/pages/s/EDP0702_format_test.jsp"
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
			...
			<SELECT name="E01DPFLGT" >
					...
					<OPTION value="2"
						<%if (brnDetails.getE01DPFLGT().equals("2")) { out.print("selected"); }%>>Cliente Persona Física</OPTION>						
			</SELECT>
			</td>
		</tr>
