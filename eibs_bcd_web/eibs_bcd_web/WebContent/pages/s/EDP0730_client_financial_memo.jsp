...
<h3 align="center">Memo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_financial_memo.jsp,EDP0730"></h3>
<hr size="4">
   ...
   <TABLE id="headTable" width="100%" cellpading=0 cellspacing=0>
    ...
    <tr id="trdark"> 
      ...
      <td nowrap > 
         ...
         <input type="text" name="E01IFMFED" size="3" readonly value="<%=mL0730.getE01IFMFED().trim()%>">/
         <input type="text" name="E01IFMFEM" size="3" readonly value="<%=mL0730.getE01IFMFEM().trim()%>">/
         <input type="text" name="E01IFMFEY" size="5" readonly value="<%=mL0730.getE01IFMFEY().trim()%>">
...
<TABLE  class="tableinfo"> 
	...
	%> 
		...
		<INPUT type="text" maxlength="3" size="3" name="E01DPMS<%= name %>" value="<%= mL0730.getField("E01DPMS"+name).getString().trim()%>" readonly="readonly">
		</TD>
		<TD ALIGN="left" NOWRAP width="600">
	...
	<div align="center"> 		
       ...
       <input id="EIBSBTN" type="button" name="Submit" value="Enviar" onclick="goConfirm()"> 
	    <% }; %> 
       <INPUT id="EIBSBTN" type="button" name="Cancel" value="Cancelar" onclick="checkClose();">
	</div>
