...
%>
<h3 align="center">Cotizaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_instruments.jsp, EWD0308"></h3>
<hr size="4">
 ...
 %> 
  <TABLE class="tbenter" width="100%" height="50%" >
    <tr>
      <TD > 
        <div align="center"> 
          <p><b>Este instrumentos no posee cotizaciones definidas, por favor escoja una de las siguientes opciones </b></p>
    ...
    <TD NOWRAP valign="top" width="100%" >
        <table id="headTable" width="100%" >
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap > 
              <div align="center">Price <BR> MID</div>
            </th>
			<th align=CENTER nowrap > 
              <div align="center">Precio MID  <br>antes del Cierre</div>
            </th>
			<th align=CENTER nowrap > 
