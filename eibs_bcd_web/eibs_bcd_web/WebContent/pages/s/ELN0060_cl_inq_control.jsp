...
<h3 align="center">Linea de Control<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cl_inq_control.jsp, ELN0060"></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trdark"> 
            ...
            <td width=20%> 
              <div align="left"> 
                <eibsinput:text name="clControl" property="E03LNEAMN" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true"/>
              </div>
            </td>
            <td width=26%> 
            ...
            <td width=28% nowrap> 
              <div align="left"> 
				<eibsinput:date name="clBasic" fn_year="E03LNEOPY" fn_month="E03LNEOPM" fn_day="E03LNEOPD" readonly="true" />
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td width=20%> 
              <div align="left"> 
                <eibsinput:text name="clControl" property="E03LNEAMU" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true"/>
            ...
            <td width=28% nowrap> 
              <div align="left"> 
				<eibsinput:date name="clBasic" fn_year="E03LNEMTY" fn_month="E03LNEMTM" fn_day="E03LNEMTD" readonly="true" />
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td width=28% nowrap> 
              <div align="left"> 
				<eibsinput:date name="clBasic" fn_year="E03LNEAUY" fn_month="E03LNEAUM" fn_day="E03LNEAUD" readonly="true" />
              </div>
            </td>
          </tr>
        </table>
