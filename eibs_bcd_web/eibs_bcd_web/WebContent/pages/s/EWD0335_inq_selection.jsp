...
<h3 align="center"> Consulta de Contratos del Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inq_selection.jsp , EWD0335" border="0"> 
</h3>
<hr size="4">
      ...
      <td nowrap > 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="15%"> 
              <div align="left"> 
                <input type="text" name="DATEF1" size="2" maxlength="2" onkeypress="enterInteger(event)">
                <input type="text" name="DATEF2" size="2" maxlength="2" onkeypress="enterInteger(event)">
                <input type="text" name="DATEF3" size="2" maxlength="2" onkeypress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="10%"> 
            ...
            <td nowrap width="47%"> 
              <div align="left"> 
                <input type="text" name="DATET1" size="2" maxlength="2" onkeypress="enterInteger(event)">
                <input type="text" name="DATET2" size="2" maxlength="2" onkeypress="enterInteger(event)">
                <input type="text" name="DATET3" size="2" maxlength="2" onkeypress="enterInteger(event)">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="15%" > 
              <div align="left"> 
                <input type="text" name="REFERENCE1" size="15" maxlength="13" onkeypress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="10%" > 
              <div align="right"><b>Hasta :</b></div>
            ...
            <td nowrap width="47%" > 
              <div align="left"> 
                <input type="text" name="REFERENCE2" size="15" maxlength="13" onkeypress="enterInteger(event)">
              </div>
            </td>
          </tr>
        </table>
