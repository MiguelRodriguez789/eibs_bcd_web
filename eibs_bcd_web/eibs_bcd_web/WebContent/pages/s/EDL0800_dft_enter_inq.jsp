...
<h3 align="center">Consulta Descuento de Documentos
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dft_enter_inq, EDL0800"></h3>
<hr size="4">
<p>&nbsp;</p>
