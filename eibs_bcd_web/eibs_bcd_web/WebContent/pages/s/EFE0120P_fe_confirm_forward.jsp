...
String sTitle = "Forward";
try {
   sTitle = trOption.getHeader2();
} catch (Exception e) {
   sTitle = "Forward";
}   
if (sTitle == null) sTitle = "Forward";
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="21%" ><%= Util.formatDate(fex.getE01FESDD1(),fex.getE01FESDD2(),fex.getE01FESDD3())%><%= userPO.getHeader1()%></td>
            <td nowrap width="23%" ><div align="right">N&uacute;mero de Referencia :</div>
            </td>
            <td nowrap width="23%" > 
