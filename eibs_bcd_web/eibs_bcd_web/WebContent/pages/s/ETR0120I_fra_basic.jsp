...
%> 
<h3 align="center"> Inquiry of Forward Rates Agreements <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fra_basic.jsp,ETR0120I"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0  border="0" width="100%">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
			  ...
			  >
              <input type="text" readonly  name="E01WFRDD3" size="5" maxlength="4" value="<%= fra.getE01WFRDD3().trim()%>" 
			  >
            </td>
            <td nowrap > 
            ...
            <td nowrap > 
			  ...
			  >
              <input type="text" readonly  name="E01WFRVD3" size="5" maxlength="4" value="<%= fra.getE01WFRVD3().trim()%>" 
			  >
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap > 
			  ...
			  >
              <input type="text" readonly  name="E01WFRMA3" size="5" maxlength="4" value="<%= fra.getE01WFRMA3().trim()%>" 
			  >
            </td>
          </tr>
          <tr id="trclear"> 
