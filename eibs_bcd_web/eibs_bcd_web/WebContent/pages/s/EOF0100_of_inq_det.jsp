...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEOF0100" >
  ...
  <h3 align="center">Cheques Oficiales - Orden de No Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="of_inq_det.jsp, EOF0100"></h3>
  <hr size="4">
  <BR>
