...
<html>
<head>
<title>Cobranza Simple Recibida</title>
...
%>
<body>
	<h3 align="center"><%= strTitle %> de Cobranza Simple Recibida
		<img src="${pageContext.request.contextPath}/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dc_opening_incoming.jsp, EDC0010">
	</h3>
	<hr size="4">
	<form method="post"
					...
					<table cellspacing="0" cellpadding="2" width="100%" border="0">
						<tr id="trdark">
							...
							<td>
								<table border="0" cellspacing="0">
									<tr id="trdark">
										<td align="left"><input type="text" name="E01DCMRBA"
			...
			<tr>
				...
				out.print("selected");%>>Cuenta</option>
							...
							<td>
								<table border="0" cellspacing="0">
									<tr id="trdark">
										<td align="left"><input type="text" name="E01DCMCLA"
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			<tr id="trdark">
				...
				<table border="0" cellspacing="0">
					<tr id="trdark">
						<td align="left">
							<input type="text" name="E01DCMDRA" size="12" maxlength="12" value="<%=dcNew.getE01DCMDRA()%>" <%=ctrlReadonly%>
						...
						<% if (!isReadonly) { %>
							...
							<img src="${pageContext.request.contextPath}/images/1b.gif" title=". . ." onclick="javascript: document.forms[0].E01DCMAF1.selectedIndex = 1" border="0"></a> Cliente o
							<a href="javascript: GetAccByClient('E01DCMDRA','','RT','','E01DCMDR1')">
							<img src="${pageContext.request.contextPath}/images/1b.gif" title=". . ." onclick="javascript: document.forms[0].E01DCMAF1.selectedIndex = 2" border="0"></a> Cuenta
						<% } %>
						</td>
					</tr>
				</table>
				...
				out.print("selected");%>>Cuenta</OPTION>
								...
								<TD>
									<TABLE border="0" cellspacing="0">
										<TBODY>
											<TR id="trdark">
												<TD align="left"><INPUT type="text" name="E01DCMDWA"
						...
						<TBODY>
							...
							<TR id="trclear">
								...
								<TD nowrap width="20%"><INPUT type="text" name="E01DCMFCY"
									...
									value="<%=dcNew.getE01DCMOFX().trim()%>" disabled> 
									</TD>
