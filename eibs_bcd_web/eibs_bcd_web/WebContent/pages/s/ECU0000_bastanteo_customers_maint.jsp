...
<h3 align="center">Sistema de Bastanteo - Mantenimiento Datos de Identificaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_customers_maint, ECU0000" ></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          ...
          <tr>  
			...
			<a href="javascript:GetCodeDescCNOFC('E02CUSTID','E02CUSTIN','34')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
          ...
          <tr> 
			...
			<a href="javascript:GetCodeDescCNOFC('E02CUSPID','E02CUSPIN','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
          ...
          <tr> 
            ...
            <td nowrap colspan="2"> 
			 ...
			 <a href="javascript:GetCodeDescCNOFC('E02CUSSTE','D02CUSSTE','27')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
        ...
        <td nowrap > 
          <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
            ...
            <tr id="teclear"> 
              ...
              <td nowrap width="25%">  
                <input type="text" name="E02CUSMD1" size="3" maxlength="2" value="<%= msgMT.getE02CUSMD1().trim()%>">
                <input type="text" name="E02CUSMD2" size="3" maxlength="2" value="<%= msgMT.getE02CUSMD2().trim()%>">
                <input type="text" name="E02CUSMD3" size="5" maxlength="4" value="<%= msgMT.getE02CUSMD3().trim()%>">
                <a href="javascript:DatePicker(document.forms[0].E02CUSMD1,document.forms[0].E02CUSMD2,document.forms[0].E02CUSMD3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title=". . ." align="bottom" border="0" ></a>
                </td>
            </tr>
            <tr id="trdark"> 
            <td nowrap  width="25%"> 
            ...
            <td nowrap  width="25%"> 
              ...
              <input type="text" name="E02CUFADN" size="35" maxlength="35" value="<%= msgMT.getE02CUFADN() %>" readonly >
      	      <a href="javascript:GetCodeDescCNOFC('E02CUFADM','E02CUFADN','YR')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
            </td>
            <td nowrap width="25%"> 
            ...
            <tr id="teclear"> 
              ...
              <td nowrap  width="25%"> 
      	    	...
      	    	<a href="javascript:GetCodeDescCNOFC('E02CUFABO','E02CUFABN','YQ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
              </td>
              <td nowrap  width="25%"> 
        ...
        <td nowrap > 
          <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
            ...
            <tr id="trdark"> 
              ...
              <td nowrap width="25%">  
                <input type="text" name="E02CUSRD1" size="3" maxlength="2" value="<%= msgMT.getE02CUSRD1().trim()%>">
                <input type="text" name="E02CUSRD2" size="3" maxlength="2" value="<%= msgMT.getE02CUSRD2().trim()%>">
                <input type="text" name="E02CUSRD3" size="5" maxlength="4" value="<%= msgMT.getE02CUSRD3().trim()%>">
                <a href="javascript:DatePicker(document.forms[0].E02CUSRD1,document.forms[0].E02CUSRD2,document.forms[0].E02CUSRD3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title=". . ." align="bottom" border="0" ></a>
                </td>
                <td nowrap  width="25%"> 
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E02CUSOBS" size="90" maxlength="80" value="<%= msgMT.getE02CUSOBS().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%">
