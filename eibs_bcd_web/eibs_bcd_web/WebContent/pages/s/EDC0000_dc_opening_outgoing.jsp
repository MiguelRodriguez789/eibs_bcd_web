...
<html>
<head>
<title>Apertura / Mantenimiento de Cobranza Documentaria Enviada</title>
...
<body>
<h3 align="center"><%= dcNew.getE01DCMOPT().equals("N")?"Apertura":"Mantenimiento" %> de Cobranza Documentaria Enviada<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dc_opening_outgoing.jsp, EDC0000"></h3>
<hr size="4">
	...
	<tr>
		...
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
			...
			<TR id="trclear">
				...
				<TD nowrap width="20%">
					<DIV align="left">
						<INPUT type="text" name="E01DCMORF" size="20" maxlength="16" value="<%=dcNew.getE01DCMORF().trim()%>" readonly>
					</DIV>
				</TD>
				<TD nowrap width="16%">
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			<tr id="trdark">
				...
				<table border="0" cellspacing="0">
					<tr id="trdark">
						<td align="right">Numero de Cliente o de Cuenta:</td>
						<td nowrap width="25%">
							<select name="E01DCMAF4" <%=ctrlDisabled%>>
				...
				<table border="0" cellspacing="0">
					<tr id="trdark">
						<td align="left">
							<input type="text" name="E01DCMCLA" id="E01DCMCLA" size="12" maxlength="12" value="<%=dcNew.getE01DCMCLA()%>" <%=ctrlReadonly%>
			  ...
			  <TR id="trclear">
			    <TD align="right" nowrap>Codigo Swift:</TD>
			    <TD align="left" nowrap><INPUT type="text" name="E01DCMCLI" size="14" maxlength="12" value="<%=dcNew.getE01DCMCLI()%>" <%=ctrlReadonly%>
			    <%if (dcNew.getF01DCMCLI().equals("Y")) out.print("class=\"txtchanged\"");%>>
				<% if (!userPO.getPurpose().equals("INQUIRY") && !userPO.getPurpose().equals("APPROVAL")) { %>
			      <A href="javascript:GetSwiftIdDesc('E01DCMCLI','E01DCMCL1','E01DCMCL2','E01DCMCL3')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"  border="0">
				  </A>
				<% } %>
				</TD>
			  </TR>
			<tr id="trdark">
				...
				<td>
					<div align="left">
						<input type="text" name="E01DCMCL1" size="45" maxlength="35" value="<%=dcNew.getE01DCMCL1()%>" <%=ctrlReadonly%>
			...
			<tr id="trclear">
				...
				<td>
					<div align="left"><input type="text" name="E01DCMCL2" size="45" maxlength="35" value="<%=dcNew.getE01DCMCL2()%>" <%=ctrlReadonly%>
			...
			<tr id="trdark">
				...
				<td>
					<div align="left">
						<input type="text" name="E01DCMCL3" size="45" maxlength="35" value="<%=dcNew.getE01DCMCL3()%>" <%=ctrlReadonly%>
			...
			<tr id="trclear">
				...
				<td>
					<div align="left">
						<input type="text" name="E01DCMCL4" size="45" maxlength="35" value="<%=dcNew.getE01DCMCL4()%>" <%=ctrlReadonly%>
			...
			<tr id="trdark">
				...
				<td>
					<div align="left">
						<input type="text" name="E01DCMCRF" size="20" maxlength="16" value="<%=dcNew.getE01DCMCRF()%>" <%=ctrlReadonly%>>
					</div>
				</td>
			</tr>
		</table>
					...
					<TBODY>
						<TR id="trdark">
							...
							<% if (!userPO.getPurpose().equals("INQUIRY") && !userPO.getPurpose().equals("APPROVAL")) { %>
								...
								<A href="javascript: GetAccByClient('E01DCMSRA','','RT','','' ,'')">
      ...
      <td nowrap>
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
		  ...
		  <TR id="trdark">
			...
			<TD nowrap width="20%">
				<eibsinput:date name="dcNew" fn_month="E01DCMILM" fn_day="E01DCMILD" fn_year="E01DCMILY" modified="F01DCMILM, F01DCMILD, F01DCMILY" readonly="<%=ctrlReadonly%>"/>
            </TD>
			<TD nowrap width="30%"><DIV align="right">Letra en Custodia :</DIV></TD>
			<TD nowrap width="20%">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
		  ...
		  <tr id="trdark">
            ...
            <td nowrap width="20%">
            	<INPUT type="text" name="E01DCMCAM" maxlength="15" size="15" value="<%= dcNew.getE01DCMCAM().trim()%>" <%=ctrlReadonly%>
            	<%if (dcNew.getF01DCMCAM().equals("Y")) out.print("class=\"txtchanged\"");%>> 
            </td>
          </tr>
		  <tr id="trclear">
			<td nowrap>
...
<% if (userPO.getPurpose().equals("INQUIRY") || userPO.getPurpose().equals("APPROVAL")) { %>
	...
	$("select").add("button").add("submit")	$("img[title='null']").add("img[src*='1b.gif']").add("img[src*='Check.gif']").add("img[src*='calendar.gif']").hide(); 	
