...
<body>
  ...
  out.println("<SCRIPT> initMenu(); </SCRIPT>");		
	...
	<div align="center">
		<h3>
			Canje Enviado<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cleaning_ce.jsp,EDD0961">
		</h3>
	</div>
			...
			<td nowrap>
				<table cellpadding=2 cellspacing=0 width="100%" border="0">
					...
					<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
						...
						<TD nowrap width="25%">
							<INPUT type="text" name="E01CANAMT" size="18" maxlength="15" value="<%=msgRcd.getE01CANAMT().trim()%>"  readonly>
						</td>
			...
			<td nowrap>
				<table cellpadding=2 cellspacing=0 width="100%" border="0">
					...
					<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
						...
						<td nowrap width="25%"><div align="right">Fecha Deposito :</div>
						</td>
						<td nowrap width="25%">
        			...
        			<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
						<td nowrap width="25%">
							<div align="right">Jornada Adicional :</div>
						</td>
						<td nowrap width="25%">
							<INPUT type="radio" name="E01CANJOR" value="Y" <%if (msgRcd.getE01CANJOR().equals("Y")) out.print("checked");%>>Si 
							<INPUT type="radio" name="E01CANJOR" value="N" <%if (msgRcd.getE01CANJOR().equals("N")) out.print("checked");%>>No
						</td>
						<td nowrap width="25%"><div align="right"> Codigo Cubierta  : </div>
						</td>
						<td nowrap width="25%">
            				<input type="text" name="E01CANCCE" size="12" maxlength="12" value="<%=msgRcd.getE01CANCCE()%>" />
                			<a href="javascript:GetCov('E01CANCCE')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0"  ></a>
						</td>
					</tr>
				</table>
			</td>
