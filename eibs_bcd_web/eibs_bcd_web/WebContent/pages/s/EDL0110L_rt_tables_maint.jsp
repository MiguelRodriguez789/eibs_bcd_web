...
<h3 align="center">Tasas Lideres Mantenimiento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_tables_maint,EDL0110L" ></h3>
<hr size="4">
...
%>             
            ...
            <td nowrap width="31%"> 
              <div align="left">         
        		 <eibsinput:date name="rates" fn_year="E02PRREFY" fn_month="E02PRREFM" fn_day="E02PRREFD" readonly="true"/> 
              </div>  
            </td>
          </tr>       
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
