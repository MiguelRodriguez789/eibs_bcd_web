...
%>
<div align="center"> 
  <h3>M&uacute;ltiples Ordenes de Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_trade_tickets_mp.jsp,EIE0130"> 
  </h3>
</div>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="17%" > 
              <div align="right"><a href="javascript:showCustomerInq(document.forms[0].E02ORDCUN.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" title="help" align="bottom" border="0" > 
                Cliente </a>:</div>
            </td>
            <td nowrap colspan="3" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" > 
              ...
              <input type="text" name="E02ORDIN3" size="5" maxlength="4" value="<%= invMult.getE02ORDIN3()%>">
            </td>
            <td nowrap width="14%" > 
            ...
            <td nowrap width="33%" > 
              ...
              <input type="text" name="E02ORDST3" size="5" maxlength="4" value="<%= invMult.getE02ORDST3()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="33%" > 
              <div align="left"> 
                ...
                <a href="javascript:GetCustomerDescIdInvest('E02ORDCUN','E02ORDCTN','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="36%" > 
              <div align="left"> 
                ...
                <a href="javascript:GetPortfolioNumDesc('E02ORDPRF','E02ORDCUN','',document.forms[0].E02ORDCUN.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
              </div>
            </td>
            <td nowrap width="14%" > 
              <div align="right"><a href="javascript:showRetAccountInq(document.forms[0].E02ORDHAC.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" title="help" align="bottom" border="0" > 
            ...
            <td nowrap width="33%" > 
              <div align="left"> 
                ...
                <a href="javascript:GetCashAccount('E02ORDHCY','E02ORDHAC','E02MEMBAL',document.forms[0].E02ORDCUN.value,document.forms[0].E02ORDPRF.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"  ></a></div>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="13%" > 
              ...
              <a href="javascript:GetCommCustodyTable('E02ORDOCT',document.forms[0].E02ORDPTY.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap> 
              <div align="center"> 
                <input type="text" name="E02ORDHBR" size="4" maxlength="4"
                class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E02ORDHBK.value,'','','','')" value="<%= invMult.getE02ORDHBR()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDHCY4" size="3" maxlength="3" value="<%= invMult.getE02ORDHCY()%>"
                class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.forms[0].E02ORDHBK.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDHGL" size="17" maxlength="16" value="<%= invMult.getE02ORDHGL()%>" 
				class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.forms[0].E02ORDHBK.value,document.forms[0].E02ORDHCY.value,'','','')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDHAC4" size="13" maxlength="12" value="<%= invMult.getE02ORDHAC()%>"
                class="context-menu-help" onmousedown="init(accountHelp,this.name,document.forms[0].E02ORDHBK.value,'','','','RT')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E02ORDHCC" size="9" maxlength="8" value="<%= invMult.getE02ORDHCC()%>"
				class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E02ORDHBK.value,'','','','')">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <select name="E02ORDIPT">
                  ...
                  <option value="2" <%if (invMult.getE02ORDIPT().equals("2")) {  out.print("selected"); }%>>Cheques Oficiales</option>
            ...
            <td nowrap> 
              <div align="center"> 
                <input type="text" name="E02ORDIBR" size="4" maxlength="4"
                class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E02ORDIBK.value,'','','','')" value="<%= invMult.getE02ORDIBR()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDICY" size="3" maxlength="3" value="<%= invMult.getE02ORDICY()%>"
                class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.forms[0].E02ORDIBK.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDIGL" size="17" maxlength="16" value="<%= invMult.getE02ORDIGL()%>" 
				class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.forms[0].E02ORDIBK.value,document.forms[0].E02ORDICY.value,'','','')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDIAC" size="13" maxlength="12" value="<%= invMult.getE02ORDIAC()%>"
                class="context-menu-help" onmousedown="init(accountHelp,this.name,document.forms[0].E02ORDIBK.value,'','','','RT')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E02ORDICC" size="9" maxlength="8" value="<%= invMult.getE02ORDICC()%>"
				class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E02ORDIBK.value,'','','','')">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <select name="E02ORDCPT">
                  ...
                  <option value="2" <%if (invMult.getE02ORDCPT().equals("2")) {  out.print("selected"); }%>>Cheques Oficiales</option>
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDCBR" size="4" maxlength="4"
                class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E02ORDCBK.value,'','','','')" value="<%= invMult.getE02ORDCBR()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDCCY" size="3" maxlength="3" value="<%= invMult.getE02ORDCCY()%>"
                class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.forms[0].E02ORDCBK.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDCGL" size="17" maxlength="16" value="<%= invMult.getE02ORDCGL()%>" 
				class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.forms[0].E02ORDCBK.value,document.forms[0].E02ORDCCY.value,'','','')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDCAC" size="13" maxlength="12" value="<%= invMult.getE02ORDCAC()%>"
                class="context-menu-help" onmousedown="init(accountHelp,this.name,document.forms[0].E02ORDCBK.value,'','','','RT')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E02ORDCCC" size="9" maxlength="8" value="<%= invMult.getE02ORDCCC()%>"
				class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E02ORDCBK.value,'','','','')">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <select name="E02ORDDPT">
                  ...
                  <option value="2" <%if (invMult.getE02ORDDPT().equals("2")) {  out.print("selected"); }%>>Cheques Oficiales</option>
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDDBR" size="4" maxlength="4" value="<%= invMult.getE02ORDDBR()%>"
                class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E02ORDDBK.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDDCY" size="3" maxlength="3" value="<%= invMult.getE02ORDDCY()%>"
                class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.forms[0].E02ORDDBK.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDDGL" size="17" maxlength="16" value="<%= invMult.getE02ORDDGL()%>"
				class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.forms[0].E02ORDDBK.value,document.forms[0].E02ORDDCY.value,'','','')"  >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E02ORDDAC" size="13" maxlength="12" value="<%= invMult.getE02ORDDAC()%>"
                class="context-menu-help" onmousedown="init(accountHelp,this.name,document.forms[0].E02ORDDBK.value,'','','','RT')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E02ORDDCC" size="9" maxlength="8" value="<%= invMult.getE02ORDDCC()%>"
				class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E02ORDDBK.value,'','','','')">
              </div>
            </td>
          </tr>
        </table>
