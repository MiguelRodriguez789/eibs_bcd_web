...
<H3 align="center">Mantenimiento de Retenciones e Impuestos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="taxes_001_interest.jsp, ESD0009"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="19"> 
              <div align="left">
                 <eibsinput:text name="taxes" property="E01TAXPRC" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_RATE %>" />
              </div>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="19"> 
              <div align="left">
                <eibsinput:text name="taxes" property="E01TAXUPL" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" /></div>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="40%" height="19"> 
            ...
            <td nowrap height="19"> 
              <div align="left">
                <eibsinput:text name="taxes" property="E01TAXLLM" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" /></div>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="40%" height="19"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <eibsinput:text name="taxes" property="E01TAXRTL" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_RATE %>" />
              </div>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="19"> 
              <div align="left">
                <eibsinput:text name="taxes" property="E01TAXART" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" />
              </div>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="19"> 
              <div align="left">
                <eibsinput:text name="taxes" property="E01TAXADR" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_RATE %>" />
              </div>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="19"> 
              <div align="left">
               <eibsinput:cnofc name="taxes" flag="03" property="E01TAXCTY" required="false"/>
               </div>
            </td>
          </tr>
        </table>
