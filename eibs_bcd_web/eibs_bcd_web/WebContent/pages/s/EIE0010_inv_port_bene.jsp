...
<h3 align="center">Beneficiarios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_port_bene, EIE0010"></h3>
<hr size="4">
...
<table>
<tr>
<td align="left"><h4>Septimo</h4></td>
</tr>
</table>
<%          
           break;
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap > 
              <p> 
                ...
                <a href="javascript:GetCodeCNOFC('E<%= name %>4MLC','32')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0"  ></a>	
                </p>
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="42%" nowrap> 
              <div align="right">En la capacidad de :</div>
            </td>
            <td width="58%" nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap > 
              <select name="E<%= name %>4BMS">
                ...
                <option value=5 <% if (bene.getField("E" + name + "4BMS").getString().equals("5")) out.print("selected"); %>>Concubino</option>
