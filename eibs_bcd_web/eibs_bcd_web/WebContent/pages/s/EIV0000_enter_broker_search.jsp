...
%>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0312P" >
  ...
  <h3 align="center">B&uacute;squeda - Tablas de Comisi&oacute;n <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="enter_broker_search.jsp,EIV0000"> 
  </h3>
  <hr size="4">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
      ...
      <td> 
        <table id="tableinfo" width="100%" border="0" cellspacing="1" cellpadding="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="70%" nowrap> 
              <input type="text" name="TABLE" size="3" maxlength="2"  >
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="70%" nowrap > 
              <div align="left"> 
                ...
                <a href="javascript:GetProduct('PRODUCT','DESCPROD','IV','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
              </div>
            </td>
          </tr>
        </table>
