...
<H3 align="center">Mantenimiento de Retenciones e Impuestos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="taxes_800_bank_debit.jsp, ESD0009"></H3>
<hr size="4">
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td nowrap width="30%" height="19"> 
              <div align="right">Cuenta Contable D&eacute;bitos Pagado x el Banco 
                :</div>
            </td>
            <td nowrap height="19"> 
              <div align="left"> 
