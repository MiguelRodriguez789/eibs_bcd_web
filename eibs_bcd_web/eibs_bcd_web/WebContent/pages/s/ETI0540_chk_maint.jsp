...
<body>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chk_maint,ETI0540" >
...
<INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="600">
    ...
    <table cellpadding=2 cellspacing=0 width="100%" border="0" class="tableinfo" >
          ...
          <tr id="trdark">            
            ...
            <td nowrap width="30%">  
               <input type="text" name="E01CKCCNL" size="5" maxlength="4" value="<%= msgData.getE01CKCCNL()%>" 
                <% if(msgData.getE01CKCSTS().equals("I")|| msgData.getE01CKCSTS().equals("O")){out.print("readonly");}%>                              
               >
               <a href="javascript:GetCodeCNOFC('E01CKCCNL','MR')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a> 
            </td>  
            <td nowrap align=right width="20%"> 
              Canal de pago:
            </td>
          ...
          <tr id="trclear"> 
            ...
            <INPUT type="text" name="E01CKCCEXM" size="3" maxlength="2" value="<%= msgData.getE01CKCEXM()%>"
               <% if(msgData.getE01CKCSTS().equals("I")|| msgData.getE01CKCSTS().equals("O")){out.print("readonly");}%>                              
            >
            <INPUT type="text" name="E01CKCCEXD" size="3" maxlength="2" value="<%= msgData.getE01CKCEXD()%>"
               <% if(msgData.getE01CKCSTS().equals("I")|| msgData.getE01CKCSTS().equals("O")){out.print("readonly");}%>                              
            >
            <INPUT type="text" name="E01CKCCEXY" size="5" maxlength="4" value="<%= msgData.getE01CKCEXY()%>"
               <% if(msgData.getE01CKCSTS().equals("I")|| msgData.getE01CKCSTS().equals("O")){out.print("readonly");}%>                              
            >
            </td>          
          </tr>
    ...
    <table cellpadding=2 cellspacing=0  border="0" class="tableinfo" width="100%">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%">  
               <input type="text" name="E01CKCRDM" size="3" maxlength="2" value="<%= msgData.getE01CKCRDM()%>"  readonly>
               <input type="text" name="E01CKCRDD" size="3" maxlength="2" value="<%= msgData.getE01CKCRDD()%>"  readonly>
               <input type="text" name="E01CKCRDY" size="5" maxlength="4" value="<%= msgData.getE01CKCRDY()%>"  readonly>
            </td>
            <td nowrap align=right width="20%">
            Hora :</td>
            <td nowrap width="30%">
...
<table cellpadding=2 cellspacing=0  border="0" class="tableinfo" width="100%">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%">    
               <input type="text" name="E01CKCVFM" size="3" maxlength="2" value="<%= msgData.getE01CKCVFM()%>"  readonly>
               <input type="text" name="E01CKCVFD" size="3" maxlength="2" value="<%= msgData.getE01CKCVFD()%>"  readonly>
               <input type="text" name="E01CKCVFY" size="5" maxlength="4" value="<%= msgData.getE01CKCVFY()%>"  readonly>
            </td>
            <td nowrap align=right width="20%">
            Hora :</td>
            <td nowrap width="30%">
          ...
          <tr id="trclear">           
            ...
            <td nowrap width="30%">
            <INPUT type="text" name="E01CKCBRN" size="5" maxlength="4" value="<%= msgData.getE01CKCBRN()%>" 	readonly>
            </td> 
          </tr>          
