...
<h3 align="center">Consulta de Producto de Pr&eacute;stamos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="products_inq_ln.jsp, ESD0711"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly name="E10TYPDES" size="45" maxlength="45" value="<%= lnProdInq.getE10TYPDES().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly name="E10DESCRI" size="50" maxlength="45" value="<%= lnProdInq.getE10DESCRI().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              <input type="text" readonly name="E10MERCAD" size="28" maxlength="25" value="<%= lnProdInq.getE10MERCAD().trim()%>">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="50%"> 
              <input type="text" readonly name="E10GLMDSC" size="45" maxlength="45" value="<%= lnProdInq.getE10GLMDSC().trim()%>">
            </td>
          </tr>
        </table>
      </td>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="55%"> 
			  ...
			  <a href="javascript:showLNServCharge('<%= lnProdInq.getE10APCBNK().trim()%>','<%= lnProdInq.getE10APCTYP().trim()%>','<%= lnProdInq.getE10APCTLN().trim()%>');"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="45%"> 
            ...
            <td width="55%"> 
              ...
              <a href="javascript:showCDRates('<%= lnProdInq.getE10APCCCY().trim()%>','<%= lnProdInq.getE10APCCDT().trim()%>');"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="45%"> 
