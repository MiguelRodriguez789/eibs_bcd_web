...
<HTML>
<HEAD>
<TITLE>Banesco - Abonos Masivos, opcion Automática - Aceptar</TITLE>
...
function goSubmit(value){
	if (value == 1) {
		...
		if (confirm("¿Está seguro que desea eliminar esta planilla?")) {
...
function goAction(op) {
 ...
 var page="";
 if (op == 1) {
     page = '${pageContext.request.contextPath}/pages/s/EDL1111_ln_new_sch.jsp';
 } else if (op == 5) {
     page = '${pageContext.request.contextPath}/pages/s/EDL1111_ln_inquiry_sch.jsp?ROW=' + document.forms[0].ROW.value;
 }
...
<h3 align="center">Abonos Masivos, Proceso Automático - Aceptar<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_list_sch.jsp,EDL1111"> 
</h3>
<hr size="4">
      ...
      <td nowrap height="143"> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              <div align="left"> 
                <input type="hidden" readonly name="E01CNOMID" size="5" maxlength="4" value="<%= userPO.getHeader7().trim()%>">
			      ...
			      <td nowrap >
			        <table cellspacing=2 cellpadding=2 width="100%" border="0">
			          ...
			          <tr id="trclear"> 
			            ...
			            <td nowrap  "> 
			              <div align="center"> 
			                <input type="text" readonly size="4" maxlength="4" name="E01OFFBRN" value="<%= userPO.getHeader14().trim()%>">
			              </div>
			            </td>
			            <td nowrap   > 
			              <div align="center"> 
