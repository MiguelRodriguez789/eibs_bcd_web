...
//    		page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSEDL0810?SCREEN=1&OPT=" + opt; 
       ...
       if (document.forms[0].E01DLHNRO.value != "999999999999"){
       	if (opt == 'N') {
                 if (document.forms[0].ideacc.value == "") {
    		   	    page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSEDL0810?SCREEN=600&ACTION=V"+"&ADDRESS="+document.forms[0].address.value;
                 } else {
                 	var formLength= document.forms[0].elements.length;
			          ...
			          page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSEDL0810?SCREEN=600&ACTION=V&IDEACC=" + document.forms[0].ideacc.value+"&IDENDA="+document.forms[0].idenda.value+"&ADDRESS="+document.forms[0].address.value;
			        }
                 }
       	}
       	if (opt == 'M') {
       	   page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSEDL0810?SCREEN=600&ACTION=V&IDEACC=" + document.forms[0].IDACC1.value+"&IDENDA="+document.forms[0].idenda1.value;
       	}
		if (opt == 'D') {
           ...
           if (ideacc == "") {
             alert("No existen deudores");
           } else {
       	     page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSEDL0810?SCREEN=800&ACTION=V&E01DLHNRO=" + document.forms[0].E01DLHNRO.value +"&IDEACC="+ideacc+"&GRP=4&IDENDA="+document.forms[0].idenda1.value;
       	   }
       	}
        if (exists == false) {      
			CenterWindow(page,650,550,2);
...
<h3 align="center">Carta Guia de Cobranzas</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap> 
                <input type="text" name="E01DLHCUN" size="10" maxlength="9" value="<%= collBasic.getE01DLHCUN() %>" readonly>
            </td>
            <td nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="left">
				<input type="text" name="E01DLHNRO" size="13" maxlength="12" value="<%= collBasic.getE01DLHNRO()  %>" readonly>
              </div>
            </td>
            <td nowrap> 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
				<eibsinput:date name="collBasic" fn_year="E01DLHOPY" fn_month="E01DLHOPM" fn_day="E01DLHOPD" readonly="true"/>
            </td>
            <td nowrap width="25%"> 
              <div align="right">No. de Documentos :</div>
            </td>
            <td nowrap>
              <INPUT type="text" name="E01DLHNDO" size="3" maxlength="2" value="<%= collBasic.getE01DLHNDO() %>" onkeypress="enterInteger(event)" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="E01DLHCAC" size="12" maxlength="12" value="<%= collBasic.getE01DLHCAC() %>" onkeypress="enterInteger(event)" readonly>
              <a href="javascript:GetAccount('E01DLHCAC','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="E01DLHDAC" size="12" maxlength="12" value="<%= collBasic.getE01DLHDAC() %>" onkeypress="enterInteger(event)" readonly>
              <a href="javascript:GetAccount('E01DLHCAC','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan=3> 
              <input type="text" name="E01DLHNCG" size="12" maxlength="12" value="<%=collBasic.getE01DLHNCG()%>" onkeypress="enterInteger(event)" readonly>
            </td>
