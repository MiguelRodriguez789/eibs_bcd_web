...
<SCRIPT type="text/javascript">
  ...
  function goAction() {
     ...
     for(var n=0;n<formLength;n++)
      ...
      if ( ok ) 
      {          
      	if (document.forms[0].E02CHMENT.value.trim() != "")      
      	{
	      	if (document.forms[0].E02CHMEIDN.value.trim() != "")
		 	{
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chb_delivery_list.jsp,ECH0320">
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <input type="text" name="E02CHMCUN" size="10" maxlength="9" readonly value="<%= msgChkB.getE02CHMCUN().trim()%>">
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E02CHMACC" size="13" maxlength="12" value="<%= msgChkB.getE02CHMACC().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%= Util.formatCustomDate( currUser.getE01DTF(), msgChkB.getE02CHMRQM(),msgChkB.getE02CHMRQD(),msgChkB.getE02CHMRQY()) %></TD>
     ...
     <TD valign=top>
        <TABLE  border = "0" width="100%" >
          ...
          <TR> 
            ...
            <td> 
              <input type="text" name="E02CHMENT" size="60" maxlength="60" value="<%= msgChkB.getE02CHMENT().trim()%>">
            </td>
          </TR>
          <TR> 
        ...
        <%} else {%>           
            ...
            <td> 
              <input type="text" name="E02CHMEIDN" size="15" maxlength="15" value="<%= msgChkB.getE02CHMEIDN().trim()%>">
            </td>
		<%}%> 
          </TR>
          <TR> 
            <td ALIGN=right></td>
            <td> 
              <input type="hidden" name="E02CHMETID" size="4" maxlength="4" value="<%= msgChkB.getE02CHMETID().trim()%>">
              <!--    		    <a href="javascript:GetCodeCNOFC('E02CHMETID','34')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a>           --> 
            </td>
          </TR>
          <TR> 
            <td  ALIGN=right ></td>
            <td> 
<%--               <input type="hidden" name="E02CHMEIDN" size="4" maxlength="4" value="<%= msgChkB.getE02CHMEIDN().trim()%>">
 --%>              <!--    		    <a href="javascript:GetCodeCNOFC('E02CHMEPID','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a>             --> 
            </td>
          </TR>
        </TABLE>
            </TD>
