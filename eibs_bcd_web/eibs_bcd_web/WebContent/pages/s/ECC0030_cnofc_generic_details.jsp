...
<H3 align="center">C&oacute;digos de Plásticos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnofc_generic_details.jsp, ECC0030"></H3>
<hr size="4">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap height="23"> 
              <div align="left"> 
                ...
                <input type="text" name="E02CCTDSC" size="50" maxlength="45" value="<%= ccCodes.getE02CCTDSC().trim()%>" >
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
