...
<h3 align="center">Asignación Usuarios Propuesta de Crédito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="asignusers_filter,EDP0738"></h3>
<hr size="4">
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter"  border=0  width=70% align="center" >
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
      	    ...
      	    <input type="text" name="E01FILBRN" size="4" maxlength="3" value="" onKeypress="enterInteger(event)">
     ...
     <tr valign="middle"> 
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILEST" size=16 maxlength=2 onKeypress="enterInteger(event)">
