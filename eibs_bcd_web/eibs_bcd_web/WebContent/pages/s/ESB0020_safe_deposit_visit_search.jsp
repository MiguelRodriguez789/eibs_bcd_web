...
%>
<H3 align="center">Búsqueda Consulta de Logs - Caja de Seguridad<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="safe_deposit_visit_search, ESB0020"></H3>
<hr size="4">
