...
<H3 align="center">Reversion de Ingreso Manual Papel Valor<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_mov_rev_inq,EVL0035"></H3>
<hr size="4">
<p>&nbsp;</p>
