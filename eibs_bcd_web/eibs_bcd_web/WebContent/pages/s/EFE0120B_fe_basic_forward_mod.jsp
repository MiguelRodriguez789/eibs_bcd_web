...
%>
<div align="center"> 
  <h3>Forward Moneda Extranjera (Back Office) </h3>
</div>
<hr size="4">
      ...
      <td nowrap align="left"> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" align="right">Fecha Pacto :</td>
            <td nowrap width="23%" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" > <% if(fex.getE01FESSBT().equals("PU")) out.print("Compra");
          ...
          <tr id="trclear"> 
            <td nowrap width="33%" > 
              <div align="right">Moneda Nostro :</div>
            </td>
          ...
          <tr id="trclear"> 
            <td nowrap width="33%" > 
              <div align="right"> Moneda Vostro :</div>
            </td>
