...
<h3 align="center">Cargos por Servicios y Tasas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ESD0205_rt_inq_tables_dda_02, ESD0205" ></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="31%"> 
              <div align="left"> 
                <input type="text" name="E02RTEMBM" size="14" maxlength="13" value="<%= charges.getE02RTEMBM()%>" readonly>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEBL3" size="14" maxlength="13" value="<%= charges.getE02RTEBL3()%>" readonly>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="31%" height="34" > 
              <div align="left"> 
                <input type="text" name="E02RTEMBR" size="14" maxlength="13" value="<%= charges.getE02RTEMBR()%>" readonly>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="18%" > 
              <div align="left"> 
                <input type="text" name="E02RTEMDC" size="10" maxlength="9" value="<%= charges.getE02RTEMDC()%>" readonly>
              </div>
            </td>
            <td nowrap width="29%"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEMKD" size="4" maxlength="3" value="<%= charges.getE02RTEMKD()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            ...
            <td nowrap width="25%"> 
              <div align="left"> 
                <input type="text" readonly class="txtright"  name="E02RTEDDL" size="5" maxlength="4" value="<%= charges.getE02RTEDDL()%>">
              </div>
            </td>
            <td nowrap width="25%"> 
            ...
            <td nowrap width="25%"> 
                <input type="text" readonly  class="txtright"  name="E02RTEDCH" size="10" maxlength="9" value="<%= charges.getE02RTEDCH()%>">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="16%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMKL" size="14" maxlength="13" value="<%= charges.getE02RTEMKL()%>" readonly>
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB1" size="14" maxlength="13" value="<%= charges.getE02RTEMB1()%>" readonly>
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="16%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMB2" size="14" maxlength="13" value="<%= charges.getE02RTEMB2()%>" readonly>
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMB3" size="14" maxlength="13" value="<%= charges.getE02RTEMB3()%>" readonly>
              </div>
            </td>
            <td nowrap width="27%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="16%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMB4" size="14" maxlength="13" value="<%= charges.getE02RTEMB4()%>" readonly>
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB5" size="14" maxlength="13" value="<%= charges.getE02RTEMB5()%>" readonly>
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="16%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMB6" size="14" maxlength="13" value="<%= charges.getE02RTEMB6()%>" readonly>
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB7" size="14" maxlength="13" value="<%= charges.getE02RTEMB7()%>" readonly>
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="16%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB8" size="14" maxlength="13" value="<%= charges.getE02RTEMB8()%>" readonly>
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB9" size="14" maxlength="13" value="<%= charges.getE02RTEMB9()%>" readonly>
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="16%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMBX" size="14" maxlength="13" value="<%= charges.getE02RTEMBX()%>" readonly>
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMBY" size="14" maxlength="13" value="<%= charges.getE02RTEMBY()%>" readonly>
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
