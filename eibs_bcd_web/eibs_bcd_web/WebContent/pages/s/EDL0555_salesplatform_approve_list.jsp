...
<h3 align="center">Aprobacion de Negociacion de Creditos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="salesplatform_approve_list.jsp,EDL0555"></h3>
<hr size="4">
...
<input type="hidden" id="TYPE" name="TYPE" value=""> 
  ...
  <table class="tbenter" style="width: 100%;">
    <tr>
      ...
      <td align="center" class="tdbkg" width="33%"><a href="javascript:goAction('1001')"><b>Aprobar</b></a></td>
      <td align="center" class="tdbkg" width="33%"><a href="javascript:goAction('1004')"><b>Borrar</b> </a></td>
      <% } %>
    </tr>
  </table>
        ...
        <div id="dataDiv1"  style="height:360px; overflow:auto;"> 
          ...
          %>
            <tr id="dataTable<%= msgList.getCurrentRow() %>">
              ...
              <td nowrap align="center" width="10%"><a href="javascript:goAction('1009',<%=msgList.getCurrentRow()%>);"><%=list.getE02DLNOFN()%></a></td>
              <td nowrap align="center" width="10%"><a href="javascript:goAction('1009',<%=msgList.getCurrentRow()%>);"><%=list.getE02SELCUN()%></a></td>
              <td nowrap align="left" width="40%"><a href="javascript:goAction('1009',<%=msgList.getCurrentRow()%>);"><%=list.getE02DSCPRO()%></a></td>
              <td nowrap align="center" width="10%"><a href="javascript:goAction('1009',<%=msgList.getCurrentRow()%>);"><%= Util.formatCustomDate(currUser.getE01DTF(), list.getBigDecimalE02DLNODM().intValue(), 
              										    list.getBigDecimalE02DLNODD().intValue(),
               										    list.getBigDecimalE02DLNODY().intValue()) %></a></td>
              <td nowrap align="center" width="10%"><a href="javascript:goAction('1009',<%=msgList.getCurrentRow()%>);"><% if (list.getField("E02DLNSTS").getString().equals("")) {
