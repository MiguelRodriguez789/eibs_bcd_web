...
<H3 ALIGN="center">Control de Documentos Recibidos<IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left"
	NAME="EIBS_GIF" title="coll_doc_enter.jsp, EDCC0200"></H3>
<HR SIZE="4">
	...
	<TR>
		...
		<TD width="50%">
		   <DIV><INPUT TYPE="text" NAME="E01DCMACC" SIZE="13" MAXLENGTH="12" ONKEYPRESS="enterInteger(event)">
		    <A HREF="javascript:GetAccount('E01DCMACC','','51','')"> <IMG SRC="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" BORDER="0"></A>
		   </DIV>
		</TD>
	</TR>
	<TR>
