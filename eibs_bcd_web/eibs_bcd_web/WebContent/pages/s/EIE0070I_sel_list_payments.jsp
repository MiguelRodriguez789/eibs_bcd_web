...
<h3 align="center">Esquema de Pagos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_instruments.jsp, EWD0308"></h3>
<hr size="4">
...
<TABLE class="tbenter" width="100%" height="50%" >
    <tr>
      <TD > 
        <div align="center"> 
          <p><b>No hay resultados para su busqueda </b></p>
        </div>
    ...
    <TD NOWRAP valign="top" width="100%" >
        <table id="headTable" width="100%" >
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap > 
              <div align="center">Fecha<br> de Pago</div>
            </th>
