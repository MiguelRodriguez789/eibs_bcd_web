...
%>
<div align="center"> 
  <h3>Consulta - Forward Moneda Extranjera </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="21%" > <% if(fex.getE01FEMSBT().equals("PU")) out.print("Compra");
          ...
          <tr id="trclear"> 
            ...
            <td nowrap align="right" width="23%">Monto Original Mda. Base :</td>
          ...
          <tr id="trdark">
            ...
            <td nowrap align="right" width="23%">Balance Moneda Base :</td>
