...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_signatures_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMTSig.getE08CUFAC1(),msgMTSig.getE08CUFAC2(),msgMTSig.getE08CUFAC3())  + " - " + msgMTSig.getE08CUFACT()%></TD>
