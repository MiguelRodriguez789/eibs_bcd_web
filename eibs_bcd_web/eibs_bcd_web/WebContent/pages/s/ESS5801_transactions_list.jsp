...
<% String CusName = "";
 ...
 %>
<H3 align="center">Pagos de Navieras por Internet<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="transaction_list, ESS5801"></H3>
<hr size="4">
