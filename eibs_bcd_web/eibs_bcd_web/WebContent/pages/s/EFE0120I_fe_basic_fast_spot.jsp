...
%> 
<h3 align="center"> Consulta - Fast Spot <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_fast_spot.jsp,EFE0120I"> 
</h3>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="85%" > 
              <div align="left"> 
                ...
                <input type="text"  size="45" maxlength="45" readonly value="<%= fex.getD01FESCPL().trim()%>" name="D01FESCPL">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap >&nbsp;</td>
            <td nowrap colspan="4" > 
              <input type="text"  name="E01FESCIS" size="70" maxlength="60" value="<%= fex.getE01FESCIS().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
