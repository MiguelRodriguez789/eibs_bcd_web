...
function enter(){
	if(!(document.getElementById("E01SELBRN") == null)) {
		  	if(!(document.getElementById("E01SELBRN").value.length > 0)) {
		  		alert("Debe Ingresar Código de Oficina");
  				document.getElementById("E01SELBRN").focus();
  				return false;
  			}
	}
	if(!(document.getElementById("E01SELCAU") == null)) {
		  	
	  		if(!(document.getElementById("E01SELCAU").value.length > 0)) {
	  		    alert("Debe Ingresar Código de Causal");
  			    document.getElementById("E01SELCAU").focus();
  			    return false;
		 	}
	} 
   return true;
...
%>
<h3 align="center">Devoluci&oacute;n de Cheques<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rejection_chk_search.jsp,EDD0924"></h3>
<hr size="4">
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.approval.JSEDD0924" onsubmit="return(enter())">
  ...
  <INPUT TYPE=HIDDEN NAME="ACCNUM" id="ACCNUM" VALUE="">
  <INPUT TYPE=HIDDEN NAME="opt" id="opt" VALUE="<%= dataCR.getOption() %>">
    ...
    <table class="tbenter" width="100%" border="0">
			<% if(	(dataCR.getOption().equals("NSF")) ||
                ...
                <tr> 
                  ...
                  <td NOWRAP width="50%"> 
                    <div align="left"> 
                      <input type="text" name="E01SELOFC" id="E01SELOFC" size=5 maxlength=4 value="<%if (dataCR.getOfficer() != null) out.print(dataCR.getOfficer());%>">
			...
			<% }
              ...
              <div align="right"> C&oacute;digo de Oficina : </div>
                  ...
                  <td NOWRAP width="50%">
                    <div align="left"> 
                      <input type="text" name="E01SELBRN" id="E01SELBRN" size=5 maxlength=4 value="<%if (dataCR.getBranch() != null) out.print(dataCR.getBranch());%>">
			...
			<% }
              ...
              <div align="right"> C&oacute;digo de Causal : </div>
                  ...
                  <td NOWRAP width="50%"> 
                    <div align="left"> 
					  <input type="text" name="E01SELCAU"  id="E01SELCAU"  size=5 maxlength=4 value="<%if (dataCR.getCause() != null) out.print(dataCR.getCause());%>">
			...
			<% }
                ...
                <tr> 
                  ...
                  <td NOWRAP width="50%"> 
                    <div align="left"> 
					 <input type="text" name="E01SELACC" id="E01SELACC" size="12" maxlength="12"  onKeypress="enterInteger(event)" value="<%if (dataCR.getAccNum() != null) out.print(dataCR.getAccNum());%>">
			...
			<% } 
              ...
              <div align="right"> Monto : </div>
                  ...
                  <td NOWRAP width="50%"> 
                    <div align="left"> 
					  <input type="text" name="E01SELAMT"  id="E01SELAMT"  size=22 maxlength=20 value="<%if (dataCR.getAmount() != null) out.print(dataCR.getAmount());%>" onKeypress="enterDecimal()">
					</div>
				  </td>
                </tr>
			<% } %>
...
<script type="text/javascript">
   <% if(		(dataCR.getOption().equals("NSF")) || 
   				...
   				(dataCR.getOption().equals("RP")) || 
   				(dataCR.getOption().equals("RR"))){ %>
      document.getElementById("E01SELOFC").focus();
   <% } else if((dataCR.getOption().equals("LI"))){%>
      document.getElementById("E01SELBRN").focus();
   <% } else if(dataCR.getOption().equals("PI")){%>
