...
<H3 align="center">Actualizacion Stock de Oficina<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_stock_update_detail,EVL0080"></H3>
<hr size="4">
