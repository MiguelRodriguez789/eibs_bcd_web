...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSEGL0420">
  ...
  <h3 align="center">Consulta de Transacciones de Cuentas Contables<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="st_list_fp.jsp,EGL0420"> 
  </h3>
  <hr size="4">
...
<table class="tableinfo">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark">
            ...
            <td nowrap width="70%" > 
              ...
              <input type="text" name="E02GLMBRN" size="5" readonly maxlength="4" value="<%= userPO.getBranch().trim()%>" >
  ...
  <TABLE id=cfTable class="tableinfolist">
    <TR id=trdark> 
      <TH ALIGN=CENTER width="53" nowrap>Fecha Proceso</TH>
      ...
      <TH ALIGN=CENTER width="43" nowrap>Fecha Valor </TH>
