...
%>
<h3 align="center">MT 300 - Mensaje de Confirmaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_op_format.jsp,ESWF300A"> 
</h3>
<hr size="4">
<form method="post" >
