...
function eliminar(){
	a = confirm("¿Desea eliminar el Deudor?");
	if (a) {
...
%> 
<h3 align="center">Mantenimiento de Deudores<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dft_acceptor_mant.jsp,EDL0810"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3"> 
              <INPUT type="text" name="ideacc" size="27" maxlength="25" value="<%= dftAcceptor.getE03DLDIDA() %>" <%=strReadonly %> readonly>
            </td>
	          <td nowrap width="25%">
