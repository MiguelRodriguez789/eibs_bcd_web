...
%>
<h3 align="center">MT 300 Mensaje de Confirmaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_sf_format.jsp,ESWF300I"> 
</h3>
<hr size="4">
<form method="post" >
                  ...
                  <tr id="trdark"> 
                    ...
                    <td nowrap > 
                      <div align="left"><%= Util.formatCustomDate(currUser.getE01DTF(),
                      		swift.getBigDecimalE03SWFTDM().intValue(),
                      		swift.getBigDecimalE03SWFTDD().intValue(),
                      		swift.getBigDecimalE03SWFTDY().intValue())%></div>
                    </td>
                  </tr>
                  <tr id="trclear"> 
                    <td nowrap width="17%" > 
                    ...
                    <td nowrap > 
                      <div align="left"><%= Util.formatCustomDate(currUser.getE01DTF(),
                      		swift.getBigDecimalE03SWFVDM().intValue(),
                      		swift.getBigDecimalE03SWFVDD().intValue(),
                      		swift.getBigDecimalE03SWFVDY().intValue())%></div>
                    </td>
                  </tr>
                </table>
              </td>
