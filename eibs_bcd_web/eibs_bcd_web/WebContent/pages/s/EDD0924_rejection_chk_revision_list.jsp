...
<HTML>
<HEAD>
<TITLE> Cheques No Procesados </TITLE>
...
<h3 align="center">Revisi&oacute;n Resoluci&oacute;n de Protestos, Oficial : 
  ...
  <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rejection_chk_revision_list.jsp,EDD0924"></h3>
<hr size="4">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<TR>
	  <TD ALIGN=right nowrap>
          Buscar Cuenta : 
          <input type="text" maxlength=9 size=11 name="ACCNUM" id="ACCNUM" onKeyPress="enterInteger(event)"
...
<div id="hiddenDivCause" class="hiddenDiv">
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<TR>
	  <TD ALIGN=right nowrap>
          Buscar Causal : 
          <input type="text" name="CAUSE" id="CAUSE" maxlength=4 size=5 
  ...
  %> 
     		<TR> 
              ...
              <TD ALIGN=Left NOWRAP><a href="javascript:radioClick('RECNUM',<%= chkList.getCurrentRow() %>)"><%= chkList.getRecord(0) %> - </a> 
				...
				<TD ALIGN=RIGHT NOWRAP><a href="javascript:radioClick('RECNUM',<%= chkList.getCurrentRow() %>)"><%= datapro.eibs.master.Util.formatCell(chkList.getRecord(18)) %></a></TD>
				<TD ALIGN=RIGHT NOWRAP><a href="javascript:radioClick('RECNUM',<%= chkList.getCurrentRow() %>)"><%= datapro.eibs.master.Util.formatCell(chkList.getRecord(28)) %></a></TD>
