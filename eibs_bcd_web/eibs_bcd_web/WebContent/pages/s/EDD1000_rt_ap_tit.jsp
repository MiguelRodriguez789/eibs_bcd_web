...
<h3 align="center">Informaci&oacute;n de Titulares<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_ap_tit.jsp,EDD1000"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" readonly name="E04DEACUN" size="10" maxlength="9"  value="<%= userPO.getCusNum().trim() %>">
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" readonly name="E04CUSNA1" size="45" maxlength="45" value="<%= userPO.getCusName().trim()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" readonly name="E06ACC" size="13" maxlength="12" value="<%= userPO.getAccNum().trim()%>">
              </div>
            </td>
            <td nowrap width="16%"> 
            ...
            <td nowrap width="16%"> 
              <div align="left">
                <input type="text" readonly name="E04DEAPRO" size="5" maxlength="4"value="<%= userPO.getProdCode().trim()%>">
              </div>
            </td>
          </tr>
        </table>
