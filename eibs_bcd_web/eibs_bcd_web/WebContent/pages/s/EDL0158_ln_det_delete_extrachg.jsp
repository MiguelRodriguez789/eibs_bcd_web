...
<h3 align="center">Confirmacion Borrado de Gastos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_det_extrachg.jsp, EDL0158"></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0158">
  ...
  <INPUT TYPE=HIDDEN NAME="E01DLSTYP" VALUE= "<%= EDL0158code.getE01DLSTYP()%>">
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" id="INFOCHG">
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="70%"> 
 		        <eibsinput:text name="EDL0158code" property="E01DLSSEQ" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_INTEGER %>" size="4" maxlength="3" readonly="true" />
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td width="30%"> 
		 	...
		 	<td width="70%"> 
            	<select  name="E01DLSTYP1" disabled>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  
            ...
            <td nowrap width="70%"> 
            <div align="left">
            	<eibsinput:text name="EDL0158code" property="E01DLSAMT" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_DECIMAL %>" readonly="true"/>
			</div>
            </td>
          </tr>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td width="70%"> 
              <input type="text" name="E01DLSNAR" size="60" maxlength="60" value="<%= EDL0158code.getE01DLSNAR().trim()%>" readonly>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td width="30%"> 
               ...
               <table class="tableinfo" style="filter:''">
                    ...
                    <div align="center">Cuenta Contable</div>
          			...
          			<tr id="trclear"> 
            			...
            			<td width="13%"> 
              				<div align="center"> 
                			<input type="text" name="E01DLSOBR" size="4" maxlength="4" value="<%= EDL0158code.getE01DLSOBR().trim()%>"
							class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E01DLSOBK.value,'','','','')">
              				</div>
            			</td>
            			<td width="12%" > 
              				<div align="center">
                			<input type="text" name="E01DLSOCY" size="3" maxlength="3" value="<%= EDL0158code.getE01DLSOCY().trim()%>"
                			class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.forms[0].E01DLSOBK.value,'','','','')"> 
              				</div>
            			</td>
            			<td width="25%" > 
              				<div align="center"> 
                			<input type="text" name="E01DLSOGL" size="16" maxlength="16" value="<%= EDL0158code.getE01DLSOGL().trim()%>"
            			...
            			<td width="25%" > 
              				<div align="center"> 
                			<input type="text" name="E01DLSOAC" size="16" maxlength="16" value="<%= EDL0158code.getE01DLSOAC().trim()%>"
