...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cleaning_load_list, EDD0931"></h3> 
<hr size="4">
  ...
  <TABLE class="tableinfo">
    ...
    <%
          ...
          while (loadList.getNextRow()) {
               EDD093102Message msgList = (EDD093102Message) loadList.getRecord();			 
