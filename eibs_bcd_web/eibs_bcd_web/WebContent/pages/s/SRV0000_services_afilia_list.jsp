...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_afilia_list.jsp,SRV0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE01AFICD1(),msgMT.getE01AFICD2(),msgMT.getE01AFICD3())  + " - " + Util.formatCell(msgMT.getE01AFICRT())%></TD>
