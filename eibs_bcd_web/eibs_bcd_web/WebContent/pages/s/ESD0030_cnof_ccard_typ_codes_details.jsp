...
<H3 align="center">C&oacute;digos de Referencia del Sistema <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnof_ccard_typ_codes_details.jsp, ESD0030"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E02CNOPAF" size="3" maxlength="2" value="<%= refCodes.getE02CNOPAF().trim()%>">
              </div>
            </td>
          </tr>
        </table>
