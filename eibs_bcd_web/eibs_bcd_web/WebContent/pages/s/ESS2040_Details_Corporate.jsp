      ...
      <tr >
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          ...
          <tr id="teclear">
            ...
            <td nowrap width="60%" ><div align="left"> <input READONLY type="text" ID="MANDATORY" name="E02EUSACC" class="<%= userDetail.getF02EUSACC().equals("Y")?"textchanged":"" %>" size="35" maxlength="12" value="<%= userDetail.getE02EUSACC().trim()%>" onkeypress="enterInteger(event)">
          ...
          <tr id="trdark"> 
            <td nowrap width="40%" ><div align="right">Múltiples Administradores :</div></td> 
            <td nowrap width="60%" ><div align="left">
               <SELECT DISABLED NAME="E01EUSCFM" class="<%= userDetail.getF02EUSCFM().equals("Y")?"textchanged":"" %>">
                 <OPTION VALUE="1" <%if (userDetail.getE02EUSCFM().equals("1")) {out.print("selected"); }%>>NO</OPTION>
                 <OPTION VALUE="2" <%if (userDetail.getE02EUSCFM().equals("2")) {out.print("selected"); }%>>SI</OPTION>
               </SELECT>            
             </div> 
            </td>
          </tr>          
          ...
          <tr id="teclear">
            ...
            <td nowrap width="60%" ><div align="left"> <input READONLY type="text" ID="MANDATORY" name="E02EUSIAD" class="<%= userDetail.getF02EUSIAD().equals("Y")?"textchanged":"" %>" size="35" maxlength="45" value="<%= userDetail.getE02EUSIAD().trim()%>"></div></td>
          </tr>
        </table>
        </td>
      </tr>
