...
<h3 align="center">Sistema de Bastanteo - Consulta Datos de Identificaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_customers_inq, ECU0000" ></h3>
<hr size="4">
        ...
        <td nowrap > 
          <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
            ...
            <tr id="teclear"> 
              ...
              <td nowrap width="25%">  
                <input type="text" name="E02CUSMD1" size="3" maxlength="2"  readonly value="<%= msgMT.getE02CUSMD1().trim()%>">
                <input type="text" name="E02CUSMD2" size="3" maxlength="2"  readonly value="<%= msgMT.getE02CUSMD2().trim()%>">
                <input type="text" name="E02CUSMD3" size="5" maxlength="4"  readonly value="<%= msgMT.getE02CUSMD3().trim()%>">
                </td>
            </tr>
            <tr id="trdark"> 
            <td nowrap  width="25%"> 
        ...
        <td nowrap > 
          <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
            ...
            <tr id="trdark"> 
              ...
              <td nowrap width="25%">  
                <input type="text" name="E02CUSRD1" size="3" maxlength="2"  readonly value="<%= msgMT.getE02CUSRD1().trim()%>">
                <input type="text" name="E02CUSRD2" size="3" maxlength="2"  readonly value="<%= msgMT.getE02CUSRD2().trim()%>">
                <input type="text" name="E02CUSRD3" size="5" maxlength="4"  readonly value="<%= msgMT.getE02CUSRD3().trim()%>">
                </td>
                <td nowrap  width="25%"> 
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E02CUSOBS" size="90" maxlength="80" readonly value="<%= msgMT.getE02CUSOBS().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%">
