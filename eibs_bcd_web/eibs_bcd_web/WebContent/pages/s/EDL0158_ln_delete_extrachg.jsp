      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="25%" > 
              <div align="left"> 
                <input type="text" name="E01DLSSEQ" size="3" maxlength="2" value="<%= msgLN.getE01DLSSEQ().trim()%>" readonly>
              </div>
            </td>
          </tr>
        </table>
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" id="INFOCHG">
          ...
          <!--  
            ...
            <td > 
              <input type="text" name="E01DLSPD1" size="3" maxlength="2" value="" readonly>
              <input type="text" name="E01DLSPD2" size="3" maxlength="2" value="" readonly>
              <input type="text" name="E01DLSPD3" size="5" maxlength="4" value="" readonly>
            </td>
            -->
          </tr>
          <tr id="trdark">  
            ...
            <td > 
              <input type="text" name="E01DLSAMT" size="17" maxlength="17" value="<%= msgLN.getE01DLSAMT()%>" onkeypress="enterDecimal(event, 2)" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="30%"> 
          ...
          <tr id="trclear"> 
            ...
            <td > 
              <input type="text" name="E01DLSIVP" size="8" maxlength="8" value="<%= msgLN.getE01DLSIVP() %>" onKeypress="enterInteger(event)" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="30%"> 
            ...
            <td > 
              <input type="text" name="E01DLSIVB" size="17" maxlength="17" value="<%= msgLN.getE01DLSIVB()%>" onKeypress="enterInteger(event)" readonly>
            </td>
          </tr>
        </table>                       
      </td>
