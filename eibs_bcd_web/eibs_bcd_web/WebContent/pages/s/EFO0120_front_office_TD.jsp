...
<h3>Front Office - Certificado de Depósito Nuevo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="front_office_TD.jsp,EFO0120"></h3>
</div>
<hr size="4">
		...
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
			<TBODY>
				<TR id="trintro">
					...
					<TD nowrap width="25%">
						<%if (msgCust.getE02FESCCL().equals("1")) out.print("Moral - ");
									else if (msgCust.getE02FESCCL().equals("2")) out.print("Físico - ");
									else out.print("OTRO - ");%>
						<%if (msgCust.getE02FESSTS().equals("3")) out.print("Lista de Control");
...
<B> 
	<SCRIPT type="text/javascript">
    	function resizeDoc() {
			...
			adjustEquTables( getElement('headTable1'), getElement('dataTable1'), getElement('dataDiv2'),1,false);
    	}	
    	resizeDoc();
