...
<html>
<head>
<title>Cantidad de Mensajes</title>
...
%>
<body>
<H3 align="center">Códigos de Referencia del Sistema - Cantidad de Mensajes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnof_qty_messages.jsp, ESD0030"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="16%" align="right"> 
               <div align="right">Cantidad de Mensajes :</div>
            </td>
            <td nowrap align="left">
