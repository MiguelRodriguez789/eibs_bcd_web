...
<html>
<head>
<title>Table/List Eventos Credilinea</title>
...
<h3 align="center">Eventos Hist&oacute;ricos - Credilinea<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cuplus_eventos_enter.jsp, EPV0153"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.salesplatform.JSEPV0153DADC" >
