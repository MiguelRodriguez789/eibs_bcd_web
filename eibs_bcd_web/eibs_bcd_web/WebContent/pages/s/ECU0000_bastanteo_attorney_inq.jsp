...
<H3 align="center">Sistema de Bastanteo - Consulta del Propietario/Apoderado<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_apoderado_inq,ECU0000"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	...
    	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E05CUMDD1" readonly size="3" maxlength="2" value="<%= msgMT.getE05CUMDD1() %>">
	      	<input type="text" name="E05CUMDD2" readonly size="3" maxlength="2" value="<%= msgMT.getE05CUMDD2() %>">
	      	<input type="text" name="E05CUMDD3" readonly size="5" maxlength="4" value="<%= msgMT.getE05CUMDD3() %>">
	      </td>     
      	</tr>
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E05CUMD21" size="3" maxlength="2" readonly value="<%= msgMT.getE05CUMD21() %>">
	      	<input type="text" name="E05CUMD22" size="3" maxlength="2" readonly value="<%= msgMT.getE05CUMD22() %>">
	      	<input type="text" name="E05CUMD23" size="5" maxlength="4" readonly value="<%= msgMT.getE05CUMD23() %>">
      	  </td>     
      	</tr>
     	<tr id="trdark"> 
          <td> 
      ...
      <tr > 
        ...
        <tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E05REGRDD" readonly size="3" maxlength="2" value="<%= msgMT.getE05REGRDD() %>">
	      	<input type="text" name="E05REGRMM" readonly size="3" maxlength="2" value="<%= msgMT.getE05REGRMM() %>">
	      	<input type="text" name="E05REGRYY" readonly size="5" maxlength="4" value="<%= msgMT.getE05REGRYY() %>">
	      </td>     
      	</tr>
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMOBS" size="90" maxlength="80" readonly value="<%= msgMT.getE05CUMOBS().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="100%">
