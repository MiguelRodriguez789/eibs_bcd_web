...
<H3 align="center">Solicitud Manual a la Dispensadora<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chb_enter_acc, ECH5305"></H3>
...
<INPUT type="hidden" name="SCREEN" value="2">
  ...
  <table class="tbenter" cellspacing=0 cellpadding=2 border="0">
    <tr> 
      ...
      <td nowrap width="50%"><input type="text" name="E01CHPACC" size="13" maxlength="12" onKeypress="enterInteger(event)">
