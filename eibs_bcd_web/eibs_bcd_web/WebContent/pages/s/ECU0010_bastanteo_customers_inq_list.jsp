...
<HEAD>
<TITLE>
Consulta de Vencimientos Sistema de Bastanteo
</TITLE>
...
<SCRIPT type="text/javascript">
  ...
  function goAction(opt) {
    ...
    if (opt == "I") { 
    	...
    	page = "<%=request.getContextPath()%>/pages/s/ECU0010_bastanteo_customers_inq.jsp?ROW=" + row;
...
<h3 align="center">Consulta de Vencimientos - Sistema de Bastanteo
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_customers_inq_list.jsp,ECU0010">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
  		<TR id="trdark"> 
    		...
    		<TH ALIGN=CENTER >Dias de <BR>Vencimiento</TH>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01CUSV00())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01CUSV60())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01CUSV12())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01CUSV18())%></TD>
