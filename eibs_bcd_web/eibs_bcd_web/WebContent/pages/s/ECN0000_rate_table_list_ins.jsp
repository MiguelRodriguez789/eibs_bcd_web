...
function goAction(op) {
	...
	page = "<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSECN0000?SCREEN=250&opt=" + op + params;	
...
<h3 align="center">Tasas Para Seguros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rate_table_list_ins.jsp, ECN0000"></h3>
<hr size="4">
