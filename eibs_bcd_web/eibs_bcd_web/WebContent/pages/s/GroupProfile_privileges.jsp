...
<SCRIPT type="text/javascript">
  ...
  function getNewPrivilege(){
    page= "${pageContext.request.contextPath}/pages/s/PrivilProfile_container.jsp"
    fieldPVL = "NEWPVL";
    fieldVAL = "NEWVAL";
  ...
  var row = document.forms[0].ROW.value;
    page= "${pageContext.request.contextPath}/pages/s/PrivilProfile_search.jsp?PARENT=GRP&ROW=" + row;
    fieldPVL = "NEWPVL";
    fieldVAL = "NEWVAL";
...
<body>
<h3 align="center">Privilegios de Grupo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="privileges, GroupProfile"></h3>
<hr size="4">
