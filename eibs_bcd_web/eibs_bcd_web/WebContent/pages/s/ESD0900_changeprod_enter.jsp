...
%>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0900" >
  ...
  <h3 align="center">Cambio de C&uacute;digo de Productos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="change_products.jsp,ESD0900"> 
  </h3>
  <hr size="4">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
        ...
        <table id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
           <tr> 
            ...
            <td width="60%" nowrap> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E01CHGAPL','E01PRDDSC','AP')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a> 
        ...
        <table id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
           <tr> 
            ...
            <td width="60%" nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E01CHGPRT','04')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a> 
            </td>
          </tr>
        </table>
      </td>
