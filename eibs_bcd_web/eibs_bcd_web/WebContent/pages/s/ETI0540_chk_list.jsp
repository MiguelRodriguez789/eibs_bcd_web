...
%>
<BODY>
<h3 align="center">Lista de Cheques Preautorizados<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="loan_parties_list, EDL0170"></h3>
<hr size="4">
<P><BR>
      ...
      <TD > 
        <div align="center"> 
         ...
         <table class="tbenter" width=100% align=center>
           <tr>
           <td class=TDBKG>
                <div align="center" style="cursor:hand" onClick="javascript:goAction(200)"><a><b>Crear</b></a></div>
              </td>
              <td class=TDBKG>
  ...
  <p> 
   ...
   <table class="tbenter" width=100% align=center>
    <tr> 
      ...
      <td class=TDBKG width="33%"> 
        <div align="center"><a href="javascript:goAction(300)"><b>Modificar</b></a></div>
      </td>
      <td class=TDBKG width="33%"> 
        <div align="center"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Salir</b></a></div>
      </td>
 ...
 <TR > 
    <TD NOWRAP valign="top" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="LEFT"><%=msgPart.getE01CKCSTS()%></TD>
