...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_balance_list.jsp,SRV0030">
</h3>
<hr size="4">
...
%> 
 ...
 <TABLE class="tbenter" width="100%" align=center>
    <TR> 
      ...
      <TD class=TDBKG width="25%"> 
        <div align="center"><a href="javascript:goAction('M')">Consultar</a> 
        </div>
      </TD>
      <TD class=TDBKG width="25%"> 
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE01BALUD1(),msgMT.getE01BALUD2(),msgMT.getE01BALUD3())  + " - " + Util.formatCell(msgMT.getE01BALUPT())%></TD>
