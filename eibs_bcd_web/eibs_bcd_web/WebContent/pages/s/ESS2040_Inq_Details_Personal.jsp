...
<h3 align="center">Usuario Persona Física</h3><form method="post" action="<%=request.getContextPath()%>/servlet/com.datapro.eibs.internet.JSESS2040" onsubmit="return FieldNotBlank(this)"><INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="4">
  ...
  <table class="tableinfo">
      <tr >
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          ...
          <tr id="teclear">
            <td nowrap width="40%" ><div align="right">Clave :</div></td>
			...
			<TR>
				<TD nowrap width="40%" colspan="2" align="center">
				   <TABLE width="90%">
					  ...
					  <tr align="center">
					     <TD align="right">Permite Transferencia entre Mis Cuentas :</TD>
					  ...
					  <tr align="center">
					     <TD align="right">Permite Transferencia a Terceros en BNP :</TD>
					  ...
					  <tr align="center">
					     <TD align="right">Permite Transferencia  Internacionales :</TD>
          ...
          <tr id="trdark">
            ...
            <td nowrap width="60%" ><div align="left"> <input readonly  type="text" ID="MANDATORY" name="E02EUSIAD" class="<%= userDetail.getF02EUSIAD().equals("Y")?"textchanged":"" %>" size="50" maxlength="40" value="<%= userDetail.getE02EUSIAD().trim()%>"></div></td>
          </tr>
          <!--  tr id="teclear">
  ...
  <table border="0" width="95%">
    <tr align="center">
       <td><INPUT id="EIBSBTN" type=BUTTON name="Submit" value="Aceptar" onclick="JavaScript:window.close()"></td>
    </tr>
  </table>
</form>
</body>
