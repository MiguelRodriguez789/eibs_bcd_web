      ...
      <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" name="TB_BENEFICIARY_CORP" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
          <tr id="trdark"> 
            ...
            <td width="23%" nowrap>  
              <input type="text" name="E<%= name %>4MA1" maxlength="45" size="50" value="<%= liabilities.getField("E" + name + "4MA1").getString().trim()%>">
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="13%" nowrap> 
            ...
            <td nowrap>  
              <input type="text" name="E<%= name %>4MA2" maxlength="45" size="50" value="<%= liabilities.getField("E" + name + "4MA2").getString().trim()%>">
              </td>
          </tr>
          <tr id="trdark"> 
            <td width="13%" nowrap> 
            ...
            <td width="23%" nowrap>  
              <input type="text" name="E<%= name %>4MA3" maxlength="45" size="50" value="<%= liabilities.getField("E" + name + "4MA3").getString().trim()%>">
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="13%" nowrap> 
            ...
            <td width="23%" nowrap>  
              <input type="text" name="E<%= name %>4AM1" maxlength="15" size="16" value="<%= liabilities.getField("E" + name + "4AM1").getString().trim()%>" onKeypress="enterDecimal()" class="txtright">
              </td>
          </tr>
          <tr id="trdark"> 
            <td width="13%" nowrap> 
            ...
            <td width="23%" nowrap>  
              <input type="text" name="E<%= name %>4DT1" size="3" maxlength="2" value="<%= liabilities.getField("E" + name + "4DT1").getString().trim()%>" class="txtright">
             
              <input type="text" name="E<%= name %>4DT2" size="3" maxlength="2" value="<%= liabilities.getField("E" + name + "4DT2").getString().trim()%>" class="txtright">
             
              <input type="text" name="E<%= name %>4DT3" size="5" maxlength="4" value="<%= liabilities.getField("E" + name + "4DT3").getString().trim()%>" class="txtright">
              </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="34%">
