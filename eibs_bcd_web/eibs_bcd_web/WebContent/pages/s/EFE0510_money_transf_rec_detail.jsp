...
<H3 align="center">Recibo de Remesas de Efectivo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transf_rec_detail,EFE0510"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
        ...
        <tr id=trdark>
          ...
          <td nowrap>
             <input type="text" name="E03REMPOR" value="<%= msgMT.getE03REMPOR() %>" onkeypress="enterInteger(event)">             
          </td>
        </tr>
        <tr id=trdark>
          <td nowrap>
          ...
          <td nowrap>
             <input type="text" name="E03REMPLO" value="<%= msgMT.getE03REMPLO() %>" onkeypress="enterInteger(event)">             
          </td>
        </tr>
     </table>
    </td>
