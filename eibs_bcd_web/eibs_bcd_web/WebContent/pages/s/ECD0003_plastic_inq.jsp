...
<body>
<h3 align="center">Consulta de Plástico<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_inq.jsp, ECD0003"> 
</h3>
<hr size="4">
<% 
        ...
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
         ...
         <TR id="trclear"> 
          ...
          <TR id="trdark"> 
            ...
            <TD nowrap width="20%"> 
              <DIV align="left">
              	<INPUT type="text" name="E03CDRDAR0" size="3" maxlength="2" readonly value="<%= msgCD.getE03CDRDAR() %>">
