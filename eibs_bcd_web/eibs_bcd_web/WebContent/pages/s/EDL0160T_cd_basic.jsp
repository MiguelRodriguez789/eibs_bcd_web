...
<h3 align="center">Datos Básicos de Contrato<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_basic.jsp,EDL0160T"></h3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="31%" height="19"> 
              ...
              <input type="text" name="E02DEAOGL" size="16" maxlength="16" value="<%= cdMant.getE02DEAOGL().trim()%>" readonly>
            </td>
            <td nowrap width="20%" height="19"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="31%" height="19"> 
              <input type="text" name="E02DEAMLA2" size="2" maxlength="2" value="<%= cdMant.getE02DEAMLA().trim()%>" readonly>
            </td>
            <td nowrap width="20%" height="19"> 
