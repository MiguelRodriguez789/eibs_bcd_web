...
<jsp:useBean id="msg" class="datapro.eibs.beans.EDC001005Message"  scope="session" />
...
%> 
<H3 align="center"><%= title %><IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dc_field_info.jsp, EDC0010"></H3>
<HR size="4">
