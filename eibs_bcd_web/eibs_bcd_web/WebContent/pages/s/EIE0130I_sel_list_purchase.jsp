...
%>
<h3 align="center">Consulta M&uacute;ltiples Ordenes de Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_list_purchase.jsp, EIE0130I"></h3>
<hr size="4">
