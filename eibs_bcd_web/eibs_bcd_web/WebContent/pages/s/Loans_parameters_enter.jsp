...
<body>
<h3 align="center">Mantenimiento Tabla de Parametros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="Loans_parameters_enter.jsp"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table id="SELECTIONTABLE" cellspacing="0" cellpadding="2" width="100%" border="0" class="tbenter">
          <tr> 
            ...
            <td nowrap> 
               <input type="text" name="E01DLSBNK" size="5" maxlength="2" value="<%=prd.getE01APCBNK()%>" readonly onkeypress="enterInteger(event)">
            </td>
          </tr>
          <tr> 
            ...
            <td nowrap > 
               ...
               <a href="javascript:GetCodeDescCNOFC('E01DLSTYP','DESPRD','04')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>-->
          </tr>
          <tr> 
            <td nowrap align=right> 
            ...
            <td nowrap> 
               ...
               <a href="javascript:GetLoanTable('E01DLSTLN',document.forms[0].E01DLSTYP.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>
            </td>
          </tr>
          <tr> 
            <td nowrap align=right>
            ...
            <td nowrap> 
               <input type="text" name="E01DLSCUN" size="10" maxlength="9" value="" onkeypress="enterInteger(event)">          
               <a href="javascript:GetCustomer('E01DLSCUN')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>               
            </td>
          </tr>             
        </table>
      </td>
