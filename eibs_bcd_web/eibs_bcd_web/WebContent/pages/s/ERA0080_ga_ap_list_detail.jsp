...
<form>
  ...
  <h3 align="center">Listado de Detalles de Garant&iacute;as<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ERA0010_ga_list_detail.jsp" width="35" height="35" ></h3>
  <hr size="4">
  <p align="left"></p>
  ...
  <table class="tableinfo">
    ...
    <tr id="trclear"> 
      ...
      <td align="center" nowrap> 
              <eibsinput:date name="gaMant" fn_month="E02RODMDM" fn_day="E02RODMDD" fn_year="E02RODMDY" required="TRUE" />
      </td>
    </tr>
    <%
             }
