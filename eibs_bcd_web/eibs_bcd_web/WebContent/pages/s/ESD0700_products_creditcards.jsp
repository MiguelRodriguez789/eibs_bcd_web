...
<h3 align="center">Producto de Tarjetas de Credito<img
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="products_creditcards.jsp, ESD0700"></h3>
<hr size="4">
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trdark">
				...
				<td><input type="text" name="E01APCTAX" size="3" maxlength="2"
					value="<%= prd.getE01APCTAX()%>"> <a
			...
			<tr id="trclear">
				...
				<td><input type="text" name="E01APCCC1" size="4" maxlength="2"
					value="<%= prd.getE01APCCC1().trim()%>"></td>
			</tr>
			<tr id="trdark">
				<td>
				<div align="right">Uso del Plastico:</div>
				</td>
				<td><input type="text" name="E01APCMCI" size="4" maxlength="2"
					value="<%= prd.getE01APCMCI().trim()%>"> <a
					href="javascript:GetCode('E01APCMCI','STATIC_cc_plastic_use.jsp')"><img
					src="<%=request.getContextPath()%>/images/1b.gif" title=". . ."
					align="bottom" border="0"></a></td>
				<td>
				<div align="right">Forma de Uso:</div>
				</td>
				<td width="18%"><INPUT type="text" name="E01APCMCP" size="4"
					maxlength="2" value="<%= prd.getE01APCMCP().trim()%>"> <a
					href="javascript:GetCode('E01APCMCP','STATIC_tc_form_use.jsp')"><img
					src="<%=request.getContextPath()%>/images/1b.gif" title=". . ."
					align="bottom" border="0"></a></td>
			</tr>
			<tr id="trclear">
				...
				<td width="25%"><input type="text" name="E01APCCRF" size="3"
					maxlength="1" value="<%= prd.getE01APCCRF().trim()%>"> <a
					href="javascript:GetCode('E01APCCRF','STATIC_tc_send_form.jsp')"><img
					src="<%=request.getContextPath()%>/images/1b.gif" title=". . ."
					align="bottom" border="0"></a></td>
				<td>
				<div align="right">Limite Giros :</div>
				</td>
				<td><select name="E01APCICT">
					<option value="0"
						<%if (prd.getE01APCICT().equals("0")) { out.print("selected"); }%>>No
					Aplica</option>
					<option value="1"
						<%if (prd.getE01APCICT().equals("1")) { out.print("selected"); }%>>Limite
					Diario</option>
					<option value="2"
						<%if (prd.getE01APCICT().equals("2")) { out.print("selected"); }%>>Limite
					Semanal</option>
				</select></td>
			</tr>
			<tr id="trdark">
				...
				<td><INPUT type="text" name="E01APCUC2" size="4" maxlength="2"
					value="<%= prd.getE01APCUC2().trim()%>"> <a
					href="javascript:GetCodeCNOFC('E01APCUC2','66')"><img
					src="<%=request.getContextPath()%>/images/1b.gif" title=". . ."
					align="bottom" border="0"></a></td>
				<td>
				<div align="right">Giros :</div>
				</td>
				<td><INPUT type="text" name="E01APCAMO" size="4" maxlength="2"
					value="<%= prd.getE01APCAMO().trim()%>"> <a
					href="javascript:GetCode('E01APCAMO','STATIC_tc_drafts.jsp')"><img
					src="<%=request.getContextPath()%>/images/1b.gif" title=". . ."
					align="bottom" border="0"></a></td>
			</tr>
			<tr id="trclear">
				...
				<td><INPUT type="text" name="E01APCITP" size="4" maxlength="2"
					value="<%= prd.getE01APCITP().trim()%>"> <a
					href="javascript:GetCode('E01APCITP','STATIC_tc_transfers.jsp')"><img
					src="<%=request.getContextPath()%>/images/1b.gif" title=". . ."
					align="bottom" border="0"></a></td>
				<td>
				<div align="right">Tipo de Cliente :</div>
				</td>
				<td><select name="E01APCFL4">
					<option value=""
						<%if (prd.getE01APCFL4().equals(""))   { out.print("selected"); }%>>Cualquiera</option>
					<option value="1"
						<%if (prd.getE01APCFL4().equals("1")) { out.print("selected"); }%>>Empresa</option>
					<option value="2"
						<%if (prd.getE01APCFL4().equals("2")) { out.print("selected"); }%>>Persona</option>
				</select></td>
			</tr>
			<tr id="trdark">
				<td>
				<div align="right">BIN :</div>
				</td>
				<td><INPUT type="text" name="E01APARAC" size="9" maxlength="8"
					value="<%= prd.getE01APARAC().trim()%>"></td>
				<td></td>
				<td></td>
			</tr>
		</table>
