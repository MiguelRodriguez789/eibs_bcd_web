...
<h3 align="center">Tabla de Indices de Avalúos para Bienes Inmuebles. Nivel Ciudades por Departamento. Año <%= userPO.getHeader20().trim() %><br><%= userPO.getHeader22().trim() %>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="valuation_index_city_list,ERA0082"></h3>
		 ...
		 %>
          <tr> 
			...
			<INPUT TYPE=HIDDEN NAME="E01TB2CTY_<%= trans.getCurrentRow() %>"  VALUE="<%=trans.getRecord(18)%>">
                <input type="radio" name="CURRROW" value="" <%=chk%> onClick="getParams(this.value,'<%= trans.getRecord(1) %>')">
            </td>
	      	<td align="center" nowrap width="5%">  
				<div ><%=trans.getRecord(18)%></DIV>
      		</td>
	      	<td align="center" nowrap width="10%">  
				<div ><%=trans.getRecord(19)%></DIV>
      		</td>
