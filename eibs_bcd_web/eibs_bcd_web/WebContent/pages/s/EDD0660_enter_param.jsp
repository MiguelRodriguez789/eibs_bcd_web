...
<h3 align="center">Estructura de Cargos de Pagos y Recibos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="enter_param.jsp, EDD0660"></h3>
<hr size="4">
  <br><br><br><br><br><br>
