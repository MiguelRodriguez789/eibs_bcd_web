...
<H3 align="center">Aprobacion/Rechazo de Compraventa de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0345"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		<tr>
			...
			<td nowrap width="60%">
				<input type="text" name="E01REQRJS" size="45" maxlength="140" value="<%= msgInst.getE01REQRJS() %>"> 
			</td>
		</tr>
     </table>
    </td>
