      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
            ...
            <td nowrap width="66%" > 
              <input type="text" name="E01FEBPVI" size="25" 
				  value="<% if (invBrok.getE01FEBPVI().equals("A")) out.print("Cuenta de Detalle");
							...
							else if (invBrok.getE01FEBPVI().equals("F")) out.print("Transferencia FED");
						    else if (invBrok.getE01FEBPVI().equals("T")) out.print("Transferencia Telex");
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="right">Recolectar informaci&oacute;n antes de :</div>
            </td>
            <td nowrap > 
              <input type="text" readonly  name="E01FEB" size="9" maxlength="8"  value="<%= invBrok.getE01FEBCCN().trim()%>">
              D&iacute;as</td>
          </tr>
        </table>
      </td>
