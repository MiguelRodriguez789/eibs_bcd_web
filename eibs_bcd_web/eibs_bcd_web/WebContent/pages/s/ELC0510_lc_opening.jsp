...
<h3 align="center">Mantenimiento
 Carta de Credito<img
	...
	name="EIBS_GIF" title="lc_opening.jsp,ELC0510"></h3>
<hr size="4">
<form method="post"
			...
			<table cellspacing="0" cellpadding="2" width="100%" border="0"
				...
				<tbody>
					<tr id="trdark0">
						...
						<td nowrap width="16%"><div align="left"><b> 
							<eibsinput:date name="lcNew" fn_month="E01LCMLAM" fn_day="E01LCMLAD" fn_year="E01LCMLAY" readonly="true" />
							</b>
							</div>
						</td>
					</tr>
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trclear">
				...
				<table>
					<tbody><tr>
						<td><input type="text" name="E01LCMIB5" size="4" maxlength="4" value="<%=lcNew.getE01LCMIB5()%>"> Código Postal <input type="text" name="E01LCMIB6" size="16" maxlength="15" value="<%=lcNew.getE01LCMIB6()%>"> País <input type="text" name="E01LCMIB7" size="4" maxlength="4" value="<%=lcNew.getE01LCMIB7()%>"><a href="javascript:GetCodeCNOFC('E01LCMIB7','03')">
							<img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a></td>
					</tr>
				</tbody></table>
				</td>
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trclear">
				...
				<table>
					<tbody><tr>
						<td><input type="text" name="E01LCMCB5" size="4" maxlength="4" value="<%=lcNew.getE01LCMCB5()%>"> Código Postal <input type="text" name="E01LCMCB6" size="16" maxlength="15" value="<%=lcNew.getE01LCMCB6()%>"> País <input type="text" name="E01LCMCB7" size="4" maxlength="4" value="<%=lcNew.getE01LCMCB7()%>"><a href="javascript:GetCodeCNOFC('E01LCMCB7','03')">
							<img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a></td>
					</tr>
				</tbody></table>
				</td>
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			<tbody><tr id="trdark">
				...
				<table border="0" cellspacing="0">
					<tbody><tr id="trdark">
						...
						<img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a> Cliente o <a href="javascript: GetAccByClient('E01LCMABA','','RT','','E01LCMAB1')">
						<img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." onClick="javascript: document.forms[0].E01LCMAF1.selectedIndex = 2"  border="0"></a> Cuenta</td>
					</tr>
				</tbody></table>
				</td>
			...
			<tr id="trdark">
				...
				<table id="trdark">
					<tbody ><tr id="trdark">
						<td><input type="text" name="E01LCMAB5" size="4" maxlength="4" value="<%=lcNew.getE01LCMAB5()%>"> Código Postal <input type="text" name="E01LCMAB6" size="16" maxlength="15" value="<%=lcNew.getE01LCMAB6()%>"> País <input type="text" name="E01LCMAB7" size="4" maxlength="4" value="<%=lcNew.getE01LCMAB7()%>"><a href="javascript:GetCodeCNOFC('E01LCMAB7','03')">
							<img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a></td>
					</tr>
				</tbody></table>
				</td>
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trclear">
				...
				<table>
					<tbody><tr>
						<td><input type="text" name="E01LCMCA5" size="4" maxlength="4" value="<%=lcNew.getE01LCMCA5()%>"> Código Postal <input type="text" name="E01LCMCA6" size="16" maxlength="15" value="<%=lcNew.getE01LCMCA6()%>"> País <input type="text" name="E01LCMCA7" size="4" maxlength="4" value="<%=lcNew.getE01LCMCA7()%>"><a href="javascript:GetCodeCNOFC('E01LCMCA7','03')">
							<img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a></td>
					</tr>
				</tbody></table>
				</td>
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trdark">
				...
				<table id="trdark">
					<tbody><tr>
						<td><input type="text" name="E01LCMRB5" size="4" maxlength="4" value="<%=lcNew.getE01LCMRB5()%>"> Código Postal <input type="text" name="E01LCMRB6" size="16" maxlength="15" value="<%=lcNew.getE01LCMRB6()%>"> País <input type="text" name="E01LCMRB7" size="4" maxlength="4" value="<%=lcNew.getE01LCMRB7()%>"><a href="javascript:GetCodeCNOFC('E01LCMRB7','03')">
							<img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a></td>
					</tr>
				</tbody></table>
				</td>
