...
var reason = '';
     ...
     for(var n=0;n<formLength;n++)
     {
      ...
      if ( ok ) {          
         document.forms[0].submit();
 		 ...
 		 alert("Seleccione instrumento antes de esta operación");	   
      }
 ...
 function showAddInfo(idxRow){
   tbAddInfo.rows[0].cells[1].innerHTML=getElement("TXTDATA"+idxRow).value; // extraInfo(getElement("TXTDATA"+idxRow).value,7);
...
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  ...
  <h3 align="center">Aprobación Instrumento</h3>
<hr size="4">

  <TABLE class="tbenter">
    <TR> 
      <TD ALIGN=CENTER width="33%" class=TDBKG> <a href="javascript:goAction('A')" id="linkApproval">Approbar</a> 
      </TD>
 ...
 <TR > 
    <TD NOWRAP valign="top" width="100%" >
        <table id="headTable" style="width: 100%">
          <TR id="trdark"> 
			...
			<TH ALIGN=CENTER NOWRAP>Tipo<br> Instrumento</TH>
			<TH ALIGN=CENTER NOWRAP>Marca para <br> Borrar</TH>
   ...
   <TD nowrap ALIGN="RIGHT" valign="top">
      <Table id="tbAddInfoH"   width="100%" >
        <tr id="trdark">
         <TH ALIGN=CENTER nowrap >Información Basica </TH>
        </tr>
      </Table>
