...
%>
<h3 align="center">Devoluci&oacute;n de Cheques<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rejection_chk_search.jsp,EDD0934"></h3>
<hr size="4">
                ...
                <tr> 
                  ...
                  <td NOWRAP width="50%"> 
                    <div align="left"> 
                      ...
                      <a href="javascript:GetCodeCNOFC('E01SELOFC','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"  ></a></div>
                  </td>
                </tr>			   	
                <tr> 
                  <td NOWRAP width="50%">                     
                  ...
                  <td NOWRAP width="50%"> 
                    <div align="left"> 
                      ...
                      <a href="javascript:GetBranch('E01SELBRN','<%=currUser.getE01UBK().trim()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a></div>
                  </td>
                </tr>
                <tr> 
                  <td NOWRAP width="50%">                     
                  ...
                  <td NOWRAP width="50%"> 
                    <div align="left"> 
                      ...
                      <input type="text" name="E01SELAMT"  size=17 maxlength=15 onKeypress="enterDecimal(event, 2)">
                    </div>
                  </td>
                </tr>
