...
String sTitle = "Forward - Moneda Extranjera";
try {
   sTitle = trOption.getHeader2();
} catch (Exception e) {
   sTitle = "Forward - Moneda Extranjera";
}   
if (sTitle == null) sTitle = "Forward - Moneda Extranjera";

%>
<h3 align="center"> <%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_forward.jsp,EFE0120P"> 
</h3>
<hr size="4">
...
%>
  ...
  <INPUT TYPE=HIDDEN NAME="E01FESTYP" VALUE="FWRD">
          ...
          <tr id="trdark"> 
          	<% if(fex.getH01FLGWK3().equals("Y")){%>
            	...
            	<td nowrap > 
              		...
              		<a href="javascript:GetClassFex('E01FESCLS','FWR',document.forms[0].E01FESCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            	</td> 
             <%}%>
            <td nowrap  colspan="5" > 
              <div align="right"></div>
