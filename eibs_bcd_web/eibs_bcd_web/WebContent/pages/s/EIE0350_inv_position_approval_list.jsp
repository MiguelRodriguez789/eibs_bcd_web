...
<html>
<head>
<title>Position Approval List</title>
...
<SCRIPT type="text/javascript">
		...
		function SelectAll() {
			var checked = document.forms[0].AllBox.checked;
			var formLength= document.forms[0].elements.length;
	       for(var n=0;n<formLength;n++)
	       {
	      	  var elementName= document.forms[0].elements[n].name;
      	  		if (elementName == "selectedAcc" ) {
					document.forms[0].elements[n].checked = checked;
	      	  	}
	       }	
		}
</SCRIPT>
...
<div align="center"> 
  <h3>Posicion de Inversiones <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_position_approval_list.jsp, EIE0350"> 
  </h3>
</div>
<hr size="4">
...
%> 
  ...
  <TABLE class="tbenter" width="100%">
    <TR> 
      <TD ALIGN=CENTER class=TDBKG width="50%"> <a href="javascript:goAction(700,' ')" ><b>Aprobar</b></a> 
      </TD>
      <TD ALIGN=CENTER class=TDBKG width="50%"> <a href="<%=request.getContextPath()%>/pages/background.jsp" ><b>Salir</b></a> 
      </TD>
    </TR>
  </TABLE>
...
<br>
 ...
 <TR> 
     ...
     <TR id="trdark"> 
      <TH ALIGN=CENTER NOWRAP><input type="checkbox" id="AllBox" onclick="SelectAll()"></TH>
                ...
                <TR>       
                  ...
                  <TD NOWRAP  ALIGN=CENTER width="10%">
                  	<% if (msgList.getH01FLGWK1().equals("P") ) { %>
                  		<FONT COLOR="FF0000"><%= msgList.getD01DEAFLY() %></FONT>
                 	<% } else { %> 
