...
%>
	...
	function goAction(opt) {
		if (opt == "5") { //Condiciones especiales de firmas	
		document.forms[0].action = "<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD5700?opt="+opt;
...
<BODY>
 ...
 <h3 align="center">
  Firmantes - Consulta
 <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_inq_signers_list.jsp,EDD0000"> 
    </h3>
   <hr size="4">
