...
<h3 align="center">Abonos Masivos, Proceso Automático - Eliminación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_maint_sch.jsp, EDL1111"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01DEAACC" size="13" maxlength="12" value="<%= msgLN.getE01DEAACC().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="20%" > 
