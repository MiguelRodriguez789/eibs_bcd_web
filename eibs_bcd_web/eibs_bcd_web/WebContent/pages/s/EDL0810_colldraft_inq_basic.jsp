...
<h3 align="center">Carta Guia de Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="collection_list.jsp,EDL0810"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan=3> 
              <input type="text" name="E01DLHDAC" size="12" maxlength="12" value=" " onkeypress="enterInteger(event)" readonly>
            </td>
