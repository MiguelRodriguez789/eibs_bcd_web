...
<H3 align="center">Transferencia de Carta De Credito 
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"	name="EIBS_GIF" title="lc_tranfer_list, ELC0510"></H3>
<HR size="4">
...
<TABLE class="tbenter">
	<TR>
		<TD class=TDBKG>
			<div align="center"><a href="javascript:goAction('N')"><b>Crear</b></a></div>
		</TD>
		<TD class=TDBKG>
