...
<body >
<h3 align="center">Consulta  de Calificaci&oacute;n y Provisi&oacute;n<img
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="search_cust_acc_table.jsp ,EDL0527"></h3>
<hr size="4">
<form method="post"
	...
	<td nowrap> 
		<table cellspacing="0" cellpadding="2" width="100%" border="0"class="tbhead">
			...
			<tr id="trdark">
				...
				<td nowrap width="10%"><eibsinput:text name="EDL0527Record"
					...
					<input type="text" name="E01DESCRP" readonly size="45" maxlength="45" value="<%= EDL0527Record.getE01DESCRP().trim()%>"></td>
				<%
				}
				%>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			<tr id="trdark">
				...
				<td nowrap width="5%" align="left"><eibsinput:text
					property="E01CPVDTD" name="EDL0527Record"
		...
		<table cellspacing=0 cellpadding=2 width="100%" border="0">
			 ...
			 <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
				...
				<td nowrap width="5%" align="left"><eibsinput:text
					...
					<% 
					if (EDL0527Record.getE01CPVCPR().equals("M")) { %>
					<eibsinput:text
			 ...
			 <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
				...
				<td nowrap width="5%" align="left"><eibsinput:text
					property="E01CPVTBL" name="EDL0527Record"
			...
			<td nowrap width="5%">
				...
				<td nowrap width="5%" align="left"><eibsinput:text
					property="E01CPVMCA" name="EDL0527Record"
					eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CHAR %>" readonly="true"/></td>
				<td nowrap width="68%">
				<div align="right">Modalidad : </div>
				</td>
				<td nowrap width="5%" align="left"><eibsinput:text
					property="E01CPVCPR" name="EDL0527Record"
					eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CHAR %>" readonly="true"/></td>
    ...
    <td nowrap><table cellspacing="0" cellpadding="2" width="100%" border="0">
      ...
      <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
        ...
        <td nowrap width="5%"><eibsinput:text property="E01CPVPVO"
					...
					if (EDL0527Record.getE01CPVCPR().equals("M")) { %>
					<eibsinput:text
					property="E01CPVXR1" name="EDL0527Record"
					eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true"/>
					<% } %>
					</td>
      ...
      <td nowrap><table cellspacing="0" cellpadding="2" width="100%" border="0">
	   <% if (EDL0527Record.getE01CPVCPR().equals("M")) { %>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"> <input type="text" name="E01CPVPR1" size="10" maxlength="10" value="<%= EDL0527Record.getE01CPVPR1().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p>% M&iacute;nimo Provisi&oacute;n :</p>
            </div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVPR2" size="10" maxlength="10" value="<%= EDL0527Record.getE01CPVPR2().trim()%>" readonly></td>
          </tr>
		  <% } %>
		  
		   <% if (EDL0527Record.getE01CPVCPR().equals("H")) { %>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">
              <p>% Provisi&oacute;n parte Garantizada : </p>
            </div></td>
            <td nowrap width="5%"><input type="text" name="E01CPVPR3" size="10" maxlength="10" value="<%= EDL0527Record.getE01CPVPR3().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p>% Provisi&oacute;n parte No Garantizada : </p>
            </div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVPR4" size="10" maxlength="10" value="<%= EDL0527Record.getE01CPVPR4().trim()%>" readonly></td>
          </tr>
  		  <% } %>
		   <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">
            ...
            <td nowrap width="5%"><input type="text" name="E01CPVCID" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVCID().trim()%>" readonly></td>
		 <% if (EDL0527Record.getE01CPVCPR().equals("H")) { %>
            <td nowrap width="52%"><div align="right">
              <p>Capital No Id&oacute;neo :</p>
            </div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVCNI" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVCNI().trim()%>" readonly></td>
		 <% } %>	
		   </tr>
		   <% if (EDL0527Record.getE01CPVCPR().equals("M")) { %>
		   <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"><input type="text" name="E01CPVCNI" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVCNI().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p></p>
            </div></td>
            <td nowrap width="23%"></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"><input type="text" name="E01CPVMGC" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVMGC().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p>Valor Mínimo de Provisión Capital :</p>
            </div></td>

            <td nowrap width="23%"><input type="text" name="E01CPVMPC" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVMPC().trim()%>" readonly></td>
          </tr>
		  <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">
              <p>Total Provisión Capital :</p>
            </div></td>
            <td nowrap width="5%"><input type="text" name="E01CPVPRC" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVPRC().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p></p>
            </div></td>
            <td nowrap width="23%"></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"><input type="text" name="E01CPVMGI" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVMGI().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p>Valor Mínimo de Provisión  Interés:</p>
            </div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVMPI" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVMPI().trim()%>" readonly></td>
          </tr>
		  	  <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">
              <p>Total Provisión Interés :</p>
            </div></td>
            <td nowrap width="5%"><input type="text" name="E01CPVMII" size="15" maxlength="15" value="<%= EDL0527Record.getE01CPVMII().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p></p>
            </div></td>
            <td nowrap width="23%"></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"><input type="text" name="E01CPVMG2" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVMG2().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p>Valor Mínimo de Provisión Otros :</p>
            </div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVMP2" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVMP2().trim()%>" readonly></td>
          </tr>		  	
		    <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">
              <p>Total Provisión Otros :</p>
            </div></td>
            <td nowrap width="5%"><input type="text" name="E01CPVXR2" size="15" maxlength="15" value="<%= EDL0527Record.getE01CPVXR2().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p></p>
            </div></td>
            <td nowrap width="23%"></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"><input type="text" name="E01CPVMG1" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVMG1().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p>Valor Mínimo de Provisión Otros :</p>
            </div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVMP1" size="16" maxlength="16" value="<%= EDL0527Record.getE01CPVMP1().trim()%>" readonly></td>
          </tr>		  	
		    <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">
              <p>Total Provisión Otros :</p>
            </div></td>
            <td nowrap width="5%"><input type="text" name="E01CPVXR1" size="15" maxlength="15" value="<%= EDL0527Record.getE01CPVXR1().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">
              <p></p>
            </div></td>
            <td nowrap width="23%"></td>
...
<% if (EDL0527Record.getE01CPVMCA().equals("D")) { %>
<p>&nbsp;</p>
<table class=tbenter>
	<tr>
		<td nowrap>
	...
	<tr bordercolor="#FFFFFF">
      <td nowrap><table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"> <input type="text" name="E01PRXPCA" size="22" maxlength="22" value="<%= EDL0527Record.getE01PRXPCA().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">Valor PNR Interes : </div></td>
            <td nowrap width="23%"><input type="text" name="E01PRXPIN" size="22" maxlength="22" value="<%= EDL0527Record.getE01PRXPIN().trim()%>" readonly></td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Valor PNR Otros  :</div></td>
            <td nowrap width="5%"><input type="text" name="E01PRXPOT" size="22" maxlength="22" value="<%= EDL0527Record.getE01PRXPOT().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right"></div></td>
            <td nowrap width="23%"></td>
          </tr>
		   <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Valor CIC Capital : </div></td>
            <td nowrap width="5%"> <input type="text" name="E01PRXCCA" size="22" maxlength="22" value="<%= EDL0527Record.getE01PRXCCA().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">Valor CIC Interes : </div></td>
            <td nowrap width="23%"><input type="text" name="E01PRXCIN" size="22" maxlength="22" value="<%= EDL0527Record.getE01PRXCIN().trim()%>" readonly></td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Valor CIC Otros  :</div></td>
            <td nowrap width="5%"><input type="text" name="E01PRXCOT" size="22" maxlength="22" value="<%= EDL0527Record.getE01PRXCOT().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right"></div></td>
            <td nowrap width="23%"></td>
          </tr>
      </table></td>
	...
	<tr bordercolor="#FFFFFF">
      <td nowrap><table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"> <input type="text" name="E01CPVVRA" size="22" maxlength="22" value="<%= EDL0527Record.getE01CPVVRA().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">Valor IPC : </div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVIPC" size="22" maxlength="22" value="<%= EDL0527Record.getE01CPVIPC().trim()%>" readonly></td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Cartera Vencida Deflactada  :</div></td>
            <td nowrap width="5%"><input type="text" name="E01CPVVRD" size="22" maxlength="22" value="<%= EDL0527Record.getE01CPVVRD().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">Tasa Anual Crecimiento  :</div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVTCR" size="15" maxlength="15" value="<%= EDL0527Record.getE01CPVTCR().trim()%>" readonly></td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Variacion Semestral :</div></td>
            <td nowrap width="5%"><input type="text" name="E01CPVVSM" size="15" maxlength="15" value="<%= EDL0527Record.getE01CPVVSM().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">Promedio Movil Semestral  :</div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVPMS" size="15" maxlength="15" value="<%= EDL0527Record.getE01CPVPMS().trim()%>" readonly></td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Aplica Provision Adicional  :</div></td>
            <td nowrap width="5%"><input type="text" name="E01CPVST1" size="2" maxlength="2" value="<%= EDL0527Record.getE01CPVST1().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right"></div></td>
            <td nowrap width="23%">&nbsp;</td>
          </tr>
      </table></td>
...
<table class="tableinfo">
  ...
  <%  if (!(EDL0527Record.getE01GARTI2().trim().equals(""))) {%>
<table class=tbenter>
	<tr>
		<td nowrap>
...
<table class="tableinfo">
 ...
 <% } %>
  <%  if (!(EDL0527Record.getE01GARTI3().trim().equals(""))) {%>
<table class=tbenter>
	<tr>
		<td nowrap>
...
<% } %>
  <%  if (!(EDL0527Record.getE01GARTI4().trim().equals(""))) {%>
<table class=tbenter>
	<tr>
		<td nowrap>
...
<% } %>
  <%  if (!(EDL0527Record.getE01GARTI5().trim().equals(""))) {%>
<table class=tbenter>
	<tr>
		<td nowrap>
...
<% } %>
  <%  if (!(EDL0527Record.getE01GARTI6().trim().equals(""))) {%>
<table class=tbenter>
	<tr>
		<td nowrap>
...
<% } %>
  <%  if (!(EDL0527Record.getE01GARTI7().trim().equals(""))) {%>
<table class=tbenter>
	<tr>
		<td nowrap>
...
<% } %>
  <%  if (!(EDL0527Record.getE01GARTI8().trim().equals(""))) {%>
<table class=tbenter>
	<tr>
		<td nowrap>
...
<% } %>
  <%  if (!(EDL0527Record.getE01GARTI9().trim().equals(""))) {%>
<table class=tbenter>
	<tr>
		<td nowrap>
...
<% } %>
  <%  if (!(EDL0527Record.getE01GARTI0().trim().equals(""))) {%>
<table class=tbenter>
	<tr>
		<td nowrap>
      ...
      <td nowrap><table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"><eibsinput:text property="E01CPVTI8"
					name="EDL0527Record"
					eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CODE %>" readonly="true"/>
			F.I:<%= Util.formatDate(EDL0527Record.getE01CPVSID(),EDL0527Record.getE01CPVSIM(),EDL0527Record.getE01CPVSIY())%>
			F.V:<%= Util.formatDate(EDL0527Record.getE01CPVSFD(),EDL0527Record.getE01CPVSFM(),EDL0527Record.getE01CPVSFY())%>
            </td>
            <td nowrap width="52%"><div align="right">
			Calificaci&oacute;n Reestructurado Inicial :<br>
            </div></td>
            <td nowrap width="23%"><eibsinput:text property="E01CPVREI" name="EDL0527Record" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CODE %>" readonly="true"/>
			F.I:<%= Util.formatDate(EDL0527Record.getE01CPVRID(),EDL0527Record.getE01CPVRIM(),EDL0527Record.getE01CPVRIY())%>
			F.V:<%= Util.formatDate(EDL0527Record.getE01CPVRFD(),EDL0527Record.getE01CPVRFM(),EDL0527Record.getE01CPVRFY())%>	
			<br>
		  ...
		  <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"><eibsinput:text property="E01CPVRDE"
					name="EDL0527Record"
					eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CODE %>" readonly="true"/>
			F.I:<%= Util.formatDate(EDL0527Record.getE01CPVPID(),EDL0527Record.getE01CPVPIM(),EDL0527Record.getE01CPVPIY())%>
			F.V:<%= Util.formatDate(EDL0527Record.getE01CPVPFD(),EDL0527Record.getE01CPVPFM(),EDL0527Record.getE01CPVPFY())%></td>
            <td nowrap width="52%"><div align="right"></div></td>
            <td nowrap width="23%">&nbsp;</td>
          </tr>
		  <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"><eibsinput:text property="E01CPVOTO"
					name="EDL0527Record"
					eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CODE %>" readonly="true"/>
			F.I:<%= Util.formatDate(EDL0527Record.getE01CPVOID(),EDL0527Record.getE01CPVOIM(),EDL0527Record.getE01CPVOIY())%>
			F.V:<%= Util.formatDate(EDL0527Record.getE01CPVOFD(),EDL0527Record.getE01CPVOFM(),EDL0527Record.getE01CPVOFY())%>		
            </td>
            ...
            <td nowrap width="23%"><eibsinput:text property="E01CPVEVA"
					name="EDL0527Record"
					eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CODE %>" readonly="true"/>
			F.I:<%= Util.formatDate(EDL0527Record.getE01CPVEID(),EDL0527Record.getE01CPVEIM(),EDL0527Record.getE01CPVEIY())%>
			F.V:<%= Util.formatDate(EDL0527Record.getE01CPVEFD(),EDL0527Record.getE01CPVEFM(),EDL0527Record.getE01CPVEFY())%>		
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right"></div></td>
	...
	<tr bordercolor="#FFFFFF">
      <td nowrap><table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%">
			 ...
			 <input type="text" readonly name="E01CPVSTS" size="15" maxlength="15" 
				       value="<% if (EDL0527Record.getE01CPVSTS().equals("")) out.print("REGULAR");
							else if (EDL0527Record.getE01CPVSTS().equals("C")) out.print("CANCELADO");
							else if (EDL0527Record.getE01CPVSTS().equals("R")) out.print("REESTRUCTURADO");
							else if (EDL0527Record.getE01CPVSTS().equals("A")) out.print("CASTIGADO"); %>" >
            </td>
            <td nowrap width="52%"><div align="right">Tipo Producto   :</div></td>
            <td nowrap width="23%">
					   <input type="text" readonly name="E01CPVACD" size="30" maxlength="30" 
				       value="<% if (EDL0527Record.getE01CPVACD().equals("10")) out.print("PRESTAMO O DESCUENTO");
							else if (EDL0527Record.getE01CPVACD().equals("70")) out.print("PRODUCTO EXTERNO DEL ACTIVO");
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="5%"><input type="text" name="E01CPVBNK" size="03" maxlength="03" value="<%= EDL0527Record.getE01CPVBNK().trim()%>" readonly>            </td>
            <td nowrap width="52%"><div align="right">Agencia :</div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVBRN" size="03" maxlength="03" value="<%= EDL0527Record.getE01CPVBRN().trim()%>" readonly>            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Moneda  :</div></td>
            <td nowrap width="5%">
              <input type="text" name="E01CPVCCY" size="4" maxlength="4" value="<%= EDL0527Record.getE01CPVCCY().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">Plazo Parámetro<br> Circular 047 :</div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVPLA" size="4" maxlength="4" value="<%= EDL0527Record.getE01CPVPLA().trim()%>" readonly></td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Fecha desde Desembolso <br> Circular 047 :</div></td>
            <td nowrap width="5%"><%= Util.formatDate(EDL0527Record.getE01CPVFED(),EDL0527Record.getE01CPVFEM(),EDL0527Record.getE01CPVFEY())%></td>
            <td nowrap width="52%"><div align="right">Plazo Remanente Pr&eacute;stamo :</div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVPLR" size="4" maxlength="4" value="<%= EDL0527Record.getE01CPVPLR().trim()%>" readonly></td>
          </tr>
		  <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Ajuste Por Plazo AxP :</div></td>
            <td nowrap width="5%">
            <input type="text" name="E01CPVAXP" size="15" maxlength="15" value="<%= EDL0527Record.getE01CPVAXP().trim()%>" readonly></td>
            <td nowrap width="52%"><div align="right">Cliente Ley de Victima : </div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVVIC" size="2" maxlength="2" value="<%= EDL0527Record.getE01CPVVIC().trim()%>" readonly></td>
          </tr>
		    <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Fecha  del Hecho<br> Ley de Victima :</div></td>
            <td nowrap width="5%">
			<%= Util.formatDate(EDL0527Record.getE01CPVVID(),EDL0527Record.getE01CPVVIM(),EDL0527Record.getE01CPVVIY())%>
            <td nowrap width="52%"><div align="right">Mora de la fecha del Hecho<br> Ley de Victima : </div></td>
            <td nowrap width="23%"><input type="text" name="E01CPVMVI" size="5" maxlength="5" value="<%= EDL0527Record.getE01CPVMVI().trim()%>" readonly></td>
          </tr>
		   <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="23%"><eibsinput:text
					property="E01CPVCOS" name="EDL0527Record"
					eibsType="<%= EibsFields.EIBS_FIELD_TYPE_DAYS %>" readonly="true"/></td>
		   </tr>
		   <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%"><div align="right">Pr&eacute;stamo Libranza  :</div></td>
            <td nowrap width="5%">
			<input type="text" name="E01CPVLIB" size="2" maxlength="2" value="<%= EDL0527Record.getE01CPVLIB().trim()%>" readonly>
            <td nowrap width="52%"><div align="right"></div></td>
            <td nowrap width="23%">&nbsp;</td>
		   </tr>
      </table></td>
