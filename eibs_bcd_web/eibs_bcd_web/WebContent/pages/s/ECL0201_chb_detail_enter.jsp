...
<body >
<h3 align="center">Operaciones del Cliente<br>Detalle de Chequeras<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chb_detail_enter.jsp, ECL0201"> 
</h3>
<hr size="4">
<% 
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.misc.JSECL0201" >
  ...
  <INPUT TYPE=HIDDEN NAME="E01NROSER" VALUE="0">
