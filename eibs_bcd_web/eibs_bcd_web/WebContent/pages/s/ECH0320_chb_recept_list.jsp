...
<h3 align="center">Recepci&oacute;n de Chequeras de Proveedores - <% if (userPO.getOption().equals("L")) out.print("Ciclo Largo"); else out.print("Ciclo Corto"); %>	
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chb_recept_list.jsp,ECH0320">
</h3>
<hr size="4">
    ...
    <TH ALIGN=CENTER >Cheque<br>Final</TH>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%= Util.formatCustomDate( currUser.getE01DTF(), msgChkB.getE01CHMRQM(),msgChkB.getE01CHMRQD(),msgChkB.getE01CHMRQY()) %></TD>
			...
			<TD NOWRAP ALIGN="CENTER"><%= Util.formatCell(msgChkB.getE01CHMDBR()) %></TD>
