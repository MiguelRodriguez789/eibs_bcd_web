...
<h3 align="center">Mantenimiento de Proteccion de Cheques<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_maint_protec.jsp , ECH0335"></h3> 
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap>
              <INPUT type="text" name="E01CKCCKN" size="12" maxlength="11" readonly value="<%= chkList.getRecord(0).trim()%>">
            </td>         
          </tr>          
          <tr id="trclear"> 
            <td nowrap > 
