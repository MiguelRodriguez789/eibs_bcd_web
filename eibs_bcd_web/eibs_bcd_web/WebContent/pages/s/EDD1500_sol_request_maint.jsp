...
%> 
<H3 align="center"><% if(solBasic.getE01REQAPC().equals("FA")) out.print("Mantencion Solicitud Fallecido");
   else if ((solBasic.getE01REQAPC().equals("RP")) &&  (solBasic.getE01REQACD().equals("04"))) out.print("Mentencion Solicitud Giro Cuenta Ahorro");
   else if ((solBasic.getE01REQAPC().equals("RP")) &&  (solBasic.getE01REQACD().equals("06"))) out.print("Mantencion Solicitud Retiro Parcial Cuota Participacion"); 
   else if ((solBasic.getE01REQAPC().equals("RE")) &&  (solBasic.getE01REQACD().equals("06"))) out.print("Mantencion Solicitud Renuncia Cuota Participacion");     
   else out.print("");%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sol_request_maint.jsp, EDD1500"></H3>
<hr size="4">
...
<% if(solBasic.getE01REQAPC().equals("FA")){%>  
            ...
            <td nowrap width="20%" > 
            <div align="left"> 
				<eibsinput:date name="solBasic" fn_year="E01REQFYY" fn_month="E01REQFMM" fn_day="E01REQFDD" required="true" readonly="false"/>
            </div>  
            </td> 
<%} else {%>                         
            <td nowrap width="16%">
