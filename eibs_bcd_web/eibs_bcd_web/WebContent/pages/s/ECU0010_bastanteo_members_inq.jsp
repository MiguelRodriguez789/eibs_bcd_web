...
<H3 align="center">Sistema de Bastanteo - Consulta de Integrantes de la Junta Directiva<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_members_inq,ECU0010"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	...
    	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E02CUMDD1" readonly size="3" maxlength="2" value="<%= msgMT.getE02CUMDD1() %>">
	      	<input type="text" name="E02CUMDD2" readonly size="3" maxlength="2" value="<%= msgMT.getE02CUMDD2() %>">
	      	<input type="text" name="E02CUMDD3" readonly size="5" maxlength="4" value="<%= msgMT.getE02CUMDD3() %>">
	      </td>     
      	</tr>
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E02CUMD21" size="3" maxlength="2" readonly value="<%= msgMT.getE02CUMD21() %>">
	      	<input type="text" name="E02CUMD22" size="3" maxlength="2" readonly value="<%= msgMT.getE02CUMD22() %>">
	      	<input type="text" name="E02CUMD23" size="5" maxlength="4" readonly value="<%= msgMT.getE02CUMD23() %>">
      	  </td>     
      	</tr>
     	<tr id="trdark"> 
          <td> 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%" align="center"> 
              <textarea name="E08CUMOBS" rows="8" cols="64" <%= msgMT.getE02CUMOBS().trim() %>>
              </textarea>
            </td>
          </tr>
        </table>
