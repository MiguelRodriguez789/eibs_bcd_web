...
<html>
<head>
<title>Codigos Especiales de Usuario</title>
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="codes_list.jsp, EUS0000"></h3>
<hr size="4">
 ...
 %>
  ...
  <TABLE class="tbenter" width="100%" >
    <TR>
      <TD > 
        <div align="center"> 
          <p><b>No hay Informacion con este creterio de Busqueda</b></p>
