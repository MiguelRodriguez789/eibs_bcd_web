...
%>
 ...
 <h3 align="center">Ese Código Oficial no Existe<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cust_search_error_occurred.jsp,ECIF170"></h3>
