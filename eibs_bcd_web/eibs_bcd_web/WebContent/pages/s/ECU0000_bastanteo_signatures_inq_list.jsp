...
<HEAD>
<TITLE>
Consulta de Firmas Conjuntas Especificas
</TITLE>
...
<SCRIPT type="text/javascript">
  ...
  function goAction(opt) {
    ...
    if (opt == "I") { 
    	...
    	page = "<%=request.getContextPath()%>/pages/s/ECU0000_bastanteo_signatures_inq.jsp?ROW=" + row;
    	CenterNamedWindow(page,'Information',650,500,2);
  	} else if (opt == "R") {   
    	page = "<%=request.getContextPath()%>/pages/s/ECU0000_bastanteo_facult_inq.jsp?ROW=" + <%= userPO.getHeader6()%>;
    	CenterNamedWindow(page,'Information',650,500,2);
  	} 
  }
...
<h3 align="center">Sistema de Bastanteo - Consulta de Firmas Conjuntas Especificas
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_signatures_inq_list.jsp,ECU0000">
</h3>
<hr size="4">
...
%> 
  ...
  <TABLE class="tbenter" width=100% height=40%>
      ...
      <TD> 
        <div align="center"> 
          <p>
            <b>No existen registros de firmas conjuntas.</b>
          </p>          
        </div>
      </TD>
     </TR>
  ...
  <TR> 
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
  		<TR id="trdark"> 
  			<TH ALIGN=CENTER ></TH>
    		<TH ALIGN=CENTER >Secuencia del<BR>Acompañante</TH>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE08CUFSEQ())%></TD>
			<TD NOWRAP ALIGN="LEFT"><%=Util.formatCell(msgMT.getE08CUFACC())%></TD>
			<TD NOWRAP ALIGN="LEFT"><%=Util.formatCell(msgMT.getE08CUFACN())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE08CUFAC1(),msgMT.getE08CUFAC2(),msgMT.getE08CUFAC3())  + " - " + msgMT.getE08CUFACT()%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE08CUFACU())%></TD>
		</TR>    		
    <%             
    				chk = "";     
                }
