...
<h3 align="center">Resumen de Cuenta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rejection_chk_inq_account, EDD00924"></h3>
<hr size="4">
<form>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" readonly name="E01ACMCUN" size="10" maxlength="9"  value="<%= rtRejAccInq.getE01ACMCUN().trim()%>">
              </div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" readonly name="E01ACMACC" size="13" maxlength="12" value="<%= rtRejAccInq.getE01ACMACC().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="26%"> 
              <div align="left"> 
		   		  <eibsinput:date name="rtRejAccInq" fn_year="E01LSTODY" fn_month="E01LSTODM" fn_day="E01LSTODD" readonly="true"/>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
              <div align="left">
		   		  <eibsinput:date name="rtRejAccInq" fn_year="E01OPNDTY" fn_month="E01OPNDTM" fn_day="E01OPNDTD" readonly="true"/>
              </div>
            </td>
            <td nowrap width="26%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              <div align="left">
		   		  <eibsinput:date name="rtRejAccInq" fn_year="E01LNXDTY" fn_month="E01LNXDTM" fn_day="E01LNXDTD" readonly="true"/>
              </div>
            </td>
            <td nowrap width="26%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
              <div align="left">
		   		  <eibsinput:date name="rtRejAccInq" fn_year="E01LSTDDY" fn_month="E01LSTDDM" fn_day="E01LSTDDD" readonly="true"/>
              </div>
            </td>
            <td nowrap width="26%"> 
