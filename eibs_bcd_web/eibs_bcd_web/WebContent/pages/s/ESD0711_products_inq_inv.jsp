...
<h3 align="center">Consulta de Producto de Inversiones
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="products_inq_ln.jsp, ESD0711"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly name="E13TYPDES" size="45" maxlength="45" value="<%= invProdInq.getE13TYPDES().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly name="E13DESCRI" size="50" maxlength="45" value="<%= invProdInq.getE13DESCRI().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              <input type="text" readonly name="E13MERCAD" size="28" maxlength="25" value="<%= invProdInq.getE13MERCAD().trim()%>">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="50%"> 
              <input type="text" readonly name="E13GLMDSC" size="45" maxlength="45" value="<%= invProdInq.getE13GLMDSC().trim()%>">
            </td>
          </tr>
        </table>
      </td>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E13APCITP" size="45" maxlength="45"  
          ...
          <tr id="trclear">
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E13APCFRN" size="45" maxlength="45"  
          ...
          <tr id="trclear"> 
            ...
            <td width="55%"> 
              <input type="text" readonly name="E13APCDOC" size="3" maxlength="2" value="<%= invProdInq.getE13APCDOC().trim()%>">
            </td>
          </tr>
        </table>
      </td>
