...
<body>
<h3 align="center">Control de Participaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="particip_maint.jsp, EDL6000"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="15%">
        		...
        		<a href="javascript:GetCurrency('E01PARCCY',document.forms[0].E01PARBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a>	
            </td>
            <td nowrap width="25%" align=right>
            	<b>Tipo :</b>
            </td>
            <td nowrap width="25%">
              <input type="text" name="E01PARTYP" size="4" maxlength="4" value="<%= participant.getE01PARTYP() %>" >
           	  <a href="javascript:GetCodeDescCNOFC('E01PARTYP','E01PARTYN','04')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a><br>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="15%">
              ...
              <input type="text" name="E01PARLD3" size="5" maxlength="4" value="<%= participant.getE01PARLD3() %>" readonly>
              <input type="text" name="E01PARLDT" size="8" maxlength="2" value="<%= Util.formatCell(participant.getE01PARLDT()) %>" readonly>
            </td>
            <td nowrap width="25%" align=right>
            	<b>Usuario :</b>
            </td>
