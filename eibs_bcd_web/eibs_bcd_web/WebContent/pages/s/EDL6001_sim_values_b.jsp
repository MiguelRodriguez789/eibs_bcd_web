...
<h3 align="center">Cotizador de Préstamos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sim_values_b,EDL6001"></h3>
<hr size="4">
...
<%--              <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0"  > --%>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01INFECI" size="15" maxlength="15" value="<%= lnBasic.getE01INFECI().trim()%>" onKeypress="enterDecimal(event)"></td>
            <td nowrap width="25%" > 
              <div align="right">Tasa :</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01TASAPR" size="12" maxlength="10" value="<%= lnBasic.getE01TASAPR().trim()%>" onKeypress="enterRate(event)" onKeypress="enterSignDecimal(event)">
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01MONPRE" size="15" maxlength="15" value="<%= lnBasic.getE01MONPRE().trim()%>" onKeypress="enterDecimal(event)"></td>
            <td nowrap width="25%" > 
              <div align="right">Tasa Efectiva :</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01EFERTE" size="12" maxlength="10" value="<%= lnBasic.getE01EFERTE().trim()%>" onKeypress="enterRate(event)" onKeypress="enterSignDecimal(event)">
            </td>
          </tr>
		...
		<tr id="trdark"> 
          ...
          <%
			...
			int i = 1;
			boolean nextRowDark = false;
			String rowColor = "trclear";
			
			while(i<=9){
			
			String fieldName = "E01DEDA0"+i;
			String ivaName = "E01DEDI0"+i;
			String fieldDescription = "E01DEDD0"+i;	
			if(nextRowDark){
				rowColor = "trdark";
				nextRowDark = false;
			}else{
		...
		<tr id="<%=rowColor %>"> 
            ...
            <td nowrap width="25%"> 
              <div align="right"><%= lnBasic.getFieldString(fieldDescription).trim()%>:</div>
            </td>
            <td nowrap width="23%"> 
              <input type="text" name="<%=fieldName %>" size="15" maxlength="15" value="<%= lnBasic.getFieldString(fieldName).trim()%>" onKeypress="enterDecimal(event)"> 
            </td>
            <% if(!lnBasic.getFieldString(ivaName).equals("0.00")){
            ...
            %>
            	...
            	<td nowrap align="left" width="27%"> 
             	 	<input type="text" name="<%=ivaName %>" size="15" maxlength="15" value="<%= lnBasic.getFieldString(ivaName).trim()%>" onKeypress="enterDecimal(event)">
            	</td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01GASCIE" size="15" maxlength="15" value="<%= lnBasic.getE01GASCIE().trim()%>" onKeypress="enterDecimal(event)"></td>
            <td nowrap width="25%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01SRVDES" size="15" maxlength="15" value="<%= lnBasic.getE01SRVDES().trim()%>" onKeypress="enterDecimal(event)"></td>
            <td nowrap width="25%" > 
	...
	<tr id="trdark"> 
           <td nowrap width="25%" > 
            ...
            <td nowrap width="27%" > 
				<input type="text" name="E01COMISI" size="15" maxlength="15" value="<%= lnBasic.getE01COMISI().trim()%>" onKeypress="enterDecimal(event)">		 
			</td>               
          </tr>
		...
		<tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01PAGTOT" size="15" maxlength="15" value="<%= lnBasic.getE01PAGTOT().trim()%>" onKeypress="enterDecimal(event)"></td>
            <td nowrap width="25%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01VLNETO" size="15" maxlength="15" value="<%= lnBasic.getE01VLNETO().trim()%>" onKeypress="enterDecimal(event)"></td>
            <td nowrap width="25%" > 
		...
		<tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01PAGPRI" size="15" maxlength="15" value="<%= lnBasic.getE01PAGPRI().trim()%>" onKeypress="enterDecimal(event)"></td>
            <td nowrap width="25%" > 
              <div align="right">Seguro de Vida :</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01PAGSEG" size="15" maxlength="15" value="<%= lnBasic.getE01PAGSEG().trim()%>" onKeypress="enterDecimal(event)"></td>
          </tr>
		...
		<tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01PAGFEC" size="15" maxlength="15" value="<%= lnBasic.getE01PAGFEC().trim()%>" onKeypress="enterDecimal(event)"></td>
            <td nowrap width="25%" > 
              <div align="right">Mensualidad Total :</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01VCUOTA" size="15" maxlength="15" value="<%= lnBasic.getE01VCUOTA().trim()%>" onKeypress="enterDecimal(event)"></td>
          </tr>
		...
		<tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01PAGINT" size="15" maxlength="15" value="<%= lnBasic.getE01PAGINT().trim()%>" onKeypress="enterDecimal(event)"></td>
            <td nowrap width="25%" > 
