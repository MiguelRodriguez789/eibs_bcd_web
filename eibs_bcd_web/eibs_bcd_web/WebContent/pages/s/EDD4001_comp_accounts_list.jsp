...
<BODY>
<h3 align="center">Mantenimiento de Pagos Automáticos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="comp_accounts_list.jsp, EDD4001"></h3>
<hr size="4">
        ...
        <table id="headTable" width="100%">
		 ...
		 %>
          <tr> 
            ...
            <td NOWRAP  align=CENTER width="3%"><%= Util.formatCustomDate(currUser.getE01DTF(),
            		msgList.getBigDecimalE01PAYRDM().intValue(),
            		msgList.getBigDecimalE01PAYRDD().intValue(),
            		msgList.getBigDecimalE01PAYRDY().intValue())%></td>
          </tr>
          <%
                }
              %>
