...
<h3 align="center">Listado Documentos a Cancelar<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pay_list,EDL0825"></h3>
<hr size="4">  
  ...
  <table class="tableinfo" id="trdark">
    <tr id="trdark">
      ...
      <% if (request.getParameter("OPT").equals("LN")) { out.println("Cuenta");}
        		 else { out.println("ADeudor");} %>
      </th>
    </tr>
    <tr id="trclear">
      <td align="center" nowrap width="50%">
       <% if (request.getParameter("OPT").equals("LN")) { out.print("<b>Número : </b>"+docList.getRecord(0));}
        		 else { out.print("<b>Identificación : </b>"+docList.getRecord(4));} %>
      </td>
      
      <td align="center" nowrap width="50%">
       <% if (request.getParameter("OPT").equals("LN")) { out.println("<b>Cliente : </b>"+docList.getRecord(1));}
  ...
  <TR> 
   ...
   <table id="headTable" style="width: 100%">
    <TR id="trdark"> 
      ...
      <th align="center" nowrap ><% if (request.getParameter("OPT").equals("LN")) { out.println("Deudor");}
