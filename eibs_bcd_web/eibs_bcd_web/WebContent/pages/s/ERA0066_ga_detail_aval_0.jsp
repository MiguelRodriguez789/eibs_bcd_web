...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_detail_aval_0.jsp, ERA0066"></h3> 
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap colspan=4> 
				<B>Información Bono de Prenda</B>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap> 
              <div align="right">Número del Bono de Prenda : </div>
            </td>
            <td nowrap >
            ...
            <td nowrap> 
              <div align="right">Número del Depósito de Mercancía : </div>
            </td>
            <td nowrap >
		  ...
		  <%if (!gaDetail.getE01R05TYP().equals("X")) { %>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap >
              <div align="right">Expedido por:</div>
            </td>
            <td nowrap >
            ...
            <td nowrap >
<%-- 
                <input type="text" name="E01R05IDE" id="E05R05IDE" size="28" maxlength="25" value="<%= gaDetail.getE01R05IDE().trim() %>">
--%>
            </td>
          </tr>
		  <%} %>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap> 
              <div align="right">Fecha Emisión del Bono : </div>
            </td>
            <td nowrap >
	...
	%>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap >
              <div align="right">Carta de Instrucciones de <br>Diligenciamiento Bono de Prenda : </div>
            </td>
            <td nowrap >
