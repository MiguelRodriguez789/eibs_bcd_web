...
<H3 align="center">Gestion de Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="params_officer_maint,ECB0030"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="9%" > 
              <div align="left"> 
                <input type="text" name="E01ECBCUN" size="10" maxlength="9" readonly value="<%= msgMT.getE01ECBCUN().trim()%>"readonly>
              </div>
            </td>
            <td nowrap width="12%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="9%"> 
              <div align="left"> 
                <input type="text" name="E01ECBACC" size="13" maxlength="12" value="<%= msgMT.getE01ECBACC().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="12%"> 
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
            ...
            <td nowrap > 
              <input type="text" name="E01CUSNA2" size="45" maxlength="45" value="<%=  msgMT.getE01CUSNA2().trim()%>" readonly>
            </td>
            <td nowrap > 
            ...
            <td nowrap > 
              <input type="text" name="E01CUSNA3" size="45" maxlength="45" value="<%= msgMT.getE01CUSNA3().trim()%>" readonly>
            </td>
            <td nowrap > 
         ...
         <tr id="trdark"> 
            ...
            <td nowrap > 
              <input type="text" name="E01CUSNA4" size="45" maxlength="45" value="<%=  msgMT.getE01CUSNA4().trim()%>" readonly>
            </td>
            <td nowrap > 
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
            ...
            <td nowrap > 
              <eibsinput:date name="msgMT" fn_month="E01DEAODM" fn_day="E01DEAODD" fn_year="E01DEAODY" readonly="true"/>
            </td>
            <td nowrap > 
              <div align="right">Fecha Vencimiento :</div>
            </td>
            <td nowrap >
              <eibsinput:date name="msgMT" fn_month="E01DEAMDM" fn_day="E01DEAMDD" fn_year="E01DEAMDY" readonly="true"/>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
          ...
          <tr id="trclear">
            ...
            <td nowrap >
              <eibsinput:date name="msgMT" fn_month="E01DEAEXM" fn_day="E01DEAEXD" fn_year="E01DEAEXY" readonly="true"/>
            </td>
          </tr>
        </table>
      </td>
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
	    ...
	    <tr id=trdark> 
	      <td nowrap width="20%"> 
     	  ...
     	  <td nowrap >                
		 	<input type="text" name="E01ECBRES" size="4" maxlength="5" readonly value="<%= msgMT.getE01ECBRES().trim()%>">
		 	<input type="text" name="E01DSCRES" size="45" maxlength="45" value="<%= msgMT.getE01DSCRES().trim()%>"readonly>
          </td>
        </tr>    
	    <tr id=trclear> 
	      <td nowrap width="20%"> 
	       	<div align="right">C&oacute;digo de Gestor :</div>
	      </td>
     	  <td nowrap >                
		 	<input type="text" name="E01ECBCOD" size="4" maxlength="5" readonly value="<%= msgMT.getE01ECBCOD().trim()%>">
		 	<input type="text" name="E01ECBJRN" size="45" maxlength="45" value="<%= msgMT.getE01ECBJRN().trim()%>"readonly>
          </td>
        </tr>    
   	   <tr id=trdark> 
	      <td nowrap width="20%"> 
     	  ...
     	  <td nowrap >                
		 	<input type="text" name="E01ECBICS" size="11" maxlength="10" readonly value="<%= msgMT.getE01ECBICS().trim()%>">
          </td>
        </tr>    	
      	<tr id=trclear> 
	      <td nowrap width="20%"> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01ECBNA0" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA0() %>">
	      </td>
     	</tr>
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	       <input type="text" name="E01ECBNA1" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA1() %>"> 
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	       <input type="text" name="E01ECBNA2" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA2() %>">
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	       <input type="text" name="E01ECBNA3" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA3() %>">
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	       <input type="text" name="E01ECBNA4" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA4() %>">
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	       <input type="text" name="E01ECBNA5" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA5() %>">
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	       <input type="text" name="E01ECBNA6" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA6() %>">
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	       <input type="text" name="E01ECBNA7" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA7() %>">
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	       <input type="text" name="E01ECBNA8" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA8() %>">
	      ...
	      <td nowrap>
	       <input type="text" name="E01ECBNA9" size="90" maxlength="80" readonly value="<%= msgMT.getE01ECBNA9() %>">
