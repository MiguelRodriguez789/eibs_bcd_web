...
<H3 align="center">Cancelaci&oacute;n de Cuentas de Ahorro<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cancel_enter_sv.jsp, EDD1150"></H3>
  ...
  <table class="tbenter" HEIGHT="75%" width="100%" border="0">
    ...
    <tr> 
      <td nowrap ALIGN=CENTER> N&uacute;mero de Cuenta: 
        ...
        <a href="javascript:GetAccount('E01ACMACC','','04','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
