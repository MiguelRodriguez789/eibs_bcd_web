...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEOF0120" >
  ...
  <h3 align="center">Cancelaci&oacute;n de Cheques Certificados<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="of_chkcer_inq_det_cancel.jsp, EOF0120"></h3>
  <hr size="4">
  <BR>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="26%"> 
              <div > <%= Util.formatCustomDate(currUser.getE01DTF(), dvDocDet.getE02OFMEMM(),dvDocDet.getE02OFMEMD(),dvDocDet.getE02OFMEMY())%> </div>
            </td>
          </tr>
        </table>
      </td>
