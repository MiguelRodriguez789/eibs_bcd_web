...
<H3 align="center">Consulta de Ejecutivos de Cuenta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_agent_inq,ECIF090"></H3>
<hr size="4">
<p>&nbsp;</p>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01INQBNK" size="3" maxlength="2" onKeypress="enterInteger(event)" value="<%= msgMT.getE01INQBNK()%>">
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01INQRDY" size="5" maxlength="4" onKeypress="enterInteger(event)" value="<%= msgMT.getE01INQRDY()%>">
	        <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
	      </td>
     	</tr>
     	<tr id=trdark> 
		  <td nowrap width="40%"> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E01INQRDM" size="3" maxlength="2" onKeypress="enterInteger(event)" value="<%= msgMT.getE01INQRDM()%>">
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
      	  </td>     
      	</tr>
      	<tr id=trclear> 
		  <td nowrap width="40%"> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E01INQOFC','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
      	  </td>     
      	</tr>
     </table>
