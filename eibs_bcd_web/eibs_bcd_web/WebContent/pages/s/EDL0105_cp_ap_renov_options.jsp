...
%> 
<h3 align="center">Intrucciones de Pago  (Renovación)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cp_ap_renov_options,EDL0105"></h3>
<hr size="4">
      ...
      <td>
        <table cellpadding=2 cellspacing=0 align=center width=100% bordercolor="#000000">
          <tr id="trdark"> 
            ...
            <td height="46" colspan="2" > Opción de Cancelación. Principal e Intereses serán pagados a una Cuenta Contable. <input type="hidden" name="E08DDDFLV" value=""></td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
            <td colspan="2" >&nbsp;</td>
          ...
          <tr id="trdark"> 
            ...
            <td height="36" colspan="2" >Opción de Cancelación. Principal e Intereses serán pagados a una Cuenta de Detalle (Corriente, Ahorros, etc.). </td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
            <td colspan="2" >&nbsp;</td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" > 
              <p>Interés será pagado en  
                ...
                un Certificado. El principal será renovado por el mismo periodo de tiempo.</p>
            </td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" > Interés será pagado en   
              ...
              a una Cuenta Contable. El principal será renovado por el mismo periodo de tiempo.</td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
            <td colspan="2" >&nbsp;</td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" >El Principal e Interés será pagado basado en una cronograma de pago  <a href="javascript:document.forms[0].typeS.click();showCDPayMaint()"><img src="<%=request.getContextPath()%>/images/eibs_deducciones.gif" title="Payment Plan" align="middle" border="0" ></a> 
              , y será pagado a una Cuenta Contable o a una Cuenta de Detalle. </td>
          </tr>
        </table>
      </td>
    </tr>
