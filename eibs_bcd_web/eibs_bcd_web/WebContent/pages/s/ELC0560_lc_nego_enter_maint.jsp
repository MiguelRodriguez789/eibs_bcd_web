...
<SCRIPT type="text/javascript">
 function HelpWindow(fld1,fld2){
 	fieldAux1=fld1;
	fieldAux2=fld2;
	var page= '<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0100?SCREEN=6';
...
<H3 ALIGN="center">Pago/Negociaci&oacute;n de Cartas de Cr&eacute;dito
	<IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left" NAME="EIBS_GIF" title="lc_nego_enter_maint.jsp, ELC0560"></H3>
<HR SIZE="4">
...
<TABLE CLASS="tbenter" WIDTH="100%" BORDER="0">
	<TR>
		...
		<TD nowrap>
		<DIV><INPUT TYPE="text" NAME="E01LCRNUM" SIZE="13" MAXLENGTH="12" ONKEYPRESS="enterInteger(event)">
		<A HREF="javascript:HelpWindow('E01LCRNUM','E01DRWNUM')"> <IMG SRC="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" BORDER="0"></A>
			</DIV>
		</TD>
	</TR>
	<TR>
		...
		<TD nowrap><INPUT TYPE="text" NAME="E01DRWNUM" SIZE="2" MAXLENGTH="2" ONKEYPRESS="return enterDecimalNum(event)"><IMG
			src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" border="0"> <A
