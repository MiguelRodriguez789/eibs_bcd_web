...
<H3 align="center">Mantenimiento de Instrumentos de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_new, EPR0305"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
			...
			<a href="javascript:GetCodeDescCNOFC('E02PSIINS','E02PSIINA','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a>
			<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
		  </td>
     	</tr>
     	<tr id=trdark> 
		  <td> 
			...
			<a href="javascript:GetCurrency('E02PSICCY',document.forms[0].E02PSIBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
      	  </td>     
      	</tr>
      	<tr id=trclear>
          ...
          <td nowrap>
              ...
              <a href="javascript:GetCustomerDescId('E02PSICUS','E02PSICUN',document.forms[0].E02PSIBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
          </td>
        </tr>
     </table>
    </td>
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		<tr>
			...
			<td nowrap width="60%">
				...
				<a href="javascript:GetCurrency('E02PSILIC',document.forms[0].E02PSIBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
				<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
			</td>
		</tr>
		<tr>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td align="center">
				<input type="text" name="E02PSIPTI"	value="<%= msgInst.getE02PSIPTI() %>" onkeypress="enterInteger(event)">
			</td>
			<td align="center">
				<input type="text" name="E02PSISTI" value="<%= msgInst.getE02PSISTI() %>" onkeypress="enterInteger(event)">
			</td>
		</tr>
     </table>
    </td>
