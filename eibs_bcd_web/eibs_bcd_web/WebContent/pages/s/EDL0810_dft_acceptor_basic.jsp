...
{
	page= "${pageContext.request.contextPath}/pages/s/EWD0170_dft_hlp_acpt.jsp?codeflag=" + flag;
	fieldName=name;
...
%> 
<h3 align="center">Mantenimiento de Deudores<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dft_acceptor_basic.jsp,EDL0810"> 
</h3>
<hr size="4">
...
<%
if (strGrp.equals("V")) {
  if (dftAcceptor.getE03DLDMA1().trim().equals("")) {
  strReadonly = "";
  } else {
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left">
                <INPUT type="text" name="E01DEACUN" size="10" maxlength="9" value="<%= userPO.getHeader2()%>" readonly>
                </div>
            </td>
            <td nowrap width="16%" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3"> 
              <INPUT type="text" name="E03DLDIDA" size="27" maxlength="25" value="<%= dftAcceptor.getE03DLDIDA() %>" <%=strReadonly %> readonly>
            </td>
	          <td nowrap width="25%">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="5"> 
              <INPUT type="text" name="E03DLDHPN" size="17" maxlength="15" value="<%= dftAcceptor.getE03DLDHPN() %>" <%=strReadonly %>>
            </td>
          ...
          <tr id="trclear">             
            ...
            <td nowrap colspan=5> 
              ...
              <a href="javascript:GetCodeDescCNOFC1('E03DLDCOM','D03DLDCOM','E03DLDCIU','D03DLDCIU','80')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>	
         ...
         <tr id="trdark"> 
            ...
            <td nowrap colspan=5> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E03DLDCIU','D03DLDCIU','84')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>	
          ...
          <tr id="trdark"> 
            ...
            <a href="javascript:GetCodeCNOFC('E03DLDREW','42')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a> 
	        </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" colspan="3"> 
              ...
              <a href="javascript:GetCodeAcpt('E03DLDPYW','02')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a>
           </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap colspan="5" > 
              ...
              <a href="javascript:GetCodeAcpt('E03DLDREM','01')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a>
            </td>
          </tr>
