...
<h3 align="center">Información Básica<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cp_ap_maint.jsp,EDL0105"></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0105A" onsubmit="javascript:this.disabled = true;">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01DEACUN" readonly <% if (cdMant.getF01DEACUN().equals("Y")) out.print("class=\"txtchanged\""); %> size="10" maxlength="9" value="<%= cdMant.getE01DEACUN().trim()%>" >
               </div>
            </td>
            <td nowrap width="16%" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="27%"> 
              <input type="text" name="E01DEALID" readonly <% if (cdMant.getF01DEALID().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="2" value="<%= cdMant.getE01DEALID().trim()%>" >
              <input type="text" name="E01DEALIM" readonly <% if (cdMant.getF01DEALIM().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="2" value="<%= cdMant.getE01DEALIM().trim()%>" >
              <input type="text" name="E01DEALIY" readonly <% if (cdMant.getF01DEALIY().equals("Y")) out.print("class=\"txtchanged\""); %> size="5" maxlength="4" value="<%= cdMant.getE01DEALIY().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01DEASTD" size="3" maxlength="2" value="<%= cdMant.getE01DEASTD().trim()%>" readonly>
              <input type="text" name="E01DEASTM" size="3" maxlength="2" value="<%= cdMant.getE01DEASTM().trim()%>" readonly>
              <input type="text" name="E01DEASTY" size="5" maxlength="4" value="<%= cdMant.getE01DEASTY().trim()%>" readonly>
            </td>
            <td nowrap width="25%"> 
              <div align="right">Fecha de Vencimiento :</div>
            </td>
            <td nowrap width="27%"> 
              <input type="text" name="E01DEAMDD" <% if (cdMant.getF01DEAMDD().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="2" value="<%= cdMant.getE01DEAMDD().trim()%>" >
              <input type="text" name="E01DEAMDM" <% if (cdMant.getF01DEAMDM().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="2" value="<%= cdMant.getE01DEAMDM().trim()%>" >
              <input type="text" name="E01DEAMDY" <% if (cdMant.getF01DEAMDY().equals("Y")) out.print("class=\"txtchanged\""); %> size="5" maxlength="4" value="<%= cdMant.getE01DEAMDY().trim()%>" >
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" height="37"> 
             <input type="text" name="E01DEATRM" size="6" maxlength="5" value="<%= cdMant.getE01DEATRM().trim()%>" readonly>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="27%" >
            	<input type="text" name="E01DEAF02" size="10" readonly <% if (cdMant.getF01DEAF02().equals("Y")) out.print("class=\"txtchanged\""); %>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAUC6" readonly <% if (cdMant.getF01DEAUC6().equals("Y")) out.print("class=\"txtchanged\""); %> size="5" maxlength="4" value="<%= cdMant.getE01DEAUC6().trim()%>" >
            </td>
            <td nowrap width="25%" >
              <div align="right">Tipo de Revaloración :</div>
            </td>
            <td nowrap width="27%" >
            	<input type="text" name="E01DEARRT" size="30" readonly <% if (cdMant.getF01DEARRT().equals("Y")) out.print("class=\"txtchanged\""); %>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" > 
				<input type="text" name="E01SFENUM" readonly <% if (cdMant.getF01SFENUM().equals("Y")) out.print("class=\"txtchanged\""); %> size="11" maxlength="10" value="<%= cdMant.getE01SFENUM().trim()%>" > 
           </td>
            <td nowrap width="25%" >
              <div align="right">No. de CUSIP/ISIN :</div>
            </td>
            <td nowrap width="27%" >
             <INPUT type="text" name="E01DEACUI" readonly <% if (cdMant.getF01DEACUI().equals("Y")) out.print("class=\"txtchanged\""); %> size="13"	maxlength="12" value="<%= cdMant.getE01DEACUI().trim()%>">
            </td>
          </tr>     
          <tr id="trdark"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="75%" colspan="3"> 
				<INPUT type="text" name="E01DEAREF" readonly <% if (cdMant.getF01DEAREF().equals("Y")) out.print("class=\"txtchanged\""); %> size="13"	maxlength="12" value="<%= cdMant.getE01DEAREF().trim()%>">            
			</td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="75%" colspan="3"> 
              <input type="text" name="E01DEAUC7" readonly <% if (cdMant.getF01DEAUC7().equals("Y")) out.print("class=\"txtchanged\""); %> size="5" maxlength="4" value="<%= cdMant.getE01DEAUC7().trim()%>" >
              <input type="text" name="D01DEAUC7" readonly <% if (cdMant.getF01DEAUC7().equals("Y")) out.print("class=\"txtchanged\""); %> size="40" maxlength="35" value="<%= cdMant.getE01DEAUC7().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="75%" colspan="3" > 
            	<input type="text" name="E01DEALOC" readonly <% if (cdMant.getF01DEALOC().equals("Y")) out.print("class=\"txtchanged\""); %> size="40" maxlength="35" value="<%= cdMant.getE01DEALOC().trim()%>" >
            </td>
          </tr>  
           <tr id="trclear"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAGCD" readonly <% if (cdMant.getF01DEAGCD().equals("Y")) out.print("class=\"txtchanged\""); %> size="5" maxlength="4" value="<%= cdMant.getE01DEAGCD().trim()%>" >
            </td>
            <td nowrap width="25%" >
              <div align="right">País de Riesgo  :</div>
            </td>
            <td nowrap width="27%" >
              <input type="text" name="E01DEAGRC" readonly <% if (cdMant.getF01DEAGRC().equals("Y")) out.print("class=\"txtchanged\""); %> size="13" maxlength="12" value="<%= cdMant.getE01DEAGRC().trim()%>" >
             </td>
          </tr>          
          <tr id="trdark"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAFTB" readonly <% if (cdMant.getF01DEAFTB().equals("Y")) out.print("class=\"txtchanged\""); %> size="2" maxlength="2" value="<%= cdMant.getE01DEAFTB().trim()%>">
            	<input type="text" name="E01DEAFTY" size="10" readonly <% if (cdMant.getF01DEAFTY().equals("Y")) out.print("class=\"txtchanged\""); %>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEARDD" readonly <% if (cdMant.getF01DEARDD().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="2" value="<%= cdMant.getE01DEARDD().trim()%>" >
              <input type="text" name="E01DEARDM" readonly <% if (cdMant.getF01DEARDM().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="2" value="<%= cdMant.getE01DEARDM().trim()%>" >
              <input type="text" name="E01DEARDY" readonly <% if (cdMant.getF01DEARDY().equals("Y")) out.print("class=\"txtchanged\""); %> size="5" maxlength="4" value="<%= cdMant.getE01DEARDY().trim()%>" >
              / 
              <input type="text" name="E01DEARRP" readonly <% if (cdMant.getF01DEARRP().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="3" value="<%= cdMant.getE01DEARRP().trim()%>"  >
            </td>
            <td nowrap width="25%" > 
              <div align="right">Centro de Costo :</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01DEACCN" size="9" maxlength="8" value="<%= cdMant.getE01DEACCN().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%">
  ...
  <TR><TD>
   ...
   <table id="headTable">
    ...
    <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01OFFBR<%= name %>" size="4" maxlength="4" value="<%= cdMant.getField("E01OFFBR"+name).getString().trim()%>" readonly>
        </div>
      </td>
      <td nowrap  > 
        <div align="center"> 
  ...
  <TR><TD>
   ...
   <table id="headTable1" style="width: 100%">
...
<!--       <td nowrap align="center" >Monto</td>			-->
    ...
    <div id="dataDiv1" class="scbarcolor" style="height:60; overflow-y :scroll; z-index:0" >
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01REPBRN" size="4" maxlength="4" value="<%= cdMant.getE01REPBRN().trim()%>" readonly>
        </div>
      </td>
      <td nowrap  > 
        <div align="center"> 
 ...
 <SCRIPT type="text/javascript">
    function tableresize() {
     ...
     adjustEquTables( getElement('headTable1'), getElement('dataTable1'), getElement('dataDiv1'),0,true);
   }
