...
<script type="text/javascript">
	function validate() {
		if (getElement("account").value == "") {
			alert("Por favor seleccione una boleta valida.");
		} else {
			return true;
		}
	}
...
<H3 align="center">Mantenimiento de Boletas de Garantia
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bg_enter_maint, ELC5000"></H3>
