...
<H3 align="center">Consulta de Balances - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_balance_maint,SRV0030"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01BALCD1" size="3" maxlength="2" value="<%= msgMT.getE01BALCD1() %>" readonly>
	      	<input type="text" name="E01BALCD2" size="3" maxlength="2" value="<%= msgMT.getE01BALCD2() %>" readonly>
	      	<input type="text" name="E01BALCD3" size="5" maxlength="4" value="<%= msgMT.getE01BALCD3() %>" readonly>
	      </td>
     	</tr>
     	<tr id=trclear> 
		  <td> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01BALAD1" size="3" maxlength="2" readonly value="<%= msgMT.getE01BALAD1() %>">
	      	<input type="text" name="E01BALAD2" size="3" maxlength="2" readonly value="<%= msgMT.getE01BALAD2() %>">
	      	<input type="text" name="E01BALAD3" size="5" maxlength="4" readonly value="<%= msgMT.getE01BALAD3() %>">
	      </td>
     	</tr>
     	<tr id=trclear> 
		  <td> 
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01BALUD1" size="3" maxlength="2" readonly value="<%= msgMT.getE01BALUD1() %>">
	      	<input type="text" name="E01BALUD2" size="3" maxlength="2" readonly value="<%= msgMT.getE01BALUD2() %>">
	      	<input type="text" name="E01BALUD3" size="5" maxlength="4" readonly value="<%= msgMT.getE01BALUD3() %>">
	      </td>
     	</tr>
     	<tr id=trclear> 
		  <td> 
