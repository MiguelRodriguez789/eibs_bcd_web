...
<html>
<head>
<title>Información Detalle de Avales</title>
...
function goReturn(){
   ...
   addEventHandler(document,'submit', function(){
	   waitSimulate(); 
   });
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_detail_aval_I.jsp, ERA0066"></h3> 
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
			<%
			if ((gaDetail.getE01R05TYP().equals("Q"))
				|| (gaDetail.getE01R05TYP().equals("O"))
				|| (gaDetail.getE01R05TYP().equals("6"))
				|| (gaDetail.getE01R05TYP().equals("G"))) {
			%>		
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap >
				<%
 					if (!b_read_only1) {
 				%>
               <eibsinput:cnofc name="gaDetail" flag="GT" property="E01R05TIC" fn_description="D01R05TIC" required="true"  readonly="<%=b_read_only1%>"/>
				<%
					} else {
				%>
            ...
            <td nowrap> 
              <div align="right">Número de Documento Cliente :</div>
            </td>
            <td nowrap >
                <input type="text" name="E01R05IDC" id="E05R05IDC" size="28" maxlength="25" value="<%= gaDetail.getE01R05IDC().trim() %>" <% if (gaDetail.getF01R05IDC().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
			<%
			}
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap >
				<%
 					if (!b_read_only1) {
 				%>
               <eibsinput:cnofc name="gaDetail" flag="34" property="E01R05TIE" fn_description="D01R05TIE" required="true"  readonly="<%=b_read_only1%>"/>
				<%
					} else {
				%>
            ...
            <td nowrap> 
              <div align="right">Número de Documento Emisor :</div>
            </td>
            <td nowrap >
                <input type="text" name="E01R05IDE" id="E05R05IDE" size="28" maxlength="25" value="<%= gaDetail.getE01R05IDE().trim() %>" <% if (gaDetail.getF01R05IDE().equals("Y")) out.print("class=\"txtchanged\""); %>>
                <a href="javascript:GetCustomerDescId('','E01R05NME','E01R05IDE')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
                <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"  > 
                <br>
                <input type="text" name="E01R05NME" readonly size="45" maxlength="45" value="<%= gaDetail.getE01R05NME().trim()%>" <% if (gaDetail.getF01R05IDE().equals("Y")) out.print("class=\"txtchanged\""); %>>
            </td>
          </tr>
		<%
		if ((gaDetail.getE01R05TYP().equals("Q"))
			|| (gaDetail.getE01R05TYP().equals("N"))
			|| (gaDetail.getE01R05TYP().equals("O"))
			|| (gaDetail.getE01R05TYP().equals("6"))
			|| (gaDetail.getE01R05TYP().equals("G"))) {
		%>		
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap> 
              <div align="right">Código de Oficina : </div>
            </td>
            <td nowrap >
			  ...
			  <%} %>
               <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"  > 
                <eibsinput:text name="gaDetail" property="D01R05BRN" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME_SHORT %>" readonly="true" modified="F01R05BRN"/>
            </td>
          </tr>
		  <%} %>
		<%
		if ((gaDetail.getE01R05TYP().equals("K"))
			|| (gaDetail.getE01R05TYP().equals("I"))
			|| (gaDetail.getE01R05TYP().equals("J"))) {
		%>		
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap> 
              <div align="right">Fecha de Emisión : </div>
		  ...
		  <%} %>
		<%
		if ((gaDetail.getE01R05TYP().equals("I"))
			|| (gaDetail.getE01R05TYP().equals("J"))) {
		%>		
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap> 
	  ...
	  <%} %>
		...
		%>		
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap >
              <div align="right">Moneda Emisor : </div>
            </td>
            <td nowrap >
		      	<input type="text" name="E01R05CCE" size="4" maxlength="3" value="<%=gaDetail.getE01R05CCE()%>" <%=read_only1%> <% if (gaDetail.getF01R05CCE().equals("Y")) out.print("class=\"txtchanged\""); %>>
		...
		%>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap >
              <div align="right">Monto Límite : </div>
            </td>
            <td nowrap >
