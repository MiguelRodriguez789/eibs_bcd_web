...
%>
<h3 align="center">MT 210 - Notificaci&oacute;n de Recibo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_fw_format.jsp, ESWF210I"> 
</h3>
<hr size="4">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" ><%= Util.formatCustomDate(currUser.getE01DTF(),
            		swift.getBigDecimalE03SWFVDM().intValue(),
              		...
              		swift.getBigDecimalE03SWFVDY().intValue())%> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="21%" > 
