...
<body>
<h3 align="center">Consulta Detallada - Posici&oacute;n de Moneda<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_currency.jsp,EWD0327"> 
</h3>
<hr size="4">
<%
