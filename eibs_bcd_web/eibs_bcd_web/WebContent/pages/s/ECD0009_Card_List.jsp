...
//<!-- Hide from old browsers
  ...
  function query(codigoPlastico){
    var page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSECD0009?SCREEN=2&E01CDRTBL="+codigoPlastico;
...
<h3 align="center">Control de Plástico<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="Card_List.jsp, ECD0009">
</h3>
<hr size="4">
 ...
 <table class="tbenter" width="100%" align="center">
    <tr> 
      <td class="TDBKG" width="25%"> 
        <div align="center" style="cursor:hand" onClick="create()"><a><b>Crear</b></a></div>
      </td>
      <td class="TDBKG" width="25%"> 
        <div align="center" ><a href="javascript:edit()"><b>Modificar</b></a></div>
      </td>
      <td class="TDBKG" width="25%"> 
