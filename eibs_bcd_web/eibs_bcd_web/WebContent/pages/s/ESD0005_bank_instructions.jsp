...
<h3 align="center">Instrucciones del Banco<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bank_instructions.jsp,ESD0005"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%"> 
              ...
              <a href="javascript:GetSwiftId('E06SWI')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="middle" border="0"></a> 
            </td>
            <td nowrap width="26%"> 
            ...
            <td nowrap width="26%">
              ...
              <a href="javascript:GetCustomerDescId('E06CC1','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="19%" height="23"> 
              ...
              <a href="javascript:GetAccount('E06DDA',document.forms[0].E06BNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
            </td>
            ...
            <td nowrap width="26%" height="23"> 
              ...
              <a href="javascript:GetLedger('E06GLN',document.forms[0].E06BNK.value,document.forms[0].E06CCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="19%" height="19"> 
              ...
              <a href="javascript:GetAccount('E06DD1',document.forms[0].E06BNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
            </td>
            ...
            <td nowrap width="26%" height="19"> 
              ...
              <a href="javascript:GetLedger('E06GL1',document.forms[0].E06BNK.value,document.forms[0].E06CCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
            </td>
          </tr>
        </table>
      </td>
                      ...
                      <table id="TableTabL" cellspacing=0 cellpadding=0 border="0">
                        ...
                        <tr > 
                          <td nowrap id="Tab3" class="tabnormalv" onClick="showTab(3,'E06RI1')"> 
                            <div  >Recibidor Intermediario</div>
                          <td> 
                        </tr>
                        <tr > 
                            ...
                            <tr> 
                              <td width="53%"> 
                                <div align=center> N&uacute;mero de Cliente : 
                                  <input type="text" name="E06PYC" size="9" maxlength="9" value="<%= pymInst.getE06PYC()%>" onkeypress="enterInteger(event)">
                                <a href="javascript:GetCustomerDescId('E06PYC','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
                                </div>
                              </td>
                            </tr>
                            <tr> 
                        ...
                        <div id="dataTab1" style="display: none"> 
                          <table width="94%" border="0">
                            <tr> 
                              <td width="53%"> 
                                <div align=center> N&uacute;mero de Cliente :
<input type="text" name="E06RCC" size="9" maxlength="9" value="<%= pymInst.getE06RCC()%>" onkeypress="enterInteger(event)">
                                <a href="javascript:GetCustomerDescId('E06RCC','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
                                </div>
                              </td>
                            </tr>
                            <tr> 
