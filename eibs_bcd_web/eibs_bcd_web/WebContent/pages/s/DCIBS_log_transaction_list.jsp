...
<H3 align="center">Transactions List <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="DCIBS_log_transaction_list.jsp, DCIBS"></H3>
<hr size="4">
