...
<h3 align="center">Informaci&oacute;n de Titulares<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_tit.jsp,EPC0000"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table id="headTable" width="100%">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap> 
              <div align="center"> 
                <input type="text" name="E06ID<%= name %>" size="28" maxlength="25" value="<%= cdTit.getField("E06ID"+name).getString().trim()%>">
              </div>
            </td>
            <td nowrap> 
              <div align="center"> 
