...
%> 
<h3 align="center"> Consulta - Opciones de Moneda<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_opt.jsp,EFE120I"> 
</h3>
<hr size="4">
...
<input type="radio" name="CE01FESTRC" value="Y" onClick="document.forms[0].E01FESTRC.value='Y'"
          ...
          <tr id="trdark"> 
            ...
            <td nowrap height="35" colspan="4" > 
              <div align="left"> 
                <input type="text" readonly  name="E01FESOTS" size="65" maxlength="120" value="<%= fex.getE01FESOTS()%>" 
			  >
