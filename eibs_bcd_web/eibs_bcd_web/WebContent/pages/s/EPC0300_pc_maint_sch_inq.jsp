...
<h3 align="center">Mantenimiento Presupuesto de Obra - Consulta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_maint_sch_inq.jsp, EPC0300"></h3>
<hr size="4">
