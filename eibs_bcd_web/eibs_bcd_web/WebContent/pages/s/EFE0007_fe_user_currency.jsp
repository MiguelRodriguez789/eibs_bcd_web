...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_user_currency.jsp, EFE0007"></H3>
<hr size="4">
  ...
  <table  class="tableinfo" width="100%">
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        ...
        <tr id="trdark"> 
            <td nowrap width="20%" align="right">Usuario : </td>
			...
			<td nowrap width="20%">Fecha de Actualización : <%= datapro.eibs.master.Util.formatDate(Dtl.getE01FEUUPT())%>
            </td>
		</tr>
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="25%" align="right">Porcentaje : </td>
