...
%> 
<h3 align="center"> <%= dftBasic.getE01DSCPRO().trim() %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dft_basic.jsp,EDL0800"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
            <eibsinput:date name="dftBasic" fn_year="E01DEAODY" fn_month="E01DEAODM" fn_day="E01DEAODD" readonly />
