...
<H3 align="center">Consulta de Cobranza Documentaria Recibida<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="coll_doc_inq_basic_incoming,EDC0100"></h3>
<hr size="4">
<form method="post">
      ...
      <td nowrap>
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trdark">
           ...
           <TR id="trclear">
            ...
            <TD nowrap width="30%">
            	...
            	<INPUT type="text" name="E01DCMOFX" maxlength="19" size="20" value="<%= collBasic.getE01DCMOFX().trim()%>" onkeypress="enterDecimal(event, 6)" readonly>
            </TD>
          </TR>
          <TR id="trdark">
            <TD nowrap width="30%">
            	...
            	<INPUT type="text" name="E01DCMOAM" maxlength="19" size="20" value="<%= collBasic.getE01DCMOAM().trim()%>" onkeypress="enterDecimal()" readonly>
            </TD>
			<TD nowrap width="30%">
          ...
          <TR id="trdark">
            ...
            <TD nowrap width="20%">
            	<INPUT type="radio" name="E01DCMTVS" <%if(collBasic.getE01DCMTVS().equals("Y")) out.print("checked");%> value="Y" disabled>Sí
            	<INPUT type="radio" name="E01DCMTVS" <%if(collBasic.getE01DCMTVS().equals("N")) out.print("checked");%> value="N" disabled>No
            </TD>
          </TR>
          <TR id="trclear">
            <TD nowrap width="30%">
