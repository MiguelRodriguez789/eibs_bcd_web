...
<H3 align="center">Tabla de Cargos Camara/Devoluciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="causal_basic.jsp, EDD0938"></H3>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" name="E01CDVDSC" size="48" maxlength="45" value="<%= caBasic.getE01CDVDSC().trim()%>">
              </div>
            </td>
          </tr>
        </table>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="19%"><INPUT type="text" name="E01CDVCCY" size="4" maxlength="3" value="<%= caBasic.getE01CDVCCY().trim()%>">
              <a href="javascript:GetCurrency('E01CDVCCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="26%"><INPUT type="text" name="E01CDVALT" size="7" maxlength="2" value="<%= caBasic.getE01CDVALT().trim()%>">
            <a href="javascript:GetCodeCNOFC('E01CDVALT','35')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0"></a>
            </td>
          </tr>
              	  <tr id="trclear"> 
      		<td nowrap width="29%" align="right">Tipo de Causal</td>
            <td nowrap width="19%">
            	<SELECT name="E01CDVFL1">
					<OPTION value="A"
						<% if (caBasic.getE01CDVFL1().equals("A")) out.print("selected"); %>>AUTOMATICA</OPTION>
					<OPTION value="T"
						<% if (caBasic.getE01CDVFL1().equals("T")) out.print("selected"); %>>TECNICA</OPTION>
				</SELECT>
            </td>
            <td nowrap width="26%" align="right">RESERVADA IBS:</td>
            <td nowrap width="26%">
					<% 	boolean reserved = false; 
						if (caBasic.getE01CDVCAU().trim().equals("0000") || 
						   caBasic.getE01CDVCAU().trim().equals("0001") ||
						   caBasic.getE01CDVCAU().trim().equals("0002") ||
						   caBasic.getE01CDVCAU().trim().equals("0003") ||
						   caBasic.getE01CDVCAU().trim().equals("0004") ||
						   caBasic.getE01CDVCAU().trim().equals("0005") ||
						   caBasic.getE01CDVCAU().trim().equals("0006") ||
						   caBasic.getE01CDVCAU().trim().equals("0007") ||
						   caBasic.getE01CDVCAU().trim().equals("0000") ||
						   caBasic.getE01CDVCAU().trim().equals("0008") ||
						   caBasic.getE01CDVCAU().trim().equals("0009") ||
						   caBasic.getE01CDVCAU().trim().equals("0010") ||
						   caBasic.getE01CDVCAU().trim().equals("0011") ||
						   caBasic.getE01CDVCAU().trim().equals("0012") ||
						   caBasic.getE01CDVCAU().trim().equals("0100")

					) { reserved = true; %>
						<B><FONT color="red">SI</FONT></B>
					<% } else { %>
						<B><FONT color="green">NO</FONT></B>
            		<% } %>	
            </td>
          </tr>
      ...
      <td nowrap> 
        <table cellspacing="0" width="100%" border="0">
          <tr id="trdark"> 
          	...
          	<tr id="trclear">          	
            	<td><INPUT type="text" name="E01CDVDE1" size="25" maxlength="25" value="<%= caBasic.getE01CDVDE1().trim()%>"></td>
            	<td>
            	...
            	<td><INPUT type="text" name="E01CDVCA1" size="11" maxlength="9" value="<%= caBasic.getE01CDVCA1().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td>
            	...
            	<td><INPUT type="text" name="E01CDVMN1" size="11" maxlength="9" value="<%= caBasic.getE01CDVMN1().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td><INPUT type="text" name="E01CDVMX1" size="11" maxlength="9" value="<%= caBasic.getE01CDVMX1().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td>
            		<SELECT name="E01CDVGF1">
						<OPTION value=" "<% if (caBasic.getE01CDVGF1().equals(" ")) out.print("selected"); %>>  </OPTION>
						<OPTION value="B"<% if (caBasic.getE01CDVGF1().equals("B")) out.print("selected"); %>>Base</OPTION>
						<OPTION value="N"<% if (caBasic.getE01CDVGF1().equals("N")) out.print("selected"); %>>Transacci&oacute;n</OPTION>
					</SELECT>
            	</td>            	
            	<td>
            		<input type="text" name="E01CDVGL1" size="17" maxlength="16" onKeypress="enterInteger(event)" value="<%= caBasic.getE01CDVGL1()%>" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,'<%=currUser.getE01UBK()%>',document.forms[0].E01CDVCCY.value,'','','')"  class="txtright">
            	</td>
            	<td>
          	...
          	<tr id="trclear">          	
            	<td><INPUT type="text" name="E01CDVDE2" size="25" maxlength="25" value="<%= caBasic.getE01CDVDE2().trim()%>"></td>
            	<td>
            	...
            	<td><INPUT type="text" name="E01CDVCA2" size="11" maxlength="9" value="<%= caBasic.getE01CDVCA2().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td>
            	...
            	<td><INPUT type="text" name="E01CDVMN2" size="11" maxlength="9" value="<%= caBasic.getE01CDVMN2().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td><INPUT type="text" name="E01CDVMX2" size="11" maxlength="9" value="<%= caBasic.getE01CDVMX2().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td>
            		<SELECT name="E01CDVGF2">
						<OPTION value=" "<% if (caBasic.getE01CDVGF2().equals(" ")) out.print("selected"); %>>  </OPTION>
						<OPTION value="B"<% if (caBasic.getE01CDVGF2().equals("B")) out.print("selected"); %>>Base</OPTION>
						<OPTION value="N"<% if (caBasic.getE01CDVGF2().equals("N")) out.print("selected"); %>>Transacci&oacute;n</OPTION>
					</SELECT>
            	</td>            	
            	<td><input type="text" name="E01CDVGL2" size="17" maxlength="16" onKeypress="enterInteger(event)" value="<%= caBasic.getE01CDVGL2()%>" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,'<%=currUser.getE01UBK()%>',document.forms[0].E01CDVCCY.value,'','','')"  class="txtright"></td>
            	<td>
          	...
          	<tr id="trclear">          	
            	<td><INPUT type="text" name="E01CDVDE3" size="25" maxlength="25" value="<%= caBasic.getE01CDVDE3().trim()%>"></td>
            	<td>
            	...
            	<td><INPUT type="text" name="E01CDVCA3" size="11" maxlength="9" value="<%= caBasic.getE01CDVCA3().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td>
            	...
            	<td><INPUT type="text" name="E01CDVMN3" size="11" maxlength="9" value="<%= caBasic.getE01CDVMN3().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td><INPUT type="text" name="E01CDVMX3" size="11" maxlength="9" value="<%= caBasic.getE01CDVMX3().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td>
            		<SELECT name="E01CDVGF3">
						<OPTION value=" "<% if (caBasic.getE01CDVGF3().equals(" ")) out.print("selected"); %>>  </OPTION>
						<OPTION value="B"<% if (caBasic.getE01CDVGF3().equals("B")) out.print("selected"); %>>Base</OPTION>
						<OPTION value="N"<% if (caBasic.getE01CDVGF3().equals("N")) out.print("selected"); %>>Transacci&oacute;n</OPTION>
					</SELECT>
            	</td>            	
            	<td><input type="text" name="E01CDVGL3" size="17" maxlength="16" onKeypress="enterInteger(event)" value="<%= caBasic.getE01CDVGL3()%>" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,'<%=currUser.getE01UBK()%>',document.forms[0].E01CDVCCY.value,'','','')"  class="txtright"></td>
            	<td>
          	...
          	<tr id="trclear">          	
            	<td><INPUT type="text" name="E01CDVDE4" size="25" maxlength="25" value="<%= caBasic.getE01CDVDE4().trim()%>"></td>
            	<td>
            	...
            	<td><INPUT type="text" name="E01CDVCA4" size="11" maxlength="9" value="<%= caBasic.getE01CDVCA4().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td>
            	...
            	<td><INPUT type="text" name="E01CDVMN4" size="11" maxlength="9" value="<%= caBasic.getE01CDVMN4().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td><INPUT type="text" name="E01CDVMX4" size="11" maxlength="9" value="<%= caBasic.getE01CDVMX4().trim()%>" onkeypress="enterDecimal(event, 2)" class="txtright"></td>
            	<td>
            		<SELECT name="E01CDVGF4">
						<OPTION value=" "<% if (caBasic.getE01CDVGF4().equals(" ")) out.print("selected"); %>>  </OPTION>
						<OPTION value="B"<% if (caBasic.getE01CDVGF4().equals("B")) out.print("selected"); %>>Base</OPTION>
						<OPTION value="N"<% if (caBasic.getE01CDVGF4().equals("N")) out.print("selected"); %>>Transacci&oacute;n</OPTION>
					</SELECT>
            	</td>            	
            	<td><input type="text" name="E01CDVGL4" size="17" maxlength="16" onKeypress="enterInteger(event)" value="<%= caBasic.getE01CDVGL4()%>" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,'<%=currUser.getE01UBK()%>',document.forms[0].E01CDVCCY.value,'','','')"  class="txtright"></td>
            	<td>
