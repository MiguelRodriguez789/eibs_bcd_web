...
%> 
<h3 align="center"> Forward Rates Agreements <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_fra_basic.jsp,ETR0130"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="right">Acción Tomada :</div>
            </td>
            <td nowrap colspan="2">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
              <a href="javascript:GetProductT('E01WFRPRO','D01APCDSC','','FRA')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a>
<input type="text" name="D01APCDSC" size="50" maxlength="70" value="<%= fra.getD01APCDSC()%>" 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
			  ...
			  >
              <a href="javascript:GetCode('E01WFRPVI','STATIC_fe_bo_pay.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap > 
              <div align="left">Tipo Confirmación : 
                <input type="text" name="E01WFRCFT" size="3" maxlength="2" value="<%= fra.getE01WFRCFT().trim()%>" 
			  >
                <a href="javascript:GetCode('E01WFRCFT','STATIC_fe_bo_not.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a></div>
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="21%"> 
              <h4 align="center">Monto Límite</h4>
            </td>
            <td nowrap width="23%"> 
              <h4 align="center"><b>Límite Disponible</b> </h4>
            </td>
            <td nowrap width="34%"> 
              <h4 align="center">Monto Límite Final</h4>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap  colspan="2"> 
