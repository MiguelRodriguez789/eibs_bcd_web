...
<H3 align="center">Preliquidacion de Solicitudes de Canje de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_maint, EPR0333"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	<tr id=trdark>
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E02REQBRN" size="5" maxlength="4" value="<%= msgCanje.getE02REQBRN() %>" readonly>
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
		...
		<tr>
			...
			<td nowrap width="60%">
				...
				<a href="javascript:GetCodeDescCNOFC('E02REQOPR','E02REQORN','Y!')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
				<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E02REQVD1" size="3" maxlength="2" value="<%= msgCanje.getE02REQVD1() %>" >
                <input type="text" name="E02REQVD2" size="3" maxlength="2" value="<%= msgCanje.getE02REQVD2() %>" >
                <input type="text" name="E02REQVD3" size="5" maxlength="4" value="<%= msgCanje.getE02REQVD3() %>" >
  ...
  <TR><TD>
   <table id="headTable" width="100%">
    ...
    <tr id="trclear" align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR1" size="5" maxlength="4" value="<%= msgCanje.getE02OFFBR1() %>"
       ...
       <td nowrap > 
          <div align="center"> 
             ...
             class="context-menu-help" onmousedown="init(lnreferHelp,this.name,document.forms[0].E02REQBNK.value,'',document.forms[0].E02REQCUS.value,'','RT')">
          </div>
        </td>
       <td nowrap > 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR2" size="5" maxlength="4" value="<%= msgCanje.getE02OFFBR2() %>"
             class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E02REQBNK.value,'','','','')">
          </div>
       </td>
       <td nowrap> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR3" size="5" maxlength="4" value="<%= msgCanje.getE02OFFBR3() %>"
             class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E02REQBNK.value,'','','','')">
          </div>
       </td>
       <td nowrap> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR4" size="5" maxlength="4" value="<%= msgCanje.getE02OFFBR4() %>"
             class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E02REQBNK.value,'','','','')">
          </div>
       </td>
       <td nowrap> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR5" size="5" maxlength="4" value="<%= msgCanje.getE02OFFBR5() %>"
             class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E02REQBNK.value,'','','','')">
          </div>
       </td>
       <td nowrap> 
