...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cleaning_applay_list, EDD0726"></h3> 
<hr size="4">
  ...
  <TABLE class="tableinfo">
    ...
    <%
          ...
          while (applayList.getNextRow()) {
               EDD072602Message msgList = (EDD072602Message) applayList.getRecord();			 
