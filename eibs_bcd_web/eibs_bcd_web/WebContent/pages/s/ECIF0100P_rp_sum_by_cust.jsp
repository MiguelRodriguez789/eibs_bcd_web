...
%>
  <h3 align="center">Resumen de Cuentas por N&uacute;mero de Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rp_sum_by_cust.jsp, ECIF0100P"></h3>
  <hr size="4">
  <p>&nbsp;</p>
