...
<h3 align="center">Mantenimiento <%=titu%> Clientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="client_list.jsp, ESD1080"></h3>
<hr size="4">
...
%>    
  ...
  <table  class="tableinfo" width="100%">
    ...
    <TR id=trdark> 
		...
		<TD nowrap align="center" width="5%"><B>Tipo de<br>IDN</B></TD>
		<td NOWRAP align="center" width="5%"><B>Tipo<br>Legal</B></td>
		<td NOWRAP align="center" width="10%"><B>Tipo<br>Mnto.</B></td>
    ...
    <TR id=trclear>
		...
		<td NOWRAP align="center" width="5%"> 
            <% if (!msgList.getE01APR().equals("L")) { %>
            	<INPUT type="radio" name="CODE" value="<%= msgList.getE01CUN() %>">
            <% } else { %>	
             <img src="<%=request.getContextPath()%>/images/warning_16.jpg" title="Requiere Aprobación de Cumplimiento" align="middle" border="0" >
			<% } %>
		...
		<td NOWRAP align="center" width="5%" ><%= msgList.getE01TID() %></td>
		<td NOWRAP align="center" width="5%" >
			<% if (msgList.getE01LGT().equals("2")) out.print("Natural") ;
			    else out.print("Juridico");
			%>
		</td>
		<td NOWRAP align="center" width="10%" style="color:green;font-size:10;">
			<% if (msgList.getE01CRT().equals("Y")) out.print("CREAR-") ;
			    else out.print("ACTUALIZAR-");
			String mntTyp = "BASICO";
			if (msgList.getE01OPE().equals("02")) mntTyp = "ESTADO";
			if (msgList.getE01OPE().equals("10")) mntTyp = "FUSION";
			if (msgList.getE01OPE().equals("12")) mntTyp = "LEY DE VICTIMAS";
			if (msgList.getE01OPE().equals("15")) mntTyp = "IDENTIFICACION";
			if (msgList.getE01OPE().equals("20")) mntTyp = "BASICO PROSPECTO";
			if (msgList.getE01OPE().equals("25")) mntTyp = "IMPUESTOS";
			if (msgList.getE01OPE().equals("30")) mntTyp = "FATCA";
			out.print(mntTyp);
			%>
		</td>
	</TR>
