...
<h3 align="center">Tasa de Cambio<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cp_inq_xchg_rate.jsp, EDL0105"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td width="61%">
              <input type="text" name="E06TRNVD1" readonly  size="3" maxlength="2" value="<%= cdRate.getE06TRNVD1().trim()%>" >
              <input type="text" name="E06TRNVD2" readonly  size="3" maxlength="2" value="<%= cdRate.getE06TRNVD2().trim()%>" >
              <input type="text" name="E06TRNVD3" readonly  size="5" maxlength="4" value="<%= cdRate.getE06TRNVD3().trim()%>" >
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="39%" > 
            ...
            <td width="61%" > 
              <input type="text" name="E06DEANR1" readonly  size="60" maxlength="60" value="<%= cdRate.getE06DEANR1().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="39%"> 
            ...
            <td width="61%"> 
              <input type="text" name="E06DEANR2" readonly  size="60" maxlength="60" value="<%= cdRate.getE06DEANR2().trim()%>">
            </td>
          </tr>
        </table>
      </td>
