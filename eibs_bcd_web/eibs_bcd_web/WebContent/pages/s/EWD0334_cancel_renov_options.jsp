...
%> 
<h3 align="center">Instrucciones de Cancelación/Renovaci&oacute;n <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cancel_renov_options,EWD0334"></h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 align=center width=100% >
          ...
          <tr id="trdark"> 
            ...
            <td height="32" colspan="4" > Inter&eacute;s ser&aacute; acreditado 
              ...
              <a href="javascript:GetAccount('E08BBBACC',document.forms[0].E08DEABNK.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
          ...
          <tr id="trdark"> 
            ...
            <td height="44" colspan="4" > Inter&eacute;s ser&aacute; acreditado 
              ...
              <a href="javascript:GetLedger('E08CCCGLN',document.forms[0].E08DEABNK.value,document.forms[0].E08DEACCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
              ,emitiendo un 
          ...
          <tr id="trdark"> 
            ...
            <td height="46" colspan="4" > Al vencimiento cancelar el Dep&oacute;sito 
              ...
              <a href="javascript:GetLedger('E08DDDGLN',document.forms[0].E08DEABNK.value,document.forms[0].E08DEACCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
              ,emitiendo un 
          ...
          <tr id="trdark"> 
            ...
            <td height="36" colspan="4" >Al vencimiento cancelar el Dep&oacute;sito 
              ...
              <a href="javascript:GetAccount('E08EEEACC',document.forms[0].E08DEABNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a>(Corriente, 
              Ahorro, etc.) . </td>
          </tr>
          <tr id="trclear"> 
            <td width=56></td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="4" > Al vencimiento renovar el Dep&oacute;sito y los 
              ...
              <a href="javascript:GetAccount('E08FFFACC',document.forms[0].E08DEABNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
          ...
          <tr id="trdark"> 
            ...
            <td height="19" colspan="4" >Al vencimiento renovar el Dep&oacute;sito 
              ...
              <a href="javascript:GetAccount('E08GGGACC',document.forms[0].E08DEABNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
              (Corriente, Ahorro, etc.) . </td>
          </tr>
          <tr id="trclear"> 
            <td width=56></td>
