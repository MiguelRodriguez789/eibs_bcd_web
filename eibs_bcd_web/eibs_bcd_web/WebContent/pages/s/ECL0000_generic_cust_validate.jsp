...
<body >
<h3 align="center">Operaciones del Cliente<BR>Validación del Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="generic_cust_validate.jsp, ECL0000"> 
</h3>
<hr size="4">
<% 
