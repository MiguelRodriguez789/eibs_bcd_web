...
%> 
<h3 align="center">Instrucciones Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_inq_special_inst,EDL0160"></h3>
<hr size="4">
...
<br>
        ...
        <div align="center">  
          <input id="EIBSBTN_LARGE" class="txtButton" type=button name="Button" value="Ver Historia de Instrucciones" onClick="javascript:history('2','<%= userPO.getIdentifier().trim()%>')">
        </div>
