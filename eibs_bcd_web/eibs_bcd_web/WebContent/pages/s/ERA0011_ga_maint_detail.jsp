...
<h3 align="center">Mantenimiento de Otras Inscripciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_maint_detail.jsp , ERA0011"></h3> 
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E02RODAMT" size="15" maxlength="15" onKeypress="enterDecimal(event, 2)" value="<%= collList.getRecord(3) %>">
              </div>
            </td>
            <td nowrap > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap >
              <input type="text" name="E02RODUC2" size="6" maxlength="4" onKeyPress="enterDecimal(event, 2)" value="<%= collList.getRecord(11) %>">
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">          
            ...
            <td nowrap > 
			  <eibsinput:date name="collDet" fn_year="E02RODODY" fn_month="E02RODODM" fn_day="E02RODODD" readonly="FALSE" />
            </td>
            <td nowrap> 
        ...
        <% if (!userPO.getType().equals("05")) { %>
          <tr id="trclear"> 
            ...
            <td nowrap >               
              <INPUT type="text" name="E02RODRF2" size="20" maxlength="20" value="<%= collList.getRecord(13).trim()%>" onKeyPress="enterInteger(event)"> 
            </td>
            <td nowrap > 
              <div align="right">Número Constitución :</div>
            </td>
            <td nowrap >               
              <INPUT type="text" name="E02RODNBR" size="20" maxlength="20" value="<%= collList.getRecord(1).trim()%>" onKeyPress="enterInteger(event)"> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
            ...
            <td nowrap >               
              <INPUT type="text" name="E02RODAIN" size="5" maxlength="4" value="<%= collList.getRecord(15).trim()%>" onKeyPress="enterInteger(event)"> 
            </td>
            <td nowrap > 
         ...
         <% if (userPO.getType().equals("03")) { %>
           <tr id="trdark"> 
            ...
            <td nowrap >               
			  <eibsinput:date name="collDet" fn_year="E02RODPDY" fn_month="E02RODPDM" fn_day="E02RODPDD" readonly="FALSE" />
            </td>
            <td nowrap > 
              <div align="right">Fecha Notificación :</div>
            </td>
            <td nowrap >               
			  <eibsinput:date name="collDet" fn_year="E02RODNDY" fn_month="E02RODNDM" fn_day="E02RODNDD" readonly="FALSE" />
            </td>
          </tr>
         <% }%>
   </table>
