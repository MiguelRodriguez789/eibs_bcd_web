...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_dist_recep_list.jsp, ECD0002"></h3>
<hr size="4">
    ...
    <TD NOWRAP valign="top" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE02CDRBRD())%></TD>
		  	<TD NOWRAP ALIGN="CENTER"><%= Util.formatCustomDate(currUser.getE01DTF(), msgPart.getE02CDRMON(), msgPart.getE02CDRDAY(),msgPart.getE02CDRYEA()) %></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE02CDRQTY())%></TD>
		  	<TD NOWRAP ALIGN="CENTER"><%= Util.formatCustomDate(currUser.getE01DTF(), msgPart.getE02CDRMOR(), msgPart.getE02CDRDAR(), msgPart.getE02CDRYER()) %></TD>
