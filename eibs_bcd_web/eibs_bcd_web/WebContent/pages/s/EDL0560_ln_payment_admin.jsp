...
<H3 align="center">Administracion de Fondos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_payment_admin.jsp, EDL0560"> 
</H3>
<hr size="4">
<form method="post" name="firstForm" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0560">
	...
	<INPUT TYPE=HIDDEN NAME="E01DEAOPE" id="E01DEAOPE" VALUE="2">
			...
			<td nowrap> 
				<table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
					...
					<tr id="trdark"> 
						...
						<td nowrap width="30%"> 
							<div align="left"><b> 
								<input type="text" name="E01DEACCY" size="4" maxlength="3" value="<%= lnData.getE01DEACCY().trim()%>" readonly>
								</b> </div>
						</td>
			...
			<td nowrap> 
				<table cellspacing=0 cellpadding=2 width="100%" border="0">
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
						<td width="25%"></td>
						<td width="25%" nowrap><div align="center"><b>Concepto</b></div></td>
						<td width="25%" nowrap><div align="center"><b>A Pagar</b></div></td>
						<td width="25%"></td>
					</tr>
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
						<td></td>
						<td nowrap><div align="right">CAPITAL :</div></td>
						<td align="left" nowrap>
							<input type="text" class="txtright" name="E01TRNPRI" size="16" maxlength="16" value="<%= lnData.getE01TRNPRI().trim()%>" onkeypress="enterDecimal(event, 2)" onchange="calculateConcepto(this);" onKeypress="enterDecimal(event, 2)" readonly >
						</td>
						<td></td>
					</tr>
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
						<td></td>
						<td nowrap ><div align="right">HONORARIOS :</div></td>
						<td align="left" nowrap> 
							<input type="text" class="txtright" name="E01TRNCOM" size="16" maxlength="16" value="<%= lnData.getE01TRNCOM().trim()%>" onkeypress="enterDecimal(event, 2)" onchange="calculateConcepto(this);" onKeypress="enterDecimal(event, 2)" readonly >
						</td>
						<td></td>
					</tr>
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
						<td></td>
						<td nowrap ><div align="right">IVA :</div></td>
						<td align="left" nowrap> 
							<input type="text" class="txtright" name="E01TRNIVA" size="16" maxlength="16" value="<%= lnData.getE01TRNIVA().trim()%>" onkeypress="enterDecimal(event, 2)" onchange="calculateConcepto(this);" onKeypress="enterDecimal(event, 2)" readonly >
						</td>
						<td></td>
					</tr>
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
						<td></td>
						<td nowrap><div align="right">CUENTA POR PAGAR :</div></td>
						<td align="left" nowrap> 
