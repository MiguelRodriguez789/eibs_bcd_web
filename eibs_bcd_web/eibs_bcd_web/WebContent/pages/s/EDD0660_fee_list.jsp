...
<BODY>
<h3 align="center">Estructura de Cargos de Pagos y Recibos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fee_list.jsp, EDD0660"></h3>
<hr size="4">
	  ...
	  <tr id="trclear"> 
        ...
        <td align=CENTER width="34%"> 
          <div align="left"> 
			...
			<A href="javascript:GetCustomer('CUN1')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0" ></A>
          </div>
        </td>
      </tr>
       <tr id="trdark"> 
