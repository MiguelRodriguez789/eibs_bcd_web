...
<body >
<h3 align="center">Activación de Productos y Servicios<BR>Validación del Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="activation_cust_validate.jsp, ECL0000"> 
</h3>
<hr size="4">
<% 
