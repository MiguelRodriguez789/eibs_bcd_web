  ...
  <table id="tbhelp" align="center" width="556" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td align="center">Por favor seleccione el tipo de producto:&nbsp; 
        ...
        <a href="javascript:GetCodeDescCNOFC('srhProduct','srhProduct1','04')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" width="18" height="22"></a>&nbsp;&nbsp;<img src="<%=request.getContextPath()%>/images/search1.gif" onClick="enter()" width="25" height="21"></td>
    </tr>
  </table>
