...
<H3 ALIGN="center">Pago/Negociaci&oacute;n de Cartas de Cr&eacute;dito<IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left"
	NAME="EIBS_GIF" title="ELC0560_lc_negotiation_enter.jsp"></H3>
<HR SIZE="4">
			...
			<TABLE CLASS="tbenter" ALIGN="center">
				<TBODY>
					<TR>
						...
						<A HREF="javascript:GetAccount('E01LCRNUM','','40','')"> <IMG SRC="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" BORDER="0"></A></DIV>
						</TD>
					</TR>
					<TR>
						<TD>
