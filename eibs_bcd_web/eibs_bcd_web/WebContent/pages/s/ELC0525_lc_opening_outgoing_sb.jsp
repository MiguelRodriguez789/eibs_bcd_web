...
<BODY>
<H3 align="center"><%= (userPO.getPurpose().equals("NEW") ? "Apertura" : "Mantenimiento") %> de Carta de Crédito
Standby Emitida <IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="ELC0525_lc_opening_outgoing_sb.jsp"></H3>
<HR size="4">
...
<INPUT NAME="E01LCMATY" TYPE=HIDDEN VALUE="<%=msg040001.getE01LCMATY().trim()%>" readonly="readonly">
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo" id="trclear">
  <TR id="trdark">
    <TD align="right" width="194"><STRONG>Banco : </STRONG></TD>
    <TD width="125"><INPUT type="text" name="E01LCMBNK" readonly size="4" maxlength="2" value="<%=msg040001.getE01LCMBNK().trim()%>"></TD>
    <TD width="16%" align="right" nowrap><STRONG>N&uacute;mero de Carta de Cr&eacute;dito : </STRONG></TD>
    <TD><%if (msg040001.getE01LCMACC().trim().equals("999999999999"))
				{%>
        <INPUT type="text" size="12" maxlength="12" value="Nueva" readonly>
  ...
  <TR>
    <TD align="right" width="194"><STRONG>Nuestra Referencia : </STRONG></TD>
    <TD width="125"><INPUT name="E01LCMORF" type="text" value="<%=msg040001.getE01LCMORF().trim()%>" size="20" maxlength="16" readonly="readonly"></TD>
  ...
  <TR id="trdark">
    <TD align="right" width="194"><STRONG>Referencia del Otro Banco : </STRONG></TD>
    <TD width="125"><B>
      <INPUT name="E01LCMTRF" type="text" value="<%=msg040001.getE01LCMTRF().trim()%>" size="20" maxlength="16" readonly="readonly">
    </B></TD>
    <TD width="16%" align="right" nowrap><STRONG>Descripci&oacute;n del Producto : </STRONG></TD>
    <TD><B>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap width="541"><SELECT name="E01LCMAF2" disabled>
        ...
        <INPUT name="E01LCMAPA" type="text" value="<%=msg040001.getE01LCMAPA()%>" size="12"
  ...
  <TR id="">
    ...
    <TD align="left" width="541"><INPUT name="E01LCMAP1" type="text" value="<%=msg040001.getE01LCMAP1()%>" size="45"
					maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD align="right" width="358">Dirección: </TD>
    <TD align="left" width="541"><INPUT name="E01LCMAP2" type="text" value="<%=msg040001.getE01LCMAP2()%>" size="45"
					maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD width="358"></TD>
    <TD align="left" width="541"><INPUT name="E01LCMAP3" type="text" value="<%=msg040001.getE01LCMAP3()%>" size="45"
					maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD width="358"></TD>
    <TD align="left" width="541"><INPUT name="E01LCMAP4" type="text" value="<%=msg040001.getE01LCMAP4()%>" size="45"
					maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD align="right" width="358">Estado: </TD>
    <TD align="left" width="541"><INPUT name="E01LCMAP5" type="text"
							value="<%=msg040001.getE01LCMAP5()%>" size="4" maxlength="4" readonly="readonly">
      Código Postal
      <INPUT
							name="E01LCMAP6" type="text"
							value="<%=msg040001.getE01LCMAP6()%>" size="16" maxlength="15" readonly="readonly">
      País
      <INPUT
							name="E01LCMAP7" type="text"
							value="<%=msg040001.getE01LCMAP7()%>" size="4" maxlength="4" readonly="readonly">
       </TD>
  </TR>
</TABLE>
<BR>
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF3" disabled>
        ...
        <INPUT name="E01LCMBAC" type="text" value="<%=msg040001.getE01LCMBAC()%>" size="12" maxlength="12" readonly="readonly">
         </TD>
  </TR>
  <TR id="">
  ...
  <TR id="">
    ...
    <TD align="left"><INPUT name="E01LCMBN5" type="text"
							value="<%=msg040001.getE01LCMBN5()%>" size="4" maxlength="4" readonly="readonly">
      Código Postal
      <INPUT
							name="E01LCMBN6" type="text"
							value="<%=msg040001.getE01LCMBN6()%>" size="16" maxlength="15" readonly="readonly">
      País
      <INPUT
...
<TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF4" disabled>
        <OPTION value=""></OPTION>
        <OPTION value="C" <%if (msg040001.getE01LCMAF4().equals("C")) out.print("selected");%>>Cliente</OPTION>
        <OPTION value="A" <%if (msg040001.getE01LCMAF4().equals("A")) out.print("selected");%>>Cuenta</OPTION>
      </SELECT>
        <INPUT name="E01LCMABA" type="text" value="<%=msg040001.getE01LCMABA()%>" size="12" maxlength="12" readonly="readonly">
         </TD>
  </TR>
  <TR id="">
    <TD width="35%" align="right" nowrap>Codigo Swift: </TD>
    <TD align="left" nowrap><INPUT name="E01LCMABI" type="text" value="<%=msg040001.getE01LCMABI()%>" size="12" maxlength="12" readonly="readonly">
       </TD>
  </TR>
  <TR id="">
    <TD align="right" nowrap>Nombre: </TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB1" type="text" value="<%=msg040001.getE01LCMAB1()%>" size="45" maxlength="35" readonly="readonly">
        <IMG src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" border="0"></TD>
  </TR>
  <TR id="">
    <TD align="right" nowrap>Dirección: </TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB2" type="text" value="<%=msg040001.getE01LCMAB2()%>" size="45" maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD nowrap></TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB3" type="text" value="<%=msg040001.getE01LCMAB3()%>" size="45" maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD nowrap></TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB4" type="text" value="<%=msg040001.getE01LCMAB4()%>" size="45" maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD align="right" valign="bottom" nowrap>Estado: </TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB5" type="text" value="<%=msg040001.getE01LCMAB5()%>" size="4" maxlength="4" readonly="readonly">
      Código Postal
      <INPUT name="E01LCMAB6" type="text" value="<%=msg040001.getE01LCMAB6()%>" size="16" maxlength="15" readonly="readonly">
      País
      <INPUT name="E01LCMAB7" type="text" value="<%=msg040001.getE01LCMAB7()%>" size="4" maxlength="4" readonly="readonly">
      </TD>
  </TR>
  <TR id="">
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT name="E01LCMCBC" type="text" value="<%=msg040001.getE01LCMCBC()%>" size="12" maxlength="12" readonly="readonly">
      </TD>
  </TR>
  <TR id="">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT name="E01LCMCA5" type="text" value="<%=msg040001.getE01LCMCA5()%>" size="4" maxlength="4" readonly="readonly">
      Código Postal
      <INPUT name="E01LCMCA6" type="text" value="<%=msg040001.getE01LCMCA6()%>" size="16" maxlength="15" readonly="readonly">
      País
      <INPUT name="E01LCMCA7" type="text" value="<%=msg040001.getE01LCMCA7()%>" size="4" maxlength="4" readonly="readonly">
      </TD>
  </TR>
</TABLE>
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD  align="left" nowrap><INPUT name="E01LCMRBA" type="text" value="<%=msg040001.getE01LCMRBA()%>" size="12" maxlength="12" readonly="readonly">
          </TD>
  </TR>
  <TR id="">
  ...
  <TR id="">
    <TD align="right" valign="bottom">Estado: </TD>
    <TD align="left" valign="bottom" nowrap><INPUT name="E01LCMRB5" type="text" value="<%=msg040001.getE01LCMRB5()%>" size="4" maxlength="4" readonly="readonly">
      Código Postal
      <INPUT name="E01LCMRB6" type="text" value="<%=msg040001.getE01LCMRB6()%>" size="16" maxlength="15" readonly="readonly">
      País
