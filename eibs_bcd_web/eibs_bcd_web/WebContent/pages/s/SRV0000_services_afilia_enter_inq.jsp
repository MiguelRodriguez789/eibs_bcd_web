...
<H3 align="center">Mantenimiento de Afiliaciones - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_afilia_enter_inq,SRV0000"></H3>
<hr size="4">
<p>&nbsp;</p>
     	...
     	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetAccount('E01AFIACC','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>
      	  </td>     
      	</tr>
     </table>
    </td>
