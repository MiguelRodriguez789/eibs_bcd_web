      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="35%" align="left">
            	<INPUT type="checkbox" name="E01C" value="Y" <% if (ESD0094Record.getE01CCC().substring(0,1).equals("Y")) out.print("checked"); %> <%=disabled%>>Correo Electrónico
                <INPUT type="checkbox" name="E01P" value="Y" <% if (ESD0094Record.getE01CCC().substring(1,2).equals("Y")) out.print("checked"); %> <%=disabled%>>Teléfono
         	</td>
         </tr>  
         <tr id="trclear"> 
