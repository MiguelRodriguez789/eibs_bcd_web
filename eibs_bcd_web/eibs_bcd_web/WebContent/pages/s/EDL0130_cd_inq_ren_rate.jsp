...
<h3 align="center">Tabla de Tasas de Certificados de Dep&oacute;sito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_inq_ren_rate, EDL0130"></h3>
<hr size="4">
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td width="25%"> 
            	<eibsinput:date name="cdRenRat" fn_month="E02CDRDTM" fn_day="E02CDRDTD" fn_year="E02CDRDTY" readonly="true" />
            </td>
            <td width="25%"> 
