...
<BODY>
<h3 align="center">M&uacute;ltiples Ordenes de Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_list_purchase.jsp, EIE0130"></h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="17%" > 
              <div align="right">Fecha de la Operaci&oacute;n :</div>
            </td>
            <td nowrap width="36%" > 
        ...
        <table id="headTable" width="100%" >
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap > 
              <div align="center">N&uacute;mero <br>de Orden</div>
            </th>
            <th align=CENTER nowrap > 
            ...
            <th align=CENTER nowrap >Monto <br>de Inversi&oacute;n </th>
          </tr>
        </table>
