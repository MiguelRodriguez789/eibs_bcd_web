...
<h3 align="center">Usuario Personal Internet<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_inq_corporate_new_data, ESS2000" ></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/com.datapro.eibs.internet.JSESS2000" onsubmit="return FieldNotBlank(this)">
  ...
  <INPUT TYPE=HIDDEN id="E01EUSOPR" NAME="E01EUSOPR" VALUE="0">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          ...
          <tr id="teclear"> 
            ...
            <SELECT disabled id="E01EUSOPR" NAME="E01EUSOPR">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%" ><div align="left"> 
            	<input type="text" ID="MANDATORY" name="E01EUSACC" size="10" maxlength="9" value="<%= cusdata.getE01EUSACC().trim()%>" onkeypress="enterInteger(event)">
                                    <a href="javascript:GetAccount('E01EUSACC','','','')"><img src="/WebContent/images/1b.gif" title=". . ." align="bottom" border="0" ></a>
                                    <img src="/WebContent/images/Check.gif" title="mandatory field" align="bottom" border="0"  ></div></td> 
          </tr>
          <tr id="teclear"> 
            <td nowrap width="40%" ><div align="right">Tipo Acumulación :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            <SELECT disabled id="E01EUSMXT" NAME="E01EUSMXT">
          ...
          <tr id="teclear"> 
            ...
            <td nowrap width="60%" ><div align="left">
            <SELECT disabled id="E01EUSBPA" NAME="E01EUSBPA">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%" ><div align="left">
            <SELECT disabled id="E01EUSLCA" NAME="E01EUSLCA">
           ...
           <tr id="teclear"> 
            ...
            <td nowrap width="60%" ><div align="left">
            <SELECT disabled id="E01EUSLNA" NAME="E01EUSLNA">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSMAX" name="E01EUSMAX" size="15" maxlength="13" value="<%= cusdata.getE01EUSMAX().trim()%>"></div></td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="40%" ><div align="right">Monto Máximo Acumulado :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSAMX" name="E01EUSAMX" size="15" maxlength="13" value="<%= cusdata.getE01EUSAMX().trim()%>"></div></td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="teclear"> 
            ...
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" ID="MANDATORY" name="E01EUSIAD" size="35" maxlength="45" value="<%= cusdata.getE01EUSIAD().trim()%>">
                                    </div></td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="teclear"> 
            ...
            <td nowrap width="60%" ><div align="left">
            <SELECT disabled id="E01EUSIEF" NAME="E01EUSIEF">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="" name="E01EUSA01" size="10" maxlength="9" value="<%= cusdata.getE01EUSA01().trim()%>"></div></td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="40%" ><div align="right">Cuenta Acceso #2 :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSA02" name="E01EUSA02" size="10" maxlength="9" value="<%= cusdata.getE01EUSA02().trim()%>"></div></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="40%" ><div align="right">Cuenta Acceso #3 :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSA03" name="E01EUSA03" size="10" maxlength="9" value="<%= cusdata.getE01EUSA03().trim()%>"></div></td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="40%" ><div align="right">Cuenta Acceso #4 :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSA04" name="E01EUSA04" size="10" maxlength="9" value="<%= cusdata.getE01EUSA04().trim()%>"></div></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="40%" ><div align="right">Cuenta Acceso #5 :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSA05" name="E01EUSA05" size="10" maxlength="9" value="<%= cusdata.getE01EUSA05().trim()%>"></div></td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="40%" ><div align="right">Cuenta Acceso #6 :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSA06" name="E01EUSA06" size="10" maxlength="9" value="<%= cusdata.getE01EUSA06().trim()%>"></div></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="40%" ><div align="right">Cuenta Acceso #7 :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSA07" name="E01EUSA07" size="10" maxlength="9" value="<%= cusdata.getE01EUSA07().trim()%>"></div></td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="40%" ><div align="right">Cuenta Acceso #8 :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSA08" name="E01EUSA08" size="10" maxlength="9" value="<%= cusdata.getE01EUSA08().trim()%>"></div></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="40%" ><div align="right">Cuenta Acceso #9 :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSA09" name="E01EUSA09" size="10" maxlength="9" value="<%= cusdata.getE01EUSA09().trim()%>"></div></td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="40%" ><div align="right">Cuenta Acceso #10 :</div></td>
            <td nowrap width="60%" ><div align="left"> 
            	<input readonly type="text" id="E01EUSA10" name="E01EUSA10" size="10" maxlength="9" value="<%= cusdata.getE01EUSA10().trim()%>"></div></td>
          </tr>
        </table>
        </td>
      </tr>
