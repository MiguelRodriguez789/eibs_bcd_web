...
function showDetailInquiry(idxRow) {
	...
	var winH = 400;
	if (getElement("TYPEDOC"+idxRow).value == "4") winH=480;
	page= "${pageContext.request.contextPath}/pages/s/EDL0825_pay_inq_det.jsp?CurrRow="+ idxRow;
	
	CenterWindow(page,800,winH,1);
...
<h3 align="center">Consulta 
  ...
  <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pay_inq_ln_list.jsp,EDL0825"></h3>
<hr size="4">
    ...
    <tr>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
            ...
            <TR >
                ...
                <TD nowrap><%= Util.formatCustomDate(currUser.getE01DTF(), docHeader.getE02DEAODM(), docHeader.getE02DEAODD(), docHeader.getE02DEAODY()) %></TD>
            </TR>
            <tr>
                <td nowrap>
                ...
                <td nowrap><%= Util.formatCustomDate(currUser.getE01DTF(), docHeader.getE02DEAMDM(), docHeader.getE02DEAMDD(), docHeader.getE02DEAMDY())%></td>
            </tr>
            <tr >
                <td nowrap>
            ...
            <tr>
                ...
                <td nowrap><%= docHeader.getE02DEAOFB().trim()%>-<%= docHeader.getE02DEAOCR().trim()%>-<%= docHeader.getE02DEAOCY().trim()%>-<%= docHeader.getE02DEAOGL().trim()%></td>
                <td nowrap>
    ...
    <TR>
        ...
        <TABLE id="headTable">
            <TR id="trdark">
                ...
                <TH ALIGN=CENTER NOWRAP width="35%">Deudor</TH>
                <TH ALIGN=CENTER NOWRAP width="15%">Valor Doc.</TH>
                <TH ALIGN=CENTER NOWRAP width="15%">Vence</TH>
                <TH ALIGN=CENTER NOWRAP width="15%">Cargo x Mora</TH>
        ...
        <table id="dataTable" width="100%">
            ...
            <TR>
                ...
                <div ><a href="javascript:showDetailInquiry(<%= docList.getCurrentRow() %>)"><%= docList.getRecord(0) %></a></DIV>
                <INPUT TYPE=HIDDEN NAME="TYPEDOC<%= docList.getCurrentRow() %>" VALUE="<%= docList.getRecord(6) %>">  
                </TD>
                <TD ALIGN=LEFT NOWRAP width="35%">
                <div ><a href="javascript:showDetailInquiry(<%= docList.getCurrentRow() %>)"><%= docList.getRecord(2) %></a></DIV>
                </TD>
                <TD ALIGN=RIGHT NOWRAP width="15%">
                <div ><a href="javascript:showDetailInquiry(<%= docList.getCurrentRow() %>)"><%= docList.getRecord(3) %></a></DIV>
                </TD>
                <TD ALIGN=CENTER NOWRAP width="15%">
                <div ><a href="javascript:showDetailInquiry(<%= docList.getCurrentRow() %>)"><%= docList.getRecord(4) %></a></DIV>
                </TD>
                <TD ALIGN=RIGHT NOWRAP width="15%">
                <div ><a href="javascript:showDetailInquiry(<%= docList.getCurrentRow() %>)"><%= docList.getRecord(5) %></a></DIV>
                </TD>
                <TD ALIGN=CENTER NOWRAP width="15%">
                <div ><a href="javascript:showDetailInquiry(<%= docList.getCurrentRow() %>)"> <% if (docList.getRecord(8).equals("A")) out.print("Activo");
