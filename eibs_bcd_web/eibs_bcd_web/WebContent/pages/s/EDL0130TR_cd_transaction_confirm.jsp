...
<body>
<h3 align="center">Transacciones - Confirmación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_transaction_confirm.jsp, EDL0130TR" ></h3>
<hr size="4">
