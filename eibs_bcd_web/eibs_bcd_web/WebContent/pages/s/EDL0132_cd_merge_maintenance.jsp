...
function goDelete() {
	isCheck();
	if ( !ok ) {
		alert("Favor seleccione "+<%=labeltxt%>+" a sacar de la fusión!!!");
		return;	 
	}
	document.forms[0].SCREEN.value="14";
	if (!confirm("Desea sacar este "+<%=labeltxt%>+" de la Fusión?")) {
		return;
	}
	document.forms[0].submit();
} 
...
<h3 align="center">Consolidación al <%=labeltxt %> Número <%= userPO.getIdentifier().trim() %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
...
<TABLE class="tableinfo" id="dataTable">
	...
	<TR id=trclear>
		<TD align="right" width="25%"><b>Estado de la Fusión : </b></TD>
...
%>
	<TR>
		<TD align="CENTER" class="TDBKG" width="17%">
			<a href="javascript:goNew()"><b>Adicionar<br>a Consolidación</b><br></a>
		...
		<TD align="CENTER" class="TDBKG" width="17%">
			<a href="javascript:goDelete()"><b>Eliminar de<br>la Consolidación</b></a>
		</TD>
		<TD align="CENTER" class="TDBKG" width="17%">
