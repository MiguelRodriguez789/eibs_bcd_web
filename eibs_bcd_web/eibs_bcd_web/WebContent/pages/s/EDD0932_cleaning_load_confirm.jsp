...
<h3 align="center">Carga de Camara Saliente
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cleaning_load_confirm, EDD0932"></h3> 
<hr size="4">
 <form method="post">
