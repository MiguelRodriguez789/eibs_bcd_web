...
<jsp:useBean id= "ESD0007List" class= "datapro.eibs.beans.JBObjList"  scope="session" />
...
function goInquiry() {
    ...
    %>   	
	pg = "<%=request.getContextPath()%>/servlet/datapro.eibs.security.JSESD0007?SCREEN=<%=scr%>" + 
	        "&E01BTHKEY=" + bthkey;
...
<h3 align="center">
	...
	%>  
    <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="user_list.jsp, ESD0007">
</h3>
...
<%	if (!ESD0007List.getNoResult() ) { %>    
  <TABLE class="tableinfo" id="dataTable" width="100%">
    <TR id=trdark> 
		...
		<TD nowrap align="center" width="5%"><B>Usuario</B></TD>
		...
		<TD nowrap align="center" width="5%"><B>Telefono</B></TD>
		<TD nowrap align="center" width="5%"><B>Ext.</B></TD>
 	...
 	<TR id=trdark> 
        ...
        <%
    	  int i = 0;
          ESD0007List.initRow();    
          while (ESD0007List.getNextRow()) {
            ESD000701Message msgList = (ESD000701Message) ESD0007List.getRecord();	 
         %>   
    ...
    <TR id=trclear>
		...
		<td NOWRAP align="left"   width="5%"  ><%= msgList.getE01BTHGRP()%></td>
		<td NOWRAP align="center" width="5%"  ><%= msgList.getE01BTHUBK()%></td>
		<td NOWRAP align="center" width="5%"  ><%= msgList.getE01BTHUBR()%></td>
		<td NOWRAP align="center" width="5%"  ><%= msgList.getE01BTHPHN()%></td>
		<td NOWRAP align="center" width="5%"  ><%= msgList.getE01BTHPXT()%></td>
  ...
  <TABLE  class="tbenter" WIDTH="100%" ALIGN=CENTER>
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25">
       <%
    	...
    	if ( ESD0007List.getShowPrev() ) {
  			int pos = ESD0007List.getFirstRec() - 21;
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.security.JSESD0007?SCREEN="+screen+"&FromRecord=" + pos 
 	  ...
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> 
 	  	<%       
    	if (ESD0007List.getShowNext()) {
  			int pos = ESD0007List.getLastRec();
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.security.JSESD0007?SCREEN="+screen+"&FromRecord=" + pos 
  			+ "&SEARCHCDE=" + userPO.getHeader1() + 
...
<SCRIPT Language="javascript">
	...
	document.forms[0].NEXTROWS.value = <%= ESD0007List.getLastRec()%>;
	document.forms[0].CURRROWS.value = <%= ESD0007List.getFirstRec()%>;
</SCRIPT>
<%} %>   
		</TD>
	</TR>
