...
%>
  <h3 align="center">Lista de Mensajes Swift<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_list_doc.jsp,ELC0455"> 
  </h3>
  <hr size="4">
  ...
  <TABLE class="tableinfo">
    <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER nowrap width="10%">Tipo de Mensaje</TH>
      <TH ALIGN=CENTER nowrap width="80%">Descripci&oacute;n</TH>
    </TR>
    <%
                cifList.initRow();
