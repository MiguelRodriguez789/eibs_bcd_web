...
<H3 align="center">Sistema de Bastanteo - Consulta de Autorizaciones Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_autoriz_inq,ECU0000"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	...
    	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E06CUARD1" size="3" maxlength="2" readonly value="<%= msgMT.getE06CUARD1() %>">
	      	<input type="text" name="E06CUARD2" size="3" maxlength="2" readonly value="<%= msgMT.getE06CUARD2() %>">
	      	<input type="text" name="E06CUARD3" size="5" maxlength="4" readonly value="<%= msgMT.getE06CUARD3() %>">
      	  </td>     
      	</tr>
     	<tr id=trdark> 
		  <td nowrap> 
    	...
    	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E06CUAAD1" readonly size="3" maxlength="2" value="<%= msgMT.getE06CUAAD1() %>">
	      	<input type="text" name="E06CUAAD2" readonly size="3" maxlength="2" value="<%= msgMT.getE06CUAAD2() %>">
	      	<input type="text" name="E06CUAAD3" readonly size="5" maxlength="4" value="<%= msgMT.getE06CUAAD3() %>">
	      </td>     
      	</tr>
      	<tr id="trclear"> 
          <td> 
     	...
     	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E06CUAMA1" size="3" maxlength="2" readonly value="<%= msgMT.getE06CUAMA1() %>">
	      	<input type="text" name="E06CUAMA2" size="3" maxlength="2" readonly value="<%= msgMT.getE06CUAMA2() %>">
	      	<input type="text" name="E06CUAMA3" size="5" maxlength="4" readonly value="<%= msgMT.getE06CUAMA3() %>">
      	  </td>     
      	</tr>
     </table>
    </td>
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E06CUAOBS" size="90" readonly maxlength="80" value="<%= msgMT.getE06CUAOBS().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%">
