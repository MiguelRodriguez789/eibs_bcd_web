...
<head>
<title>Customer Bills and Accounts Payable Vendors Maintenance</title>
...
<h3 align="center">Mantenimiento Pagos y Recibos de Clientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="vendor_basic, EBA0010" ></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
            ...
            <td nowrap > 
              <div align="right">Clasificacion :</div>
				...
				<td nowrap >
					...
					<a href="javascript:GetCodeCNOFC('E01BAVCLS','BB')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a> 
				</td>            
          </tr>
          <% if (!vendor.getH01FLGWK1().equals("7")) { %>
	          <tr id="trdark"> 
	            <td nowrap > 
	              <div align="right">Estado :</div>
					...
					<td nowrap >
						...
						<a href="javascript:GetCodeCNOFC('E01BAVSTE','27')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a> 
					</td>
	             <td nowrap > 
          ...
          <% if (!vendor.getH01FLGWK1().equals("7")) { %>
	            ...
	            <td nowrap> 
	              ...
	              <a href="javascript:GetBanksAba('E01BAVABA','','D')"><img id="Ayuda" src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
	            </td>
		  <% } else { %>
            	<td nowrap></td> 
            	<td nowrap></td> 
		  <% } %>
           ...
           <tr id="trdark"> 
            ...
            <td nowrap  > 
              <input type="text" name="E01BAVRMK" size="52" maxlength="50" value="<%= vendor.getE01BAVRMK().trim()%>" >
            </td>
           <td nowrap> 
