...
%>
<div align="center"> 
  <h3> Aprobación de Esquema de Pagos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_quote_basic.jsp,EIE0060"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="33%" > 
              ...
              <% if(invTrade.getE01SCHTYP().equals("I")) out.print("Interes");
              				else if(invTrade.getE01SCHTYP().equals("D")) out.print("Dividendos");
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" > 
              ...
              <input type="text" readonly  name="E01SCHDE3" size="5" maxlength="4" value="<%= invTrade.getE01SCHDE3()%>">
            </td>
            <td nowrap width="14%" > 
            ...
            <td nowrap width="33%" > 
              ...
              <input type="text" readonly  name="E01SCHRE3" size="5" maxlength="4" value="<%= invTrade.getE01SCHRE3()%>" >
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap width="36%" > 
              ...
              <input type="text" readonly  name="E01SCHPA3" size="5" maxlength="4" value="<%= invTrade.getE01SCHPA3()%>" >
            </td>
            <td nowrap width="14%" > 
            ...
            <td nowrap width="33%" > 
              ...
              <input type="text" readonly  name="E01SCHDL3" size="5" maxlength="4" value="<%= invTrade.getE01SCHDL3()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="right">Cantidad de Pagos :</div>
            </td>
            <td nowrap > 
