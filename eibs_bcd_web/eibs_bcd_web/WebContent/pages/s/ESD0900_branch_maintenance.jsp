...
<H3 align="center">Cambio de Productos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="branch_maintenance.jsp, ESD0900"></H3>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="55%"> 
             ...
             <INPUT type="text" name="E01CHGBNK" maxlength="3" size="2"
					onkeypress="enterInteger(event)"
					value="<%= brnDetails.getE01CHGBNK().trim()%>" ;
          ...
          <tr id="trclear"> 
            ...
            <td nowrap height="23" colspan="1" width="372"> 
				...
				<INPUT type="text" name="E01CHGACC" size="17" maxlength="16"
					value="<%= brnDetails.getE01CHGACC().trim()%>";
					<% if(userPO.getHeader16().equals("2")){out.print("readonly");} %> >
				<A
          ...
          <tr id="trclear"> 
            ...
            <INPUT type="hidden" name="E01CHGAPL" maxlength="2" size="2"
					value="<%= brnDetails.getE01CHGACD().trim()%>" readonly>
			</td>
          </tr>
 		 <tr id="trdark"> 
          ...
          <script type="text/javascript">
  		  ...
  		  <% if(userPO.getHeader16().equals("1")){out.print("document.forms[0].E01CHGBNK.focus()");} %>
   		  <% if(userPO.getHeader16().equals("1")){out.print("document.forms[0].E01CHGBNK.select()");} %>
  		  <% if(userPO.getHeader16().equals("2")){out.print("document.forms[0].E01CHGPRC.focus()");} %>
   		  <% if(userPO.getHeader16().equals("2")){out.print("document.forms[0].E01CHGPRC.select()");} %>
