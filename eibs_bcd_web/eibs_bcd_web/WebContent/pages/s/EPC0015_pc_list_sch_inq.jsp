...
function goAction(op) {
 ...
 if (op == 1) {
     ...
     page = '${pageContext.request.contextPath}/pages/s/EPC0015_pc_maint_sch_inq.jsp?ROW=' + document.forms[0].ROW.value;
 } else if (op == 4) {     
...
<h3 align="center">Inspectores Asociados a Proyecto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_list_sch_inq.jsp,EPC0015"> 
</h3>
<hr size="4">
 ...
 <TR> 
   <TD NOWRAP valign="top" width="100%">
    ...
    <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER nowrap>Inspector</TH>
      <TH ALIGN=CENTER nowrap> </TH>
    </TR>
    </TABLE>
    ...
    <%
     ...
     %> 
            <TR> 
              ...
              <TD ALIGN=LEFT NOWRAP><%= Util.formatCell(msgPCB.getE01PCPNM1()) %></TD>
              <TD ALIGN=LEFT NOWRAP><%= Util.formatCell(msgPCB.getE01PCPNM2()) %></TD>
             </TR>
      <%              
         }        
    %>
