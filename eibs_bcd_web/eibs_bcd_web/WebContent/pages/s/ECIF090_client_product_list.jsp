...
function GetProdDet(officer,name,product,descri,clase) {
	...
	page = "${pageContext.request.contextPath}/servlet/datapro.eibs.client.JSECIF100?SCREEN=1" + param;
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_product_list.jsp,ECIF090">
</h3>
<hr size="4">
