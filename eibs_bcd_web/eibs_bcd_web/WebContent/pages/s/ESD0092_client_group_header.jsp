...
<html>
<head>
<title>Grupos Economicos Header</title>
...
Consulta
<% } %>
 de Cabeza de Relaciones de Clientes
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_group_header.jsp, ESD0092"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap align="left" width="35%">
            	<INPUT type="text" name="E01GEMMST" maxlength="9" size="10" readonly value="<%= ESD0092Record.getE01GEMMST().trim()%>">
			</td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap align="left" width="35%">
				...
				<% if (userPO.getPurpose().equals("NEW"))  { %>
					<A href="javascript:GetCustomerDescId('E01GEMCUN','E01GEMNA1','')">
					<IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0">
					</A>
				<% } %>
            	<INPUT type="text" name="E01GEMNA1" maxlength="45" size="46" <%= read %> value="<%= ESD0092Record.getE01GEMNA1().trim()%>">
            	<%=mandatory %>
			</td>
            <td nowrap width="15%" align="right">Tipo de Relación : </td>
            <td nowrap width="35%" align="left"> 
              	<eibsinput:cnofc name="ESD0092Record" property="E01GEMGRP" required="true" flag="GE" fn_code="E01GEMGRP" fn_description="D01GRP" readonly="<%=readOnly%>"/>
				<input TYPE="text" NAME="D01GRP" value="<%=ESD0092Record.getD01GRP().trim()%>" size="45" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="15%" align="right">Fecha de Relación : </td>
			<td nowrap width="35%" align="left">
                <eibsinput:date name="ESD0092Record" required="true" fn_year="E01GEMRLY" fn_month="E01GEMRLM" fn_day="E01GEMRLD" readonly="true"/>
            </td>
          </tr>
        </table> 
      </td>  
