...
function goAction(op) {
	if (op == "DCSUSP") { // Debit Card Suspension
		page = "${pageContext.request.contextPath}/servlet/datapro.eibs.misc.JSECL0000?SCREEN=800&option=190";
	}
	else if (op == "CHBSUS") { // Checkbooks Suspension
		page = "${pageContext.request.contextPath}/servlet/datapro.eibs.misc.JSECL0000?SCREEN=800&option=202";
	}
...
<body >
<h3 align="center">Suspensión de Productos y Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="suspension_cust_operations.jsp, ECL0000"> 
</h3>
<hr size="4">
<% 
			...
			<TR valign="bottom">
				<TD width="50%">
					<DIV id="btnOption1" align="left">
						...
						<A href="javascript:goAction('DCSUSP')"><B>Suspensión de Tarjeta de Débito</B></A>
					</DIV>
				</TD>
			</TR>
			<TR>
				<TD width="50%">
					<DIV id="btnOption1" align="left">
						<IMG border="0" src="<%=request.getContextPath()%>/images/ico1.gif" width="16" height="16" align="middle">
						<A href="javascript:goAction('CHBSUS')"><B>Suspensión de Cheques y Chequeras</B></A>
					</DIV>
				</TD>
			</TR>
		</TBODY>
