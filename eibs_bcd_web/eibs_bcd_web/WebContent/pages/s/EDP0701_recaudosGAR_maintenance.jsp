						...
						<TBODY>
							<tr id="trdark">
								...
								<td nowrap align="left" width="70%">
									<INPUT type="text" name="E01DPWBNK" onkeypress="enterInteger(event)" size="3" maxlength="2" value="<%= msg0701.getE01DPWBNK().trim()%>" <% if(userPO.getHeader18().equals("1")){out.print("readonly");} %>>
								</td>
							</tr>
						</TBODY>
					</TABLE>
						...
						<TBODY>
							<tr id="trdark">
								...
								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>
									...
									<option value="2" 
									   <%if (msg0701.getE01DPWUDO().equals("2")) { out.print("selected"); }%>>Personas Físicas</option>	
									<option value="3"
