...
%> 
<h3 align="center">Clientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pr_maint.jsp,EPR0000"></h3>
<hr size="4">
                      ...
                      <div id="dataTab0"> 
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr id="trdark"> 
                              ...
                              <td nowrap> 
                                <div align="left"> 
                                  <eibsinput:date name="customer" fn_month="E01PVMBDM" fn_day="E01PVMBDD" fn_year="E01PVMBDY" />
                                </div>
                              </td>
                            </tr>
                            <tr id="trclear"> 
                            ...
                            <tr id="trclear">
                              ...
                              <td nowrap  width="31%">
                                <div align="left">
								  <eibsinput:text name="customer" property="E01PVMHPN" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_PHONE %>" />
                                </div>
                              </td>
                              <td nowrap width="21%" >
                              ...
                              <td nowrap width="23%" >
                                <div align="left">
								  <eibsinput:text name="customer" property="E01PVMPHN" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_PHONE %>" />
                                </div>
                              </td>
                            </tr>
                            <tr id="trdark"> 
            	...
            	<div id="dataTab3" style="display: none"> 
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap > 
                                      <eibsinput:date name="customer" fn_month="E01PVMSWM" fn_day="E01PVMSWD" fn_year="E01PVMSWY" />
                                    </td>
                                  </tr>
                                  <tr id="trclear"> 
                                    <td nowrap > 
                                  ...
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap > 
                                      <input type="text" name="E01PVMICD" size="4" maxlength="4" value="<%= customer.getE01PVMICD().trim()%>" onKeyPress="enterInteger(event)">
                                    </td>
                                  </tr>
                                </table>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr id="trclear"> 
                                  ...
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap> 
                                      <input type="text" name="E01PVMICU" size="17" maxlength="15" value="<%= customer.getE01PVMICU().trim()%>" onKeypress="enterDecimal(event, 2)">
                                    </td>
                                    <td nowrap> 
                                      <div align="right">Otros Ingresos :</div>
                                    </td>
                                    <td nowrap> 
                                      <input type="text" name="E01PVMAM2" size="17" maxlength="15" value="<%= customer.getE01PVMAM2().trim()%>" onKeyPress="enterDecimal(event, 2)">
                                    </td>
                                  </tr>
                                  <tr id="trclear"> 
                                    <td nowrap colspan="4" > 
                                  ...
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap > 
                                      <INPUT type="text" name="E01PVMECU" size="17" maxlength="15" value="<%= customer.getE01PVMECU().trim()%>" onkeypress="enterDecimal(event, 2)">
                                    </td>
                                    <td nowrap > 
                                      <div align="right">Otros Egresos :</div>
                                    </td>
                                    <td nowrap > 
                                      <input type="text" name="E01PVMEWF" size="17" maxlength="15" value="<%= customer.getE01PVMEWF().trim()%>" onKeyPress="enterDecimal(event, 2)">
                                    </td>
                                  </tr>
                                  <tr id="trdark"> 
                                    <td nowrap > 
                                    ...
                                    <td nowrap > 
                                      <div align="left">
                                        <input type="text" name="E01PVMAM4" size="17" maxlength="15" value="<%= customer.getE01PVMAM4().trim()%>" onKeyPress="enterDecimal(event, 2)">
                                      </div>
                                    </td>
                                    <td nowrap > 
                                    ...
                                    <td nowrap > 
                                      <div align="left">
                                        <input type="text" name="E01PVMAM5" size="17" maxlength="15" value="<%= customer.getE01PVMAM5().trim()%>" onKeyPress="enterDecimal(event, 2)">
                                      </div>
                                    </td>
                                  </tr>
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap > 
                                      <div align="left">
                                        <input type="text" name="E01PVMAM7" size="17" maxlength="15" value="<%= customer.getE01PVMAM7().trim()%>" onKeyPress="enterDecimal(event, 2)">
                                      </div>
                                    </td>
                                    <td nowrap > 
                                    ...
                                    <td nowrap > 
                                      <div align="left">
                                        <input type="text" name="E01PVMAM6" size="17" maxlength="15" value="<%= customer.getE01PVMAM6().trim()%>" onKeyPress="enterDecimal(event, 2)">
                                      </div>
                                    </td>
                                  </tr>
             		...
             		<div id="dataTab5" style="display: none"> 
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr id="trdark"> 
                              ...
                              <td nowrap > 
                                 <input type="text" name="E01PVRAMT<%=i%>" size="17" maxlength="15" value="<%= customer.getField("E01PVRAMT" +i).getString().trim()%>" onKeyPress="enterDecimal(event, 2)">
                              </td>
                            </tr>
                          </table>
					<% } %> 
