...
<body bgcolor="#FFFFFF">
<H3 align="center"> Tesorer&iacute;a - Dealer Slip<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_enter_opt,EFE0000"></H3>
    ...
    <table class="tableinfo" width="73%">
      ...
      <tr id="trintro"> 
        ...
        <td colspan="6"><div>
          ...
          <a href="javascript:GetFeRef('E01FESDID','E01FESTYPO','E01FESREF')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a>
          </div></td>
      </tr>      
    </table>
