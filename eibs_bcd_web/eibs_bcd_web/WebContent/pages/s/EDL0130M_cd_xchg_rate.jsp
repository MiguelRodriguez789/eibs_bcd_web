...
<h3 align="center">Cambio de Tasa de Intereses<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_xchg_rate.jsp, EDL0130M"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="61%" > 
              <input type="text" name="E06DEANR1" size="60" maxlength="60" value="<%= cdRate.getE06DEANR1().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="39%"> 
            ...
            <td width="61%"> 
              <input type="text" name="E06DEANR2" size="60" maxlength="60" value="<%= cdRate.getE06DEANR2().trim()%>">
            </td>
          </tr>
        </table>
      </td>
