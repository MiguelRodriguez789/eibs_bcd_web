...
<H3 align="center">Mantenimiento de L&iacute;mites de Aprobaci&oacute;n de Ejecutivos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="params_approv_limits_inq,EEJ0000"></H3>
<hr size="4">
<p>&nbsp;</p>
     	...
     	<tr id=trdark> 
		  <td nowrap width="40%"> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E01EJLGRT','Y0')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	  </td>     
      	</tr>
      	<tr id=trclear> 
		  <td nowrap width="40%"> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E01EJLGRC',document.forms[0].E01EJLGRT.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	  </td>     
      	</tr>
      	<tr id=trdark> 
		  <td nowrap width="40%"> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E01EJLJRQ','YY')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	  </td>     
      	</tr>
      	<tr id=trclear> 
		  <td nowrap width="40%"> 
