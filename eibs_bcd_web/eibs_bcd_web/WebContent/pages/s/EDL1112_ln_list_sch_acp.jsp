...
<HTML>
<HEAD>
<TITLE>Banesco - Abonos Masivos, opcion manual - Aceptar</TITLE>
...
function goAction(op) {
 ...
 var page="";
 if (op == 1) {
     page = '${pageContext.request.contextPath}/pages/s/EDL1112_ln_new_sch.jsp';
 } else if (op == 5) {
     page = '${pageContext.request.contextPath}/pages/s/EDL1112_ln_inq_sch.jsp?ROW=' + document.forms[0].ROW.value;
 }
...
<h3 align="center">Abonos Masivos, Proceso Manual - Aceptar<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_list_sch.jsp,EDL1112"> 
</h3>
<hr size="4">
      ...
      <td nowrap height="143"> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="3%">&nbsp;</td>
            <td nowrap width="23%"> 
	             <input type="text" readonly name="E01NARRAT" size="60" maxlength="60" value="<%= userPO.getHeader9().trim()%>">
            </td>
          </tr>
