...
<h3 align="center">An&aacute;lisis de Riesgo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cr_basic, ECIF200"  ></h3>
<hr size="4">
 <FORM>
...
<div align="left">
    ...
    <h4>Estado de Situaci&oacute;n al <%= Util.formatCustomDate(currUser.getE01DTF(), currUser.getE01RDM(),currUser.getE01RDD(),currUser.getE01RDY())%> 
