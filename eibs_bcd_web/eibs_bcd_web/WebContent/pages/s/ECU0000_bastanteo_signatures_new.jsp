...
<H3 align="center">Sistema de Bastanteo - Creacion de Firmas Conjuntas Especificas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_signatures_new,ECU0000"></H3>
<hr size="4">
    	...
    	<tr id=trdark> 
		  <td nowrap> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetSignature('E08CUFSEQ','E08CUFMA1','E08CUFACN',document.forms[0].E08CUFCUN.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	  </td>     
      	</tr>
     </table>
    </td>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%" align="center"> 
              <textarea name="E08CUFOBS" rows="8" cols="64" <%= msgSig.getE08CUFOBS().trim() %>>
              </textarea>	
            </td>
          </tr>
        </table>
