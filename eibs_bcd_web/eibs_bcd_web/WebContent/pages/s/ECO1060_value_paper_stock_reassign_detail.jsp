<html> 
<head>
<title>Reasignacion Stock Adhesivos</title>
...
<% 
 ...
 <%
   ...
   datapro.eibs.beans.ECO106002Message msgMT = (datapro.eibs.beans.ECO106002Message) appList.getRecord();
   
%>
</head>
<body>

<H3 align="center">Reasignacion de Stock de Adhesivos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_stock_reassign_detail,ECO1060"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	        ...
	        <input type="text" name="E02DOCBRN" size="5" maxlength="4" readonly value="<%= msgMT.getE02DOCBRN() %>">
	      </td>
     	</tr>
     	<tr id=trdark> 
	      <td nowrap> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E02DOCCSN" size="5" maxlength="5" readonly value="<%= msgMT.getE02DOCCSN() %>"><b>-</b> 
	        <input type="text" name="E02DOCCSM" size="35" maxlength="35" readonly value="<%= msgMT.getE02DOCCSM() %>">
	      </td>
     	</tr>     	
     	<tr id=trclear> 
		  <td> 
          ...
          <td nowrap>
              <input type="text" name="E02DOCSUB" size="5" maxlength="4" readonly value="<%= msgMT.getE02DOCSUB() %>">
        ...
        <tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:getOficial('E02MOVUSR',document.forms[0].E02DOCBRN.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
          ...
          <td nowrap>
             <input type="text" name="E02MOVQTY" size="13" maxlength="13" value ="<%= msgMT.getE02MOVQTY() %>" onkeypress="enterInteger(event)">
             <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">             
          </td>
        </tr>
        <tr id=trdark>
          ...
          <td nowrap>
             <input type="text" name="E02MOVINI" size="20" maxlength="12" value ="<%= msgMT.getE02MOVINI() %>" onkeypress="enterInteger(event)">
             <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">             
          </td>
        </tr>
        <tr id=trclear>
          ...
          <td nowrap>
             <input type="text" name="E02MOVFIN" size="20" maxlength="12" value ="<%= msgMT.getE02MOVFIN() %>" onkeypress="enterInteger(event)">
             <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">             
          </td>
        </tr>
     </table>
