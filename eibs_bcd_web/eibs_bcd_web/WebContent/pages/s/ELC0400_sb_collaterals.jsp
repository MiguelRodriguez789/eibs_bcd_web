...
<jsp:useBean id= "msgLC" class= "datapro.eibs.beans.ELC040011Message"  scope="session" />
...
<h3 align="center">Garant&iacute;as<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_documents.jsp,0400"></h3>
<hr size="4"> <form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0400">
 ...
 <input type=HIDDEN name="H11FLGWK3" value="<%= msgLC.getH11FLGWK3()%>"> 
  ...
  <br><br><br>
  <table cellpadding=2 cellspacing=0 width="600" border="1" bordercolor="#000000" bgcolor="#FFFFFF" align="center">
    <tr bordercolor="#FFFFFF"> 
      <td nowrap > 
