...
<BR>Nueva
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_aditional_card_new.jsp,ECC0060"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="16%"> 
              <div align="left">
                <input type="text" name="E01CCRNUM" size="21" maxlength="20" value="<%= userPO.getHeader23().trim() %>" onKeypress="enterInteger(event)">
                <A href="javascript:readStripe();">
                <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Leer Tarjeta" align="bottom" border="0"></A> 
				<%--
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                ...
                <a href="javascript:GetCustomerDescId('E01SECCUN','E01SECNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>
			  </div>
            </td>
            <td nowrap width="16%" > 
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0" align="center" >
           <tr id="trdark"> 
            <TD nowrap width="25%"> 
              ...
              <!-- <INPUT type="text" name="E01CCREXD" readonly size="3" maxlength="2" value="<%= msgCard.getE01CCREXD().trim()%>" onkeypress="enterInteger(event)">  -->
              <INPUT type="text" name="E01CCREXM" readonly size="3" maxlength="2" value="<%= msgCard.getE01CCREXM().trim()%>" onkeypress="enterInteger(event)">
              <INPUT type="text" name="E01CCREXY" readonly size="6" maxlength="4" value="<%= msgCard.getE01CCREXY().trim()%>" onkeypress="enterInteger(event)">
            ...
            <td nowrap width="27%"> 
              <input type="text" name="E01CCRISD" readonly size="3" maxlength="2" value="<%= msgCard.getE01CCRISD().trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCRISM" readonly size="3" maxlength="2" value="<%= msgCard.getE01CCRISM().trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCRISY" readonly size="6" maxlength="4" value="<%= msgCard.getE01CCRISY().trim()%>" onkeypress="enterInteger(event)">
...
function processCard(){
	...
	if( document.form1.E01CCRNUM.value.trim() != ""  && 
		"<%=error.getERRNUM()%>" == "0"   ){
