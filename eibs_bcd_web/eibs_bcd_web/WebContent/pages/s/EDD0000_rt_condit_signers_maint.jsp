...
<body>
<h3 align="center">Condiciones Especiales de Firmantes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_condit_signers_maint.jsp, EDD0000"></h3>
<hr size="4">
  ...
  <table id="mainTable" class="tableinfo">
    	...
    	<tr id="trdark"> 
            ...
            <% if (opt.equals("1")||opt.equals("2")) { //new %>
			   ...
			   <a href="javascript:GetCustomerDetails('E01SG1','E01NM1','','','','','','','','','','','','','','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
            <% } else {%>
          ...
          <tr id="trdark"> 
            ...
            <td width="23%" nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E01CS1','FI')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>	
            </td>
          </tr>
    	<tr id="trclear"> 
            <td width="13%" nowrap> 
            ...
            <% if (opt.equals("1")||opt.equals("2")) { //new %>
			   ...
			   <a href="javascript:GetCustomerDetails('E01SG2','E01NM2','','','','','','','','','','','','','','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
            <% } else {%>
          ...
          <tr id="trdark"> 
            ...
            <td width="23%" nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E01CS2','FI')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>	
            </td>
          </tr>
    	<tr id="trclear"> 
            <td width="13%" nowrap> 
            ...
            <% if (opt.equals("1")||opt.equals("2")) { //new %>
			   ...
			   <a href="javascript:GetCustomerDetails('E01SG3','E01NM3','','','','','','','','','','','','','','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
            <% } else {%>
          ...
          <tr id="trdark"> 
            ...
            <td width="23%" nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E01CS3','FI')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>	
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="13%" > 
