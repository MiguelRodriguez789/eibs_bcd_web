		...
		<tr  height="95%">    
			<td nowrap="nowrap"> 
				<div id="dataDiv1"  style="max-height:400px; overflow:auto; border: 0px;"> 
					<table id="dataTable" class="tableinfoList" style="border: 0; font-size: 5pt" cellspacing="0" cellpadding="1" border="0" >         
					<%
						double sum01 = 0;
					 	double sum02 = 0;
					 	double sum03 = 0;
						 ...
						 while (list.getNextRow()) {
						   ...
						   sumpnu = 0;
						   sumpnu += plan.getBigDecimalE08TOTA01().doubleValue() + plan.getBigDecimalE08TOTA02().doubleValue()
								   +plan.getBigDecimalE08TOTA03().doubleValue() + plan.getBigDecimalE08TOTA04().doubleValue()
								   +plan.getBigDecimalE08TOTA05().doubleValue() + plan.getBigDecimalE08TOTA06().doubleValue()
								   +plan.getBigDecimalE08TOTA07().doubleValue() + plan.getBigDecimalE08TOTA08().doubleValue()
								   +plan.getBigDecimalE08TOTA09().doubleValue() + plan.getBigDecimalE08TOTA10().doubleValue()
								   +plan.getBigDecimalE08TOTA11().doubleValue() + plan.getBigDecimalE08TOTA12().doubleValue()
								   +plan.getBigDecimalE08TOTA13().doubleValue() + plan.getBigDecimalE08TOTA14().doubleValue()
								   +plan.getBigDecimalE08TOTA15().doubleValue() + plan.getBigDecimalE08TOTA16().doubleValue()
								   +plan.getBigDecimalE08TOTA17().doubleValue() + plan.getBigDecimalE08TOTA18().doubleValue()
								   +plan.getBigDecimalE08TOTA19().doubleValue();
