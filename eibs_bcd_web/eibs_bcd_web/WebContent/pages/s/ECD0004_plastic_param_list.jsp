...
%>
<BODY>
<h3 align="center">Parametros de Tarjetas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_param_list.jsp, ECD0004"></h3>
<hr size="4">
