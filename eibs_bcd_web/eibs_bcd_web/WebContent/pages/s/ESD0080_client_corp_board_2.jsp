      ...
      <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" name="TB_BENEFICIARY_CORP" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
          <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA1" maxlength="60" size="65" value="<%= board.getField("E" + name + "4MA1").getString().trim()%>">
              </td>
          </tr>
        ...
        <%--  
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4D21" maxlength="3" size="2" value="<%= board.getField("E" + name + "4D21").getString().trim()%>">
              <input type="text" name="E<%= name %>4D22" maxlength="3" size="2" value="<%= board.getField("E" + name + "4D22").getString().trim()%>">
              <input type="text" name="E<%= name %>4D23" maxlength="5" size="4" value="<%= board.getField("E" + name + "4D23").getString().trim()%>">
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="42%" nowrap > 
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4HPN" maxlength="15" size="16" value="<%= board.getField("E" + name + "4HPN").getString().trim()%>">
              </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" name="E<%= name %>4BNI" maxlength="25" size="26" value="<%= board.getField("E" + name + "4BNI").getString().trim()%>">
              </td>
          </tr>
          <tr id="trclear">
            <td width="42%" > 
