...
{
//	page = webapp + "/servlet/datapro.eibs.valuepaper.JSEVL0120?SCREEN=200&E01IMPACC=" + num +"&E01IMPACD=" + acd;
...
function PrintPreview() {
	var pg = '<%=request.getContextPath()%>/pages/s/EVL0120_vl_inquiry_list_print.jsp';
...
<BODY>
<div id="imprime">
<h3 align="center">Consulta de Documentos Emitidos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="vl_inquiry_list.jsp, EVL0120"></h3>
<hr size="4">
      ...
      <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="8%"><div align="center">Tipo de<br>Docto.</div></th>
        ...
        <TR>
		  ...
		  <TD NOWRAP ALIGN="CENTER"><a href="javascript:getDetail('<%= msgPart.getE01IMPACD() %>', '<%= msgPart.getE01IMPACC() %>')"><%=Util.getTimeFromTimestamp(msgPart.getE01IMPUET())%></a></TD>
...
--%>  
  <%}%>
  <p align="center"> 
    <input id="EIBSBTN" type="submit" name="Submit" value="Imprimir" OnClick="PrintPreview();">
  </p>
  </FORM>
</div>
</body>
