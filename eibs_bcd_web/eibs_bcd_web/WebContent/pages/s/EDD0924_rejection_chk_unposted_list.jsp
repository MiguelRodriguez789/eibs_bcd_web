...
<h3 align="center">Devolución de Cheques<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rejection_chk_unposted_list.jsp,EDD0924"></h3>
<hr size="4">
...
<input type="HIDDEN" name="CAUSE" value="<%=dataCR.getCause() != null?dataCR.getCause():""%>">
 ...
 <h4 style="text-align:center">Devolución por Otros Conceptos--Official : <% if ( dataCR.getOfficer().trim().equals("")){out.print("All");} else {out.print(dataCR.getOfficer());} %>
   </h4>
