...
%>
<H3 align="center"><%= title %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_payment.jsp, EDL0950" width="35" height="35"> 
</H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0950" onsubmit="return(checkOPT())">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap width="20%"> 
              <div align="right">
                <eibsinput:date name="lnCancel"  fn_month="E01VENDT1" fn_day="E01VENDT2" fn_year="E01VENDT3"/> 
            ...
            <td nowrap width="23%"> 
              <div align="right">
                <eibsinput:date name="lnCancel"  fn_month="E01PRXDT1" fn_day="E01PRXDT2" fn_year="E01PRXDT3"/> 
            ...
            <td nowrap width="17%"> 
              <div align="right">
                <eibsinput:date name="lnCancel"  fn_month="E01SALDT1" fn_day="E01SALDT2" fn_year="E01SALDT3" /> 
        ...
        <%if(userPO.getType().equals("1")) {%>
         ...
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap>Pago Parcial 
             <input type="text" name="E01PAGABO" size="15" maxlength="15" value="<%= lnCancel.getE01PAGDIS().trim()%>" onKeypress="enterDecimal(event, 2)">
            </td>
            <TD nowrap>
         ...
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap colspan=2> Monto a Distribuir (Valor a Pagar 
              <input type="text" name="E01PAGTOT" size="15" maxlength="15" value="<%= lnCancel.getE01PAGDIS().trim()%>" onKeypress="enterDecimal(event, 2)">
              ) </td>
          </tr>
