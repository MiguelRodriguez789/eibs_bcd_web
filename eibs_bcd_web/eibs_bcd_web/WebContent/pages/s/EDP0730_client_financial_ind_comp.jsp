...
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/s/javascripts/optMenu.jsp"> </SCRIPT><SCRIPT type="text/javascript">
...
function ShowFormula() 
{
  	...
  	page= '${pageContext.request.contextPath}/pages/s/STATIC_creditproposal_financial_idx_for.jsp';
...
<h3 align="center">Indices Financieros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="creditproposal_financial_ind_comp.jsp,EDP0730"></h3>
<hr size="4">
          ...
          <tr id="trdark"> 
            <th align=CENTER nowrap width="5%">&nbsp;
             ...
             <th align=CENTER nowrap width="20%"> 
            	...
            	<INPUT type="text" name="E01IFMFY3" size="5" readonly value="<%=mL0734.getE01IFMFY3().trim()%>">/
            	<INPUT type="text" name="E01IFMFM3" size="3" readonly value="<%=mL0734.getE01IFMFM3().trim()%>">
            	<INPUT type="text" name="TIPAUDIT3" size="1" readonly value="<%=mL0734.getE01IFMCA3().substring(0,1)%>">
            	</div>           	
            </th>
             <th align=CENTER nowrap width="20%"> 
            	<div align="center">Periodo
            	<INPUT type="text" name="E01IFMFY2" size="5" readonly value="<%=mL0734.getE01IFMFY2().trim()%>">/
            	<INPUT type="text" name="E01IFMFM2" size="3" readonly value="<%=mL0734.getE01IFMFM2().trim()%>">
            	<INPUT type="text" name="TIPAUDIT2" size="1" readonly value="<%=mL0734.getE01IFMCA3().substring(1,2)%>">
            	</div>
            </th>
             <th align=CENTER nowrap width="20%"> 
            	<div align="center">Periodo
            	<INPUT type="text" name="E01IFMFEY" size="5" readonly value="<%=mL0734.getE01IFMFEY().trim()%>">/
            	<INPUT type="text" name="E01IFMFEM" size="3" readonly value="<%=mL0734.getE01IFMFEM().trim()%>">
