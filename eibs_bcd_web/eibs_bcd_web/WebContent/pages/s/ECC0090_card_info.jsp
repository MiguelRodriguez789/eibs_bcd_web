...
de Tarjetas de Débito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="card_info.jsp, ECC0090"> 
</h3>
<hr size="4">
<% 
 ...
 <TR > 
	...
	<TBODY>
		...
		<TR>
			...
			<TD nowrap align="CENTER"><%=Util.formatCustomDate( currUser.getE01DTF(), msgPart.getE01CCRDLM(),msgPart.getE01CCRDLD(),msgPart.getE01CCRDLY()) %></TD>
