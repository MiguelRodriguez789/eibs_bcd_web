      ...
      <td nowrap> 
        <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
		  ...
		  <tr> 
            ...
            <td nowrap width="50%"> 
              <input type="text" name="E02ACMACC" size="12" maxlength="12" onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E02ACMACC','','04','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
            </td>
          </tr>
        </table>
      </td>
