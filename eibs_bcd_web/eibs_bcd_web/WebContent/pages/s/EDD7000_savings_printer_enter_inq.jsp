...
<H3 align="center">Impresion Datos del Titular en Libreta de Ahorros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="savings_printer_enter_inq,EDD7000"></H3>
<hr size="4">
<p>&nbsp;</p>
