...
%> 
<h3 align="center"> Portafolio - Orden de Compra / Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_enter_basic.jsp, EIV0301"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                ...
                <a href="javascript:GetCustomerDescId('E01IVSCUN','E01IVSNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="29%" > 
              <input type="text" name="E01IVSBRK" size="5" maxlength="4" value="<%= inv.getE01IVSBRK()%>" >
              <input type="text" name="E01IVSBRD" size="15" maxlength="15" value="<%= inv.getE01IVSBRD()%>" >
              <a href="javascript:GetBrokerT('E01IVSBRK','E01IVSBRD')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a> 
            </td>
            <td nowrap width="20%" > 
            ...
            <td nowrap width="40%" > 
              ...
              <a href="javascript:GetPortfolioNum('E01IVSPRP','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a> 
            </td>
          </tr>
        </table>
      </td>
