...
<h3 align="center">Consulta de Cartas de Crédito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_enter_inquiry.jsp, ELC0450"></h3>
<hr size="4">
          ...
          <tr id="trdark">
            ...
            <td width="50%"> 
              <div align="left"> 
    	          ...
    	          <a href="javascript:GetAccount('E01LCMACC','','LC','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
              </div>
            </td>
          </tr>
         </table>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear">
            ...
            <td width="70%" nowrap>
              Del 
              <input type="text" size="3" maxlength="2" name="E01SCHFI1" onkeypress="enterInteger(event)">
              <input type="text" size="3" maxlength="2" name="E01SCHFI2" onkeypress="enterInteger(event)">
              <input type="text" size="5" maxlength="4" name="E01SCHFI3" onkeypress="enterInteger(event)">
              al 
              <input type="text" size="3" maxlength="2" name="E01SCHTI1" onkeypress="enterInteger(event)">
              <input type="text" size="3" maxlength="2" name="E01SCHTI2" onkeypress="enterInteger(event)">
              <input type="text" size="5" maxlength="4" name="E01SCHTI3" onkeypress="enterInteger(event)">
            </td>
          </tr>
          <tr id="trdark">
            <td width="30%" nowrap> 
            ...
            <td width="70%" nowrap>
              Del 
              <input type="text" size="3" maxlength="2" name="E01SCHFE1" onkeypress="enterInteger(event)">
              <input type="text" size="3" maxlength="2" name="E01SCHFE2" onkeypress="enterInteger(event)">
              <input type="text" size="5" maxlength="4" name="E01SCHFE3" onkeypress="enterInteger(event)">
              al 
              <input type="text" size="3" maxlength="2" name="E01SCHTE1" onkeypress="enterInteger(event)">
              <input type="text" size="3" maxlength="2" name="E01SCHTE2" onkeypress="enterInteger(event)">
              <input type="text" size="5" maxlength="4" name="E01SCHTE3" onkeypress="enterInteger(event)">
            </td>
          </tr>
          <tr id="trclear">
            <td width="30%" nowrap>
          ...
          <tr id="trdark">
            ...
            <td width="70%" nowrap>
              ...
              <a href="javascript:GetProductRates('E01SCHATY','LC')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0"></a>
            </td>
          </tr>
          <tr id="trclear">
            <td width="30%" nowrap>
            ...
            <td width="70%" nowrap>
              ...
              <a href="javascript:GetProduct('E01SCHPRO','LC','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0"></a>
            </td>
          </tr>
          <tr id="trdark">
            <td width="30%" nowrap>
            ...
            <td width="70%" nowrap>
              <input type="text" name="E01SCHBRN" size="5" maxlength="4">
          ...
          <tr id="trdark">
            ...
            <td width="70%" nowrap >
          	  Desde 
              <input type="text" name="E01SCHAMF" size="20" maxlength="19" onKeypress="enterDecimal(event)">
              hasta
              <input type="text" name="E01SCHAMT" size="20" maxlength="19" onKeypress="enterDecimal(event)">
            </td>
          </tr>
          <tr id="trclear">
            <td width="30%" nowrap>
