...
<H3 align="center">Aprobación de Cheques de Gerencia <IMG
	...
	name="EIBS_GIF" title="EOF0115_of_chk_apr_list.jsp"></H3>
<HR size="4">
...
for(int i = 0; i < msgList.size(); i++)
{
	...
	showRef = "showOffChkApproval('" + msgPart.getE01OFMNCH() + "', '" + msgPart.getE01OFMCCY() + "', '" + strPurpose + "')";%>
			<TR>
				...
				<TD NOWRAP ALIGN="RIGHT"><A href="javascript:<%=showRef%>"><%=Util.formatCell(msgPart.getE01OFMNCH())%></A></TD>
				<TD NOWRAP ALIGN="CENTER"><A href="javascript:<%=showRef%>"><%=Util.formatCell(msgPart.getE01OFMCCY())%></A></TD>
				<TD NOWRAP ALIGN="RIGHT"><A href="javascript:<%=showRef%>"><%=Util.formatCell(msgPart.getE01OFMBRN())%></A></TD>
				<TD NOWRAP ALIGN="RIGHT"><A href="javascript:<%=showRef%>"><%=Util.formatCell(msgPart.getE01OFMMCH())%></A></TD>
				<TD NOWRAP ALIGN="CENTER"><A href="javascript:<%=showRef%>"><%=Util.formatCell(msgPart.getE01OFMSTS())%></A></TD>
				<TD NOWRAP ALIGN="CENTER"><A href="javascript:<%=showRef%>"><%=Util.formatCustomDate(currUser.getE01DTF(),msgPart.getE01OFMIDM(), msgPart.getE01OFMIDD(), msgPart.getE01OFMIDY())%></A></TD>
				<TD NOWRAP ALIGN="LEFT"><A href="javascript:<%=showRef%>"><%=Util.formatCell(msgPart.getE01OFMBNF())%></A></TD>
