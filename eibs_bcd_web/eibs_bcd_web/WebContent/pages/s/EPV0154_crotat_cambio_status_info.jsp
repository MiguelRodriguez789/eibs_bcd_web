...
<html>
<head>
<title> Cupo Rotativo Basic Information for Status</title>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=ISO-8859-1">
<link Href="<%=request.getContextPath()%>/pages/style.css" rel="stylesheet">

<jsp:useBean id="RecData" class="datapro.eibs.beans.EPV015406Message"  scope="session" />
...
<h3 align="center"> Cambio Status- Cupo Rotativo:  <%=RecData.getE06DSCPRO()%>
 <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="crotat_cambio_status_info.jsp, EPV0154"></h3>
<hr size="4">
