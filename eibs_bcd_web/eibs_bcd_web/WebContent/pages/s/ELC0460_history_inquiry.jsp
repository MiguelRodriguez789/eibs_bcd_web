...
<BODY>
<H3 align="center">Consulta Carta de Crédito<IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="ELC0460_history_inquiry.jsp"></H3>
<HR size="4">
<FORM>
            ...
            <TR id="trdark">
              ...
              <TD nowrap width="16%" align="left"><B>
                <INPUT type="text" name="E01DSCPRO" size="40"
						maxlength="35" value="<%=msg046001.getE01DSCPRO().trim()%>" readonly>
                </B> </TD>
            </TR>
  </TABLE>
  ...
  <TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
    ...
    <TR id="">
      ...
      <TD nowrap><SELECT name="E01LCMAF4" disabled >
        ...
        <INPUT name="E01LCMABA" type="text" value="<%=msg046001.getE01LCMABA()%>" size="12" maxlength="12" readonly="readonly"
       		<%if (msg046001.getF01LCMABA().equals("Y")) out.print("class=\"txtchanged\"");%>>
           </TD>
    </TR>
    <TR id="">
      <TD width="35%" align="right" nowrap>Codigo Swift: </TD>
      <TD align="left" nowrap><INPUT name="E01LCMABI" type="text" value="<%=msg046001.getE01LCMABI()%>" size="12" maxlength="12" readonly="readonly"
          		<%if (msg046001.getF01LCMABI().equals("Y")) out.print("class=\"txtchanged\"");%>>
         </TD>
    </TR>
    <TR id="">
      <TD align="right" nowrap>Nombre: </TD>
      <TD align="left" nowrap><INPUT name="E01LCMAB1" type="text" value="<%=msg046001.getE01LCMAB1()%>" size="45" maxlength="35" readonly="readonly"
       		<%if (msg046001.getF01LCMAB1().equals("Y")) out.print("class=\"txtchanged\"");%>>
          <IMG src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" border="0"></TD>
    </TR>
    <TR id="">
      <TD align="right" nowrap>Dirección: </TD>
      <TD align="left" nowrap><INPUT name="E01LCMAB2" type="text" value="<%=msg046001.getE01LCMAB2()%>" size="45" maxlength="35" readonly="readonly"      
       		<%if (msg046001.getF01LCMAB2().equals("Y")) out.print("class=\"txtchanged\"");%>>
      </TD>    		
    </TR>
    <TR id="">
      <TD nowrap></TD>
      <TD align="left" nowrap><INPUT name="E01LCMAB3" type="text" value="<%=msg046001.getE01LCMAB3()%>" size="45" maxlength="35" readonly="readonly"      
       		<%if (msg046001.getF01LCMAB3().equals("Y")) out.print("class=\"txtchanged\"");%>>
      </TD>
    </TR>
    <TR id="">
      <TD nowrap></TD>
      <TD align="left" nowrap><INPUT name="E01LCMAB4" type="text" value="<%=msg046001.getE01LCMAB4()%>" size="45" maxlength="35" readonly="readonly"      
       		<%if (msg046001.getF01LCMAB4().equals("Y")) out.print("class=\"txtchanged\"");%>>
      </TD>
    </TR>
    <TR id="">
      <TD align="right" valign="bottom" nowrap>Estado: </TD>
      <TD align="left" nowrap><INPUT name="E01LCMAB5" type="text" value="<%=msg046001.getE01LCMAB5()%>" size="2" maxlength="2" readonly="readonly"
       		<%if (msg046001.getF01LCMAB5().equals("Y")) out.print("class=\"txtchanged\"");%>>
        Cddigo Postal
        <INPUT name="E01LCMAB6" type="text" value="<%=msg046001.getE01LCMAB6()%>" size="11" maxlength="10" readonly="readonly"
       		<%if (msg046001.getF01LCMAB6().equals("Y")) out.print("class=\"txtchanged\"");%>>
        País
        <INPUT name="E01LCMAB7" type="text" value="<%=msg046001.getE01LCMAB7()%>" size="4" maxlength="4" readonly="readonly"
       		<%if (msg046001.getF01LCMAB7().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
    </TR>
    <TR id="">
  ...
  <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
    ...
    <TR id="">
      ...
      <TD align="left" nowrap><P>
        <INPUT name="E01LCMCBC" type="text" value="<%=msg046001.getE01LCMCBC()%>" size="12" maxlength="12" readonly="readonly"
...
<!-- <TABLE width="100%" border="0" align="center" cellpadding="2"  cellspacing="0" class="tableinfo">
 ...
 <% if(request.getParameter("OPTMENU") != null) { %>
   ...
   function goMsgSwift() {
   	...
   	page = "<%=request.getContextPath()%>/servlet/datapro.eibs.approval.JSEPR1080A?SCREEN=8&TRANSREFNUM=<%=msg046001.getE01LCMACC().trim()%>";
