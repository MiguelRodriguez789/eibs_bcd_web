...
<BODY>
<h3 align="center">Ingreso de Planilla Automatico<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="collection_upload, EDL0810"></h3>
<hr size="4">
...
<TABLE class="tbenter">
        <TR align="center">
			...
			<TD align="left"><INPUT type="text" name="PRDCDE" size="4" value ="<%= currUser.getH01OPE() %>" readonly>
			<!--<a href="javascript:GetProduct('PRDCDE','10','<%=currUser.getE01UBK() %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Help" align="bottom" border="0"></a>-->
			</TD>
		</TR>
		<TR align="center">
