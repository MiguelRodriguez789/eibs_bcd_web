...
<form>
  ...
  <h3 align="center">Cronograma de Plan de Pagos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_ap_crn_pay.jsp,EDL0900"> 
  </h3>
  <hr size="4">
...
<h4></h4>
 ...
 <%int row = 0; %>
  ...
  <TABLE class="tableinfo"  cellspacing=3>
    <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
  ...
  <TABLE class="tableinfo"  cellspacing=3>
    ...
    <%
                ...
                while (listUF.getNextRow()) {
                    if (couteDateUF.equals(listUF.getRecord(1))) {
                    } else {
