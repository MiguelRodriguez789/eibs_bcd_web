        ...
        <table id="headTable" width="100%">
          ...
          <%
                ...
                <TR>
					...
					<TD NOWRAP ALIGN=CENTER width="40%"><%= Util.formatCustomDate(currUser.getE01DTF(),
																	msgList.getBigDecimalE02PVMOPM().intValue(),
																	msgList.getBigDecimalE02PVMOPD().intValue(),
																	msgList.getBigDecimalE02PVMOPY().intValue())%></td>
