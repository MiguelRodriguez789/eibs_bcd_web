...
function goAction(op) {
 ...
 var page="";
 if (op == 1) {
     page = '${pageContext.request.contextPath}/pages/s/EPC0180_pc_new_sch.jsp?LASTROW=' + document.forms[0].LASTROW.value;
 } else if (op == 2) {
     page = '${pageContext.request.contextPath}/pages/s/EPC0180_pc_maint_sch_inq.jsp?ROW=' + document.forms[0].ROW.value;
 } else if (op == 4) {     
     page = '${pageContext.request.contextPath}/pages/s/EPC0180_pc_delete_sch.jsp?ROW=' + document.forms[0].ROW.value; 
 } else if (op == 5) {     
     page = '${pageContext.request.contextPath}/pages/s/EPC0180_pc_sale_sch.jsp?ROW=' + document.forms[0].ROW.value; 
 }
...
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEPC0180">
<INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="201">
<INPUT TYPE=HIDDEN NAME="OPT" VALUE="3">
<INPUT TYPE=HIDDEN NAME="ROW" VALUE="0">
<INPUT TYPE=HIDDEN NAME="LASTROW" VALUE="1">

<h3 align="center">Unidades de Vivienda Asociadas a Proyecto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_list_sch_inq.jsp,EPC0180"> 
</h3>
<hr size="4">
 ...
 <TR> 
   <TD NOWRAP valign="top" width="100%">
    ...
    <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER nowrap>Porcentaje Liberacion</TH>
      <TH ALIGN=CENTER nowrap>Hipoteca</TH>
...
<%--                <INPUT TYPE="radio" NAME="EXTCHG" VALUE="<%= extList.getCurrentRow() %>" <% if (extList.getCurrentRow() == row) out.print("checked"); %> onClick="showInfo(<%= extList.getCurrentRow() %>,'<%=msgPC.getE01PCDNUM()%>')">--%>
			...
			<% } %>
              ...
              <TD ALIGN=RIGHT NOWRAP><%= Util.formatCell(msgPC.getE01PCDARA()) %></TD>              
              <TD ALIGN=RIGHT NOWRAP><%= Util.formatCell(msgPC.getE01PCDPLI()) %></TD>              
              <TD ALIGN=RIGHT NOWRAP><%= Util.formatCell(msgPC.getE01PCDHPT()) %></TD>              
