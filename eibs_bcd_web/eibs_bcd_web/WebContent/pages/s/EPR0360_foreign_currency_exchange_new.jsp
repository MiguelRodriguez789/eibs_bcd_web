...
<H3 align="center">Ingreso Compras de Cheques de Remesa y Cobranza<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_new, EPR0360"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01REQBRN" size="5" maxlength="4" value="<%= userPO.getBranch() %>" readonly>
		  </td>
     	</tr>
     	<tr id=trdark> 
	      <td nowrap> 
	      ...
	      <td nowrap>
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E01REQINS','E01REQINN','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
     	...
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetInstCurrency('E01REQCCY',document.forms[0].E01REQBNK.value,document.forms[0].E01REQINS.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
      	  </td>     
      	</tr>
      	<tr id=trdark>
          ...
          <td nowrap>
			 ...
			 <a href="javascript:GetCustomerDescId('E01REQCUS','E01REQCUN','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			 <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
          </td>
        </tr>
     </table>
		...
		<tr>
			...
			<td nowrap width="60%">
				...
				<input type="text" name="E01REQCHN" size="35" maxlength="35" value="<%= msgInst.getE01REQCHN() %>" readonly >
      	    	<a href="javascript:GetCodeDescCNOFC('E01REQCHB','E01REQCHN','YE')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    	<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">  
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td nowrap width="60%">
				...
				<input type="text" name="E01REQORN" size="35" maxlength="35" value="<%= msgInst.getE01REQORN() %>" readonly> 
      	    	<a href="javascript:GetCodeDescCNOFC('E01REQOPR','E01REQORN','Y*')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    	<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
			</td>
		</tr>
		<tr>
			...
			<td nowrap width="60%">
				...
				<a href="javascript:GetCorrespondentDescId('E01REQCOR','E01REQCON','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
				<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
			</td>
		</tr>
     </table>
