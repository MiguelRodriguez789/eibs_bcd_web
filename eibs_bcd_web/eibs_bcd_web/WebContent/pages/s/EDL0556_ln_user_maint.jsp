...
<h3 align="center">Negociacion Tabla de Usuarios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_user_maint.jsp,EDL0556"> 
</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEDL0556" >
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
             ...
             <td nowrap width="5%">
              <input type="text" name="E01NUSUSR" size="12" maxlength="10" value="<%= lnParam.getE01NUSUSR()%>" readonly="false"> 
             </td>
            <td nowrap width="10%" align=left><% if (lnParam.getField("E01NUSAUT").getString().equals("1")) {
												out.print(Util.formatCell("Gestores/Consejeros"));
											} else if (lnParam.getField("E01NUSAUT").getString().equals("2")) {
												out.print(Util.formatCell("Supervisores"));
											} else if (lnParam.getField("E01NUSAUT").getString().equals("3")) {
												out.print(Util.formatCell("Coordinadores"));
											} else if (lnParam.getField("E01NUSAUT").getString().equals("4")) {
  ...
  <H4>Datos B&aacute;sicos Porcentajes de Negociacion</H4>
  <table  class="tableinfo" >
    <tr > 
      <td nowrap> 
