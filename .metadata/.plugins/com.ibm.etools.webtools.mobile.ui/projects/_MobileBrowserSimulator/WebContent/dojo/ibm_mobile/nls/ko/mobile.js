...
({
	...
	'index_xdomain_warning' : '현재 표시된 웹 페이지는 다른 서버와 이 테스트 클라이언트에 있습니다.',
	...
	'index_need_http' : "상대 경로가 아닌 경로 사용 시 경로 앞에 'http://'를 사용해야 합니다.",
	...
	'MobileBrowserSimulator_xdomain_warning' : '현재 표시된 웹 페이지는 다른 서버와 이 테스트 클라이언트에 있습니다.',
	...
	'index_cordova_enable_desc' : 'Cordova 시뮬레이션을 사용하면 시뮬레이터로 Cordova API를 시뮬레이션합니다.',	
	'index_cordova_support' : 'Cordova 시뮬레이션은 다음 브라우저에서 지원됩니다.'
