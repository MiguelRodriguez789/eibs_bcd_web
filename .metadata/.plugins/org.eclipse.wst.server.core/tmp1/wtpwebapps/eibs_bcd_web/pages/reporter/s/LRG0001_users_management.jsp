...
<body>
 ...
 %>
<h3 class="h3title">Asignación de Reportes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="usermodule_list, LRG0001">
</h3>
<hr class="raya">
<br>
...
%>
		...
		<p align="center">  
   		...
   		&nbsp;&nbsp;&nbsp;
   		<input id="EIBSBTN" type="button" value="Retornar" onClick="javascript:goReturn();">
   		</p>
  </form>
