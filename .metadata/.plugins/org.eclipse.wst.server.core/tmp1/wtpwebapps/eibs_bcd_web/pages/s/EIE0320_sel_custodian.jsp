...
<BODY>
<h3 align="center">Instrumento Posici&oacute;n Abierta por Custodio<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_custodian.jsp, EIE0320"></h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trclear"> 
            <td nowrap width="25%" > 
              <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].INSTRUMENT.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" title="help" align="bottom" border="0" > 
                Instrumento </a> :</div>
            </td>
            <td nowrap colspan="5" > 
              <div align="left"> 
