...
<H3 align="center">C&oacute;digos de Referencia del Sistema - Causas de Cancelaci&oacute;n 
  de Cuentas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnof_cancellation_accounts.jsp, ESD0030"></H3>
<hr size="4">
      ...
      <td nowrap> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E02CNODCC" size="5" maxlength="4" value="<%= refCodes.getE02CNODCC().trim()%>">
                <a href="javascript:GetCodeCNOFC('E02CNODCC','20')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a></div>
            </td>
          </tr>
        </table>
      </td>
