...
<script type="text/javascript">
	function enter(bnk,brn,ccy,gln,acc) {
		...
		if (isValidObject(form[top.opener.bank])) form[top.opener.bank].value = bnk;
		if (isValidObject(form[top.opener.branch])) form[top.opener.branch].value = brn;
		if (isValidObject(form[top.opener.currency])) form[top.opener.currency].value = ccy;
		if (isValidObject(form[top.opener.glNumber])) form[top.opener.glNumber].value = gln;
		if (isValidObject(form[top.opener.account])) form[top.opener.account].value = acc;  		
		top.close();
 	}
</script>
