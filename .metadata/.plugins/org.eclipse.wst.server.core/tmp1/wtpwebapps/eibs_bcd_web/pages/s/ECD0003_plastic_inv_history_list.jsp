...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_inv_history_list.jsp , ECD0003">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign="top" width="100%">
        ...
        <TR>
			<TD NOWRAP ALIGN="CENTER">
				<%= Util.formatCustomDate( currUser.getE01DTF(), msgPart.getE03CDRMOR(), msgPart.getE03CDRDAR(), msgPart.getE03CDRYER()) %>
			</TD>
			<TD NOWRAP ALIGN="CENTER">
				<%=Util.formatCell(msgPart.getE03CDRTIR())%>
			</TD>
			<TD NOWRAP ALIGN="CENTER">
