...
<h3 align="center">Referencias Cruzadas Cuenta Contable M/E<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fx_enter, EFE0100"></h3>
<hr>
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
	      ...
	      <tr id="trdark"> 
	        ...
	        <td nowrap width=40% align="left"  > 
	          <INPUT type="text" name="E01FEGBNK" size="3" maxlength="2" onkeypress="enterInteger(event)">
	        </td>
	      </tr>
	      <tr id="trclear"> 
	        ...
	        <td nowrap width=40% align="left"> 
	              ...
	              <a href="javascript:GetCurrency('E01FEGCCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a> 
	        </td>
	      </tr>
	      <tr id="trdark"> 
