...
<h3 align="center">Ajuste de Documentos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pay_inq_ln_adjustments.jsp, EDL0828"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear">  
            ...
            <td width="60%"> 
              <input type="text" name="E01TRNTOT" readonly size="15" maxlength="15" value="<%= lnAdjustment.getE01TRNTOT().trim()%>" onKeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
				<eibsinput:date name="lnAdjustment" fn_year="E01TRNVDY" fn_month="E01TRNVDM" fn_day="E01TRNVDD" readonly="true"/>
            </td>
          </tr>
           <tr id="clear"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" name="E01TRNNAR" readonly size="60" maxlength="60" value="<%= lnAdjustment.getE01TRNNAR().trim()%>">
            </td>
          </tr>
        </table>
