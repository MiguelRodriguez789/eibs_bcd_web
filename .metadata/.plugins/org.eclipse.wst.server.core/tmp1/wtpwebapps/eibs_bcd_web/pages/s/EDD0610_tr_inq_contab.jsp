...
<h3 align="center">Contabilización<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="EDD0610_tr_inq_contab.jsp"></h3>
<hr size="4" width="100%">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trdark"> 
            ...
            <td nowrap width="21%" > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTBNK" size="3" maxlength="2" value="<%= inqContab.getE05WRTBNK().trim()%>" >
              </div>
            </td>
            <td nowrap width="10%" > 
              <div align="right"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2">Nuestra 
                Referencia:</font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></div>
            </td>
            <td nowrap colspan="3" > 
              <div align="left"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2"> 
                ...
                <input type="text" readonly name="E05WRTORF" size="18" maxlength="16" value="<%= inqContab.getE05WRTORF().trim()%>" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="21%">
              <input type="text" readonly size="10" maxlength="7" name="E05SCHNUM" value="<%= inqContab.getE05SCHNUM().trim()%>">
            </td>
            <td nowrap width="8%"> 
              <div align="right"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2">Numero Lote:</font></font></font></font></font></font></font></font></font></font></font></font></div>
            </td>
            <td nowrap width="21%" colspan="3"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2">
              <input type="text" readonly name="E05WRTBTH" size="6" maxlength="5" value="<%= inqContab.getE05WRTBTH().trim()%>" >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2"><font face="Arial"><font face="Arial"><font size="2"> 
              </font></font></font></font></font></font></font></font></font><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2"> 
              <input type="text" readonly name="E05WRTBYO" size="60" maxlength="60" value="<%= inqContab.getE05WRTBYO().trim()%>" >
            ...
            <td nowrap width="10%"><font face="Arial"><font face="Arial"><font size="2"> 
				...
				<eibsinput:date name="inqContab" fn_year="E05INSDTY" fn_month="E05INSDTM" fn_day="E05INSDTD" />
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="21%">
              <input type="text" readonly name="E05WRTDS1" size="60" maxlength="60" value="<%= inqContab.getE05WRTDS1().trim()%>" >
            </td>
            <td nowrap width="10%"> 
              <div align="right"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2">Contrato 
            ...
            <td nowrap width="11%"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2">
	           Tasa Relaci&oacute;n:</font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></font></td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="21%">
              <input type="text" readonly name="E05WRTDS2" size="60" maxlength="60" value="<%= inqContab.getE05WRTDS2().trim()%>" >
            </td>
            <td nowrap width="10%">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="21%"><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2">
              <input type="text" readonly name="E05WRTDS3" size="60" maxlength="60" value="<%= inqContab.getE05WRTDS3().trim()%>" >
              </font></font></font></font></font></td>
            <td nowrap width="10%">
      ...
      <td nowrap width="50%"> 
        <table cellspacing=0 cellpadding=2 border="0" width="100%">
          ...
          <tr id="trdark"> 
            <td nowrap width="30%"  > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTDBK" size="3" maxlength="2" value="<%= inqContab.getE05WRTDBK().trim()%>" >
                / 
                <input type="text" readonly name="E05WRTDBR" size="5" maxlength="4" value="<%= inqContab.getE05WRTDBR().trim()%>" >
                / 
                <input type="text" readonly name="E05WRTDCY" size="4" maxlength="3" value="<%= inqContab.getE05WRTDCY().trim()%>" >
              </div>
            </td>
            <td nowrap width="29%"  > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTDGL2" size="17" maxlength="16" value="<%= inqContab.getE05WRTDGL().trim()%>" >
              </div>
            </td>
            <td nowrap width="41%" > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTDAC" size="13" maxlength="12" value="<%= inqContab.getE05WRTDAC().trim()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="30%"  > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTDSU" size="6" maxlength="5" value="<%= inqContab.getE05WRTDSU().trim()%>" >
              </div>
            </td>
            <td nowrap width="29%"  > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTDCT" size="9" maxlength="8" value="<%= inqContab.getE05WRTDCT().trim()%>" >
              </div>
            </td>
            <td nowrap width="41%" bordercolor="#000000" > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTDAM" size="16" maxlength="15" value="<%= inqContab.getE05WRTDAM().trim()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            <td nowrap colspan="3" > 
              <input type="text" readonly name="E05WRTDDS" size="60" maxlength="60" value="<%= inqContab.getE05WRTDDS().trim()%>" >
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap colspan="3"  > 
      ...
      <td nowrap width="50%" > 
        <table cellspacing=0 cellpadding=2 border="0" width="100%">
          ...
          <tr id="trdark"> 
            <td nowrap width="25%" > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTCBK" size="3" maxlength="2" value="<%= inqContab.getE05WRTCBK().trim()%>" >
                / 
                <input type="text" readonly name="E05WRTCBR" size="5" maxlength="4" value="<%= inqContab.getE05WRTCBR().trim()%>" >
                / 
                <input type="text" readonly name="E05WRTCCY" size="4" maxlength="3" value="<%= inqContab.getE05WRTCCY().trim()%>" >
              </div>
            </td>
            <td nowrap width="24%"  > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTCGL" size="17" maxlength="16" value="<%= inqContab.getE05WRTCGL().trim()%>" >
              </div>
            </td>
            <td nowrap width="51%"  > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTCAC" size="13" maxlength="12" value="<%= inqContab.getE05WRTCAC().trim()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="25%" > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTCSU" size="6" maxlength="5" value="<%= inqContab.getE05WRTCSU().trim()%>" >
              </div>
            </td>
            <td nowrap width="24%"  > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTCCT" size="9" maxlength="8" value="<%= inqContab.getE05WRTCCT().trim()%>" >
              </div>
            </td>
            <td nowrap width="51%"  > 
              <div align="left"> 
                <input type="text" readonly name="E05WRTCAM" size="16" maxlength="15" value="<%= inqContab.getE05WRTCAM().trim()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            <td nowrap colspan="3"  > 
              <input type="text" readonly name="E05WRTCDS" size="60" maxlength="60" value="<%= inqContab.getE05WRTCDS().trim()%>" >
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap colspan="3"  > 
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td nowrap colspan="8" > 
              <input type="text" readonly name="E02DEABAP2542" size="60" maxlength="60" >
            </td>
            <td nowrap width="17%" > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="6%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC1B" size="3" maxlength="2" value="<%= inqContab.getE05WRTC1B().trim()%>" >
              </div>
            </td>
            <td nowrap width="8%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC1S" size="5" maxlength="4" value="<%= inqContab.getE05WRTC1S().trim()%>" >
              </div>
            </td>
            <td nowrap width="9%" > 
              <div align="center"> 
                <input type="text" readonly size="4" maxlength="3" value="<%= inqContab.getE05WRTC1Y().trim()%>" name="E05WRTC1Y" >
              </div>
            </td>
            <td nowrap width="16%" > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="6%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC2B" size="3" maxlength="2" value="<%= inqContab.getE05WRTC2B().trim()%>" >
              </div>
            </td>
            <td nowrap width="8%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC2S" size="5" maxlength="4" value="<%= inqContab.getE05WRTC2S().trim()%>" >
              </div>
            </td>
            <td nowrap width="9%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC2Y" size="4" maxlength="3" value="<%= inqContab.getE05WRTC2Y().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%" > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="6%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC3B" size="3" maxlength="2" value="<%= inqContab.getE05WRTC3B().trim()%>" >
              </div>
            </td>
            <td nowrap width="8%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC3S" size="5" maxlength="4" value="<%= inqContab.getE05WRTC3S().trim()%>" >
              </div>
            </td>
            <td nowrap width="9%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC3Y" size="4" maxlength="3" value="<%= inqContab.getE05WRTC3Y().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%" > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="6%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC4B" size="3" maxlength="2" value="<%= inqContab.getE05WRTC4B().trim()%>" >
              </div>
            </td>
            <td nowrap width="8%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC4S" size="5" maxlength="4" value="<%= inqContab.getE05WRTC4S().trim()%>" >
              </div>
            </td>
            <td nowrap width="9%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC4Y" size="4" maxlength="3" value="<%= inqContab.getE05WRTC4Y().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%" > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="6%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC5B" size="3" maxlength="2" value="<%= inqContab.getE05WRTC5B().trim()%>" >
              </div>
            </td>
            <td nowrap width="8%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC5S" size="5" maxlength="4" value="<%= inqContab.getE05WRTC5S().trim()%>" >
              </div>
            </td>
            <td nowrap width="9%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC5Y" size="4" maxlength="3" value="<%= inqContab.getE05WRTC5Y().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%" > 
              <div align="center"> 
          ...
          <tr id="trclear">
            <td nowrap width="6%" > 
              <div align="center">
                <input type="text" readonly name="E05WRTC6B25536" size="3" maxlength="2" value="<%= inqContab.getE05WRTC6B().trim()%>" >
              </div>
            </td>
            <td nowrap width="8%" > 
              <div align="center">
                <input type="text" readonly name="E05WRTC6S" size="5" maxlength="4" value="<%= inqContab.getE05WRTC6S().trim()%>" >
              </div>
            </td>
            <td nowrap width="9%" > 
              <div align="center">
                <input type="text" readonly name="E05WRTC6Y" size="4" maxlength="3" value="<%= inqContab.getE05WRTC6Y().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%" > 
              <div align="center">
          ...
          <tr id="trclear"> 
            <td nowrap width="6%" > 
              <div align="center">
                <input type="text" readonly name="E05WRTC7B62" size="3" maxlength="2" value="<%= inqContab.getE05WRTC7B().trim()%>" >
              </div>
            </td>
            <td nowrap width="8%" > 
              <div align="center">
                <input type="text" readonly name="E05WRTC7S" size="5" maxlength="4" value="<%= inqContab.getE05WRTC7S().trim()%>" >
              </div>
            </td>
            <td nowrap width="9%" > 
              <div align="center"> 
                <input type="text" readonly name="E05WRTC7Y" size="4" maxlength="3" value="<%= inqContab.getE05WRTC7Y().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%" > 
              <div align="center">
