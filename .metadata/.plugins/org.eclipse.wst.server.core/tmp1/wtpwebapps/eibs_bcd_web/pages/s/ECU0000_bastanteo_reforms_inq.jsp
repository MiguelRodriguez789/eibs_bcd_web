...
<H3 align="center">Sistema de Bastanteo - Consulta de Reformas Documento Constitutivo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_reforms_inq,ECU0000"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E04CURRD1" readonly size="3" maxlength="2" value="<%= msgMT.getE04CURRD1() %>">
	      	<input type="text" name="E04CURRD2" readonly size="3" maxlength="2" value="<%= msgMT.getE04CURRD2() %>">
	      	<input type="text" name="E04CURRD3" readonly size="5" maxlength="4" value="<%= msgMT.getE04CURRD3() %>">
	      </td>     
      	</tr>
    	<tr id=trclear> 
	      <td nowrap >
     	...
     	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E04CURRE1" size="3" maxlength="2" readonly value="<%= msgMT.getE04CURRE1() %>">
	      	<input type="text" name="E04CURRE2" size="3" maxlength="2" readonly value="<%= msgMT.getE04CURRE2() %>">
	      	<input type="text" name="E04CURRE3" size="5" maxlength="4" readonly value="<%= msgMT.getE04CURRE3() %>">
      	  </td>     
      	</tr>
     	<tr id=trclear> 
	      <td nowrap >
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E04CUROBS" size="90" maxlength="80" readonly value="<%= msgMT.getE04CUROBS().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%">
