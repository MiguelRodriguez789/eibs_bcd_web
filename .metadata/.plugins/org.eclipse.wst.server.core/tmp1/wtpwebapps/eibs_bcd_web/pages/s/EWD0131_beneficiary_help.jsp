...
//	form[top.opener.fieldName].value = customer;
  	if (isValidObject(form[top.opener.fieldAux1])) form[top.opener.fieldAux1].value = acc;
  	if (isValidObject(form[top.opener.fieldAux2])) form[top.opener.fieldAux2].value = bad1;
  	if (isValidObject(form[top.opener.fieldAux3])) form[top.opener.fieldAux3].value = bad2;
  	if (isValidObject(form[top.opener.fieldAux4])) form[top.opener.fieldAux4].value = bad3;
  	if (isValidObject(form[top.opener.fieldAux5])) form[top.opener.fieldAux5].value = bkid;
   	if (isValidObject(form[top.opener.fieldAux6])) form[top.opener.fieldAux6].value = bka1;
   	if (isValidObject(form[top.opener.fieldAux7])) form[top.opener.fieldAux7].value = bka2;
   	if (isValidObject(form[top.opener.fieldAux8])) form[top.opener.fieldAux8].value = bka3;
   	if (isValidObject(form[top.opener.fieldAux9])) form[top.opener.fieldAux9].value = bka4;
   	if (isValidObject(form[top.opener.fieldAux10])) form[top.opener.fieldAux10].value = ibid;
   	if (isValidObject(form[top.opener.fieldAux11])) form[top.opener.fieldAux11].value = iba1;
   	if (isValidObject(form[top.opener.fieldAux12])) form[top.opener.fieldAux12].value = iba2;
   	if (isValidObject(form[top.opener.fieldAux13])) form[top.opener.fieldAux13].value = iba3;
   	if (isValidObject(form[top.opener.fieldAux14])) form[top.opener.fieldAux14].value = iba4;
	top.close();
}
...
<form>
  ...
  <h3 align="center">Lista de Beneficiarios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="beneficiary_help.jsp,EWD0131"> 
  </h3>
<hr size="4">
