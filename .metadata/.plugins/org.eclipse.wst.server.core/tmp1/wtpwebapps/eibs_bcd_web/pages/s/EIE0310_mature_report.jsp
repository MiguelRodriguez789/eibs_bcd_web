...
<BODY>
<h3 align="center">Reporte Pr&oacute;ximo Evento - Vencimiento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="mature_report.jsp, EIE0310"></h3>
<hr size="4">
        ...
        <table id="headTable" width="100%" >
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap >Monto a<br>
              Pagar</th>
            <th align=CENTER nowrap > 
              <div align="center">Ultima
                Tasa <br>de Cambio</div>
            </th>
			<th align=CENTER nowrap > 
    ...
    <TR> 
      <TD WIDTH="50%" ALIGN=LEFT> <%
        if ( EIE0310Help.getShowPrev() ) {
      			...
      			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.invest.JSEIE0310?SCREEN=1&Pos=" + pos +"\"><IMG border=\"0\" src=\""+request.getContextPath()+"/images/s/previous_records.gif\" ></A>");
        }
   %> </TD>
      <TD WIDTH="50%" ALIGN=RIGHT> <% 
        if ( EIE0310Help.getShowNext() ) {
      			int pos = EIE0310Help.getLastRec();
      			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.invest.JSEIE0310?SCREEN=1&Pos=" + pos +"\"><IMG border=\"0\" src=\""+request.getContextPath()+"/images/s/next_records.gif\" ></A>");
        }
  %> </TD>
    </TR>
  </TABLE>
