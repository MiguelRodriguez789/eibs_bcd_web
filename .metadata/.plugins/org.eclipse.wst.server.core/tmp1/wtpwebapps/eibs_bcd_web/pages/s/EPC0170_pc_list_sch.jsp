...
<HTML>
<HEAD>
<TITLE>Historia de Valuaciones</TITLE>
...
function goAction(op) {
 ...
 var page="";
 if (op == 1) {
     page = '${pageContext.request.contextPath}/pages/s/EPC0170_pc_new_sch.jsp?LASTROW=' + document.forms[0].LASTROW.value;
 } else if (op == 2) {
     page = '${pageContext.request.contextPath}/pages/s/EPC0170_pc_inq_sch.jsp?ROW=' + document.forms[0].ROW.value; 
 } else if (op == 4) {     
     page = '${pageContext.request.contextPath}/pages/s/EPC0170_pc_delete_sch.jsp?ROW=' + document.forms[0].ROW.value; 
 } else if (op == 5) {     
     page = '${pageContext.request.contextPath}/pages/s/EPC0170_pc_sale_sch.jsp?ROW=' + document.forms[0].ROW.value; 
 }
...
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEPC0170">
<INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="2">
<INPUT TYPE=HIDDEN NAME="OPT" VALUE="3">
<INPUT TYPE=HIDDEN NAME="ROW" VALUE="0">
<INPUT TYPE=HIDDEN NAME="LASTROW" VALUE="1">

<h3 align="center">Historia de Valuaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_list_sch.jsp,EPC0170"> 
</h3>
<hr size="4">
 ...
 <TR> 
   <TD NOWRAP valign="top" width="100%">
    ...
    <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER nowrap>Fecha Valuación</TH>      
      <TH ALIGN=CENTER nowrap>Valor Valuación</TH>      
      <TH ALIGN=CENTER nowrap>Valor Deducción</TH>            
      <TH ALIGN=CENTER nowrap>Neto a Cobrar</TH>                  
    </TR>
    </TABLE>
     ...
     %> 
            <TR> 
              <TD ALIGN=CENTER NOWRAP> 
                ...
                onClick="showInfo(<%= extList.getCurrentRow() %>,'<%=msgPC.getE01PCVNUM()%>')">
             </TD>
              <TD ALIGN=CENTER NOWRAP><%= Util.formatCell(msgPC.getE01PCVNUM()) %></TD>
              <TD ALIGN=CENTER NOWRAP><%= Util.formatDate(msgPC.getE01PCVVLM(),msgPC.getE01PCVVLD(),msgPC.getE01PCVVLY()) %></TD> 
              <TD ALIGN=RIGHT NOWRAP><%= Util.formatCell(msgPC.getE01PCVVAL()) %></TD>              
              <TD ALIGN=RIGHT NOWRAP><%= Util.formatCell(msgPC.getE01PCVDED()) %></TD>              
              <TD ALIGN=RIGHT NOWRAP><%= Util.formatCell(msgPC.getE01PCVINC()) %></TD>              
             </TR>
      <%              
		}
    %>
