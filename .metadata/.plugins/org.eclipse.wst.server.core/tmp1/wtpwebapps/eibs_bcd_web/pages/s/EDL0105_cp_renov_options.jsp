...
%> 
<h3 align="center">Intrucciones de Pago  (Renovación)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cp_renov_options,EDL0105"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" onkeypress="enterInteger(event)" name="E08DEACUN" size="10" maxlength="9" readonly value="<%= userPO.getHeader2().trim()%>">
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" onkeypress="enterInteger(event)" name="E08CUSNA1" size="45" maxlength="45" readonly value="<%= userPO.getHeader3().trim()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" onkeypress="enterInteger(event)" name="E08DEAACC" size="13" maxlength="12" value="<%= userPO.getIdentifier().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
        ...
        <table cellpadding=2 cellspacing=0 align=center width=100% bordercolor="#000000">
          <tr id="trdark"> 
            ...
            <td height="46" colspan="2" > Opción de Cancelación. Principal e Intereses serán pagados a la Cuenta Contable <INPUT
					type="text" onkeypress="enterInteger(event)" name="E08DDDGLN" size="16"
              ...
              <A
					...
					align="bottom" border="0"></A><input type="hidden" name="E08DDDFLV" value="">. </td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
            <td colspan="2" >&nbsp;</td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" > 
              <p>Interés será pagado en
                <input type="text" onkeypress="enterInteger(event)" name="E08HHHROY" size="3" maxlength="3" value="<%= cdRenov.getE08HHHROY().trim()%>">
                ...
                <INPUT type="text" onkeypress="enterInteger(event)"
                ...
                <A
					...
					src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"
					align="bottom" border="0"></A>. El principal será renovado por el mismo periodo de tiempo.</p>
            </td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" > Interés será pagado en   
              <input type="text" onkeypress="enterInteger(event)" name="E08IIIROY" size="3" maxlength="3" value="<%= cdRenov.getE08IIIROY().trim()%>">
              ...
              <A
					...
					src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"
					align="bottom" border="0"></A>. El principal será renovado por el mismo periodo de tiempo.</td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
            <td colspan="2" >&nbsp;</td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" >El Principal e Interés será pagado basado en una cronograma de pago 
              <a href="javascript:document.forms[0].typeS.click();showCDPayMaint()"><img src="<%=request.getContextPath()%>/images/eibs_deducciones.gif" title="Payment Plan" align="middle" border="0" ></a> 
              ...
              <A
					...
					src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"
					align="bottom" border="0"></A>, o a la Cuenta de Detalle <INPUT
					type="text" onkeypress="enterInteger(event)" name="E08SSSACC" size="12"
