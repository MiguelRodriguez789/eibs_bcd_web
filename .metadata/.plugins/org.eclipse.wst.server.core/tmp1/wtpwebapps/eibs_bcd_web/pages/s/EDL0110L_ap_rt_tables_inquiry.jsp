...
<h3 align="center">Tasas L&iacute;der Aprobaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_tables_maint,EDL0110L" ></h3>
<hr size="4">
            ...
            <td nowrap width="31%"> 
              <div align="left">  
				<%= Util.formatCustomDate(currUser.getE01DTF(),
										rates.getBigDecimalE02PRREFM().intValue(),
										rates.getBigDecimalE02PRREFD().intValue(), 
										rates.getBigDecimalE02PRREFY().intValue())%>        
              </div>  
            </td>
          </tr>       
          <tr id="trclear"> 
