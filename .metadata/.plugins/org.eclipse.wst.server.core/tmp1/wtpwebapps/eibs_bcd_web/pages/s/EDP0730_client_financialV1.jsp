...
function showGrpAcc(flg,idxRow){
  ...
  try {
  	...
  	adjustEquTables(headTable2, getElement("dataAccTable"+flg), getElement("dataDiv2"),1,false);
	...
	<TR>
		...
		<TABLE id="headTable" width="100%" cellpading=0 cellspacing=0>
			...
			<tr id="trclear">
				...
				<td align="right">
				<b>F.Vencmto.:</b>
					<eibsinput:date name="mL0730" fn_month="E01DPBFVM" fn_day="E01DPBFVD" fn_year="E01DPBFVA" readonly="true" />
				<br>
