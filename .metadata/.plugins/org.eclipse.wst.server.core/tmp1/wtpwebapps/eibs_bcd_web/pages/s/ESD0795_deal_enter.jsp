...
<H3 align="center">Consulta de Convenios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="deal_enter.jsp, ESD0795"></H3>

<hr size="4">
<p>&nbsp;</p>

<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0795" onsubmit="return(enterCode());">
  <p> 
      ...
      <td width="50%"> 
        <div align="left"> 
          <input type="text" name="E01COTCDE" size="5" maxlength="4" value="<%= deal.getE01COTCDE().trim()%>">
            <a href="javascript:GetCodeDescDeal('E01COTCDE','E01COTDES')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
