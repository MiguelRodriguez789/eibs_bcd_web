...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_customers_maint_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE02CUMAC1(),msgMT.getE02CUMAC2(),msgMT.getE02CUMAC3())  + " - " + msgMT.getE02CUMACT()%></TD>
