...
de Tarjetas de Débito<BR>Reemplazo de Tarjeta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="card_replace.jsp, ECC0090"></h3>
<hr size="4">
<% 
