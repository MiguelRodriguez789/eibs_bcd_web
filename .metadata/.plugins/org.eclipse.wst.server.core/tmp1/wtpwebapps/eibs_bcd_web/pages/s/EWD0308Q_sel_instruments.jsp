...
<BODY>
<h3 align="center">Mantenimiento de Instrumentos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_instruments.jsp, EWD0308Q"></h3>
<hr size="4">
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      <td class=TDBKG width="52%"> 
        <div align="center"><a href="javascript:goAction(2)"><b>Seleccione el Instrumento</b></a></div>
      </td>
