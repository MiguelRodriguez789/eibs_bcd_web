...
<H3 align="center">Sistema de Bastanteo - Creacion de Cuentas Jur&iacute;dicas Relacionadas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_accounts_new,ECU0000"></H3>
<hr size="4">
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E03CRLOBS" size="90" maxlength="80" value="<%= msgAcc.getE03CRLOBS().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%">
