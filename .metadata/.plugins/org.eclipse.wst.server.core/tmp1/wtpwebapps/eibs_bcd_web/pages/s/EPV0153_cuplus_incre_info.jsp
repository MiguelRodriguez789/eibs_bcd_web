...
<html>
<head>
<title> Credilinea Basic Information for Desmbolso</title>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=ISO-8859-1">
<link Href="<%=request.getContextPath()%>/pages/style.css" rel="stylesheet">

<jsp:useBean id="RecData" class="datapro.eibs.beans.EPV015305Message"  scope="session" />
...
<h3 align="center"> Aumento/Disminucion - L&iacute;nea Cr&eacute;dito:  <%=RecData.getE05DSCPRO()%>
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cuplus_incre_info.jsp, EPV0153">
</h3>
<hr size="4">
