...
<html>
<head>
<title>Confirmacion Creación Garantía</title>
...
<script type="text/javascript">
 function finish(){
<%--
  self.window.location.href = "<%=request.getContextPath()%>/pages/s/ERA0050_ga_basic.jsp";
--%>
...
%> 
<h3 align="center">Garantias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_confirm.jsp,ERA0050"></h3> 
<hr size="4">
