...
<BODY>
<h3 align="center">Listado de Comisionistas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="brk_list.jsp,EDL0370"> 
</h3>
<hr size="4">
...
%>
  ...
  <TABLE class="tableinfo" style="width:95%" ALIGN=CENTER>
    ...
    %>
        <TR> 
			<TD ALIGN=center NOWRAP><div><a href="javascript:enter('<%= brkList.getCurrentRow() %>')"><%= brkList.getRecord(4) %></a></DIV></TD>
			<TD ALIGN=LEFT NOWRAP><div><a href="javascript:enter('<%= brkList.getCurrentRow() %>')"><%= brkList.getRecord(9) %></a></DIV></TD>      
			<TD ALIGN=center NOWRAP><div><a href="javascript:enter('<%= brkList.getCurrentRow() %>')"><%= brkList.getRecord(5) %></a></DIV></TD>
			<TD ALIGN=center NOWRAP><div><a href="javascript:enter('<%= brkList.getCurrentRow() %>')"><%= brkList.getRecord(6) %></a></DIV></TD>
			<TD ALIGN=center NOWRAP><div><a href="javascript:enter('<%= brkList.getCurrentRow() %>')">
