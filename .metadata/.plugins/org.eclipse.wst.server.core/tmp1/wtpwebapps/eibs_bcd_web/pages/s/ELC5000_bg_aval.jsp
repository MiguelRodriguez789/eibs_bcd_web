...
%>
<h3 align="center">Ingreso de Avales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bg_aval.jsp,ELC5000"></h3>
<hr size="4">
   ...
   <td>
	...
	<tr id=trdark>
       ...
       <td>
            ...
            <a href="javascript:GetCustomerDescId('E02CUMRCN','E02CUMMA1','E02CUMBNI')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a>
       </td>
    <tr id=trdark>
       <td width=40% align=right>Rut :</td>
       <td>
         	<INPUT size="28" type="text" name="E02CUMBNI" maxlength="25" value="<%= msgAval.getE02CUMBNI() %>" readonly>
        </td>
  	<tr id=trclear>
