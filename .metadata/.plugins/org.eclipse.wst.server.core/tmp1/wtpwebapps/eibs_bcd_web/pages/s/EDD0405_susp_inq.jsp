...
<h3 align="center">Suspensiones de Pagos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="susp_inq.jsp,EDD0405"></h3>
<hr size="4">
  ...
  <TABLE class="tableinfo">
    ...
    <TR>
		...
		<TD NOWRAP ALIGN=CENTER><%=Util.formatCustomDate(currUser.getE01DTF(),
				msgList.getBigDecimalE01STPDTM().intValue(),
				msgList.getBigDecimalE01STPDTD().intValue(),
				msgList.getBigDecimalE01STPDTY().intValue())%></TD>
		<TD NOWRAP ALIGN=CENTER><%=Util.formatCell(msgList.getE01STPTIM())%></TD>
		<TD NOWRAP><%=Util.formatCell(msgList.getE01STPUSR())%></TD>
		<TD NOWRAP><%=Util.formatCell(msgList.getE01STPSTS())%></TD>
		<TD NOWRAP ALIGN=CENTER><%=Util.formatCustomDate(currUser.getE01DTF(),
				msgList.getBigDecimalE01STPRDM().intValue(),
				msgList.getBigDecimalE01STPRDD().intValue(),
				msgList.getBigDecimalE01STPRDY().intValue())%></TD>
		<TD NOWRAP ALIGN=CENTER><%=Util.formatCell(msgList.getE01STPRTM())%></TD>
