...
<jsp:useBean id= "EDD400201Help" class= "datapro.eibs.beans.JBObjList"  scope="session" />
...
<BODY>
<h3 align="center">Transacciones en Cuentas de Compañias (Pensiones/Nómina/FMH)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="interface_list.jsp, EDD4002"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEDD4002" >
  <p> 
	...
	<tr id="trdark"> 
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          ...
          <a href="javascript:GetCodeDescCNOFC('E01DDCCIA','','BT')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
        </div>
      </td>
    </tr>
   <tr id="trclear">
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
        ...
        <div align="center"><a href="javascript:goAction(2)"><b>Transacciones</b></a></div>
      </td>
      <td class=TDBKG width="30%"> 
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          ...
          <%
				...
				String chk = "";
                EDD400201Help.initRow();
                while (EDD400201Help.getNextRow()) {
					if (firstTime) {
						firstTime = false;
						chk = "checked";
					} else {
                  ...
                  datapro.eibs.beans.EDD400201Message msgList = (datapro.eibs.beans.EDD400201Message) EDD400201Help.getRecord();
		 %>
          <tr> 
            <td NOWRAP  align=CENTER width="10%"> 
              <input type="radio" name="CURRCODE" value="<%= EDD400201Help.getCurrentRow() %>" <%=chk%> >
            </td>
