...
{
	page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSECD0003?SCREEN=113&ROW=" + rowNum;
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_inv_stock_list.jsp , ECD0003">
</h3>
<hr size="4">
 ...
 <TR > 
    <TD NOWRAP valign="top" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE03CDRMIN())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE03CDRMAX())%></TD>
		</TR>    		
    	<%}%>    
        </table>
    </table>
