...
function enter(seq,nam,job) {
	var form = top.opener.document.forms[0];
 	if (isValidObject(form[top.opener.fieldSeq])) form[top.opener.fieldSeq].value = seq;
 	if (isValidObject(form[top.opener.fieldName])) form[top.opener.fieldNam].value = nam;
 	if (isValidObject(form[top.opener.fieldJob])) form[top.opener.fieldJob].value = job;
 	top.close();
}
//-->
</script>
