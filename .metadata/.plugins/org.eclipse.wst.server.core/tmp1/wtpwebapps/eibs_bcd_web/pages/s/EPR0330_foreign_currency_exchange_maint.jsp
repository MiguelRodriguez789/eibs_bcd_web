...
function checkFieldChange(oldvalue,newvalue) {
	if (oldvalue.toLowerCase() != newvalue.toLowerCase()) {
		document.getElementById("H02FLGWK2").value = "1";
	}
}

function goAction(opt) {
	document.getElementById("H02FLGWK1").value = opt;
...
<H3 align="center">Modificacion de Solicitudes de Compraventa de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_maint, EPR0330"></H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEPR0330">
  ...
  <INPUT TYPE=HIDDEN NAME="H02FLGWK1" id="H02FLGWK1" VALUE="V">
  <INPUT TYPE=HIDDEN NAME="H02FLGWK2" id="H02FLGWK2" value="<%= msgInst.getH02FLGWK2() %>">
    	...
    	<td>
    		<table cellspacing=0 cellpadding=2 width="100%" border="0">
    			<tr id=trdark> 
	      			...
	      			<td nowrap width="60%"> 
	        			<input type="text" name="E02REQREF" id="E02REQREF" readonly size="15" maxlength="15" value="<%= msgInst.getE02REQREF() %>">
	      			</td>
     			</tr>    
     			<tr id=trclear> 
	      			<td nowrap> 
	      			...
	      			<td nowrap>
	      				<select name="E02REQOPC" id="E02REQOPC">
     			...
     			<tr id=trdark> 
	      			...
	      			<td nowrap width="60%"> 
	        			<input type="text" name="E02REQBNK" id="E02REQBNK" size="3" maxlength="2" value="<%= msgInst.getE02REQBNK() %>" readonly >
	     	 		</td>
     			</tr>
     			<tr id=trclear> 
	      			<td nowrap> 
	      			...
	      			<td nowrap>
	      				<input type="text" name="E02REQBRN" size="5" maxlength="4" value="<%= msgInst.getE02REQBRN() %>" readonly >
		  			</td>
     			</tr>
     			<tr id=trdark> 
	      			<td nowrap> 
	      			...
	      			<td nowrap>
	      				<input type="text" name="E02REQINS" id="E02REQINS" size="5" maxlength="4" value="<%= msgInst.getE02REQINS() %>" 
	      						onChange="checkFieldChange('<%=msgInst.getE02REQINS()%>',document.getElementById('E02REQINS').value)"
	      						onselect="checkFieldChange('<%=msgInst.getE02REQINS()%>',document.getElementById('E02REQINS').value)">
     			...
     			<tr id=trclear> 
		  			<td> 
      	  			...
      	  			<td nowrap> 
      	    			<input type="text" name="E02REQCCY" id="E02REQCCY" size="5" maxlength="3" value="<%= msgInst.getE02REQCCY() %>" 
      	    				onChange="checkFieldChange('<%=msgInst.getE02REQCCY()%>',document.getElementById('E02REQCCY').value)" 
      	    				onselect="checkFieldChange('<%=msgInst.getE02REQCCY()%>',document.getElementById('E02REQCCY').value)" >
      	    			<a href="javascript:GetInstCurrency('E02REQCCY',document.getElementById('E02REQBNK').value,document.getElementById('E02REQINS').value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    			<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
      	  			</td>     
      			</tr>
      			<tr id=trdark>
          			...
          			<td nowrap>
             			<input type="text" name="E02REQCUS" id="E02REQCUS" size="10" maxlength="9" value="<%= msgInst.getE02REQCUS() %>" 
              				onChange="checkFieldChange('<%=msgInst.getE02REQCUS()%>',document.getElementById('E02REQCUS').value)"
              				onselect="checkFieldChange('<%=msgInst.getE02REQCUS()%>',document.getElementById('E02REQCUS').value)">
    	...
    	<td>
    		<table cellspacing=0 cellpadding=2 width="100%" border="0">    
				<tr>
					...
					<td nowrap width="60%">
						<input type="text" name="E02REQOPR" id="E02REQOPR" size="5" maxlength="4" value="<%= msgInst.getE02REQOPR() %>" 
							onChange="checkFieldChange('<%=msgInst.getE02REQOPR()%>',document.getElementById('E02REQOPR').value)"
							onselect="checkFieldChange('<%=msgInst.getE02REQOPR()%>',document.getElementById('E02REQOPR').value)"> 
						<input type="text"  name="E02REQORN" size="35" maxlength="35" value="<%= msgInst.getE02REQORN() %>" readonly>
						<a href="javascript:GetCodeDescCNOFC('E02REQOPR','E02REQORN',document.getElementById('E02REQOPC').value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
						<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">
					</td>
				</tr>
				<tr>
					...
					<td nowrap width="60%">
						<input type="text" name="E02REQCOR" id="E02REQCOR" size="10" maxlength="9" value="<%= msgInst.getE02REQCOR() %>" 
							onChange="checkFieldChange('<%=msgInst.getE02REQCOR()%>',document.getElementById('E02REQCOR').value)"
							onselect="checkFieldChange('<%=msgInst.getE02REQCOR()%>',document.getElementById('E02REQCOR').value)"> 
				...
				<tr>
					...
					<td nowrap width="60%">
						<input type="text" name="E02REQAAD" id="E02REQAAD" size="12" maxlength="10" value="<%= msgInst.getE02REQAAD() %>" 
							onChange="checkFieldChange('<%=msgInst.getE02REQAAD()%>',document.getElementById('E02REQAAD').value)"
							onselect="checkFieldChange('<%=msgInst.getE02REQAAD()%>',document.getElementById('E02REQAAD').value)"> 
					</td>
				</tr>
				<tr>
					<td nowrap width="40%">
					...
					<td nowrap width="60%">
						<input type="text" name="E02REQALD" id="E02REQALD" size="12" maxlength="10" value="<%= msgInst.getE02REQALD() %>" 
							onChange="checkFieldChange('<%=msgInst.getE02REQALD()%>',document.getElementById('E02REQALD').value)"
							onselect="checkFieldChange('<%=msgInst.getE02REQALD()%>',document.getElementById('E02REQALD').value)"> 
					</td>
				</tr>
				<tr>
					<td nowrap width="40%">
					...
					<td nowrap width="60%">
                		<input type="text" name="E02REQVD1" id="E02REQVD1" size="3" maxlength="2" value="<%= msgInst.getE02REQVD1() %>">
                		<input type="text" name="E02REQVD2" id="E02REQVD2" size="3" maxlength="2" value="<%= msgInst.getE02REQVD2() %>">
                		<input type="text" name="E02REQVD3" id="E02REQVD3" size="5" maxlength="4" value="<%= msgInst.getE02REQVD3() %>">
						<a href="javascript:DatePicker(document.getElementById('E02REQVD1'), document.getElementById('E02REQVD2'), document.getElementById('E02REQVD3'))"><img src="<%=request.getContextPath()%>/images/calendar.gif" title=". . ." align="bottom" border="0" ></a>
					</td>
				</tr>
     		</table>
    	</td>
   		...
   		<td>
    		<table cellspacing=0 cellpadding=2 width="100%" border="0">    
				<tr>
					...
					<td nowrap width="60%">
						<input type="text" name="E02REQFEA" id="E02REQFEA" size="15" maxlength="15" value="<%= msgInst.getE02REQFEA() %>" onchange="checkFieldChange('<%=msgInst.getE02REQFEA()%>',document.getElementById('E02REQFEA').value)" 
						onselect="checkFieldChange('<%=msgInst.getE02REQFEA()%>',document.getElementById('E02REQFEA').value)">
						<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
					</td>
				</tr>
				<tr>
					...
					<td nowrap width="60%">
						<input type="text" name="E02REQEXR" id="E02REQEXR" size="20" maxlength="15" value="<%= msgInst.getE02REQEXR() %>" onChange="checkFieldChange('<%=msgInst.getE02REQEXR()%>',document.getElementById('E02REQEXR').value)" 
						onselect="checkFieldChange('<%=msgInst.getE02REQEXR()%>',document.getElementById('E02REQEXR').value)"> 
					</td>
				</tr>
				<tr>
					<td nowrap width="40%">
				...
				<tr>
					...
					<td nowrap width="60%">
						...
						<a href="javascript:GetComission(document.getElementById('E02REQREF').value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
						<%}%> 
					</td>
				</tr>
				<tr>
   				...
   				<tr id="trclear" align="center"> 
      				...
      				<td nowrap> 
          				<div align="center"> 
            				 ...
            				 class="context-menu-help" onmousedown="init(branchHelp,this.name,document.getElementById('E02REQBNK').value,'','','','')">
         				</div>
       				</td>
       				<td nowrap> 
          				<div align="center"> 
             				<input type="text" name="E02OFFCY1" size="3" maxlength="3" value="<%= msgInst.getE02OFFCY1() %>"
             				class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.getElementById('E02REQBNK').value,'','','','')">
          				</div>
       				</td>
       				<td nowrap > 
          				<div align="center"> 
             				<input type="text" name="E02OFFAC1" size="13" maxlength="12"  value="<%= msgInst.getE02OFFAC1() %>"
            				class="context-menu-help" onmousedown="init(lnreferHelp,this.name,document.getElementById('E02REQBNK').value,'',document.getElementById('E02REQCUS').value,'','RX')">
          				</div>
       				</td>
       				<td nowrap > 
          				<div align="center"> 
      			...
      			<tr id="trdark" align="center"> 
      				<td nowrap > 
          				<div align="center" > 
          					...
          					class="context-menu-help" onmousedown="init(conceptHelp,this.name, document.getElementById('E02REQBNK').value, document.getElementById('E02OFFCY2').value,'E02OFFGL2','E02OFFOP2','34')">
          				</div>
      				</td>
      				<td nowrap > 
          				<div align="center"> 
      				...
      				<td nowrap> 
       				...
       				<td nowrap> 
          				<div align="center"> 
             				...
             				class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.fgetElementById('E02REQBNK').value,'','','','')">
          				</div>
       				</td>
       				<td nowrap > 
          				<div align="center"> 
