...
de Tarjetas de Débito<BR>Consulta de Tarjeta Titular<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="assign_accounts_info.jsp, ECC0090"></h3>
<hr size="4">
<% 
