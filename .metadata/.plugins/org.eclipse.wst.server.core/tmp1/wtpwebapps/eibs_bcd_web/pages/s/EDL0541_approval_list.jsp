...
<HTML>
<HEAD>
<TITLE>Aprobacion de Incumplimientos</TITLE>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=ISO-8859-1">
<META name="GENERATOR" content="IBM WebSphere Studio">
<link href="<%=request.getContextPath()%>/pages/style.css" rel="stylesheet">

<jsp:useBean id= "searchParameters" class= "datapro.eibs.beans.EDL054101Message"  scope="session" />
...
<script type="text/javascript">
  var reason = '';
	...
	function showInqApprovalInc(ref){
		var SCREEN = "12";
		var E01CUSCUN = ref;
		var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0519?SCREEN="+SCREEN+"&E01CUSCUN="+E01CUSCUN;
...
<h3 align="center"> Aprobación de Incumplimientos</h3>
<hr size="4">


<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0541" >
