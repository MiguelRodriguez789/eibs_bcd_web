...
<h3 align="center">Manejo de Clientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_both_enter, EPV5000"></h3>
<hr size="4">
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.credprop.JSEPV5000" >
	...
	<tr>
      <td align="center"> Ingrese el N&uacute;mero de Identificaci&oacute;n : 
        ...
        <a href="javascript:GetCustomerDescId('CLIENCODE','CLIENTNAME','E01PVMIDN')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
        <p align="center"> 
