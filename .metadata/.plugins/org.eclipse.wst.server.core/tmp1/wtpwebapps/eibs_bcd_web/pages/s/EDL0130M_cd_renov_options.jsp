...
%> 
<h3 align="center">Renovaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_renov_options,EDL0130M"></h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 align=center width=100% bordercolor="#000000">
          <tr id="trdark"> 
            ...
            <td height="46" colspan="2" > Cuando el Contrato vence cancela el 
              ...
              N&uacute;mero
<input type="text" onkeypress="enterInteger(event)" name="E08DDDGLN" size="17" maxlength="16" value="<%= cdRenov.getE08DDDGLN().trim()%>">
              <a href="javascript:GetLedger('E08DDDGLN',document.forms[0].E08DEABNK.value,document.forms[0].E08DEACCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
              , generando un
...
<input type="text" onkeypress="enterInteger(event)" name="E08EEEACC" size="13" maxlength="12" value="<%= cdRenov.getE08EEEACC().trim()%>">
              <a href="javascript:GetAccount('E08EEEACC',document.forms[0].E08DEABNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>(Corriente, 
              Ahorro, etc.) .</td>
          </tr>
        </table>
      </td>
