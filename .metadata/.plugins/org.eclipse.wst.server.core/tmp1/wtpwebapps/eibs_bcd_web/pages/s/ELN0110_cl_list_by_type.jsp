...
<h3 align="center">Consulta de Lineas de Cr&eacute;dito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cl_list_by_type.jsp,ELN0110"></h3>
<hr size="4">
  ...
  <table class="tableinfo">
    <tr bordercolor="#FFFFFF"> 
      ...
      <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
        <tr id="trdark"> 
          <TD ALIGN=RIGHT WIDTH=20%> Tipo de Linea : </TD>
