   				...
   				<TD NOWRAP valign="top">
    				...
    				<div id="dataDiv1" class="scbarcolor" style="padding:0">
    					...
    					<%
					     ...
					     %> 
	            				<TR> 
	              					<TD ALIGN=CENTER NOWRAP><INPUT TYPE="radio" NAME="ROW" VALUE="<%= collList.getCurrentRow() %>" <% if (collList.getCurrentRow() == row) out.print("checked"); %> onClick="showAddInfo(<%= collList.getCurrentRow() %>,<%= collDet.getE02RODSEQ() %>)"></TD>
