...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0439">
  ...
  <h3 align="center">Protecci&oacute;n de Sobregiros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="od_protect.jsp, EDD0439"> 
  </h3>
  <hr size="4">
  <br>
      ...
      <td > 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td width="25%">
              <input type="text" name="E01CLSPRT" size="16" maxlength="15"  value="<%= userPO.getHeader20().trim()%>" onKeyPress="enterDecimal()">
            </td>
          </tr>
        </table>
      </td>
