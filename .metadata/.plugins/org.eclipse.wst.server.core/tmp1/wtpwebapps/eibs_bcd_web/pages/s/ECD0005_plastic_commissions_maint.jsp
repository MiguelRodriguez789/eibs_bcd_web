...
<body>
<h3 align="center">Comisiones de Tarjetas<BR>Mantenimiento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_commissions_maint.jsp, ECD0005"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E05CDRGLN" size="16" maxlength="20" value="<%= msgCD.getE05CDRGLN() %>" onKeypress="enterInteger(event)">
