...
<H3 align="center">Compraventa Moneda Extranjera - Apertura y Cierre de Oficinas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_maint, EPR0385"></H3>
<hr size="4">
