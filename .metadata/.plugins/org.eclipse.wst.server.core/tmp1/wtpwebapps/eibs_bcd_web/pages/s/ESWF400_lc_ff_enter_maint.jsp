...
<HTML>
<HEAD>
<TITLE>Formatos Libres Swift</TITLE>
...
<H3 align="center">Formatos Libres Swift <%= titTypePlu %><IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_ff_enter_maint, ESWF400"></H3>
<HR size="4">
<FORM method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESWF400">
    <INPUT TYPE="HIDDEN" NAME="SCREEN" VALUE="906">
