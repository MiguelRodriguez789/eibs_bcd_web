...
<jsp:useBean id= "ESD005001ListEX" class= "datapro.eibs.beans.JBObjList"  scope="session" />
...
function goInquiry() {
	isCheck();
	if ( !ok ) {
		alert("Favor seleccionar un Mensaje !!!");
		return;	 
	}
...
%> 
<h3 align="center">Mensajes Vencidos
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_alert_expired_messages_1.jsp, ESD0050"></h3>
<hr size="4">
...
<%
   if ( ESD005001ListEX.getNoResult() ) {
%>
<TABLE class="tbenter" width=100% height=30%">
   <TR>
      <TD>         
         <div align="center"> <h4 style="text-align:center">No hay Mensajes Vencidos</h4></div>
      </TD>
   </TR>
</TABLE>
...
<table  class="tableinfo" width="100%">
   <TR id=trdark> 
	  ...
	  <td NOWRAP align="center" width="30%"><B>Motivo</B></td>
   ...
   <%
      int i = 0;
      ESD005001ListEX.initRow();    
      while (ESD005001ListEX.getNextRow()) {
      ESD005001Message msgList = (ESD005001Message) ESD005001ListEX.getRecord(); 
   %>  
   <TR>          
...
<SCRIPT type="text/javascript">
	...
	document.forms[0].NEXTROWS.value = <%= ESD005001ListEX.getLastRec()%>;
	document.forms[0].CURRROWS.value = <%= ESD005001ListEX.getFirstRec()%>;
</SCRIPT>
