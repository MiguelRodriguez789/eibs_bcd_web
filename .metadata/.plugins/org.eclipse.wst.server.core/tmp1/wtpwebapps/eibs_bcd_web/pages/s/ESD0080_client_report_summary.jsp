...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_report_summary.jsp,ESD0080"></font></b></i></font></b></i></font> 
<hr size="4">
        ...
        <table width="100%">
          ...
          <tr> 
            ...
            <td width="58%"> 
              ...
              <%= userPO.getHeader2() %> </b></i></font></div>
            </td>
          </tr>
          <tr> 
