...
<H3 align="center">Conceptos Contables - Fraccionamiento de Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_conceptos, EPR0353"></H3>
<hr size="4">
  ...
  <TR><TD>
   <table id="headTable" width="100%">
    ...
    <tr id="trclear" align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR1" size="4" maxlength="4" value="<%= msgFrac.getE02OFFBR1() %>"
             class="context-menu-help" onmousedown="init(branchHelp,this.name,'<%= msgFrac.getE02REQBNK() %>','','','','')">
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFCY1" size="3" maxlength="3" value="<%= msgFrac.getE02OFFCY1() %>"
             class="context-menu-help" onmousedown="init(currencyHelp,this.name,'<%= msgFrac.getE02REQBNK() %>','','','','')">
          </div>
       </td>
       <td nowrap > 
          <div align="center"> 
             <input type="text" name="E02OFFAC1" size="12" maxlength="12"  value="<%= msgFrac.getE02OFFAC1() %>"
             class="context-menu-help" onmousedown="init(lnreferHelp,this.name,'<%= msgFrac.getE02REQBNK() %>','','<%= msgFrac.getE02REQCUS() %>','','RT')">
          </div>
       </td>
       <td nowrap > 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR2" size="4" maxlength="4" value="<%= msgFrac.getE02OFFBR2() %>"
             class="context-menu-help" onmousedown="init(branchHelp,this.name,'<%= msgFrac.getE02REQBNK() %>','','','','')">
          </div>
       </td>
       <td nowrap> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR3" size="4" maxlength="4" value="<%= msgFrac.getE02OFFBR3() %>"
             class="context-menu-help" onmousedown="init(branchHelp,this.name,'<%= msgFrac.getE02REQBNK() %>','','','','')">
          </div>
       </td>
       <td nowrap> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR4" size="4" maxlength="4" value="<%= msgFrac.getE02OFFBR4() %>"
             class="context-menu-help" onmousedown="init(branchHelp,this.name,'<%= msgFrac.getE02REQBNK() %>','','','','')">
          </div>
       </td>
       <td nowrap> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR5" size="4" maxlength="4" value="<%= msgFrac.getE02OFFBR5() %>"
             class="context-menu-help" onmousedown="init(branchHelp,this.name,'<%= msgFrac.getE02REQBNK() %>','','','','')">
          </div>
       </td>
       <td nowrap> 
