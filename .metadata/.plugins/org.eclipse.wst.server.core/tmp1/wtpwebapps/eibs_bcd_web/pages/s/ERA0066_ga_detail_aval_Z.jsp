...
<html>
<head>
<title>Información Detalle de Cartas de Crédito Stand By</title>
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap >
              <div align="right">Calificación Banco Pagador : </div>
            </td>
            <td nowrap >
 				<%
 					if (!b_read_only1) {
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap> 
              <div align="right">Comprobante Registro Banco República : </div>
            </td>
            <td nowrap >
