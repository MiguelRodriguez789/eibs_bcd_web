...
%>
  <h3 align="center">Mantenimiento de Datos Comunes<br>Nuevo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="common_info_new.jsp, EDL0848"> 
  </h3>
  <hr size="4">
