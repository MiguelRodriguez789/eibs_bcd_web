...
<body>
<h3 align="center">Pago/Liquidación  de Cobranzas <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="coll_payment.jsp, EDC0060"></h3>
<hr size="4">
...
<table class="tableinfo">
	...
	<tr>
		...
		<TD align="left">
			 <INPUT type="text" name=E01DCMRCI size="16" maxlength="14" readonly="readonly" value="<%= dcPag.getE01DCMRCI() %>"> 
		</td>
		<td>
		</td>					
		<TD align="left">
...
<TABLE class="tableinfo">
  <TR>
    ...
    <TD WIDTH="25%">
		...
		</SELECT><IMG src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" border="0">    
    </TD>
...
<TABLE class="tableinfo">
  <TR>
    ...
    <TD WIDTH="15%"><DIV align="left">
	  ...
	  </SELECT> <IMG	src="<%=request.getContextPath()%>/images/Check.gif"	title="mandatory field" border="0"></DIV>
	</TD>
			...
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
				<TBODY>
					 <TR id="trclear">
						...
						<TD>
						<DIV align="left">
            	<input type="radio" name="E01IVAFLG" value="Y" <%if(dcPag.getE01IVAFLG().equals("Y")) out.print("checked");%>>Sí 
            	<input type="radio" name="E01IVAFLG" value="N" <%if(dcPag.getE01IVAFLG().equals("N")) out.print("checked");%>>No 
            </DIV>
						</TD>
						<TD width="25%">
						<DIV align="right">I.T.E. :</DIV>
						</TD>
						<TD>
						<DIV align="left">
            	<input type="radio" name="E01ITEFLG" value="Y" <%if(dcPag.getE01ITEFLG().equals("Y")) out.print("checked");%>>Sí 
            	<input type="radio" name="E01ITEFLG" value="N" <%if(dcPag.getE01ITEFLG().equals("N")) out.print("checked");%>>No 
            </DIV>
						</TD>
					</TR>
				 <TR id="trdark">
						<TD>
						<DIV align="right">I.S.R. :</DIV>
						</TD>
						<TD>
						<DIV align="left">
            	<input type="radio" name="E01ISRFLG" value="Y" <%if(dcPag.getE01ISRFLG().equals("Y")) out.print("checked");%>>Sí 
            	<input type="radio" name="E01ISRFLG" value="N" <%if(dcPag.getE01ISRFLG().equals("N")) out.print("checked");%>>No 
            </DIV>
						</TD>
						<TD>
						...
						<TD>
						<DIV align="left">
            	<select name="E01TAXTTP">
            <option value=" " <% if (!(dcPag.getE01TAXTTP().equals("607")||dcPag.getE01TAXTTP().equals("608"))) out.print("selected"); %>></option>
            <option value="607" <% if (dcPag.getE01TAXTTP().equals("607")) out.print("selected"); %>>Impto.Adic. 4%</option>
            <option value="608" <% if (dcPag.getE01TAXTTP().equals("608")) out.print("selected"); %>>Impto.Adic. 35%</option>
          </select>
            </DIV>
						</TD>
					</TR>
