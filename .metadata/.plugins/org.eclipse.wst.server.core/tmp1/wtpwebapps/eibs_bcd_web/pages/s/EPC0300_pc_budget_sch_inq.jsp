...
<h3 align="center">Consulta Presupuesto de Obra - Ejecución<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_budget_sch_inq.jsp, EPC0300"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01PCBACC" size="13" maxlength="12" value="<%= userPO.getIdentifier().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="20%" > 
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" id="INFOCHG">
          ...
          <tr id="trdark"> 
            ...
            <td width="70%"> 
              <input type="text" readonly name="E01PCBXAM" size="17" maxlength="15" value="<%= msgPCC.getE01PCBXAM().trim()%>" onkeypress="enterDecimal()">
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td width="70%"> 
              <input type="text" readonly name="E01PCBXPR" size="19" maxlength="18" value="<%= msgPCC.getE01PCBXPR().trim()%>" onkeypress="enterDecimal()">
            </td>
          </tr>
