...
<H3 align="center">Otras Polizas de Seguro<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_poliza_detail.jsp , ERA0011"></H3> 
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan=2> 
              <input type="text" name="E03ROCICN" readonly size="6" maxlength="4" value="<%= gaPoliza.getE03ROCICN().trim()%>" >
              <a href="javascript:GetCodeDescCNOFC('E03ROCICN','E03ROCICM','24')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"  ></a>
            ...
            <td nowrap colspan=2>
             	<eibsinput:text name="gaPoliza" property="E03ROCICM" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_NAME %>" />
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
            ...
            <td nowrap colspan=2>
              <% if (userPO.getHeader22().equals("N")) {	%> 
                 <INPUT type="text" name="E03ROCCIN" size="25" maxlength="20" value="<%= gaPoliza.getE03ROCCIN().trim()%>">
                 <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"  >             
              <% } else { %> 
                 <INPUT type="text" readonly name="E03ROCCIN" size="25" maxlength="20" value="<%= gaPoliza.getE03ROCCIN().trim()%>">
              <% } 	%>
            </td>
            <td nowrap> 
            ...
            <td nowrap colspan=2>
              	<eibsinput:text name="gaPoliza" property="E03ROCIPD" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_DESCRIPTION %>" readonly="false"/>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap> 
            ...
            <td nowrap colspan=2>
            	<eibsinput:text name="gaPoliza" property="E03ROCIPA" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" />
            	   <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"  >
            </td>
            <td nowrap > 
            ...
            <td nowrap colspan=2>
                ...
                <a href="javascript:GetCurrency('E03ROCICY',document.forms[0].E03ROCICY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a> 
                   <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"  >
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan=2> 
	           	<eibsinput:date name="collDet" fn_month="E03ROCEMM" fn_day="E03ROCEMD" fn_year="E03ROCEMY" required="true"/>
            </td>
            <td nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan=2> 
	           	<eibsinput:date name="collDet" fn_month="E03ROCMDM" fn_day="E03ROCMDD" fn_year="E03ROCMDY" required="true"/>
            </td>
            <td nowrap> 
