...
<body>
<h3 align="center">Parametros Tablas de Comisiones Para Transferencias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fee_maint.jsp, EPR4000"></h3>
<hr size="4">
