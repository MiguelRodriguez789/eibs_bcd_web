...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transf_reverse.jsp,EFE0510">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE04REMAD1(),msgMT.getE04REMAD2(),msgMT.getE04REMAD3())  + " - " + Util.formatCell(msgMT.getE04REMAPT())%></TD>
