...
<H3 align="center">Mantenimiento de Remesas de Efectivo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transfer_maint,EFE0500"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E01REMCAR','YK')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	  </td>     
      	</tr>
      	<tr id=trclear>
          <td nowrap>
        ...
        <tr id=trclear>
          ...
          <td nowrap>
             <input type="text" name="E01REMRAM" size="17" maxlength="15" value ="<%= msgMT.getE01REMRAM() %>" onkeypress="enterDecimal()">             
          </td>
        </tr>
     </table>
    </td>
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD01" size="5" maxlength="4" value="<%= msgMT.getE01REMD01() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD01','E01REMN01','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ01" value ="<%= msgMT.getE01REMQ01() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD02" size="5" maxlength="4" value="<%= msgMT.getE01REMD02() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD02','E01REMN02','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ02" value ="<%= msgMT.getE01REMQ02() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD03" size="5" maxlength="4" value="<%= msgMT.getE01REMD03() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD03','E01REMN03','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ03" value ="<%= msgMT.getE01REMQ03() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD04" size="5" maxlength="4" value="<%= msgMT.getE01REMD04() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD04','E01REMN04','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ04" value ="<%= msgMT.getE01REMQ04() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD05" size="5" maxlength="4" value="<%= msgMT.getE01REMD05() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD05','E01REMN05','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ05" value ="<%= msgMT.getE01REMQ05() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD06" size="5" maxlength="4" value="<%= msgMT.getE01REMD06() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD06','E01REMN06','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ06" value ="<%= msgMT.getE01REMQ06() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD07" size="5" maxlength="4" value="<%= msgMT.getE01REMD07() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD07','E01REMN07','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ07" value ="<%= msgMT.getE01REMQ07() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD08" size="5" maxlength="4" value="<%= msgMT.getE01REMD08() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD08','E01REMN08','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ08" value ="<%= msgMT.getE01REMQ08() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD09" size="5" maxlength="4" value="<%= msgMT.getE01REMD09() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD09','E01REMN09','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ09" value ="<%= msgMT.getE01REMQ09() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD10" size="5" maxlength="4" value="<%= msgMT.getE01REMD10() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD10','E01REMN10','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ10" value ="<%= msgMT.getE01REMQ10() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD11" size="5" maxlength="4" value="<%= msgMT.getE01REMD11() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD11','E01REMN11','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ11" value ="<%= msgMT.getE01REMQ11() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD12" size="5" maxlength="4" value="<%= msgMT.getE01REMD12() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD12','E01REMN12','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ12" value ="<%= msgMT.getE01REMQ12() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD13" size="5" maxlength="4" value="<%= msgMT.getE01REMD13() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD13','E01REMN13','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ13" value ="<%= msgMT.getE01REMQ13() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD14" size="5" maxlength="4" value="<%= msgMT.getE01REMD14() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD14','E01REMN14','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ14" value ="<%= msgMT.getE01REMQ14() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD15" size="5" maxlength="4" value="<%= msgMT.getE01REMD15() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD15','E01REMN15','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ15" value ="<%= msgMT.getE01REMQ15() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD16" size="5" maxlength="4" value="<%= msgMT.getE01REMD16() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD16','E01REMN16','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ16" value ="<%= msgMT.getE01REMQ16() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD17" size="5" maxlength="4" value="<%= msgMT.getE01REMD17() %>"> 
      	   ...
      	   <a href="javascript:GetCodeDescAuxCNOFC('E01REMD17','E01REMN17','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ17" value ="<%= msgMT.getE01REMQ17() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD18" size="5" maxlength="4" value="<%= msgMT.getE01REMD18() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD18','E01REMN18','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ18" value ="<%= msgMT.getE01REMQ18() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
	    <td>
			<input type="text" name="E01REMD19" size="5" maxlength="4" value="<%= msgMT.getE01REMD19() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD19','E01REMN19','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ19" value ="<%= msgMT.getE01REMQ19() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
	    <td>
			<input type="text" name="E01REMD20" size="5" maxlength="4" value="<%= msgMT.getE01REMD20() %>"> 
      	    ...
      	    <a href="javascript:GetCodeDescAuxCNOFC('E01REMD20','E01REMN20','YN',document.forms[0].E01REMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
		</td> 
      	<td> 
      	   <input type="text" name="E01REMQ20" value ="<%= msgMT.getE01REMQ20() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
