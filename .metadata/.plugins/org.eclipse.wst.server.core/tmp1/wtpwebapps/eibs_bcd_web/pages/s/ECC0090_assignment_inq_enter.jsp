...
<H3 align="center">Consulta de Asignaciones
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="assignment_inq_enter.jsp, ECC0090"></H3>
  ...
  <table class="tbenter" HEIGHT="25%" width="100%" border="0">
    <TR>
		...
		<TD nowrap align="left">
			<INPUT type="text" name="E01PRICUN" size="10" maxlength="9" onKeyPress="enterInteger(event)" onclick="document.forms[0].search[0].click()">
    ...
    <tr> 
    	...
    	<td nowrap ALIGN="left"> 
        	<INPUT type="text" name="E01CCRNUM" size="24" maxlength="20" onclick="document.forms[0].search[1].click()" onkeypress="enterInteger(event)">
