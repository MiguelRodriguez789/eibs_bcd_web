...
%> 
<h3 align="center"> Copia Formatos Libres SWIFT <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="swift_free_format_inq.jsp,ESWF200"> 
</h3>
<hr size="4">
