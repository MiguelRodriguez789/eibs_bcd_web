...
<FORM>
<h3 align="center">Estado de Cuenta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="st_list_fp.jsp,EDL0160T"> 
  </h3>
  <hr size="4">
<BR>
<%
...
%> 
      ...
      <td > 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td  width="15%" nowrap> 
              <div align="right"><%= datapro.eibs.master.Util.formatCustomDate(currUser.getE01DTF(),
  ...
  <TABLE class="tableinfo">
    <TR id="trclear"> 
      ...
      <TH ALIGN=CENTER  nowrap colspan="2" >Capital</TH>
