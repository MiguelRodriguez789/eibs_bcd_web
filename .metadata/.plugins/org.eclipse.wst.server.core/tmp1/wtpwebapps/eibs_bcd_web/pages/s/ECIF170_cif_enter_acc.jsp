...
<h3 align="center">Consulta de Cuentas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cif_enter_acc, ECIF170"></h3>
<hr size="4">
<p>&nbsp;</p>
	  ...
	  <tr><td>&nbsp;</td></tr>
		  ...
		  <tr> 
            ...
            <td width="50%"> 
              ...
              <a href="javascript:GetAccount('ACCNUM','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            </td>
          </tr>
        </table>
      </td>
