						...
						<TBODY>
							<tr id="trdark">
								...
								<td nowrap align="left" width="70%">
									<INPUT type="text" name="E01DPRBNK" onkeypress="enterInteger(event)" size="2" maxlength="2" value="<%= brnDetails.getE01DPRBNK().trim()%>" <% if(userPO.getHeader18().equals("1")){out.print("readonly");} %>>
								</td>
							</tr>
						</TBODY>
					</TABLE>
