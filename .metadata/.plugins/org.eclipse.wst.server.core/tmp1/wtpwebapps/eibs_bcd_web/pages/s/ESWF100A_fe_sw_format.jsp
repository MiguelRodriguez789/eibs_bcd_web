...
%>
<h3 align="center">Mensaje Swift Formato MT - <%= swift.getE01SWFFMT()%> 
  <input type="hidden" name="E01SWFFMT"  value="<%= swift.getE01SWFFMT()%>" >
  <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_sw_format.jsp,ESWF100A"> 
</h3>
<hr size="4">
