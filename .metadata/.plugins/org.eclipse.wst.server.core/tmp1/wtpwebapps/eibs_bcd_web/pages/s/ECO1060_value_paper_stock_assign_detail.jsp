<html> 
<head>
<title>Asignacion Stock Adhesivos</title>
...
<% 
 ...
 <%
   ...
   datapro.eibs.beans.ECO106001Message msgMT = (datapro.eibs.beans.ECO106001Message) appList.getRecord();
   
%>
</head>
<body>

<H3 align="center">Asignacion de Stock de Adhesivos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_stock_assign_detail,ECO1060"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	        ...
	        <input type="text" name="E01BALBRN" size="5" maxlength="4" readonly value="<%= msgMT.getE01BALBRN() %>">
	      </td>
     	</tr>
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01BALCSN" size="5" maxlength="5" readonly value="<%= msgMT.getE01BALCSN() %>"><b>-</b> 
	        <input type="text" name="E01BALCSM" size="35" maxlength="35" readonly value="<%= msgMT.getE01BALCSM() %>">
	      </td>
     	</tr>     	
     	<tr id=trclear> 
		  <td> 
          ...
          <td nowrap>
              <input type="text" name="E01BALSUB" size="5" maxlength="4" readonly value="<%= msgMT.getE01BALSUB() %>">
        ...
        <tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E01MOVUSR" size="12" maxlength="10" value="<%= msgMT.getE01MOVUSR() %>">
      	  	<a href="javascript:getOficial('E01MOVUSR',document.forms[0].E01BALBRN.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
          ...
          <td nowrap>
             <input type="text" name="E01MOVQTY" size="13" maxlength="13" value ="<%= msgMT.getE01MOVQTY() %>" onkeypress="enterInteger(event)">
             <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">             
          </td>
        </tr>
        <tr id=trdark>
          ...
          <td nowrap>
             <input type="text" name="E01MOVINI" size="20" maxlength="12" value ="<%= msgMT.getE01MOVINI() %>" onkeypress="enterInteger(event)">
             <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">             
          </td>
        </tr>
        <tr id=trclear>
          ...
          <td nowrap>
             <input type="text" name="E01MOVFIN" size="20" maxlength="12" value ="<%= msgMT.getE01MOVFIN() %>" onkeypress="enterInteger(event)">
             <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20">             
          </td>
        </tr>
     </table>
