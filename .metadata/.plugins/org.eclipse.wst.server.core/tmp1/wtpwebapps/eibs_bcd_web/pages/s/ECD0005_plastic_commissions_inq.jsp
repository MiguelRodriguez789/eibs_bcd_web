...
<body>
<h3 align="center">Comisiones de Tarjetas<BR>Consulta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_commissions_inq.jsp, ECD0005"> 
</h3>
<hr size="4">
<% 
