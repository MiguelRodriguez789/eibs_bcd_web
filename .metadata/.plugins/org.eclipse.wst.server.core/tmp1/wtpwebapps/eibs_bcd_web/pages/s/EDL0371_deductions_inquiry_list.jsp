    ...
    <tr  height="5%"> 
      <td NOWRAP valign="top" width="100%"> 
		...
		<tr id="dataTable<%= list.getCurrentRow() %>">
			...
			<td nowrap align="center" width="10%"><a href="javascript:goAction('4000');"><%=msg.getE02DLICDE()%></a></td>
			<td nowrap align="left" width="30%"><a href="javascript:goAction('4000');"><%=msg.getE02DLINME()%></a></td>
			<td nowrap align="right" width="10%"><a href="javascript:goAction('4000');"><%=msg.getE02DLIDPM()%></a></td>
			<td nowrap align="center" width="10%"><a href="javascript:goAction('4000');"><%=msg.getE02DLIFAC()%></a></td>
