...
<H3 ALIGN="center">Pago/Negociaci&oacute;n de Cartas de Cr&eacute;dito<IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left"
	NAME="EIBS_GIF" title="ELC0560_lc_negotiation_enter_maint.jsp"></H3>
<HR SIZE="4">
...
<TABLE CLASS="tbenter" WIDTH="100%" BORDER="0">
	<TR>
		...
		<TD>
		<DIV><INPUT TYPE="text" NAME="E01LCRNUM" SIZE="13" MAXLENGTH="12" onkeypress="enterInteger(event)"> <A
			HREF="javascript:GetAccount('E01LCRNUM','','40','')"> <IMG SRC="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" BORDER="0"></A></DIV>
		</TD>
	</TR>
	<TR>
		<TD>
