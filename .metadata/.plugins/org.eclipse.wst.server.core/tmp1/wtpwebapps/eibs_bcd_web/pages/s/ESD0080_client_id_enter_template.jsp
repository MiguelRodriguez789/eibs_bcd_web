	...
	<tr> 
	 <td nowrap >
		<div id="ID_CUSTYPE" style="position:relative; display:none;">
			...
			<input type="radio" name="CUSCLS" value="PERS" onclick="showIdFields(document.forms[0].COUNTRY.value,'PERS');" checked="checked">Físico 
			</label>
			<label for="corp" id="corp" >
			<input type="radio" name="CUSCLS" value="CORP" onclick="showIdFields(document.forms[0].COUNTRY.value,'CORP');" >Empresa 
			</label>
