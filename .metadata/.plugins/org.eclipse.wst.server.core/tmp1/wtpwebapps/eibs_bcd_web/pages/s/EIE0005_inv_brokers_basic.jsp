...
%>
<div align="center"> 
  <h3>Brokers <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_brokers_basic.jsp,EIE0005"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <input type="text" name="E01FEBCCN" size="9" maxlength="8"  value="<%= invBrok.getE01FEBCCN().trim()%>"
	              class="context-menu-help"
          ...
          <tr id="trclear"> 
            <td nowrap width="34%" > 
              <div align="right">Tipo de Cálculo de Cargos Fijo :</div>
            </td>
            <td nowrap width="34%" > 
          ...
          <tr id="trdark"> 
            <td nowrap width="34%" > 
              <div align="right">Cantidad Pagada :</div>
            </td>
            <td nowrap width="34%" > 
            ...
            <td nowrap width="34%" > 
              <div align="right">Cantidad Retenida :</div>
            </td>
            <td nowrap width="66%" > 
