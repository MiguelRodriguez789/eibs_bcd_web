...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transf_receive.jsp,EFE0510">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE03REMSD1(),msgMT.getE03REMSD2(),msgMT.getE03REMSD3())  + " - " + Util.formatCell(msgMT.getE03REMSHT())%></TD>
