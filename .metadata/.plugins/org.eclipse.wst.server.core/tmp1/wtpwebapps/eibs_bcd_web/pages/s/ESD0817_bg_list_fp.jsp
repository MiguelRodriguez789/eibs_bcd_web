...
function PrintPreview() {
  ...
  %>
	var pg = '<%=request.getContextPath()%>/servlet/datapro.eibs.trade.JSESD0817B?SCREEN=4&Pos=' + pos;
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="9%" > 
              <div align="left"> 
                <input type="text" name="E02CIFCUN" size="9" maxlength="9" readonly value="<%= lcBalances.getE02CIFCUN()%>">
              </div>
            </td>
            <td nowrap width="12%" > 
            ...
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E02CUSNA1" size="45" maxlength="45" readonly value="<%= lcBalances.getE02CUSNA1()%>">
              </div>
            </td>
            <td nowrap > 
            ...
            <td nowrap ><b> 
              <input type="text" name="E02CIFPRD" size="4" maxlength="4" readonly value="<%= lcBalances.getE02CIFPRD() %>">
              </b></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="14%"> 
            ...
            <td nowrap width="33%"> 
              <div align="left"><b> 
                <input type="text" name="E02DSCOFC" size="30" maxlength="30" readonly value="<%= lcBalances.getE02DSCOFC() %>">
                </b> </div>
            </td>
            <td nowrap width="11%"> 
            ...
            <td nowrap width="21%"> 
              <div align="left"><b> 
                <input type="text" name="E02CIFCCY" size="3" maxlength="3" value="<%= lcBalances.getE02CIFCCY()%>" readonly>
                </b> </div>
            </td>
          </tr>
          <tr id=trclear>
...
out.print("Pendiente");
  ...
  <h4>Datos B&aacute;sicos de la Boleta</h4>
  <table class="tableinfo">
    <tr > 
      <td > 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
