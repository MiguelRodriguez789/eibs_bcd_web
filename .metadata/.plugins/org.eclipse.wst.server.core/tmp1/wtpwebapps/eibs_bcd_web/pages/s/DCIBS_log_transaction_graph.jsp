...
<H3 align="center">DCIBS Transactions Graph<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="DCIBS_log_transaction_list.jsp, DCIBS"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" height="100%">
          <tr id="tbenter">
            <td nowrap colspan=2> 
              <div align="center">
              	<APPLET name="history" code="VerticalBar3D.class" width="90%" height="90%" align="middle" archive="3DGraphs.zip" codebase="<%=request.getContextPath()%>/pages/s/">
