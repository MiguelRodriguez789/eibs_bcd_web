...
<SCRIPT type="text/javascript">
 ...
 "<A HREF= javascript:checkClose()>Salir</A>"; 
  ...
  function getNewBranch(){
    page= "${pageContext.request.contextPath}/pages/s/BranchProfile_container.jsp"
    fieldBank = "NEWBANK";
  ...
  function setDefBranch(){
    ...
    if (document.forms[0]["DBAALL"+row].value =="*") {
    	page= "${pageContext.request.contextPath}/pages/s/BranchProfile_container.jsp?DEFBANK=" + bank;
    	fieldBank = "NEWBANK";
    	fieldBranch = "NEWBRANCH";
    	fieldFlag = "NEWFLAG";
		CenterWindow(page,450,450,1);
