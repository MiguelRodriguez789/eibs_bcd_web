       ...
       if (opt == "9") { //Delete
     	 ...
     	 ok = confirm("Esta seguro que desea eliminar el registro seleccionado?");
	  	 if (ok) document.forms[0].submit();
	        ...
	        if ((opt == "1") && (document.forms[0].totalRow.value != "99") ) {
		        page = "${pageContext.request.contextPath}/pages/s/EDD0000_rt_signers.jsp?OPTION=" + opt;
		  		CenterWindow(page,700,650,1);
	   		}
...
<BODY>
 ...
 <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_signers_list.jsp, EDD0000"> 
    </h3>
   <hr size="4">
...
<INPUT TYPE=HIDDEN NAME="NAMES" VALUE="">   
  ...
  <% if (!userPO.getHeader2().equals("0")) {%> 
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" name="E02NA1" size="65" maxlength="50" readonly value="<%= userPO.getCusName().trim()%>">
              </div>
            </td>
          </tr>
  <% } %> 
    ...
    <%
     ...
     %> 
            <TR> 
              ...
              <TD ALIGN=center NOWRAP><%= Util.formatCell(dds.getE01RCN()) %></TD>
