...
<H3 align="center">Autorización de Accesos a Códigos de Referencia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ref_codes_user_access_enter.jsp, ESD0035"></H3>
        ...
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
		    <tr id="trdark"> 
		      ...
		      <td nowrap width="50%"> 
		        ...
		        <a href="javascript:GetUser('E01CREUSR','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0"></a> 
		      </td>
		    </tr> 
		</TABLE>
      </td>
