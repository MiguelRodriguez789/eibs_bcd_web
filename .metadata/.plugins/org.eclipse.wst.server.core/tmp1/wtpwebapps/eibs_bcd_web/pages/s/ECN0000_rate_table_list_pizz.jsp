...
function goAction(op) {
	...
	page = "<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSECN0000?SCREEN=400&opt=" + op + params;	
...
<h3 align="center">Tasas de Pizarra<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rate_table_list_pizz.jsp, ECN0000"></h3>
<hr size="4">
