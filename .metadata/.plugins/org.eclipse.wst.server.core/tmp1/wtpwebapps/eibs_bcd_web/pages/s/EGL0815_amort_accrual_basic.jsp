...
<SCRIPT type="text/javascript">
 ...
 function goAction(op) {
	...
	// Validate & Update
  	case 1:  {
    	document.getElementById("OPTION").value = 'U';
	...
	// Delete Amortization
		...
		document.getElementById("OPTION").value = 'D';
		document.forms[0].submit();
       	break;
		}
  	default:  {
...
%> 
<H3 align="center">Mantenimiento de Amortización<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="amort_accrual_basic, EGL0815"></H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEGL0815" >
  ...
  <INPUT TYPE=HIDDEN NAME="OPTION" ID="OPTION" value="U">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E02AMOBNK" id="E02AMOBNK" size="4" maxlength="3" value="<%= acc.getE02AMOBNK().trim()%>" readonly>
               </div>
            </td>
            <td nowrap  > 
            ...
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E02AMOGLN" id="E02AMOGLN" size="19" maxlength="17" readonly value="<%= acc.getE02AMOGLN().trim()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E02AMOBRN" id="E02AMOBRN" size="5" maxlength="4" value="<%= acc.getE02AMOBRN().trim()%>" readonly>
               </div>
            </td>
            <td nowrap  > 
            ...
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E02AMOACC" id="E02AMOACC" size="19" maxlength="17" readonly value="<%= acc.getE02AMOACC().trim()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E02AMOCCY" id="E02AMOCCY" size="4" maxlength="3" value="<%= acc.getE02AMOCCY().trim()%>" readonly>
               </div>
            </td>
            <td nowrap  > 
            ...
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E02AMOCCN" id="E02AMOCCN" size="10" maxlength="9" value="<%= acc.getE02AMOCCN().trim()%>" >
              		<A href="javascript:GetCostCenter('E02AMOCCN',document.getElementById('E02AMOBNK').value)">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%" > 
           		<input type="text" name="E02AMOVL1" size="3" maxlength="2" value="<%= acc.getE02AMOVL1().trim()%>" onkeypress="enterInteger(event)">
           		<input type="text" name="E02AMOVL2" size="3" maxlength="2" value="<%= acc.getE02AMOVL2().trim()%>" onkeypress="enterInteger(event)">
           		<input type="text" name="E02AMOVL3" size="5" maxlength="4" value="<%= acc.getE02AMOVL3().trim()%>" onkeypress="enterInteger(event)">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%" > 
           		<input type="text" name="E02AMOMD1" size="3" maxlength="2" value="<%= acc.getE02AMOMD1().trim()%>" onkeypress="enterInteger(event)">
           		<input type="text" name="E02AMOMD2" size="3" maxlength="2" value="<%= acc.getE02AMOMD2().trim()%>" onkeypress="enterInteger(event)">
           		<input type="text" name="E02AMOMD3" size="5" maxlength="4" value="<%= acc.getE02AMOMD3().trim()%>" onkeypress="enterInteger(event)">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%" > 
           		...
           		<a href="javascript:GetCodeCNOFC('E02AMOTCD','20')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align=bottom" border="0" ></a> 
            </td>
          </tr>
        </table>
      </td>
   ...
   <table id="headTable1">
    ...
    <div id="dataDiv1" class="scbarcolor" style="height:60; overflow-y :scroll; z-index:0" >
     ...
     <tr id="trclear"> 
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E02OFFBNK" id="E02OFFBNK" size="3" maxlength="2" value="<%= acc.getE02OFFBNK().trim()%>" onkeypress="enterInteger(event)">
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E02OFFBRN" size="5" maxlength="4" value="<%= acc.getE02OFFBRN().trim()%>"
              class="context-menu-help"
              onmousedown="init(branchHelp,this.name,document.getElementById('E02OFFBNK').value,'','','','')" onkeypress="enterInteger(event)">
        </div>
      </td>
      <td nowrap  > 
        <div align="center"> 
          <input type="text" name="E02OFFCCY" size="4" maxlength="3" value="<%= acc.getE02OFFCCY().trim()%>"
              class="context-menu-help"
              onmousedown="init(currencyHelp,this.name,document.getElementById('E02OFFBNK').value,'','','','')">
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E02OFFGLN" size="19" maxlength="17"  value="<%= acc.getE02OFFGLN().trim()%>"
              class="context-menu-help"
              onmousedown="init(ledgerHelp,this.name,document.getElementById('E02OFFBNK').value,'','','','')"  onkeypress="enterInteger(event)">
        </div>
      </td>      
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E02OFFACC" size="15" maxlength="13"  value="<%= acc.getE02OFFACC().trim()%>"
              class="context-menu-help"
              onmousedown="init(accountHelp,this.name,document.getElementById('E02OFFBNK').value,'','','','RT')"  onkeypress="enterInteger(event)">
        </div>
      </td>
    </tr>
     </table>
