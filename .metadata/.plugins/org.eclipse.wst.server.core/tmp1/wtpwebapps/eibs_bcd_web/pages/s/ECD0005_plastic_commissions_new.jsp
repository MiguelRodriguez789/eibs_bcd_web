...
<body>
<h3 align="center">Comisiones de Tarjetas<BR>Nueva<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_commissions_maint.jsp, ECD0005"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
				...
				<a href="javascript:GetDescATMCard('E05CDRTPL')">
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E05CDRFEE" size="5" maxlength="4" value="<%= msgCD.getE05CDRFEE() %>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E05CDRACC" size="14" maxlength="12" value="<%= msgCD.getE05CDRACC() %>" onKeypress="enterInteger(event)">
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E05CDRGLN" size="13" maxlength="16" value="<%= msgCD.getE05CDRGLN() %>" onKeypress="enterInteger(event)">
