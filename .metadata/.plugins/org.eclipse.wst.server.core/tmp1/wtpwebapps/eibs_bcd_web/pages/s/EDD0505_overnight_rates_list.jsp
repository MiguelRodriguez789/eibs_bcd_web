...
String chk = "";
%>
<h3 align="center">Tablas de Colocaciones a 24 Horas (Overnight)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="overnight_rates_list.jsp, EDD0505"></h3>
<hr size="4">
