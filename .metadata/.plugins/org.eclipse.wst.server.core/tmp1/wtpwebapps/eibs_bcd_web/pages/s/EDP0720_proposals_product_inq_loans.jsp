    ...
    <%--  xxxx  --%>
      ...
      <tr > 
		...
		<tr id="trclear">         		          
            ...
            <td nowrap width="50%"> 
              <input type="text" readonly name="E01DEAOBL" size="3" maxlength="2" value="<%= msgList.getE01DEAOBL().trim()%>">
             <% if(!msgRT.getH01FLGWK3().equals("3")){ %>
              <a href="javascript:GetCodeDescCNOFC('E01DEAOBL','','YY')"><img src="<%=request.getContextPath()%>/images/1b.gif" 
              alt="Ayuda" align="absbottom" border="0" ><% }%>
            </td>
          </tr> 
			<tr id="trclear">
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
		   <tr id="trclear">
				  ...
				  <td nowrap width="50%" align="left">
					 ...
					 >
				   <INPUT type="text" readonly name="E01DPDX25" size="47" maxlength="45" value="<%= msgList.getE01DPDX25().trim()%>">
				   </td>
			</tr>	
		</table>
		</td>
    ...
    <% if((msgRTC.getE02DPJC00().equals("1"))){%>
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
		   <tr id="trclear">
					<td width="20%" align="right">
               			<div align="left">Principales Clientes :</div>
					</td>
...
<% } %>
   ...
   <% if((msgRTC.getE02DPJC01().equals("1"))){%>
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear" >
				<td nowrap align="left" width="20%">Descripción de la Infraestructura del Negocio:</td>
				<td nowrap align="left" width="50%">
	...
	<% if((msgRTC.getE02DPJC03().equals("1"))){%>
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				<td nowrap align="left" width="20%">Descripción del Propósito del Crédito:</td>
				<td nowrap align="left" width="50%">
   ...
   <% } %> 
     ...
     <% if((msgRTC.getE02DPJC05().equals("1"))){%>
       <TR>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				<td nowrap align="left" width="20%">Principales Proveedores:</td>
				<td nowrap align="left" width="50%">
      ...
      <% } %>
   	...
   	<% if(msgRTC.getE02DPJC06().equals("1")){%>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				<td nowrap align="left" width="20%">
				Resumen del Ánalisis de la Situación Financiera:</td>
				<td nowrap align="left" width="50%">
