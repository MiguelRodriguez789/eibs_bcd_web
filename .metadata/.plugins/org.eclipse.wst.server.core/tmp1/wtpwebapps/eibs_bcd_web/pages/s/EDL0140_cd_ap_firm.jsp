...
<h3 align="center">Firmantes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_inq_firm_pa.jsp, EDD0000"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E02CUN" size="10" maxlength="9" readonly value="<%= userPO.getHeader2().trim()%>">
              </div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E04CUN" size="13" maxlength="12" value="<%= userPO.getIdentifier().trim() %>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
...
<%          
 ...
 out.print("<A href=\"javascript:go(6)\">6</A>,<A href=\"javascript:go(7)\">7</A>,<A href=\"javascript:go(8)\">8</A>,<A href=\"javascript:go(9)\">9</A>,<A href=\"javascript:go(10)\">10</A>");
  ...
  out.println("</table>"); 
%>
  <input type="hidden" id="E<%=name%>4FL2" value="<%=cdFirm.getField("E" + name + "4FL2").getString().trim()%>" />
  ...
  <table id="mainTable<%= name %>" class="tableinfo">
    <tr bgcolor="#FFFFFF" bordercolor="#FFFFFF"> 
      <td> 
        <table  cellspacing="0" cellpadding="2" width="100%" border="0" title="TB_cdFirmFICIARY_CORP" bgcolor="#FFFFFF" bordercolor="#FFFFFF" align="center">
        <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            <td width="40%" nowrap> 
              <div align="right">N&uacute;mero de Cliente : </div>
            </td>
            <td nowrap width="60%"> 
              <input type="text" name="E<%= name %>4RCN" maxlength="12" size="12" value="<%= cdFirm.getField("E" + name + "4RCN").getString().trim()%>" readonly>
...
<%-- INICIO SECCION DE DIRECCION --%>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            ...
            <td width="60%" nowrap> 
              <input type="text" name="E<%= name %>4MA4" maxlength="35" size="36" value="<%= cdFirm.getField("E" + name + "4MA4").getString().trim()%>" readonly>
            </td>
          </tr> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td width="60%" nowrap> 
              ...
              <input type="text" name="D<%= name %>4STE" maxlength="30" size="31" value="<%= cdFirm.getField("D" + name + "4STE").getString().trim()%>" readonly>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td id="PATID <%=name%>" width="40%" nowrap> 
              <div align="right"> Distrito :</div>
            </td>
            <td width="60%" nowrap> 
              <input type="text" name="E<%= name %>4TID" maxlength="4" size="5" value="<%= cdFirm.getField("E" + name + "4TID").getString().trim()%>" readonly>
              <input type="text" name="D<%= name %>4TID" maxlength="35" size="36" value="<%= cdFirm.getField("D" + name + "4TID").getString().trim()%>" readonly>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            <td id="PAPID<%=name%>" width="40%" nowrap> 
              <div align="right"> Corregimiento :</div>
            </td>
            <td width="60%" nowrap> 
              
                <input type="text" name="E<%= name %>4PID" maxlength="4" size="5" value="<%= cdFirm.getField("E" + name + "4PID").getString().trim()%>" readonly>
                <input type="text" name="D<%= name %>4PID" maxlength="35" size="36" value="<%= cdFirm.getField("D" + name + "4PID").getString().trim()%>" readonly>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td width="60%" nowrap> 
              <input type="text" name="E<%=name%>4CTR" maxlength="30" size="31" value="<%= cdFirm.getField("E" + name + "4CTR").getString().trim()%>" readonly>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            <td width="40%" nowrap> 
 ...
 <%-- FIN SECCION DE DIRECCION --%>
           ...
           <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            ...
            <td width="60%" nowrap>
              <div id="EXID<%= name %>"  style="display:none" >
                <input type="text" name="E<%= name %>4BNI" maxlength="30" size="31" value="<%= cdFirm.getField("E" + name + "4BNI").getString().trim()%>" readonly> 
              </div>
              <div id="PAID<%= name %>"  >
                <input type="text" name="E<%= name %>4NME" maxlength="30" size="31" value="<%= cdFirm.getField("E" + name + "4NME").getString().trim()%>" readonly>
               </div>
            </td>
          </tr>
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            ...
            <td width="60%" nowrap> 
              <select name="E<%= name %>4FL1" disabled>
                <option value=" " <% if (!(cdFirm.getField("E" + name + "4FL1").getString().equals("1") || cdFirm.getField("E" + name + "4FL1").getString().equals("2") || cdFirm.getField("E" + name + "4FL1").getString().equals("3"))) out.print("selected"); %>></option>
                <option value="1" <% if (cdFirm.getField("E" + name + "4FL1").getString().equals("1")) out.print("selected"); %>>Firma Indistinta</option>
                <option value="2" <% if (cdFirm.getField("E" + name + "4FL1").getString().equals("2")) out.print("selected"); %>>Firma Mancomunada</option>
				<option value="3" <% if (cdFirm.getField("E" + name + "4FL1").getString().equals("3")) out.print("selected"); %>>Firma Individual</option>
				</select>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td width="60%" nowrap> 
              <input type="text" name="E<%= name %>4FL3" maxlength="1" size="2" value="<%= cdFirm.getField("E" + name + "4FL3").getString().trim()%>" readonly>
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td width="23%" nowrap> 
              <input type="text" name="D<%= name %>4CIT" size="35" maxlength="35" value="<%= cdFirm.getField("D" + name + "4CIT").getString().trim()%>">
            </td>
          </tr>
          --%>
        </table>
