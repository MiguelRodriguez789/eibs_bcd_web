...
<H3 align="center">Beneficiarios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_beneficiaries.jsp, ESD0086"></H3>
<hr size="4">
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="15%" align="right">Porcentaje de Relación :</td>
            <td nowrap width="35%" align="left">
            	<eibsinput:text name="ESD0086Record" property="E01AM1" required="false" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_PERCENTAGE%>" readonly="<%=isReadOnly %>"/>
            </td>
         </tr>          
       </table>
