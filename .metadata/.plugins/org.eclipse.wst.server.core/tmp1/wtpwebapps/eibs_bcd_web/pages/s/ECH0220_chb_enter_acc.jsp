...
<H3 align="center">Entrega de Chequeras Universal a Clientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chb_enter_acc,ECH0220"></H3>
      ...
      <td nowrap width="50%"> 
        <input type="text" name="E02SELACC" size="13" maxlength="12" onKeypress="enterInteger(event)"><IMG
			...
			title="campo obligatorio" border="0">
 			 <a href="javascript:GetAccount('E02SELACC','','RT','<%= client %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0"  ></a>        
		</td>      
    </tr>
