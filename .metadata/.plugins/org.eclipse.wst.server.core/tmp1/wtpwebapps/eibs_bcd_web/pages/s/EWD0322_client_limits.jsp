...
<h3 align="center">Consulta L&iacute;mites de Clientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_limits.jsp,EWD0322"></h3>
<hr size="4">
  <form>
