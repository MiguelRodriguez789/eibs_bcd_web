...
<H3 align="center">Pago/Liquidaci&oacute;n de Cobranzas <%=dcPag.getE01DCMTYP().equals("I") ? "Recibidas" : "Enviadas" %><IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="coll_enter_detail_incoming.jsp, EDC0060"></H3>
<HR size="4">
			  ...
			  <TR id="trclear">
			    ...
			    <TD align="left" nowrap><INPUT type="text" name="E01SWFRCV" size="14" maxlength="12">
			     ...
			     <INPUT TYPE=HIDDEN NAME="E01SWFRCV4" VALUE="">
			      <A href="javascript:GetSwiftIdDesc('E01SWFRCV','E01SWFRCV2','E01SWFRCV3','E01SWFRCV4')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"  border="0"></A> </TD>
			  </TR>
	...
	<tr>
		...
		<TR id="trdark">
			...
			<TD width="664">
				...
				<IMG src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" border="0" align="middle">
			</TD>
		</TR>
		<TR id="trclear">
			<TD width="670">
			...
			<TD width="664">
				...
				<A href="javascript:GetCurrency('E01REMCCY','')"><IMG	src="<%=request.getContextPath()%>/images/1b.gif" title="help"
		...
		<TR id="trdark">
			    ...
			    <INPUT TYPE=HIDDEN NAME="E01CRPBID4" VALUE="">
			      <A href="javascript:GetSwiftIdDesc('E01CRPBID','E01CRPBID2','E01CRPBID3','E01CRPBID4')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"  border="0"></A> </TD>
			  </TR>
		</table>
		</td>
	</tr>
