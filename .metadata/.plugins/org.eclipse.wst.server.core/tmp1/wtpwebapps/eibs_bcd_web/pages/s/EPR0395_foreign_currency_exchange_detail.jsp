...
datapro.eibs.beans.EPR039501Message msgInst = (datapro.eibs.beans.EPR039501Message) mtList.getRecord();
...
<h3 align="center">Consulta de Operaciones Compraventa Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0395"></H3>
<hr size="4">
  ...
  <TR><TD>
   <table id="headTable" width="100%">
    ...
    <tr id="trclear" align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR1" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR1() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR2" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR2() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR3" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR3() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR4" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR4() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E01OFFBR5" size="4" maxlength="4" value="<%= msgInst.getE01OFFBR5() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
  ...
  <table class="tableinfo">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<%if (!msgInst.getE01REQAAD().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">AAD:</div>
			</td>
			<td nowrap width="60%">
				<input type="text" name="" size="12" maxlength="10" value="<%= msgInst.getE01REQAAD() %>" readonly> 
			</td>
		</tr>
		<%}%>
		<%if (!msgInst.getE01REQALD().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQCR1" size="3" maxlength="2" value="<%= msgInst.getE01REQCR1() %>" readonly>
                <input type="text" name="E01REQCR2" size="3" maxlength="2" value="<%= msgInst.getE01REQCR2() %>" readonly>
                <input type="text" name="E01REQCR3" size="5" maxlength="4" value="<%= msgInst.getE01REQCR3() %>" readonly>
		...
		<%if (!msgInst.getE01REQUP1().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha/Hora de Modificacion:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQUP1" size="3" maxlength="2" value="<%= msgInst.getE01REQUP1() %>" readonly>
                <input type="text" name="E01REQUP2" size="3" maxlength="2" value="<%= msgInst.getE01REQUP2() %>" readonly>
                <input type="text" name="E01REQUP3" size="5" maxlength="4" value="<%= msgInst.getE01REQUP3() %>" readonly>
                <input type="text" name="E01REQUPT" size="28" maxlength="26" value="<%= msgInst.getE01REQUPT() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
				<div align="right">Usuario que Modifica:</div>
			</td>
			<td nowrap width="60%">
				<input type="text" name="E01REQUPU" size="12" maxlength="10" value="<%= msgInst.getE01REQUPU() %>" readonly> 
			</td>
		</tr>
		<%}%>
		<%if (!msgInst.getE01REQVA1().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha de Liquidacion SPOT:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQVA1" size="3" maxlength="2" value="<%= msgInst.getE01REQVA1() %>" readonly>
                <input type="text" name="E01REQVA2" size="3" maxlength="2" value="<%= msgInst.getE01REQVA2() %>" readonly>
                <input type="text" name="E01REQVA3" size="5" maxlength="4" value="<%= msgInst.getE01REQVA3() %>" readonly>
			</td>
		</tr>
		<%}%>
		<%if (!msgInst.getE01REQSN1().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha/Hora de Envio a Aprobacion:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQSN1" size="3" maxlength="2" value="<%= msgInst.getE01REQSN1() %>" readonly>
                <input type="text" name="E01REQSN2" size="3" maxlength="2" value="<%= msgInst.getE01REQSN2() %>" readonly>
                <input type="text" name="E01REQSN3" size="5" maxlength="4" value="<%= msgInst.getE01REQSN3() %>" readonly>
				<input type="text" name="E01REQSNT" size="28" maxlength="26" value="<%= msgInst.getE01REQSNT() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
				<div align="right">Usuario que Envia a Aprobacion:</div>
			</td>
			<td nowrap width="60%">
				<input type="text" name="E01REQSNU" size="12" maxlength="10" value="<%= msgInst.getE01REQSNU() %>" readonly> 
			</td>
		</tr>
		<%}%>
		<%if (!msgInst.getE01REQAP1().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha/Hora de Aprobacion Extracupo:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQAP1" size="3" maxlength="2" value="<%= msgInst.getE01REQAP1() %>" readonly>
                <input type="text" name="E01REQAP2" size="3" maxlength="2" value="<%= msgInst.getE01REQAP2() %>" readonly>
                <input type="text" name="E01REQAP3" size="5" maxlength="4" value="<%= msgInst.getE01REQAP3() %>" readonly>
				<input type="text" name="E01REQAPT" size="28" maxlength="26" value="<%= msgInst.getE01REQAPT() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
				<div align="right">Usuario que Aprueba:</div>
			</td>
			<td nowrap width="60%">
				<input type="text" name="E01REQAPU" size="12" maxlength="10" value="<%= msgInst.getE01REQAPU() %>" readonly> 
			</td>
		</tr>
		<%}%>
		<%if (!msgInst.getE01REQRJ1().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha/Hora de Rechazo:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQRJ1" size="3" maxlength="2" value="<%= msgInst.getE01REQRJ1() %>" readonly>
                <input type="text" name="E01REQRJ2" size="3" maxlength="2" value="<%= msgInst.getE01REQRJ2() %>" readonly>
                <input type="text" name="E01REQRJ3" size="5" maxlength="4" value="<%= msgInst.getE01REQRJ3() %>" readonly>
				<input type="text" name="E01REQRJT" size="28" maxlength="26" value="<%= msgInst.getE01REQRJT() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
			...
			<td nowrap width="60%">
				<input type="text" name="E01REQRR1" size="45" maxlength="40" value="<%= msgInst.getE01REQRR1() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
			...
			<td nowrap width="60%">
				<input type="text" name="E01REQRR2" size="45" maxlength="40" value="<%= msgInst.getE01REQRR2() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
		...
		<%}%>
		<%if (!msgInst.getE01REQSU1().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha/Aprobación de Liquidación:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQSU1" size="3" maxlength="2" value="<%= msgInst.getE01REQSU1() %>" readonly>
                <input type="text" name="E01REQSU2" size="3" maxlength="2" value="<%= msgInst.getE01REQSU2() %>" readonly>
                <input type="text" name="E01REQSU3" size="5" maxlength="4" value="<%= msgInst.getE01REQSU3() %>" readonly>
				<input type="text" name="E01REQSUT" size="28" maxlength="26" value="<%= msgInst.getE01REQSUT() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
			...
			<td nowrap width="60%">
				<input type="text" name="E01REQSUU" size="12" maxlength="10" value="<%= msgInst.getE01REQSUU() %>" readonly> 
			</td>
		</tr>
		<%}%>
		<%if (!msgInst.getE01REQRE1().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha/Hora de Reversion:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQRE1" size="3" maxlength="2" value="<%= msgInst.getE01REQRE1() %>" readonly>
                <input type="text" name="E01REQRE2" size="3" maxlength="2" value="<%= msgInst.getE01REQRE2() %>" readonly>
                <input type="text" name="E01REQRE3" size="5" maxlength="4" value="<%= msgInst.getE01REQRE3() %>" readonly>
				<input type="text" name="E01REQRET" size="28" maxlength="26" value="<%= msgInst.getE01REQRET() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
				<div align="right">Usuario que Reversa:</div>
			</td>
			<td nowrap width="60%">
				<input type="text" name="E01REQREU" size="12" maxlength="10" value="<%= msgInst.getE01REQREU() %>" readonly> 
			</td>
		</tr>
		<%}%>
		<%if (!msgInst.getE01REQTR1().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha/Hora de Canje:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQTR1" size="3" maxlength="2" value="<%= msgInst.getE01REQTR1() %>" readonly>
                <input type="text" name="E01REQTR2" size="3" maxlength="2" value="<%= msgInst.getE01REQTR2() %>" readonly>
                <input type="text" name="E01REQTR3" size="5" maxlength="4" value="<%= msgInst.getE01REQTR3() %>" readonly>
				<input type="text" name="E01REQTRT" size="28" maxlength="26" value="<%= msgInst.getE01REQTRT() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
				<div align="right">Usuario que Canjea:</div>
			</td>
			<td nowrap width="60%">
				<input type="text" name="E01REQTRU" size="12" maxlength="10" value="<%= msgInst.getE01REQTRU() %>" readonly> 
			</td>
		</tr>
		<%}%>
		<%if (!msgInst.getE01REQFR1().equals("0")) {%>
		<tr>
			<td nowrap width="40%">
				<div align="right">Fecha/Hora de Fraccionamiento:</div>
			</td>
			<td nowrap width="60%">
                <input type="text" name="E01REQFR1" size="3" maxlength="2" value="<%= msgInst.getE01REQFR1() %>" readonly>
                <input type="text" name="E01REQFR2" size="3" maxlength="2" value="<%= msgInst.getE01REQFR2() %>" readonly>
                <input type="text" name="E01REQFR3" size="5" maxlength="4" value="<%= msgInst.getE01REQFR3() %>" readonly>
				<input type="text" name="E01REQFRT" size="28" maxlength="26" value="<%= msgInst.getE01REQFRT() %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
				<div align="right">Usuario que Fracciona:</div>
			</td>
			<td nowrap width="60%">
				<input type="text" name="E01REQFRU" size="12" maxlength="10" value="<%= msgInst.getE01REQFRU() %>" readonly> 
			</td>
		</tr>
		<%}%>
     </table>
  ...
  <table class="tableinfo">
   ...
   <td>
    ...
    <%if (!msgInst.getE01REQOPC().equals("P")) {%>  
	 ...
	 <%if (msgInst.getE01REQOPC().equals("P")) {%> 
		<tr>
			<%if (msgInst.getH01FLGWK2().equals("4")) {%> 
			<td nowrap width="20%">
				<div align="right">Nombre del Banco</div>
			</td>
			<td nowrap width="30%">
                <input type="text" name="E01REQBB1" size="35" readonly maxlength="35" value="<%= msgInst.getE01REQBB1() %>">
			</td>
			<%} else {%>
			<td nowrap width="20%">
