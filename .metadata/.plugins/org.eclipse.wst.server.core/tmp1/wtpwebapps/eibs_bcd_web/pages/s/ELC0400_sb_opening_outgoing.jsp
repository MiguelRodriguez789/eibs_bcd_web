...
<BODY>
<H3 align="center"><%= (msg.getE01LCMOPT().equals("N") ? "Apertura" : "Mantenimiento") %> de Carta de Credito
Standby Emitida <IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="ELC0400_sb_opening_outgoing.jsp"></H3>
<HR size="4">
...
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo">
  ...
  <TR id="trdark">
    <TD align="right" nowrap><STRONG>Referencia  del Otro Banco :</STRONG></TD>
    <TD><B>
            ...
            <TBODY>
              <TR id="trdark">
                ...
                <TD nowrap width="16%" align="left">
					<eibsinput:date name="msg" fn_month="E01LCMLAM" fn_day="E01LCMLAD" fn_year="E01LCMLAY" required="false"/>
				</TD>
              </TR>
            </TBODY>
        </TABLE></TD>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    <TD align="right" nowrap>No.  Cliente o  Cuenta:</TD>
  ...
  <TR id="">
    ...
    <TD align="left"><INPUT type="text" name="E01LCMAP5" size="6" maxlength="4"
        ...
        <A href="javascript:GetCodeCNOFC('E01LCMAP5','27')"> 
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD align="left"><INPUT type="text" name="E01LCMBN5" size="6" maxlength="4"
      ...
      <A href="javascript:GetCodeCNOFC('E01LCMBN5','27')"> 
        <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></A> C&oacute;digo Postal
      <INPUT type="text"
...
<TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF4">
        <OPTION value=""></OPTION>
        <OPTION value="C" <%if (msg.getE01LCMAF4().equals("C")) out.print("selected");%>>Cliente</OPTION>
        <OPTION value="A" <%if (msg.getE01LCMAF4().equals("A")) out.print("selected");%>>Cuenta</OPTION>
      </SELECT>
        ...
        <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" onClick="javascript: document.forms[0].E01LCMAF4.selectedIndex = 1"  border="0"> </A> Cliente o 
        <A href="javascript: GetAccByClient('E01LCMABA','','RT','','E01LCMAB1')"> 
        <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" onClick="javascript: document.forms[0].E01LCMAF4.selectedIndex = 2"  border="0"></A> Cuenta</TD>
  </TR>
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT type="text" name="E01LCMABI" size="14" maxlength="12" value="<%=msg.getE01LCMABI()%>">
      <A href="javascript:GetSwiftIdDesc('E01LCMABI','E01LCMAB1')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda"  border="0"></A> </TD>
  </TR>
  <TR id="">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB5" size="6" maxlength="4" value="<%=msg.getE01LCMAB5()%>">
        <A href="javascript:GetCodeCNOFC('E01LCMAB5','27')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></A> C&oacute;digo Postal
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD align="left">
    	<INPUT type="text" name="E01LCMCAI" size="14" maxlength="12" value="<%=msg.getE01LCMCAI()%>">
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD  align="left" nowrap><INPUT type="text" name="E01LCMRBA" size="12" maxlength="12" value="<%=msg.getE01LCMRBA()%>">
		...
		<IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></A> Cliente o
  ...
  <TR id="">
    ...
    <TD align="left" valign="bottom" nowrap><INPUT type="text" name="E01LCMRB5" size="6" maxlength="4" value="<%=msg.getE01LCMRB5()%>">
        <A href="javascript:GetCodeCNOFC('E01LCMRB5','27')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></A> C&oacute;digo Postal
...
<BR>
 ...
 <% if(error.getERWRNG().equals("Y")){%>
   <h4 style="text-align:center"><input type="checkbox" name="H01FLGWK2" value="A" <% if(msg.getH01FLGWK2().equals("A")){ out.print("checked");} %>>
