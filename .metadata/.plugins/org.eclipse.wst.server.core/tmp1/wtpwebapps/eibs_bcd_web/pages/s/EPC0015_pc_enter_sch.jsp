...
<jsp:useBean id= "pcScheme" class= "datapro.eibs.beans.EPC001501Message"  scope="session" />

<body bgcolor="#FFFFFF">

<h3 align="center">Inspectores Asociados a Proyecto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_enter_sch,EPC0015"></h3>
<hr size="4">

<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEPC0015" onsubmit="return(CheckACC())">
  <p> 
