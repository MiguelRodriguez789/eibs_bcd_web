...
<h3 align="center">Cotizador de Préstamos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sim_enter_b,EDL6001"></h3>
<hr size="4">
...
<%--              <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0"  > --%>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
				<eibsinput:date name="lnBasic" fn_year="E01FNACOY" fn_month="E01FNACOM" fn_day="E01FNACOD" />
            </td>
            <td nowrap width="25%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="E01TASAPR" size="12" maxlength="10" value="<%= lnBasic.getE01TASAPR().trim()%>" onKeypress="enterRate(event)">
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="E01EFERTE" size="12" maxlength="10" value="<%= lnBasic.getE01EFERTE().trim()%>" onKeypress="enterRate(event)" >
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="E01NCUOTA" size="4" maxlength="3" value="<%= lnBasic.getE01NCUOTA().trim()%>" onKeypress="enterInteger(event)">
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%" > 
				<eibsinput:date name="lnBasic" fn_year="E01PPAGOY" fn_month="E01PPAGOM" fn_day="E01PPAGOD" />
			</td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
 				<eibsinput:date name="lnBasic" fn_year="E01MATDTY" fn_month="E01MATDTM" fn_day="E01MATDTD" />
            </td>
            <td nowrap width="25%" >
