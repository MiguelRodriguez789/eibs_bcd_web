...
<% } %>
          			...
          			<tr class="<%=getRowColor()%>"  >
            			...
            			<td nowrap  > 
	              			<div align="left">	
              				<input type="text" name="<%=dir1%>" id="<%=dir1%>" size="55" maxlength="45" value="<%=mr.getField(dir1).getString()%>"  <%=READ_ONLY_TAG%>  class="direccion" 
          			...
          			<tr class="<%=getRowColor()%>"  >
            			...
            			<td nowrap  > 
	              			<div align="left">	
              				<input type="text" name="<%=dir2%>" id="<%=dir2%>" size="55" maxlength="45" value="<%=mr.getField(dir2).getString()%>"  <%=READ_ONLY_TAG%>  class="direccion" 
          			...
          			<tr class="<%=getRowColor()%>"  >
            			...
            			<td nowrap  >
	              			<div align="left">	
              				<input type="text" name="<%=dir3%>" id="<%=dir3%>" size="55" maxlength="45" value="<%=mr.getField(dir3).getString()%>"  <%=READ_ONLY_TAG%>  class="direccion" 
          			...
          			<tr class="<%=getRowColor()%>"  >
            			...
            			<td nowrap  >
              				<input type="text" name="<%=ciudadDsc%>" id="<%=ciudadDsc%>" size="55" maxlength="45" value="<%=mr.getField(ciudadDsc).getString()%>"  <%=READ_ONLY_TAG%>  class="direccion" 
          			...
          			<tr class="<%=getRowColor()%>"  >
            			...
            			<td nowrap  > 
              				<input type="hidden" name="<%=estado%>" id="<%=estado%>" size="6" maxlength="4" value="<%=mr.getField(estado).getString()%>"  <%=READ_ONLY_TAG%>  class="direccion" >
              				...
              				%>
	              					<A href="javascript:GetCodeDescCNOFC('<%=estado%>','<%=estadoDsc%>','27')" >
