...
<body bgcolor="#FFFFFF">
<H3 align="center"> Calculadoras<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_enter_new,EFE0120P"></H3>
      ...
      <tr id="trintro"> 
        <td colspan="5"> 
          <div align="left">Cliente : 
            ...
            <a href="javascript:GetCustomerDescId('CUNCOD','CUNDSC','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a></div>
        </td>
        <td colspan="3">Numero de Referencia: 
          <input type="hidden" name="E01FESDID">
          <input type="text" name="E01FESREF" size="9" maxlength="9">
          <a href="javascript:GetFeRef('E01FESDID','E01FESREF',document.forms[0].E01FESTYP.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a></td>
      </tr>
    </table>
