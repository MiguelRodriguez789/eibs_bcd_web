...
<jsp:useBean id= "CURYEAR" class= "java.lang.String"  scope="session" />
...
<body>
<h3 align="center"><% if (request.getParameter("OPT").equals("M")) out.print("Mantenimiento"); else out.print("Nueva");%> Tabla de Seguros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="Loans_insurance_maint.jsp"> 
</h3>
<hr size="4">
