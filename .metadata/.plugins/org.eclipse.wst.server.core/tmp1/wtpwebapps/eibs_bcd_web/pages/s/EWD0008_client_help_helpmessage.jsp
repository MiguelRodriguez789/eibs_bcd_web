...
function enter(code, description, type) {
	...
	if (isValidObject(oForm[top.opener.fieldName])) {
		setField(oForm[top.opener.fieldName], code);	
	}
	if (isValidObject(oForm[top.opener.fieldAux1])) {
		setField(oForm[top.opener.fieldAux1], description);	
	}
	if (isValidObject(oForm[top.opener.fieldAux2])) {
		setField(oForm[top.opener.fieldAux2], type);	
	}
	top.close();
 }
</script>
