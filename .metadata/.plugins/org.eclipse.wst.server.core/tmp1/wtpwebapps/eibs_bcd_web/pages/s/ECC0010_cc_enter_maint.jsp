...
<H3 align="center">Mantenimiento Cupo de Crédito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_enter_maint, ECC0010"></H3>
  ...
  <table class="tbenter" HEIGHT="75%" width="100%" border="0">
    ...
    <tr> 
      <td nowrap ALIGN=CENTER>Numero de Cuenta: 
        <INPUT type="text" name="E01CCMACC" size="13" maxlength="12" onkeypress="enterInteger(event)">
        <a href="javascript:GetAccount('E01CCMACC','','94','<%= client %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
			<br>
 <div align="center"> 
