...
%>
  ...
  <TABLE class="tableinfoList" style="width:95%" ALIGN=CENTER>
    <TR id="trdark"> 
      ...
      <TH ALIGN=LEFT  nowrap width="40%">Descripción</TH>
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25"> <%
        if ( ewd0010Help.getShowPrev() ) {
      			int pos = ewd0010Help.getFirstRec() - 21;
      			 out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.helps.JSEWD0010?NameSearch=" + NameSearch + "&FromRecord=" + pos +  "&shrBank=" + shrBank + "&shrAppCode=" + shrAppCode + "&shrCurrency=" + shrCurrency + "&shrType=" + shrType +"\" > <img src=\""+request.getContextPath()+"/images/s/previous_records.gif\" border=0></A>");
        }
%> </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> <%       
        if ( ewd0010Help.getShowNext() ) {
      			int pos = ewd0010Help.getLastRec();
      			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.helps.JSEWD0010?NameSearch=" + NameSearch + "&FromRecord=" + pos +  "&shrBank=" + shrBank + "&shrAppCode=" + shrAppCode + "&shrCurrency=" + shrCurrency + "&shrType=" + shrType + "\" > <img src=\""+request.getContextPath()+"/images/s/next_records.gif\" border=0></A>");
