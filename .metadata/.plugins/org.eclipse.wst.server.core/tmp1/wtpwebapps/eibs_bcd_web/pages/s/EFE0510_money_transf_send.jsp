...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transf_send.jsp,EFE0510">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE02REMAD1(),msgMT.getE02REMAD2(),msgMT.getE02REMAD3())  + " - " + Util.formatCell(msgMT.getE02REMAPT())%></TD>
		</TR>    		
    <%             
    				chk = "";     
                }
