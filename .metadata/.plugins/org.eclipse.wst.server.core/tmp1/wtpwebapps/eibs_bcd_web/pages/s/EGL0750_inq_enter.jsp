...
%>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.accounting.JSEGL0750" >
  ...
  <h3 align="center">Consulta de Balances<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inq_enter.jsp,EGL0750"> 
  </h3>
  <hr size="4">
<p></p>
      ...
      <td> 
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <TR>
            ...
            <td nowrap width="50%" align="left"> 
              <input type="text" name="E01GLBBRN" size="5" maxlength="4"  >
              <a href="javascript:GetBranch('E01GLBBRN','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"  ></a>
            </td>
          </tr>
          <tr>
            ...
            <td nowrap width="50%" align="left"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E01GLBCLS','','01')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
            </td>
          </tr>
          <tr>
            <td nowrap width="50%" align="right">Descripcion :</td>
            <td nowrap width="50%" align="left"> 
              <input type="text" name="E01GLBDSC" size="65" maxlength="60"  >
            </td>
          </tr>
          <tr>
            ...
            <td nowrap width="50%" align="left"> 
              ...
              <a href="javascript:GetCurrency('E01GLBCCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr>
            ...
            <td nowrap width="50%" align="left"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E01GLBATY','','04')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
            </td>
          </tr>
          <tr>
            <td nowrap width="50%" align="right">Centro de Costo :</td>
            <td nowrap width="50%" align="left"> 
              <input type="text" name="E01GLBCCN" size="9" maxlength="8"  >
              <a href="javascript:GetCostCenter('E01GLBCCN','01')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a> 
            </td>
          </tr>
          <tr>
            ...
            <td nowrap width="50%" align="left"> 
              ...
              <a href="javascript:GetLedger('E01GLBGLN',document.forms[0].E01GLBBNK.value,document.forms[0].E01GLBCCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            </td>
          </tr>
         <tr>
