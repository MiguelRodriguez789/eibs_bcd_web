...
<html>
<head>
<title>Cambio de Estado de Negociacion de Creditos</title>
...
<script type="text/javascript">
 ...
 function goAction(op,row) {
 	if (!isValidObject(getElement("key"))) {
 		return;
 	}
	var params = "&ROW=" + getElementChecked('key').value;
	var pg = "<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0555?SCREEN=3002" + params;
...
<h3 align="center">Cambio de Estado de Negociacion de Creditos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="salesplatform_chg_status_list.jsp,EDL0555"></h3>
<hr size="4">
<form method="POST" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0555">
<input type="hidden" id="SCREEN" name="SCREEN" value="3002"> 
<input type="hidden" id="TYPE" name="TYPE" value=""> 
  ...
  <table class="tbenter" style="width: 100%;">
    <tr>
      ...
      <td align="center" class="tdbkg" width="33%"><a href="javascript:goAction('3002')"><b>Modificar</b></a></td>
      <% } %>
    </tr>
  </table>
        ...
        <div id="dataDiv1"  style="height:360px; overflow:auto;"> 
          ...
          %>
            <tr id="dataTable<%= msgList.getCurrentRow() %>">
              ...
              <td nowrap align="center" width="10%"><a href="javascript:goAction('3002',<%=msgList.getCurrentRow()%>);"><%=list.getE02DLNOFN()%></a></td>
              <td nowrap align="center" width="10%"><a href="javascript:goAction('3002',<%=msgList.getCurrentRow()%>);"><%=list.getE02SELCUN()%></a></td>
              <td nowrap align="left" width="40%"><a href="javascript:goAction('3002',<%=msgList.getCurrentRow()%>);"><%=list.getE02DSCPRO()%></a></td>
              <td nowrap align="center" width="10%"><a href="javascript:goAction('3002',<%=msgList.getCurrentRow()%>);"><%= Util.formatCustomDate(currUser.getE01DTF(), list.getBigDecimalE02DLNODM().intValue(), 
              										    list.getBigDecimalE02DLNODD().intValue(),
               										    list.getBigDecimalE02DLNODY().intValue()) %></a></td>
              <td nowrap align="center" width="10%"><a href="javascript:goAction('3002',<%=msgList.getCurrentRow()%>);">
				<% if (list.getField("E02DLNSTS").getString().equals("")) {
