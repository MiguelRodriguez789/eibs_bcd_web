...
%>
<div align="center"> 
  <h3>Mantenimiento Orden de Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_trade_tickets.jsp,EIE0130M"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="4" >
              <div align="right"><a href="javascript:GetInvestmentsByCustomer(document.forms[0].E01ORDCUN.value,'E01ORDPRF','E01ORDIIC','E01ORDICN','E01ORDSCY','E01ORDCUC','E01ORDCCN','E01ORDPTY','E01ORDVNO','E01ORDQTY','E01ORDCSP','E01ORDSYM','E01ORDISI','E01ORDATY','E01ORDLP2','E01ORDLP1','E01ORDLP3')">Inversiones 
                por Cliente<img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a><a href="javascript:GetInvestmentsByCustomer(document.forms[0].E01ORDCUN.value,'E01ORDPRF','E01ORDIIC','E01ORDICN','E01ORDSCY','E01ORDCUC','E01ORDCCN','E01ORDPTY','E01ORDVNO','E01ORDQTY','E01ORDCSP','E01ORDSYM','E01ORDISI','E01ORDATY','E01ORDLP2','E01ORDLP1','E01ORDLP3')"> 
                </a></div>
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="5" > 
              ...
              <input type="text" readonly  name="E01ORDHAC" size="12" maxlength="9" value="<%= invTrade.getE01ORDHAC()%>"
                onmousedown="init(accountHelp,this.name,document.forms[0].E01ORDHBK.value,'','','','RT')" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="17%"> 
              <div align="center"> 
                <input type="text" readonly    name="E01ORDPBR" size="5" maxlength="4"
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="33%" > 
              <div align="left"> 
                ...
                <a href="javascript:GetCommCustodyTable('E02ORDOCT',document.forms[0].E02ORDPTY.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a></div>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap colspan="4" > 
            ...
            <td nowrap > 
              <div align="center"> 
                <select name="E01ORDBPT">
                  ...
                  <option value="2" <%if (invTrade.getE01ORDBPT().equals("2")) {  out.print("selected"); }%>>Cheque Oficiales</option>
