...
<BODY>
<H3 align="center">Cambio de Clave<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="change_password, ESS0030"></H3>
<hr size="4">
  ...
  <TABLE CLASS="tbenter" WIDTH=98% HEIGHT=85% BORDER=0>
    ...
    <TABLE class="tableinfo"0>
	   <TR  id="trdark">    
        ...
        <TD width="50%"> 
          <INPUT TYPE="password" SIZE=12 MAXLENGTH=15 NAME="LoginPassword">
        </TD>
   	  </TR>
	   <TR  id="trclear">    
        ...
        <TD width="50%"> 
          <INPUT TYPE="password" SIZE=12 MAXLENGTH=15 NAME="LoginPassword_1">
        </TD>
   	  </TR>
	    <TR id="trdark">
        <TD ALIGN=right width="50%" > 
        ...
        <TD width="50%"> 
          <INPUT TYPE="password" SIZE=12 MAXLENGTH=15 NAME="LoginPassword_2">
        </TD>
   	  </TR>
     </TABLE>
    </TD>
    ...
    <TABLE class="tableinfo">
	   <TR  id="trdark">    
              <TD ALIGN=right width="50%" > Clave : </TD>
        <TD width="50%"> 
          <INPUT TYPE="password" SIZE=12 MAXLENGTH=15 NAME="AppPassword">
        </TD>
   	 </TR>
	   <TR  id="trclear">    
        <TD ALIGN=right width="50%" > 
        ...
        <TD width="50%"> 
          <INPUT TYPE="password" SIZE=12 MAXLENGTH=15 NAME="AppPassword_1">
        </TD>
   	 </TR>
	    <TR id="trdark">
        <TD ALIGN=right width="50%" > 
        ...
        <TD width="50%"> 
          <INPUT TYPE="password" SIZE=12 MAXLENGTH=15 NAME="AppPassword_2">
        </TD>
   	  </TR>
     </TABLE>
    </TD>
