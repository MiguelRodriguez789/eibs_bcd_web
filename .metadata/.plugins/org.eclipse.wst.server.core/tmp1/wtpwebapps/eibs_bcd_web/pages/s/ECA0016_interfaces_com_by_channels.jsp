...
<jsp:useBean id= "msgRcd" class= "datapro.eibs.beans.ECA001601Message"  scope="session" />
...
<h3 align="center">Mantenimiento Comisiones por canal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="interfaces_com_by_channels.jsp, ECA0016"></h3>
<hr size="4">

<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.interfaces.JSECA0016" >
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          	...
          	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
           	<td nowrap width=10% align="right">Tabla : </td>
				...
				<td nowrap width=40% align="left">
            		<input type="text" name="E01CBCDSC" size="62" maxlength="60"  value="<%=msgRcd.getE01CBCDSC()%>"><%=mandatory %>
				</td>
	  		</tr>
          	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCTP1" size="3" maxlength="1"
	              class="context-menu-help" onmousedown="init(staticCoTypHelp,this.name)" value="<%= msgRcd.getE01CBCTP1()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCFA2" size="3" maxlength="1"
	              ...
	              onmousedown="init(staticCoFactHelp,this.name)" value="<%= msgRcd.getE01CBCFA2()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCTP2" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoTypHelp,this.name)" value="<%= msgRcd.getE01CBCTP2()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCFA3" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoFactHelp,this.name)" value="<%= msgRcd.getE01CBCFA3()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCTP3" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoTypHelp,this.name)" value="<%= msgRcd.getE01CBCTP3()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCFA4" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoFactHelp,this.name)" value="<%= msgRcd.getE01CBCFA4()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCTP4" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoTypHelp,this.name)" value="<%= msgRcd.getE01CBCTP4()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCTP5" size="3" maxlength="1"
	              class="context-menu-help" onmousedown="init(staticCoTypHelp,this.name)" value="<%= msgRcd.getE01CBCTP5()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCFA6" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoFactHelp,this.name)" value="<%= msgRcd.getE01CBCFA6()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCTP6" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoTypHelp,this.name)" value="<%= msgRcd.getE01CBCTP6()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
           ...
           <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCVA7" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= msgRcd.getE01CBCVA7()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCMI7" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= msgRcd.getE01CBCMI7()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCMA7" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= msgRcd.getE01CBCMA7()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCFA7" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoFactHelp,this.name)" value="<%= msgRcd.getE01CBCFA7()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCTP7" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoTypHelp,this.name)" value="<%= msgRcd.getE01CBCTP7()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCBK7" size="2" maxlength="2" value="<%= msgRcd.getE01CBCBK7()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCCY7" size="3" maxlength="3" value="<%= msgRcd.getE01CBCCY7()%>"
	              class="context-menu-help"
	              onmousedown="init(currencyHelp,this.name,document.forms[0].E01CBCBK7.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCGI7" size="17" maxlength="16" value="<%= msgRcd.getE01CBCGI7()%>" 
	              class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.forms[0].E01CBCBK7.value,document.forms[0].E01CBCCY7.value,'','','')" >
              </div>
            </td>
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E01CBCDE7" size="25" maxlength="20" value="<%= msgRcd.getE01CBCDE7()%>">
              </div>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCVA8" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= msgRcd.getE01CBCVA8()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCMI8" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= msgRcd.getE01CBCMI8()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCMA8" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= msgRcd.getE01CBCMA8()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCFA8" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoFactHelp,this.name)" value="<%= msgRcd.getE01CBCFA8()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCTP8" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoTypHelp,this.name)" value="<%= msgRcd.getE01CBCTP8()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCBK8" size="2" maxlength="2" value="<%= msgRcd.getE01CBCBK8()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCCY8" size="3" maxlength="3" value="<%= msgRcd.getE01CBCCY8()%>"
	              class="context-menu-help"
	              onmousedown="init(currencyHelp,this.name,document.forms[0].E01CBCBK8.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCGI8" size="17" maxlength="16" value="<%= msgRcd.getE01CBCGI8()%>" 
	              class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.forms[0].E01CBCBK8.value,document.forms[0].E01CBCCY8.value,'','','')" >
              </div>
            </td>
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E01CBCDE8" size="25" maxlength="20" value="<%= msgRcd.getE01CBCDE8()%>">
              </div>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCVA9" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= msgRcd.getE01CBCVA9()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCMI9" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= msgRcd.getE01CBCMI9()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCMA9" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= msgRcd.getE01CBCMA9()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCFA9" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoFactHelp,this.name)" value="<%= msgRcd.getE01CBCFA9()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCTP9" size="3" maxlength="1"
	              class="context-menu-help"
	              onmousedown="init(staticCoTypHelp,this.name)" value="<%= msgRcd.getE01CBCTP9()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCBK9" size="2" maxlength="2" value="<%= msgRcd.getE01CBCBK9()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCCY9" size="3" maxlength="3" value="<%= msgRcd.getE01CBCCY9()%>"
	              class="context-menu-help"
	              onmousedown="init(currencyHelp,this.name,document.forms[0].E01CBCBK9.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01CBCGI9" size="17" maxlength="16" value="<%= msgRcd.getE01CBCGI9()%>" 
	              class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.forms[0].E01CBCBK9.value,document.forms[0].E01CBCCY9.value,'','','')" >
              </div>
            </td>
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E01CBCDE9" size="25" maxlength="20" value="<%= msgRcd.getE01CBCDE9()%>">
              </div>
            </td>
          </tr>
        </table>
