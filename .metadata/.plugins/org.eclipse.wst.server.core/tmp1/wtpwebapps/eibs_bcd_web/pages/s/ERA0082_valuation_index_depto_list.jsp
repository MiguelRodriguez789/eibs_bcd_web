...
function getParams(currrow,dpto,ddpto) {
	getElement("CURRENTROW").value = currrow;
    document.forms[0].E01TB2DPT.value = dpto;
    document.forms[0].D01TB2DPT.value = ddpto;
}
...
function submitThis(option) {
  ...
  getElement("SCREEN").value="2";
   switch (option) {
    ...
    case 5 :{
	         document.forms[0].H01FLGWK1.value = "C";
            ...
            //actualizacion
    case 7 :{
	         document.forms[0].H01FLGWK1.value = "D";
...
<h3 align="center">Tabla de Indices de Avalúos para Bienes Inmuebles. Nivel Departamental. Año <%= userPO.getHeader20().trim() %>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="valuation_index_depto_list,ERA0082"></h3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSERA0082">
  <p> 
    ...
    <INPUT TYPE=HIDDEN NAME="E01TB2DPT" id="E01TB2DPT" VALUE="">
    <INPUT TYPE=HIDDEN NAME="D01TB2DPT" id="D01TB2DPT" VALUE="">
...
<div id="button_bar"> 
  <table class="tbenter" width=100% align=center>
    ...
    <td class=TDBKG width="20%">
        <div align="center">
        <a href="javascript:submitThis(5)"><b>Seleccionar Departamento</b></a>
        </div> 
    </td> 
    <td class=TDBKG width="20%">
        <div align="center">
        <a href="javascript:submitThis(7)"><b>Guardar  Cambios % Departamentos</b></a>
        </div> 
    </td> 
      <td class=TDBKG width="20%"> 
      ...
      <td class=TDBKG width="20%" >
        <div align="center">
        <a href="javascript:printMe()"><b>Imprimir</b></a>
        </div> 
      </td>    
    </tr>
  </table>
      ...
      <td NOWRAP valign="top" width="100%"> 
		<table id="headTable" width="98%">
			<tr id="trdark">
	            ...
	            <th align=CENTER nowrap width="5%"> <div align="center">Código</div> </th>
	            <th align=CENTER nowrap width="10%">Departamento</th>
		  ...
		  <tr  height="95%">    
		    <td nowrap="nowrap">      
		       <div id="dataDiv1" style="height:850px; overflow:auto;"> 
    ...
    %> 
		 ...
		 %>
          <tr> 
			...
			<INPUT TYPE=HIDDEN NAME="E01TB2DPT_<%= trans.getCurrentRow() %>"  VALUE="<%=trans.getRecord(1)%>">
			<INPUT TYPE=HIDDEN NAME="E01TB2CTY_<%= trans.getCurrentRow() %>"  VALUE="<%=trans.getRecord(18)%>">
                <input type="radio" name="CURRROW" value="" <%=chk%> onClick="getParams(this.value,'<%= trans.getRecord(1) %>','<%= trans.getRecord(2) %>')">
            </td>
	      	<td align="center" nowrap width="5%">  
				<div ><%=trans.getRecord(1)%></DIV>
      		</td>
	      	<td align="center" nowrap width="10%">  
				<div ><%=trans.getRecord(2)%></DIV>
      		</td>
