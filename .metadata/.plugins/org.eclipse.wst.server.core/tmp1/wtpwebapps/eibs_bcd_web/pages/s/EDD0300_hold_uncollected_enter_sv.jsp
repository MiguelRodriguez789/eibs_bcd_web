...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="hold_uncollected_enter.jsp , EDD0300"> 
</h3><hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0300">
  ...
  <table class="tbenter" height="75%" width="100%" border="0">
    <tr>
          ...
          Número de Cuenta :   
              <input type="text" name="E01UNCACC" size="13" maxlength="12" onkeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E01UNCACC','','04','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0"  ></a> 
            <p>
    			<div align="center"> 
