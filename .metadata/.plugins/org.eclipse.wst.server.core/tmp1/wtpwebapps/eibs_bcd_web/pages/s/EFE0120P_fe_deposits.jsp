...
%> 
<h3 align="center"> Dep&oacute;sitos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_deposits.jsp,EFE0120P"> 
</h3>
<hr size="4">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="85%" > 
              <div align="left"> 
                ...
                <%= fex.getD01FESCPL()%> Datapro, Inc.</div>
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="15%" >
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              ...
              <a href="javascript:GetBrokerT('E01FESBRK','D01FEBNM1')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a> 
            </td>
          ...
          <tr id="trdark"> 
            ...
            <INPUT type="text" name="E01FESVD1" size="3" maxlength="2" value="<%= fex.getE01FESVD1().trim()%>">
              ...
              <INPUT type="text" name="E01FESVD3" size="5" maxlength="4" value="<%= fex.getE01FESVD3().trim()%>"></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
