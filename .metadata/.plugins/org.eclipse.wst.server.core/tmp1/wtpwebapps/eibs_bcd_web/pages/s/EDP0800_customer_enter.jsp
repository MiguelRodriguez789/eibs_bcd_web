...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0800">
  ...
  <table class="tbenter" cellspacing=0 cellpadding=3 width="100%" border="0">
    <tr> 
      ...
      <td width="10%"> 
            <input type=TEXT name="E01DUECUN" size=10 maxlength=9 value="" onKeypress="enterInteger(event)"  value="<%= userPO.getCusNum().trim()%>" >
       ...
       <td width="30%"> 
      		<input type="text" name="E01DUENA1" size="45" maxlength="45" value="" readonly>
       </td>
    </tr>
  </table>
