...
%> 
<h3 align="center"> Confirmaci&oacute;n - L&iacute;mites Establecidos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_lim_basic_confirm_delete.jsp,EFE0325"> 
</h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap colspan="2" >Los l&iacute;mites establecidos para el cliente 
              <%= fex.getD01FEOCP1()%> han sido borrados</td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="36%" > 
