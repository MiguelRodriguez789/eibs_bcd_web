...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="references_inq_list.jsp,EPR0000">
</h3>
<hr size="4">
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEPR0000" >
 ...
 <INPUT TYPE=HIDDEN ID="SCREEN" NAME="SCREEN" VALUE="203">
 ...
 <TABLE  id="mainTable" class="tableinfo" >
  <TR> 
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			<TD NOWRAP width="2%"><input type="radio" id="ROW" name="ROW" value="<%= mtListRef.getCurrentRow()%>" <%=chk%> onClick="document.forms[0].CURRENTROW.value = this.value;"></TD>
