...
%> 
<h3 align="center"> Detalles Interfase de Pagos - Consulta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inq_payments_basic.jsp,EPR0015"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap > 
              ...
              <input type="text" readonly  name="E01PRCTD3" size="5" maxlength="4" value="<%= payments.getE01PRCTD3()%>" >
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
