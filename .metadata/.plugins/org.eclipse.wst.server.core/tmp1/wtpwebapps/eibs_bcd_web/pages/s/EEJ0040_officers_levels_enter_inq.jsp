...
<H3 align="center">Consulta de Niveles de Ejecutivos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="officers_levels_enter_inq,EEJ0040"></H3>
<hr size="4">
<p>&nbsp;</p>
        ...
        <tr id=trdark> 
		  <td nowrap width="40%"> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E01EJVOFC','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
