  ...
  <% if(request.getParameter("OPTMENU") != null) { %>
   ...
   <%} else {%>
	<% if (userPO.getAccOpt().equals("T") )  { %>
			builtNewMenu(lc_apr_tranfer_cc_maint<%=("Y".equals(request.getParameter("E01DOMFLG"))?"_local":"")%>);
	<% } else { %>
...
<BODY>
<H3 align="center">Consulta de Historial de Cartas de Crédito de Exportación<IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="ELC0460_lc_inquiry_export.jsp"></H3>
<HR size="4">
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0" >
    <tr id="trdark">
      ...
      <td width="18%"><input type="text" name="E02ACC" size="25" maxlength="30" value="<%= userPO.getHeader2() %>" readonly></td>
    ...
    <tr id="trdark">
      ...
      <td width="18%"><input type="text" name="E02ACC" size="25" maxlength="30" value="<%= userPO.getHeader5() %>" readonly></td>
      <td height="18%" align="right"><b>Fecha y Hora  :</b></td>
...
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo" id="trclear">
    <TR id="trdark">
      ...
      <TD nowrap width="16%" align="right"><B>N&uacute;mero de Carta de Cr&eacute;dito :</B> </TD>
      <TD nowrap width="16%" align="left"><B> <B>
        <INPUT type="text" name="E01LCMACC" size="16" maxlength="12"
			value="<%= msg046001.getE01LCMACC().trim()%>" readonly>
      </B></B></TD>
    </TR>
    <TR>
  ...
  <TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
    ...
    <TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
      ...
      <TR id="">
        ...
        <TD nowrap><SELECT name="E01LCMAF1" disabled>
            ...
            <INPUT name="E01LCMIBA" type="text" value="<%=msg046001.getE01LCMIBA()%>" size="12" maxlength="12" readonly="readonly"
        	<%if (msg046001.getF01LCMIBA().equals("Y")) out.print("class=\"txtchanged\"");%>>
             </TD>
      </TR>
      <TR id="">
        <TD align="right">Codigo Swift: </TD>
        <TD align="left" nowrap><INPUT name="E01LCMIBI" type="text" value="<%=msg046001.getE01LCMIBI()%>" size="14" maxlength="12" readonly="readonly"
        	<%if (msg046001.getF01LCMIBI().equals("Y")) out.print("class=\"txtchanged\"");%>>
          </TD>
      </TR>
      <TR id="">
        <TD align="right">Nombre: </TD>
        <TD align="left" nowrap><INPUT name="E01LCMIB1" type="text" value="<%=msg046001.getE01LCMIB1()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMIB1().equals("Y")) out.print("class=\"txtchanged\"");%>>
          <IMG src="<%=request.getContextPath()%>/images/Check.gif"
			title="campo obligatorio" border="0"></TD>
      </TR>
      <TR id="">
        <TD align="right">Dirección: </TD>
        <TD align="left"><INPUT name="E01LCMIB2" type="text" value="<%=msg046001.getE01LCMIB2()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMIB2().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD></TD>
        <TD align="left"><INPUT name="E01LCMIB3" type="text" value="<%=msg046001.getE01LCMIB3()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMIB3().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD></TD>
        <TD align="left"><INPUT name="E01LCMIB4" type="text" value="<%=msg046001.getE01LCMIB4()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMIB4().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD align="right" valign="bottom">Estado: </TD>
        <TD align="left" valign="bottom" nowrap><INPUT name="E01LCMIB5" type="text" value="<%=msg046001.getE01LCMIB5()%>" size="2" maxlength="2" readonly="readonly"
        	<%if (msg046001.getF01LCMIB5().equals("Y")) out.print("class=\"txtchanged\"");%>>
          Código Postal
          <INPUT name="E01LCMIB6" type="text" value="<%=msg046001.getE01LCMIB6()%>" size="11" maxlength="10" readonly="readonly"
        	<%if (msg046001.getF01LCMIB6().equals("Y")) out.print("class=\"txtchanged\"");%>>
          País
          <INPUT name="E01LCMIB7" type="text" value="<%=msg046001.getE01LCMIB7()%>" size="4" maxlength="4" readonly="readonly"
        	<%if (msg046001.getF01LCMIB7().equals("Y")) out.print("class=\"txtchanged\"");%>>
           </TD>
      </TR>
    </TABLE>
    <BR>
    <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
      ...
      <TR id="">
        ...
        <TD align="left" nowrap><INPUT name="E01LCMCBC" type="text" value="<%=msg046001.getE01LCMCBC()%>" size="12" maxlength="12" readonly="readonly"
        	<%if (msg046001.getF01LCMCBC().equals("Y")) out.print("class=\"txtchanged\"");%>>
          </TD>
      </TR>
      <TR id="">
        <TD nowrap="nowrap" align="right">Codigo Swift: </TD>
        <TD align="left"><INPUT name="E01LCMCAI" type="text" value="<%=msg046001.getE01LCMCAI()%>" size="12" maxlength="12" readonly="readonly"
        	<%if (msg046001.getF01LCMCAI().equals("Y")) out.print("class=\"txtchanged\"");%>>
           </TD>
      </TR>
      <TR id="">
        <TD align="right"> Nombre: </TD>
        <TD align="left"><INPUT name="E01LCMCA1" type="text" value="<%=msg046001.getE01LCMCA1()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMCA1().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD align="right">Dirección: </TD>
        <TD align="left"><INPUT name="E01LCMCA2" type="text" value="<%=msg046001.getE01LCMCA2()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMCA2().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD></TD>
        <TD align="left"><INPUT name="E01LCMCA3" type="text" value="<%=msg046001.getE01LCMCA3()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMCA3().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD></TD>
        <TD align="left"><INPUT name="E01LCMCA4" type="text" value="<%=msg046001.getE01LCMCA4()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMCA4().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD align="right" valign="bottom">Estado: </TD>
        <TD align="left" nowrap><INPUT name="E01LCMCA5" type="text" value="<%=msg046001.getE01LCMCA5()%>" size="2" maxlength="2" readonly="readonly"
        	<%if (msg046001.getF01LCMCA5().equals("Y")) out.print("class=\"txtchanged\"");%>>
          Código Postal
          <INPUT name="E01LCMCA6" type="text" value="<%=msg046001.getE01LCMCA6()%>" size="11" maxlength="10" readonly="readonly"
        	<%if (msg046001.getF01LCMCA6().equals("Y")) out.print("class=\"txtchanged\"");%>>
          País
          <INPUT name="E01LCMCA7" type="text" value="<%=msg046001.getE01LCMCA7()%>" size="3" maxlength="7" readonly="readonly"
        	<%if (msg046001.getF01LCMCA7().equals("Y")) out.print("class=\"txtchanged\"");%>>
          </TD>
      </TR>
    </TABLE>
...
<!-- <TABLE width="100%" border="0" align="center" cellpadding="2"  cellspacing="0" class="tableinfo">
      ...
      <TR id="">
        <TD width="35%" align="right" nowrap="nowrap">Cliente: </TD>
        <TD align="left" nowrap><INPUT name="E01LCMCOR" type="text" id="E01LCMCOR" value="<%=msg046001.getE01LCMCOR()%>" size="12" maxlength="12" readonly="readonly"
        	<%if (msg046001.getF01LCMCOR().equals("Y")) out.print("class=\"txtchanged\"");%>>
             Linea de Credito:
          <INPUT name="E01LCMCMG" type="text" value="<%=msg046001.getE01LCMCMG()%>" size="4" maxlength="4" readonly="readonly"
        	<%if (msg046001.getF01LCMCMG().equals("Y")) out.print("class=\"txtchanged\"");%>>
		  </TD>
      </TR>
      <TR id="">
        <TD nowrap="nowrap" align="right">Codigo Swift: </TD>
        <TD align="left"><INPUT name="E01LCMCBI" type="text" id="E01LCMCBI" value="<%=msg046001.getE01LCMCBI()%>" size="12" maxlength="12" readonly="readonly"
        	<%if (msg046001.getF01LCMCBI().equals("Y")) out.print("class=\"txtchanged\"");%>>
           </TD>
      </TR>
      <TR id="">
        <TD align="right"> Nombre: </TD>
        <TD align="left"><INPUT name="E01LCMCB1" type="text" id="E01LCMCB1" value="<%=msg046001.getE01LCMCB1()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMCB1().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD align="right">Direcci&oacute;n: </TD>
        <TD align="left"><INPUT name="E01LCMCB2" type="text" id="E01LCMCB2" value="<%=msg046001.getE01LCMCB2()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMCB2().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD></TD>
        <TD align="left"><INPUT name="E01LCMCB3" type="text" id="E01LCMCB3" value="<%=msg046001.getE01LCMCB3()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMCB3().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD></TD>
        <TD align="left"><INPUT name="E01LCMCB4" type="text" id="E01LCMCB4" value="<%=msg046001.getE01LCMCB4()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMCB4().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD align="right" valign="bottom">Estado </TD>
        <TD align="left" nowrap><INPUT name="E01LCMCB5" type="text" id="E01LCMCB5" value="<%=msg046001.getE01LCMCB5()%>" size="2" maxlength="2" readonly="readonly"
        	<%if (msg046001.getF01LCMCB5().equals("Y")) out.print("class=\"txtchanged\"");%>>
          C&oacute;digo Postal
          <INPUT name="E01LCMCB6" type="text" id="E01LCMCB6" value="<%=msg046001.getE01LCMCB6()%>" size="11" maxlength="10" readonly="readonly"
        	<%if (msg046001.getF01LCMCB6().equals("Y")) out.print("class=\"txtchanged\"");%>>
          Pa&iacute;s
          <INPUT name="E01LCMCB7" type="text" id="E01LCMCB7" value="<%=msg046001.getE01LCMCB7()%>" size="3" maxlength="7" readonly="readonly"
        	<%if (msg046001.getF01LCMCB7().equals("Y")) out.print("class=\"txtchanged\"");%>>
          </TD>
      </TR>
    </TABLE> -->
    ...
    <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
      ...
      <TR id="">
        ...
        <TD  align="left" nowrap><INPUT name="E01LCMRBA" type="text" value="<%=msg046001.getE01LCMRBA()%>" size="12" maxlength="12" readonly="readonly"
        	<%if (msg046001.getF01LCMRBA().equals("Y")) out.print("class=\"txtchanged\"");%>>
              </TD>
      </TR>
      <TR id="">
        <TD nowrap="nowrap" align="right">Codigo Swift: </TD>
        <TD align="left" nowrap><INPUT name="E01LCMRBI" type="text" value="<%=msg046001.getE01LCMRBI()%>" size="14" maxlength="12" readonly="readonly"
        	<%if (msg046001.getF01LCMRBI().equals("Y")) out.print("class=\"txtchanged\"");%>>
          </TD>
      </TR>
      <TR id="">
        <TD align="right" nowrap="nowrap">Nombre: </TD>
        <TD><INPUT name="E01LCMRB1" type="text" value="<%=msg046001.getE01LCMRB1()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMRB1().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD align="right">Dirección: </TD>
        <TD align="left"><INPUT name="E01LCMRB2" type="text" value="<%=msg046001.getE01LCMRB2()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMRB2().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD width="35%"></TD>
        <TD align="left"><INPUT name="E01LCMRB3" type="text" value="<%=msg046001.getE01LCMRB3()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMRB3().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD></TD>
        <TD align="left"><INPUT name="E01LCMRB4" type="text" value="<%=msg046001.getE01LCMRB4()%>" size="45" maxlength="35" readonly="readonly"
        	<%if (msg046001.getF01LCMRB4().equals("Y")) out.print("class=\"txtchanged\"");%>>
        </TD>
      </TR>
      <TR id="">
        <TD align="right" valign="bottom">Estado: </TD>
        <TD align="left" valign="bottom" nowrap><INPUT name="E01LCMRB5" type="text" value="<%=msg046001.getE01LCMRB5()%>" size="2" maxlength="2" readonly="readonly"
        	<%if (msg046001.getF01LCMRB5().equals("Y")) out.print("class=\"txtchanged\"");%>>
          Código Postal
          <INPUT name="E01LCMRB6" type="text" value="<%=msg046001.getE01LCMRB6()%>" size="11" maxlength="10" readonly="readonly"
        	<%if (msg046001.getF01LCMRB6().equals("Y")) out.print("class=\"txtchanged\"");%>>
          País
          <INPUT name="E01LCMRB7" type="text" value="<%=msg046001.getE01LCMRB7()%>" size="4" maxlength="4" readonly="readonly"
        	<%if (msg046001.getF01LCMRB7().equals("Y")) out.print("class=\"txtchanged\"");%>>
          </TD>
      </TR>
    </TABLE>
</FORM>
