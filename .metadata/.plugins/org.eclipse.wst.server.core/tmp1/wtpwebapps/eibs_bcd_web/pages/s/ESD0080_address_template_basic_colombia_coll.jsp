        	...
        	<td nowrap >
        		<table cellspacing="0" cellpadding="2" width="100%" border="0">
          			...
          			<tr id="<%=color2%>"> 
            			...
            			<td nowrap > 
              				<input type="text" name="CSTE<%=i%>"  size="3" maxlength="2" value="<%= mr.getField(departamento).getString()%>" readonly onChange="chgDpto<%=i%>(1)" >
              				...
              				<% if ( !readOnly ) { %>
              					<A href="javascript:GetCodeDescCNOFC('CSTE<%=i%>','CDSTE<%=i%>','27')" >
            			...
            			<td nowrap >
              				<input type="text" name="CCTYCOD<%=i%>" size="6" maxlength="5" value="<%= mr.getField(ciudad).getString()%>" readonly onChange="chgData<%=i%>(1)" >
