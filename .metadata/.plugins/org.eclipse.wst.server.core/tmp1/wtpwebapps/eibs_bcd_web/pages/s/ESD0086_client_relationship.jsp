...
<H3 align="center"><%=title%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_relationship.jsp, ESD0086"></H3>
<hr size="4">
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
         ...
         <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td nowrap width="5%" align="right">Comentarios : </td> 
            <td nowrap width="35%" align="left">
            	<textarea name="E01RMK" cols="64" rows="4" <%=read%>><%=ESD0086Record.getE01RMK()%></textarea>
            </td> 
            <% if ( userPO.getHeader10().equals("C") && ESD0086Record.getH01LGT().equals("1") ) { %>
            	<td nowrap width="15%" align="right">Representante Legal :</td>
				<td nowrap width="35%" align="left">
					<select name="E01FL1" <%=disabled%>>
