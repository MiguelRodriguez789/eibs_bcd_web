...
de Tarjetas de Débito<BR>Consulta de Tarjeta Adicional<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="additional_card_info.jsp, ECC0090"></h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E03PRICUN" size="10" maxlength="9" value="<%= msgCD.getE03PRICUN().trim()%>" readonly>
			  </div>
            </td>
            <td nowrap width="16%" > 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E03PRICUNA" size="10" maxlength="9" value="<%= msgCD.getE03PRICUNA().trim()%>" readonly>
			  </div>
            </td>
            <td nowrap width="16%" ></td>
