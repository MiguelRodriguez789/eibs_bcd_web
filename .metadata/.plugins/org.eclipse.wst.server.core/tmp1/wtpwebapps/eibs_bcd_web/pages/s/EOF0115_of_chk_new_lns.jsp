...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEOF0115">
  ...
  out.print("Emisi&oacute;n de Cheques por Desembolso de Descuento de Documentos"); }
  else { 
  out.print("Emisi&oacute;n de Cheques por Desembolso de Préstamos"); }
  %>
  <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="of_chk_new_lns, EOF0115"> 
  </h3>
