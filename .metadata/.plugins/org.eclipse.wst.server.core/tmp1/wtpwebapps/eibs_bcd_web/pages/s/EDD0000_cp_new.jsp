...
<%
 ...
 if (currClient != null && error.getERRNUM().equals("0")) {
    ...
    CUSCUN = cpBasic.getE01ACMCUN().trim();
    CUSNA1 = cpBasic.getE01CUSNA1().trim();
 }
...
%> 
<H3 align="center"> Apertura de Cuentas Cuotas de Participaci&oacute;n
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cp_new.jsp, EDD0000"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E01ACMACC" size="15" maxlength="12" readonly value="<% if (cpBasic.getE01ACMACC().trim().equals("999999999999")) out.print("NUEVA CUENTA"); else out.print(cpBasic.getE01ACMACC().trim()); %>">
              </div>
            </td>
            <td nowrap width="16%"> 
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trclear"> 
            <td nowrap width="29%"> 
              <div align="right">Nombre Alias :</div>
            </td>
            <td nowrap width="19%"> 
              <input type="text" name="E01ACMNME" size="60" maxlength="80" value="<%= cpBasic.getE01ACMNME().trim()%>">             
            </td>
            <td nowrap width="26%"> 
            </td>
            <td nowrap width="26%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="19%"> 
					<eibsinput:date name="cpBasic" fn_year="E01ACMOPY" fn_month="E01ACMOPM" fn_day="E01ACMOPD" />
            </td>
            <td nowrap width="26%"> 
            ...
            <td nowrap width="26%"> 
              <select name="E01ACMRCD">
                <option value=" " <% if (!(cpBasic.getE01ACMRCD().equals("D") ||cpBasic.getE01ACMRCD().equals("C")||cpBasic.getE01ACMRCD().equals("A"))) out.print("selected"); %>></option>
                <option value="D" <% if (cpBasic.getE01ACMRCD().equals("D")) out.print("selected"); %>>D&eacute;bitos</option>
                <option value="C" <% if (cpBasic.getE01ACMRCD().equals("C")) out.print("selected"); %>>Cr&eacute;ditos</option>
                <option value="A" <% if (cpBasic.getE01ACMRCD().equals("A")) out.print("selected"); %>>Ambos</option>
              </select>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%"> 
              <input type="text" name="E01ACMWHF" size="2" maxlength="1" value="<%= cpBasic.getE01ACMWHF().trim()%>" readonly>
              <a href="javascript:GetCode('E01ACMWHF','STATIC_cd_taxes.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            ...
            <td nowrap width="26%"> 
              <select name="E01ACMPEC">
                <option value=" " <% if (!(cpBasic.getE01ACMPEC().equals("1") ||cpBasic.getE01ACMPEC().equals("2"))) out.print("selected"); %>></option>
                <option value="1" <%if (cpBasic.getE01ACMPEC().equals("1")) out.print("selected"); %>>Indistinto</option>
                <option value="2" <% if (cpBasic.getE01ACMPEC().equals("2")) out.print("selected"); %>>Conjunto</option>
			  </select>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%" height="19"> 
              <input type="text" name="E01ACMMLA" size="2" maxlength="2" value="<%= cpBasic.getE01ACMMLA().trim()%>">
              <a href="javascript:GetMailing('E01ACMMLA',document.forms[0].E01ACMCUN.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Direcciones de Correo del Cliente" align="middle" border="0" ></a> 
            </td>
            <td nowrap width="26%" height="19"> 
              <div align="right">Centro de Costo :</div>
            </td>
            <td nowrap width="26%" height="19">
              <input type="text" name="E01ACMCCN" size="8" maxlength="8" value="<%= cpBasic.getE01ACMCCN().trim()%>">
              <a href="javascript:GetCostCenter('E01ACMCCN','01')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="29%" height="19"> 
            ...
            <td nowrap width="19%" height="19"> 
              <input type="text" size="2" maxlength="1" value="<%= cpBasic.getE01ACMWLF().trim()%>" name="E01ACMWLF" readonly disabled>
            ...
            <td nowrap width="26%" height="19"> 
              <input type="text" size="2" maxlength="1" value="<%= cpBasic.getE01ACMWNF().trim()%>" name="E01ACMWNF" readonly disabled>
          ...
          <tr id="trclear">
            ...
            <td nowrap width="19%" height="19">
               <input type="text" name="E01APCTNU" size="3" readonly maxlength="2" value="<%= cpBasic.getE01APCTNU().trim()%>">
            ...
            <td nowrap >
            <% if (!protect) {%>
              <input type="text" name="E01ACMBNK" size="2" maxlength="2" value="<%= cpBasic.getE01ACMBNK().trim()%>">
              <input type="text" name="E01ACMBRN" size="5" maxlength="4" value="<%= cpBasic.getE01ACMBRN().trim()%>">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="18%"> 
              <input type="hidden" name="E01ACMSCF" value="<%= cpBasic.getE01ACMSCF()%>">
              <input type="radio" name="CE01ACMSCF" value="Y" onClick="document.forms[0].E01ACMSCF.value='Y'"
			  <%if(cpBasic.getE01ACMSCF().equals("Y")) out.print("checked");%> readonly disabled>
              S&iacute; 
              <input type="radio" name="CE01ACMSCF" value="N" onClick="document.forms[0].E01ACMSCF.value='N'"
			  <%if(cpBasic.getE01ACMSCF().equals("N")) out.print("checked");%> readonly disabled>
              No <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" ></td>
            <td nowrap width="28%"> 
            ...
            <td nowrap width="24%">
              <select name="E01ACMSHF" disabled>
				<option value=" " <% if (!(cpBasic.getE01ACMSHF().equals("D") ||cpBasic.getE01ACMSHF().equals("W")
				||cpBasic.getE01ACMSHF().equals("B")||cpBasic.getE01ACMSHF().equals("M")||cpBasic.getE01ACMSHF().equals("Q")))
				out.print("selected"); %>></option>
                <option value="D" <%if (cpBasic.getE01ACMSHF().equals("D")) out.print("selected"); %>>Diario</option>
                <option value="W" <%if (cpBasic.getE01ACMSHF().equals("W")) out.print("selected"); %>>Semanal</option>
                <option value="B" <%if (cpBasic.getE01ACMSHF().equals("B")) out.print("selected"); %>>Quincenal</option>
                <option value="M" <%if (cpBasic.getE01ACMSHF().equals("M")) out.print("selected"); %>>Mensual</option>
                <option value="Q" <%if (cpBasic.getE01ACMSHF().equals("Q")) out.print("selected"); %>>Trimestral</option>
              </select>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="18%"> 
              <input type="text" name="E01ACMACL" size="2" maxlength="2" value="<%= cpBasic.getE01ACMACL().trim()%>" readonly disabled>
            ...
            <td nowrap width="24%"> 
              <input type="text" name="E01ACMSHY" size="3" maxlength="2" value="<%= cpBasic.getE01ACMSHY().trim()%>" readonly disabled>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="18%"> 
              <input type="text" name="E01ACMSDY" size="3" maxlength="2" value="<%= cpBasic.getE01ACMSDY().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="18%" height="23"> 
              <select name="E01ACMSTY" >
                <option value=" " <% if (!(cpBasic.getE01ACMSTY().equals("P") ||cpBasic.getE01ACMSTY().equals("C")||cpBasic.getE01ACMSTY().equals("N"))) out.print("selected"); %>></option>
                <option value="P" <% if (cpBasic.getE01ACMSTY().equals("P")) out.print("selected"); %>>Personal</option>
                <option value="C" <% if (cpBasic.getE01ACMSTY().equals("C")) out.print("selected"); %>>Corporativa</option>
                <option value="N" <% if (cpBasic.getE01ACMSTY().equals("N")) out.print("selected"); %>>Ninguna</option>
              </select> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" > 
            </td>
            ...
            <td nowrap width="24%" height="23">
              <select name="E01ACMSTE" disabled="disabled">
				<option value="N" <% if (!(cpBasic.getE01ACMSTE().equals("T") ||cpBasic.getE01ACMSTE().equals("P")
				||cpBasic.getE01ACMSTE().equals("F")||cpBasic.getE01ACMSTE().equals("E")))
				out.print("selected"); %>>Ninguna</option>
                <option value="T" <%if (cpBasic.getE01ACMSTE().equals("T")) out.print("selected"); %>>Telex</option>
                <option value="P" <%if (cpBasic.getE01ACMSTE().equals("P")) out.print("selected"); %>>Impresora</option>
                <option value="F" <%if (cpBasic.getE01ACMSTE().equals("F")) out.print("selected"); %>>Facsimil</option>
                <option value="E" <%if (cpBasic.getE01ACMSTE().equals("E")) out.print("selected"); %>>Email</option>
              </select>
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" > 
            </td>
          </tr>
	...
	<tr bordercolor="#FFFFFF">
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			<tr id="trdark">
				...
				<td nowrap width="21%">
					<input type="text" name="E01ACMCNV" size="5" maxlength="4" value="<%=cpBasic.getE01ACMCNV().trim()%>" readonly>
				</td>
				<td nowrap width="25%">
...
<% if (!"18".equals(currUser.getE01INT())) { %>
     ...
     <table id="dataTable" >
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="center"> 
                <%= i %>
                <input type="text" name="E01OFFOP<%= name %>" value="<%= cpBasic.getField("E01OFFOP"+name).getString().trim()%>" size="3" maxlength="3">
            ...
            <td nowrap>   
              <div align="center"> 
                <input type="text" name="E01OFFBK<%= name %>" size="2" maxlength="2" value="<%= cpBasic.getField("E01OFFBK"+name).getString().trim()%>">
              </div>
            </td>
            <td nowrap> 
              <div align="center"> 
            ...
            <td nowrap> 
              <div align="center"> 
                <input type="text" name="E01OFFAC<%= name %>" size="13" maxlength="12"  value="<%= cpBasic.getField("E01OFFAC"+name).getString().trim()%>"
            ...
            <td nowrap > 
              <div align="center"> 
                <input class="txtright" type="text" name="E01OFFAM<%= name %>" size="15" maxlength="15"  value="<%= cpBasic.getField("E01OFFAM"+name).getString().trim()%>" onKeypress="enterDecimal()">
              </div>
            </td>
          </tr>
          <%
...
<% } %>        
 ...
 <SCRIPT type="text/javascript">
  ...
  <% if(error.getERWRNG().equals("Y")){%>
   <h4 style="text-align:center"><input type="checkbox" name="H01FLGWK2" value="A" <% if(cpBasic.getH01FLGWK2().equals("A")){ out.print("checked");} %>>
