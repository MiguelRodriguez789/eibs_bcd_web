...
<frameset  rows="340,1*" cols="*"> 
  <frame name="query" src="<%=request.getContextPath()%>/pages/s/EDL0521_client_clasif_enter_search.jsp" marginwidth=5 marginheight=10 scrolling="no" frameborder="0">
