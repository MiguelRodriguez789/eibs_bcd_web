...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transf_approval.jsp,EFE0510">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE01REMCD1(),msgMT.getE01REMCD2(),msgMT.getE01REMCD3()) + " - " + Util.formatCell(msgMT.getE01REMCRT())%></TD>
