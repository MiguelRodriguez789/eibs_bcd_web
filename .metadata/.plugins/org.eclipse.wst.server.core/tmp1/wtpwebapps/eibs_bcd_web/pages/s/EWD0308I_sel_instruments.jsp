...
<BODY>
<h3 align="center">Consulta de Instrumentos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_instruments.jsp, EWD0308I"></h3>
<hr size="4">
    ...
    <TD NOWRAP valign="top" width="100%" >
        <table id="headTable" width="100%" >
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap > 
              <div align="center">Fecha de<br>Emision</div>
            </th>
          </tr>
        </table>
...
<TABLE class="tbenter" WIDTH="98%" ALIGN=CENTER>
  ...
  <%
        if ( EWD0308Help.getShowPrev() ) {
      			...
      			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.invest.JSEWD0308P?SCREEN=3&PREFINST="+userPO.getHeader9()+"&Pos=" + pos +"\"><IMG border=\"0\" src=\""+request.getContextPath()+"/images/s/previous_records.gif\" ></A>");
        }
   %>  
  </TD>
