...
<body>
<h3 align="center">Cambio Tasa Solicitada
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="special_autoriz_change.jsp, EEJ0050"></h3>
<hr size="4">
