...
function goAction(op) {
 ...
 if (op == 1) {
     ...
     page = '${pageContext.request.contextPath}/pages/s/EPC0010_pc_maint_sch_inq.jsp?ROW=' + document.forms[0].ROW.value;
 } else if (op == 4) {     
...
<h3 align="center">Participantes de Pool Asociados a Proyecto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_list_sch_inq.jsp,EPC0010"> 
</h3>
<hr size="4">
