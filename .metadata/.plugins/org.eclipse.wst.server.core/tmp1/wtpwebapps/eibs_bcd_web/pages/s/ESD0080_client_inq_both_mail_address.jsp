...
<h3 align="center">Direcciones de Correo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_inq_both_mail_address, ESD0080" ></h3>
<hr size="4">
      ...
      <td nowrap >
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" name="E<%= name %>4MA1" maxlength="60" size="65" value="<%= mailA.getField("E" + name + "4MA1").getString().trim()%>" readonly>
            </td>
          </tr>
         ...
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" readonly name="E<%= name %>4TID" maxlength="4" size="5" value="<%= mailA.getField("E" + name + "4TID").getString().trim()%>">
         ...
         <tr id="trclear"> 
            ...
            <td nowrap width="58%"> 
              <input type="text" readonly name="E<%= name %>4PID" maxlength="4" size="5" value="<%= mailA.getField("E" + name + "4PID").getString().trim()%>">
