...
<h3 align="center">Seleccionar Planilla para su cancelacion<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cancelar_planilla_search.jsp, ECO0120"></h3>
<hr size="4">
...
<table id="TBHELPN" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-left: center; margin-right: center;">
			...
			<table id="TBHELPN" border="0" align="center">
				<tr>
					...
					<td nowrap align="left">
			 			<eibsinput:help name="header" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_ACCOUNT %>" property="E01SELNUM" 
	...
	<script type="text/javascript">
		alert("Actualización de Planilla Exitosa!!");
	</script> 
	<%} %>
</body>
</html>
