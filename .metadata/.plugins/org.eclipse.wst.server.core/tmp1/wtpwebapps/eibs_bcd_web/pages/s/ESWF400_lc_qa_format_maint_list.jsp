...
%>
<h3 align="center">Preguntas y Respuestas de <%= titTypePlu %> <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_qa_format_main_list.jsp,ESWF4000"> 
</h3>
<hr size="4">
...
%>
							...
							<TD NOWRAP ALIGN=CENTER>
								...
								&nbsp;
									<img border="0" src="/images/ico1.gif" title="TRX con observaci&oacute;n" onclick="viewMessage('<%=indexRow%>')">
								<% } %>								
							</TD>
