...
<H3 align="center">Importaci&oacute;n de Im&aacute;genes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ExportImagesEnter.jsp"></H3>
<hr size="4">
