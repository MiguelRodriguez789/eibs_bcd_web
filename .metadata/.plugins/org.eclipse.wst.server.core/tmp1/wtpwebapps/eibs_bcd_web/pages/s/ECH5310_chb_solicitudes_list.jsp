...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chb_solicitudes_list.jsp, ECH5310">
</h3>
<hr size="4">
    ...
    <TH ALIGN=CENTER >Estado</TH>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%= Util.formatCustomDate(currUser.getE01DTF(), msgChkB.getE01CHDRQ1(),msgChkB.getE01CHDRQ2(),msgChkB.getE01CHDRQ3()) %></TD>
