...
<h3 align="center">Cargos por Servicios y Tasas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ESD0205_rt_inq_tables_dda_01, ESD0205" ></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="31%" height="34" > 
              <div align="left"> 
                <input type="text" name="E02RTEBL1" size="15" maxlength="13" value="<%= charges.getE02RTEBL1()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEBL2" size="15" maxlength="13" value="<%= charges.getE02RTEBL2()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEBL3" size="15" maxlength="13" value="<%= charges.getE02RTEBL3()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEBL4" size="15" maxlength="13" value="<%= charges.getE02RTEBL4()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEDO1" size="4" maxlength="3" value="<%= charges.getE02RTEDO1()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="teclear"> 
            ...
            <td nowrap width="31%"> 
              <div align="left"> 
                <input type="text" name="E02RTEDO2" size="4" maxlength="3" value="<%= charges.getE02RTEDO2()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEDO3" size="4" maxlength="3" value="<%= charges.getE02RTEDO3()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEDO4" size="4" maxlength="3" value="<%= charges.getE02RTEDO4()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEMST" size="4" maxlength="3" value="<%= charges.getE02RTEMST()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
