...
<BODY>
<h3 align="center">Detalles de la Transacci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="position_inquiry.jsp, EIE0300"></h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            <td nowrap width="14%" > 
              <div align="right"><a href="javascript:showCustomerInq(document.forms[0].CUSTOMER.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" title="help" align="bottom" border="0" > 
                Cliente :</a></div>
            </td>
            <td nowrap width="9%" > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="14%"> 
              <div align="right"><a href="javascript:showPortfolioInq(document.forms[0].CUSTOMER.value,document.forms[0].PORTFOLIO.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" title="help" align="bottom" border="0" > 
                Portafolio : </a></div>
            </td>
            <td nowrap colspan="3"> 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="14%"> 
              <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].CODE.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" title="help" align="bottom" border="0" > 
                Instrumento :</a> </div>
            </td>
            <td nowrap colspan="3"> 
