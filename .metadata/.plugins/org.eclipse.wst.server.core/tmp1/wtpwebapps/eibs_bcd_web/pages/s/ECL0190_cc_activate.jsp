...
function validate() {
	if(confirm("Se procederá a activar la tarjeta de débito. ¿Está seguro que desea realizar esta operación?")){
		return true;
	} else {
		return false;
	}
...
<body >
<h3 align="center">Activación de Productos y Servicios<br>Activación de Tarjeta de Débito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_activate.jsp, ECL0190"> 
</h3>
<hr size="4">
<% 
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.misc.JSECL0190" onSubmit="return validate();">
  ...
  <input type="hidden" name="E01TIPPRO" value="1">
  ...
  <h4>Información de la Activación</h4>
  <table class="tableinfo">
    <tr > 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
              ...
              <div align="left"> 
				...
				<%
					...
					while (prodList.getNextRow()) {
             			...
             			if (msg.getE02DESPRO().equals("TDDI")) {
