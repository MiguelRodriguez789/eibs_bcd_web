...
<h3 align="center">Detalle del Producto
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="proposals_product_inq_lines.jsp,EDP0720"></h3>
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
      		<tr id="trclear" > 
				...
				<td nowrap align="left" width="50%">
					<TEXTAREA name="E02DPAC02" rows="5" cols="70" 
					<% if(msgRT.getH01FLGWK3().equals("3")){out.print("readonly");}%>
