      ...
      <td nowrap > 
        <table cellspacing=2 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
			<div align="left">
              <input type="text" name="NEWGL" size="17" maxlength="16" value="<%= request.getParameter("GL") %>" onKeypress="enterInteger(event)" >
              <a href="javascript:GetLedger('NEWGL','<%= chkList.getRecord(18) %>','<%= chkList.getRecord(25) %>','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"  ></a>
			</div>
            </td>
          </tr>
		<tr id="trclear">
            ...
            <td nowrap > 
			<div align="left">
              <input type="text" name="NEWACC" size="13" maxlength="12" value="<%= request.getParameter("Acc") %>" onKeypress="enterInteger(event)" >
              <a href="javascript:GetAccount('NEWACC','<%= chkList.getRecord(18) %>','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"  ></a>
			</div>
            </td>
          </tr>
		<tr id="trclear"> 
			...
			<td nowrap  > 
			<div align="left">
              <input type="text" name="CURCHK" size="13" maxlength="11" value="<%= chkList.getRecord(2) %>" readonly>
			</div>
            </td>
            <td nowrap > 
			<div align="left">
              <input type="text" name="NEWCHK" size="13" maxlength="11" value="<%= request.getParameter("Chk") %>" onKeypress="enterInteger(event)" >
			</div>
            </td>
		</tr>
		<tr id="trclear">
			...
			<div align="left">
              ...
              <a href="javascript:GetCasualTable('NEWRS1','CURRS1')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"  ></a>
			</div>
            </td>
          </tr>
          <tr id="trclear">
			...
			<div align="left">
              ...
              <a href="javascript:GetCasualTable('NEWRS2','CURRS2')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"  ></a>
			</div>
            </td>
          </tr>
          <tr id="trclear"> 
			...
			<div align="left">
              ...
              <a href="javascript:GetCasualTable('NEWRS3','CURRS3')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"  ></a>
			</div>
            </td>
          </tr>
          <tr id="trclear">
			...
			<div align="left">
              ...
              <a href="javascript:GetCasualTable('NEWRS4','CURRS4')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"  ></a>
			</div>
            </td>
          </tr> 
	 </table> 
