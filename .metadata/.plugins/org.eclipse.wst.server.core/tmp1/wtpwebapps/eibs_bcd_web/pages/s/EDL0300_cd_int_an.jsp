...
%>
  ...
  <h3 align="center">An&aacute;lisis de Intereses<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_int_an.jsp,EDL0300"> 
  </h3>
  <hr size="4">
...
<table class="tableinfo">
    <tr> 
      <td width="34%"> 
        <div align="left"><b>Intereses Calculados</b></div>
      </td>
      <td width="21%"><b>D&iacute;as :</b> <%= userPO.getHeader19().trim()%></td>
      <td width="45%"><b>Valor de Intereses </b> : <%= userPO.getHeader20().trim()%></td>
    </tr>
  </table>
  <p align=center>&nbsp; </p>
