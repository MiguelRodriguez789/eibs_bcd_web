...
%>
<h3 align="center"> Confirmaci&oacute;n - Swap </h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap align="right">Acci&oacute;n Tomada : </td>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="left"></div>
              <% if(fex.getE01WKFNTF().equals("P")) out.print("Imprimir");
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" > 
              <div align="left"><% if(fex.getE01WKFBPV().equals("F")) out.print("Via Fed");
            ...
            <td nowrap ><% if(fex.getE01WKFBCT().equals("F")) out.print("Via Fed");
				 else if(fex.getE01WKFBCT().equals("1")) out.print("Via Swift MT-100");
				 else if(fex.getE01WKFBCT().equals("2")) out.print("Via Swift MT-200");
				 else if(fex.getE01WKFBCT().equals("3")) out.print("Via Swift MT-202");
				 else if(fex.getE01WKFBCT().equals("T")) out.print("Via Telex");
