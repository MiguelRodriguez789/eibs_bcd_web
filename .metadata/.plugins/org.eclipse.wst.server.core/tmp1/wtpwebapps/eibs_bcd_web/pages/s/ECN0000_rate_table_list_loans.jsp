...
<%@ page import="datapro.eibs.master.Util,datapro.eibs.beans.ECN000001Message"%>
...
function goAction(op) {
	...
	page = "<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSECN0000?SCREEN=450&opt=" + op + params;	
	CenterWindow(page,1000,700,2);
...
<h3 align="center">Tasas Para Prestamos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rate_table_list_loans.jsp, ECN0000"></h3>
<hr size="4">
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
      ...
      <TD>         
      <div align="center"> 
          <h4 style="text-align:center"> No hay Resultados para su Busqueda</h4>
        </div>
      </TD></TR>
   	</TABLE>
   	<TABLE class="tbenter">
