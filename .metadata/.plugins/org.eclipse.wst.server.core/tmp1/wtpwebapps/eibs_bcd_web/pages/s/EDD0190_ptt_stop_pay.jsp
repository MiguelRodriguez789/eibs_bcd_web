...
function goPrint(){
location= "${pageContext.request.contextPath}/pages/s/EDD0190_ptt_stop_pay_print_all.jsp";
}
...
%> 
<h3 align="center">Protesto Manual<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ptt_stop_pay.jsp , EDD0190"></h3>
<hr size="4">
   ...
   <TD NOWRAP valign="top" width="100%" >
     ...
     <TR id="trdark">  
            ...
            <TH ALIGN=CENTER NOWRAP width="140"> 
              <DIV ALIGN=CENTER >Fecha / Hora del Protesto</DIV>
            </TH>
     </TR>
    </TABLE>
    ...
    <TR> 
      ...
      <TD ALIGN=CENTER NOWRAP><%= Util.formatDate(stop.getRecord(3),stop.getRecord(4),stop.getRecord(5)) %> - <%= Util.formatCell(stop.getRecord(6)) %></TD>
