...
%> 
<H3 align="center">Protecci&oacute;n de Sobregiros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="EDD0000_rt_basic.jsp, EDD0000"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="26%"> 
              <input type="text" name="E01OVCCGL" size="19" maxlength="16" value="<%= rtBasic.getE01OVCCGL()%>" onKeyPress="enterInteger(event)">
              <a href="javascript:GetLedger('E01OVCCGL',document.forms[0].E01OVCBNK.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="29%"> 
