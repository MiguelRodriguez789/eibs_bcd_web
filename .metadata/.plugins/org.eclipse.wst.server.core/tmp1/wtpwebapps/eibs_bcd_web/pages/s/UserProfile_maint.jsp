              ...
              <input type="text" name="EUPOAF" size="4" maxlength="4" value="">
				...
				<TR id="trdark">
					...
					<TD nowrap><INPUT type="text" name="EUPROT" size="11"
						...
						src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom"
						border="0"></A></TD>
				</TR>
				<TR id="trclear">
					<TD nowrap>
  			...
  			<table width="100%" border="0" cellspacing="0" cellpadding="0">
  				<tr id="trdark">
            		...
            		<td nowrap>
              		    ...
              		    <input type="text" name="BTHCCN" size="8" maxlength="8" value="<%= userInfo.getBTHCCN()%>" onkeypress="enterInteger(event)">
              			<a href="javascript:GetCostCenter('BTHCCN',document.forms[0].BTHUBK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="middle" border="0" ></a> 
            		</td>
  				</tr>
  				<tr id="trclear">
  				    <td nowrap> 
  				...
  				<tr id="trclear">
            		...
            		<td nowrap>
              			<input type="text" name="BTHCUN" size="10" maxlength="9" value="<%= userInfo.getBTHCUN()%>" onkeypress="enterInteger(event)">
            		</td>
  				</tr>
  				<tr id="trdark">
  					<td nowrap> 
            		...
            		<td nowrap>
              			...
              			<a href="javascript:GetCodeDescCNOFC('BTHOFC','','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0"></a>
            		</td>
  				</tr>
  				<tr id="trclear">
  				    <td nowrap> 
  				...
  				<tr id="trclear">
            		...
            		<td nowrap>
              			<input type="text" name="BTHINL" size="2" maxlength="1" value="<%= userInfo.getBTHINL()%>" onkeypress="enterInteger(event)"> (0 - 9)
            		</td>
  				</tr>
  				<tr id="trdark">
  				    <td nowrap> 
            		...
            		<td nowrap>
              			<input type="text" name="BTHACL" size="2" maxlength="1" value="<%= userInfo.getBTHACL()%>" onkeypress="enterInteger(event)"> (0 - 9)
            		</td>
  				</tr>
  				<tr id="trclear">
  				    <td nowrap> 
        		...
        		<tr id="trdark">
  				...
  				<tr>
            		...
            		<td nowrap align="center">
              			<input type="text" name="BTHFB1" size="5" maxlength="4" value="<%= userInfo.getBTHFB1()%>" onkeypress="enterInteger(event)">
            		</td>
            		<td nowrap align="center">
              			<input type="text" name="BTHTB1" size="5" maxlength="4" value="<%= userInfo.getBTHTB1()%>" onkeypress="enterInteger(event)">
            		</td>
  				</tr>
  				<tr>
  				    <td nowrap> 
            		...
            		<td nowrap align="center">
              			<input type="text" name="BTHFB2" size="5" maxlength="4" value="<%= userInfo.getBTHFB2()%>" onkeypress="enterInteger(event)">
            		</td>
            		<td nowrap align="center">
              			<input type="text" name="BTHTB2" size="5" maxlength="4" value="<%= userInfo.getBTHTB2()%>" onkeypress="enterInteger(event)">
            		</td>
  				</tr>
  				<tr>
  				    <td nowrap> 
            		...
            		<td nowrap align="center">
              			<input type="text" name="BTHFB3" size="5" maxlength="4" value="<%= userInfo.getBTHFB3()%>" onkeypress="enterInteger(event)">
            		</td>
            		<td nowrap align="center">
              			<input type="text" name="BTHTB3" size="5" maxlength="4" value="<%= userInfo.getBTHTB3()%>" onkeypress="enterInteger(event)">
            		</td>
  				</tr>
  				<tr>
  				    <td nowrap> 
            		...
            		<td nowrap align="center">
              			<input type="text" name="BTHDIB" size="5" maxlength="4" value="<%= userInfo.getBTHDIB()%>" onkeypress="enterInteger(event)">
            		</td>
            		<td nowrap align="center">
  				...
  				<tr>
            		...
            		<td nowrap align="center">
              			<input type="text" name="BTHPRB" size="5" maxlength="4" value="<%= userInfo.getBTHPRB()%>" onkeypress="enterInteger(event)">
            		</td>
            		<td nowrap align="center">
