...
<h3 align="center">Consulta Historica de Logs de Caja de Seguridad <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="safe_deposit_visit_list, ESB0020"></H3>
<hr size="4">
    ...
    <div style="width: 100%; height: 700px; overflow: scroll; background-color: #F2F1F1;">
  	 <TABLE id="dataTable" width="100%">
        ...
        while (msgList.getNextRow()) {
           ...
           ESB002501Message msgPart = (ESB002501Message) msgList.getRecord();
     	%>               
        <TR>
