...
<h3 align="center">Autorización para Cambio de Tasa de Certificados<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_enter_xchg_rate, EDL0130"></h3>
<hr size="4">
  ...
  <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" height="80%" border="0">
  	<tr> 
    	<td nowrap align="center"> 
        	Número de Cuenta :
            <INPUT type="text" name="E06DEAACC" size="15" maxlength="12" onkeypress="enterInteger(event)" value="<%= cdRate.getE06DEAACC() %>" <%=blocked%>> 
	...
	<tr>	
		<td nowrap align="center"> 
            ...
            <INPUT type="text" name="E06DEANR1" size="5" maxlength="4" onkeypress="enterInteger(event)" value="<%= cdRate.getE06DEANR1() %>" <%=blocked%>> 
		</td>
	</tr>
	<tr>
		<td nowrap align="center"> 
