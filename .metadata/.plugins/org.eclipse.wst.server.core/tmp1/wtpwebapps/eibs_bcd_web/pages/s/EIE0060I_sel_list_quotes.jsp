...
%>
<h3 align="center">Consulta de Cotizaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_instruments.jsp, EWD0308"></h3>
<hr size="4">
 ...
 %> 
  <TABLE class="tbenter" width="100%" height="50%" >
    <tr>
      <TD > 
        <div align="center"> 
          <p><b>No existen cotizaciones definidas </b></p>
        </div>
