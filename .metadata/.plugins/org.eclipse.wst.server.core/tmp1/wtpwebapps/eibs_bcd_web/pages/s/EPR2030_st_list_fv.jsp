...
<h3 align="center">Consulta Transacciones
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="st_list_fv.jsp, EPR2030"> 
  </h3>
  <hr size="4">
 <FORM> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="33%"> 
              <div align="left"><input type="text" name="E02NA122" size="45" maxlength="45" readonly value="<%= userPO.getOfficer().trim()%>">
              </div>
            </td>
            <td nowrap width="11%"> 
...
%>
  ...
  <BR>
       ...
       <TD WIDTH="50%" ALIGN=LEFT>
        ...
        if ( cifList.getShowPrev() ) {
      			...
      			out.println("<A HREF=\"" + request.getContextPath()+ "/servlet/datapro.eibs.transfer.JSEPR2030?SCREEN=1&Pos=" + pos 
  ...
  <SCRIPT type="text/javascript">
   		var max = document.getElementsByName("cfTable").rows.length;
     	for (var i= 1; i < max; i++){
      		document.getElementsByName("cfTable").rows[i].cells[1].style.display = "none";
     	}
  </SCRIPT>
   <%
  }
