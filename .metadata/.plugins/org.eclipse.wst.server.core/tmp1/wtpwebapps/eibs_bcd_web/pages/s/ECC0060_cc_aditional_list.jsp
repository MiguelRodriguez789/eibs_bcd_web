...
<h3 align="center">Tarjetas de <% if (userPO.getHeader2().equals("D")) out.print("Débito"); else out.print("Crédito"); %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_aditional_list.jsp,ECC0060"></h3>
<hr size="4">
  ...
  <TABLE class="tbenter" width=100% height=100%>
      ...
      <div align="center"> 
          ...
          <table class="tbenter" width="100%">
            <tr> 
              <td align=CENTER class=TDBKG style="cursor:hand"> <a href="javascript:goAction(1)"><b>Crear</b></a></td>
...
%> 
  ...
  <table class="tbenter" width="100%">
    <tr> 
      <td align=CENTER class=TDBKG style="cursor:hand" width="20%"> <a href="javascript:goAction(1)"><b>Crear</b></a></td>
      <td align=CENTER class=TDBKG style="cursor:hand" width="20%"> <a href="javascript:goAction(2)"><b>Modificar</b></a></td>     
