...
<H3 align="center">Consulta de Operaciones Compraventa Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_mov_inq,EPR0395"></H3>
<hr size="4">
<p>&nbsp;</p>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01REQBNK" size="3" maxlength="2" onKeypress="enterInteger(event)" value="<%= msgMT.getE01REQBNK()%>">
	      </td>
     	</tr>
     	<tr id=trclear> 
	      <td nowrap width="40%"> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01REQBRN" size="4" maxlength="4" value="">
	        <a href="javascript:GetBranch('E01REQBRN',document.forms[0].E01REQBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
	      </td>
     	</tr>
     	<tr id=trdark> 
		  <td> 
	      ...
	      <td nowrap> 
	        <input type="text" name="E01REQREF" size="15" maxlength="12" onKeypress="enterInteger(event)" value="<%= msgMT.getE01REQREF()%>">
	      </td>
     	</tr>
      	<tr id=trdark>
          <td nowrap>
          ...
          <td nowrap> 
              <input type="text" name="E01REQCD1" size="3" maxlength="2" value="<%= msgMT.getE01REQCD1()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01REQCD2" size="3" maxlength="2" value="<%= msgMT.getE01REQCD2()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01REQCD3" size="5" maxlength="4" value="<%= msgMT.getE01REQCD3()%>" onkeypress="enterInteger(event)">
              &nbsp; Hasta : &nbsp; 
              <input type="text" name="E01REQCH1" size="3" maxlength="2" value="<%= msgMT.getE01REQCH1()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01REQCH2" size="3" maxlength="2" value="<%= msgMT.getE01REQCH2()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01REQCH3" size="5" maxlength="4" value="<%= msgMT.getE01REQCH3()%>" onkeypress="enterInteger(event)">               
          </td>
        </tr>
      	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeCNOFC('E01REQINS','YJ')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	  </td>     
      	</tr>
      	<tr id=trdark> 
	      <td nowrap> 
