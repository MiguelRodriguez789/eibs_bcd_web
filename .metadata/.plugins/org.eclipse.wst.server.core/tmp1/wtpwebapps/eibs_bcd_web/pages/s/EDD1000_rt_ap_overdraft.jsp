...
<H3 align="center">Informaci&oacute;n para Sobregiros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_ap_overdraft.jsp, EDD1000"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E03ACMCUN" size="10" maxlength="9"  value="<%= rtOverdraft.getE03ACMCUN().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E03ACMACC"  size="13" maxlength="12" value="<%= rtOverdraft.getE03ACMACC().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
            ...
            <td nowrap width="16%"> 
              <div align="left"><b> 
                <input type="text" name="E03ACMCCY" size="3" maxlength="3" value="<%= userPO.getCurrency().trim()%>" readonly>
                </b> </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%"> 
              <input type="text" name="E03ACMOL1" maxlength="13" size="15" value="<%= rtOverdraft.getE03ACMOL1().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="30%" height="23">
              <input type="text" name="E03ACMOI1" size="10" maxlength="9" value="<%= rtOverdraft.getE03ACMOI1().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" height="19"> 
              <input type="text" name="E03ACMOL2" maxlength="13" size="15" value="<%= rtOverdraft.getE03ACMOL2().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" height="19"> 
            ...
            <td nowrap width="30%" height="19"> 
              <input type="text" name="E03ACMOI2" size="10" maxlength="9" value="<%= rtOverdraft.getE03ACMOI2().trim()%>" readonly>
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" height="19"> 
              ...
              <input type="text" name="E03ACMRBR" size="4" maxlength="4" value="<%= rtOverdraft.getE03ACMRBR().trim()%>" readonly>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" height="19"> 
              <input type="text" name="E03LNSPRD" size="4" maxlength="4" value="<%= rtOverdraft.getE03LNSPRD().trim()%>" readonly>
            </td>
          </tr>
        </table>
      </td>
