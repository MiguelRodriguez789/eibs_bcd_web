          ...
          <td width="192" height="20" colspan="2" valign="top"> 
            <table width="100%" border="0" cellspacing="2" cellpadding="0">
              ...
              <tr> 
                <td><font face="Arial, Helvetica, sans-serif" size="2">
               <%= datapro.eibs.master.Util.formatCustomDate(currUser.getE01DTF(),
                                                             cdFinish.getBigDecimalE10CNTRDM().intValue(),
                                                             cdFinish.getBigDecimalE10CNTRDD().intValue(),
                                                             cdFinish.getBigDecimalE10CNTRDY().intValue())%>
 				</font></td>
              </tr>
            </table>
          </td>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="0">
        ...
        <tr> 
          <td><font face="Arial, Helvetica, sans-serif" size="2">Para constancia 
            se firma el presente contrato a los <%= cdFinish.getE10CNTRDD().trim()%> 
            d&iacute;as del mes de <% if((cdFinish.getE10CNTRDM().equals("1"))||(cdFinish.getE10CNTRDM().equals("01"))) out.print("Enero");
              				else if((cdFinish.getE10CNTRDM().equals("2"))||(cdFinish.getE10CNTRDM().equals("02"))) out.print("Febrero");
							else if((cdFinish.getE10CNTRDM().equals("3"))||(cdFinish.getE10CNTRDM().equals("03"))) out.print("Marzo");
							else if((cdFinish.getE10CNTRDM().equals("4"))||(cdFinish.getE10CNTRDM().equals("04"))) out.print("Abril");
							else if((cdFinish.getE10CNTRDM().equals("5"))||(cdFinish.getE10CNTRDM().equals("05"))) out.print("Mayo");
							else if((cdFinish.getE10CNTRDM().equals("6"))||(cdFinish.getE10CNTRDM().equals("06"))) out.print("Junio");
							else if((cdFinish.getE10CNTRDM().equals("7"))||(cdFinish.getE10CNTRDM().equals("07"))) out.print("Julio");
							else if((cdFinish.getE10CNTRDM().equals("8"))||(cdFinish.getE10CNTRDM().equals("08"))) out.print("Agosto");
							else if((cdFinish.getE10CNTRDM().equals("9"))||(cdFinish.getE10CNTRDM().equals("09"))) out.print("Septiembre");
							else if((cdFinish.getE10CNTRDM().equals("10"))) out.print("Octubre");
							else if((cdFinish.getE10CNTRDM().equals("11"))) out.print("Noviembre");
							else if((cdFinish.getE10CNTRDM().equals("12"))) out.print("Diciembre");
							%> del a&ntilde;o 200<%= cdFinish.getE10CNTRDY().trim()%></font></td>
        </tr>
      </table>
      <br>
      <table width="100%">
