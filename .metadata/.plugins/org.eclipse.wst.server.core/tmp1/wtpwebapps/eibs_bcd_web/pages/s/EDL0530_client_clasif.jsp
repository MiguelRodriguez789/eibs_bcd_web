...
<% 
 ...
 <h3 align="center">Tipo de Relación y Clasificación de Cliente <%= title %>  <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_clasif, EDL0530" ></h3>
<hr size="4">
          ...
          <table cellspacing="2" cellpadding="2" width="100%" border="0" align="left">
            <tr id=trclear> 
              ...
              <td nowrap width="70%"> 
                ...
                <a href="javascript:GetCodeDescCNOFC('E01CUSUC1','D01CUSUC1','2A')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            ...
            <tr id=trdark> 
              ...
              <td nowrap width="70%"> 
                ...
                <a href="javascript:GetCodeDescCNOFC('E01CUSUC2','D01CUSUC2','2B')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
              <IMG src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0">
              </td>
            </tr>
          </table>
