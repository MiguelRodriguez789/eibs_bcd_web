...
<body>
<h3 align="center">Detalle de Consulta de Auditoría<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_audit_inq.jsp, ECD0011"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
         ...
         <TR id="trclear"> 
            ...
            <TD nowrap width="20%"> 
              <DIV align="left"> 
                <INPUT type="text" name="E01TDDDAY" size="3" maxlength="3" readonly value="<%= msgAudit.getE01TDDDAY() %>">
                <INPUT type="text" name="E01TDDMON" size="3" maxlength="3" readonly value="<%= msgAudit.getE01TDDMON() %>">
                <INPUT type="text" name="E01TDDYEA" size="5" maxlength="5" readonly value="<%= msgAudit.getE01TDDYEA() %>">
              </DIV>
            </TD>
            <TD nowrap width="16%"> 
