  ...
  <TD NOWRAP >
   <TABLE id="headTable" width="100%" cellpading=0 cellspacing=0>
    ...
    <tr id="trdark"> 
      ...
      <td nowrap > 
         <input type="text" name="E01IFMFED" size="3" readonly value="<%=userPO.getHeader8()%>">/
...
<TABLE  class="tableinfo"> 
		...
		onKeyDown="limitText(this.form.E01CAFM21,800);" onKeyUp="limitText(this.form.E01CAFM21,800);" onchange="this.value=this.value.substring(0, 800);" 
		...
		<TR id=trclear> 
			...
			<TD ALIGN="left" NOWRAP width="60%">
			<b></b>Análisis Estado de Resultados
			</TD>
			<TD ALIGN=LEFT colspan="3" NOWRAP width="10%"><b></b> 
			</TD>
		</TR>
		...
		onKeyDown="limitText(this.form.E01CAFM22,800);" onKeyUp="limitText(this.form.E01CAFM22,800);" onchange="this.value=this.value.substring(0, 800);" 
		<% if(userPO.getHeader16().equals("5")){out.print("readonly");}%>
		>
		</TEXTAREA>
		...
		onKeyDown="limitText(this.form.E01CAFM23,800);" onKeyUp="limitText(this.form.E01CAFM23,800);" onchange="this.value=this.value.substring(0, 800);" 
		<% if(userPO.getHeader16().equals("5")){out.print("readonly");}%>
		>
		</TEXTAREA>
		...
		<TR id=trdark> 
			...
			<TD ALIGN="left" NOWRAP width="60%">
			<b></b>Disponibilidad y Análisis de Capacidad de Pago
			</TD>
			<TD ALIGN=LEFT colspan="3" NOWRAP width="10%"><b></b> 
			</TD>
		</TR>
		...
		onKeyDown="limitText(this.form.E01CAFM24,800);" onKeyUp="limitText(this.form.E01CAFM24,800);" onchange="this.value=this.value.substring(0, 800);" 
		<% if(userPO.getHeader16().equals("5")){out.print("readonly");}%>
		>
		</TEXTAREA>
		...
		onKeyDown="limitText(this.form.E01CAFM25,800);" onKeyUp="limitText(this.form.E01CAFM25,800);" onchange="this.value=this.value.substring(0, 800);" 
		<% if(userPO.getHeader16().equals("5")){out.print("readonly");}%>
		>
		</TEXTAREA>
