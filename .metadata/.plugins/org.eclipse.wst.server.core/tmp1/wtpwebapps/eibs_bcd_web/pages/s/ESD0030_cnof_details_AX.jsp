...
<H3 align="center">C&oacute;digos de Referencia del Sistema - Codigos AXON<img src="<%=request.getContextPath()%>/images/e_ibs.gif"
				...
				<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
          		...
          		<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            		<td nowrap width="16%" height="19"> 
              			<div align="right">Satisfactoria :</div>
            		</td>
            		<td nowrap height="19"> 
              			<div align="left"> 
