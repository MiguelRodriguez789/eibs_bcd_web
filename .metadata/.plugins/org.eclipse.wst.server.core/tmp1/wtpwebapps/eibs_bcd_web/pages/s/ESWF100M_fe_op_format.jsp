...
%> 
  <table class="tbenter" width=100% height=100%>
    <tr> 
      ...
      <div align="center"> <b> No hay resultados que correspondan con su criterio de b&uacute;squeda</b> </div>
      </td>
    </tr>
  </table>
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_op_format.jsp,ESWF100M"> 
<hr size="4">
