...
<h3 align="center">Portafolio de Inversiones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_enter_port_new, EIE0010"></h3>
<hr>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010" onSubmit="return(checkCust())">
    ...
    <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
      <tr> 
        ...
        <td nowrap> 
          <INPUT type="text" name="E01PRFCUN" size="9" maxlength="9" onkeypress="enterInteger(event)">
          <a href="javascript:GetCustomerDescId('E01PRFCUN','D01CUSNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
      ...
      <tr> 
        ...
        <td nowrap align="left"> 
          <INPUT type="text" name="E01PRFNUM" size="5" maxlength="4" onkeypress="enterInteger(event)">
        <a href="javascript:GetPortfolioNumDesc('E01PRFNUM','E01PRFCUN','',document.forms[0].E01PRFCUN.value)"><i><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></i></a> 
