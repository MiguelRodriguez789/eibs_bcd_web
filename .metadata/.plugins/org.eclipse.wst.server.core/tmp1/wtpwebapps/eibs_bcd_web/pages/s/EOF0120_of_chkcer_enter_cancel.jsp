...
<h3 align="center">Cancelación de Cheques Certificados<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="of_chkcer_enter_cancel, EOF0120"></h3>
<hr size="4">
<p>&nbsp;</p>
      ...
      <td nowrap> 
        <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr>
            ...
            <td nowrap width="50%">
              <input type="text" id="ACCOUNT" name="E02OFMACC" size="15" maxlength="12" onKeypress="enterInteger(event)">
          ...
          <tr> 
            ...
            <td nowrap width="50%"> 
              <input type="text" name="E02OFMCKN" size="12" maxlength="11" onKeypress="enterInteger(event)">
