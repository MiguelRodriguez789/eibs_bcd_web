      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E04CUN" size="13" maxlength="12" value="<%= userPO.getAccNum().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
...
<%-- INICIO SECCION DE DIRECCION --%>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            <td width="40%" nowrap> 
              <div id="PATID<%=name%>" align="right"> Distrito :</div>
            </td>
            <td width="60%" nowrap> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td width="40%" nowrap> 
              <div id="PAPID<%=name%>" align="right"> Corregimiento :</div>
            </td>
            <td width="60%" nowrap> 
