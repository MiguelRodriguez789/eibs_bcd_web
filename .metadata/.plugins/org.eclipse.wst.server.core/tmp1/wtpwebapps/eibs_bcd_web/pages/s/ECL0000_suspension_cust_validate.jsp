...
<body >
<h3 align="center">Suspensión de Productos y Servicios<BR>Validación del Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="suspension_cust_validate.jsp, ECL0000"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trdark"> 
            ...
            <TD nowrap width="25%">
              <DIV align="left">
                <INPUT type="hidden" id="E01CCLANS<%= row %>" name="E01CCLANS<%= row %>" value="<%= msgPart.getE01CCLANS().trim() %>">
