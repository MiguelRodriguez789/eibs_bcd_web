...
<h3 align="center">Consulta de Producto de Cobranzas
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly name="E05TYPDES" size="50" maxlength="45" value="<%= colProdInq.getE05TYPDES().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              ...
              <input type="text" readonly name="E05DESCRI" size="60" maxlength="60" value="<%= colProdInq.getE05DESCRI().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="30%"> 
            ...
            <td width="70%"> 
              <input type="text" readonly name="E05MERCAD" size="28" maxlength="25" value="<%= colProdInq.getE05MERCAD().trim()%>">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="50%"> 
              <input type="text" readonly name="E05GLMDSC" size="45" maxlength="45" value="<%= colProdInq.getE05GLMDSC().trim()%>">
            </td>
          </tr>
        </table>
      </td>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="55%"> 
              ...
              <a href="javascript:showCOLServCharge('<%= colProdInq.getE05APCBNK().trim()%>','<%= colProdInq.getE05APCTYP().trim()%>','<%= colProdInq.getE05APCTLN().trim()%>');"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="45%"> 
