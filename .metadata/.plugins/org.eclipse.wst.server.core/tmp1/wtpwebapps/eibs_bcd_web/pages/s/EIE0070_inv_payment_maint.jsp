...
%>
<div align="center"> 
  <h3>Esquema de Pagos de Cupones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_quote_basic.jsp,EIE0060"> 
  </h3>
</div>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0070" >
  ...
  <table  class="tableinfo">
    <tr id="trdark"> 
      <td nowrap width="29%" > 
        <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].E01SCHIIC.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" title="help" align="bottom" border="0" > 
          Instrumento :</a></div>
      </td>
      <td nowrap width="71%" > 
    ...
    <tr id="trclear"> 
      <td nowrap width="29%" > 
        <div align="right"><a href="javascript:GetSymbolInfo(document.forms[0].D01ISISYM.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" title="help" align="bottom" border="0" > 
          Símbolo :</a></div>
      </td>
      <td nowrap width="71%" > 
        <div align="left"> 
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="82%" > 
              ...
              Dividendos <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0"  ></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="18%" > 
            ...
            <td nowrap colspan="3" width="82%" > 
              ...
              Porciento <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" border="0"  ></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="18%" > 
            ...
            <td nowrap colspan="3" width="82%" > 
              ...
              <input type="text" name="E01SCHPA3" size="5" maxlength="4" value="<%= invTrade.getE01SCHPA3()%>">
              <a href="javascript:DatePicker(document.forms[0].E01SCHPA1,document.forms[0].E01SCHPA2,document.forms[0].E01SCHPA3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="82%" > 
              ...
              <input type="text" name="E01SCHDE3" size="5" maxlength="4" value="<%= invTrade.getE01SCHDE3()%>">
              <a href="javascript:DatePicker(document.forms[0].E01SCHDE1,document.forms[0].E01SCHDE2,document.forms[0].E01SCHDE3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="18%" > 
            ...
            <td nowrap colspan="3" width="82%" > 
              ...
              <input type="text" name="E01SCHRE3" size="5" maxlength="4" value="<%= invTrade.getE01SCHRE3()%>">
              <a href="javascript:DatePicker(document.forms[0].E01SCHRE1,document.forms[0].E01SCHRE2,document.forms[0].E01SCHRE3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a> 
            </td>
          </tr>
		   <%}%> 
          <tr id="trclear"> 
