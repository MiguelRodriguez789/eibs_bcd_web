  ...
  function goAction(opt) {
    ...
    if (opt == "D") {
	  ...
	  if (ok) document.forms[0].submit();
    	...
    	page = "<%=request.getContextPath()%>/pages/s/EPR0370_foreign_currency_exchange_detail.jsp?ROW=" + row;
  		CenterNamedWindow(page,'Information',550,450,2);
	} else if (opt == "L") { 
		var row = document.forms[0].CURRENTROW.value;   
    	page = "<%=request.getContextPath()%>/pages/s/EPR0370_foreign_currency_exchange_maint.jsp?ROW=" + row;
  		CenterNamedWindow(page,'Information',550,450,2);
  	} else {
  	    page = "<%=request.getContextPath()%>/pages/s/EPR0370_foreign_currency_exchange_new.jsp?NEW=yes";
  		CenterNamedWindow(page,'Information',550,450,2);
  	}
  }
</SCRIPT>
...
<h3 align="center">Compraventa Moneda Extranjera<BR>Liquidacion de Compra de Cheques de Remesa y Cobranza<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_list, EPR0370"></H3>
<hr size="4">
...
<%}	else {%>
 ...
 <TABLE class="tbenter" width="100%" align=center>
    <TR>
      ...
      <TD class=TDBKG width="25%"> 
        <div align="center"><a href="javascript:goAction('L')">Procesar</a> 
        </div>
      </TD>
      <TD class=TDBKG width="25%"> 
        <div align="center"><a href="javascript:checkClose()">Salir</a> </div>
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        while (mtList.getNextRow()) {
           ...
           datapro.eibs.beans.EPR037001Message msgMT = (datapro.eibs.beans.EPR037001Message) mtList.getRecord();
     	%>               
        <TR>
