          ...
          <tr> 
            ...
            <td nowrap width="54%"> 
              <div align="left"> 
                ...
                <a href="javascript:GetLedger('E07ABK','<%=userPO.getBank().trim()%>','<%= userPO.getCurrency().trim()%>','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
              </div>
            </td>
          </tr>
        </table>
