...
{
	page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSECD0003?SCREEN=3&ROW=" + rowNum;
	CenterWindow(page,800,500,2);
}

function PrintPreview() {

	var pg = "<%=request.getContextPath()%>/pages/s/ECD0003_plastic_inq_print.jsp";
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_inq_list.jsp, ECD0003"> 
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign="top" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER">
				...
				<%= Util.formatCustomDate(currUser.getE01DTF(), msgPart.getE03CDRMON(), msgPart.getE03CDRDAY(), msgPart.getE03CDRYEA()) %></a>
			</TD>
			<TD NOWRAP ALIGN="CENTER">
			...
			<TD NOWRAP ALIGN="CENTER">
				<a href="javascript:getDetail('<%= detList.getCurrentRow() %>')">
				<%= Util.formatCustomDate(currUser.getE01DTF(),msgPart.getE03CDRMOR(), msgPart.getE03CDRDAR(),msgPart.getE03CDRYER()) %></a>
			</TD>
			<TD NOWRAP ALIGN="CENTER">
			...
			<TD NOWRAP ALIGN="CENTER">
				<a href="javascript:getDetail('<%= detList.getCurrentRow() %>')">
				<%= Util.formatCustomDate(currUser.getE01DTF(),msgPart.getE03CDRMOD(), msgPart.getE03CDRDAD(),msgPart.getE03CDRYED()) %></a>
			</TD>
			<TD NOWRAP ALIGN="CENTER">
