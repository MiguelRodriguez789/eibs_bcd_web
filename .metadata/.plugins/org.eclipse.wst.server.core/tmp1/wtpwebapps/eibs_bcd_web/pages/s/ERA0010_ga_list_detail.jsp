...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSERA0010">
  ...
  <h3 align="center">Listado de Detalles de Garant&iacute;as</h3>
  <hr size="4">
  <p align="left"></p>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="9%" > 
              <div align="left"> 
                <input type="text" name="E01ROCCUN" size="10" maxlength="9" value="<%=userPO.getCusNum().trim()%>">
              </div>
            </td>
            <td nowrap width="15%" > 
  ...
  <table class="tableinfo" >
    ...
    <tr id="trclear"> 
      ...
      <td align="center" nowrap > 
        <input type="text"  name="E02RODSEQ_<%= collList.getCurrentRow() %>" size="2" maxlength="2"   readonly value="<%= collList.getRecord(0) %>" class="txtright">
      </td>
      <td align="center" nowrap > 
        <input type="text" name="E02RODNBR_<%= collList.getCurrentRow() %>" size="4" maxlength="4" onKeypress="enterInteger(event)" value="<%= collList.getRecord(1) %>" >
      </td>
      <td align="center" nowrap> 
        <input type="text" name="E02RODDSC_<%= collList.getCurrentRow() %>" size="35" maxlength="35" value="<%= collList.getRecord(2) %>" >
      </td>
      <td align="center" nowrap > 
        <input type="text" name="E02RODAMT_<%= collList.getCurrentRow() %>" size="17" maxlength="17" value="<%= collList.getRecord(3) %>" onKeypress="enterDecimal(event, 2)" >
      </td>
      <td align="center" nowrap> 
        <eibsinput:date name="gaCodes" fn_month="E02RODMDM" fn_day="E02RODMDD"" fn_year="E02RODMDY" />
      </td>
    </tr>
    <%
             }
    ...
    <tr id="trclear"> 
      ...
      <td align="left" nowrap width="6%" > 
        <div align="center">
          <input type="text" name="E02RODSEQ_<%= i %>" size="2" maxlength="2"   readonly  class="txtright" value="<%=seq %>" >
        </div>
      </td>
      <td align="left" nowrap width="9%" > 
        <div align="center">
          <input type="text" name="E02RODNBR_<%= i %>" size="4" maxlength="4" onKeypress="enterInteger(event)" id="txtleft" value="">
        </div>
      </td>
      ...
      <td align="left" nowrap width="14%"> 
        <div align="center">
          <input type="text" name="E02RODAMT_<%= i %>" size="17" maxlength="17" value="" id="txtleft"  onKeypress="enterDecimal(event, 2)">
        </div>
      </td>
    ...
    <tr > 
      <td width="37%" height="52" nowrap> 
        <div align="right">Cantidad de Registros a A&ntilde;adir : 
          <input type="text" name="TEMP_ROW" size="4" maxlength="3" value="0" onKeyPress="enterInteger(event)" onBlur="checkRowValue()">
        </div>
      </td>
      <td width="10%" height="52" nowrap><a href="javascript:submitThis(1)"><img src="<%=request.getContextPath()%>/images/s/applicar_on.gif" title="aplicar" align="middle" border="0" ></a></td>
      <td  width="44%" height="52" nowrap> 
        <div align="right">Elimina Registro Seleccionado: </div>
      </td>
      <td  width="9%" height="52" nowrap><a href="javascript:submitThis(3)"><img src="<%=request.getContextPath()%>/images/s/delete_over.gif" title=" borrar" align="middle" border="0" ></a></td>
    </tr>
  </table>
