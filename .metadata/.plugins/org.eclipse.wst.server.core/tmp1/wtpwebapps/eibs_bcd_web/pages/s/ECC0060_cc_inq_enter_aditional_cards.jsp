...
%>
	...
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_inq_enter_aditional_cards, ECC0060"></H3>
  ...
  <table class="tbenter" HEIGHT="25%" width="100%" border="0">
    ...
    <tr> 
      ...
      <td nowrap ALIGN="left"> 
        ...
        <img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" onclick="document.forms[0].search[1].click()"></a>     
		--%>
      </td>
    </tr> 
  </table>  
