...
title="ELC0560_lc_nego_acp.jsp"></H3>
<HR size="4">
    ...
    <TR bgcolor="#ffffff"> 
      <TD nowrap height="79" width="100%">
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
			   ...
			   <TR ID="trclear">
						<TD ALIGN="right" VALIGN="top" HEIGHT="24" WIDTH="128"><B>Carta de Crédito: </B></TD>
		  ...
		  <TR id="trclear">
              ...
              <TD colspan=3 nowrap valign="top" height="24" align="left">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <TR id="trclear">
	...
	<INPUT type="text" name="E01CRPGLN" size="20" maxlength="16" value="<%=msg01.getE01CRPGLN()%>" onKeyPress="enterInteger(event)" class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.forms[0].E01CRPBNK.value,document.forms[0].E01CRPCCY.value,'','','')"></TD>
	...
	class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')"></TD>
  </TR>
</TABLE>
<% } %>
<P></P>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
		...
		<A href="javascript: GetProduct('E01NEWPRO','<%=(msg01.getE01OPCODE().equals("2") ? "41" : "42")%>','<%= msg01.getE01CUSBNK()%>')">
...
if (msg01.getE01OPCODE().equals("2")) {%>
	...
	<h4>Información Banco a Banco</h4>
  <table class="tableinfo">
