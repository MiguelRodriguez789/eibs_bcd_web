...
<h3 align="center">Consulta de Promedios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="average_enter, ECIF040" width="32" height="32"></h3>
<hr size="4">
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter"  border=0  width=70% align="center" >
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=40% align="left"> 
          <p> 
            <input type=TEXT name="E01ACCNUM" value="<%= average.getE01ACCNUM() %>" size=13 maxlength=12 onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E01ACCNUM','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
            &nbsp; 
        </td>
      </tr>
      <tr> 
