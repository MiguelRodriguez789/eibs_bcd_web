...
<H3 align="center">Estado de Cuentas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="st_enter_stat.jsp, EDL0300"></H3>
  ...
  <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
    ...
    <tr> 
      ...
      <td nowrap width="50%"> 
        ...
        <a href="javascript:GetAccount('E01DEAACC','','CD','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
      </td>
    </tr>
  </table>
  <h4>&nbsp;</h4>
