...
<TITLE>Asiento de Cargos por Corresponsal&iacute;a</TITLE>
...
<BODY>
<h4> Cargos del Banco Corresponsal</h4>
<table class="tableinfo" style="width:95%" ALIGN=CENTER>
  ...
  <tr> 
    ...
    <td width="420"><a href="javascript:a('Y')">
    	Consolidar los cargos en una sola transacción</a>
    </td>
  </tr>
  <tr> 
    <td width=30 height="18" > 
    ...
    <td width="420"><a href="javascript:a('N')">
		Generar transacciones separadas por cada cargo</a>
	</td>
  </tr> 
</table>
<P>
