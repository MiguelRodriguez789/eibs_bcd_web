...
<body>
  ...
  <hr size="4">
  <FORM METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080?SCREEN=11">
   <INPUT TYPE=HIDDEN NAME="E02SFR" VALUE="<%= client.getE02SFR().trim()%>">
