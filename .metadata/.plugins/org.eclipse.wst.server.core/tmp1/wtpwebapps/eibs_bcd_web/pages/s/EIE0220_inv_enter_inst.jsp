...
<input type="radio" name="CSTATUS" value="R" onClick="document.forms[0].STATUS.value='R'" checked>
                ...
                <tr id="trclear"> 
                  ...
                  <td width="70%" nowrap > 
                    <div align="left"> 
                      <input type="text" size="3" maxlength="2" name="DATEF1" onKeyPress="document.forms[0].SEARCHC.value='D'">
                      ...
                      para 
                      <input type="text" size="3" maxlength="2" name="DATET1" onKeyPress="document.forms[0].SEARCHC.value='D'">
                ...
                <tr id="trclear"> 
                  ...
                  <td width="70%" nowrap > 
                    <input type="text" size="3" maxlength="2" name="DATEMF1" onKeyPress="document.forms[0].SEARCHC.value='D'">
                    <input type="text" size="3" maxlength="2" name="DATEMF2" onKeyPress="document.forms[0].SEARCHC.value='D'">
                    <input type="text" size="5" maxlength="4" name="DATEMF3" onKeyPress="document.forms[0].SEARCHC.value='D'">
                    ...
                    para 
                    <input type="text" size="3" maxlength="2" name="DATEMT1" onKeyPress="document.forms[0].SEARCHC.value='D'">
                    <input type="text" size="3" maxlength="2" name="DATEMT2" onKeyPress="document.forms[0].SEARCHC.value='D'">
                    <input type="text" size="5" maxlength="4" name="DATEMT3" onKeyPress="document.forms[0].SEARCHC.value='D'">
                ...
                <tr id="trclear"> 
                  ...
                  <td width="70%" nowrap > 
                    <div align="left"> 
					  ...
					  onKeyPress="document.forms[0].SEARCHC.value='C'">
                      <a href="javascript:GetCurrency('CURRENCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a></div>
                  </td>
                </tr>
                <tr id="trclear"> 
                  <td width="10%" align="center">&nbsp;</td>
