...
<SCRIPT type="text/javascript">
	...
	function showInfo(idx){
		...
		getElement("dataOpt"+index).style.display="none";
		getElement("dataOpt"+idx).style.display="";
		getElement("ACCIDX").value = idx;
...
<body>
<h3 align="center">Promedios de Cuentas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="averages_rt.jsp,ECIF250"></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSECIF250" target="AVEFRAME">
          			...
          			<table cellspacing="0" cellpadding="2" width="100%" border="0">
				        ...
				        <tr id=trclear> 
				         ...
				         <tr id=trdark> 
				            ...
				            <td nowrap width="20%"> 
				              <div align="left">
				              	<eibsinput:date name="accBean" fn_month="E02OPNDTM" fn_day="E02OPNDTD" fn_year="E02OPNDTY" />
				              </div>
				            </td>
				         </tr>
				         <tr id=trclear> 
				         ...
				         <tr id=trdark> 
				            ...
				            <td nowrap width="20%"> 
				              <div align="left">
				              	<eibsinput:date name="accBean" fn_month="E02LSCSTM" fn_day="E02LSCSTD" fn_year="E02LSCSTY" />
				              </div>
				            </td>
				          </tr>
				        </table>   
  ...
  <IFRAME NAME=AVEFRAME SCROLLING=NO FRAMEBORDER=0 WIDTH=100% HEIGHT=490 SRC="<%=request.getContextPath()%>/pages/s/EWD0005_client_help_blank.jsp"></IFRAME>  
  <SCRIPT type="text/javascript">
