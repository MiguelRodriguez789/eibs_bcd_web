...
<BODY>
<h3 align="center">M&uacute;ltiples Ordenes de Compra - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="sel_list_purchase.jsp, EIE0130M"></h3>
<hr size="4">
...
<p> 
  ...
  <table class="tbenter" align=center>
    <tr> 
      <td class=TDBKG > 
        <div align="center"><a href="javascript:goAction(2)"><b>Moificar</b></a></div>
      </td>
      <td class=TDBKG > 
