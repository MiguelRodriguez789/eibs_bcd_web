...
%> 
  <table class="tbenter" width=100% height=100%>
    <tr> 
      ...
      <div align="center"> <b> </b><b>No hay resultados que correspondan con su 
        criterio de b&uacute;squeda</b> </div>
      </td>
    </tr>
  </table>
...
<%}%>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_ac_format.jsp,ESWF100"> 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap ><%= Util.formatCustomDate(currUser.getE01DTF(),
            		swift.getBigDecimalE01SWFODM().intValue(),
            		swift.getBigDecimalE01SWFODD().intValue(),
            		swift.getBigDecimalE01SWFODY().intValue())%></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="21%" > 
