...
<h3 align="center">Formularios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="forms_pdf_list.jsp, EFRM000"></h3>
<hr size="4">
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.reports.JSEFRM000XSN" target="pdf">
	...
	<TABLE class="tableinfo" ALIGN=CENTER >
		 ...
		 %>
          <tr> 
            ...
            <td NOWRAP align=LEFT width="80%"><A HREF="javascript:showPDF('<%= msg.getE01APFPTH() %>')"><%= msg.getE01APFDSC() %></A></td>
          </tr>
		<% } %>
	</TABLE>
<% } %>
