...
function enter(code1,code2,code3,code4,code5,code6,code7,code8,code9,code10,code11,code12,code13,code14,code15,code16,code17,code18,code19) {
  ...
  if(top.opener.fieldAux4.trim() != "" && oForm[top.opener.fieldAux4]){oForm[top.opener.fieldAux4].value = code4}  
  ...
  if(top.opener.fieldAux13.trim() != ""){oForm[top.opener.fieldAux13].value = code13}
  ...
  if(top.opener.fieldAux18.trim() != ""){oForm[top.opener.fieldAux18].value = code18}
  if(top.opener.fieldAux19.trim() != "" && oForm[top.opener.fieldAux19]){oForm[top.opener.fieldAux19].value = code7.substr(21,15)}
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25"> <%
        if ( ewd0001Help.getShowPrev() ) {
      			int pos =ewd0001Help.getFirstRec() - 81;
      			   out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.helps.JSEWD0001V?NameSearch=" + NameSearch + "&FromRecord=" + pos + "&Type=" + Type + "\" > <img src=\""+request.getContextPath()+"/images/s/previous_records.gif\" border=0></A>");
        }
%> </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> <%       
        if ( ewd0001Help.getShowNext() ) {
      			int pos = ewd0001Help.getLastRec();
      			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.helps.JSEWD0001V?NameSearch=" + NameSearch + "&FromRecord=" + pos + "&Type=" + Type + "\" ><img src=\""+request.getContextPath()+"/images/s/next_records.gif\" border=0></A>");
