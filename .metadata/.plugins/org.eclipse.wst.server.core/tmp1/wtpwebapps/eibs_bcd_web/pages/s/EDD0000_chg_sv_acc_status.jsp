...
<%int row = 0; %>
<H3 align="center">Cambios Estado de Cuenta y Bloqueos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chg_sv_acc_status, EDD0000"></H3>
<hr size="4">
