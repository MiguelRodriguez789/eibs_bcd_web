...
<BODY>
<h3 align="center">Historia de Instrucciones Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="spins_history_list.jsp, EWD0701"></h3>
<hr size="4">
                ...
                while (EWD0701Help.getNextRow()) {                 
                  ...
                  <TR>
					<TD NOWRAP ALIGN=LEFT>
		              <input type="text" name="EWDDSC" size="155" value="<%=msgList.getEWDDSC()%>" readonly>
					</TD>
					<td>
		              <input type="text" name="EWDDTM" size="3" maxlength="2" value="<%= msgList.getEWDDTM().trim()%>" readonly>
		              <input type="text" name="EWDDTD" size="3" maxlength="2" value="<%= msgList.getEWDDTD().trim()%>" readonly>
		              <input type="text" name="EWDDTY" size="5" maxlength="4" value="<%= msgList.getEWDDTY().trim()%>" readonly>
					</td>
				 </TR>
               <%   k++;   
                }
