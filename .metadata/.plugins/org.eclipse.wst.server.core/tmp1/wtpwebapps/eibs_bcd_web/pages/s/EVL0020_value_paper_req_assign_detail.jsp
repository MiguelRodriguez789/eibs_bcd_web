...
<H3 align="center">Asignacion de Pedidos Papel Valor<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_req_assign_detail,EVL0020"></H3>
<hr size="4">
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO1" size="12" maxlength="12" value="<%= msgMT.getE01BALLO1() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO1','E01BALBA1','E01BALIN1','E01BALFI1','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO2" size="12" maxlength="12" value="<%= msgMT.getE01BALLO2() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO2','E01BALBA2','E01BALIN2','E01BALFI2','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO3" size="12" maxlength="12" value="<%= msgMT.getE01BALLO3() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO3','E01BALBA3','E01BALIN3','E01BALFI3','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO4" size="12" maxlength="12" value="<%= msgMT.getE01BALLO4() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO4','E01BALBA4','E01BALIN4','E01BALFI4','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO5" size="12" maxlength="12" value="<%= msgMT.getE01BALLO5() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO5','E01BALBA5','E01BALIN5','E01BALFI5','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO6" size="12" maxlength="12" value="<%= msgMT.getE01BALLO6() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO6','E01BALBA6','E01BALIN6','E01BALFI6','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO7" size="12" maxlength="12" value="<%= msgMT.getE01BALLO7() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO7','E01BALBA7','E01BALIN7','E01BALFI7','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO8" size="12" maxlength="12" value="<%= msgMT.getE01BALLO8() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO8','E01BALBA8','E01BALIN8','E01BALFI8','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO9" size="12" maxlength="12" value="<%= msgMT.getE01BALLO9() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO9','E01BALBA9','E01BALIN9','E01BALFI9','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
		...
		<tr>
			<td>
				<input type="text" name="E01BALLO0" size="12" maxlength="12" value="<%= msgMT.getE01BALLO0() %>">
      	    	<a href="javascript:GetValuePaper('E01BALLO0','E01BALBA0','E01BALIN0','E01BALFI0','<%= userPO.getBank() %>','<%= userPO.getBranch() %>',document.forms[0].E01REQTIP.value,document.forms[0].E01REQSUB.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
			</td>
			<td>
