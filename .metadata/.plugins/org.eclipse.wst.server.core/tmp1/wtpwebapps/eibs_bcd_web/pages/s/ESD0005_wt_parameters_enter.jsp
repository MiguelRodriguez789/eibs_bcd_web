...
%>
 ...
 <h3 align="center">Parametros de Transferencia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="wt_parameters_enter.jsp,ESD0005"> 
 </h3>
 <hr size="4">
      ...
      <td> 
        <table class=tbenter width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr id="trdark"> 
            ...
            <td width="50%" nowrap> 
              <input type="text" name="E04CWTBNK" size="3" maxlength="2"  >
            </td>
          </tr>
