...
<h3 align="center">Ajustes a Intereses - Porción DGI<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_enter_adjustment,EDL0153"></h3>
<hr size="4">
<p>&nbsp;</p>
		  ...
		  <tr><td>&nbsp;</td></tr>
		   <tr><td>&nbsp;</td></tr>
            ...
            <td nowrap width="50%"> 
              ...
              <a href="javascript:GetAccount('E01DEAACC','','10','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Numero de Prestamo" align="bottom" border="0" ></a> 
            </td>
            </tr>
        </table>
      </td>
