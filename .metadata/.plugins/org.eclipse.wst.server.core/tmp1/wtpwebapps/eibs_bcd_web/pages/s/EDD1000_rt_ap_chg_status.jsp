...
<H3 align="center">Cambio de Status de Cuenta <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_ap_chg_status, EDD1000"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="59%" height="23"> 
	              <eibsinput:date name="rtStatus"  fn_month="E02ACMCHM" fn_day="E02ACMCHD" fn_year="E02ACMCHY" readonly="true"/> 
            </td>
          </tr>
          <tr id="trclear"> 
