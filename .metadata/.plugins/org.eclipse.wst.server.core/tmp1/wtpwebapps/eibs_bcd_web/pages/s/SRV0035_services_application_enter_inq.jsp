...
<H3 align="center">Aplicacion de Pagos y Cobros de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_application_enter_inq,SRV0035"></H3>
<hr size="4">
<p>&nbsp;</p>
