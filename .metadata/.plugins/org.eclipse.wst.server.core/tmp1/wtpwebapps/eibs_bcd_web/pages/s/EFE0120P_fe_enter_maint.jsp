...
function showGInfo(idxRow){
  ...
  getElement("sgTable"+i).style.display="none";
  getElement("sgTable"+idxRow).style.display="";
  getElement("ccTable"+i+"_"+j).style.display="none";
  getElement("ccTable"+idxRow+"_0").style.display="";
  maxRow = getElement("sgTable"+idxRow).rows.length;
  for(k=0;k<maxRow;k++){
	getElement("sgTable"+idxRow).rows[k].className="trnormal";
  }
  getElement("sgTable"+idxRow).rows[0].className="trhighlight";
  document.forms[0].ActGRow.value=""+idxRow;
...
function showSGInfo(idxRow){
  var i= parseInt(getElement("ActGRow").value);
  var j= parseInt(getElement("ActSGRow").value);

  getElement("sgTable"+i).rows[j].className="trnormal";
  getElement("sgTable"+i).rows[idxRow].className="trhighlight";
  getElement("ccTable"+i+"_"+j).style.display="none";
  getElement("ccTable"+i+"_"+idxRow).style.display="";  
  getElement("ActSGRow").value=""+idxRow;  
}
...
function clickSGckBox(val,idxRow){
  ...
  var oObject = getElement("chkCCenter"+i+"_"+j);
   if (oObject != null){
...
function clickGckBox(val,idxRow){
  showGInfo(idxRow); 
  var oObject = getElement("chkSGroup"+idxRow);
   if (oObject != null){
     if (oObject.length != null){
      for(j=0;j < oObject.length;j++){
       oObject(j).checked=val;
	   var oObject1 = getElement("chkCCenter"+idxRow+"_"+j);
   		if (oObject1 != null){
...
<body bgcolor="#FFFFFF">
<H3 align="center">Entradas Dealer Slip - Moneda Extranjera <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_enter_maint,EFE0120P"></H3>
        ...
        <table class="tableinfo">
          ...
          <tr id="trclear"> 
            ...
            <td width="64%"> 
              ...
              <a href="javascript:GetTypPar('E01FESCCY','E01FESCLS',document.forms[0].E01FESTYP.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td width="64%" height="2"> 
              ...
              <a href="javascript:GetCustomerDescId('E01FESCUN','E01FESNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="64%" height="2"> 
              ...
              <a href="javascript:GetFeRef('E01FESDID','E01FESREF',document.forms[0].E01FESTYP.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
          </tr>
        </table>
