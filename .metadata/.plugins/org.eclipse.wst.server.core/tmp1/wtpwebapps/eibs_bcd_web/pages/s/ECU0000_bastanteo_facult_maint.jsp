...
<H3 align="center">Sistema de Bastanteo - Mantenimiento de Facultades Limitadas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_facult_maint,ECU0000"></H3>
<hr size="4">
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E07CULOBS" size="90" maxlength="80" value="<%= msgMTFac.getE07CULOBS().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%">
