...
%> 
<h3 align="center"> <%= sTitle%> <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basi_swap.jsp,EFE0120I"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
			  ...
			  >
              <input type="text" readonly  name="E01FESMA3" size="5" maxlength="4" value="<%= fex.getE01FESMA3().trim()%>" 
			  >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <input type="text" readonly  name="E01FESOTS" size="70" maxlength="120" value="<%= fex.getE01FESOTS()%>" 
			  >
            </td>
          </tr>
          <tr id="trdark"> 
