...
<SCRIPT type="text/javascript">
  function goAction(opt) {
    ...
    if (opt == "C") { 
    	...
    	page = "<%=request.getContextPath()%>/pages/s/EPR0390_foreign_currency_exchange_detail.jsp?ROW=" + row;
  		CenterNamedWindow(page,'Information',550,450,2);
	} else if (opt == "R") { 
		var row = document.forms[0].CURRENTROW.value;   
    	page = "<%=request.getContextPath()%>/pages/s/EPR0390_foreign_currency_exchange_maint.jsp?ROW=" + row;
  		CenterNamedWindow(page,'Information',550,450,2);
  	}
  }
</SCRIPT>
...
<h3 align="center">Compraventa Moneda Extranjera<BR>Reversion de Operaciones Diarias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_list, EPR0390"></H3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
  		<TR id="trdark"> 
    		...
    		<TH ALIGN=CENTER >Usuario<br>Fecha/Hora <br>Liquidacion</TH> 
  		</TR>
     	<%
        mtList.initRow(); 
        ...
        while (mtList.getNextRow()) {
           ...
           datapro.eibs.beans.EPR039001Message msgMT = (datapro.eibs.beans.EPR039001Message) mtList.getRecord();
     	%>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01REQLIU()) + "<br>" +  Util.formatDate(msgMT.getE01REQLD1(),msgMT.getE01REQLD2(),msgMT.getE01REQLD3()) + "<br>" + Util.formatCell(msgMT.getE01REQLIT()) %></TD>
		</TR>    		
    	<%}%>    
     </TABLE>
    </TD>
