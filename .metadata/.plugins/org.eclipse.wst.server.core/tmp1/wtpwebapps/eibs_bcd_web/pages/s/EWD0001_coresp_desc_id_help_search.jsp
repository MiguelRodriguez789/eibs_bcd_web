...
function enter(){
	...
	parent.results.window.location.href="<%=request.getContextPath()%>/pages/s/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0001C?NameSearch=" + NameSearch + "@Type=" + Type + "@FromRecord=" + FromRecord + "@CusType=" + CusType + "'";
}
...
<tr>
<td nowrap>
<input type="radio" name="Type" value="S" checked onclick="typeClick()">Nombre Corto</td>
</tr>
<tr>
