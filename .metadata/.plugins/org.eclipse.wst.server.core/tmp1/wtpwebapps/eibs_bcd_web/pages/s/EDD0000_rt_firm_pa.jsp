      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E04CUN" size="13" maxlength="12" value="<%= rtFirm.getE04CUN().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td> 
        ...
        <tr id="trdark"> 
            ...
            <td nowrap> 
			  ...
			  <a href="javascript:GetSignerByCustomer('E<%= name %>4RCN','E<%= name %>4MA1','E<%=name%>4ID','E<%= name %>4TID','E<%= name %>4PID','E<%= name %>4MA2','E<%= name %>4MA3','E<%= name %>4MA4','E<%= name %>4CTY','E<%= name %>4STE','E<%= name %>4CTR','E<%= name %>4POB','E<%= name %>4ZPC','','','','','E<%= name %>4HPN','<%=name%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
...
<%-- INICIO SECCION DE DIRECCION --%>
          ...
          <tr id="trdark"> 
            ...
            <td width="23%" nowrap> 
              <input type="text" name="E<%= name %>4MA4" maxlength="35" size="36" value="<%= rtFirm.getField("E" + name + "4MA4").getString().trim()%>">
            </td>
          </tr> 
          ...
          <tr id="trclear"> 
            ...
            <td width="23%" nowrap> 
              ...
              <input type="text" name="D<%= name %>4STE" maxlength="30" size="31" value="<%= rtFirm.getField("D" + name + "4STE").getString().trim()%>">
          ...
          <tr id="PATID<%=name%>" class="trclear" > 
            ...
            <td width="23%" nowrap> 
              ...
              <input type="text" name="D<%= name %>4TID" maxlength="35" size="36" value="<%= rtFirm.getField("D" + name + "4TID").getString().trim()%>">
            </td>
          </tr>
          <tr  id="PAPID<%=name%>"  class="trdark" > 
            ...
            <td width="23%" nowrap> 
                ...
                <input type="text" name="D<%= name %>4PID" maxlength="35" size="36" value="<%= rtFirm.getField("D" + name + "4PID").getString().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td width="23%" nowrap> 
              <input type="text" name="E<%=name%>4CTR" maxlength="30" size="31" value="<%= rtFirm.getField("E" + name + "4CTR").getString().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="13%" nowrap> 
 ...
 <%-- FIN SECCION DE DIRECCION --%>
           ...
           <tr id="trdark"> 
            ...
            <td width="23%" nowrap>
              <div id="EXID<%= name %>"  style="display:none" >
                <input type="text" name="E<%= name %>4BNI" maxlength="25" size="27" value="<%= rtFirm.getField("E" + name + "4BNI").getString().trim()%>"> 
              </div>
              <div id="PAID<%= name %>"  >
          ...
          <tr id="trclear"> 
            ...
            <td width="23%" nowrap> 
              <input type="text" name="E<%= name %>4HPN" maxlength="15" size="17" value="<%= rtFirm.getField("E" + name + "4HPN").getString().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="13%" nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td width="23%" nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E<%= name %>4FL3','FI')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>	
            </td>
          </tr>
