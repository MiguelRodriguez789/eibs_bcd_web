...
function goList() {
	...
	page= "${pageContext.request.contextPath}/pages/s/EDP0703_financial_maintenance_sel.jsp"
...
// funciones expresion de calculo
 ...
 function hideAMT(){
	 getElement("AMT").style.visibility="hidden";
 }
...
// si hay valor, adiciona a arreglo +
if (f1.trim() != "") initPlus(f1); 
if (f2.trim() != "") initMinus(f2);
}
...
<H3 align="center">Mantenimiento Estado Financiero : <span style="font-style: italic;"> <%= userPO.getHeader10().trim()%> </span>
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="financial_maintenance.jsp, EDP0703">
</H3>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								...
								<BR>
								<INPUT type="button" class="styled-button-Search" value=">> +" onclick="suma();" ><BR>
								<BR>
								<BR>
								<BR>
								<BR>
								<BR>
								<INPUT type="button" class="styled-button-Search" value=">> - " onclick="resta();"> <BR>
								<BR>
								 <DIV align="left"></DIV>
								<td nowrap width="30%">
									...
									<TBODY>
										...
										<TR>
											...
											<INPUT type="button" class="EIBSBTN" value="Remover" onclick="removeMas();">
											</TD>
										</TR>
										<TR>
										...
										<TR>
											...
											<INPUT type="button" value="Remover" class="EIBSBTN" onclick="removeMenos();">
											</TD>
										</TR>
									</TBODY>
									</TABLE>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								...
								<td nowrap align="left" width="100%">
									<INPUT type="text" name="E01DPXGLN" size="18" maxlength="16" onkeypress="enterInteger(event)" value="<%= brnDetails.getE01DPXGLN().trim()%>" <% if(userPO.getHeader16().equals("2")){out.print("readonly");} %>>
								</td>
							</tr>
						</TBODY>
					</TABLE>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								...
								<td nowrap align="left" width="70%">
								<INPUT type="text" name="E01DPXSEC" size="5" maxlength="6" onkeypress="enterInteger(event)" value="<%= brnDetails.getE01DPXSEC().trim()%>">
								</td>
							</tr>
						</TBODY>
					</TABLE>
				...
				<TR>
					...
					<TABLE id="opTable" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="clear">
      				   		<TD ALIGN="right" >
      				   			<input type="button" class="styled-button-Search" value="Fórmula de cálculo >>" style="font-style: italic;" onclick="goAction(1,event)">      				   		
							</TD>							
							<td nowrap align="left" width="70%">
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trdark">
								<td nowrap width="17%">
									<DIV align="right">Seleccione Variable
										<BR> del Indice Financiero :
									</DIV>
								</td>
								<td nowrap align="left" width="100%">
								...
								<TABLE border="0" width="529">
									<TBODY>
						    			...
						    			%>
											...
											<TD nowrap width="28%"><input type="button" class="styled-button-Search" style="font-style: italic;" value="Remover >>"
												onclick="removeMe();"> <BR>
											</TD>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trclear">
								...
								<td nowrap align="left" width="70%">
									<INPUT type="text" name="E01DPXLME" size="5" maxlength="6" onkeypress="enterInteger(event)" value="<%= brnDetails.getE01DPXLME().trim()%>">
								</td>
							</tr>
						</TBODY>
					</TABLE>
