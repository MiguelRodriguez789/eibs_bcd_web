...
%> 
<h3 align="center">Instrucciones Especiales de Contratos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_special_inst,EDL0160T"></h3>
<hr size="4">
