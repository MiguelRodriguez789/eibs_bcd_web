...
<h3 align="center">Detalle del Producto
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="proposals_product_maint.jsp,EDP0720"></h3>
    		  ...
    		  <% if(msgRTC.getE02DPJF10().equals("1")){%>
				...
				<td width="15%" align="left">
				   <INPUT type="TEXT" name="E01PLTRTE" size="12" maxlength="10"
					...
					<% if (!msgRT.getH01FLGWK3().equals("3")){out.print("onkeypress=enterDecimal(event, 2)");}%> 
					<% if(msgRT.getH01FLGWK3().equals("3")){out.print("readonly");}%>
					>
				</td>
				<% }; %>
