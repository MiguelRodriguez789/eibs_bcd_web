...
<h3 align="center">Documento Swift<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="EDD0610_tr_inq_swift.jsp"></h3>
<hr size="4" width="100%">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="42%"> 
              <div align="left"> 
 				<eibsinput:date name="inqSwift" fn_year="E03INSDTY" fn_month="E03INSDTM" fn_day="E03INSDTD" readonly="true"/>
              </div>
            </td>
          </tr>
        </table>
