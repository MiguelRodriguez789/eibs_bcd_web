...
<script type="text/javascript">
  function finish(){
  top.opener.location.href = "<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSECO1000?SCREEN=2";
  top.close();
 }
</script>
</head>
...
<h3 align="center"> Carga de Cuadraturas automaticas
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="transfer_file_confirm, ECO1000" ></h3>
<hr size="4">
