...
<%if (userPO.getHeader10().equals("A")) {%>
<h3 align="center">Compraventa Moneda Extranjera<BR>Aprobacion de Liquidacion de Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_maint, EPR0350"></H3>
<%} else {%>
<h3 align="center">Compraventa Moneda Extranjera<BR>Liquidacion de Operaciones<%if (userPO.getHeader10().equals("D")) {%> Diarias <%} else {%> SPOT <%}%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_maint, EPR0350"></H3>
<%}%>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E02REQBRN" readonly size="5" maxlength="4" value="<%= msgLiquida.getE02REQBRN() %>">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
				...
				<a href="javascript:GetComission(document.forms[0].E02REQREF.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
				<%}%> 
			</td>
		</tr>
		<tr>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E02REQVD1" size="3" maxlength="2" value="<%= msgLiquida.getE02REQVD1() %>" readonly>
                <input type="text" name="E02REQVD2" size="3" maxlength="2" value="<%= msgLiquida.getE02REQVD2() %>" readonly>
                <input type="text" name="E02REQVD3" size="5" maxlength="4" value="<%= msgLiquida.getE02REQVD3() %>" readonly>
			</td>
		</tr>
		<%}%>
     </table>
  ...
  <TR><TD>
   <table id="headTable" width="100%">
    ...
    <tr id="trclear" align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR1" size="4" maxlength="4" value="<%= msgLiquida.getE02OFFBR1() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR2" size="4" maxlength="4" value="<%= msgLiquida.getE02OFFBR2() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR3" size="4" maxlength="4" value="<%= msgLiquida.getE02OFFBR3() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR4" size="4" maxlength="4" value="<%= msgLiquida.getE02OFFBR4() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
      ...
      <td nowrap> 
          <div align="center"> 
             <input type="text" name="E02OFFBR5" size="4" maxlength="4" value="<%= msgLiquida.getE02OFFBR5() %>" readonly>
          </div>
       </td>
       <td nowrap> 
          <div align="center"> 
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
		...
		<tr>
			<td nowrap width="20%" align="center">
                ...
                <%if (!userPO.getHeader10().equals("A")) {%>
				<a href="javascript:GetCheckForeignExc('E02REQCS1','E02REQCN1','E02REQCL1','E02REQCF1','E02REQCT1','E02REQCB1','E02REQCI1',document.forms[0].E02REQBNK.value,document.forms[0].E02REQBRN.value,document.forms[0].E02REQINS.value,'<%= msgLiquida.getH02USERID() %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
				<%}%>
		...
		<tr>
			<td nowrap width="20%" align="center">
                ...
                <%if (!userPO.getHeader10().equals("A")) {%>
				<a href="javascript:GetCheckForeignExc('E02REQCS2','E02REQCN2','E02REQCL2','E02REQCF2','E02REQCT2','E02REQCB2','E02REQCI2',document.forms[0].E02REQBNK.value,document.forms[0].E02REQBRN.value,document.forms[0].E02REQINS.value,'<%= msgLiquida.getH02USERID() %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
                <%}%>
		...
		<tr>
			<td nowrap width="20%" align="center">
                ...
                <%if (!userPO.getHeader10().equals("A")) {%>
				<a href="javascript:GetCheckForeignExc('E02REQCS3','E02REQCN3','E02REQCL3','E02REQCF3','E02REQCT3','E02REQCB3','E02REQCI3',document.forms[0].E02REQBNK.value,document.forms[0].E02REQBRN.value,document.forms[0].E02REQINS.value,'<%= msgLiquida.getH02USERID() %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
                <%}%>
		...
		<tr>
			<td nowrap width="20%" align="center">
				...
				<%if (!userPO.getHeader10().equals("A")) {%>
				<a href="javascript:GetCheckForeignExc('E02REQCS4','E02REQCN4','E02REQCL4','E02REQCF4','E02REQCT4','E02REQCB4','E02REQCI4',document.forms[0].E02REQBNK.value,document.forms[0].E02REQBRN.value,document.forms[0].E02REQINS.value,'<%= msgLiquida.getH02USERID() %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
                <%}%>
		...
		<tr>
			<td nowrap width="20%" align="center">
				...
				<%if (!userPO.getHeader10().equals("A")) {%>
				<a href="javascript:GetCheckForeignExc('E02REQCS5','E02REQCN5','E02REQCL5','E02REQCF5','E02REQCT5','E02REQCB5','E02REQCI5',document.forms[0].E02REQBNK.value,document.forms[0].E02REQBRN.value,document.forms[0].E02REQINS.value,'<%= msgLiquida.getH02USERID() %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
                <%}%>
