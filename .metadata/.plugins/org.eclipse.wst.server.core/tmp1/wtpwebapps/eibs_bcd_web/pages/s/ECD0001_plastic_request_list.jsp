      ...
      <TD > 
        <div align="center"> 
          ...
          <table class="tbenter" width=100% align=center>
           <tr>
            <td class=TDBKG>
                <div align="center" style="cursor:hand" onClick="showEnterData()"><a><b>Crear</b></a></div>
              </td>
              <td class=TDBKG>
    ...
    <TD NOWRAP valign="top" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01CDRREQ())%></TD>
		  	<TD NOWRAP ALIGN="CENTER"><%= Util.formatCustomDate( currUser.getE01DTF(), msgPart.getE01CDRMON(), msgPart.getE01CDRDAY(),msgPart.getE01CDRYEA()) %></TD>
