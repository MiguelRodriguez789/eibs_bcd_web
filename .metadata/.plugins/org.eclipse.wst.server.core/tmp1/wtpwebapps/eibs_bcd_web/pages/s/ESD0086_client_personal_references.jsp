...
<H3 align="center">Referencias Personales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_personal_references.jsp, ESD0086"></H3>
<hr size="4">
  ...
  <table  class="tableinfo" width="100%">
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="15%" align="right">Parentesco / Vinculo :</td>
            <td nowrap width="35%" align="left">
                <% if (isReadOnly) {%> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="35%" align="left">
                <% if (isReadOnly) {%> 
            		<input type="text" name="E01RMK" size="50" value="<%= ESD0086Record.getE01RMK().trim()%>" readonly> 
               	<% } else { %>
            		<eibsinput:text name="ESD0086Record" property="E01RMK" size="50" required="false" />
            	<% } %>
            </td>
            <td nowrap width="15%" align="right"></td>
            <td nowrap width="35%" align="left">
