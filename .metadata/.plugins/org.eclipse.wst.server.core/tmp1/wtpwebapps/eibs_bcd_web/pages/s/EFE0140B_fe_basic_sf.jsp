...
%>
<h3 align="center"> Spot - Moneda Extranjera <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_sf.jsp,EFE0140B"> 
</h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="right">Tipo de Confirmacti&oacute;n :</div>
            </td>
            <td nowrap colspan="2" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <h5 align="center">Cuenta Contale</h5>
            </td>
            <td nowrap > 
