...
<h3 align="center">Compraventa Moneda Extranjera<BR>Reversion de Operaciones Diarias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0390"></H3>
<hr size="4">
