...
<SCRIPT type="text/javascript">
		...
		function setInstrument(type, value){
...
<div align="center"> 
  <h3>Posicion de Inversiones <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_position_list.jsp, EIE0350"> 
  </h3>
</div>
<hr size="4">
...
%> 
  ...
  <TABLE class="tbenter" width="100%">
    <TR> 
      <TD ALIGN=CENTER class=TDBKG width="25%"> <a href="javascript:goAction(300,'B')" ><b>Bloquear</b></a> 
      </TD>
     <TD ALIGN=CENTER class=TDBKG width="25%"> <a href="javascript:goAction(300,'U')" ><b>Desbloquear</b></a> 
      </TD>
      <TD ALIGN=CENTER class=TDBKG width="25%"> <a href="javascript:goAction(400, 'D')" ><b>Ver Detalle</b></a> 
      </TD>
...
<br>
 ...
 <TR> 
     ...
     <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER NOWRAP># Contratos</TH>
     ...
     <% if (msgList.getE01LINTYP().equals("D"))  {%>         
                <TR>       
                  <TD NOWRAP ALIGN=CENTER width="10%">  
                      <input type="radio" name="selectedRow" value="<%=msgList.getE01ISINUM()%>" onClick="setInstrument('<%= msgList.getE01SELTYP() %>','<%= msgList.getE01ISINUM() %>')">
                  </TD>
                  <TD NOWRAP  ALIGN=CENTER width="10%"><%= msgList.getE01NUMDOC() %></td> 
                  <TD NOWRAP  ALIGN=CENTER width="10%"><%= msgList.getD01SELTYP() %></td>
                  <TD NOWRAP  ALIGN=CENTER width="10%"><%= msgList.getE01ISINUM() %></td> 
                  <TD NOWRAP  ALIGN=CENTER width="10%"><%= msgList.getE01ISIDSC() %></td>
