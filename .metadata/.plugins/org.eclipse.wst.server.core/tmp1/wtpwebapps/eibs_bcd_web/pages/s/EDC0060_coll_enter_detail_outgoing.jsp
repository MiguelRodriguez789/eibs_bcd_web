...
<H3 align="center">Pago/Liquidaci&oacute;n de Cobranzas <%=dcPag.getE01DCMTYP().equals("I") ? "Recibidas" : "Enviadas" %><IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="coll_enter_detail_outgoing.jsp, EDC0060"></H3>
<HR size="4">
...
<br>  
  <h4>Pago/Cobro a Nuestro Cliente</h4>
<table class="tableinfo">
	<tr>
		<td>
		...
		<TR id="trdark">
			...
			<TD width="663">
				<SELECT name="E01PAGVIA">
					<OPTION value=" " selected></OPTION>
					<OPTION value="2"	<%= dcPag.getE01PAGVIA().equals("2")?"selected":"" %>>Cuenta</OPTION>
