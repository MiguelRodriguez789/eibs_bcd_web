  ...
  <input type=HIDDEN name="E01YYYFIL" value=""> 
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter"  border=0  width=70% align="center" >
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILNPR" size=9 maxlength=9 onKeypress="enterInteger(event)">
        </td>
      </tr>
       <tr valign="middle"> 
        <td nowrap width=20% align="right" >
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILCUN" size=15 maxlength=9 onKeypress="enterInteger(event)">
     ...
     <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILEJE" size=15 maxlength=9 onKeypress="enterInteger(event)">
