...
%> 
  <table class="tbenter" width=100% height=100%>
    <tr> 
      <td>
      <div align="center"><b>No hay resultados que correspondan con su criterio de b&uacute;squeda</b> 
      </div>
      </td>
    </tr>
  </table>
...
<%}%>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_fr_format.jsp,ESWF100"> 
<hr size="4">
