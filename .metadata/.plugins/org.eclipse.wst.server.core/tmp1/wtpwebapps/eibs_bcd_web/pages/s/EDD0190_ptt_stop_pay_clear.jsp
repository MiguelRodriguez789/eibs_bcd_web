...
<H3 align="center"><% if (userPO.getHeader20().equals("DO_CLEAR")) out.print("Aclarar"); else out.print("Entregar");%> Protesto del Documento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ptt_stop_pay_clear.jsp , EDD0190"> 
</H3>
<hr size="4">
