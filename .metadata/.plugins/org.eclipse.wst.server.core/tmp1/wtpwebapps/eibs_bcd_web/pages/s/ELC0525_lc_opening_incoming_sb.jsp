...
<BODY>
<H3 align="center"><%= (userPO.getPurpose().equals("NEW") ? "Apertura" : "Mantenimiento") %> de Carta de Crédito Standby Recibida 
<IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="ELC0525_lc_opening_incoming_sb.jsp"></H3>
<HR size="4">
<FORM>
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
  <TR id="trdark">
    <TD align="right" width="208"><STRONG>Banco : </STRONG></TD>
    <TD width="126"><INPUT type="text" name="E01LCMBNK" readonly size="4" maxlength="2" value="<%=msg040001.getE01LCMBNK().trim()%>"></TD>
    <TD align="right" nowrap width="22%"><STRONG>N&uacute;mero de Carta de Cr&eacute;dito : </STRONG></TD>
  ...
  <TR>
    <TD align="right" width="208"><STRONG>Nuestra Referencia : </STRONG></TD>
    <TD width="126"><INPUT name="E01LCMORF" type="text" value="<%=msg040001.getE01LCMORF().trim()%>" size="20" maxlength="16" readonly="readonly"></TD>
    <TD align="right" nowrap width="22%"><STRONG>Producto : </STRONG></TD>
    <TD><B>
      <INPUT type="text" name="E01LCMPRO" size="4" maxlength="4" value="<%=msg040001.getE01LCMPRO().trim()%>" readonly>
    </B></TD>
  </TR>
  <TR id="trdark">
    <TD align="right" width="208"><STRONG>Referencia del Banco Emisor : </STRONG></TD>
    <TD width="126"><B>
      <INPUT name="E01LCMTRF" type="text" value="<%=msg040001.getE01LCMTRF().trim()%>" size="20" maxlength="16" readonly="readonly">
    </B></TD>
    <TD align="right" nowrap width="22%"><STRONG>Descripci&oacute;n del Producto : </STRONG></TD>
    <TD><B>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF2" disabled>
        ...
        <INPUT name="E01LCMAPA" type="text" value="<%=msg040001.getE01LCMAPA()%>" size="12"	maxlength="12" readonly="readonly"></TD>
  </TR>
  <TR id="">
    <TD width="35%" align="right">Nombre: </TD>
    <TD align="left"><INPUT name="E01LCMAP1" type="text" value="<%=msg040001.getE01LCMAP1()%>" size="45" maxlength="35" readonly="readonly">    
...
<TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD align="left" valign="bottom" nowrap><INPUT name="E01LCMIB5" type="text" value="<%=msg040001.getE01LCMIB5()%>" size="4" maxlength="4" readonly="readonly">
      Código Postal
      <INPUT name="E01LCMIB6" type="text" value="<%=msg040001.getE01LCMIB6()%>" size="16" maxlength="15" readonly="readonly">
      País
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT name="E01LCMCA5" type="text" value="<%=msg040001.getE01LCMCA5()%>" size="4" maxlength="4" readonly="readonly">
      ...
      Pa&iacute;s
      <INPUT name="E01LCMCA7" type="text" value="<%=msg040001.getE01LCMCA7()%>" size="4" maxlength="4" readonly="readonly"></TD>
  </TR>
</TABLE>
...
<!-- <TABLE width="100%" border="0" align="center" cellpadding="2"  cellspacing="0" class="tableinfo">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT name="E01LCMCB5" type="text" id="E01LCMCB5" value="<%=msg040001.getE01LCMCB5()%>" size="2" maxlength="2" readonly="readonly">
      C&oacute;digo Postal
      <INPUT name="E01LCMCB6" type="text" id="E01LCMCB6" value="<%=msg040001.getE01LCMCB6()%>" size="16" maxlength="15" readonly="readonly">
      Pa&iacute;s
