...
%> 
<h3 align="center"> Plantillas Formatos Libres SWIFT <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inq_swift_free_format.jsp,ESWF300"> 
</h3>
<hr size="4">
