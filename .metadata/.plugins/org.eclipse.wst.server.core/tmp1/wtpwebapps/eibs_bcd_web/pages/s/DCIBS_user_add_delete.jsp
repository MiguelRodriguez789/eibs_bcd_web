...
<BODY>
<H3 align="center">DCIBS Entity User Inquiry <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="DCIBS_user_add_delete.jsp, DCIBS"></H3>
<hr size="4">
<FORM>
