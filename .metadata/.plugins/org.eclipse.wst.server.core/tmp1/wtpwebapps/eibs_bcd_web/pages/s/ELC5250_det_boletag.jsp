...
<h4></h4>
<h3 align="center">Comprobante de Documentaria en Efectivo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="det_boletag.jsp,ELC5250"></h3>
<hr size="4">
    ...
    <TD>
       <TABLE style="background-color: #ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
        ...
        <TR>
          ...
          <TD STYLE="BORDER-RIGHT: black 1px solid;"><div align=left>&nbsp;<%=Util.formatCustomDate(currUser.getE01DTF(),Integer.parseInt(bolgaran.getE01LCMIDM()),Integer.parseInt(bolgaran.getE01LCMIDD()),Integer.parseInt(bolgaran.getE01LCMIDY()))%>
          </div></TD>
        ...
        %>
          ...
          <TD id="trcolor" style="BORDER-RIGHT: black 1px solid; HEIGHT:20PX" width="96"><div align=left>&nbsp;<%= Util.formatCell(bolgaran.getE01LCMBRN().trim())%></div></TD>
        </TR>
        <TR id="trcolor">
        ...
        <TR id="trcolor">
          ...
          <TD style="BORDER-RIGHT: black 1px solid; HEIGHT:20PX"><div align=left>&nbsp;<%= Util.formatCell(bolgaran.getE01APLRUT().trim())%></div></TD>
        ...
        <TR id="trcolor">
          ...
          <TD style="BORDER-RIGHT: black 1px solid; HEIGHT:5PX" width="100"><div align=right>&nbsp;<%= Util.formatCCY(bolgaran.getE01LCMCAM().trim())%></div></TD>
        </TR>
        <TR id="trcolor">
          ...
          <TD style="BORDER-RIGHT: black 1px solid; HEIGHT:5PX" width="100"><div align=right>&nbsp;<%= Util.formatCCY(bolgaran.getE01LCMC11().trim())%></div></TD>
        </TR>
        <TR id="trcolor">
          ...
          <TD style="HEIGHT:5PX"><div align=left>Total $</div></TD>
           <%
		   double monto 		= Double.parseDouble(bolgaran.getE01LCMCAM().trim());
		   double comision 		= Double.parseDouble(bolgaran.getE01LCMC11().trim());
		   String total_suma	= String.valueOf(monto + comision);

		   String comision_str	= Util.formatCCY(bolgaran.getE01LCMC11().trim());
           ...
           <% }
          	  ...
          	  <div align=right><%= Util.formatCCY(bolgaran.getE01LCMC11().trim())%></div>
           <% } %>
           </TD>
           </TR>
        <TR id="trcolor">
          <TD style="BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid"><div align=left>Ciudad</div></TD>
          <TD style="BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid"><div align=left>&nbsp;<%= bolgaran.getE01BNFCTY().trim()%></div></TD>
        ...
        <TR id="trcolor">
          ...
          <TD style="BORDER-RIGHT: black 1px solid" valign=bottom><div align=left>&nbsp;<%= Util.formatCell(bolgaran.getE01BNFRUT().trim())%></div></TD>
    ...
    <TD>
       <TABLE style="background-color: #ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
        ...
        <TR>
          ...
          <TD><div align=left>&nbsp;<%= bolgaran.getE01APLNME().trim()%></div></TD>
          <TD>&nbsp;</TD>
          <TD style="HEIGHT:20PX" colspan="3"><div align=left>CORPBANCA</div> </TD>
        </TR>
        <TR>
          <TD style="HEIGHT:20PX"><div align=left>RUT</div></TD>
          <TD><div align=left>&nbsp;<%= Util.formatCell(bolgaran.getE01APLRUT().trim())%></div></TD>
          <TD>&nbsp;</TD>
        ...
        <TR>
          ...
          <TD style="HEIGHT:5PX" colspan="2"><div align=right>&nbsp;<%= Util.formatCCY(bolgaran.getE01LCMC11().trim())%></div></TD>
          <TD style="HEIGHT:20PX"></TD>
        </TR>
        <TR>
          <TD>&nbsp;</TD>
        ...
        <TR>
          <TD style="HEIGHT:20PX"><div align=left>Fecha</div></TD>
          <TD><div align=left>&nbsp;<%=Util.formatCustomDate(currUser.getE01DTF(),Integer.parseInt(bolgaran.getE01LCMIDM()),Integer.parseInt(bolgaran.getE01LCMIDD()),Integer.parseInt(bolgaran.getE01LCMIDY()))%>
          </div></TD>
          <TD>&nbsp;</TD>
          <TD colspan="2">&nbsp;</TD>
          <TD>&nbsp;</TD>
        ...
        <TR>
          ...
          <TD style="HEIGHT:20PX"><div align=left>&nbsp;<%= Util.formatCell(bolgaran.getE01LCMBRN().trim())%></div></TD>
          <TD>&nbsp;</TD>
          <TD colspan="2">&nbsp;</TD>
          <TD>&nbsp;</TD>
        </TR>
