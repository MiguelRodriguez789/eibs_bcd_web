...
<H3 align="center">Consulta de Afiliaciones - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_afilia_inq,SRV0000"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01AFICD1" size="3" maxlength="2" readonly value="<%= msgMT.getE01AFICD1() %>">
	      	<input type="text" name="E01AFICD2" size="3" maxlength="2" readonly value="<%= msgMT.getE01AFICD2() %>">
	      	<input type="text" name="E01AFICD3" size="5" maxlength="4" readonly value="<%= msgMT.getE01AFICD3() %>">
	      </td>
     	</tr>
     	<tr id=trclear> 
		  <td> 
