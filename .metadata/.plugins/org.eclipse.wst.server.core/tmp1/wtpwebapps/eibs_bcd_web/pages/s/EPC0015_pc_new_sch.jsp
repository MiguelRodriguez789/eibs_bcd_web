...
<jsp:useBean id= "msgPCB" class= "datapro.eibs.beans.EPC001501Message"  scope="session" />
...
<h3 align="center">Inspectores Asociados a Proyecto - Adición<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_new_sch.jsp, EPC0015"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01PCPACC" size="12" maxlength="12" value="<%= userPO.getIdentifier().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="20%" > 
            ...
            <td nowrap width="5%" > 
              <div align="left"> 
                <input type="text" name="E01PCPCUN" size="11" maxlength="9" value="<%= userPO.getCusNum().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="25%" > 
              <div align="left"> 
      ...
      <td> 
        <table cellspacing=0 cellpadding=1 width="100%" border="0" id="INFOCHG">
          ...
          <tr id="trdark"> 
            ...
            <td width="70%"> 
              <input type="text" name="E01PCPNUM" id="E01PCPNUM" size="5" maxlength="3" value="<%= msgPCB.getE01PCPNUM().trim()%>">
              <a href="javascript:GetTypeBroker('E01PCPNUM','O')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="middle" border="0"></a> 
