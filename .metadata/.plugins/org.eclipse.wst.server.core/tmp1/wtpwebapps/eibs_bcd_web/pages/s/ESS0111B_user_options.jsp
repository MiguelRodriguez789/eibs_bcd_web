...
function loadMenu(groupId, type) {
	...
	$("#menu").jstree({
		"json_data" : {
			"ajax" : {
				"url" : function (n) {
					return "<%=request.getContextPath()%>/servlet/datapro.eibs.security.JSESS0111B?SCREEN=3";
				},
				"cache" : false, 
				"data" : function (n) {
					//Data to be sent to the server, could be key/value pairs
		...
		"search" : {
			"ajax" : {
				"url" : function (n) {
					return "<%=request.getContextPath()%>/servlet/datapro.eibs.security.JSESS0111B?SCREEN=6";
				},
				"cache" : false, 
				"data" : function (str) {
					//Data to be sent to the server, could be key/value pairs
...
function submitChecked(){
	...
	var text = type == "G" ? "Actualizando opciones de grupos..." : "Actualizando opciones de usuarios...";
	var url = "<%=request.getContextPath()%>/servlet/datapro.eibs.security.JSESS0111B";
...
<h3 align="center">Asignación del Opciones del IBS a Usuarios del Sistema
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="user_options, ESS0111B"></h3>
<hr size="4">
							...
							<tr align="center">
								<td align="left" bgcolor="white">
							    	<div id="updateDiv">
							    		...
							    		<img src="<%=request.getContextPath()%>/images/s/update.gif" title="Actualizar menues del usuario" border="0"></a>
							  		</div>
								</td>
						   		<td align="right"  bgcolor="white">Opciones :&nbsp;</td>
								<td align="left" bgcolor="white">
