...
<h3 align="center">Cuentas Corrientes Con Interes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ESD0205_rt_tables_dda_02, ESD0205" ></h3>
<hr size="4">
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            ...
            <td nowrap width="31%"> 
              <div align="left"> 
                <input type="text" name="E02RTEMBM" size="15" maxlength="13" value="<%= charges.getE02RTEMBM()%>">
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            ...
            <td nowrap width="31%" height="34" > 
              <div align="left"> 
                <input type="text" name="E02RTEMBR" size="15" maxlength="13" value="<%= charges.getE02RTEMBR()%>">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="16%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMKL" size="14" maxlength="13" value="<%= charges.getE02RTEMKL()%>">
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB1" size="14" maxlength="13" value="<%= charges.getE02RTEMB1()%>">
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
         ...
         <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="16%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMB2" size="14" maxlength="13" value="<%= charges.getE02RTEMB2()%>">
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMB3" size="14" maxlength="13" value="<%= charges.getE02RTEMB3()%>">
              </div>
            </td>
            <td nowrap width="27%"> 
              <div align="center"> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="16%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMB4" size="14" maxlength="13" value="<%= charges.getE02RTEMB4()%>">
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB5" size="14" maxlength="13" value="<%= charges.getE02RTEMB5()%>">
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            ...
            <td nowrap width="16%"> 
              <div align="center"> 
                <input type="text" name="E02RTEMB6" size="14" maxlength="13" value="<%= charges.getE02RTEMB6()%>">
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB7" size="14" maxlength="13" value="<%= charges.getE02RTEMB7()%>">
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
         ...
         <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            ...
            <td nowrap width="16%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB8" size="14" maxlength="13" value="<%= charges.getE02RTEMB8()%>">
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMB9" size="14" maxlength="13" value="<%= charges.getE02RTEMB9()%>">
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
            ...
            <td nowrap width="16%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMBX" size="14" maxlength="13" value="<%= charges.getE02RTEMBX()%>">
              </div>
            </td>
            <td nowrap width="9%"> 
              <div align="center"> 
            ...
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E02RTEMBY" size="14" maxlength="13" value="<%= charges.getE02RTEMBY()%>">
              </div>
            </td>
            <td nowrap width="27%" > 
              <div align="center"> 
