...
<SCRIPT type="text/javascript">
 ...
 function showAddInfo(idxRow){
   ...
   getElement("E01DEANRTE"+idxRow).focus();
  }   
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="authoritation_list.jsp,EDL0141">
</h3>
<hr size="4">
 ...
 <TR> 
  ...
  <TR id="trdark"> 
   ...
   <TD nowrap ALIGN="RIGHT" valign="top">
     ...
     <Table id="tbAddInfo" >
      <tr id="trclear">
         <TD ALIGN="RIGHT" align="center" nowrap><b>Principal : <br>Operador : <br>Base : <br>Tasa :<br>Nueva Tasa : </b></TD>
