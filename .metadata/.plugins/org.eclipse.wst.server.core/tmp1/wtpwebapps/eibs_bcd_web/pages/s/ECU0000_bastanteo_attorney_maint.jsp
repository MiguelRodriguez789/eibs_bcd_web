...
<H3 align="center">Sistema de Bastanteo - Mantenimiento del Propietario/Apoderado<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_attorney_maint,ECU0000"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	...
    	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E05CUMDD1" size="3" maxlength="2" value="<%= msgMTMem.getE05CUMDD1() %>">
	      	<input type="text" name="E05CUMDD2" size="3" maxlength="2" value="<%= msgMTMem.getE05CUMDD2() %>">
	      	<input type="text" name="E05CUMDD3" size="5" maxlength="4" value="<%= msgMTMem.getE05CUMDD3() %>">
	      	...
	      	&nbsp;T&eacute;rmino&nbsp;
	      	<input type="text" name="E05MBMTRM" size="6" maxlength="5" value="<%= msgMTMem.getE05MBMTRM().trim()%>">
     	...
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E05CUMD21" size="3" maxlength="2" value="<%= msgMTMem.getE05CUMD21() %>">
	      	<input type="text" name="E05CUMD22" size="3" maxlength="2" value="<%= msgMTMem.getE05CUMD22() %>">
	      	<input type="text" name="E05CUMD23" size="5" maxlength="4" value="<%= msgMTMem.getE05CUMD23() %>">
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMOBS" size="90" maxlength="80" value="<%= msgMTMem.getE05CUMOBS().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="100%">
