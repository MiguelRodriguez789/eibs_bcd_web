 ...
 <TABLE id=tbhelp cellpadding=4 cellspacing=2 style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
   ...
   <TR>
      ...
      <TD ALIGN=Left nowrap colspan=5>
	     ...
	     <a href="javascript:GetCodeCNOFC('E01DPGCOD','06')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0"></a> 
      </TD>
   </TR>
   <TR>
	  <TD ALIGN=right nowrap>
   ...
   <TR>
      ...
      <TD ALIGN=Left nowrap>
          <input type="text" name="E01DPGCF1" size="2" maxlength="2" onKeypress="enterInteger(event)" value="">       
      </TD>
      <TD ALIGN=Left nowrap>
          <input type="text" name="E01DPGCF2" size="2" maxlength="2" onKeypress="enterInteger(event)" value="">      
      </TD>
      <TD ALIGN=Left nowrap>
          <input type="text" name="E01DPGCF3" size="2" maxlength="2" onKeypress="enterInteger(event)" value="">       
      </TD>
      <TD ALIGN=Left nowrap>
          <input type="text" name="E01DPGCF4" size="2" maxlength="2" onKeypress="enterInteger(event)" value="">      
      </TD>
      <TD ALIGN=Left nowrap>
          <input type="text" name="E01DPGCF5" size="2" maxlength="2" onKeypress="enterInteger(event)" value="">      	 
      </TD>
   </TR>
   <TR>
	  <TD ALIGN=center colspan=6>
   ...
   <TABLE id=opTable class="tbenter">
    <TR>
      <TD ALIGN=CENTER width="20%" class=TDBKG>
  		 <a href="javascript:goAction(1)">Crear</a>
      </TD>
      <TD ALIGN=CENTER width="20%" class=TDBKG>
  		 <a href="javascript:goAction(2)">Modificar</a>
      </TD>
      <TD ALIGN=CENTER width="20%" class=TDBKG>
