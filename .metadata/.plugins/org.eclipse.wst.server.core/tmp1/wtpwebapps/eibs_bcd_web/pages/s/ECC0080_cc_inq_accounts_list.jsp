...
%> 
<h3 align="center">Cuentas Asignadas a tarjeta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_inq_accounts_list.jsp, ECC0080"></h3>
<hr size="4">
