...
<h3 align="center">Firmantes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_ap_firm.jsp, EDD1000"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E04CUN" size="10" maxlength="9" readonly value="<%= userPO.getCusNum().trim()%>">
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" name="E04NA1" size="45" maxlength="45" readonly value="<%= userPO.getCusName().trim()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="16%"> 
              <div align="left"><b> 
                <input type="text" name="E04CCY" size="3" maxlength="3" value="<%= userPO.getCurrency().trim()%>" readonly>
                </b> </div>
            </td>
            <td nowrap width="16%"> 
            ...
            <td nowrap width="16%"> 
              <div align="left"><b> 
                <input type="text" name="E04PRO" size="4" maxlength="4" readonly value="<%= userPO.getProdCode().trim()%>">
                </b> </div>
            </td>
          </tr>
        </table>
      ...
      <td> 
        ...
        <tr id="trdark"> 
            ...
            <td nowrap> 
			  ...
			  <a href="javascript:GetSignerByCustomer('E<%= name %>4RCN','E<%= name %>4MA1','E<%= name %>4NME','E<%= name %>4TID','E<%= name %>4PID','E<%= name %>4MA2','E<%= name %>4MA3','E<%= name %>4MA4','E<%= name %>4CTY','E<%= name %>4STE','E<%= name %>4CTR','E<%= name %>4POB','E<%= name %>4ZPC','','','','','E<%= name %>4HPN','<%=name%>')"></a>
...
<%--
          <tr id="trdark"> 
            ...
            <td width="23%" nowrap>
                    <%
					  if (rtFirm.getField("E" + name + "4HPN").getString().trim().equals("1"))					    
					   
					     out.print("Firma Indistinta");
					  
					   else if (rtFirm.getField("E" + name + "4HPN").getString().trim().equals("2") ) 
					     out.print("Firma Mancomunada");
					   else 
					      out.print("Firma Individual");
					   %>
            </td>
          </tr>
--%>
