...
<BODY>
<h3 align="center">Datos Plan de Disminucion<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="datos_plan_disminucion.jsp,ELC5000"></h3>
<hr size="4">
    ...
    <tr id=trclear>
    	<td align="center" nowrap> 1 </td>
         <td align="center" nowrap>
         	...
         	%>
            <input type="text" size="3" maxlength="2" name="E05L01EXD" value="<%= planDis.getE05L01EXD().equals("0")?"":planDis.getE05L01EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" maxlength="2" name="E05L01EXM" value="<%= planDis.getE05L01EXM().equals("0")?"":planDis.getE05L01EXM() %>" <%= apli3 %>>
            /
    ...
    <tr id=trdark>
    	<td align="center" nowrap> 2 </td>
         <td align="center" nowrap>
         	...
         	%>
            <input type="text" size="3" name="E05L02EXD" maxlength="2" value="<%= planDis.getE05L02EXD().equals("0")?"":planDis.getE05L02EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L02EXM" maxlength="2" value="<%= planDis.getE05L02EXM().equals("0")?"":planDis.getE05L02EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 3 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L03STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L03EXD" maxlength="2" value="<%= planDis.getE05L03EXD().equals("0")?"":planDis.getE05L03EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L03EXM" maxlength="2" value="<%= planDis.getE05L03EXM().equals("0")?"":planDis.getE05L03EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 4 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L04STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L04EXD" maxlength="2" value="<%= planDis.getE05L04EXD().equals("0")?"":planDis.getE05L04EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L04EXM" maxlength="2" value="<%= planDis.getE05L04EXM().equals("0")?"":planDis.getE05L04EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 5 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L05STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L05EXD" maxlength="2" value="<%= planDis.getE05L05EXD().equals("0")?"":planDis.getE05L05EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L05EXM" maxlength="2" value="<%= planDis.getE05L05EXM().equals("0")?"":planDis.getE05L05EXM() %>" <%= apli3 %>>
            /
	    ...
	    <td align="center" nowrap> 6 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L06STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L06EXD" maxlength="2" value="<%= planDis.getE05L06EXD().equals("0")?"":planDis.getE05L06EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L06EXM" maxlength="2" value="<%= planDis.getE05L06EXM().equals("0")?"":planDis.getE05L06EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 7 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L07STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L07EXD" maxlength="2" value="<%= planDis.getE05L07EXD().equals("0")?"":planDis.getE05L07EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L07EXM" maxlength="2" value="<%= planDis.getE05L07EXM().equals("0")?"":planDis.getE05L07EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 8 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L08STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L08EXD" maxlength="2" value="<%= planDis.getE05L08EXD().equals("0")?"":planDis.getE05L08EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L08EXM" maxlength="2" value="<%= planDis.getE05L08EXM().equals("0")?"":planDis.getE05L08EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 9 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L09STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L09EXD" maxlength="2" value="<%= planDis.getE05L09EXD().equals("0")?"":planDis.getE05L09EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L09EXM" maxlength="2" value="<%= planDis.getE05L09EXM().equals("0")?"":planDis.getE05L09EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 10 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L10STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L10EXD" maxlength="2" value="<%= planDis.getE05L10EXD().equals("0")?"":planDis.getE05L10EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L10EXM" maxlength="2" value="<%= planDis.getE05L10EXM().equals("0")?"":planDis.getE05L10EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 11 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L11STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L11EXD" maxlength="2" value="<%= planDis.getE05L11EXD().equals("0")?"":planDis.getE05L11EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L11EXM" maxlength="2" value="<%= planDis.getE05L11EXM().equals("0")?"":planDis.getE05L11EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 12 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L12STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L12EXD" maxlength="2" value="<%= planDis.getE05L12EXD().equals("0")?"":planDis.getE05L12EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L12EXM" maxlength="2" value="<%= planDis.getE05L12EXM().equals("0")?"":planDis.getE05L12EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 13 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L13STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L13EXD" maxlength="2" value="<%= planDis.getE05L13EXD().equals("0")?"":planDis.getE05L13EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L13EXM" maxlength="2" value="<%= planDis.getE05L13EXM().equals("0")?"":planDis.getE05L13EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 14 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L14STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L14EXD" maxlength="2" value="<%= planDis.getE05L14EXD().equals("0")?"":planDis.getE05L14EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L14EXM" maxlength="2" value="<%= planDis.getE05L14EXM().equals("0")?"":planDis.getE05L14EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 15 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L15STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L15EXD" maxlength="2" value="<%= planDis.getE05L15EXD().equals("0")?"":planDis.getE05L15EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L15EXM" maxlength="2" value="<%= planDis.getE05L15EXM().equals("0")?"":planDis.getE05L15EXM() %>" <%= apli3 %>>
            /
    	...
    	<td align="center" nowrap> 16 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L16STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L16EXD" maxlength="2" value="<%= planDis.getE05L16EXD().equals("0")?"":planDis.getE05L16EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L16EXM" maxlength="2" value="<%= planDis.getE05L16EXM().equals("0")?"":planDis.getE05L16EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L16EXA" maxlength="4" value="<%= planDis.getE05L16EXA().equals("0")?"":planDis.getE05L16EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
    	...
    	<td align="center" nowrap> 17 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L17STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L17EXD" maxlength="2" value="<%= planDis.getE05L17EXD().equals("0")?"":planDis.getE05L17EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L17EXM" maxlength="2" value="<%= planDis.getE05L17EXM().equals("0")?"":planDis.getE05L17EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L17EXA" maxlength="4" value="<%= planDis.getE05L17EXA().equals("0")?"":planDis.getE05L17EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
    	...
    	<td align="center" nowrap> 18 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L18STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L18EXD" maxlength="2" value="<%= planDis.getE05L18EXD().equals("0")?"":planDis.getE05L18EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L18EXM" maxlength="2" value="<%= planDis.getE05L18EXM().equals("0")?"":planDis.getE05L18EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L18EXA" maxlength="4" value="<%= planDis.getE05L18EXA().equals("0")?"":planDis.getE05L18EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
    	...
    	<td align="center" nowrap> 19 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L19STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L19EXD" maxlength="2" value="<%= planDis.getE05L19EXD().equals("0")?"":planDis.getE05L19EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L19EXM" maxlength="2" value="<%= planDis.getE05L19EXM().equals("0")?"":planDis.getE05L19EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L19EXA" maxlength="4" value="<%= planDis.getE05L19EXA().equals("0")?"":planDis.getE05L19EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
    	...
    	<td align="center" nowrap> 20 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L20STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L20EXD" maxlength="2" value="<%= planDis.getE05L20EXD().equals("0")?"":planDis.getE05L20EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L20EXM" maxlength="2" value="<%= planDis.getE05L20EXM().equals("0")?"":planDis.getE05L20EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L20EXA" maxlength="4" value="<%= planDis.getE05L20EXA().equals("0")?"":planDis.getE05L20EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
    	...
    	<td align="center" nowrap> 21 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L21STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L21EXD" maxlength="2" value="<%= planDis.getE05L21EXD().equals("0")?"":planDis.getE05L21EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L21EXM" maxlength="2" value="<%= planDis.getE05L21EXM().equals("0")?"":planDis.getE05L21EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L21EXA" maxlength="4" value="<%= planDis.getE05L21EXA().equals("0")?"":planDis.getE05L21EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
    	...
    	<td align="center" nowrap> 22 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L22STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L22EXD" maxlength="2" value="<%= planDis.getE05L22EXD().equals("0")?"":planDis.getE05L22EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L22EXM" maxlength="2" value="<%= planDis.getE05L22EXM().equals("0")?"":planDis.getE05L22EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L22EXA" maxlength="4" value="<%= planDis.getE05L22EXA().equals("0")?"":planDis.getE05L22EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
    	...
    	<td align="center" nowrap> 23 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L23STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L23EXD" maxlength="2" value="<%= planDis.getE05L23EXD().equals("0")?"":planDis.getE05L23EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L23EXM" maxlength="2" value="<%= planDis.getE05L23EXM().equals("0")?"":planDis.getE05L23EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L23EXA" maxlength="4" value="<%= planDis.getE05L23EXA().equals("0")?"":planDis.getE05L23EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
    	...
    	<td align="center" nowrap> 24 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L24STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L24EXD" maxlength="2" value="<%= planDis.getE05L24EXD().equals("0")?"":planDis.getE05L24EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L24EXM" maxlength="2" value="<%= planDis.getE05L24EXM().equals("0")?"":planDis.getE05L24EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L24EXA" maxlength="4" value="<%= planDis.getE05L24EXA().equals("0")?"":planDis.getE05L24EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
    	...
    	<td align="center" nowrap> 25 </td>
         <td align="center" nowrap>
         	<%	apli1 = planDis.getE05L25STS();
         		...
         		apli3 = apli1.equalsIgnoreCase("P")?"readonly":"";
         	%>
            <input type="text" size="3" name="E05L25EXD" maxlength="2" value="<%= planDis.getE05L25EXD().equals("0")?"":planDis.getE05L25EXD() %>" <%= apli3 %>>
            /
            <input type="text" size="3" name="E05L25EXM" maxlength="2" value="<%= planDis.getE05L25EXM().equals("0")?"":planDis.getE05L25EXM() %>" <%= apli3 %>>
            /
            <input type="text" size="5" name="E05L25EXA" maxlength="4" value="<%= planDis.getE05L25EXA().equals("0")?"":planDis.getE05L25EXA() %>" <%= apli3 %>>
         </td>
         <td align="center" nowrap>
