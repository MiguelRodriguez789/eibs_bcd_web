...
%>
<div align="center"> 
  <h3>Forward - Moneda Extranjera <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_forward.jsp,EFE0140B"> 
  </h3>
</div>
<hr size="4">
          ...
          <tr id="trdark">           
            ...
            <% if(fex.getH01FLGWK3().equals("N")){%>
             <td nowrap colspan="2" > 
              ...
              <a href="javascript:GetClassFex('E01WKFCLS','FWR','<%= fex.getE01WKFCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <%} else {%>             
           ...
           <%}%> 
            ...
            <td nowrap > 
			  ...
			  >
              <a href="javascript:GetCode('E01WKFRVF','STATIC_fe_bo_rev.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap >&nbsp;</td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
              <a href="javascript:GetCode('E01WKFNTF','STATIC_fe_bo_not.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="center"> 
                ...
                class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E01WKFOBK.value,'','','','')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
