...
<H3 align="center">Creacion de Servicios - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_serv_new,SRV0020"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap> 
	        ...
	        <a href="javascript:GetCodeDescCNOFC('E01SERCIA','E01SERCIN','YP')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
     	...
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E01SERACC" size="15" maxlength="12" value="<%= msgSer.getE01SERACC() %>" onKeypress="enterInteger(event)">
		  ...
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E01SERBTH" size="5" maxlength="4" value="<%= msgSer.getE01SERBTH() %>" onkeypress="enterInteger(event)">
      	  </td>     
      	</tr>
      	<tr id=trclear> 
		  <td> 
