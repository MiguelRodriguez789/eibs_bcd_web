...
<H3 align="center">Creacion de Afiliaciones - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_afilia_new,SRV0000"></H3>
<hr size="4">
     	...
     	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E01AFICIA','E01AFICIN','YP')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
	      ...
	      <td nowrap>
      	    ...
      	    <a href="javascript:GetCodeService('E01AFISRV','E01AFISRN',document.forms[0].E01AFICIA.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
      	  </td>
     	</tr>
     	<tr id=trdark> 
