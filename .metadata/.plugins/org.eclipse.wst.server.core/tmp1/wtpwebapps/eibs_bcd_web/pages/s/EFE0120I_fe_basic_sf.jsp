...
%> 
<h3 align="center"> Consulta - Spot <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_sf.jsp,EFE0120I"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="4" > 
              <input type="text" readonly  name="E01FESOTS" size="70" maxlength="120" value="<%= fex.getE01FESOTS().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
