...
<jsp:useBean id= "msgLC" class= "datapro.eibs.beans.ELC050011Message"  scope="session" />
...
<h3 align="center">Garant&iacute;as<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_documents.jsp,0500"></h3>
