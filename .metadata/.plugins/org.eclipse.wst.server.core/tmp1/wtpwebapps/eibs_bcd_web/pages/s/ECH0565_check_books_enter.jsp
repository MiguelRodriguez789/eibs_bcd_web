...
<h3 align="center">Consulta de Chequeras<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="check_books_enter.jsp, ECH0565"></h3>
<hr size="4">
...
<table  class="tableinfo">
          <tr id="trdark">
            ...
            <td nowrap>
              <input type="text" name="E01ACMDBR" size="5" maxlength="4" value="<%= rtBasic.getE01ACMDBR().trim()%>" readonly> </td>
          </tr>
          ...
          <tr id="trclear">
            ...
            <td nowrap align="left">
              <INPUT type="text" name="E01ACMNCB" size="3" maxlength="2" value="<%= rtBasic_01.getE01CHPASK().trim()%>" onkeypress="enterInteger(event)" readonly>
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap align=left>
              <INPUT type="text" name="E01ACMTBK" size="3" maxlength="2" value="<%= rtBasic.getE01ACMTBK().trim()%>" onkeypress="enterInteger(event)" readonly>
              <A href="javascript:GetTypCHKBook('E01ACMTBK','','<%= rtBasic.getE01ACMATY().trim()%>','<%= rtBasic.getE01ACMCCY().trim()%>')">
            ...
            <td nowrap><INPUT type="text" name="E01ACMMSK" size="3" maxlength="2" value="<%= rtBasic.getE01ACMMSK().trim()%>" onkeypress="enterInteger(event)" readonly> </td>
