...
de Tarjetas de Débito<BR>Reemplazo de Tarjeta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="card_replace2.jsp, ECC0090"></h3>
<hr size="4">
<% 
		...
		<TR>
			...
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0"
				...
				<TBODY>
					<TR id="trdark">
						<TD nowrap width="16%">
							<DIV align="right"><B>Número de Tarjeta Actual :</B></DIV>
						</TD>
						<TD nowrap width="20%">
							<DIV align="left">
						...
						<TD nowrap width="16%">
							<DIV align="right"><B>Número de Tarjeta Titular :</B></DIV>
						</TD>
						<TD nowrap width="20%">
							<DIV align="left">
					...
					<TR id="trclear">
						<TD nowrap width="16%">
							<DIV align="right"><B>Número de Tarjeta Nuevo :</B></DIV>
						</TD>
						<TD nowrap width="20%">
							<DIV align="left">
						...
						<TD nowrap width="16%">
							<DIV align="right"><B>Motivo de Reemplazo :</B></DIV>
						</TD>
						<TD nowrap width="20%">
							<DIV align="left">
