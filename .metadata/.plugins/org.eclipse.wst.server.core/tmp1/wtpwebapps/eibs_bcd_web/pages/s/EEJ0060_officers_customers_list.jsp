...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="officers_customers_list.jsp,EEJ0060">
</h3>
<hr size="4">
    	...
    	<TD NOWRAP valign=top>
  	 		<TABLE id="dataTable" width="100%">
        		...
        		<TR>
					...
					<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01EJEORI())%></TD>
					<TD NOWRAP ALIGN="LEFT"><%=Util.formatCell(msgMT.getE01EJEDES())%></TD>
				</TR>    		
    			<%             
    				chk = "";     
                }
