...
%> 
<h3 align="center"> Procesar Archivo de Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="payments_basic.jsp,EPR0015"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap >
              ...
              <a href="javascript:GetLedger('E01PRCOSA','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>
            </td>
          </tr>          
        </table>
      </td>
