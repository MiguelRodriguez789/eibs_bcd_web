...
<h3 align="center">Instrucciones Especiales
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_special_inst.jsp, ERA0050"></h3>
<hr size="4">
 <FORM METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSERA0050" >
      ...
      <td nowrap width="100%"> 
        <table class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01ROCCUN" size="12" maxlength="9" readonly value="<%= userPO.getCusNum().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="20%" > 
            ...
            <td nowrap width="30%" > 
              <div align="left"> 
                <input type="text" name="E01CUSNA1" size="60" maxlength="45" readonly value="<%= userPO.getCusName().trim()%>" readonly>
                </div>
            </td>
          </tr>
        </table>
  ...
  if ( (!userPO.getPurpose().equals("APPROVE")) && (!userPO.getPurpose().equals("INQUIRY")) ) { %>
  <p align="center"> 
