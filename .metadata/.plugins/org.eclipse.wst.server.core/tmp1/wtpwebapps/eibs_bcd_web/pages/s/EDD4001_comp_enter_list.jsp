...
<BODY>
<h3 align="center">Mantenimiento de Pagos Automáticos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="comp_enter_list.jsp, EDD4001"></h3>
<hr size="4">
	...
	<tr id="trclear"> 
      ...
      <td align=CENTER width="34%"> 
        <div align="left"> 
         ...
         <a href="javascript:GetCodeDescCNOFC('TABLECODE','','BT')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a>             
        </div>
      </td>
    </tr>
	<tr id="trdark"> 
      ...
      <td align=CENTER width="34%"> 
        <div align="left"> 
         ...
         <a href="javascript:GetCodeDescCNOFC('PROCESSCODE','','PT')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a>             
        </div>
      </td>
    </tr>
