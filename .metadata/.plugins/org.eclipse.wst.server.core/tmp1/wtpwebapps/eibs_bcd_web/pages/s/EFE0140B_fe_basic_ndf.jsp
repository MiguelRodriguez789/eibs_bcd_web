...
%> 
<h3 align="center"> Non Deliverable Forwards (NDF)</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">            
            ...
            <% if(fex.getH01FLGWK3().equals("N")){%>
             <td nowrap colspan="2" > 
              ...
              <a href="javascript:GetClassFex('E01WKFCLS','SWP','<%= fex.getE01WKFCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
             </td>
            <%} else {%>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" >
			  ...
			  >
              <input type="text" name="E01WKFMA3" size="5" maxlength="4" value="<%= fex.getE01WKFMA3()%>" 
			  >
            </td>
            <td nowrap >&nbsp;</td>
            <td nowrap >&nbsp;</td>
