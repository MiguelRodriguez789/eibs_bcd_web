...
<h3 align="center">Detalles del Documento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cancel_ap_det.jsp,EDL0828"></h3>
<hr size="4">
        ...
        <td nowrap>
		 <table  cellspacing="0" cellpadding="2" width="100%" border="0">
		  <tr>
			...
			<td nowrap >
			  <div align="left"> 
        		<input type="text" readonly name="E01DEANR1" size="60" maxlength="60" value="<%= payDoc.getE01DEANR1().trim()%>">
              </div>
			</td>
          </tr>
		  <tr>
			...
			<td nowrap >
			  <div align="left"> 
                <input type="text" readonly name="E01DEANR2" size="60" maxlength="60" value="<%= payDoc.getE01DEANR2().trim()%>">               
              </div>
			</td>
          </tr>
         </table>
