...
<table class="tbenter" align=center height="72%" >
  <TR valign=top height="2%">
    <TD>
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" title="EVL0000_stock_warning_viewer">
	</TD>
 ...
 <TR valign=top height="2%">
	...
	<td nowrap>Realizar Solicitud de Papel Valor, Stock de Oficina en minimo.</td>
 </TR>
