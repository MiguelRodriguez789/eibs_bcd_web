...
<jsp:useBean id= "msgInst" 	class= "datapro.eibs.beans.EPR034001Message"  		scope="session"/>

<% 
//int row = 0;
//try { row = Integer.parseInt(request.getParameter("ROW"));} catch (Exception e) {}
//mtList.setCurrentRow(row);
//datapro.eibs.beans.EPR034001Message msgInst = (datapro.eibs.beans.EPR034001Message) mtList.getRecord();
...
<H3 align="center">Aprobacion/Rechazo de Compraventa de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0340"></H3>
<hr size="4">
