...
<html>
<head>
<title>Eliminacion de documentos papel valor Plazo Fijo</title>
...
<BODY>
<h3 align="center">Eliminacion de documentos papel valor Plazo Fijo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="del_list.jsp, EDL0170"></h3>
<hr size="4">
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
	  <td class=TDBKG width="25%"> 
        <div align="center"><a href="javascript:goDelete(3)"><b>Eliminar</b></a></div>
      </td>      
      <td class=TDBKG width="25%"> 
        <div align="center"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Salir</b></a></div>
      </td>
