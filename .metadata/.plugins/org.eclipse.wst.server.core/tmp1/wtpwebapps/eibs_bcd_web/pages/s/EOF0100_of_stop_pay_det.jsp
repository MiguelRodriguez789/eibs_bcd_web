...
<H3 align="center">Cheques Oficiales - Orden de No Pago
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="of_stop_pay_det.jsp , EOF0100"></H3> 
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">          
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="left"> 
				<eibsinput:date name="stpchk" fn_year="E01STPCKY" fn_month="E01STPCKM" fn_day="E01STPCKD" />
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap>
              <input type="text" name="E01STPBNK" size="3" maxlength="2" value="<%= stpchk.getE01STPBNK()%>" readonly>
              / 
              <input type="text" name="E01STPBRN" size="5" maxlength="4" value="<%= stpchk.getE01STPBRN()%>" readonly>
            </td>
          </tr>
          ...
          <tr id="trdark">
            ...
            <td nowrap>
              <input type="text" name="E01STPGLN" size="17" maxlength="16" value="<%= stpchk.getE01STPGLN()%>" readonly>
            </td>
          </tr>
          ...
          <tr id="trdark">             
            ...
            <td nowrap width="54%" > 
              ...
              <a href="javascript:GetCodeDescCNOFC('E01STPF02','E01DSCCAU','51')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0" ></a>             
