...
<h3 align="center">Tabla de Credito Milagroso<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_table_maint.jsp,EDL0547"></h3>
<hr size="4">
			...
			<td nowrap> 
				<table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
					<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
						...
						<td nowrap width="30%">                
							<SELECT name="E01CMLCON" disabled>
						...
						<td nowrap width="20%" align=right><b>Agencia :&nbsp;</b></td>
						<td nowrap width="30%">
							<eibsinput:text name="lnParam" property="E01CMLBRN" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_BRANCH %>" readonly="true" />
						</td>
					</tr>
				</table>
			</td>
				...
				<table cellspacing="0" cellpadding="2" width="100%" border="0">
					...
					<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
						<td nowrap width="25%"align="center">
							<eibsinput:text name="lnParam" property="E01CMLRTI" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_RATE %>" readonly="<%=!newOnly%>" />
						</td>
						 <td nowrap width="25%"align="center">
							<eibsinput:text name="lnParam" property="E01CMLRTF" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_RATE %>" readonly="<%=!newOnly%>" />
						 </td>
