...
<body>
<h3 align="center">Aprobacion de L&iacute;mites de Aprobaci&oacute;n de Ejecutivos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="params_approv_limits_detail.jsp, EEJ0010"></h3>
<hr size="4">
    ...
    <tr> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            <td nowrap width="40%" align=right>Puntos Persona Física :
            </td>
            <td nowrap width="60%">
          ...
          <tr id="clear"> 
            <td nowrap width="40%" align=right>Montos Persona Física :
            </td>
            <td nowrap width="60%">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%">
              <input type="text" name="E01EJLLD1" size="3" maxlength="2" value="<%= clasific.getE01EJLLM1() %>" readonly>
              <input type="text" name="E01EJLLD2" size="3" maxlength="2" value="<%= clasific.getE01EJLLM2() %>" readonly>
              <input type="text" name="E01EJLLD3" size="5" maxlength="4" value="<%= clasific.getE01EJLLM3() %>" readonly>
              <input type="text" name="E01EJLLDT" size="8" maxlength="6" value="<%= Util.formatCell(clasific.getE01EJLLMT()) %>" readonly>
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="40%" align=right>
            ...
            <td nowrap width="60%">
              <input type="text" name="E01EJLUSR" size="12" maxlength="10" value="<%= clasific.getE01EJLLMU() %>" readonly>
            </td>
          </tr>
        </table>
      </td>
