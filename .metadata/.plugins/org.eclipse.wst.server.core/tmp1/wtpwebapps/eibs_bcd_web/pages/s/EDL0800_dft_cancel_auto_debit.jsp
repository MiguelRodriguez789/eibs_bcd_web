...
<script type="text/javascript">
  function valDates(){
    ...
    var inDate=addLeftChar('0',2,getElement('E10DLASDY').value)+
               addLeftChar('0',2,getElement('E10DLASDD').value)+
               addLeftChar('0',2,getElement('E10DLASDM').value);
               
               
    var endDate=addLeftChar('0',2,getElement('E10DLAMAY').value)+
                addLeftChar('0',2,getElement('E10DLAMAD').value)+
                addLeftChar('0',2,getElement('E10DLAMAM').value);
...
<h3 align="center">Suspensión de Débito Automático<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dft_cancel_auto_debit.jsp, EDL0800"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left">
                <input type="text" name="E10DEAACC" size="13" maxlength="12" value="<%= userPO.getIdentifier().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="61%">
            	<eibsinput:date name="lnAutoDebit" fn_month="E10DLASDM" fn_day="E10DLASDD" fn_year="E10DLASDY" />
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="39%" > 
            ...
            <td width="61%">
            	<eibsinput:date name="lnAutoDebit" fn_month="E10DLAMAM" fn_day="E10DLAMAD" fn_year="E10DLAMAY" />
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="39%" > 
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="25%">
              <input type="text" name="E10DLALDM" size="3" maxlength="2" value="<%= lnAutoDebit.getE10DLALDM().trim()%>" readonly>
              <input type="text" name="E10DLALDD" size="3" maxlength="2" value="<%= lnAutoDebit.getE10DLALDD().trim()%>" readonly>
              <input type="text" name="E10DLALDY" size="5" maxlength="4" value="<%= lnAutoDebit.getE10DLALDY().trim()%>" readonly>
            </td>
          </tr>
         </table>
      </td>
