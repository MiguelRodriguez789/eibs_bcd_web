...
%> 
<h3 align="center">Hist&oacute;rico del Estado del Pr&eacute;stamo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_inq_hist_status.jsp,EDL0160"> 
</h3>
<hr size="4">
            ...
            <TR>               
              <td align=center ><%= OldSts %></td>            	
         	  ...
         	  <%= datapro.eibs.master.Util.formatCustomDate(currUser.getE01DTF(),
         	                                                msgStatus.getBigDecimalE03DLSDTM().intValue(),
         	                                                msgStatus.getBigDecimalE03DLSDTD().intValue(),
         	                                                msgStatus.getBigDecimalE03DLSDTY().intValue())%>
         	  
         	  </td>
    		  <td align=center nowrap><%=Util.formatCell(msgStatus.getE03DLSTIM()) %></td>
