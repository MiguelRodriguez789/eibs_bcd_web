...
<%@ page import = "datapro.eibs.beans.EPC000501Message" %>
...
<h3 align="center">Unidades de Vivienda Asociadas a Proyecto - Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pc_sale_sch.jsp, EPC0005"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" id="INFOCHG">
          ...
          <tr id="trclear"> 
            ...
            <td width="70%"> 
            	<eibsinput:date name="msgPC" fn_month="E01PCDVTM" fn_day="E01PCDVTD" fn_year="E01PCDVTY" required="true" />
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td width="70%"> 
              <input type="text" name="E01PCDNLN" size="13" maxlength="12" value="<%= msgPC.getE01PCDNLN().trim()%>" onkeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E01PCDNLN','','10','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a>
            </td>
          </tr>
