...
<h3 align="center">Abonos Masivos, Proceso Manual - Aprobación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_enter_sch_app,EDL1112"></h3>
<hr size="4">
