          ...
          <tr id="trdark"> 
            <th align=CENTER nowrap width="2%">&nbsp;
             ...
             <th align=CENTER nowrap width="15%"> 
				...
				<INPUT type="text" name="E01IFMFY1" size="5" readonly value="<%=mL0730.getE01IFMFY1().trim()%>">/
            	<INPUT type="text" name="E01IFMFM1" size="3" readonly value="<%=mL0730.getE01IFMFM1().trim()%>">
            	<INPUT type="text" name="E01DPBCR1" size="1" readonly value="<%=mL0730.getE01DPBCR1().trim()%>"></div>
            </th>
             <th align=CENTER nowrap width="15%"> 
            	<div align="center">Periodo<BR>
				<INPUT type="text" name="E01IFMFY2" size="5" readonly value="<%=mL0730.getE01IFMFY2().trim()%>">/
            	<INPUT type="text" name="E01IFMFM2" size="3" readonly value="<%=mL0730.getE01IFMFM2().trim()%>">
