...
<h3 align="center">Ordenes de Pago Mantenimiento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pr_maint.jsp,EDD0670" ></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.transfer.JSEDD0670">
	...
	<INPUT TYPE=HIDDEN NAME="E01PODTYP" id="E01PODTYP" VALUE="<%= prBasic.getE01PODTYP()%>">
    <INPUT TYPE=HIDDEN NAME="E01REFNUM" id="E01REFNUM" VALUE="<%= prBasic.getE01REFNUM()%>">
                ...
                <div id="dataTab8" style="display: none"> 
                  <table width="100%">
                    ...
                    <tr   > 
                      ...
                      <td nowrap> 
                        <input type="text" name="E01POSDBR" size="5" maxlength="4" value="<%= prBasic.getE01POSDBR()%>"
                    ...
                    <tr id="trclear" > 
                      ...
                      <td nowrap> 
                        <input type="text" name="E01POSCBR" size="5" maxlength="4" value="<%= prBasic.getE01POSCBR()%>" 
