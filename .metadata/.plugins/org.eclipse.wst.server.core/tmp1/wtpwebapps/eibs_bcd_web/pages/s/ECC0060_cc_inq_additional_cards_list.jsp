...
<BR>Consulta
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_inq_additional_cards_list.jsp, ECC0060"></h3>
<hr size="4">
              ...
              <td nowrap> 
                <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
                  ...
                  <tr id="trdark"> 
                    ...
                    <td nowrap width="20%"> 
                      <div align="left"> 
                        <input type="text" name="E01CCRCRA" size="13" maxlength="12" value="<%= userPO.getAccNum().trim()%>" readonly>
                      </div>
                    </td>
                    <td nowrap width="16%"> 
      ...
      <tr > 
        ...
        <TR>
	      ...
	      <TD ALIGN=LEFT NOWRAP>
	      	<a href="javascript:getCardInfo('<%= appList.getCurrentRow() %>')"><%= msgPart.getE01CCRNUM() %></a>
	      </TD>
	      <TD ALIGN=CENTER NOWRAP>
	      	<a href="javascript:getCardInfo('<%= appList.getCurrentRow() %>')"><%= Util.formatCell(msgPart.getE01CCRCRA()) %></a>
	      </TD>
	      <TD ALIGN=CENTER NOWRAP>
	      	<%= Util.formatCell(msgPart.getE01CCRTCL()) %>
	      </TD>
		  <TD ALIGN=CENTER NOWRAP><%= Util.formatCustomDate( currUser.getE01DTF(), msgPart.getE01CCRISM(),msgPart.getE01CCRISD(),msgPart.getE01CCRISY()) %></TD>
	      <TD ALIGN=CENTER NOWRAP><%= Util.formatCustomDate( currUser.getE01DTF(), msgPart.getE01CCREXM(),msgPart.getE01CCREXD(),msgPart.getE01CCREXY()) %></TD>
