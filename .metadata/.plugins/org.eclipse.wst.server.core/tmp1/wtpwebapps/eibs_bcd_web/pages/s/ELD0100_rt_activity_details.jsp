...
<h3 align="center"> Consulta de Control de Actividades<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_inquiry, EDL0160"></h3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              ...
              <input type="text" name="E02LDEBDY" size="5" maxlength="4" value="<%= rtLaunder.getE02LDEBDY().trim()%>" readonly>
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
				<eibsinput:date name="rtLaunder" fn_year="E02LSTRDY" fn_month="E02LSTRDM" fn_day="E02LSTRDD" readonly="true"/>
            </td>
            <td nowrap width="26%"> 
              <div align="right">Fecha Ultimo Sobregiro :</div>
            </td>
            <td nowrap width="26%"> 
				<eibsinput:date name="rtLaunder" fn_year="E02LSTDDY" fn_month="E02LSTDDM" fn_day="E02LSTDDD" readonly="true"/>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="26%"> 
              <input type="text" name="E02ACMLDA" size="16" maxlength="15" value="<%= rtLaunder.getE02ACMLDA().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E02LDPVNT" size="10" maxlength="9" value="<%= rtLaunder.getE02LDPVNT().trim()%>" readonly>
            </td>
            <td nowrap width="26%"> 
              <div align="right">Variaci&oacute;n Monto :</div>
            </td>
            <td nowrap width="26%"> 
              <input type="text" name="E02LDPVAM" size="16" maxlength="15" value="<%= rtLaunder.getE02LDPVAM().trim()%>" readonly>
              (%) </td>
          </tr>
        </table>
      </td>
