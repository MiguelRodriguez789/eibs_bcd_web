...
<H3 align="center">C&oacute;digos de Referencia del Sistema - Codigos de Compensacion<img src="<%=request.getContextPath()%>/images/e_ibs.gif"
	align="left" name="EIBS_GIF"
	title="cnof_code_exchange.jsp, ESD0030"></H3>
<hr size="4">
		...
		<td nowrap>
			<table  width="100%" border="0">
				<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
					...
					<td nowrap>
						<div align="left"><input type="text" name="E02CNOCFL" readonly size="3" maxlength="2" value="<%= refCodes.getE02CNOCFL().trim()%>"> </div>
					</td>
				</tr>
	          	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">
					...
					<td nowrap height="23">
						<div align="left">
							<input type="text" name="E02CNORCD" size="4" maxlength="2" value="<%= refCodes.getE02CNORCD().trim()%>">
				...
				<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
	            	<td nowrap width="25%"> 
                   		<div align="right">Codigo Compensacion Nuevo :</div>
    	        	</td>
            		<td nowrap height="19"> 
              			<div align="left">
              			    <input type="text" name="E02CNOAPC" size="5" maxlength="4" value="<%= refCodes.getE02CNOCPC().trim()%>"> 
						</div>
            		</td>
	          	</tr>
			</table>
