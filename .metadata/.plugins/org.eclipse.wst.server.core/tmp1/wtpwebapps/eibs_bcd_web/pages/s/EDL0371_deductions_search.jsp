...
<h3 align="center">Mantenimiento de Deducciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="deductions_search,EDL0371"></h3>
<hr size="4">
