...
<h3>From Office - Transferencias Externas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="front_office_TR_External.jsp,EFO0120"></h3>
</div>
<hr size="4">
				...
				<TR id="trclear">
					...
					<TD height="10" align="left" width="30%">
						<INPUT type="text" name="E02FESTCY" size="4" value="<%= msgCust.getE02FESTCY().trim()%>">
							<a href="javascript:GetCurrency('E02FESTCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0">
							</a> 
				...
				<TR id="trdark">
					...
					<TD height="10" width="25%" align="left">
						<INPUT type="text" name="E02COMTBL" size="3" maxlength="2"
							value="<%= msgCust.getE02COMTBL().trim()%>" onkeypress="enterInteger(event)">
			...
			<TBODY>
				...
				<TR id="trclear">
					...
					<TD height="10" align="left" width="20%"><IMG
						...
						title="obligatorio" align="bottom"></TD>
				...
				<TR id="trdark">
					...
					<TD height="10" align="left" width="30%"><INPUT type="text"
						...
						<img src="<%=request.getContextPath()%>/images/1b.gif" title="Swift" align="middle" border="0">
						</a>
						<a href="javascript:GetAbaAll('E02BNKID','E02BNKAD1','E02BNKAD2','E02BNKAD3','E02BNKAD4')">
						<img src="<%=request.getContextPath()%>/images/1b.gif" title="Código ABA" align="middle" border="0">
						</a>
						<IMG src="<%=request.getContextPath()%>/images/Check.gif" title="obligatorio" align="bottom">
					</TD>
					<TD height="10" align="right" width="20%">
					 Código : </TD>
					<TD height="10" align="left" width="30%">
