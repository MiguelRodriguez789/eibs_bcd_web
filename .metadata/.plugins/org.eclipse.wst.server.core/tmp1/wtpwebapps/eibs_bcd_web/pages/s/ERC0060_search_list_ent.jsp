...
%>
<h3 align="center">Transacciones Pendientes Reconciliaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="search_list_ent.jsp, ERC0060"></h3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark">
	            <td nowrap width="25%"> 
	              ...
	              <input type="text" name="E01RCTFR1" size="3" maxlength="2" value="" onkeypress="enterInteger(event)">
	              <input type="text" name="E01RCTFR2" size="3" maxlength="2" value="" onkeypress="enterInteger(event)">
	              <input type="text" name="E01RCTFR3" size="5" maxlength="4" value="" onkeypress="enterInteger(event)">
	              <a href="javascript:DatePicker(document.forms[0].E01RCTFR1,document.forms[0].E01RCTFR2,document.forms[0].E01RCTFR3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="ayuda" align="middle" border="0"></a> 
	            </td>
	            <td nowrap width="25%"> 
	              ...
	              <input type="text" name="E01RCTTO1" size="3" maxlength="2" value="" onkeypress="enterInteger(event)">
	              <input type="text" name="E01RCTTO2" size="3" maxlength="2" value="" onkeypress="enterInteger(event)">
	              <input type="text" name="E01RCTTO3" size="5" maxlength="4" value="" onkeypress="enterInteger(event)"> 
	              <a href="javascript:DatePicker(document.forms[0].E01RCTTO1,document.forms[0].E01RCTTO2,document.forms[0].E01RCTTO3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="ayuda" align="middle" border="0"></a> 
	            </td>
...
if(request.getParameter("showList")!=null){
	if ( glList.getNoResult() ) {%>
	  ...
	  <TABLE class="tbenter" width="100%" id=cfTable>
				...
				<tr>
					...
					<table cellspacing=0 cellpadding=2 width="100%" border="0">
						...
						<tr id="trdark">
							...
							<td nowrap width="32%"><input type="text" readonly size="20"
								maxlength="16" value="<%=cred%>"></td>
						</tr>
						<tr id="trdark">
							<td nowrap width="32%" align="center"><input id="EIBSBTN"
								type=submit name="cancel" value="Cancelar"></td>
							<td nowrap width="32%" align="center"><input id="EIBSBTN"
		...
		%>
			<div>
				<input align="middle" id="EIBSBTN" type=submit name="Submit" value="Enviar">
			</div>
		<%
			if(request.getAttribute("E01RCTFR1")!=null && request.getAttribute("E01RCTFR2")!=null &&
					request.getAttribute("E01RCTFR3")!=null && request.getAttribute("E01RCTTO1")!=null &&
