...
%> 
<h3 align="center">Estructura de Tasas de Certificados de Deposito  (En Cientos)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_inq_ren_rate, ECN0030"></h3>
<hr size="4">
