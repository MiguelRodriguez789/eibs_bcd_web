...
if (opt == "M") {  
    page = "<%=request.getContextPath()%>/pages/s/EPR0380_foreign_currency_exchange_maint.jsp?";
...
<h3 align="center">Compraventa Moneda Extranjera - Actualizacion Tipo de Cambio<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_list.jsp, EPR0380">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        while (mtList.getNextRow()) {
           datapro.eibs.beans.EPR038001Message msgMT = (datapro.eibs.beans.EPR038001Message) mtList.getRecord();
     	%>               
        <TR>
