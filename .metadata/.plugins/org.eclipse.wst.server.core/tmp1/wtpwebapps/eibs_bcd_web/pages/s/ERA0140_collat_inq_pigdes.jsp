...
<jsp:useBean id="gaBasic" class="datapro.eibs.beans.ERA014001Message"  scope="session" />
...
%>
           de Garantias a Cuentas del Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="collat_inq_pigdes_era0140"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="20%" height="17"> <%= gaBasic.getE01RCLAACC().trim() %>
            </td>
            <td nowrap width="16%" height="17"> 
              <div align="right">Moneda :</div>
            </td>
            <td nowrap width="16%" height="17"> <%= gaBasic.getE01RCLACCY().trim() %>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="16%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> <%= Util.formatCustomDate(currUser.getH01USR(), gaBasic.getE01RCLAODM(),gaBasic.getE01RCLAODD(),gaBasic.getE01RCLAODY())%> </div>
            </td>
            <td nowrap width="16%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> <%= Util.formatCustomDate(currUser.getH01USR(), gaBasic.getE01RCLAMDM(),gaBasic.getE01RCLAMDD(),gaBasic.getE01RCLAMDY())%> </td>
            <td nowrap width="16%"> 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="30%" > <%= Util.formatCustomDate(currUser.getH01USR(), gaBasic.getE01RCLEXPM(),gaBasic.getE01RCLEXPD(),gaBasic.getE01RCLEXPY())%> </td>
            <td nowrap width="22%" > 
