        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="16%" height="23"> 
              <div align="right">C&oacute;digo de la Comuna :</div>
            </td>
            <td nowrap height="23"> 
              <div align="left"> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="16%" height="23"> 
              <div align="right">Descripcion de la Comuna :</div>
            </td>
            <td nowrap height="23"> 
              <div align="left"> 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="16%" height="19"> 
              <div align="right">Codigo Ciudad Referenciada :</div>
            </td>
            <td nowrap height="19"> 
              <div align="left"> 
               <eibsinput:cnofc name="refCodes" flag="84" property="E02CNOUS1" fn_description="E02DSCUS1" required="false"/>
