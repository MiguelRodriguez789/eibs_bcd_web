...
function goAction() {
	...
	page = "${pageContext.request.contextPath}/servlet/datapro.eibs.forex.JSEPR0345?SCREEN=300&ROW=" + + row;
...
<h3 align="center">Compraventa Moneda Extranjera<BR>Aprobacion/Rechazo de Solicitudes de Compraventa<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_list, EPR0345"></h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        while (mtList.getNextRow()) {
           ...
           datapro.eibs.beans.EPR034501Message msgMT = (datapro.eibs.beans.EPR034501Message) mtList.getRecord();
     	%>               
        <TR>
