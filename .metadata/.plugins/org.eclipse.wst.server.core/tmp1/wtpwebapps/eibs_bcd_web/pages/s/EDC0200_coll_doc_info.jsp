...
<H3 ALIGN="center">Control de Documentos Recibidos <IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left"
	NAME="EIBS_GIF" title="coll_doc_info.jsp, EDC0200"></H3>
<HR SIZE="4">
<BR>
...
<TABLE class="tableinfo" id="trclear" cellspacing="0" cellpadding="2" width="100%" border="0" >
				  <TR  id="trdark">
					...
					<TD nowrap>
						<eibsinput:date name="msg01" fn_month="E01DCIRDM" fn_day="E01DCIRDD" fn_year="E01DCIRDY" />
					    <INPUT name="E01DCITIM" value="<%=msg01.getE01DCITIM()%>" size="8" maxlength="8">	
...
<TR>
  ...
  <TR>
    ...
    Pais <INPUT name="E01DCIRB7" value="<%=msg01.getE01DCIRB7()%>" size="4"> <A
			href="javascript:GetCodeCNOFC('E01DCIRB7','03')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom"
			border="0"></A></TD>
  </TR>
</TABLE>
<BR>
