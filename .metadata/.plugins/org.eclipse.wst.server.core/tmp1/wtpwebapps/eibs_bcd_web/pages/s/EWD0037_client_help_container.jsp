<html>
<head>
<title>Búsqueda de Reservas FNG</title>
...
<frameset rows="40%,*" border=0> 
  <frame name="query" src="<%=request.getContextPath()%>/pages/s/EWD0037_client_help_search.jsp" marginwidth=5 marginheight=10 scrolling="no" frameborder="0">
