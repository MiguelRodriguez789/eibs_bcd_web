...
%> 
<h3 align="center">Confirmación Tarjetas de Crédito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_confirm.jsp,ECC0010"></h3> 
<hr size="4">
    ...
    <tr > 
      <td> 
        ...
        <table width="100%">
          ...
          <tr>
            <td width="9%">&nbsp;</td>
            <td width="91%"> con día de apertura : <%= Util.formatCustomDate( currUser.getE01DTF(), ccNew.getE01CCMOPM().trim(),ccNew.getE01CCMOPD().trim(),ccNew.getE01CCMOPY().trim())%> 
               y día de expiración : <%= Util.formatCustomDate( currUser.getE01DTF(), ccNew.getE01CCMEXM().trim(),ccNew.getE01CCMEXD().trim(),ccNew.getE01CCMEXY().trim())%> 
            </td>
          </tr>
          <tr>
            <td width="9%">&nbsp;</td>
