...
<H3 align="center">Mantenimiento de Timbres Fiscales <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="branch_maintenance.jsp, ETX0100"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01TXBBNK" size="3" maxlength="2"  value="<%= brnDetails.getE01TXBBNK().trim()%>" onKeypress="enterInteger(event)" >
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"><font face="Arial"><font face="Arial"><font size="2"> 
                <input type="text" name="E01TXBBRN" size="5"  maxlength="4" value="<%= brnDetails.getE01TXBBRN().trim()%>" onKeypress="enterInteger(event)">
                <a href="javascript:GetBranch('E01TXBBRN',document.forms[0].E01TXBBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
                </font></font></font></div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"><font face="Arial"><font face="Arial"><font size="2"> 
                ...
                <A href="javascript:GetCodeDescCNOFC('E01TXBCDE','E01TXBCDE','YV')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></A>
                </font></font></font></div>
            </td>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <input type="text" name="E01TXBPBK" size="3" maxlength="2" value="<%= brnDetails.getE01TXBPBK().trim()%>" onKeypress="enterInteger(event)"> 
            &nbsp;
            <INPUT type="text" name="E01TXBPBR" size="5" maxlength="4" value="<%= brnDetails.getE01TXBPBR().trim()%>" onKeypress="enterInteger(event)">
            <a href="javascript:GetBranch('E01TXBPBR',document.forms[0].E01TXBPBK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
            &nbsp;
		    ...
		    &nbsp;
		    <INPUT type="text" name="E01TXBPAC" size="13" maxlength="12" value="<%= brnDetails.getE01TXBPAC().trim()%>" onKeypress="enterInteger(event)">
		...
		<td nowrap width="16%" height="19"> 
 		 ...
 		 <tr id="trdark"> 
            ...
            <td nowrap width="40%" height="19"> 
              <input type="text" name="E01TXBCOR" size="10" maxlength="9" value="<%= brnDetails.getE01TXBCOR().trim()%>" onKeypress="enterInteger(event)">
              <input type="text" name="E01REQCON" readonly size="35" maxlength="35" value="<%= brnDetails.getE01REQCON().trim()%>" readonly>
            <a href="javascript:GetCorrespondentDescId('E01TXBCOR','E01REQCON','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>		
			</td>
			<td nowrap width="16%" height="19"> 
			<div align="right"> </div>
			</td>
