...
%> 
<h3 align="center"> Forward Rates Agreements - Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fra_basic.jsp,ETR0120T"> 
</h3>
<hr size="4">
