...
<body>
<h3 align="center">Consulta de Asignaciones<BR>Detalle - Tarjeta Adicional<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="assignment_inq_card2.jsp, ECC0090"></h3>
<hr size="4">
<% 
						...
						<TBODY>
							...
							<TR id="trclear">
								...
								<TD nowrap align="left"><INPUT type="radio" name="CC_Main"
									...
									src="<%=request.getContextPath()%>/images/cone.gif" title="main"
