...
<h3 align="center"> Consulta Aprobacion Rango de Tolerancia <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rango_approval_inq.jsp,EFE0130A"> 
</h3>
<hr size="4">
