	...
	function goAction(op) {
    	...
    	if (op == "D") {
    		if (document.forms[0].actRowCancel.value == 'Y'){
    			...
    			if (confirm("La orden seleccionada sera cancelada")) {
    				document.forms[0].submit();
    			}
    		}
    	} else {  
    		if (op == "N" || op == "M" || op == "I" || op == "S") { 
...
<h3 align="center">Mantenimiento de Ordenes de Pago
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pr_list.jsp, EPR2000"></h3>
<hr size="4">
...
%>
  ...
  <TABLE class="tbenter">
    <TR>
      ...
      <TD class="TDBKG" width="16%">
  		<a href="javascript:goAction('I')">Consultar</a>
      </TD>
      <TD class="TDBKG" width="16%">
  		<a href="javascript:goAction('S')">Consultar<br>Transacciones</a>
      </TD>  
      <TD class="TDBKG" width="16%">
  		<a href="javascript:checkClose()">Salir</a>
      </TD>
    ...
    <%
       ...
       %>             
          ...
          <td align="center" nowrap > 
        	<input type="radio" name="ROW" value="<%= prList.getCurrentRow() %>" onClick="setInfo(<%= prList.getCurrentRow() + 2 %>,'<%= msgList.getE01PRPFL3()%>')">
      	  </td>
