...
<h3 align="center">Compraventa Moneda Extranjera-Actualizacion de Comisiones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_list.jsp, EPR0320">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01COMACT())%></TD>
