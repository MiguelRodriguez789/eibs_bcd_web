...
<jsp:useBean id="fra" class="datapro.eibs.beans.ETR0170DSMessage"  scope="session" />
...
%> 
<h3 align="center"> Forward Rates Agreements <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_fra_basic.jsp,ETR0170"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap>
			  <%= fra.getE01FRALCU().trim()%>
			  &nbsp;/&nbsp;
              <%= fra.getE01FRACMM().trim()%>			
