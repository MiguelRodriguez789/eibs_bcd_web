...
<H3 align="center">Tabla de Gastos y Comisiones de Corresponsal<IMG
	...
	name="EIBS_GIF" title="ELC0600_sc_corresp_basic"></H3>
<HR size="4">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trdark">
            ...
            <TD nowrap ><input type="text" name="E01CUSNME" size="45" maxlength="45" value="<%= msg01.getE01CUSNME().trim()%>" readonly></TD>
    </TR>
          <TR id="trclear">
        ...
        <IMG src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></A> </TD>
            <TD align="right" nowrap  ><b>Descripción de Tabla:</b></TD>
            <TD nowrap ><input type="text" name="E01RLCDSC" size="45" maxlength="45" value="<%= msg01.getE01RLCDSC().trim()%>" ></TD>
          </TR>
</TABLE>
...
<BR>
	<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
			<TR id="trdark">
				...
				<TD nowrap width="143">
					<INPUT type="text" name="E01CPYCUN" size="10" maxlength="9" value="">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
		<TR id="trdark">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text" name="E01RLCCG1" size="18"
				...
				<TD nowrap width="234">
				<DIV align="center"><INPUT type="text" name="E01RLCCD1" size="60" maxlength="60" value="<%= msg01.getE01RLCCD1().trim()%>" readonly></DIV>
				</TD>
			</TR>
			<TR id="trdark">
				<TD nowrap width="178">
