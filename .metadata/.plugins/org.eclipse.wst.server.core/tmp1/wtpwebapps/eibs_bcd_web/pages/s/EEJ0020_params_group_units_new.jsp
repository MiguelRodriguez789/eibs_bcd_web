...
<H3 align="center">Creacion de Unidades de Agrupaci&oacute;n de Ejecutivos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="params_group_units_new,EEJ0020"></H3>
<hr size="4">
    	...
    	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetOfficer('E01EJUEJE')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
     	...
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E01EJUTYP','E01EJUTYN','Y0')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
      	  </td>     
      	</tr>
      	<tr id=trdark> 
	      ...
	      <td nowrap>
      	    ...
      	    <a href="javascript:GetCodeDescCNOFC('E01EJUCDE','E01EJUCDN',document.forms[0].E01EJUTYP.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
      	    <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
      	  </td>
     	</tr>
     </table>
