...
%> 
<h3 align="center"> Portafolio - Orden de Compra / Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_basic_bonds.jsp, EIV0301"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="29%" > 
              <input type="text" name="E01IVSBRK" size="5" maxlength="4" value="<%= inv.getE01IVSBRK()%>" readonly>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              ...
              <input type="text" name="E01IVSLPY" size="5" maxlength="4" value="<%= inv.getE01IVSLPY()%>" >
            </td>
            <td nowrap > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              ...
              <input type="text" name="E01IVSLIY" size="5" maxlength="4" value="<%= inv.getE01IVSLIY()%>" >
            </td>
            <td nowrap > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              ...
              <input type="text" name="E01IVSINY" size="5" maxlength="4" value="<%= inv.getE01IVSINY()%>" >
            </td>
            <td nowrap > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01IVSRBK" id="E01IVSRBK" size="2" maxlength="2" value="<%= inv.getE01IVSRBK()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01IVSRBR" size="4" maxlength="4"
                class="context-menu-help" onmousedown="init(branchHelp,this.name,document.getElementById('E01IVSRBK').value,'','','','')" value="<%= inv.getE01IVSRBR()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01IVSRCY" id="E01IVSRCY" size="3" maxlength="3" value="<%= inv.getE01IVSRCY()%>"
                class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.getElementById('E01IVSRBK').value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01IVSRGL" size="17" maxlength="16" value="<%= inv.getE01IVSRGL()%>" 
				class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.getElementById('E01IVSRBK').value,document.getElementById('E01IVSRCY').value,'','','')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E01IVSRAC" size="13" maxlength="12" value="<%= inv.getE01IVSRAC()%>"
                class="context-menu-help" onmousedown="init(accountHelp,this.name,document.getElementById('E01IVSRBK').value,'','','','RT')" >
              </div>
            </td>
          </tr>
        </table>
