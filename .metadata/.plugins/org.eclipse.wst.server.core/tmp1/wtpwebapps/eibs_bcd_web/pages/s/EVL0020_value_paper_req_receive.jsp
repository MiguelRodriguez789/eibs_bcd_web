...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_req_receive.jsp,EVL0020">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE02REQASU()) + "<br>" +  Util.formatDate(msgMT.getE02REQAD1(),msgMT.getE02REQAD2(),msgMT.getE02REQAD3()) + "<br>" + Util.formatCell(msgMT.getE02REQAST()) %></TD>
