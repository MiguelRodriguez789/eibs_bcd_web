...
<body>
<h3 align="center">Tarjeta Adicional<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_aditional_card.jsp,ECC0060"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01PRICUN" size="10" maxlength="9" readonly value="<%= userPO.getCusNum().trim()%>">
			  </div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" readonly name="E01CCRCRA" size="13" maxlength="12" value="<%= userPO.getAccNum().trim() %>">
              </div>
            </td>
            <td nowrap width="16%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                ...
                <a href="javascript:GetCustomerDescId('E01SECCUN','E01SECNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
			  </div>
            </td>
            <td nowrap width="16%" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
           <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
				<input type="text" name="E01CCRABA" size="11" maxlength="10" value="<%= appList.getRecord(8).trim()%>" onKeypress="enterInteger(event)"> 
            </td>
            <td nowrap width="25%"> 
              <div align="right"></div>
            </td>
           ...
           <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
				...
				<a href="javascript:GetCodeCreditCard('E01CCRRNS','07')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
            </td>
            <td nowrap width="25%"> 
            ...
            <td nowrap width="27%"> 
			  ...
			  <a href="javascript:GetCodeCreditCard('E01CCRACD','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>               
 			</td>
          </tr>     
           <tr id="trclear"> 
            <td nowrap width="25%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
				...
				<a href="javascript:GetCodeCreditCard('E01CCRPLA','02')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>               
            </td>
            <td nowrap width="25%"> 
            ...
            <% if(currUser.getE01DTF().equals("YMD")) { %>
              <input type="text" name="E01CCRISY" size="5" maxlength="4" value="<%= appList.getRecord(4).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCRISM" size="2" maxlength="2" value="<%= appList.getRecord(2).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCRISD" size="2" maxlength="2" value="<%= appList.getRecord(3).trim()%>" onkeypress="enterInteger(event)">
              <a href="javascript:DatePicker(document.forms[0].E01CCRISY,document.forms[0].E01CCRISM,document.forms[0].E01CCRISD)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="Ayuda" align="middle" border="0"></a> 
  			<% } else if(currUser.getE01DTF().equals("MDY")) {%>
              <input type="text" name="E01CCRISM" size="2" maxlength="2" value="<%= appList.getRecord(2).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCRISD" size="2" maxlength="2" value="<%= appList.getRecord(3).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCRISY" size="5" maxlength="4" value="<%= appList.getRecord(4).trim()%>" onkeypress="enterInteger(event)">
              <a href="javascript:DatePicker(document.forms[0].E01CCRISM,document.forms[0].E01CCRISD,document.forms[0].E01CCRISY)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="Ayuda" align="middle" border="0"></a> 
  			<% } else { %>
              <input type="text" name="E01CCRISD" size="2" maxlength="2" value="<%= appList.getRecord(3).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCRISM" size="2" maxlength="2" value="<%= appList.getRecord(2).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCRISY" size="5" maxlength="4" value="<%= appList.getRecord(4).trim()%>" onkeypress="enterInteger(event)">
              <a href="javascript:DatePicker(document.forms[0].E01CCRISD,document.forms[0].E01CCRISM,document.forms[0].E01CCRISY)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="Ayuda" align="middle" border="0"></a> 
  			<% } %>
  			</td>
          </tr>   
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
            <% if(currUser.getE01DTF().equals("YMD")) { %>
              <input type="text" name="E01CCREXY" size="5" maxlength="4" value="<%= appList.getRecord(7).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCREXM" size="2" maxlength="2" value="<%= appList.getRecord(5).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCREXD" size="2" maxlength="2" value="<%= appList.getRecord(6).trim()%>" onkeypress="enterInteger(event)">
              <a href="javascript:DatePicker(document.forms[0].E01CCREXY,document.forms[0].E01CCREXM,document.forms[0].E01CCREXD)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="Ayuda" align="middle" border="0"></a> 
  			<% } else if(currUser.getE01DTF().equals("MDY")) {%>
              <input type="text" name="E01CCREXM" size="2" maxlength="2" value="<%= appList.getRecord(5).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCREXD" size="2" maxlength="2" value="<%= appList.getRecord(6).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCREXY" size="5" maxlength="4" value="<%= appList.getRecord(7).trim()%>" onkeypress="enterInteger(event)">
              <a href="javascript:DatePicker(document.forms[0].E01CCREXM,document.forms[0].E01CCREXD,document.forms[0].E01CCREXY)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="Ayuda" align="middle" border="0"></a> 
  			<% } else { %>
              <input type="text" name="E01CCREXD" size="2" maxlength="2" value="<%= appList.getRecord(6).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCREXM" size="2" maxlength="2" value="<%= appList.getRecord(5).trim()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01CCREXY" size="5" maxlength="4" value="<%= appList.getRecord(7).trim()%>" onkeypress="enterInteger(event)">
              <a href="javascript:DatePicker(document.forms[0].E01CCREXD,document.forms[0].E01CCREXM,document.forms[0].E01CCREXY)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="Ayuda" align="middle" border="0"></a> 
  			<% } %>
            </td>
            <td nowrap width="25%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="27%"> 
				...
				<a href="javascript:GetCode('E01CCRPIO','STATIC_pin_offset.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>               
  			</td>
          </tr>  
          <tr id="trdark"> 
            <td nowrap width="25%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
				...
				<a href="javascript:GetCodeCreditCard('E01CCRRNC','10')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
            </td>
            <td nowrap width="25%"> 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
				<input type="text" name="E01CCRFBL" size="10" maxlength="9" value="<%= appList.getRecord(30).trim()%>" onkeypress="enterInteger(event)">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Limite Sobregiro :</div>
            </td>
            <td nowrap width="27%"> 
            	<input type="text" name="E01CCROVL" size="10" maxlength="9" value="<%= appList.getRecord(31).trim()%>" onkeypress="enterInteger(event)">
  			</td>
          </tr>      
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%"> 
				<input type="text" name="E01CCRWHL" size="10" maxlength="9" value="<%= appList.getRecord(32).trim()%>" onkeypress="enterInteger(event)">
            </td>
            <td nowrap width="25%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
				<input type="text" name="E01CCRPWL" size="10" maxlength="9" value="<%= appList.getRecord(41).trim()%>" onkeypress="enterInteger(event)">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Limite de Pago  :</div>
            </td>
            <td nowrap width="27%"> 
            	<input type="text" name="E01CCRBPL" size="10" maxlength="9" value="<%= appList.getRecord(42).trim()%>" onkeypress="enterInteger(event)">
  			</td>
          </tr>   
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%"> 
				<input type="text" name="E01CCRLIM" size="10" maxlength="9" value="<%= appList.getRecord(43).trim()%>" onkeypress="enterInteger(event)">
            </td>
            <td nowrap width="25%"> 
              <div align="right"></div>
            </td>
