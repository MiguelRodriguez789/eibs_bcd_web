...
<table width="161" border="0" align="right" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td nowrap width="61" align="left" height="24" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="1pt" color="#003399">
      <div ID=RunClock></div>
      </font> 
    </td>
    <td nowrap width="100" align="right" height="24" valign="top">
    	<font face="Verdana, Arial, Helvetica, sans-serif" size="1pt" color="#003399">
			<%=Util.formatCustomDate(currUser.getE01DTF(), currUser.getBigDecimalE01RDM().intValue(), currUser.getBigDecimalE01RDD().intValue(), currUser.getBigDecimalE01RDY().intValue())%>
