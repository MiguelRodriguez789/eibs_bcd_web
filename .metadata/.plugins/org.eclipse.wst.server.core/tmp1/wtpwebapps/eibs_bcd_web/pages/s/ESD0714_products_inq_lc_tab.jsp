...
<h3 align="center">Consulta de Tarifas de Carta de Cr&eacute;dito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="products_inq_ln.jsp, ESD0711"></h3>
<hr size="4">
    ...
    <tr > 
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
  		...
  		<div align="center"> 
    		<input id="EIBSBTN" type=button name="Submit" OnClick="top.close()" value="Enviar">
  		</div>
