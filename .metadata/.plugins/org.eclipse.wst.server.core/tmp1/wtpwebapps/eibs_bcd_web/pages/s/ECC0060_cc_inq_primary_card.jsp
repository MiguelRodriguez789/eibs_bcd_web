...
function setShowStatus(){
	if( "<%=msgCard.getE01CCRIST()%>" == "A" || "<%=msgCard.getE01CCRIST()%>" == "C" ) {
...
<BR>Consulta
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_inq_primary_card.jsp, ECC0060"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">    
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="16%"> 
              <div align="left"><b> 
                <input type="text" readonly name="E01CCRNUM" size="22" maxlength="20" value="<%= msgCard.getE01CCRNUM().trim()%>">
                </b> </div>
            </td>
          </tr>            
        </table>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">   
           <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
			<INPUT type="text" name="E01CCREXD" readonly size="10" maxlength="10" readonly
			value=<% if(msgCard.getE01CCRIST().equals("I")) out.print("Inactiva");
					else if(msgCard.getE01CCRIST().equals("A")) out.print("Activa"); 
					else out.print(""); 
					%> >
            </td>
            <td nowrap width="25%">
            	<div id="causallabel" style="visibility:hidden;" align="right">Causal :</div>
            </td>
            <td nowrap width="27%">
           		<div id="causalinput" style="visibility:hidden;">
            	<input type="text" name="E01CCRDSC" readonly size="17" maxlength="15" value="<%= msgCard.getE01CCRDSC().trim()%>" >
				</div>
            </td>
          </tr>     
          <tr id="trdark"> 
