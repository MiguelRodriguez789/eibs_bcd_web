    ...
    if (opt == "D") {
	  ...
	  if (ok) document.forms[0].submit();
    	...
    	page = "<%=request.getContextPath()%>/pages/s/ECU0000_bastanteo_customers_maint.jsp?ROW=" + <%= userPO.getHeader4()%>;
  	    ...
  	    page = "<%=request.getContextPath()%>/pages/s/ECU0000_bastanteo_attorney_new.jsp";
  		CenterNamedWindow(page,'Information',650,500,2);
  	}
  }
...
<h3 align="center">Sistema de Bastanteo - Mantenimiento del Propietario/Apoderado
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_attorney_list.jsp,ECU0000">
</h3>
<hr size="4">
...
%> 
  ...
  <TABLE class="tbenter" width=100% height=40%>
      ...
      <TD> 
        <div align="center"> 
          <p>
            <b>No existe registro de apoderado. Haga click en la opcion "Nuevo" para crear un registro. </b>
          </p>          
        </div>
      </TD>
     </TR>
 ...
 <INPUT type="HIDDEN" name="E05CUMMAN" size="2" maxlength="2" value="01" readonly> 
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMTMem.getE05CUMMA3())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMTMem.getE05CUMMA1())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMTMem.getE05CUMAC1(),msgMTMem.getE05CUMAC2(),msgMTMem.getE05CUMAC3())  + " - " + msgMTMem.getE05CUMACT()%></TD>
