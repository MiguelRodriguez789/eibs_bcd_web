...
<% 
 ...
 %>
<h3 align="center">Aprobaci&oacute;n Cierre Masivo de Cuentas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_details_close, EDD1160" ></h3>
<hr size="4">
  ...
  <table class="tableinfo">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap> 
              <input type="text" readonly  name="E01ACMBRN" size="5" maxlength="4" value="<%= close.getE01ACMBRN()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="10%" > 
              <input type="text" readonly  onKeyPress="enterInteger(event)" name="E01PAGOGL" size="16" maxlength="16" value="<%= close.getE01PAGOGL().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="20%" align=right> 
            ...
            <td nowrap> 
              <input type="text" readonly  onKeyPress="enterInteger(event)" name="E01PAGOCN" size="9" maxlength="8" value="<%= close.getE01PAGOCN().trim()%>">
            </td>
          </tr>
        </table>
        </td>
