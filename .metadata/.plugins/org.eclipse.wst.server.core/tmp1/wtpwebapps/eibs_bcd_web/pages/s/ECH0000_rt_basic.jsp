...
<H3 align="center">Personalización de Chequeras<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_basic.jsp, ECH0000"></H3>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01CHPCUN" size="10" maxlength="9" value="<%= rtBasic.getE01CHPCUN().trim()%>">
			</div>
            </td>
            <td nowrap width="16%" > 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
			...
			<a href="javascript:GetBranchCodeName('E01CHPDBR','DESNJMOET','01')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"  ></a>
			</td>
          </tr>
