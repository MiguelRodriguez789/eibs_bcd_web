...
<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" title="ELC0560_lc_negotiation_acp.jsp" name="EIBS_GIF"></H3>
<HR size="4">
...
<TABLE CLASS="tableinfo" CELLSPACING="0" CELLPADDING="2" WIDTH="100%" BORDER="0">
	...
	<TR id="trclear">
		...
		<TD width="61" height="24" align="center" valign="top" nowrap>
	 		<INPUT type="text" name="E01CUSBRN" size="6" maxlength="4" value="<%= msg01.getE01CUSBRN()%>" class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E01CUSBNK.value,'','','','')" onkeypress="enterInteger(event)"></TD>
	  ...
	  <INPUT type="text" name="E01CUSACC" size="18" maxlength="12" value="<%= msg01.getE01CUSACC()%>" class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E01CUSBNK.value,'','','','')"></TD>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
         ...
         <TR id="trclear">
           <TD width="230" height="24" align="left" valign="top" nowrap>
			<INPUT type="text" name="E01CONDCO" value="<%=msg01.getE01CONDCO()%>" size="4" maxlength="2">
             <INPUT type="text" name="E01CONDCB" size="25" maxlength="25" value="<%=msg01.getE01CONDCB()%>"
				class="context-menu-help" onmousedown="init(conceptHelp,'E01CONCDD','','40','E01DEBGL2','E01CONDCO',''); return false;"></TD>
           ...
           <TD nowrap valign="top" height="24" align="center" width="61">
			<INPUT type="text" name="E01DEBBR2" size="6" maxlength="4" value="<%=msg01.getE01DEBBR2()%>" class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E01DEBBK2.value,'','','','')" onkeypress="enterInteger(event)"></TD>
           ...
           <TD nowrap align="center" valign="top" height="24" width="132">
			<INPUT type="text" name="E01DEBAC2" size="18" maxlength="12" value="<%=msg01.getE01DEBAC2()%>" class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E01DEBBK2.value,'','','','')"></TD>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
		...
		<TR id="trclear">
			...
			<TD nowrap valign="top" height="24" align="center" width="61">
				<INPUT type="text" name="E01PMTBRN" size="6" maxlength="4" value="<%= msg01.getE01PMTBRN()%>" class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E01PMTBNK.value,'','','','')" onkeypress="enterInteger(event)"></TD>
			<TD nowrap align="center" valign="top" height="24" width="47">
			...
			<TD nowrap align="center" valign="top" height="24" width="132">
				<INPUT type="text" name="E01PMTACC" size="18" maxlength="12" value="<%= msg01.getE01PMTACC()%>" class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E01PMTBNK.value,'','','','')"></TD>
			<TD nowrap align="center" valign="top" height="24" width="114">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <TR id="trclear">
    ...
    <TD nowrap valign="top" height="24" align="center" width="61">
		<INPUT type="text" name="E01CRPBRN" size="6" maxlength="4" value="<%=msg01.getE01CRPBRN()%>" class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')" onkeypress="enterInteger(event)"></TD>
    <TD nowrap align="center" valign="top" height="24" width="47">
    ...
    <TD nowrap align="center" valign="top" height="24" width="132">
		<INPUT type="text" name="E01CRPACC" size="18" maxlength="12" value="<%=msg01.getE01CRPACC()%>" class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')"></TD>
    <TD nowrap align="center" valign="top" height="24" width="114">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<TR id="<%out.print((i%2==0 ? "trdark" : "trclear"));%>">
		<TD nowrap align="left" valign="top" height="24">Fecha de Aceptacion:</TD>
		<TD nowrap align="left" valign="top" height="24">
		<INPUT name="E01DRFDTM" value="<%=msg01.getE01DRFDTM()%>" size="3" maxlength="2" >
		<INPUT name="E01DRFDTD" value="<%=msg01.getE01DRFDTD()%>" size="3" maxlength="2" >
		<INPUT name="E01DRFDTY" value="<%=msg01.getE01DRFDTY()%>" size="5" maxlength="4" >
		</TD>
		<TD nowrap align="left" valign="top" height="24" width="170">Fecha Valor:</TD>
		<TD nowrap align="left" valign="top" height="24" width="160">
		<INPUT name="E01VALDTM" value="<%=msg01.getE01VALDTM()%>" size="3" maxlength="2" >
		<INPUT name="E01VALDTD" value="<%=msg01.getE01VALDTD()%>" size="3" maxlength="2" >
		<INPUT name="E01VALDTY" value="<%=msg01.getE01VALDTY()%>" size="5" maxlength="4" >
		</TD>
	</TR>
	<TR>
		<TD nowrap align="left" valign="top" height="24">Plazo (Nro. de Dias):</TD>
		<TD nowrap align="left" valign="top" height="24">
		<INPUT name="E01NUMDYS" value="<%=msg01.getE01NUMDYS()%>" size="4" maxlength="4" ></TD>
		<TD nowrap align="left" valign="top" height="24" width="170">Fecha de Vencimiento</TD>
		<TD nowrap align="left" valign="top" height="24" width="160">
		<INPUT name="E01MATDTM" value="<%=msg01.getE01MATDTM()%>" size="3" maxlength="2" >
		<INPUT name="E01MATDTD" value="<%=msg01.getE01MATDTD()%>" size="3" maxlength="2" >
		<INPUT name="E01MATDTY" value="<%=msg01.getE01MATDTY()%>" size="5" maxlength="4" ></TD>
	</TR>
	<TR>
		<TD nowrap align="left" valign="top" height="24">Codigo de Producto</TD>
		<TD nowrap align="left" valign="top" height="24">
		<INPUT name="E01NEWPRO" value="<%=msg01.getE01NEWPRO()%>" size="4" maxlength="4" ></TD>
		<TD nowrap align="left" valign="top" height="24" width="170">Base Anual</TD>
		<TD nowrap align="left" valign="top" height="24" width="160">
...
<TR id='<%= (counter++ %2 == 0 ? "trclear" : "trdark") %>'>
	...
	<TR id='<%= (counter++ %2 == 0 ? "trclear" : "trdark") %>'>
		...
		<TD align="center"><SELECT name="E01ACCPBY">
			...
			<OPTION value="W" <%if(msg01.getE01ACCPBY().equals("W")) out.print("selected");%>>Condonar</OPTION>
			...
			<OPTION value="W" <%if(msg01.getE01ACCCPB().equals("W")) out.print("selected");%>>Condonar</OPTION>
			</SELECT></TD>
