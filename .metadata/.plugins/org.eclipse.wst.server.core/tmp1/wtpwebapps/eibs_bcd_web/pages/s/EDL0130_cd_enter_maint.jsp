...
<h3 align="center">Mantenimiento de Certificados de Depósitos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_enter_maint, EDL0130"></h3>
<hr size="4">
