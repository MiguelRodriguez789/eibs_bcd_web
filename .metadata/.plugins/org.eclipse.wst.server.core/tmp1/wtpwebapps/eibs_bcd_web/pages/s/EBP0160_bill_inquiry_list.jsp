...
function goInquiryPayment() {
	isCheck();
	if (!ok) {
		alert("Por Favor Seleccione un Factura!");
		return;	 
	}
    pg = "<%=request.getContextPath()%>/servlet/datapro.eibs.bap.JSEBP0162?SCREEN=1&DOCUMENTO=" + document.getElementById("E01BPBNUM").value;
...
<h3 align="center"> Consulta Facturas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="bill_inqury_list.jsp, EBP0160"></h3>
<hr size="4">
...
%>    
  <TABLE class="tbenter"> 
		<TR>
			...
			<TD align="CENTER" class="TDBKG" width="33%">
				<a href="javascript:goInquiryPayment()"><b>Consulta<br>Pagos</b></a>
      		</TD>
	...
	<TABLE class="tableinfo" id="dataTable">
    	<TR id=trdark> 
			...
			<td NOWRAP align="center" width="10%"><B>Estado<BR>Factura</B></td>
		</TR>
    	<TR id=trdark>
			<td NOWRAP align="center" width="5%"></td>
			<td NOWRAP align="center" width="5%">
				<INPUT type="text" id="SEARCHCDE" name="SEARCHCDE" size="10" maxlength="" value="<%= userPO.getProdCode() %>">
					<IMG src="<%=request.getContextPath()%>/images/ico5.gif" onclick="goSearch()" width="15" height="11"
				 	title="Orden y posició en...">
			</td>
    	...
    	<TR id=trclear>
			...
			<td NOWRAP align="left" width="5%" ><%= datapro.eibs.master.Util.formatCustomDate( currUser.getE01DTF(), msgList.getE01BPBPDM(),msgList.getE01BPBPDD(),msgList.getE01BPBPDY())%></td>
			...
			<td NOWRAP align="left" width="10%" ><%= msgList.getE01BPBSTD() %></td>
		</TR>
       <% 
       	 i++; 
        } 
