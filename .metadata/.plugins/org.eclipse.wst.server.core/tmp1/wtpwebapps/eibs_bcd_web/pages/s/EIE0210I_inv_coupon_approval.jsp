...
%>
<div align="center"> 
  <h3>Consulta Pago de Cupones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="inv_coupon_approval.jsp,EIE0210I"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="7" > 
              <input type="text" readonly  name="D01CSTCOD" size="5" maxlength="4" value="<%= invTrade.getD01CSTCOD()%>" >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="E01CPNCBK" id="E01CPNCBK" size="2" maxlength="2" value="<%= invTrade.getE01CPNCBK()%>">
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="E01CPNCBR" size="4" maxlength="4" value="<%= invTrade.getE01CPNCBR()%>"
                class="context-menu-help" onmousedown="init(branchHelp,this.name,document.getElementById('E01CPNCBK').value,'','','','')">
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="E01CPNCCY" id="E01CPNCCY"  size="3" maxlength="3" value="<%= invTrade.getE01CPNCCY()%>"
                class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.getElementById('E01CPNCBK').value,'','','','')">
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="E01CPNCGL" size="17" maxlength="16" value="<%= invTrade.getE01CPNCGL()%>"
				class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.getElementById('E01CPNCBK').value,document.getElementById('E01CPNCCY').value,'','','')"  >
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="E01CPNCAC" size="13" maxlength="12" value="<%= invTrade.getE01CPNCAC()%>"
                class="context-menu-help" onmousedown="init(accountHelp,this.name,document.getElementById('E01CPNCBK').value,'','','','RT')" >
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="E01CPNCCC" size="9" maxlength="8" value="<%= invTrade.getE01CPNCCC()%>"
                class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.getElementById('E01CPNCBK').value,'','','','')" >
              </div>
            </td>
          </tr>
        </table>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="D01ORDIBK" id="D01ORDIBK" size="2" maxlength="2" value="<%= invTrade.getD01ORDIBK()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="D01ORDIBR" size="4" maxlength="4" value="<%= invTrade.getD01ORDIBR()%>"
                class="context-menu-help" onmousedown="init(branchHelp,this.name,document.getElementById('D01ORDIBK').value,'','','','')">
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="D01ORDICY" id="D01ORDICY" size="3" maxlength="3" value="<%= invTrade.getD01ORDICY()%>"
                class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.getElementById('D01ORDIBK').value,'','','','')">
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="D01ORDIGL" size="17" maxlength="16" value="<%= invTrade.getD01ORDIGL()%>"
				class="context-menu-help" onmousedown="init(ledgerHelp,this.name,document.getElementById('D01ORDIBK').value,document.getElementById('D01ORDICY').value,'','','')"  >
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="D01ORDIAC" size="13" maxlength="12" value="<%= invTrade.getD01ORDIAC()%>"
                class="context-menu-help" onmousedown="init(accountHelp,this.name,document.getElementById('D01ORDIBK').value,'','','','RT')" >
              </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                <input type="text" readonly  name="D01ORDICC" size="9" maxlength="8" value="<%= invTrade.getD01ORDICC()%>"
                class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.getElementById('D01ORDIBK').value,'','','','')" >
              </div>
            </td>
          </tr>
        </table>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="left"> 
                ...
                <input type="text" readonly  name="E01CPNPM3" size="5" maxlength="4" value="<%= invTrade.getE01CPNPM3()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <div align="left"> 
                ...
                <input type="text" readonly  name="E01CPNDL3" size="5" maxlength="4" value="<%= invTrade.getE01CPNDL3()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
