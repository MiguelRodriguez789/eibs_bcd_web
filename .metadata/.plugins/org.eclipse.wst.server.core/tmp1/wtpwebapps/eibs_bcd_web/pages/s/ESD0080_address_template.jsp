    ...
    <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <INPUT type="text" name="<%=Pais%>" id="address.PaisDsc" size="21" value="<%=mr.getField(Pais).getString().equals("")?"Venezuela":mr.getField(Pais).getString()%>" <%=READ_ONLY_TAG%> onfocus="clearAdress( this.value );" maxlength="20"> 
              <%if(!readOnly.equals("true")) {%>
                 <a href="javascript:GetCodeDescCNOFC('CTRCode','<%=Pais%>','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
		    ...
		    <td nowrap >
		     ...
		     <INPUT type="text" name="<%=RegionDsc%>" id="address.RegionDsc" size="36" value="<%=regionDscValue%>" <%=READ_ONLY_TAG%> maxlength="35">
              <%if(!readOnly.equals("true")) {%>
				<a href="javascript:GetCodeDescCNOFC('<%=Region%>','<%=RegionDsc%>','07')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
                <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" >		
              <%}%>  
			</td>	
		    <TD nowrap >
              ...
              <%if(!readOnly.equals("true")) {%>
			    <a href="javascript:clearMunicipio();GetCodeDescCNOFC('<%=Estado%>','<%=EstadoDsc%>','27')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
                <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" >		
              <%}%>  
			</td>		
		  <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            ...
            <input type="text" 	name="<%=MunicipioDsc%>" size="36" id="address.Municipio.Dsc"  value="<%=municipioDscValue%>" <%=READ_ONLY_TAG%> maxlength="35">
              <%if(!readOnly.equals("true")) {%>
                <a href="javascript:clearParroquia();GetCNOFCFilteredCodes('Aux_Municipio','<%=MunicipioDsc%>',document.getElementById('<%=Estado%>').value,'85')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
                <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" >
              <%}%>
			</td>
            <td nowrap >
            ...
            <input type="text" name="Aux_CTYDsc" id="address.CiudadDsc" size="27" value="<%=ciudadDscValue%>" <%=READ_ONLY_TAG%> maxlength="26">
              <%if(!readOnly.equals("true")) {%>
 				 <a href="javascript:GetCNOFCFilteredCodes('Aux_CTYCode','Aux_CTYDsc',document.getElementById('<%=Estado%>').value,'84')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
                 <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" >		
              <%}%>   
			</td>
			<TD nowrap >
          ...
          <tr id="trclear"> 
            <td nowrap >Codigo Postal/Urbanizacion</td>
        ...
        <td nowrap> 
          <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
			...
			<% } %>
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>NA2" size="36" maxlength="35" value="<%= mr.getField(suffix + "NA2").getString().trim()%>">
                <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" > </td>
            </tr>
            <tr id="teclear"> 
              <td nowrap width="39%"> 
            <%if(currUser.getE01INT().equals("04")){%> 
			...
			<% } %>
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>NA3" size="36" maxlength="35" value="<%= mr.getField(suffix + "NA3").getString().trim()%>">
                </td>
            </tr>
            <tr id="trdark"> 
              <td nowrap width="39%"> 
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>NA4" size="36" maxlength="35" value="<%= mr.getField(suffix + "NA4").getString().trim()%>">
                </td>
            </tr>
           <%if(currUser.getE01INT().equals("18")){%> 
            <tr id="teclear"> 
              ...
              <input type="text" name="<%= suffix %>UC7" size="5" maxlength="4" value="<%= mr.getField(suffix + "UC7").getString().trim()%>">
              <a href="javascript:GetCodeCNOFC('<%= suffix %>UC7','84')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" ></td>
            </tr>
            <tr id="trdark"> 
              <td nowrap width="39%"> 
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>UC8" size="5" maxlength="4" value="<%= mr.getField(suffix + "STE").getString().trim()%>">
              <a href="javascript:GetCodeCNOFC('<%= suffix %>UC8','80')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" ></td>
            </tr>
            <%} else {%>           
            <tr id="teclear"> 
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>CTY" size="31" maxlength="30" value="<%= mr.getField(suffix + "CTY").getString().trim()%>">
                <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" ></td>
            </tr>
            <tr id="trdark"> 
              <td nowrap width="39%"> 
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>STE" size="5" maxlength="4" value="<%= mr.getField(suffix + "STE").getString().trim()%>">
                <a href="javascript:GetCodeCNOFC('<%= suffix %>STE','27')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
                <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" ></td>
            </tr>
            <%}%>
            <tr id="teclear"> 
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>CTR" size="21" maxlength="20" value="<%= mr.getField(suffix + "CTR").getString().trim()%>">
              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom"> 
            </td>
            </tr>
            <tr id="trdark"> 
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>POB" size="11" maxlength="10" value="<%= mr.getField(suffix + "POB").getString().trim()%>">
                </td>
            </tr>
            <tr id="teclear"> 
              <td nowrap width="39%"> 
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>ZPC" size="16" maxlength="15" value="<%= mr.getField(suffix + "ZPC").getString().trim()%>">
                </td>
            </tr>
            <tr id="trdark"> 
              <td nowrap width="39%"> 
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>MLC" size="5" maxlength="4" value="<%= mr.getField(suffix + "MLC").getString().trim()%>">
                </td>
            </tr>
            <tr id="teclear"> 
              <td nowrap width="39%"> 
              ...
              <td nowrap width="61%">  
                <input type="text" name="<%= suffix %>IAD" size="41" maxlength="40" value="<%= mr.getField(suffix + "IAD").getString().trim()%>">
                </td>
            </tr>
          </table>
        </td>
