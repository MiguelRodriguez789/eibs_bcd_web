...
<H3 align="center">Envio de Remesas de Efectivo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transf_snd_detail,EFE0510"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
        ...
        <tr id=trdark>
          ...
          <td nowrap>
             <input type="text" name="E02REMPOR" value="<%= msgMT.getE02REMPOR() %>" onkeypress="enterInteger(event)">             
          </td>
        </tr>
        <tr id=trdark>
          <td nowrap>
          ...
          <td nowrap>
             <input type="text" name="E02REMPLO" value="<%= msgMT.getE02REMPLO() %>" onkeypress="enterInteger(event)">             
          </td>
        </tr>
     </table>
    </td>
  ...
  <table cellspacing=0 cellpadding=2 width="100%" border="0">
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ01" value ="<%= msgMT.getE02RESQ01() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ02" value ="<%= msgMT.getE02RESQ02() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ03" value ="<%= msgMT.getE02RESQ03() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ04" value ="<%= msgMT.getE02RESQ04() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ05" value ="<%= msgMT.getE02RESQ05() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ06" value ="<%= msgMT.getE02RESQ06() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ07" value ="<%= msgMT.getE02RESQ07() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ08" value ="<%= msgMT.getE02RESQ08() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ09" value ="<%= msgMT.getE02RESQ09() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ10" value ="<%= msgMT.getE02RESQ10() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ11" value ="<%= msgMT.getE02RESQ11() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ12" value ="<%= msgMT.getE02RESQ12() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ13" value ="<%= msgMT.getE02RESQ13() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ14" value ="<%= msgMT.getE02RESQ14() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ15" value ="<%= msgMT.getE02RESQ15() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ16" value ="<%= msgMT.getE02RESQ16() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ17" value ="<%= msgMT.getE02RESQ17() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ18" value ="<%= msgMT.getE02RESQ18() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trdark> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ19" value ="<%= msgMT.getE02RESQ19() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
     ...
     <tr id=trclear> 	      
		...
		<td> 
      	...
      	<td> 
      	   <input type="text" name="E02RESQ20" value ="<%= msgMT.getE02RESQ20() %>" onkeypress="enterInteger(event)">             
      	</td>
      	<td> 
