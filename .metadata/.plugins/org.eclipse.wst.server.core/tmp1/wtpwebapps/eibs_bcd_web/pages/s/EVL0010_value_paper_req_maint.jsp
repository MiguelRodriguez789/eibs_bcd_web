...
<H3 align="center">Mantenimiento de Pedidos Papel Valor<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_req_maint,EVL0010"></H3>
<hr size="4">
