...
function goAction(op) {
 if (op == 1) {
    ...
    document.forms[0].submit();
 	...
 	if (confirm("Esta seguro que desea borrar la Garantía seleccionada")) {
...
<TABLE class="tbenter">
 ...
 %>
    <TD CLASS="TDBKG" ALIGN=CENTER><a href="javascript:goGaBasic()" >Modificar</a> </TD>
    <TD CLASS="TDBKG"ALIGN=CENTER> <a href="javascript:goAction('2')" >Borrar</a>  </TD>
 <% } %>
