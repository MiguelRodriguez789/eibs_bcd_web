...
<h3 align="center">Suspension Debito Automatico<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_cancel_auto_debit.jsp, EDL0150"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td width="25%">
              <eibsinput:date name="lnAutoDebit"  fn_month="E10DLALDM" fn_day="E10DLALDD" fn_year="E10DLALDY" /> 
            </td>
          </tr>
         </table>
      </td>
