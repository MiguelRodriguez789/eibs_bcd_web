...
<H3 align="center">Creacion de Compañias - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_cias_new,SRV0050"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap width="80%"> 
	        <input type="text" name="E01CNOSCG" size="10" maxlength="9" value="<%= msgCia.getE01CNOSCG() %>" onKeypress="enterInteger(event)">
