...
<SCRIPT type="text/javascript">
  ...
  function setInfo(code,txt) {
    if ( code !== document.forms[0].SELCODE.value ) {
       getElement("div"+document.forms[0].SELCODE.value).style.display="none";
       getElement("div"+code).style.display="";
...
<h3 align="center">Verificacion de Propuesta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_both_enter, EPV5000"></h3>
<hr size="4">
