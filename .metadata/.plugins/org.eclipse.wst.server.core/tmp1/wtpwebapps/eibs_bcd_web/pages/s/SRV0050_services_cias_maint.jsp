...
<H3 align="center">Mantenimiento de Compañias - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_cias_maint,SRV0050"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap width="80%"> 
	        <input type="text" name="E01CNOSCG" size="10" maxlength="9" value="<%= msgMT.getE01CNOSCG() %>" onKeypress="enterInteger(event)">
	        <input type="text" name="E01CIANAM" size="40" maxlength="35" value="<%= msgMT.getE01CIANAM() %>" readonly>
	                    <a href="javascript:GetCustomerDescId('E01CNOSCG','E01CIANAM','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a>
