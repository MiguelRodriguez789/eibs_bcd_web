...
<H3 align="center">Consulta de Remesas de Efectivo en Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="money_transfer_enter_inq,EFE0520"></H3>
<hr size="4">
<p>&nbsp;</p>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  
	      ...
	      <td nowrap> 
	        <input type="text" name="E01REMBNK" size="3" maxlength="2" onKeypress="enterInteger(event)" value="<%= msgMT.getE01REMBNK()%>">
	      </td>
     	</tr>
     	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  
	      <td nowrap width="45 %"> 
	      ...
	      <td nowrap> 
	        ...
	        <a href="javascript:GetBranch('E01REMBRN',document.forms[0].E01REMBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
	      </td>
     	</tr>
     	<tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>">  
		  <td> 
        ...
        <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
          ...
          <td nowrap> 
              <input type="text" name="E01REMFD1" size="3" maxlength="2" value="<%= msgMT.getE01REMFD1()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01REMFD2" size="3" maxlength="2" value="<%= msgMT.getE01REMFD2()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01REMFD3" size="5" maxlength="4" value="<%= msgMT.getE01REMFD3()%>" onkeypress="enterInteger(event)">
              &nbsp; Hasta : &nbsp; 
              <input type="text" name="E01REMTD1" size="3" maxlength="2" value="<%= msgMT.getE01REMTD1()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01REMTD2" size="3" maxlength="2" value="<%= msgMT.getE01REMTD2()%>" onkeypress="enterInteger(event)">
              <input type="text" name="E01REMTD3" size="5" maxlength="4" value="<%= msgMT.getE01REMTD3()%>" onkeypress="enterInteger(event)">               
          </td>
        </tr>
     </table>
    </td>
