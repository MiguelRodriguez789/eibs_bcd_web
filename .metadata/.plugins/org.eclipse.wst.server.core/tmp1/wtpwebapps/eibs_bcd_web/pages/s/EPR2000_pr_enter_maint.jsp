...
<h3 align="center">Mantenimiento de Ordenes de Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="pr_enter_maint.jsp,EPR2000"></h3>
<hr size="4">
  ...
  <table class="tbenter">
    ...
    <tr > 
      ...
      <td nowrap align="center" width="60%"> 
        <div align="left"> 
          <input type="text" name="E01PRPDAC" size="12" maxlength="12" onKeyPress="enterInteger(event)" value="">
          <a href="javascript:GetAccount('E01PRPDAC','','','RM')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a></div>
      </td>
    </tr> 
    ...
    <tr > 
      ...
      <td nowrap align="center" width="60%"> 
        <div align="left"> 
          <input type="text" name="E01PRPNUM" size="9" maxlength="9" onKeyPress="enterInteger(event)" value="">
