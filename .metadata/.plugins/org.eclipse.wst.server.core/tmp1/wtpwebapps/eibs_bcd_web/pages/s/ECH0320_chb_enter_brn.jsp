...
<H3 align="center">Recepci&oacute;n de Chequeras/Talonarios de Proveedores - <% if (userPO.getOption().equals("L")) out.print("Ciclo Largo"); else out.print("Ciclo Corto"); %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chb_enter_brn,ECH0320"></H3>
