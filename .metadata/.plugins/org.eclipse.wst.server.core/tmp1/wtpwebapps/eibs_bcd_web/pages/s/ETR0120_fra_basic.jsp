...
%> 
<h3 align="center"><%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fra_basic.jsp,ETR0120"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0  border="0" width="100%">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              ...
              <a href="javascript:GetCurrency('E01WFRCCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap > 
              <div align="right"> </div>
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
			  ...
			  >
              <input type="text" name="E01WFRDD3" size="5" maxlength="4" value="<%= fra.getE01WFRDD3().trim()%>" 
			  >
              <a href="javascript:DatePicker(document.forms[0].E01WFRDD1,document.forms[0].E01WFRDD2,document.forms[0].E01WFRDD3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a> 
            </td>
            <td nowrap > 
            ...
            <td nowrap > 
			  ...
			  >
              <input type="text" name="E01WFRVD3" size="5" maxlength="4" value="<%= fra.getE01WFRVD3().trim()%>" 
			  >
              <a href="javascript:DatePicker(document.forms[0].E01WFRVD1,document.forms[0].E01WFRVD2,document.forms[0].E01WFRVD3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
            ...
            <td nowrap > 
			  ...
			  >
              <input type="text" name="E01WFRMA3" size="5" maxlength="4" value="<%= fra.getE01WFRMA3().trim()%>" 
			  >
              <a href="javascript:DatePicker(document.forms[0].E01WFRMA1,document.forms[0].E01WFRMA2,document.forms[0].E01WFRMA3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title="help" align="middle" border="0"></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
