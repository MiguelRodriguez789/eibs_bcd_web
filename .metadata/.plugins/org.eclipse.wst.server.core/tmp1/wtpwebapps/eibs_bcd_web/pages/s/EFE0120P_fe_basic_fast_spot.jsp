...
%>
<h3 align="center"><%= sTitle%> <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_fast_spot.jsp,EFE0120P"> 
</h3>
<hr size="4">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="85%" > 
              <div align="left"> 
                ...
                <a href="javascript:GetCustomerDescId('E01FESCUN','D01FESCPL','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
