...
%>
<%if ("".equals(emp)){ %> 
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="detail_inq_approve.jsp, EDL0555"></h3>
	<hr size="4">
<%}%>
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="<%=(row % 2 == 1) ? "trdark" : "trclear"%><%row++;%>"> 
            <td nowrap width="10%" align="right"> Cuenta Remanente : </td>
            <td nowrap width="23%"align="left">
              <eibsinput:text name="datarec" property="E04DLNREM" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_ACCOUNT %>" readonly="true"/>
            </td>
            ...
            <td nowrap width="23%" align="left">    	<% if (datarec.getField("E04DLNSTS").getString().equals("")) {
																			out.print(Util.formatCell("En Proceso"));
																} else if (datarec.getField("E04DLNSTS").getString().equals("A")) {
																			out.print(Util.formatCell("Activo"));	
																} else if (datarec.getField("E04DLNSTS").getString().equals("D")) {
																			out.print(Util.formatCell("Anulado"));	
																} else if (datarec.getField("E04DLNSTS").getString().equals("C")) {
																			out.print(Util.formatCell("Cumplido"));	
																} else if (datarec.getField("E04DLNSTS").getString().equals("I")) {
																			out.print(Util.formatCell("Incumplido"));	
																} else if (datarec.getField("E04DLNSTS").getString().equals("M")) {
																			out.print(Util.formatCell("Incumplido Manual"));	
																} else if (datarec.getField("E04DLNSTS").getString().equals("N")) {
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR1" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD1" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR2" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD2" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPRE" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true"  /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCDE" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true"  /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR3" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD3" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR4" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD4" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR5" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD5" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR6" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD6" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR7" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD7" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR8" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD8" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR9" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD9" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPR0" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCD0" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPRA" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCDA" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPRB" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCDB" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPRF" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true"  /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCDF" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true"  /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPRG" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true"  /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCDG" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true"  /></td>
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNPRH" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_PERCENTAGE %>" readonly="true" /></td>
            <td align="center" width="10%"><eibsinput:text name="datarec" property="E04DLNCDH" eibsType="<%=EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" readonly="true" /></td>
