...
<H3 align="center">Pago/Liquidaci&oacute;n de Cobranzas <%=dcPag.getE01DCMTYP().equals("I") ? "Recibidas" : "Enviadas" %><IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="coll_nego_enter_detail_outgoing.jsp, EDC0060"></H3>
<HR size="4">
