...
%> 
<h3 align="center">Confirmacion Solicitud  a Dispensadora<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_confirm.jsp,ECC0010"></h3> 
<hr size="4">
