...
<h3 align="center">Consulta de Aprobación de Lineas de Credito <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cl_ap_enter_maint, ELN0000"></h3>
<hr>
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter" border=0   width=70% align="center" height="80%">
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=40% align="left" height="24" > 
          <input type=TEXT name="CUSNUM" value="" size=10 maxlength=9>
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=40% align="left" height="28" > 
          <input type=TEXT name="LNENUM" value="" size=5 maxlength=4>
