...
<h3 align="center">Parametros Tablas de Comisiones Transferencias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="enter_param.jsp, EPR4000"></h3>
<hr size="4">
  <br><br><br><br><br><br>
  <table class="tableinfo">
    <tr> 
      ...
      <td valign="middle" align="center" height=33 width="51%"> 
        <div align="left"> 
          <input type="text" name="E01PRCBNK"  size=3 maxlength="2">
        </div>
      </td>
    </tr>
  </table>
