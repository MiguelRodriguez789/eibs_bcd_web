...
<H3 align="center">Consulta de Movimientos de Papel Valor por Oficina<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="value_paper_branch_mov_inq,EVL0070"></H3>
<hr size="4">
<p>&nbsp;</p>
