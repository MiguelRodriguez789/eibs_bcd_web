...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_agent_list.jsp,ECIF090">
</h3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
				<input type="text" name="E02INQRDY" size="5" maxlength="4" value="<%= userPOLevel.getHeader22() %>" readonly> 
