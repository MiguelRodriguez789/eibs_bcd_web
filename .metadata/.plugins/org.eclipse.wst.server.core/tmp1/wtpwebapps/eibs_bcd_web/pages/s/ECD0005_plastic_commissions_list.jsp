...
%>
<BODY>
<h3 align="center">Comisiones de Tarjetas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_commissions_list.jsp, ECD0005"> </h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECD0005" >
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      ...
      <td class=TDBKG> 
        <div align="center"><a href="javascript:goAction(3)"><b>Consultar</b></a></div>
      </td>
      <td class=TDBKG> 
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="30%">Tipo Com.</th>
            <th align=CENTER nowrap width="30%">Factor Cargo</th>
            <th align=CENTER nowrap width="10%"><div align="center">Cargo %</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Monto Com.</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Cuenta Crédito</div></th>
          </tr>
     	<%
        appList.initRow(); 
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE05CDRGLN())%></TD>
		</TR>    		
    	<%}%>    
        </table>
    </table>
