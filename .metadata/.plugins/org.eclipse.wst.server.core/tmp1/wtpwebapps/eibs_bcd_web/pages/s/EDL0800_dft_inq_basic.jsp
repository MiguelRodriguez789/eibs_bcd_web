...
%> 
<h3 align="center"> <%= dftBasic.getE01DSCPRO().trim() %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dft_inq_basic.jsp,EDL0800"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left">
                <input type="text" name="E01DEACUN" size="10" maxlength="9" value="<%= dftBasic.getE01DEACUN() %>" readonly>
                </div>
            </td>
            <td nowrap width="16%" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
            <eibsinput:date name="dftBasic" fn_year="E01DEAODY" fn_month="E01DEAODM" fn_day="E01DEAODD"  readonly="Y" />
		...
		<input type="text" name="E01DEAOAM" <% if (dftBasic.getF01DEAOAM().equals("Y")) out.print("class=\"txtchanged\""); %> size="15" maxlength="15" value="<%= dftBasic.getE01DEAOAM() %>" readonly>
          ...
          <tr id="trdark">
            ...
            <td nowrap width="23%" > 
              ...
              <input type="text" name="E01DEAPIF" <% if (dftBasic.getF01DEAPIF().equals("Y")) out.print("class=\"txtchanged\""); %> size="2" maxlength="1" value="<%= dftBasic.getE01DEAPIF() %>"  readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%" > 
		...
		<input type="text" name="E01DEABCP" <% if (dftBasic.getF01DEABCP().equals("Y")) out.print("class=\"txtchanged\""); %> size="10" maxlength="9" value="<%= dftBasic.getE01DEABCP() %>"  readonly>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAICT" <% if (dftBasic.getF01DEAICT().equals("Y")) out.print("class=\"txtchanged\""); %> size="2" maxlength="1" value="<%= dftBasic.getE01DEAICT() %>" readonly>
              </td>
            <td nowrap width="25%" > 
              <div align="right">Período Base :</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01DEABAS" <% if (dftBasic.getF01DEABAS().equals("Y")) out.print("class=\"txtchanged\""); %> size="4" maxlength="3" value="<%= dftBasic.getE01DEABAS() %>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAIFL" <% if (dftBasic.getF01DEAIFL().equals("Y")) out.print("class=\"txtchanged\""); %> size="2" maxlength="1" value="<%= dftBasic.getE01DEAIFL() %>" readonly> </td>
            <td nowrap width="25%" > 
              <div align="right">Cálculo de Inter&eacute;s Mora:</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01DEAPCL" <% if (dftBasic.getF01DEAPCL().equals("Y")) out.print("class=\"txtchanged\""); %> size="2" maxlength="1" value="<%= dftBasic.getE01DEAPCL() %>"  readonly>
              </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEATLN" <% if (dftBasic.getF01DEATLN().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="2" value="<%= dftBasic.getE01DEATLN() %>" readonly> </td>
            <td nowrap width="25%" > 
              <div align="right">Período de Gracia:</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01DEAGPD" <% if (dftBasic.getF01DEAGPD().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="2" value="<%= dftBasic.getE01DEAGPD() %>"  readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEARTB" <% if (dftBasic.getF01DEARTB().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="2" value="<%= dftBasic.getE01DEARTB() %>" readonly> </td>
            <td nowrap width="25%" > 
              <div align="right">Porcentaje de Retención :</div>
            </td>
            <td nowrap width="27%" >
            <input type="text" name="E01DEAPRP" <% if (dftBasic.getF01DEAPRP().equals("Y")) out.print("class=\"txtchanged\""); %> size="10" maxlength="9" value="<%= dftBasic.getE01DEAPRP() %>" readonly> 
              </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAROR" <% if (dftBasic.getF01DEAROR().equals("Y")) out.print("class=\"txtchanged\""); %> size="10" maxlength="9" value="<%= dftBasic.getE01DEAROR() %>" readonly> </td>
            <td nowrap width="25%" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAICT" size="2" maxlength="1" readonly value="<%= dftBasic.getE01DEAICT() %>" readonly>
              </td>
            <td nowrap width="25%" > 
              <div align="right">Período Base :</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01DEABAS" size="4" maxlength="3" readonly value="<%= dftBasic.getE01DEABAS() %>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAIFL" size="2" maxlength="1" readonly value="<%= dftBasic.getE01DEAIFL() %>" readonly>
            </td>
            <td nowrap width="25%" > 
              <div align="right">Cálculo de Inter&eacute;s Mora :</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01DEAPCL" size="2" maxlength="1" readonly value="<%= dftBasic.getE01DEAPCL() %>" readonly>
              </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEATLN" size="3" maxlength="2" readonly value="<%= dftBasic.getE01DEATLN() %>" readonly>
            </td>
            <td nowrap width="25%" >
              <div align="right">Período de Gracia :</div>
            </td>
            <td nowrap width="27%" > 
              <input type="text" name="E01DEAGPD" size="3" maxlength="2" value="<%= dftBasic.getE01DEAGPD() %>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%" >
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAROR" size="10" maxlength="9" onKeypress="enterSignDecimal(6)" value="<%= dftBasic.getE01DEAROR() %>" readonly> 
            </td>
            ...
            <td nowrap width="27%" >
            	<input type="text" name="E01DEAPRP" size="10" maxlength="9"  onKeypress="enterSignDecimal(6)" value="<%= dftBasic.getE01DEAPRP() %>" readonly>
              </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEARTB" size="3" maxlength="2" readonly value="<%= dftBasic.getE01DEARTB() %>" readonly>
            </td>
            <td nowrap width="25%" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="15%" > 
              <div align="center"> 
                <input type="text" name="E01PAGBNK" <% if (dftBasic.getF01PAGBNK().equals("Y")) out.print("class=\"txtchanged\""); %> size="2" maxlength="2" value="<%= dftBasic.getE01PAGBNK() %>" readonly>
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="center"> 
                <input type="text" name="E01PAGBRN" <% if (dftBasic.getF01PAGBRN().equals("Y")) out.print("class=\"txtchanged\""); %> size="4" maxlength="4" value="<%= dftBasic.getE01PAGBRN() %>" readonly>
			  </div>
            </td>
            <td nowrap width="14%" > 
              <div align="center"> 
                <input type="text" name="E01PAGCCY" <% if (dftBasic.getF01PAGCCY().equals("Y")) out.print("class=\"txtchanged\""); %> size="3" maxlength="3" value="<%= dftBasic.getE01PAGCCY() %>" readonly>
			</div>
            </td>
            <td nowrap width="16%" > 
              <div align="center"> 
                <input type="text" name="E01PAGACC" <% if (dftBasic.getF01PAGACC().equals("Y")) out.print("class=\"txtchanged\""); %> size="12" maxlength="12"  value="<%= dftBasic.getE01PAGACC() %>" readonly>
			  </div>
            </td>
          </tr>
          <tr id="trdark"> 
     	...
     	while (lstAcceptors.getNextRow()) {
         	...
         	%>
				...
				%>
							 ...
							 <TD>
							<div align="center"><%= dftBasic.getE01DEARET().equals("4") ? "Documento" : "Referencia" %></div>
							 </TD>
							 <TD>
							 <div align="center">Vencimiento</div>
							 </TD>
							 <TD>
							 <div align="center">Ejercer Recurso</div>
							 </TD>
							 <TD>
						...
						<TD nowrap>
						<div align="center"><INPUT size="2" type="text" name="STS" value="<%= doc.getE02DLDDLC()%>" readonly></div>
						</TD>
						<TD nowrap>
						<div align="center">
