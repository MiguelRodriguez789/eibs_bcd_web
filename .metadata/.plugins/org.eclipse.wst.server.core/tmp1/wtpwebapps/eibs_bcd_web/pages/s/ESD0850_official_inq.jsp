...
<h3 align="center">Datos del Oficial<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="official_inq.jsp,ESD0850"></h3> 
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E01OFCNME" size="45" value="<%= official.getE01OFCNME().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E01OFCIDN" size="25" value="<%= official.getE01OFCIDN().trim()%>" readonly>
            </td> 
          </tr>
          <tr>
            <td nowrap width="30%"> 
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E01OFCBRN" size="4" value="<%= official.getE01OFCBRN().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E01OFCCCN" size="8" value="<%= official.getE01OFCCCN().trim()%>" readonly>
            </td> 
          </tr>
          <tr>
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <input type="text" name="E01DSCAOF" size="45" value="<%= official.getE01DSCAOF().trim()%>" readonly>
            </td> 
