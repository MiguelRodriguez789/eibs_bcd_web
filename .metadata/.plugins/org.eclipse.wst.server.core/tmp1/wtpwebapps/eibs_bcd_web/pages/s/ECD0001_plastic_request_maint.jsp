...
<BR>Mantenimiento
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="plastic_request_maint.jsp, ECD0001"> 
</h3>
<hr size="4">
<% 
  ...
  <table class="tableinfo">
	...
	<% if(msgCD.getE01CDRSTS().equals("10")){ %>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E01CDRQTY" size="8" maxlength="7" value="<%= msgCD.getE01CDRQTY() %>" onKeypress="enterInteger(event)">
              </div>
            </td>
            <td nowrap width="16%" > 
	      ...
	      <tr id="trclear"> 
	        ...
	        <td align=CENTER width="34%"> 
	          <div align="left"> 
	            ...
	            <input type="text" name="E01CDRYEX"  size="5" maxlength="4" value="<%= msgCD.getE01CDRYEX() %>">
	            (Mes/A&ntilde;o) 
	          </div>
	        </td>
		...
		<% } else if (msgCD.getE01CDRSTS().equals("11")) {	%>          
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01CDRREQ" size="15" maxlength="13" value="<%= msgCD.getE01CDRREQ() %>" onKeypress="enterInteger(event)">
			  </div>
            </td>
          </tr>
	      <tr id="trclear"> 
