...
{
	page = "${pageContext.request.contextPath}/servlet/datapro.eibs.products.JSEDL0105I?SCREEN=400&E01DEAACC=" + ref;
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0130">
  ...
  <h3 align="center">Cancelación - Renovación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cancel_renov_list, EWD0334"> 
  </h3>
<hr size="4">
