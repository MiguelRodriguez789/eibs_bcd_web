...
<body>
 ...
 <h3 align="center">Generar Archivo Saliente de ACH<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="incoming_file, EACH410"></h3>
<hr size="4">
	...
	<table  class="tbenter" width="100%" height="50%" border="0" cellspacing=0 cellpadding=2>
		<tr>
     		<td align="center">
				...
				con fechas anteriores o iguales a <%= datapro.eibs.master.Util.formatCustomDate(currUser.getE01DTF(), currUser.getE01RDM(),currUser.getE01RDD(),currUser.getE01RDY())%>.<br>
				<BR><BR>
        		...
        		<table cellspacing="0" width="100%" border="0">
          			<tr id="trdark"> 
            			...
            			<td nowrap align="left" width="70%">
							<INPUT type="text" id="E01DATA" name="E01DATA" size="4"  maxlength="3" value="">
							<A href="javascript:GetAchClass('E01DATA','E01ECDDSC')">
							<IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"> ALL = Todas</A> 
