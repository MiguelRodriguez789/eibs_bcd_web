...
<h3 align="center"> Ajuste Transacciones Reconciliaci&oacute;n Bancaria <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="adjust_search_criteria.jsp,ERC0060"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="32%">
              <input type="text" name="E01RCTGLN" size="20" maxlength="16" onKeypress="enterInteger(event)">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="32%">
              <input type="text" name="E01RCTACC" size="12" maxlength="12" onKeypress="enterInteger(event)">
              <a href="javascript:GetAccount('E01RCTACC','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="bottom" border="0" ></a> 
              </td>
          </tr>
        </table>
      </td>
