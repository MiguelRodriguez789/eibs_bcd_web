...
<script type="text/javascript">
   ...
   function goAction(refnum) {
     ...
     page = "${pageContext.request.contextPath}/servlet/datapro.eibs.transfer.JSEWD0341F?SCREEN=3&REFNUM="+refnum;
...
<BODY onLoad="">
<h3 align="center">Listado de Transferencias <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="swift_list.jsp, EWD0341"></h3>
<hr size="4">
<%
