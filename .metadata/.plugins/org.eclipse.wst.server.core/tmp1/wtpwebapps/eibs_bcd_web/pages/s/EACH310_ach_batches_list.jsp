...
<%
 String sc = "11";
 if (userPO.getPurpose().equals("NEW") || userPO.getPurpose().equals("MAINTENANCE")) sc = "1";
  	 	else if (userPO.getPurpose().equals("APPROVAL")) sc = "10";
%>
...
<h3 align="center">
	<% if (userPO.getPurpose().equals("NEW") || userPO.getPurpose().equals("MAINTENANCE")) out.print("Entrada ");
  	 else if (userPO.getPurpose().equals("APPROVAL")) out.print("Aprobación ");
		else out.print("Consulta ");
	%>
		de Archivo de salida ACH<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ach_batches_list.jsp, EACH310">
</h3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.ach.JSEACH310">
  ...
  <INPUT TYPE="HIDDEN" id="E01ACBBTH" name="E01ACBBTH" value="0">
...
%>
	<TR>
		<TD align="CENTER" class="TDBKG" width="20%">
			<a href="javascript:goNew()"><b>Crear<br>Archivo</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="20%">
			<a href="javascript:goProcess()"><b>Modificar<br>Archivo</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="20%">
			<a href="javascript:goDetail()"><b>Transacciones</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="20%">
			<a href="javascript:goDelete()"><b>Borrar<br>Archivo</b></a>
		</TD>
	  	<TD align="CENTER" class="TDBKG" width="20%">
...
%>
	<TR>
		<TD align="CENTER" class="TDBKG" width="25%">
			<a href="javascript:goProcess()"><b>Ver Detalle<br>del Archivo</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="25%">
			<a href="javascript:goDetail()"><b>Ver/Aprobar<br>Transacciones</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="25%">
			<a href="javascript:goApproval()"><b>Aprobar<br>Archivo</b></a>
		</TD>
	  	<TD align="CENTER" class="TDBKG" width="25%">
			<a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Salir</b></a>
      	</TD>
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    <TR id=trdark> 
		...
		<TD nowrap align="center" width="10%"><B>Código<br>Originador</B></TD>
	</TR>
    <TR id=trdark>
		<td NOWRAP align="center" width="5%"></td>
		<td NOWRAP align="center" width="5%">
			<INPUT type="text" id="SEARCHCDE" name="SEARCHCDE" size="5" maxlength="4" value="<%= userPO.getProdCode() %>">
    ...
    <TR id=trclear>
		...
		<td NOWRAP align="center" width="10%" ><%= Util.formatCustomDate(currUser.getE01DTF(),
														msgList.getBigDecimalE01ACBVDM().intValue(),
														msgList.getBigDecimalE01ACBVDD().intValue(),
														msgList.getBigDecimalE01ACBVDY().intValue())
																		%></td>
		...
		<td NOWRAP align="center" width="10%" ><%= msgList.getE01ACBOCD() %></td>
	</TR>
       <% 
       	 i++; 
        } 
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25">
       <%
    	if ( EACH310List.getShowPrev() ) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH310?SCREEN=" + sc + "&FromRecord=" + pos + "&SEARCHCDE=" + userPO.getProdCode() + "\" > <img src=\""+request.getContextPath()+"/images/s/previous_records.gif\" border=0></A>");
    	} %>
      </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> 
    	...
    	if (EACH310List.getShowNext()) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH310?SCREEN=" + sc + "&FromRecord=" + pos + "&SEARCHCDE=" + userPO.getProdCode() + "\" ><img src=\""+request.getContextPath()+"/images/s/next_records.gif\" border=0></A>");
	    } %>
  </TD>
 </TR>
 </TABLE>
