...
%> 
<H3 align="center">Solicitud de Chequeras <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ECH0000_rt_Solicitud.jsp, ECH0000"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01CHPCUN" size="10" maxlength="9" value="<%= rtBasic.getE01CHPCUN().trim()%>" readonly>
			</div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E01CHPACC" size="13" maxlength="12" value="<%= rtBasic.getE01CHPACC().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap>
            	<eibsinput:date name="rtBasic" fn_month="E01LSTODM" fn_day="E01LSTODD"  fn_year="E01LSTODY" readonly="true"/>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
            ...
            <td nowrap>
            	<eibsinput:date name="rtBasic" fn_month="E01OPNDTM" fn_day="E01OPNDTD"  fn_year="E01OPNDTY" readonly="true"/>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap>
            	<eibsinput:date name="rtBasic" fn_month="E01CHPDTM" fn_day="E01CHPDTD"  fn_year="E01CHPDTY" readonly="true"/>
            </td>
            <td nowrap>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark">
            ...
            <td nowrap>
            	<INPUT type="text" name="E01CHMDBR" size="3" maxlength="3" value="<%= rtBasic.getE01CHMDBR().trim()%>" onkeypress="enterInteger(event)">
