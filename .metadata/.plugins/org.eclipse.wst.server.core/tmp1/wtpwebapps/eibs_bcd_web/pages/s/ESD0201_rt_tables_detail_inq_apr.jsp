  		 ...
  		 <tr id="<%=(row % 2 == 1) ? "trclear" : "trdark"%><%row++;%>"> 
            ...
            <td nowrap width="18%" > 
              <div align="left" id="FIJO" style="display: none"> 
				<input type="text" class="txtright" name="E01DDCCOA" size="17" maxlength="15"  value="<%= charges.getE01DDCCOA() %>" readonly disabled >
              </div>
              <div align="left" id="ESCALA" style="display: none"> 
                <input type="text" name="E01DDCCHN" size="4" maxlength="5" value="<%= charges.getE01DDCCHN().trim()%>" readonly disabled >
                <input type="text" name="D01DDCCHN" size="31" maxlength="30" readonly value="<%=charges.getD01DDCCHN()%>" readonly disabled >
            </div>                  
            </td>
            <td nowrap width="29%"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          ...
          <tr id="<%=(row % 2 == 1) ? "trclear" : "trdark"%><%row++;%>"> 
            ...
            <td nowrap width="31%" > 
            <input type="text" name="E01DDCAAC" disabled size="13" maxlength="12" readonly value="<%= charges.getE01DDCAAC() %>">
            </td>
