...
<H3 align="center">Prepago Retrofecha <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_payment_det_rot.jsp, EDL0950"></H3> 
<% } else if (userPO.getOption().equals("CU")) { %>
<H3 align="center">Pago de Utilizaciones <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_payment_det_rot.jsp, EDL0950"></H3> 
<%} else { %>
<H3 align="center">Pago de Pr&eacute;stamos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ln_payment_det_rot.jsp, EDL0950"></H3> 
<% } %>
			...
			<td colspan="4" nowrap> 
				<table cellspacing=0 cellpadding=4 width="100%" border="0" >
					...
					<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
			 		...
			 		--%>
			 		<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
						<td nowrap  width="20%"><div align="right">IMPUESTOS:</div></td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02APGIMP" id="E02APGIMP" value="<%= lnCancelDet.getE02APGIMP().trim()%>" readonly>
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02XCNIMP" id="E02XCNIMP" onchange="calculateConcepto(this);" value="<%= lnCancelDet.getE02XCNIMP().trim()%>" onKeypress="enterDecimal(event, 2)">
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02PAGIMP" id="E02PAGIMP" onchange="calculateConcepto(this);" value="<%= lnCancelDet.getE02PAGIMP().trim()%>" onKeypress="enterDecimal(event, 2)">
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
			 		...
			 		<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
						...
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02APGDED" id="E02APGDED" value="<%= lnCancelDet.getE02APGDED().trim()%>" readonly>
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02XCNDED" id="E02XCNDED" onchange="calculateConcepto(this);" value="<%= lnCancelDet.getE02XCNDED().trim()%>" onKeypress="enterDecimal(event, 2)">
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02PAGDED" id="E02PAGDED" onchange="calculateConcepto(this);" value="<%= lnCancelDet.getE02PAGDED().trim()%>" onKeypress="enterDecimal(event, 2)">
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
			 		...
			 		<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
						...
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02APGCBZ" id="E02APGCBZ" value="<%= lnCancelDet.getE02APGCBZ().trim()%>" readonly>
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02XCNCBZ" id="E02XCNCBZ" onchange="calculateConcepto(this);" value="<%= lnCancelDet.getE02XCNCBZ().trim()%>" onKeypress="enterDecimal(event, 2)">
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02PAGCBZ" id="E02PAGCBZ" onchange="calculateConcepto(this);" value="<%= lnCancelDet.getE02PAGCBZ().trim()%>" onKeypress="enterDecimal(event, 2)">
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
			 		...
			 		<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
						<td nowrap  width="20%"><div align="right">IVA:</div></td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02APGIVA" id="E02APGIVA" value="<%= lnCancelDet.getE02APGIVA().trim()%>" readonly>
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02XCNIVA" id="E02XCNIVA" onchange="calculateConcepto(this);" value="<%= lnCancelDet.getE02XCNIVA().trim()%>" onKeypress="enterDecimal(event, 2)">
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
								<input type="text" class="txtright" size="21" maxlength="21" name="E02PAGIVA" id="E02PAGIVA" onchange="calculateConcepto(this);" value="<%= lnCancelDet.getE02PAGIVA().trim()%>" onKeypress="enterDecimal(event, 2)">
							</div>
						</td>
						<td nowrap  width="20%"> 
							<div align="center">
