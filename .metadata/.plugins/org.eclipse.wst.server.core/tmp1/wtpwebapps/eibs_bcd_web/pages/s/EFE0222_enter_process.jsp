...
%> 
<h3 align="center"> Bloomberg Interface Management<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="payments_basic.jsp,EPR0015"> 
</h3>
<hr size="4">
