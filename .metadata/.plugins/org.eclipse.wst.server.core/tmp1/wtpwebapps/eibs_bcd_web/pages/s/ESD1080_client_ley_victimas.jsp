...
<H3 align="center">Mantenimiento de Ley de Victimas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_ley_victimas.jsp, ESD1080"></H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD1080">
  
  <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="5">
  <INPUT TYPE=HIDDEN NAME="OPE" VALUE="12">
  <INPUT TYPE=HIDDEN NAME="E01OPE" VALUE="12">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
        	<tr id="trdark"> 
              ...
              <td nowrap width="15%" align="right">Hecho Victimizante :</td>
              <td nowrap width="35%" align="left">
              	<eibsinput:cnofc name="client" property="E01FC3" value="<%=client.getE01FC3()%>" required="true" flag="FH" fn_code="E01FC3" fn_description="D01FC3" readonly="<%=isReadOnly %>"/>
              	<input type="text" name="D01FC3" size="20" value="<%= client.getD01FC3().trim()%>" readonly>
              </td>
            </tr>
            <tr id="trclear"> 
              <td nowrap width="15%" align="right">Causal :</td>
            	<td nowrap width="35%" align="left">
            	<input type="text" name="E01FC1" size="5" maxlength="4" value="<%= client.getE01FC1().trim()%>" readonly>
            	<input type="text" name="D01FC1" size="20" value="<%= client.getD01FC1().trim()%>" readonly><br>
              </td>
              <td nowrap width="15%" align="right">Estado Unidad de Victimas :</td>
              <td nowrap width="35%" align="left">
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          while (row < 11) {
            if (!lbl[x].equals("")) {
             	String v = String.valueOf(row).trim();
             	if (v == "10") v = "A";
          %>
