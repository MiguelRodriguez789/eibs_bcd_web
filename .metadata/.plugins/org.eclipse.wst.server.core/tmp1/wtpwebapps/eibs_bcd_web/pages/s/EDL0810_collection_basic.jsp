      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="left">
                <input type="text" name="E01DLHCUN" size="10" maxlength="9" value="<%= collBasic.getE01DLHCUN() %>">
...
%>
              <input type="hidden" name="E01DLHNRO" size="13" maxlength="12" value="<%= collBasic.getE01DLHNRO()  %>">
              <input type="text" name="DLHNRO" size="13" maxlength="12" value="<%= strNroAcc  %>">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
				<eibsinput:date name="collBasic" fn_year="E01DLHOPY" fn_month="E01DLHOPM" fn_day="E01DLHOPD" />
            </td>
            <td nowrap width="25%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan=3> 
              <input type="text" name="E01DLHNCG" size="12" maxlength="12" value="<%=collBasic.getE01DLHNCG()%>" onkeypress="enterInteger(event)">
            </td>
