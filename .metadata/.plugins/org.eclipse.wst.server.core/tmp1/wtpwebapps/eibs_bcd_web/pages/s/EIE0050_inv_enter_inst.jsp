...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0308P" >
  ...
  <h3 align="center">Administración Instrumentos</h3>
        ...
        <table class="tableinfo" align="center" >
              ...
              <table width="100%">
                <tr id="trdark"> 
                  <td valign="middle" align="center" colspan="3" height=33> 
                    <div align="left"><b>Búsqueda por :</b></div>
                  </td>
                </tr>
                <tr id="trclear"> 
                  <td>&nbsp;</td>
                  <td width="20%" nowrap> 
                    <div align="right">Código Instrumento Interno : </div>
                  </td>
                  <td width="70%" nowrap> 
                ...
                <tr id="trclear"> 
                  ...
                  <td width="20%" nowrap> 
                    <div align="right">Número ISIN  / Serial : </div>
                  </td>
                  <td width="70%" nowrap> 
                ...
                <tr id="trclear"> 
                  <td width="10%" align="center">&nbsp;</td>
                  <td width="20%" nowrap > 
                    <div align="right">Descripción Instrumento :</div>
                  </td>
                  <td width="70%" nowrap > 
                    <div align="left"> 
          ...
          <div id="divShow" >
			  <table width="100%">
                <tr id="trdark"> 
                  <td valign="middle" align="center" colspan="3" height=33> 
                    <div align="left"><a href="javascript:Options('S')">Opcion Búsqueda Expandida</a></div>
                  </td>
                </tr>
              </table>            
          </div>
          ...
          <tr> 
            <td> 
              ...
              <table width="100%">
                <tr id="trdark"> 
                  <td valign="middle" align="center" colspan="3" height=33> 
                    <div align="left"><b>Opciones Búsquedas Adicionales :&nbsp;&nbsp;&nbsp; </b><a href="javascript:Options('H')">Hide</a></div> 
                  </td>
                </tr>
                <tr id="trclear"> 
                  <td>&nbsp;</td>
                ...
                <tr id="trclear"> 
                  <td width="10%" align="center">&nbsp;</td>
                  <td width="20%" nowrap > 
                    <div align="right">Tasa Cupón :</div>
                  </td>
                  <td width="70%" nowrap > 
                ...
                <tr id="trclear"> 
                  <td width="10%" align="center">&nbsp;</td>
                  <td width="20%" nowrap > 
                    <div align="right">Listar Unicmante Instrumentos Complex : </div>
                  </td>
                  <td width="70%" nowrap > 
                    <div align="left"> 
