...
<HEAD>
<TITLE>
Consulta Reversion de Factoreo
</TITLE>
...
%> 
<h3 align="center">Consulta de Reversi&oacute;n de Factoreo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_reversal_inq.jsp,EDL0830">
</h3>
<hr size="4">
...
<TABLE class="tableinfo">
 <TR> 
   <TD NOWRAP >
        <TABLE width="100%">
          <TR id="trdark"> 
            <Td ALIGN=CENTER NOWRAP>Nro. Transacciones: <%= lnRever.getLastRec() + 1 %></Td>
