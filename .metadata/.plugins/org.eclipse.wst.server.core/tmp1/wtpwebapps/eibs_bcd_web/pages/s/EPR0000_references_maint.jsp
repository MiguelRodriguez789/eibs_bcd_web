   		...
   		<td>
    		<table cellspacing=0 cellpadding=2 width="100%" border="0">
     			...
     			<tr id=trdark>
     				...
     				<td>
              			<input type="text" name="E02PRMCCY" id="E02PRMCCY" size="4" maxlength="3" readonly value="<%= msgMTRef.getE02PRMCCY().trim()%>">
           			 </td>
        		</tr>
        		<tr id=trclear>
        			<td nowrap width="39%"> 
     				...
     				<td>
              			<input type="text" name="E02PRMAMT" id="E02PRMAMT" size="20" maxlength="17" readonly value="<%= msgMTRef.getE02PRMAMT().trim()%>">
           			 </td>
        		</tr>
     			<tr id=trdark> 
	      			<td nowrap >
