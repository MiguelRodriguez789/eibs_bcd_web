...
<table id="TBHELPN" width="100%" border="0" cellspacing="0"
	...
	<tr>
		...
		<td  width="50%">
			<eibsinput:help name="datarec" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CUSTOMER %>" property="E01PVHCUN" 
				fn_param_one="E01PVHCUN" fn_param_two="" fn_param_three="E01PVHCUN"   />
		</td>
	</tr>
	<tr>
