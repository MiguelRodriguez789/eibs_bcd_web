...
%> 
<h3 align="center"> Opciones de Moneda Extranjera</h3>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="fe_basic_opt.jsp,EFE0120B"> 
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap height="35" colspan="3" > 
              <div align="left"> <%= fex.getE01FESOTS()%> </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="23%" > 
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">            
            ...
            <td nowrap colspan="2" > 
              ...
              <a href="javascript:GetClassFex('E01FESCLS','OPT','<%= fex.getE01FESCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
