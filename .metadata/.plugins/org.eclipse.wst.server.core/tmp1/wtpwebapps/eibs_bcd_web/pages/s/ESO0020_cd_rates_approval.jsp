...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_rates_approval.jsp, ESO0020"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="25%"> 
              <div align="left"> 
                <input type="text" name="E01SOLTRM" size="6" maxlength="5" value="<%= msgCD.getE01SOLTRM().trim()%>">
