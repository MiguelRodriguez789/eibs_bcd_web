...
<H3 align="center">Consulta de Solicitudes de Fraccionamiento de Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_detail, EPR0353"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
				...
				<a href="javascript:GetComission(document.forms[0].E01REQROR.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
				<%}%>  
			</td>
		</tr>
		<tr>
