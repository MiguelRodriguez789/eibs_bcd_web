...
<BODY>
<H3 align="center">Comisiones de Cesiones a Cartas de Crédito
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_assignment_commission.jsp, ELC0510"></H3>
<HR size="4">


<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0510" >
<INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="114">
	...
	<tbody>
		<tr>
			...
			<table border="0" cellspacing="0" width="100%">
					...
					<tr id="trclear">
						<td align="right">Comisión por Cesión</td>
						...
						<td align="right">Comisión por Swift</td>
						<td nowrap width="17%" align="center">
