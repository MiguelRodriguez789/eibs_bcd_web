...
<H3 align="center">Tablas de Referencia Tarjetas de Cr&eacute;dito <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnof_generic_short_codes_details.jsp, ESD0030"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E01CCDDSC" size="50" maxlength="45" value="<%= ccCodes.getE01CCDDSC().trim()%>" >
              </div>
            </td>
          </tr>
        </table>
