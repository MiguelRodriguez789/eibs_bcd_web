...
function goAction(op) {
	if (op==450){
		...
		//para que grabe la pestaña 04	
		if (document.forms[0].E04DCBTCE.value!="0000" && document.forms[0].E04DCBTCE.value!=""){
			document.forms[0].GRABAR04.value="S";
		}else{//es cero o blanco pero verificamos que el historico no sea cero o blanco
			if (document.forms[0].E04DCBTCE.value != document.forms[0].E04DCBTCE_H.value){
				document.forms[0].GRABAR04.value="S";
			}else{
				//Siempre ha sido cero o blanco no debo guardar
			}
		}
	}
...
<%} %>	
 ...
 function golistaCanales() {
  ...
  function golistaCodigoBarra() {
 	if (document.forms[0].E01COMNUM.value!="999999999999"){
		page = "<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSECO1050?SCREEN=800&E01COMCUN="+document.forms[0].E01COMCUN.value+"&E01COMNUM="+document.forms[0].E01COMNUM.value;
		//alert(page);		
  		CenterWindow(page,800,500,2);
	}else{
      ...
      <td nowrap> 
		...
		<tr id="trdark"> 
            ...
            <td nowrap align="left">
                <eibsinput:cnofc name="cdeObj" property="E01COMOFL" value="<%=cdeObj.getE01COMOFL()%>" required="false" flag="10" fn_code="E01COMOFL" fn_description="E01COMDOF" readonly="<%=isReadOnly %>"/>
       ...
       <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="25%" align="left">
             	<eibsinput:cnofc name="cdeObj" property="E01COMCTS" value="<%=cdeObj.getE01COMCTS()%>" required="true" readonly="<%=isReadOnly %>" flag="VA" fn_code="E01COMCTS" fn_description="E01COMDTS"/>
          ...
          <tr id="trclear"> 
			...
			<td nowrap  align="right" colspan="2">Indicador Ajustes de Pagos: </td>
			<td nowrap align="left">
...
--%>                                 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap  align="left"> 
            	<eibsinput:text name="cdeObj" property="E01COMVMR" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" required="false" readonly="<%=isReadOnly %>"/>              	
             </td>
            <td nowrap align="right">Monto Máximo: </td>
            <td nowrap  align="left">
				<eibsinput:text name="cdeObj" property="E01COMVXR" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" required="false" readonly="<%=isReadOnly %>"/>                   	
            </td>
 	   ...
 	   <table cellspacing="0" cellpadding="2" width="100%" border="0">            
         <tr id="trclear" > 
            ...
            <td nowrap  align="left" colspan="5">
            	...
            	&nbsp;&nbsp;&nbsp;&nbsp;
            	<INPUT type="radio" name="E01COMFPG00" value="0000" <% if (vec.contains("0000")) out.print(" checked"); %>
         ...
         <tr id="rowMixto" style="display:none;" > 
            ...
            <td nowrap  align="left" colspan="4">
            	...
            	<INPUT type="CHECKBOX" name="E01COMMFP00" value="0000" <% if (vec1.contains("0000")) out.print(" checked"); %>
            	<%=isReadOnly?"disabled":""%>>Efectivo
            	&nbsp;&nbsp;&nbsp;&nbsp;
				<INPUT type="CHECKBOX" name="E01COMMFP01" value="0001" <% if (vec1.contains("0001")) out.print(" checked"); %>
				onclick="showHide(this,'Y')" <%=isReadOnly?"disabled":""%>>Cheque
				&nbsp;&nbsp;&nbsp;&nbsp;
            	<INPUT type="CHECKBOX" name="E01COMMFP02" value="0002" <% if (vec1.contains("0002")) out.print(" checked"); %>
            	<%=isReadOnly?"disabled":""%>>Cargo a Cuenta
            	&nbsp;&nbsp;&nbsp;&nbsp;
            	<INPUT type="CHECKBOX" name="E01COMMFP03" value="0003" <% if (vec1.contains("0003")) out.print(" checked"); %>
            	<%=isReadOnly?"disabled":""%>>CERT
            	&nbsp;&nbsp;&nbsp;&nbsp;
            	<INPUT type="CHECKBOX" name="E01COMMFP04" value="0004" <% if (vec1.contains("0004")) out.print(" checked"); %>
            	<%=isReadOnly?"disabled":""%>>Tarjeta Crédito
            	&nbsp;&nbsp;&nbsp;&nbsp;
            	<INPUT type="CHECKBOX" name="E01COMMFP05" value="0005" <% if (vec1.contains("0005")) out.print(" checked"); %>
			   ...
			   <tr id="rowDiario" style="display:none;" >
		            ...
		            <td nowrap  align="left" colspan="3">
		            	...
		            	<table width="100%" border="0">
		            		...
		            		<tr>
		            			<td >
		            				 Intervalo en Horas Envió Información:
		            			</td>
		            			<td >
  ...
  <table class="tableinfo">
    ...
    <tr > 
      <td nowrap > 
     			...
     			<!-- CAMPOS Ocultos -->
     			<INPUT TYPE=HIDDEN NAME="E04DCBCCO" VALUE="<%= cdeObj4.getE04DCBCCO().trim()%>">
     			<INPUT TYPE=HIDDEN NAME="E04DCBCCM" VALUE="<%= cdeObj4.getE04DCBCCM().trim()%>">
     ...
     <td>       
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">  
          ...
          <tr id="trdark"> 
            ...
            <td nowrap align="left">
					<eibsinput:text name="cdeObj4" property="E04DCBSCB" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_INTEGER %>" required="false" readonly="<%=isReadOnly %>" size="4" maxlength="3"/>
            </td>
			<td nowrap align="right">&nbsp;</td>
			<td nowrap align="left">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap align="left">
            	<eibsinput:text name="cdeObj4" property="E04DCBCCO" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CHAR %>" required="false" readonly="<%=isReadOnly %>" size="30" maxlength="25"/>
            </td>
     ...
     <td>  		
		<table cellspacing="0" cellpadding="2" width="100%" border="0">                 
		 <tr id="trdark"> 
            ...
            <td nowrap align="left">            
				<eibsinput:text name="cdeObj4" property="E04DCBTFM" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CHAR %>" required="false" readonly="<%=isReadOnly %>" size="5" maxlength="4"/>            
            </td>
            <td nowrap align="right">Tipo Impreso <br>Formulario:</td>
            <td nowrap align="left">
				<eibsinput:text name="cdeObj4" property="E04DCBTIF" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CHAR %>" required="false" readonly="<%=isReadOnly %>" size="5" maxlength="4"/>            
            </td>
	    	<td nowrap align="right">Tipo de Impreso:</td>
	    	<td nowrap align="left">
				<eibsinput:text name="cdeObj4" property="E04DCBTIP" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CHAR %>" required="false" readonly="<%=isReadOnly %>" size="5" maxlength="4"/>	    	
	    	</td>            
         </tr> 
         <tr id="trclear"> 
            <td nowrap align="right">Código de Impuesto:</td>
            <td nowrap align="left">            
				<eibsinput:text name="cdeObj4" property="E04DCBCIM" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CHAR %>" required="false" readonly="<%=isReadOnly %>" size="5" maxlength="4"/>            
            </td>
            <td nowrap align="right">Tipo de Impuesto:</td>
            <td nowrap align="left">
				<eibsinput:text name="cdeObj4" property="E04DCBTIM" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CHAR %>" required="false" readonly="<%=isReadOnly %>" size="5" maxlength="4"/>            
            </td>
	    	<td nowrap align="right">Tipo Pago de <br>Impuesto:</td>
	    	<td nowrap align="left">
				<eibsinput:text name="cdeObj4" property="E04DCBTPI" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_CHAR %>" required="false" readonly="<%=isReadOnly %>" size="5" maxlength="4"/>	    	
	    	</td>            
         </tr>
		</table>
      </td>
