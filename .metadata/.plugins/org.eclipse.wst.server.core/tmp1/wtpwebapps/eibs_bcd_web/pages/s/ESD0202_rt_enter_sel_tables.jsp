...
<jsp:useBean id= "ESD0202msg" class= "datapro.eibs.beans.ESD020201Message"  scope="session"/>
...
%> 
  <h3 align="center">Comisiones-Definición de Cargos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="rt_enter_sel_tables.jsp, ESD0202"></H3>
  <hr size="4">
