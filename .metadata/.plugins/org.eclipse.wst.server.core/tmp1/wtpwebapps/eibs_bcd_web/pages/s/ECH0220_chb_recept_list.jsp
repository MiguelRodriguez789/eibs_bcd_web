...
<h3 align="center">Recepci&oacute;n de Chequeras Universal de Proveedores - <% if (userPO.getOption().equals("L")) out.print("Ciclo Largo"); else out.print("Ciclo Corto"); %>	
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="chb_recept_list.jsp,ECH0220">
</h3>
<hr size="4">
    ...
    <TH ALIGN=CENTER >Sucursal<br>Entrega</TH>
     ...
     <%
                ...
                while (chkbList.getNextRow()) {
                  ...
                  datapro.eibs.beans.ECH022001Message msgChkB = (datapro.eibs.beans.ECH022001Message) chkbList.getRecord();
     %>               
        <TR>
