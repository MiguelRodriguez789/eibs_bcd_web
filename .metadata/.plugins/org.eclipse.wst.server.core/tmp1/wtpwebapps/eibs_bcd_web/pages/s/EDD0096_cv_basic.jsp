...
<jsp:useBean id="svBasic" class="datapro.eibs.beans.EDD009601Message" scope="session" /> 
...
%>
<H3 align="center">Mantenimiento de Cuentas<img
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" title="cv_basic.jsp, EDD0096"></H3>
<hr size="4">
<form method="post"
	action="<%=request.getContextPath()%>/servlet/datapro.eibs.taxes.JSEDD0096">
         ...
         <table cellspacing="0" cellpadding="2" width="100%" border="0">
           <tr id="trdark"> 
            <% if (currUser.getE01INT().equals("05")) {%> 
                 <td nowrap width="50%"> <div align="right">Exenta del Gravamen a Movimientos Financieros (GMF): </div>
              </td>
              <td nowrap width="30%"> 
			  ...
			  <%if(svBasic.getE01ACMTX1().equals("Y")) out.print("checked");%> >
              S&iacute; 
              <input type="radio" name="CE01ACMTX1" value="N" onClick="document.forms[0].E01ACMTX1.value='N'"
			  <%if(svBasic.getE01ACMTX1().equals("N")) out.print("checked");%> >
              No <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" >
              </td>
              <%if (svBasic.getE01ACMRE1().equals("Y")) {%>
                   <td nowrap bgcolor="#D0D8E1">    
                   <div  align="right"><font color="red"><B>YA TIENE UNA CUENTA EXENTA </B></font></div>  
              </td>  
              <%}%>
            <% } else {%>
           ...
           <!--   <tr id="trclear"> 
            <td nowrap width="30%"> 
              <div align="right">Norma:</div>
            </td>
            <td nowrap width="22%"> 
              <input type="text" name="E01ACMUC4" size="6" maxlength="6" value="<%= svBasic.getE01ACMUC4().trim()%>" readonly>
              <a href="javascript:GetCodeDescCNOFC('E01ACMUC4','','NI')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
            </td>
          </tr> -->
          ...
          <!-- <tr id="trdark"> 
			...
			<td nowrap width="22%"><input type="text" name="E01ACMWHF"
			  size="2" maxlength="1" value="<%=svBasic.getE01ACMWHF().trim()%>"
			  <%=blocked%>> <%
              if (blocked == "") {
                %> <a
