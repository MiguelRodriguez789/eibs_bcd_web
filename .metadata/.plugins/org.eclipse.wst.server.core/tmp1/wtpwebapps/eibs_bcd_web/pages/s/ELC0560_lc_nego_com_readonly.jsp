...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" title="ELC0560_lc_nego_com_readonly.jsp" name="EIBS_GIF" align="left"></h3>
<hr size="4">
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
         ...
         <tr id="trclear">
           ...
           <td nowrap  height="24" align="center" width="61">
			<input name="E01DEBBR2" type="text" onKeyPress="enterInteger(event)" value="<%=msg01.getE01DEBBR2()%>" size="6" maxlength="4" readonly="readonly" class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E01DEBBK2.value,'','','','')"></td>
           <td nowrap align="center"  height="24" width="47">
			<input name="E01DEBCY2" type="text" value="<%=msg01.getE01DEBCY2()%>" size="6" maxlength="3" readonly="readonly" class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.forms[0].E01DEBBK2.value,'','','','')"></td>
           ...
           <td nowrap align="center"  height="24" width="132">
			<input name="E01DEBAC2" type="text" value="<%=msg01.getE01DEBAC2()%>" size="18" maxlength="12" readonly="readonly" class="context-menu-help" onmousedown="init(accountHelp,this.name,document.forms[0].E01DEBBK2.value,'','','','RT')"></td>
           <td nowrap align="center"  height="24" width="114">
			<input name="E01DEBCC2" type="text" value="<%=msg01.getE01DEBCC2()%>" size="13" maxlength="8" readonly="readonly" class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E01DEBBK2.value,'','','','')"></td>
		</tr>
</table>
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <tr id="trclear">
    ...
    <td nowrap  height="24" align="center" width="61">
		<input name="E01CRPBRN" type="text" onKeyPress="enterInteger(event)" value="<%=msg01.getE01CRPBRN()%>" size="6" maxlength="4" readonly="readonly" class="context-menu-help" onmousedown="init(branchHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')"></td>
    <td nowrap align="center"  height="24" width="47">
		<input name="E01CRPCCY" type="text" value="<%=msg01.getE01CRPCCY()%>" size="6" maxlength="3" readonly="readonly" class="context-menu-help" onmousedown="init(currencyHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')"></td>
    <td nowrap align="center"  height="24" width="128">
    ...
    <td nowrap align="center"  height="24" width="132">
		<input name="E01CRPACC" type="text" value="<%=msg01.getE01CRPACC()%>" size="18" maxlength="12" readonly="readonly" class="context-menu-help" onmousedown="init(accountHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','RT')"></td>
    <td nowrap align="center"  height="24" width="114">
			<input name="E01CRPCCN" type="text" value="<%=msg01.getE01CRPCCN()%>" size="13" maxlength="8" readonly="readonly" class="context-menu-help" onmousedown="init(costcenterHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')"></td>
	</tr>
</table>
<% } %>
<p></p>
