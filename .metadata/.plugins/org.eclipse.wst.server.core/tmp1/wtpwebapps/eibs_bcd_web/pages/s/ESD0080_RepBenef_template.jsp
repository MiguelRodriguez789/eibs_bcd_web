...
<% 
  ...
  String addressType = request.getParameter("addressType") == null ? "S" : request.getParameter("addressType");
   ...
   String index = suffix.length() > 2  ? suffix.substring(1, 2) : "0";
   
   // Obtiene el mensaje a desplegar
   String messageName = request.getParameter("messageName") == null ? "" : request.getParameter("messageName");
   MessageRecord mr = null;
   if (!messageName.equals("")) mr = (MessageRecord) session.getAttribute(messageName);      
...
%>	       
	...
	<script type="text/javascript">
    	function concat<%=RegionMunPar%>(evt){
  					...
  					<tr id="trclear">
					    ...
					    <td nowrap width="58%">
					       <INPUT type="text" name="<%=Nombre%>" id="address.Name"
						    ...
						    <a href="javascript:GetCodeCNOFC('Region','07')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
		          ...
		          <tr id="trdark"> 
		           <td nowrap width="42%">Pais</td>
		            <td nowrap width="58%"><INPUT type="text" name="<%=Pais%>" id="address.Pais"
					   ...
					   <a href="javascript:GetCodeCNOFC('<%=Pais%>','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
		              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" >		
					</td>
				   </tr>
				   <tr id="trclear">
				   ...
				   <tr id="trdark">	
				    ...
				    <TD nowrap width="58%">
				      <INPUT type="text" name="<%=Estado%>" id="address.Estado" 
					    ...
					    <a href="javascript:GetCodeCNOFC('<%=Estado%>','27')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
		               <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" >		
					</td>
					</tr>		
				  <tr id="trclear"> 
		            ...
		            <INPUT type="text" 	name="Municipio" size="20" id="address.Municipio"
		             value="<%=municipioValue%>" >
					   <a href="javascript:GetCodeCNOFC('Municipio','85')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
		              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" >
					</td>
				   </tr>
				   <tr id="trdark">	
		             <td nowrap width="42%">Ciudad</td>
		              <td nowrap width="58%"><INPUT type="text" name="<%=Ciudad%>" id="address.Ciudad"
						 ...
						 <a href="javascript:GetCodeCNOFC('<%=Ciudad%>','84')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
		              <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" >		
					 </td>
				    </tr>
				    <tr id="trclear">		
					  ...
					  <TD nowrap width="58%"><INPUT type="text" name="Parroquia" id="address.Parroquia"
				       ...
				       <a href="javascript:GetCodeCNOFC('Parroquia','80')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="bottom" border="0"></a> 
		                <img src="<%=request.getContextPath()%>/images/Check.gif" title="mandatory field" align="bottom" >  	     		
					 </TD>
					</tr>
		           <tr id="trdark"> 
				  ...
				  <tr id="trclear">	
				    ...
				    <tr id="trclear">	
					  ...
					  <INPUT type="text" name="<%=Fecha2%>" id="address.AptoOfi0"
							...
							name="<%=Fecha3%>" id="address.AptoOfi1" size="5"
							value="<%=mr.getField(Fecha3).getString()%>"
							onchange="concatUbicacion();" maxlength="4"></TD>
				   </tr>
				    <tr id="trclear">	
    ...
    <script type="text/javascript" >
       //util = new EventUtils();
       EventUtils.addEventListener(document.forms[0],'submit',concat<%=RegionMunPar%>);
