...
function goAction(opt) {
    ...
    if (opt == "C") { 
    	...
    	page = "<%=request.getContextPath()%>/pages/s/EPR0333_foreign_currency_exchange_detail.jsp?ROW=" + row;
  		CenterNamedWindow(page,'Information',550,450,2);
  	} else {
  		var row = document.forms[0].CURRENTROW.value;
  	    page = "<%=request.getContextPath()%>/pages/s/EPR0333_foreign_currency_exchange_maint.jsp?ROW=" + row + "&MNT=1";
  		CenterNamedWindow(page,'Information',550,450,2);
  	}
}
...
<h3 align="center">Compraventa Moneda Extranjera<BR>Preliquidacion de Solicitudes de Canje<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_list.jsp, EPR0333">
</h3>
<hr size="4">
 ...
 <TABLE class="tbenter" width="100%" align=center>
    <TR> 
      ...
      <TD class=TDBKG width="33%"> 
        <div align="center"><a href="javascript:goAction('T')">Canje</a> 
        </div>
      </TD>
      <TD class=TDBKG width="33%"> 
        <div align="center"><a href="javascript:checkClose()">Salir</a> </div>
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        while (mtList.getNextRow()) {
           ...
           datapro.eibs.beans.EPR033301Message msgMT = (datapro.eibs.beans.EPR033301Message) mtList.getRecord();
     	%>               
        <TR>
