...
<H3 align="center">Mantenimiento de Instrumentos de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="foreign_currency_exchange_maint, EPR0305"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		<tr>
			...
			<td nowrap width="60%">
				...
				<a href="javascript:GetCurrency('E01PSILIC',document.forms[0].E01PSIBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0"></a>
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td align="center">
				<input type="text" name="E01PSIPTI"	value="<%= msgInst.getE01PSIPTI() %>" onkeypress="enterInteger(event)">
			</td>
			<td align="center">
				<input type="text" name="E01PSISTI" value="<%= msgInst.getE01PSISTI() %>" onkeypress="enterInteger(event)">
			</td>
		</tr>
     </table>
    </td>
