...
<H3 align="center">Aplicación de Pre-Cancelación
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_precancel_enter.jsp, ESO0010"></H3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESO0010">
  ...
  <table class="tbenter" HEIGHT="25%" width="100%" border="0">
    ...
    <tr> 
    	...
    	<td nowrap ALIGN="left"> 
        	<INPUT type="text" name="E01SELACC" size="14" maxlength="13" onclick="document.forms[0].search[1].click()" onkeypress="enterInteger(event)">
            <a href="javascript:document.forms[0].search[1].click();GetAccount('E01SELACC','','CD','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a> 
    	</td>
    </tr> 
  </table>  
 <p align="center"> 
