...
<H3 align="center">Consulta de Historial de Cartas de Crédito<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="lc_details.jsp,ELC0460"></H3> 
