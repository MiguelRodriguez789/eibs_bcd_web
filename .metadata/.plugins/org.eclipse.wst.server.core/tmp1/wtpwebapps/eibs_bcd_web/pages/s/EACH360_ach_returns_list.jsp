...
<h3 align="center">Retornos ACH Pendientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
	name="EIBS_GIF" title="ach_returns_list.jsp, EACH360"></h3>
<hr size="4">
    ...
    <TR id=trclear>
		...
		<td NOWRAP align="center" width="8%" >
			<%= Util.formatCustomDate(currUser.getE01DTF(),
						msgList.getBigDecimalE01ACRVDM().intValue(),
						msgList.getBigDecimalE01ACRVDD().intValue(),
						msgList.getBigDecimalE01ACRVDY().intValue())%>
		</td>
