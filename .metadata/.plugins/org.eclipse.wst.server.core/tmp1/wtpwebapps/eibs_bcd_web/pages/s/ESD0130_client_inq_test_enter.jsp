...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="client_inq_test_enter.jsp , ESD0130"></h3> 
<hr size="4">
<p>&nbsp;</p>
      ...
      <td nowrap> 
        <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
		  ...
		  <tr> 
            ...
            <td nowrap width="50%"> 
              <input type="text" name="E01CUN" size="10" maxlength="9" onKeypress="enterInteger(event)">
              <a href="javascript:GetCustomer('E01CUN')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="ayuda" align="middle" border="0"  ></a> 
            </td>
          </tr>
        </table>
      </td>
