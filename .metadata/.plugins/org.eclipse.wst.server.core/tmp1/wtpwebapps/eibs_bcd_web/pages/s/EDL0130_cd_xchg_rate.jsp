...
<h3 align="center">Cambio de Tasa de Intereses<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_xchg_rate.jsp, EDL0130"></h3>
<hr size="4">
            ...
            <td nowrap width="25%" > 
              ...
              <input type="text" name="E06DEATRC" size="10" 
				  value="<% if (cdRate.getE06DEATRC().equals("D")) out.print("D&iacute;a(s)");
							else if (cdRate.getE06DEATRC().equals("M")) out.print("De Cada Mes");
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
  		<tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
           <td nowrap width="25%"  height="23"> 
            ...
            <td nowrap width="25%" > 
              <input type="text" name="E06NEWFTB" id="E06NEWFTB" size="3" maxlength="2" value="<%= cdRate.getE06NEWFTB().trim()%>">
              <a href="javascript:GetFloating('E06NEWFTB','','E06NEWDSC','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a> 
              <select name="E06NEWFTY" id="E06NEWFTY">
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            ...
            <td nowrap width="25%"> 
	             <select name="E06DEAFLX" id="E06DEAFLX">
            ...
            <td nowrap width="25%" > 
              <eibsinput:text name="cdRate" property="E06DEARTX" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_RATE %>" readonly="false"/>
            </td> 
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
             <td nowrap width="25%" > 
            ...
            <td nowrap width="25%"> 
        	   <eibsinput:text name="cdRate" property="E06NEWRTE" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_RATE %>" readonly="false"/>
            </td>
          </tr>
           <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="25%"> 
            	<eibsinput:text name="cdRate" property="E06NEWSPR" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_RATE %>" readonly="false"/>
            </td>
          </tr>
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>"> 
            <td nowrap width="25%" > 
            ...
            <td nowrap width="25%">
	              <eibsinput:date name="cdRate"  fn_month="E06TRNVDM" fn_day="E06TRNVDD" fn_year="E06TRNVDY" /> 
            </td>
              <td nowrap width="25%" > 
        	</td>
        	 <td nowrap width="25%" > 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="25%" > 
        	   <eibsinput:text name="cdRate" property="E06DEANR1" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_DESCRIPTION %>" readonly="false"/>
            </td>
             <td nowrap width="25%" > 
        	</td>
        	 <td nowrap width="25%" > 
          ...
          <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="25%"> 
        	   <eibsinput:text name="cdRate" property="E06DEANR2" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_DESCRIPTION %>" readonly="false"/>
            </td>
             <td nowrap width="25%" > 
        	</td>
        	 <td nowrap width="25%" > 
...
<% if (currUser.getE01AUT().equals("B") || currUser.getE01AUT().equals("C") || currUser.getE01AUT().equals("D") || currUser.getE01AUT().equals("O") || currUser.getE01STS().equals("I")) { 
   		if(error.getERWRNG().equals("Y")){%>
   			<h4 style="text-align:center">
				<input type="checkbox" name="H06FLGWK2" value="A" <% if(cdRate.getH06FLGWK2().equals("A")){ out.print("checked");} %>>Aceptar con Avisos
			</h4>
 	 <% } %>         
  		<p align="center"> 
...
<% } else { %>
		<h3 align="center"><b>No Autorizado para Modificar Tasa <%=currUser.getE01STS().trim()%></b></h3>
<% } %>
