<html> 
<head>
<title>Creacion del Apoderado</title>
...
<H3 align="center">Sistema de Bastanteo - Creacion del Propetario/Apoderado<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="bastanteo_attorney_new,ECU0000"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
     	<tr id=trdark> 
		  ...
		  <td nowrap>
				<input type="text" name="E05CUMMA3" size="40" maxlength="35" value="<%= msgMem.getE05CUMMA3() %>"> 
		  </td>
     	</tr>
     	<tr id=trclear> 
            <td nowrap width="39%"> 
            ...
            <td nowrap colspan="2"> 
              <input type="text" name="E05CUMCTR" size="16" maxlength="15" value="<%= msgMem.getE05CUMCTR().trim()%>">
            </td>
        </tr>
     	<tr id=trdark>
     		<td nowrap width="39%"> 
     		...
     		<td>
              <input type="hidden" name="E05CUMINC" size="5" maxlength="4" value="<%= msgMem.getE05CUMINC().trim()%>">
              <input type="text" name="E05CUMINN" size="40" maxlength="35" readonly value="<%= msgMem.getE05CUMINN().trim()%>">
              <a href="javascript:GetCodeDescCNOFC('E05CUMINC','E05CUMINN','34')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
            </td>
        </tr>
        <tr id=trclear>
        	<td nowrap width="39%"> 
     		...
     		<td>
              <input type="hidden" name="E05CUMBNC" size="5" maxlength="4" value="<%= msgMem.getE05CUMBNC().trim()%>">
              <input type="text" name="E05CUMBNN" size="40" maxlength="35" readonly value="<%= msgMem.getE05CUMBNN().trim()%>">
              <a href="javascript:GetCodeDescCNOFC('E05CUMBNC','E05CUMBNN','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
            </td>
        </tr>
     	<tr id=trdark> 
	      <td nowrap >
     	...
     	<tr id=trdark>
     		...
     		<td>
              <input type="hidden" name="E05CUMTID" size="5" maxlength="4" value="<%= msgMem.getE05CUMTID().trim()%>">
        ...
        <tr id=trclear>
        	<td nowrap width="39%"> 
     		...
     		<td>
              <input type="hidden" name="E05CUMPID" size="5" maxlength="4" value="<%= msgMem.getE05CUMPID().trim()%>">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          ...
          <td> 
            ...
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMCTY" size="30" maxlength="30" value="<%= msgMem.getE05CUMCTY().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
          <td> 
            ...
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMMA2" size="35" maxlength="35" value="<%= msgMem.getE05CUMMA2().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
          <td> 
            ...
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMNST" size="9" maxlength="7" value="<%= msgMem.getE05CUMNST().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
          <td> 
            ...
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMPOB" size="10" maxlength="8" value="<%= msgMem.getE05CUMPOB().trim()%>">
            </td>
          </tr>
        <tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E05REGRDD" size="3" maxlength="2" value="<%= msgMem.getE05REGRDD() %>">
	      	<input type="text" name="E05REGRMM" size="5" maxlength="2" value="<%= msgMem.getE05REGRMM() %>">
	      	<input type="text" name="E05REGRYY" size="5" maxlength="4" value="<%= msgMem.getE05REGRYY() %>">
	      	<a href="javascript:DatePicker(document.forms[0].E05REGRDD,document.forms[0].E05REGRMM,document.forms[0].E05REGRYY)"><img src="<%=request.getContextPath()%>/images/calendar.gif" title=". . ." align="bottom" border="0" ></a>
	      </td>     
      	</tr>
