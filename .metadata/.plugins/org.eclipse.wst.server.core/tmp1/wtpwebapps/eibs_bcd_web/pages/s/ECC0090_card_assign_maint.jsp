		...
		if (num == 1) {
			if (E02CCRAPC.value != "01" &&
				...
				if (ccp !="" && ccp !=null) {
					...
					apcode1 = E02CCRAPC.value;
					ccp = E02CCRCRA.value;
					document.forms[0].CC_Main[0].value = E02CCRCRA.value;
					type1 = E02CCRTYP.value;
					subtype1 = E02CCRSTP.value;
		...
		if (num == 2) { 
			if (E02CCRAPC.value != "04") {
				...
				if (cap != "" && cap !=null) {
					...
					apcode2 = E02CCRAPC.value;
					cap= E02CCRCRA.value;
					document.forms[0].CC_Main[1].value = E02CCRCRA.value;
					type2 = E02CCRTYP.value;
					subtype2 = E02CCRSTP.value;
		...
		if (num == 3) {
			if (E02CCRTYP.value != "CFAL") {
				...
				if (cfp != "" && cfp != null) {
					...
					apcode3 = E02CCRAPC.value;
					cfp = E02CCRCRA.value;
					document.forms[0].CC_Main[2].value = E02CCRCRA.value;
					type3 = E02CCRTYP.value;
					subtype3 = E02CCRSTP.value;
...
<body>
<h3 align="center">Asignación de Tarjetas<BR>Mantenimiento de Tarjeta Titular<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="card_assign_maint.jsp, ECC0090"></h3>
<hr size="4">
<% 
