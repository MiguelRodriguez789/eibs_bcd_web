              ...
              <table width="100%">
                ...
                <tr id="trclear"> 
                  ...
                  <td width="73%" nowrap> 
                    ...
                    <a href="javascript:GetPortfolioNumDesc('PORTFOLIO','',document.forms[0].CUSTOMER.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="bottom" border="0" ></a> 
                    o</td>
                </tr>
                <tr id="trclear"> 
                  <td width="27%" nowrap> 
                  ...
                  <td nowrap width="73%"> 
					...
					onChange="javascript:validOptions('B')">
                    <a href="javascript:GetBrokerI('BROKER','DESCR')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="help" align="middle" border="0"></a> 
                    o</td>
                </tr>
                <tr id="trclear"> 
                  <td width="27%" nowrap > 
                ...
                <tr id="trclear"> 
                  ...
                  <td nowrap width="69%" > 
                    <div align="left"> 
                      <input type="text" size="3" maxlength="2" name="DATEF1" onChange="javascript:validOptions('D')">
                      ...
                      para 
                      <input type="text" size="3" maxlength="2" name="DATET1" onChange="javascript:validOptions('D')">
