...
<H3 align="center">Mantenimiento de Retenciones e Impuestos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="taxes_500_iva.jsp, ESD0009"></H3>
<hr size="4">
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <eibsinput:help name="taxes" property="E01TAXGCC" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_GLEDGER%>" required="false"
          	    	fn_param_one="E01TAXGCC" fn_param_two="<%= taxes.getE01TAXBNK() %>" /></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="30%" height="19"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <eibsinput:text name="taxes" property="E01TAXUPL" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" />
               </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <eibsinput:text name="taxes" property="E01TAXLLM" eibsType="<%= EibsFields.EIBS_FIELD_TYPE_AMOUNT %>" />
              </div>
            </td>
          </tr>
