...
<BR>Consulta
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cd_precancel_inq.jsp, ESO0010"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="25%"> 
              <div align="left"> 
      				<eibsinput:date name="msgCD" fn_year="E01DEAMAY" fn_month="E01DEAMAM" fn_day="E01DEAMAD" readonly="true"/>
              </div>
            </td>
          </tr>  
          <tr id="trdark"> 
            ...
            <td nowrap width="25%"> 
              <div align="left"> 
              	<select name="E01SOLPVI" disabled>
