...
<BODY>
<h3 align="center">C&oacute;digos de Referencia Tarjetas de Crédito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cnofc_cc_list.jsp, ECC0030"></h3>
<hr size="4">
          ...
          <table class="tbenter" width=100% align=center>
            <tr> 
              <td class=TDBKG width="30%"> 
                <div align="center"><a href="javascript:goAction(1)">Crear</a></div>
              </td>
              <td class=TDBKG width="30%"> 
