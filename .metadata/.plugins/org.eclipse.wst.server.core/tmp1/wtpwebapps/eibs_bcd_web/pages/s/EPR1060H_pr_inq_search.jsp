		...
		<table id="tbenter" width="100%" border="0" cellspacing="1"
			...
			<tr>
				...
				<td width="70%" nowrap><input type="text" name="E01SCHOCU" size=10
					maxlength="10" onKeyPress="enterInteger(event)"> <a
			...
			<tr>
				...
				<td width="70%" nowrap>
				<p><input type="text" size="3" maxlength="2" name="E01SCHFD1"
					onKeyPress="enterInteger(event)"> <input type="text" size="3"
					maxlength="2" name="E01SCHFD2" onKeyPress="enterInteger(event)"> <input
					type="text" size="5" maxlength="4" name="E01SCHFD3"
					onKeyPress="enterInteger(event)"> hasta : <input type="text" size="3"
					maxlength="2" name="E01SCHTD1" onKeyPress="enterInteger(event)"> <input
					type="text" size="3" maxlength="2" name="E01SCHTD2"
					onKeyPress="enterInteger(event)"> <input type="text" size="5"
					maxlength="4" name="E01SCHTD3" onKeyPress="enterInteger(event)"></p>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td width="70%" nowrap><input type="text" size="2" maxlength="2"
					name="E01SCHDBK" onKeyPress="enterInteger(event)"> / <input type="text"
					size="3" maxlength="3" name="E01SCHDCY"> <a
					href="javascript:GetCurrency('E01SCHDCY',document.forms[0].E01SCHDBK.value)"><img
					src="<%=request.getContextPath()%>/images/1b.gif" title="Help"
					align="middle" border="0"></a> <input type="text"
					name="E01SCHDGL" size=15 maxlength="16" onKeyPress="enterInteger(event)">
				<a
			...
			<tr>
				...
				<td width="70%" nowrap><input type="text" size="2" maxlength="2"
					name="E01SCHCBK" onKeyPress="enterInteger(event)"> / <input type="text"
					size="3" maxlength="3" name="E01SCHCCY"> <a
					href="javascript:GetCurrency('E01SCHCCY',document.forms[0].E01SCHCBK.value)"><img
					src="<%=request.getContextPath()%>/images/1b.gif" title="Help"
					align="middle" border="0"></a> <input type="text"
					name="E01SCHCGL" size=15 maxlength="16" onKeyPress="enterInteger(event)">
				<a
