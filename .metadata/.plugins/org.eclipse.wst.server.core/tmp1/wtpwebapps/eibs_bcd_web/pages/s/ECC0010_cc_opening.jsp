...
%>
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_opening.jsp,ECC0010"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01CCMCUN" size="10" maxlength="9" value="<%= ccNew.getE01CCMCUN().trim()%>" <%if (!userPO.getPurpose().equals("NEW")) {%> readonly <%}%>>
                <%if (userPO.getPurpose().equals("NEW")) {%> 
                <a href="javascript:GetCustomerDescId('E01CCMCUN','E01CUSNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a></div>
                <%}%>
            </td>
            <td nowrap width="16%" > 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
            	<eibsinput:date name="ccNew" fn_month="E01CCMOPM" fn_day="E01CCMOPD" fn_year="E01CCMOPY" />
            </td>
            <td nowrap width="25%"> 
              <div align="right">Fecha de Vencimiento:</div>
            </td>
            <td nowrap width="27%"> 
            	<eibsinput:date name="ccNew" fn_month="E01CCMEXM" fn_day="E01CCMEXD" fn_year="E01CCMEXY" />
            </td>
          </tr>        
          <tr id="trclear"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%"> 
				<input type="text" name="E01CCMTBL" size="3" maxlength="2" value="<%= ccNew.getE01CCMTBL().trim()%>">
				<a href="javascript:GetTableFeeCod('E01CCMTBL',document.forms[0].E01CCMATY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>                         
            </td>
            <td nowrap width="25%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%"> 
              <input type="text" name="E01CCMPCN" size="21" maxlength="20" value="<%= ccNew.getE01CCMPCN().trim()%>" onKeypress="enterInteger(event)">
				<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" >  
 			</td>
          </tr>                
          <tr id="trclear"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="27%"> 
              <input type="text" name="E01CCMNCC" size="8" maxlength="7" value="<%= ccNew.getE01CCMNCC().trim()%>" onKeypress="enterInteger(event)"> 
 			</td>
          </tr>  
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%"> 
				<input type="text" name="E01CCMRPA" size="11" maxlength="10" value="<%= ccNew.getE01CCMRPA().trim()%>" onKeypress="enterInteger(event)"> 
            </td>
            <td nowrap width="25%">
            	<div align="right">Centro de Costos:</div>
            </td>
            <td nowrap width="27%">
              <input type="text" name="E01CCMCCN" size="8" maxlength="6" value="<%= ccNew.getE01CCMCCN().trim()%>" onkeypress="enterInteger(event)">
              <a href="javascript:GetCostCenter('E01CCMCCN',document.forms[0].E01CCMBNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="middle" border="0" ></a>             
            </td>
          </tr>           
          <tr id="trclear"> 
            <td nowrap width="25%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
				<input type="text" name="E01CCMNST" size="7" maxlength="6" value="<%= ccNew.getE01CCMNST().trim()%>" onKeypress="enterInteger(event)"> 
            </td>
            <td nowrap width="25%"> 
              <div align="right">Carpeta:</div>
            </td>
            <td nowrap width="27%"> 
              <input type="text" name="E01CCMFOL" size="7" maxlength="6" value="<%= ccNew.getE01CCMFOL().trim()%>" onKeypress="enterInteger(event)"> 
 			</td>
          </tr>             
        </table>
      </td>
