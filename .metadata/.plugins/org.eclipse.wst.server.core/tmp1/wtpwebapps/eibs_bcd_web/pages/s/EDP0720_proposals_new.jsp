...
<SCRIPT type="text/javascript">
	...
	function callCust() {
    	var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080?SCREEN=600&E01CUN="+customer;
    	CenterNamedWindow(page,'Information',650,500,2);
	}

	function callForex() {
		var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEPR0395?SCREEN=200&E01REQBRN=999&E01REQCD1=0&E01REQCD2=0&E01REQCD3=0&E01REQCH1=0&E01REQCH2=0&E01REQCH3=0&E01REQREF=0&E01REQCUS="+customer;
		CenterNamedWindow(page,'Information',650,500,2);
	}
	...
	function callGroup() {
		customer = "<%=msgRT.getE01PLPGRP().trim()%>";    
    	var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSECIF010?SCREEN=5&CUSTOMER="+customer;
    	CenterNamedWindow(page,'Information',650,500,2);
	}
	...
	function callGuard() {
    	var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0725?SCREEN=200&NPR="+ <%=msgRT.getE01PLPNPR().trim()%>
    														+"&CUN="
	...
	function callInfF() {
    	var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0730?SCREEN=100&CUSTOMER="+ <%=msgRT.getE01CUSCUN().trim()%>;
    	CenterNamedWindow(page,'Information',700,600,2);
	}

	function callCupo() {
    	var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.credit.JSELN0110?SCREEN=1";
    	CenterNamedWindow(page,'Information',700,600,2);
	}


	function callSegP() {
    	var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0750?SCREEN=200&RUT="+ <%=msgRT.getE01PLPNPR().trim()%>+"&DSC= ";
...
function asigDat(name) {
	...
	if (n < 10) {
		...
		if (eval(DPUBCHK) == true) {
			...
			eval("document.forms[0].E01DPDY0"+n+".value = '<%=msgRT.getE01PLPIPY().trim()%>'");
		} else {
		...
		if (eval(DPUBCHK) == true) {
			...
			eval("document.forms[0].E01DPDY"+n+".value = '<%=msgRT.getE01PLPIPY().trim()%>'");
		} else {
    ...
    case 1 :{     
			  ...
			  if (document.forms[0].E01CUSCUN.value == 0) {
				alert('Debe Asignar un numero de cliente \n\n');
			     ...
			     if(document.forms[0].E01DEARRC.value == 0){
			      alert('Error 119 - Codigo de Estado/Situacion o Falta');
			     }else if(document.forms[0].E01PLPINC.value == 0){
			      alert('Error 210 - Sector Económico Falta');
			     }else if(document.forms[0].E01PLPCL9.value == 0){
			      alert('Error 220 - Tipo de Credito Falta');
			     }else if(document.forms[0].E01PLPBUC.value == 0){
			      alert('Error 230 - Actividad Económica Falta');
			     }else{
...
var id = idx;
  ...
  var actTab= document.forms[0].CCOD.value.trim();
...
<H3 align="center">Nueva Propuesta de Cr&eacute;dito
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="proposals_new.jsp, EDP0720">
</H3>
<hr size="4">
...
<% }; %>
  ...
  <h4><A id="Miscelaneos"> Propuesta </A></h4>
      ...
      <td>
		...
		<tr id="trdark"> 
			...
			<tr id="trclear">
				...
				<td width="45%">
				 <INPUT type="text" name="E01PLPIPD" size="3" maxlength="2" value="<%= msgRT.getE01PLPIPD().trim()%>" readonly> 
				 <INPUT type="text" name="E01PLPIPM" size="3" maxlength="2" value="<%= msgRT.getE01PLPIPM().trim()%>" readonly> 
				 <INPUT type="text" name="E01PLPPLP" size="5" maxlength="4" value="<%= msgRT.getE01PLPIPY().trim()%>" readonly> 
				</td>
			</tr>
			...
			<tr id="trdark">
				...
				<% if(userPO.getHeader16().equals("x")) { %> 
		      	    <input type="text" name="E01PLPBNK" size="3" maxlength="2" value="" onKeypress="enterInteger(event)">
				...
				<td width="15%" >
				<div align="right">Sucursal de Apertura:</div>
				</td>
				<td width="45%">
          ...
          <tr id="trclear"> 
            ...
            <td width="25%">
            	<input type="text" name="E01PLPAID" size="12" maxlength="10" value="<%= msgRT.getE01PLPAID().trim()%>" readonly> 
				<INPUT type="text" readonly name="E01XXXAID" size="24" maxlength="24"  value="<%= msgRT.getE01XXXAID().trim()%>">
			...
			<A href="javascript:GetCodeDescCNOFC('E01PLPCN2','E01PLPRE2','PD')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0">
			</A>
			<% } %>
			...
			<% if(userPO.getHeader16().equals("5")){out.print("readonly");}%>
	   		...
	   		<% if(!userPO.getHeader16().equals("5")) {%>
			<A href="javascript:GetCodeDescCNOFC('E01PLPCN3','E01PLPRE3','PD')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0">
			</A>
			<% } %>
			<INPUT type="text" name="E01PLPRE3" size="18" maxlength="15" value="<%= msgRT.getE01PLPRE3().trim()%>" readonly> 
		    </td>
           </tr>
          <tr id="trdark">         		          
            <td nowrap width="15%" > 
            ...
            <td nowrap width="15%" > 
              <div align="right" >Situación Nuevo :</div>
            </td>
            <td nowrap width="45%" > 
      ...
      <td> 
        <table cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="30%">
				...
				<% if(userPO.getHeader16().equals("1")) { %>
        		    ...
        		    <a href="javascript:GetCustomerDescId('E01CUSCUN','E01CUSNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" title=". . ." align="middle" border="0" ></a> 
				<% } else { %>
            ...
            <td width="30%">
               		<input type="text" name="E01CUSNA1" size="36"
					maxlength="35" value="<%= msgRT.getE01CUSNA1().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="20%"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="30%">
			<INPUT type="TEXT" name="E01PLPGRP" size="10" maxlength="9" onkeypress="enterInteger(event)" value="<%= msgRT.getE01PLPGRP().trim()%>" readonly >
            ...
            <td width="30%">
			<INPUT type="TEXT" name="E01PLPBUC" size="4" maxlength="4" onkeypress="enterInteger(event)" readonly value="<%= msgRT.getE01PLPBUC().trim()%>">
			<a href="javascript:GetCodeDescCNOFC('E01PLPBUC','E01XXXBUC','12')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
          ...
          <tr id="trclear"> 
            ...
            <td width="30%">
				<INPUT type="text" name="E01CUSIDD" size="3" maxlength="2" value="<%= msgRT.getE01CUSIDD().trim()%>" readonly> 
				<INPUT type="text" name="E01CUSIDM" size="3" maxlength="2" value="<%= msgRT.getE01CUSIDM().trim()%>" readonly> 
				<INPUT type="text" name="E01CUSIDY" size="5" maxlength="4" value="<%= msgRT.getE01CUSIDY().trim()%>" readonly> 
            
			</td>
            <td width="20%" align="right">
			Fecha Vencimiento:</td>
            <td width="30%">
				<INPUT type="text" name="E01XXXVAD" size="3" maxlength="2" value="<%= msgRT.getE01XXXVAD().trim()%>" readonly> 
				<INPUT type="text" name="E01XXXVAM" size="3" maxlength="2" value="<%= msgRT.getE01XXXVAM().trim()%>" readonly> 
				<INPUT type="text" name="E01XXXVAY" size="5" maxlength="4" value="<%= msgRT.getE01XXXVAY().trim()%>" readonly> 
			</td>
          </tr>
         <tr id="trdark">
			...
			<td width="30%">
			   ...
			   <a href="javascript:GetCodeDescCNOFC('E01PLPINC','E01XXXINC','09')">
			   <img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
           		<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0">
			...
			<td width="30%">
			   ...
			   <a href="javascript:GetCodeDescCNOFC('E01PLPCL9','E01XXXCL9','71')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
           		<img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0">
		...
		<table id="dataTable">
			...
			while (gaCodeList.getNextRow()) {
				...
				<TR>
					...
					<TD ALIGN=CENTER NOWRAP width="5%"><%=gaCodeList.getRecord(0)%></TD>
					<TD ALIGN=LEFT NOWRAP width="35%"><%=gaCodeList.getRecord(1)%></TD>
...
<%} %>
  ...
  <div align="center"> 
       <INPUT class="EIBSBTN" type="button" name="Cancel" value="Cancelar" onclick="goCancel('<%= userPO.getHeader9().trim() %>')">
  </div>
