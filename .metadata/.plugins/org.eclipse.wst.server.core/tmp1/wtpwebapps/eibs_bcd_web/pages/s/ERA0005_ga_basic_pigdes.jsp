...
<h3 align="center"> 
		...
		%>
				...
				de Garantias a Cuentas del Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="ga_basic_pigdes.jsp, ERA0005"> 
</h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="20%" height="17"> 
              <input type="text" name="E01RCLAACC" size="13" maxlength="10" value="<%= gaBasic.getE01RCLAACC()%>" onKeyPress="enterDecimal(event, 2)" readonly>
            </td>
            <td nowrap width="16%" height="17"> 
