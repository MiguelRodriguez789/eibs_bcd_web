...
<H3 align="center">Mantenimiento de Cobranzas Simples<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="dc_enter_maint.jsp, EDC0010"></H3>
<HR size="4">
    ...
    <TR> 
      ...
      <TD nowrap width="50%">
	    <div align="left">
    	    ...
    	    <A href="javascript:GetAccount('E01DCMACC','','50','')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" border="0" align="middle"></A>
    	</div>
      </TD>
    </TR>
  </table>
