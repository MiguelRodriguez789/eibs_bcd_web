...
<H3 align="center">Creacion de Domiciliaciones - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="services_domici_new,SRV0010"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap> 
	        ...
	        <input type="text" name="E01DOMCIN" size="40" maxlength="35" readonly value="<%= msgDom.getE01DOMCIN() %>">
	      	<a href="javascript:GetCodeDescCNOFC('E01DOMCIA','E01DOMCIN','YP')"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
	      ...
	      <td nowrap> 
	        ...
	        <a href="javascript:GetCodeService('E01DOMSRV','E01DOMSRN',document.forms[0].E01DOMCIA.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" title="Ayuda" align="bottom" border="0" ></a>
	        <img src="<%=request.getContextPath()%>/images/Check.gif" title="campo obligatorio" align="bottom" border="0" width="16" height="20"> 
	      </td>
     	</tr>
     	<tr id=trdark> 
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01DOMFD1" size="3" maxlength="2" value="<%= msgDom.getE01DOMFD1() %>" onkeypress="enterInteger(event)">
	      	<input type="text" name="E01DOMFD2" size="3" maxlength="2" value="<%= msgDom.getE01DOMFD2() %>" onkeypress="enterInteger(event)">
	      	<input type="text" name="E01DOMFD3" size="5" maxlength="4" value="<%= msgDom.getE01DOMFD3() %>" onkeypress="enterInteger(event)">
     	...
     	<tr id=trclear> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01DOMTD1" size="3" maxlength="2" value="<%= msgDom.getE01DOMTD1() %>" onkeypress="enterInteger(event)">
	      	<input type="text" name="E01DOMTD2" size="3" maxlength="2" value="<%= msgDom.getE01DOMTD2() %>" onkeypress="enterInteger(event)">
	      	<input type="text" name="E01DOMTD3" size="5" maxlength="4" value="<%= msgDom.getE01DOMTD3() %>" onkeypress="enterInteger(event)">
